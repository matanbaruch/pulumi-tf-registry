...
export class ObjectUserLdap extends pulumi.CustomResource {
    /**
     * Get an existing ObjectUserLdap resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectUserLdapState, opts?: pulumi.CustomResourceOptions): ObjectUserLdap {
        return new ObjectUserLdap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectUserLdap:ObjectUserLdap';

    /**
     * Returns true if the given object is an instance of ObjectUserLdap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectUserLdap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectUserLdap.__pulumiType;
    }
    ...
    public readonly dynamicMappings!: pulumi.Output<outputs.ObjectUserLdapDynamicMapping[] | undefined>;
    ...
    public readonly passwordAttr!: pulumi.Output<string | undefined>;
    ...
    public readonly searchTypes!: pulumi.Output<string[]>;
    ...
    public readonly twoFactorFilter!: pulumi.Output<string | undefined>;
    public readonly twoFactorNotification!: pulumi.Output<string | undefined>;
    public readonly type!: pulumi.Output<string>;
    public readonly userInfoExchangeServer!: pulumi.Output<string | undefined>;
    public readonly username!: pulumi.Output<string | undefined>;

    /**
     * Create a ObjectUserLdap resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ObjectUserLdapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectUserLdapArgs | ObjectUserLdapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectUserLdapState | undefined;
            ...
            resourceInputs["searchTypes"] = state ? state.searchTypes : undefined;
            ...
            const args = argsOrState as ObjectUserLdapArgs | undefined;
            ...
            resourceInputs["searchTypes"] = args ? args.searchTypes : undefined;
        ...
        super(ObjectUserLdap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectUserLdap resources.
 */
export interface ObjectUserLdapState {
    ...
    dynamicMappings?: pulumi.Input<pulumi.Input<inputs.ObjectUserLdapDynamicMapping>[]>;
...
/**
 * The set of arguments for constructing a ObjectUserLdap resource.
 */
export interface ObjectUserLdapArgs {
    accountKeyCertField?: pulumi.Input<string>;
    accountKeyFilter?: pulumi.Input<string>;
    accountKeyProcessing?: pulumi.Input<string>;
    accountKeyUpnSan?: pulumi.Input<string>;
