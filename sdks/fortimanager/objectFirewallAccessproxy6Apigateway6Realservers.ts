...
export class ObjectFirewallAccessproxy6Apigateway6Realservers extends pulumi.CustomResource {
    /**
     * Get an existing ObjectFirewallAccessproxy6Apigateway6Realservers resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectFirewallAccessproxy6Apigateway6RealserversState, opts?: pulumi.CustomResourceOptions): ObjectFirewallAccessproxy6Apigateway6Realservers {
        return new ObjectFirewallAccessproxy6Apigateway6Realservers(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectFirewallAccessproxy6Apigateway6Realservers:ObjectFirewallAccessproxy6Apigateway6Realservers';

    /**
     * Returns true if the given object is an instance of ObjectFirewallAccessproxy6Apigateway6Realservers.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectFirewallAccessproxy6Apigateway6Realservers {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectFirewallAccessproxy6Apigateway6Realservers.__pulumiType;
    }
    ...
    /**
     * Create a ObjectFirewallAccessproxy6Apigateway6Realservers resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectFirewallAccessproxy6Apigateway6RealserversArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectFirewallAccessproxy6Apigateway6RealserversArgs | ObjectFirewallAccessproxy6Apigateway6RealserversState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectFirewallAccessproxy6Apigateway6RealserversState | undefined;
            ...
            const args = argsOrState as ObjectFirewallAccessproxy6Apigateway6RealserversArgs | undefined;
        ...
        super(ObjectFirewallAccessproxy6Apigateway6Realservers.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectFirewallAccessproxy6Apigateway6Realservers resources.
 */
export interface ObjectFirewallAccessproxy6Apigateway6RealserversState {
...
/**
 * The set of arguments for constructing a ObjectFirewallAccessproxy6Apigateway6Realservers resource.
 */
export interface ObjectFirewallAccessproxy6Apigateway6RealserversArgs {
    accessProxy6: pulumi.Input<string>;
    addrType?: pulumi.Input<string>;
    address?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
