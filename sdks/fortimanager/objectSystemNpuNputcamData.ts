...
export class ObjectSystemNpuNputcamData extends pulumi.CustomResource {
    /**
     * Get an existing ObjectSystemNpuNputcamData resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectSystemNpuNputcamDataState, opts?: pulumi.CustomResourceOptions): ObjectSystemNpuNputcamData {
        return new ObjectSystemNpuNputcamData(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectSystemNpuNputcamData:ObjectSystemNpuNputcamData';

    /**
     * Returns true if the given object is an instance of ObjectSystemNpuNputcamData.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectSystemNpuNputcamData {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectSystemNpuNputcamData.__pulumiType;
    }
    ...
    /**
     * Create a ObjectSystemNpuNputcamData resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectSystemNpuNputcamDataArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectSystemNpuNputcamDataArgs | ObjectSystemNpuNputcamDataState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectSystemNpuNputcamDataState | undefined;
            ...
            const args = argsOrState as ObjectSystemNpuNputcamDataArgs | undefined;
        ...
        super(ObjectSystemNpuNputcamData.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectSystemNpuNputcamData resources.
 */
export interface ObjectSystemNpuNputcamDataState {
...
/**
 * The set of arguments for constructing a ObjectSystemNpuNputcamData resource.
 */
export interface ObjectSystemNpuNputcamDataArgs {
    adom?: pulumi.Input<string>;
    df?: pulumi.Input<string>;
    dstip?: pulumi.Input<string>;
    dstipv6?: pulumi.Input<string>;
