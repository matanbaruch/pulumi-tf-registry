...
export class ObjectWirelesscontrollerWtpprofileRadio4 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectWirelesscontrollerWtpprofileRadio4 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectWirelesscontrollerWtpprofileRadio4State, opts?: pulumi.CustomResourceOptions): ObjectWirelesscontrollerWtpprofileRadio4 {
        return new ObjectWirelesscontrollerWtpprofileRadio4(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectWirelesscontrollerWtpprofileRadio4:ObjectWirelesscontrollerWtpprofileRadio4';

    /**
     * Returns true if the given object is an instance of ObjectWirelesscontrollerWtpprofileRadio4.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectWirelesscontrollerWtpprofileRadio4 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectWirelesscontrollerWtpprofileRadio4.__pulumiType;
    }

    public readonly adom!: pulumi.Output<string | undefined>;
    public readonly airtimeFairness!: pulumi.Output<string | undefined>;
    public readonly amsdu!: pulumi.Output<string | undefined>;
    ...
    public readonly autoPowerTarget!: pulumi.Output<string | undefined>;
    public readonly band!: pulumi.Output<string | undefined>;
    public readonly band5gType!: pulumi.Output<string | undefined>;
    ...
    public readonly bssColorMode!: pulumi.Output<string | undefined>;
    public readonly callAdmissionControl!: pulumi.Output<string | undefined>;
    public readonly callCapacity!: pulumi.Output<number | undefined>;
    public readonly channelBonding!: pulumi.Output<string | undefined>;
    public readonly channelUtilization!: pulumi.Output<string | undefined>;
    public readonly channels!: pulumi.Output<string[]>;
    public readonly coexistence!: pulumi.Output<string | undefined>;
    public readonly darrp!: pulumi.Output<string | undefined>;
    public readonly drma!: pulumi.Output<string | undefined>;
    public readonly drmaSensitivity!: pulumi.Output<string | undefined>;
    public readonly dtim!: pulumi.Output<number | undefined>;
    public readonly fragThreshold!: pulumi.Output<number | undefined>;
    ...
    public readonly n80211d!: pulumi.Output<string | undefined>;
    public readonly optionalAntenna!: pulumi.Output<string | undefined>;
    public readonly optionalAntennaGain!: pulumi.Output<string | undefined>;
    public readonly powerLevel!: pulumi.Output<number | undefined>;
    public readonly powerMode!: pulumi.Output<string | undefined>;
    ...
    public readonly rtsThreshold!: pulumi.Output<number | undefined>;
    ...
    public readonly samEapMethod!: pulumi.Output<string | undefined>;
    ...
    public readonly shortGuardInterval!: pulumi.Output<string | undefined>;
    ...
    public readonly zeroWaitDfs!: pulumi.Output<string | undefined>;

    /**
     * Create a ObjectWirelesscontrollerWtpprofileRadio4 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectWirelesscontrollerWtpprofileRadio4Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectWirelesscontrollerWtpprofileRadio4Args | ObjectWirelesscontrollerWtpprofileRadio4State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectWirelesscontrollerWtpprofileRadio4State | undefined;
            ...
            const args = argsOrState as ObjectWirelesscontrollerWtpprofileRadio4Args | undefined;
        ...
        super(ObjectWirelesscontrollerWtpprofileRadio4.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectWirelesscontrollerWtpprofileRadio4 resources.
 */
export interface ObjectWirelesscontrollerWtpprofileRadio4State {
...
/**
 * The set of arguments for constructing a ObjectWirelesscontrollerWtpprofileRadio4 resource.
 */
export interface ObjectWirelesscontrollerWtpprofileRadio4Args {
    adom?: pulumi.Input<string>;
    airtimeFairness?: pulumi.Input<string>;
    amsdu?: pulumi.Input<string>;
    apHandoff?: pulumi.Input<string>;
