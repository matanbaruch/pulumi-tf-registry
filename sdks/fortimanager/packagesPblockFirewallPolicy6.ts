...
export class PackagesPblockFirewallPolicy6 extends pulumi.CustomResource {
    /**
     * Get an existing PackagesPblockFirewallPolicy6 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesPblockFirewallPolicy6State, opts?: pulumi.CustomResourceOptions): PackagesPblockFirewallPolicy6 {
        return new PackagesPblockFirewallPolicy6(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesPblockFirewallPolicy6:PackagesPblockFirewallPolicy6';

    /**
     * Returns true if the given object is an instance of PackagesPblockFirewallPolicy6.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesPblockFirewallPolicy6 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesPblockFirewallPolicy6.__pulumiType;
    }
    ...
    public readonly sslMirrorIntfs!: pulumi.Output<string[]>;
    ...
    /**
     * Create a PackagesPblockFirewallPolicy6 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesPblockFirewallPolicy6Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesPblockFirewallPolicy6Args | PackagesPblockFirewallPolicy6State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesPblockFirewallPolicy6State | undefined;
            ...
            const args = argsOrState as PackagesPblockFirewallPolicy6Args | undefined;
        ...
        super(PackagesPblockFirewallPolicy6.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesPblockFirewallPolicy6 resources.
 */
export interface PackagesPblockFirewallPolicy6State {
    ...
    sslMirrorIntfs?: pulumi.Input<pulumi.Input<string>[]>;
...
/**
 * The set of arguments for constructing a PackagesPblockFirewallPolicy6 resource.
 */
export interface PackagesPblockFirewallPolicy6Args {
    _policyBlock?: pulumi.Input<number>;
    action?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    antiReplay?: pulumi.Input<string>;
