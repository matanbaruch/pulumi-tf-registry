...
export class PackagesGlobalFooterConsolidatedPolicy extends pulumi.CustomResource {
    /**
     * Get an existing PackagesGlobalFooterConsolidatedPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesGlobalFooterConsolidatedPolicyState, opts?: pulumi.CustomResourceOptions): PackagesGlobalFooterConsolidatedPolicy {
        return new PackagesGlobalFooterConsolidatedPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesGlobalFooterConsolidatedPolicy:PackagesGlobalFooterConsolidatedPolicy';

    /**
     * Returns true if the given object is an instance of PackagesGlobalFooterConsolidatedPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesGlobalFooterConsolidatedPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesGlobalFooterConsolidatedPolicy.__pulumiType;
    }
    ...
    /**
     * Create a PackagesGlobalFooterConsolidatedPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesGlobalFooterConsolidatedPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesGlobalFooterConsolidatedPolicyArgs | PackagesGlobalFooterConsolidatedPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesGlobalFooterConsolidatedPolicyState | undefined;
            ...
            const args = argsOrState as PackagesGlobalFooterConsolidatedPolicyArgs | undefined;
        ...
        super(PackagesGlobalFooterConsolidatedPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesGlobalFooterConsolidatedPolicy resources.
 */
export interface PackagesGlobalFooterConsolidatedPolicyState {
...
/**
 * The set of arguments for constructing a PackagesGlobalFooterConsolidatedPolicy resource.
 */
export interface PackagesGlobalFooterConsolidatedPolicyArgs {
    _policyBlock?: pulumi.Input<number>;
    action?: pulumi.Input<string>;
    appCategory?: pulumi.Input<string>;
    appGroup?: pulumi.Input<string>;
