...
export class PackagesGlobalFooterPolicy extends pulumi.CustomResource {
    /**
     * Get an existing PackagesGlobalFooterPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesGlobalFooterPolicyState, opts?: pulumi.CustomResourceOptions): PackagesGlobalFooterPolicy {
        return new PackagesGlobalFooterPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesGlobalFooterPolicy:PackagesGlobalFooterPolicy';

    /**
     * Returns true if the given object is an instance of PackagesGlobalFooterPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesGlobalFooterPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesGlobalFooterPolicy.__pulumiType;
    }
    ...
    /**
     * Create a PackagesGlobalFooterPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesGlobalFooterPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesGlobalFooterPolicyArgs | PackagesGlobalFooterPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesGlobalFooterPolicyState | undefined;
            ...
            const args = argsOrState as PackagesGlobalFooterPolicyArgs | undefined;
        ...
        super(PackagesGlobalFooterPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesGlobalFooterPolicy resources.
 */
export interface PackagesGlobalFooterPolicyState {
...
/**
 * The set of arguments for constructing a PackagesGlobalFooterPolicy resource.
 */
export interface PackagesGlobalFooterPolicyArgs {
    _policyBlock?: pulumi.Input<number>;
    accessProxies?: pulumi.Input<pulumi.Input<string>[]>;
    action?: pulumi.Input<string>;
    activeAuthMethod?: pulumi.Input<string>;
