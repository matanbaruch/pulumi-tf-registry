...
export class ObjectWirelesscontrollerWidsprofile extends pulumi.CustomResource {
    /**
     * Get an existing ObjectWirelesscontrollerWidsprofile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectWirelesscontrollerWidsprofileState, opts?: pulumi.CustomResourceOptions): ObjectWirelesscontrollerWidsprofile {
        return new ObjectWirelesscontrollerWidsprofile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectWirelesscontrollerWidsprofile:ObjectWirelesscontrollerWidsprofile';

    /**
     * Returns true if the given object is an instance of ObjectWirelesscontrollerWidsprofile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectWirelesscontrollerWidsprofile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectWirelesscontrollerWidsprofile.__pulumiType;
    }

    public readonly adom!: pulumi.Output<string | undefined>;
    public readonly apAutoSuppress!: pulumi.Output<string | undefined>;
    public readonly apBgscanDisableDays!: pulumi.Output<string[]>;
    public readonly apBgscanDisableEnd!: pulumi.Output<string | undefined>;
    public readonly apBgscanDisableSchedules!: pulumi.Output<string[]>;
    public readonly apBgscanDisableStart!: pulumi.Output<string | undefined>;
    ...
    /**
     * Create a ObjectWirelesscontrollerWidsprofile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ObjectWirelesscontrollerWidsprofileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectWirelesscontrollerWidsprofileArgs | ObjectWirelesscontrollerWidsprofileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectWirelesscontrollerWidsprofileState | undefined;
            resourceInputs["adom"] = state ? state.adom : undefined;
            resourceInputs["apAutoSuppress"] = state ? state.apAutoSuppress : undefined;
            resourceInputs["apBgscanDisableDays"] = state ? state.apBgscanDisableDays : undefined;
            ...
            const args = argsOrState as ObjectWirelesscontrollerWidsprofileArgs | undefined;
            resourceInputs["adom"] = args ? args.adom : undefined;
            resourceInputs["apAutoSuppress"] = args ? args.apAutoSuppress : undefined;
            resourceInputs["apBgscanDisableDays"] = args ? args.apBgscanDisableDays : undefined;
        ...
        super(ObjectWirelesscontrollerWidsprofile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectWirelesscontrollerWidsprofile resources.
 */
export interface ObjectWirelesscontrollerWidsprofileState {
    adom?: pulumi.Input<string>;
    apAutoSuppress?: pulumi.Input<string>;
    apBgscanDisableDays?: pulumi.Input<pulumi.Input<string>[]>;
...
/**
 * The set of arguments for constructing a ObjectWirelesscontrollerWidsprofile resource.
 */
export interface ObjectWirelesscontrollerWidsprofileArgs {
    adom?: pulumi.Input<string>;
    apAutoSuppress?: pulumi.Input<string>;
    apBgscanDisableDays?: pulumi.Input<pulumi.Input<string>[]>;
    apBgscanDisableEnd?: pulumi.Input<string>;
