...
export class PackagesFirewallPolicy46 extends pulumi.CustomResource {
    /**
     * Get an existing PackagesFirewallPolicy46 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesFirewallPolicy46State, opts?: pulumi.CustomResourceOptions): PackagesFirewallPolicy46 {
        return new PackagesFirewallPolicy46(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesFirewallPolicy46:PackagesFirewallPolicy46';

    /**
     * Returns true if the given object is an instance of PackagesFirewallPolicy46.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesFirewallPolicy46 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesFirewallPolicy46.__pulumiType;
    }
    ...
    /**
     * Create a PackagesFirewallPolicy46 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesFirewallPolicy46Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesFirewallPolicy46Args | PackagesFirewallPolicy46State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesFirewallPolicy46State | undefined;
            ...
            const args = argsOrState as PackagesFirewallPolicy46Args | undefined;
        ...
        super(PackagesFirewallPolicy46.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesFirewallPolicy46 resources.
 */
export interface PackagesFirewallPolicy46State {
...
/**
 * The set of arguments for constructing a PackagesFirewallPolicy46 resource.
 */
export interface PackagesFirewallPolicy46Args {
    action?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    cgnLogServerGrp?: pulumi.Input<string>;
    comments?: pulumi.Input<string>;
