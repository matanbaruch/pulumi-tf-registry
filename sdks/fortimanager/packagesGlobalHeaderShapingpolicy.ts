...
export class PackagesGlobalHeaderShapingpolicy extends pulumi.CustomResource {
    /**
     * Get an existing PackagesGlobalHeaderShapingpolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesGlobalHeaderShapingpolicyState, opts?: pulumi.CustomResourceOptions): PackagesGlobalHeaderShapingpolicy {
        return new PackagesGlobalHeaderShapingpolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesGlobalHeaderShapingpolicy:PackagesGlobalHeaderShapingpolicy';

    /**
     * Returns true if the given object is an instance of PackagesGlobalHeaderShapingpolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesGlobalHeaderShapingpolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesGlobalHeaderShapingpolicy.__pulumiType;
    }
    ...
    /**
     * Create a PackagesGlobalHeaderShapingpolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesGlobalHeaderShapingpolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesGlobalHeaderShapingpolicyArgs | PackagesGlobalHeaderShapingpolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesGlobalHeaderShapingpolicyState | undefined;
            ...
            const args = argsOrState as PackagesGlobalHeaderShapingpolicyArgs | undefined;
        ...
        super(PackagesGlobalHeaderShapingpolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesGlobalHeaderShapingpolicy resources.
 */
export interface PackagesGlobalHeaderShapingpolicyState {
...
/**
 * The set of arguments for constructing a PackagesGlobalHeaderShapingpolicy resource.
 */
export interface PackagesGlobalHeaderShapingpolicyArgs {
    appCategory?: pulumi.Input<string>;
    appGroup?: pulumi.Input<string>;
    applications?: pulumi.Input<pulumi.Input<number>[]>;
    classId?: pulumi.Input<string>;
