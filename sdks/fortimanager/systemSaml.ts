...
export class SystemSaml extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/systemSaml:SystemSaml';
    ...
    public readonly acsUrl!: pulumi.Output<string | undefined>;
    ...
    public readonly slsUrl!: pulumi.Output<string | undefined>;
