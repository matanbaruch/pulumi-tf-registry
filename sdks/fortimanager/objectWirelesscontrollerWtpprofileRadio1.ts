...
export class ObjectWirelesscontrollerWtpprofileRadio1 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectWirelesscontrollerWtpprofileRadio1 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectWirelesscontrollerWtpprofileRadio1State, opts?: pulumi.CustomResourceOptions): ObjectWirelesscontrollerWtpprofileRadio1 {
        return new ObjectWirelesscontrollerWtpprofileRadio1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectWirelesscontrollerWtpprofileRadio1:ObjectWirelesscontrollerWtpprofileRadio1';

    /**
     * Returns true if the given object is an instance of ObjectWirelesscontrollerWtpprofileRadio1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectWirelesscontrollerWtpprofileRadio1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectWirelesscontrollerWtpprofileRadio1.__pulumiType;
    }
    ...
    public readonly apSnifferBufsize!: pulumi.Output<number>;
    ...
    /**
     * Create a ObjectWirelesscontrollerWtpprofileRadio1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectWirelesscontrollerWtpprofileRadio1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectWirelesscontrollerWtpprofileRadio1Args | ObjectWirelesscontrollerWtpprofileRadio1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectWirelesscontrollerWtpprofileRadio1State | undefined;
            ...
            const args = argsOrState as ObjectWirelesscontrollerWtpprofileRadio1Args | undefined;
        ...
        super(ObjectWirelesscontrollerWtpprofileRadio1.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectWirelesscontrollerWtpprofileRadio1 resources.
 */
export interface ObjectWirelesscontrollerWtpprofileRadio1State {
...
/**
 * The set of arguments for constructing a ObjectWirelesscontrollerWtpprofileRadio1 resource.
 */
export interface ObjectWirelesscontrollerWtpprofileRadio1Args {
    adom?: pulumi.Input<string>;
    airtimeFairness?: pulumi.Input<string>;
    amsdu?: pulumi.Input<string>;
    apHandoff?: pulumi.Input<string>;
