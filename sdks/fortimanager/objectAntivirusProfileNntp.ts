...
export class ObjectAntivirusProfileNntp extends pulumi.CustomResource {
    /**
     * Get an existing ObjectAntivirusProfileNntp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectAntivirusProfileNntpState, opts?: pulumi.CustomResourceOptions): ObjectAntivirusProfileNntp {
        return new ObjectAntivirusProfileNntp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectAntivirusProfileNntp:ObjectAntivirusProfileNntp';

    /**
     * Returns true if the given object is an instance of ObjectAntivirusProfileNntp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectAntivirusProfileNntp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectAntivirusProfileNntp.__pulumiType;
    }
    ...
    /**
     * Create a ObjectAntivirusProfileNntp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectAntivirusProfileNntpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectAntivirusProfileNntpArgs | ObjectAntivirusProfileNntpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectAntivirusProfileNntpState | undefined;
            ...
            const args = argsOrState as ObjectAntivirusProfileNntpArgs | undefined;
        ...
        super(ObjectAntivirusProfileNntp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectAntivirusProfileNntp resources.
 */
export interface ObjectAntivirusProfileNntpState {
...
/**
 * The set of arguments for constructing a ObjectAntivirusProfileNntp resource.
 */
export interface ObjectAntivirusProfileNntpArgs {
    adom?: pulumi.Input<string>;
    archiveBlocks?: pulumi.Input<pulumi.Input<string>[]>;
    archiveLogs?: pulumi.Input<pulumi.Input<string>[]>;
    avScan?: pulumi.Input<string>;
