...
export class PackagesFirewallInterfacepolicy extends pulumi.CustomResource {
    /**
     * Get an existing PackagesFirewallInterfacepolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesFirewallInterfacepolicyState, opts?: pulumi.CustomResourceOptions): PackagesFirewallInterfacepolicy {
        return new PackagesFirewallInterfacepolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesFirewallInterfacepolicy:PackagesFirewallInterfacepolicy';

    /**
     * Returns true if the given object is an instance of PackagesFirewallInterfacepolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesFirewallInterfacepolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesFirewallInterfacepolicy.__pulumiType;
    }
    ...
    /**
     * Create a PackagesFirewallInterfacepolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesFirewallInterfacepolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesFirewallInterfacepolicyArgs | PackagesFirewallInterfacepolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesFirewallInterfacepolicyState | undefined;
            ...
            const args = argsOrState as PackagesFirewallInterfacepolicyArgs | undefined;
        ...
        super(PackagesFirewallInterfacepolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesFirewallInterfacepolicy resources.
 */
export interface PackagesFirewallInterfacepolicyState {
...
/**
 * The set of arguments for constructing a PackagesFirewallInterfacepolicy resource.
 */
export interface PackagesFirewallInterfacepolicyArgs {
    addressType?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    applicationList?: pulumi.Input<string>;
    applicationListStatus?: pulumi.Input<string>;
