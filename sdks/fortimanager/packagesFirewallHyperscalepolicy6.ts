...
export class PackagesFirewallHyperscalepolicy6 extends pulumi.CustomResource {
    /**
     * Get an existing PackagesFirewallHyperscalepolicy6 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesFirewallHyperscalepolicy6State, opts?: pulumi.CustomResourceOptions): PackagesFirewallHyperscalepolicy6 {
        return new PackagesFirewallHyperscalepolicy6(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesFirewallHyperscalepolicy6:PackagesFirewallHyperscalepolicy6';

    /**
     * Returns true if the given object is an instance of PackagesFirewallHyperscalepolicy6.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesFirewallHyperscalepolicy6 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesFirewallHyperscalepolicy6.__pulumiType;
    }
    ...
    /**
     * Create a PackagesFirewallHyperscalepolicy6 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesFirewallHyperscalepolicy6Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesFirewallHyperscalepolicy6Args | PackagesFirewallHyperscalepolicy6State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesFirewallHyperscalepolicy6State | undefined;
            ...
            const args = argsOrState as PackagesFirewallHyperscalepolicy6Args | undefined;
        ...
        super(PackagesFirewallHyperscalepolicy6.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesFirewallHyperscalepolicy6 resources.
 */
export interface PackagesFirewallHyperscalepolicy6State {
...
/**
 * The set of arguments for constructing a PackagesFirewallHyperscalepolicy6 resource.
 */
export interface PackagesFirewallHyperscalepolicy6Args {
    action?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    autoAsicOffload?: pulumi.Input<string>;
    cgnLogServerGrp?: pulumi.Input<string>;
