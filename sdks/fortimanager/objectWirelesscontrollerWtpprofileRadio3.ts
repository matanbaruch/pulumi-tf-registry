...
export class ObjectWirelesscontrollerWtpprofileRadio3 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectWirelesscontrollerWtpprofileRadio3 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectWirelesscontrollerWtpprofileRadio3State, opts?: pulumi.CustomResourceOptions): ObjectWirelesscontrollerWtpprofileRadio3 {
        return new ObjectWirelesscontrollerWtpprofileRadio3(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectWirelesscontrollerWtpprofileRadio3:ObjectWirelesscontrollerWtpprofileRadio3';

    /**
     * Returns true if the given object is an instance of ObjectWirelesscontrollerWtpprofileRadio3.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectWirelesscontrollerWtpprofileRadio3 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectWirelesscontrollerWtpprofileRadio3.__pulumiType;
    }
    ...
    /**
     * Create a ObjectWirelesscontrollerWtpprofileRadio3 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectWirelesscontrollerWtpprofileRadio3Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectWirelesscontrollerWtpprofileRadio3Args | ObjectWirelesscontrollerWtpprofileRadio3State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectWirelesscontrollerWtpprofileRadio3State | undefined;
            ...
            const args = argsOrState as ObjectWirelesscontrollerWtpprofileRadio3Args | undefined;
        ...
        super(ObjectWirelesscontrollerWtpprofileRadio3.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectWirelesscontrollerWtpprofileRadio3 resources.
 */
export interface ObjectWirelesscontrollerWtpprofileRadio3State {
...
/**
 * The set of arguments for constructing a ObjectWirelesscontrollerWtpprofileRadio3 resource.
 */
export interface ObjectWirelesscontrollerWtpprofileRadio3Args {
    adom?: pulumi.Input<string>;
    airtimeFairness?: pulumi.Input<string>;
    amsdu?: pulumi.Input<string>;
    apHandoff?: pulumi.Input<string>;
