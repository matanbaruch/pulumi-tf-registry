...
export class ObjectSwitchcontrollerLldpprofile extends pulumi.CustomResource {
    /**
     * Get an existing ObjectSwitchcontrollerLldpprofile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectSwitchcontrollerLldpprofileState, opts?: pulumi.CustomResourceOptions): ObjectSwitchcontrollerLldpprofile {
        return new ObjectSwitchcontrollerLldpprofile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectSwitchcontrollerLldpprofile:ObjectSwitchcontrollerLldpprofile';

    /**
     * Returns true if the given object is an instance of ObjectSwitchcontrollerLldpprofile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectSwitchcontrollerLldpprofile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectSwitchcontrollerLldpprofile.__pulumiType;
    }
    ...
    public readonly customTlvs!: pulumi.Output<outputs.ObjectSwitchcontrollerLldpprofileCustomTlv[] | undefined>;
    public readonly dynamicSortSubtable!: pulumi.Output<string | undefined>;
    public readonly medLocationServices!: pulumi.Output<outputs.ObjectSwitchcontrollerLldpprofileMedLocationService[] | undefined>;
    public readonly medNetworkPolicies!: pulumi.Output<outputs.ObjectSwitchcontrollerLldpprofileMedNetworkPolicy[] | undefined>;
    ...
    /**
     * Create a ObjectSwitchcontrollerLldpprofile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ObjectSwitchcontrollerLldpprofileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectSwitchcontrollerLldpprofileArgs | ObjectSwitchcontrollerLldpprofileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectSwitchcontrollerLldpprofileState | undefined;
            ...
            const args = argsOrState as ObjectSwitchcontrollerLldpprofileArgs | undefined;
        ...
        super(ObjectSwitchcontrollerLldpprofile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectSwitchcontrollerLldpprofile resources.
 */
export interface ObjectSwitchcontrollerLldpprofileState {
    ...
    customTlvs?: pulumi.Input<pulumi.Input<inputs.ObjectSwitchcontrollerLldpprofileCustomTlv>[]>;
    dynamicSortSubtable?: pulumi.Input<string>;
    medLocationServices?: pulumi.Input<pulumi.Input<inputs.ObjectSwitchcontrollerLldpprofileMedLocationService>[]>;
    medNetworkPolicies?: pulumi.Input<pulumi.Input<inputs.ObjectSwitchcontrollerLldpprofileMedNetworkPolicy>[]>;
...
/**
 * The set of arguments for constructing a ObjectSwitchcontrollerLldpprofile resource.
 */
export interface ObjectSwitchcontrollerLldpprofileArgs {
    adom?: pulumi.Input<string>;
    autoIsl?: pulumi.Input<string>;
    autoIslAuth?: pulumi.Input<string>;
    autoIslAuthEncrypt?: pulumi.Input<string>;
