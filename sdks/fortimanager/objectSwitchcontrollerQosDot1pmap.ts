...
export class ObjectSwitchcontrollerQosDot1pmap extends pulumi.CustomResource {
    /**
     * Get an existing ObjectSwitchcontrollerQosDot1pmap resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectSwitchcontrollerQosDot1pmapState, opts?: pulumi.CustomResourceOptions): ObjectSwitchcontrollerQosDot1pmap {
        return new ObjectSwitchcontrollerQosDot1pmap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectSwitchcontrollerQosDot1pmap:ObjectSwitchcontrollerQosDot1pmap';

    /**
     * Returns true if the given object is an instance of ObjectSwitchcontrollerQosDot1pmap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectSwitchcontrollerQosDot1pmap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectSwitchcontrollerQosDot1pmap.__pulumiType;
    }
    ...
    /**
     * Create a ObjectSwitchcontrollerQosDot1pmap resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ObjectSwitchcontrollerQosDot1pmapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectSwitchcontrollerQosDot1pmapArgs | ObjectSwitchcontrollerQosDot1pmapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectSwitchcontrollerQosDot1pmapState | undefined;
            ...
            const args = argsOrState as ObjectSwitchcontrollerQosDot1pmapArgs | undefined;
        ...
        super(ObjectSwitchcontrollerQosDot1pmap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectSwitchcontrollerQosDot1pmap resources.
 */
export interface ObjectSwitchcontrollerQosDot1pmapState {
...
/**
 * The set of arguments for constructing a ObjectSwitchcontrollerQosDot1pmap resource.
 */
export interface ObjectSwitchcontrollerQosDot1pmapArgs {
    adom?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    egressPriTagging?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
