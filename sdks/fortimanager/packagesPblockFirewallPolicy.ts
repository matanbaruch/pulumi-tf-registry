...
export class PackagesPblockFirewallPolicy extends pulumi.CustomResource {
    /**
     * Get an existing PackagesPblockFirewallPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesPblockFirewallPolicyState, opts?: pulumi.CustomResourceOptions): PackagesPblockFirewallPolicy {
        return new PackagesPblockFirewallPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesPblockFirewallPolicy:PackagesPblockFirewallPolicy';

    /**
     * Returns true if the given object is an instance of PackagesPblockFirewallPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesPblockFirewallPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesPblockFirewallPolicy.__pulumiType;
    }
    ...
    public readonly rtpAddrs!: pulumi.Output<string[]>;
    ...
    /**
     * Create a PackagesPblockFirewallPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesPblockFirewallPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesPblockFirewallPolicyArgs | PackagesPblockFirewallPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesPblockFirewallPolicyState | undefined;
            ...
            const args = argsOrState as PackagesPblockFirewallPolicyArgs | undefined;
        ...
        super(PackagesPblockFirewallPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesPblockFirewallPolicy resources.
 */
export interface PackagesPblockFirewallPolicyState {
    ...
    rtpAddrs?: pulumi.Input<pulumi.Input<string>[]>;
...
/**
 * The set of arguments for constructing a PackagesPblockFirewallPolicy resource.
 */
export interface PackagesPblockFirewallPolicyArgs {
    _policyBlock?: pulumi.Input<number>;
    action?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    antiReplay?: pulumi.Input<string>;
