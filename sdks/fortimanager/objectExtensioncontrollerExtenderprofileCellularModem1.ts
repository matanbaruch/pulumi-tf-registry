...
export class ObjectExtensioncontrollerExtenderprofileCellularModem1 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectExtensioncontrollerExtenderprofileCellularModem1 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectExtensioncontrollerExtenderprofileCellularModem1State, opts?: pulumi.CustomResourceOptions): ObjectExtensioncontrollerExtenderprofileCellularModem1 {
        return new ObjectExtensioncontrollerExtenderprofileCellularModem1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectExtensioncontrollerExtenderprofileCellularModem1:ObjectExtensioncontrollerExtenderprofileCellularModem1';

    /**
     * Returns true if the given object is an instance of ObjectExtensioncontrollerExtenderprofileCellularModem1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectExtensioncontrollerExtenderprofileCellularModem1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectExtensioncontrollerExtenderprofileCellularModem1.__pulumiType;
    }

    public readonly adom!: pulumi.Output<string | undefined>;
    public readonly autoSwitch!: pulumi.Output<outputs.ObjectExtensioncontrollerExtenderprofileCellularModem1AutoSwitch | undefined>;
    ...
    /**
     * Create a ObjectExtensioncontrollerExtenderprofileCellularModem1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectExtensioncontrollerExtenderprofileCellularModem1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectExtensioncontrollerExtenderprofileCellularModem1Args | ObjectExtensioncontrollerExtenderprofileCellularModem1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectExtensioncontrollerExtenderprofileCellularModem1State | undefined;
            ...
            const args = argsOrState as ObjectExtensioncontrollerExtenderprofileCellularModem1Args | undefined;
        ...
        super(ObjectExtensioncontrollerExtenderprofileCellularModem1.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectExtensioncontrollerExtenderprofileCellularModem1 resources.
 */
export interface ObjectExtensioncontrollerExtenderprofileCellularModem1State {
...
/**
 * The set of arguments for constructing a ObjectExtensioncontrollerExtenderprofileCellularModem1 resource.
 */
export interface ObjectExtensioncontrollerExtenderprofileCellularModem1Args {
    adom?: pulumi.Input<string>;
    autoSwitch?: pulumi.Input<inputs.ObjectExtensioncontrollerExtenderprofileCellularModem1AutoSwitch>;
    connStatus?: pulumi.Input<number>;
    defaultSim?: pulumi.Input<string>;
