...
export class PackagesFirewallConsolidatedPolicy extends pulumi.CustomResource {
    /**
     * Get an existing PackagesFirewallConsolidatedPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesFirewallConsolidatedPolicyState, opts?: pulumi.CustomResourceOptions): PackagesFirewallConsolidatedPolicy {
        return new PackagesFirewallConsolidatedPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesFirewallConsolidatedPolicy:PackagesFirewallConsolidatedPolicy';

    /**
     * Returns true if the given object is an instance of PackagesFirewallConsolidatedPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesFirewallConsolidatedPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesFirewallConsolidatedPolicy.__pulumiType;
    }
    ...
    public readonly captivePortalExempt!: pulumi.Output<string | undefined>;
    ...
    /**
     * Create a PackagesFirewallConsolidatedPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesFirewallConsolidatedPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesFirewallConsolidatedPolicyArgs | PackagesFirewallConsolidatedPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesFirewallConsolidatedPolicyState | undefined;
            ...
            const args = argsOrState as PackagesFirewallConsolidatedPolicyArgs | undefined;
        ...
        super(PackagesFirewallConsolidatedPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesFirewallConsolidatedPolicy resources.
 */
export interface PackagesFirewallConsolidatedPolicyState {
...
/**
 * The set of arguments for constructing a PackagesFirewallConsolidatedPolicy resource.
 */
export interface PackagesFirewallConsolidatedPolicyArgs {
    _policyBlock?: pulumi.Input<number>;
    action?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    appCategory?: pulumi.Input<string>;
