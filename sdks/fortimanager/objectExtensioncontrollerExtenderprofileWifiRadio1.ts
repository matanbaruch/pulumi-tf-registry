...
export class ObjectExtensioncontrollerExtenderprofileWifiRadio1 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectExtensioncontrollerExtenderprofileWifiRadio1 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectExtensioncontrollerExtenderprofileWifiRadio1State, opts?: pulumi.CustomResourceOptions): ObjectExtensioncontrollerExtenderprofileWifiRadio1 {
        return new ObjectExtensioncontrollerExtenderprofileWifiRadio1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectExtensioncontrollerExtenderprofileWifiRadio1:ObjectExtensioncontrollerExtenderprofileWifiRadio1';

    /**
     * Returns true if the given object is an instance of ObjectExtensioncontrollerExtenderprofileWifiRadio1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectExtensioncontrollerExtenderprofileWifiRadio1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectExtensioncontrollerExtenderprofileWifiRadio1.__pulumiType;
    }
    ...
    /**
     * Create a ObjectExtensioncontrollerExtenderprofileWifiRadio1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectExtensioncontrollerExtenderprofileWifiRadio1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectExtensioncontrollerExtenderprofileWifiRadio1Args | ObjectExtensioncontrollerExtenderprofileWifiRadio1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectExtensioncontrollerExtenderprofileWifiRadio1State | undefined;
            ...
            const args = argsOrState as ObjectExtensioncontrollerExtenderprofileWifiRadio1Args | undefined;
        ...
        super(ObjectExtensioncontrollerExtenderprofileWifiRadio1.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectExtensioncontrollerExtenderprofileWifiRadio1 resources.
 */
export interface ObjectExtensioncontrollerExtenderprofileWifiRadio1State {
...
/**
 * The set of arguments for constructing a ObjectExtensioncontrollerExtenderprofileWifiRadio1 resource.
 */
export interface ObjectExtensioncontrollerExtenderprofileWifiRadio1Args {
    adom?: pulumi.Input<string>;
    band?: pulumi.Input<string>;
    bandwidth?: pulumi.Input<string>;
    beaconInterval?: pulumi.Input<number>;
