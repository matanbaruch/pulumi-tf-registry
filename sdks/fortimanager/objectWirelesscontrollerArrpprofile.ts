...
export class ObjectWirelesscontrollerArrpprofile extends pulumi.CustomResource {
    /**
     * Get an existing ObjectWirelesscontrollerArrpprofile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectWirelesscontrollerArrpprofileState, opts?: pulumi.CustomResourceOptions): ObjectWirelesscontrollerArrpprofile {
        return new ObjectWirelesscontrollerArrpprofile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectWirelesscontrollerArrpprofile:ObjectWirelesscontrollerArrpprofile';

    /**
     * Returns true if the given object is an instance of ObjectWirelesscontrollerArrpprofile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectWirelesscontrollerArrpprofile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectWirelesscontrollerArrpprofile.__pulumiType;
    }
    ...
    /**
     * Create a ObjectWirelesscontrollerArrpprofile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ObjectWirelesscontrollerArrpprofileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectWirelesscontrollerArrpprofileArgs | ObjectWirelesscontrollerArrpprofileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectWirelesscontrollerArrpprofileState | undefined;
            ...
            const args = argsOrState as ObjectWirelesscontrollerArrpprofileArgs | undefined;
        ...
        super(ObjectWirelesscontrollerArrpprofile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectWirelesscontrollerArrpprofile resources.
 */
export interface ObjectWirelesscontrollerArrpprofileState {
...
/**
 * The set of arguments for constructing a ObjectWirelesscontrollerArrpprofile resource.
 */
export interface ObjectWirelesscontrollerArrpprofileArgs {
    adom?: pulumi.Input<string>;
    comment?: pulumi.Input<string>;
    darrpOptimize?: pulumi.Input<number>;
    darrpOptimizeSchedules?: pulumi.Input<pulumi.Input<string>[]>;
