...
export class ObjectAntivirusProfileHttp extends pulumi.CustomResource {
    /**
     * Get an existing ObjectAntivirusProfileHttp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectAntivirusProfileHttpState, opts?: pulumi.CustomResourceOptions): ObjectAntivirusProfileHttp {
        return new ObjectAntivirusProfileHttp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectAntivirusProfileHttp:ObjectAntivirusProfileHttp';

    /**
     * Returns true if the given object is an instance of ObjectAntivirusProfileHttp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectAntivirusProfileHttp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectAntivirusProfileHttp.__pulumiType;
    }

    public readonly adom!: pulumi.Output<string | undefined>;
    public readonly archiveBlocks!: pulumi.Output<string[]>;
    public readonly archiveLogs!: pulumi.Output<string[]>;
    public readonly avOptimize!: pulumi.Output<string | undefined>;
    ...
    /**
     * Create a ObjectAntivirusProfileHttp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectAntivirusProfileHttpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectAntivirusProfileHttpArgs | ObjectAntivirusProfileHttpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectAntivirusProfileHttpState | undefined;
            ...
            resourceInputs["avOptimize"] = state ? state.avOptimize : undefined;
            ...
            const args = argsOrState as ObjectAntivirusProfileHttpArgs | undefined;
            ...
            resourceInputs["avOptimize"] = args ? args.avOptimize : undefined;
        ...
        super(ObjectAntivirusProfileHttp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectAntivirusProfileHttp resources.
 */
export interface ObjectAntivirusProfileHttpState {
...
/**
 * The set of arguments for constructing a ObjectAntivirusProfileHttp resource.
 */
export interface ObjectAntivirusProfileHttpArgs {
    adom?: pulumi.Input<string>;
    archiveBlocks?: pulumi.Input<pulumi.Input<string>[]>;
    archiveLogs?: pulumi.Input<pulumi.Input<string>[]>;
    avOptimize?: pulumi.Input<string>;
