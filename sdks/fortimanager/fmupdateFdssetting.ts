...
export class FmupdateFdssetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/fmupdateFdssetting:FmupdateFdssetting';
    ...
    public readonly systemSupportFazs!: pulumi.Output<string[]>;
    public readonly systemSupportFcts!: pulumi.Output<string[]>;
    public readonly systemSupportFdcs!: pulumi.Output<string[]>;
    public readonly systemSupportFgts!: pulumi.Output<string[]>;
    public readonly systemSupportFis!: pulumi.Output<string[]>;
    public readonly systemSupportFmls!: pulumi.Output<string[]>;
    public readonly systemSupportFsas!: pulumi.Output<string[]>;
    public readonly systemSupportFsws!: pulumi.Output<string[]>;
    public readonly systemSupportFts!: pulumi.Output<string[]>;
