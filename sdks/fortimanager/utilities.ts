...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("fortimanager");
			params.setVersion("1.12.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ZvcnRpbmV0ZGV2L2ZvcnRpbWFuYWdlciIsInZlcnNpb24iOiIxLjEyLjEifX0="), c => c.charCodeAt(0)));
