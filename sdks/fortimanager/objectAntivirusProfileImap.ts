...
export class ObjectAntivirusProfileImap extends pulumi.CustomResource {
    /**
     * Get an existing ObjectAntivirusProfileImap resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectAntivirusProfileImapState, opts?: pulumi.CustomResourceOptions): ObjectAntivirusProfileImap {
        return new ObjectAntivirusProfileImap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectAntivirusProfileImap:ObjectAntivirusProfileImap';

    /**
     * Returns true if the given object is an instance of ObjectAntivirusProfileImap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectAntivirusProfileImap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectAntivirusProfileImap.__pulumiType;
    }
    ...
    /**
     * Create a ObjectAntivirusProfileImap resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectAntivirusProfileImapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectAntivirusProfileImapArgs | ObjectAntivirusProfileImapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectAntivirusProfileImapState | undefined;
            ...
            const args = argsOrState as ObjectAntivirusProfileImapArgs | undefined;
        ...
        super(ObjectAntivirusProfileImap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectAntivirusProfileImap resources.
 */
export interface ObjectAntivirusProfileImapState {
...
/**
 * The set of arguments for constructing a ObjectAntivirusProfileImap resource.
 */
export interface ObjectAntivirusProfileImapArgs {
    adom?: pulumi.Input<string>;
    archiveBlocks?: pulumi.Input<pulumi.Input<string>[]>;
    archiveLogs?: pulumi.Input<pulumi.Input<string>[]>;
    avScan?: pulumi.Input<string>;
