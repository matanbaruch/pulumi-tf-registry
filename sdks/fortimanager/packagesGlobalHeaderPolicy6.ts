...
export class PackagesGlobalHeaderPolicy6 extends pulumi.CustomResource {
    /**
     * Get an existing PackagesGlobalHeaderPolicy6 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesGlobalHeaderPolicy6State, opts?: pulumi.CustomResourceOptions): PackagesGlobalHeaderPolicy6 {
        return new PackagesGlobalHeaderPolicy6(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesGlobalHeaderPolicy6:PackagesGlobalHeaderPolicy6';

    /**
     * Returns true if the given object is an instance of PackagesGlobalHeaderPolicy6.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesGlobalHeaderPolicy6 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesGlobalHeaderPolicy6.__pulumiType;
    }
    ...
    /**
     * Create a PackagesGlobalHeaderPolicy6 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesGlobalHeaderPolicy6Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesGlobalHeaderPolicy6Args | PackagesGlobalHeaderPolicy6State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesGlobalHeaderPolicy6State | undefined;
            ...
            const args = argsOrState as PackagesGlobalHeaderPolicy6Args | undefined;
        ...
        super(PackagesGlobalHeaderPolicy6.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesGlobalHeaderPolicy6 resources.
 */
export interface PackagesGlobalHeaderPolicy6State {
...
/**
 * The set of arguments for constructing a PackagesGlobalHeaderPolicy6 resource.
 */
export interface PackagesGlobalHeaderPolicy6Args {
    _policyBlock?: pulumi.Input<number>;
    action?: pulumi.Input<string>;
    antiReplay?: pulumi.Input<string>;
    appCategory?: pulumi.Input<string>;
