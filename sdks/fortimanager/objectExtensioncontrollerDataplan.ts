...
export class ObjectExtensioncontrollerDataplan extends pulumi.CustomResource {
    /**
     * Get an existing ObjectExtensioncontrollerDataplan resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectExtensioncontrollerDataplanState, opts?: pulumi.CustomResourceOptions): ObjectExtensioncontrollerDataplan {
        return new ObjectExtensioncontrollerDataplan(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectExtensioncontrollerDataplan:ObjectExtensioncontrollerDataplan';

    /**
     * Returns true if the given object is an instance of ObjectExtensioncontrollerDataplan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectExtensioncontrollerDataplan {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectExtensioncontrollerDataplan.__pulumiType;
    }
    ...
    public readonly preferredSubnet!: pulumi.Output<number | undefined>;
    ...
    /**
     * Create a ObjectExtensioncontrollerDataplan resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ObjectExtensioncontrollerDataplanArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectExtensioncontrollerDataplanArgs | ObjectExtensioncontrollerDataplanState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectExtensioncontrollerDataplanState | undefined;
            ...
            const args = argsOrState as ObjectExtensioncontrollerDataplanArgs | undefined;
        ...
        super(ObjectExtensioncontrollerDataplan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectExtensioncontrollerDataplan resources.
 */
export interface ObjectExtensioncontrollerDataplanState {
...
/**
 * The set of arguments for constructing a ObjectExtensioncontrollerDataplan resource.
 */
export interface ObjectExtensioncontrollerDataplanArgs {
    adom?: pulumi.Input<string>;
    apn?: pulumi.Input<string>;
    authType?: pulumi.Input<string>;
    billingDate?: pulumi.Input<number>;
