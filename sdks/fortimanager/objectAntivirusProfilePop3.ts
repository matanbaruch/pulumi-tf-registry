...
export class ObjectAntivirusProfilePop3 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectAntivirusProfilePop3 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectAntivirusProfilePop3State, opts?: pulumi.CustomResourceOptions): ObjectAntivirusProfilePop3 {
        return new ObjectAntivirusProfilePop3(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectAntivirusProfilePop3:ObjectAntivirusProfilePop3';

    /**
     * Returns true if the given object is an instance of ObjectAntivirusProfilePop3.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectAntivirusProfilePop3 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectAntivirusProfilePop3.__pulumiType;
    }
    ...
    /**
     * Create a ObjectAntivirusProfilePop3 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectAntivirusProfilePop3Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectAntivirusProfilePop3Args | ObjectAntivirusProfilePop3State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectAntivirusProfilePop3State | undefined;
            ...
            const args = argsOrState as ObjectAntivirusProfilePop3Args | undefined;
        ...
        super(ObjectAntivirusProfilePop3.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectAntivirusProfilePop3 resources.
 */
export interface ObjectAntivirusProfilePop3State {
...
/**
 * The set of arguments for constructing a ObjectAntivirusProfilePop3 resource.
 */
export interface ObjectAntivirusProfilePop3Args {
    adom?: pulumi.Input<string>;
    archiveBlocks?: pulumi.Input<pulumi.Input<string>[]>;
    archiveLogs?: pulumi.Input<pulumi.Input<string>[]>;
    avScan?: pulumi.Input<string>;
