...
export class ObjectFirewallProfileprotocoloptionsImap extends pulumi.CustomResource {
    /**
     * Get an existing ObjectFirewallProfileprotocoloptionsImap resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectFirewallProfileprotocoloptionsImapState, opts?: pulumi.CustomResourceOptions): ObjectFirewallProfileprotocoloptionsImap {
        return new ObjectFirewallProfileprotocoloptionsImap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectFirewallProfileprotocoloptionsImap:ObjectFirewallProfileprotocoloptionsImap';

    /**
     * Returns true if the given object is an instance of ObjectFirewallProfileprotocoloptionsImap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectFirewallProfileprotocoloptionsImap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectFirewallProfileprotocoloptionsImap.__pulumiType;
    }
    ...
    /**
     * Create a ObjectFirewallProfileprotocoloptionsImap resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectFirewallProfileprotocoloptionsImapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectFirewallProfileprotocoloptionsImapArgs | ObjectFirewallProfileprotocoloptionsImapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectFirewallProfileprotocoloptionsImapState | undefined;
            ...
            const args = argsOrState as ObjectFirewallProfileprotocoloptionsImapArgs | undefined;
        ...
        super(ObjectFirewallProfileprotocoloptionsImap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectFirewallProfileprotocoloptionsImap resources.
 */
export interface ObjectFirewallProfileprotocoloptionsImapState {
...
/**
 * The set of arguments for constructing a ObjectFirewallProfileprotocoloptionsImap resource.
 */
export interface ObjectFirewallProfileprotocoloptionsImapArgs {
    adom?: pulumi.Input<string>;
    inspectAll?: pulumi.Input<string>;
    options?: pulumi.Input<pulumi.Input<string>[]>;
    oversizeLimit?: pulumi.Input<number>;
