...
export class ObjectExtensioncontrollerExtenderprofileCellularModem2 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectExtensioncontrollerExtenderprofileCellularModem2 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectExtensioncontrollerExtenderprofileCellularModem2State, opts?: pulumi.CustomResourceOptions): ObjectExtensioncontrollerExtenderprofileCellularModem2 {
        return new ObjectExtensioncontrollerExtenderprofileCellularModem2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectExtensioncontrollerExtenderprofileCellularModem2:ObjectExtensioncontrollerExtenderprofileCellularModem2';

    /**
     * Returns true if the given object is an instance of ObjectExtensioncontrollerExtenderprofileCellularModem2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectExtensioncontrollerExtenderprofileCellularModem2 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectExtensioncontrollerExtenderprofileCellularModem2.__pulumiType;
    }

    public readonly adom!: pulumi.Output<string | undefined>;
    public readonly autoSwitch!: pulumi.Output<outputs.ObjectExtensioncontrollerExtenderprofileCellularModem2AutoSwitch | undefined>;
    ...
    /**
     * Create a ObjectExtensioncontrollerExtenderprofileCellularModem2 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectExtensioncontrollerExtenderprofileCellularModem2Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectExtensioncontrollerExtenderprofileCellularModem2Args | ObjectExtensioncontrollerExtenderprofileCellularModem2State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectExtensioncontrollerExtenderprofileCellularModem2State | undefined;
            ...
            const args = argsOrState as ObjectExtensioncontrollerExtenderprofileCellularModem2Args | undefined;
        ...
        super(ObjectExtensioncontrollerExtenderprofileCellularModem2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectExtensioncontrollerExtenderprofileCellularModem2 resources.
 */
export interface ObjectExtensioncontrollerExtenderprofileCellularModem2State {
...
/**
 * The set of arguments for constructing a ObjectExtensioncontrollerExtenderprofileCellularModem2 resource.
 */
export interface ObjectExtensioncontrollerExtenderprofileCellularModem2Args {
    adom?: pulumi.Input<string>;
    autoSwitch?: pulumi.Input<inputs.ObjectExtensioncontrollerExtenderprofileCellularModem2AutoSwitch>;
    connStatus?: pulumi.Input<number>;
    defaultSim?: pulumi.Input<string>;
