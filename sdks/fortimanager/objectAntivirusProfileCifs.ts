...
export class ObjectAntivirusProfileCifs extends pulumi.CustomResource {
    /**
     * Get an existing ObjectAntivirusProfileCifs resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectAntivirusProfileCifsState, opts?: pulumi.CustomResourceOptions): ObjectAntivirusProfileCifs {
        return new ObjectAntivirusProfileCifs(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectAntivirusProfileCifs:ObjectAntivirusProfileCifs';

    /**
     * Returns true if the given object is an instance of ObjectAntivirusProfileCifs.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectAntivirusProfileCifs {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectAntivirusProfileCifs.__pulumiType;
    }
    ...
    /**
     * Create a ObjectAntivirusProfileCifs resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectAntivirusProfileCifsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectAntivirusProfileCifsArgs | ObjectAntivirusProfileCifsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectAntivirusProfileCifsState | undefined;
            ...
            const args = argsOrState as ObjectAntivirusProfileCifsArgs | undefined;
        ...
        super(ObjectAntivirusProfileCifs.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectAntivirusProfileCifs resources.
 */
export interface ObjectAntivirusProfileCifsState {
...
/**
 * The set of arguments for constructing a ObjectAntivirusProfileCifs resource.
 */
export interface ObjectAntivirusProfileCifsArgs {
    adom?: pulumi.Input<string>;
    archiveBlocks?: pulumi.Input<pulumi.Input<string>[]>;
    archiveLogs?: pulumi.Input<pulumi.Input<string>[]>;
    avScan?: pulumi.Input<string>;
