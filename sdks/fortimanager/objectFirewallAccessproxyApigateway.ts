...
export class ObjectFirewallAccessproxyApigateway extends pulumi.CustomResource {
    /**
     * Get an existing ObjectFirewallAccessproxyApigateway resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectFirewallAccessproxyApigatewayState, opts?: pulumi.CustomResourceOptions): ObjectFirewallAccessproxyApigateway {
        return new ObjectFirewallAccessproxyApigateway(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectFirewallAccessproxyApigateway:ObjectFirewallAccessproxyApigateway';

    /**
     * Returns true if the given object is an instance of ObjectFirewallAccessproxyApigateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectFirewallAccessproxyApigateway {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectFirewallAccessproxyApigateway.__pulumiType;
    }
    ...
    public readonly quic!: pulumi.Output<outputs.ObjectFirewallAccessproxyApigatewayQuic | undefined>;
    public readonly realservers!: pulumi.Output<outputs.ObjectFirewallAccessproxyApigatewayRealserver[] | undefined>;
    ...
    public readonly sslCipherSuites!: pulumi.Output<outputs.ObjectFirewallAccessproxyApigatewaySslCipherSuite[] | undefined>;
    ...
    /**
     * Create a ObjectFirewallAccessproxyApigateway resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectFirewallAccessproxyApigatewayArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectFirewallAccessproxyApigatewayArgs | ObjectFirewallAccessproxyApigatewayState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectFirewallAccessproxyApigatewayState | undefined;
            ...
            const args = argsOrState as ObjectFirewallAccessproxyApigatewayArgs | undefined;
        ...
        super(ObjectFirewallAccessproxyApigateway.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectFirewallAccessproxyApigateway resources.
 */
export interface ObjectFirewallAccessproxyApigatewayState {
...
/**
 * The set of arguments for constructing a ObjectFirewallAccessproxyApigateway resource.
 */
export interface ObjectFirewallAccessproxyApigatewayArgs {
    accessProxy: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    applications?: pulumi.Input<pulumi.Input<string>[]>;
    dynamicSortSubtable?: pulumi.Input<string>;
