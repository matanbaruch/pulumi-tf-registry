...
export class ObjectFirewallSslsshprofileSsl extends pulumi.CustomResource {
    /**
     * Get an existing ObjectFirewallSslsshprofileSsl resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectFirewallSslsshprofileSslState, opts?: pulumi.CustomResourceOptions): ObjectFirewallSslsshprofileSsl {
        return new ObjectFirewallSslsshprofileSsl(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectFirewallSslsshprofileSsl:ObjectFirewallSslsshprofileSsl';

    /**
     * Returns true if the given object is an instance of ObjectFirewallSslsshprofileSsl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectFirewallSslsshprofileSsl {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectFirewallSslsshprofileSsl.__pulumiType;
    }
    ...
    public readonly certValidationFailure!: pulumi.Output<string | undefined>;
    public readonly certValidationTimeout!: pulumi.Output<string | undefined>;
    ...
    public readonly expiredServerCert!: pulumi.Output<string | undefined>;
    ...
    public readonly revokedServerCert!: pulumi.Output<string | undefined>;
    ...
    public readonly untrustedServerCert!: pulumi.Output<string | undefined>;

    /**
     * Create a ObjectFirewallSslsshprofileSsl resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectFirewallSslsshprofileSslArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectFirewallSslsshprofileSslArgs | ObjectFirewallSslsshprofileSslState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectFirewallSslsshprofileSslState | undefined;
            ...
            const args = argsOrState as ObjectFirewallSslsshprofileSslArgs | undefined;
        ...
        super(ObjectFirewallSslsshprofileSsl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectFirewallSslsshprofileSsl resources.
 */
export interface ObjectFirewallSslsshprofileSslState {
...
/**
 * The set of arguments for constructing a ObjectFirewallSslsshprofileSsl resource.
 */
export interface ObjectFirewallSslsshprofileSslArgs {
    adom?: pulumi.Input<string>;
    allowInvalidServerCert?: pulumi.Input<string>;
    certProbeFailure?: pulumi.Input<string>;
    certValidationFailure?: pulumi.Input<string>;
