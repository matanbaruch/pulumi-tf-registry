...
export class ObjectFirewallSslsshprofileImaps extends pulumi.CustomResource {
    /**
     * Get an existing ObjectFirewallSslsshprofileImaps resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectFirewallSslsshprofileImapsState, opts?: pulumi.CustomResourceOptions): ObjectFirewallSslsshprofileImaps {
        return new ObjectFirewallSslsshprofileImaps(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectFirewallSslsshprofileImaps:ObjectFirewallSslsshprofileImaps';

    /**
     * Returns true if the given object is an instance of ObjectFirewallSslsshprofileImaps.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectFirewallSslsshprofileImaps {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectFirewallSslsshprofileImaps.__pulumiType;
    }
    ...
    /**
     * Create a ObjectFirewallSslsshprofileImaps resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectFirewallSslsshprofileImapsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectFirewallSslsshprofileImapsArgs | ObjectFirewallSslsshprofileImapsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectFirewallSslsshprofileImapsState | undefined;
            ...
            const args = argsOrState as ObjectFirewallSslsshprofileImapsArgs | undefined;
        ...
        super(ObjectFirewallSslsshprofileImaps.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectFirewallSslsshprofileImaps resources.
 */
export interface ObjectFirewallSslsshprofileImapsState {
...
/**
 * The set of arguments for constructing a ObjectFirewallSslsshprofileImaps resource.
 */
export interface ObjectFirewallSslsshprofileImapsArgs {
    adom?: pulumi.Input<string>;
    allowInvalidServerCert?: pulumi.Input<string>;
    certValidationFailure?: pulumi.Input<string>;
    certValidationTimeout?: pulumi.Input<string>;
