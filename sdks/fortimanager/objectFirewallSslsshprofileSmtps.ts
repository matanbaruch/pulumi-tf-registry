...
export class ObjectFirewallSslsshprofileSmtps extends pulumi.CustomResource {
    /**
     * Get an existing ObjectFirewallSslsshprofileSmtps resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectFirewallSslsshprofileSmtpsState, opts?: pulumi.CustomResourceOptions): ObjectFirewallSslsshprofileSmtps {
        return new ObjectFirewallSslsshprofileSmtps(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectFirewallSslsshprofileSmtps:ObjectFirewallSslsshprofileSmtps';

    /**
     * Returns true if the given object is an instance of ObjectFirewallSslsshprofileSmtps.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectFirewallSslsshprofileSmtps {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectFirewallSslsshprofileSmtps.__pulumiType;
    }
    ...
    /**
     * Create a ObjectFirewallSslsshprofileSmtps resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectFirewallSslsshprofileSmtpsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectFirewallSslsshprofileSmtpsArgs | ObjectFirewallSslsshprofileSmtpsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectFirewallSslsshprofileSmtpsState | undefined;
            ...
            const args = argsOrState as ObjectFirewallSslsshprofileSmtpsArgs | undefined;
        ...
        super(ObjectFirewallSslsshprofileSmtps.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectFirewallSslsshprofileSmtps resources.
 */
export interface ObjectFirewallSslsshprofileSmtpsState {
...
/**
 * The set of arguments for constructing a ObjectFirewallSslsshprofileSmtps resource.
 */
export interface ObjectFirewallSslsshprofileSmtpsArgs {
    adom?: pulumi.Input<string>;
    allowInvalidServerCert?: pulumi.Input<string>;
    certValidationFailure?: pulumi.Input<string>;
    certValidationTimeout?: pulumi.Input<string>;
