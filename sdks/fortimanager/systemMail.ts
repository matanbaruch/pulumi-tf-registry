...
export class SystemMail extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/systemMail:SystemMail';
    ...
    public readonly fromPasswds!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: SystemMailArgs | SystemMailState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["fromPasswds"] = state ? state.fromPasswds : undefined;
            ...
            resourceInputs["fromPasswds"] = args?.fromPasswds ? pulumi.secret(args.fromPasswds) : undefined;
        ...
        const secretOpts = { additionalSecretOutputs: ["fromPasswds", "passwds"] };
...
export interface SystemMailState {
    ...
    fromPasswds?: pulumi.Input<pulumi.Input<string>[]>;
