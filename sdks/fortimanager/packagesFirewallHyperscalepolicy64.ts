...
export class PackagesFirewallHyperscalepolicy64 extends pulumi.CustomResource {
    /**
     * Get an existing PackagesFirewallHyperscalepolicy64 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PackagesFirewallHyperscalepolicy64State, opts?: pulumi.CustomResourceOptions): PackagesFirewallHyperscalepolicy64 {
        return new PackagesFirewallHyperscalepolicy64(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/packagesFirewallHyperscalepolicy64:PackagesFirewallHyperscalepolicy64';

    /**
     * Returns true if the given object is an instance of PackagesFirewallHyperscalepolicy64.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PackagesFirewallHyperscalepolicy64 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PackagesFirewallHyperscalepolicy64.__pulumiType;
    }
    ...
    /**
     * Create a PackagesFirewallHyperscalepolicy64 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PackagesFirewallHyperscalepolicy64Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PackagesFirewallHyperscalepolicy64Args | PackagesFirewallHyperscalepolicy64State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PackagesFirewallHyperscalepolicy64State | undefined;
            ...
            const args = argsOrState as PackagesFirewallHyperscalepolicy64Args | undefined;
        ...
        super(PackagesFirewallHyperscalepolicy64.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PackagesFirewallHyperscalepolicy64 resources.
 */
export interface PackagesFirewallHyperscalepolicy64State {
...
/**
 * The set of arguments for constructing a PackagesFirewallHyperscalepolicy64 resource.
 */
export interface PackagesFirewallHyperscalepolicy64Args {
    action?: pulumi.Input<string>;
    adom?: pulumi.Input<string>;
    cgnEif?: pulumi.Input<string>;
    cgnEim?: pulumi.Input<string>;
