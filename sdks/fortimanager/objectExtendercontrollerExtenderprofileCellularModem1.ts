...
export class ObjectExtendercontrollerExtenderprofileCellularModem1 extends pulumi.CustomResource {
    /**
     * Get an existing ObjectExtendercontrollerExtenderprofileCellularModem1 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectExtendercontrollerExtenderprofileCellularModem1State, opts?: pulumi.CustomResourceOptions): ObjectExtendercontrollerExtenderprofileCellularModem1 {
        return new ObjectExtendercontrollerExtenderprofileCellularModem1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortimanager:index/objectExtendercontrollerExtenderprofileCellularModem1:ObjectExtendercontrollerExtenderprofileCellularModem1';

    /**
     * Returns true if the given object is an instance of ObjectExtendercontrollerExtenderprofileCellularModem1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectExtendercontrollerExtenderprofileCellularModem1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectExtendercontrollerExtenderprofileCellularModem1.__pulumiType;
    }

    public readonly adom!: pulumi.Output<string | undefined>;
    public readonly autoSwitch!: pulumi.Output<outputs.ObjectExtendercontrollerExtenderprofileCellularModem1AutoSwitch | undefined>;
    ...
    /**
     * Create a ObjectExtendercontrollerExtenderprofileCellularModem1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObjectExtendercontrollerExtenderprofileCellularModem1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ObjectExtendercontrollerExtenderprofileCellularModem1Args | ObjectExtendercontrollerExtenderprofileCellularModem1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ObjectExtendercontrollerExtenderprofileCellularModem1State | undefined;
            ...
            const args = argsOrState as ObjectExtendercontrollerExtenderprofileCellularModem1Args | undefined;
        ...
        super(ObjectExtendercontrollerExtenderprofileCellularModem1.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ObjectExtendercontrollerExtenderprofileCellularModem1 resources.
 */
export interface ObjectExtendercontrollerExtenderprofileCellularModem1State {
...
/**
 * The set of arguments for constructing a ObjectExtendercontrollerExtenderprofileCellularModem1 resource.
 */
export interface ObjectExtendercontrollerExtenderprofileCellularModem1Args {
    adom?: pulumi.Input<string>;
    autoSwitch?: pulumi.Input<inputs.ObjectExtendercontrollerExtenderprofileCellularModem1AutoSwitch>;
    connStatus?: pulumi.Input<number>;
    defaultSim?: pulumi.Input<string>;
