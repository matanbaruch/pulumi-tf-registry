...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("dsm");
			params.setVersion("0.5.32");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2ZvcnRhbml4L2RzbSIsInZlcnNpb24iOiIwLjUuMzIifX0="), c => c.charCodeAt(0)));
