...
export class AlertChannelWebhook extends pulumi.CustomResource {
    /**
     * Get an existing AlertChannelWebhook resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertChannelWebhookState, opts?: pulumi.CustomResourceOptions): AlertChannelWebhook {
        return new AlertChannelWebhook(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lacework:index/alertChannelWebhook:AlertChannelWebhook';

    /**
     * Returns true if the given object is an instance of AlertChannelWebhook.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AlertChannelWebhook {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AlertChannelWebhook.__pulumiType;
    }
    ...
    /**
     * Create a AlertChannelWebhook resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AlertChannelWebhookArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AlertChannelWebhookArgs | AlertChannelWebhookState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AlertChannelWebhookState | undefined;
            ...
            const args = argsOrState as AlertChannelWebhookArgs | undefined;
        ...
        super(AlertChannelWebhook.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AlertChannelWebhook resources.
 */
export interface AlertChannelWebhookState {
...
/**
 * The set of arguments for constructing a AlertChannelWebhook resource.
 */
export interface AlertChannelWebhookArgs {
    /**
     * The state of the external integration
     */
    enabled?: pulumi.Input<boolean>;
