...
export class AlertChannelJiraServer extends pulumi.CustomResource {
    /**
     * Get an existing AlertChannelJiraServer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertChannelJiraServerState, opts?: pulumi.CustomResourceOptions): AlertChannelJiraServer {
        return new AlertChannelJiraServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lacework:index/alertChannelJiraServer:AlertChannelJiraServer';

    /**
     * Returns true if the given object is an instance of AlertChannelJiraServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AlertChannelJiraServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AlertChannelJiraServer.__pulumiType;
    }
    ...
    /**
     * Create a AlertChannelJiraServer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AlertChannelJiraServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AlertChannelJiraServerArgs | AlertChannelJiraServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AlertChannelJiraServerState | undefined;
            ...
            const args = argsOrState as AlertChannelJiraServerArgs | undefined;
        ...
        super(AlertChannelJiraServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AlertChannelJiraServer resources.
 */
export interface AlertChannelJiraServerState {
    /**
     * Whether the integration is Unidirectional or Bidirectional. Defaults to Unidirectional
     */
...
/**
 * The set of arguments for constructing a AlertChannelJiraServer resource.
 */
export interface AlertChannelJiraServerArgs {
    /**
     * Whether the integration is Unidirectional or Bidirectional. Defaults to Unidirectional
     */
    configuration?: pulumi.Input<string>;
