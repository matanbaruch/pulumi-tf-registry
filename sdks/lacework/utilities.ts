...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("lacework");
			params.setVersion("1.19.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2xhY2V3b3JrL2xhY2V3b3JrIiwidmVyc2lvbiI6IjEuMTkuMSJ9fQ=="), c => c.charCodeAt(0)));
