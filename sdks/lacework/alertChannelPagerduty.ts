...
export class AlertChannelPagerduty extends pulumi.CustomResource {
    /**
     * Get an existing AlertChannelPagerduty resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertChannelPagerdutyState, opts?: pulumi.CustomResourceOptions): AlertChannelPagerduty {
        return new AlertChannelPagerduty(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lacework:index/alertChannelPagerduty:AlertChannelPagerduty';

    /**
     * Returns true if the given object is an instance of AlertChannelPagerduty.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AlertChannelPagerduty {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AlertChannelPagerduty.__pulumiType;
    }
    ...
    /**
     * Create a AlertChannelPagerduty resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AlertChannelPagerdutyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AlertChannelPagerdutyArgs | AlertChannelPagerdutyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AlertChannelPagerdutyState | undefined;
            ...
            const args = argsOrState as AlertChannelPagerdutyArgs | undefined;
        ...
        super(AlertChannelPagerduty.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AlertChannelPagerduty resources.
 */
export interface AlertChannelPagerdutyState {
...
/**
 * The set of arguments for constructing a AlertChannelPagerduty resource.
 */
export interface AlertChannelPagerdutyArgs {
    /**
     * The state of the external integration
     */
    enabled?: pulumi.Input<boolean>;
