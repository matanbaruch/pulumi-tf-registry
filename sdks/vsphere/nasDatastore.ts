...
export class NasDatastore extends pulumi.CustomResource {
    ...
    /**
     * Indicates that this NAS volume is a protocol endpoint. This field is only populated if the host supports virtual
     * datastores.
     */
    public /*out*/ readonly protocolEndpoint!: pulumi.Output<boolean>;
    /**
     * The hostnames or IP addresses of the remote server or servers. Only one element should be present for NFS v3 but
     * multiple can be present for NFS v4.1.
     */
    ...
    constructor(name: string, argsOrState?: NasDatastoreArgs | NasDatastoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NasDatastore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
