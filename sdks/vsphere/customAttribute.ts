...
export class CustomAttribute extends pulumi.CustomResource {
    ...
    /**
     * Object type for which the custom attribute is valid. If not specified, the attribute is valid for all managed object
     * types.
     */
    ...
    constructor(name: string, argsOrState?: CustomAttributeArgs | CustomAttributeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CustomAttribute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
