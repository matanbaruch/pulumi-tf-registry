...
export class ContentLibrary extends pulumi.CustomResource {
     ...
     */
    public readonly publication!: pulumi.Output<outputs.ContentLibraryPublication | undefined>;
    /**
     * The name of the content library.
     */
    ...
    constructor(name: string, argsOrState?: ContentLibraryArgs | ContentLibraryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ContentLibrary.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
