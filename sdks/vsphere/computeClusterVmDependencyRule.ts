...
export class ComputeClusterVmDependencyRule extends pulumi.CustomResource {
    ...
    /**
     * The name of the VM group that this rule depends on. The VMs defined in the group specified by vm_group_name will not be
     * started until the VMs in this group are started.
     */
    ...
    /**
     * The name of the VM group that is the subject of this rule. The VMs defined in this group will not be started until the
     * VMs in the group specified by dependency_vm_group_name are started.
     */
    ...
    constructor(name: string, argsOrState?: ComputeClusterVmDependencyRuleArgs | ComputeClusterVmDependencyRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ComputeClusterVmDependencyRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
