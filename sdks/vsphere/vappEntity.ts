...
export class VappEntity extends pulumi.CustomResource {
    ...
    /**
     * How to start the entity. Valid settings are none or powerOn. If set to none, then the entity does not participate in
     * auto-start.
     */
    ...
    /**
     * Defines the stop action for the entity. Can be set to none, powerOff, guestShutdown, or suspend. If set to none, then
    ...
    constructor(name: string, argsOrState?: VappEntityArgs | VappEntityState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VappEntity.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
