...
Object.defineProperty(exports, "clientDebug", {
    get() {
        return __config.getObject<boolean>("clientDebug");
    },
    enumerable: true,
});
...
Object.defineProperty(exports, "clientDebugPath", {
    get() {
        return __config.get("clientDebugPath");
    },
    enumerable: true,
});
...
Object.defineProperty(exports, "clientDebugPathRun", {
    get() {
        return __config.get("clientDebugPathRun");
    },
    enumerable: true,
});
...
Object.defineProperty(exports, "persistSession", {
    get() {
        return __config.getObject<boolean>("persistSession");
    },
    enumerable: true,
});
...
Object.defineProperty(exports, "restSessionPath", {
    get() {
        return __config.get("restSessionPath");
    },
    enumerable: true,
});
...
Object.defineProperty(exports, "vimKeepAlive", {
    get() {
        return __config.getObject<number>("vimKeepAlive");
    },
    enumerable: true,
});
...
Object.defineProperty(exports, "vimSessionPath", {
    get() {
        return __config.get("vimSessionPath");
    },
    enumerable: true,
});
