...
export class DrsVmOverride extends pulumi.CustomResource {
    ...
    /**
     * The automation level for this virtual machine in the cluster. Can be one of manual, partiallyAutomated, or
     * fullyAutomated.
     */
    ...
    constructor(name: string, argsOrState?: DrsVmOverrideArgs | DrsVmOverrideState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DrsVmOverride.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
