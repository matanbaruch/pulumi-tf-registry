...
export class DistributedPortGroup extends pulumi.CustomResource {
     ...
     * The VLAN ID for single VLAN mode. 0 denotes no VLAN.
     */
    public readonly vlanRanges!: pulumi.Output<outputs.DistributedPortGroupVlanRange[] | undefined>;
    ...
    constructor(name: string, argsOrState?: DistributedPortGroupArgs | DistributedPortGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DistributedPortGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
