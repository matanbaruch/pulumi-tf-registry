...
export class HostPortGroup extends pulumi.CustomResource {
    ...
    /**
     * The effective network policy after inheritance. Note that this will look similar to, but is not the same, as the policy
    ...
    /**
     * The VLAN ID/trunk mode for this port group. An ID of 0 denotes no tagging, an ID of 1-4094 tags with the specific ID,
     * and an ID of 4095 enables trunk mode, allowing the guest to manage its own tagging.
     */
    ...
    constructor(name: string, argsOrState?: HostPortGroupArgs | HostPortGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(HostPortGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
