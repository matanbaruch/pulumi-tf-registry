...
export class DistributedVirtualSwitch extends pulumi.CustomResource {
    ...
    /**
     * The version of this virtual switch. Allowed versions are 8.0.0, 7.0.3, 7.0.2, 7.0.0, 6.6.0, 6.5.0, 6.0.0, 5.5.0, 5.1.0,
     * and 5.0.0.
     */
     ...
     * The VLAN ID for single VLAN mode. 0 denotes no VLAN.
     */
    public readonly vlanRanges!: pulumi.Output<outputs.DistributedVirtualSwitchVlanRange[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DistributedVirtualSwitchArgs | DistributedVirtualSwitchState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DistributedVirtualSwitch.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
