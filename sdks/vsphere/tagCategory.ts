...
export class TagCategory extends pulumi.CustomResource {
     ...
     * Datacenter, Datastore, StoragePod, DistributedVirtualPortgroup, DistributedVirtualSwitch,
     * VmwareDistributedVirtualSwitch, HostSystem, com.vmware.content.Library, com.vmware.content.library.Item, HostNetwork,
     * Network, OpaqueNetwork, ResourcePool, VirtualApp, VirtualMachine.
     */
    public readonly associableTypes!: pulumi.Output<string[]>;
    /**
     * The associated cardinality of the category. Can be one of SINGLE (object can only be assigned one tag in this category)
     * or MULTIPLE (object can be assigned multiple tags in this category).
     */
    ...
    constructor(name: string, argsOrState?: TagCategoryArgs | TagCategoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TagCategory.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
