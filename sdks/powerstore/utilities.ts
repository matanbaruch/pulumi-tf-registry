...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("powerstore");
			params.setVersion("1.1.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2RlbGwvcG93ZXJzdG9yZSIsInZlcnNpb24iOiIxLjEuMyJ9fQ=="), c => c.charCodeAt(0)));
