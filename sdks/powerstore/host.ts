...
export class Host extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'powerstore:index/host:Host';
     ...
     */
    public readonly hostConnectivity!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly initiators!: pulumi.Output<outputs.HostInitiator[]>;
    /**
    ...
    constructor(name: string, argsOrState?: HostArgs | HostState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["hostConnectivity"] = state ? state.hostConnectivity : undefined;
            ...
            resourceInputs["hostConnectivity"] = args ? args.hostConnectivity : undefined;
...
export interface HostState {
     ...
     * Connectivity type for hosts and host groups.
     */
    hostConnectivity?: pulumi.Input<string>;
    /**
     * Associated host group, if host is part of host group.
     */
     ...
     * Parameters for creating or adding initiators to host.
     */
    initiators?: pulumi.Input<pulumi.Input<inputs.HostInitiator>[]>;
    /**
     * Name of the host. This should be unique across all hosts in the cluster.
     */
