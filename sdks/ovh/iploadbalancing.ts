...
export class Iploadbalancing extends pulumi.CustomResource {
     ...
     */
    public readonly orders!: pulumi.Output<outputs.IploadbalancingOrder[] | undefined>;
    /**
     * Ovh Subsidiary
     */
    ...
    constructor(name: string, argsOrState?: IploadbalancingArgs | IploadbalancingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Iploadbalancing.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
