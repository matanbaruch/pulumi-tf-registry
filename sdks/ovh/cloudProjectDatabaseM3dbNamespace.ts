...
export class CloudProjectDatabaseM3dbNamespace extends pulumi.CustomResource {
    /**
     * Get an existing CloudProjectDatabaseM3dbNamespace resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudProjectDatabaseM3dbNamespaceState, opts?: pulumi.CustomResourceOptions): CloudProjectDatabaseM3dbNamespace {
        return new CloudProjectDatabaseM3dbNamespace(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ovh:index/cloudProjectDatabaseM3dbNamespace:CloudProjectDatabaseM3dbNamespace';

    /**
     * Returns true if the given object is an instance of CloudProjectDatabaseM3dbNamespace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudProjectDatabaseM3dbNamespace {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudProjectDatabaseM3dbNamespace.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.CloudProjectDatabaseM3dbNamespaceTimeouts | undefined>;
    /**
     * Type of namespace
     */
    ...
    /**
     * Create a CloudProjectDatabaseM3dbNamespace resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudProjectDatabaseM3dbNamespaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudProjectDatabaseM3dbNamespaceArgs | CloudProjectDatabaseM3dbNamespaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudProjectDatabaseM3dbNamespaceState | undefined;
            ...
            const args = argsOrState as CloudProjectDatabaseM3dbNamespaceArgs | undefined;
        ...
        super(CloudProjectDatabaseM3dbNamespace.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface CloudProjectDatabaseM3dbNamespaceState {
    /**
     * Id of the database cluster
     */
    ...
    timeouts?: pulumi.Input<inputs.CloudProjectDatabaseM3dbNamespaceTimeouts>;
    /**
     * Type of namespace
     */
 ...
 */
export interface CloudProjectDatabaseM3dbNamespaceArgs {
    /**
     * Id of the database cluster
     */
    clusterId: pulumi.Input<string>;
