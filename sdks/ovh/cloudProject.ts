...
export class CloudProject extends pulumi.CustomResource {
     ...
     */
    public readonly orders!: pulumi.Output<outputs.CloudProjectOrder[] | undefined>;
    /**
     * Ovh Subsidiary
     */
    ...
    constructor(name: string, argsOrState?: CloudProjectArgs | CloudProjectState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CloudProject.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
