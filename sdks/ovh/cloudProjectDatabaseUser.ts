...
export class CloudProjectDatabaseUser extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CloudProjectDatabaseUserTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CloudProjectDatabaseUserArgs | CloudProjectDatabaseUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CloudProjectDatabaseUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CloudProjectDatabaseUserState {
    ...
    timeouts?: pulumi.Input<inputs.CloudProjectDatabaseUserTimeouts>;
}
