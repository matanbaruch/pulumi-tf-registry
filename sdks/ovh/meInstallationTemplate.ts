...
export class MeInstallationTemplate extends pulumi.CustomResource {
    ...
    public /*out*/ readonly inputs!: pulumi.Output<outputs.MeInstallationTemplateInput[]>;
    /**
    ...
    constructor(name: string, argsOrState?: MeInstallationTemplateArgs | MeInstallationTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MeInstallationTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MeInstallationTemplateState {
    ...
    inputs?: pulumi.Input<pulumi.Input<inputs.MeInstallationTemplateInput>[]>;
    /**
     * Whether this distribution supports Logical Volumes (Linux LVM)
     */
