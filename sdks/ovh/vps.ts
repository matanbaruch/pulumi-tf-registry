...
export class Vps extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ovh:index/vps:Vps';
     ...
     */
    public /*out*/ readonly iam!: pulumi.Output<outputs.VpsIam>;
    /**
     ...
     */
    public readonly model!: pulumi.Output<outputs.VpsModel>;
    /**
     ...
     */
    public /*out*/ readonly order!: pulumi.Output<outputs.VpsOrder>;
    /**
     * OVH subsidiaries
     */
    public readonly ovhSubsidiary!: pulumi.Output<string>;
    public readonly planOptions!: pulumi.Output<outputs.VpsPlanOption[]>;
    public readonly plans!: pulumi.Output<outputs.VpsPlan[]>;
    /**
...
export interface VpsState {
     ...
     * IAM resource metadata
     */
    iam?: pulumi.Input<inputs.VpsIam>;
    /**
     * KVM keyboard layout on VPS Cloud
     */
     ...
     * A structure describing characteristics of a VPS model
     */
    model?: pulumi.Input<inputs.VpsModel>;
    /**
     * Ip blocks for OVH monitoring servers
     */
     ...
     * Details about an Order
     */
    order?: pulumi.Input<inputs.VpsOrder>;
    /**
     * OVH subsidiaries
     */
    ovhSubsidiary?: pulumi.Input<string>;
    planOptions?: pulumi.Input<pulumi.Input<inputs.VpsPlanOption>[]>;
    plans?: pulumi.Input<pulumi.Input<inputs.VpsPlan>[]>;
    /**
     * The internal name of your VPS offer
     */
