...
export class Vrack extends pulumi.CustomResource {
     ...
     */
    public readonly orders!: pulumi.Output<outputs.VrackOrder[] | undefined>;
    /**
     * Ovh Subsidiary
     */
    ...
    constructor(name: string, argsOrState?: VrackArgs | VrackState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Vrack.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
