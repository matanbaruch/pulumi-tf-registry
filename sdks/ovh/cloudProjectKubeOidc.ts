...
export class CloudProjectKubeOidc extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CloudProjectKubeOidcTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CloudProjectKubeOidcArgs | CloudProjectKubeOidcState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CloudProjectKubeOidc.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CloudProjectKubeOidcState {
    ...
    timeouts?: pulumi.Input<inputs.CloudProjectKubeOidcTimeouts>;
}
