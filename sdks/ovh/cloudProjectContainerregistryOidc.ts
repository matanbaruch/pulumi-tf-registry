...
export class CloudProjectContainerregistryOidc extends pulumi.CustomResource {
    /**
     * Get an existing CloudProjectContainerregistryOidc resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudProjectContainerregistryOidcState, opts?: pulumi.CustomResourceOptions): CloudProjectContainerregistryOidc {
        return new CloudProjectContainerregistryOidc(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ovh:index/cloudProjectContainerregistryOidc:CloudProjectContainerregistryOidc';

    /**
     * Returns true if the given object is an instance of CloudProjectContainerregistryOidc.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudProjectContainerregistryOidc {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudProjectContainerregistryOidc.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.CloudProjectContainerregistryOidcTimeouts | undefined>;

    /**
     * Create a CloudProjectContainerregistryOidc resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudProjectContainerregistryOidcArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudProjectContainerregistryOidcArgs | CloudProjectContainerregistryOidcState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudProjectContainerregistryOidcState | undefined;
            ...
            const args = argsOrState as CloudProjectContainerregistryOidcArgs | undefined;
        ...
        super(CloudProjectContainerregistryOidc.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface CloudProjectContainerregistryOidcState {
    ...
    timeouts?: pulumi.Input<inputs.CloudProjectContainerregistryOidcTimeouts>;
}

/**
 * The set of arguments for constructing a CloudProjectContainerregistryOidc resource.
 */
export interface CloudProjectContainerregistryOidcArgs {
    deleteUsers?: pulumi.Input<boolean>;
    oidcAdminGroup?: pulumi.Input<string>;
    oidcAutoOnboard?: pulumi.Input<boolean>;
    oidcClientId: pulumi.Input<string>;
