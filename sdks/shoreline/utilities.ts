...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("shoreline");
			params.setVersion("1.15.13");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Nob3JlbGluZXNvZnR3YXJlL3Nob3JlbGluZSIsInZlcnNpb24iOiIxLjE1LjEzIn19"), c => c.charCodeAt(0)));
