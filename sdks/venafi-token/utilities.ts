...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("venafi-token");
			params.setVersion("0.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ZlbmFmaS92ZW5hZmktdG9rZW4iLCJ2ZXJzaW9uIjoiMC4yLjAifX0="), c => c.charCodeAt(0)));
