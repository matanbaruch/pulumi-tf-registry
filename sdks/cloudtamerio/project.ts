...
export class Project extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudtamerio:index/project:Project';
    ...
    public readonly projectFundings!: pulumi.Output<outputs.ProjectProjectFunding[]>;
    ...
    constructor(name: string, argsOrState?: ProjectArgs | ProjectState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.projectFundings === undefined) && !opts.urn) {
                throw new Error("Missing required property 'projectFundings'");
            }
