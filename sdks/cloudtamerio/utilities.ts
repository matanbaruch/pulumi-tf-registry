...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudtamerio");
			params.setVersion("0.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Nsb3VkdGFtZXItaW8vY2xvdWR0YW1lcmlvIiwidmVyc2lvbiI6IjAuMi4wIn19"), c => c.charCodeAt(0)));
