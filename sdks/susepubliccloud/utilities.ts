...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("susepubliccloud");
			params.setVersion("0.6.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3N1c2Uvc3VzZXB1YmxpY2Nsb3VkIiwidmVyc2lvbiI6IjAuNi4wIn19"), c => c.charCodeAt(0)));
