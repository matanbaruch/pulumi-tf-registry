...
export class VirtualGoRepository extends pulumi.CustomResource {
    /**
     * Get an existing VirtualGoRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualGoRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualGoRepository {
        return new VirtualGoRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualGoRepository:VirtualGoRepository';

    /**
     * Returns true if the given object is an instance of VirtualGoRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualGoRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualGoRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualGoRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualGoRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualGoRepositoryArgs | VirtualGoRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualGoRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualGoRepositoryArgs | undefined;
        ...
        super(VirtualGoRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VirtualGoRepository resources.
 */
export interface VirtualGoRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
...
/**
 * The set of arguments for constructing a VirtualGoRepository resource.
 */
export interface VirtualGoRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
