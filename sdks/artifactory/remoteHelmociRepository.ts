...
export class RemoteHelmociRepository extends pulumi.CustomResource {
    ...
    /**
     * Use this attribute to enter your GCR, GAR Project Id to limit the scope of this remote repo to a specific project in
     * your third-party registry. When leaving this field blank or unset, remote repositories that support project id will
     * default to their default project as you have set up in your account.
     */
    ...
    constructor(name: string, argsOrState?: RemoteHelmociRepositoryArgs | RemoteHelmociRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RemoteHelmociRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
