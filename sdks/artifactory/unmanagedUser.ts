...
export class UnmanagedUser extends pulumi.CustomResource {
    ...
    /**
     * List of groups this user is a part of. **Notes:** If this attribute is not specified then user's group membership is set
     * to empty. User will not be part of default "readers" group automatically.
     */
    ...
    /**
     * Username for user. May contain lowercase letters, numbers and symbols: '.-_@' for self-hosted. For SaaS, '+' is also
     * allowed.
     */
    ...
    constructor(name: string, argsOrState?: UnmanagedUserArgs | UnmanagedUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UnmanagedUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
