...
export class LocalDebianRepository extends pulumi.CustomResource {
    /**
     * Get an existing LocalDebianRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalDebianRepositoryState, opts?: pulumi.CustomResourceOptions): LocalDebianRepository {
        return new LocalDebianRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localDebianRepository:LocalDebianRepository';

    /**
     * Returns true if the given object is an instance of LocalDebianRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalDebianRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalDebianRepository.__pulumiType;
    }
    ...
    /**
     * Create a LocalDebianRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LocalDebianRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalDebianRepositoryArgs | LocalDebianRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalDebianRepositoryState | undefined;
            ...
            const args = argsOrState as LocalDebianRepositoryArgs | undefined;
        ...
        super(LocalDebianRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LocalDebianRepository resources.
 */
export interface LocalDebianRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
...
/**
 * The set of arguments for constructing a LocalDebianRepository resource.
 */
export interface LocalDebianRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
