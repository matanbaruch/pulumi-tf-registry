...
export class LocalRepositorySingleReplication extends pulumi.CustomResource {
    ...
    /**
     * A valid CRON expression that you can use to control replication frequency. Eg: `0 0 12 * * ? *`, `0 0 2 ? * MON-SAT *`.
     * Note: use 6 or 7 parts format - Seconds, Minutes Hours, Day Of Month, Month, Day Of Week, Year (optional). Specifying
     * both a day-of-week AND a day-of-month parameter is not supported. One of them should be replaced by `?`. Incorrect: `*
     * 5,7,9 14/2 * * WED,SAT *`, correct: `* 5,7,9 14/2 ? * WED,SAT *`. See details in [Cron Trigger
    ...
    constructor(name: string, argsOrState?: LocalRepositorySingleReplicationArgs | LocalRepositorySingleReplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LocalRepositorySingleReplication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
