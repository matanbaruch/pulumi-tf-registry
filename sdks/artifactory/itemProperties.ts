...
export class ItemProperties extends pulumi.CustomResource {
    ...
    /**
     * Map of key and list of values. ~>Keys are limited up to 255 characters and values are limited up to 2,400 characters.
     * Using properties with values over this limit might cause backend issues. ~>The following special characters are
     * forbidden in the key field: `)(}{][*+^$/~``!@#%&<>;=,±§` and the space character.
     */
    ...
    constructor(name: string, argsOrState?: ItemPropertiesArgs | ItemPropertiesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ItemProperties.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
