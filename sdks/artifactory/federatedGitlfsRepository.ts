...
export class FederatedGitlfsRepository extends pulumi.CustomResource {
    /**
     * Get an existing FederatedGitlfsRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedGitlfsRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedGitlfsRepository {
        return new FederatedGitlfsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedGitlfsRepository:FederatedGitlfsRepository';

    /**
     * Returns true if the given object is an instance of FederatedGitlfsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedGitlfsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedGitlfsRepository.__pulumiType;
    }
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedGitlfsRepositoryMember[]>;
    /**
    ...
    /**
     * Create a FederatedGitlfsRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FederatedGitlfsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedGitlfsRepositoryArgs | FederatedGitlfsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedGitlfsRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedGitlfsRepositoryArgs | undefined;
        ...
        super(FederatedGitlfsRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering FederatedGitlfsRepository resources.
 */
export interface FederatedGitlfsRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedGitlfsRepositoryMember>[]>;
    /**
     * Internal description.
     */
...
/**
 * The set of arguments for constructing a FederatedGitlfsRepository resource.
 */
export interface FederatedGitlfsRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
