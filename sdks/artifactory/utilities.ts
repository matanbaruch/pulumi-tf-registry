...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("artifactory");
			params.setVersion("11.8.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2pmcm9nL2FydGlmYWN0b3J5IiwidmVyc2lvbiI6IjExLjguMCJ9fQ=="), c => c.charCodeAt(0)));
