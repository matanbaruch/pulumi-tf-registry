...
export class PasswordExpirationPolicy extends pulumi.CustomResource {
    ...
    /**
     * Send mail notification before password expiration. Users will receive an email notification a few days before password
     * will expire. Mail server must be enabled and configured correctly.
     */
    ...
    constructor(name: string, argsOrState?: PasswordExpirationPolicyArgs | PasswordExpirationPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PasswordExpirationPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
