...
export class PackageCleanupPolicy extends pulumi.CustomResource {
    ...
    /**
     * The Cron expression that sets the schedule of policy execution. For example, `0 0 2 * * ?` executes the policy every day
     * at 02:00 AM. The minimum recurrent time for policy execution is 6 hours.
     */
    public readonly cronExpression!: pulumi.Output<string | undefined>;
    public readonly description!: pulumi.Output<string | undefined>;
    /**
     * Enable and select the maximum duration for policy execution. Note: using this setting can cause the policy to stop
     * before completion.
     */
     ...
     * cron expression, then it will be scheduled for execution based on it. If a policy is disabled, its future executions
     * will be unscheduled. Defaults to `true`
     */
    public readonly enabled!: pulumi.Output<boolean>;
    /**
     * Policy key. It has to be unique. It should not be used for other policies and configuration entities like archive
     * policies, key pairs, repo layouts, property sets, backups, proxies, reverse proxies etc.
     */
    public readonly key!: pulumi.Output<string>;
    public readonly searchCriteria!: pulumi.Output<outputs.PackageCleanupPolicySearchCriteria>;
    /**
     * When enabled, deleted packages are permanently removed from Artifactory without an option to restore them. Defaults to
     * `false`
     */
    ...
    constructor(name: string, argsOrState?: PackageCleanupPolicyArgs | PackageCleanupPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PackageCleanupPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
