...
export class LocalDockerV2Repository extends pulumi.CustomResource {
    /**
     * Get an existing LocalDockerV2Repository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalDockerV2RepositoryState, opts?: pulumi.CustomResourceOptions): LocalDockerV2Repository {
        return new LocalDockerV2Repository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localDockerV2Repository:LocalDockerV2Repository';

    /**
     * Returns true if the given object is an instance of LocalDockerV2Repository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalDockerV2Repository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalDockerV2Repository.__pulumiType;
    }
    ...
    /**
     * Create a LocalDockerV2Repository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LocalDockerV2RepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalDockerV2RepositoryArgs | LocalDockerV2RepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalDockerV2RepositoryState | undefined;
            ...
            const args = argsOrState as LocalDockerV2RepositoryArgs | undefined;
        ...
        super(LocalDockerV2Repository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LocalDockerV2Repository resources.
 */
export interface LocalDockerV2RepositoryState {
    /**
     * The Docker API version to use. This cannot be set
     */
...
/**
 * The set of arguments for constructing a LocalDockerV2Repository resource.
 */
export interface LocalDockerV2RepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
