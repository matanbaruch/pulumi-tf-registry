...
export class LocalAlpineRepository extends pulumi.CustomResource {
    /**
     * Get an existing LocalAlpineRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalAlpineRepositoryState, opts?: pulumi.CustomResourceOptions): LocalAlpineRepository {
        return new LocalAlpineRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localAlpineRepository:LocalAlpineRepository';

    /**
     * Returns true if the given object is an instance of LocalAlpineRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalAlpineRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalAlpineRepository.__pulumiType;
    }
    ...
    /**
     * Create a LocalAlpineRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LocalAlpineRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalAlpineRepositoryArgs | LocalAlpineRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalAlpineRepositoryState | undefined;
            ...
            const args = argsOrState as LocalAlpineRepositoryArgs | undefined;
        ...
        super(LocalAlpineRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LocalAlpineRepository resources.
 */
export interface LocalAlpineRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
...
/**
 * The set of arguments for constructing a LocalAlpineRepository resource.
 */
export interface LocalAlpineRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
