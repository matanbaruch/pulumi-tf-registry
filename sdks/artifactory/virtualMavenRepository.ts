...
export class VirtualMavenRepository extends pulumi.CustomResource {
    /**
     * Get an existing VirtualMavenRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualMavenRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualMavenRepository {
        return new VirtualMavenRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualMavenRepository:VirtualMavenRepository';

    /**
     * Returns true if the given object is an instance of VirtualMavenRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualMavenRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualMavenRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualMavenRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualMavenRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualMavenRepositoryArgs | VirtualMavenRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualMavenRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualMavenRepositoryArgs | undefined;
        ...
        super(VirtualMavenRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VirtualMavenRepository resources.
 */
export interface VirtualMavenRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
...
/**
 * The set of arguments for constructing a VirtualMavenRepository resource.
 */
export interface VirtualMavenRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
