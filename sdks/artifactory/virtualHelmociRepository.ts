...
export class VirtualHelmociRepository extends pulumi.CustomResource {
    ...
    /**
     * When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will
    ...
    constructor(name: string, argsOrState?: VirtualHelmociRepositoryArgs | VirtualHelmociRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VirtualHelmociRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
