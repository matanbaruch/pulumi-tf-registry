...
export class DistributionPublicKey extends pulumi.CustomResource {
    ...
    /**
     * The Public key to add as a trusted distribution GPG key. To avoid state drift, ensure there are no leading tab or space
    ...
    constructor(name: string, argsOrState?: DistributionPublicKeyArgs | DistributionPublicKeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DistributionPublicKey.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
