...
export class ReleaseBundleV2 extends pulumi.CustomResource {
    ...
    /**
     * Determines whether to skip the resolution of the Docker manifest, which adds the image layers to the Release Bundle. The
     * default value is `false` (the manifest is resolved and image layers are included).
     */
    public readonly skipDockerManifestResolution!: pulumi.Output<boolean>;
    /**
     * Defines specific repositories to include in the promotion. If this property is left undefined, all repositories (except
     * those specifically excluded) are included in the promotion. Important: If one or more repositories are specifically
     * included, all other repositories are excluded (regardless of what is defined in `excluded_repository_keys`).
     */
    ...
    constructor(name: string, argsOrState?: ReleaseBundleV2Args | ReleaseBundleV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ReleaseBundleV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
