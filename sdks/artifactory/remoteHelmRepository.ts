...
export class RemoteHelmRepository extends pulumi.CustomResource {
     ...
     * URLs matching the index.yamls hostname or URLs starting with this base url. Support http/https/oci protocol scheme.
     */
    ...
    constructor(name: string, argsOrState?: RemoteHelmRepositoryArgs | RemoteHelmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RemoteHelmRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
