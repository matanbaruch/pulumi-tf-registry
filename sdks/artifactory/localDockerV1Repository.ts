...
export class LocalDockerV1Repository extends pulumi.CustomResource {
    /**
     * Get an existing LocalDockerV1Repository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalDockerV1RepositoryState, opts?: pulumi.CustomResourceOptions): LocalDockerV1Repository {
        return new LocalDockerV1Repository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localDockerV1Repository:LocalDockerV1Repository';

    /**
     * Returns true if the given object is an instance of LocalDockerV1Repository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalDockerV1Repository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalDockerV1Repository.__pulumiType;
    }
    ...
    /**
     * Create a LocalDockerV1Repository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LocalDockerV1RepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalDockerV1RepositoryArgs | LocalDockerV1RepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalDockerV1RepositoryState | undefined;
            ...
            const args = argsOrState as LocalDockerV1RepositoryArgs | undefined;
        ...
        super(LocalDockerV1Repository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LocalDockerV1Repository resources.
 */
export interface LocalDockerV1RepositoryState {
...
/**
 * The set of arguments for constructing a LocalDockerV1Repository resource.
 */
export interface LocalDockerV1RepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
