...
export class LocalGitlfsRepository extends pulumi.CustomResource {
    /**
     * Get an existing LocalGitlfsRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalGitlfsRepositoryState, opts?: pulumi.CustomResourceOptions): LocalGitlfsRepository {
        return new LocalGitlfsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localGitlfsRepository:LocalGitlfsRepository';

    /**
     * Returns true if the given object is an instance of LocalGitlfsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalGitlfsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalGitlfsRepository.__pulumiType;
    }
    ...
    /**
     * Create a LocalGitlfsRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LocalGitlfsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalGitlfsRepositoryArgs | LocalGitlfsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalGitlfsRepositoryState | undefined;
            ...
            const args = argsOrState as LocalGitlfsRepositoryArgs | undefined;
        ...
        super(LocalGitlfsRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LocalGitlfsRepository resources.
 */
export interface LocalGitlfsRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
...
/**
 * The set of arguments for constructing a LocalGitlfsRepository resource.
 */
export interface LocalGitlfsRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
