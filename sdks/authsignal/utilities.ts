...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("authsignal");
			params.setVersion("1.3.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2F1dGhzaWduYWwvYXV0aHNpZ25hbCIsInZlcnNpb24iOiIxLjMuMSJ9fQ=="), c => c.charCodeAt(0)));
