...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("netapp-elementsw");
			params.setVersion("20.11.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL25ldGFwcC9uZXRhcHAtZWxlbWVudHN3IiwidmVyc2lvbiI6IjIwLjExLjAifX0="), c => c.charCodeAt(0)));
