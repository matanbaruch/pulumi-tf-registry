...
export class RepositoryFile extends pulumi.CustomResource {
    ...
    /**
     * Enable overwriting existing files, defaults to `false`. This attribute is only used during `create` and must be use
     * carefully. We suggest to use `imports` whenever possible and limit the use of this attribute for when the project was
     * imported on the same `apply`. This attribute is not supported during a resource import.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.RepositoryFileTimeouts | undefined>;
    /**
...
export interface RepositoryFileState {
    ...
    timeouts?: pulumi.Input<inputs.RepositoryFileTimeouts>;
    /**
     * Update commit message.
     */
