...
export class IntegrationTelegram extends pulumi.CustomResource {
    ...
    /**
     * Branches to send notifications for (introduced in GitLab 16.5). Update of this attribute was not supported before Gitlab
     * 16.11 due to API bug. Valid options are `all`, `default`, `protected`, `default_and_protected`.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationTelegramArgs | IntegrationTelegramState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IntegrationTelegram.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
