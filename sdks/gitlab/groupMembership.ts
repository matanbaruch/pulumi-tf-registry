...
export class GroupMembership extends pulumi.CustomResource {
    ...
    /**
     * Whether the deletion of direct memberships of the removed member in subgroups and projects should be skipped. Only used
     * during a destroy.
     */
    public readonly skipSubresourcesOnDestroy!: pulumi.Output<boolean | undefined>;
    /**
     * Whether the removed member should be unassigned from any issues or merge requests inside a given group or project. Only
     * used during a destroy.
     */
