...
export class Group extends pulumi.CustomResource {
    ...
    /**
     * See https://docs.gitlab.com/ee/api/groups.html#options-for-default_branch_protection. Valid values are: `0`, `1`, `2`,
     * `3`, `4`.
     */
    ...
    /**
     * A list of IP addresses or subnet masks to restrict group access. Will be concatenated together into a comma separated
     * string. Only allowed on top level groups.
     */
    ...
    /**
     * Whether the group should be permanently removed during a `delete` operation. This only works with subgroups. Must be
     * configured via an `apply` before the `destroy` is run.
     */
     ...
     */
    public readonly pushRules!: pulumi.Output<outputs.GroupPushRules | undefined>;
    /**
    ...
    /**
     * Can be set by administrators only. Maximum number of monthly CI/CD minutes for this group. Can be nil (default; inherit
     * system default), 0 (unlimited), or > 0.
     */
     ...
     * `disabled_and_overridable`, `disabled_and_unoverridable`, `disabled_with_override`.
     */
    ...
    /**
     * The group's wiki access level. Only available on Premium and Ultimate plans. Valid values are `disabled`, `private`,
     * `enabled`.
     */
