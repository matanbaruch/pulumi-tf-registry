...
export class GroupSamlLink extends pulumi.CustomResource {
    ...
    /**
     * The ID of a custom member role. Only available for Ultimate instances. When using a custom role, the `access_level` must
     * match the base role used to create the custom role.
     */
    ...
    constructor(name: string, argsOrState?: GroupSamlLinkArgs | GroupSamlLinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GroupSamlLink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
