...
export class ProjectApprovalRule extends pulumi.CustomResource {
    ...
    /**
     * Whether the rule is applied to all protected branches. If set to 'true', the value of `protected_branch_ids` is ignored.
     * Default is 'false'.
     */
    ...
    constructor(name: string, argsOrState?: ProjectApprovalRuleArgs | ProjectApprovalRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectApprovalRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
