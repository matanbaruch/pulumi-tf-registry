...
export class GroupAccessToken extends pulumi.CustomResource {
    ...
    /**
     * The access level for the group access token. Valid values are: `no one`, `minimal`, `guest`, `reporter`, `developer`,
     * `maintainer`, `owner`. Default is `maintainer`.
     */
    ...
    /**
     * The scopes of the group access token. Valid values are: `api`, `read_api`, `read_registry`, `write_registry`,
     * `read_repository`, `write_repository`, `create_runner`, `manage_runner`, `ai_features`, `k8s_proxy`,
    ...
    constructor(name: string, argsOrState?: GroupAccessTokenArgs | GroupAccessTokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GroupAccessToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
