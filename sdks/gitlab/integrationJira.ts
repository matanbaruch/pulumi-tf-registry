...
export class IntegrationJira extends pulumi.CustomResource {
     ...
     * project. By default, this ID is set to 2. *Note**: importing this field is only supported since GitLab 15.2.
     */
    ...
    constructor(name: string, argsOrState?: IntegrationJiraArgs | IntegrationJiraState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IntegrationJira.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
