...
export class Application extends pulumi.CustomResource {
    ...
    /**
     * The application is used where the client secret can be kept confidential. Native mobile apps and Single Page Apps are
     * considered non-confidential. Defaults to true if not supplied
     */
    ...
    /**
     * Scopes of the application. Use "openid" if you plan to use this as an oidc authentication application. Valid options
     * are: `api`, `read_api`, `read_user`, `read_repository`, `write_repository`, `read_registry`, `write_registry`, `sudo`,
     * `admin_mode`, `openid`, `profile`, `email`. This is only populated when creating a new application. This attribute is
     * not available for imported resources
     */
    public readonly scopes!: pulumi.Output<string[]>;
    /**
     * Application secret. Sensitive and must be kept secret. This is only populated when creating a new application. This
     * attribute is not available for imported resources.
     */
