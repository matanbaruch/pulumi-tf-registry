...
export class GroupLdapLink extends pulumi.CustomResource {
    ...
    /**
     * If true, then delete and replace an existing LDAP link if one exists. Will also remove an LDAP link if the parent group
     * is not found.
     */
    ...
    /**
     * The name of the LDAP provider as stored in the GitLab database. Note that this is NOT the value of the `label` attribute
     * as shown in the web UI. In most cases this will be `ldapmain` but you may use the [LDAP check rake
     * task](https://docs.gitlab.com/ee/administration/raketasks/ldap.html#check) for receiving the LDAP server name: `LDAP:
     * ... Server: ldapmain`
     */
    ...
    constructor(name: string, argsOrState?: GroupLdapLinkArgs | GroupLdapLinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GroupLdapLink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
