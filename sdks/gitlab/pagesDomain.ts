...
export class PagesDomain extends pulumi.CustomResource {
    ...
    /**
     * Enables [automatic
     * generation](https://docs.gitlab.com/ee/user/project/pages/custom_domains_ssl_tls_certification/lets_encrypt_integration.html)
     * of SSL certificates issued by Let’s Encrypt for custom domains. When this is set to "true", certificate can't be
     * provided.
     */
    ...
    /**
     * The ID or [URL-encoded path of the project](https://docs.gitlab.com/ee/api/index.html#namespaced-path-encoding) owned by
    ...
    constructor(name: string, argsOrState?: PagesDomainArgs | PagesDomainState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PagesDomain.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
