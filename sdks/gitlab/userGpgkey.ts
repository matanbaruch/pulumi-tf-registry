...
export class UserGpgkey extends pulumi.CustomResource {
    ...
    /**
     * The ID of the user to add the GPG key to. If this field is omitted, this resource manages a GPG key for the current
     * user. Otherwise, this resource manages a GPG key for the specified user, and an admin token is required.
     */
    ...
    constructor(name: string, argsOrState?: UserGpgkeyArgs | UserGpgkeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserGpgkey.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
