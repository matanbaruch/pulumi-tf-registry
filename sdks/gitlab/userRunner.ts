...
export class UserRunner extends pulumi.CustomResource {
    ...
    /**
     * Maximum timeout that limits the amount of time (in seconds) that runners can run jobs. Must be at least 600 (10
     * minutes).
     */
    ...
    constructor(name: string, argsOrState?: UserRunnerArgs | UserRunnerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserRunner.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
