...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gitlab");
			params.setVersion("17.3.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2dpdGxhYmhxL2dpdGxhYiIsInZlcnNpb24iOiIxNy4zLjEifX0="), c => c.charCodeAt(0)));
