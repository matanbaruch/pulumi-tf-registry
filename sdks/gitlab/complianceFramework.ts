...
export class ComplianceFramework extends pulumi.CustomResource {
     ...
     * `.gitlab/.compliance-gitlab-ci.yml@compliance/hipaa`. Required format: `path/file.y[a]ml@group-name/project-name`
    ...
    constructor(name: string, argsOrState?: ComplianceFrameworkArgs | ComplianceFrameworkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ComplianceFramework.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
