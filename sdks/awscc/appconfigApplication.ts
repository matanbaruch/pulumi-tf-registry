...
export class AppconfigApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'awscc:index/appconfigApplication:AppconfigApplication';
    ...
    /**
     * Metadata to assign to the application. Tags help organize and categorize your AWS AppConfig resources. Each tag consists
     * of a key and an optional value, both of which you define.
     */
    public readonly tags!: pulumi.Output<outputs.AppconfigApplicationTag[]>;
...
export interface AppconfigApplicationState {
     ...
     * of a key and an optional value, both of which you define.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.AppconfigApplicationTag>[]>;
}
