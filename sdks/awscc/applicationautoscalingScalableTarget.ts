...
export class ApplicationautoscalingScalableTarget extends pulumi.CustomResource {
    /**
     * Get an existing ApplicationautoscalingScalableTarget resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApplicationautoscalingScalableTargetState, opts?: pulumi.CustomResourceOptions): ApplicationautoscalingScalableTarget {
        return new ApplicationautoscalingScalableTarget(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'awscc:index/applicationautoscalingScalableTarget:ApplicationautoscalingScalableTarget';

    /**
     * Returns true if the given object is an instance of ApplicationautoscalingScalableTarget.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApplicationautoscalingScalableTarget {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApplicationautoscalingScalableTarget.__pulumiType;
    }

    /**
     * The maximum value that you plan to scale out to. When a scaling policy is in effect, Application Auto Scaling can scale
     * out (expand) as needed to the maximum capacity limit in response to changing demand.
     */
    public readonly maxCapacity!: pulumi.Output<number>;
    /**
     * The minimum value that you plan to scale in to. When a scaling policy is in effect, Application Auto Scaling can scale
     * in (contract) as needed to the minimum capacity limit in response to changing demand.
     */
    public readonly minCapacity!: pulumi.Output<number>;
    /**
     * The identifier of the resource associated with the scalable target. This string consists of the resource type and unique
    ...
    /**
     * Specify the Amazon Resource Name (ARN) of an Identity and Access Management (IAM) role that allows Application Auto
     * Scaling to modify the scalable target on your behalf. This can be either an IAM service role that Application Auto
     * Scaling can assume to make calls to other AWS resources on your behalf, or a service-linked role for the specified
     * service. For more information, see [How Application Auto Scaling works with
     * IAM](https://docs.aws.amazon.com/autoscaling/application/userguide/security_iam_service-with-iam.html) in the
     * *Application Auto Scaling User Guide*. To automatically create a service-linked role (recommended), specify the full ARN
     * of the service-linked role in your stack template. To find the exact ARN of the service-linked role for your AWS or
     * custom resource, see the [Service-linked
     * roles](https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-service-linked-roles.html)
     * topic in the *Application Auto Scaling User Guide*. Look for the ARN in the table at the bottom of the page.
     */
    public readonly roleArn!: pulumi.Output<string>;
    /**
     * The scalable dimension associated with the scalable target. This string consists of the service namespace, resource
     * type, and scaling property. + ``ecs:service:DesiredCount`` - The desired task count of an ECS service. +
     * ``elasticmapreduce:instancegroup:InstanceCount`` - The instance count of an EMR Instance Group. +
     * ``ec2:spot-fleet-request:TargetCapacity`` - The target capacity of a Spot Fleet. + ``appstream:fleet:DesiredCapacity`` -
     * The desired capacity of an AppStream 2.0 fleet. + ``dynamodb:table:ReadCapacityUnits`` - The provisioned read capacity
     * for a DynamoDB table. + ``dynamodb:table:WriteCapacityUnits`` - The provisioned write capacity for a DynamoDB table. +
    ...
    public /*out*/ readonly scalableTargetId!: pulumi.Output<string>;
    /**
     * The scheduled actions for the scalable target. Duplicates aren't allowed.
     */
    public readonly scheduledActions!: pulumi.Output<outputs.ApplicationautoscalingScalableTargetScheduledAction[]>;
    /**
     ...
     * Setting the value of an attribute to ``true`` suspends the specified scaling activities. Setting it to ``false``
     * (default) resumes the specified scaling activities. *Suspension Outcomes* + For ``DynamicScalingInSuspended``, while a
     * suspension is in effect, all scale-in activities that are triggered by a scaling policy are suspended. + For
     * ``DynamicScalingOutSuspended``, while a suspension is in effect, all scale-out activities that are triggered by a
     * scaling policy are suspended. + For ``ScheduledScalingSuspended``, while a suspension is in effect, all scaling
     * activities that involve scheduled actions are suspended.
     */
    public readonly suspendedState!: pulumi.Output<outputs.ApplicationautoscalingScalableTargetSuspendedState>;

    /**
     * Create a ApplicationautoscalingScalableTarget resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ApplicationautoscalingScalableTargetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApplicationautoscalingScalableTargetArgs | ApplicationautoscalingScalableTargetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApplicationautoscalingScalableTargetState | undefined;
            ...
            resourceInputs["scalableTargetId"] = state ? state.scalableTargetId : undefined;
            ...
            const args = argsOrState as ApplicationautoscalingScalableTargetArgs | undefined;
            ...
            resourceInputs["scalableTargetId"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(ApplicationautoscalingScalableTarget.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ApplicationautoscalingScalableTarget resources.
 */
export interface ApplicationautoscalingScalableTargetState {
    /**
     * The maximum value that you plan to scale out to. When a scaling policy is in effect, Application Auto Scaling can scale
     * out (expand) as needed to the maximum capacity limit in response to changing demand.
     */
    ...
    scalableTargetId?: pulumi.Input<string>;
    /**
     * The scheduled actions for the scalable target. Duplicates aren't allowed.
     */
    scheduledActions?: pulumi.Input<pulumi.Input<inputs.ApplicationautoscalingScalableTargetScheduledAction>[]>;
    /**
     * The namespace of the AWS service that provides the resource, or a ``custom-resource``.
     */
     ...
     * activities that involve scheduled actions are suspended.
     */
    suspendedState?: pulumi.Input<inputs.ApplicationautoscalingScalableTargetSuspendedState>;
}

/**
 * The set of arguments for constructing a ApplicationautoscalingScalableTarget resource.
 */
export interface ApplicationautoscalingScalableTargetArgs {
    /**
     * The maximum value that you plan to scale out to. When a scaling policy is in effect, Application Auto Scaling can scale
     * out (expand) as needed to the maximum capacity limit in response to changing demand.
     */
