...
export function getApigatewayDeployment(args: GetApigatewayDeploymentArgs, opts?: pulumi.InvokeOptions): Promise<GetApigatewayDeploymentResult> {
    ...
    return pulumi.runtime.invoke("awscc:index/getApigatewayDeployment:getApigatewayDeployment", {
        "id": args.id,
...
export interface GetApigatewayDeploymentResult {
    readonly deploymentCanarySettings: outputs.GetApigatewayDeploymentDeploymentCanarySettings;
    readonly deploymentId: string;
    readonly description: string;
    readonly id: string;
    readonly restApiId: string;
    readonly stageDescription: outputs.GetApigatewayDeploymentStageDescription;
