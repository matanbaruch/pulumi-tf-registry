...
export class LocationPlaceIndex extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'awscc:index/locationPlaceIndex:LocationPlaceIndex';
    ...
    public readonly dataSourceConfiguration!: pulumi.Output<outputs.LocationPlaceIndexDataSourceConfiguration>;
     ...
     */
    public readonly tags!: pulumi.Output<outputs.LocationPlaceIndexTag[]>;
    /**
     * The datetime value in ISO 8601 format. The timezone is always UTC. (YYYY-MM-DDThh:mm:ss.sssZ)
     */
...
export interface LocationPlaceIndexState {
     ...
     * An array of key-value pairs to apply to this resource.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.LocationPlaceIndexTag>[]>;
    /**
     * The datetime value in ISO 8601 format. The timezone is always UTC. (YYYY-MM-DDThh:mm:ss.sssZ)
     */
