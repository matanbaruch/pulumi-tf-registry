...
export class CloudformationHookVersion extends pulumi.CustomResource {
    /**
     * Get an existing CloudformationHookVersion resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudformationHookVersionState, opts?: pulumi.CustomResourceOptions): CloudformationHookVersion {
        return new CloudformationHookVersion(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'awscc:index/cloudformationHookVersion:CloudformationHookVersion';

    /**
     * Returns true if the given object is an instance of CloudformationHookVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudformationHookVersion {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudformationHookVersion.__pulumiType;
    }

    /**
     * The Amazon Resource Name (ARN) of the type, here the HookVersion. This is used to uniquely identify a HookVersion
     * resource
     */
     ...
     */
    public readonly loggingConfig!: pulumi.Output<outputs.CloudformationHookVersionLoggingConfig>;
    /**
    ...
    /**
     * Create a CloudformationHookVersion resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudformationHookVersionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudformationHookVersionArgs | CloudformationHookVersionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudformationHookVersionState | undefined;
            ...
            const args = argsOrState as CloudformationHookVersionArgs | undefined;
        ...
        super(CloudformationHookVersion.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CloudformationHookVersion resources.
 */
export interface CloudformationHookVersionState {
    /**
     * The Amazon Resource Name (ARN) of the type, here the HookVersion. This is used to uniquely identify a HookVersion
     * resource
     */
     ...
     * Specifies logging configuration information for a type.
     */
    loggingConfig?: pulumi.Input<inputs.CloudformationHookVersionLoggingConfig>;
    /**
     * A url to the S3 bucket containing the schema handler package that contains the schema, event handlers, and associated
     * files for the type you want to register. For information on generating a schema handler package for the type you want to
     * register, see submit in the CloudFormation CLI User Guide.
...
/**
 * The set of arguments for constructing a CloudformationHookVersion resource.
 */
export interface CloudformationHookVersionArgs {
    /**
     * The Amazon Resource Name (ARN) of the IAM execution role to use to register the type. If your resource type calls AWS
     * APIs in any of its handlers, you must create an IAM execution role that includes the necessary permissions to call those
     * AWS APIs, and provision that execution role in your account. CloudFormation then assumes that execution role to provide
