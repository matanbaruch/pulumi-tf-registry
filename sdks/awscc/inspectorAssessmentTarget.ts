...
export class InspectorAssessmentTarget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'awscc:index/inspectorAssessmentTarget:InspectorAssessmentTarget';
    ...
    public readonly assessmentTargetName!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: InspectorAssessmentTargetArgs | InspectorAssessmentTargetState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["assessmentTargetName"] = state ? state.assessmentTargetName : undefined;
