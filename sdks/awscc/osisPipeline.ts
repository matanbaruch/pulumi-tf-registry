...
export class OsisPipeline extends pulumi.CustomResource {
    /**
     * Get an existing OsisPipeline resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OsisPipelineState, opts?: pulumi.CustomResourceOptions): OsisPipeline {
        return new OsisPipeline(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'awscc:index/osisPipeline:OsisPipeline';

    /**
     * Returns true if the given object is an instance of OsisPipeline.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OsisPipeline {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OsisPipeline.__pulumiType;
    }

    /**
     * Key-value pairs to configure buffering.
     */
    public readonly bufferOptions!: pulumi.Output<outputs.OsisPipelineBufferOptions>;
    /**
     * Key-value pairs to configure encryption at rest.
     */
    public readonly encryptionAtRestOptions!: pulumi.Output<outputs.OsisPipelineEncryptionAtRestOptions>;
    /**
     ...
     */
    public readonly logPublishingOptions!: pulumi.Output<outputs.OsisPipelineLogPublishingOptions>;
    /**
    ...
    /**
     * Name of the OpenSearch Ingestion Service pipeline to create. Pipeline names are unique across the pipelines owned by an
     ...
     */
    public readonly tags!: pulumi.Output<outputs.OsisPipelineTag[]>;
    /**
     ...
     */
    public /*out*/ readonly vpcEndpoints!: pulumi.Output<outputs.OsisPipelineVpcEndpoint[]>;
    /**
     * Container for the values required to configure VPC access for the pipeline. If you don't specify these values,
     * OpenSearch Ingestion Service creates the pipeline with a public endpoint.
     */
    public readonly vpcOptions!: pulumi.Output<outputs.OsisPipelineVpcOptions>;

    /**
     * Create a OsisPipeline resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OsisPipelineArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OsisPipelineArgs | OsisPipelineState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OsisPipelineState | undefined;
            ...
            resourceInputs["vpcEndpointService"] = state ? state.vpcEndpointService : undefined;
            resourceInputs["vpcEndpoints"] = state ? state.vpcEndpoints : undefined;
            resourceInputs["vpcOptions"] = state ? state.vpcOptions : undefined;
        } else {
            const args = argsOrState as OsisPipelineArgs | undefined;
        ...
        super(OsisPipeline.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OsisPipeline resources.
 */
export interface OsisPipelineState {
    /**
     * Key-value pairs to configure buffering.
     */
    bufferOptions?: pulumi.Input<inputs.OsisPipelineBufferOptions>;
    /**
     * Key-value pairs to configure encryption at rest.
     */
    encryptionAtRestOptions?: pulumi.Input<inputs.OsisPipelineEncryptionAtRestOptions>;
    /**
     * A list of endpoints that can be used for ingesting data into a pipeline
     */
     ...
     * Key-value pairs to configure log publishing.
     */
    logPublishingOptions?: pulumi.Input<inputs.OsisPipelineLogPublishingOptions>;
    /**
     * The maximum pipeline capacity, in Ingestion OpenSearch Compute Units (OCUs).
     */
     ...
     * An array of key-value pairs to apply to this resource.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.OsisPipelineTag>[]>;
    /**
     * The VPC endpoint service name for the pipeline.
     */
     ...
     * The VPC interface endpoints that have access to the pipeline.
     */
    vpcEndpoints?: pulumi.Input<pulumi.Input<inputs.OsisPipelineVpcEndpoint>[]>;
    /**
     * Container for the values required to configure VPC access for the pipeline. If you don't specify these values,
     * OpenSearch Ingestion Service creates the pipeline with a public endpoint.
     */
    vpcOptions?: pulumi.Input<inputs.OsisPipelineVpcOptions>;
}

/**
 * The set of arguments for constructing a OsisPipeline resource.
 */
export interface OsisPipelineArgs {
    /**
     * Key-value pairs to configure buffering.
     */
    bufferOptions?: pulumi.Input<inputs.OsisPipelineBufferOptions>;
