...
export class RedshiftCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'awscc:index/redshiftCluster:RedshiftCluster';
     ...
     */
    public readonly allowVersionUpgrade!: pulumi.Output<boolean>;
    /**
     * The value represents how the cluster is configured to use AQUA (Advanced Query Accelerator) after the cluster is
     * restored. Possible values include the following. enabled - Use AQUA if it is available for the current Region and Amazon
     * Redshift node type. disabled - Don't use AQUA. auto - Amazon Redshift determines whether to use AQUA.
     */
     ...
     * value is 1
     */
    public readonly automatedSnapshotRetentionPeriod!: pulumi.Output<number>;
    /**
     ...
     * is complete.
     */
    public readonly availabilityZoneRelocation!: pulumi.Output<boolean>;
    /**
     * The availability zone relocation status of the cluster
     */
    public readonly availabilityZoneRelocationStatus!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly classic!: pulumi.Output<boolean>;
    /**
    ...
    /**
     * The name of the first database to be created when the cluster is created. To create additional databases after the
     * cluster is created, connect to the cluster with a SQL client and use SQL commands to create a database.
     */
    public readonly dbName!: pulumi.Output<string>;
    /**
     * A boolean indicating whether to enable the deferred maintenance window.
     */
    public readonly deferMaintenance!: pulumi.Output<boolean>;
    /**
     ...
     */
    public readonly deferMaintenanceDuration!: pulumi.Output<number>;
    /**
     * A timestamp indicating end time for the deferred maintenance window. If you specify an end time, you can't specify a
     * duration.
     */
    public readonly deferMaintenanceEndTime!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly deferMaintenanceStartTime!: pulumi.Output<string>;
    /**
     * The destination AWS Region that you want to copy snapshots to. Constraints: Must be the name of a valid AWS Region. For
     * more information, see Regions and Endpoints in the Amazon Web Services
    ...
    public readonly endpoint!: pulumi.Output<outputs.RedshiftClusterEndpoint>;
    /**
     * An option that specifies whether to create the cluster with enhanced VPC routing enabled. To create a cluster that uses
     * enhanced VPC routing, the cluster must be in a VPC. For more information, see Enhanced VPC Routing in the Amazon
     * Redshift Cluster Management Guide. If this option is true , enhanced VPC routing is enabled. Default: false
     */
    ...
    public readonly loggingProperties!: pulumi.Output<outputs.RedshiftClusterLoggingProperties>;
    /**
     ...
     */
    public readonly maintenanceTrackName!: pulumi.Output<string>;
    /**
     * A boolean indicating if the redshift cluster's admin user credentials is managed by Redshift or not. You can't use
     * MasterUserPassword if ManageMasterPassword is true. If ManageMasterPassword is false or not set, Amazon Redshift uses
     * MasterUserPassword for the admin user account's password.
     */
    public readonly manageMasterPassword!: pulumi.Output<boolean>;
    /**
     ...
     * MasterUserPassword if ManageMasterPassword is true. Password must be between 8 and 64 characters in length, should have
     * at least one uppercase letter.Must contain at least one lowercase letter.Must contain one number.Can be any printable
     * ASCII character.
     */
    public readonly masterUserPassword!: pulumi.Output<string>;
    /**
     * The user name associated with the master user account for the cluster that is being created. The user name can't be
     * PUBLIC and first character must be a letter.
     */
    public readonly masterUsername!: pulumi.Output<string>;
    /**
     * A boolean indicating if the redshift cluster is multi-az or not. If you don't provide this parameter or set the value to
     * false, the redshift cluster will be single-az.
     */
     ...
     * multi-node.
     */
    public readonly numberOfNodes!: pulumi.Output<number>;
     ...
     * APIs
     */
    public readonly resourceAction!: pulumi.Output<string>;
    /**
     * The identifier of the database revision. You can retrieve this value from the response to the DescribeClusterDbRevisions
     * request.
     */
    public readonly revisionTarget!: pulumi.Output<string>;
    /**
     * A boolean indicating if we want to rotate Encryption Keys.
     */
    public readonly rotateEncryptionKey!: pulumi.Output<boolean>;
    /**
     ...
     */
    public readonly snapshotClusterIdentifier!: pulumi.Output<string>;
    /**
     ...
     * snapshots.
     */
    public readonly snapshotCopyManual!: pulumi.Output<boolean>;
    /**
     * The number of days to retain automated snapshots in the destination region after they are copied from the source region.
     * Default is 7. Constraints: Must be at least 1 and no more than 35.
     */
    public readonly snapshotCopyRetentionPeriod!: pulumi.Output<number>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.RedshiftClusterTag[]>;
    /**
    ...
    constructor(name: string, argsOrState?: RedshiftClusterArgs | RedshiftClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["availabilityZoneRelocation"] = state ? state.availabilityZoneRelocation : undefined;
            resourceInputs["availabilityZoneRelocationStatus"] = state ? state.availabilityZoneRelocationStatus : undefined;
            resourceInputs["classic"] = state ? state.classic : undefined;
            ...
            resourceInputs["deferMaintenance"] = state ? state.deferMaintenance : undefined;
            resourceInputs["deferMaintenanceDuration"] = state ? state.deferMaintenanceDuration : undefined;
            resourceInputs["deferMaintenanceEndTime"] = state ? state.deferMaintenanceEndTime : undefined;
            resourceInputs["deferMaintenanceIdentifier"] = state ? state.deferMaintenanceIdentifier : undefined;
            resourceInputs["deferMaintenanceStartTime"] = state ? state.deferMaintenanceStartTime : undefined;
            ...
            resourceInputs["loggingProperties"] = state ? state.loggingProperties : undefined;
            ...
            resourceInputs["resourceAction"] = state ? state.resourceAction : undefined;
            resourceInputs["revisionTarget"] = state ? state.revisionTarget : undefined;
            resourceInputs["rotateEncryptionKey"] = state ? state.rotateEncryptionKey : undefined;
            ...
            resourceInputs["snapshotCopyManual"] = state ? state.snapshotCopyManual : undefined;
            resourceInputs["snapshotCopyRetentionPeriod"] = state ? state.snapshotCopyRetentionPeriod : undefined;
...
export interface RedshiftClusterState {
     ...
     * A unique identifier for the deferred maintenance window.
     */
    deferMaintenanceIdentifier?: pulumi.Input<string>;
    /**
     * A timestamp indicating the start time for the deferred maintenance window.
     */
    ...
    endpoint?: pulumi.Input<inputs.RedshiftClusterEndpoint>;
    /**
     * An option that specifies whether to create the cluster with enhanced VPC routing enabled. To create a cluster that uses
     * enhanced VPC routing, the cluster must be in a VPC. For more information, see Enhanced VPC Routing in the Amazon
     * Redshift Cluster Management Guide. If this option is true , enhanced VPC routing is enabled. Default: false
    ...
    loggingProperties?: pulumi.Input<inputs.RedshiftClusterLoggingProperties>;
    /**
     * The name for the maintenance track that you want to assign for the cluster. This name change is asynchronous. The new
     * track name stays in the PendingModifiedValues for the cluster until the next maintenance window. When the maintenance
     * track changes, the cluster is switched to the latest cluster release available for the maintenance track. At this point,
     ...
     * The list of tags for the cluster parameter group.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.RedshiftClusterTag>[]>;
    /**
     * A list of Virtual Private Cloud (VPC) security groups to be associated with the cluster.
     */
