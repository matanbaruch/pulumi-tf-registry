...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("kafka");
			params.setVersion("0.8.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21vbmdleS9rYWZrYSIsInZlcnNpb24iOiIwLjguMSJ9fQ=="), c => c.charCodeAt(0)));
