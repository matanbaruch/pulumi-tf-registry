...
export class AgentIngress extends pulumi.CustomResource {
    ...
    /**
     * a list of target values to use as the values of NS records for the domain property these values will delegate control
     * over the domain to ngrok
     */
    public /*out*/ readonly nsTargets!: pulumi.Output<string[]>;
    /**
     * a list of regional agent ingress domains that are subdomains of the value of domain this value may increase over time as
     * ngrok adds more regions
     */
    ...
    constructor(name: string, argsOrState?: AgentIngressArgs | AgentIngressState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AgentIngress.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
