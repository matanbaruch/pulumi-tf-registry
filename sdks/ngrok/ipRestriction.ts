...
export class IpRestriction extends pulumi.CustomResource {
    ...
    /**
     * the type of IP restriction. this defines what traffic will be restricted with the attached policies. four values are
     * currently supported: `dashboard`, `api`, `agent`, and `endpoints`
     */
    ...
    constructor(name: string, argsOrState?: IpRestrictionArgs | IpRestrictionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IpRestriction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
