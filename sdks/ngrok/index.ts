...
export { BotUserArgs, BotUserState } from "./botUser";
export type BotUser = import("./botUser").BotUser;
export const BotUser: typeof import("./botUser").BotUser = null as any;
utilities.lazyLoad(exports, ["BotUser"], () => require("./botUser"));
...
export { ReservedAddrArgs, ReservedAddrState } from "./reservedAddr";
export type ReservedAddr = import("./reservedAddr").ReservedAddr;
export const ReservedAddr: typeof import("./reservedAddr").ReservedAddr = null as any;
utilities.lazyLoad(exports, ["ReservedAddr"], () => require("./reservedAddr"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "ngrok:index/botUser:BotUser":
                return new BotUser(name, <any>undefined, { urn })
            ...
            case "ngrok:index/reservedAddr:ReservedAddr":
                return new ReservedAddr(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("ngrok", "index/botUser", _module)
...
pulumi.runtime.registerResourceModule("ngrok", "index/reservedAddr", _module)
