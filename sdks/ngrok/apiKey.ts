...
export class ApiKey extends pulumi.CustomResource {
    ...
    /**
     * the bearer token that can be placed into the Authorization header to authenticate request to the ngrok API. **This value
     * is only available one time, on the API response from key creation. Otherwise it is null.**
     */
