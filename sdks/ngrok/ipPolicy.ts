...
export class IpPolicy extends pulumi.CustomResource {
    ...
    /**
     * this field is deprecated. Please leave it empty and use the ip policy rule object's "action" field instead. It is
     * temporarily retained for backwards compatibility reasons.
     */
    ...
    constructor(name: string, argsOrState?: IpPolicyArgs | IpPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IpPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
