...
export class SshHostCertificate extends pulumi.CustomResource {
    ...
    /**
     * the list of principals included in the ssh host certificate. This is the list of hostnames and/or IP addresses that are
     * authorized to serve SSH traffic with this certificate. Dangerously, if no principals are specified, this certificate is
    ...
    constructor(name: string, argsOrState?: SshHostCertificateArgs | SshHostCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SshHostCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
