...
export class ReservedDomain extends pulumi.CustomResource {
    ...
    /**
     * DNS CNAME target for the host _acme-challenge.example.com, where example.com is your reserved domain name. This is
     * required to issue certificates for wildcard, non-ngrok reserved domains. Must be null for non-wildcard domains and ngrok
     * subdomains.
     */
    public /*out*/ readonly acmeChallengeCnameTarget!: pulumi.Output<string>;
    /**
     * ID of a user-uploaded TLS certificate to use for connections to targeting this domain. Optional, mutually exclusive with
    ...
    /**
     * DNS CNAME target for a custom hostname, or null if the reserved domain is a subdomain of an ngrok owned domain (e.g.
     * *.ngrok.app)
     */
    public /*out*/ readonly cnameTarget!: pulumi.Output<string>;
    /**
    ...
    /**
     * the domain name to reserve. It may be a full domain name like app.example.com. If the name does not contain a '.' it
     * will reserve that subdomain on ngrok.io.
     */
    public readonly name!: pulumi.Output<string>;
    /**
     * deprecated: With the launch of the ngrok Global Network domains traffic is now handled globally. This field applied only
     * to endpoints. Note that agents may still connect to specific regions. Optional, null by default. (au, eu, ap, us, jp,
     * in, sa)
     */
    ...
    constructor(name: string, argsOrState?: ReservedDomainArgs | ReservedDomainState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["acmeChallengeCnameTarget"] = undefined /*out*/;
            resourceInputs["cnameTarget"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(ReservedDomain.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
