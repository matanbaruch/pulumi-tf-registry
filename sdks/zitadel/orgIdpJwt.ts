...
export class OrgIdpJwt extends pulumi.CustomResource {
    ...
    /**
     * Some identity providers specify the styling of the button to their login, supported values: STYLING_TYPE_UNSPECIFIED,
     * STYLING_TYPE_GOOGLE
     */
    ...
    constructor(name: string, argsOrState?: OrgIdpJwtArgs | OrgIdpJwtState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrgIdpJwt.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
