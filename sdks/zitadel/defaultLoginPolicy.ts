...
export class DefaultLoginPolicy extends pulumi.CustomResource {
    ...
    /**
     * if set to true, the suffix (@domain.com) of an unknown username input on the login screen will be matched against the
     * org domains and will redirect to the registration of that organisation on success.
     */
    ...
    /**
     * if activated, ZITADEL only enforces MFA on local authentications. On authentications through MFA, ZITADEL won't prompt
     * for MFA.
     */
    ...
    constructor(name: string, argsOrState?: DefaultLoginPolicyArgs | DefaultLoginPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DefaultLoginPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
