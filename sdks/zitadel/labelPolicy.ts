...
export class LabelPolicy extends pulumi.CustomResource {
    ...
    /**
     * hides the org suffix on the login form if the scope "urn:zitadel:iam:org:domain:primary:{domainname}" is set. Details
     * about this scope in https://zitadel.com/docs/apis/openidoauth/scopes#reserved-scopes
     */
    ...
    constructor(name: string, argsOrState?: LabelPolicyArgs | LabelPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LabelPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
