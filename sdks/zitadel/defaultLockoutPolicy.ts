...
export class DefaultLockoutPolicy extends pulumi.CustomResource {
    ...
    /**
     * Maximum password check attempts before the account gets locked. Attempts are reset as soon as the password is entered
     * correctly or the password is reset.
     */
    ...
    constructor(name: string, argsOrState?: DefaultLockoutPolicyArgs | DefaultLockoutPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DefaultLockoutPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
