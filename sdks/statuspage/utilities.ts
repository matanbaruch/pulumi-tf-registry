...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("statuspage");
			params.setVersion("0.1.12");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3lhbm5oL3N0YXR1c3BhZ2UiLCJ2ZXJzaW9uIjoiMC4xLjEyIn19"), c => c.charCodeAt(0)));
