...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("mondoo");
			params.setVersion("0.15.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21vbmRvb2hxL21vbmRvbyIsInZlcnNpb24iOiIwLjE1LjIifX0="), c => c.charCodeAt(0)));
