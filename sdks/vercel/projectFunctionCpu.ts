...
export class ProjectFunctionCpu extends pulumi.CustomResource {
    ...
    /**
     * The amount of CPU available to your Serverless Functions. Should be one of 'basic' (0.6vCPU), 'standard' (1vCPU) or
     * 'performance' (1.7vCPUs).
     */
    ...
    constructor(name: string, argsOrState?: ProjectFunctionCpuArgs | ProjectFunctionCpuState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectFunctionCpu.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
