...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("vercel");
			params.setVersion("1.13.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ZlcmNlbC92ZXJjZWwiLCJ2ZXJzaW9uIjoiMS4xMy4wIn19"), c => c.charCodeAt(0)));
