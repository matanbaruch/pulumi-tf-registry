...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("boundary");
			params.setVersion("1.1.15");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2hhc2hpY29ycC9ib3VuZGFyeSIsInZlcnNpb24iOiIxLjEuMTUifX0="), c => c.charCodeAt(0)));
