...
export class NetworkIsolated extends pulumi.CustomResource {
     ...
     */
    public readonly metadataEntries!: pulumi.Output<outputs.NetworkIsolatedMetadataEntry[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NetworkIsolatedArgs | NetworkIsolatedState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkIsolated.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
