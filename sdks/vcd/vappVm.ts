...
export class VappVm extends pulumi.CustomResource {
     ...
     */
    public readonly bootOptions!: pulumi.Output<outputs.VappVmBootOptions | undefined>;
    /**
     ...
     */
    public readonly customization!: pulumi.Output<outputs.VappVmCustomization | undefined>;
    /**
     * The VM description
     */
     ...
     */
    public readonly metadataEntries!: pulumi.Output<outputs.VappVmMetadataEntry[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VappVmArgs | VappVmState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VappVm.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
