...
export class AccessToken extends pulumi.CustomResource {
    ...
    /**
     * The default API version for this token. Defaults to the latest API version. A change in this field will force the
     * destruction of the existing resource and the creation of a new one.
     */
    public readonly defaultApiVersion!: pulumi.Output<number>;
    /**
     * An expiration time for the current token secret, expressed as a Unix epoch time. Replace the computed token secret with
     * a new value. The expired secret will no longer be able to authorize usage of the LaunchDarkly API. This field argument
     * is **deprecated**. Please update your config to remove `expire` to maintain compatibility with future versions
     *
     * @deprecated Deprecated
     */
    public readonly expire!: pulumi.Output<number | undefined>;
    /**
     * Define inline custom roles. An array of statements represented as config blocks with three attributes: effect,
     * resources, actions. May be used in place of a built-in or custom role. [Using
     * polices](https://docs.launchdarkly.com/home/members/role-policies). May be specified more than once.
     */
    ...
    /**
     * Define inline custom roles. An array of statements represented as config blocks with three attributes: effect,
     * resources, actions. May be used in place of a built-in or custom role. May be specified more than once. This field
     * argument is **deprecated**. Update your config to use `inline_role` to maintain compatibility with future versions.
     *
     * @deprecated Deprecated
     */
    ...
    /**
     * Whether the token will be a [service
     * token](https://docs.launchdarkly.com/home/account-security/api-access-tokens#service-tokens). A change in this field
     * will force the destruction of the existing resource and the creation of a new one.
     */
