...
export class TeamMember extends pulumi.CustomResource {
    ...
    /**
     * The list of custom roles keys associated with the team member. Custom roles are only available to customers on an
     * Enterprise plan. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan,
     * [contact LaunchDarkly Sales](https://launchdarkly.com/contact-sales/). > **Note:** each `launchdarkly.TeamMember` must
     * have either a `role` or `custom_roles` argument.
     */
    public readonly customRoles!: pulumi.Output<string[] | undefined>;
    /**
     * The unique email address associated with the team member. A change in this field will force the destruction of the
