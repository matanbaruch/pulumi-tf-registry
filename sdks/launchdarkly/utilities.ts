...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("launchdarkly");
			params.setVersion("2.20.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2xhdW5jaGRhcmtseS9sYXVuY2hkYXJrbHkiLCJ2ZXJzaW9uIjoiMi4yMC4yIn19"), c => c.charCodeAt(0)));
