...
export class RelayProxyConfiguration extends pulumi.CustomResource {
    ...
    /**
     * The Relay Proxy configuration's unique key. Because the `full_key` is only exposed upon creation, it will not be
     * available if the resource is imported.
     */
    ...
    /**
     * The Relay Proxy configuration's rule policy block. This determines what content the Relay Proxy receives. To learn more,
     * read [Understanding policies](https://docs.launchdarkly.com/home/members/role-policies#understanding-policies).
     */
    ...
    constructor(name: string, argsOrState?: RelayProxyConfigurationArgs | RelayProxyConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RelayProxyConfiguration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
