...
export class FeatureFlag extends pulumi.CustomResource {
    ...
    /**
     * Specifies whether the flag is archived or not. Note that you cannot create a new flag that is archived, but can update a
     * flag to be archived.
     */
    public readonly archived!: pulumi.Output<boolean | undefined>;
    public readonly clientSideAvailabilities!: pulumi.Output<outputs.FeatureFlagClientSideAvailability[] | undefined>;
    /**
     * List of nested blocks describing the feature flag's [custom
     * properties](https://docs.launchdarkly.com/home/connecting/custom-properties)
     */
    public readonly customProperties!: pulumi.Output<outputs.FeatureFlagCustomProperty[] | undefined>;
    /**
     * A block containing the indices of the variations to be used as the default on and off variations in all new
     * environments. Flag configurations in existing environments will not be changed nor updated if the configuration block is
     * removed.
     */
    public readonly defaults!: pulumi.Output<outputs.FeatureFlagDefaults | undefined>;
    /**
     * The feature flag's description.
     */
    public readonly description!: pulumi.Output<string | undefined>;
    /**
     * Specifies whether this flag should be made available to the client-side JavaScript SDK using the client-side Id. This
     * value gets its default from your project configuration if not set. `include_in_snippet` is now deprecated. Please
     * migrate to `client_side_availability.using_environment_id` to maintain future compatibility.
     *
     * @deprecated Deprecated
     */
    public readonly includeInSnippet!: pulumi.Output<boolean>;
    /**
     * The unique feature flag key that references the flag in your application code. A change in this field will force the
    ...
    /**
     * The key of the associated team that maintains this feature flag. `maintainer_id` cannot be set if `maintainer_team_key`
     * is set
     */
    ...
    /**
     * The feature flag's project key. A change in this field will force the destruction of the existing resource and the
    ...
    /**
     * The feature flag's variation type: `boolean`, `string`, `number` or `json`. A change in this field will force the
     * destruction of the existing resource and the creation of a new one.
     */
     ...
     */
    public readonly variations!: pulumi.Output<outputs.FeatureFlagVariation[] | undefined>;
