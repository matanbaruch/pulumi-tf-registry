...
export class AuditLogSubscription extends pulumi.CustomResource {
    ...
    /**
     * The integration key. Supported integration keys are `chronosphere`, `cloudtrail`, `datadog`, `dynatrace`, `elastic`,
     * `grafana`, `honeycomb`, `last9`, `logdna`, `msteams`, `new-relic-apm`, `signalfx`, `slack`, and `splunk`. A change in
    ...
    constructor(name: string, argsOrState?: AuditLogSubscriptionArgs | AuditLogSubscriptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AuditLogSubscription.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
