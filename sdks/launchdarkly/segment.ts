...
export class Segment extends pulumi.CustomResource {
    ...
    /**
     * The segment's environment key. A change in this field will force the destruction of the existing resource and the
     * creation of a new one.
     */
    public readonly envKey!: pulumi.Output<string>;
    /**
     * List of non-user target objects excluded from the segment. This attribute is not valid when `unbounded` is set to
     * `true`.
     */
    public readonly excludedContexts!: pulumi.Output<outputs.SegmentExcludedContext[] | undefined>;
    /**
     * List of user keys excluded from the segment. To target on other context kinds, use the excluded_contexts block
     * attribute. This attribute is not valid when `unbounded` is set to `true`.
     */
     ...
     * This attribute is not valid when `unbounded` is set to `true`.
     */
    public readonly includeds!: pulumi.Output<string[] | undefined>;
    /**
     * The unique key that references the segment. A change in this field will force the destruction of the existing resource
    ...
    /**
     * The segment's project key. A change in this field will force the destruction of the existing resource and the creation
     * of a new one.
     */
    public readonly projectKey!: pulumi.Output<string>;
    /**
     * List of nested custom rule blocks to apply to the segment. This attribute is not valid when `unbounded` is set to
     * `true`.
     */
    ...
    /**
     * For Big Segments, the targeted context kind. If this attribute is not specified it will default to `user`. A change in
     * this field will force the destruction of the existing resource and the creation of a new one.
     */
