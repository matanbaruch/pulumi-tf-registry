...
export class FlagTrigger extends pulumi.CustomResource {
    ...
    /**
     * The unique key of the environment the flag trigger will work in. A change in this field will force the destruction of
     * the existing resource and the creation of a new one.
     */
    public readonly envKey!: pulumi.Output<string>;
    /**
     * The unique key of the associated flag. A change in this field will force the destruction of the existing resource and
     ...
     * `turnFlagOn` and `turnFlagOff`. This must be passed as the key-value pair `{ kind = "<flag_action>" }`.
     */
    public readonly instructions!: pulumi.Output<outputs.FlagTriggerInstructions>;
    /**
     * The unique identifier of the integration you intend to set your trigger up with. Currently supported are
     * `generic-trigger`, `datadog`, `dynatrace`, `dynatrace-cloud-automation`, `honeycomb`, `new-relic-apm`, and `signalfx`.
     * `generic-trigger` should be used for integrations not explicitly supported. A change in this field will force the
    ...
    /**
     * The unique key of the project encompassing the associated flag. A change in this field will force the destruction of the
     * existing resource and the creation of a new one.
     */
    ...
    constructor(name: string, argsOrState?: FlagTriggerArgs | FlagTriggerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FlagTrigger.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
