...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ucloud");
			params.setVersion("1.39.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3VjbG91ZC91Y2xvdWQiLCJ2ZXJzaW9uIjoiMS4zOS4xIn19"), c => c.charCodeAt(0)));
