...
export class IamGroupPolicyAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ucloud:index/iamGroupPolicyAttachment:IamGroupPolicyAttachment';
    ...
    constructor(name: string, argsOrState?: IamGroupPolicyAttachmentArgs | IamGroupPolicyAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IamGroupPolicyAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
