...
export class IamUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ucloud:index/iamUser:IamUser';
    ...
    public readonly isFrozen!: pulumi.Output<boolean | undefined>;
    public readonly loginEnable!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: IamUserArgs | IamUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["isFrozen"] = state ? state.isFrozen : undefined;
            resourceInputs["loginEnable"] = state ? state.loginEnable : undefined;
            ...
            resourceInputs["isFrozen"] = args ? args.isFrozen : undefined;
            resourceInputs["loginEnable"] = args ? args.loginEnable : undefined;
...
export interface IamUserState {
    ...
    isFrozen?: pulumi.Input<boolean>;
    loginEnable?: pulumi.Input<boolean>;
