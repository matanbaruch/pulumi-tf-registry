...
export class IamUserPolicyAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ucloud:index/iamUserPolicyAttachment:IamUserPolicyAttachment';
    ...
    public readonly policyUrn!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: IamUserPolicyAttachmentArgs | IamUserPolicyAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["policyUrn"] = state ? state.policyUrn : undefined;
            resourceInputs["projectId"] = state ? state.projectId : undefined;
            resourceInputs["userName"] = state ? state.userName : undefined;
        } else {
            const args = argsOrState as IamUserPolicyAttachmentArgs | undefined;
            if ((!args || args.policyUrn === undefined) && !opts.urn) {
                throw new Error("Missing required property 'policyUrn'");
            }
            if ((!args || args.userName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'userName'");
            }
            resourceInputs["policyUrn"] = args ? args.policyUrn : undefined;
