...
export class Group extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'freeipa:index/group:Group';
     ...
     */
    public readonly nonposix!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: GroupArgs | GroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["nonposix"] = state ? state.nonposix : undefined;
        } else {
            ...
            resourceInputs["nonposix"] = args ? args.nonposix : undefined;
        }
