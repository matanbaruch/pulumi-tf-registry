...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cohesity");
			params.setVersion("1.0.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvaGVzaXR5L2NvaGVzaXR5IiwidmVyc2lvbiI6IjEuMC4xIn19"), c => c.charCodeAt(0)));
