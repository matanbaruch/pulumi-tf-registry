...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("jupiterone");
			params.setVersion("1.6.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2p1cGl0ZXJvbmUvanVwaXRlcm9uZSIsInZlcnNpb24iOiIxLjYuMCJ9fQ=="), c => c.charCodeAt(0)));
