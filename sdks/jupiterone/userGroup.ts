...
export class UserGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'jupiterone:index/userGroup:UserGroup';
     ...
     */
    public readonly queryPolicies!: pulumi.Output<{[key: string]: string[]}[] | undefined>;
    ...
    constructor(name: string, argsOrState?: UserGroupArgs | UserGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["queryPolicies"] = state ? state.queryPolicies : undefined;
        } else {
            const args = argsOrState as UserGroupArgs | undefined;
            resourceInputs["description"] = args ? args.description : undefined;
            resourceInputs["name"] = args ? args.name : undefined;
            resourceInputs["permissions"] = args ? args.permissions : undefined;
            resourceInputs["queryPolicies"] = args ? args.queryPolicies : undefined;
        }
...
export interface UserGroupState {
     ...
     * A set of query policy statements for the user group.
     */
    queryPolicies?: pulumi.Input<pulumi.Input<{[key: string]: pulumi.Input<pulumi.Input<string>[]>}>[]>;
}
