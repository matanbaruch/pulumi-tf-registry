...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("iterative");
			params.setVersion("0.11.20");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2l0ZXJhdGl2ZS9pdGVyYXRpdmUiLCJ2ZXJzaW9uIjoiMC4xMS4yMCJ9fQ=="), c => c.charCodeAt(0)));
