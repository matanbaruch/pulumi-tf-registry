...
/**
 * The provider type for the styra package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'styra';
    ...
    public readonly bearer!: pulumi.Output<string | undefined>;
    /**
