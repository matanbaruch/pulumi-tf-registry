...
export class PlatformPolicy extends pulumi.CustomResource {
    /**
     * Get an existing PlatformPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PlatformPolicyState, opts?: pulumi.CustomResourceOptions): PlatformPolicy {
        return new PlatformPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:index/platformPolicy:PlatformPolicy';

    /**
     * Returns true if the given object is an instance of PlatformPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PlatformPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PlatformPolicy.__pulumiType;
    }
    ...
    /**
     * Create a PlatformPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PlatformPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PlatformPolicyArgs | PlatformPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PlatformPolicyState | undefined;
            ...
            const args = argsOrState as PlatformPolicyArgs | undefined;
        ...
        super(PlatformPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PlatformPolicy resources.
 */
export interface PlatformPolicyState {
    /**
     * Description of the resource.
     */
...
/**
 * The set of arguments for constructing a PlatformPolicy resource.
 */
export interface PlatformPolicyArgs {
    /**
     * Description of the resource.
     */
    description?: pulumi.Input<string>;
