...
export class PlatformToken extends pulumi.CustomResource {
    /**
     * Get an existing PlatformToken resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PlatformTokenState, opts?: pulumi.CustomResourceOptions): PlatformToken {
        return new PlatformToken(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:index/platformToken:PlatformToken';

    /**
     * Returns true if the given object is an instance of PlatformToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PlatformToken {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PlatformToken.__pulumiType;
    }
    ...
    /**
     * Create a PlatformToken resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PlatformTokenArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PlatformTokenArgs | PlatformTokenState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PlatformTokenState | undefined;
            ...
            const args = argsOrState as PlatformTokenArgs | undefined;
        ...
        super(PlatformToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PlatformToken resources.
 */
...
/**
 * The set of arguments for constructing a PlatformToken resource.
 */
export interface PlatformTokenArgs {
    /**
     * Account Identifier for the Entity
     */
    accountId: pulumi.Input<string>;
