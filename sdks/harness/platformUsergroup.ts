...
export class PlatformUsergroup extends pulumi.CustomResource {
    /**
     * Get an existing PlatformUsergroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PlatformUsergroupState, opts?: pulumi.CustomResourceOptions): PlatformUsergroup {
        return new PlatformUsergroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:index/platformUsergroup:PlatformUsergroup';

    /**
     * Returns true if the given object is an instance of PlatformUsergroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PlatformUsergroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PlatformUsergroup.__pulumiType;
    }
     ...
     */
    public readonly notificationConfigs!: pulumi.Output<outputs.PlatformUsergroupNotificationConfig[] | undefined>;
    /**
    ...
    /**
     * Create a PlatformUsergroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PlatformUsergroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PlatformUsergroupArgs | PlatformUsergroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PlatformUsergroupState | undefined;
            ...
            const args = argsOrState as PlatformUsergroupArgs | undefined;
        ...
        super(PlatformUsergroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PlatformUsergroup resources.
 */
export interface PlatformUsergroupState {
    /**
     * Description of the resource.
     */
     ...
     * List of notification settings.
     */
    notificationConfigs?: pulumi.Input<pulumi.Input<inputs.PlatformUsergroupNotificationConfig>[]>;
    /**
     * Unique identifier of the organization.
     */
...
/**
 * The set of arguments for constructing a PlatformUsergroup resource.
 */
export interface PlatformUsergroupArgs {
    /**
     * Description of the resource.
     */
    description?: pulumi.Input<string>;
