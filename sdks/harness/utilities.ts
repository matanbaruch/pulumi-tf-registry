...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("harness");
			params.setVersion("0.32.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hhcm5lc3MvaGFybmVzcyIsInZlcnNpb24iOiIwLjMyLjcifX0="), c => c.charCodeAt(0)));
