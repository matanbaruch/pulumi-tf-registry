...
export class EncryptedText extends pulumi.CustomResource {
    ...
    /**
     * Name of the existing secret. If you already have secrets created in a secrets manager such as HashiCorp Vault or AWS
     * Secrets Manager, you do not need to re-create the existing secrets in Harness.
     */
    ...
    constructor(name: string, argsOrState?: EncryptedTextArgs | EncryptedTextState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EncryptedText.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
