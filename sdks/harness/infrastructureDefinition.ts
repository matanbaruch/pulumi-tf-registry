...
export class InfrastructureDefinition extends pulumi.CustomResource {
    ...
    /**
     * The type of the cloud provider to connect with. Valid options are AWS, AZURE, CUSTOM, PHYSICAL_DATA_CENTER,
     * KUBERNETES_CLUSTER, PCF, SPOT_INST
     */
    ...
    /**
     * The type of the deployment to use. Valid options are AMI, AWS_CODEDEPLOY, AWS_LAMBDA, AZURE_VMSS, AZURE_WEBAPP, CUSTOM,
     * ECS, HELM, KUBERNETES, PCF, SSH, WINRM
     */
    ...
    constructor(name: string, argsOrState?: InfrastructureDefinitionArgs | InfrastructureDefinitionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InfrastructureDefinition.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
