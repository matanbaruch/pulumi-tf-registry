...
export class AutostoppingAzureProxy extends pulumi.CustomResource {
    /**
     * Get an existing AutostoppingAzureProxy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutostoppingAzureProxyState, opts?: pulumi.CustomResourceOptions): AutostoppingAzureProxy {
        return new AutostoppingAzureProxy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:index/autostoppingAzureProxy:AutostoppingAzureProxy';

    /**
     * Returns true if the given object is an instance of AutostoppingAzureProxy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AutostoppingAzureProxy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AutostoppingAzureProxy.__pulumiType;
    }
    ...
    public readonly certificates!: pulumi.Output<outputs.AutostoppingAzureProxyCertificates | undefined>;
    /**
    ...
    /**
     * Create a AutostoppingAzureProxy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AutostoppingAzureProxyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AutostoppingAzureProxyArgs | AutostoppingAzureProxyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AutostoppingAzureProxyState | undefined;
            ...
            const args = argsOrState as AutostoppingAzureProxyArgs | undefined;
        ...
        super(AutostoppingAzureProxy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AutostoppingAzureProxy resources.
 */
export interface AutostoppingAzureProxyState {
    /**
     * Boolean value to indicate if proxy vm needs to have static IP
     */
    ...
    certificates?: pulumi.Input<inputs.AutostoppingAzureProxyCertificates>;
    /**
     * Id of the cloud connector
     */
...
/**
 * The set of arguments for constructing a AutostoppingAzureProxy resource.
 */
export interface AutostoppingAzureProxyArgs {
    /**
     * Boolean value to indicate if proxy vm needs to have static IP
     */
    allocateStaticIp?: pulumi.Input<boolean>;
