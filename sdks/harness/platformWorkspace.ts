...
export class PlatformWorkspace extends pulumi.CustomResource {
    /**
     * Get an existing PlatformWorkspace resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PlatformWorkspaceState, opts?: pulumi.CustomResourceOptions): PlatformWorkspace {
        return new PlatformWorkspace(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:index/platformWorkspace:PlatformWorkspace';

    /**
     * Returns true if the given object is an instance of PlatformWorkspace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PlatformWorkspace {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PlatformWorkspace.__pulumiType;
    }
     ...
     */
    public readonly environmentVariables!: pulumi.Output<outputs.PlatformWorkspaceEnvironmentVariable[] | undefined>;
    /**
    ...
    public readonly terraformVariableFiles!: pulumi.Output<outputs.PlatformWorkspaceTerraformVariableFile[] | undefined>;
    public readonly terraformVariables!: pulumi.Output<outputs.PlatformWorkspaceTerraformVariable[] | undefined>;

    /**
     * Create a PlatformWorkspace resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PlatformWorkspaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PlatformWorkspaceArgs | PlatformWorkspaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PlatformWorkspaceState | undefined;
            ...
            const args = argsOrState as PlatformWorkspaceArgs | undefined;
        ...
        super(PlatformWorkspace.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PlatformWorkspace resources.
 */
export interface PlatformWorkspaceState {
     ...
     * Environment variables configured on the workspace
     */
    environmentVariables?: pulumi.Input<pulumi.Input<inputs.PlatformWorkspaceEnvironmentVariable>[]>;
    /**
     * Unique identifier of the resource.
     */
    ...
    terraformVariableFiles?: pulumi.Input<pulumi.Input<inputs.PlatformWorkspaceTerraformVariableFile>[]>;
    terraformVariables?: pulumi.Input<pulumi.Input<inputs.PlatformWorkspaceTerraformVariable>[]>;
}

/**
 * The set of arguments for constructing a PlatformWorkspace resource.
 */
export interface PlatformWorkspaceArgs {
    /**
     * Cost estimation enabled determines if cost estimation operations are performed.
     */
    costEstimationEnabled: pulumi.Input<boolean>;
