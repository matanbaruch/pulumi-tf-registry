...
export class AutostoppingAzureGateway extends pulumi.CustomResource {
    /**
     * Get an existing AutostoppingAzureGateway resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutostoppingAzureGatewayState, opts?: pulumi.CustomResourceOptions): AutostoppingAzureGateway {
        return new AutostoppingAzureGateway(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:index/autostoppingAzureGateway:AutostoppingAzureGateway';

    /**
     * Returns true if the given object is an instance of AutostoppingAzureGateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AutostoppingAzureGateway {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AutostoppingAzureGateway.__pulumiType;
    }
    ...
    /**
     * ID of existing SSL certificate from AppGateway being imported. Required only for importing existing AppGateway. Required
     * only for SSL based rules
     */
    ...
    /**
     * ID of IP address to be used. Required only for creating new AppGateway. See
     * https://learn.microsoft.com/en-us/azure/application-gateway/application-gateway-components#static-versus-dynamic-public-ip-address
     * for more details
     */
    ...
    /**
     * Create a AutostoppingAzureGateway resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AutostoppingAzureGatewayArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AutostoppingAzureGatewayArgs | AutostoppingAzureGatewayState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AutostoppingAzureGatewayState | undefined;
            ...
            const args = argsOrState as AutostoppingAzureGatewayArgs | undefined;
        ...
        super(AutostoppingAzureGateway.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AutostoppingAzureGateway resources.
 */
export interface AutostoppingAzureGatewayState {
    /**
     * ID of Azure AppGateway for importing. Required only for importing exiging AppGateway
     */
...
/**
 * The set of arguments for constructing a AutostoppingAzureGateway resource.
 */
export interface AutostoppingAzureGatewayArgs {
    /**
     * ID of Azure AppGateway for importing. Required only for importing exiging AppGateway
     */
    appGatewayId?: pulumi.Input<string>;
