...
export class AutostoppingAwsProxy extends pulumi.CustomResource {
    /**
     * Get an existing AutostoppingAwsProxy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutostoppingAwsProxyState, opts?: pulumi.CustomResourceOptions): AutostoppingAwsProxy {
        return new AutostoppingAwsProxy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'harness:index/autostoppingAwsProxy:AutostoppingAwsProxy';

    /**
     * Returns true if the given object is an instance of AutostoppingAwsProxy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AutostoppingAwsProxy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AutostoppingAwsProxy.__pulumiType;
    }
    ...
    public readonly certificates!: pulumi.Output<outputs.AutostoppingAwsProxyCertificates | undefined>;
    /**
    ...
    /**
     * Create a AutostoppingAwsProxy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AutostoppingAwsProxyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AutostoppingAwsProxyArgs | AutostoppingAwsProxyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AutostoppingAwsProxyState | undefined;
            ...
            const args = argsOrState as AutostoppingAwsProxyArgs | undefined;
        ...
        super(AutostoppingAwsProxy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AutostoppingAwsProxy resources.
 */
export interface AutostoppingAwsProxyState {
    /**
     * Boolean value to indicate if proxy vm needs to have static IP
     */
    ...
    certificates?: pulumi.Input<inputs.AutostoppingAwsProxyCertificates>;
    /**
     * Id of the cloud connector
     */
...
/**
 * The set of arguments for constructing a AutostoppingAwsProxy resource.
 */
export interface AutostoppingAwsProxyArgs {
    /**
     * Boolean value to indicate if proxy vm needs to have static IP
     */
    allocateStaticIp?: pulumi.Input<boolean>;
