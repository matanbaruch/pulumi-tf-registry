...
export class Role extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'powerscale:index/role:Role';
     ...
     */
    public readonly members!: pulumi.Output<outputs.RoleMember[]>;
    /**
...
export interface RoleState {
     ...
     * Specifies the users or groups that have this role.
     */
    members?: pulumi.Input<pulumi.Input<inputs.RoleMember>[]>;
    /**
     * Specifies the name of the role.
     */
