...
export class Workload extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'newrelic:index/workload:Workload';
     ...
     */
    public readonly entitySearchQueries!: pulumi.Output<outputs.WorkloadEntitySearchQuery[] | undefined>;
    /**
     ...
     */
    public readonly statusConfigAutomatic!: pulumi.Output<outputs.WorkloadStatusConfigAutomatic | undefined>;
    /**
     * A list of static status configurations. You can only configure one static status for a workload.
     */
    public readonly statusConfigStatic!: pulumi.Output<outputs.WorkloadStatusConfigStatic | undefined>;
    /**
...
export interface WorkloadState {
     ...
     * A list of search queries that define a dynamic workload.
     */
    entitySearchQueries?: pulumi.Input<pulumi.Input<inputs.WorkloadEntitySearchQuery>[]>;
    /**
     * The unique entity identifier of the workload in New Relic.
     */
     ...
     * An input object used to represent an automatic status configuration.
     */
    statusConfigAutomatic?: pulumi.Input<inputs.WorkloadStatusConfigAutomatic>;
    /**
     * A list of static status configurations. You can only configure one static status for a workload.
     */
    statusConfigStatic?: pulumi.Input<inputs.WorkloadStatusConfigStatic>;
    /**
     * The unique entity identifier of the workload.
     */
