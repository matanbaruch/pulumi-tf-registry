...
export class DataPartitionRule extends pulumi.CustomResource {
    ...
    /**
     * Whether or not this data partition rule is deleted. Deleting a data partition rule does not delete the already persisted
     * data. This data will be retained for a given period of time specified in the retention policy field.
     */
    ...
    /**
     * The NRQL to match events for this data partition rule. Logs matching this criteria will be routed to the specified data
     * partition.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.DataPartitionRuleTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DataPartitionRuleArgs | DataPartitionRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DataPartitionRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DataPartitionRuleState {
    ...
    timeouts?: pulumi.Input<inputs.DataPartitionRuleTimeouts>;
}
