...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("newrelic");
			params.setVersion("3.45.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL25ld3JlbGljL25ld3JlbGljIiwidmVyc2lvbiI6IjMuNDUuMCJ9fQ=="), c => c.charCodeAt(0)));
