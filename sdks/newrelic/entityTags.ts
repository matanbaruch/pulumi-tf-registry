...
export class EntityTags extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.EntityTagsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: EntityTagsArgs | EntityTagsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EntityTags.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EntityTagsState {
    ...
    timeouts?: pulumi.Input<inputs.EntityTagsTimeouts>;
}
