...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("quorum");
			params.setVersion("0.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvbnNlbnN5cy9xdW9ydW0iLCJ2ZXJzaW9uIjoiMC4zLjAifX0="), c => c.charCodeAt(0)));
