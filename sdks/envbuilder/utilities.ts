...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("envbuilder");
			params.setVersion("0.0.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvZGVyL2VudmJ1aWxkZXIiLCJ2ZXJzaW9uIjoiMC4wLjUifX0="), c => c.charCodeAt(0)));
