...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("zillizcloud");
			params.setVersion("0.2.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ppbGxpenRlY2gvemlsbGl6Y2xvdWQiLCJ2ZXJzaW9uIjoiMC4yLjMifX0="), c => c.charCodeAt(0)));
