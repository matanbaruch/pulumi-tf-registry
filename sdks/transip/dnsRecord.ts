...
export class DnsRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'transip:index/dnsRecord:DnsRecord';
    ...
    /**
     * The type of dns entry. Possbible types are 'A', 'AAAA', 'CAA', 'CNAME', 'MX', 'NS', 'TXT', 'SRV', 'SSHFP' and 'TLSA'.
     */
