...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("transip");
			params.setVersion("0.1.23");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FlcXVpdGFzL3RyYW5zaXAiLCJ2ZXJzaW9uIjoiMC4xLjIzIn19"), c => c.charCodeAt(0)));
