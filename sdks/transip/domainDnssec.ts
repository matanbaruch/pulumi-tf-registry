...
export class DomainDnssec extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'transip:index/domainDnssec:DomainDnssec';
    ...
    /**
     * List of dnssec entries associated with domain
     */
    public readonly dnssecs!: pulumi.Output<outputs.DomainDnssecDnssec[]>;
    /**
    ...
    constructor(name: string, argsOrState?: DomainDnssecArgs | DomainDnssecState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dnssecs"] = state ? state.dnssecs : undefined;
            resourceInputs["domain"] = state ? state.domain : undefined;
        } else {
            const args = argsOrState as DomainDnssecArgs | undefined;
            if ((!args || args.dnssecs === undefined) && !opts.urn) {
                throw new Error("Missing required property 'dnssecs'");
            }
            if ((!args || args.domain === undefined) && !opts.urn) {
                throw new Error("Missing required property 'domain'");
            }
            resourceInputs["dnssecs"] = args ? args.dnssecs : undefined;
...
export interface DomainDnssecState {
     ...
     * List of dnssec entries associated with domain
     */
    dnssecs?: pulumi.Input<pulumi.Input<inputs.DomainDnssecDnssec>[]>;
    /**
     * The domain, including the tld
     */
