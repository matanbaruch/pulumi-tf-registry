...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pipes");
			params.setVersion("0.14.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3R1cmJvdC9waXBlcyIsInZlcnNpb24iOiIwLjE0LjAifX0="), c => c.charCodeAt(0)));
