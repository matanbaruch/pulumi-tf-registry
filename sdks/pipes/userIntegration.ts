...
export class UserIntegration extends pulumi.CustomResource {
    /**
     * Get an existing UserIntegration resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserIntegrationState, opts?: pulumi.CustomResourceOptions): UserIntegration {
        return new UserIntegration(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pipes:index/userIntegration:UserIntegration';

    /**
     * Returns true if the given object is an instance of UserIntegration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is UserIntegration {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === UserIntegration.__pulumiType;
    }
    ...
    /**
     * Create a UserIntegration resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: UserIntegrationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: UserIntegrationArgs | UserIntegrationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as UserIntegrationState | undefined;
            ...
            const args = argsOrState as UserIntegrationArgs | undefined;
        ...
        super(UserIntegration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering UserIntegration resources.
 */
export interface UserIntegrationState {
...
/**
 * The set of arguments for constructing a UserIntegration resource.
 */
export interface UserIntegrationArgs {
    config?: pulumi.Input<string>;
    createdBy?: pulumi.Input<string>;
    githubInstallationId?: pulumi.Input<string>;
    handle: pulumi.Input<string>;
