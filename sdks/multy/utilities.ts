...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("multy");
			params.setVersion("0.0.16");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL211bHR5Y2xvdWQvbXVsdHkiLCJ2ZXJzaW9uIjoiMC4wLjE2In19"), c => c.charCodeAt(0)));
