...
/**
 * The provider type for the infra package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'infra';
     ...
     */
    public readonly serverCertificateFile!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, args: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["serverCertificateFile"] = args ? args.serverCertificateFile : undefined;
...
export interface ProviderArgs {
     ...
     * `INFRA_SERVER_CERTIFICATE_FILE`. Cannot be used with `skip_tls_verify`, `server_certificate`.
     */
    serverCertificateFile?: pulumi.Input<string>;
    /**
