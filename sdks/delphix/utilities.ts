...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("delphix");
			params.setVersion("3.2.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2RlbHBoaXgtaW50ZWdyYXRpb25zL2RlbHBoaXgiLCJ2ZXJzaW9uIjoiMy4yLjMifX0="), c => c.charCodeAt(0)));
