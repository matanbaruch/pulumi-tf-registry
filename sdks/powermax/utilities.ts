...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("powermax");
			params.setVersion("1.0.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RlbGwvcG93ZXJtYXgiLCJ2ZXJzaW9uIjoiMS4wLjIifX0="), c => c.charCodeAt(0)));
