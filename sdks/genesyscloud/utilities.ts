...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("genesyscloud");
			params.setVersion("1.46.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL215cHVyZWNsb3VkL2dlbmVzeXNjbG91ZCIsInZlcnNpb24iOiIxLjQ2LjAifX0="), c => c.charCodeAt(0)));
