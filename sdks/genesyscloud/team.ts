...
export class Team extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'genesyscloud:index/team:Team';
    ...
    constructor(name: string, argsOrState?: TeamArgs | TeamState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.divisionId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'divisionId'");
            }
