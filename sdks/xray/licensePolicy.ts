...
export class LicensePolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'xray:index/licensePolicy:LicensePolicy';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.LicensePolicyRule[]>;
    /**
     * Type of the policy
     */
...
export interface LicensePolicyState {
     ...
     * the subsequent rules in the list will not be applied.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.LicensePolicyRule>[]>;
    /**
     * Type of the policy
     */
