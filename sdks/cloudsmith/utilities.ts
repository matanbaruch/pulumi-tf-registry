...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudsmith");
			params.setVersion("0.0.52");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Nsb3Vkc21pdGgtaW8vY2xvdWRzbWl0aCIsInZlcnNpb24iOiIwLjAuNTIifX0="), c => c.charCodeAt(0)));
