...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ns");
			params.setVersion("0.6.23");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL251bGxzdG9uZS1pby9ucyIsInZlcnNpb24iOiIwLjYuMjMifX0="), c => c.charCodeAt(0)));
