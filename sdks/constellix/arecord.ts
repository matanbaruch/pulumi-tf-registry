...
export class ARecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:index/aRecord:ARecord';
    ...
    public readonly recordFailoverValues!: pulumi.Output<outputs.ARecordRecordFailoverValue[] | undefined>;
    public readonly recordOption!: pulumi.Output<string>;
    public readonly roundrobinFailovers!: pulumi.Output<outputs.ARecordRoundrobinFailover[] | undefined>;
    public readonly roundrobins!: pulumi.Output<outputs.ARecordRoundrobin[] | undefined>;
...
export interface ARecordState {
    ...
    recordFailoverValues?: pulumi.Input<pulumi.Input<inputs.ARecordRecordFailoverValue>[]>;
    recordOption?: pulumi.Input<string>;
    roundrobinFailovers?: pulumi.Input<pulumi.Input<inputs.ARecordRoundrobinFailover>[]>;
    roundrobins?: pulumi.Input<pulumi.Input<inputs.ARecordRoundrobin>[]>;
