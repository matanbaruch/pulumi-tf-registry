...
export function getTxtRecord(args: GetTxtRecordArgs, opts?: pulumi.InvokeOptions): Promise<GetTxtRecordResult> {
    ...
    return pulumi.runtime.invoke("constellix:index/getTxtRecord:getTxtRecord", {
...
export interface GetTxtRecordArgs {
    ...
    parent?: string;
    parentid?: number;
    roundrobins?: inputs.GetTxtRecordRoundrobin[];
    source?: string;
    sourceType: string;
    ttl?: number;
    type?: string;
...
export interface GetTxtRecordResult {
    ...
    readonly roundrobins?: outputs.GetTxtRecordRoundrobin[];
...
export interface GetTxtRecordOutputArgs {
    ...
    roundrobins?: pulumi.Input<pulumi.Input<inputs.GetTxtRecordRoundrobinArgs>[]>;
