...
export class CaaRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:index/caaRecord:CaaRecord';
    ...
    public readonly roundrobins!: pulumi.Output<outputs.CaaRecordRoundrobin[]>;
    ...
    constructor(name: string, argsOrState?: CaaRecordArgs | CaaRecordState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CaaRecord.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CaaRecordState {
    ...
    roundrobins?: pulumi.Input<pulumi.Input<inputs.CaaRecordRoundrobin>[]>;
