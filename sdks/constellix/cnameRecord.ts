...
export class CnameRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:index/cnameRecord:CnameRecord';
    ...
    public readonly recordFailoverValues!: pulumi.Output<outputs.CnameRecordRecordFailoverValue[] | undefined>;
...
export interface CnameRecordState {
    ...
    recordFailoverValues?: pulumi.Input<pulumi.Input<inputs.CnameRecordRecordFailoverValue>[]>;
