...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("constellix");
			params.setVersion("0.4.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvbnN0ZWxsaXgvY29uc3RlbGxpeCIsInZlcnNpb24iOiIwLjQuNiJ9fQ=="), c => c.charCodeAt(0)));
