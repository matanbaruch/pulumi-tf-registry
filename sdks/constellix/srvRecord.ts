...
export class SrvRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'constellix:index/srvRecord:SrvRecord';
    ...
    public readonly roundrobins!: pulumi.Output<outputs.SrvRecordRoundrobin[]>;
...
export interface SrvRecordState {
    ...
    roundrobins?: pulumi.Input<pulumi.Input<inputs.SrvRecordRoundrobin>[]>;
