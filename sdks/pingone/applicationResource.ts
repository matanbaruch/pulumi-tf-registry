...
export class ApplicationResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pingone:index/applicationResource:ApplicationResource';
    ...
    /**
     * A single object that describes the application resource's parent.
     */
    public /*out*/ readonly parent!: pulumi.Output<outputs.ApplicationResourceParent>;
    /**
     * The ID of the resource that is assigned as an application resource.
     */
    public /*out*/ readonly resourceId!: pulumi.Output<string>;
    /**
     * The name of the resource to should be assigned as an application resource. This field is immutable and will trigger a
...
export interface ApplicationResourceState {
     ...
     * A single object that describes the application resource's parent.
     */
    parent?: pulumi.Input<inputs.ApplicationResourceParent>;
    /**
     * The ID of the resource that is assigned as an application resource.
     */
