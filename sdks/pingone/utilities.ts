...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pingone");
			params.setVersion("1.1.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BpbmdpZGVudGl0eS9waW5nb25lIiwidmVyc2lvbiI6IjEuMS4xIn19"), c => c.charCodeAt(0)));
