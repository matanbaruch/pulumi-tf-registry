...
export class GatewayRoleAssignment extends pulumi.CustomResource {
    /**
     * Get an existing GatewayRoleAssignment resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GatewayRoleAssignmentState, opts?: pulumi.CustomResourceOptions): GatewayRoleAssignment {
        return new GatewayRoleAssignment(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingone:index/gatewayRoleAssignment:GatewayRoleAssignment';

    /**
     * Returns true if the given object is an instance of GatewayRoleAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GatewayRoleAssignment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GatewayRoleAssignment.__pulumiType;
    }

    /**
     * The ID of the environment that contains the gateway to assign the admin role to. Must be a valid PingOne resource ID.
     * This field is immutable and will trigger a replace plan if changed.
     */
    public readonly environmentId!: pulumi.Output<string>;
    /**
     * The ID of an gateway to assign an admin role to. Must be a valid PingOne resource ID. This field is immutable and will
    ...
    /**
     * The ID of an admin role to assign to the gateway. Must be a valid PingOne resource ID. This field is immutable and will
     * trigger a replace plan if changed.
     */
    ...
    /**
     * Create a GatewayRoleAssignment resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GatewayRoleAssignmentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GatewayRoleAssignmentArgs | GatewayRoleAssignmentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GatewayRoleAssignmentState | undefined;
            ...
            const args = argsOrState as GatewayRoleAssignmentArgs | undefined;
        ...
        super(GatewayRoleAssignment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering GatewayRoleAssignment resources.
 */
export interface GatewayRoleAssignmentState {
    /**
     * The ID of the environment that contains the gateway to assign the admin role to. Must be a valid PingOne resource ID.
     * This field is immutable and will trigger a replace plan if changed.
     */
...
/**
 * The set of arguments for constructing a GatewayRoleAssignment resource.
 */
export interface GatewayRoleAssignmentArgs {
    /**
     * The ID of the environment that contains the gateway to assign the admin role to. Must be a valid PingOne resource ID.
     * This field is immutable and will trigger a replace plan if changed.
     */
