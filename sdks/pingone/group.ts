...
export class Group extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pingone:index/group:Group';
    ...
    /**
     * The ID of the environment to manage the group in. Must be a valid PingOne resource ID. This field is immutable and will
    ...
    /**
     * The ID of the population that the group should be assigned to. This field is immutable and will trigger a replace plan
     * if changed.
     */
    public readonly populationId!: pulumi.Output<string | undefined>;
    /**
     * A SCIM filter to dynamically assign users to the group. Examples are found in the [PingOne online
     * documentation](https://docs.pingidentity.com/bundle/pingone/page/kti1564020489340.html).
     */
