...
export class DeviceProfile extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceProfileState, opts?: pulumi.CustomResourceOptions): DeviceProfile {
        return new DeviceProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'netscalersdx:index/deviceProfile:DeviceProfile';
    ...
    constructor(name: string, argsOrState?: DeviceProfileArgs | DeviceProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceProfileState | undefined;
            ...
            const args = argsOrState as DeviceProfileArgs | undefined;
        ...
        super(DeviceProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
