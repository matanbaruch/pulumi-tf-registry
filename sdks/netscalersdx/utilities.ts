...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("netscalersdx");
			params.setVersion("0.5.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL25ldHNjYWxlci9uZXRzY2FsZXJzZHgiLCJ2ZXJzaW9uIjoiMC41LjAifX0="), c => c.charCodeAt(0)));
