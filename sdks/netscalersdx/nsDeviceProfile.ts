...
export class NsDeviceProfile extends pulumi.CustomResource {
    /**
     * Get an existing NsDeviceProfile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NsDeviceProfileState, opts?: pulumi.CustomResourceOptions): NsDeviceProfile {
        return new NsDeviceProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'netscalersdx:index/nsDeviceProfile:NsDeviceProfile';

    /**
     * Returns true if the given object is an instance of NsDeviceProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NsDeviceProfile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NsDeviceProfile.__pulumiType;
    }
    ...
    /**
     * Create a NsDeviceProfile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NsDeviceProfileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NsDeviceProfileArgs | NsDeviceProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NsDeviceProfileState | undefined;
            ...
            const args = argsOrState as NsDeviceProfileArgs | undefined;
        ...
        super(NsDeviceProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NsDeviceProfile resources.
 */
export interface NsDeviceProfileState {
    /**
     * Profile Name, This is one of the already created NetScaler SD-WAN profiles.
     */
...
/**
 * The set of arguments for constructing a NsDeviceProfile resource.
 */
export interface NsDeviceProfileArgs {
    /**
     * Profile Name, This is one of the already created NetScaler SD-WAN profiles.
     */
    cbProfileName?: pulumi.Input<string>;
