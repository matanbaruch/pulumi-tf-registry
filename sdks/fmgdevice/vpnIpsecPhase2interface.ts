...
export class VpnIpsecPhase2interface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/vpnIpsecPhase2interface:VpnIpsecPhase2interface';
    ...
    public readonly l2tp!: pulumi.Output<string | undefined>;
