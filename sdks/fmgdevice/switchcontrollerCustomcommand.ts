...
export class SwitchcontrollerCustomcommand extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerCustomcommand:SwitchcontrollerCustomcommand';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerCustomcommandArgs | SwitchcontrollerCustomcommandState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerCustomcommand.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
