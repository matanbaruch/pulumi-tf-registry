...
export class LogSyslogd3Overridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logSyslogd3Overridefilter:LogSyslogd3Overridefilter';
    ...
    constructor(name: string, argsOrState?: LogSyslogd3OverridefilterArgs | LogSyslogd3OverridefilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogSyslogd3Overridefilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
