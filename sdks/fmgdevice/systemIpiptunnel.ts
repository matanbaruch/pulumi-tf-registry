...
export class SystemIpiptunnel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemIpiptunnel:SystemIpiptunnel';
    ...
    constructor(name: string, argsOrState?: SystemIpiptunnelArgs | SystemIpiptunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemIpiptunnel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
