...
export class SystemProberesponse extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemProberesponse:SystemProberesponse';
    ...
    public readonly httpProbeValue!: pulumi.Output<string | undefined>;
    ...
    public readonly ttlMode!: pulumi.Output<string | undefined>;
