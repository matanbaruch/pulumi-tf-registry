...
export class SystemDns64 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemDns64:SystemDns64';
    ...
    constructor(name: string, argsOrState?: SystemDns64Args | SystemDns64State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemDns64.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
