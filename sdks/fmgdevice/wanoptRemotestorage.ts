...
export class WanoptRemotestorage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wanoptRemotestorage:WanoptRemotestorage';
    ...
    public readonly localCacheId!: pulumi.Output<string | undefined>;
    public readonly remoteCacheId!: pulumi.Output<string | undefined>;
