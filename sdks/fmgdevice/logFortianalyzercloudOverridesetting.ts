...
export class LogFortianalyzercloudOverridesetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logFortianalyzercloudOverridesetting:LogFortianalyzercloudOverridesetting';
    ...
    constructor(name: string, argsOrState?: LogFortianalyzercloudOverridesettingArgs | LogFortianalyzercloudOverridesettingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogFortianalyzercloudOverridesetting.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
