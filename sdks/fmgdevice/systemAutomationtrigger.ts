...
export class SystemAutomationtrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemAutomationtrigger:SystemAutomationtrigger';
    ...
    public readonly iocLevel!: pulumi.Output<string | undefined>;
    public readonly licenseType!: pulumi.Output<string>;
    public readonly logids!: pulumi.Output<number[]>;
    ...
    public readonly triggerHour!: pulumi.Output<number | undefined>;
    public readonly triggerMinute!: pulumi.Output<number | undefined>;
    public readonly triggerType!: pulumi.Output<string>;
    public readonly triggerWeekday!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: SystemAutomationtriggerArgs | SystemAutomationtriggerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["logids"] = state ? state.logids : undefined;
            ...
            resourceInputs["logids"] = args ? args.logids : undefined;
...
export interface SystemAutomationtriggerState {
    ...
    logids?: pulumi.Input<pulumi.Input<number>[]>;
