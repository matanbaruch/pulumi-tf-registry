...
export class SystemSdwanHealthcheck extends pulumi.CustomResource {
    /**
     * Get an existing SystemSdwanHealthcheck resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemSdwanHealthcheckState, opts?: pulumi.CustomResourceOptions): SystemSdwanHealthcheck {
        return new SystemSdwanHealthcheck(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemSdwanHealthcheck:SystemSdwanHealthcheck';

    /**
     * Returns true if the given object is an instance of SystemSdwanHealthcheck.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemSdwanHealthcheck {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemSdwanHealthcheck.__pulumiType;
    }
    ...
    public readonly slas!: pulumi.Output<outputs.SystemSdwanHealthcheckSla[] | undefined>;
    ...
    /**
     * Create a SystemSdwanHealthcheck resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemSdwanHealthcheckArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemSdwanHealthcheckArgs | SystemSdwanHealthcheckState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemSdwanHealthcheckState | undefined;
            ...
            const args = argsOrState as SystemSdwanHealthcheckArgs | undefined;
        ...
        super(SystemSdwanHealthcheck.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemSdwanHealthcheck resources.
 */
export interface SystemSdwanHealthcheckState {
...
/**
 * The set of arguments for constructing a SystemSdwanHealthcheck resource.
 */
export interface SystemSdwanHealthcheckArgs {
    addrMode?: pulumi.Input<string>;
    classIds?: pulumi.Input<pulumi.Input<string>[]>;
    detectMode?: pulumi.Input<string>;
    deviceName?: pulumi.Input<string>;
