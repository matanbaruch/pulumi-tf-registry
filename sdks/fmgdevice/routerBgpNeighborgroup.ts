...
export class RouterBgpNeighborgroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/routerBgpNeighborgroup:RouterBgpNeighborgroup';
    ...
    public readonly remoteAsFilters!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: RouterBgpNeighborgroupArgs | RouterBgpNeighborgroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["remoteAsFilters"] = state ? state.remoteAsFilters : undefined;
            ...
            resourceInputs["remoteAsFilters"] = args ? args.remoteAsFilters : undefined;
