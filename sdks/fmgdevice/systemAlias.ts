...
export class SystemAlias extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemAlias:SystemAlias';
    ...
    constructor(name: string, argsOrState?: SystemAliasArgs | SystemAliasState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemAlias.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
