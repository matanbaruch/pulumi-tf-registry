...
export class WirelesscontrollerMpskprofile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerMpskprofile:WirelesscontrollerMpskprofile';
    ...
    public readonly mpskExternalServers!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: WirelesscontrollerMpskprofileArgs | WirelesscontrollerMpskprofileState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mpskExternalServers"] = state ? state.mpskExternalServers : undefined;
            ...
            resourceInputs["mpskExternalServers"] = args ? args.mpskExternalServers : undefined;
...
export interface WirelesscontrollerMpskprofileState {
    ...
    mpskExternalServers?: pulumi.Input<pulumi.Input<string>[]>;
