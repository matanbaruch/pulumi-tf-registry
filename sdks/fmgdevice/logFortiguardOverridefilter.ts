...
export class LogFortiguardOverridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logFortiguardOverridefilter:LogFortiguardOverridefilter';
    ...
    constructor(name: string, argsOrState?: LogFortiguardOverridefilterArgs | LogFortiguardOverridefilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogFortiguardOverridefilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
