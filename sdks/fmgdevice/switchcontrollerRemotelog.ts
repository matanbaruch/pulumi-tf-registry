...
export class SwitchcontrollerRemotelog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerRemotelog:SwitchcontrollerRemotelog';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerRemotelogArgs | SwitchcontrollerRemotelogState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerRemotelog.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
