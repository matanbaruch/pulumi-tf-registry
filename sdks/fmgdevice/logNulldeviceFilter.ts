...
export class LogNulldeviceFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logNulldeviceFilter:LogNulldeviceFilter';
    ...
    constructor(name: string, argsOrState?: LogNulldeviceFilterArgs | LogNulldeviceFilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogNulldeviceFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
