...
export class LogSyslogd4Filter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logSyslogd4Filter:LogSyslogd4Filter';
    ...
    constructor(name: string, argsOrState?: LogSyslogd4FilterArgs | LogSyslogd4FilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogSyslogd4Filter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
