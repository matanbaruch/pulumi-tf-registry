...
export class LogSyslogd2Overridesetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logSyslogd2Overridesetting:LogSyslogd2Overridesetting';
    ...
    constructor(name: string, argsOrState?: LogSyslogd2OverridesettingArgs | LogSyslogd2OverridesettingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogSyslogd2Overridesetting.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
