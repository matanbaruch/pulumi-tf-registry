...
export class VpnPptp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/vpnPptp:VpnPptp';
    ...
    public readonly sip!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: VpnPptpArgs | VpnPptpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpnPptp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
