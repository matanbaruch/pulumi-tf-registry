...
export class SwitchcontrollerSnmptrapthreshold extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerSnmptrapthreshold:SwitchcontrollerSnmptrapthreshold';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerSnmptrapthresholdArgs | SwitchcontrollerSnmptrapthresholdState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerSnmptrapthreshold.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
