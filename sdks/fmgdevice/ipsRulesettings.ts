...
export class IpsRulesettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/ipsRulesettings:IpsRulesettings';
    ...
    constructor(name: string, argsOrState?: IpsRulesettingsArgs | IpsRulesettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IpsRulesettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
