...
export class SwitchcontrollerManagedswitchSnmpcommunity extends pulumi.CustomResource {
    /**
     * Get an existing SwitchcontrollerManagedswitchSnmpcommunity resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SwitchcontrollerManagedswitchSnmpcommunityState, opts?: pulumi.CustomResourceOptions): SwitchcontrollerManagedswitchSnmpcommunity {
        return new SwitchcontrollerManagedswitchSnmpcommunity(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerManagedswitchSnmpcommunity:SwitchcontrollerManagedswitchSnmpcommunity';

    /**
     * Returns true if the given object is an instance of SwitchcontrollerManagedswitchSnmpcommunity.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SwitchcontrollerManagedswitchSnmpcommunity {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SwitchcontrollerManagedswitchSnmpcommunity.__pulumiType;
    }
    ...
    public readonly hosts!: pulumi.Output<outputs.SwitchcontrollerManagedswitchSnmpcommunityHost[] | undefined>;
    ...
    /**
     * Create a SwitchcontrollerManagedswitchSnmpcommunity resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SwitchcontrollerManagedswitchSnmpcommunityArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SwitchcontrollerManagedswitchSnmpcommunityArgs | SwitchcontrollerManagedswitchSnmpcommunityState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SwitchcontrollerManagedswitchSnmpcommunityState | undefined;
            ...
            const args = argsOrState as SwitchcontrollerManagedswitchSnmpcommunityArgs | undefined;
        ...
        super(SwitchcontrollerManagedswitchSnmpcommunity.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SwitchcontrollerManagedswitchSnmpcommunity resources.
 */
export interface SwitchcontrollerManagedswitchSnmpcommunityState {
...
/**
 * The set of arguments for constructing a SwitchcontrollerManagedswitchSnmpcommunity resource.
 */
export interface SwitchcontrollerManagedswitchSnmpcommunityArgs {
    deviceName?: pulumi.Input<string>;
    deviceVdom?: pulumi.Input<string>;
    dynamicSortSubtable?: pulumi.Input<string>;
    events?: pulumi.Input<pulumi.Input<string>[]>;
