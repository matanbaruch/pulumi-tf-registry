...
export class WirelesscontrollerUtmprofile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerUtmprofile:WirelesscontrollerUtmprofile';
    ...
    constructor(name: string, argsOrState?: WirelesscontrollerUtmprofileArgs | WirelesscontrollerUtmprofileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WirelesscontrollerUtmprofile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
