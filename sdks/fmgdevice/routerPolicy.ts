...
export class RouterPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/routerPolicy:RouterPolicy';
    ...
    public readonly endSourcePort!: pulumi.Output<number | undefined>;
    ...
    public readonly outputDevices!: pulumi.Output<string[]>;
    ...
    public readonly startSourcePort!: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: RouterPolicyArgs | RouterPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["outputDevices"] = state ? state.outputDevices : undefined;
            ...
            resourceInputs["outputDevices"] = args ? args.outputDevices : undefined;
...
export interface RouterPolicyState {
    ...
    outputDevices?: pulumi.Input<pulumi.Input<string>[]>;
