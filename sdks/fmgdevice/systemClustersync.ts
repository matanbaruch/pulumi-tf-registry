...
export class SystemClustersync extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemClustersync:SystemClustersync';
    ...
    public readonly ikeSeqjumpSpeed!: pulumi.Output<number | undefined>;
    ...
    public readonly slaveAddIkeRoutes!: pulumi.Output<string | undefined>;
    public readonly syncId!: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: SystemClustersyncArgs | SystemClustersyncState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ikeSeqjumpSpeed"] = state ? state.ikeSeqjumpSpeed : undefined;
            ...
            resourceInputs["ikeSeqjumpSpeed"] = args ? args.ikeSeqjumpSpeed : undefined;
...
export interface SystemClustersyncState {
    ...
    ikeSeqjumpSpeed?: pulumi.Input<number>;
