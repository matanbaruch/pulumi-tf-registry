...
export class LogSyslogd2Overridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logSyslogd2Overridefilter:LogSyslogd2Overridefilter';
    ...
    constructor(name: string, argsOrState?: LogSyslogd2OverridefilterArgs | LogSyslogd2OverridefilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogSyslogd2Overridefilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
