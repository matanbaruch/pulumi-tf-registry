...
export class DpdkGlobal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/dpdkGlobal:DpdkGlobal';
    ...
    public readonly elasticbuffer!: pulumi.Output<string | undefined>;
    ...
    public readonly protects!: pulumi.Output<string | undefined>;
