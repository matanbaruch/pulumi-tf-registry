...
export class WebfilterSearchengine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/webfilterSearchengine:WebfilterSearchengine';
    ...
    public readonly safesearchStr!: pulumi.Output<string | undefined>;
