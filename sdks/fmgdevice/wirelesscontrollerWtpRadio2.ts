...
export class WirelesscontrollerWtpRadio2 extends pulumi.CustomResource {
    /**
     * Get an existing WirelesscontrollerWtpRadio2 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WirelesscontrollerWtpRadio2State, opts?: pulumi.CustomResourceOptions): WirelesscontrollerWtpRadio2 {
        return new WirelesscontrollerWtpRadio2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerWtpRadio2:WirelesscontrollerWtpRadio2';

    /**
     * Returns true if the given object is an instance of WirelesscontrollerWtpRadio2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WirelesscontrollerWtpRadio2 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WirelesscontrollerWtpRadio2.__pulumiType;
    }
    ...
    /**
     * Create a WirelesscontrollerWtpRadio2 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WirelesscontrollerWtpRadio2Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WirelesscontrollerWtpRadio2Args | WirelesscontrollerWtpRadio2State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WirelesscontrollerWtpRadio2State | undefined;
            ...
            const args = argsOrState as WirelesscontrollerWtpRadio2Args | undefined;
        ...
        super(WirelesscontrollerWtpRadio2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WirelesscontrollerWtpRadio2 resources.
 */
export interface WirelesscontrollerWtpRadio2State {
...
/**
 * The set of arguments for constructing a WirelesscontrollerWtpRadio2 resource.
 */
export interface WirelesscontrollerWtpRadio2Args {
    autoPowerHigh?: pulumi.Input<number>;
    autoPowerLevel?: pulumi.Input<string>;
    autoPowerLow?: pulumi.Input<number>;
    autoPowerTarget?: pulumi.Input<string>;
