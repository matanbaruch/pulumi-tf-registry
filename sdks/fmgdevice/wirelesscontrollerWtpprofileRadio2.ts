...
export class WirelesscontrollerWtpprofileRadio2 extends pulumi.CustomResource {
    /**
     * Get an existing WirelesscontrollerWtpprofileRadio2 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WirelesscontrollerWtpprofileRadio2State, opts?: pulumi.CustomResourceOptions): WirelesscontrollerWtpprofileRadio2 {
        return new WirelesscontrollerWtpprofileRadio2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerWtpprofileRadio2:WirelesscontrollerWtpprofileRadio2';

    /**
     * Returns true if the given object is an instance of WirelesscontrollerWtpprofileRadio2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WirelesscontrollerWtpprofileRadio2 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WirelesscontrollerWtpprofileRadio2.__pulumiType;
    }
    ...
    /**
     * Create a WirelesscontrollerWtpprofileRadio2 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WirelesscontrollerWtpprofileRadio2Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WirelesscontrollerWtpprofileRadio2Args | WirelesscontrollerWtpprofileRadio2State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WirelesscontrollerWtpprofileRadio2State | undefined;
            ...
            const args = argsOrState as WirelesscontrollerWtpprofileRadio2Args | undefined;
        ...
        super(WirelesscontrollerWtpprofileRadio2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WirelesscontrollerWtpprofileRadio2 resources.
 */
export interface WirelesscontrollerWtpprofileRadio2State {
...
/**
 * The set of arguments for constructing a WirelesscontrollerWtpprofileRadio2 resource.
 */
export interface WirelesscontrollerWtpprofileRadio2Args {
    airtimeFairness?: pulumi.Input<string>;
    amsdu?: pulumi.Input<string>;
    apHandoff?: pulumi.Input<string>;
    apSnifferAddr?: pulumi.Input<string>;
