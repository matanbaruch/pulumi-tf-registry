...
export class WebfilterIpsurlfiltercachesetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/webfilterIpsurlfiltercachesetting:WebfilterIpsurlfiltercachesetting';
    ...
    public readonly dnsRetryInterval!: pulumi.Output<number | undefined>;
    public readonly extendedTtl!: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: WebfilterIpsurlfiltercachesettingArgs | WebfilterIpsurlfiltercachesettingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebfilterIpsurlfiltercachesetting.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
