...
export class SystemReplacemsgAlertmail extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemReplacemsgAlertmail:SystemReplacemsgAlertmail';
    ...
    constructor(name: string, argsOrState?: SystemReplacemsgAlertmailArgs | SystemReplacemsgAlertmailState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemReplacemsgAlertmail.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
