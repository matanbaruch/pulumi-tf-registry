...
/**
 * The provider type for the fmgdevice package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice';
    ...
    public readonly deviceVdom!: pulumi.Output<string | undefined>;
