...
export class LogFortiguardFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logFortiguardFilter:LogFortiguardFilter';
    ...
    constructor(name: string, argsOrState?: LogFortiguardFilterArgs | LogFortiguardFilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogFortiguardFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
