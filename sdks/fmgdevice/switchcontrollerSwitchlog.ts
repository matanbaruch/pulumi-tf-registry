...
export class SwitchcontrollerSwitchlog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerSwitchlog:SwitchcontrollerSwitchlog';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerSwitchlogArgs | SwitchcontrollerSwitchlogState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerSwitchlog.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
