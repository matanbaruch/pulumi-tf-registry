...
export class SystemIpam extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemIpam:SystemIpam';
    ...
    public readonly poolSubnets!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: SystemIpamArgs | SystemIpamState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["poolSubnets"] = state ? state.poolSubnets : undefined;
            ...
            resourceInputs["poolSubnets"] = args ? args.poolSubnets : undefined;
...
export interface SystemIpamState {
    ...
    poolSubnets?: pulumi.Input<pulumi.Input<string>[]>;
