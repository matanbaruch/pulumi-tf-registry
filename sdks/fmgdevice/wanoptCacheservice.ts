...
export class WanoptCacheservice extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wanoptCacheservice:WanoptCacheservice';
    ...
    public readonly acceptableConnections!: pulumi.Output<string | undefined>;
