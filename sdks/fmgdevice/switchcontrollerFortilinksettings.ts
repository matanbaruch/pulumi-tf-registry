...
export class SwitchcontrollerFortilinksettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerFortilinksettings:SwitchcontrollerFortilinksettings';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerFortilinksettingsArgs | SwitchcontrollerFortilinksettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerFortilinksettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
