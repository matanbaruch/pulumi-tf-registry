...
export class WirelesscontrollerSsidpolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerSsidpolicy:WirelesscontrollerSsidpolicy';
    ...
    constructor(name: string, argsOrState?: WirelesscontrollerSsidpolicyArgs | WirelesscontrollerSsidpolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WirelesscontrollerSsidpolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
