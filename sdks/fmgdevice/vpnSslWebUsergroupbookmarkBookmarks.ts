...
export class VpnSslWebUsergroupbookmarkBookmarks extends pulumi.CustomResource {
    /**
     * Get an existing VpnSslWebUsergroupbookmarkBookmarks resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpnSslWebUsergroupbookmarkBookmarksState, opts?: pulumi.CustomResourceOptions): VpnSslWebUsergroupbookmarkBookmarks {
        return new VpnSslWebUsergroupbookmarkBookmarks(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/vpnSslWebUsergroupbookmarkBookmarks:VpnSslWebUsergroupbookmarkBookmarks';

    /**
     * Returns true if the given object is an instance of VpnSslWebUsergroupbookmarkBookmarks.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpnSslWebUsergroupbookmarkBookmarks {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VpnSslWebUsergroupbookmarkBookmarks.__pulumiType;
    }
    ...
    public readonly formDatas!: pulumi.Output<outputs.VpnSslWebUsergroupbookmarkBookmarksFormData[] | undefined>;
    ...
    /**
     * Create a VpnSslWebUsergroupbookmarkBookmarks resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VpnSslWebUsergroupbookmarkBookmarksArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VpnSslWebUsergroupbookmarkBookmarksArgs | VpnSslWebUsergroupbookmarkBookmarksState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VpnSslWebUsergroupbookmarkBookmarksState | undefined;
            ...
            const args = argsOrState as VpnSslWebUsergroupbookmarkBookmarksArgs | undefined;
        ...
        super(VpnSslWebUsergroupbookmarkBookmarks.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VpnSslWebUsergroupbookmarkBookmarks resources.
 */
export interface VpnSslWebUsergroupbookmarkBookmarksState {
    ...
    formDatas?: pulumi.Input<pulumi.Input<inputs.VpnSslWebUsergroupbookmarkBookmarksFormData>[]>;
...
/**
 * The set of arguments for constructing a VpnSslWebUsergroupbookmarkBookmarks resource.
 */
export interface VpnSslWebUsergroupbookmarkBookmarksArgs {
    additionalParams?: pulumi.Input<string>;
    apptype?: pulumi.Input<string>;
    colorDepth?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
