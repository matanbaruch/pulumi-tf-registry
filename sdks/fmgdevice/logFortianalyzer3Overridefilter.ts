...
export class LogFortianalyzer3Overridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logFortianalyzer3Overridefilter:LogFortianalyzer3Overridefilter';
    ...
    constructor(name: string, argsOrState?: LogFortianalyzer3OverridefilterArgs | LogFortianalyzer3OverridefilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogFortianalyzer3Overridefilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
