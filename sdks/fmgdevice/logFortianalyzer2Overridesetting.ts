...
export class LogFortianalyzer2Overridesetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logFortianalyzer2Overridesetting:LogFortianalyzer2Overridesetting';
    ...
    constructor(name: string, argsOrState?: LogFortianalyzer2OverridesettingArgs | LogFortianalyzer2OverridesettingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogFortianalyzer2Overridesetting.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
