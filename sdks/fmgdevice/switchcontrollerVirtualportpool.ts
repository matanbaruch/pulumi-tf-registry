...
export class SwitchcontrollerVirtualportpool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerVirtualportpool:SwitchcontrollerVirtualportpool';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerVirtualportpoolArgs | SwitchcontrollerVirtualportpoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerVirtualportpool.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
