...
export class SwitchcontrollerSwitchinterfacetag extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerSwitchinterfacetag:SwitchcontrollerSwitchinterfacetag';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerSwitchinterfacetagArgs | SwitchcontrollerSwitchinterfacetagState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerSwitchinterfacetag.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
