...
export class WirelesscontrollerWtpprofileLbs extends pulumi.CustomResource {
    /**
     * Get an existing WirelesscontrollerWtpprofileLbs resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WirelesscontrollerWtpprofileLbsState, opts?: pulumi.CustomResourceOptions): WirelesscontrollerWtpprofileLbs {
        return new WirelesscontrollerWtpprofileLbs(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerWtpprofileLbs:WirelesscontrollerWtpprofileLbs';

    /**
     * Returns true if the given object is an instance of WirelesscontrollerWtpprofileLbs.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WirelesscontrollerWtpprofileLbs {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WirelesscontrollerWtpprofileLbs.__pulumiType;
    }

    public readonly aeroscout!: pulumi.Output<string>;
    public readonly aeroscoutApMac!: pulumi.Output<string | undefined>;
    public readonly aeroscoutMmuReport!: pulumi.Output<string | undefined>;
    public readonly aeroscoutMu!: pulumi.Output<string | undefined>;
    public readonly aeroscoutMuFactor!: pulumi.Output<number | undefined>;
    public readonly aeroscoutMuTimeout!: pulumi.Output<number | undefined>;
    public readonly aeroscoutServerIp!: pulumi.Output<string | undefined>;
    ...
    public readonly polestarAssetAddrgrpLists!: pulumi.Output<string[]>;
    ...
    /**
     * Create a WirelesscontrollerWtpprofileLbs resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WirelesscontrollerWtpprofileLbsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WirelesscontrollerWtpprofileLbsArgs | WirelesscontrollerWtpprofileLbsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WirelesscontrollerWtpprofileLbsState | undefined;
            ...
            resourceInputs["polestarAssetAddrgrpLists"] = state ? state.polestarAssetAddrgrpLists : undefined;
            ...
            const args = argsOrState as WirelesscontrollerWtpprofileLbsArgs | undefined;
            ...
            resourceInputs["polestarAssetAddrgrpLists"] = args ? args.polestarAssetAddrgrpLists : undefined;
        ...
        super(WirelesscontrollerWtpprofileLbs.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WirelesscontrollerWtpprofileLbs resources.
 */
export interface WirelesscontrollerWtpprofileLbsState {
...
/**
 * The set of arguments for constructing a WirelesscontrollerWtpprofileLbs resource.
 */
export interface WirelesscontrollerWtpprofileLbsArgs {
    aeroscout?: pulumi.Input<string>;
    aeroscoutApMac?: pulumi.Input<string>;
    aeroscoutMmuReport?: pulumi.Input<string>;
    aeroscoutMu?: pulumi.Input<string>;
