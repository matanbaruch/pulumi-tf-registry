...
export class WirelesscontrollerWtpRadio1 extends pulumi.CustomResource {
    /**
     * Get an existing WirelesscontrollerWtpRadio1 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WirelesscontrollerWtpRadio1State, opts?: pulumi.CustomResourceOptions): WirelesscontrollerWtpRadio1 {
        return new WirelesscontrollerWtpRadio1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerWtpRadio1:WirelesscontrollerWtpRadio1';

    /**
     * Returns true if the given object is an instance of WirelesscontrollerWtpRadio1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WirelesscontrollerWtpRadio1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WirelesscontrollerWtpRadio1.__pulumiType;
    }
    ...
    public readonly drmaManualMode!: pulumi.Output<string>;
    ...
    /**
     * Create a WirelesscontrollerWtpRadio1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WirelesscontrollerWtpRadio1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WirelesscontrollerWtpRadio1Args | WirelesscontrollerWtpRadio1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WirelesscontrollerWtpRadio1State | undefined;
            ...
            const args = argsOrState as WirelesscontrollerWtpRadio1Args | undefined;
        ...
        super(WirelesscontrollerWtpRadio1.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WirelesscontrollerWtpRadio1 resources.
 */
export interface WirelesscontrollerWtpRadio1State {
...
/**
 * The set of arguments for constructing a WirelesscontrollerWtpRadio1 resource.
 */
export interface WirelesscontrollerWtpRadio1Args {
    autoPowerHigh?: pulumi.Input<number>;
    autoPowerLevel?: pulumi.Input<string>;
    autoPowerLow?: pulumi.Input<number>;
    autoPowerTarget?: pulumi.Input<string>;
