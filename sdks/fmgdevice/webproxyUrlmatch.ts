...
export class WebproxyUrlmatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/webproxyUrlmatch:WebproxyUrlmatch';
    ...
    public readonly fastFallbacks!: pulumi.Output<string[]>;
    public readonly forwardServers!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: WebproxyUrlmatchArgs | WebproxyUrlmatchState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["fastFallbacks"] = state ? state.fastFallbacks : undefined;
            resourceInputs["forwardServers"] = state ? state.forwardServers : undefined;
            ...
            resourceInputs["fastFallbacks"] = args ? args.fastFallbacks : undefined;
            resourceInputs["forwardServers"] = args ? args.forwardServers : undefined;
...
export interface WebproxyUrlmatchState {
    ...
    fastFallbacks?: pulumi.Input<pulumi.Input<string>[]>;
    forwardServers?: pulumi.Input<pulumi.Input<string>[]>;
