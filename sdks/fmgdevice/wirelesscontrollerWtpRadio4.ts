...
export class WirelesscontrollerWtpRadio4 extends pulumi.CustomResource {
    /**
     * Get an existing WirelesscontrollerWtpRadio4 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WirelesscontrollerWtpRadio4State, opts?: pulumi.CustomResourceOptions): WirelesscontrollerWtpRadio4 {
        return new WirelesscontrollerWtpRadio4(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerWtpRadio4:WirelesscontrollerWtpRadio4';

    /**
     * Returns true if the given object is an instance of WirelesscontrollerWtpRadio4.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WirelesscontrollerWtpRadio4 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WirelesscontrollerWtpRadio4.__pulumiType;
    }
    ...
    /**
     * Create a WirelesscontrollerWtpRadio4 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WirelesscontrollerWtpRadio4Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WirelesscontrollerWtpRadio4Args | WirelesscontrollerWtpRadio4State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WirelesscontrollerWtpRadio4State | undefined;
            ...
            const args = argsOrState as WirelesscontrollerWtpRadio4Args | undefined;
        ...
        super(WirelesscontrollerWtpRadio4.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WirelesscontrollerWtpRadio4 resources.
 */
export interface WirelesscontrollerWtpRadio4State {
...
/**
 * The set of arguments for constructing a WirelesscontrollerWtpRadio4 resource.
 */
export interface WirelesscontrollerWtpRadio4Args {
    autoPowerHigh?: pulumi.Input<number>;
    autoPowerLevel?: pulumi.Input<string>;
    autoPowerLow?: pulumi.Input<number>;
    autoPowerTarget?: pulumi.Input<string>;
