...
export class SwitchcontrollerSwitchprofile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerSwitchprofile:SwitchcontrollerSwitchprofile';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerSwitchprofileArgs | SwitchcontrollerSwitchprofileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerSwitchprofile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
