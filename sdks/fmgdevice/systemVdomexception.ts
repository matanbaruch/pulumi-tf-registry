...
export class SystemVdomexception extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemVdomexception:SystemVdomexception';
    ...
    constructor(name: string, argsOrState?: SystemVdomexceptionArgs | SystemVdomexceptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemVdomexception.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
