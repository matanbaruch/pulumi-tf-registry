...
export class WirelesscontrollerLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/wirelesscontrollerLog:WirelesscontrollerLog';
    ...
    public readonly addrgrpLog!: pulumi.Output<string | undefined>;
