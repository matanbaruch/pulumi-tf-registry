...
export class WebfilterOverride extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/webfilterOverride:WebfilterOverride';
    ...
    public readonly newProfiles!: pulumi.Output<string[]>;
    public readonly oldProfiles!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: WebfilterOverrideArgs | WebfilterOverrideState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["newProfiles"] = state ? state.newProfiles : undefined;
            resourceInputs["oldProfiles"] = state ? state.oldProfiles : undefined;
            ...
            resourceInputs["newProfiles"] = args ? args.newProfiles : undefined;
            resourceInputs["oldProfiles"] = args ? args.oldProfiles : undefined;
...
export interface WebfilterOverrideState {
    ...
    newProfiles?: pulumi.Input<pulumi.Input<string>[]>;
    oldProfiles?: pulumi.Input<pulumi.Input<string>[]>;
