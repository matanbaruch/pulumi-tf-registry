...
export class WebfilterFortiguard extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/webfilterFortiguard:WebfilterFortiguard';
    ...
    public readonly requestPacketSizeLimit!: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: WebfilterFortiguardArgs | WebfilterFortiguardState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebfilterFortiguard.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
