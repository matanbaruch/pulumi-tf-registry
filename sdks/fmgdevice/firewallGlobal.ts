...
export class FirewallGlobal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/firewallGlobal:FirewallGlobal';
    ...
    constructor(name: string, argsOrState?: FirewallGlobalArgs | FirewallGlobalState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FirewallGlobal.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
