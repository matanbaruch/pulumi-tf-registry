...
export class SwitchcontrollerNetworkmonitorsettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/switchcontrollerNetworkmonitorsettings:SwitchcontrollerNetworkmonitorsettings';
    ...
    constructor(name: string, argsOrState?: SwitchcontrollerNetworkmonitorsettingsArgs | SwitchcontrollerNetworkmonitorsettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SwitchcontrollerNetworkmonitorsettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
