...
export class LogFortianalyzercloudOverridefilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logFortianalyzercloudOverridefilter:LogFortianalyzercloudOverridefilter';
    ...
    constructor(name: string, argsOrState?: LogFortianalyzercloudOverridefilterArgs | LogFortianalyzercloudOverridefilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogFortianalyzercloudOverridefilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
