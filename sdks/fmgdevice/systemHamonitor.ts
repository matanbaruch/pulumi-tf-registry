...
export class SystemHamonitor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/systemHamonitor:SystemHamonitor';
    ...
    public readonly monitorVlan!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: SystemHamonitorArgs | SystemHamonitorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemHamonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
