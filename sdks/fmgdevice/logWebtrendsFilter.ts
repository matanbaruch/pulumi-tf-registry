...
export class LogWebtrendsFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/logWebtrendsFilter:LogWebtrendsFilter';
    ...
    constructor(name: string, argsOrState?: LogWebtrendsFilterArgs | LogWebtrendsFilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogWebtrendsFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
