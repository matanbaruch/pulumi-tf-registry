...
export class RouterRip extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fmgdevice:index/routerRip:RouterRip';
    ...
    public readonly maxOutMetric!: pulumi.Output<number | undefined>;
    ...
    public readonly recvBufferSize!: pulumi.Output<number | undefined>;
    public readonly redistribute!: pulumi.Output<outputs.RouterRipRedistribute | undefined>;
...
export interface RouterRipState {
    ...
    redistribute?: pulumi.Input<inputs.RouterRipRedistribute>;
