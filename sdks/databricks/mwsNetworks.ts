...
export class MwsNetworks extends pulumi.CustomResource {
    ...
    public readonly errorMessages!: pulumi.Output<outputs.MwsNetworksErrorMessage[] | undefined>;
    ...
    public readonly vpcEndpoints!: pulumi.Output<outputs.MwsNetworksVpcEndpoints | undefined>;
    ...
    constructor(name: string, argsOrState?: MwsNetworksArgs | MwsNetworksState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MwsNetworks.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
