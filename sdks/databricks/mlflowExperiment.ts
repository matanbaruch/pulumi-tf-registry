...
export class MlflowExperiment extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.MlflowExperimentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: MlflowExperimentArgs | MlflowExperimentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MlflowExperiment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MlflowExperimentState {
    ...
    timeouts?: pulumi.Input<inputs.MlflowExperimentTimeouts>;
}
