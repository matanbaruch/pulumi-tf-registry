...
export { DatabricksProviderArgs, DatabricksProviderState } from "./databricksProvider";
export type DatabricksProvider = import("./databricksProvider").DatabricksProvider;
export const DatabricksProvider: typeof import("./databricksProvider").DatabricksProvider = null as any;
utilities.lazyLoad(exports, ["DatabricksProvider"], () => require("./databricksProvider"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "databricks:index/databricksProvider:DatabricksProvider":
                return new DatabricksProvider(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("databricks", "index/databricksProvider", _module)
