...
export class SqlTable extends pulumi.CustomResource {
    ...
    public readonly columns!: pulumi.Output<outputs.SqlTableColumn[] | undefined>;
    ...
    constructor(name: string, argsOrState?: SqlTableArgs | SqlTableState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SqlTable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
