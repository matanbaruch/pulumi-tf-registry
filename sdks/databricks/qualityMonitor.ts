...
export class QualityMonitor extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.QualityMonitorTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: QualityMonitorArgs | QualityMonitorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(QualityMonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface QualityMonitorState {
    ...
    timeouts?: pulumi.Input<inputs.QualityMonitorTimeouts>;
