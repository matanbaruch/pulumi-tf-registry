...
export class VectorSearchEndpoint extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.VectorSearchEndpointTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VectorSearchEndpointArgs | VectorSearchEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VectorSearchEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VectorSearchEndpointState {
    ...
    timeouts?: pulumi.Input<inputs.VectorSearchEndpointTimeouts>;
}
