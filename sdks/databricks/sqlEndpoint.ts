...
export class SqlEndpoint extends pulumi.CustomResource {
    ...
    public /*out*/ readonly odbcParams!: pulumi.Output<outputs.SqlEndpointOdbcParam[]>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.SqlEndpointTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SqlEndpointArgs | SqlEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SqlEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SqlEndpointState {
    ...
    odbcParams?: pulumi.Input<pulumi.Input<inputs.SqlEndpointOdbcParam>[]>;
    spotInstancePolicy?: pulumi.Input<string>;
    state?: pulumi.Input<string>;
    tags?: pulumi.Input<inputs.SqlEndpointTags>;
    timeouts?: pulumi.Input<inputs.SqlEndpointTimeouts>;
