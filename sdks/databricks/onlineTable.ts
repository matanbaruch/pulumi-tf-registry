...
export class OnlineTable extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.OnlineTableTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OnlineTableArgs | OnlineTableState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OnlineTable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface OnlineTableState {
    ...
    timeouts?: pulumi.Input<inputs.OnlineTableTimeouts>;
}
