...
export class VectorSearchIndex extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.VectorSearchIndexTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VectorSearchIndexArgs | VectorSearchIndexState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VectorSearchIndex.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VectorSearchIndexState {
    ...
    timeouts?: pulumi.Input<inputs.VectorSearchIndexTimeouts>;
}
