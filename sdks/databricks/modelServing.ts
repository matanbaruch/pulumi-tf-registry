...
export class ModelServing extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ModelServingTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ModelServingArgs | ModelServingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ModelServing.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ModelServingState {
    ...
    timeouts?: pulumi.Input<inputs.ModelServingTimeouts>;
}
