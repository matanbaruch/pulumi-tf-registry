...
export class Mount extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.MountTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: MountArgs | MountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Mount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MountState {
    ...
    timeouts?: pulumi.Input<inputs.MountTimeouts>;
