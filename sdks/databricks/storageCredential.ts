...
export class StorageCredential extends pulumi.CustomResource {
    ...
    public readonly databricksGcpServiceAccount!: pulumi.Output<outputs.StorageCredentialDatabricksGcpServiceAccount | undefined>;
    ...
    constructor(name: string, argsOrState?: StorageCredentialArgs | StorageCredentialState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(StorageCredential.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
