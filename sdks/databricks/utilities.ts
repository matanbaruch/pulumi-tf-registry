...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("databricks");
			params.setVersion("1.51.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RhdGFicmlja3MvZGF0YWJyaWNrcyIsInZlcnNpb24iOiIxLjUxLjAifX0="), c => c.charCodeAt(0)));
