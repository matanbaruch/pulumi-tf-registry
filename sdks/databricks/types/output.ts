...
export interface OnlineTableStatus {
    continuousUpdateStatuses: outputs.OnlineTableStatusContinuousUpdateStatus[];
    detailedState: string;
    failedStatuses: outputs.OnlineTableStatusFailedStatus[];
    message: string;
    provisioningStatuses: outputs.OnlineTableStatusProvisioningStatus[];
    triggeredUpdateStatuses: outputs.OnlineTableStatusTriggeredUpdateStatus[];
}

export interface OnlineTableStatusContinuousUpdateStatus {
    initialPipelineSyncProgresses: outputs.OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgress[];
...
export interface OnlineTableStatusProvisioningStatus {
    initialPipelineSyncProgresses: outputs.OnlineTableStatusProvisioningStatusInitialPipelineSyncProgress[];
}
...
export interface OnlineTableStatusTriggeredUpdateStatus {
    lastProcessedCommitVersion: number;
    timestamp: string;
    triggeredUpdateProgresses: outputs.OnlineTableStatusTriggeredUpdateStatusTriggeredUpdateProgress[];
}
...
export interface SqlEndpointHealth {
    details: string;
    failureReasons: outputs.SqlEndpointHealthFailureReason[];
    message: string;
    status: string;
    summary: string;
}
