...
export class Recipient extends pulumi.CustomResource {
    ...
    public readonly tokens!: pulumi.Output<outputs.RecipientToken[] | undefined>;
    ...
    constructor(name: string, argsOrState?: RecipientArgs | RecipientState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Recipient.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
