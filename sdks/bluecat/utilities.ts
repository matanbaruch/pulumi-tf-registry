...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("bluecat");
			params.setVersion("1.1.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2JsdWVjYXRsYWJzL2JsdWVjYXQiLCJ2ZXJzaW9uIjoiMS4xLjEifX0="), c => c.charCodeAt(0)));
