...
export class ObjectBucketPolicy extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ObjectBucketPolicyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ObjectBucketPolicyArgs | ObjectBucketPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ObjectBucketPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ObjectBucketPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.ObjectBucketPolicyTimeouts>;
}
