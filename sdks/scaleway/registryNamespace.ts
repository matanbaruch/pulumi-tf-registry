...
export class RegistryNamespace extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.RegistryNamespaceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RegistryNamespaceArgs | RegistryNamespaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RegistryNamespace.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RegistryNamespaceState {
    ...
    timeouts?: pulumi.Input<inputs.RegistryNamespaceTimeouts>;
}
