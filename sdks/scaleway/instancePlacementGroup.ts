...
export class InstancePlacementGroup extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.InstancePlacementGroupTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstancePlacementGroupArgs | InstancePlacementGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstancePlacementGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InstancePlacementGroupState {
    ...
    timeouts?: pulumi.Input<inputs.InstancePlacementGroupTimeouts>;
    /**
     * The zone you want to attach the resource to
     */
