...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("scaleway");
			params.setVersion("2.43.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NjYWxld2F5L3NjYWxld2F5IiwidmVyc2lvbiI6IjIuNDMuMCJ9fQ=="), c => c.charCodeAt(0)));
