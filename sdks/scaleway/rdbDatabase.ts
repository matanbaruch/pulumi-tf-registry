...
export class RdbDatabase extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.RdbDatabaseTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RdbDatabaseArgs | RdbDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RdbDatabase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RdbDatabaseState {
    ...
    timeouts?: pulumi.Input<inputs.RdbDatabaseTimeouts>;
}
