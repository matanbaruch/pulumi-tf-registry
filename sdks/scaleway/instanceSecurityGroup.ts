...
export class InstanceSecurityGroup extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.InstanceSecurityGroupTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstanceSecurityGroupArgs | InstanceSecurityGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstanceSecurityGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InstanceSecurityGroupState {
    ...
    timeouts?: pulumi.Input<inputs.InstanceSecurityGroupTimeouts>;
    /**
     * The zone you want to attach the resource to
     */
