...
export class InstanceServer extends pulumi.CustomResource {
     ...
     */
    public readonly publicIps!: pulumi.Output<outputs.InstanceServerPublicIp[] | undefined>;
    /**
     ...
     */
    public readonly rootVolume!: pulumi.Output<outputs.InstanceServerRootVolume | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.InstanceServerTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstanceServerArgs | InstanceServerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstanceServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InstanceServerState {
    ...
    timeouts?: pulumi.Input<inputs.InstanceServerTimeouts>;
    /**
     * The instanceSDK type of the server
     */
