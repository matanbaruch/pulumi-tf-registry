...
export class VpcPrivateNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly ipv4Subnet!: pulumi.Output<outputs.VpcPrivateNetworkIpv4Subnet | undefined>;
    /**
     * The IPv6 subnet associated with the private network
     */
    public readonly ipv6Subnets!: pulumi.Output<outputs.VpcPrivateNetworkIpv6Subnet[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VpcPrivateNetworkArgs | VpcPrivateNetworkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcPrivateNetwork.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
