...
export class IpamIpReverseDns extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.IpamIpReverseDnsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: IpamIpReverseDnsArgs | IpamIpReverseDnsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IpamIpReverseDns.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface IpamIpReverseDnsState {
    ...
    timeouts?: pulumi.Input<inputs.IpamIpReverseDnsTimeouts>;
}
