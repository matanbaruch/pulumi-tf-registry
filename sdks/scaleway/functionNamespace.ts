...
export class FunctionNamespace extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.FunctionNamespaceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: FunctionNamespaceArgs | FunctionNamespaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FunctionNamespace.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FunctionNamespaceState {
    ...
    timeouts?: pulumi.Input<inputs.FunctionNamespaceTimeouts>;
}
