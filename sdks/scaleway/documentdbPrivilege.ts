...
export class DocumentdbPrivilege extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DocumentdbPrivilegeTimeouts | undefined>;
    /**
     * User name
     */
    ...
    constructor(name: string, argsOrState?: DocumentdbPrivilegeArgs | DocumentdbPrivilegeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DocumentdbPrivilege.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DocumentdbPrivilegeState {
    ...
    timeouts?: pulumi.Input<inputs.DocumentdbPrivilegeTimeouts>;
    /**
     * User name
     */
