...
export class VpcPublicGatewayDhcpReservation extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpcPublicGatewayDhcpReservationTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: VpcPublicGatewayDhcpReservationArgs | VpcPublicGatewayDhcpReservationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcPublicGatewayDhcpReservation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcPublicGatewayDhcpReservationState {
    ...
    timeouts?: pulumi.Input<inputs.VpcPublicGatewayDhcpReservationTimeouts>;
    /**
     * The reservation type, either static (DHCP reservation) or dynamic (DHCP lease). Possible values are reservation and
     * lease
     */
