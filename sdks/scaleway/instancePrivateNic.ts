...
export class InstancePrivateNic extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.InstancePrivateNicTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstancePrivateNicArgs | InstancePrivateNicState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstancePrivateNic.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InstancePrivateNicState {
    ...
    timeouts?: pulumi.Input<inputs.InstancePrivateNicTimeouts>;
    /**
     * The zone you want to attach the resource to
     */
