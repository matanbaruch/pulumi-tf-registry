...
export class LbCertificate extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.LbCertificateTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: LbCertificateArgs | LbCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LbCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LbCertificateState {
    ...
    timeouts?: pulumi.Input<inputs.LbCertificateTimeouts>;
}
