...
export class RdbReadReplica extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.RdbReadReplicaTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RdbReadReplicaArgs | RdbReadReplicaState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RdbReadReplica.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RdbReadReplicaState {
    ...
    timeouts?: pulumi.Input<inputs.RdbReadReplicaTimeouts>;
}
