...
export class CockpitGrafanaUser extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CockpitGrafanaUserTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CockpitGrafanaUserArgs | CockpitGrafanaUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CockpitGrafanaUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CockpitGrafanaUserState {
    ...
    timeouts?: pulumi.Input<inputs.CockpitGrafanaUserTimeouts>;
}
