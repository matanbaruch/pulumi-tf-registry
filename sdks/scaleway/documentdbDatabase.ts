...
export class DocumentdbDatabase extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DocumentdbDatabaseTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DocumentdbDatabaseArgs | DocumentdbDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DocumentdbDatabase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DocumentdbDatabaseState {
    ...
    timeouts?: pulumi.Input<inputs.DocumentdbDatabaseTimeouts>;
}
