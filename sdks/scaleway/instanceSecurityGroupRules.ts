...
export class InstanceSecurityGroupRules extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.InstanceSecurityGroupRulesTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: InstanceSecurityGroupRulesArgs | InstanceSecurityGroupRulesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstanceSecurityGroupRules.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InstanceSecurityGroupRulesState {
    ...
    timeouts?: pulumi.Input<inputs.InstanceSecurityGroupRulesTimeouts>;
}
