...
export class CockpitToken extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CockpitTokenTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CockpitTokenArgs | CockpitTokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CockpitToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CockpitTokenState {
    ...
    timeouts?: pulumi.Input<inputs.CockpitTokenTimeouts>;
    /**
     * The date and time of the last update of the Cockpit Token (Format ISO 8601)
     */
