...
export class InstanceIpReverseDns extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.InstanceIpReverseDnsTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstanceIpReverseDnsArgs | InstanceIpReverseDnsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstanceIpReverseDns.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InstanceIpReverseDnsState {
    ...
    timeouts?: pulumi.Input<inputs.InstanceIpReverseDnsTimeouts>;
    /**
     * The zone you want to attach the resource to
     */
