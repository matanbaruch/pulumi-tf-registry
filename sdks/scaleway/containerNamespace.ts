...
export class ContainerNamespace extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ContainerNamespaceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ContainerNamespaceArgs | ContainerNamespaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ContainerNamespace.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ContainerNamespaceState {
    ...
    timeouts?: pulumi.Input<inputs.ContainerNamespaceTimeouts>;
}
