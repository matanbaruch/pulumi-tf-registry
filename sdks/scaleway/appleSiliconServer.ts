...
export class AppleSiliconServer extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppleSiliconServerTimeouts | undefined>;
    /**
     * Type of the server
     */
    ...
    constructor(name: string, argsOrState?: AppleSiliconServerArgs | AppleSiliconServerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AppleSiliconServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AppleSiliconServerState {
    ...
    timeouts?: pulumi.Input<inputs.AppleSiliconServerTimeouts>;
    /**
     * Type of the server
     */
