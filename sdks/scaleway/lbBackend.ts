...
export class LbBackend extends pulumi.CustomResource {
    ...
    public readonly healthCheckTcp!: pulumi.Output<outputs.LbBackendHealthCheckTcp | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.LbBackendTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: LbBackendArgs | LbBackendState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LbBackend.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LbBackendState {
    ...
    timeouts?: pulumi.Input<inputs.LbBackendTimeouts>;
}
