...
export class DocumentdbInstance extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DocumentdbInstanceTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DocumentdbInstanceArgs | DocumentdbInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DocumentdbInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DocumentdbInstanceState {
    ...
    timeouts?: pulumi.Input<inputs.DocumentdbInstanceTimeouts>;
    /**
     * Identifier for the first user of the database instance
     */
