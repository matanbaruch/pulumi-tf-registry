...
export class DocumentdbUser extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DocumentdbUserTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DocumentdbUserArgs | DocumentdbUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DocumentdbUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DocumentdbUserState {
    ...
    timeouts?: pulumi.Input<inputs.DocumentdbUserTimeouts>;
}
