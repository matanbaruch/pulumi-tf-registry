...
export class IotDevice extends pulumi.CustomResource {
     ...
     */
    public readonly certificate!: pulumi.Output<outputs.IotDeviceCertificate | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: IotDeviceArgs | IotDeviceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IotDevice.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
