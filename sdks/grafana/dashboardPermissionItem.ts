...
export class DashboardPermissionItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'grafana:index/dashboardPermissionItem:DashboardPermissionItem';
    ...
    /**
     * The Organization ID. If not set, the default organization is used for basic authentication, or the one that owns your
     * service account for token authentication.
     */
    ...
    constructor(name: string, argsOrState?: DashboardPermissionItemArgs | DashboardPermissionItemState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DashboardPermissionItem.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
