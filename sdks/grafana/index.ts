...
export { GetCloudIpsArgs, GetCloudIpsResult, GetCloudIpsOutputArgs } from "./getCloudIps";
...
export { GetOncallUsersResult } from "./getOncallUsers";
export const getOncallUsers: typeof import("./getOncallUsers").getOncallUsers = null as any;
export const getOncallUsersOutput: typeof import("./getOncallUsers").getOncallUsersOutput = null as any;
utilities.lazyLoad(exports, ["getOncallUsers","getOncallUsersOutput"], () => require("./getOncallUsers"));
...
export { MachineLearningAlertArgs, MachineLearningAlertState } from "./machineLearningAlert";
export type MachineLearningAlert = import("./machineLearningAlert").MachineLearningAlert;
export const MachineLearningAlert: typeof import("./machineLearningAlert").MachineLearningAlert = null as any;
utilities.lazyLoad(exports, ["MachineLearningAlert"], () => require("./machineLearningAlert"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "grafana:index/machineLearningAlert:MachineLearningAlert":
                return new MachineLearningAlert(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("grafana", "index/machineLearningAlert", _module)
