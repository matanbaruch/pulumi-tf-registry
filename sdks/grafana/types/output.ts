...
export interface GetOncallUsersUser {
    email: string;
    id: string;
    role: string;
    username: string;
...
export interface GetSlosSloAlerting {
    advancedOptions: outputs.GetSlosSloAlertingAdvancedOption[];
...
export interface GetSlosSloAlertingAdvancedOption {
    minFailures: number;
}
...
export interface GetSlosSloQuery {
    freeforms: outputs.GetSlosSloQueryFreeform[];
    ratios: outputs.GetSlosSloQueryRatio[];
    type: string;
}
...
export interface SloAlerting {
     ...
     */
    fastburn?: outputs.SloAlertingFastburn;
    /**
     ...
     */
    slowburn?: outputs.SloAlertingSlowburn;
}
