...
export class SyntheticMonitoringCheck extends pulumi.CustomResource {
     ...
     * value is 1 second (1000 ms), and the maximum is 1 hour (3600000 ms). Defaults to `60000`.
     */
     ...
     * and the maximum 10 seconds (10000 ms). Defaults to `3000`.
     */
    ...
    constructor(name: string, argsOrState?: SyntheticMonitoringCheckArgs | SyntheticMonitoringCheckState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SyntheticMonitoringCheck.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
