...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("grafana");
			params.setVersion("3.7.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2dyYWZhbmEvZ3JhZmFuYSIsInZlcnNpb24iOiIzLjcuMCJ9fQ=="), c => c.charCodeAt(0)));
