...
export class FolderPermissionItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'grafana:index/folderPermissionItem:FolderPermissionItem';
    ...
    constructor(name: string, argsOrState?: FolderPermissionItemArgs | FolderPermissionItemState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FolderPermissionItem.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
