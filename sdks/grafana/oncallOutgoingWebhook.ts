...
export class OncallOutgoingWebhook extends pulumi.CustomResource {
     ...
     * group created`, `acknowledge`, `resolve`, `silence`, `unsilence`, `unresolve`, `unacknowledge`. Defaults to
     * `escalation`.
     */
    ...
    constructor(name: string, argsOrState?: OncallOutgoingWebhookArgs | OncallOutgoingWebhookState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OncallOutgoingWebhook.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
