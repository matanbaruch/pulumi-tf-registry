...
export class OncallUserNotificationRule extends pulumi.CustomResource {
    ...
    /**
     * Personal notification rules execute one after another starting from position=0. A new escalation policy created with a
     * position of an existing escalation policy will move the old one (and all following) down on the list.
     */
    public readonly position!: pulumi.Output<number | undefined>;
    /**
     * The type of notification rule. Can be wait, notify_by_slack, notify_by_msteams, notify_by_sms, notify_by_phone_call,
     * notify_by_telegram, notify_by_email, notify_by_mobile_app, notify_by_mobile_app_critical. NOTE: `notify_by_msteams` is
    ...
    constructor(name: string, argsOrState?: OncallUserNotificationRuleArgs | OncallUserNotificationRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OncallUserNotificationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
