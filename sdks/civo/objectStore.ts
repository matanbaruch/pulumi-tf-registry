...
export class ObjectStore extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ObjectStoreTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ObjectStoreArgs | ObjectStoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ObjectStore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ObjectStoreState {
    ...
    timeouts?: pulumi.Input<inputs.ObjectStoreTimeouts>;
}
