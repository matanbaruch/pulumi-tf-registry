...
export class Firewall extends pulumi.CustomResource {
     ...
     */
    public readonly egressRules!: pulumi.Output<outputs.FirewallEgressRule[] | undefined>;
    /**
     * The ingress rules, this is a list of rules that will be applied to the firewall
     */
    public readonly ingressRules!: pulumi.Output<outputs.FirewallIngressRule[] | undefined>;
    /**
     * The firewall name
     */
