...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("orcasecurity");
			params.setVersion("0.0.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL29yY2FzZWN1cml0eS9vcmNhc2VjdXJpdHkiLCJ2ZXJzaW9uIjoiMC4wLjQifX0="), c => c.charCodeAt(0)));
