...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("citrixadc");
			params.setVersion("1.40.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NpdHJpeC9jaXRyaXhhZGMiLCJ2ZXJzaW9uIjoiMS40MC4wIn19"), c => c.charCodeAt(0)));
