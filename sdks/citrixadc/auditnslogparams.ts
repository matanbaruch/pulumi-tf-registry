...
export class Auditnslogparams extends pulumi.CustomResource {
    /**
     * Get an existing Auditnslogparams resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuditnslogparamsState, opts?: pulumi.CustomResourceOptions): Auditnslogparams {
        return new Auditnslogparams(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'citrixadc:index/auditnslogparams:Auditnslogparams';

    /**
     * Returns true if the given object is an instance of Auditnslogparams.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Auditnslogparams {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Auditnslogparams.__pulumiType;
    }
    ...
    /**
     * Create a Auditnslogparams resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: AuditnslogparamsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AuditnslogparamsArgs | AuditnslogparamsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AuditnslogparamsState | undefined;
            ...
            const args = argsOrState as AuditnslogparamsArgs | undefined;
        ...
        super(Auditnslogparams.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Auditnslogparams resources.
 */
export interface AuditnslogparamsState {
...
/**
 * The set of arguments for constructing a Auditnslogparams resource.
 */
export interface AuditnslogparamsArgs {
    acl?: pulumi.Input<string>;
    alg?: pulumi.Input<string>;
    appflowexport?: pulumi.Input<string>;
    contentinspectionlog?: pulumi.Input<string>;
