...
export class Auditnslogaction extends pulumi.CustomResource {
    /**
     * Get an existing Auditnslogaction resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuditnslogactionState, opts?: pulumi.CustomResourceOptions): Auditnslogaction {
        return new Auditnslogaction(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'citrixadc:index/auditnslogaction:Auditnslogaction';

    /**
     * Returns true if the given object is an instance of Auditnslogaction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Auditnslogaction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Auditnslogaction.__pulumiType;
    }
    ...
    /**
     * Create a Auditnslogaction resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: AuditnslogactionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AuditnslogactionArgs | AuditnslogactionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AuditnslogactionState | undefined;
            ...
            const args = argsOrState as AuditnslogactionArgs | undefined;
        ...
        super(Auditnslogaction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Auditnslogaction resources.
 */
export interface AuditnslogactionState {
...
/**
 * The set of arguments for constructing a Auditnslogaction resource.
 */
export interface AuditnslogactionArgs {
    acl?: pulumi.Input<string>;
    alg?: pulumi.Input<string>;
    appflowexport?: pulumi.Input<string>;
    contentinspectionlog?: pulumi.Input<string>;
