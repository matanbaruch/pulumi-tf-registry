...
export class Ipsecparameter extends pulumi.CustomResource {
    /**
     * Get an existing Ipsecparameter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpsecparameterState, opts?: pulumi.CustomResourceOptions): Ipsecparameter {
        return new Ipsecparameter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'citrixadc:index/ipsecparameter:Ipsecparameter';

    /**
     * Returns true if the given object is an instance of Ipsecparameter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ipsecparameter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ipsecparameter.__pulumiType;
    }
    ...
    /**
     * Create a Ipsecparameter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: IpsecparameterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IpsecparameterArgs | IpsecparameterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpsecparameterState | undefined;
            ...
            const args = argsOrState as IpsecparameterArgs | undefined;
        ...
        super(Ipsecparameter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Ipsecparameter resources.
 */
export interface IpsecparameterState {
...
/**
 * The set of arguments for constructing a Ipsecparameter resource.
 */
export interface IpsecparameterArgs {
    encalgos?: pulumi.Input<pulumi.Input<string>[]>;
    hashalgos?: pulumi.Input<pulumi.Input<string>[]>;
    ikeretryinterval?: pulumi.Input<number>;
    ikeversion?: pulumi.Input<string>;
