...
export class Ntpserver extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'citrixadc:index/ntpserver:Ntpserver';
    ...
    public readonly autokey!: pulumi.Output<boolean>;
    ...
    public readonly preferredntpserver!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: NtpserverArgs | NtpserverState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["preferredntpserver"] = state ? state.preferredntpserver : undefined;
            ...
            resourceInputs["preferredntpserver"] = args ? args.preferredntpserver : undefined;
...
export interface NtpserverState {
    ...
    preferredntpserver?: pulumi.Input<string>;
