...
export class Sslpolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'citrixadc:index/sslpolicy:Sslpolicy';
    ...
    constructor(name: string, argsOrState?: SslpolicyArgs | SslpolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Sslpolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
