...
export class Tmformssoaction extends pulumi.CustomResource {
    /**
     * Get an existing Tmformssoaction resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TmformssoactionState, opts?: pulumi.CustomResourceOptions): Tmformssoaction {
        return new Tmformssoaction(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'citrixadc:index/tmformssoaction:Tmformssoaction';

    /**
     * Returns true if the given object is an instance of Tmformssoaction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Tmformssoaction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Tmformssoaction.__pulumiType;
    }
    ...
    /**
     * Create a Tmformssoaction resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TmformssoactionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TmformssoactionArgs | TmformssoactionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TmformssoactionState | undefined;
            ...
            const args = argsOrState as TmformssoactionArgs | undefined;
        ...
        super(Tmformssoaction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Tmformssoaction resources.
 */
export interface TmformssoactionState {
...
/**
 * The set of arguments for constructing a Tmformssoaction resource.
 */
export interface TmformssoactionArgs {
    actionurl: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    namevaluepair?: pulumi.Input<string>;
    nvtype?: pulumi.Input<string>;
