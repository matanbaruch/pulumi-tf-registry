...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("accuknox");
			params.setVersion("1.0.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FjY3Vrbm94L2FjY3Vrbm94IiwidmVyc2lvbiI6IjEuMC4wIn19"), c => c.charCodeAt(0)));
