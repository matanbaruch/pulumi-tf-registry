...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("serverspace");
			params.setVersion("0.3.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2l0Z2xvYmFsY29tL3NlcnZlcnNwYWNlIiwidmVyc2lvbiI6IjAuMy4xIn19"), c => c.charCodeAt(0)));
