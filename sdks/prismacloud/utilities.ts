...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("prismacloud");
			params.setVersion("1.5.8");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BhbG9hbHRvbmV0d29ya3MvcHJpc21hY2xvdWQiLCJ2ZXJzaW9uIjoiMS41LjgifX0="), c => c.charCodeAt(0)));
