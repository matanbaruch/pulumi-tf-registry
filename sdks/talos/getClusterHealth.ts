...
export function getClusterHealthOutput(args: GetClusterHealthOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetClusterHealthResult> {
    return pulumi.output(args).apply((a: any) => getClusterHealth(a, opts))
}
