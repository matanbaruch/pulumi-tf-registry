...
export class MachineConfigurationApply extends pulumi.CustomResource {
    /**
     * Get an existing MachineConfigurationApply resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MachineConfigurationApplyState, opts?: pulumi.CustomResourceOptions): MachineConfigurationApply {
        return new MachineConfigurationApply(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'talos:index/machineConfigurationApply:MachineConfigurationApply';

    /**
     * Returns true if the given object is an instance of MachineConfigurationApply.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MachineConfigurationApply {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MachineConfigurationApply.__pulumiType;
    }
     ...
     */
    public readonly clientConfiguration!: pulumi.Output<outputs.MachineConfigurationApplyClientConfiguration>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.MachineConfigurationApplyTimeouts | undefined>;

    /**
     * Create a MachineConfigurationApply resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MachineConfigurationApplyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MachineConfigurationApplyArgs | MachineConfigurationApplyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MachineConfigurationApplyState | undefined;
            ...
            const args = argsOrState as MachineConfigurationApplyArgs | undefined;
        ...
        super(MachineConfigurationApply.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MachineConfigurationApply resources.
 */
export interface MachineConfigurationApplyState {
    /**
     * The mode of the apply operation
     */
     ...
     * The client configuration data
     */
    clientConfiguration?: pulumi.Input<inputs.MachineConfigurationApplyClientConfiguration>;
    /**
     * The list of config patches to apply
     */
    ...
    timeouts?: pulumi.Input<inputs.MachineConfigurationApplyTimeouts>;
}

/**
 * The set of arguments for constructing a MachineConfigurationApply resource.
 */
export interface MachineConfigurationApplyArgs {
    /**
     * The mode of the apply operation
     */
    applyMode?: pulumi.Input<string>;
