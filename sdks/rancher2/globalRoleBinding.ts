...
export class GlobalRoleBinding extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.GlobalRoleBindingTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: GlobalRoleBindingArgs | GlobalRoleBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GlobalRoleBinding.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface GlobalRoleBindingState {
    ...
    timeouts?: pulumi.Input<inputs.GlobalRoleBindingTimeouts>;
