...
export class ProjectRoleTemplateBinding extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ProjectRoleTemplateBindingTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ProjectRoleTemplateBindingArgs | ProjectRoleTemplateBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectRoleTemplateBinding.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ProjectRoleTemplateBindingState {
    ...
    timeouts?: pulumi.Input<inputs.ProjectRoleTemplateBindingTimeouts>;
