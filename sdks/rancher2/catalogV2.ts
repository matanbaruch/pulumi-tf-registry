...
export class CatalogV2 extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CatalogV2Timeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CatalogV2Args | CatalogV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CatalogV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CatalogV2State {
    ...
    timeouts?: pulumi.Input<inputs.CatalogV2Timeouts>;
    /**
     * URL to an index generated by Helm
     */
