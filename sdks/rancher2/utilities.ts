...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("rancher2");
			params.setVersion("5.0.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3JhbmNoZXIvcmFuY2hlcjIiLCJ2ZXJzaW9uIjoiNS4wLjAifX0="), c => c.charCodeAt(0)));
