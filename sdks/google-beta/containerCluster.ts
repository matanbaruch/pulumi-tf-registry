...
export class ContainerCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/containerCluster:ContainerCluster';
     ...
     */
    public readonly clusterTelemetry!: pulumi.Output<outputs.ContainerClusterClusterTelemetry | undefined>;
    /**
     ...
     * number of nodes per zone. Must be set if node_pool is not set. If you're using google-beta.ContainerNodePool objects
     * with no default node pool, you'll need to set this to a value of at least 1, alongside setting remove_default_node_pool
     * to true.
     */
    ...
    /**
     * List of node pools associated with this cluster. See google-beta.ContainerNodePool for schema. Warning: node pools
     * defined inside a cluster can't be changed (or added/removed) after cluster creation without deleting and recreating the
     * entire cluster. Unless you absolutely need the ability to say "these are the only node pools associated with this
     * cluster", use the google-beta.ContainerNodePool resource instead of this property.
     */
     ...
     */
    public readonly podSecurityPolicyConfig!: pulumi.Output<outputs.ContainerClusterPodSecurityPolicyConfig | undefined>;
    /**
     ...
     */
    public readonly protectConfig!: pulumi.Output<outputs.ContainerClusterProtectConfig | undefined>;
    /**
    ...
    /**
     * If true, deletes the default node pool upon cluster creation. If you're using google-beta.ContainerNodePool resources
     * with no default node pool, this should be set to true, alongside setting initial_node_count to at least 1.
     */
     ...
     */
    public readonly secretManagerConfig!: pulumi.Output<outputs.ContainerClusterSecretManagerConfig | undefined>;
    /**
     ...
     */
    public readonly tpuConfig!: pulumi.Output<outputs.ContainerClusterTpuConfig | undefined>;
    /**
     ...
     */
    public readonly workloadAltsConfig!: pulumi.Output<outputs.ContainerClusterWorkloadAltsConfig | undefined>;
    /**
...
export interface ContainerClusterState {
     ...
     * Telemetry integration for the cluster.
     */
    clusterTelemetry?: pulumi.Input<inputs.ContainerClusterClusterTelemetry>;
    /**
     * Configuration for the confidential nodes feature, which makes nodes run on confidential VMs. Warning: This configuration
     * can't be changed (or added/removed) after cluster creation without deleting and recreating the entire cluster.
     */
     ...
     * Configuration for the PodSecurityPolicy feature.
     */
    podSecurityPolicyConfig?: pulumi.Input<inputs.ContainerClusterPodSecurityPolicyConfig>;
    /**
     * Configuration for private clusters, clusters with private nodes.
     */
     ...
     * Enable/Disable Protect API features for the cluster.
     */
    protectConfig?: pulumi.Input<inputs.ContainerClusterProtectConfig>;
    /**
     * Configuration options for the Release channel feature, which provide more control over automatic upgrades of your GKE
     * clusters. Note that removing this field from your config will not unenroll it. Instead, use the "UNSPECIFIED" channel.
     */
     ...
     * Configuration for the Secret Manager feature.
     */
    secretManagerConfig?: pulumi.Input<inputs.ContainerClusterSecretManagerConfig>;
    /**
     * Defines the config needed to enable/disable features for the Security Posture API
     */
     ...
     * TPU configuration for the cluster.
     */
    tpuConfig?: pulumi.Input<inputs.ContainerClusterTpuConfig>;
    /**
     * The IP address range of the Cloud TPUs in this cluster, in CIDR notation (e.g. 1.2.3.4/29).
     */
     ...
     * Configuration for direct-path (via ALTS) with workload identity.
     */
    workloadAltsConfig?: pulumi.Input<inputs.ContainerClusterWorkloadAltsConfig>;
    /**
     * Configuration for the use of Kubernetes Service Accounts in GCP IAM policies.
     */
