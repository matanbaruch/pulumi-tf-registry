...
export class ComputeInstanceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeInstanceGroup:ComputeInstanceGroup';
     ...
     */
    public readonly namedPorts!: pulumi.Output<outputs.ComputeInstanceGroupNamedPort[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ComputeInstanceGroupTimeouts | undefined>;
    /**
...
export interface ComputeInstanceGroupState {
     ...
     * The named port configuration.
     */
    namedPorts?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceGroupNamedPort>[]>;
    /**
     * The URL of the network the instance group is in. If this is different from the network where the instances are in, the
     * creation fails. Defaults to the network where the instances are in (if neither network nor instances is specified, this
     * field will be blank).
