...
export class ComputeRegionSslPolicy extends pulumi.CustomResource {
    /**
     * Get an existing ComputeRegionSslPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeRegionSslPolicyState, opts?: pulumi.CustomResourceOptions): ComputeRegionSslPolicy {
        return new ComputeRegionSslPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeRegionSslPolicy:ComputeRegionSslPolicy';

    /**
     * Returns true if the given object is an instance of ComputeRegionSslPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ComputeRegionSslPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ComputeRegionSslPolicy.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.ComputeRegionSslPolicyTimeouts | undefined>;

    /**
     * Create a ComputeRegionSslPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ComputeRegionSslPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ComputeRegionSslPolicyArgs | ComputeRegionSslPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ComputeRegionSslPolicyState | undefined;
            ...
            const args = argsOrState as ComputeRegionSslPolicyArgs | undefined;
        ...
        super(ComputeRegionSslPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ComputeRegionSslPolicyState {
    /**
     * Creation timestamp in RFC3339 text format.
     */
    ...
    timeouts?: pulumi.Input<inputs.ComputeRegionSslPolicyTimeouts>;
}

/**
 * The set of arguments for constructing a ComputeRegionSslPolicy resource.
 */
export interface ComputeRegionSslPolicyArgs {
    /**
     * A list of features enabled when the selected profile is CUSTOM. The method returns the set of features that can be
     * specified in this list. This field must be empty if the profile is not CUSTOM. See the [official
     * documentation](https://cloud.google.com/compute/docs/load-balancing/ssl-policies#profilefeaturesupport) for which
