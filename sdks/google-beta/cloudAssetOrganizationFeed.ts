...
export class CloudAssetOrganizationFeed extends pulumi.CustomResource {
    /**
     * Get an existing CloudAssetOrganizationFeed resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudAssetOrganizationFeedState, opts?: pulumi.CustomResourceOptions): CloudAssetOrganizationFeed {
        return new CloudAssetOrganizationFeed(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/cloudAssetOrganizationFeed:CloudAssetOrganizationFeed';

    /**
     * Returns true if the given object is an instance of CloudAssetOrganizationFeed.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudAssetOrganizationFeed {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudAssetOrganizationFeed.__pulumiType;
    }
     ...
     */
    public readonly condition!: pulumi.Output<outputs.CloudAssetOrganizationFeedCondition | undefined>;
    /**
     ...
     */
    public readonly feedOutputConfig!: pulumi.Output<outputs.CloudAssetOrganizationFeedFeedOutputConfig>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.CloudAssetOrganizationFeedTimeouts | undefined>;

    /**
     * Create a CloudAssetOrganizationFeed resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudAssetOrganizationFeedArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudAssetOrganizationFeedArgs | CloudAssetOrganizationFeedState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudAssetOrganizationFeedState | undefined;
            ...
            const args = argsOrState as CloudAssetOrganizationFeedArgs | undefined;
        ...
        super(CloudAssetOrganizationFeed.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface CloudAssetOrganizationFeedState {
    /**
     * A list of the full names of the assets to receive updates. You must specify either or both of assetNames and assetTypes.
     * Only asset updates matching specified assetNames and assetTypes are exported to the feed. For example:
     * //compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1. See
     ...
     * Other fields of condition are optional.
     */
    condition?: pulumi.Input<inputs.CloudAssetOrganizationFeedCondition>;
    /**
     * Asset content type. If not specified, no content but the asset name and type will be returned. Possible values:
     * ["CONTENT_TYPE_UNSPECIFIED", "RESOURCE", "IAM_POLICY", "ORG_POLICY", "OS_INVENTORY", "ACCESS_POLICY"]
     */
     ...
     * Output configuration for asset feed destination.
     */
    feedOutputConfig?: pulumi.Input<inputs.CloudAssetOrganizationFeedFeedOutputConfig>;
    /**
     * The format will be organizations/{organization_number}/feeds/{client-assigned_feed_identifier}.
     */
    ...
    timeouts?: pulumi.Input<inputs.CloudAssetOrganizationFeedTimeouts>;
}

/**
 * The set of arguments for constructing a CloudAssetOrganizationFeed resource.
 */
export interface CloudAssetOrganizationFeedArgs {
    /**
     * A list of the full names of the assets to receive updates. You must specify either or both of assetNames and assetTypes.
     * Only asset updates matching specified assetNames and assetTypes are exported to the feed. For example:
     * //compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1. See
