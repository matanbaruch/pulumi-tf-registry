...
export class DataflowJob extends pulumi.CustomResource {
    /**
     * Get an existing DataflowJob resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataflowJobState, opts?: pulumi.CustomResourceOptions): DataflowJob {
        return new DataflowJob(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/dataflowJob:DataflowJob';

    /**
     * Returns true if the given object is an instance of DataflowJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataflowJob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataflowJob.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DataflowJobTimeouts | undefined>;
    /**
    ...
    /**
     * Create a DataflowJob resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DataflowJobArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DataflowJobArgs | DataflowJobState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataflowJobState | undefined;
            ...
            const args = argsOrState as DataflowJobArgs | undefined;
        ...
        super(DataflowJob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface DataflowJobState {
    /**
     * List of experiments that should be used by the job. An example value is ["enable_stackdriver_agent_metrics"].
     */
    ...
    timeouts?: pulumi.Input<inputs.DataflowJobTimeouts>;
    /**
     * Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the
     * corresponding name prefixes of the new job.
     */
 ...
 */
export interface DataflowJobArgs {
    /**
     * List of experiments that should be used by the job. An example value is ["enable_stackdriver_agent_metrics"].
     */
    additionalExperiments?: pulumi.Input<pulumi.Input<string>[]>;
