...
export class AlloydbCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/alloydbCluster:AlloydbCluster';
     ...
     */
    public /*out*/ readonly trialMetadatas!: pulumi.Output<outputs.AlloydbClusterTrialMetadata[]>;
    /**
...
export interface AlloydbClusterState {
     ...
     * Contains information and all metadata related to TRIAL clusters.
     */
    trialMetadatas?: pulumi.Input<pulumi.Input<inputs.AlloydbClusterTrialMetadata>[]>;
    /**
     * The system-generated UID of the resource.
     */
