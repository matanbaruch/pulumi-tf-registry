...
export class PrivatecaCertificate extends pulumi.CustomResource {
    /**
     * Get an existing PrivatecaCertificate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivatecaCertificateState, opts?: pulumi.CustomResourceOptions): PrivatecaCertificate {
        return new PrivatecaCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/privatecaCertificate:PrivatecaCertificate';

    /**
     * Returns true if the given object is an instance of PrivatecaCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PrivatecaCertificate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PrivatecaCertificate.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly certificateDescriptions!: pulumi.Output<outputs.PrivatecaCertificateCertificateDescription[]>;
    /**
     ...
     */
    public readonly config!: pulumi.Output<outputs.PrivatecaCertificateConfig | undefined>;
    /**
     ...
     * this field is present.
     */
    public /*out*/ readonly revocationDetails!: pulumi.Output<outputs.PrivatecaCertificateRevocationDetail[]>;
    /**
     * The combination of labels configured directly on the resource and default labels configured on the provider.
     */
    public /*out*/ readonly terraformLabels!: pulumi.Output<{[key: string]: string}>;
    public readonly timeouts!: pulumi.Output<outputs.PrivatecaCertificateTimeouts | undefined>;
    /**
    ...
    /**
     * Create a PrivatecaCertificate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PrivatecaCertificateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PrivatecaCertificateArgs | PrivatecaCertificateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PrivatecaCertificateState | undefined;
            ...
            const args = argsOrState as PrivatecaCertificateArgs | undefined;
        ...
        super(PrivatecaCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface PrivatecaCertificateState {
    /**
     * The Certificate Authority ID that should issue the certificate. For example, to issue a Certificate from a Certificate
     * Authority with resource name 'projects/my-project/locations/us-central1/caPools/my-pool/certificateAuthorities/my-ca',
     * argument 'pool' should be set to 'projects/my-project/locations/us-central1/caPools/my-pool', argument
     ...
     * this field is present.
     */
    certificateDescriptions?: pulumi.Input<pulumi.Input<inputs.PrivatecaCertificateCertificateDescription>[]>;
    /**
     * The resource name for a CertificateTemplate used to issue this certificate, in the format
     * 'projects/*&#47;locations/*&#47;certificateTemplates/*'. If this is specified, the caller must have the necessary permission to
     * use this template. If this is omitted, no template will be used. This template must be in the same location as the
     ...
     * The config used to create a self-signed X.509 certificate or CSR.
     */
    config?: pulumi.Input<inputs.PrivatecaCertificateConfig>;
    /**
     * The time that this resource was created on the server. This is in RFC3339 text format.
     */
     ...
     * this field is present.
     */
    revocationDetails?: pulumi.Input<pulumi.Input<inputs.PrivatecaCertificateRevocationDetail>[]>;
    /**
     * The combination of labels configured directly on the resource and default labels configured on the provider.
     */
    terraformLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.PrivatecaCertificateTimeouts>;
    /**
     * Output only. The time at which this CertificateAuthority was updated. This is in RFC3339 text format.
     */
 ...
 */
export interface PrivatecaCertificateArgs {
    /**
     * The Certificate Authority ID that should issue the certificate. For example, to issue a Certificate from a Certificate
     * Authority with resource name 'projects/my-project/locations/us-central1/caPools/my-pool/certificateAuthorities/my-ca',
     * argument 'pool' should be set to 'projects/my-project/locations/us-central1/caPools/my-pool', argument
