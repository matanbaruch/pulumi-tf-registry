...
export class FolderAccessApprovalSettings extends pulumi.CustomResource {
    /**
     * Get an existing FolderAccessApprovalSettings resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FolderAccessApprovalSettingsState, opts?: pulumi.CustomResourceOptions): FolderAccessApprovalSettings {
        return new FolderAccessApprovalSettings(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/folderAccessApprovalSettings:FolderAccessApprovalSettings';

    /**
     * Returns true if the given object is an instance of FolderAccessApprovalSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FolderAccessApprovalSettings {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FolderAccessApprovalSettings.__pulumiType;
    }
     ...
     */
    public readonly enrolledServices!: pulumi.Output<outputs.FolderAccessApprovalSettingsEnrolledService[]>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.FolderAccessApprovalSettingsTimeouts | undefined>;

    /**
     * Create a FolderAccessApprovalSettings resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FolderAccessApprovalSettingsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FolderAccessApprovalSettingsArgs | FolderAccessApprovalSettingsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FolderAccessApprovalSettingsState | undefined;
            ...
            const args = argsOrState as FolderAccessApprovalSettingsArgs | undefined;
        ...
        super(FolderAccessApprovalSettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface FolderAccessApprovalSettingsState {
    /**
     * The asymmetric crypto key version to use for signing approval requests. Empty active_key_version indicates that a
     * Google-managed key should be used for signing. This property will be ignored if set by an ancestor of the resource, and
     * new non-empty values may not be set.
     ...
     * expanded as the set of supported services is expanded.
     */
    enrolledServices?: pulumi.Input<pulumi.Input<inputs.FolderAccessApprovalSettingsEnrolledService>[]>;
    /**
     * ID of the folder of the access approval settings.
     */
    ...
    timeouts?: pulumi.Input<inputs.FolderAccessApprovalSettingsTimeouts>;
}

/**
 * The set of arguments for constructing a FolderAccessApprovalSettings resource.
 */
export interface FolderAccessApprovalSettingsArgs {
    /**
     * The asymmetric crypto key version to use for signing approval requests. Empty active_key_version indicates that a
     * Google-managed key should be used for signing. This property will be ignored if set by an ancestor of the resource, and
     * new non-empty values may not be set.
