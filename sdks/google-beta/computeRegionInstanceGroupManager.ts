...
export class ComputeRegionInstanceGroupManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeRegionInstanceGroupManager:ComputeRegionInstanceGroupManager';
     ...
     */
    public readonly params!: pulumi.Output<outputs.ComputeRegionInstanceGroupManagerParams | undefined>;
    /**
     ...
     */
    public readonly standbyPolicy!: pulumi.Output<outputs.ComputeRegionInstanceGroupManagerStandbyPolicy | undefined>;
    /**
...
export interface ComputeRegionInstanceGroupManagerState {
     ...
     * Input only additional params for instance group manager creation.
     */
    params?: pulumi.Input<inputs.ComputeRegionInstanceGroupManagerParams>;
    /**
     * The ID of the project in which the resource belongs. If it is not provided, the provider project is used.
     */
     ...
     * Standby policy for stopped and suspended instances.
     */
    standbyPolicy?: pulumi.Input<inputs.ComputeRegionInstanceGroupManagerStandbyPolicy>;
    /**
     * Disks created on the instances that will be preserved on instance delete, update, etc. Structure is documented below.
     * For more information see the official documentation. Proactive cross zone instance redistribution must be disabled
     * before you can update stateful disks on existing instance group managers. This can be controlled via the update_policy.
