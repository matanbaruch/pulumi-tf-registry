...
export class NetappVolume extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/netappVolume:NetappVolume';
     ...
     */
    public readonly backupConfig!: pulumi.Output<outputs.NetappVolumeBackupConfig | undefined>;
    /**
     ...
     * such a volume will fail. Setting this parameter to FORCE will delete volumes including nested snapshots.
     */
     ...
     */
    public readonly exportPolicy!: pulumi.Output<outputs.NetappVolumeExportPolicy | undefined>;
    /**
     ...
     */
    public /*out*/ readonly mountOptions!: pulumi.Output<outputs.NetappVolumeMountOption[]>;
    /**
     ...
     */
    public readonly restoreParameters!: pulumi.Output<outputs.NetappVolumeRestoreParameters | undefined>;
    /**
     ...
     */
    public readonly snapshotPolicy!: pulumi.Output<outputs.NetappVolumeSnapshotPolicy | undefined>;
    /**
     * State of the volume.
     */
...
export interface NetappVolumeState {
     ...
     * Backup configuration for the volume.
     */
    backupConfig?: pulumi.Input<inputs.NetappVolumeBackupConfig>;
    /**
     * Capacity of the volume (in GiB).
     */
     ...
     * Export policy of the volume for NFSV3 and/or NFSV4.1 access.
     */
    exportPolicy?: pulumi.Input<inputs.NetappVolumeExportPolicy>;
    /**
     * Indicates whether the volume is part of a volume replication relationship.
     */
     ...
     * Reports mount instructions for this volume.
     */
    mountOptions?: pulumi.Input<pulumi.Input<inputs.NetappVolumeMountOption>[]>;
    /**
     * The name of the volume. Needs to be unique per location.
     */
     ...
     * Used to create this volume from a snapshot (= cloning) or an backup.
     */
    restoreParameters?: pulumi.Input<inputs.NetappVolumeRestoreParameters>;
    /**
     * List of actions that are restricted on this volume. Possible values: ["DELETE"]
     */
     ...
     * remove the whole snapshot_policy block.
     */
    snapshotPolicy?: pulumi.Input<inputs.NetappVolumeSnapshotPolicy>;
    /**
     * State of the volume.
     */
