...
export class PubsubSubscription extends pulumi.CustomResource {
    /**
     * Get an existing PubsubSubscription resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PubsubSubscriptionState, opts?: pulumi.CustomResourceOptions): PubsubSubscription {
        return new PubsubSubscription(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/pubsubSubscription:PubsubSubscription';

    /**
     * Returns true if the given object is an instance of PubsubSubscription.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PubsubSubscription {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PubsubSubscription.__pulumiType;
    }
     ...
     */
    public readonly bigqueryConfig!: pulumi.Output<outputs.PubsubSubscriptionBigqueryConfig | undefined>;
    /**
     * If delivery to Cloud Storage is used with this subscription, this field is used to configure it. Either pushConfig,
     * bigQueryConfig or cloudStorageConfig can be set, but not combined. If all three are empty, then the subscriber will pull
     * and ack messages using API methods.
     */
    public readonly cloudStorageConfig!: pulumi.Output<outputs.PubsubSubscriptionCloudStorageConfig | undefined>;
    /**
     ...
     * this subscription.
     */
    public readonly deadLetterPolicy!: pulumi.Output<outputs.PubsubSubscriptionDeadLetterPolicy | undefined>;
     ...
     */
    public readonly expirationPolicy!: pulumi.Output<outputs.PubsubSubscriptionExpirationPolicy | undefined>;
    /**
     ...
     */
    public readonly pushConfig!: pulumi.Output<outputs.PubsubSubscriptionPushConfig | undefined>;
    /**
     ...
     */
    public readonly retryPolicy!: pulumi.Output<outputs.PubsubSubscriptionRetryPolicy | undefined>;
    /**
     * The combination of labels configured directly on the resource and default labels configured on the provider.
     */
    public /*out*/ readonly terraformLabels!: pulumi.Output<{[key: string]: string}>;
    public readonly timeouts!: pulumi.Output<outputs.PubsubSubscriptionTimeouts | undefined>;
    /**
    ...
    /**
     * Create a PubsubSubscription resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PubsubSubscriptionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PubsubSubscriptionArgs | PubsubSubscriptionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PubsubSubscriptionState | undefined;
            ...
            const args = argsOrState as PubsubSubscriptionArgs | undefined;
        ...
        super(PubsubSubscription.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PubsubSubscriptionState {
     ...
     * and ack messages using API methods.
     */
    bigqueryConfig?: pulumi.Input<inputs.PubsubSubscriptionBigqueryConfig>;
    /**
     * If delivery to Cloud Storage is used with this subscription, this field is used to configure it. Either pushConfig,
     * bigQueryConfig or cloudStorageConfig can be set, but not combined. If all three are empty, then the subscriber will pull
     * and ack messages using API methods.
     */
    cloudStorageConfig?: pulumi.Input<inputs.PubsubSubscriptionCloudStorageConfig>;
    /**
     * A policy that specifies the conditions for dead lettering messages in this subscription. If dead_letter_policy is not
     * set, dead lettering is disabled. The Cloud Pub/Sub service account associated with this subscription's parent project
     * (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to Acknowledge() messages on
     * this subscription.
     */
    deadLetterPolicy?: pulumi.Input<inputs.PubsubSubscriptionDeadLetterPolicy>;
     ...
     * "", the resource never expires. The minimum allowed value for expirationPolicy.ttl is 1 day.
     */
    expirationPolicy?: pulumi.Input<inputs.PubsubSubscriptionExpirationPolicy>;
    /**
     * The subscription only delivers the messages that match the filter. Pub/Sub automatically acknowledges the messages that
     * don't match the filter. You can filter messages by their attributes. The maximum length of a filter is 256 bytes. After
     * creating the subscription, you can't modify the filter.
     ...
     * the subscriber will pull and ack messages using API methods.
     */
    pushConfig?: pulumi.Input<inputs.PubsubSubscriptionPushConfig>;
    /**
     * Indicates whether to retain acknowledged messages. If 'true', then messages are not expunged from the subscription's
     * backlog, even if they are acknowledged, until they fall out of the messageRetentionDuration window.
     */
     ...
     * RetryPolicy will be triggered on NACKs or acknowledgement deadline exceeded events for a given message
     */
    retryPolicy?: pulumi.Input<inputs.PubsubSubscriptionRetryPolicy>;
    /**
     * The combination of labels configured directly on the resource and default labels configured on the provider.
     */
    terraformLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.PubsubSubscriptionTimeouts>;
    /**
     * A reference to a Topic resource, of the form projects/{project}/topics/{{name}} (as in the id property of a
     * google_pubsub_topic), or just a topic name if the topic is in the same project as the subscription.
     */
 ...
 */
export interface PubsubSubscriptionArgs {
    /**
     * This value is the maximum time after a subscriber receives a message before the subscriber should acknowledge the
     * message. After message delivery but before the ack deadline expires and before the message is acknowledged, it is an
     * outstanding message and will not be delivered again during that time (on a best-effort basis). For pull subscriptions,
