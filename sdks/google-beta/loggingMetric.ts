...
export class LoggingMetric extends pulumi.CustomResource {
    /**
     * Get an existing LoggingMetric resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LoggingMetricState, opts?: pulumi.CustomResourceOptions): LoggingMetric {
        return new LoggingMetric(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/loggingMetric:LoggingMetric';

    /**
     * Returns true if the given object is an instance of LoggingMetric.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LoggingMetric {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LoggingMetric.__pulumiType;
    }
     ...
     */
    public readonly bucketOptions!: pulumi.Output<outputs.LoggingMetricBucketOptions | undefined>;
    /**
     ...
     */
    public readonly metricDescriptor!: pulumi.Output<outputs.LoggingMetricMetricDescriptor | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.LoggingMetricTimeouts | undefined>;
    /**
    ...
    /**
     * Create a LoggingMetric resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LoggingMetricArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LoggingMetricArgs | LoggingMetricState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LoggingMetricState | undefined;
            ...
            const args = argsOrState as LoggingMetricArgs | undefined;
        ...
        super(LoggingMetric.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface LoggingMetricState {
    /**
     * The resource name of the Log Bucket that owns the Log Metric. Only Log Buckets in projects are supported. The bucket has
     * to be in the same project as the metric.
     */
     ...
     * boundaries used to create a histogram of the extracted values.
     */
    bucketOptions?: pulumi.Input<inputs.LoggingMetricBucketOptions>;
    /**
     * A description of this metric, which is used in documentation. The maximum length of the description is 8000 characters.
     */
     ...
     * of log entries matching the filter expression.
     */
    metricDescriptor?: pulumi.Input<inputs.LoggingMetricMetricDescriptor>;
    /**
     * The client-assigned metric identifier. Examples - "error_count", "nginx/requests". Metric identifiers are limited to 100
     * characters and can include only the following characters A-Z, a-z, 0-9, and the special characters _-.,+!*',()%/. The
     * forward-slash character (/) denotes a hierarchy of name pieces, and it cannot be the first character of the name.
    ...
    timeouts?: pulumi.Input<inputs.LoggingMetricTimeouts>;
    /**
     * A valueExtractor is required when using a distribution logs-based metric to extract the values to record from a log
     * entry. Two functions are supported for value extraction - EXTRACT(field) or REGEXP_EXTRACT(field, regex). The argument
     * are 1. field - The name of the log entry field from which the value is to be extracted. 2. regex - A regular expression
 ...
 */
export interface LoggingMetricArgs {
    /**
     * The resource name of the Log Bucket that owns the Log Metric. Only Log Buckets in projects are supported. The bucket has
     * to be in the same project as the metric.
     */
