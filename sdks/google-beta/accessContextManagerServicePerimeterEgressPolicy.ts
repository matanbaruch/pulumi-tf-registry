...
export class AccessContextManagerServicePerimeterEgressPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/accessContextManagerServicePerimeterEgressPolicy:AccessContextManagerServicePerimeterEgressPolicy';
