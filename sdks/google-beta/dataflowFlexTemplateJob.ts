...
export class DataflowFlexTemplateJob extends pulumi.CustomResource {
    /**
     * Get an existing DataflowFlexTemplateJob resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataflowFlexTemplateJobState, opts?: pulumi.CustomResourceOptions): DataflowFlexTemplateJob {
        return new DataflowFlexTemplateJob(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/dataflowFlexTemplateJob:DataflowFlexTemplateJob';

    /**
     * Returns true if the given object is an instance of DataflowFlexTemplateJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataflowFlexTemplateJob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataflowFlexTemplateJob.__pulumiType;
    }
    ...
    /**
     * Create a DataflowFlexTemplateJob resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DataflowFlexTemplateJobArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DataflowFlexTemplateJobArgs | DataflowFlexTemplateJobState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataflowFlexTemplateJobState | undefined;
            ...
            const args = argsOrState as DataflowFlexTemplateJobArgs | undefined;
        ...
        super(DataflowFlexTemplateJob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface DataflowFlexTemplateJobState {
    /**
     * List of experiments that should be used by the job. An example value is ["enable_stackdriver_agent_metrics"].
     */
 ...
 */
export interface DataflowFlexTemplateJobArgs {
    /**
     * List of experiments that should be used by the job. An example value is ["enable_stackdriver_agent_metrics"].
     */
    additionalExperiments?: pulumi.Input<pulumi.Input<string>[]>;
