...
export class ComputeImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeImage:ComputeImage';
     ...
     */
    public readonly guestOsFeatures!: pulumi.Output<outputs.ComputeImageGuestOsFeature[] | undefined>;
    /**
     ...
     */
    public readonly imageEncryptionKey!: pulumi.Output<outputs.ComputeImageImageEncryptionKey | undefined>;
    /**
     ...
     */
    public readonly rawDisk!: pulumi.Output<outputs.ComputeImageRawDisk | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.ComputeImageTimeouts | undefined>;
...
export interface ComputeImageState {
     ...
     * A list of features to enable on the guest operating system. Applicable only for bootable images.
     */
    guestOsFeatures?: pulumi.Input<pulumi.Input<inputs.ComputeImageGuestOsFeature>[]>;
    /**
     * Encrypts the image using a customer-supplied encryption key. After you encrypt an image with a customer-supplied key,
     * you must provide the same key if you use the image later (e.g. to create a disk from the image)
     */
    imageEncryptionKey?: pulumi.Input<inputs.ComputeImageImageEncryptionKey>;
    /**
     * The fingerprint used for optimistic locking of this resource. Used internally during updates.
     */
     ...
     * The parameters of the raw disk image.
     */
    rawDisk?: pulumi.Input<inputs.ComputeImageRawDisk>;
