...
export class ComputeInstanceFromTemplate extends pulumi.CustomResource {
    /**
     * Get an existing ComputeInstanceFromTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeInstanceFromTemplateState, opts?: pulumi.CustomResourceOptions): ComputeInstanceFromTemplate {
        return new ComputeInstanceFromTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeInstanceFromTemplate:ComputeInstanceFromTemplate';

    /**
     * Returns true if the given object is an instance of ComputeInstanceFromTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ComputeInstanceFromTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ComputeInstanceFromTemplate.__pulumiType;
    }

    /**
     * Controls for advanced machine-related behavior features.
     */
    public readonly advancedMachineFeatures!: pulumi.Output<outputs.ComputeInstanceFromTemplateAdvancedMachineFeatures | undefined>;
    public readonly allowStoppingForUpdate!: pulumi.Output<boolean>;
    /**
     * List of disks attached to the instance
     */
    public readonly attachedDisks!: pulumi.Output<outputs.ComputeInstanceFromTemplateAttachedDisk[] | undefined>;
    /**
     * The boot disk for the instance.
     */
    public readonly bootDisk!: pulumi.Output<outputs.ComputeInstanceFromTemplateBootDisk | undefined>;
    /**
     ...
     * to create.
     */
    public readonly confidentialInstanceConfig!: pulumi.Output<outputs.ComputeInstanceFromTemplateConfidentialInstanceConfig | undefined>;
    /**
     ...
     */
    public readonly guestAccelerators!: pulumi.Output<outputs.ComputeInstanceFromTemplateGuestAccelerator[] | undefined>;
    /**
     ...
     */
    public readonly networkInterfaces!: pulumi.Output<outputs.ComputeInstanceFromTemplateNetworkInterface[] | undefined>;
    /**
     * Configures network performance settings for the instance. If not specified, the instance will be created with its
     * default network performance configuration.
     */
    public readonly networkPerformanceConfig!: pulumi.Output<outputs.ComputeInstanceFromTemplateNetworkPerformanceConfig | undefined>;
    /**
     * Stores additional params passed with the request, but not persisted as part of resource payload.
     */
    public readonly params!: pulumi.Output<outputs.ComputeInstanceFromTemplateParams | undefined>;
    /**
     ...
     */
    public readonly reservationAffinity!: pulumi.Output<outputs.ComputeInstanceFromTemplateReservationAffinity | undefined>;
    /**
     ...
     */
    public readonly scheduling!: pulumi.Output<outputs.ComputeInstanceFromTemplateScheduling | undefined>;
    /**
     * The scratch disks attached to the instance.
     */
    public readonly scratchDisks!: pulumi.Output<outputs.ComputeInstanceFromTemplateScratchDisk[] | undefined>;
    /**
     ...
     */
    public readonly serviceAccount!: pulumi.Output<outputs.ComputeInstanceFromTemplateServiceAccount | undefined>;
    /**
     * The shielded vm config being used by the instance.
     */
    public readonly shieldedInstanceConfig!: pulumi.Output<outputs.ComputeInstanceFromTemplateShieldedInstanceConfig | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ComputeInstanceFromTemplateTimeouts | undefined>;
    /**
    ...
    /**
     * Create a ComputeInstanceFromTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ComputeInstanceFromTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ComputeInstanceFromTemplateArgs | ComputeInstanceFromTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ComputeInstanceFromTemplateState | undefined;
            ...
            const args = argsOrState as ComputeInstanceFromTemplateArgs | undefined;
        ...
        super(ComputeInstanceFromTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ComputeInstanceFromTemplateState {
    /**
     * Controls for advanced machine-related behavior features.
     */
    advancedMachineFeatures?: pulumi.Input<inputs.ComputeInstanceFromTemplateAdvancedMachineFeatures>;
    allowStoppingForUpdate?: pulumi.Input<boolean>;
    /**
     * List of disks attached to the instance
     */
    attachedDisks?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceFromTemplateAttachedDisk>[]>;
    /**
     * The boot disk for the instance.
     */
    bootDisk?: pulumi.Input<inputs.ComputeInstanceFromTemplateBootDisk>;
    /**
     * Whether sending and receiving of packets with non-matching source or destination IPs is allowed.
     */
     ...
     * to create.
     */
    confidentialInstanceConfig?: pulumi.Input<inputs.ComputeInstanceFromTemplateConfidentialInstanceConfig>;
    /**
     * The CPU platform used by this instance.
     */
     ...
     * List of the type and count of accelerator cards attached to the instance.
     */
    guestAccelerators?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceFromTemplateGuestAccelerator>[]>;
    /**
     * A custom hostname for the instance. Must be a fully qualified DNS name and RFC-1035-valid. Valid format is a series of
     * labels 1-63 characters long matching the regular expression a-z, concatenated with periods. The entire hostname must not
     * exceed 253 characters. Changing this forces a new resource to be created.
     ...
     * The networks attached to the instance.
     */
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceFromTemplateNetworkInterface>[]>;
    /**
     * Configures network performance settings for the instance. If not specified, the instance will be created with its
     * default network performance configuration.
     */
    networkPerformanceConfig?: pulumi.Input<inputs.ComputeInstanceFromTemplateNetworkPerformanceConfig>;
    /**
     * Stores additional params passed with the request, but not persisted as part of resource payload.
     */
    params?: pulumi.Input<inputs.ComputeInstanceFromTemplateParams>;
    /**
     * Partner Metadata Map made available within the instance.
     */
     ...
     * Specifies the reservations that this instance can consume from.
     */
    reservationAffinity?: pulumi.Input<inputs.ComputeInstanceFromTemplateReservationAffinity>;
    /**
     * A list of self_links of resource policies to attach to the instance. Currently a max of 1 resource policy is supported.
     */
     ...
     * The scheduling strategy being used by the instance.
     */
    scheduling?: pulumi.Input<inputs.ComputeInstanceFromTemplateScheduling>;
    /**
     * The scratch disks attached to the instance.
     */
    scratchDisks?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceFromTemplateScratchDisk>[]>;
    /**
     * The URI of the created resource.
     */
     ...
     * The service account to attach to the instance.
     */
    serviceAccount?: pulumi.Input<inputs.ComputeInstanceFromTemplateServiceAccount>;
    /**
     * The shielded vm config being used by the instance.
     */
    shieldedInstanceConfig?: pulumi.Input<inputs.ComputeInstanceFromTemplateShieldedInstanceConfig>;
    /**
     * Name or self link of an instance template to create the instance based on.
     */
    ...
    timeouts?: pulumi.Input<inputs.ComputeInstanceFromTemplateTimeouts>;
    /**
     * The zone of the instance. If self_link is provided, this value is ignored. If neither self_link nor zone are provided,
     * the provider zone is used.
     */
 ...
 */
export interface ComputeInstanceFromTemplateArgs {
    /**
     * Controls for advanced machine-related behavior features.
     */
    advancedMachineFeatures?: pulumi.Input<inputs.ComputeInstanceFromTemplateAdvancedMachineFeatures>;
