...
export class AlloydbInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/alloydbInstance:AlloydbInstance';
     ...
     */
    public readonly observabilityConfig!: pulumi.Output<outputs.AlloydbInstanceObservabilityConfig | undefined>;
    /**
...
export interface AlloydbInstanceState {
     ...
     * Configuration for enhanced query insights.
     */
    observabilityConfig?: pulumi.Input<inputs.AlloydbInstanceObservabilityConfig>;
    /**
     * Configuration for Private Service Connect (PSC) for the instance.
     */
