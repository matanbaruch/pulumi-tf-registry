...
export class RedisInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/redisInstance:RedisInstance';
     ...
     */
    public readonly maintenancePolicy!: pulumi.Output<outputs.RedisInstanceMaintenancePolicy | undefined>;
    /**
     * Upcoming maintenance schedule.
     */
    public /*out*/ readonly maintenanceSchedules!: pulumi.Output<outputs.RedisInstanceMaintenanceSchedule[]>;
    /**
     ...
     */
    public /*out*/ readonly nodes!: pulumi.Output<outputs.RedisInstanceNode[]>;
    /**
     * Persistence configuration for an instance.
     */
    public readonly persistenceConfig!: pulumi.Output<outputs.RedisInstancePersistenceConfig | undefined>;
    /**
     ...
     */
    public /*out*/ readonly serverCaCerts!: pulumi.Output<outputs.RedisInstanceServerCaCert[]>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.RedisInstanceTimeouts | undefined>;
    /**
...
export interface RedisInstanceState {
     ...
     * Maintenance policy for an instance.
     */
    maintenancePolicy?: pulumi.Input<inputs.RedisInstanceMaintenancePolicy>;
    /**
     * Upcoming maintenance schedule.
     */
    maintenanceSchedules?: pulumi.Input<pulumi.Input<inputs.RedisInstanceMaintenanceSchedule>[]>;
    /**
     * The self service update maintenance version.
     */
     ...
     * Output only. Info per node.
     */
    nodes?: pulumi.Input<pulumi.Input<inputs.RedisInstanceNode>[]>;
    /**
     * Persistence configuration for an instance.
     */
    persistenceConfig?: pulumi.Input<inputs.RedisInstancePersistenceConfig>;
    /**
     * Output only. Cloud IAM identity used by import / export operations to transfer data to/from Cloud Storage. Format is
     * "serviceAccount:". The value may change over time for a given instance so should be checked before each import/export
     * operation.
     ...
     * List of server CA certificates for the instance.
     */
    serverCaCerts?: pulumi.Input<pulumi.Input<inputs.RedisInstanceServerCaCert>[]>;
    /**
     * The combination of labels configured directly on the resource and default labels configured on the provider.
     */
    ...
    timeouts?: pulumi.Input<inputs.RedisInstanceTimeouts>;
    /**
     * The TLS mode of the Redis instance, If not provided, TLS is disabled for the instance. - SERVER_AUTHENTICATION: Client
     * to Server traffic encryption enabled with server authentication Default value: "DISABLED" Possible values:
     * ["SERVER_AUTHENTICATION", "DISABLED"]
