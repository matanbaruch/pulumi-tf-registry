...
export function getContainerCluster(args: GetContainerClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerClusterResult> {
    ...
    return pulumi.runtime.invoke("google-beta:index/getContainerCluster:getContainerCluster", {
        "id": args.id,
...
export interface GetContainerClusterResult {
    ...
    readonly clusterTelemetries: outputs.GetContainerClusterClusterTelemetry[];
    ...
    readonly podSecurityPolicyConfigs: outputs.GetContainerClusterPodSecurityPolicyConfig[];
    readonly privateClusterConfigs: outputs.GetContainerClusterPrivateClusterConfig[];
    readonly privateIpv6GoogleAccess: string;
    readonly project?: string;
    readonly protectConfigs: outputs.GetContainerClusterProtectConfig[];
    ...
    readonly tpuConfigs: outputs.GetContainerClusterTpuConfig[];
    readonly tpuIpv4CidrBlock: string;
    readonly verticalPodAutoscalings: outputs.GetContainerClusterVerticalPodAutoscaling[];
    readonly workloadAltsConfigs: outputs.GetContainerClusterWorkloadAltsConfig[];
