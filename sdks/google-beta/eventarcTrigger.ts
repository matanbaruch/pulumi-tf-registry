...
export class EventarcTrigger extends pulumi.CustomResource {
    /**
     * Get an existing EventarcTrigger resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EventarcTriggerState, opts?: pulumi.CustomResourceOptions): EventarcTrigger {
        return new EventarcTrigger(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/eventarcTrigger:EventarcTrigger';

    /**
     * Returns true if the given object is an instance of EventarcTrigger.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EventarcTrigger {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EventarcTrigger.__pulumiType;
    }
     ...
     */
    public readonly destination!: pulumi.Output<outputs.EventarcTriggerDestination>;
     ...
     */
    public readonly matchingCriterias!: pulumi.Output<outputs.EventarcTriggerMatchingCriteria[]>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.EventarcTriggerTimeouts | undefined>;
    /**
     ...
     */
    public readonly transport!: pulumi.Output<outputs.EventarcTriggerTransport | undefined>;
    /**
    ...
    /**
     * Create a EventarcTrigger resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: EventarcTriggerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: EventarcTriggerArgs | EventarcTriggerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EventarcTriggerState | undefined;
            ...
            const args = argsOrState as EventarcTriggerArgs | undefined;
        ...
        super(EventarcTrigger.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface EventarcTriggerState {
    /**
     * Optional. The name of the channel associated with the trigger in
     * `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from
     * Eventarc SaaS partners.
     ...
     * Required. Destination specifies where the events should be sent to.
     */
    destination?: pulumi.Input<inputs.EventarcTriggerDestination>;
     ...
     * will be sent to the destination.
     */
    matchingCriterias?: pulumi.Input<pulumi.Input<inputs.EventarcTriggerMatchingCriteria>[]>;
    /**
     * Required. The resource name of the trigger. Must be unique within the location on the project.
     */
    ...
    timeouts?: pulumi.Input<inputs.EventarcTriggerTimeouts>;
    /**
     * Optional. In order to deliver messages, Eventarc may use other GCP products as transport intermediary. This field
     * contains a reference to that transport intermediary. This information can be used for debugging purposes.
     */
    transport?: pulumi.Input<inputs.EventarcTriggerTransport>;
    /**
     * Output only. Server assigned unique identifier for the trigger. The value is a UUID4 string and guaranteed to remain
     * unchanged until the resource is deleted.
     */
 ...
 */
export interface EventarcTriggerArgs {
    /**
     * Optional. The name of the channel associated with the trigger in
     * `projects/{project}/locations/{location}/channels/{channel}` format. You must provide a channel to receive events from
     * Eventarc SaaS partners.
