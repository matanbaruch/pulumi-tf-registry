...
export class CloudAssetFolderFeed extends pulumi.CustomResource {
    /**
     * Get an existing CloudAssetFolderFeed resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudAssetFolderFeedState, opts?: pulumi.CustomResourceOptions): CloudAssetFolderFeed {
        return new CloudAssetFolderFeed(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/cloudAssetFolderFeed:CloudAssetFolderFeed';

    /**
     * Returns true if the given object is an instance of CloudAssetFolderFeed.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudAssetFolderFeed {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudAssetFolderFeed.__pulumiType;
    }
     ...
     */
    public readonly condition!: pulumi.Output<outputs.CloudAssetFolderFeedCondition | undefined>;
    /**
     ...
     */
    public readonly feedOutputConfig!: pulumi.Output<outputs.CloudAssetFolderFeedFeedOutputConfig>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.CloudAssetFolderFeedTimeouts | undefined>;

    /**
     * Create a CloudAssetFolderFeed resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudAssetFolderFeedArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudAssetFolderFeedArgs | CloudAssetFolderFeedState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudAssetFolderFeedState | undefined;
            ...
            const args = argsOrState as CloudAssetFolderFeedArgs | undefined;
        ...
        super(CloudAssetFolderFeed.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface CloudAssetFolderFeedState {
    /**
     * A list of the full names of the assets to receive updates. You must specify either or both of assetNames and assetTypes.
     * Only asset updates matching specified assetNames and assetTypes are exported to the feed. For example:
     * //compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1. See
     ...
     * Other fields of condition are optional.
     */
    condition?: pulumi.Input<inputs.CloudAssetFolderFeedCondition>;
    /**
     * Asset content type. If not specified, no content but the asset name and type will be returned. Possible values:
     * ["CONTENT_TYPE_UNSPECIFIED", "RESOURCE", "IAM_POLICY", "ORG_POLICY", "OS_INVENTORY", "ACCESS_POLICY"]
     */
     ...
     * Output configuration for asset feed destination.
     */
    feedOutputConfig?: pulumi.Input<inputs.CloudAssetFolderFeedFeedOutputConfig>;
    /**
     * The folder this feed should be created in.
     */
    ...
    timeouts?: pulumi.Input<inputs.CloudAssetFolderFeedTimeouts>;
}

/**
 * The set of arguments for constructing a CloudAssetFolderFeed resource.
 */
export interface CloudAssetFolderFeedArgs {
    /**
     * A list of the full names of the assets to receive updates. You must specify either or both of assetNames and assetTypes.
     * Only asset updates matching specified assetNames and assetTypes are exported to the feed. For example:
     * //compute.googleapis.com/projects/my_project_123/zones/zone1/instances/instance1. See
