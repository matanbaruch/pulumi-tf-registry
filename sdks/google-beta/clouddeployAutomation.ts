...
export class ClouddeployAutomation extends pulumi.CustomResource {
    /**
     * Get an existing ClouddeployAutomation resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClouddeployAutomationState, opts?: pulumi.CustomResourceOptions): ClouddeployAutomation {
        return new ClouddeployAutomation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/clouddeployAutomation:ClouddeployAutomation';

    /**
     * Returns true if the given object is an instance of ClouddeployAutomation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClouddeployAutomation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClouddeployAutomation.__pulumiType;
    }
     ...
     */
    public readonly rules!: pulumi.Output<outputs.ClouddeployAutomationRule[]>;
    /**
     * Required. Selected resources to which the automation will be applied.
     */
    public readonly selector!: pulumi.Output<outputs.ClouddeployAutomationSelector>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClouddeployAutomationTimeouts | undefined>;
    /**
    ...
    /**
     * Create a ClouddeployAutomation resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClouddeployAutomationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClouddeployAutomationArgs | ClouddeployAutomationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClouddeployAutomationState | undefined;
            ...
            const args = argsOrState as ClouddeployAutomationArgs | undefined;
        ...
        super(ClouddeployAutomation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ClouddeployAutomationState {
    /**
     * Optional. User annotations. These attributes can only be set and used by the user, and not by Cloud Deploy. Annotations
     * must meet the following constraints: * Annotations are key/value pairs. * Valid annotation keys have two segments: an
     * optional prefix and name, separated by a slash ('/'). * The name segment is required and must be 63 characters or less,
     ...
     * 250 rules per Delivery Pipeline. Note: the order of the rules here is not the same as the order of execution.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.ClouddeployAutomationRule>[]>;
    /**
     * Required. Selected resources to which the automation will be applied.
     */
    selector?: pulumi.Input<inputs.ClouddeployAutomationSelector>;
    /**
     * Required. Email address of the user-managed IAM service account that creates Cloud Deploy release and rollout resources.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClouddeployAutomationTimeouts>;
    /**
     * Output only. Unique identifier of the 'Automation'.
     */
 ...
 */
export interface ClouddeployAutomationArgs {
    /**
     * Optional. User annotations. These attributes can only be set and used by the user, and not by Cloud Deploy. Annotations
     * must meet the following constraints: * Annotations are key/value pairs. * Valid annotation keys have two segments: an
     * optional prefix and name, separated by a slash ('/'). * The name segment is required and must be 63 characters or less,
