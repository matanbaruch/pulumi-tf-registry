...
export class SccMuteConfig extends pulumi.CustomResource {
    /**
     * Get an existing SccMuteConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SccMuteConfigState, opts?: pulumi.CustomResourceOptions): SccMuteConfig {
        return new SccMuteConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/sccMuteConfig:SccMuteConfig';

    /**
     * Returns true if the given object is an instance of SccMuteConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SccMuteConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SccMuteConfig.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.SccMuteConfigTimeouts | undefined>;
    /**
    ...
    /**
     * Create a SccMuteConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SccMuteConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SccMuteConfigArgs | SccMuteConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SccMuteConfigState | undefined;
            ...
            const args = argsOrState as SccMuteConfigArgs | undefined;
        ...
        super(SccMuteConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface SccMuteConfigState {
    /**
     * The time at which the mute config was created. This field is set by the server and will be ignored if provided on config
     * creation.
     */
    ...
    timeouts?: pulumi.Input<inputs.SccMuteConfigTimeouts>;
    /**
     * Output only. The most recent time at which the mute config was updated. This field is set by the server and will be
     * ignored if provided on config creation or update.
     */
 ...
 */
export interface SccMuteConfigArgs {
    /**
     * A description of the mute config.
     */
    description?: pulumi.Input<string>;
