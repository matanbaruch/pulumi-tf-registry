...
export class DocumentAiWarehouseDocumentSchema extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/documentAiWarehouseDocumentSchema:DocumentAiWarehouseDocumentSchema';
     ...
     */
    public readonly propertyDefinitions!: pulumi.Output<outputs.DocumentAiWarehouseDocumentSchemaPropertyDefinition[]>;
    public readonly timeouts!: pulumi.Output<outputs.DocumentAiWarehouseDocumentSchemaTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DocumentAiWarehouseDocumentSchemaArgs | DocumentAiWarehouseDocumentSchemaState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DocumentAiWarehouseDocumentSchema.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DocumentAiWarehouseDocumentSchemaState {
     ...
     * Defines the metadata for a schema property.
     */
    propertyDefinitions?: pulumi.Input<pulumi.Input<inputs.DocumentAiWarehouseDocumentSchemaPropertyDefinition>[]>;
    timeouts?: pulumi.Input<inputs.DocumentAiWarehouseDocumentSchemaTimeouts>;
}
