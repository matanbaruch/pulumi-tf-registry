...
export class ContainerAzureCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/containerAzureCluster:ContainerAzureCluster';
     ...
     */
    public readonly loggingConfig!: pulumi.Output<outputs.ContainerAzureClusterLoggingConfig | undefined>;
    /**
...
export interface ContainerAzureClusterState {
     ...
     * Logging configuration.
     */
    loggingConfig?: pulumi.Input<inputs.ContainerAzureClusterLoggingConfig>;
    /**
     * The name of this resource.
     */
