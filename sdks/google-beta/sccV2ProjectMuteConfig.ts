...
export class SccV2ProjectMuteConfig extends pulumi.CustomResource {
    /**
     * Get an existing SccV2ProjectMuteConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SccV2ProjectMuteConfigState, opts?: pulumi.CustomResourceOptions): SccV2ProjectMuteConfig {
        return new SccV2ProjectMuteConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/sccV2ProjectMuteConfig:SccV2ProjectMuteConfig';

    /**
     * Returns true if the given object is an instance of SccV2ProjectMuteConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SccV2ProjectMuteConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SccV2ProjectMuteConfig.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.SccV2ProjectMuteConfigTimeouts | undefined>;
    /**
    ...
    /**
     * Create a SccV2ProjectMuteConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SccV2ProjectMuteConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SccV2ProjectMuteConfigArgs | SccV2ProjectMuteConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SccV2ProjectMuteConfigState | undefined;
            ...
            const args = argsOrState as SccV2ProjectMuteConfigArgs | undefined;
        ...
        super(SccV2ProjectMuteConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface SccV2ProjectMuteConfigState {
    /**
     * The time at which the mute config was created. This field is set by the server and will be ignored if provided on config
     * creation.
     */
    ...
    timeouts?: pulumi.Input<inputs.SccV2ProjectMuteConfigTimeouts>;
    /**
     * The type of the mute config.
     */
 ...
 */
export interface SccV2ProjectMuteConfigArgs {
    /**
     * A description of the mute config.
     */
    description?: pulumi.Input<string>;
