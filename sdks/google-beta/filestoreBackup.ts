...
export class FilestoreBackup extends pulumi.CustomResource {
    /**
     * Get an existing FilestoreBackup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FilestoreBackupState, opts?: pulumi.CustomResourceOptions): FilestoreBackup {
        return new FilestoreBackup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/filestoreBackup:FilestoreBackup';

    /**
     * Returns true if the given object is an instance of FilestoreBackup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FilestoreBackup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FilestoreBackup.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.FilestoreBackupTimeouts | undefined>;

    /**
     * Create a FilestoreBackup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FilestoreBackupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FilestoreBackupArgs | FilestoreBackupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FilestoreBackupState | undefined;
            ...
            const args = argsOrState as FilestoreBackupArgs | undefined;
        ...
        super(FilestoreBackup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface FilestoreBackupState {
    /**
     * The amount of bytes needed to allocate a full copy of the snapshot content.
     */
    ...
    timeouts?: pulumi.Input<inputs.FilestoreBackupTimeouts>;
}

/**
 * The set of arguments for constructing a FilestoreBackup resource.
 */
export interface FilestoreBackupArgs {
    /**
     * A description of the backup with 2048 characters or less. Requests with longer descriptions will be rejected.
     */
    description?: pulumi.Input<string>;
