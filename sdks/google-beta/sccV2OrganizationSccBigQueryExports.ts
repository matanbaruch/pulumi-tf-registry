...
export class SccV2OrganizationSccBigQueryExports extends pulumi.CustomResource {
    /**
     * Get an existing SccV2OrganizationSccBigQueryExports resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SccV2OrganizationSccBigQueryExportsState, opts?: pulumi.CustomResourceOptions): SccV2OrganizationSccBigQueryExports {
        return new SccV2OrganizationSccBigQueryExports(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/sccV2OrganizationSccBigQueryExports:SccV2OrganizationSccBigQueryExports';

    /**
     * Returns true if the given object is an instance of SccV2OrganizationSccBigQueryExports.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SccV2OrganizationSccBigQueryExports {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SccV2OrganizationSccBigQueryExports.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.SccV2OrganizationSccBigQueryExportsTimeouts | undefined>;
    /**
    ...
    /**
     * Create a SccV2OrganizationSccBigQueryExports resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SccV2OrganizationSccBigQueryExportsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SccV2OrganizationSccBigQueryExportsArgs | SccV2OrganizationSccBigQueryExportsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SccV2OrganizationSccBigQueryExportsState | undefined;
            ...
            const args = argsOrState as SccV2OrganizationSccBigQueryExportsArgs | undefined;
        ...
        super(SccV2OrganizationSccBigQueryExports.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface SccV2OrganizationSccBigQueryExportsState {
    /**
     * This must be unique within the organization.
     */
    ...
    timeouts?: pulumi.Input<inputs.SccV2OrganizationSccBigQueryExportsTimeouts>;
    /**
     * The most recent time at which the BigQuery export was updated. This field is set by the server and will be ignored if
     * provided on export creation or update. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to
     * nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
 ...
 */
export interface SccV2OrganizationSccBigQueryExportsArgs {
    /**
     * This must be unique within the organization.
     */
    bigQueryExportId: pulumi.Input<string>;
