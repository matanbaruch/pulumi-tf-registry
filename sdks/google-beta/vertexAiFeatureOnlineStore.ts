...
export class VertexAiFeatureOnlineStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/vertexAiFeatureOnlineStore:VertexAiFeatureOnlineStore';
     ...
     */
    public readonly embeddingManagement!: pulumi.Output<outputs.VertexAiFeatureOnlineStoreEmbeddingManagement | undefined>;
    /**
...
export interface VertexAiFeatureOnlineStoreState {
     ...
     * @deprecated Deprecated
     */
    embeddingManagement?: pulumi.Input<inputs.VertexAiFeatureOnlineStoreEmbeddingManagement>;
    /**
     * Used to perform consistent read-modify-write updates.
     */
