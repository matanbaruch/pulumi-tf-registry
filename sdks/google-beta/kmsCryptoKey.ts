...
export class KmsCryptoKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/kmsCryptoKey:KmsCryptoKey';
     ...
     * to change.
     */
    public readonly keyAccessJustificationsPolicy!: pulumi.Output<outputs.KmsCryptoKeyKeyAccessJustificationsPolicy | undefined>;
    /**
...
export interface KmsCryptoKeyState {
     ...
     * to change.
     */
    keyAccessJustificationsPolicy?: pulumi.Input<inputs.KmsCryptoKeyKeyAccessJustificationsPolicy>;
    /**
     * The KeyRing that this key belongs to. Format: ''projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}''.
     */
