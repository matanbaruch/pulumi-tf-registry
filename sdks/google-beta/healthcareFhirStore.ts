...
export class HealthcareFhirStore extends pulumi.CustomResource {
    /**
     * Get an existing HealthcareFhirStore resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HealthcareFhirStoreState, opts?: pulumi.CustomResourceOptions): HealthcareFhirStore {
        return new HealthcareFhirStore(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/healthcareFhirStore:HealthcareFhirStore';

    /**
     * Returns true if the given object is an instance of HealthcareFhirStore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HealthcareFhirStore {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HealthcareFhirStore.__pulumiType;
    }
     ...
     */
    public readonly notificationConfig!: pulumi.Output<outputs.HealthcareFhirStoreNotificationConfig | undefined>;
    /**
     * A list of notifcation configs that configure the notification for every resource mutation in this FHIR store.
     */
    public readonly notificationConfigs!: pulumi.Output<outputs.HealthcareFhirStoreNotificationConfig[] | undefined>;
    /**
     ...
     */
    public readonly streamConfigs!: pulumi.Output<outputs.HealthcareFhirStoreStreamConfig[] | undefined>;
    /**
     * The combination of labels configured directly on the resource and default labels configured on the provider.
     */
    public /*out*/ readonly terraformLabels!: pulumi.Output<{[key: string]: string}>;
    public readonly timeouts!: pulumi.Output<outputs.HealthcareFhirStoreTimeouts | undefined>;
    /**
    ...
    /**
     * Create a HealthcareFhirStore resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: HealthcareFhirStoreArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HealthcareFhirStoreArgs | HealthcareFhirStoreState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HealthcareFhirStoreState | undefined;
            ...
            const args = argsOrState as HealthcareFhirStoreArgs | undefined;
        ...
        super(HealthcareFhirStore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface HealthcareFhirStoreState {
    /**
     * Enable parsing of references within complex FHIR data types such as Extensions. If this value is set to ENABLED, then
     * features like referential integrity and Bundle reference rewriting apply to all references. If this flag has not been
     * specified the behavior of the FHIR store will not change, references in complex data types will not be parsed. New
     ...
     * @deprecated Deprecated
     */
    notificationConfig?: pulumi.Input<inputs.HealthcareFhirStoreNotificationConfig>;
    /**
     * A list of notifcation configs that configure the notification for every resource mutation in this FHIR store.
     */
    notificationConfigs?: pulumi.Input<pulumi.Input<inputs.HealthcareFhirStoreNotificationConfig>[]>;
    /**
     * The fully qualified name of this dataset
     */
     ...
     * expected before the results show up in the streaming destination.
     */
    streamConfigs?: pulumi.Input<pulumi.Input<inputs.HealthcareFhirStoreStreamConfig>[]>;
    /**
     * The combination of labels configured directly on the resource and default labels configured on the provider.
     */
    terraformLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.HealthcareFhirStoreTimeouts>;
    /**
     * The FHIR specification version. Default value: "STU3" Possible values: ["DSTU2", "STU3", "R4"]
     */
 ...
 */
export interface HealthcareFhirStoreArgs {
    /**
     * Enable parsing of references within complex FHIR data types such as Extensions. If this value is set to ENABLED, then
     * features like referential integrity and Bundle reference rewriting apply to all references. If this flag has not been
     * specified the behavior of the FHIR store will not change, references in complex data types will not be parsed. New
