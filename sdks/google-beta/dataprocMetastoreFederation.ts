...
export class DataprocMetastoreFederation extends pulumi.CustomResource {
    /**
     * Get an existing DataprocMetastoreFederation resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataprocMetastoreFederationState, opts?: pulumi.CustomResourceOptions): DataprocMetastoreFederation {
        return new DataprocMetastoreFederation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/dataprocMetastoreFederation:DataprocMetastoreFederation';

    /**
     * Returns true if the given object is an instance of DataprocMetastoreFederation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataprocMetastoreFederation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataprocMetastoreFederation.__pulumiType;
    }
     ...
     */
    public readonly backendMetastores!: pulumi.Output<outputs.DataprocMetastoreFederationBackendMetastore[]>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.DataprocMetastoreFederationTimeouts | undefined>;
    /**
    ...
    /**
     * Create a DataprocMetastoreFederation resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DataprocMetastoreFederationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DataprocMetastoreFederationArgs | DataprocMetastoreFederationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataprocMetastoreFederationState | undefined;
            ...
            const args = argsOrState as DataprocMetastoreFederationArgs | undefined;
        ...
        super(DataprocMetastoreFederation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface DataprocMetastoreFederationState {
    /**
     * A map from BackendMetastore rank to BackendMetastores from which the federation service serves metadata at query time.
     * The map key represents the order in which BackendMetastores should be evaluated to resolve database names at query time
     * and should be greater than or equal to zero. A BackendMetastore with a lower number will be evaluated before a
     * BackendMetastore with a higher number.
     */
    backendMetastores?: pulumi.Input<pulumi.Input<inputs.DataprocMetastoreFederationBackendMetastore>[]>;
    ...
    timeouts?: pulumi.Input<inputs.DataprocMetastoreFederationTimeouts>;
    /**
     * The globally unique resource identifier of the metastore federation.
     */
 ...
 */
export interface DataprocMetastoreFederationArgs {
    /**
     * A map from BackendMetastore rank to BackendMetastores from which the federation service serves metadata at query time.
     * The map key represents the order in which BackendMetastores should be evaluated to resolve database names at query time
     * and should be greater than or equal to zero. A BackendMetastore with a lower number will be evaluated before a
