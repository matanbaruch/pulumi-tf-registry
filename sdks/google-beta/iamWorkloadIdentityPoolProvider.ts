...
export class IamWorkloadIdentityPoolProvider extends pulumi.CustomResource {
    /**
     * Get an existing IamWorkloadIdentityPoolProvider resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IamWorkloadIdentityPoolProviderState, opts?: pulumi.CustomResourceOptions): IamWorkloadIdentityPoolProvider {
        return new IamWorkloadIdentityPoolProvider(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/iamWorkloadIdentityPoolProvider:IamWorkloadIdentityPoolProvider';

    /**
     * Returns true if the given object is an instance of IamWorkloadIdentityPoolProvider.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IamWorkloadIdentityPoolProvider {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IamWorkloadIdentityPoolProvider.__pulumiType;
    }
     ...
     */
    public readonly aws!: pulumi.Output<outputs.IamWorkloadIdentityPoolProviderAws | undefined>;
    /**
     ...
     */
    public readonly oidc!: pulumi.Output<outputs.IamWorkloadIdentityPoolProviderOidc | undefined>;
    public readonly project!: pulumi.Output<string>;
    /**
     * An SAML 2.0 identity provider. Not compatible with the property oidc or aws.
     */
    public readonly saml!: pulumi.Output<outputs.IamWorkloadIdentityPoolProviderSaml | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.IamWorkloadIdentityPoolProviderTimeouts | undefined>;
    /**
    ...
    /**
     * Create a IamWorkloadIdentityPoolProvider resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IamWorkloadIdentityPoolProviderArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IamWorkloadIdentityPoolProviderArgs | IamWorkloadIdentityPoolProviderState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IamWorkloadIdentityPoolProviderState | undefined;
            ...
            const args = argsOrState as IamWorkloadIdentityPoolProviderArgs | undefined;
        ...
        super(IamWorkloadIdentityPoolProvider.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface IamWorkloadIdentityPoolProviderState {
    /**
     * [A Common Expression Language](https://opensource.google/projects/cel) expression, in plain text, to restrict what
     * otherwise valid authentication credentials issued by the provider should not be accepted. The expression must output a
     * boolean representing whether to allow the federation. The following keywords may be referenced in the expressions: *
     ...
     * An Amazon Web Services identity provider. Not compatible with the property oidc or saml.
     */
    aws?: pulumi.Input<inputs.IamWorkloadIdentityPoolProviderAws>;
    /**
     * A description for the provider. Cannot exceed 256 characters.
     */
     ...
     * An OpenId Connect 1.0 identity provider. Not compatible with the property aws or saml.
     */
    oidc?: pulumi.Input<inputs.IamWorkloadIdentityPoolProviderOidc>;
    project?: pulumi.Input<string>;
    /**
     * An SAML 2.0 identity provider. Not compatible with the property oidc or aws.
     */
    saml?: pulumi.Input<inputs.IamWorkloadIdentityPoolProviderSaml>;
    /**
     * The state of the provider. * STATE_UNSPECIFIED: State unspecified. * ACTIVE: The provider is active, and may be used to
     * validate authentication credentials. * DELETED: The provider is soft-deleted. Soft-deleted providers are permanently
     * deleted after approximately 30 days. You can restore a soft-deleted provider using UndeleteWorkloadIdentityPoolProvider.
    ...
    timeouts?: pulumi.Input<inputs.IamWorkloadIdentityPoolProviderTimeouts>;
    /**
     * The ID used for the pool, which is the final component of the pool resource name. This value should be 4-32 characters,
     * and may contain the characters [a-z0-9-]. The prefix 'gcp-' is reserved for use by Google, and may not be specified.
     */
 ...
 */
export interface IamWorkloadIdentityPoolProviderArgs {
    /**
     * [A Common Expression Language](https://opensource.google/projects/cel) expression, in plain text, to restrict what
     * otherwise valid authentication credentials issued by the provider should not be accepted. The expression must output a
     * boolean representing whether to allow the federation. The following keywords may be referenced in the expressions: *
