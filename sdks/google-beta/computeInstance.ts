...
export class ComputeInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeInstance:ComputeInstance';
     ...
     */
    public readonly advancedMachineFeatures!: pulumi.Output<outputs.ComputeInstanceAdvancedMachineFeatures | undefined>;
    public readonly allowStoppingForUpdate!: pulumi.Output<boolean | undefined>;
    /**
     * List of disks attached to the instance
     */
    public readonly attachedDisks!: pulumi.Output<outputs.ComputeInstanceAttachedDisk[] | undefined>;
    /**
     ...
     * to create.
     */
    public readonly confidentialInstanceConfig!: pulumi.Output<outputs.ComputeInstanceConfidentialInstanceConfig | undefined>;
    /**
     ...
     */
    public readonly guestAccelerators!: pulumi.Output<outputs.ComputeInstanceGuestAccelerator[] | undefined>;
    /**
     ...
     */
    public readonly networkPerformanceConfig!: pulumi.Output<outputs.ComputeInstanceNetworkPerformanceConfig | undefined>;
    /**
     * Stores additional params passed with the request, but not persisted as part of resource payload.
     */
    public readonly params!: pulumi.Output<outputs.ComputeInstanceParams | undefined>;
    /**
     ...
     */
    public readonly reservationAffinity!: pulumi.Output<outputs.ComputeInstanceReservationAffinity | undefined>;
    /**
     ...
     */
    public readonly scheduling!: pulumi.Output<outputs.ComputeInstanceScheduling | undefined>;
    /**
     * The scratch disks attached to the instance.
     */
    public readonly scratchDisks!: pulumi.Output<outputs.ComputeInstanceScratchDisk[] | undefined>;
    /**
     ...
     */
    public readonly serviceAccount!: pulumi.Output<outputs.ComputeInstanceServiceAccount | undefined>;
    /**
     * The shielded vm config being used by the instance.
     */
    public readonly shieldedInstanceConfig!: pulumi.Output<outputs.ComputeInstanceShieldedInstanceConfig | undefined>;
    /**
...
export interface ComputeInstanceState {
     ...
     * Controls for advanced machine-related behavior features.
     */
    advancedMachineFeatures?: pulumi.Input<inputs.ComputeInstanceAdvancedMachineFeatures>;
    allowStoppingForUpdate?: pulumi.Input<boolean>;
    /**
     * List of disks attached to the instance
     */
    attachedDisks?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceAttachedDisk>[]>;
    /**
     * The boot disk for the instance.
     */
     ...
     * to create.
     */
    confidentialInstanceConfig?: pulumi.Input<inputs.ComputeInstanceConfidentialInstanceConfig>;
    /**
     * The CPU platform used by this instance.
     */
     ...
     * List of the type and count of accelerator cards attached to the instance.
     */
    guestAccelerators?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceGuestAccelerator>[]>;
    /**
     * A custom hostname for the instance. Must be a fully qualified DNS name and RFC-1035-valid. Valid format is a series of
     * labels 1-63 characters long matching the regular expression a-z, concatenated with periods. The entire hostname must not
     * exceed 253 characters. Changing this forces a new resource to be created.
     ...
     * default network performance configuration.
     */
    networkPerformanceConfig?: pulumi.Input<inputs.ComputeInstanceNetworkPerformanceConfig>;
    /**
     * Stores additional params passed with the request, but not persisted as part of resource payload.
     */
    params?: pulumi.Input<inputs.ComputeInstanceParams>;
    /**
     * Partner Metadata Map made available within the instance.
     */
     ...
     * Specifies the reservations that this instance can consume from.
     */
    reservationAffinity?: pulumi.Input<inputs.ComputeInstanceReservationAffinity>;
    /**
     * A list of self_links of resource policies to attach to the instance. Currently a max of 1 resource policy is supported.
     */
     ...
     * The scheduling strategy being used by the instance.
     */
    scheduling?: pulumi.Input<inputs.ComputeInstanceScheduling>;
    /**
     * The scratch disks attached to the instance.
     */
    scratchDisks?: pulumi.Input<pulumi.Input<inputs.ComputeInstanceScratchDisk>[]>;
    /**
     * The URI of the created resource.
     */
     ...
     * The service account to attach to the instance.
     */
    serviceAccount?: pulumi.Input<inputs.ComputeInstanceServiceAccount>;
    /**
     * The shielded vm config being used by the instance.
     */
    shieldedInstanceConfig?: pulumi.Input<inputs.ComputeInstanceShieldedInstanceConfig>;
    /**
     * The list of tags attached to the instance.
     */
