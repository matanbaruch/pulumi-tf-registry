...
export class VertexAiIndex extends pulumi.CustomResource {
    /**
     * Get an existing VertexAiIndex resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VertexAiIndexState, opts?: pulumi.CustomResourceOptions): VertexAiIndex {
        return new VertexAiIndex(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/vertexAiIndex:VertexAiIndex';

    /**
     * Returns true if the given object is an instance of VertexAiIndex.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VertexAiIndex {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VertexAiIndex.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly deployedIndexes!: pulumi.Output<outputs.VertexAiIndexDeployedIndex[]>;
    /**
     ...
     */
    public /*out*/ readonly indexStats!: pulumi.Output<outputs.VertexAiIndexIndexStat[]>;
    /**
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.VertexAiIndexMetadata | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.VertexAiIndexTimeouts | undefined>;
    /**
    ...
    /**
     * Create a VertexAiIndex resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VertexAiIndexArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VertexAiIndexArgs | VertexAiIndexState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VertexAiIndexState | undefined;
            ...
            const args = argsOrState as VertexAiIndexArgs | undefined;
        ...
        super(VertexAiIndex.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface VertexAiIndexState {
    /**
     * The timestamp of when the Index was created in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine
     * fractional digits.
     */
     ...
     * been undeployed first.
     */
    deployedIndexes?: pulumi.Input<pulumi.Input<inputs.VertexAiIndexDeployedIndex>[]>;
    /**
     * The description of the Index.
     */
     ...
     * Stats of the index resource.
     */
    indexStats?: pulumi.Input<pulumi.Input<inputs.VertexAiIndexIndexStat>[]>;
    /**
     * The update method to use with this Index. The value must be the followings. If not set, BATCH_UPDATE will be used by
     * default. * BATCH_UPDATE: user can call indexes.patch with files on Cloud Storage of datapoints to update. *
     * STREAM_UPDATE: user can call indexes.upsertDatapoints/DeleteDatapoints to update the Index and the updates will be
     ...
     * An additional information about the Index
     */
    metadata?: pulumi.Input<inputs.VertexAiIndexMetadata>;
    /**
     * Points to a YAML file stored on Google Cloud Storage describing additional information about the Index, that is specific
     * to it. Unset if the Index does not have any additional information.
     */
    ...
    timeouts?: pulumi.Input<inputs.VertexAiIndexTimeouts>;
    /**
     * The timestamp of when the Index was last updated in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine
     * fractional digits.
     */
 ...
 */
export interface VertexAiIndexArgs {
    /**
     * The description of the Index.
     */
    description?: pulumi.Input<string>;
