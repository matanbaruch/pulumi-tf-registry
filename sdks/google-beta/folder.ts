...
export class Folder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/folder:Folder';
    ...
    public readonly timeouts!: pulumi.Output<outputs.FolderTimeouts | undefined>;
...
export interface FolderState {
    ...
    timeouts?: pulumi.Input<inputs.FolderTimeouts>;
}
