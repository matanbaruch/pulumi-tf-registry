...
export class CloudRunV2Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/cloudRunV2Service:CloudRunV2Service';
     ...
     */
    public readonly scaling!: pulumi.Output<outputs.CloudRunV2ServiceScaling | undefined>;
    /**
...
export interface CloudRunV2ServiceState {
     ...
     * Scaling settings that apply to the whole service
     */
    scaling?: pulumi.Input<inputs.CloudRunV2ServiceScaling>;
    /**
     * The template used to create revisions for this Service.
     */
