...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("google-beta");
			params.setVersion("6.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2hhc2hpY29ycC9nb29nbGUtYmV0YSIsInZlcnNpb24iOiI2LjEuMCJ9fQ=="), c => c.charCodeAt(0)));
