...
export class ComputeSslPolicy extends pulumi.CustomResource {
    /**
     * Get an existing ComputeSslPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeSslPolicyState, opts?: pulumi.CustomResourceOptions): ComputeSslPolicy {
        return new ComputeSslPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeSslPolicy:ComputeSslPolicy';

    /**
     * Returns true if the given object is an instance of ComputeSslPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ComputeSslPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ComputeSslPolicy.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.ComputeSslPolicyTimeouts | undefined>;

    /**
     * Create a ComputeSslPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ComputeSslPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ComputeSslPolicyArgs | ComputeSslPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ComputeSslPolicyState | undefined;
            ...
            const args = argsOrState as ComputeSslPolicyArgs | undefined;
        ...
        super(ComputeSslPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ComputeSslPolicyState {
    /**
     * Creation timestamp in RFC3339 text format.
     */
    ...
    timeouts?: pulumi.Input<inputs.ComputeSslPolicyTimeouts>;
}

/**
 * The set of arguments for constructing a ComputeSslPolicy resource.
 */
export interface ComputeSslPolicyArgs {
    /**
     * Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. This
     * can be one of 'COMPATIBLE', 'MODERN', 'RESTRICTED', or 'CUSTOM'. If using 'CUSTOM', the set of SSL features to enable
     * must be specified in the 'customFeatures' field. See the [official
