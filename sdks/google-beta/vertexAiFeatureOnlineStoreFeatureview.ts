...
export class VertexAiFeatureOnlineStoreFeatureview extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/vertexAiFeatureOnlineStoreFeatureview:VertexAiFeatureOnlineStoreFeatureview';
    ...
    /**
     * Configuration for vector search. It contains the required configurations to create an index from source data, so that
     * approximate nearest neighbor (a.k.a ANN) algorithms search can be performed during online serving.
     */
    public readonly vectorSearchConfig!: pulumi.Output<outputs.VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfig | undefined>;
...
export interface VertexAiFeatureOnlineStoreFeatureviewState {
     ...
     * approximate nearest neighbor (a.k.a ANN) algorithms search can be performed during online serving.
     */
    vectorSearchConfig?: pulumi.Input<inputs.VertexAiFeatureOnlineStoreFeatureviewVectorSearchConfig>;
}
