...
export class ComputeRegionDisk extends pulumi.CustomResource {
    /**
     * Get an existing ComputeRegionDisk resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeRegionDiskState, opts?: pulumi.CustomResourceOptions): ComputeRegionDisk {
        return new ComputeRegionDisk(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeRegionDisk:ComputeRegionDisk';

    /**
     * Returns true if the given object is an instance of ComputeRegionDisk.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ComputeRegionDisk {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ComputeRegionDisk.__pulumiType;
    }

    /**
     * A nested object resource
     */
    public readonly asyncPrimaryDisk!: pulumi.Output<outputs.ComputeRegionDiskAsyncPrimaryDisk | undefined>;
    /**
     ...
     */
    public readonly diskEncryptionKey!: pulumi.Output<outputs.ComputeRegionDiskDiskEncryptionKey | undefined>;
    public /*out*/ readonly effectiveLabels!: pulumi.Output<{[key: string]: string}>;
    /**
     * A list of features to enable on the guest operating system. Applicable only for bootable disks.
     */
    public readonly guestOsFeatures!: pulumi.Output<outputs.ComputeRegionDiskGuestOsFeature[] | undefined>;
    /**
     ...
     */
    public readonly sourceSnapshotEncryptionKey!: pulumi.Output<outputs.ComputeRegionDiskSourceSnapshotEncryptionKey | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ComputeRegionDiskTimeouts | undefined>;
    /**
    ...
    /**
     * Create a ComputeRegionDisk resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ComputeRegionDiskArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ComputeRegionDiskArgs | ComputeRegionDiskState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ComputeRegionDiskState | undefined;
            ...
            const args = argsOrState as ComputeRegionDiskArgs | undefined;
        ...
        super(ComputeRegionDisk.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ComputeRegionDiskState {
    /**
     * A nested object resource
     */
    asyncPrimaryDisk?: pulumi.Input<inputs.ComputeRegionDiskAsyncPrimaryDisk>;
    /**
     * Creation timestamp in RFC3339 text format.
     */
     ...
     * and you do not need to provide a key to use the disk later.
     */
    diskEncryptionKey?: pulumi.Input<inputs.ComputeRegionDiskDiskEncryptionKey>;
    effectiveLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    /**
     * A list of features to enable on the guest operating system. Applicable only for bootable disks.
     */
    guestOsFeatures?: pulumi.Input<pulumi.Input<inputs.ComputeRegionDiskGuestOsFeature>[]>;
    /**
     * Specifies the disk interface to use for attaching this disk, which is either SCSI or NVME. The default is SCSI.
     *
     * @deprecated Deprecated
     ...
     * customer-supplied encryption key.
     */
    sourceSnapshotEncryptionKey?: pulumi.Input<inputs.ComputeRegionDiskSourceSnapshotEncryptionKey>;
    /**
     * The unique ID of the snapshot used to create this disk. This value identifies the exact snapshot that was used to create
     * this persistent disk. For example, if you created the persistent disk from a snapshot that was later deleted and
     * recreated under the same name, the source snapshot ID would identify the exact version of the snapshot that was used.
    ...
    timeouts?: pulumi.Input<inputs.ComputeRegionDiskTimeouts>;
    /**
     * URL of the disk type resource describing which disk type to use to create the disk. Provide this when creating the disk.
     */
 ...
 */
export interface ComputeRegionDiskArgs {
    /**
     * A nested object resource
     */
    asyncPrimaryDisk?: pulumi.Input<inputs.ComputeRegionDiskAsyncPrimaryDisk>;
