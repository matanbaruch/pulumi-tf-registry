...
export class TpuNode extends pulumi.CustomResource {
    /**
     * Get an existing TpuNode resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TpuNodeState, opts?: pulumi.CustomResourceOptions): TpuNode {
        return new TpuNode(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/tpuNode:TpuNode';

    /**
     * Returns true if the given object is an instance of TpuNode.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TpuNode {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TpuNode.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly networkEndpoints!: pulumi.Output<outputs.TpuNodeNetworkEndpoint[]>;
    public readonly project!: pulumi.Output<string>;
    /**
     * Sets the scheduling options for this TPU instance.
     */
    public readonly schedulingConfig!: pulumi.Output<outputs.TpuNodeSchedulingConfig | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.TpuNodeTimeouts | undefined>;
    /**
    ...
    /**
     * Create a TpuNode resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TpuNodeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TpuNodeArgs | TpuNodeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TpuNodeState | undefined;
            ...
            const args = argsOrState as TpuNodeArgs | undefined;
        ...
        super(TpuNode.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface TpuNodeState {
     ...
     * node first reach out to the first (index 0) entry.
     */
    networkEndpoints?: pulumi.Input<pulumi.Input<inputs.TpuNodeNetworkEndpoint>[]>;
    project?: pulumi.Input<string>;
    /**
     * Sets the scheduling options for this TPU instance.
     */
    schedulingConfig?: pulumi.Input<inputs.TpuNodeSchedulingConfig>;
    /**
     * The service account used to run the tensor flow services within the node. To share resources, including Google Cloud
     * Storage data, with the Tensorflow job running in the Node, this account must have permissions to that data.
     */
    ...
    timeouts?: pulumi.Input<inputs.TpuNodeTimeouts>;
    /**
     * Whether the VPC peering for the node is set up through Service Networking API. The VPC Peering should be set up before
     * provisioning the node. If this field is set, cidr_block field should not be specified. If the network that you want to
     * peer the TPU Node to is a Shared VPC network, the node must be created with this this field enabled.
