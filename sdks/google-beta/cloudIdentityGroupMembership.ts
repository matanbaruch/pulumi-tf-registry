...
export class CloudIdentityGroupMembership extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/cloudIdentityGroupMembership:CloudIdentityGroupMembership';
     ...
     */
    public readonly memberKey!: pulumi.Output<outputs.CloudIdentityGroupMembershipMemberKey | undefined>;
    /**
...
export interface CloudIdentityGroupMembershipState {
     ...
     * EntityKey of the member.
     */
    memberKey?: pulumi.Input<inputs.CloudIdentityGroupMembershipMemberKey>;
    /**
     * The resource name of the Membership, of the form groups/{group_id}/memberships/{membership_id}.
     */
