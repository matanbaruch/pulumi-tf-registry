...
export class ComputeNetworkFirewallPolicyRule extends pulumi.CustomResource {
    /**
     * Get an existing ComputeNetworkFirewallPolicyRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeNetworkFirewallPolicyRuleState, opts?: pulumi.CustomResourceOptions): ComputeNetworkFirewallPolicyRule {
        return new ComputeNetworkFirewallPolicyRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/computeNetworkFirewallPolicyRule:ComputeNetworkFirewallPolicyRule';

    /**
     * Returns true if the given object is an instance of ComputeNetworkFirewallPolicyRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ComputeNetworkFirewallPolicyRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ComputeNetworkFirewallPolicyRule.__pulumiType;
    }
     ...
     * enforced.
     */
    public readonly match!: pulumi.Output<outputs.ComputeNetworkFirewallPolicyRuleMatch>;
    /**
     ...
     */
    public readonly targetSecureTags!: pulumi.Output<outputs.ComputeNetworkFirewallPolicyRuleTargetSecureTag[] | undefined>;
    /**
     * A list of service accounts indicating the sets of instances that are applied with this rule.
     */
    public readonly targetServiceAccounts!: pulumi.Output<string[] | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.ComputeNetworkFirewallPolicyRuleTimeouts | undefined>;
    /**
    ...
    /**
     * Create a ComputeNetworkFirewallPolicyRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ComputeNetworkFirewallPolicyRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ComputeNetworkFirewallPolicyRuleArgs | ComputeNetworkFirewallPolicyRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ComputeNetworkFirewallPolicyRuleState | undefined;
            ...
            const args = argsOrState as ComputeNetworkFirewallPolicyRuleArgs | undefined;
        ...
        super(ComputeNetworkFirewallPolicyRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ComputeNetworkFirewallPolicyRuleState {
    /**
     * The Action to perform when the client connection triggers the rule. Valid actions are "allow", "deny", "goto_next" and
     * "apply_security_profile_group".
     */
     ...
     * enforced.
     */
    match?: pulumi.Input<inputs.ComputeNetworkFirewallPolicyRuleMatch>;
    /**
     * An integer indicating the priority of a rule in the list. The priority must be a positive value between 0 and
     * 2147483647. Rules are evaluated from highest to lowest priority where 0 is the highest priority and 2147483647 is the
     * lowest prority.
     ...
     * instances on the specified network. Maximum number of target label tags allowed is 256.
     */
    targetSecureTags?: pulumi.Input<pulumi.Input<inputs.ComputeNetworkFirewallPolicyRuleTargetSecureTag>[]>;
    /**
     * A list of service accounts indicating the sets of instances that are applied with this rule.
     */
    targetServiceAccounts?: pulumi.Input<pulumi.Input<string>[]>;
    timeouts?: pulumi.Input<inputs.ComputeNetworkFirewallPolicyRuleTimeouts>;
    /**
     * Boolean flag indicating if the traffic should be TLS decrypted. It can be set only if action =
     * 'apply_security_profile_group' and cannot be set for other actions.
     */
 ...
 */
export interface ComputeNetworkFirewallPolicyRuleArgs {
    /**
     * The Action to perform when the client connection triggers the rule. Valid actions are "allow", "deny", "goto_next" and
     * "apply_security_profile_group".
     */
