...
export class MonitoringMetricDescriptor extends pulumi.CustomResource {
    /**
     * Get an existing MonitoringMetricDescriptor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitoringMetricDescriptorState, opts?: pulumi.CustomResourceOptions): MonitoringMetricDescriptor {
        return new MonitoringMetricDescriptor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/monitoringMetricDescriptor:MonitoringMetricDescriptor';

    /**
     * Returns true if the given object is an instance of MonitoringMetricDescriptor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MonitoringMetricDescriptor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MonitoringMetricDescriptor.__pulumiType;
    }
     ...
     */
    public readonly labels!: pulumi.Output<outputs.MonitoringMetricDescriptorLabel[] | undefined>;
    /**
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.MonitoringMetricDescriptorMetadata | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.MonitoringMetricDescriptorTimeouts | undefined>;
    /**
    ...
    /**
     * Create a MonitoringMetricDescriptor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MonitoringMetricDescriptorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MonitoringMetricDescriptorArgs | MonitoringMetricDescriptorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MonitoringMetricDescriptorState | undefined;
            ...
            const args = argsOrState as MonitoringMetricDescriptorArgs | undefined;
        ...
        super(MonitoringMetricDescriptor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface MonitoringMetricDescriptorState {
    /**
     * A detailed description of the metric, which can be used in documentation.
     */
     ...
     * entire resource must be deleted, then created with the desired labels.
     */
    labels?: pulumi.Input<pulumi.Input<inputs.MonitoringMetricDescriptorLabel>[]>;
    /**
     * The launch stage of the metric definition. Possible values: ["LAUNCH_STAGE_UNSPECIFIED", "UNIMPLEMENTED", "PRELAUNCH",
     * "EARLY_ACCESS", "ALPHA", "BETA", "GA", "DEPRECATED"]
     */
     ...
     * Metadata which can be used to guide usage of the metric.
     */
    metadata?: pulumi.Input<inputs.MonitoringMetricDescriptorMetadata>;
    /**
     * Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metricKind and valueType
     * might not be supported. Possible values: ["METRIC_KIND_UNSPECIFIED", "GAUGE", "DELTA", "CUMULATIVE"]
     */
    ...
    timeouts?: pulumi.Input<inputs.MonitoringMetricDescriptorTimeouts>;
    /**
     * The metric type, including its DNS name prefix. The type is not URL-encoded. All service defined metrics must be
     * prefixed with the service name, in the format of {service name}/{relative metric name}, such as
     * cloudsql.googleapis.com/database/cpu/utilization. The relative metric name must have only upper and lower-case letters,
 ...
 */
export interface MonitoringMetricDescriptorArgs {
    /**
     * A detailed description of the metric, which can be used in documentation.
     */
    description: pulumi.Input<string>;
