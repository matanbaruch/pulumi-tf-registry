...
export class NetworkSecurityTlsInspectionPolicy extends pulumi.CustomResource {
    /**
     * Get an existing NetworkSecurityTlsInspectionPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkSecurityTlsInspectionPolicyState, opts?: pulumi.CustomResourceOptions): NetworkSecurityTlsInspectionPolicy {
        return new NetworkSecurityTlsInspectionPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-beta:index/networkSecurityTlsInspectionPolicy:NetworkSecurityTlsInspectionPolicy';

    /**
     * Returns true if the given object is an instance of NetworkSecurityTlsInspectionPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkSecurityTlsInspectionPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkSecurityTlsInspectionPolicy.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkSecurityTlsInspectionPolicyTimeouts | undefined>;
    /**
    ...
    /**
     * Create a NetworkSecurityTlsInspectionPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkSecurityTlsInspectionPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkSecurityTlsInspectionPolicyArgs | NetworkSecurityTlsInspectionPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkSecurityTlsInspectionPolicyState | undefined;
            ...
            const args = argsOrState as NetworkSecurityTlsInspectionPolicyArgs | undefined;
        ...
        super(NetworkSecurityTlsInspectionPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface NetworkSecurityTlsInspectionPolicyState {
    /**
     * A CA pool resource used to issue interception certificates.
     */
    ...
    timeouts?: pulumi.Input<inputs.NetworkSecurityTlsInspectionPolicyTimeouts>;
    /**
     * The selected Profile. If this is not set, then the default value is to allow the broadest set of clients and servers
     * (\"PROFILE_COMPATIBLE\"). Setting this to more restrictive values may improve security, but may also prevent the TLS
     * inspection proxy from connecting to some clients or servers. Note that Secure Web Proxy does not yet honor this field.
 ...
 */
export interface NetworkSecurityTlsInspectionPolicyArgs {
    /**
     * A CA pool resource used to issue interception certificates.
     */
    caPool: pulumi.Input<string>;
