...
export class Role extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'catalystcenter:index/role:Role';
     ...
     */
    public readonly resourceTypes!: pulumi.Output<outputs.RoleResourceType[]>;
...
export interface RoleState {
     ...
     * The resource types of the role
     */
    resourceTypes?: pulumi.Input<pulumi.Input<inputs.RoleResourceType>[]>;
}
