...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("catalystcenter");
			params.setVersion("0.1.10");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Npc2NvZGV2bmV0L2NhdGFseXN0Y2VudGVyIiwidmVyc2lvbiI6IjAuMS4xMCJ9fQ=="), c => c.charCodeAt(0)));
