...
export class Tag extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'catalystcenter:index/tag:Tag';
     ...
     */
    public readonly dynamicRules!: pulumi.Output<outputs.TagDynamicRule[] | undefined>;
    public readonly name!: pulumi.Output<string>;
    /**
     * true for system created tags, false for user defined tag
     */
    public readonly systemTag!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: TagArgs | TagState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dynamicRules"] = state ? state.dynamicRules : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
            resourceInputs["systemTag"] = state ? state.systemTag : undefined;
        } else {
            const args = argsOrState as TagArgs | undefined;
            resourceInputs["description"] = args ? args.description : undefined;
            resourceInputs["dynamicRules"] = args ? args.dynamicRules : undefined;
            resourceInputs["name"] = args ? args.name : undefined;
            resourceInputs["systemTag"] = args ? args.systemTag : undefined;
        }
...
export interface TagState {
     ...
     * Dynamic rules details
     */
    dynamicRules?: pulumi.Input<pulumi.Input<inputs.TagDynamicRule>[]>;
    name?: pulumi.Input<string>;
    /**
     * true for system created tags, false for user defined tag
     */
    systemTag?: pulumi.Input<boolean>;
}
