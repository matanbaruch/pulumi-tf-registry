...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("metalcloud");
			params.setVersion("2.7.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21ldGFsc29mdC1pby9tZXRhbGNsb3VkIiwidmVyc2lvbiI6IjIuNy4zIn19"), c => c.charCodeAt(0)));
