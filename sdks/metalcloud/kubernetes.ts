...
export class Kubernetes extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metalcloud:index/kubernetes:Kubernetes';
    ...
    public readonly instanceArrayNetworkProfileMasters!: pulumi.Output<outputs.KubernetesInstanceArrayNetworkProfileMaster[] | undefined>;
    public readonly instanceArrayNetworkProfileWorkers!: pulumi.Output<outputs.KubernetesInstanceArrayNetworkProfileWorker[] | undefined>;
    public readonly instanceArrays!: pulumi.Output<outputs.KubernetesInstanceArray[] | undefined>;
    public readonly instanceCustomVariablesMasters!: pulumi.Output<outputs.KubernetesInstanceCustomVariablesMaster[] | undefined>;
    public readonly instanceCustomVariablesWorkers!: pulumi.Output<outputs.KubernetesInstanceCustomVariablesWorker[] | undefined>;
    public readonly instanceServerTypeMasters!: pulumi.Output<outputs.KubernetesInstanceServerTypeMaster[] | undefined>;
    public readonly instanceServerTypeWorkers!: pulumi.Output<outputs.KubernetesInstanceServerTypeWorker[] | undefined>;
    public readonly interfaceMasters!: pulumi.Output<outputs.KubernetesInterfaceMaster[] | undefined>;
    public readonly interfaceWorkers!: pulumi.Output<outputs.KubernetesInterfaceWorker[] | undefined>;
...
export interface KubernetesState {
    ...
    instanceArrayNetworkProfileMasters?: pulumi.Input<pulumi.Input<inputs.KubernetesInstanceArrayNetworkProfileMaster>[]>;
    instanceArrayNetworkProfileWorkers?: pulumi.Input<pulumi.Input<inputs.KubernetesInstanceArrayNetworkProfileWorker>[]>;
    instanceArrays?: pulumi.Input<pulumi.Input<inputs.KubernetesInstanceArray>[]>;
    instanceCustomVariablesMasters?: pulumi.Input<pulumi.Input<inputs.KubernetesInstanceCustomVariablesMaster>[]>;
    instanceCustomVariablesWorkers?: pulumi.Input<pulumi.Input<inputs.KubernetesInstanceCustomVariablesWorker>[]>;
    instanceServerTypeMasters?: pulumi.Input<pulumi.Input<inputs.KubernetesInstanceServerTypeMaster>[]>;
    instanceServerTypeWorkers?: pulumi.Input<pulumi.Input<inputs.KubernetesInstanceServerTypeWorker>[]>;
    interfaceMasters?: pulumi.Input<pulumi.Input<inputs.KubernetesInterfaceMaster>[]>;
    interfaceWorkers?: pulumi.Input<pulumi.Input<inputs.KubernetesInterfaceWorker>[]>;
}
