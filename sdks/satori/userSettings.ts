...
export class UserSettings extends pulumi.CustomResource {
    ...
    /**
     * User's set of attributes in JSON object format. may include the following types: int, string, float, boolean, string[],
     * number[], where number may be float/int. The value may be a path to a json file that contains the attributes for a user
     * or a raw JSON string, for example: "./attribute_files/user_a.json" OR "{"company": "SatoriCyber","age": 30.5,"cities":
     * ["Washington", "Lisbon"],"kids_age": [1, 3.14759, 7], "isActive": true}"
     */
