...
pulumi.runtime.registerResourceModule("apko", "index/build", _module)
pulumi.runtime.registerResourcePackage("apko", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:apko") {
