...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("template");
			params.setVersion("2.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hhc2hpY29ycC90ZW1wbGF0ZSIsInZlcnNpb24iOiIyLjIuMCJ9fQ=="), c => c.charCodeAt(0)));
