...
export class EssScheduledTask extends pulumi.CustomResource {
    /**
     * Get an existing EssScheduledTask resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EssScheduledTaskState, opts?: pulumi.CustomResourceOptions): EssScheduledTask {
        return new EssScheduledTask(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/essScheduledTask:EssScheduledTask';

    /**
     * Returns true if the given object is an instance of EssScheduledTask.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EssScheduledTask {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EssScheduledTask.__pulumiType;
    }
    ...
    /**
     * Create a EssScheduledTask resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: EssScheduledTaskArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: EssScheduledTaskArgs | EssScheduledTaskState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EssScheduledTaskState | undefined;
            ...
            const args = argsOrState as EssScheduledTaskArgs | undefined;
        ...
        super(EssScheduledTask.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering EssScheduledTask resources.
 */
export interface EssScheduledTaskState {
...
/**
 * The set of arguments for constructing a EssScheduledTask resource.
 */
export interface EssScheduledTaskArgs {
    description?: pulumi.Input<string>;
    desiredCapacity?: pulumi.Input<number>;
    launchExpirationTime?: pulumi.Input<number>;
    launchTime?: pulumi.Input<string>;
