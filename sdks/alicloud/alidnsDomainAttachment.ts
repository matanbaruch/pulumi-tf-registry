...
export class AlidnsDomainAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/alidnsDomainAttachment:AlidnsDomainAttachment';
    ...
    constructor(name: string, argsOrState?: AlidnsDomainAttachmentArgs | AlidnsDomainAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AlidnsDomainAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
