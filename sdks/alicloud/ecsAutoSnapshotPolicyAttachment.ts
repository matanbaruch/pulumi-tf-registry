...
export class EcsAutoSnapshotPolicyAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/ecsAutoSnapshotPolicyAttachment:EcsAutoSnapshotPolicyAttachment';
    ...
    constructor(name: string, argsOrState?: EcsAutoSnapshotPolicyAttachmentArgs | EcsAutoSnapshotPolicyAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EcsAutoSnapshotPolicyAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
