...
export function getSlbLoadBalancers(args?: GetSlbLoadBalancersArgs, opts?: pulumi.InvokeOptions): Promise<GetSlbLoadBalancersResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("alicloud:index/getSlbLoadBalancers:getSlbLoadBalancers", {
...
/**
 * A collection of arguments for invoking getSlbLoadBalancers.
 */
export interface GetSlbLoadBalancersArgs {
    address?: string;
...
/**
 * A collection of values returned by getSlbLoadBalancers.
 */
export interface GetSlbLoadBalancersResult {
    readonly address?: string;
    readonly addressIpVersion?: string;
    readonly addressType?: string;
    readonly balancers: outputs.GetSlbLoadBalancersBalancer[];
     ...
     */
    readonly slbs: outputs.GetSlbLoadBalancersSlb[];
...
export function getSlbLoadBalancersOutput(args?: GetSlbLoadBalancersOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSlbLoadBalancersResult> {
    return pulumi.output(args).apply((a: any) => getSlbLoadBalancers(a, opts))
}

/**
 * A collection of arguments for invoking getSlbLoadBalancers.
 */
export interface GetSlbLoadBalancersOutputArgs {
