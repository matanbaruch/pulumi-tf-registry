...
export class SslVpnClientCert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/sslVpnClientCert:SslVpnClientCert';
    ...
    constructor(name: string, argsOrState?: SslVpnClientCertArgs | SslVpnClientCertState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SslVpnClientCert.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
