...
export class DbAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/dbAccount:DbAccount';
    ...
    public readonly timeouts!: pulumi.Output<outputs.DbAccountTimeouts | undefined>;
    /**
     * @deprecated Deprecated
     */
    ...
    constructor(name: string, argsOrState?: DbAccountArgs | DbAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DbAccount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DbAccountState {
    ...
    timeouts?: pulumi.Input<inputs.DbAccountTimeouts>;
    /**
     * @deprecated Deprecated
     */
