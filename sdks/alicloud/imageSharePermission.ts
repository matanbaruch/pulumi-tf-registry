...
export class ImageSharePermission extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/imageSharePermission:ImageSharePermission';
    ...
    constructor(name: string, argsOrState?: ImageSharePermissionArgs | ImageSharePermissionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ImageSharePermission.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
