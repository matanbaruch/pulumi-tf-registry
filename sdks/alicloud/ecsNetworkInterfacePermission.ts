...
export class EcsNetworkInterfacePermission extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/ecsNetworkInterfacePermission:EcsNetworkInterfacePermission';
    ...
    public readonly timeouts!: pulumi.Output<outputs.EcsNetworkInterfacePermissionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: EcsNetworkInterfacePermissionArgs | EcsNetworkInterfacePermissionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EcsNetworkInterfacePermission.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EcsNetworkInterfacePermissionState {
    ...
    timeouts?: pulumi.Input<inputs.EcsNetworkInterfacePermissionTimeouts>;
}
