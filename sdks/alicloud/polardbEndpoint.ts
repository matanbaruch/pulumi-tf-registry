...
export class PolardbEndpoint extends pulumi.CustomResource {
    /**
     * Get an existing PolardbEndpoint resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolardbEndpointState, opts?: pulumi.CustomResourceOptions): PolardbEndpoint {
        return new PolardbEndpoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/polardbEndpoint:PolardbEndpoint';

    /**
     * Returns true if the given object is an instance of PolardbEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolardbEndpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolardbEndpoint.__pulumiType;
    }
    ...
    /**
     * Create a PolardbEndpoint resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PolardbEndpointArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolardbEndpointArgs | PolardbEndpointState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolardbEndpointState | undefined;
            ...
            const args = argsOrState as PolardbEndpointArgs | undefined;
        ...
        super(PolardbEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolardbEndpoint resources.
 */
export interface PolardbEndpointState {
...
/**
 * The set of arguments for constructing a PolardbEndpoint resource.
 */
export interface PolardbEndpointArgs {
    autoAddNewNodes?: pulumi.Input<string>;
    connectionPrefix?: pulumi.Input<string>;
    dbClusterId: pulumi.Input<string>;
    dbEndpointDescription?: pulumi.Input<string>;
