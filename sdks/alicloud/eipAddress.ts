...
export class EipAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/eipAddress:EipAddress';
    ...
    public readonly timeouts!: pulumi.Output<outputs.EipAddressTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: EipAddressArgs | EipAddressState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EipAddress.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EipAddressState {
    ...
    timeouts?: pulumi.Input<inputs.EipAddressTimeouts>;
