...
export class EcsDedicatedHostCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/ecsDedicatedHostCluster:EcsDedicatedHostCluster';
    ...
    constructor(name: string, argsOrState?: EcsDedicatedHostClusterArgs | EcsDedicatedHostClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EcsDedicatedHostCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
