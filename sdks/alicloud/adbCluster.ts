...
export class AdbCluster extends pulumi.CustomResource {
    /**
     * Get an existing AdbCluster resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AdbClusterState, opts?: pulumi.CustomResourceOptions): AdbCluster {
        return new AdbCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/adbCluster:AdbCluster';

    /**
     * Returns true if the given object is an instance of AdbCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AdbCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AdbCluster.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.AdbClusterTimeouts | undefined>;
    public readonly vpcId!: pulumi.Output<string>;
    public readonly vswitchId!: pulumi.Output<string | undefined>;
    public readonly zoneId!: pulumi.Output<string>;

    /**
     * Create a AdbCluster resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AdbClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AdbClusterArgs | AdbClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AdbClusterState | undefined;
            ...
            const args = argsOrState as AdbClusterArgs | undefined;
        ...
        super(AdbCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AdbCluster resources.
 */
export interface AdbClusterState {
    ...
    timeouts?: pulumi.Input<inputs.AdbClusterTimeouts>;
...
/**
 * The set of arguments for constructing a AdbCluster resource.
 */
export interface AdbClusterArgs {
    autoRenewPeriod?: pulumi.Input<number>;
    computeResource?: pulumi.Input<string>;
    dbClusterCategory: pulumi.Input<string>;
    /**
