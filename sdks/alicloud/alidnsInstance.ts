...
export class AlidnsInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/alidnsInstance:AlidnsInstance';
    ...
    constructor(name: string, argsOrState?: AlidnsInstanceArgs | AlidnsInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AlidnsInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
