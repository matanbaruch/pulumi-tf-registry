...
export class OosPatchBaseline extends pulumi.CustomResource {
    /**
     * Get an existing OosPatchBaseline resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OosPatchBaselineState, opts?: pulumi.CustomResourceOptions): OosPatchBaseline {
        return new OosPatchBaseline(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/oosPatchBaseline:OosPatchBaseline';

    /**
     * Returns true if the given object is an instance of OosPatchBaseline.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OosPatchBaseline {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OosPatchBaseline.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.OosPatchBaselineTimeouts | undefined>;

    /**
     * Create a OosPatchBaseline resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OosPatchBaselineArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OosPatchBaselineArgs | OosPatchBaselineState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OosPatchBaselineState | undefined;
            ...
            const args = argsOrState as OosPatchBaselineArgs | undefined;
        ...
        super(OosPatchBaseline.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OosPatchBaseline resources.
 */
export interface OosPatchBaselineState {
    ...
    timeouts?: pulumi.Input<inputs.OosPatchBaselineTimeouts>;
}

/**
 * The set of arguments for constructing a OosPatchBaseline resource.
 */
export interface OosPatchBaselineArgs {
    approvalRules: pulumi.Input<string>;
    approvedPatches?: pulumi.Input<pulumi.Input<string>[]>;
    approvedPatchesEnableNonSecurity?: pulumi.Input<boolean>;
    description?: pulumi.Input<string>;
