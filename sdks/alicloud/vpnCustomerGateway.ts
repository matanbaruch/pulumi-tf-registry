...
export class VpnCustomerGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/vpnCustomerGateway:VpnCustomerGateway';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpnCustomerGatewayTimeouts | undefined>;
...
export interface VpnCustomerGatewayState {
    ...
    timeouts?: pulumi.Input<inputs.VpnCustomerGatewayTimeouts>;
}
