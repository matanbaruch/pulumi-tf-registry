...
export class Slb extends pulumi.CustomResource {
    /**
     * Get an existing Slb resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SlbState, opts?: pulumi.CustomResourceOptions): Slb {
        return new Slb(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/slb:Slb';

    /**
     * Returns true if the given object is an instance of Slb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Slb {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Slb.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.SlbTimeouts | undefined>;
    public readonly vswitchId!: pulumi.Output<string | undefined>;

    /**
     * Create a Slb resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SlbArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SlbArgs | SlbState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SlbState | undefined;
            ...
            const args = argsOrState as SlbArgs | undefined;
        ...
        super(Slb.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Slb resources.
 */
export interface SlbState {
    ...
    timeouts?: pulumi.Input<inputs.SlbTimeouts>;
    vswitchId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a Slb resource.
 */
export interface SlbArgs {
    address?: pulumi.Input<string>;
    addressIpVersion?: pulumi.Input<string>;
    addressType?: pulumi.Input<string>;
    bandwidth?: pulumi.Input<number>;
