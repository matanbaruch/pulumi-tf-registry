...
export class Actiontrail extends pulumi.CustomResource {
    /**
     * Get an existing Actiontrail resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ActiontrailState, opts?: pulumi.CustomResourceOptions): Actiontrail {
        return new Actiontrail(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/actiontrail:Actiontrail';

    /**
     * Returns true if the given object is an instance of Actiontrail.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Actiontrail {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Actiontrail.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.ActiontrailTimeouts | undefined>;
    public readonly trailName!: pulumi.Output<string>;
    public readonly trailRegion!: pulumi.Output<string>;

    /**
     * Create a Actiontrail resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ActiontrailArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ActiontrailArgs | ActiontrailState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ActiontrailState | undefined;
            ...
            const args = argsOrState as ActiontrailArgs | undefined;
        ...
        super(Actiontrail.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Actiontrail resources.
 */
export interface ActiontrailState {
    ...
    timeouts?: pulumi.Input<inputs.ActiontrailTimeouts>;
    trailName?: pulumi.Input<string>;
    trailRegion?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a Actiontrail resource.
 */
export interface ActiontrailArgs {
    eventRw?: pulumi.Input<string>;
    isOrganizationTrail?: pulumi.Input<boolean>;
    /**
     * @deprecated Deprecated
