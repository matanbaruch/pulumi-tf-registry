...
export class RouteTableAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/routeTableAttachment:RouteTableAttachment';
    ...
    public readonly timeouts!: pulumi.Output<outputs.RouteTableAttachmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RouteTableAttachmentArgs | RouteTableAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RouteTableAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RouteTableAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.RouteTableAttachmentTimeouts>;
