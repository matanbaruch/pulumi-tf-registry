...
export class RocketmqTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/rocketmqTopic:RocketmqTopic';
    ...
    public readonly timeouts!: pulumi.Output<outputs.RocketmqTopicTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RocketmqTopicArgs | RocketmqTopicState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RocketmqTopic.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RocketmqTopicState {
    ...
    timeouts?: pulumi.Input<inputs.RocketmqTopicTimeouts>;
