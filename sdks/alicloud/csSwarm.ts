...
export class CsSwarm extends pulumi.CustomResource {
    /**
     * Get an existing CsSwarm resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CsSwarmState, opts?: pulumi.CustomResourceOptions): CsSwarm {
        return new CsSwarm(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/csSwarm:CsSwarm';

    /**
     * Returns true if the given object is an instance of CsSwarm.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CsSwarm {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CsSwarm.__pulumiType;
    }
    ...
    public /*out*/ readonly nodes!: pulumi.Output<outputs.CsSwarmNode[]>;
    ...
    /**
     * Create a CsSwarm resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CsSwarmArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CsSwarmArgs | CsSwarmState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CsSwarmState | undefined;
            ...
            const args = argsOrState as CsSwarmArgs | undefined;
        ...
        super(CsSwarm.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CsSwarm resources.
 */
export interface CsSwarmState {
    ...
    nodes?: pulumi.Input<pulumi.Input<inputs.CsSwarmNode>[]>;
...
/**
 * The set of arguments for constructing a CsSwarm resource.
 */
export interface CsSwarmArgs {
    cidrBlock: pulumi.Input<string>;
    diskCategory?: pulumi.Input<string>;
    diskSize?: pulumi.Input<number>;
    imageId?: pulumi.Input<string>;
