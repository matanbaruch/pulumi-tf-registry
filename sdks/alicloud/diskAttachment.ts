...
export class DiskAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/diskAttachment:DiskAttachment';
    ...
    public readonly timeouts!: pulumi.Output<outputs.DiskAttachmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DiskAttachmentArgs | DiskAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DiskAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DiskAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.DiskAttachmentTimeouts>;
}
