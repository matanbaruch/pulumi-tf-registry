...
export class EcsSessionManagerStatus extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/ecsSessionManagerStatus:EcsSessionManagerStatus';
    ...
    constructor(name: string, argsOrState?: EcsSessionManagerStatusArgs | EcsSessionManagerStatusState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EcsSessionManagerStatus.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
