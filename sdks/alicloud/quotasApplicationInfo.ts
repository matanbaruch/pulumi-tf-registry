...
export class QuotasApplicationInfo extends pulumi.CustomResource {
    /**
     * Get an existing QuotasApplicationInfo resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: QuotasApplicationInfoState, opts?: pulumi.CustomResourceOptions): QuotasApplicationInfo {
        return new QuotasApplicationInfo(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/quotasApplicationInfo:QuotasApplicationInfo';

    /**
     * Returns true if the given object is an instance of QuotasApplicationInfo.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is QuotasApplicationInfo {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === QuotasApplicationInfo.__pulumiType;
    }
    ...
    public readonly dimensions!: pulumi.Output<outputs.QuotasApplicationInfoDimension[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.QuotasApplicationInfoTimeouts | undefined>;

    /**
     * Create a QuotasApplicationInfo resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: QuotasApplicationInfoArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: QuotasApplicationInfoArgs | QuotasApplicationInfoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as QuotasApplicationInfoState | undefined;
            ...
            const args = argsOrState as QuotasApplicationInfoArgs | undefined;
        ...
        super(QuotasApplicationInfo.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering QuotasApplicationInfo resources.
 */
export interface QuotasApplicationInfoState {
    ...
    dimensions?: pulumi.Input<pulumi.Input<inputs.QuotasApplicationInfoDimension>[]>;
    ...
    timeouts?: pulumi.Input<inputs.QuotasApplicationInfoTimeouts>;
}

/**
 * The set of arguments for constructing a QuotasApplicationInfo resource.
 */
export interface QuotasApplicationInfoArgs {
    auditMode?: pulumi.Input<string>;
    desireValue: pulumi.Input<number>;
    dimensions?: pulumi.Input<pulumi.Input<inputs.QuotasApplicationInfoDimension>[]>;
    effectiveTime?: pulumi.Input<string>;
