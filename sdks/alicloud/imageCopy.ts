...
export class ImageCopy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/imageCopy:ImageCopy';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ImageCopyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ImageCopyArgs | ImageCopyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ImageCopy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ImageCopyState {
    ...
    timeouts?: pulumi.Input<inputs.ImageCopyTimeouts>;
}
