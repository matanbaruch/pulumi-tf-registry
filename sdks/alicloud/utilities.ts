...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("alicloud");
			params.setVersion("1.229.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FsaXl1bi9hbGljbG91ZCIsInZlcnNpb24iOiIxLjIyOS4xIn19"), c => c.charCodeAt(0)));
