...
export class TagPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/tagPolicy:TagPolicy';
    ...
    constructor(name: string, argsOrState?: TagPolicyArgs | TagPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TagPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
