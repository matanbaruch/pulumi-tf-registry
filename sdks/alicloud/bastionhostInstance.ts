...
export class BastionhostInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/bastionhostInstance:BastionhostInstance';
    ...
    public readonly adAuthServers!: pulumi.Output<outputs.BastionhostInstanceAdAuthServer[] | undefined>;
    public readonly bandwidth!: pulumi.Output<string>;
    public readonly description!: pulumi.Output<string>;
    public readonly enablePublicAccess!: pulumi.Output<boolean>;
    public readonly ldapAuthServers!: pulumi.Output<outputs.BastionhostInstanceLdapAuthServer[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.BastionhostInstanceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: BastionhostInstanceArgs | BastionhostInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BastionhostInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface BastionhostInstanceState {
    adAuthServers?: pulumi.Input<pulumi.Input<inputs.BastionhostInstanceAdAuthServer>[]>;
    bandwidth?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    enablePublicAccess?: pulumi.Input<boolean>;
    ldapAuthServers?: pulumi.Input<pulumi.Input<inputs.BastionhostInstanceLdapAuthServer>[]>;
    ...
    timeouts?: pulumi.Input<inputs.BastionhostInstanceTimeouts>;
