...
export class Vswitch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/vswitch:Vswitch';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VswitchTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VswitchArgs | VswitchState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Vswitch.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VswitchState {
    ...
    timeouts?: pulumi.Input<inputs.VswitchTimeouts>;
