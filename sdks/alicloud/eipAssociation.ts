...
export class EipAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/eipAssociation:EipAssociation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.EipAssociationTimeouts | undefined>;
...
export interface EipAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.EipAssociationTimeouts>;
