...
export class QuotasQuotaApplication extends pulumi.CustomResource {
    /**
     * Get an existing QuotasQuotaApplication resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: QuotasQuotaApplicationState, opts?: pulumi.CustomResourceOptions): QuotasQuotaApplication {
        return new QuotasQuotaApplication(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/quotasQuotaApplication:QuotasQuotaApplication';

    /**
     * Returns true if the given object is an instance of QuotasQuotaApplication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is QuotasQuotaApplication {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === QuotasQuotaApplication.__pulumiType;
    }
    ...
    public readonly dimensions!: pulumi.Output<outputs.QuotasQuotaApplicationDimension[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.QuotasQuotaApplicationTimeouts | undefined>;

    /**
     * Create a QuotasQuotaApplication resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: QuotasQuotaApplicationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: QuotasQuotaApplicationArgs | QuotasQuotaApplicationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as QuotasQuotaApplicationState | undefined;
            ...
            const args = argsOrState as QuotasQuotaApplicationArgs | undefined;
        ...
        super(QuotasQuotaApplication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering QuotasQuotaApplication resources.
 */
export interface QuotasQuotaApplicationState {
    ...
    dimensions?: pulumi.Input<pulumi.Input<inputs.QuotasQuotaApplicationDimension>[]>;
    ...
    timeouts?: pulumi.Input<inputs.QuotasQuotaApplicationTimeouts>;
}

/**
 * The set of arguments for constructing a QuotasQuotaApplication resource.
 */
export interface QuotasQuotaApplicationArgs {
    auditMode?: pulumi.Input<string>;
    desireValue: pulumi.Input<number>;
    dimensions?: pulumi.Input<pulumi.Input<inputs.QuotasQuotaApplicationDimension>[]>;
    effectiveTime?: pulumi.Input<string>;
