...
export class RdsServiceLinkedRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/rdsServiceLinkedRole:RdsServiceLinkedRole';
    ...
    constructor(name: string, argsOrState?: RdsServiceLinkedRoleArgs | RdsServiceLinkedRoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RdsServiceLinkedRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
