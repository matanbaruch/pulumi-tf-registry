...
export class CopyImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/copyImage:CopyImage';
    ...
    public readonly timeouts!: pulumi.Output<outputs.CopyImageTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CopyImageArgs | CopyImageState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CopyImage.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CopyImageState {
    ...
    timeouts?: pulumi.Input<inputs.CopyImageTimeouts>;
}
