...
export class EcsKeyPair extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/ecsKeyPair:EcsKeyPair';
    ...
    public readonly timeouts!: pulumi.Output<outputs.EcsKeyPairTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: EcsKeyPairArgs | EcsKeyPairState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EcsKeyPair.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EcsKeyPairState {
    ...
    timeouts?: pulumi.Input<inputs.EcsKeyPairTimeouts>;
}
