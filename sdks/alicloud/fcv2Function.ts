...
export class Fcv2Function extends pulumi.CustomResource {
    /**
     * Get an existing Fcv2Function resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Fcv2FunctionState, opts?: pulumi.CustomResourceOptions): Fcv2Function {
        return new Fcv2Function(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/fcv2Function:Fcv2Function';

    /**
     * Returns true if the given object is an instance of Fcv2Function.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Fcv2Function {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Fcv2Function.__pulumiType;
    }

    public readonly caPort!: pulumi.Output<number>;
    public readonly code!: pulumi.Output<outputs.Fcv2FunctionCode | undefined>;
    public readonly codeChecksum!: pulumi.Output<string>;
    public readonly cpu!: pulumi.Output<number | undefined>;
    public /*out*/ readonly createTime!: pulumi.Output<string>;
    public readonly customContainerConfig!: pulumi.Output<outputs.Fcv2FunctionCustomContainerConfig | undefined>;
    public readonly customDns!: pulumi.Output<outputs.Fcv2FunctionCustomDns | undefined>;
    public readonly customHealthCheckConfig!: pulumi.Output<outputs.Fcv2FunctionCustomHealthCheckConfig | undefined>;
    public readonly customRuntimeConfig!: pulumi.Output<outputs.Fcv2FunctionCustomRuntimeConfig | undefined>;
    ...
    public readonly instanceLifecycleConfig!: pulumi.Output<outputs.Fcv2FunctionInstanceLifecycleConfig | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.Fcv2FunctionTimeouts | undefined>;

    /**
     * Create a Fcv2Function resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: Fcv2FunctionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Fcv2FunctionArgs | Fcv2FunctionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Fcv2FunctionState | undefined;
            ...
            const args = argsOrState as Fcv2FunctionArgs | undefined;
        ...
        super(Fcv2Function.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Fcv2Function resources.
 */
export interface Fcv2FunctionState {
    caPort?: pulumi.Input<number>;
    code?: pulumi.Input<inputs.Fcv2FunctionCode>;
    codeChecksum?: pulumi.Input<string>;
    cpu?: pulumi.Input<number>;
    createTime?: pulumi.Input<string>;
    customContainerConfig?: pulumi.Input<inputs.Fcv2FunctionCustomContainerConfig>;
    customDns?: pulumi.Input<inputs.Fcv2FunctionCustomDns>;
    customHealthCheckConfig?: pulumi.Input<inputs.Fcv2FunctionCustomHealthCheckConfig>;
    customRuntimeConfig?: pulumi.Input<inputs.Fcv2FunctionCustomRuntimeConfig>;
    ...
    instanceLifecycleConfig?: pulumi.Input<inputs.Fcv2FunctionInstanceLifecycleConfig>;
    ...
    timeouts?: pulumi.Input<inputs.Fcv2FunctionTimeouts>;
}

/**
 * The set of arguments for constructing a Fcv2Function resource.
 */
export interface Fcv2FunctionArgs {
    caPort?: pulumi.Input<number>;
    code?: pulumi.Input<inputs.Fcv2FunctionCode>;
    codeChecksum?: pulumi.Input<string>;
    cpu?: pulumi.Input<number>;
