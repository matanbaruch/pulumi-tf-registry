...
export class NetworkAclAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:index/networkAclAttachment:NetworkAclAttachment';
    ...
    public readonly resources!: pulumi.Output<outputs.NetworkAclAttachmentResource[]>;
    ...
    constructor(name: string, argsOrState?: NetworkAclAttachmentArgs | NetworkAclAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkAclAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NetworkAclAttachmentState {
    ...
    resources?: pulumi.Input<pulumi.Input<inputs.NetworkAclAttachmentResource>[]>;
}
