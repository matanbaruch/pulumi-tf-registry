...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("secureworkload");
			params.setVersion("1.7.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Npc2NvZGV2bmV0L3NlY3VyZXdvcmtsb2FkIiwidmVyc2lvbiI6IjEuNy42In19"), c => c.charCodeAt(0)));
