...
export class Scope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'secureworkload:index/scope:Scope';
    ...
    /**
     * Root scope for the secureworkload installation
     */
    ...
    /**
     * JSON object representation of an inventory filter query. The query shown in the above example is
     * 'orchestrator_system/name containes Random and Address = 10.0.1.1 or CVE Score v3 >2'.Operator can any of the following:
     * [and, or, eq, subnet, contains, regex, gt, gte, lt, lte, in, range, ranges, not, all, none]
     */
    public readonly shortQuery!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ScopeArgs | ScopeState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["shortQuery"] = state ? state.shortQuery : undefined;
            ...
            resourceInputs["shortQuery"] = args ? args.shortQuery : undefined;
...
export interface ScopeState {
     ...
     * [and, or, eq, subnet, contains, regex, gt, gte, lt, lte, in, range, ranges, not, all, none]
     */
    shortQuery?: pulumi.Input<string>;
    /**
     * User-specified sub type for the scope.
     */
