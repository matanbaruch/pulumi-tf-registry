...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("observability");
			params.setVersion("0.0.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Npc2NvLW9wZW4vb2JzZXJ2YWJpbGl0eSIsInZlcnNpb24iOiIwLjAuMiJ9fQ=="), c => c.charCodeAt(0)));
