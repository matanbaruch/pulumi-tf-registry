...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("versadirector");
			params.setVersion("0.0.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ZlcnNhLW5ldHdvcmtzL3ZlcnNhZGlyZWN0b3IiLCJ2ZXJzaW9uIjoiMC4wLjEifX0="), c => c.charCodeAt(0)));
