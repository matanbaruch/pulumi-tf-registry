...
export class InputsTcpCooked extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.InputsTcpCookedAcl | undefined>;
    /**
    ...
    /**
     * Required. The port number of this input.
     */
    ...
    constructor(name: string, argsOrState?: InputsTcpCookedArgs | InputsTcpCookedState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InputsTcpCooked.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
