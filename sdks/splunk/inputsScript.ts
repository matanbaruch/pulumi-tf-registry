...
export class InputsScript extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.InputsScriptAcl | undefined>;
    /**
    ...
    /**
     * Specify an integer or cron schedule. This parameter specifies how often to execute the specified script, in seconds or a
     * valid cron schedule. If you specify a cron schedule, the script is not executed on start-up.
     */
    ...
    /**
     * User to run the script as. If you provide a username, Splunk software generates an auth token for that user and passes
     * it to the script.
     */
    ...
    constructor(name: string, argsOrState?: InputsScriptArgs | InputsScriptState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InputsScript.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
