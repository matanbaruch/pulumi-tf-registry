...
export class DataUiViews extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.DataUiViewsAcl | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DataUiViewsArgs | DataUiViewsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DataUiViews.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
