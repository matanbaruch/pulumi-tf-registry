...
export class ConfigsConf extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.ConfigsConfAcl | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ConfigsConfArgs | ConfigsConfState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConfigsConf.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
