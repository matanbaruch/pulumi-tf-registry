...
export class OutputsTcpSyslog extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.OutputsTcpSyslogAcl | undefined>;
    /**
    ...
    /**
     * Sets syslog priority value.The priority value should specified as an integer. See
     * $SPLUNK_HOME/etc/system/README/outputs.conf.spec for details.
     */
    ...
    /**
     * Specifies a rule for handling data in addition to that provided by the "syslog" sourcetype. By default, there is no
     * value for syslogSourceType.This string is used as a substring match against the sourcetype key.
     */
    public readonly syslogSourcetype!: pulumi.Output<string>;
    /**
     * Format of timestamp to add at start of the events to be forwarded.The format is a strftime-style timestamp formatting
     * string. See $SPLUNK_HOME/etc/system/README/outputs.conf.spec for details.
     */
    ...
    constructor(name: string, argsOrState?: OutputsTcpSyslogArgs | OutputsTcpSyslogState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OutputsTcpSyslog.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
