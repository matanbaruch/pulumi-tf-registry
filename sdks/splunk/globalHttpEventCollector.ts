...
export class GlobalHttpEventCollector extends pulumi.CustomResource {
    ...
    /**
     * Maximum number of simultaneous HTTP connections accepted. Adjusting this value may cause server performance issues and
     * is not generally recommended. Possible values for this setting vary by OS.
     */
    public readonly maxSockets!: pulumi.Output<number>;
    /**
     * Maximum number of threads that can be used by active HTTP transactions. Adjusting this value may cause server
     * performance issues and is not generally recommended. Possible values for this setting vary by OS.
     */
    ...
    /**
     * Indicates whether the event collector input writes its configuration to a deployment server repository.When this setting
     * is set to 1 (enabled), the input writes its configuration to the directory specified as repositoryLocation in
     * serverclass.conf.Copy the full contents of the splunk_httpinput app directory to this directory for the configuration to
     * work.When enabled, only the tokens defined in the splunk_httpinput app in this repository are viewable and editable on
     * the API and the Data Inputs page in Splunk Web.When disabled, the input writes its configuration to
     * $SPLUNK_HOME/etc/apps by default.Defaults to 0 (disabled).
     */
    ...
    constructor(name: string, argsOrState?: GlobalHttpEventCollectorArgs | GlobalHttpEventCollectorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GlobalHttpEventCollector.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
