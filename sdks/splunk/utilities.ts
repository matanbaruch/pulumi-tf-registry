...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("splunk");
			params.setVersion("1.4.24");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NwbHVuay9zcGx1bmsiLCJ2ZXJzaW9uIjoiMS40LjI0In19"), c => c.charCodeAt(0)));
