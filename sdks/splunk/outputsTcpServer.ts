...
export class OutputsTcpServer extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.OutputsTcpServerAcl | undefined>;
    /**
     * Disables default tcpout settings
     */
    public readonly disabled!: pulumi.Output<boolean>;
    /**
     * Valid values: (clone | balance | autobalance)The data distribution method used when two or more servers exist in the
     * same forwarder group.
     */
    public readonly method!: pulumi.Output<string>;
    /**
     * <host>:<port> of the Splunk receiver. <host> can be either an ip address or server name. <port> is the that port that
     * the Splunk receiver is listening on.
     */
    ...
    /**
     * Check the common name of the server's certificate against this name.If there is no match, assume that Splunk Enterprise
     * is not authenticated against this server. You must specify this setting if sslVerifyServerCert is true.
     */
    ...
    /**
     * If true, make sure that the server you are connecting to is a valid one (authenticated). Both the common name and the
     * alternate name of the server are then checked for a match.
     */
    ...
    constructor(name: string, argsOrState?: OutputsTcpServerArgs | OutputsTcpServerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OutputsTcpServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
