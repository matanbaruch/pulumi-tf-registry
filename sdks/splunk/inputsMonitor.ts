...
export class InputsMonitor extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.InputsMonitorAcl | undefined>;
    /**
    ...
    /**
     * A string that modifies the file tracking identity for files in this input. The magic value <SOURCE> invokes special
    ...
    /**
     * Specify a regular expression for a file path. If the path for a file matches this regular expression, the captured value
     * is used to populate the host field for events from this data input. The regular expression must have one capture group.
     */
    ...
    /**
     * Specify a time value. If the modification time of a file being monitored falls outside of this rolling time window, the
     * file is no longer being monitored.
     */
    ...
    /**
     * The value to populate in the source field for events from this data input. The same source should not be used for
    ...
    /**
     * When Splunk software reaches the end of a file that is being read, the file is kept open for a minimum of the number of
     * seconds specified in this value. After this period has elapsed, the file is checked again for more data.
     */
    ...
    constructor(name: string, argsOrState?: InputsMonitorArgs | InputsMonitorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InputsMonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
