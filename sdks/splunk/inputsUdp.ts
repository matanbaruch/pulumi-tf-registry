...
export class InputsUdp extends pulumi.CustomResource {
    ...
    public readonly acl!: pulumi.Output<outputs.InputsUdpAcl | undefined>;
    /**
    ...
    /**
     * The value to populate in the host field for incoming events. This is used during parsing/indexing, in particular to set
     * the host field. It is also the host field used at search time.
     */
    ...
    /**
     * Restrict incoming connections on this port to the host specified here. If this is not set, the value specified in
     * [udp://<remote server>:<port>] in inputs.conf is used.
     */
    public readonly restrictToHost!: pulumi.Output<string>;
    /**
     * The value to populate in the source field for incoming events. The same source should not be used for multiple data
     * inputs.
     */
    ...
    constructor(name: string, argsOrState?: InputsUdpArgs | InputsUdpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InputsUdp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
