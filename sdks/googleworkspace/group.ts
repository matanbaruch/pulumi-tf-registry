...
export class Group extends pulumi.CustomResource {
     ...
     * parent),members of the child group are not counted in the directMembersCount property of the parent group.
     */
    ...
    /**
     * asps.list of the group's non-editable alias email addresses that are outside of the account's primary domain or
