...
export class GmailSendAsAlias extends pulumi.CustomResource {
     ...
     * address, and it cannot be deleted from the collection of send-as aliases.
     */
    ...
    /**
     * An optional HTML signature that is included in messages composed with this alias in the Gmail web UI. This signature is
     * added to new emails only.
     */
    ...
    /**
     * Defaults to `true`. Whether Gmail should treat this address as an alias for the user's primary email address. This
     * setting only applies to custom 'from' aliases. See https://support.google.com/a/answer/1710338 for help on making this
     * decision
     */
    ...
    constructor(name: string, argsOrState?: GmailSendAsAliasArgs | GmailSendAsAliasState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GmailSendAsAlias.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
