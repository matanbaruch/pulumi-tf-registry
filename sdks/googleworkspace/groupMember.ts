...
export class GroupMember extends pulumi.CustomResource {
    ...
    /**
     * Defaults to `ALL_MAIL`. Defines mail delivery preferences of member. Acceptable values are: - `ALL_MAIL`: All messages,
    ...
    /**
     * Defaults to `MEMBER`. The member's role in a group. The API returns an error for cycles in group memberships. For
    ...
    public readonly timeouts!: pulumi.Output<outputs.GroupMemberTimeouts | undefined>;
    /**
     * Defaults to `USER`. The type of group member. Acceptable values are: - `CUSTOMER`: The member represents all users in a
...
export interface GroupMemberState {
    ...
    timeouts?: pulumi.Input<inputs.GroupMemberTimeouts>;
    /**
     * Defaults to `USER`. The type of group member. Acceptable values are: - `CUSTOMER`: The member represents all users in a
     * domain. An email address is not returned and the ID returned is the customer ID. - `GROUP`: The member is another group.
     * - `USER`: The member is a user.
