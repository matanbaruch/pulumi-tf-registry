...
export class GroupSettings extends pulumi.CustomResource {
    ...
    /**
     * Defaults to `false`. Identifies whether members external to your organization can join the group. If true, Google
    ...
    /**
     * Defaults to `true`. Allows posting from web. If true, allows any member to post to the group forum. If false, Members
     * only use Gmail to communicate with the group.
     */
    public readonly allowWebPosting!: pulumi.Output<boolean | undefined>;
    /**
     * Defaults to `false`. Allows the group to be archived only. If true, Group is archived and the group is inactive. New
    ...
    /**
     * Defaults to `true`. Enables the group to be included in the Global Address List. If true, the group is included in the
    ...
    /**
     * Defaults to `false`. Allows the Group contents to be archived. If true, archive messages sent to the group. If false, Do
    ...
    /**
     * Defaults to `false`. Enables members to post messages as the group. If true, group member can post messages using the
    ...
    /**
     * Defaults to `MODERATE_NONE`. Moderation level of incoming messages. Possible values are: - `MODERATE_ALL_MESSAGES`: All
    ...
    /**
     * Defaults to `REPLY_TO_IGNORE`. Specifies who receives the default reply. Possible values are: - `REPLY_TO_CUSTOM`: For
    ...
    /**
     * Defaults to `false`. Allows a member to be notified if the member's message to the group is denied by the group owner.
    ...
    /**
     * Defaults to `MODERATE`. Specifies moderation levels for messages detected as spam. Possible values are: - `ALLOW`: Post
    ...
    public readonly timeouts!: pulumi.Output<outputs.GroupSettingsTimeouts | undefined>;
    /**
     * Defaults to `NONE`. Specifies who can moderate metadata. Possible values are: - `ALL_MEMBERS` - `OWNERS_AND_MANAGERS` -
    ...
    /**
     * Defaults to `ALL_IN_DOMAIN_CAN_DISCOVER`. Specifies the set of users for whom this group is discoverable. Possible
    ...
    /**
     * Defaults to `CAN_REQUEST_TO_JOIN`. Permission to join group. Possible values are: - `ANYONE_CAN_JOIN`: Any Internet
    ...
    /**
     * Defaults to `ALL_MEMBERS_CAN_LEAVE`. Permission to leave the group. Possible values are: - `ALL_MANAGERS_CAN_LEAVE` -
     * `ALL_MEMBERS_CAN_LEAVE` - `NONE_CAN_LEAVE`
     */
    public readonly whoCanLeaveGroup!: pulumi.Output<string | undefined>;
    /**
     * Defaults to `OWNERS_AND_MANAGERS`. Specifies who can moderate content. Possible values are: - `ALL_MEMBERS` -
     * `OWNERS_AND_MANAGERS` - `OWNERS_ONLY` - `NONE`
     */
    public readonly whoCanModerateContent!: pulumi.Output<string | undefined>;
    /**
     * Defaults to `OWNERS_AND_MANAGERS`. Specifies who can manage members. Possible values are: - `ALL_MEMBERS` -
     * `OWNERS_AND_MANAGERS` - `OWNERS_ONLY` - `NONE`
     */
    ...
    /**
     * Defaults to `ALL_MEMBERS_CAN_VIEW`. Permissions to view group messages. Possible values are: - `ANYONE_CAN_VIEW`: Any
    ...
    /**
     * Defaults to `ALL_MEMBERS_CAN_VIEW`. Permissions to view membership. Possible values are: - `ALL_IN_DOMAIN_CAN_VIEW`:
...
export interface GroupSettingsState {
    ...
    timeouts?: pulumi.Input<inputs.GroupSettingsTimeouts>;
    /**
     * Defaults to `NONE`. Specifies who can moderate metadata. Possible values are: - `ALL_MEMBERS` - `OWNERS_AND_MANAGERS` -
     * `MANAGERS_ONLY` - `OWNERS_ONLY` - `NONE`
     */
