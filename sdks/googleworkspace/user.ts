...
export class User extends pulumi.CustomResource {
     ...
     */
    public readonly emails!: pulumi.Output<outputs.UserEmail[] | undefined>;
    /**
    ...
    /**
     * Defaults to `true`. Indicates if the user's profile is visible in the Google Workspace global address list when the
