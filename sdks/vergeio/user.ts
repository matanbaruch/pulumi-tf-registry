...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'vergeio:index/user:User';
    ...
    public readonly authSource!: pulumi.Output<number>;
    ...
    constructor(name: string, argsOrState?: UserArgs | UserState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["authSource"] = state ? state.authSource : undefined;
            ...
            resourceInputs["authSource"] = args ? args.authSource : undefined;
...
export interface UserState {
    authSource?: pulumi.Input<number>;
