...
export class ServiceendpointJfrogXrayV2 extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServiceendpointJfrogXrayV2Timeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceendpointJfrogXrayV2Args | ServiceendpointJfrogXrayV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceendpointJfrogXrayV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServiceendpointJfrogXrayV2State {
    ...
    timeouts?: pulumi.Input<inputs.ServiceendpointJfrogXrayV2Timeouts>;
    /**
     * Url for the JFrog Artifactory Server
     */
