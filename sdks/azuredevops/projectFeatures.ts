...
export class ProjectFeatures extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ProjectFeaturesTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ProjectFeaturesArgs | ProjectFeaturesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectFeatures.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ProjectFeaturesState {
    ...
    timeouts?: pulumi.Input<inputs.ProjectFeaturesTimeouts>;
}
