...
export class BranchPolicyBuildValidation extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.BranchPolicyBuildValidationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: BranchPolicyBuildValidationArgs | BranchPolicyBuildValidationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BranchPolicyBuildValidation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface BranchPolicyBuildValidationState {
    ...
    timeouts?: pulumi.Input<inputs.BranchPolicyBuildValidationTimeouts>;
}
