...
export class ServiceendpointIncomingwebhook extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServiceendpointIncomingwebhookTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceendpointIncomingwebhookArgs | ServiceendpointIncomingwebhookState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceendpointIncomingwebhook.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServiceendpointIncomingwebhookState {
    ...
    timeouts?: pulumi.Input<inputs.ServiceendpointIncomingwebhookTimeouts>;
    /**
     * The name of the WebHook.
     */
