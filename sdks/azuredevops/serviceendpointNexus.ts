...
export class ServiceendpointNexus extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServiceendpointNexusTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceendpointNexusArgs | ServiceendpointNexusState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceendpointNexus.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServiceendpointNexusState {
    ...
    timeouts?: pulumi.Input<inputs.ServiceendpointNexusTimeouts>;
    /**
     * Url for the Nexus Repository
     */
