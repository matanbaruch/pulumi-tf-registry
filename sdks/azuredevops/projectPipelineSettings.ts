...
export class ProjectPipelineSettings extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ProjectPipelineSettingsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ProjectPipelineSettingsArgs | ProjectPipelineSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectPipelineSettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ProjectPipelineSettingsState {
    ...
    timeouts?: pulumi.Input<inputs.ProjectPipelineSettingsTimeouts>;
}
