...
export class VariableGroupPermissions extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.VariableGroupPermissionsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VariableGroupPermissionsArgs | VariableGroupPermissionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VariableGroupPermissions.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VariableGroupPermissionsState {
    ...
    timeouts?: pulumi.Input<inputs.VariableGroupPermissionsTimeouts>;
