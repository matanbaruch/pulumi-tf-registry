...
export class TeamAdministrators extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.TeamAdministratorsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: TeamAdministratorsArgs | TeamAdministratorsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TeamAdministrators.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface TeamAdministratorsState {
    ...
    timeouts?: pulumi.Input<inputs.TeamAdministratorsTimeouts>;
}
