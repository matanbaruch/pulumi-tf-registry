...
export class GitRepositoryFile extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.GitRepositoryFileTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: GitRepositoryFileArgs | GitRepositoryFileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GitRepositoryFile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface GitRepositoryFileState {
    ...
    timeouts?: pulumi.Input<inputs.GitRepositoryFileTimeouts>;
}
