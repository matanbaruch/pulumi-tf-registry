...
export class BranchPolicyStatusCheck extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.BranchPolicyStatusCheckTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: BranchPolicyStatusCheckArgs | BranchPolicyStatusCheckState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BranchPolicyStatusCheck.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface BranchPolicyStatusCheckState {
    ...
    timeouts?: pulumi.Input<inputs.BranchPolicyStatusCheckTimeouts>;
}
