...
export class AreaPermissions extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AreaPermissionsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AreaPermissionsArgs | AreaPermissionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AreaPermissions.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AreaPermissionsState {
    ...
    timeouts?: pulumi.Input<inputs.AreaPermissionsTimeouts>;
}
