...
export class GitPermissions extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.GitPermissionsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: GitPermissionsArgs | GitPermissionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GitPermissions.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface GitPermissionsState {
    ...
    timeouts?: pulumi.Input<inputs.GitPermissionsTimeouts>;
}
