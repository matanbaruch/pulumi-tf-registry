...
export class BuildDefinition extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.BuildDefinitionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: BuildDefinitionArgs | BuildDefinitionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BuildDefinition.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface BuildDefinitionState {
    ...
    timeouts?: pulumi.Input<inputs.BuildDefinitionTimeouts>;
