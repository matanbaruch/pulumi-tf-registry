...
export class BranchPolicyMergeTypes extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.BranchPolicyMergeTypesTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: BranchPolicyMergeTypesArgs | BranchPolicyMergeTypesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BranchPolicyMergeTypes.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface BranchPolicyMergeTypesState {
    ...
    timeouts?: pulumi.Input<inputs.BranchPolicyMergeTypesTimeouts>;
}
