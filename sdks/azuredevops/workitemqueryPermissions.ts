...
export class WorkitemqueryPermissions extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.WorkitemqueryPermissionsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: WorkitemqueryPermissionsArgs | WorkitemqueryPermissionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WorkitemqueryPermissions.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface WorkitemqueryPermissionsState {
    ...
    timeouts?: pulumi.Input<inputs.WorkitemqueryPermissionsTimeouts>;
}
