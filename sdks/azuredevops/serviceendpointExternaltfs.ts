...
export class ServiceendpointExternaltfs extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServiceendpointExternaltfsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ServiceendpointExternaltfsArgs | ServiceendpointExternaltfsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceendpointExternaltfs.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServiceendpointExternaltfsState {
    ...
    timeouts?: pulumi.Input<inputs.ServiceendpointExternaltfsTimeouts>;
}
