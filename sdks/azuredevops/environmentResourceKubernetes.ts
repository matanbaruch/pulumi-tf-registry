...
export class EnvironmentResourceKubernetes extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.EnvironmentResourceKubernetesTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: EnvironmentResourceKubernetesArgs | EnvironmentResourceKubernetesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EnvironmentResourceKubernetes.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EnvironmentResourceKubernetesState {
    ...
    timeouts?: pulumi.Input<inputs.EnvironmentResourceKubernetesTimeouts>;
}
