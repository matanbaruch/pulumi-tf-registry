...
export class Feed extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.FeedTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: FeedArgs | FeedState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Feed.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FeedState {
    ...
    timeouts?: pulumi.Input<inputs.FeedTimeouts>;
}
