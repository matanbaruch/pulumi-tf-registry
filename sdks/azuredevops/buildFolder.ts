...
export class BuildFolder extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.BuildFolderTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: BuildFolderArgs | BuildFolderState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BuildFolder.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface BuildFolderState {
    ...
    timeouts?: pulumi.Input<inputs.BuildFolderTimeouts>;
}
