...
export class SecurityroleAssignment extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.SecurityroleAssignmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SecurityroleAssignmentArgs | SecurityroleAssignmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SecurityroleAssignment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SecurityroleAssignmentState {
    ...
    timeouts?: pulumi.Input<inputs.SecurityroleAssignmentTimeouts>;
}
