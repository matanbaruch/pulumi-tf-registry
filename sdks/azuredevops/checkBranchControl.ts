...
export class CheckBranchControl extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CheckBranchControlTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CheckBranchControlArgs | CheckBranchControlState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CheckBranchControl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CheckBranchControlState {
    ...
    timeouts?: pulumi.Input<inputs.CheckBranchControlTimeouts>;
