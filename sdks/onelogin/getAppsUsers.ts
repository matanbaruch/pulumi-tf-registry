...
export function getAppsUsers(args: GetAppsUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetAppsUsersResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("onelogin:index/getAppsUsers:getAppsUsers", {
...
/**
 * A collection of arguments for invoking getAppsUsers.
 */
export interface GetAppsUsersArgs {
    activatedAt?: string;
    appsId: string;
    comment?: string;
    company?: string;
    ...
    email?: string;
    externalId?: string;
    filters?: inputs.GetAppsUsersFilter[];
    firstname?: string;
    groupId?: number;
    id?: string;
...
/**
 * A collection of values returned by getAppsUsers.
 */
export interface GetAppsUsersResult {
    ...
    readonly filters?: outputs.GetAppsUsersFilter[];
...
export function getAppsUsersOutput(args: GetAppsUsersOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAppsUsersResult> {
    return pulumi.output(args).apply((a: any) => getAppsUsers(a, opts))
}

/**
 * A collection of arguments for invoking getAppsUsers.
 */
export interface GetAppsUsersOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.GetAppsUsersFilterArgs>[]>;
