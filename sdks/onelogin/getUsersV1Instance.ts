...
export function getUsersV1Instance(args: GetUsersV1InstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetUsersV1InstanceResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("onelogin:index/getUsersV1Instance:getUsersV1Instance", {
...
/**
 * A collection of arguments for invoking getUsersV1Instance.
 */
export interface GetUsersV1InstanceArgs {
    activatedAt?: string;
    comment?: string;
    company?: string;
    createdAt?: string;
...
/**
 * A collection of values returned by getUsersV1Instance.
 */
export interface GetUsersV1InstanceResult {
...
export function getUsersV1InstanceOutput(args: GetUsersV1InstanceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetUsersV1InstanceResult> {
    return pulumi.output(args).apply((a: any) => getUsersV1Instance(a, opts))
}

/**
 * A collection of arguments for invoking getUsersV1Instance.
 */
export interface GetUsersV1InstanceOutputArgs {
