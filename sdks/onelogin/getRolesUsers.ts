...
export function getRolesUsers(args: GetRolesUsersArgs, opts?: pulumi.InvokeOptions): Promise<GetRolesUsersResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("onelogin:index/getRolesUsers:getRolesUsers", {
...
/**
 * A collection of arguments for invoking getRolesUsers.
 */
export interface GetRolesUsersArgs {
    activatedAt?: string;
    comment?: string;
    company?: string;
    createdAt?: string;
    ...
    email?: string;
    externalId?: string;
    filters?: inputs.GetRolesUsersFilter[];
    firstname?: string;
    groupId?: number;
    id?: string;
...
/**
 * A collection of values returned by getRolesUsers.
 */
export interface GetRolesUsersResult {
    ...
    readonly filters?: outputs.GetRolesUsersFilter[];
...
export function getRolesUsersOutput(args: GetRolesUsersOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRolesUsersResult> {
    return pulumi.output(args).apply((a: any) => getRolesUsers(a, opts))
}

/**
 * A collection of arguments for invoking getRolesUsers.
 */
export interface GetRolesUsersOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.GetRolesUsersFilterArgs>[]>;
