...
export class Users extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'onelogin:index/users:Users';
    ...
    public readonly timeouts!: pulumi.Output<outputs.UsersTimeouts | undefined>;
    /**
...
export interface UsersState {
    ...
    timeouts?: pulumi.Input<inputs.UsersTimeouts>;
    /**
     * The user's job title.
     */
