...
export function getRolesAdmins(args: GetRolesAdminsArgs, opts?: pulumi.InvokeOptions): Promise<GetRolesAdminsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("onelogin:index/getRolesAdmins:getRolesAdmins", {
...
/**
 * A collection of arguments for invoking getRolesAdmins.
 */
export interface GetRolesAdminsArgs {
    activatedAt?: string;
    comment?: string;
    company?: string;
    createdAt?: string;
    ...
    email?: string;
    externalId?: string;
    filters?: inputs.GetRolesAdminsFilter[];
    firstname?: string;
    groupId?: number;
    id?: string;
...
/**
 * A collection of values returned by getRolesAdmins.
 */
export interface GetRolesAdminsResult {
    ...
    readonly filters?: outputs.GetRolesAdminsFilter[];
...
export function getRolesAdminsOutput(args: GetRolesAdminsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRolesAdminsResult> {
    return pulumi.output(args).apply((a: any) => getRolesAdmins(a, opts))
}

/**
 * A collection of arguments for invoking getRolesAdmins.
 */
export interface GetRolesAdminsOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.GetRolesAdminsFilterArgs>[]>;
