...
export class Privileges extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.PrivilegesTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PrivilegesArgs | PrivilegesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Privileges.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PrivilegesState {
    ...
    timeouts?: pulumi.Input<inputs.PrivilegesTimeouts>;
}
