...
export class UsersV1 extends pulumi.CustomResource {
    /**
     * Get an existing UsersV1 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UsersV1State, opts?: pulumi.CustomResourceOptions): UsersV1 {
        return new UsersV1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'onelogin:index/usersV1:UsersV1';

    /**
     * Returns true if the given object is an instance of UsersV1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is UsersV1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === UsersV1.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.UsersV1Timeouts | undefined>;
    /**
    ...
    /**
     * Create a UsersV1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: UsersV1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: UsersV1Args | UsersV1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as UsersV1State | undefined;
            ...
            const args = argsOrState as UsersV1Args | undefined;
        ...
        super(UsersV1.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering UsersV1 resources.
 */
export interface UsersV1State {
    ...
    timeouts?: pulumi.Input<inputs.UsersV1Timeouts>;
    /**
     * The user's job title.
     */
...
/**
 * The set of arguments for constructing a UsersV1 resource.
 */
export interface UsersV1Args {
    activatedAt?: pulumi.Input<string>;
    /**
     * Free text related to the user.
     */
