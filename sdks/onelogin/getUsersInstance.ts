...
export function getUsersInstance(args: GetUsersInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetUsersInstanceResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("onelogin:index/getUsersInstance:getUsersInstance", {
...
/**
 * A collection of arguments for invoking getUsersInstance.
 */
export interface GetUsersInstanceArgs {
    activatedAt?: string;
    comment?: string;
    company?: string;
    createdAt?: string;
...
/**
 * A collection of values returned by getUsersInstance.
 */
export interface GetUsersInstanceResult {
...
export function getUsersInstanceOutput(args: GetUsersInstanceOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetUsersInstanceResult> {
    return pulumi.output(args).apply((a: any) => getUsersInstance(a, opts))
}

/**
 * A collection of arguments for invoking getUsersInstance.
 */
export interface GetUsersInstanceOutputArgs {
