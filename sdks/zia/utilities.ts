...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("zia");
			params.setVersion("3.0.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3pzY2FsZXIvemlhIiwidmVyc2lvbiI6IjMuMC4zIn19"), c => c.charCodeAt(0)));
