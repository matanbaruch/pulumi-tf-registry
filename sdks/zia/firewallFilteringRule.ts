...
export class FirewallFilteringRule extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.FirewallFilteringRuleTimeouts | undefined>;
    /**
     ...
     */
    public readonly workloadGroups!: pulumi.Output<outputs.FirewallFilteringRuleWorkloadGroup[] | undefined>;
    /**
     ...
     */
    public readonly zpaAppSegments!: pulumi.Output<outputs.FirewallFilteringRuleZpaAppSegment[] | undefined>;
    ...
    constructor(name: string, argsOrState?: FirewallFilteringRuleArgs | FirewallFilteringRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FirewallFilteringRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FirewallFilteringRuleState {
    ...
    timeouts?: pulumi.Input<inputs.FirewallFilteringRuleTimeouts>;
    /**
     * list of users for which rule must be applied
     */
