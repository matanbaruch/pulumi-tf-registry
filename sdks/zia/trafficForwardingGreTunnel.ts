...
export class TrafficForwardingGreTunnel extends pulumi.CustomResource {
     ...
     */
    public readonly primaryDestVips!: pulumi.Output<outputs.TrafficForwardingGreTunnelPrimaryDestVip[] | undefined>;
    /**
     * The secondary destination data center and virtual IP address (VIP) of the GRE tunnel
     */
    public readonly secondaryDestVips!: pulumi.Output<outputs.TrafficForwardingGreTunnelSecondaryDestVip[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: TrafficForwardingGreTunnelArgs | TrafficForwardingGreTunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TrafficForwardingGreTunnel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
