...
export class UrlCategories extends pulumi.CustomResource {
    ...
    public readonly urlKeywordCounts!: pulumi.Output<outputs.UrlCategoriesUrlKeywordCounts | undefined>;
    ...
    constructor(name: string, argsOrState?: UrlCategoriesArgs | UrlCategoriesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UrlCategories.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
