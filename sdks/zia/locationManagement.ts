...
export class LocationManagement extends pulumi.CustomResource {
     ...
     */
    public readonly dynamicLocationGroups!: pulumi.Output<outputs.LocationManagementDynamicLocationGroups | undefined>;
     ...
     * Name-ID pairs of locations for which rule must be applied
     */
    public readonly staticLocationGroups!: pulumi.Output<outputs.LocationManagementStaticLocationGroups | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LocationManagementArgs | LocationManagementState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LocationManagement.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
