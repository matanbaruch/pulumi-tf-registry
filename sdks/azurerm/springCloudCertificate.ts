...
export class SpringCloudCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/springCloudCertificate:SpringCloudCertificate';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SpringCloudCertificateTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SpringCloudCertificateArgs | SpringCloudCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpringCloudCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpringCloudCertificateState {
    ...
    timeouts?: pulumi.Input<inputs.SpringCloudCertificateTimeouts>;
}
