...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/networkWatcher:NetworkWatcher';
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkWatcherTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NetworkWatcherArgs | NetworkWatcherState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkWatcher.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NetworkWatcherState {
    ...
    timeouts?: pulumi.Input<inputs.NetworkWatcherTimeouts>;
}
