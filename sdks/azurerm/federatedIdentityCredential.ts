...
export class FederatedIdentityCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/federatedIdentityCredential:FederatedIdentityCredential';
    ...
    public readonly timeouts!: pulumi.Output<outputs.FederatedIdentityCredentialTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: FederatedIdentityCredentialArgs | FederatedIdentityCredentialState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FederatedIdentityCredential.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FederatedIdentityCredentialState {
    ...
    timeouts?: pulumi.Input<inputs.FederatedIdentityCredentialTimeouts>;
}
