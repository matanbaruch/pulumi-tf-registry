...
export class VirtualMachineRestorePointCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/virtualMachineRestorePointCollection:VirtualMachineRestorePointCollection';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VirtualMachineRestorePointCollectionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VirtualMachineRestorePointCollectionArgs | VirtualMachineRestorePointCollectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VirtualMachineRestorePointCollection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VirtualMachineRestorePointCollectionState {
    ...
    timeouts?: pulumi.Input<inputs.VirtualMachineRestorePointCollectionTimeouts>;
}
