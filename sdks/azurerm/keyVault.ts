...
export class KeyVault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/keyVault:KeyVault';
     ...
     */
    public readonly contacts!: pulumi.Output<outputs.KeyVaultContact[] | undefined>;
...
export interface KeyVaultState {
     ...
     * @deprecated Deprecated
     */
    contacts?: pulumi.Input<pulumi.Input<inputs.KeyVaultContact>[]>;
