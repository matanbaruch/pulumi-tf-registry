...
export class WindowsVirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/windowsVirtualMachine:WindowsVirtualMachine';
    ...
    public readonly galleryApplications!: pulumi.Output<outputs.WindowsVirtualMachineGalleryApplication[] | undefined>;
    public readonly hotpatchingEnabled!: pulumi.Output<boolean | undefined>;
    public readonly identity!: pulumi.Output<outputs.WindowsVirtualMachineIdentity | undefined>;
    ...
    public readonly osImageNotification!: pulumi.Output<outputs.WindowsVirtualMachineOsImageNotification | undefined>;
    ...
    public readonly terminationNotification!: pulumi.Output<outputs.WindowsVirtualMachineTerminationNotification | undefined>;
...
export interface WindowsVirtualMachineState {
    ...
    galleryApplications?: pulumi.Input<pulumi.Input<inputs.WindowsVirtualMachineGalleryApplication>[]>;
    hotpatchingEnabled?: pulumi.Input<boolean>;
    identity?: pulumi.Input<inputs.WindowsVirtualMachineIdentity>;
    ...
    osImageNotification?: pulumi.Input<inputs.WindowsVirtualMachineOsImageNotification>;
    ...
    terminationNotification?: pulumi.Input<inputs.WindowsVirtualMachineTerminationNotification>;
