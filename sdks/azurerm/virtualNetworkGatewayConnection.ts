...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/virtualNetworkGatewayConnection:VirtualNetworkGatewayConnection';
    ...
    public readonly customBgpAddresses!: pulumi.Output<outputs.VirtualNetworkGatewayConnectionCustomBgpAddresses | undefined>;
    ...
    public readonly trafficSelectorPolicies!: pulumi.Output<outputs.VirtualNetworkGatewayConnectionTrafficSelectorPolicy[] | undefined>;
...
export interface VirtualNetworkGatewayConnectionState {
    ...
    customBgpAddresses?: pulumi.Input<inputs.VirtualNetworkGatewayConnectionCustomBgpAddresses>;
    ...
    trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.VirtualNetworkGatewayConnectionTrafficSelectorPolicy>[]>;
