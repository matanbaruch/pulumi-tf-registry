...
export class RouteMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/routeMap:RouteMap';
    ...
    public readonly rules!: pulumi.Output<outputs.RouteMapRule[] | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.RouteMapTimeouts | undefined>;
...
export interface RouteMapState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.RouteMapRule>[]>;
    timeouts?: pulumi.Input<inputs.RouteMapTimeouts>;
