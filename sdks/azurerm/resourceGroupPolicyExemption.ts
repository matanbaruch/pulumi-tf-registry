...
export class ResourceGroupPolicyExemption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/resourceGroupPolicyExemption:ResourceGroupPolicyExemption';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ResourceGroupPolicyExemptionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourceGroupPolicyExemptionArgs | ResourceGroupPolicyExemptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ResourceGroupPolicyExemption.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResourceGroupPolicyExemptionState {
    ...
    timeouts?: pulumi.Input<inputs.ResourceGroupPolicyExemptionTimeouts>;
}
