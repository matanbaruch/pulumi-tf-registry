...
export class IothubDeviceUpdateAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/iothubDeviceUpdateAccount:IothubDeviceUpdateAccount';
    ...
    public readonly identity!: pulumi.Output<outputs.IothubDeviceUpdateAccountIdentity | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.IothubDeviceUpdateAccountTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: IothubDeviceUpdateAccountArgs | IothubDeviceUpdateAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IothubDeviceUpdateAccount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface IothubDeviceUpdateAccountState {
    ...
    identity?: pulumi.Input<inputs.IothubDeviceUpdateAccountIdentity>;
    ...
    timeouts?: pulumi.Input<inputs.IothubDeviceUpdateAccountTimeouts>;
}
