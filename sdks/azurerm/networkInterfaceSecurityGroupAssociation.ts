...
export class NetworkInterfaceSecurityGroupAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/networkInterfaceSecurityGroupAssociation:NetworkInterfaceSecurityGroupAssociation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkInterfaceSecurityGroupAssociationTimeouts | undefined>;
...
export interface NetworkInterfaceSecurityGroupAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.NetworkInterfaceSecurityGroupAssociationTimeouts>;
}
