...
export class LinuxWebApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/linuxWebApp:LinuxWebApp';
    ...
    public readonly authSettings!: pulumi.Output<outputs.LinuxWebAppAuthSettings | undefined>;
    public readonly authSettingsV2!: pulumi.Output<outputs.LinuxWebAppAuthSettingsV2 | undefined>;
    public readonly backup!: pulumi.Output<outputs.LinuxWebAppBackup | undefined>;
    ...
    public readonly connectionStrings!: pulumi.Output<outputs.LinuxWebAppConnectionString[] | undefined>;
    ...
    public readonly identity!: pulumi.Output<outputs.LinuxWebAppIdentity | undefined>;
    public readonly keyVaultReferenceIdentityId!: pulumi.Output<string>;
    public /*out*/ readonly kind!: pulumi.Output<string>;
    public readonly location!: pulumi.Output<string>;
    public readonly logs!: pulumi.Output<outputs.LinuxWebAppLogs | undefined>;
    ...
    public readonly siteConfig!: pulumi.Output<outputs.LinuxWebAppSiteConfig>;
    public /*out*/ readonly siteCredentials!: pulumi.Output<outputs.LinuxWebAppSiteCredential[]>;
    public readonly stickySettings!: pulumi.Output<outputs.LinuxWebAppStickySettings | undefined>;
    public readonly storageAccounts!: pulumi.Output<outputs.LinuxWebAppStorageAccount[] | undefined>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.LinuxWebAppTimeouts | undefined>;
    ...
    /**
     * The local path and filename of the Zip packaged application to deploy to this Linux Web App. **Note:** Using this value
     * requires either `WEBSITE_RUN_FROM_PACKAGE=1` or `SCM_DO_BUILD_DURING_DEPLOYMENT=true` to be set on the App in
     * `app_settings`.
     */
    ...
    constructor(name: string, argsOrState?: LinuxWebAppArgs | LinuxWebAppState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LinuxWebApp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LinuxWebAppState {
    ...
    authSettings?: pulumi.Input<inputs.LinuxWebAppAuthSettings>;
    authSettingsV2?: pulumi.Input<inputs.LinuxWebAppAuthSettingsV2>;
    backup?: pulumi.Input<inputs.LinuxWebAppBackup>;
    ...
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.LinuxWebAppConnectionString>[]>;
    ...
    identity?: pulumi.Input<inputs.LinuxWebAppIdentity>;
    keyVaultReferenceIdentityId?: pulumi.Input<string>;
    kind?: pulumi.Input<string>;
    location?: pulumi.Input<string>;
    logs?: pulumi.Input<inputs.LinuxWebAppLogs>;
    ...
    siteConfig?: pulumi.Input<inputs.LinuxWebAppSiteConfig>;
    siteCredentials?: pulumi.Input<pulumi.Input<inputs.LinuxWebAppSiteCredential>[]>;
    stickySettings?: pulumi.Input<inputs.LinuxWebAppStickySettings>;
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.LinuxWebAppStorageAccount>[]>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.LinuxWebAppTimeouts>;
