...
export class SshPublicKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/sshPublicKey:SshPublicKey';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SshPublicKeyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SshPublicKeyArgs | SshPublicKeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SshPublicKey.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SshPublicKeyState {
    ...
    timeouts?: pulumi.Input<inputs.SshPublicKeyTimeouts>;
}
