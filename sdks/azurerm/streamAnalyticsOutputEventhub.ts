...
export class StreamAnalyticsOutputEventhub extends pulumi.CustomResource {
    /**
     * Get an existing StreamAnalyticsOutputEventhub resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamAnalyticsOutputEventhubState, opts?: pulumi.CustomResourceOptions): StreamAnalyticsOutputEventhub {
        return new StreamAnalyticsOutputEventhub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/streamAnalyticsOutputEventhub:StreamAnalyticsOutputEventhub';

    /**
     * Returns true if the given object is an instance of StreamAnalyticsOutputEventhub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StreamAnalyticsOutputEventhub {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StreamAnalyticsOutputEventhub.__pulumiType;
    }
    ...
    public readonly serialization!: pulumi.Output<outputs.StreamAnalyticsOutputEventhubSerialization>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.StreamAnalyticsOutputEventhubTimeouts | undefined>;

    /**
     * Create a StreamAnalyticsOutputEventhub resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: StreamAnalyticsOutputEventhubArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: StreamAnalyticsOutputEventhubArgs | StreamAnalyticsOutputEventhubState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StreamAnalyticsOutputEventhubState | undefined;
            ...
            const args = argsOrState as StreamAnalyticsOutputEventhubArgs | undefined;
        ...
        super(StreamAnalyticsOutputEventhub.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering StreamAnalyticsOutputEventhub resources.
 */
export interface StreamAnalyticsOutputEventhubState {
    ...
    serialization?: pulumi.Input<inputs.StreamAnalyticsOutputEventhubSerialization>;
    ...
    timeouts?: pulumi.Input<inputs.StreamAnalyticsOutputEventhubTimeouts>;
}

/**
 * The set of arguments for constructing a StreamAnalyticsOutputEventhub resource.
 */
export interface StreamAnalyticsOutputEventhubArgs {
    authenticationMode?: pulumi.Input<string>;
    eventhubName: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    partitionKey?: pulumi.Input<string>;
