...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/virtualMachine:VirtualMachine';
    ...
    public readonly additionalCapabilities!: pulumi.Output<outputs.VirtualMachineAdditionalCapabilities | undefined>;
...
export interface VirtualMachineState {
    additionalCapabilities?: pulumi.Input<inputs.VirtualMachineAdditionalCapabilities>;
