...
export class StreamAnalyticsStreamInputBlob extends pulumi.CustomResource {
    /**
     * Get an existing StreamAnalyticsStreamInputBlob resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamAnalyticsStreamInputBlobState, opts?: pulumi.CustomResourceOptions): StreamAnalyticsStreamInputBlob {
        return new StreamAnalyticsStreamInputBlob(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/streamAnalyticsStreamInputBlob:StreamAnalyticsStreamInputBlob';

    /**
     * Returns true if the given object is an instance of StreamAnalyticsStreamInputBlob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StreamAnalyticsStreamInputBlob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StreamAnalyticsStreamInputBlob.__pulumiType;
    }
    ...
    public readonly serialization!: pulumi.Output<outputs.StreamAnalyticsStreamInputBlobSerialization>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.StreamAnalyticsStreamInputBlobTimeouts | undefined>;

    /**
     * Create a StreamAnalyticsStreamInputBlob resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: StreamAnalyticsStreamInputBlobArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: StreamAnalyticsStreamInputBlobArgs | StreamAnalyticsStreamInputBlobState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StreamAnalyticsStreamInputBlobState | undefined;
            ...
            const args = argsOrState as StreamAnalyticsStreamInputBlobArgs | undefined;
        ...
        super(StreamAnalyticsStreamInputBlob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering StreamAnalyticsStreamInputBlob resources.
 */
export interface StreamAnalyticsStreamInputBlobState {
    dateFormat?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    pathPattern?: pulumi.Input<string>;
    resourceGroupName?: pulumi.Input<string>;
    serialization?: pulumi.Input<inputs.StreamAnalyticsStreamInputBlobSerialization>;
    storageAccountKey?: pulumi.Input<string>;
    storageAccountName?: pulumi.Input<string>;
    storageContainerName?: pulumi.Input<string>;
    streamAnalyticsJobName?: pulumi.Input<string>;
    timeFormat?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.StreamAnalyticsStreamInputBlobTimeouts>;
}

/**
 * The set of arguments for constructing a StreamAnalyticsStreamInputBlob resource.
 */
export interface StreamAnalyticsStreamInputBlobArgs {
    dateFormat: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    pathPattern: pulumi.Input<string>;
    resourceGroupName: pulumi.Input<string>;
