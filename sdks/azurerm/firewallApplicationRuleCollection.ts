...
export class FirewallApplicationRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/firewallApplicationRuleCollection:FirewallApplicationRuleCollection';
    ...
    public readonly rules!: pulumi.Output<outputs.FirewallApplicationRuleCollectionRule[]>;
    public readonly timeouts!: pulumi.Output<outputs.FirewallApplicationRuleCollectionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: FirewallApplicationRuleCollectionArgs | FirewallApplicationRuleCollectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FirewallApplicationRuleCollection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FirewallApplicationRuleCollectionState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.FirewallApplicationRuleCollectionRule>[]>;
    timeouts?: pulumi.Input<inputs.FirewallApplicationRuleCollectionTimeouts>;
}
