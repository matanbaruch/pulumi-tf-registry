...
export class UserAssignedIdentity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/userAssignedIdentity:UserAssignedIdentity';
    ...
    public readonly timeouts!: pulumi.Output<outputs.UserAssignedIdentityTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: UserAssignedIdentityArgs | UserAssignedIdentityState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserAssignedIdentity.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface UserAssignedIdentityState {
    ...
    timeouts?: pulumi.Input<inputs.UserAssignedIdentityTimeouts>;
}
