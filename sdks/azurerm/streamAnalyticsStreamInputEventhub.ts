...
export class StreamAnalyticsStreamInputEventhub extends pulumi.CustomResource {
    /**
     * Get an existing StreamAnalyticsStreamInputEventhub resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamAnalyticsStreamInputEventhubState, opts?: pulumi.CustomResourceOptions): StreamAnalyticsStreamInputEventhub {
        return new StreamAnalyticsStreamInputEventhub(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/streamAnalyticsStreamInputEventhub:StreamAnalyticsStreamInputEventhub';

    /**
     * Returns true if the given object is an instance of StreamAnalyticsStreamInputEventhub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StreamAnalyticsStreamInputEventhub {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StreamAnalyticsStreamInputEventhub.__pulumiType;
    }
    ...
    public readonly serialization!: pulumi.Output<outputs.StreamAnalyticsStreamInputEventhubSerialization>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.StreamAnalyticsStreamInputEventhubTimeouts | undefined>;

    /**
     * Create a StreamAnalyticsStreamInputEventhub resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: StreamAnalyticsStreamInputEventhubArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: StreamAnalyticsStreamInputEventhubArgs | StreamAnalyticsStreamInputEventhubState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StreamAnalyticsStreamInputEventhubState | undefined;
            ...
            const args = argsOrState as StreamAnalyticsStreamInputEventhubArgs | undefined;
        ...
        super(StreamAnalyticsStreamInputEventhub.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering StreamAnalyticsStreamInputEventhub resources.
 */
export interface StreamAnalyticsStreamInputEventhubState {
    ...
    serialization?: pulumi.Input<inputs.StreamAnalyticsStreamInputEventhubSerialization>;
    ...
    timeouts?: pulumi.Input<inputs.StreamAnalyticsStreamInputEventhubTimeouts>;
}

/**
 * The set of arguments for constructing a StreamAnalyticsStreamInputEventhub resource.
 */
export interface StreamAnalyticsStreamInputEventhubArgs {
    authenticationMode?: pulumi.Input<string>;
    eventhubConsumerGroupName?: pulumi.Input<string>;
    eventhubName: pulumi.Input<string>;
    name?: pulumi.Input<string>;
