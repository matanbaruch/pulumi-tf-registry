...
export class VirtualMachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/virtualMachineExtension:VirtualMachineExtension';
    ...
    public readonly protectedSettingsFromKeyVault!: pulumi.Output<outputs.VirtualMachineExtensionProtectedSettingsFromKeyVault | undefined>;
...
export interface VirtualMachineExtensionState {
    ...
    protectedSettingsFromKeyVault?: pulumi.Input<inputs.VirtualMachineExtensionProtectedSettingsFromKeyVault>;
