...
export class KubernetesFleetManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/kubernetesFleetManager:KubernetesFleetManager';
     ...
     */
    public readonly hubProfile!: pulumi.Output<outputs.KubernetesFleetManagerHubProfile | undefined>;
    public readonly location!: pulumi.Output<string>;
    public readonly name!: pulumi.Output<string>;
    public readonly resourceGroupName!: pulumi.Output<string>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.KubernetesFleetManagerTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: KubernetesFleetManagerArgs | KubernetesFleetManagerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KubernetesFleetManager.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KubernetesFleetManagerState {
     ...
     * @deprecated Deprecated
     */
    hubProfile?: pulumi.Input<inputs.KubernetesFleetManagerHubProfile>;
    location?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    resourceGroupName?: pulumi.Input<string>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.KubernetesFleetManagerTimeouts>;
}
