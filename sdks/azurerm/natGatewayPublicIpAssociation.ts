...
export class NatGatewayPublicIpAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/natGatewayPublicIpAssociation:NatGatewayPublicIpAssociation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.NatGatewayPublicIpAssociationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NatGatewayPublicIpAssociationArgs | NatGatewayPublicIpAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NatGatewayPublicIpAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NatGatewayPublicIpAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.NatGatewayPublicIpAssociationTimeouts>;
}
