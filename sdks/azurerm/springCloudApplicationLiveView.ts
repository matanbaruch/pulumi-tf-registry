...
export class SpringCloudApplicationLiveView extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/springCloudApplicationLiveView:SpringCloudApplicationLiveView';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SpringCloudApplicationLiveViewTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SpringCloudApplicationLiveViewArgs | SpringCloudApplicationLiveViewState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpringCloudApplicationLiveView.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpringCloudApplicationLiveViewState {
    ...
    timeouts?: pulumi.Input<inputs.SpringCloudApplicationLiveViewTimeouts>;
}
