...
export class ResourceGroupPolicyRemediation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/resourceGroupPolicyRemediation:ResourceGroupPolicyRemediation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ResourceGroupPolicyRemediationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourceGroupPolicyRemediationArgs | ResourceGroupPolicyRemediationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ResourceGroupPolicyRemediation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResourceGroupPolicyRemediationState {
    ...
    timeouts?: pulumi.Input<inputs.ResourceGroupPolicyRemediationTimeouts>;
}
