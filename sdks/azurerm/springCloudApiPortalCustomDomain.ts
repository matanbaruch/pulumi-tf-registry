...
export class SpringCloudApiPortalCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/springCloudApiPortalCustomDomain:SpringCloudApiPortalCustomDomain';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SpringCloudApiPortalCustomDomainTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SpringCloudApiPortalCustomDomainArgs | SpringCloudApiPortalCustomDomainState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpringCloudApiPortalCustomDomain.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpringCloudApiPortalCustomDomainState {
    ...
    timeouts?: pulumi.Input<inputs.SpringCloudApiPortalCustomDomainTimeouts>;
}
