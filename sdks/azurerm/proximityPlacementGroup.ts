...
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/proximityPlacementGroup:ProximityPlacementGroup';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ProximityPlacementGroupTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ProximityPlacementGroupArgs | ProximityPlacementGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProximityPlacementGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ProximityPlacementGroupState {
    ...
    timeouts?: pulumi.Input<inputs.ProximityPlacementGroupTimeouts>;
