...
export class ResourceGroupPolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/resourceGroupPolicyAssignment:ResourceGroupPolicyAssignment';
    ...
    public readonly identity!: pulumi.Output<outputs.ResourceGroupPolicyAssignmentIdentity | undefined>;
    public readonly location!: pulumi.Output<string | undefined>;
    public readonly metadata!: pulumi.Output<string>;
    public readonly name!: pulumi.Output<string>;
    public readonly nonComplianceMessages!: pulumi.Output<outputs.ResourceGroupPolicyAssignmentNonComplianceMessage[] | undefined>;
    public readonly notScopes!: pulumi.Output<string[] | undefined>;
    public readonly overrides!: pulumi.Output<outputs.ResourceGroupPolicyAssignmentOverride[] | undefined>;
    public readonly parameters!: pulumi.Output<string | undefined>;
    public readonly policyDefinitionId!: pulumi.Output<string>;
    public readonly resourceGroupId!: pulumi.Output<string>;
    public readonly resourceSelectors!: pulumi.Output<outputs.ResourceGroupPolicyAssignmentResourceSelector[] | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.ResourceGroupPolicyAssignmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourceGroupPolicyAssignmentArgs | ResourceGroupPolicyAssignmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ResourceGroupPolicyAssignment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResourceGroupPolicyAssignmentState {
    ...
    identity?: pulumi.Input<inputs.ResourceGroupPolicyAssignmentIdentity>;
    location?: pulumi.Input<string>;
    metadata?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    nonComplianceMessages?: pulumi.Input<pulumi.Input<inputs.ResourceGroupPolicyAssignmentNonComplianceMessage>[]>;
    notScopes?: pulumi.Input<pulumi.Input<string>[]>;
    overrides?: pulumi.Input<pulumi.Input<inputs.ResourceGroupPolicyAssignmentOverride>[]>;
    parameters?: pulumi.Input<string>;
    policyDefinitionId?: pulumi.Input<string>;
    resourceGroupId?: pulumi.Input<string>;
    resourceSelectors?: pulumi.Input<pulumi.Input<inputs.ResourceGroupPolicyAssignmentResourceSelector>[]>;
    timeouts?: pulumi.Input<inputs.ResourceGroupPolicyAssignmentTimeouts>;
}
