...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/roleAssignment:RoleAssignment';
    ...
    public readonly timeouts!: pulumi.Output<outputs.RoleAssignmentTimeouts | undefined>;
...
export interface RoleAssignmentState {
    ...
    timeouts?: pulumi.Input<inputs.RoleAssignmentTimeouts>;
}
