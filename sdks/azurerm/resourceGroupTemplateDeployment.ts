...
export class ResourceGroupTemplateDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/resourceGroupTemplateDeployment:ResourceGroupTemplateDeployment';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ResourceGroupTemplateDeploymentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourceGroupTemplateDeploymentArgs | ResourceGroupTemplateDeploymentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ResourceGroupTemplateDeployment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResourceGroupTemplateDeploymentState {
    ...
    timeouts?: pulumi.Input<inputs.ResourceGroupTemplateDeploymentTimeouts>;
}
