...
export class ManagedDiskSasToken extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/managedDiskSasToken:ManagedDiskSasToken';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ManagedDiskSasTokenTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ManagedDiskSasTokenArgs | ManagedDiskSasTokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedDiskSasToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ManagedDiskSasTokenState {
    ...
    timeouts?: pulumi.Input<inputs.ManagedDiskSasTokenTimeouts>;
}
