...
export class VirtualWan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/virtualWan:VirtualWan';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VirtualWanTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VirtualWanArgs | VirtualWanState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VirtualWan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VirtualWanState {
    ...
    timeouts?: pulumi.Input<inputs.VirtualWanTimeouts>;
