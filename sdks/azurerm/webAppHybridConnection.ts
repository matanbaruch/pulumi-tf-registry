...
export class WebAppHybridConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/webAppHybridConnection:WebAppHybridConnection';
    ...
    public readonly timeouts!: pulumi.Output<outputs.WebAppHybridConnectionTimeouts | undefined>;
    /**
     * The ID of the Web App for this Hybrid Connection.
     */
    public readonly webAppId!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: WebAppHybridConnectionArgs | WebAppHybridConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebAppHybridConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface WebAppHybridConnectionState {
    ...
    timeouts?: pulumi.Input<inputs.WebAppHybridConnectionTimeouts>;
    /**
     * The ID of the Web App for this Hybrid Connection.
     */
