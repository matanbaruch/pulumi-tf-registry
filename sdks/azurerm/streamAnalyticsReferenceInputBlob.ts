...
export class StreamAnalyticsReferenceInputBlob extends pulumi.CustomResource {
    /**
     * Get an existing StreamAnalyticsReferenceInputBlob resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamAnalyticsReferenceInputBlobState, opts?: pulumi.CustomResourceOptions): StreamAnalyticsReferenceInputBlob {
        return new StreamAnalyticsReferenceInputBlob(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/streamAnalyticsReferenceInputBlob:StreamAnalyticsReferenceInputBlob';

    /**
     * Returns true if the given object is an instance of StreamAnalyticsReferenceInputBlob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StreamAnalyticsReferenceInputBlob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StreamAnalyticsReferenceInputBlob.__pulumiType;
    }
    ...
    public readonly serialization!: pulumi.Output<outputs.StreamAnalyticsReferenceInputBlobSerialization>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.StreamAnalyticsReferenceInputBlobTimeouts | undefined>;

    /**
     * Create a StreamAnalyticsReferenceInputBlob resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: StreamAnalyticsReferenceInputBlobArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: StreamAnalyticsReferenceInputBlobArgs | StreamAnalyticsReferenceInputBlobState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StreamAnalyticsReferenceInputBlobState | undefined;
            ...
            const args = argsOrState as StreamAnalyticsReferenceInputBlobArgs | undefined;
        ...
        super(StreamAnalyticsReferenceInputBlob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering StreamAnalyticsReferenceInputBlob resources.
 */
export interface StreamAnalyticsReferenceInputBlobState {
    authenticationMode?: pulumi.Input<string>;
    dateFormat?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    pathPattern?: pulumi.Input<string>;
    resourceGroupName?: pulumi.Input<string>;
    serialization?: pulumi.Input<inputs.StreamAnalyticsReferenceInputBlobSerialization>;
    storageAccountKey?: pulumi.Input<string>;
    storageAccountName?: pulumi.Input<string>;
    storageContainerName?: pulumi.Input<string>;
    streamAnalyticsJobName?: pulumi.Input<string>;
    timeFormat?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.StreamAnalyticsReferenceInputBlobTimeouts>;
}

/**
 * The set of arguments for constructing a StreamAnalyticsReferenceInputBlob resource.
 */
export interface StreamAnalyticsReferenceInputBlobArgs {
    authenticationMode?: pulumi.Input<string>;
    dateFormat: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    pathPattern: pulumi.Input<string>;
