...
export class PostgresqlDatabase extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostgresqlDatabaseState, opts?: pulumi.CustomResourceOptions): PostgresqlDatabase {
        return new PostgresqlDatabase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/postgresqlDatabase:PostgresqlDatabase';
    ...
    public readonly timeouts!: pulumi.Output<outputs.PostgresqlDatabaseTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PostgresqlDatabaseArgs | PostgresqlDatabaseState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PostgresqlDatabaseState | undefined;
            ...
            const args = argsOrState as PostgresqlDatabaseArgs | undefined;
        ...
        super(PostgresqlDatabase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface PostgresqlDatabaseState {
    charset?: pulumi.Input<string>;
    collation?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    resourceGroupName?: pulumi.Input<string>;
    serverName?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.PostgresqlDatabaseTimeouts>;
}
