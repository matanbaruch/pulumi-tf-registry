...
export class DedicatedHostGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/dedicatedHostGroup:DedicatedHostGroup';
    ...
    public readonly timeouts!: pulumi.Output<outputs.DedicatedHostGroupTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DedicatedHostGroupArgs | DedicatedHostGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DedicatedHostGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DedicatedHostGroupState {
    ...
    timeouts?: pulumi.Input<inputs.DedicatedHostGroupTimeouts>;
