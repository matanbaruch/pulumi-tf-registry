...
export class EventhubAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/eventhubAuthorizationRule:EventhubAuthorizationRule';
    ...
    public readonly timeouts!: pulumi.Output<outputs.EventhubAuthorizationRuleTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: EventhubAuthorizationRuleArgs | EventhubAuthorizationRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EventhubAuthorizationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EventhubAuthorizationRuleState {
    ...
    timeouts?: pulumi.Input<inputs.EventhubAuthorizationRuleTimeouts>;
}
