...
export class ApplicationSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/applicationSecurityGroup:ApplicationSecurityGroup';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ApplicationSecurityGroupTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ApplicationSecurityGroupArgs | ApplicationSecurityGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApplicationSecurityGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ApplicationSecurityGroupState {
    ...
    timeouts?: pulumi.Input<inputs.ApplicationSecurityGroupTimeouts>;
}
