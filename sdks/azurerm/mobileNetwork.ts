...
export class MobileNetwork extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MobileNetworkState, opts?: pulumi.CustomResourceOptions): MobileNetwork {
        return new MobileNetwork(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/mobileNetwork:MobileNetwork';
    ...
    public readonly timeouts!: pulumi.Output<outputs.MobileNetworkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: MobileNetworkArgs | MobileNetworkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MobileNetworkState | undefined;
            ...
            const args = argsOrState as MobileNetworkArgs | undefined;
        ...
        super(MobileNetwork.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MobileNetworkState {
    ...
    timeouts?: pulumi.Input<inputs.MobileNetworkTimeouts>;
}
