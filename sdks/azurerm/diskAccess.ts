...
export class DiskAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/diskAccess:DiskAccess';
    ...
    public readonly timeouts!: pulumi.Output<outputs.DiskAccessTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DiskAccessArgs | DiskAccessState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DiskAccess.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DiskAccessState {
    ...
    timeouts?: pulumi.Input<inputs.DiskAccessTimeouts>;
}
