...
export class ResourcePolicyRemediation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/resourcePolicyRemediation:ResourcePolicyRemediation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ResourcePolicyRemediationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourcePolicyRemediationArgs | ResourcePolicyRemediationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ResourcePolicyRemediation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResourcePolicyRemediationState {
    ...
    timeouts?: pulumi.Input<inputs.ResourcePolicyRemediationTimeouts>;
}
