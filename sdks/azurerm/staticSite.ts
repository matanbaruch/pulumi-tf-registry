...
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/staticSite:StaticSite';
    ...
    public readonly identity!: pulumi.Output<outputs.StaticSiteIdentity | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.StaticSiteTimeouts | undefined>;
...
export interface StaticSiteState {
    ...
    identity?: pulumi.Input<inputs.StaticSiteIdentity>;
    ...
    timeouts?: pulumi.Input<inputs.StaticSiteTimeouts>;
}
