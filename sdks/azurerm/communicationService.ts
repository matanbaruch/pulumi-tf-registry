...
export class CommunicationService extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CommunicationServiceState, opts?: pulumi.CustomResourceOptions): CommunicationService {
        return new CommunicationService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/communicationService:CommunicationService';
    ...
    public readonly timeouts!: pulumi.Output<outputs.CommunicationServiceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CommunicationServiceArgs | CommunicationServiceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CommunicationServiceState | undefined;
            ...
            const args = argsOrState as CommunicationServiceArgs | undefined;
        ...
        super(CommunicationService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface CommunicationServiceState {
    ...
    timeouts?: pulumi.Input<inputs.CommunicationServiceTimeouts>;
}
