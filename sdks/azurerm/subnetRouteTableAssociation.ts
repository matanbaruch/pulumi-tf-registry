...
export class SubnetRouteTableAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/subnetRouteTableAssociation:SubnetRouteTableAssociation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SubnetRouteTableAssociationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SubnetRouteTableAssociationArgs | SubnetRouteTableAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SubnetRouteTableAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SubnetRouteTableAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.SubnetRouteTableAssociationTimeouts>;
}
