...
export class RedisFirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/redisFirewallRule:RedisFirewallRule';
    ...
    public readonly timeouts!: pulumi.Output<outputs.RedisFirewallRuleTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RedisFirewallRuleArgs | RedisFirewallRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RedisFirewallRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RedisFirewallRuleState {
    ...
    timeouts?: pulumi.Input<inputs.RedisFirewallRuleTimeouts>;
}
