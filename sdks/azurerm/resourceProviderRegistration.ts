...
export class ResourceProviderRegistration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/resourceProviderRegistration:ResourceProviderRegistration';
    ...
    public readonly features!: pulumi.Output<outputs.ResourceProviderRegistrationFeature[] | undefined>;
    public readonly name!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.ResourceProviderRegistrationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourceProviderRegistrationArgs | ResourceProviderRegistrationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ResourceProviderRegistration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResourceProviderRegistrationState {
    features?: pulumi.Input<pulumi.Input<inputs.ResourceProviderRegistrationFeature>[]>;
    name?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.ResourceProviderRegistrationTimeouts>;
}
