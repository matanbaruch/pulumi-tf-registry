...
export class VirtualHubIp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/virtualHubIp:VirtualHubIp';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VirtualHubIpTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VirtualHubIpArgs | VirtualHubIpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VirtualHubIp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VirtualHubIpState {
    ...
    timeouts?: pulumi.Input<inputs.VirtualHubIpTimeouts>;
