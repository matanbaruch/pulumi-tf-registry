...
export class SpringCloudApplicationInsightsApplicationPerformanceMonitoring extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/springCloudApplicationInsightsApplicationPerformanceMonitoring:SpringCloudApplicationInsightsApplicationPerformanceMonitoring';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SpringCloudApplicationInsightsApplicationPerformanceMonitoringTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SpringCloudApplicationInsightsApplicationPerformanceMonitoringArgs | SpringCloudApplicationInsightsApplicationPerformanceMonitoringState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpringCloudApplicationInsightsApplicationPerformanceMonitoring.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpringCloudApplicationInsightsApplicationPerformanceMonitoringState {
    ...
    timeouts?: pulumi.Input<inputs.SpringCloudApplicationInsightsApplicationPerformanceMonitoringTimeouts>;
}
