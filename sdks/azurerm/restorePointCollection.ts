...
export class RestorePointCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/restorePointCollection:RestorePointCollection';
    ...
    public readonly timeouts!: pulumi.Output<outputs.RestorePointCollectionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RestorePointCollectionArgs | RestorePointCollectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RestorePointCollection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RestorePointCollectionState {
    ...
    timeouts?: pulumi.Input<inputs.RestorePointCollectionTimeouts>;
}
