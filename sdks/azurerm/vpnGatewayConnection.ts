...
export class VpnGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/vpnGatewayConnection:VpnGatewayConnection';
    ...
    public readonly routing!: pulumi.Output<outputs.VpnGatewayConnectionRouting | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.VpnGatewayConnectionTimeouts | undefined>;
    public readonly trafficSelectorPolicies!: pulumi.Output<outputs.VpnGatewayConnectionTrafficSelectorPolicy[] | undefined>;
    public readonly vpnGatewayId!: pulumi.Output<string>;
    public readonly vpnLinks!: pulumi.Output<outputs.VpnGatewayConnectionVpnLink[]>;
    ...
    constructor(name: string, argsOrState?: VpnGatewayConnectionArgs | VpnGatewayConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpnGatewayConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpnGatewayConnectionState {
    ...
    routing?: pulumi.Input<inputs.VpnGatewayConnectionRouting>;
    timeouts?: pulumi.Input<inputs.VpnGatewayConnectionTimeouts>;
    trafficSelectorPolicies?: pulumi.Input<pulumi.Input<inputs.VpnGatewayConnectionTrafficSelectorPolicy>[]>;
    vpnGatewayId?: pulumi.Input<string>;
    vpnLinks?: pulumi.Input<pulumi.Input<inputs.VpnGatewayConnectionVpnLink>[]>;
}
