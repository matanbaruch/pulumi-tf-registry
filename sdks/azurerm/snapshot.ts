...
export class Snapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/snapshot:Snapshot';
    ...
    public readonly encryptionSettings!: pulumi.Output<outputs.SnapshotEncryptionSettings | undefined>;
...
export interface SnapshotState {
    ...
    encryptionSettings?: pulumi.Input<inputs.SnapshotEncryptionSettings>;
