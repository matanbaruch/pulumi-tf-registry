...
export class LinuxFunctionApp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinuxFunctionAppState, opts?: pulumi.CustomResourceOptions): LinuxFunctionApp {
        return new LinuxFunctionApp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/linuxFunctionApp:LinuxFunctionApp';

    /**
     * Returns true if the given object is an instance of LinuxFunctionApp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LinuxFunctionApp {
    ...
    public readonly authSettings!: pulumi.Output<outputs.LinuxFunctionAppAuthSettings | undefined>;
    public readonly authSettingsV2!: pulumi.Output<outputs.LinuxFunctionAppAuthSettingsV2 | undefined>;
    public readonly backup!: pulumi.Output<outputs.LinuxFunctionAppBackup | undefined>;
    /**
    ...
    public readonly connectionStrings!: pulumi.Output<outputs.LinuxFunctionAppConnectionString[] | undefined>;
    /**
    ...
    public readonly identity!: pulumi.Output<outputs.LinuxFunctionAppIdentity | undefined>;
    /**
    ...
    public readonly siteConfig!: pulumi.Output<outputs.LinuxFunctionAppSiteConfig>;
    public /*out*/ readonly siteCredentials!: pulumi.Output<outputs.LinuxFunctionAppSiteCredential[]>;
    public readonly stickySettings!: pulumi.Output<outputs.LinuxFunctionAppStickySettings | undefined>;
    /**
    ...
    public readonly storageAccounts!: pulumi.Output<outputs.LinuxFunctionAppStorageAccount[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.LinuxFunctionAppTimeouts | undefined>;
    ...
    /**
     * The local path and filename of the Zip packaged application to deploy to this Linux Function App. **Note:** Using this
    ...
    constructor(name: string, argsOrState?: LinuxFunctionAppArgs | LinuxFunctionAppState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LinuxFunctionApp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LinuxFunctionAppState {
    ...
    authSettings?: pulumi.Input<inputs.LinuxFunctionAppAuthSettings>;
    authSettingsV2?: pulumi.Input<inputs.LinuxFunctionAppAuthSettingsV2>;
    backup?: pulumi.Input<inputs.LinuxFunctionAppBackup>;
    /**
     * Should built in logging be enabled. Configures `AzureWebJobsDashboard` app setting based on the configured storage
     * setting
     */
    ...
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.LinuxFunctionAppConnectionString>[]>;
    /**
     * Force disable the content share settings.
     */
    ...
    identity?: pulumi.Input<inputs.LinuxFunctionAppIdentity>;
    /**
     * The User Assigned Identity to use for Key Vault access.
     */
    ...
    siteConfig?: pulumi.Input<inputs.LinuxFunctionAppSiteConfig>;
    siteCredentials?: pulumi.Input<pulumi.Input<inputs.LinuxFunctionAppSiteCredential>[]>;
    stickySettings?: pulumi.Input<inputs.LinuxFunctionAppStickySettings>;
    /**
     * The access key which will be used to access the storage account for the Function App.
     */
    ...
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.LinuxFunctionAppStorageAccount>[]>;
    /**
     * The Key Vault Secret ID, including version, that contains the Connection String to connect to the storage account for
     * this Function App.
     */
    ...
    timeouts?: pulumi.Input<inputs.LinuxFunctionAppTimeouts>;
