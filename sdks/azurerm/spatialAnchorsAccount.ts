...
export class SpatialAnchorsAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/spatialAnchorsAccount:SpatialAnchorsAccount';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SpatialAnchorsAccountTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SpatialAnchorsAccountArgs | SpatialAnchorsAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpatialAnchorsAccount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpatialAnchorsAccountState {
    ...
    timeouts?: pulumi.Input<inputs.SpatialAnchorsAccountTimeouts>;
}
