...
export class VirtualNetworkDnsServers extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/virtualNetworkDnsServers:VirtualNetworkDnsServers';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VirtualNetworkDnsServersTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VirtualNetworkDnsServersArgs | VirtualNetworkDnsServersState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VirtualNetworkDnsServers.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VirtualNetworkDnsServersState {
    ...
    timeouts?: pulumi.Input<inputs.VirtualNetworkDnsServersTimeouts>;
