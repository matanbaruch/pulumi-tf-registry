...
export class WebAppActiveSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/webAppActiveSlot:WebAppActiveSlot';
    ...
    public readonly timeouts!: pulumi.Output<outputs.WebAppActiveSlotTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: WebAppActiveSlotArgs | WebAppActiveSlotState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebAppActiveSlot.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface WebAppActiveSlotState {
    ...
    timeouts?: pulumi.Input<inputs.WebAppActiveSlotTimeouts>;
}
