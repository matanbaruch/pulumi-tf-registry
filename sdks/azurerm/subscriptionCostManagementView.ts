...
export class SubscriptionCostManagementView extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurerm:index/subscriptionCostManagementView:SubscriptionCostManagementView';
    ...
    public readonly dataset!: pulumi.Output<outputs.SubscriptionCostManagementViewDataset>;
    public readonly displayName!: pulumi.Output<string>;
    public readonly kpis!: pulumi.Output<outputs.SubscriptionCostManagementViewKpi[] | undefined>;
    public readonly name!: pulumi.Output<string>;
    public readonly pivots!: pulumi.Output<outputs.SubscriptionCostManagementViewPivot[] | undefined>;
    public readonly reportType!: pulumi.Output<string>;
    public readonly subscriptionId!: pulumi.Output<string>;
    public readonly timeframe!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.SubscriptionCostManagementViewTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SubscriptionCostManagementViewArgs | SubscriptionCostManagementViewState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SubscriptionCostManagementView.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SubscriptionCostManagementViewState {
    ...
    dataset?: pulumi.Input<inputs.SubscriptionCostManagementViewDataset>;
    displayName?: pulumi.Input<string>;
    kpis?: pulumi.Input<pulumi.Input<inputs.SubscriptionCostManagementViewKpi>[]>;
    name?: pulumi.Input<string>;
    pivots?: pulumi.Input<pulumi.Input<inputs.SubscriptionCostManagementViewPivot>[]>;
    reportType?: pulumi.Input<string>;
    subscriptionId?: pulumi.Input<string>;
    timeframe?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.SubscriptionCostManagementViewTimeouts>;
}
