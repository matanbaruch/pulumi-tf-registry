...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("castai");
			params.setVersion("7.13.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Nhc3RhaS9jYXN0YWkiLCJ2ZXJzaW9uIjoiNy4xMy4yIn19"), c => c.charCodeAt(0)));
