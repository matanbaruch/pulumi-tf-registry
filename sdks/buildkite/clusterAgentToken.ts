...
export class ClusterAgentToken extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'buildkite:index/clusterAgentToken:ClusterAgentToken';
    ...
    /**
     * A list of CIDR-notation IPv4 addresses from which agents can use this Cluster Agent Token.If not set, all IP addresses
     * are allowed (the same as setting 0.0.0.0/0).
     */
    ...
    constructor(name: string, argsOrState?: ClusterAgentTokenArgs | ClusterAgentTokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClusterAgentToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
