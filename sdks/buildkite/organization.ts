...
export class Organization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'buildkite:index/organization:Organization';
    ...
    /**
     * A list of IP addresses in CIDR format that are allowed to access the Buildkite API.If not set, all IP addresses are
     * allowed (the same as setting 0.0.0.0/0). > The "Allowed API IP Addresses" feature must be enabled on your organization
     * in order to manage the `allowed_api_ip_addresses` attribute.
     */
