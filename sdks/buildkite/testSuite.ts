...
export class TestSuite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'buildkite:index/testSuite:TestSuite';
    ...
    constructor(name: string, argsOrState?: TestSuiteArgs | TestSuiteState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TestSuite.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
