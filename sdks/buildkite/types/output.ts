...
export interface PipelineProviderSettings {
    /**
     * Whether to create builds when branches are pushed. Defaults to `true` when `trigger_mode` is set to `code`.
     */
    ...
    /**
     * Whether to create builds for commits that are part of a pull request. Defaults to `true` when `trigger_mode` is set to `code`.
     */
    ...
    /**
     * Whether to update the status of commits in Bitbucket or GitHub. Defaults to `true` when `trigger_mode` is set to `code`.
     */
    ...
    /**
     * Whether to skip creating a new build for a pull request if an existing build for the commit and branch already exists.  Defaults to `true` when `trigger_mode` is set to `code`.
     */
