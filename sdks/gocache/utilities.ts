...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gocache");
			params.setVersion("0.3.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2dvY2FjaGVici9nb2NhY2hlIiwidmVyc2lvbiI6IjAuMy4yIn19"), c => c.charCodeAt(0)));
