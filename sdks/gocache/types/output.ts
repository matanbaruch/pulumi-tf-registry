...
export interface SmartRulesRatelimitSmartRule {
    actions: outputs.SmartRulesRatelimitSmartRuleAction[];
    matches: outputs.SmartRulesRatelimitSmartRuleMatch[];
    metadatas?: outputs.SmartRulesRatelimitSmartRuleMetadata[];
}

export interface SmartRulesRatelimitSmartRuleAction {
    rateLimitAction?: string;
    rateLimitAmount?: string;
    rateLimitBlockTtl?: string;
