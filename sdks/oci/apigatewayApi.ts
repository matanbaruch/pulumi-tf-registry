...
export class ApigatewayApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'oci:index/apigatewayApi:ApigatewayApi';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ApigatewayApiTimeouts | undefined>;
    public /*out*/ readonly validationResults!: pulumi.Output<outputs.ApigatewayApiValidationResult[]>;
...
export interface ApigatewayApiState {
    ...
    timeouts?: pulumi.Input<inputs.ApigatewayApiTimeouts>;
    validationResults?: pulumi.Input<pulumi.Input<inputs.ApigatewayApiValidationResult>[]>;
}
