...
export class DataSafeSqlFirewallPolicy extends pulumi.CustomResource {
    /**
     * Get an existing DataSafeSqlFirewallPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataSafeSqlFirewallPolicyState, opts?: pulumi.CustomResourceOptions): DataSafeSqlFirewallPolicy {
        return new DataSafeSqlFirewallPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:index/dataSafeSqlFirewallPolicy:DataSafeSqlFirewallPolicy';

    /**
     * Returns true if the given object is an instance of DataSafeSqlFirewallPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataSafeSqlFirewallPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataSafeSqlFirewallPolicy.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DataSafeSqlFirewallPolicyTimeouts | undefined>;
    public readonly violationAction!: pulumi.Output<string>;
    public readonly violationAudit!: pulumi.Output<string>;

    /**
     * Create a DataSafeSqlFirewallPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DataSafeSqlFirewallPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DataSafeSqlFirewallPolicyArgs | DataSafeSqlFirewallPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataSafeSqlFirewallPolicyState | undefined;
            ...
            const args = argsOrState as DataSafeSqlFirewallPolicyArgs | undefined;
        ...
        super(DataSafeSqlFirewallPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DataSafeSqlFirewallPolicy resources.
 */
export interface DataSafeSqlFirewallPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.DataSafeSqlFirewallPolicyTimeouts>;
    violationAction?: pulumi.Input<string>;
    violationAudit?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a DataSafeSqlFirewallPolicy resource.
 */
export interface DataSafeSqlFirewallPolicyArgs {
    allowedClientIps?: pulumi.Input<pulumi.Input<string>[]>;
    allowedClientOsUsernames?: pulumi.Input<pulumi.Input<string>[]>;
    allowedClientPrograms?: pulumi.Input<pulumi.Input<string>[]>;
    compartmentId?: pulumi.Input<string>;
