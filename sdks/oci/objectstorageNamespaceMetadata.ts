...
export class ObjectstorageNamespaceMetadata extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ObjectstorageNamespaceMetadataTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ObjectstorageNamespaceMetadataArgs | ObjectstorageNamespaceMetadataState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ObjectstorageNamespaceMetadata.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ObjectstorageNamespaceMetadataState {
    ...
    timeouts?: pulumi.Input<inputs.ObjectstorageNamespaceMetadataTimeouts>;
}
