...
export class OptimizerEnrollmentStatus extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.OptimizerEnrollmentStatusTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OptimizerEnrollmentStatusArgs | OptimizerEnrollmentStatusState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OptimizerEnrollmentStatus.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface OptimizerEnrollmentStatusState {
    ...
    timeouts?: pulumi.Input<inputs.OptimizerEnrollmentStatusTimeouts>;
}
