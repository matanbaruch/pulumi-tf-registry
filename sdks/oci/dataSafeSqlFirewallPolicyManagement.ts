...
export class DataSafeSqlFirewallPolicyManagement extends pulumi.CustomResource {
    /**
     * Get an existing DataSafeSqlFirewallPolicyManagement resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataSafeSqlFirewallPolicyManagementState, opts?: pulumi.CustomResourceOptions): DataSafeSqlFirewallPolicyManagement {
        return new DataSafeSqlFirewallPolicyManagement(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:index/dataSafeSqlFirewallPolicyManagement:DataSafeSqlFirewallPolicyManagement';

    /**
     * Returns true if the given object is an instance of DataSafeSqlFirewallPolicyManagement.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataSafeSqlFirewallPolicyManagement {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataSafeSqlFirewallPolicyManagement.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DataSafeSqlFirewallPolicyManagementTimeouts | undefined>;
    public readonly violationAction!: pulumi.Output<string>;
    public readonly violationAudit!: pulumi.Output<string>;

    /**
     * Create a DataSafeSqlFirewallPolicyManagement resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DataSafeSqlFirewallPolicyManagementArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DataSafeSqlFirewallPolicyManagementArgs | DataSafeSqlFirewallPolicyManagementState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataSafeSqlFirewallPolicyManagementState | undefined;
            ...
            const args = argsOrState as DataSafeSqlFirewallPolicyManagementArgs | undefined;
        ...
        super(DataSafeSqlFirewallPolicyManagement.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DataSafeSqlFirewallPolicyManagement resources.
 */
export interface DataSafeSqlFirewallPolicyManagementState {
    ...
    timeouts?: pulumi.Input<inputs.DataSafeSqlFirewallPolicyManagementTimeouts>;
    violationAction?: pulumi.Input<string>;
    violationAudit?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a DataSafeSqlFirewallPolicyManagement resource.
 */
export interface DataSafeSqlFirewallPolicyManagementArgs {
    allowedClientIps?: pulumi.Input<pulumi.Input<string>[]>;
    allowedClientOsUsernames?: pulumi.Input<pulumi.Input<string>[]>;
    allowedClientPrograms?: pulumi.Input<pulumi.Input<string>[]>;
    compartmentId?: pulumi.Input<string>;
