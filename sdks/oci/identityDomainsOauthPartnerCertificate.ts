...
export class IdentityDomainsOauthPartnerCertificate extends pulumi.CustomResource {
    /**
     * Get an existing IdentityDomainsOauthPartnerCertificate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityDomainsOauthPartnerCertificateState, opts?: pulumi.CustomResourceOptions): IdentityDomainsOauthPartnerCertificate {
        return new IdentityDomainsOauthPartnerCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:index/identityDomainsOauthPartnerCertificate:IdentityDomainsOauthPartnerCertificate';

    /**
     * Returns true if the given object is an instance of IdentityDomainsOauthPartnerCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityDomainsOauthPartnerCertificate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityDomainsOauthPartnerCertificate.__pulumiType;
    }
    ...
    public /*out*/ readonly idcsCreatedBies!: pulumi.Output<outputs.IdentityDomainsOauthPartnerCertificateIdcsCreatedBy[]>;
    public readonly idcsEndpoint!: pulumi.Output<string>;
    public /*out*/ readonly idcsLastModifiedBies!: pulumi.Output<outputs.IdentityDomainsOauthPartnerCertificateIdcsLastModifiedBy[]>;
    ...
    public /*out*/ readonly metas!: pulumi.Output<outputs.IdentityDomainsOauthPartnerCertificateMeta[]>;
    ...
    public readonly tags!: pulumi.Output<outputs.IdentityDomainsOauthPartnerCertificateTag[] | undefined>;
    public /*out*/ readonly tenancyOcid!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.IdentityDomainsOauthPartnerCertificateTimeouts | undefined>;
    public readonly x509base64certificate!: pulumi.Output<string>;

    /**
     * Create a IdentityDomainsOauthPartnerCertificate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityDomainsOauthPartnerCertificateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityDomainsOauthPartnerCertificateArgs | IdentityDomainsOauthPartnerCertificateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityDomainsOauthPartnerCertificateState | undefined;
            ...
            const args = argsOrState as IdentityDomainsOauthPartnerCertificateArgs | undefined;
        ...
        super(IdentityDomainsOauthPartnerCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityDomainsOauthPartnerCertificate resources.
 */
export interface IdentityDomainsOauthPartnerCertificateState {
    ...
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsOauthPartnerCertificateIdcsCreatedBy>[]>;
    idcsEndpoint?: pulumi.Input<string>;
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsOauthPartnerCertificateIdcsLastModifiedBy>[]>;
    ...
    metas?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsOauthPartnerCertificateMeta>[]>;
    ocid?: pulumi.Input<string>;
    resourceTypeSchemaVersion?: pulumi.Input<string>;
    schemas?: pulumi.Input<pulumi.Input<string>[]>;
    sha1thumbprint?: pulumi.Input<string>;
    sha256thumbprint?: pulumi.Input<string>;
    tags?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsOauthPartnerCertificateTag>[]>;
    tenancyOcid?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.IdentityDomainsOauthPartnerCertificateTimeouts>;
    x509base64certificate?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a IdentityDomainsOauthPartnerCertificate resource.
 */
export interface IdentityDomainsOauthPartnerCertificateArgs {
    authorization?: pulumi.Input<string>;
    certificateAlias: pulumi.Input<string>;
    externalId?: pulumi.Input<string>;
    idcsEndpoint: pulumi.Input<string>;
