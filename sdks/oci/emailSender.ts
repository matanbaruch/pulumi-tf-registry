...
export class EmailSender extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.EmailSenderTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: EmailSenderArgs | EmailSenderState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EmailSender.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EmailSenderState {
    ...
    timeouts?: pulumi.Input<inputs.EmailSenderTimeouts>;
}
