...
export class CoreVcn extends pulumi.CustomResource {
    ...
    public readonly byoipv6cidrDetails!: pulumi.Output<outputs.CoreVcnByoipv6cidrDetail[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.CoreVcnTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CoreVcnArgs | CoreVcnState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CoreVcn.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CoreVcnState {
    ...
    byoipv6cidrDetails?: pulumi.Input<pulumi.Input<inputs.CoreVcnByoipv6cidrDetail>[]>;
    ...
    timeouts?: pulumi.Input<inputs.CoreVcnTimeouts>;
