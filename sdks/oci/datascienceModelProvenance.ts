...
export class DatascienceModelProvenance extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DatascienceModelProvenanceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DatascienceModelProvenanceArgs | DatascienceModelProvenanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatascienceModelProvenance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DatascienceModelProvenanceState {
    ...
    timeouts?: pulumi.Input<inputs.DatascienceModelProvenanceTimeouts>;
