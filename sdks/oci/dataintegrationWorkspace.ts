...
export class DataintegrationWorkspace extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DataintegrationWorkspaceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DataintegrationWorkspaceArgs | DataintegrationWorkspaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DataintegrationWorkspace.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DataintegrationWorkspaceState {
    ...
    timeouts?: pulumi.Input<inputs.DataintegrationWorkspaceTimeouts>;
