...
export class IdentityDomainsAuthToken extends pulumi.CustomResource {
    /**
     * Get an existing IdentityDomainsAuthToken resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityDomainsAuthTokenState, opts?: pulumi.CustomResourceOptions): IdentityDomainsAuthToken {
        return new IdentityDomainsAuthToken(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:index/identityDomainsAuthToken:IdentityDomainsAuthToken';

    /**
     * Returns true if the given object is an instance of IdentityDomainsAuthToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityDomainsAuthToken {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityDomainsAuthToken.__pulumiType;
    }
    ...
    public /*out*/ readonly idcsCreatedBies!: pulumi.Output<outputs.IdentityDomainsAuthTokenIdcsCreatedBy[]>;
    public readonly idcsEndpoint!: pulumi.Output<string>;
    public /*out*/ readonly idcsLastModifiedBies!: pulumi.Output<outputs.IdentityDomainsAuthTokenIdcsLastModifiedBy[]>;
    ...
    public /*out*/ readonly metas!: pulumi.Output<outputs.IdentityDomainsAuthTokenMeta[]>;
    ...
    public readonly tags!: pulumi.Output<outputs.IdentityDomainsAuthTokenTag[] | undefined>;
    public /*out*/ readonly tenancyOcid!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.IdentityDomainsAuthTokenTimeouts | undefined>;
    public readonly urnietfparamsscimschemasoracleidcsextensionselfChangeUser!: pulumi.Output<outputs.IdentityDomainsAuthTokenUrnietfparamsscimschemasoracleidcsextensionselfChangeUser | undefined>;
    public readonly user!: pulumi.Output<outputs.IdentityDomainsAuthTokenUser | undefined>;

    /**
     * Create a IdentityDomainsAuthToken resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityDomainsAuthTokenArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityDomainsAuthTokenArgs | IdentityDomainsAuthTokenState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityDomainsAuthTokenState | undefined;
            ...
            const args = argsOrState as IdentityDomainsAuthTokenArgs | undefined;
        ...
        super(IdentityDomainsAuthToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityDomainsAuthToken resources.
 */
export interface IdentityDomainsAuthTokenState {
    ...
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsAuthTokenIdcsCreatedBy>[]>;
    idcsEndpoint?: pulumi.Input<string>;
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsAuthTokenIdcsLastModifiedBy>[]>;
    idcsLastUpgradedInRelease?: pulumi.Input<string>;
    idcsPreventedOperations?: pulumi.Input<pulumi.Input<string>[]>;
    metas?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsAuthTokenMeta>[]>;
    ocid?: pulumi.Input<string>;
    resourceTypeSchemaVersion?: pulumi.Input<string>;
    schemas?: pulumi.Input<pulumi.Input<string>[]>;
    status?: pulumi.Input<string>;
    tags?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsAuthTokenTag>[]>;
    tenancyOcid?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.IdentityDomainsAuthTokenTimeouts>;
    urnietfparamsscimschemasoracleidcsextensionselfChangeUser?: pulumi.Input<inputs.IdentityDomainsAuthTokenUrnietfparamsscimschemasoracleidcsextensionselfChangeUser>;
    user?: pulumi.Input<inputs.IdentityDomainsAuthTokenUser>;
}

/**
 * The set of arguments for constructing a IdentityDomainsAuthToken resource.
 */
export interface IdentityDomainsAuthTokenArgs {
    attributeSets?: pulumi.Input<pulumi.Input<string>[]>;
    attributes?: pulumi.Input<string>;
    authorization?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
