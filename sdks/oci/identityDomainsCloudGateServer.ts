...
export class IdentityDomainsCloudGateServer extends pulumi.CustomResource {
    /**
     * Get an existing IdentityDomainsCloudGateServer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityDomainsCloudGateServerState, opts?: pulumi.CustomResourceOptions): IdentityDomainsCloudGateServer {
        return new IdentityDomainsCloudGateServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:index/identityDomainsCloudGateServer:IdentityDomainsCloudGateServer';

    /**
     * Returns true if the given object is an instance of IdentityDomainsCloudGateServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityDomainsCloudGateServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityDomainsCloudGateServer.__pulumiType;
    }
    ...
    public readonly cloudGate!: pulumi.Output<outputs.IdentityDomainsCloudGateServerCloudGate>;
    ...
    public /*out*/ readonly idcsCreatedBies!: pulumi.Output<outputs.IdentityDomainsCloudGateServerIdcsCreatedBy[]>;
    public readonly idcsEndpoint!: pulumi.Output<string>;
    public /*out*/ readonly idcsLastModifiedBies!: pulumi.Output<outputs.IdentityDomainsCloudGateServerIdcsLastModifiedBy[]>;
    ...
    public /*out*/ readonly metas!: pulumi.Output<outputs.IdentityDomainsCloudGateServerMeta[]>;
    ...
    public readonly tags!: pulumi.Output<outputs.IdentityDomainsCloudGateServerTag[] | undefined>;
    public /*out*/ readonly tenancyOcid!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.IdentityDomainsCloudGateServerTimeouts | undefined>;

    /**
     * Create a IdentityDomainsCloudGateServer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityDomainsCloudGateServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityDomainsCloudGateServerArgs | IdentityDomainsCloudGateServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityDomainsCloudGateServerState | undefined;
            ...
            const args = argsOrState as IdentityDomainsCloudGateServerArgs | undefined;
        ...
        super(IdentityDomainsCloudGateServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityDomainsCloudGateServer resources.
 */
export interface IdentityDomainsCloudGateServerState {
    attributeSets?: pulumi.Input<pulumi.Input<string>[]>;
    attributes?: pulumi.Input<string>;
    authorization?: pulumi.Input<string>;
    cloudGate?: pulumi.Input<inputs.IdentityDomainsCloudGateServerCloudGate>;
    ...
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsCloudGateServerIdcsCreatedBy>[]>;
    idcsEndpoint?: pulumi.Input<string>;
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsCloudGateServerIdcsLastModifiedBy>[]>;
    idcsLastUpgradedInRelease?: pulumi.Input<string>;
    idcsPreventedOperations?: pulumi.Input<pulumi.Input<string>[]>;
    isOpcService?: pulumi.Input<boolean>;
    metas?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsCloudGateServerMeta>[]>;
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsCloudGateServerTag>[]>;
    tenancyOcid?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.IdentityDomainsCloudGateServerTimeouts>;
}

/**
 * The set of arguments for constructing a IdentityDomainsCloudGateServer resource.
 */
export interface IdentityDomainsCloudGateServerArgs {
    attributeSets?: pulumi.Input<pulumi.Input<string>[]>;
    attributes?: pulumi.Input<string>;
    authorization?: pulumi.Input<string>;
    cloudGate: pulumi.Input<inputs.IdentityDomainsCloudGateServerCloudGate>;
