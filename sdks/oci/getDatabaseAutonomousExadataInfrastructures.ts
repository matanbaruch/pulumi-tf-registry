...
export function getDatabaseAutonomousExadataInfrastructuresOutput(args: GetDatabaseAutonomousExadataInfrastructuresOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDatabaseAutonomousExadataInfrastructuresResult> {
    return pulumi.output(args).apply((a: any) => getDatabaseAutonomousExadataInfrastructures(a, opts))
}

/**
 * A collection of arguments for invoking getDatabaseAutonomousExadataInfrastructures.
 */
export interface GetDatabaseAutonomousExadataInfrastructuresOutputArgs {
    availabilityDomain?: pulumi.Input<string>;
    compartmentId: pulumi.Input<string>;
    displayName?: pulumi.Input<string>;
    filters?: pulumi.Input<pulumi.Input<inputs.GetDatabaseAutonomousExadataInfrastructuresFilterArgs>[]>;
