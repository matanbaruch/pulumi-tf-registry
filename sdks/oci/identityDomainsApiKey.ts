...
export class IdentityDomainsApiKey extends pulumi.CustomResource {
    /**
     * Get an existing IdentityDomainsApiKey resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityDomainsApiKeyState, opts?: pulumi.CustomResourceOptions): IdentityDomainsApiKey {
        return new IdentityDomainsApiKey(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:index/identityDomainsApiKey:IdentityDomainsApiKey';

    /**
     * Returns true if the given object is an instance of IdentityDomainsApiKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityDomainsApiKey {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityDomainsApiKey.__pulumiType;
    }
    ...
    public /*out*/ readonly idcsCreatedBies!: pulumi.Output<outputs.IdentityDomainsApiKeyIdcsCreatedBy[]>;
    public readonly idcsEndpoint!: pulumi.Output<string>;
    public /*out*/ readonly idcsLastModifiedBies!: pulumi.Output<outputs.IdentityDomainsApiKeyIdcsLastModifiedBy[]>;
    ...
    public /*out*/ readonly metas!: pulumi.Output<outputs.IdentityDomainsApiKeyMeta[]>;
    ...
    public readonly tags!: pulumi.Output<outputs.IdentityDomainsApiKeyTag[] | undefined>;
    public /*out*/ readonly tenancyOcid!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.IdentityDomainsApiKeyTimeouts | undefined>;
    public readonly urnietfparamsscimschemasoracleidcsextensionselfChangeUser!: pulumi.Output<outputs.IdentityDomainsApiKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUser | undefined>;
    public readonly user!: pulumi.Output<outputs.IdentityDomainsApiKeyUser | undefined>;

    /**
     * Create a IdentityDomainsApiKey resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityDomainsApiKeyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityDomainsApiKeyArgs | IdentityDomainsApiKeyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityDomainsApiKeyState | undefined;
            ...
            const args = argsOrState as IdentityDomainsApiKeyArgs | undefined;
        ...
        super(IdentityDomainsApiKey.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityDomainsApiKey resources.
 */
export interface IdentityDomainsApiKeyState {
    ...
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsApiKeyIdcsCreatedBy>[]>;
    idcsEndpoint?: pulumi.Input<string>;
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsApiKeyIdcsLastModifiedBy>[]>;
    idcsLastUpgradedInRelease?: pulumi.Input<string>;
    idcsPreventedOperations?: pulumi.Input<pulumi.Input<string>[]>;
    key?: pulumi.Input<string>;
    metas?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsApiKeyMeta>[]>;
    ocid?: pulumi.Input<string>;
    resourceTypeSchemaVersion?: pulumi.Input<string>;
    schemas?: pulumi.Input<pulumi.Input<string>[]>;
    tags?: pulumi.Input<pulumi.Input<inputs.IdentityDomainsApiKeyTag>[]>;
    tenancyOcid?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.IdentityDomainsApiKeyTimeouts>;
    urnietfparamsscimschemasoracleidcsextensionselfChangeUser?: pulumi.Input<inputs.IdentityDomainsApiKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUser>;
    user?: pulumi.Input<inputs.IdentityDomainsApiKeyUser>;
}

/**
 * The set of arguments for constructing a IdentityDomainsApiKey resource.
 */
export interface IdentityDomainsApiKeyArgs {
    attributeSets?: pulumi.Input<pulumi.Input<string>[]>;
    attributes?: pulumi.Input<string>;
    authorization?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
