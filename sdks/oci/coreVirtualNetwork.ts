...
export class CoreVirtualNetwork extends pulumi.CustomResource {
    ...
    public readonly byoipv6cidrDetails!: pulumi.Output<outputs.CoreVirtualNetworkByoipv6cidrDetail[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.CoreVirtualNetworkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CoreVirtualNetworkArgs | CoreVirtualNetworkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CoreVirtualNetwork.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CoreVirtualNetworkState {
    ...
    byoipv6cidrDetails?: pulumi.Input<pulumi.Input<inputs.CoreVirtualNetworkByoipv6cidrDetail>[]>;
    ...
    timeouts?: pulumi.Input<inputs.CoreVirtualNetworkTimeouts>;
