...
export class StorageContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurestack:index/storageContainer:StorageContainer';
    ...
    public readonly timeouts!: pulumi.Output<outputs.StorageContainerTimeouts | undefined>;
...
export interface StorageContainerState {
    ...
    timeouts?: pulumi.Input<inputs.StorageContainerTimeouts>;
}
