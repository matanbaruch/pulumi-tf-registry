...
export class DnsZone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurestack:index/dnsZone:DnsZone';
    ...
    public readonly soaRecord!: pulumi.Output<outputs.DnsZoneSoaRecord | undefined>;
...
export interface DnsZoneState {
    ...
    soaRecord?: pulumi.Input<inputs.DnsZoneSoaRecord>;
