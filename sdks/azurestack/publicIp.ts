...
export class PublicIp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurestack:index/publicIp:PublicIp';
    ...
    constructor(name: string, argsOrState?: PublicIpArgs | PublicIpState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["publicIpAddressAllocation"] = state ? state.publicIpAddressAllocation : undefined;
            ...
            resourceInputs["publicIpAddressAllocation"] = args ? args.publicIpAddressAllocation : undefined;
