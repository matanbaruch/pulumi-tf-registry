...
export class ResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurestack:index/resourceGroup:ResourceGroup';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ResourceGroupTimeouts | undefined>;
...
export interface ResourceGroupState {
    ...
    timeouts?: pulumi.Input<inputs.ResourceGroupTimeouts>;
}
