...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azurestack:index/availabilitySet:AvailabilitySet';
    ...
    public readonly timeouts!: pulumi.Output<outputs.AvailabilitySetTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AvailabilitySetArgs | AvailabilitySetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AvailabilitySet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AvailabilitySetState {
    ...
    timeouts?: pulumi.Input<inputs.AvailabilitySetTimeouts>;
}
