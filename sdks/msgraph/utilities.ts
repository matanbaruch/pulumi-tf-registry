...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("msgraph");
			params.setVersion("0.0.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3lhZWdhc2hpL21zZ3JhcGgiLCJ2ZXJzaW9uIjoiMC4wLjUifX0="), c => c.charCodeAt(0)));
