...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("dme");
			params.setVersion("1.0.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Ruc21hZGVlYXN5L2RtZSIsInZlcnNpb24iOiIxLjAuNiJ9fQ=="), c => c.charCodeAt(0)));
