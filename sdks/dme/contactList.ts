...
export class ContactList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'dme:index/contactList:ContactList';
    ...
    constructor(name: string, argsOrState?: ContactListArgs | ContactListState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ContactList.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
