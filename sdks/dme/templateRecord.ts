...
export class TemplateRecord extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TemplateRecordState, opts?: pulumi.CustomResourceOptions): TemplateRecord {
        return new TemplateRecord(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dme:index/templateRecord:TemplateRecord';
    ...
    constructor(name: string, argsOrState?: TemplateRecordArgs | TemplateRecordState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TemplateRecordState | undefined;
            ...
            const args = argsOrState as TemplateRecordArgs | undefined;
        ...
        super(TemplateRecord.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface TemplateRecordState {
