...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("circleci");
			params.setVersion("0.5.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3RvbXR1Y2thL2NpcmNsZWNpIiwidmVyc2lvbiI6IjAuNS4wIn19"), c => c.charCodeAt(0)));
