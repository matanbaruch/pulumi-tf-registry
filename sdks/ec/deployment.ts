...
export class Deployment extends pulumi.CustomResource {
    ...
    /**
     * Deployment template identifier to create the deployment from. See the [full
     * list](https://www.elastic.co/guide/en/cloud/current/ec-regions-templates-instances.html) of regions and deployment
     * templates available in ESS.
     */
    ...
    /**
     * Elastic Stack version to use for all of the deployment resources. > Read the [ESS stack version
     * policy](https://www.elastic.co/guide/en/cloud/current/ec-version-policy.html#ec-version-policy-available) to understand
