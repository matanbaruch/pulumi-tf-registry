...
export class ElasticsearchProject extends pulumi.CustomResource {
    ...
    /**
     * The cloud ID, an encoded string that provides other Elastic services with the necessary information to connect to this
    ...
    /**
     * The purpose for which the hardware of this elasticsearch project is optimized for. Also known as the Elasticsearch
     * project subtype.
     */
    ...
    constructor(name: string, argsOrState?: ElasticsearchProjectArgs | ElasticsearchProjectState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ElasticsearchProject.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
