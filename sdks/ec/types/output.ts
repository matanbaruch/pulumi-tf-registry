...
export interface GetDeploymentElasticsearchTopology {
    ...
    nodeRoles: string[];
    /**
     * Defines whether this node can hold data (<8.0).
     */
    nodeTypeData: boolean;
    /**
     * Defines whether this node can run an ingest pipeline (<8.0).
     */
    nodeTypeIngest: boolean;
    /**
     * Defines whether this node can be elected master (<8.0).
     */
    nodeTypeMaster: boolean;
    /**
     * Defines whether this node can run ML jobs (<8.0).
     */
    nodeTypeMl: boolean;
    /**
