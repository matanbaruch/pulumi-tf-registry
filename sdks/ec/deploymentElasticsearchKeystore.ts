...
export class DeploymentElasticsearchKeystore extends pulumi.CustomResource {
    ...
    /**
     * Indicates the the remote keystore setting should be stored as a file. The default is false, which stores the keystore
     * setting as string when value is a plain string.
     */
    ...
    constructor(name: string, argsOrState?: DeploymentElasticsearchKeystoreArgs | DeploymentElasticsearchKeystoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DeploymentElasticsearchKeystore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
