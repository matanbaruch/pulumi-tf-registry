...
export class DeploymentExtension extends pulumi.CustomResource {
    ...
    /**
     * Extension type. Must be `bundle` or `plugin`. A `bundle` will usually contain a dictionary or script, where a `plugin`
    ...
    /**
     * Elastic stack version. A full version (e.g 8.7.0) should be set for plugins. A wildcard (e.g 8.*) may be used for
     * bundles.
     */
    ...
    constructor(name: string, argsOrState?: DeploymentExtensionArgs | DeploymentExtensionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DeploymentExtension.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
