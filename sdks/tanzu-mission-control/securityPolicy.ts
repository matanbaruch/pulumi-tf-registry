...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tanzu-mission-control:index/securityPolicy:SecurityPolicy';
     ...
     */
    public readonly meta!: pulumi.Output<outputs.SecurityPolicyMeta | undefined>;
    /**
     ...
     */
    public readonly scope!: pulumi.Output<outputs.SecurityPolicyScope>;
    /**
     * Spec for the security policy
     */
    public readonly spec!: pulumi.Output<outputs.SecurityPolicySpec>;
...
export interface SecurityPolicyState {
     ...
     * Metadata for the resource
     */
    meta?: pulumi.Input<inputs.SecurityPolicyMeta>;
    /**
     * Name of the security policy
     */
     ...
     * image and network policy: workspace or organization.
     */
    scope?: pulumi.Input<inputs.SecurityPolicyScope>;
    /**
     * Spec for the security policy
     */
    spec?: pulumi.Input<inputs.SecurityPolicySpec>;
}
