...
export class ClusterGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tanzu-mission-control:index/clusterGroup:ClusterGroup';
     ...
     */
    public readonly meta!: pulumi.Output<outputs.ClusterGroupMeta | undefined>;
...
export interface ClusterGroupState {
     ...
     * Metadata for the resource
     */
    meta?: pulumi.Input<inputs.ClusterGroupMeta>;
