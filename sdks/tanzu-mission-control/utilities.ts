...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("tanzu-mission-control");
			params.setVersion("1.4.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Ztd2FyZS90YW56dS1taXNzaW9uLWNvbnRyb2wiLCJ2ZXJzaW9uIjoiMS40LjUifX0="), c => c.charCodeAt(0)));
