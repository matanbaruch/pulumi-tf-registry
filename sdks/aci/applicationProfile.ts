...
export class ApplicationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aci:index/applicationProfile:ApplicationProfile';
    ...
    public readonly relationFvRsApMonPol!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: ApplicationProfileArgs | ApplicationProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["relationFvRsApMonPol"] = state ? state.relationFvRsApMonPol : undefined;
            ...
            resourceInputs["relationFvRsApMonPol"] = args ? args.relationFvRsApMonPol : undefined;
...
export interface ApplicationProfileState {
    ...
    relationFvRsApMonPol?: pulumi.Input<string>;
