...
export class CloudExternalEpg extends pulumi.CustomResource {
    /**
     * Get an existing CloudExternalEpg resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudExternalEpgState, opts?: pulumi.CustomResourceOptions): CloudExternalEpg {
        return new CloudExternalEpg(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aci:index/cloudExternalEpg:CloudExternalEpg';

    /**
     * Returns true if the given object is an instance of CloudExternalEpg.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudExternalEpg {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudExternalEpg.__pulumiType;
    }
    ...
    public readonly routeReachability!: pulumi.Output<string>;

    /**
     * Create a CloudExternalEpg resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudExternalEpgArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudExternalEpgArgs | CloudExternalEpgState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudExternalEpgState | undefined;
            ...
            resourceInputs["routeReachability"] = state ? state.routeReachability : undefined;
        } else {
            const args = argsOrState as CloudExternalEpgArgs | undefined;
            ...
            resourceInputs["routeReachability"] = args ? args.routeReachability : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(CloudExternalEpg.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CloudExternalEpg resources.
 */
export interface CloudExternalEpgState {
...
/**
 * The set of arguments for constructing a CloudExternalEpg resource.
 */
export interface CloudExternalEpgArgs {
    annotation?: pulumi.Input<string>;
    cloudApplicationcontainerDn: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    exceptionTag?: pulumi.Input<string>;
