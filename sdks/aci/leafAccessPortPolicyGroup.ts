...
export class LeafAccessPortPolicyGroup extends pulumi.CustomResource {
    /**
     * Get an existing LeafAccessPortPolicyGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LeafAccessPortPolicyGroupState, opts?: pulumi.CustomResourceOptions): LeafAccessPortPolicyGroup {
        return new LeafAccessPortPolicyGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aci:index/leafAccessPortPolicyGroup:LeafAccessPortPolicyGroup';

    /**
     * Returns true if the given object is an instance of LeafAccessPortPolicyGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LeafAccessPortPolicyGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LeafAccessPortPolicyGroup.__pulumiType;
    }
    ...
    public readonly relationInfraRsDwdmIfPol!: pulumi.Output<string>;
    ...
    public readonly relationInfraRsNetflowMonitorPols!: pulumi.Output<outputs.LeafAccessPortPolicyGroupRelationInfraRsNetflowMonitorPol[] | undefined>;
    public readonly relationInfraRsPoeIfPol!: pulumi.Output<string | undefined>;
    ...
    /**
     * Create a LeafAccessPortPolicyGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: LeafAccessPortPolicyGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LeafAccessPortPolicyGroupArgs | LeafAccessPortPolicyGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LeafAccessPortPolicyGroupState | undefined;
            ...
            resourceInputs["relationInfraRsDwdmIfPol"] = state ? state.relationInfraRsDwdmIfPol : undefined;
            ...
            resourceInputs["relationInfraRsPoeIfPol"] = state ? state.relationInfraRsPoeIfPol : undefined;
            ...
            const args = argsOrState as LeafAccessPortPolicyGroupArgs | undefined;
            ...
            resourceInputs["relationInfraRsDwdmIfPol"] = args ? args.relationInfraRsDwdmIfPol : undefined;
            ...
            resourceInputs["relationInfraRsPoeIfPol"] = args ? args.relationInfraRsPoeIfPol : undefined;
        ...
        super(LeafAccessPortPolicyGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LeafAccessPortPolicyGroup resources.
 */
export interface LeafAccessPortPolicyGroupState {
    ...
    relationInfraRsDwdmIfPol?: pulumi.Input<string>;
    ...
    relationInfraRsNetflowMonitorPols?: pulumi.Input<pulumi.Input<inputs.LeafAccessPortPolicyGroupRelationInfraRsNetflowMonitorPol>[]>;
    relationInfraRsPoeIfPol?: pulumi.Input<string>;
...
/**
 * The set of arguments for constructing a LeafAccessPortPolicyGroup resource.
 */
export interface LeafAccessPortPolicyGroupArgs {
    annotation?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    nameAlias?: pulumi.Input<string>;
