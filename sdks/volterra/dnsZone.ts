...
export class DnsZone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'volterra:index/dnsZone:DnsZone';
    ...
    public readonly primaries!: pulumi.Output<outputs.DnsZonePrimary[] | undefined>;
    public readonly secondaries!: pulumi.Output<outputs.DnsZoneSecondary[] | undefined>;
...
export interface DnsZoneState {
    ...
    primaries?: pulumi.Input<pulumi.Input<inputs.DnsZonePrimary>[]>;
    secondaries?: pulumi.Input<pulumi.Input<inputs.DnsZoneSecondary>[]>;
}
