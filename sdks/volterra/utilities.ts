...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("volterra");
			params.setVersion("0.11.35");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ZvbHRlcnJhZWRnZS92b2x0ZXJyYSIsInZlcnNpb24iOiIwLjExLjM1In19"), c => c.charCodeAt(0)));
