...
export class PublicIp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'volterra:index/publicIp:PublicIp';
    ...
    public readonly virtualSites!: pulumi.Output<outputs.PublicIpVirtualSite[] | undefined>;
...
export interface PublicIpState {
    ...
    virtualSites?: pulumi.Input<pulumi.Input<inputs.PublicIpVirtualSite>[]>;
}
