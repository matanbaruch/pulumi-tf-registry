...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("skysql");
			params.setVersion("3.1.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NreXNxbGluYy9za3lzcWwiLCJ2ZXJzaW9uIjoiMy4xLjMifX0="), c => c.charCodeAt(0)));
