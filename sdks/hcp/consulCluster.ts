...
export class ConsulCluster extends pulumi.CustomResource {
     ...
     * auto-accept feature is to create an `hcp.HvnPeeringConnection` resource that explicitly defines the HVN resources that
    ...
    /**
     * The accessor ID of the root ACL token that is generated upon cluster creation.
     */
    public /*out*/ readonly consulRootTokenAccessorId!: pulumi.Output<string>;
    /**
     * The secret ID of the root ACL token that is generated upon cluster creation.
     */
    ...
    /**
     * Allowed IPV4 address ranges (CIDRs) for inbound traffic. Each entry must be a unique CIDR. Maximum 3 CIDRS supported at
     * this time.
     */
    public readonly ipAllowlists!: pulumi.Output<outputs.ConsulClusterIpAllowlist[] | undefined>;
    /**
     * The minimum Consul patch version of the cluster. Allows only the rightmost version component to increment (E.g: `1.13.0`
     * will allow installation of `1.13.2` and `1.13.3` etc., but not `1.14.0`). If not specified, it is defaulted to the
     * version that is currently recommended by HCP.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.ConsulClusterTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ConsulClusterArgs | ConsulClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConsulCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ConsulClusterState {
     ...
     * this time.
     */
    ipAllowlists?: pulumi.Input<pulumi.Input<inputs.ConsulClusterIpAllowlist>[]>;
    /**
     * The minimum Consul patch version of the cluster. Allows only the rightmost version component to increment (E.g: `1.13.0`
     * will allow installation of `1.13.2` and `1.13.3` etc., but not `1.14.0`). If not specified, it is defaulted to the
     * version that is currently recommended by HCP.
    ...
    timeouts?: pulumi.Input<inputs.ConsulClusterTimeouts>;
}
