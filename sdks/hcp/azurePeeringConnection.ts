...
export class AzurePeeringConnection extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AzurePeeringConnectionTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AzurePeeringConnectionArgs | AzurePeeringConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AzurePeeringConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AzurePeeringConnectionState {
    ...
    timeouts?: pulumi.Input<inputs.AzurePeeringConnectionTimeouts>;
    /**
     * If the HVN should use the gateway of the peered VNet
     */
