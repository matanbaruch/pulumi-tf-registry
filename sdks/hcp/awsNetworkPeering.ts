...
export class AwsNetworkPeering extends pulumi.CustomResource {
    ...
    /**
     * The ID of the HCP project where the network peering is located. Always matches the HVN's project. If not specified, the
     * project specified in the HCP Provider config block will be used, if configured. If a project is not configured in the
     * HCP Provider config block, the oldest project in the organization will be used.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.AwsNetworkPeeringTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AwsNetworkPeeringArgs | AwsNetworkPeeringState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AwsNetworkPeering.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AwsNetworkPeeringState {
    ...
    timeouts?: pulumi.Input<inputs.AwsNetworkPeeringTimeouts>;
}
