...
export class Mariadb extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'samsungcloudplatform:index/mariadb:Mariadb';
    ...
    public readonly backup!: pulumi.Output<outputs.MariadbBackup | undefined>;
    /**
     * block storage.
     */
    public readonly blockStorages!: pulumi.Output<outputs.MariadbBlockStorage[]>;
    /**
     ...
     */
    public readonly mariadbClusterName!: pulumi.Output<string>;
    /**
     * Mariadb cluster state (RUNNING|STOPPED)
     */
    public readonly mariadbClusterState!: pulumi.Output<string>;
    /**
     * Mariadb servers (HA configuration when entering two server specifications)
     */
    public readonly mariadbServers!: pulumi.Output<outputs.MariadbMariadbServer[]>;
    /**
     * Whether to use nat.
     */
    ...
    /**
     * Security-Group ids of this Mariadb DB. Each security-group must be a valid security-group resource which is attached to
     * the VPC.
     */
    ...
    constructor(name: string, argsOrState?: MariadbArgs | MariadbState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mariadbClusterName"] = state ? state.mariadbClusterName : undefined;
            resourceInputs["mariadbClusterState"] = state ? state.mariadbClusterState : undefined;
            resourceInputs["mariadbServers"] = state ? state.mariadbServers : undefined;
            ...
            if ((!args || args.mariadbClusterName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'mariadbClusterName'");
            }
            if ((!args || args.mariadbClusterState === undefined) && !opts.urn) {
                throw new Error("Missing required property 'mariadbClusterState'");
            }
            if ((!args || args.mariadbServers === undefined) && !opts.urn) {
                throw new Error("Missing required property 'mariadbServers'");
            }
            ...
            resourceInputs["mariadbClusterName"] = args ? args.mariadbClusterName : undefined;
            resourceInputs["mariadbClusterState"] = args ? args.mariadbClusterState : undefined;
            resourceInputs["mariadbServers"] = args ? args.mariadbServers : undefined;
...
export interface MariadbState {
    ...
    backup?: pulumi.Input<inputs.MariadbBackup>;
    /**
     * block storage.
     */
    blockStorages?: pulumi.Input<pulumi.Input<inputs.MariadbBlockStorage>[]>;
    /**
     * Contract (None|1 Year|3 Year)
     */
     ...
     * Mariadb servers (HA configuration when entering two server specifications)
     */
    mariadbServers?: pulumi.Input<pulumi.Input<inputs.MariadbMariadbServer>[]>;
    /**
     * Whether to use nat.
     */
