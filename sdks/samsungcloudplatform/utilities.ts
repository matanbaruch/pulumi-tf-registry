...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("samsungcloudplatform");
			params.setVersion("3.7.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3NhbXN1bmdzZHNjbG91ZC9zYW1zdW5nY2xvdWRwbGF0Zm9ybSIsInZlcnNpb24iOiIzLjcuMSJ9fQ=="), c => c.charCodeAt(0)));
