...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("lumen");
			params.setVersion("2.4.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2x1bWVudGVjaC9sdW1lbiIsInZlcnNpb24iOiIyLjQuMCJ9fQ=="), c => c.charCodeAt(0)));
