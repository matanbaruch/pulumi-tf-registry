...
export class ComputeDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google:index/computeDisk:ComputeDisk';
     ...
     */
    public readonly asyncPrimaryDisk!: pulumi.Output<outputs.ComputeDiskAsyncPrimaryDisk | undefined>;
    /**
     ...
     */
    public readonly diskEncryptionKey!: pulumi.Output<outputs.ComputeDiskDiskEncryptionKey | undefined>;
    /**
     ...
     */
    public readonly guestOsFeatures!: pulumi.Output<outputs.ComputeDiskGuestOsFeature[] | undefined>;
    /**
     ...
     * If referred by family, the images names must include the family name. If they don't, use the [google.ComputeImage data
     * source](https://www.terraform.io/docs/providers/google/d/compute_image.html). For instance, the image
     ...
     */
    public readonly sourceImageEncryptionKey!: pulumi.Output<outputs.ComputeDiskSourceImageEncryptionKey | undefined>;
    /**
     ...
     * customer-supplied encryption key.
     */
    public readonly sourceSnapshotEncryptionKey!: pulumi.Output<outputs.ComputeDiskSourceSnapshotEncryptionKey | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ComputeDiskTimeouts | undefined>;
    /**
...
export interface ComputeDiskState {
     ...
     * A nested object resource
     */
    asyncPrimaryDisk?: pulumi.Input<inputs.ComputeDiskAsyncPrimaryDisk>;
    /**
     * Creation timestamp in RFC3339 text format.
     */
     ...
     * and you do not need to provide a key to use the disk later.
     */
    diskEncryptionKey?: pulumi.Input<inputs.ComputeDiskDiskEncryptionKey>;
    /**
     * The unique identifier for the resource. This identifier is defined by the server.
     */
     ...
     * A list of features to enable on the guest operating system. Applicable only for bootable disks.
     */
    guestOsFeatures?: pulumi.Input<pulumi.Input<inputs.ComputeDiskGuestOsFeature>[]>;
    /**
     * The image from which to initialize this disk. This can be one of: the image's 'self_link',
     * 'projects/{project}/global/images/{image}', 'projects/{project}/global/images/family/{family}', 'global/images/{image}',
     * 'global/images/family/{family}', 'family/{family}', '{project}/{family}', '{project}/{image}', '{family}', or '{image}'.
     ...
     * customer-supplied encryption key.
     */
    sourceImageEncryptionKey?: pulumi.Input<inputs.ComputeDiskSourceImageEncryptionKey>;
    /**
     * The ID value of the image used to create this disk. This value identifies the exact image that was used to create this
     * persistent disk. For example, if you created the persistent disk from an image that was later deleted and recreated
     * under the same name, the source image ID would identify the exact version of the image that was used.
     ...
     * customer-supplied encryption key.
     */
    sourceSnapshotEncryptionKey?: pulumi.Input<inputs.ComputeDiskSourceSnapshotEncryptionKey>;
    /**
     * The unique ID of the snapshot used to create this disk. This value identifies the exact snapshot that was used to create
     * this persistent disk. For example, if you created the persistent disk from a snapshot that was later deleted and
     * recreated under the same name, the source snapshot ID would identify the exact version of the snapshot that was used.
