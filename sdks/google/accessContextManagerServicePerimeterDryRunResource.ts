...
export class AccessContextManagerServicePerimeterDryRunResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google:index/accessContextManagerServicePerimeterDryRunResource:AccessContextManagerServicePerimeterDryRunResource';
