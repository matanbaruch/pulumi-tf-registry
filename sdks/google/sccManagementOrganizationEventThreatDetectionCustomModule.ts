...
export class SccManagementOrganizationEventThreatDetectionCustomModule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google:index/sccManagementOrganizationEventThreatDetectionCustomModule:SccManagementOrganizationEventThreatDetectionCustomModule';
