...
export class AssuredWorkloadsWorkload extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google:index/assuredWorkloadsWorkload:AssuredWorkloadsWorkload';
     ...
     */
    public readonly enableSovereignControls!: pulumi.Output<boolean | undefined>;
    /**
