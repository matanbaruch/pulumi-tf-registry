...
export class Status extends pulumi.CustomResource {
    ...
    /**
     * Whether the status should be considered 'live' (now renamed to active), 'learning' (now renamed to post-incident) or
     * 'closed'. The triage and declined statuses cannot be created or modified.
     */
