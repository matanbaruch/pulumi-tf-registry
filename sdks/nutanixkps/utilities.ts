...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("nutanixkps");
			params.setVersion("1.1.9");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL251dGFuaXgvbnV0YW5peGtwcyIsInZlcnNpb24iOiIxLjEuOSJ9fQ=="), c => c.charCodeAt(0)));
