...
/**
 * The provider type for the nhncloud package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'nhncloud';
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            resourceInputs["allowReauth"] = pulumi.output(args ? args.allowReauth : undefined).apply(JSON.stringify);
            ...
            resourceInputs["delayedAuth"] = pulumi.output(args ? args.delayedAuth : undefined).apply(JSON.stringify);
            ...
            resourceInputs["swauth"] = pulumi.output(args ? args.swauth : undefined).apply(JSON.stringify);
