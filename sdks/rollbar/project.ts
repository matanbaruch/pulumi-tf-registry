...
export class Project extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'rollbar:index/project:Project';
    ...
    /**
     * ID of the account that owns the project
     */
     ...
     */
    public readonly teamIds!: pulumi.Output<number[] | undefined>;
