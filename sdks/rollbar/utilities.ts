...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("rollbar");
			params.setVersion("1.15.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3JvbGxiYXIvcm9sbGJhciIsInZlcnNpb24iOiIxLjE1LjAifX0="), c => c.charCodeAt(0)));
