...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("grafana-adaptive-metrics");
			params.setVersion("0.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2dyYWZhbmEvZ3JhZmFuYS1hZGFwdGl2ZS1tZXRyaWNzIiwidmVyc2lvbiI6IjAuMi4wIn19"), c => c.charCodeAt(0)));
