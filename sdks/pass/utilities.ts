...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pass");
			params.setVersion("2.1.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NhbXB0b2NhbXAvcGFzcyIsInZlcnNpb24iOiIyLjEuMSJ9fQ=="), c => c.charCodeAt(0)));
