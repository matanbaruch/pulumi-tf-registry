...
export class FirewallPolicyMove extends pulumi.CustomResource {
    /**
     * Get an existing FirewallPolicyMove resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallPolicyMoveState, opts?: pulumi.CustomResourceOptions): FirewallPolicyMove {
        return new FirewallPolicyMove(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/firewallPolicyMove:FirewallPolicyMove';

    /**
     * Returns true if the given object is an instance of FirewallPolicyMove.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallPolicyMove {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirewallPolicyMove.__pulumiType;
    }
    ...
    /**
     * Create a FirewallPolicyMove resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FirewallPolicyMoveArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirewallPolicyMoveArgs | FirewallPolicyMoveState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirewallPolicyMoveState | undefined;
            ...
            const args = argsOrState as FirewallPolicyMoveArgs | undefined;
        ...
        super(FirewallPolicyMove.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface FirewallPolicyMoveState {
 ...
 */
export interface FirewallPolicyMoveArgs {
    comment?: pulumi.Input<string>;
    move: pulumi.Input<string>;
    policyidDst: pulumi.Input<number>;
    policyidSrc: pulumi.Input<number>;
