...
export class FirewallCentralsnatmapSort extends pulumi.CustomResource {
    ...
    public /*out*/ readonly statePolicyLists!: pulumi.Output<outputs.FirewallCentralsnatmapSortStatePolicyList[]>;
    ...
    constructor(name: string, argsOrState?: FirewallCentralsnatmapSortArgs | FirewallCentralsnatmapSortState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FirewallCentralsnatmapSort.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FirewallCentralsnatmapSortState {
    ...
    statePolicyLists?: pulumi.Input<pulumi.Input<inputs.FirewallCentralsnatmapSortStatePolicyList>[]>;
