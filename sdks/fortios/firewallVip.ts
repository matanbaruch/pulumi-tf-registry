...
export class FirewallVip extends pulumi.CustomResource {
    ...
    public readonly gslbPublicIps!: pulumi.Output<outputs.FirewallVipGslbPublicIp[] | undefined>;
    ...
    public readonly quic!: pulumi.Output<outputs.FirewallVipQuic | undefined>;
...
export interface FirewallVipState {
    ...
    gslbPublicIps?: pulumi.Input<pulumi.Input<inputs.FirewallVipGslbPublicIp>[]>;
