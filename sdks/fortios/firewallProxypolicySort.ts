...
export class FirewallProxypolicySort extends pulumi.CustomResource {
    ...
    public /*out*/ readonly statePolicyLists!: pulumi.Output<outputs.FirewallProxypolicySortStatePolicyList[]>;
    ...
    constructor(name: string, argsOrState?: FirewallProxypolicySortArgs | FirewallProxypolicySortState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FirewallProxypolicySort.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FirewallProxypolicySortState {
    ...
    statePolicyLists?: pulumi.Input<pulumi.Input<inputs.FirewallProxypolicySortStatePolicyList>[]>;
