...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("fortios");
			params.setVersion("1.20.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ZvcnRpbmV0ZGV2L2ZvcnRpb3MiLCJ2ZXJzaW9uIjoiMS4yMC4wIn19"), c => c.charCodeAt(0)));
