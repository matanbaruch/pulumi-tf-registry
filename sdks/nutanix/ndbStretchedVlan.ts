...
export class NdbStretchedVlan extends pulumi.CustomResource {
    ...
    public readonly metadata!: pulumi.Output<outputs.NdbStretchedVlanMetadata | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbStretchedVlanArgs | NdbStretchedVlanState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbStretchedVlan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
