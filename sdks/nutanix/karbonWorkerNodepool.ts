...
export class KarbonWorkerNodepool extends pulumi.CustomResource {
    ...
    public readonly ahvConfig!: pulumi.Output<outputs.KarbonWorkerNodepoolAhvConfig | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.KarbonWorkerNodepoolTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: KarbonWorkerNodepoolArgs | KarbonWorkerNodepoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KarbonWorkerNodepool.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KarbonWorkerNodepoolState {
    ...
    timeouts?: pulumi.Input<inputs.KarbonWorkerNodepoolTimeouts>;
}
