...
export class NdbScaleDatabase extends pulumi.CustomResource {
    ...
    public readonly tags!: pulumi.Output<outputs.NdbScaleDatabaseTag[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.NdbScaleDatabaseTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbScaleDatabaseArgs | NdbScaleDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbScaleDatabase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NdbScaleDatabaseState {
    ...
    timeouts?: pulumi.Input<inputs.NdbScaleDatabaseTimeouts>;
