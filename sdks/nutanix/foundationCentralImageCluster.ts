...
export class FoundationCentralImageCluster extends pulumi.CustomResource {
    ...
    public readonly clusterStatus!: pulumi.Output<outputs.FoundationCentralImageClusterClusterStatus | undefined>;
    public readonly commonNetworkSettings!: pulumi.Output<outputs.FoundationCentralImageClusterCommonNetworkSettings | undefined>;
    ...
    public readonly hypervisorIsoDetails!: pulumi.Output<outputs.FoundationCentralImageClusterHypervisorIsoDetails | undefined>;
    ...
    public readonly nodeLists!: pulumi.Output<outputs.FoundationCentralImageClusterNodeList[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.FoundationCentralImageClusterTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: FoundationCentralImageClusterArgs | FoundationCentralImageClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FoundationCentralImageCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FoundationCentralImageClusterState {
    ...
    timeouts?: pulumi.Input<inputs.FoundationCentralImageClusterTimeouts>;
