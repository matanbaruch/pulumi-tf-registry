...
export class UserGroups extends pulumi.CustomResource {
    ...
    public readonly categories!: pulumi.Output<outputs.UserGroupsCategory[] | undefined>;
    ...
    constructor(name: string, argsOrState?: UserGroupsArgs | UserGroupsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserGroups.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
