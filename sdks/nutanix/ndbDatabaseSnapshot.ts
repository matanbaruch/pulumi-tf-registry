...
export class NdbDatabaseSnapshot extends pulumi.CustomResource {
    ...
    public readonly tags!: pulumi.Output<outputs.NdbDatabaseSnapshotTag[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.NdbDatabaseSnapshotTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbDatabaseSnapshotArgs | NdbDatabaseSnapshotState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbDatabaseSnapshot.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NdbDatabaseSnapshotState {
    ...
    timeouts?: pulumi.Input<inputs.NdbDatabaseSnapshotTimeouts>;
