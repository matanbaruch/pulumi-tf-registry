...
export class NdbLogCatchups extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.NdbLogCatchupsTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbLogCatchupsArgs | NdbLogCatchupsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbLogCatchups.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NdbLogCatchupsState {
    ...
    timeouts?: pulumi.Input<inputs.NdbLogCatchupsTimeouts>;
}
