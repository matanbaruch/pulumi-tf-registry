...
export class NdbDbserverVm extends pulumi.CustomResource {
    ...
    public readonly tags!: pulumi.Output<outputs.NdbDbserverVmTag[] | undefined>;
    public readonly timeMachineId!: pulumi.Output<string | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.NdbDbserverVmTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbDbserverVmArgs | NdbDbserverVmState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbDbserverVm.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NdbDbserverVmState {
    ...
    timeouts?: pulumi.Input<inputs.NdbDbserverVmTimeouts>;
