...
export class NdbDatabaseScale extends pulumi.CustomResource {
    ...
    public readonly tags!: pulumi.Output<outputs.NdbDatabaseScaleTag[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.NdbDatabaseScaleTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbDatabaseScaleArgs | NdbDatabaseScaleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbDatabaseScale.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NdbDatabaseScaleState {
    ...
    timeouts?: pulumi.Input<inputs.NdbDatabaseScaleTimeouts>;
