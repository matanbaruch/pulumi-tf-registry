...
export class AccessControlPolicy extends pulumi.CustomResource {
    ...
    public readonly categories!: pulumi.Output<outputs.AccessControlPolicyCategory[] | undefined>;
    public readonly contextFilterLists!: pulumi.Output<outputs.AccessControlPolicyContextFilterList[] | undefined>;
    public readonly description!: pulumi.Output<string>;
    public /*out*/ readonly metadata!: pulumi.Output<{[key: string]: string}>;
    public readonly name!: pulumi.Output<string>;
    public readonly ownerReference!: pulumi.Output<outputs.AccessControlPolicyOwnerReference | undefined>;
    public readonly roleReference!: pulumi.Output<outputs.AccessControlPolicyRoleReference>;
    public /*out*/ readonly state!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.AccessControlPolicyTimeouts | undefined>;
    public readonly userGroupReferenceLists!: pulumi.Output<outputs.AccessControlPolicyUserGroupReferenceList[] | undefined>;
    public readonly userReferenceLists!: pulumi.Output<outputs.AccessControlPolicyUserReferenceList[] | undefined>;
    ...
    constructor(name: string, argsOrState?: AccessControlPolicyArgs | AccessControlPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AccessControlPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AccessControlPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.AccessControlPolicyTimeouts>;
