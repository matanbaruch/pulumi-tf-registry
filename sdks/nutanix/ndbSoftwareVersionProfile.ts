...
export class NdbSoftwareVersionProfile extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.NdbSoftwareVersionProfileTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbSoftwareVersionProfileArgs | NdbSoftwareVersionProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbSoftwareVersionProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NdbSoftwareVersionProfileState {
    ...
    timeouts?: pulumi.Input<inputs.NdbSoftwareVersionProfileTimeouts>;
