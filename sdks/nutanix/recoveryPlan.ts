...
export class RecoveryPlan extends pulumi.CustomResource {
    ...
    public readonly categories!: pulumi.Output<outputs.RecoveryPlanCategory[] | undefined>;
    public readonly description!: pulumi.Output<string>;
    public /*out*/ readonly metadata!: pulumi.Output<{[key: string]: string}>;
    public readonly name!: pulumi.Output<string>;
    public readonly ownerReference!: pulumi.Output<outputs.RecoveryPlanOwnerReference | undefined>;
    public readonly parameters!: pulumi.Output<outputs.RecoveryPlanParameters>;
    public readonly projectReference!: pulumi.Output<outputs.RecoveryPlanProjectReference | undefined>;
    public readonly stageLists!: pulumi.Output<outputs.RecoveryPlanStageList[]>;
    public /*out*/ readonly state!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.RecoveryPlanTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RecoveryPlanArgs | RecoveryPlanState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RecoveryPlan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RecoveryPlanState {
    ...
    timeouts?: pulumi.Input<inputs.RecoveryPlanTimeouts>;
}
