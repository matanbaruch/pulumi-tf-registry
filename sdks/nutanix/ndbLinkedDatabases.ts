...
export class NdbLinkedDatabases extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.NdbLinkedDatabasesTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NdbLinkedDatabasesArgs | NdbLinkedDatabasesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NdbLinkedDatabases.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NdbLinkedDatabasesState {
    ...
    timeouts?: pulumi.Input<inputs.NdbLinkedDatabasesTimeouts>;
