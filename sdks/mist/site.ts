...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'mist:index/site:Site';
    ...
    public readonly latlng!: pulumi.Output<outputs.SiteLatlng | undefined>;
...
export interface SiteState {
    ...
    latlng?: pulumi.Input<inputs.SiteLatlng>;
