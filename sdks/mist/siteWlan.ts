...
export class SiteWlan extends pulumi.CustomResource {
    /**
     * Get an existing SiteWlan resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SiteWlanState, opts?: pulumi.CustomResourceOptions): SiteWlan {
        return new SiteWlan(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'mist:index/siteWlan:SiteWlan';

    /**
     * Returns true if the given object is an instance of SiteWlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SiteWlan {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SiteWlan.__pulumiType;
    }
     ...
     */
    public readonly acctServers!: pulumi.Output<outputs.SiteWlanAcctServer[]>;
    /**
     * airwatch wlan settings
     */
    public readonly airwatch!: pulumi.Output<outputs.SiteWlanAirwatch | undefined>;
    /**
     ...
     */
    public readonly appLimit!: pulumi.Output<outputs.SiteWlanAppLimit | undefined>;
    /**
     * app qos wlan settings
     */
    public readonly appQos!: pulumi.Output<outputs.SiteWlanAppQos | undefined>;
    /**
     ...
     */
    public readonly auth!: pulumi.Output<outputs.SiteWlanAuth | undefined>;
    /**
     ...
     */
    public readonly authServers!: pulumi.Output<outputs.SiteWlanAuthServer[]>;
    /**
     ...
     */
    public readonly bonjour!: pulumi.Output<outputs.SiteWlanBonjour | undefined>;
    /**
     * Cisco CWA (central web authentication) required RADIUS with COA in order to work. See CWA:
     * https://www.cisco.com/c/en/us/support/docs/security/identity-services-engine/115732-central-web-auth-00.html
     */
    public readonly ciscoCwa!: pulumi.Output<outputs.SiteWlanCiscoCwa | undefined>;
    /**
     * kbps
     */
     ...
     */
    public readonly coaServers!: pulumi.Output<outputs.SiteWlanCoaServer[]>;
    /**
     ...
     */
    public readonly dnsServerRewrite!: pulumi.Output<outputs.SiteWlanDnsServerRewrite | undefined>;
     ...
     */
    public readonly dynamicPsk!: pulumi.Output<outputs.SiteWlanDynamicPsk | undefined>;
    /**
     * for 802.1x
     */
    public readonly dynamicVlan!: pulumi.Output<outputs.SiteWlanDynamicVlan | undefined>;
    /**
     ...
     */
    public readonly hotspot20!: pulumi.Output<outputs.SiteWlanHotspot20 | undefined>;
    public readonly injectDhcpOption82!: pulumi.Output<outputs.SiteWlanInjectDhcpOption82 | undefined>;
    /**
    ...
    public readonly mistNac!: pulumi.Output<outputs.SiteWlanMistNac | undefined>;
     ...
     */
    public readonly portal!: pulumi.Output<outputs.SiteWlanPortal | undefined>;
    /**
    ...
    public readonly qos!: pulumi.Output<outputs.SiteWlanQos | undefined>;
    /**
     * Radsec settings
     */
    public readonly radsec!: pulumi.Output<outputs.SiteWlanRadsec | undefined>;
    /**
     * enum: `11r`, `OKC`, `none`
     */
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.SiteWlanSchedule | undefined>;
    ...
    /**
     * Create a SiteWlan resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SiteWlanArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SiteWlanArgs | SiteWlanState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SiteWlanState | undefined;
            ...
            const args = argsOrState as SiteWlanArgs | undefined;
        ...
        super(SiteWlan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SiteWlan resources.
 */
export interface SiteWlanState {
    /**
     * enable coa-immediate-update and address-change-immediate-update on the access profile.
     */
     ...
     * list of RADIUS accounting servers, optional, order matters where the first one is treated as primary
     */
    acctServers?: pulumi.Input<pulumi.Input<inputs.SiteWlanAcctServer>[]>;
    /**
     * airwatch wlan settings
     */
    airwatch?: pulumi.Input<inputs.SiteWlanAirwatch>;
    /**
     * only applicable when limit_bcast==true, which allows or disallows ipv6 Neighbor Discovery packets to go through
     */
     ...
     * bandwidth limiting for apps (applies to up/down)
     */
    appLimit?: pulumi.Input<inputs.SiteWlanAppLimit>;
    /**
     * app qos wlan settings
     */
    appQos?: pulumi.Input<inputs.SiteWlanAppQos>;
    /**
     * enum: `aps`, `site`, `wxtags`
     */
     ...
     * authentication wlan settings
     */
    auth?: pulumi.Input<inputs.SiteWlanAuth>;
    /**
     * When ordered, AP will prefer and go back to the first server if possible. enum: `ordered`, `unordered`
     */
     ...
     * is treated as primary
     */
    authServers?: pulumi.Input<pulumi.Input<inputs.SiteWlanAuthServer>[]>;
    /**
     * optional, up to 48 bytes, will be dynamically generated if not provided. used only for authentication servers
     */
     ...
     * bonjour gateway wlan settings
     */
    bonjour?: pulumi.Input<inputs.SiteWlanBonjour>;
    /**
     * Cisco CWA (central web authentication) required RADIUS with COA in order to work. See CWA:
     * https://www.cisco.com/c/en/us/support/docs/security/identity-services-engine/115732-central-web-auth-00.html
     */
    ciscoCwa?: pulumi.Input<inputs.SiteWlanCiscoCwa>;
    /**
     * kbps
     */
     ...
     * list of COA (change of authorization) servers, optional
     */
    coaServers?: pulumi.Input<pulumi.Input<inputs.SiteWlanCoaServer>[]>;
    /**
     * some old WLAN drivers may not be compatible
     */
     ...
     * for radius_group-based DNS server (rewrite DNS request depending on the Group RADIUS server returns)
     */
    dnsServerRewrite?: pulumi.Input<inputs.SiteWlanDnsServerRewrite>;
     ...
     * now, wpa3 support on the roadmap)
     */
    dynamicPsk?: pulumi.Input<inputs.SiteWlanDynamicPsk>;
    /**
     * for 802.1x
     */
    dynamicVlan?: pulumi.Input<inputs.SiteWlanDynamicVlan>;
    /**
     * enable AP-AP keycaching via multicast
     */
     ...
     * hostspot 2.0 wlan settings
     */
    hotspot20?: pulumi.Input<inputs.SiteWlanHotspot20>;
    injectDhcpOption82?: pulumi.Input<inputs.SiteWlanInjectDhcpOption82>;
    /**
     * where this WLAN will be connected to. enum: `all`, `eth0`, `eth1`, `eth2`, `eth3`, `mxtunnel`, `site_mxedge`, `wxtunnel`
     */
    ...
    mistNac?: pulumi.Input<inputs.SiteWlanMistNac>;
     ...
     * portal wlan settings
     */
    portal?: pulumi.Input<inputs.SiteWlanPortal>;
    /**
     * list of hostnames without http(s):// (matched by substring)
     */
    ...
    qos?: pulumi.Input<inputs.SiteWlanQos>;
    /**
     * Radsec settings
     */
    radsec?: pulumi.Input<inputs.SiteWlanRadsec>;
    /**
     * enum: `11r`, `OKC`, `none`
     */
     ...
     * WLAN operating schedule, default is disabled
     */
    schedule?: pulumi.Input<inputs.SiteWlanSchedule>;
...
/**
 * The set of arguments for constructing a SiteWlan resource.
 */
export interface SiteWlanArgs {
    /**
     * enable coa-immediate-update and address-change-immediate-update on the access profile.
     */
    acctImmediateUpdate?: pulumi.Input<boolean>;
