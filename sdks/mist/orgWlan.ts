...
export class OrgWlan extends pulumi.CustomResource {
    /**
     * Get an existing OrgWlan resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrgWlanState, opts?: pulumi.CustomResourceOptions): OrgWlan {
        return new OrgWlan(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'mist:index/orgWlan:OrgWlan';

    /**
     * Returns true if the given object is an instance of OrgWlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrgWlan {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OrgWlan.__pulumiType;
    }
     ...
     */
    public readonly acctServers!: pulumi.Output<outputs.OrgWlanAcctServer[]>;
    /**
     * airwatch wlan settings
     */
    public readonly airwatch!: pulumi.Output<outputs.OrgWlanAirwatch | undefined>;
    /**
     ...
     */
    public readonly appLimit!: pulumi.Output<outputs.OrgWlanAppLimit | undefined>;
    /**
     * app qos wlan settings
     */
    public readonly appQos!: pulumi.Output<outputs.OrgWlanAppQos | undefined>;
    /**
     ...
     */
    public readonly auth!: pulumi.Output<outputs.OrgWlanAuth | undefined>;
    /**
     ...
     */
    public readonly authServers!: pulumi.Output<outputs.OrgWlanAuthServer[]>;
    /**
     ...
     */
    public readonly bonjour!: pulumi.Output<outputs.OrgWlanBonjour | undefined>;
    /**
     * Cisco CWA (central web authentication) required RADIUS with COA in order to work. See CWA:
     * https://www.cisco.com/c/en/us/support/docs/security/identity-services-engine/115732-central-web-auth-00.html
     */
    public readonly ciscoCwa!: pulumi.Output<outputs.OrgWlanCiscoCwa | undefined>;
    /**
     * kbps
     */
     ...
     */
    public readonly coaServers!: pulumi.Output<outputs.OrgWlanCoaServer[]>;
    /**
     ...
     */
    public readonly dnsServerRewrite!: pulumi.Output<outputs.OrgWlanDnsServerRewrite | undefined>;
     ...
     */
    public readonly dynamicPsk!: pulumi.Output<outputs.OrgWlanDynamicPsk | undefined>;
    /**
     * for 802.1x
     */
    public readonly dynamicVlan!: pulumi.Output<outputs.OrgWlanDynamicVlan | undefined>;
    /**
     ...
     */
    public readonly hotspot20!: pulumi.Output<outputs.OrgWlanHotspot20 | undefined>;
    public readonly injectDhcpOption82!: pulumi.Output<outputs.OrgWlanInjectDhcpOption82 | undefined>;
    /**
    ...
    public readonly mistNac!: pulumi.Output<outputs.OrgWlanMistNac | undefined>;
     ...
     */
    public readonly portal!: pulumi.Output<outputs.OrgWlanPortal | undefined>;
    /**
    ...
    public readonly qos!: pulumi.Output<outputs.OrgWlanQos | undefined>;
    /**
     * Radsec settings
     */
    public readonly radsec!: pulumi.Output<outputs.OrgWlanRadsec | undefined>;
    /**
     * enum: `11r`, `OKC`, `none`
     */
     ...
     */
    public readonly schedule!: pulumi.Output<outputs.OrgWlanSchedule | undefined>;
    /**
    ...
    /**
     * Create a OrgWlan resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OrgWlanArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OrgWlanArgs | OrgWlanState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OrgWlanState | undefined;
            ...
            const args = argsOrState as OrgWlanArgs | undefined;
        ...
        super(OrgWlan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OrgWlan resources.
 */
export interface OrgWlanState {
    /**
     * enable coa-immediate-update and address-change-immediate-update on the access profile.
     */
     ...
     * list of RADIUS accounting servers, optional, order matters where the first one is treated as primary
     */
    acctServers?: pulumi.Input<pulumi.Input<inputs.OrgWlanAcctServer>[]>;
    /**
     * airwatch wlan settings
     */
    airwatch?: pulumi.Input<inputs.OrgWlanAirwatch>;
    /**
     * only applicable when limit_bcast==true, which allows or disallows ipv6 Neighbor Discovery packets to go through
     */
     ...
     * bandwidth limiting for apps (applies to up/down)
     */
    appLimit?: pulumi.Input<inputs.OrgWlanAppLimit>;
    /**
     * app qos wlan settings
     */
    appQos?: pulumi.Input<inputs.OrgWlanAppQos>;
    /**
     * enum: `aps`, `site`, `wxtags`
     */
     ...
     * authentication wlan settings
     */
    auth?: pulumi.Input<inputs.OrgWlanAuth>;
    /**
     * When ordered, AP will prefer and go back to the first server if possible. enum: `ordered`, `unordered`
     */
     ...
     * is treated as primary
     */
    authServers?: pulumi.Input<pulumi.Input<inputs.OrgWlanAuthServer>[]>;
    /**
     * optional, up to 48 bytes, will be dynamically generated if not provided. used only for authentication servers
     */
     ...
     * bonjour gateway wlan settings
     */
    bonjour?: pulumi.Input<inputs.OrgWlanBonjour>;
    /**
     * Cisco CWA (central web authentication) required RADIUS with COA in order to work. See CWA:
     * https://www.cisco.com/c/en/us/support/docs/security/identity-services-engine/115732-central-web-auth-00.html
     */
    ciscoCwa?: pulumi.Input<inputs.OrgWlanCiscoCwa>;
    /**
     * kbps
     */
     ...
     * list of COA (change of authorization) servers, optional
     */
    coaServers?: pulumi.Input<pulumi.Input<inputs.OrgWlanCoaServer>[]>;
    /**
     * some old WLAN drivers may not be compatible
     */
     ...
     * for radius_group-based DNS server (rewrite DNS request depending on the Group RADIUS server returns)
     */
    dnsServerRewrite?: pulumi.Input<inputs.OrgWlanDnsServerRewrite>;
     ...
     * now, wpa3 support on the roadmap)
     */
    dynamicPsk?: pulumi.Input<inputs.OrgWlanDynamicPsk>;
    /**
     * for 802.1x
     */
    dynamicVlan?: pulumi.Input<inputs.OrgWlanDynamicVlan>;
    /**
     * enable AP-AP keycaching via multicast
     */
     ...
     * hostspot 2.0 wlan settings
     */
    hotspot20?: pulumi.Input<inputs.OrgWlanHotspot20>;
    injectDhcpOption82?: pulumi.Input<inputs.OrgWlanInjectDhcpOption82>;
    /**
     * where this WLAN will be connected to. enum: `all`, `eth0`, `eth1`, `eth2`, `eth3`, `mxtunnel`, `site_mxedge`, `wxtunnel`
     */
    ...
    mistNac?: pulumi.Input<inputs.OrgWlanMistNac>;
     ...
     * portal wlan settings
     */
    portal?: pulumi.Input<inputs.OrgWlanPortal>;
    /**
     * list of hostnames without http(s):// (matched by substring)
     */
    ...
    qos?: pulumi.Input<inputs.OrgWlanQos>;
    /**
     * Radsec settings
     */
    radsec?: pulumi.Input<inputs.OrgWlanRadsec>;
    /**
     * enum: `11r`, `OKC`, `none`
     */
     ...
     * WLAN operating schedule, default is disabled
     */
    schedule?: pulumi.Input<inputs.OrgWlanSchedule>;
    /**
     * whether to exclude this WLAN from SLE metrics
     */
...
/**
 * The set of arguments for constructing a OrgWlan resource.
 */
export interface OrgWlanArgs {
    /**
     * enable coa-immediate-update and address-change-immediate-update on the access profile.
     */
    acctImmediateUpdate?: pulumi.Input<boolean>;
