...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("opsgenie");
			params.setVersion("0.6.37");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL29wc2dlbmllL29wc2dlbmllIiwidmVyc2lvbiI6IjAuNi4zNyJ9fQ=="), c => c.charCodeAt(0)));
