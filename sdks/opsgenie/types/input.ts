...
export interface AlertPolicyTimeRestriction {
    restriction?: pulumi.Input<inputs.AlertPolicyTimeRestrictionRestriction>;
...
export interface NotificationPolicyTimeRestriction {
    restriction?: pulumi.Input<inputs.NotificationPolicyTimeRestrictionRestriction>;
...
export interface NotificationRuleTimeRestriction {
    restriction?: pulumi.Input<inputs.NotificationRuleTimeRestrictionRestriction>;
...
export interface ScheduleRotationTimeRestriction {
    restriction?: pulumi.Input<inputs.ScheduleRotationTimeRestrictionRestriction>;
...
export interface TeamRoutingRuleTimeRestriction {
    restriction?: pulumi.Input<inputs.TeamRoutingRuleTimeRestrictionRestriction>;
