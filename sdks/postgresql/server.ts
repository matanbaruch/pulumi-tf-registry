...
export class Server extends pulumi.CustomResource {
    ...
    /**
     * Automatically drop objects that depend on the server (such as user mappings), and in turn all objects that depend on
     * those objects. Drop RESTRICT is the default
     */
    ...
    /**
     * This clause specifies the options for the server. The options typically define the connection details of the server, but
     * the actual names and values are dependent on the server's foreign-data wrapper
     */
