...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("postgresql");
			params.setVersion("1.22.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2N5cmlsZ2RuL3Bvc3RncmVzcWwiLCJ2ZXJzaW9uIjoiMS4yMi4wIn19"), c => c.charCodeAt(0)));
