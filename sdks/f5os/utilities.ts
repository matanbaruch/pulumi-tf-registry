...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("f5os");
			params.setVersion("1.3.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Y1bmV0d29ya3MvZjVvcyIsInZlcnNpb24iOiIxLjMuNyJ9fQ=="), c => c.charCodeAt(0)));
