...
export class Repository extends pulumi.CustomResource {
    ...
    /**
     * Specifies if the repository should be archived. Defaults to 'false'. NOTE Currently, the API does not support
     * unarchiving.
     */
    ...
    /**
     * Set to 'true' to enable the GitHub Projects features on the repository. Per the GitHub documentation when in an
     * organization that has disabled repository projects it will default to 'false' and will otherwise default to 'true'. If
     * you specify 'true' when it has been disabled it will return an error.
     */
    ...
    /**
     * Set to true to not call the vulnerability alerts endpoint so the resource can also be used without admin permissions
     * during read.
     */
    ...
    /**
     * Can be 'public' or 'private'. If your organization is associated with an enterprise account using GitHub Enterprise
     * Cloud or GitHub Enterprise Server 2.20+, visibility can also be 'internal'.
     */
    public readonly visibility!: pulumi.Output<string>;
    /**
     * Set to 'true' to enable security alerts for vulnerable dependencies. Enabling requires alerts to be enabled on the owner
     * level. (Note for importing: GitHub enables the alerts on public repos but disables them on private repos by default).
     * Note that vulnerability alerts have not been successfully tested on any GitHub Enterprise instance and may be
