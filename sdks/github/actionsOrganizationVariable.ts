...
export class ActionsOrganizationVariable extends pulumi.CustomResource {
    ...
    /**
     * Configures the access that repositories have to the organization variable. Must be one of 'all', 'private', or
     * 'selected'. 'selected_repository_ids' is required if set to 'selected'.
     */
    ...
    constructor(name: string, argsOrState?: ActionsOrganizationVariableArgs | ActionsOrganizationVariableState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ActionsOrganizationVariable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
