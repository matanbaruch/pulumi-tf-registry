...
export class ActionsRepositoryAccessLevel extends pulumi.CustomResource {
    ...
    /**
     * Where the actions or reusable workflows of the repository may be used. Possible values are 'none', 'user',
    ...
    constructor(name: string, argsOrState?: ActionsRepositoryAccessLevelArgs | ActionsRepositoryAccessLevelState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ActionsRepositoryAccessLevel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
