...
export class UserInvitationAccepter extends pulumi.CustomResource {
    ...
    /**
     * Allow the ID to be unset. This will result in the resource being skipped when the ID is not set instead of returning an
     * error.
     */
    ...
    constructor(name: string, argsOrState?: UserInvitationAccepterArgs | UserInvitationAccepterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserInvitationAccepter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
