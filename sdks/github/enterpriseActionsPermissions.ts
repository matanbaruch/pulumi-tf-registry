...
export class EnterpriseActionsPermissions extends pulumi.CustomResource {
    ...
    /**
     * Sets the list of selected organizations that are enabled for GitHub Actions in an enterprise. Only available when
    ...
    constructor(name: string, argsOrState?: EnterpriseActionsPermissionsArgs | EnterpriseActionsPermissionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EnterpriseActionsPermissions.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
