...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("github");
			params.setVersion("6.2.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ludGVncmF0aW9ucy9naXRodWIiLCJ2ZXJzaW9uIjoiNi4yLjMifX0="), c => c.charCodeAt(0)));
