...
export class ActionsOrganizationPermissions extends pulumi.CustomResource {
    ...
    /**
     * The permissions policy that controls the actions that are allowed to run. Can be one of: 'all', 'local_only', or
     * 'selected'.
     */
     ...
     * 'all', 'none', or 'selected'.
     */
    public readonly enabledRepositories!: pulumi.Output<string>;
    /**
     * Sets the list of selected repositories that are enabled for GitHub Actions in an organization. Only available when
    ...
    constructor(name: string, argsOrState?: ActionsOrganizationPermissionsArgs | ActionsOrganizationPermissionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ActionsOrganizationPermissions.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
