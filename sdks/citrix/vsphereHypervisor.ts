...
export class VsphereHypervisor extends pulumi.CustomResource {
    /**
     * Get an existing VsphereHypervisor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VsphereHypervisorState, opts?: pulumi.CustomResourceOptions): VsphereHypervisor {
        return new VsphereHypervisor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'citrix:index/vsphereHypervisor:VsphereHypervisor';

    /**
     * Returns true if the given object is an instance of VsphereHypervisor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VsphereHypervisor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VsphereHypervisor.__pulumiType;
    }
    ...
    /**
     * Create a VsphereHypervisor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VsphereHypervisorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VsphereHypervisorArgs | VsphereHypervisorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VsphereHypervisorState | undefined;
            ...
            const args = argsOrState as VsphereHypervisorArgs | undefined;
        ...
        super(VsphereHypervisor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VsphereHypervisor resources.
 */
export interface VsphereHypervisorState {
    /**
     * Hypervisor address(es). At least one is required.
     */
...
/**
 * The set of arguments for constructing a VsphereHypervisor resource.
 */
export interface VsphereHypervisorArgs {
    /**
     * Hypervisor address(es). At least one is required.
     */
    addresses: pulumi.Input<pulumi.Input<string>[]>;
