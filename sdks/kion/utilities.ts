...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("kion");
			params.setVersion("0.3.18");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2tpb25zb2Z0d2FyZS9raW9uIiwidmVyc2lvbiI6IjAuMy4xOCJ9fQ=="), c => c.charCodeAt(0)));
