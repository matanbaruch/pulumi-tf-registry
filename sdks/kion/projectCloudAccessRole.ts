...
export class ProjectCloudAccessRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kion:index/projectCloudAccessRole:ProjectCloudAccessRole';
    ...
    public readonly gcpIamRoles!: pulumi.Output<outputs.ProjectCloudAccessRoleGcpIamRole[] | undefined>;
...
export interface ProjectCloudAccessRoleState {
    ...
    gcpIamRoles?: pulumi.Input<pulumi.Input<inputs.ProjectCloudAccessRoleGcpIamRole>[]>;
