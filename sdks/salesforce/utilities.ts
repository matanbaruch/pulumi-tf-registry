...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("salesforce");
			params.setVersion("0.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hhc2hpY29ycC9zYWxlc2ZvcmNlIiwidmVyc2lvbiI6IjAuMS4wIn19"), c => c.charCodeAt(0)));
