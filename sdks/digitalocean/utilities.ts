...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("digitalocean");
			params.setVersion("2.40.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2RpZ2l0YWxvY2Vhbi9kaWdpdGFsb2NlYW4iLCJ2ZXJzaW9uIjoiMi40MC4wIn19"), c => c.charCodeAt(0)));
