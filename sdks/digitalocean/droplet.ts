...
export class Droplet extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DropletTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DropletArgs | DropletState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Droplet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DropletState {
    ...
    timeouts?: pulumi.Input<inputs.DropletTimeouts>;
