...
export class ManagedDatabaseRedis extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ManagedDatabaseRedisProperties | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedDatabaseRedisArgs | ManagedDatabaseRedisState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedDatabaseRedis.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
