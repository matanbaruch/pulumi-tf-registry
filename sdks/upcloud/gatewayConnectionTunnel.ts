...
export class GatewayConnectionTunnel extends pulumi.CustomResource {
     ...
     */
    public readonly ipsecProperties!: pulumi.Output<outputs.GatewayConnectionTunnelIpsecProperties | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GatewayConnectionTunnelArgs | GatewayConnectionTunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GatewayConnectionTunnel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
