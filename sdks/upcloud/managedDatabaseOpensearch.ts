...
export class ManagedDatabaseOpensearch extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ManagedDatabaseOpensearchProperties | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedDatabaseOpensearchArgs | ManagedDatabaseOpensearchState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedDatabaseOpensearch.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
