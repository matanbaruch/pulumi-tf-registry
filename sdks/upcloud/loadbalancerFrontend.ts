...
export class LoadbalancerFrontend extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.LoadbalancerFrontendProperty[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LoadbalancerFrontendArgs | LoadbalancerFrontendState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoadbalancerFrontend.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LoadbalancerFrontendState {
     ...
     * Frontend properties. Properties can set back to defaults by defining empty `properties {}` block.
     */
    properties?: pulumi.Input<pulumi.Input<inputs.LoadbalancerFrontendProperty>[]>;
    /**
     * Set of frontend rule names.
     */
