...
export class Network extends pulumi.CustomResource {
     ...
     */
    public readonly ipNetworks!: pulumi.Output<outputs.NetworkIpNetwork[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NetworkArgs | NetworkState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ipNetworks"] = state ? state.ipNetworks : undefined;
            ...
            resourceInputs["ipNetworks"] = args ? args.ipNetworks : undefined;
...
export interface NetworkState {
     ...
     * IP subnet within the network. Network must have exactly one IP subnet.
     */
    ipNetworks?: pulumi.Input<pulumi.Input<inputs.NetworkIpNetwork>[]>;
    /**
     * User defined key-value pairs to classify the network.
     */
