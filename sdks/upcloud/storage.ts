...
export class Storage extends pulumi.CustomResource {
    ...
    public readonly backupRules!: pulumi.Output<outputs.StorageBackupRule[] | undefined>;
    /**
     * Block defining another storage/template to clone to storage.
     */
    public readonly clones!: pulumi.Output<outputs.StorageClone[] | undefined>;
    /**
     ...
     */
    public readonly imports!: pulumi.Output<outputs.StorageImport[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StorageArgs | StorageState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["clones"] = state ? state.clones : undefined;
            ...
            resourceInputs["clones"] = args ? args.clones : undefined;
...
export interface StorageState {
    backupRules?: pulumi.Input<pulumi.Input<inputs.StorageBackupRule>[]>;
    /**
     * Block defining another storage/template to clone to storage.
     */
    clones?: pulumi.Input<pulumi.Input<inputs.StorageClone>[]>;
    /**
     * If set to true, the backup taken before the partition and filesystem resize attempt will be deleted immediately after
     * success.
     */
     ...
     * Block defining external data to import to storage
     */
    imports?: pulumi.Input<pulumi.Input<inputs.StorageImport>[]>;
    /**
     * User defined key-value pairs to classify the storage.
     */
