...
export class ManagedDatabasePostgresql extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ManagedDatabasePostgresqlProperties | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedDatabasePostgresqlArgs | ManagedDatabasePostgresqlState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedDatabasePostgresql.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
