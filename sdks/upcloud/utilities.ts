...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("upcloud");
			params.setVersion("5.10.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3VwY2xvdWRsdGQvdXBjbG91ZCIsInZlcnNpb24iOiI1LjEwLjEifX0="), c => c.charCodeAt(0)));
