...
export class Project extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'project:index/project:Project';
    ...
    /**
     * Block deployment of artifacts if storage quota is exceeded. ~>This setting only applies to self-hosted environment. See
     * [Manage Storage Quotas](https://jfrog.com/help/r/jfrog-platform-administration-documentation/manage-storage-quotas).
     */
    ...
    /**
     * The Project Key is added as a prefix to resources created within a Project. This field is mandatory and supports only 2
     * - 32 lowercase alphanumeric and hyphen characters. Must begin with a letter. For example: `us1a-test`.
     */
     ...
     * `lifecycle.ignore_changes` in the `project.Project` resource to avoid state drift. ```hcl lifecycle { ignore_changes = [
     * repos ] } ```
     *
     * @deprecated Deprecated
     */
    ...
    /**
     * When set to true, this resource will ignore the `group` attributes and allow users to be managed by `project.Group`
     ...
     * `project.Repository` resource instead. Default to `true`.
     */
    public readonly useProjectRepositoryResource!: pulumi.Output<boolean>;
    /**
     * When set to true, this resource will ignore the `roles` attributes and allow roles to be managed by `project.Role`
     * resource instead. Default to `true`.
     */
    public readonly useProjectRoleResource!: pulumi.Output<boolean>;
    /**
     * When set to true, this resource will ignore the `member` attributes and allow users to be managed by `project.User`
     * resource instead. Default to `true`.
     */
