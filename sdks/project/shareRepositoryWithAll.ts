...
export class ShareRepositoryWithAll extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'project:index/shareRepositoryWithAll:ShareRepositoryWithAll';
    ...
    constructor(name: string, argsOrState?: ShareRepositoryWithAllArgs | ShareRepositoryWithAllState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ShareRepositoryWithAll.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
