...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cosign");
			params.setVersion("0.0.20");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NoYWluZ3VhcmQtZGV2L2Nvc2lnbiIsInZlcnNpb24iOiIwLjAuMjAifX0="), c => c.charCodeAt(0)));
