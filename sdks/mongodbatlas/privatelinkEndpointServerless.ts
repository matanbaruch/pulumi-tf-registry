...
export class PrivatelinkEndpointServerless extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.PrivatelinkEndpointServerlessTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PrivatelinkEndpointServerlessArgs | PrivatelinkEndpointServerlessState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PrivatelinkEndpointServerless.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PrivatelinkEndpointServerlessState {
    ...
    timeouts?: pulumi.Input<inputs.PrivatelinkEndpointServerlessTimeouts>;
}
