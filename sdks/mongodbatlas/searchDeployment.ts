...
export class SearchDeployment extends pulumi.CustomResource {
    ...
    /**
     * List of settings that configure the search nodes for your cluster. This list is currently limited to defining a single
     * element.
     */
    ...
    constructor(name: string, argsOrState?: SearchDeploymentArgs | SearchDeploymentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SearchDeployment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
