...
export class PushBasedLogExport extends pulumi.CustomResource {
     ...
     * which the authenticated user has access. **NOTE**: Groups and projects are synonymous terms. Your group id is the same
     * as your project id. For existing groups, your group/project id remains the same. The resource and corresponding
    ...
    constructor(name: string, argsOrState?: PushBasedLogExportArgs | PushBasedLogExportState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PushBasedLogExport.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
