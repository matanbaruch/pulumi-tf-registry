...
export class EncryptionAtRest extends pulumi.CustomResource {
    ...
    public readonly awsKmsConfigs!: pulumi.Output<outputs.EncryptionAtRestAwsKmsConfig[] | undefined>;
    public readonly azureKeyVaultConfigs!: pulumi.Output<outputs.EncryptionAtRestAzureKeyVaultConfig[] | undefined>;
    public readonly googleCloudKmsConfigs!: pulumi.Output<outputs.EncryptionAtRestGoogleCloudKmsConfig[] | undefined>;
    ...
    constructor(name: string, argsOrState?: EncryptionAtRestArgs | EncryptionAtRestState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["awsKmsConfigs"] = state ? state.awsKmsConfigs : undefined;
            resourceInputs["azureKeyVaultConfigs"] = state ? state.azureKeyVaultConfigs : undefined;
            resourceInputs["googleCloudKmsConfigs"] = state ? state.googleCloudKmsConfigs : undefined;
            ...
            resourceInputs["awsKmsConfigs"] = args ? args.awsKmsConfigs : undefined;
            resourceInputs["azureKeyVaultConfigs"] = args ? args.azureKeyVaultConfigs : undefined;
            resourceInputs["googleCloudKmsConfigs"] = args ? args.googleCloudKmsConfigs : undefined;
            resourceInputs["projectId"] = args ? args.projectId : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(EncryptionAtRest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EncryptionAtRestState {
    awsKmsConfigs?: pulumi.Input<pulumi.Input<inputs.EncryptionAtRestAwsKmsConfig>[]>;
    azureKeyVaultConfigs?: pulumi.Input<pulumi.Input<inputs.EncryptionAtRestAzureKeyVaultConfig>[]>;
    googleCloudKmsConfigs?: pulumi.Input<pulumi.Input<inputs.EncryptionAtRestGoogleCloudKmsConfig>[]>;
