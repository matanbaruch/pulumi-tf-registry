...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("infinity-next");
			params.setVersion("1.0.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NoZWNrcG9pbnRzdy9pbmZpbml0eS1uZXh0IiwidmVyc2lvbiI6IjEuMC40In19"), c => c.charCodeAt(0)));
