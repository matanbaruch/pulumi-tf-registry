...
export class AppsecGatewayProfile extends pulumi.CustomResource {
    /**
     * Get an existing AppsecGatewayProfile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppsecGatewayProfileState, opts?: pulumi.CustomResourceOptions): AppsecGatewayProfile {
        return new AppsecGatewayProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infinity-next:index/appsecGatewayProfile:AppsecGatewayProfile';

    /**
     * Returns true if the given object is an instance of AppsecGatewayProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppsecGatewayProfile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppsecGatewayProfile.__pulumiType;
    }
     ...
     */
    public readonly reverseproxyAdditionalSettings!: pulumi.Output<{[key: string]: string} | undefined>;
    public /*out*/ readonly reverseproxyAdditionalSettingsIds!: pulumi.Output<string[]>;
    /**
     * Sets the reverse proxy upstream timeout in seconds
     */
    public readonly reverseproxyUpstreamTimeout!: pulumi.Output<number | undefined>;
    /**
    ...
    /**
     * Create a AppsecGatewayProfile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppsecGatewayProfileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppsecGatewayProfileArgs | AppsecGatewayProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppsecGatewayProfileState | undefined;
            ...
            resourceInputs["reverseproxyAdditionalSettings"] = state ? state.reverseproxyAdditionalSettings : undefined;
            resourceInputs["reverseproxyAdditionalSettingsIds"] = state ? state.reverseproxyAdditionalSettingsIds : undefined;
            resourceInputs["reverseproxyUpstreamTimeout"] = state ? state.reverseproxyUpstreamTimeout : undefined;
            ...
            const args = argsOrState as AppsecGatewayProfileArgs | undefined;
            ...
            resourceInputs["reverseproxyAdditionalSettings"] = args ? args.reverseproxyAdditionalSettings : undefined;
            resourceInputs["reverseproxyUpstreamTimeout"] = args ? args.reverseproxyUpstreamTimeout : undefined;
            ...
            resourceInputs["reverseproxyAdditionalSettingsIds"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(AppsecGatewayProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppsecGatewayProfile resources.
 */
export interface AppsecGatewayProfileState {
    /**
     * Controls the settings of the connected agents
     */
     ...
     * Sets the reverse proxy settings of linked assets
     */
    reverseproxyAdditionalSettings?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    reverseproxyAdditionalSettingsIds?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * Sets the reverse proxy upstream timeout in seconds
     */
    reverseproxyUpstreamTimeout?: pulumi.Input<number>;
    /**
     * The upgrade mode of the profile: Automatic, Manual or Scheduled. The default is Automatic
     */
...
/**
 * The set of arguments for constructing a AppsecGatewayProfile resource.
 */
export interface AppsecGatewayProfileArgs {
    /**
     * Controls the settings of the connected agents
     */
    additionalSettings?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
