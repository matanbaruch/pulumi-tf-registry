...
export class WebApiAsset extends pulumi.CustomResource {
    /**
     * Get an existing WebApiAsset resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebApiAssetState, opts?: pulumi.CustomResourceOptions): WebApiAsset {
        return new WebApiAsset(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infinity-next:index/webApiAsset:WebApiAsset';

    /**
     * Returns true if the given object is an instance of WebApiAsset.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WebApiAsset {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WebApiAsset.__pulumiType;
    }
     ...
     */
    public readonly practices!: pulumi.Output<outputs.WebApiAssetPractice[] | undefined>;
    /**
     ...
     */
    public readonly proxySettings!: pulumi.Output<outputs.WebApiAssetProxySetting[] | undefined>;
    public /*out*/ readonly readOnly!: pulumi.Output<boolean>;
    /**
     * Defines how the source identifier valuess of the asset are retrieved
     */
    public readonly sourceIdentifiers!: pulumi.Output<outputs.WebApiAssetSourceIdentifier[] | undefined>;
    ...
    /**
     * Create a WebApiAsset resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WebApiAssetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WebApiAssetArgs | WebApiAssetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WebApiAssetState | undefined;
            ...
            const args = argsOrState as WebApiAssetArgs | undefined;
        ...
        super(WebApiAsset.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WebApiAsset resources.
 */
export interface WebApiAssetState {
     ...
     * The practices used by the asset
     */
    practices?: pulumi.Input<pulumi.Input<inputs.WebApiAssetPractice>[]>;
    /**
     * Profiles linked to the asset
     */
     ...
     * Settings for the proxy
     */
    proxySettings?: pulumi.Input<pulumi.Input<inputs.WebApiAssetProxySetting>[]>;
    readOnly?: pulumi.Input<boolean>;
    /**
     * Defines how the source identifier valuess of the asset are retrieved
     */
    sourceIdentifiers?: pulumi.Input<pulumi.Input<inputs.WebApiAssetSourceIdentifier>[]>;
...
/**
 * The set of arguments for constructing a WebApiAsset resource.
 */
export interface WebApiAssetArgs {
    /**
     * The name of the resource, also acts as its unique ID
     */
    name?: pulumi.Input<string>;
