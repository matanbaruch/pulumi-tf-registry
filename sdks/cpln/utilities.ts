...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cpln");
			params.setVersion("1.1.31");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NvbnRyb2xwbGFuZS1jb20vY3BsbiIsInZlcnNpb24iOiIxLjEuMzEifX0="), c => c.charCodeAt(0)));
