...
export class ConnectorSchedule extends pulumi.CustomResource {
    ...
    /**
     * The optional parameter that defines the sync start time when the sync frequency is already set or being set by the
     * current request to 1440. It can be specified in one hour increments starting from 00:00 to 23:00. If not specified, we
     * will use [the baseline sync start
     * time](https://fivetran.com/docs/getting-started/syncoverview#syncfrequencyandscheduling). This parameter has no effect
     * on the [0 to 60 minutes offset](https://fivetran.com/docs/getting-started/syncoverview#syncstarttimesandoffsets) used to
     * determine the actual sync start time.
     */
    ...
    constructor(name: string, argsOrState?: ConnectorScheduleArgs | ConnectorScheduleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConnectorSchedule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
