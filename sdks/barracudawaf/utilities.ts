...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("barracudawaf");
			params.setVersion("1.0.10");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2JhcnJhY3VkYW5ldHdvcmtzL2JhcnJhY3VkYXdhZiIsInZlcnNpb24iOiIxLjAuMTAifX0="), c => c.charCodeAt(0)));
