...
export class SpotMarketRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/spotMarketRequest:SpotMarketRequest';
    ...
    /**
     * Parameters for devices provisioned from this request. You can find the parameter description from the metal.Device doc
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.SpotMarketRequestTimeouts | undefined>;
    /**
     * On resource creation - wait until all desired devices are active, on resource destruction - wait until devices are
     * removed
     */
    ...
    constructor(name: string, argsOrState?: SpotMarketRequestArgs | SpotMarketRequestState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpotMarketRequest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpotMarketRequestState {
    ...
    timeouts?: pulumi.Input<inputs.SpotMarketRequestTimeouts>;
    /**
     * On resource creation - wait until all desired devices are active, on resource destruction - wait until devices are
     * removed
     */
