...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("metal");
			params.setVersion("3.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2VxdWluaXgvbWV0YWwiLCJ2ZXJzaW9uIjoiMy4zLjAifX0="), c => c.charCodeAt(0)));
