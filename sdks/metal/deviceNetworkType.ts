...
export class DeviceNetworkType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/deviceNetworkType:DeviceNetworkType';
    ...
    constructor(name: string, argsOrState?: DeviceNetworkTypeArgs | DeviceNetworkTypeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DeviceNetworkType.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
