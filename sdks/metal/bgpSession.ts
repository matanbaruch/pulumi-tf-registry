...
export class BgpSession extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/bgpSession:BgpSession';
    ...
    constructor(name: string, argsOrState?: BgpSessionArgs | BgpSessionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BgpSession.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
