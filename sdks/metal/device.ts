...
export class Device extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/device:Device';
    ...
    /**
     * The device plan slug. To find the plan slug, visit [Device plans API
     * docs](https://metal.equinix.com/developers/api/plans), set your auth token in the top of the page and see JSON from the
     * API response
     */
    ...
    /**
     * Array of IDs of the project SSH keys which should be added to the device. If you omit this, SSH keys of all the members
     * of the parent project will be added to the device. If you specify this array, only the listed project SSH keys will be
     * added. Project SSH keys can be created with the metal.ProjectSshKey resource
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.DeviceTimeouts | undefined>;
    /**
...
export interface DeviceState {
    ...
    timeouts?: pulumi.Input<inputs.DeviceTimeouts>;
    /**
     * The timestamp for the last time the device was updated
     */
