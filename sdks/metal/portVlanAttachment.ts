...
export class PortVlanAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/portVlanAttachment:PortVlanAttachment';
    ...
    /**
     * Mark this VLAN a native VLAN on the port. This can be used only if this assignment assigns second or further VLAN to the
     * port. To ensure that this attachment is not first on a port, you can use depends_on pointing to another
     * metal_port_vlan_attachment, just like in the layer2-individual example above
     */
    ...
    constructor(name: string, argsOrState?: PortVlanAttachmentArgs | PortVlanAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PortVlanAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
