...
export class Vrf extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/vrf:Vrf';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VrfTimeouts | undefined>;
...
export interface VrfState {
    ...
    timeouts?: pulumi.Input<inputs.VrfTimeouts>;
}
