...
export class Connection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/connection:Connection';
     ...
     */
    public /*out*/ readonly serviceTokens!: pulumi.Output<outputs.ConnectionServiceToken[]>;
    /**
...
export interface ConnectionState {
     ...
     * Only used with shared connection. List of service tokens to use for the connection.
     */
    serviceTokens?: pulumi.Input<pulumi.Input<inputs.ConnectionServiceToken>[]>;
    /**
     * Port speed. Allowed values are 50Mbps, 200Mbps, 500Mbps, 1Gbps, 2Gbps, 5Gbps, 10Gbps
     */
