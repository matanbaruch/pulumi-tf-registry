...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "metal:index/bgpSession:BgpSession":
                return new BgpSession(name, <any>undefined, { urn })
            case "metal:index/connection:Connection":
                return new Connection(name, <any>undefined, { urn })
            case "metal:index/device:Device":
                return new Device(name, <any>undefined, { urn })
            case "metal:index/deviceNetworkType:DeviceNetworkType":
                return new DeviceNetworkType(name, <any>undefined, { urn })
            case "metal:index/gateway:Gateway":
                return new Gateway(name, <any>undefined, { urn })
            case "metal:index/ipAttachment:IpAttachment":
                return new IpAttachment(name, <any>undefined, { urn })
            case "metal:index/organization:Organization":
                return new Organization(name, <any>undefined, { urn })
            case "metal:index/port:Port":
                return new Port(name, <any>undefined, { urn })
            case "metal:index/portVlanAttachment:PortVlanAttachment":
                return new PortVlanAttachment(name, <any>undefined, { urn })
            case "metal:index/project:Project":
                return new Project(name, <any>undefined, { urn })
            case "metal:index/projectApiKey:ProjectApiKey":
                return new ProjectApiKey(name, <any>undefined, { urn })
            case "metal:index/projectSshKey:ProjectSshKey":
                return new ProjectSshKey(name, <any>undefined, { urn })
            case "metal:index/reservedIpBlock:ReservedIpBlock":
                return new ReservedIpBlock(name, <any>undefined, { urn })
            case "metal:index/spotMarketRequest:SpotMarketRequest":
                return new SpotMarketRequest(name, <any>undefined, { urn })
            case "metal:index/sshKey:SshKey":
                return new SshKey(name, <any>undefined, { urn })
            case "metal:index/userApiKey:UserApiKey":
                return new UserApiKey(name, <any>undefined, { urn })
            case "metal:index/virtualCircuit:VirtualCircuit":
                return new VirtualCircuit(name, <any>undefined, { urn })
            case "metal:index/vlan:Vlan":
                return new Vlan(name, <any>undefined, { urn })
            case "metal:index/volume:Volume":
                return new Volume(name, <any>undefined, { urn })
            case "metal:index/volumeAttachment:VolumeAttachment":
                return new VolumeAttachment(name, <any>undefined, { urn })
            case "metal:index/vrf:Vrf":
...
pulumi.runtime.registerResourceModule("metal", "index/bgpSession", _module)
pulumi.runtime.registerResourceModule("metal", "index/connection", _module)
pulumi.runtime.registerResourceModule("metal", "index/device", _module)
pulumi.runtime.registerResourceModule("metal", "index/deviceNetworkType", _module)
pulumi.runtime.registerResourceModule("metal", "index/gateway", _module)
pulumi.runtime.registerResourceModule("metal", "index/ipAttachment", _module)
pulumi.runtime.registerResourceModule("metal", "index/organization", _module)
pulumi.runtime.registerResourceModule("metal", "index/port", _module)
pulumi.runtime.registerResourceModule("metal", "index/portVlanAttachment", _module)
pulumi.runtime.registerResourceModule("metal", "index/project", _module)
pulumi.runtime.registerResourceModule("metal", "index/projectApiKey", _module)
pulumi.runtime.registerResourceModule("metal", "index/projectSshKey", _module)
pulumi.runtime.registerResourceModule("metal", "index/reservedIpBlock", _module)
pulumi.runtime.registerResourceModule("metal", "index/spotMarketRequest", _module)
pulumi.runtime.registerResourceModule("metal", "index/sshKey", _module)
pulumi.runtime.registerResourceModule("metal", "index/userApiKey", _module)
pulumi.runtime.registerResourceModule("metal", "index/virtualCircuit", _module)
pulumi.runtime.registerResourceModule("metal", "index/vlan", _module)
pulumi.runtime.registerResourceModule("metal", "index/volume", _module)
pulumi.runtime.registerResourceModule("metal", "index/volumeAttachment", _module)
pulumi.runtime.registerResourceModule("metal", "index/vrf", _module)
pulumi.runtime.registerResourcePackage("metal", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:metal") {
