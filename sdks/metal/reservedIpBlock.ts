...
export class ReservedIpBlock extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'metal:index/reservedIpBlock:ReservedIpBlock';
    ...
    public readonly timeouts!: pulumi.Output<outputs.ReservedIpBlockTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ReservedIpBlockArgs | ReservedIpBlockState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ReservedIpBlock.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ReservedIpBlockState {
    ...
    timeouts?: pulumi.Input<inputs.ReservedIpBlockTimeouts>;
    /**
     * Either global_ipv4, public_ipv4, or vrf. Defaults to public_ipv4.
     */
