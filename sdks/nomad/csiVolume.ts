...
export class CsiVolume extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CsiVolumeTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CsiVolumeArgs | CsiVolumeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CsiVolume.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CsiVolumeState {
    ...
    timeouts?: pulumi.Input<inputs.CsiVolumeTimeouts>;
