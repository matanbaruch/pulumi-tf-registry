...
export { GetJwksArgs, GetJwksResult, GetJwksOutputArgs } from "./getJwks";
...
export { GetSchedulerConfigArgs, GetSchedulerConfigResult, GetSchedulerConfigOutputArgs } from "./getSchedulerConfig";
export const getSchedulerConfig: typeof import("./getSchedulerConfig").getSchedulerConfig = null as any;
export const getSchedulerConfigOutput: typeof import("./getSchedulerConfig").getSchedulerConfigOutput = null as any;
utilities.lazyLoad(exports, ["getSchedulerConfig","getSchedulerConfigOutput"], () => require("./getSchedulerConfig"));
...
export { QuotaSpecificationArgs, QuotaSpecificationState } from "./quotaSpecification";
export type QuotaSpecification = import("./quotaSpecification").QuotaSpecification;
export const QuotaSpecification: typeof import("./quotaSpecification").QuotaSpecification = null as any;
utilities.lazyLoad(exports, ["QuotaSpecification"], () => require("./quotaSpecification"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "nomad:index/quotaSpecification:QuotaSpecification":
                return new QuotaSpecification(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("nomad", "index/quotaSpecification", _module)
