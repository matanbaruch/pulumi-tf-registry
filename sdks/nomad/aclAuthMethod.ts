...
export class AclAuthMethod extends pulumi.CustomResource {
    ...
    /**
     * Defines whether the ACL Auth Method creates a local or global token when performing SSO login. This field must be set to
    ...
    constructor(name: string, argsOrState?: AclAuthMethodArgs | AclAuthMethodState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AclAuthMethod.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
