...
const __config = new pulumi.Config("kubectl");

/**
 * Defines the number of attempts any create/update action will take
 */
export declare const applyRetryCount: number | undefined;
Object.defineProperty(exports, "applyRetryCount", {
    get() {
        return __config.getObject<number>("applyRetryCount");
    },
    enumerable: true,
});
