...
/**
 * The provider type for the kubectl package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'kubectl';
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            resourceInputs["applyRetryCount"] = pulumi.output(args ? args.applyRetryCount : undefined).apply(JSON.stringify);
...
export interface ProviderArgs {
     ...
     */
    applyRetryCount?: pulumi.Input<number>;
    /**
     * PEM-encoded client certificate for TLS authentication.
     */
