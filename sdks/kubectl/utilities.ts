...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("kubectl");
			params.setVersion("1.14.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2dhdmluYnVubmV5L2t1YmVjdGwiLCJ2ZXJzaW9uIjoiMS4xNC4wIn19"), c => c.charCodeAt(0)));
