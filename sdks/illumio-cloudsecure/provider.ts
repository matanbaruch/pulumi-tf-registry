...
/**
 * The provider type for the illumio-cloudsecure package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'illumio-cloudsecure';
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        const secretOpts = { additionalSecretOutputs: ["accessToken", "clientSecret"] };
