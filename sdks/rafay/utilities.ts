...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("rafay");
			params.setVersion("1.1.34");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3JhZmF5c3lzdGVtcy9yYWZheSIsInZlcnNpb24iOiIxLjEuMzQifX0="), c => c.charCodeAt(0)));
