...
export class Addon extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'rafay:index/addon:Addon';
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.AddonMetadata | undefined>;
    /**
     * Specification of the addon resource
     */
    public readonly spec!: pulumi.Output<outputs.AddonSpec | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.AddonTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AddonArgs | AddonState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Addon.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AddonState {
     ...
     * Metadata of the addon resource
     */
    metadata?: pulumi.Input<inputs.AddonMetadata>;
    /**
     * Specification of the addon resource
     */
    spec?: pulumi.Input<inputs.AddonSpec>;
    timeouts?: pulumi.Input<inputs.AddonTimeouts>;
}
