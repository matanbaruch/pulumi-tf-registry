...
export class AutoBackup extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AutoBackupTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AutoBackupArgs | AutoBackupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["maxBackupNum"] = state ? state.maxBackupNum : undefined;
            ...
            resourceInputs["maxBackupNum"] = args ? args.maxBackupNum : undefined;
        ...
        super(AutoBackup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AutoBackupState {
    ...
    timeouts?: pulumi.Input<inputs.AutoBackupTimeouts>;
    /**
     * A list of weekdays to backed up. The values in the list must be in [`sun`/`mon`/`tue`/`wed`/`thu`/`fri`/`sat`]
     */
