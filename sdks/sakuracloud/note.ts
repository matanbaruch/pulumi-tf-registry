...
export class Note extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.NoteTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NoteArgs | NoteState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Note.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NoteState {
    ...
    timeouts?: pulumi.Input<inputs.NoteTimeouts>;
}
