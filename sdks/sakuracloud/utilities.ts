...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("sakuracloud");
			params.setVersion("2.25.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3NhY2xvdWQvc2FrdXJhY2xvdWQiLCJ2ZXJzaW9uIjoiMi4yNS40In19"), c => c.charCodeAt(0)));
