...
export class Internet extends pulumi.CustomResource {
     ...
     * `100`/`250`/`500`/`1000`/`1500`/`2000`/`2500`/`3000`/`3500`/`4000`/`4500`/`5000`/`5500`/`6000`/`6500`/`7000`/`7500`/`8000`/`8500`/`9000`/`9500`/`10000`
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.InternetTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InternetArgs | InternetState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ipv6NetworkAddress"] = state ? state.ipv6NetworkAddress : undefined;
            ...
            resourceInputs["maxIpAddress"] = state ? state.maxIpAddress : undefined;
            resourceInputs["minIpAddress"] = state ? state.minIpAddress : undefined;
            ...
            resourceInputs["ipv6NetworkAddress"] = undefined /*out*/;
            resourceInputs["ipv6Prefix"] = undefined /*out*/;
            resourceInputs["ipv6PrefixLen"] = undefined /*out*/;
            resourceInputs["maxIpAddress"] = undefined /*out*/;
            resourceInputs["minIpAddress"] = undefined /*out*/;
            resourceInputs["networkAddress"] = undefined /*out*/;
            resourceInputs["serverIds"] = undefined /*out*/;
            resourceInputs["switchId"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(Internet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InternetState {
    ...
    timeouts?: pulumi.Input<inputs.InternetTimeouts>;
    /**
     * The name of zone that the Switch+Router will be created (e.g. `is1a`, `tk1a`)
     */
