...
export class LocalRouter extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.LocalRouterTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: LocalRouterArgs | LocalRouterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LocalRouter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LocalRouterState {
    ...
    timeouts?: pulumi.Input<inputs.LocalRouterTimeouts>;
}
