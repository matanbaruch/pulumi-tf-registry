...
export class ArchiveShare extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ArchiveShareTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ArchiveShareArgs | ArchiveShareState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["shareKey"] = state ? state.shareKey : undefined;
            ...
            resourceInputs["archiveId"] = args ? args.archiveId : undefined;
            resourceInputs["timeouts"] = args ? args.timeouts : undefined;
            resourceInputs["zone"] = args ? args.zone : undefined;
            resourceInputs["shareKey"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const secretOpts = { additionalSecretOutputs: ["shareKey"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(ArchiveShare.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ArchiveShareState {
    ...
    timeouts?: pulumi.Input<inputs.ArchiveShareTimeouts>;
    /**
     * The name of zone that the ArchiveShare will be created (e.g. `is1a`, `tk1a`)
     */
