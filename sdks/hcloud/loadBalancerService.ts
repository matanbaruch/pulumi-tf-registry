...
export class LoadBalancerService extends pulumi.CustomResource {
    ...
    public readonly healthCheck!: pulumi.Output<outputs.LoadBalancerServiceHealthCheck | undefined>;
    ...
    constructor(name: string, argsOrState?: LoadBalancerServiceArgs | LoadBalancerServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoadBalancerService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
