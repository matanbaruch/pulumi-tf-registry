...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("hcloud");
			params.setVersion("1.48.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2hldHpuZXJjbG91ZC9oY2xvdWQiLCJ2ZXJzaW9uIjoiMS40OC4wIn19"), c => c.charCodeAt(0)));
