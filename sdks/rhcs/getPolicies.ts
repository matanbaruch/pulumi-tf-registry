...
export function getPolicies(opts?: pulumi.InvokeOptions): Promise<GetPoliciesResult> {
    ...
    return pulumi.runtime.invoke("rhcs:index/getPolicies:getPolicies", {
...
export interface GetPoliciesResult {
    readonly accountRolePolicies: outputs.GetPoliciesAccountRolePolicies;
    /**
     * The provider-assigned unique ID for this managed resource.
     */
    readonly id: string;
    readonly operatorRolePolicies: outputs.GetPoliciesOperatorRolePolicies;
}
