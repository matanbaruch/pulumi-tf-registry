...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("kafka-connect");
			params.setVersion("0.4.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21vbmdleS9rYWZrYS1jb25uZWN0IiwidmVyc2lvbiI6IjAuNC4xIn19"), c => c.charCodeAt(0)));
