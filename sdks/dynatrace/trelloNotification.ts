...
export class TrelloNotification extends pulumi.CustomResource {
    ...
    /**
     * The text of the generated Trello card. You can use the following placeholders: * `{ImpactedEntity}`: The entity impacted
    ...
    constructor(name: string, argsOrState?: TrelloNotificationArgs | TrelloNotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TrelloNotification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
