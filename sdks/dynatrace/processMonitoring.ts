...
export class ProcessMonitoring extends pulumi.CustomResource {
    ...
    /**
     * By disabling automatic deep monitoring the Dynatrace OneAgent will only deep monitor processes that are covered by a
    ...
    constructor(name: string, argsOrState?: ProcessMonitoringArgs | ProcessMonitoringState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProcessMonitoring.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
