...
export class DiskAnomalies extends pulumi.CustomResource {
    ...
    /**
     * The metric to monitor. Possible values are: `LOW_DISK_SPACE`, `LOW_INODES`, `READ_TIME_EXCEEDING` and
    ...
    /**
     * The threshold to trigger disk event. * A percentage for `LowDiskSpace` or `LowInodes` metrics. * In milliseconds for
     * `ReadTimeExceeding` or `WriteTimeExceeding` metrics
     */
    public readonly threshold!: pulumi.Output<number>;
    /**
     * The number of samples that must violate the threshold to trigger an event. Must not exceed the number of evaluated
     * samples
     */
    ...
    constructor(name: string, argsOrState?: DiskAnomaliesArgs | DiskAnomaliesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DiskAnomalies.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
