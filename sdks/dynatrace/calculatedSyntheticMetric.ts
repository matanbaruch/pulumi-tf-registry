...
export class CalculatedSyntheticMetric extends pulumi.CustomResource {
    ...
    /**
     * The type of the synthetic metric. Possible values: [ ApplicationCache, Callback, CumulativeLayoutShift, DNSLookup,
    ...
    constructor(name: string, argsOrState?: CalculatedSyntheticMetricArgs | CalculatedSyntheticMetricState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CalculatedSyntheticMetric.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
