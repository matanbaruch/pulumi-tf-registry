...
export class DashboardsGeneral extends pulumi.CustomResource {
    ...
    /**
     * Configure home dashboard for selected user group. The selected preset dashboard will be loaded as default landing page
    ...
    constructor(name: string, argsOrState?: DashboardsGeneralArgs | DashboardsGeneralState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DashboardsGeneral.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
