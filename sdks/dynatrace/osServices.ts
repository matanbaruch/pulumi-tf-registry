...
export class OsServices extends pulumi.CustomResource {
    ...
    /**
     * Toggle the switch in order to enable or disable availability metric monitoring for this policy. Availability metrics
    ...
    /**
     * By default, Dynatrace does not alert if the service is not installed. Toggle the switch to enable or disable this
     * feature
     */
    ...
    constructor(name: string, argsOrState?: OsServicesArgs | OsServicesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OsServices.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
