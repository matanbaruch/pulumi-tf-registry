...
export class ManagedNetworkZones extends pulumi.CustomResource {
    ...
    /**
     * Name of the network zone cannot be modified once created. Dynatrace stores the field in lowercase, allowed characters:
    ...
    constructor(name: string, argsOrState?: ManagedNetworkZonesArgs | ManagedNetworkZonesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedNetworkZones.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
