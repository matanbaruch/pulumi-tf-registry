...
export class CalculatedMobileMetric extends pulumi.CustomResource {
    ...
    /**
     * The type of the metric. Possible values: [ REPORTED_ERROR_COUNT, USER_ACTION_DURATION, WEB_REQUEST_COUNT,
    ...
    constructor(name: string, argsOrState?: CalculatedMobileMetricArgs | CalculatedMobileMetricState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CalculatedMobileMetric.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
