...
export class AnsibleTowerNotification extends pulumi.CustomResource {
    ...
    /**
     * The custom message of the notification. This message will be displayed in the extra variables **Message** field of your
    ...
    /**
     * Accept any, including self-signed and invalid, SSL certificate (`true`) or only trusted (`false`) certificates. Default
     * is `false`.
     */
    ...
    constructor(name: string, argsOrState?: AnsibleTowerNotificationArgs | AnsibleTowerNotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AnsibleTowerNotification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
