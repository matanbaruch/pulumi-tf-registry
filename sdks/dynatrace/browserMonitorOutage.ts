...
export class BrowserMonitorOutage extends pulumi.CustomResource {
    ...
    /**
     * (Field has overlap with `dynatrace.BrowserMonitor`) Generate a problem and send an alert when the monitor is unavailable
    ...
    /**
     * (Field has overlap with `dynatrace.BrowserMonitor`) When enabled, which is the default, failing monitor executions are
    ...
    constructor(name: string, argsOrState?: BrowserMonitorOutageArgs | BrowserMonitorOutageState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BrowserMonitorOutage.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
