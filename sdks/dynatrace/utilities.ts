...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("dynatrace");
			params.setVersion("1.65.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2R5bmF0cmFjZS1vc3MvZHluYXRyYWNlIiwidmVyc2lvbiI6IjEuNjUuMCJ9fQ=="), c => c.charCodeAt(0)));
