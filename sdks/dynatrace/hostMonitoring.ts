...
export class HostMonitoring extends pulumi.CustomResource {
    ...
    /**
     * An auto-injection disabled with [oneagentctl](https://dt-url.net/oneagentctl) takes precedence over this setting and
    ...
    /**
     * Dynatrace uses full-stack monitoring by default, to monitor every aspect of your environment, including all processes,
    ...
    constructor(name: string, argsOrState?: HostMonitoringArgs | HostMonitoringState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(HostMonitoring.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
