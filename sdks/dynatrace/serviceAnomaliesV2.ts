...
export class ServiceAnomaliesV2 extends pulumi.CustomResource {
    ...
    /**
     * The scope of this setting (SERVICE_METHOD, SERVICE, HOST_GROUP). Omit this property if you want to cover the whole
     * environment.
     */
    ...
    constructor(name: string, argsOrState?: ServiceAnomaliesV2Args | ServiceAnomaliesV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceAnomaliesV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
