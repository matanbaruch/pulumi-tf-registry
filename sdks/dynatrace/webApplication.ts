...
export class WebApplication extends pulumi.CustomResource {
    ...
    /**
     * The key performance metric of load actions. Possible values are `ACTION_DURATION`, `CUMULATIVE_LAYOUT_SHIFT`,
    ...
    /**
     * The type of the web application. Possible values are `AUTO_INJECTED`, `BROWSER_EXTENSION_INJECTED` and
     * `MANUALLY_INJECTED`
     */
    ...
    /**
     * The key performance metric of XHR actions. Possible values are `ACTION_DURATION`, `RESPONSE_END`, `RESPONSE_START` and
     * `VISUALLY_COMPLETE`.
     */
    ...
    constructor(name: string, argsOrState?: WebApplicationArgs | WebApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebApplication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
