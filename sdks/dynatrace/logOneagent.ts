...
export class LogOneagent extends pulumi.CustomResource {
    ...
    /**
     * Defines the number of characters in every log line (starting from the first character in the line) where the timestamp
     * is searched.
     */
    ...
    /**
     * Automatically detect logs written by important processes. For more details, check our
    ...
    /**
     * Defines the number of characters in every log line (starting from the first character in the line) where severity is
     * searched.
     */
    ...
    constructor(name: string, argsOrState?: LogOneagentArgs | LogOneagentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogOneagent.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
