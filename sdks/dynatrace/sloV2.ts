...
export class SloV2 extends pulumi.CustomResource {
    ...
    /**
     * Define the timeframe during which the SLO is to be evaluated. For the timeframe you can enter expressions like -1h (last
    ...
    /**
     * Set a filter parameter (entitySelector) on any GET call to evaluate this SLO against specific services only (for
    ...
    /**
     * For details, see the [Metrics page](https://www.terraform.io/ui/metrics "Metrics page").
     */
    ...
    constructor(name: string, argsOrState?: SloV2Args | SloV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SloV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
