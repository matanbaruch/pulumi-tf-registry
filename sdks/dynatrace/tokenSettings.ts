...
export class TokenSettings extends pulumi.CustomResource {
    ...
    /**
     * Allow users of this environment to generate personal access tokens based on user permissions. Note that existing
    ...
    constructor(name: string, argsOrState?: TokenSettingsArgs | TokenSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TokenSettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
