...
export class MainframeTransactionMonitoring extends pulumi.CustomResource {
    ...
    /**
     * If enabled, CICS regions belonging to the same CICSPlex will be grouped into a single process group. If disabled, a
     * process group will be created for each CICS region.
     */
    public readonly groupCicsRegions!: pulumi.Output<boolean>;
    /**
     * If enabled, IMS regions belonging to the same subsystem will be grouped into a single process group. If disabled, a
     * process group will be created for each IMS region.
     */
    public readonly groupImsRegions!: pulumi.Output<boolean>;
    /**
     * If enabled, the CICS Transaction Gateway sensor will trace all EXCI requests including those that are using the TCP/IP
     * or SNA protocol.
     */
    public readonly monitorAllCtgProtocols!: pulumi.Output<boolean>;
    /**
     * Dynatrace automatically traces incoming web requests when they are called by already-monitored services. Enable this
    ...
    /**
     * If enabled, a CICS service will be created for each monitored transaction ID within a process group. If disabled, a CICS
    ...
    /**
     * If enabled, an IMS service will be created for each monitored transaction ID within a process group. If disabled, an IMS
    ...
    constructor(name: string, argsOrState?: MainframeTransactionMonitoringArgs | MainframeTransactionMonitoringState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MainframeTransactionMonitoring.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
