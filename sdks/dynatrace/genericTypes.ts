...
export class GenericTypes extends pulumi.CustomResource {
    ...
    /**
     * Specify a list of rules which are evaluated in order. When **any** rule matches, the entity defined according to that
    ...
    constructor(name: string, argsOrState?: GenericTypesArgs | GenericTypesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GenericTypes.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
