...
export class ContainerRule extends pulumi.CustomResource {
    ...
    /**
     * Possible Values: `CONTAINS`, `ENDS`, `EQUALS`, `EXISTS`, `NOT_CONTAINS`, `NOT_ENDS`, `NOT_EQUALS`, `NOT_EXISTS`,
     * `NOT_STARTS`, `STARTS`
     */
    public readonly operator!: pulumi.Output<string>;
    /**
     * Possible Values: `CONTAINER_NAME`, `IMAGE_NAME`, `KUBERNETES_BASEPODNAME`, `KUBERNETES_CONTAINERNAME`,
    ...
    constructor(name: string, argsOrState?: ContainerRuleArgs | ContainerRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ContainerRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
