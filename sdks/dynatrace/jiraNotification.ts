...
export class JiraNotification extends pulumi.CustomResource {
    ...
    /**
     * The API token for the Jira profile. Using password authentication [was deprecated by
    ...
    constructor(name: string, argsOrState?: JiraNotificationArgs | JiraNotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(JiraNotification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
