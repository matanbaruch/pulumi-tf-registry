...
export class UsabilityAnalytics extends pulumi.CustomResource {
    ...
    /**
     * Three or more rapid clicks within the same area of a web page are considered to be rage clicks. Rage clicks commonly
    ...
    constructor(name: string, argsOrState?: UsabilityAnalyticsArgs | UsabilityAnalyticsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UsabilityAnalytics.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
