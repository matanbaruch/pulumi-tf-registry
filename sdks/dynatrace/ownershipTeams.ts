...
export class OwnershipTeams extends pulumi.CustomResource {
    ...
    /**
     * The team identifier is used to reference the team from any entity in Dynatrace. If you are using Kubernetes labels, keep
    ...
    /**
     * The supplementary team identifiers can be optionally used in addition to the main team identifier to reference this team
    ...
    constructor(name: string, argsOrState?: OwnershipTeamsArgs | OwnershipTeamsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OwnershipTeams.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
