...
export class Nettracer extends pulumi.CustomResource {
    ...
    /**
     * When disabled, OneAgent won't use NetTracer to collect network data from containers. Disabled by default. Applies only
    ...
    constructor(name: string, argsOrState?: NettracerArgs | NettracerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Nettracer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
