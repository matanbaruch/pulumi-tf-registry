...
export class AzureCredentials extends pulumi.CustomResource {
    ...
    /**
     * The monitoring is enabled (`true`) or disabled (`false`). If not set on creation, the `true` value is used. If the field
    ...
    /**
     * The secret key associated with the Application ID. For security reasons, GET requests return this field as `null`.
    ...
    /**
     * The unique name of the Azure credentials configuration. Allowed characters are letters, numbers, and spaces. Also the
     * special characters `.+-_` are allowed
     */
    public readonly label!: pulumi.Output<string | undefined>;
    /**
     * A list of Azure tags to be excluded from monitoring. You can specify up to 20 tags. A resource tagged with *any* of the
    ...
    /**
     * A list of Azure tags to be monitored. You can specify up to 20 tags. A resource tagged with *any* of the specified tags
     ...
     * Credentials. Supporting Services applied by via `dynatrace.AzureService` subsequently won't get touched.
     */
    public readonly removeDefaults!: pulumi.Output<boolean | undefined>;
    /**
     * A list of Azure supporting services to be monitored. For each service there's a sublist of its metrics and the metrics'
    ...
    constructor(name: string, argsOrState?: AzureCredentialsArgs | AzureCredentialsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AzureCredentials.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
