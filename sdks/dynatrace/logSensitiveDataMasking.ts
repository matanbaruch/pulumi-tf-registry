...
export class LogSensitiveDataMasking extends pulumi.CustomResource {
    ...
    /**
     * The scope of this setting (HOST-########, HOST_GROUP-########). Omit this property if you want to cover the whole
     * environment.
     */
    ...
    constructor(name: string, argsOrState?: LogSensitiveDataMaskingArgs | LogSensitiveDataMaskingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogSensitiveDataMasking.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
