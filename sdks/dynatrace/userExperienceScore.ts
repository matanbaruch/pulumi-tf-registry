...
export class UserExperienceScore extends pulumi.CustomResource {
    ...
    /**
     * User experience is considered Frustrating when the selected percentage or more of the user actions in a session are
     * rated as Frustrating.
     */
    public readonly maxFrustratedUserActionsThreshold!: pulumi.Output<number>;
    /**
     * User experience is considered Satisfying when at least the selected percentage of the user actions in a session are
     * rated as Satisfying.
     */
    ...
    constructor(name: string, argsOrState?: UserExperienceScoreArgs | UserExperienceScoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserExperienceScore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
