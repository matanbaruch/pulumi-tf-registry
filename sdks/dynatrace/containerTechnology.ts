...
export class ContainerTechnology extends pulumi.CustomResource {
    ...
    /**
     * Platform: Cloud Foundry Status: Released Operating system: Linux Min agent version: 1.159
     */
    ...
    constructor(name: string, argsOrState?: ContainerTechnologyArgs | ContainerTechnologyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ContainerTechnology.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
