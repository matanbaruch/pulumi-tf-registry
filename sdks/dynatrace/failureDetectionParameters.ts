...
export class FailureDetectionParameters extends pulumi.CustomResource {
    ...
    /**
     * HTTP 404 response codes are thrown when a web server can't find a certain page. 404s are classified as broken links on
    ...
    constructor(name: string, argsOrState?: FailureDetectionParametersArgs | FailureDetectionParametersState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FailureDetectionParameters.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
