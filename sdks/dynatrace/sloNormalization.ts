...
export class SloNormalization extends pulumi.CustomResource {
    ...
    /**
     * When set to true, the error budget left will be shown in percent of the total error budget. For more details see [SLO
    ...
    constructor(name: string, argsOrState?: SloNormalizationArgs | SloNormalizationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SloNormalization.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
