...
export class DashboardsPresets extends pulumi.CustomResource {
    ...
    /**
     * Dashboard presets are visible to all users by default. For a pristine environment you may disable them entirely or opt
    ...
    constructor(name: string, argsOrState?: DashboardsPresetsArgs | DashboardsPresetsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DashboardsPresets.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
