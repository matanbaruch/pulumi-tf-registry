...
export class ManagedInternetProxy extends pulumi.CustomResource {
    ...
    /**
     * Definition of hosts for which proxy won't be used. You can define multiple hosts. Each host can start or end with
    ...
    constructor(name: string, argsOrState?: ManagedInternetProxyArgs | ManagedInternetProxyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedInternetProxy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
