...
export class GenericRelationships extends pulumi.CustomResource {
    ...
    /**
     * Specify a role for the source entity. If both source and destination type are the same, referring different roles will
    ...
    /**
     * Specify all sources which should be evaluated for this relationship rule. The relationship is only created when any of
     * the filters match.
     */
    public readonly sources!: pulumi.Output<outputs.GenericRelationshipsSources>;
    /**
     * Specify a role for the destination entity. If both source and destination type are the same, referring different roles
    ...
    /**
     * Define an entity type as the destination of the relationship. You can choose the same type as the source type. In this
    ...
    constructor(name: string, argsOrState?: GenericRelationshipsArgs | GenericRelationshipsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GenericRelationships.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
