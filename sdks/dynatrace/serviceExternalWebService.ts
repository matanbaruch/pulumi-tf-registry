...
export class ServiceExternalWebService extends pulumi.CustomResource {
    ...
    /**
     * Contributors to the Service Identifier calculation. URL path is always applied as an Id Contributor. You can exclude the
    ...
    /**
     * Define a management zone of the process group for which this service detection rule should be created. Note: in case of
    ...
    constructor(name: string, argsOrState?: ServiceExternalWebServiceArgs | ServiceExternalWebServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceExternalWebService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
