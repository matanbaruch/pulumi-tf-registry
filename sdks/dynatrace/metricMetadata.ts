...
export class MetricMetadata extends pulumi.CustomResource {
    ...
    /**
     * Specifies which entity dimension should be used as the primary dimension. The property can only be configured for
    ...
    /**
     * The raw value is stored in bits or bytes. The user interface can display it in these numeral systems: Binary: 1 MiB =
    ...
    constructor(name: string, argsOrState?: MetricMetadataArgs | MetricMetadataState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MetricMetadata.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
