...
export class NetworkMonitor extends pulumi.CustomResource {
     ...
     * source 'USER' will be added automatically. But preferred option is usage of SyntheticTagWithSourceDto model.
     */
    ...
    constructor(name: string, argsOrState?: NetworkMonitorArgs | NetworkMonitorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkMonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
