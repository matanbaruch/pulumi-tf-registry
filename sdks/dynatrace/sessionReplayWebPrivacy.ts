...
export class SessionReplayWebPrivacy extends pulumi.CustomResource {
    ...
    /**
     * (Field has overlap with `dynatrace.ApplicationDataPrivacy`) When [Session Replay opt-in
    ...
    /**
     * (Field has overlap with `dynatrace.ApplicationDataPrivacy`) To protect your end users' privacy, select or customize
    ...
    /**
     * (Field has overlap with `dynatrace.ApplicationDataPrivacy`) Exclude webpages or views from Session Replay recording by
    ...
    constructor(name: string, argsOrState?: SessionReplayWebPrivacyArgs | SessionReplayWebPrivacyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SessionReplayWebPrivacy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
