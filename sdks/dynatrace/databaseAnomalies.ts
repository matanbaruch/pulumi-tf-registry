...
export class DatabaseAnomalies extends pulumi.CustomResource {
    ...
    /**
     * Parameters of the failed database connections detection. The alert is triggered when failed connections number exceeds
    ...
    constructor(name: string, argsOrState?: DatabaseAnomaliesArgs | DatabaseAnomaliesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseAnomalies.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
