...
export class SlackNotification extends pulumi.CustomResource {
    ...
    /**
     * The content of the message. You can use the following placeholders: * `{ImpactedEntity}`: The entity impacted by the
    ...
    /**
     * The URL of the Slack WebHook. This is confidential information, therefore GET requests return this field with the `null`
    ...
    constructor(name: string, argsOrState?: SlackNotificationArgs | SlackNotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SlackNotification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
