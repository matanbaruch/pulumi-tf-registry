...
export class ManagedPreferences extends pulumi.CustomResource {
    ...
    /**
     * If true, each new user will get an invitation to set up a Dynatrace user account to access Dynatrace support resources
    ...
    /**
     * If true, audited access to your Dynatrace cluster is allowed by approved Dynatrace employees otherwise by privileged
    ...
    constructor(name: string, argsOrState?: ManagedPreferencesArgs | ManagedPreferencesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedPreferences.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
