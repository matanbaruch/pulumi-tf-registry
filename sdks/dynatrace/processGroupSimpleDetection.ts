...
export class ProcessGroupSimpleDetection extends pulumi.CustomResource {
    ...
    /**
     * If Dynatrace detects this property at startup of a process, it will use its value to identify process groups more
     * granular.
     */
    ...
    /**
     * Use a variable to identify instances within a process group. The type of variable is the same as selected in 'Property
     * source'.
     */
    ...
    constructor(name: string, argsOrState?: ProcessGroupSimpleDetectionArgs | ProcessGroupSimpleDetectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProcessGroupSimpleDetection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
