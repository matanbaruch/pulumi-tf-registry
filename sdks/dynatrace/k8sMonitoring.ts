...
export class K8sMonitoring extends pulumi.CustomResource {
    ...
    /**
     * All events are monitored unless event filters are specified. All ingested events are subject to licensing by default. If
    ...
    constructor(name: string, argsOrState?: K8sMonitoringArgs | K8sMonitoringState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(K8sMonitoring.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
