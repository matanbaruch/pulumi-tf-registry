...
export class GrailMetricsAllowall extends pulumi.CustomResource {
    ...
    /**
     * When enabled every custom metric will be ingested to Grail. Warning: this setting can cause [unexpected
    ...
    constructor(name: string, argsOrState?: GrailMetricsAllowallArgs | GrailMetricsAllowallState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GrailMetricsAllowall.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
