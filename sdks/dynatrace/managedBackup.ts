...
export class ManagedBackup extends pulumi.CustomResource {
    ...
    /**
     * Max number of Elasticsearch snapshots to clean. Elasticsearch snapshots won't be created anymore if there will be more
     * backups to clean than this value.
     */
    public readonly maxEsSnapshotsToClean!: pulumi.Output<number | undefined>;
    /**
     * Pauses Elasticsearch and Cassandra backups. In comparison to enable/disable backup, this option does not modify any
    ...
    constructor(name: string, argsOrState?: ManagedBackupArgs | ManagedBackupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedBackup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
