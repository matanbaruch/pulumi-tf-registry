...
export class ManagedSmtp extends pulumi.CustomResource {
    ...
    /**
     * Connection security, possible values: `NO_ENCRYPTION`, `OPTIONAL_STARTTLS`, `REQUIRE_STARTTLS`, `TLS`. Default:
     * `NO_ENCRYPTION`
     */
    ...
    constructor(name: string, argsOrState?: ManagedSmtpArgs | ManagedSmtpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedSmtp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
