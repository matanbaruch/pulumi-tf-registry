...
export class ManagementZoneV2 extends pulumi.CustomResource {
    ...
    /**
     * **Be careful when renaming** - if there are policies that are referencing this Management zone, they will need to be
    ...
    constructor(name: string, argsOrState?: ManagementZoneV2Args | ManagementZoneV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagementZoneV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
