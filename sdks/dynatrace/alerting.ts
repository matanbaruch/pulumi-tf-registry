...
export class Alerting extends pulumi.CustomResource {
    ...
    /**
     * The list of event filters. For all filters that are *negated* inside of these event filters, that is all `Predefined` as
    ...
    /**
     * Entities which are part of the configured management zones will match this alerting profile. It is recommended to use
     * manual tags instead.
     */
    ...
    constructor(name: string, argsOrState?: AlertingArgs | AlertingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Alerting.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
