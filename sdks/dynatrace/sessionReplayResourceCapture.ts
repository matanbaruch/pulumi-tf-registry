...
export class SessionReplayResourceCapture extends pulumi.CustomResource {
    ...
    /**
     * (Field has overlap with `dynatrace.WebApplication`) When turned on, all CSS resources from all sessions are captured.
    ...
    /**
     * (Field has overlap with `dynatrace.WebApplication`) Add exclusion rules to avoid the capture of resources from certain
     * pages.
     */
    ...
    constructor(name: string, argsOrState?: SessionReplayResourceCaptureArgs | SessionReplayResourceCaptureState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SessionReplayResourceCapture.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
