...
export class CustomDevice extends pulumi.CustomResource {
    ...
    /**
     * The Dynatrace EntityID of this resource. If you need to refer to this custom device within other resources you want to
     * use this ID
     */
    ...
    /**
     * If `true` the custom device will be handled as if it was created via UI. It will be refreshed automatically and won't
    ...
    constructor(name: string, argsOrState?: CustomDeviceArgs | CustomDeviceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CustomDevice.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
