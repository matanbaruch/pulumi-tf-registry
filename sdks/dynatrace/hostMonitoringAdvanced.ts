...
export class HostMonitoringAdvanced extends pulumi.CustomResource {
    ...
    /**
     * Disabling this via [oneagentctl](https://dt-url.net/oneagentctl) takes precedence over this setting and cannot be
    ...
    constructor(name: string, argsOrState?: HostMonitoringAdvancedArgs | HostMonitoringAdvancedState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(HostMonitoringAdvanced.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
