...
export class CrashdumpAnalytics extends pulumi.CustomResource {
    ...
    /**
     * Disable the feature to stop receiving information about crash details and potential problems. We recommend keeping the
     * feature enabled.
     */
    ...
    constructor(name: string, argsOrState?: CrashdumpAnalyticsArgs | CrashdumpAnalyticsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CrashdumpAnalytics.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
