...
export class ApplicationErrorRules extends pulumi.CustomResource {
    ...
    /**
     * (Field has overlap with `dynatrace.WebAppCustomErrors`) An ordered list of HTTP errors. Rules are evaluated from top to
    ...
    constructor(name: string, argsOrState?: ApplicationErrorRulesArgs | ApplicationErrorRulesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApplicationErrorRules.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
