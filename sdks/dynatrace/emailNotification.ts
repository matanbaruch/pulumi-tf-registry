...
export class EmailNotification extends pulumi.CustomResource {
    ...
    /**
     * The template of the email notification. You can use the following placeholders: * `{ImpactedEntities}`: Details about
    ...
    constructor(name: string, argsOrState?: EmailNotificationArgs | EmailNotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EmailNotification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
