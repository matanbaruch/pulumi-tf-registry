...
export class MgmzPermission extends pulumi.CustomResource {
    ...
    /**
     * The ID of the management zone the permissions are valid for. When referring to resource `dynatrace.ManagementZoneV2` or
     * data source `dynatrace.ManagementZone` you need to refer to the attribute `legacy_id`.
     */
    public readonly managementZone!: pulumi.Output<string>;
    /**
     * The permissions to assign for that management zone. Allowed values are `DEMO_USER`, `LOG_VIEWER`,
    ...
    constructor(name: string, argsOrState?: MgmzPermissionArgs | MgmzPermissionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MgmzPermission.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
