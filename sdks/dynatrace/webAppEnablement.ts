...
export class WebAppEnablement extends pulumi.CustomResource {
    ...
    /**
     * Capture and analyze all user actions within your application. Enable [Real User Monitoring
    ...
    /**
     * [Session Replay](https://dt-url.net/session-replay) captures all user interactions within your application and replays
    ...
    constructor(name: string, argsOrState?: WebAppEnablementArgs | WebAppEnablementState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebAppEnablement.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
