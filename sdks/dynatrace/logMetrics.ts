...
export class LogMetrics extends pulumi.CustomResource {
    ...
    /**
     * To enable splitting on your metric, add desired dimensions. You can select a dimension name from the list or set it to
     * any value. To extract fields from logs, you can use log processing.
     */
    ...
    constructor(name: string, argsOrState?: LogMetricsArgs | LogMetricsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogMetrics.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
