...
export class WebAppKeyPerformanceLoad extends pulumi.CustomResource {
    ...
    /**
     * Possible Values: `CUMULATIVE_LAYOUT_SHIFT`, `DOM_INTERACTIVE`, `FIRST_INPUT_DELAY`, `LARGEST_CONTENTFUL_PAINT`,
    ...
    constructor(name: string, argsOrState?: WebAppKeyPerformanceLoadArgs | WebAppKeyPerformanceLoadState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebAppKeyPerformanceLoad.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
