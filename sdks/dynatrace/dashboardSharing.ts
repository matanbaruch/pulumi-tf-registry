...
export class DashboardSharing extends pulumi.CustomResource {
    ...
    /**
     * The dashboard is shared (`true`) or private (`false`). Make sure that this value is aligned with the attribute `shared`
     * of the resources `dynatrace.Dashboard` and `dynatrace.JsonDashboard`. Otherwise you will encounter non-empty plans.
     */
    ...
    /**
     * If `true` the dashboard will be marked as preset. Setting this attribute to `true` will automatically enforce a specific
     * set of permissions - Dashboards flagged as Preset are shared by default. Make sure that this value is aligned with the
     * attribute `preset` of the resources `dynatrace.Dashboard` and `dynatrace.JsonDashboard`. Otherwise you will encounter
     * non-empty plans.
     */
    ...
    constructor(name: string, argsOrState?: DashboardSharingArgs | DashboardSharingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DashboardSharing.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
