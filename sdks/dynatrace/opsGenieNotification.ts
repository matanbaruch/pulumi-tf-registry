...
export class OpsGenieNotification extends pulumi.CustomResource {
    ...
    /**
     * The content of the message. You can use the following placeholders: * `{ProblemID}`: The display number of the reported
    ...
    constructor(name: string, argsOrState?: OpsGenieNotificationArgs | OpsGenieNotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OpsGenieNotification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
