...
export class AttackRules extends pulumi.CustomResource {
    ...
    /**
     * If you add more than one condition, note that all conditions must be true simultaneously for the rule to apply. We
     * provide suggestions for resource attribute keys and values based on what we currently see in your environment. You can
     * also enter any value not currently seen in the list. Resource attributes come out of the box from the OneAgent, and you
     * can set them up from [data enrichment](https://docs.dynatrace.com/docs/extend-dynatrace/extend-data).
     */
    ...
    constructor(name: string, argsOrState?: AttackRulesArgs | AttackRulesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AttackRules.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
