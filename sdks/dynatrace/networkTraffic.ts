...
export class NetworkTraffic extends pulumi.CustomResource {
    ...
    /**
     * Providing a host IP address, you will exclude network traffic only in calculating connectivity (other metrics will still
     * be calculated).
     */
    public readonly excludeIp!: pulumi.Output<outputs.NetworkTrafficExcludeIp | undefined>;
    /**
     * Selecting a network interface, you will exclude all network traffic on that interface from being monitored. You can
    ...
    constructor(name: string, argsOrState?: NetworkTrafficArgs | NetworkTrafficState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkTraffic.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
