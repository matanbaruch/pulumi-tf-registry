...
export class ServiceAnomalies extends pulumi.CustomResource {
    ...
    /**
     * Configuration of failure rate increase detection. Detecting failure rate increases will be disabled if this block is
     * omitted.
     */
    ...
    /**
     * Configuration of response time degradation detection. Detecting response time degradation will be disabled if this block
     * is omitted.
     */
    ...
    constructor(name: string, argsOrState?: ServiceAnomaliesArgs | ServiceAnomaliesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceAnomalies.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
