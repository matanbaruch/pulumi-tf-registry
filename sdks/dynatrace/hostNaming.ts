...
export class HostNaming extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HostNamingState, opts?: pulumi.CustomResourceOptions): HostNaming {
        return new HostNaming(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dynatrace:index/hostNaming:HostNaming';

    /**
     * Returns true if the given object is an instance of HostNaming.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HostNaming {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HostNaming.__pulumiType;
    }

    /**
     * A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
     */
    public readonly conditions!: pulumi.Output<outputs.HostNamingCondition[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: HostNamingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HostNamingArgs | HostNamingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HostNamingState | undefined;
            ...
            const args = argsOrState as HostNamingArgs | undefined;
        ...
        super(HostNaming.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface HostNamingState {
    /**
     * A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.HostNamingCondition>[]>;
    /**
     * The rule is enabled (`true`) or disabled (`false`)
     */
 ...
 */
export interface HostNamingArgs {
    /**
     * A list of matching conditions of the rule. The rule applies only if **all** conditions are fulfilled
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.HostNamingCondition>[]>;
