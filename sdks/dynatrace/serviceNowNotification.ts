...
export class ServiceNowNotification extends pulumi.CustomResource {
    ...
    /**
     * The ServiceNow instance identifier. It refers to the first part of your own ServiceNow URL. This field is mutually
    ...
    /**
     * The content of the ServiceNow description. You can use the following placeholders: * `{ImpactedEntity}`: The entity
    ...
    /**
     * The URL of the on-premise ServiceNow installation. This field is mutually exclusive with the **instance** field. You can
     * only use one of them
     */
    public readonly url!: pulumi.Output<string | undefined>;
    /**
     * The username of the ServiceNow account. Make sure that your user account has the `rest_service`, `web_request_admin`,
    ...
    constructor(name: string, argsOrState?: ServiceNowNotificationArgs | ServiceNowNotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceNowNotification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
