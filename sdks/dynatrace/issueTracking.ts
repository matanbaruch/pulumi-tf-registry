...
export class IssueTracking extends pulumi.CustomResource {
    ...
    /**
     * You can use the following placeholders to automatically insert values from the **Release monitoring** page in your
    ...
    /**
     * For Jira, use the base URL (for example, https://jira.yourcompany.com); for GitHub, use the repository URL (for example,
    ...
    constructor(name: string, argsOrState?: IssueTrackingArgs | IssueTrackingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IssueTracking.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
