...
export class PlatformBucket extends pulumi.CustomResource {
    ...
    /**
     * The table the bucket definition applies to. Possible values are `logs`, `spans`, `events` and `bizevents`. Changing this
    ...
    constructor(name: string, argsOrState?: PlatformBucketArgs | PlatformBucketState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PlatformBucket.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
