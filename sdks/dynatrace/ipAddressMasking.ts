...
export class IpAddressMasking extends pulumi.CustomResource {
    ...
    /**
     * The scope of this setting (MOBILE_APPLICATION, CUSTOM_APPLICATION, APPLICATION). Omit this property if you want to cover
    ...
    constructor(name: string, argsOrState?: IpAddressMaskingArgs | IpAddressMaskingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IpAddressMasking.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
