...
export class UserSessionMetrics extends pulumi.CustomResource {
    ...
    /**
     * Defines the filters for the user session. Filters apply at the moment of extracting the data and only sessions that
    ...
    /**
     * Defines the type of value to be extracted from the user session. When using **User session counter**, the number of user
    ...
    constructor(name: string, argsOrState?: UserSessionMetricsArgs | UserSessionMetricsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserSessionMetrics.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
