...
export class HttpMonitorOutage extends pulumi.CustomResource {
    ...
    /**
     * (Field has overlap with `dynatrace.HttpMonitor`) Generate a problem and send an alert when the monitor is unavailable at
    ...
    /**
     * (Field has overlap with `dynatrace.HttpMonitor`) Generate a problem and send an alert when the monitor is unavailable
    ...
    constructor(name: string, argsOrState?: HttpMonitorOutageArgs | HttpMonitorOutageState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(HttpMonitorOutage.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
