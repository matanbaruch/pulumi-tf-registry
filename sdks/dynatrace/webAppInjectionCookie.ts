...
export class WebAppInjectionCookie extends pulumi.CustomResource {
    ...
    /**
     * Specify an alternative domain for cookies set by Dynatrace. Keep in mind that your browser may not allow placement of
    ...
    /**
     * If your application is only accessible via SSL, you can add the Secure attribute to all cookies set by Dynatrace. This
    ...
    constructor(name: string, argsOrState?: WebAppInjectionCookieArgs | WebAppInjectionCookieState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebAppInjectionCookie.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
