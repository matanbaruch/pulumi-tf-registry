...
export class LogTimestamp extends pulumi.CustomResource {
    ...
    /**
     * Optional field. Enter a fragment of the line text that starts the entry. No support for wildcards - the text is treated
     * literally.
     */
    ...
    constructor(name: string, argsOrState?: LogTimestampArgs | LogTimestampState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogTimestamp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
