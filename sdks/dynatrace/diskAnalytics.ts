...
export class DiskAnalytics extends pulumi.CustomResource {
    ...
    /**
     * The Disk Analytics feature requires an extension to be added to your environment. The Disk Analytics extension consumes
    ...
    constructor(name: string, argsOrState?: DiskAnalyticsArgs | DiskAnalyticsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DiskAnalytics.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
