...
export class IamPolicyBindingsV2 extends pulumi.CustomResource {
    ...
    /**
     * The UUID of the account (`urn:dtaccount:<account-uuid>`). The attribute `policies` must contain ONLY policies defined
    ...
    /**
     * A list of Policies (ID and parameters/metadata) referring to policies bound to that group. It's not possible to mix
    ...
    constructor(name: string, argsOrState?: IamPolicyBindingsV2Args | IamPolicyBindingsV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IamPolicyBindingsV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
