...
export class IamPolicy extends pulumi.CustomResource {
    ...
    /**
     * The UUID of the account (`urn:dtaccount:<account-uuid>`) in case the policy should be applied to all environments of
    ...
    /**
     * The ID of the environment (https://<environmentid>.live.dynatrace.com) if the policy should be applied to a specific
     * environment
     *
    ...
    /**
     * The ID of this resource is a concatenation of multiple pieces of information (policy UUID, accountID, environmentID,
     * ...). There are use cases where you JUST need the UUID of the Policy, though
     */
