...
export class AwsCredentials extends pulumi.CustomResource {
    ...
    /**
     * Instructs the provider to remove the supporting services Dynatrace applies by default to newly created AWS Credentials.
     * Supporting Services applied by via `dynatrace.AwsService` subsequently won't get touched.
     */
    ...
    constructor(name: string, argsOrState?: AwsCredentialsArgs | AwsCredentialsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AwsCredentials.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
