...
export interface GetSnapshotExportTaskArgs {
    ...
    id?: string;
    timeouts?: inputs.GetSnapshotExportTaskTimeouts;
}
...
export interface GetSnapshotExportTaskResult {
    ...
    readonly timeouts?: outputs.GetSnapshotExportTaskTimeouts;
}
...
export interface GetSnapshotExportTaskOutputArgs {
    ...
    timeouts?: pulumi.Input<inputs.GetSnapshotExportTaskTimeoutsArgs>;
}
