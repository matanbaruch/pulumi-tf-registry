...
export class LoadBalancerPolicy extends pulumi.CustomResource {
    ...
    public /*out*/ readonly accessLog!: pulumi.Output<{[key: string]: string}>;
    ...
    public /*out*/ readonly healthCheck!: pulumi.Output<{[key: string]: string}>;
    ...
    public readonly tags!: pulumi.Output<outputs.LoadBalancerPolicyTag[] | undefined>;
    ...
    constructor(name: string, argsOrState?: LoadBalancerPolicyArgs | LoadBalancerPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoadBalancerPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
