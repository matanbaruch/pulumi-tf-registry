...
export class VirtualGateway extends pulumi.CustomResource {
    ...
    public readonly netToVirtualGatewayLinks!: pulumi.Output<outputs.VirtualGatewayNetToVirtualGatewayLink[] | undefined>;
    ...
    constructor(name: string, argsOrState?: VirtualGatewayArgs | VirtualGatewayState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VirtualGateway.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
