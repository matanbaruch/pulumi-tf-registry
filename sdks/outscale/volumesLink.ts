...
export class VolumesLink extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.VolumesLinkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VolumesLinkArgs | VolumesLinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VolumesLink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VolumesLinkState {
    ...
    timeouts?: pulumi.Input<inputs.VolumesLinkTimeouts>;
