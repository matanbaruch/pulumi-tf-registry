...
export class Nic extends pulumi.CustomResource {
    ...
    public /*out*/ readonly linkNic!: pulumi.Output<{[key: string]: string}>;
    public /*out*/ readonly linkPublicIp!: pulumi.Output<{[key: string]: string}>;
    ...
    public readonly privateIps!: pulumi.Output<outputs.NicPrivateIp[] | undefined>;
...
export interface NicState {
    ...
    linkNic?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
