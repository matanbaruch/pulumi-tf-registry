...
export class ImageExportTask extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ImageExportTaskTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ImageExportTaskArgs | ImageExportTaskState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ImageExportTask.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ImageExportTaskState {
    ...
    timeouts?: pulumi.Input<inputs.ImageExportTaskTimeouts>;
}
