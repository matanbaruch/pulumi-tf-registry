...
export interface GetLoadBalancersLoadBalancer {
    ...
    sourceSecurityGroup: {[key: string]: string};
    subnetIds: string[];
...
export interface GetNetPeeringsNetPeering {
    accepterNet: {[key: string]: string};
    netPeeringId: string;
    sourceNet: {[key: string]: string};
...
export interface GetNicPrivateIp {
    isPrimary: boolean;
    linkPublicIp: {[key: string]: string};
