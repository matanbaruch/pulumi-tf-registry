...
export class LoadBalancerAttributes extends pulumi.CustomResource {
    ...
    public readonly accessLog!: pulumi.Output<outputs.LoadBalancerAttributesAccessLog | undefined>;
    ...
    public readonly healthCheck!: pulumi.Output<outputs.LoadBalancerAttributesHealthCheck | undefined>;
    ...
    public /*out*/ readonly sourceSecurityGroup!: pulumi.Output<{[key: string]: string}>;
    public /*out*/ readonly subnets!: pulumi.Output<string[]>;
    public /*out*/ readonly subregionNames!: pulumi.Output<string[]>;
    public readonly tags!: pulumi.Output<outputs.LoadBalancerAttributesTag[] | undefined>;
    ...
    constructor(name: string, argsOrState?: LoadBalancerAttributesArgs | LoadBalancerAttributesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoadBalancerAttributes.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LoadBalancerAttributesState {
    ...
    sourceSecurityGroup?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
