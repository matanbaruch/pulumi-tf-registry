...
export class FlexibleGpuLink extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.FlexibleGpuLinkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: FlexibleGpuLinkArgs | FlexibleGpuLinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FlexibleGpuLink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
