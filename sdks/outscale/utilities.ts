...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("outscale");
			params.setVersion("0.12.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL291dHNjYWxlL291dHNjYWxlIiwidmVyc2lvbiI6IjAuMTIuMCJ9fQ=="), c => c.charCodeAt(0)));
