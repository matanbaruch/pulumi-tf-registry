...
export class PublicIpLink extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.PublicIpLinkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PublicIpLinkArgs | PublicIpLinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PublicIpLink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
