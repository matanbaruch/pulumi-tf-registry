...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("vra7");
			params.setVersion("3.0.15");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Ztd2FyZS92cmE3IiwidmVyc2lvbiI6IjMuMC4xNSJ9fQ=="), c => c.charCodeAt(0)));
