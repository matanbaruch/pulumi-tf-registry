...
export class ComputeInstance extends pulumi.CustomResource {
    ...
    /**
     * A list of exoscale.BlockStorageVolume (ID) to attach to the instance.
     */
    ...
    /**
     * Mark the instance as protected, the Exoscale API will refuse to delete the instance until the protection is removed
     * (boolean; default: `false`).
     */
    public readonly destroyProtected!: pulumi.Output<boolean | undefined>;
    /**
     * The instance disk size (GiB; at least `10`). Can not be decreased after creation. **WARNING**: updating this attribute
     * stops/restarts the instance.
     */
