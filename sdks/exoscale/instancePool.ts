...
export class InstancePool extends pulumi.CustomResource {
     ...
     */
    public readonly instances!: pulumi.Output<outputs.InstancePoolInstance[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.InstancePoolTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstancePoolArgs | InstancePoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstancePool.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InstancePoolState {
    ...
    timeouts?: pulumi.Input<inputs.InstancePoolTimeouts>;
    /**
     * [cloud-init](http://cloudinit.readthedocs.io/) configuration to apply to the managed instances.
     */
