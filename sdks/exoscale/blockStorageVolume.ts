...
export class BlockStorageVolume extends pulumi.CustomResource {
    ...
    /**
     * Volume size in GB (default 10). If volume is attached, instance must be stopped to update this value. Volume can only
     * grow, cannot be shrunk.
     */
    ...
    constructor(name: string, argsOrState?: BlockStorageVolumeArgs | BlockStorageVolumeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BlockStorageVolume.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
