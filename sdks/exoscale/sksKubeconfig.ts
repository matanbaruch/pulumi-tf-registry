...
export class SksKubeconfig extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.SksKubeconfigTimeouts | undefined>;
    /**
     * ❗ The Time-to-Live of the Kubeconfig, after which it will expire / become invalid (seconds; default: 2592000 = 30
     * days).
     */
    public readonly ttlSeconds!: pulumi.Output<number | undefined>;
    /**
     * ❗ User name in the generated Kubeconfig. The certificate present in the Kubeconfig will also have this name set for
     * the CN field.
     */
    ...
    constructor(name: string, argsOrState?: SksKubeconfigArgs | SksKubeconfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SksKubeconfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SksKubeconfigState {
    ...
    timeouts?: pulumi.Input<inputs.SksKubeconfigTimeouts>;
    /**
     * ❗ The Time-to-Live of the Kubeconfig, after which it will expire / become invalid (seconds; default: 2592000 = 30
     * days).
     */
