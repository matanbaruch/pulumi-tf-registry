...
export class SecurityGroupRule extends pulumi.CustomResource {
    ...
    /**
     * ❗ An ICMP/ICMPv6 [type/code](https://en.wikipedia.org/wiki/Internet_Control_Message_Protocol#Control_messages) to
     * match.
     */
    ...
    /**
     * ❗ The parent security group name. Please use the `security_group_id` argument along the exoscale.SecurityGroup data
     * source instead.
     *
    ...
    public readonly timeouts!: pulumi.Output<outputs.SecurityGroupRuleTimeouts | undefined>;
    /**
     ...
     * exoscale.SecurityGroup data source instead.
     *
     * @deprecated Deprecated
     */
