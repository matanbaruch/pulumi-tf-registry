...
export class SksNodepool extends pulumi.CustomResource {
    ...
    /**
     * Create nodes with non-standard partitioning for persistent storage (requires min 100G of disk space) (may only be set at
     * creation time).
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.SksNodepoolTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SksNodepoolArgs | SksNodepoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SksNodepool.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SksNodepoolState {
    ...
    timeouts?: pulumi.Input<inputs.SksNodepoolTimeouts>;
    /**
     * The managed instances version.
     */
