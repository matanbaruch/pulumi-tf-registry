...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("exoscale");
			params.setVersion("0.60.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2V4b3NjYWxlL2V4b3NjYWxlIiwidmVyc2lvbiI6IjAuNjAuMCJ9fQ=="), c => c.charCodeAt(0)));
