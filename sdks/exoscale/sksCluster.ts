...
export class SksCluster extends pulumi.CustomResource {
    ...
    /**
     * The CNI plugin that is to be used. Available options are "calico" or "cilium". Defaults to "calico". Setting empty
     * string will result in a cluster with no CNI.
     */
    ...
    /**
     * Deploy the Exoscale [Container Storage Interface](https://github.com/exoscale/exoscale-csi-driver/) on worker nodes
     * (boolean; default: `false`; requires the CCM to be enabled).
     */
     ...
     * documented below.
     */
    public readonly oidc!: pulumi.Output<outputs.SksClusterOidc | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.SksClusterTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SksClusterArgs | SksClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SksCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SksClusterState {
    ...
    timeouts?: pulumi.Input<inputs.SksClusterTimeouts>;
    /**
     * The version of the control plane (default: latest version available from the API; see `exo compute sks versions` for
     * reference; may only be set at creation time).
     */
