...
export class NlbService extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.NlbServiceTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NlbServiceArgs | NlbServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NlbService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NlbServiceState {
    ...
    timeouts?: pulumi.Input<inputs.NlbServiceTimeouts>;
    /**
     * ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
     */
