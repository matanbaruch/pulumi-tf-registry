...
export class AntiAffinityGroup extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AntiAffinityGroupTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AntiAffinityGroupArgs | AntiAffinityGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AntiAffinityGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AntiAffinityGroupState {
    ...
    timeouts?: pulumi.Input<inputs.AntiAffinityGroupTimeouts>;
}
