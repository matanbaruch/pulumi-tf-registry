...
export class Segment extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly reportToken!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: SegmentArgs | SegmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["reportToken"] = state ? state.reportToken : undefined;
            ...
            resourceInputs["reportToken"] = undefined /*out*/;
...
export interface SegmentState {
     ...
     * Token of the report for this segment.
     */
    reportToken?: pulumi.Input<string>;
    /**
     * The title of the Segment.
     */
