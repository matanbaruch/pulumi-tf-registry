...
export class Dashboard extends pulumi.CustomResource {
    ...
    /**
     * Tokens of the saved filters used in the Dashboard.
     */
    public readonly savedFilterTokens!: pulumi.Output<string[] | undefined>;
    /**
     * The start date for the date range for CostReports in the Dashboard. ISO 8601 Formatted. Overwrites 'date_interval' if
     * set.
     */
    ...
    constructor(name: string, argsOrState?: DashboardArgs | DashboardState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.workspaceToken === undefined) && !opts.urn) {
                throw new Error("Missing required property 'workspaceToken'");
            }
