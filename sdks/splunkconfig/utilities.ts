...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("splunkconfig");
			params.setVersion("1.7.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NwbHVuay9zcGx1bmtjb25maWciLCJ2ZXJzaW9uIjoiMS43LjQifX0="), c => c.charCodeAt(0)));
