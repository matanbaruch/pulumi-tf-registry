...
export class File extends pulumi.CustomResource {
    ...
    /**
     * Boolean flag indicating whether symbolically linked directories should be excluded during the creation of the archive.
     * Defaults to `false`.
     */
    public readonly excludeSymlinkDirectories!: pulumi.Output<boolean | undefined>;
    /**
     * Specify files/directories to ignore when reading the `source_dir`. Supports glob file matching patterns including
     * doublestar/globstar (`**`) patterns.
     */
    ...
    /**
     * String that specifies the octal file mode for all archived files. For example: `"0666"`. Setting this will ensure that
     * cross platform usage of this module will not vary the modes of archived files (and ultimately checksums) resulting in
    ...
    /**
     * Add only this content to the archive with `source_content_filename` as the filename. One and only one of `source`,
    ...
    /**
     * Set this as the filename when using `source_content`. One and only one of `source`, `source_content_filename` (with
     * `source_content`), `source_file`, or `source_dir` must be specified.
     */
    public readonly sourceContentFilename!: pulumi.Output<string | undefined>;
    /**
     * Package entire contents of this directory into the archive. One and only one of `source`, `source_content_filename`
     * (with `source_content`), `source_file`, or `source_dir` must be specified.
     */
    public readonly sourceDir!: pulumi.Output<string | undefined>;
    /**
     * Package this file into the archive. One and only one of `source`, `source_content_filename` (with `source_content`),
     * `source_file`, or `source_dir` must be specified.
     */
    public readonly sourceFile!: pulumi.Output<string | undefined>;
    /**
     * Specifies attributes of a single source file to include into the archive. One and only one of `source`,
     * `source_content_filename` (with `source_content`), `source_file`, or `source_dir` must be specified.
     */
