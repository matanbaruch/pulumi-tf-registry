...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("skytap");
			params.setVersion("0.15.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NreXRhcC9za3l0YXAiLCJ2ZXJzaW9uIjoiMC4xNS4xIn19"), c => c.charCodeAt(0)));
