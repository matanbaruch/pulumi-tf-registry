...
export class CommitRulestack extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CommitRulestackTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CommitRulestackArgs | CommitRulestackState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CommitRulestack.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CommitRulestackState {
    ...
    timeouts?: pulumi.Input<inputs.CommitRulestackTimeouts>;
    /**
     * Validation error messages.
     */
