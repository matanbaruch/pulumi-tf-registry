...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudngfwaws");
			params.setVersion("2.0.20");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BhbG9hbHRvbmV0d29ya3MvY2xvdWRuZ2Z3YXdzIiwidmVyc2lvbiI6IjIuMC4yMCJ9fQ=="), c => c.charCodeAt(0)));
