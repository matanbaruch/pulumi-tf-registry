...
export class AccountOnboardingStack extends pulumi.CustomResource {
    ...
    /**
     * The CloudNGFW can decrypt inbound and outbound traffic by providing a certificate stored in secret Manager. The role
     * allows the service to access a certificate configured in the rulestack. Only certificated tagged with PaloAltoCloudNGFW
     * can be accessed
     */
    ...
    constructor(name: string, argsOrState?: AccountOnboardingStackArgs | AccountOnboardingStackState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AccountOnboardingStack.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
