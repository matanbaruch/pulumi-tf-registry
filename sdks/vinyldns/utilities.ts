...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("vinyldns");
			params.setVersion("0.10.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3ZpbnlsZG5zL3ZpbnlsZG5zIiwidmVyc2lvbiI6IjAuMTAuMyJ9fQ=="), c => c.charCodeAt(0)));
