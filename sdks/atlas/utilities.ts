...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("atlas");
			params.setVersion("0.8.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FyaWdhL2F0bGFzIiwidmVyc2lvbiI6IjAuOC40In19"), c => c.charCodeAt(0)));
