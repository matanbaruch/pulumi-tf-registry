...
export class ElasticsearchIndexLifecycle extends pulumi.CustomResource {
    ...
    /**
     * The index is no longer being updated and is queried infrequently. The information still needs to be searchable, but
     * it’s okay if those queries are slower.
     */
    ...
    /**
     * The index is no longer being updated and is queried rarely. The information still needs to be searchable, but it’s
     * okay if those queries are extremely slow.
     */
    ...
    constructor(name: string, argsOrState?: ElasticsearchIndexLifecycleArgs | ElasticsearchIndexLifecycleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ElasticsearchIndexLifecycle.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
