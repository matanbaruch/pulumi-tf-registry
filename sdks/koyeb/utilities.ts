...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("koyeb");
			params.setVersion("0.1.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tveWViL2tveWViIiwidmVyc2lvbiI6IjAuMS42In19"), c => c.charCodeAt(0)));
