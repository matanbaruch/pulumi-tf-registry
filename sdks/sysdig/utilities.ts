...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("sysdig");
			params.setVersion("1.34.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3N5c2RpZ2xhYnMvc3lzZGlnIiwidmVyc2lvbiI6IjEuMzQuMCJ9fQ=="), c => c.charCodeAt(0)));
