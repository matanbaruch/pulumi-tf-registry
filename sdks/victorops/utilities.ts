...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("victorops");
			params.setVersion("0.1.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NwbHVuay92aWN0b3JvcHMiLCJ2ZXJzaW9uIjoiMC4xLjQifX0="), c => c.charCodeAt(0)));
