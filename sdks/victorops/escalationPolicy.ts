...
export class EscalationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'victorops:index/escalationPolicy:EscalationPolicy';
    ...
    public readonly ignoreCustomPagingPolicies!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: EscalationPolicyArgs | EscalationPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ignoreCustomPagingPolicies"] = state ? state.ignoreCustomPagingPolicies : undefined;
            ...
            resourceInputs["ignoreCustomPagingPolicies"] = args ? args.ignoreCustomPagingPolicies : undefined;
...
export interface EscalationPolicyState {
    ignoreCustomPagingPolicies?: pulumi.Input<boolean>;
