...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("jetstream");
			params.setVersion("0.1.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL25hdHMtaW8vamV0c3RyZWFtIiwidmVyc2lvbiI6IjAuMS4xIn19"), c => c.charCodeAt(0)));
