...
export class DomainRecord extends pulumi.CustomResource {
     ...
     * records, this is the subdomain being associated with an IP address. Generated for SRV records.
     */
    ...
    /**
     * The type of Record this is in the DNS system. For example, A records associate a domain name with an IPv4 address, and
     ...
     * servers. Valid values are 30, 120, 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and
