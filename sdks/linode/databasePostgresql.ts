...
export class DatabasePostgresql extends pulumi.CustomResource {
    ...
    /**
     * The synchronization level of the replicating server.Must be `local` or `off` for the `asynch` replication type. Must be
    ...
    /**
     * The replication method used for the Managed Database. Must be `none` for a single node cluster. Must be `asynch` or
    ...
    public readonly timeouts!: pulumi.Output<outputs.DatabasePostgresqlTimeouts | undefined>;
    /**
     ...
     */
    public readonly updates!: pulumi.Output<outputs.DatabasePostgresqlUpdates | undefined>;
    /**
...
export interface DatabasePostgresqlState {
    ...
    timeouts?: pulumi.Input<inputs.DatabasePostgresqlTimeouts>;
    /**
     * The Linode Instance type used by the Managed Database for its nodes.
     */
