...
export class Domain extends pulumi.CustomResource {
    ...
    /**
     * The list of IPs that may perform a zone transfer for this Domain. This is potentially dangerous, and should be set to an
    ...
    /**
     * The domain this Domain represents. These must be unique in our system; you cannot have two Domains representing the same
     * domain.
     */
    public readonly domain!: pulumi.Output<string>;
    /**
     * The amount of time in seconds that may pass before this Domain is no longer Valid values are 0, 30, 120, 300, 3600,
     * 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the
     * nearest valid value.
     */
    ...
    /**
     * The amount of time in seconds before this Domain should be refreshed. Valid values are 0, 30, 120, 300, 3600, 7200,
     * 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200 - any other value will be rounded to the
     * nearest valid value.
     */
     ...
     * servers. Valid values are 0, 30, 120, 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and
     * 2419200 - any other value will be rounded to the nearest valid value.
     */
    public readonly ttlSec!: pulumi.Output<number | undefined>;
    /**
     * If this Domain represents the authoritative source of information for the domain it describes, or if it is a read-only
