...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("seeweb");
			params.setVersion("0.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NlZXdlYi9zZWV3ZWIiLCJ2ZXJzaW9uIjoiMC4xLjAifX0="), c => c.charCodeAt(0)));
