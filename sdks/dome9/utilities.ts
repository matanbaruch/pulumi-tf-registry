...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("dome9");
			params.setVersion("1.35.8");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RvbWU5L2RvbWU5IiwidmVyc2lvbiI6IjEuMzUuOCJ9fQ=="), c => c.charCodeAt(0)));
