...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ncloud");
			params.setVersion("3.1.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL25hdmVyY2xvdWRwbGF0Zm9ybS9uY2xvdWQiLCJ2ZXJzaW9uIjoiMy4xLjEifX0="), c => c.charCodeAt(0)));
