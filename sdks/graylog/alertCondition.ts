...
export class AlertCondition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'graylog:index/alertCondition:AlertCondition';
    ...
    public readonly alertConditionId!: pulumi.Output<string>;
    public readonly inGrace!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: AlertConditionArgs | AlertConditionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["alertConditionId"] = state ? state.alertConditionId : undefined;
            resourceInputs["inGrace"] = state ? state.inGrace : undefined;
            ...
            resourceInputs["alertConditionId"] = args ? args.alertConditionId : undefined;
            resourceInputs["inGrace"] = args ? args.inGrace : undefined;
...
export interface AlertConditionState {
    alertConditionId?: pulumi.Input<string>;
    inGrace?: pulumi.Input<boolean>;
