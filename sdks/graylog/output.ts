...
export class Output extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'graylog:index/output:Output';
    ...
    constructor(name: string, argsOrState?: OutputArgs | OutputState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Output.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
