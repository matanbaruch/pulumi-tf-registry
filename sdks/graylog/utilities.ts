...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("graylog");
			params.setVersion("1.0.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3RlcnJhZm9ybS1wcm92aWRlci1ncmF5bG9nL2dyYXlsb2ciLCJ2ZXJzaW9uIjoiMS4wLjQifX0="), c => c.charCodeAt(0)));
