...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pypi");
			params.setVersion("0.0.12");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2plZmZ3ZWNhbi9weXBpIiwidmVyc2lvbiI6IjAuMC4xMiJ9fQ=="), c => c.charCodeAt(0)));
