...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("limelight");
			params.setVersion("1.0.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2xsbncvbGltZWxpZ2h0IiwidmVyc2lvbiI6IjEuMC4zIn19"), c => c.charCodeAt(0)));
