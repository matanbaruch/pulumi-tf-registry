...
export class RdsClusterInstance extends pulumi.CustomResource {
    /**
     * Get an existing RdsClusterInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RdsClusterInstanceState, opts?: pulumi.CustomResourceOptions): RdsClusterInstance {
        return new RdsClusterInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/rdsClusterInstance:RdsClusterInstance';

    /**
     * Returns true if the given object is an instance of RdsClusterInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RdsClusterInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RdsClusterInstance.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.RdsClusterInstanceTimeouts | undefined>;
    public /*out*/ readonly writer!: pulumi.Output<boolean>;

    /**
     * Create a RdsClusterInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RdsClusterInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RdsClusterInstanceArgs | RdsClusterInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RdsClusterInstanceState | undefined;
            ...
            const args = argsOrState as RdsClusterInstanceArgs | undefined;
        ...
        super(RdsClusterInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RdsClusterInstance resources.
 */
export interface RdsClusterInstanceState {
    ...
    timeouts?: pulumi.Input<inputs.RdsClusterInstanceTimeouts>;
    writer?: pulumi.Input<boolean>;
}

/**
 * The set of arguments for constructing a RdsClusterInstance resource.
 */
export interface RdsClusterInstanceArgs {
    applyImmediately?: pulumi.Input<boolean>;
    autoMinorVersionUpgrade?: pulumi.Input<boolean>;
    availabilityZone?: pulumi.Input<string>;
    caCertIdentifier?: pulumi.Input<string>;
