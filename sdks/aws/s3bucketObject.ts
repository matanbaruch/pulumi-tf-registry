...
export class S3BucketObject extends pulumi.CustomResource {
    /**
     * Get an existing S3BucketObject resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: S3BucketObjectState, opts?: pulumi.CustomResourceOptions): S3BucketObject {
        return new S3BucketObject(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/s3BucketObject:S3BucketObject';

    /**
     * Returns true if the given object is an instance of S3BucketObject.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is S3BucketObject {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === S3BucketObject.__pulumiType;
    }
    ...
    /**
     * Create a S3BucketObject resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: S3BucketObjectArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: S3BucketObjectArgs | S3BucketObjectState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as S3BucketObjectState | undefined;
            ...
            const args = argsOrState as S3BucketObjectArgs | undefined;
        ...
        super(S3BucketObject.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering S3BucketObject resources.
 */
export interface S3BucketObjectState {
...
/**
 * The set of arguments for constructing a S3BucketObject resource.
 */
export interface S3BucketObjectArgs {
    acl?: pulumi.Input<string>;
    /**
     * @deprecated Deprecated
     */
