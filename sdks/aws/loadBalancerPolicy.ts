...
export class LoadBalancerPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/loadBalancerPolicy:LoadBalancerPolicy';
    ...
    public readonly policyAttributes!: pulumi.Output<outputs.LoadBalancerPolicyPolicyAttribute[] | undefined>;
