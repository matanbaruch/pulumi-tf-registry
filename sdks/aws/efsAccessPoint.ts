...
export class EfsAccessPoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/efsAccessPoint:EfsAccessPoint';
    ...
    public readonly posixUser!: pulumi.Output<outputs.EfsAccessPointPosixUser | undefined>;
    public readonly rootDirectory!: pulumi.Output<outputs.EfsAccessPointRootDirectory | undefined>;
