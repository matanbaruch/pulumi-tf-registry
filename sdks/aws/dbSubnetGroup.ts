...
export class DbSubnetGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbSubnetGroupState, opts?: pulumi.CustomResourceOptions): DbSubnetGroup {
        return new DbSubnetGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dbSubnetGroup:DbSubnetGroup';
    ...
    constructor(name: string, argsOrState?: DbSubnetGroupArgs | DbSubnetGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DbSubnetGroupState | undefined;
        ...
        super(DbSubnetGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface DbSubnetGroupState {
