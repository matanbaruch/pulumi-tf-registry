...
export class Apigatewayv2Route extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/apigatewayv2Route:Apigatewayv2Route';
    ...
    public readonly requestParameters!: pulumi.Output<outputs.Apigatewayv2RouteRequestParameter[] | undefined>;
...
export interface Apigatewayv2RouteState {
    ...
    requestParameters?: pulumi.Input<pulumi.Input<inputs.Apigatewayv2RouteRequestParameter>[]>;
