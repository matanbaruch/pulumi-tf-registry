...
export class Ami extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/ami:Ami';
    ...
    public readonly ebsBlockDevices!: pulumi.Output<outputs.AmiEbsBlockDevice[] | undefined>;
    public readonly enaSupport!: pulumi.Output<boolean | undefined>;
    public readonly ephemeralBlockDevices!: pulumi.Output<outputs.AmiEphemeralBlockDevice[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.AmiTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AmiArgs | AmiState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Ami.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AmiState {
    ...
    ebsBlockDevices?: pulumi.Input<pulumi.Input<inputs.AmiEbsBlockDevice>[]>;
    enaSupport?: pulumi.Input<boolean>;
    ephemeralBlockDevices?: pulumi.Input<pulumi.Input<inputs.AmiEphemeralBlockDevice>[]>;
    ...
    timeouts?: pulumi.Input<inputs.AmiTimeouts>;
