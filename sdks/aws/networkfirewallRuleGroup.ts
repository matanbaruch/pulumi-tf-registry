...
export class NetworkfirewallRuleGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkfirewallRuleGroup:NetworkfirewallRuleGroup';
    ...
    public readonly encryptionConfiguration!: pulumi.Output<outputs.NetworkfirewallRuleGroupEncryptionConfiguration | undefined>;
    public readonly name!: pulumi.Output<string>;
    public readonly ruleGroup!: pulumi.Output<outputs.NetworkfirewallRuleGroupRuleGroup | undefined>;
...
export interface NetworkfirewallRuleGroupState {
    ...
    encryptionConfiguration?: pulumi.Input<inputs.NetworkfirewallRuleGroupEncryptionConfiguration>;
