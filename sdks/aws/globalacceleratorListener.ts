...
export class GlobalacceleratorListener extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/globalacceleratorListener:GlobalacceleratorListener';
    ...
    public readonly timeouts!: pulumi.Output<outputs.GlobalacceleratorListenerTimeouts | undefined>;
...
export interface GlobalacceleratorListenerState {
    ...
    timeouts?: pulumi.Input<inputs.GlobalacceleratorListenerTimeouts>;
}
