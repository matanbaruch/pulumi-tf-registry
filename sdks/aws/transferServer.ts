...
export class TransferServer extends pulumi.CustomResource {
    /**
     * Get an existing TransferServer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransferServerState, opts?: pulumi.CustomResourceOptions): TransferServer {
        return new TransferServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/transferServer:TransferServer';

    /**
     * Returns true if the given object is an instance of TransferServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransferServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransferServer.__pulumiType;
    }
    ...
    public readonly endpointDetails!: pulumi.Output<outputs.TransferServerEndpointDetails | undefined>;
    ...
    public readonly protocolDetails!: pulumi.Output<outputs.TransferServerProtocolDetails | undefined>;
    public readonly protocols!: pulumi.Output<string[]>;
    public readonly s3StorageOptions!: pulumi.Output<outputs.TransferServerS3StorageOptions | undefined>;
    ...
    public readonly workflowDetails!: pulumi.Output<outputs.TransferServerWorkflowDetails | undefined>;

    /**
     * Create a TransferServer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: TransferServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransferServerArgs | TransferServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TransferServerState | undefined;
            ...
            const args = argsOrState as TransferServerArgs | undefined;
        ...
        super(TransferServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TransferServer resources.
 */
export interface TransferServerState {
    ...
    endpointDetails?: pulumi.Input<inputs.TransferServerEndpointDetails>;
    ...
    protocolDetails?: pulumi.Input<inputs.TransferServerProtocolDetails>;
    protocols?: pulumi.Input<pulumi.Input<string>[]>;
    s3StorageOptions?: pulumi.Input<inputs.TransferServerS3StorageOptions>;
    ...
    workflowDetails?: pulumi.Input<inputs.TransferServerWorkflowDetails>;
}

/**
 * The set of arguments for constructing a TransferServer resource.
 */
export interface TransferServerArgs {
    certificate?: pulumi.Input<string>;
    directoryId?: pulumi.Input<string>;
    domain?: pulumi.Input<string>;
    endpointDetails?: pulumi.Input<inputs.TransferServerEndpointDetails>;
