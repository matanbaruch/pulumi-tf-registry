...
export class OpsworksStaticWebLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksStaticWebLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksStaticWebLayerState, opts?: pulumi.CustomResourceOptions): OpsworksStaticWebLayer {
        return new OpsworksStaticWebLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksStaticWebLayer:OpsworksStaticWebLayer';

    /**
     * Returns true if the given object is an instance of OpsworksStaticWebLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksStaticWebLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksStaticWebLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksStaticWebLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksStaticWebLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksStaticWebLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksStaticWebLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksStaticWebLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksStaticWebLayerArgs | OpsworksStaticWebLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksStaticWebLayerState | undefined;
            ...
            const args = argsOrState as OpsworksStaticWebLayerArgs | undefined;
        ...
        super(OpsworksStaticWebLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksStaticWebLayer resources.
 */
export interface OpsworksStaticWebLayerState {
    arn?: pulumi.Input<string>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksStaticWebLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksStaticWebLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksStaticWebLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksStaticWebLayer resource.
 */
export interface OpsworksStaticWebLayerArgs {
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksStaticWebLayerCloudwatchConfiguration>;
