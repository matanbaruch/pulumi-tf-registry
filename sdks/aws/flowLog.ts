...
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/flowLog:FlowLog';
    ...
    public readonly destinationOptions!: pulumi.Output<outputs.FlowLogDestinationOptions | undefined>;
    ...
    constructor(name: string, argsOrState?: FlowLogArgs | FlowLogState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FlowLog.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FlowLogState {
    ...
    destinationOptions?: pulumi.Input<inputs.FlowLogDestinationOptions>;
