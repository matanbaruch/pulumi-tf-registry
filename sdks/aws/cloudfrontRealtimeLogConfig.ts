...
export class CloudfrontRealtimeLogConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/cloudfrontRealtimeLogConfig:CloudfrontRealtimeLogConfig';
    ...
    public readonly endpoint!: pulumi.Output<outputs.CloudfrontRealtimeLogConfigEndpoint>;
...
export interface CloudfrontRealtimeLogConfigState {
    ...
    endpoint?: pulumi.Input<inputs.CloudfrontRealtimeLogConfigEndpoint>;
