...
export class VpnGatewayAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpnGatewayAttachment:VpnGatewayAttachment';
    ...
    constructor(name: string, argsOrState?: VpnGatewayAttachmentArgs | VpnGatewayAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpnGatewayAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
