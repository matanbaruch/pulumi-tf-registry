...
export class ElasticBeanstalkApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/elasticBeanstalkApplication:ElasticBeanstalkApplication';
    ...
    public readonly appversionLifecycle!: pulumi.Output<outputs.ElasticBeanstalkApplicationAppversionLifecycle | undefined>;
...
export interface ElasticBeanstalkApplicationState {
    appversionLifecycle?: pulumi.Input<inputs.ElasticBeanstalkApplicationAppversionLifecycle>;
