...
export class DocdbClusterSnapshot extends pulumi.CustomResource {
    /**
     * Get an existing DocdbClusterSnapshot resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DocdbClusterSnapshotState, opts?: pulumi.CustomResourceOptions): DocdbClusterSnapshot {
        return new DocdbClusterSnapshot(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/docdbClusterSnapshot:DocdbClusterSnapshot';

    /**
     * Returns true if the given object is an instance of DocdbClusterSnapshot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DocdbClusterSnapshot {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DocdbClusterSnapshot.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DocdbClusterSnapshotTimeouts | undefined>;
    public /*out*/ readonly vpcId!: pulumi.Output<string>;

    /**
     * Create a DocdbClusterSnapshot resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DocdbClusterSnapshotArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DocdbClusterSnapshotArgs | DocdbClusterSnapshotState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DocdbClusterSnapshotState | undefined;
            ...
            const args = argsOrState as DocdbClusterSnapshotArgs | undefined;
        ...
        super(DocdbClusterSnapshot.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DocdbClusterSnapshot resources.
 */
export interface DocdbClusterSnapshotState {
    ...
    timeouts?: pulumi.Input<inputs.DocdbClusterSnapshotTimeouts>;
    vpcId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a DocdbClusterSnapshot resource.
 */
export interface DocdbClusterSnapshotArgs {
    dbClusterIdentifier: pulumi.Input<string>;
    dbClusterSnapshotIdentifier: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.DocdbClusterSnapshotTimeouts>;
}
