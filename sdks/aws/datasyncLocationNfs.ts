...
export class DatasyncLocationNfs extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/datasyncLocationNfs:DatasyncLocationNfs';
    ...
    public readonly mountOptions!: pulumi.Output<outputs.DatasyncLocationNfsMountOptions | undefined>;
