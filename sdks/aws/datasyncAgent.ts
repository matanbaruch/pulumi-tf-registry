...
export class DatasyncAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/datasyncAgent:DatasyncAgent';
    ...
    public readonly timeouts!: pulumi.Output<outputs.DatasyncAgentTimeouts | undefined>;
...
export interface DatasyncAgentState {
    ...
    timeouts?: pulumi.Input<inputs.DatasyncAgentTimeouts>;
