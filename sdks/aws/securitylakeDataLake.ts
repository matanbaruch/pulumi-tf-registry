...
export class SecuritylakeDataLake extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/securitylakeDataLake:SecuritylakeDataLake';
    ...
    public readonly configurations!: pulumi.Output<outputs.SecuritylakeDataLakeConfiguration[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.SecuritylakeDataLakeTimeouts | undefined>;
...
export interface SecuritylakeDataLakeState {
    ...
    configurations?: pulumi.Input<pulumi.Input<inputs.SecuritylakeDataLakeConfiguration>[]>;
    metaStoreManagerRoleArn?: pulumi.Input<string>;
    s3BucketArn?: pulumi.Input<string>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    tagsAll?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.SecuritylakeDataLakeTimeouts>;
}
