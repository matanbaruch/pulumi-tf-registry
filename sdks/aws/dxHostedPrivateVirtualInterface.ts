...
export class DxHostedPrivateVirtualInterface extends pulumi.CustomResource {
    /**
     * Get an existing DxHostedPrivateVirtualInterface resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DxHostedPrivateVirtualInterfaceState, opts?: pulumi.CustomResourceOptions): DxHostedPrivateVirtualInterface {
        return new DxHostedPrivateVirtualInterface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dxHostedPrivateVirtualInterface:DxHostedPrivateVirtualInterface';

    /**
     * Returns true if the given object is an instance of DxHostedPrivateVirtualInterface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DxHostedPrivateVirtualInterface {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DxHostedPrivateVirtualInterface.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DxHostedPrivateVirtualInterfaceTimeouts | undefined>;
    public readonly vlan!: pulumi.Output<number>;

    /**
     * Create a DxHostedPrivateVirtualInterface resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DxHostedPrivateVirtualInterfaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DxHostedPrivateVirtualInterfaceArgs | DxHostedPrivateVirtualInterfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DxHostedPrivateVirtualInterfaceState | undefined;
            ...
            const args = argsOrState as DxHostedPrivateVirtualInterfaceArgs | undefined;
        ...
        super(DxHostedPrivateVirtualInterface.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DxHostedPrivateVirtualInterface resources.
 */
export interface DxHostedPrivateVirtualInterfaceState {
    ...
    timeouts?: pulumi.Input<inputs.DxHostedPrivateVirtualInterfaceTimeouts>;
    vlan?: pulumi.Input<number>;
}

/**
 * The set of arguments for constructing a DxHostedPrivateVirtualInterface resource.
 */
export interface DxHostedPrivateVirtualInterfaceArgs {
    addressFamily: pulumi.Input<string>;
    amazonAddress?: pulumi.Input<string>;
    bgpAsn: pulumi.Input<number>;
    bgpAuthKey?: pulumi.Input<string>;
