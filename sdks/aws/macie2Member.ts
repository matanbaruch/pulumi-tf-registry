...
export class Macie2Member extends pulumi.CustomResource {
    /**
     * Get an existing Macie2Member resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Macie2MemberState, opts?: pulumi.CustomResourceOptions): Macie2Member {
        return new Macie2Member(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/macie2Member:Macie2Member';

    /**
     * Returns true if the given object is an instance of Macie2Member.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Macie2Member {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Macie2Member.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.Macie2MemberTimeouts | undefined>;
    public /*out*/ readonly updatedAt!: pulumi.Output<string>;

    /**
     * Create a Macie2Member resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: Macie2MemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Macie2MemberArgs | Macie2MemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Macie2MemberState | undefined;
            ...
            const args = argsOrState as Macie2MemberArgs | undefined;
        ...
        super(Macie2Member.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Macie2Member resources.
 */
export interface Macie2MemberState {
    ...
    timeouts?: pulumi.Input<inputs.Macie2MemberTimeouts>;
    updatedAt?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a Macie2Member resource.
 */
export interface Macie2MemberArgs {
    accountId: pulumi.Input<string>;
    email: pulumi.Input<string>;
    invitationDisableEmailNotification?: pulumi.Input<boolean>;
    invitationMessage?: pulumi.Input<string>;
