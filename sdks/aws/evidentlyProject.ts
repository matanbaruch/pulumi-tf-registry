...
export class EvidentlyProject extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/evidentlyProject:EvidentlyProject';
    ...
    public readonly dataDelivery!: pulumi.Output<outputs.EvidentlyProjectDataDelivery | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.EvidentlyProjectTimeouts | undefined>;
...
export interface EvidentlyProjectState {
    ...
    timeouts?: pulumi.Input<inputs.EvidentlyProjectTimeouts>;
}
