...
export class OpsworksMysqlLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksMysqlLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksMysqlLayerState, opts?: pulumi.CustomResourceOptions): OpsworksMysqlLayer {
        return new OpsworksMysqlLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksMysqlLayer:OpsworksMysqlLayer';

    /**
     * Returns true if the given object is an instance of OpsworksMysqlLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksMysqlLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksMysqlLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksMysqlLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksMysqlLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksMysqlLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksMysqlLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksMysqlLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksMysqlLayerArgs | OpsworksMysqlLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksMysqlLayerState | undefined;
            ...
            const args = argsOrState as OpsworksMysqlLayerArgs | undefined;
        ...
        super(OpsworksMysqlLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksMysqlLayer resources.
 */
export interface OpsworksMysqlLayerState {
    arn?: pulumi.Input<string>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksMysqlLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksMysqlLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksMysqlLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksMysqlLayer resource.
 */
export interface OpsworksMysqlLayerArgs {
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksMysqlLayerCloudwatchConfiguration>;
