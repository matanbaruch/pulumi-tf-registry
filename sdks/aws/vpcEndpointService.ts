...
export class VpcEndpointService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcEndpointService:VpcEndpointService';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpcEndpointServiceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VpcEndpointServiceArgs | VpcEndpointServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcEndpointService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcEndpointServiceState {
    ...
    timeouts?: pulumi.Input<inputs.VpcEndpointServiceTimeouts>;
}
