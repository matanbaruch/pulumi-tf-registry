...
export class NetworkAclAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkAclAssociation:NetworkAclAssociation';
    ...
    constructor(name: string, argsOrState?: NetworkAclAssociationArgs | NetworkAclAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkAclAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
