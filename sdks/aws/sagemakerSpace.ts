...
export class SagemakerSpace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/sagemakerSpace:SagemakerSpace';
    ...
    public readonly ownershipSettings!: pulumi.Output<outputs.SagemakerSpaceOwnershipSettings | undefined>;
    public readonly spaceDisplayName!: pulumi.Output<string | undefined>;
    public readonly spaceName!: pulumi.Output<string>;
    public readonly spaceSettings!: pulumi.Output<outputs.SagemakerSpaceSpaceSettings | undefined>;
    public readonly spaceSharingSettings!: pulumi.Output<outputs.SagemakerSpaceSpaceSharingSettings | undefined>;
