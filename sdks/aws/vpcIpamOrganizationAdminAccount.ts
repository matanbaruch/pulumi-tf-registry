...
export class VpcIpamOrganizationAdminAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcIpamOrganizationAdminAccount:VpcIpamOrganizationAdminAccount';
    ...
    constructor(name: string, argsOrState?: VpcIpamOrganizationAdminAccountArgs | VpcIpamOrganizationAdminAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcIpamOrganizationAdminAccount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
