...
export class VpcNetworkPerformanceMetricSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcNetworkPerformanceMetricSubscription:VpcNetworkPerformanceMetricSubscription';
    ...
    constructor(name: string, argsOrState?: VpcNetworkPerformanceMetricSubscriptionArgs | VpcNetworkPerformanceMetricSubscriptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcNetworkPerformanceMetricSubscription.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
