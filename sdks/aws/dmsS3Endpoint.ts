...
export class DmsS3Endpoint extends pulumi.CustomResource {
    /**
     * Get an existing DmsS3Endpoint resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DmsS3EndpointState, opts?: pulumi.CustomResourceOptions): DmsS3Endpoint {
        return new DmsS3Endpoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dmsS3Endpoint:DmsS3Endpoint';

    /**
     * Returns true if the given object is an instance of DmsS3Endpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DmsS3Endpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DmsS3Endpoint.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DmsS3EndpointTimeouts | undefined>;
    ...
    /**
     * Create a DmsS3Endpoint resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DmsS3EndpointArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DmsS3EndpointArgs | DmsS3EndpointState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DmsS3EndpointState | undefined;
            ...
            const args = argsOrState as DmsS3EndpointArgs | undefined;
        ...
        super(DmsS3Endpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DmsS3Endpoint resources.
 */
export interface DmsS3EndpointState {
    ...
    timeouts?: pulumi.Input<inputs.DmsS3EndpointTimeouts>;
...
/**
 * The set of arguments for constructing a DmsS3Endpoint resource.
 */
export interface DmsS3EndpointArgs {
    addColumnName?: pulumi.Input<boolean>;
    addTrailingPaddingCharacter?: pulumi.Input<boolean>;
    bucketFolder?: pulumi.Input<string>;
    bucketName: pulumi.Input<string>;
