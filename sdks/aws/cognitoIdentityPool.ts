...
export class CognitoIdentityPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/cognitoIdentityPool:CognitoIdentityPool';
    ...
    public readonly cognitoIdentityProviders!: pulumi.Output<outputs.CognitoIdentityPoolCognitoIdentityProvider[] | undefined>;
