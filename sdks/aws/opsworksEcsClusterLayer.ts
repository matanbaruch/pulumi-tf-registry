...
export class OpsworksEcsClusterLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksEcsClusterLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksEcsClusterLayerState, opts?: pulumi.CustomResourceOptions): OpsworksEcsClusterLayer {
        return new OpsworksEcsClusterLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksEcsClusterLayer:OpsworksEcsClusterLayer';

    /**
     * Returns true if the given object is an instance of OpsworksEcsClusterLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksEcsClusterLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksEcsClusterLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksEcsClusterLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksEcsClusterLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksEcsClusterLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksEcsClusterLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksEcsClusterLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksEcsClusterLayerArgs | OpsworksEcsClusterLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksEcsClusterLayerState | undefined;
            ...
            const args = argsOrState as OpsworksEcsClusterLayerArgs | undefined;
        ...
        super(OpsworksEcsClusterLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksEcsClusterLayer resources.
 */
export interface OpsworksEcsClusterLayerState {
    arn?: pulumi.Input<string>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksEcsClusterLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksEcsClusterLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksEcsClusterLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksEcsClusterLayer resource.
 */
export interface OpsworksEcsClusterLayerArgs {
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksEcsClusterLayerCloudwatchConfiguration>;
