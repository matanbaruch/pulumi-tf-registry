...
export class VpcIpamPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcIpamPool:VpcIpamPool';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpcIpamPoolTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VpcIpamPoolArgs | VpcIpamPoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcIpamPool.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcIpamPoolState {
    ...
    timeouts?: pulumi.Input<inputs.VpcIpamPoolTimeouts>;
}
