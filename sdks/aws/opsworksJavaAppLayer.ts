...
export class OpsworksJavaAppLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksJavaAppLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksJavaAppLayerState, opts?: pulumi.CustomResourceOptions): OpsworksJavaAppLayer {
        return new OpsworksJavaAppLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksJavaAppLayer:OpsworksJavaAppLayer';

    /**
     * Returns true if the given object is an instance of OpsworksJavaAppLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksJavaAppLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksJavaAppLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksJavaAppLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksJavaAppLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksJavaAppLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksJavaAppLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksJavaAppLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksJavaAppLayerArgs | OpsworksJavaAppLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksJavaAppLayerState | undefined;
            ...
            const args = argsOrState as OpsworksJavaAppLayerArgs | undefined;
        ...
        super(OpsworksJavaAppLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksJavaAppLayer resources.
 */
export interface OpsworksJavaAppLayerState {
    ...
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksJavaAppLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksJavaAppLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksJavaAppLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksJavaAppLayer resource.
 */
export interface OpsworksJavaAppLayerArgs {
    appServer?: pulumi.Input<string>;
    appServerVersion?: pulumi.Input<string>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
