...
export class ElasticBeanstalkConfigurationTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/elasticBeanstalkConfigurationTemplate:ElasticBeanstalkConfigurationTemplate';
    ...
    public readonly settings!: pulumi.Output<outputs.ElasticBeanstalkConfigurationTemplateSetting[] | undefined>;
...
export interface ElasticBeanstalkConfigurationTemplateState {
    ...
    settings?: pulumi.Input<pulumi.Input<inputs.ElasticBeanstalkConfigurationTemplateSetting>[]>;
