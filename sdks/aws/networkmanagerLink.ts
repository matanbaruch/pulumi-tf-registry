...
export class NetworkmanagerLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkmanagerLink:NetworkmanagerLink';
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkmanagerLinkTimeouts | undefined>;
...
export interface NetworkmanagerLinkState {
    ...
    timeouts?: pulumi.Input<inputs.NetworkmanagerLinkTimeouts>;
