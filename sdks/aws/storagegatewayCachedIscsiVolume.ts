...
export class StoragegatewayCachedIscsiVolume extends pulumi.CustomResource {
    /**
     * Get an existing StoragegatewayCachedIscsiVolume resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StoragegatewayCachedIscsiVolumeState, opts?: pulumi.CustomResourceOptions): StoragegatewayCachedIscsiVolume {
        return new StoragegatewayCachedIscsiVolume(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/storagegatewayCachedIscsiVolume:StoragegatewayCachedIscsiVolume';

    /**
     * Returns true if the given object is an instance of StoragegatewayCachedIscsiVolume.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StoragegatewayCachedIscsiVolume {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StoragegatewayCachedIscsiVolume.__pulumiType;
    }
    ...
    /**
     * Create a StoragegatewayCachedIscsiVolume resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: StoragegatewayCachedIscsiVolumeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: StoragegatewayCachedIscsiVolumeArgs | StoragegatewayCachedIscsiVolumeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StoragegatewayCachedIscsiVolumeState | undefined;
            ...
            const args = argsOrState as StoragegatewayCachedIscsiVolumeArgs | undefined;
        ...
        super(StoragegatewayCachedIscsiVolume.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering StoragegatewayCachedIscsiVolume resources.
 */
export interface StoragegatewayCachedIscsiVolumeState {
...
/**
 * The set of arguments for constructing a StoragegatewayCachedIscsiVolume resource.
 */
export interface StoragegatewayCachedIscsiVolumeArgs {
    gatewayArn: pulumi.Input<string>;
    kmsEncrypted?: pulumi.Input<boolean>;
    kmsKey?: pulumi.Input<string>;
    networkInterfaceId: pulumi.Input<string>;
