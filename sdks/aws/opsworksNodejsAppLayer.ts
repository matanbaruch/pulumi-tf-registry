...
export class OpsworksNodejsAppLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksNodejsAppLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksNodejsAppLayerState, opts?: pulumi.CustomResourceOptions): OpsworksNodejsAppLayer {
        return new OpsworksNodejsAppLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksNodejsAppLayer:OpsworksNodejsAppLayer';

    /**
     * Returns true if the given object is an instance of OpsworksNodejsAppLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksNodejsAppLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksNodejsAppLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksNodejsAppLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksNodejsAppLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksNodejsAppLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksNodejsAppLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksNodejsAppLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksNodejsAppLayerArgs | OpsworksNodejsAppLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksNodejsAppLayerState | undefined;
            ...
            const args = argsOrState as OpsworksNodejsAppLayerArgs | undefined;
        ...
        super(OpsworksNodejsAppLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksNodejsAppLayer resources.
 */
export interface OpsworksNodejsAppLayerState {
    arn?: pulumi.Input<string>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksNodejsAppLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksNodejsAppLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksNodejsAppLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksNodejsAppLayer resource.
 */
export interface OpsworksNodejsAppLayerArgs {
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksNodejsAppLayerCloudwatchConfiguration>;
