...
export class VpcEndpointPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcEndpointPolicy:VpcEndpointPolicy';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpcEndpointPolicyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VpcEndpointPolicyArgs | VpcEndpointPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcEndpointPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcEndpointPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.VpcEndpointPolicyTimeouts>;
