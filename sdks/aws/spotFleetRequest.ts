...
export class SpotFleetRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/spotFleetRequest:SpotFleetRequest';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SpotFleetRequestTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SpotFleetRequestArgs | SpotFleetRequestState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpotFleetRequest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpotFleetRequestState {
    ...
    timeouts?: pulumi.Input<inputs.SpotFleetRequestTimeouts>;
