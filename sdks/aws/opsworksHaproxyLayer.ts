...
export class OpsworksHaproxyLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksHaproxyLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksHaproxyLayerState, opts?: pulumi.CustomResourceOptions): OpsworksHaproxyLayer {
        return new OpsworksHaproxyLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksHaproxyLayer:OpsworksHaproxyLayer';

    /**
     * Returns true if the given object is an instance of OpsworksHaproxyLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksHaproxyLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksHaproxyLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksHaproxyLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksHaproxyLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksHaproxyLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksHaproxyLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksHaproxyLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksHaproxyLayerArgs | OpsworksHaproxyLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksHaproxyLayerState | undefined;
            ...
            const args = argsOrState as OpsworksHaproxyLayerArgs | undefined;
        ...
        super(OpsworksHaproxyLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksHaproxyLayer resources.
 */
export interface OpsworksHaproxyLayerState {
    arn?: pulumi.Input<string>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksHaproxyLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksHaproxyLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksHaproxyLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksHaproxyLayer resource.
 */
export interface OpsworksHaproxyLayerArgs {
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksHaproxyLayerCloudwatchConfiguration>;
