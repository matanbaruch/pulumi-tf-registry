...
export class MainRouteTableAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/mainRouteTableAssociation:MainRouteTableAssociation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.MainRouteTableAssociationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: MainRouteTableAssociationArgs | MainRouteTableAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MainRouteTableAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MainRouteTableAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.MainRouteTableAssociationTimeouts>;
