...
export class DbClusterSnapshot extends pulumi.CustomResource {
    /**
     * Get an existing DbClusterSnapshot resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbClusterSnapshotState, opts?: pulumi.CustomResourceOptions): DbClusterSnapshot {
        return new DbClusterSnapshot(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dbClusterSnapshot:DbClusterSnapshot';

    /**
     * Returns true if the given object is an instance of DbClusterSnapshot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DbClusterSnapshot {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DbClusterSnapshot.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DbClusterSnapshotTimeouts | undefined>;
    public /*out*/ readonly vpcId!: pulumi.Output<string>;

    /**
     * Create a DbClusterSnapshot resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DbClusterSnapshotArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DbClusterSnapshotArgs | DbClusterSnapshotState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DbClusterSnapshotState | undefined;
            ...
            const args = argsOrState as DbClusterSnapshotArgs | undefined;
        ...
        super(DbClusterSnapshot.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DbClusterSnapshot resources.
 */
export interface DbClusterSnapshotState {
    ...
    timeouts?: pulumi.Input<inputs.DbClusterSnapshotTimeouts>;
    vpcId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a DbClusterSnapshot resource.
 */
export interface DbClusterSnapshotArgs {
    dbClusterIdentifier: pulumi.Input<string>;
    dbClusterSnapshotIdentifier: pulumi.Input<string>;
    sharedAccounts?: pulumi.Input<pulumi.Input<string>[]>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
