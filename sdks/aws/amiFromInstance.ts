...
export class AmiFromInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/amiFromInstance:AmiFromInstance';
    ...
    public readonly ebsBlockDevices!: pulumi.Output<outputs.AmiFromInstanceEbsBlockDevice[] | undefined>;
    public /*out*/ readonly enaSupport!: pulumi.Output<boolean>;
    public readonly ephemeralBlockDevices!: pulumi.Output<outputs.AmiFromInstanceEphemeralBlockDevice[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.AmiFromInstanceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AmiFromInstanceArgs | AmiFromInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AmiFromInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AmiFromInstanceState {
    ...
    ebsBlockDevices?: pulumi.Input<pulumi.Input<inputs.AmiFromInstanceEbsBlockDevice>[]>;
    enaSupport?: pulumi.Input<boolean>;
    ephemeralBlockDevices?: pulumi.Input<pulumi.Input<inputs.AmiFromInstanceEphemeralBlockDevice>[]>;
    ...
    timeouts?: pulumi.Input<inputs.AmiFromInstanceTimeouts>;
