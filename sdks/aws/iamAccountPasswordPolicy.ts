...
export class IamAccountPasswordPolicy extends pulumi.CustomResource {
    /**
     * Get an existing IamAccountPasswordPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IamAccountPasswordPolicyState, opts?: pulumi.CustomResourceOptions): IamAccountPasswordPolicy {
        return new IamAccountPasswordPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/iamAccountPasswordPolicy:IamAccountPasswordPolicy';

    /**
     * Returns true if the given object is an instance of IamAccountPasswordPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IamAccountPasswordPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IamAccountPasswordPolicy.__pulumiType;
    }
    ...
    /**
     * Create a IamAccountPasswordPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: IamAccountPasswordPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IamAccountPasswordPolicyArgs | IamAccountPasswordPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IamAccountPasswordPolicyState | undefined;
            ...
            const args = argsOrState as IamAccountPasswordPolicyArgs | undefined;
        ...
        super(IamAccountPasswordPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IamAccountPasswordPolicy resources.
 */
export interface IamAccountPasswordPolicyState {
...
/**
 * The set of arguments for constructing a IamAccountPasswordPolicy resource.
 */
export interface IamAccountPasswordPolicyArgs {
    allowUsersToChangePassword?: pulumi.Input<boolean>;
    hardExpiry?: pulumi.Input<boolean>;
    maxPasswordAge?: pulumi.Input<number>;
    minimumPasswordLength?: pulumi.Input<number>;
