...
export class InternetGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/internetGateway:InternetGateway';
    ...
    public readonly timeouts!: pulumi.Output<outputs.InternetGatewayTimeouts | undefined>;
...
export interface InternetGatewayState {
    ...
    timeouts?: pulumi.Input<inputs.InternetGatewayTimeouts>;
