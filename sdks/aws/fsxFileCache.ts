...
export class FsxFileCache extends pulumi.CustomResource {
    /**
     * Get an existing FsxFileCache resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FsxFileCacheState, opts?: pulumi.CustomResourceOptions): FsxFileCache {
        return new FsxFileCache(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/fsxFileCache:FsxFileCache';

    /**
     * Returns true if the given object is an instance of FsxFileCache.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FsxFileCache {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FsxFileCache.__pulumiType;
    }
    ...
    public readonly dataRepositoryAssociations!: pulumi.Output<outputs.FsxFileCacheDataRepositoryAssociation[] | undefined>;
    ...
    public readonly lustreConfigurations!: pulumi.Output<outputs.FsxFileCacheLustreConfiguration[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.FsxFileCacheTimeouts | undefined>;
    public /*out*/ readonly vpcId!: pulumi.Output<string>;

    /**
     * Create a FsxFileCache resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FsxFileCacheArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FsxFileCacheArgs | FsxFileCacheState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FsxFileCacheState | undefined;
            ...
            const args = argsOrState as FsxFileCacheArgs | undefined;
        ...
        super(FsxFileCache.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering FsxFileCache resources.
 */
export interface FsxFileCacheState {
    ...
    dataRepositoryAssociations?: pulumi.Input<pulumi.Input<inputs.FsxFileCacheDataRepositoryAssociation>[]>;
    dnsName?: pulumi.Input<string>;
    fileCacheId?: pulumi.Input<string>;
    fileCacheType?: pulumi.Input<string>;
    fileCacheTypeVersion?: pulumi.Input<string>;
    kmsKeyId?: pulumi.Input<string>;
    lustreConfigurations?: pulumi.Input<pulumi.Input<inputs.FsxFileCacheLustreConfiguration>[]>;
    ...
    timeouts?: pulumi.Input<inputs.FsxFileCacheTimeouts>;
    vpcId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a FsxFileCache resource.
 */
export interface FsxFileCacheArgs {
    copyTagsToDataRepositoryAssociations?: pulumi.Input<boolean>;
    dataRepositoryAssociations?: pulumi.Input<pulumi.Input<inputs.FsxFileCacheDataRepositoryAssociation>[]>;
    fileCacheType: pulumi.Input<string>;
    fileCacheTypeVersion: pulumi.Input<string>;
