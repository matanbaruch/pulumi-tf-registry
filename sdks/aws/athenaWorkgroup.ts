...
export class AthenaWorkgroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/athenaWorkgroup:AthenaWorkgroup';
    ...
    public readonly configuration!: pulumi.Output<outputs.AthenaWorkgroupConfiguration | undefined>;
...
export interface AthenaWorkgroupState {
    ...
    configuration?: pulumi.Input<inputs.AthenaWorkgroupConfiguration>;
