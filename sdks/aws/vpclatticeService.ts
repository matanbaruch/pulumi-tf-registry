...
export class VpclatticeService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpclatticeService:VpclatticeService';
    ...
    public /*out*/ readonly dnsEntries!: pulumi.Output<outputs.VpclatticeServiceDnsEntry[]>;
    public readonly name!: pulumi.Output<string>;
    public /*out*/ readonly status!: pulumi.Output<string>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly tagsAll!: pulumi.Output<{[key: string]: string}>;
    public readonly timeouts!: pulumi.Output<outputs.VpclatticeServiceTimeouts | undefined>;
...
export interface VpclatticeServiceState {
    ...
    dnsEntries?: pulumi.Input<pulumi.Input<inputs.VpclatticeServiceDnsEntry>[]>;
    name?: pulumi.Input<string>;
    status?: pulumi.Input<string>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    tagsAll?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.VpclatticeServiceTimeouts>;
}
