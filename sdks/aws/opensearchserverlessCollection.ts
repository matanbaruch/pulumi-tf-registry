...
export class OpensearchserverlessCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/opensearchserverlessCollection:OpensearchserverlessCollection';
    ...
    public readonly timeouts!: pulumi.Output<outputs.OpensearchserverlessCollectionTimeouts | undefined>;
...
export interface OpensearchserverlessCollectionState {
    ...
    timeouts?: pulumi.Input<inputs.OpensearchserverlessCollectionTimeouts>;
