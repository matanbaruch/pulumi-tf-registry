...
export class IvsPlaybackKeyPair extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/ivsPlaybackKeyPair:IvsPlaybackKeyPair';
    ...
    public readonly timeouts!: pulumi.Output<outputs.IvsPlaybackKeyPairTimeouts | undefined>;
...
export interface IvsPlaybackKeyPairState {
    ...
    timeouts?: pulumi.Input<inputs.IvsPlaybackKeyPairTimeouts>;
}
