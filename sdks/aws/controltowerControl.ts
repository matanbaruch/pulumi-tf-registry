...
export class ControltowerControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/controltowerControl:ControltowerControl';
    ...
    public readonly parameters!: pulumi.Output<outputs.ControltowerControlParameter[] | undefined>;
    public readonly targetIdentifier!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.ControltowerControlTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ControltowerControlArgs | ControltowerControlState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ControltowerControl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ControltowerControlState {
    ...
    parameters?: pulumi.Input<pulumi.Input<inputs.ControltowerControlParameter>[]>;
    targetIdentifier?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.ControltowerControlTimeouts>;
}
