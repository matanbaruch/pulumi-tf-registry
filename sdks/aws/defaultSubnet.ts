...
export class DefaultSubnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/defaultSubnet:DefaultSubnet';
    ...
    public readonly timeouts!: pulumi.Output<outputs.DefaultSubnetTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DefaultSubnetArgs | DefaultSubnetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DefaultSubnet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DefaultSubnetState {
    ...
    timeouts?: pulumi.Input<inputs.DefaultSubnetTimeouts>;
