...
export class EksIdentityProviderConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/eksIdentityProviderConfig:EksIdentityProviderConfig';
    ...
    public readonly timeouts!: pulumi.Output<outputs.EksIdentityProviderConfigTimeouts | undefined>;
...
export interface EksIdentityProviderConfigState {
    ...
    timeouts?: pulumi.Input<inputs.EksIdentityProviderConfigTimeouts>;
}
