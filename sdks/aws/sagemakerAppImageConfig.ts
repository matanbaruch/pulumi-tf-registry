...
export class SagemakerAppImageConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/sagemakerAppImageConfig:SagemakerAppImageConfig';
    ...
    public readonly codeEditorAppImageConfig!: pulumi.Output<outputs.SagemakerAppImageConfigCodeEditorAppImageConfig | undefined>;
    public readonly jupyterLabImageConfig!: pulumi.Output<outputs.SagemakerAppImageConfigJupyterLabImageConfig | undefined>;
    public readonly kernelGatewayImageConfig!: pulumi.Output<outputs.SagemakerAppImageConfigKernelGatewayImageConfig | undefined>;
...
export interface SagemakerAppImageConfigState {
    ...
    jupyterLabImageConfig?: pulumi.Input<inputs.SagemakerAppImageConfigJupyterLabImageConfig>;
