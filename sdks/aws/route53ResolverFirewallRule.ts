...
export class Route53ResolverFirewallRule extends pulumi.CustomResource {
    /**
     * Get an existing Route53ResolverFirewallRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Route53ResolverFirewallRuleState, opts?: pulumi.CustomResourceOptions): Route53ResolverFirewallRule {
        return new Route53ResolverFirewallRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/route53ResolverFirewallRule:Route53ResolverFirewallRule';

    /**
     * Returns true if the given object is an instance of Route53ResolverFirewallRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Route53ResolverFirewallRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Route53ResolverFirewallRule.__pulumiType;
    }
    ...
    /**
     * Create a Route53ResolverFirewallRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: Route53ResolverFirewallRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Route53ResolverFirewallRuleArgs | Route53ResolverFirewallRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Route53ResolverFirewallRuleState | undefined;
            ...
            const args = argsOrState as Route53ResolverFirewallRuleArgs | undefined;
        ...
        super(Route53ResolverFirewallRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Route53ResolverFirewallRule resources.
 */
export interface Route53ResolverFirewallRuleState {
...
/**
 * The set of arguments for constructing a Route53ResolverFirewallRule resource.
 */
export interface Route53ResolverFirewallRuleArgs {
    action: pulumi.Input<string>;
    blockOverrideDnsType?: pulumi.Input<string>;
    blockOverrideDomain?: pulumi.Input<string>;
    blockOverrideTtl?: pulumi.Input<number>;
