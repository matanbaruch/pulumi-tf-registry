...
export class Ec2TrafficMirrorSession extends pulumi.CustomResource {
    /**
     * Get an existing Ec2TrafficMirrorSession resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Ec2TrafficMirrorSessionState, opts?: pulumi.CustomResourceOptions): Ec2TrafficMirrorSession {
        return new Ec2TrafficMirrorSession(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/ec2TrafficMirrorSession:Ec2TrafficMirrorSession';

    /**
     * Returns true if the given object is an instance of Ec2TrafficMirrorSession.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ec2TrafficMirrorSession {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ec2TrafficMirrorSession.__pulumiType;
    }
    ...
    /**
     * Create a Ec2TrafficMirrorSession resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: Ec2TrafficMirrorSessionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Ec2TrafficMirrorSessionArgs | Ec2TrafficMirrorSessionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Ec2TrafficMirrorSessionState | undefined;
            ...
            const args = argsOrState as Ec2TrafficMirrorSessionArgs | undefined;
        ...
        super(Ec2TrafficMirrorSession.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Ec2TrafficMirrorSession resources.
 */
export interface Ec2TrafficMirrorSessionState {
...
/**
 * The set of arguments for constructing a Ec2TrafficMirrorSession resource.
 */
export interface Ec2TrafficMirrorSessionArgs {
    description?: pulumi.Input<string>;
    networkInterfaceId: pulumi.Input<string>;
    packetLength?: pulumi.Input<number>;
    sessionNumber: pulumi.Input<number>;
