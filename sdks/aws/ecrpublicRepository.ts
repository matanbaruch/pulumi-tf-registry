...
export class EcrpublicRepository extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/ecrpublicRepository:EcrpublicRepository';
    ...
    public readonly catalogData!: pulumi.Output<outputs.EcrpublicRepositoryCatalogData | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.EcrpublicRepositoryTimeouts | undefined>;
...
export interface EcrpublicRepositoryState {
    ...
    catalogData?: pulumi.Input<inputs.EcrpublicRepositoryCatalogData>;
    ...
    timeouts?: pulumi.Input<inputs.EcrpublicRepositoryTimeouts>;
}
