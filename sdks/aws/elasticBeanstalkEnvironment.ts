...
export class ElasticBeanstalkEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/elasticBeanstalkEnvironment:ElasticBeanstalkEnvironment';
    ...
    public /*out*/ readonly allSettings!: pulumi.Output<outputs.ElasticBeanstalkEnvironmentAllSetting[]>;
    ...
    public readonly settings!: pulumi.Output<outputs.ElasticBeanstalkEnvironmentSetting[] | undefined>;
...
export interface ElasticBeanstalkEnvironmentState {
    allSettings?: pulumi.Input<pulumi.Input<inputs.ElasticBeanstalkEnvironmentAllSetting>[]>;
    ...
    settings?: pulumi.Input<pulumi.Input<inputs.ElasticBeanstalkEnvironmentSetting>[]>;
