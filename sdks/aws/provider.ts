...
export class Provider extends pulumi.ProviderResource {
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["assumeRoleWithWebIdentities"] = pulumi.output(args ? args.assumeRoleWithWebIdentities : undefined).apply(JSON.stringify);
...
export interface ProviderArgs {
    ...
    assumeRoleWithWebIdentities?: pulumi.Input<pulumi.Input<inputs.ProviderAssumeRoleWithWebIdentity>[]>;
     ...
     */
    ignoreTags?: pulumi.Input<pulumi.Input<inputs.ProviderIgnoreTag>[]>;
    /**
