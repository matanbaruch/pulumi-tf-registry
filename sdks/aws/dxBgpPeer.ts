...
export class DxBgpPeer extends pulumi.CustomResource {
    /**
     * Get an existing DxBgpPeer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DxBgpPeerState, opts?: pulumi.CustomResourceOptions): DxBgpPeer {
        return new DxBgpPeer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dxBgpPeer:DxBgpPeer';

    /**
     * Returns true if the given object is an instance of DxBgpPeer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DxBgpPeer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DxBgpPeer.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DxBgpPeerTimeouts | undefined>;
    public readonly virtualInterfaceId!: pulumi.Output<string>;

    /**
     * Create a DxBgpPeer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DxBgpPeerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DxBgpPeerArgs | DxBgpPeerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DxBgpPeerState | undefined;
            ...
            const args = argsOrState as DxBgpPeerArgs | undefined;
        ...
        super(DxBgpPeer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DxBgpPeer resources.
 */
export interface DxBgpPeerState {
    ...
    timeouts?: pulumi.Input<inputs.DxBgpPeerTimeouts>;
    virtualInterfaceId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a DxBgpPeer resource.
 */
export interface DxBgpPeerArgs {
    addressFamily: pulumi.Input<string>;
    amazonAddress?: pulumi.Input<string>;
    bgpAsn: pulumi.Input<number>;
    bgpAuthKey?: pulumi.Input<string>;
