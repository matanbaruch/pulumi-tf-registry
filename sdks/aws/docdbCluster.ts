...
export class DocdbCluster extends pulumi.CustomResource {
    /**
     * Get an existing DocdbCluster resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DocdbClusterState, opts?: pulumi.CustomResourceOptions): DocdbCluster {
        return new DocdbCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/docdbCluster:DocdbCluster';

    /**
     * Returns true if the given object is an instance of DocdbCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DocdbCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DocdbCluster.__pulumiType;
    }
    ...
    public readonly restoreToPointInTime!: pulumi.Output<outputs.DocdbClusterRestoreToPointInTime | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.DocdbClusterTimeouts | undefined>;
    public readonly vpcSecurityGroupIds!: pulumi.Output<string[]>;

    /**
     * Create a DocdbCluster resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DocdbClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DocdbClusterArgs | DocdbClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DocdbClusterState | undefined;
            ...
            const args = argsOrState as DocdbClusterArgs | undefined;
        ...
        super(DocdbCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DocdbCluster resources.
 */
export interface DocdbClusterState {
    ...
    restoreToPointInTime?: pulumi.Input<inputs.DocdbClusterRestoreToPointInTime>;
    ...
    timeouts?: pulumi.Input<inputs.DocdbClusterTimeouts>;
    vpcSecurityGroupIds?: pulumi.Input<pulumi.Input<string>[]>;
}

/**
 * The set of arguments for constructing a DocdbCluster resource.
 */
export interface DocdbClusterArgs {
    allowMajorVersionUpgrade?: pulumi.Input<boolean>;
    applyImmediately?: pulumi.Input<boolean>;
    availabilityZones?: pulumi.Input<pulumi.Input<string>[]>;
    backupRetentionPeriod?: pulumi.Input<number>;
