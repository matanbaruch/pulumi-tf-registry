...
export class DirectoryServiceRadiusSettings extends pulumi.CustomResource {
    /**
     * Get an existing DirectoryServiceRadiusSettings resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DirectoryServiceRadiusSettingsState, opts?: pulumi.CustomResourceOptions): DirectoryServiceRadiusSettings {
        return new DirectoryServiceRadiusSettings(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/directoryServiceRadiusSettings:DirectoryServiceRadiusSettings';

    /**
     * Returns true if the given object is an instance of DirectoryServiceRadiusSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DirectoryServiceRadiusSettings {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DirectoryServiceRadiusSettings.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DirectoryServiceRadiusSettingsTimeouts | undefined>;
    public readonly useSameUsername!: pulumi.Output<boolean | undefined>;

    /**
     * Create a DirectoryServiceRadiusSettings resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DirectoryServiceRadiusSettingsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DirectoryServiceRadiusSettingsArgs | DirectoryServiceRadiusSettingsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DirectoryServiceRadiusSettingsState | undefined;
            ...
            const args = argsOrState as DirectoryServiceRadiusSettingsArgs | undefined;
        ...
        super(DirectoryServiceRadiusSettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DirectoryServiceRadiusSettings resources.
 */
export interface DirectoryServiceRadiusSettingsState {
    ...
    timeouts?: pulumi.Input<inputs.DirectoryServiceRadiusSettingsTimeouts>;
    useSameUsername?: pulumi.Input<boolean>;
}

/**
 * The set of arguments for constructing a DirectoryServiceRadiusSettings resource.
 */
export interface DirectoryServiceRadiusSettingsArgs {
    authenticationProtocol: pulumi.Input<string>;
    directoryId: pulumi.Input<string>;
    displayLabel: pulumi.Input<string>;
    radiusPort: pulumi.Input<number>;
