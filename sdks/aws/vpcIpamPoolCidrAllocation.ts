...
export class VpcIpamPoolCidrAllocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcIpamPoolCidrAllocation:VpcIpamPoolCidrAllocation';
    ...
    constructor(name: string, argsOrState?: VpcIpamPoolCidrAllocationArgs | VpcIpamPoolCidrAllocationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcIpamPoolCidrAllocation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
