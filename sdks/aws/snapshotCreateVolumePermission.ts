...
export class SnapshotCreateVolumePermission extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/snapshotCreateVolumePermission:SnapshotCreateVolumePermission';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SnapshotCreateVolumePermissionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SnapshotCreateVolumePermissionArgs | SnapshotCreateVolumePermissionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SnapshotCreateVolumePermission.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SnapshotCreateVolumePermissionState {
    ...
    timeouts?: pulumi.Input<inputs.SnapshotCreateVolumePermissionTimeouts>;
}
