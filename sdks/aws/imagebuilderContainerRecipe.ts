...
export class ImagebuilderContainerRecipe extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/imagebuilderContainerRecipe:ImagebuilderContainerRecipe';
    ...
    public readonly instanceConfiguration!: pulumi.Output<outputs.ImagebuilderContainerRecipeInstanceConfiguration | undefined>;
