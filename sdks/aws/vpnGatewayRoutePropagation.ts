...
export class VpnGatewayRoutePropagation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpnGatewayRoutePropagation:VpnGatewayRoutePropagation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpnGatewayRoutePropagationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VpnGatewayRoutePropagationArgs | VpnGatewayRoutePropagationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpnGatewayRoutePropagation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpnGatewayRoutePropagationState {
    ...
    timeouts?: pulumi.Input<inputs.VpnGatewayRoutePropagationTimeouts>;
