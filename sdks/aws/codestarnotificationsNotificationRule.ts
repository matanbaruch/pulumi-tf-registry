...
export class CodestarnotificationsNotificationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/codestarnotificationsNotificationRule:CodestarnotificationsNotificationRule';
    ...
    public readonly targets!: pulumi.Output<outputs.CodestarnotificationsNotificationRuleTarget[] | undefined>;
