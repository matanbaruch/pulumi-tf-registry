...
export class KendraFaq extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/kendraFaq:KendraFaq';
    ...
    public readonly timeouts!: pulumi.Output<outputs.KendraFaqTimeouts | undefined>;
...
export interface KendraFaqState {
    ...
    timeouts?: pulumi.Input<inputs.KendraFaqTimeouts>;
