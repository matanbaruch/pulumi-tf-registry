...
export class SnsTopicSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/snsTopicSubscription:SnsTopicSubscription';
    ...
    constructor(name: string, argsOrState?: SnsTopicSubscriptionArgs | SnsTopicSubscriptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SnsTopicSubscription.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
