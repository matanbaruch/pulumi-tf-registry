...
export class NetworkmanagerVpcAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkmanagerVpcAttachment:NetworkmanagerVpcAttachment';
    ...
    public readonly options!: pulumi.Output<outputs.NetworkmanagerVpcAttachmentOptions | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkmanagerVpcAttachmentTimeouts | undefined>;
...
export interface NetworkmanagerVpcAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.NetworkmanagerVpcAttachmentTimeouts>;
