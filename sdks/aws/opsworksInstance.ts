...
export class OpsworksInstance extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksInstanceState, opts?: pulumi.CustomResourceOptions): OpsworksInstance {
        return new OpsworksInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksInstance:OpsworksInstance';

    /**
     * Returns true if the given object is an instance of OpsworksInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksInstance.__pulumiType;
    }
    ...
    public readonly ebsBlockDevices!: pulumi.Output<outputs.OpsworksInstanceEbsBlockDevice[] | undefined>;
    ...
    public readonly ephemeralBlockDevices!: pulumi.Output<outputs.OpsworksInstanceEphemeralBlockDevice[] | undefined>;
    ...
    public readonly rootBlockDevices!: pulumi.Output<outputs.OpsworksInstanceRootBlockDevice[] | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.OpsworksInstanceTimeouts | undefined>;
    public readonly virtualizationType!: pulumi.Output<string>;

    /**
     * Create a OpsworksInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksInstanceArgs | OpsworksInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksInstanceState | undefined;
            ...
            const args = argsOrState as OpsworksInstanceArgs | undefined;
        ...
        super(OpsworksInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksInstance resources.
 */
export interface OpsworksInstanceState {
    ...
    ebsBlockDevices?: pulumi.Input<pulumi.Input<inputs.OpsworksInstanceEbsBlockDevice>[]>;
    ebsOptimized?: pulumi.Input<boolean>;
    ec2InstanceId?: pulumi.Input<string>;
    ecsClusterArn?: pulumi.Input<string>;
    elasticIp?: pulumi.Input<string>;
    ephemeralBlockDevices?: pulumi.Input<pulumi.Input<inputs.OpsworksInstanceEphemeralBlockDevice>[]>;
    ...
    rootBlockDevices?: pulumi.Input<pulumi.Input<inputs.OpsworksInstanceRootBlockDevice>[]>;
    ...
    timeouts?: pulumi.Input<inputs.OpsworksInstanceTimeouts>;
    virtualizationType?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a OpsworksInstance resource.
 */
export interface OpsworksInstanceArgs {
    agentVersion?: pulumi.Input<string>;
    amiId?: pulumi.Input<string>;
    architecture?: pulumi.Input<string>;
    autoScalingType?: pulumi.Input<string>;
