...
export class OpsworksMemcachedLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksMemcachedLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksMemcachedLayerState, opts?: pulumi.CustomResourceOptions): OpsworksMemcachedLayer {
        return new OpsworksMemcachedLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksMemcachedLayer:OpsworksMemcachedLayer';

    /**
     * Returns true if the given object is an instance of OpsworksMemcachedLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksMemcachedLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksMemcachedLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksMemcachedLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksMemcachedLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksMemcachedLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksMemcachedLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksMemcachedLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksMemcachedLayerArgs | OpsworksMemcachedLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksMemcachedLayerState | undefined;
            ...
            const args = argsOrState as OpsworksMemcachedLayerArgs | undefined;
        ...
        super(OpsworksMemcachedLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksMemcachedLayer resources.
 */
export interface OpsworksMemcachedLayerState {
    ...
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksMemcachedLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksMemcachedLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksMemcachedLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksMemcachedLayer resource.
 */
export interface OpsworksMemcachedLayerArgs {
    allocatedMemory?: pulumi.Input<number>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
