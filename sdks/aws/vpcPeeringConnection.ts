...
export class VpcPeeringConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcPeeringConnection:VpcPeeringConnection';
    ...
    public readonly accepter!: pulumi.Output<outputs.VpcPeeringConnectionAccepter | undefined>;
    ...
    public readonly requester!: pulumi.Output<outputs.VpcPeeringConnectionRequester | undefined>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly tagsAll!: pulumi.Output<{[key: string]: string}>;
    public readonly timeouts!: pulumi.Output<outputs.VpcPeeringConnectionTimeouts | undefined>;
...
export interface VpcPeeringConnectionState {
    ...
    timeouts?: pulumi.Input<inputs.VpcPeeringConnectionTimeouts>;
