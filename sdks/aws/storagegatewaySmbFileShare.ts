...
export class StoragegatewaySmbFileShare extends pulumi.CustomResource {
    /**
     * Get an existing StoragegatewaySmbFileShare resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StoragegatewaySmbFileShareState, opts?: pulumi.CustomResourceOptions): StoragegatewaySmbFileShare {
        return new StoragegatewaySmbFileShare(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/storagegatewaySmbFileShare:StoragegatewaySmbFileShare';

    /**
     * Returns true if the given object is an instance of StoragegatewaySmbFileShare.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StoragegatewaySmbFileShare {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StoragegatewaySmbFileShare.__pulumiType;
    }
    ...
    public readonly cacheAttributes!: pulumi.Output<outputs.StoragegatewaySmbFileShareCacheAttributes | undefined>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.StoragegatewaySmbFileShareTimeouts | undefined>;
    ...
    /**
     * Create a StoragegatewaySmbFileShare resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: StoragegatewaySmbFileShareArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: StoragegatewaySmbFileShareArgs | StoragegatewaySmbFileShareState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StoragegatewaySmbFileShareState | undefined;
            ...
            const args = argsOrState as StoragegatewaySmbFileShareArgs | undefined;
        ...
        super(StoragegatewaySmbFileShare.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering StoragegatewaySmbFileShare resources.
 */
export interface StoragegatewaySmbFileShareState {
    ...
    cacheAttributes?: pulumi.Input<inputs.StoragegatewaySmbFileShareCacheAttributes>;
    ...
    timeouts?: pulumi.Input<inputs.StoragegatewaySmbFileShareTimeouts>;
    validUserLists?: pulumi.Input<pulumi.Input<string>[]>;
    vpcEndpointDnsName?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a StoragegatewaySmbFileShare resource.
 */
export interface StoragegatewaySmbFileShareArgs {
    accessBasedEnumeration?: pulumi.Input<boolean>;
    adminUserLists?: pulumi.Input<pulumi.Input<string>[]>;
    auditDestinationArn?: pulumi.Input<string>;
    authentication?: pulumi.Input<string>;
