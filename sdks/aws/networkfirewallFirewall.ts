...
export class NetworkfirewallFirewall extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkfirewallFirewall:NetworkfirewallFirewall';
    ...
    public readonly encryptionConfiguration!: pulumi.Output<outputs.NetworkfirewallFirewallEncryptionConfiguration | undefined>;
    ...
    public /*out*/ readonly firewallStatuses!: pulumi.Output<outputs.NetworkfirewallFirewallFirewallStatus[]>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkfirewallFirewallTimeouts | undefined>;
...
export interface NetworkfirewallFirewallState {
    ...
    encryptionConfiguration?: pulumi.Input<inputs.NetworkfirewallFirewallEncryptionConfiguration>;
    firewallPolicyArn?: pulumi.Input<string>;
    firewallPolicyChangeProtection?: pulumi.Input<boolean>;
    firewallStatuses?: pulumi.Input<pulumi.Input<inputs.NetworkfirewallFirewallFirewallStatus>[]>;
    ...
    timeouts?: pulumi.Input<inputs.NetworkfirewallFirewallTimeouts>;
