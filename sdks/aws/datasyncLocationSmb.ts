...
export class DatasyncLocationSmb extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/datasyncLocationSmb:DatasyncLocationSmb';
    ...
    public readonly mountOptions!: pulumi.Output<outputs.DatasyncLocationSmbMountOptions | undefined>;
