...
export function getElasticBeanstalkApplication(args: GetElasticBeanstalkApplicationArgs, opts?: pulumi.InvokeOptions): Promise<GetElasticBeanstalkApplicationResult> {
    ...
    return pulumi.runtime.invoke("aws:index/getElasticBeanstalkApplication:getElasticBeanstalkApplication", {
        "id": args.id,
        "name": args.name,
...
export interface GetElasticBeanstalkApplicationResult {
    readonly appversionLifecycles: outputs.GetElasticBeanstalkApplicationAppversionLifecycle[];
    readonly arn: string;
