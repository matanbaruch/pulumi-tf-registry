...
export class SchedulerScheduleGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/schedulerScheduleGroup:SchedulerScheduleGroup';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SchedulerScheduleGroupTimeouts | undefined>;
...
export interface SchedulerScheduleGroupState {
    ...
    timeouts?: pulumi.Input<inputs.SchedulerScheduleGroupTimeouts>;
}
