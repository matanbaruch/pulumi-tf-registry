...
export class NetworkmanagerSiteToSiteVpnAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkmanagerSiteToSiteVpnAttachment:NetworkmanagerSiteToSiteVpnAttachment';
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkmanagerSiteToSiteVpnAttachmentTimeouts | undefined>;
...
export interface NetworkmanagerSiteToSiteVpnAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.NetworkmanagerSiteToSiteVpnAttachmentTimeouts>;
