...
export class OpsworksRailsAppLayer extends pulumi.CustomResource {
    /**
     * Get an existing OpsworksRailsAppLayer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpsworksRailsAppLayerState, opts?: pulumi.CustomResourceOptions): OpsworksRailsAppLayer {
        return new OpsworksRailsAppLayer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/opsworksRailsAppLayer:OpsworksRailsAppLayer';

    /**
     * Returns true if the given object is an instance of OpsworksRailsAppLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpsworksRailsAppLayer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpsworksRailsAppLayer.__pulumiType;
    }
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.OpsworksRailsAppLayerCloudwatchConfiguration | undefined>;
    ...
    public readonly ebsVolumes!: pulumi.Output<outputs.OpsworksRailsAppLayerEbsVolume[] | undefined>;
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.OpsworksRailsAppLayerLoadBasedAutoScaling | undefined>;
    ...
    /**
     * Create a OpsworksRailsAppLayer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OpsworksRailsAppLayerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpsworksRailsAppLayerArgs | OpsworksRailsAppLayerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpsworksRailsAppLayerState | undefined;
            ...
            const args = argsOrState as OpsworksRailsAppLayerArgs | undefined;
        ...
        super(OpsworksRailsAppLayer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpsworksRailsAppLayer resources.
 */
export interface OpsworksRailsAppLayerState {
    ...
    cloudwatchConfiguration?: pulumi.Input<inputs.OpsworksRailsAppLayerCloudwatchConfiguration>;
    ...
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.OpsworksRailsAppLayerEbsVolume>[]>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.OpsworksRailsAppLayerLoadBasedAutoScaling>;
...
/**
 * The set of arguments for constructing a OpsworksRailsAppLayer resource.
 */
export interface OpsworksRailsAppLayerArgs {
    appServer?: pulumi.Input<string>;
    autoAssignElasticIps?: pulumi.Input<boolean>;
    autoAssignPublicIps?: pulumi.Input<boolean>;
    autoHealing?: pulumi.Input<boolean>;
