...
export class ElasticacheGlobalReplicationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/elasticacheGlobalReplicationGroup:ElasticacheGlobalReplicationGroup';
    ...
    public /*out*/ readonly globalNodeGroups!: pulumi.Output<outputs.ElasticacheGlobalReplicationGroupGlobalNodeGroup[]>;
    ...
    public readonly timeouts!: pulumi.Output<outputs.ElasticacheGlobalReplicationGroupTimeouts | undefined>;
...
export interface ElasticacheGlobalReplicationGroupState {
    ...
    globalNodeGroups?: pulumi.Input<pulumi.Input<inputs.ElasticacheGlobalReplicationGroupGlobalNodeGroup>[]>;
    ...
    timeouts?: pulumi.Input<inputs.ElasticacheGlobalReplicationGroupTimeouts>;
