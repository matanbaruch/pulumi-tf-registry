...
export class VpcIpv4CidrBlockAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcIpv4CidrBlockAssociation:VpcIpv4CidrBlockAssociation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpcIpv4CidrBlockAssociationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VpcIpv4CidrBlockAssociationArgs | VpcIpv4CidrBlockAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcIpv4CidrBlockAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcIpv4CidrBlockAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.VpcIpv4CidrBlockAssociationTimeouts>;
