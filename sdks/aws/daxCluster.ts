...
export class DaxCluster extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DaxClusterState, opts?: pulumi.CustomResourceOptions): DaxCluster {
        return new DaxCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/daxCluster:DaxCluster';
    ...
    public /*out*/ readonly nodes!: pulumi.Output<outputs.DaxClusterNode[]>;
    ...
    public readonly serverSideEncryption!: pulumi.Output<outputs.DaxClusterServerSideEncryption | undefined>;
    public readonly subnetGroupName!: pulumi.Output<string>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly tagsAll!: pulumi.Output<{[key: string]: string}>;
    public readonly timeouts!: pulumi.Output<outputs.DaxClusterTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DaxClusterArgs | DaxClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DaxClusterState | undefined;
            ...
            const args = argsOrState as DaxClusterArgs | undefined;
        ...
        super(DaxCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface DaxClusterState {
    ...
    nodes?: pulumi.Input<pulumi.Input<inputs.DaxClusterNode>[]>;
    notificationTopicArn?: pulumi.Input<string>;
    parameterGroupName?: pulumi.Input<string>;
    port?: pulumi.Input<number>;
    replicationFactor?: pulumi.Input<number>;
    securityGroupIds?: pulumi.Input<pulumi.Input<string>[]>;
    serverSideEncryption?: pulumi.Input<inputs.DaxClusterServerSideEncryption>;
    subnetGroupName?: pulumi.Input<string>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    tagsAll?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    timeouts?: pulumi.Input<inputs.DaxClusterTimeouts>;
}
