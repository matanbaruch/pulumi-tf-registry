...
export class NeptuneClusterSnapshot extends pulumi.CustomResource {
    /**
     * Get an existing NeptuneClusterSnapshot resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NeptuneClusterSnapshotState, opts?: pulumi.CustomResourceOptions): NeptuneClusterSnapshot {
        return new NeptuneClusterSnapshot(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/neptuneClusterSnapshot:NeptuneClusterSnapshot';

    /**
     * Returns true if the given object is an instance of NeptuneClusterSnapshot.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NeptuneClusterSnapshot {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NeptuneClusterSnapshot.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.NeptuneClusterSnapshotTimeouts | undefined>;
    public /*out*/ readonly vpcId!: pulumi.Output<string>;

    /**
     * Create a NeptuneClusterSnapshot resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NeptuneClusterSnapshotArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NeptuneClusterSnapshotArgs | NeptuneClusterSnapshotState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NeptuneClusterSnapshotState | undefined;
            ...
            const args = argsOrState as NeptuneClusterSnapshotArgs | undefined;
        ...
        super(NeptuneClusterSnapshot.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NeptuneClusterSnapshot resources.
 */
export interface NeptuneClusterSnapshotState {
    ...
    timeouts?: pulumi.Input<inputs.NeptuneClusterSnapshotTimeouts>;
    vpcId?: pulumi.Input<string>;
}

/**
 * The set of arguments for constructing a NeptuneClusterSnapshot resource.
 */
export interface NeptuneClusterSnapshotArgs {
    dbClusterIdentifier: pulumi.Input<string>;
    dbClusterSnapshotIdentifier: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.NeptuneClusterSnapshotTimeouts>;
}
