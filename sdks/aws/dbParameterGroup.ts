...
export class DbParameterGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbParameterGroupState, opts?: pulumi.CustomResourceOptions): DbParameterGroup {
        return new DbParameterGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dbParameterGroup:DbParameterGroup';
    ...
    public readonly parameters!: pulumi.Output<outputs.DbParameterGroupParameter[] | undefined>;
    ...
    constructor(name: string, argsOrState?: DbParameterGroupArgs | DbParameterGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DbParameterGroupState | undefined;
        ...
        super(DbParameterGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface DbParameterGroupState {
    arn?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    family?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    namePrefix?: pulumi.Input<string>;
    parameters?: pulumi.Input<pulumi.Input<inputs.DbParameterGroupParameter>[]>;
