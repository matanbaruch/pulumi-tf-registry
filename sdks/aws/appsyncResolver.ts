...
export class AppsyncResolver extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/appsyncResolver:AppsyncResolver';
    ...
    public readonly cachingConfig!: pulumi.Output<outputs.AppsyncResolverCachingConfig | undefined>;
    ...
    public readonly pipelineConfig!: pulumi.Output<outputs.AppsyncResolverPipelineConfig | undefined>;
    ...
    public readonly runtime!: pulumi.Output<outputs.AppsyncResolverRuntime | undefined>;
    public readonly syncConfig!: pulumi.Output<outputs.AppsyncResolverSyncConfig | undefined>;
