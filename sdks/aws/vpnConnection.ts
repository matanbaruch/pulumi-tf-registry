...
export class VpnConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpnConnection:VpnConnection';
    ...
    public readonly tunnel1LogOptions!: pulumi.Output<outputs.VpnConnectionTunnel1LogOptions | undefined>;
    ...
    public readonly tunnel2LogOptions!: pulumi.Output<outputs.VpnConnectionTunnel2LogOptions | undefined>;
