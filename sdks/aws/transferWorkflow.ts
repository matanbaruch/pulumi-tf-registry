...
export class TransferWorkflow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/transferWorkflow:TransferWorkflow';
    ...
    public readonly onExceptionSteps!: pulumi.Output<outputs.TransferWorkflowOnExceptionStep[] | undefined>;
