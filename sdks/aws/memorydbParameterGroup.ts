...
export class MemorydbParameterGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/memorydbParameterGroup:MemorydbParameterGroup';
    ...
    public readonly parameters!: pulumi.Output<outputs.MemorydbParameterGroupParameter[] | undefined>;
...
export interface MemorydbParameterGroupState {
    ...
    parameters?: pulumi.Input<pulumi.Input<inputs.MemorydbParameterGroupParameter>[]>;
