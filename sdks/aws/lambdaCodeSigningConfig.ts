...
export class LambdaCodeSigningConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/lambdaCodeSigningConfig:LambdaCodeSigningConfig';
    ...
    public readonly policies!: pulumi.Output<outputs.LambdaCodeSigningConfigPolicies | undefined>;
...
export interface LambdaCodeSigningConfigState {
    ...
    policies?: pulumi.Input<inputs.LambdaCodeSigningConfigPolicies>;
}
