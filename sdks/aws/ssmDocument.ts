...
export class SsmDocument extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/ssmDocument:SsmDocument';
    ...
    public readonly attachmentsSources!: pulumi.Output<outputs.SsmDocumentAttachmentsSource[] | undefined>;
    ...
    public /*out*/ readonly parameters!: pulumi.Output<outputs.SsmDocumentParameter[]>;
...
export interface SsmDocumentState {
    ...
    attachmentsSources?: pulumi.Input<pulumi.Input<inputs.SsmDocumentAttachmentsSource>[]>;
    ...
    parameters?: pulumi.Input<pulumi.Input<inputs.SsmDocumentParameter>[]>;
