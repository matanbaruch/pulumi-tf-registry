...
export class VpcEndpointConnectionAccepter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcEndpointConnectionAccepter:VpcEndpointConnectionAccepter';
    ...
    constructor(name: string, argsOrState?: VpcEndpointConnectionAccepterArgs | VpcEndpointConnectionAccepterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcEndpointConnectionAccepter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
