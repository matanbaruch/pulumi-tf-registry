...
export class NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkInterface:NetworkInterface';
    ...
    public readonly attachments!: pulumi.Output<outputs.NetworkInterfaceAttachment[] | undefined>;
