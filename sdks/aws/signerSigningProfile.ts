...
export class SignerSigningProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/signerSigningProfile:SignerSigningProfile';
    ...
    public /*out*/ readonly revocationRecords!: pulumi.Output<outputs.SignerSigningProfileRevocationRecord[]>;
    public readonly signatureValidityPeriod!: pulumi.Output<outputs.SignerSigningProfileSignatureValidityPeriod | undefined>;
    public readonly signingMaterial!: pulumi.Output<outputs.SignerSigningProfileSigningMaterial | undefined>;
...
export interface SignerSigningProfileState {
    ...
    revocationRecords?: pulumi.Input<pulumi.Input<inputs.SignerSigningProfileRevocationRecord>[]>;
    signatureValidityPeriod?: pulumi.Input<inputs.SignerSigningProfileSignatureValidityPeriod>;
    signingMaterial?: pulumi.Input<inputs.SignerSigningProfileSigningMaterial>;
