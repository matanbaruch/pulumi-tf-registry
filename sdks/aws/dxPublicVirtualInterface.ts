...
export class DxPublicVirtualInterface extends pulumi.CustomResource {
    /**
     * Get an existing DxPublicVirtualInterface resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DxPublicVirtualInterfaceState, opts?: pulumi.CustomResourceOptions): DxPublicVirtualInterface {
        return new DxPublicVirtualInterface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dxPublicVirtualInterface:DxPublicVirtualInterface';

    /**
     * Returns true if the given object is an instance of DxPublicVirtualInterface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DxPublicVirtualInterface {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DxPublicVirtualInterface.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DxPublicVirtualInterfaceTimeouts | undefined>;
    public readonly vlan!: pulumi.Output<number>;

    /**
     * Create a DxPublicVirtualInterface resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DxPublicVirtualInterfaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DxPublicVirtualInterfaceArgs | DxPublicVirtualInterfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DxPublicVirtualInterfaceState | undefined;
            ...
            const args = argsOrState as DxPublicVirtualInterfaceArgs | undefined;
        ...
        super(DxPublicVirtualInterface.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DxPublicVirtualInterface resources.
 */
export interface DxPublicVirtualInterfaceState {
    ...
    timeouts?: pulumi.Input<inputs.DxPublicVirtualInterfaceTimeouts>;
    vlan?: pulumi.Input<number>;
}

/**
 * The set of arguments for constructing a DxPublicVirtualInterface resource.
 */
export interface DxPublicVirtualInterfaceArgs {
    addressFamily: pulumi.Input<string>;
    amazonAddress?: pulumi.Input<string>;
    bgpAsn: pulumi.Input<number>;
    bgpAuthKey?: pulumi.Input<string>;
