...
export class EipDomainName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/eipDomainName:EipDomainName';
    ...
    constructor(name: string, argsOrState?: EipDomainNameArgs | EipDomainNameState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EipDomainName.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
