...
export class VpcPeeringConnectionAccepter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcPeeringConnectionAccepter:VpcPeeringConnectionAccepter';
    ...
    public readonly accepter!: pulumi.Output<outputs.VpcPeeringConnectionAccepterAccepter | undefined>;
    ...
    public readonly requester!: pulumi.Output<outputs.VpcPeeringConnectionAccepterRequester | undefined>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly tagsAll!: pulumi.Output<{[key: string]: string}>;
    public readonly timeouts!: pulumi.Output<outputs.VpcPeeringConnectionAccepterTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VpcPeeringConnectionAccepterArgs | VpcPeeringConnectionAccepterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcPeeringConnectionAccepter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcPeeringConnectionAccepterState {
    ...
    timeouts?: pulumi.Input<inputs.VpcPeeringConnectionAccepterTimeouts>;
