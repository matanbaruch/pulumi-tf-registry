...
export class DxHostedConnection extends pulumi.CustomResource {
    /**
     * Get an existing DxHostedConnection resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DxHostedConnectionState, opts?: pulumi.CustomResourceOptions): DxHostedConnection {
        return new DxHostedConnection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dxHostedConnection:DxHostedConnection';

    /**
     * Returns true if the given object is an instance of DxHostedConnection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DxHostedConnection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DxHostedConnection.__pulumiType;
    }
    ...
    /**
     * Create a DxHostedConnection resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DxHostedConnectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DxHostedConnectionArgs | DxHostedConnectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DxHostedConnectionState | undefined;
            ...
            const args = argsOrState as DxHostedConnectionArgs | undefined;
        ...
        super(DxHostedConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DxHostedConnection resources.
 */
export interface DxHostedConnectionState {
...
/**
 * The set of arguments for constructing a DxHostedConnection resource.
 */
export interface DxHostedConnectionArgs {
    bandwidth: pulumi.Input<string>;
    connectionId: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    ownerAccountId: pulumi.Input<string>;
