...
export class CeCostCategory extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/ceCostCategory:CeCostCategory';
    ...
    public readonly rules!: pulumi.Output<outputs.CeCostCategoryRule[]>;
    public readonly splitChargeRules!: pulumi.Output<outputs.CeCostCategorySplitChargeRule[] | undefined>;
...
export interface CeCostCategoryState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.CeCostCategoryRule>[]>;
    splitChargeRules?: pulumi.Input<pulumi.Input<inputs.CeCostCategorySplitChargeRule>[]>;
