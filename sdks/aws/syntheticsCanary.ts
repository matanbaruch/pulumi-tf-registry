...
export class SyntheticsCanary extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/syntheticsCanary:SyntheticsCanary';
    ...
    public readonly artifactConfig!: pulumi.Output<outputs.SyntheticsCanaryArtifactConfig | undefined>;
    ...
    public readonly runConfig!: pulumi.Output<outputs.SyntheticsCanaryRunConfig | undefined>;
    ...
    public /*out*/ readonly timelines!: pulumi.Output<outputs.SyntheticsCanaryTimeline[]>;
    public readonly vpcConfig!: pulumi.Output<outputs.SyntheticsCanaryVpcConfig | undefined>;
...
export interface SyntheticsCanaryState {
    ...
    timelines?: pulumi.Input<pulumi.Input<inputs.SyntheticsCanaryTimeline>[]>;
