...
export class EfsFileSystem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/efsFileSystem:EfsFileSystem';
    ...
    public readonly lifecyclePolicies!: pulumi.Output<outputs.EfsFileSystemLifecyclePolicy[] | undefined>;
    ...
    public readonly protection!: pulumi.Output<outputs.EfsFileSystemProtection | undefined>;
    public readonly provisionedThroughputInMibps!: pulumi.Output<number | undefined>;
    public /*out*/ readonly sizeInBytes!: pulumi.Output<outputs.EfsFileSystemSizeInByte[]>;
...
export interface EfsFileSystemState {
    ...
    protection?: pulumi.Input<inputs.EfsFileSystemProtection>;
    provisionedThroughputInMibps?: pulumi.Input<number>;
    sizeInBytes?: pulumi.Input<pulumi.Input<inputs.EfsFileSystemSizeInByte>[]>;
