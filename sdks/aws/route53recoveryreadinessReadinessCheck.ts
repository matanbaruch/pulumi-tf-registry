...
export class Route53recoveryreadinessReadinessCheck extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/route53recoveryreadinessReadinessCheck:Route53recoveryreadinessReadinessCheck';
    ...
    public readonly timeouts!: pulumi.Output<outputs.Route53recoveryreadinessReadinessCheckTimeouts | undefined>;
...
export interface Route53recoveryreadinessReadinessCheckState {
    ...
    timeouts?: pulumi.Input<inputs.Route53recoveryreadinessReadinessCheckTimeouts>;
}
