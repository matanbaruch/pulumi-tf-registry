...
export class DefaultSecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/defaultSecurityGroup:DefaultSecurityGroup';
    ...
    public readonly egresses!: pulumi.Output<outputs.DefaultSecurityGroupEgress[]>;
    public readonly ingresses!: pulumi.Output<outputs.DefaultSecurityGroupIngress[]>;
    ...
    constructor(name: string, argsOrState?: DefaultSecurityGroupArgs | DefaultSecurityGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DefaultSecurityGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DefaultSecurityGroupState {
    ...
    egresses?: pulumi.Input<pulumi.Input<inputs.DefaultSecurityGroupEgress>[]>;
    ingresses?: pulumi.Input<pulumi.Input<inputs.DefaultSecurityGroupIngress>[]>;
