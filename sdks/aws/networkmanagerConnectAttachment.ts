...
export class NetworkmanagerConnectAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkmanagerConnectAttachment:NetworkmanagerConnectAttachment';
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkmanagerConnectAttachmentTimeouts | undefined>;
...
export interface NetworkmanagerConnectAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.NetworkmanagerConnectAttachmentTimeouts>;
