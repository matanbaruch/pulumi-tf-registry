...
export class NeptuneClusterInstance extends pulumi.CustomResource {
    /**
     * Get an existing NeptuneClusterInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NeptuneClusterInstanceState, opts?: pulumi.CustomResourceOptions): NeptuneClusterInstance {
        return new NeptuneClusterInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/neptuneClusterInstance:NeptuneClusterInstance';

    /**
     * Returns true if the given object is an instance of NeptuneClusterInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NeptuneClusterInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NeptuneClusterInstance.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.NeptuneClusterInstanceTimeouts | undefined>;
    public /*out*/ readonly writer!: pulumi.Output<boolean>;

    /**
     * Create a NeptuneClusterInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NeptuneClusterInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NeptuneClusterInstanceArgs | NeptuneClusterInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NeptuneClusterInstanceState | undefined;
            ...
            const args = argsOrState as NeptuneClusterInstanceArgs | undefined;
        ...
        super(NeptuneClusterInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NeptuneClusterInstance resources.
 */
export interface NeptuneClusterInstanceState {
    ...
    timeouts?: pulumi.Input<inputs.NeptuneClusterInstanceTimeouts>;
    writer?: pulumi.Input<boolean>;
}

/**
 * The set of arguments for constructing a NeptuneClusterInstance resource.
 */
export interface NeptuneClusterInstanceArgs {
    applyImmediately?: pulumi.Input<boolean>;
    autoMinorVersionUpgrade?: pulumi.Input<boolean>;
    availabilityZone?: pulumi.Input<string>;
    clusterIdentifier: pulumi.Input<string>;
