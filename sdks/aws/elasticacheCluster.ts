...
export class ElasticacheCluster extends pulumi.CustomResource {
    /**
     * Get an existing ElasticacheCluster resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ElasticacheClusterState, opts?: pulumi.CustomResourceOptions): ElasticacheCluster {
        return new ElasticacheCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/elasticacheCluster:ElasticacheCluster';

    /**
     * Returns true if the given object is an instance of ElasticacheCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ElasticacheCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ElasticacheCluster.__pulumiType;
    }
    ...
    public /*out*/ readonly cacheNodes!: pulumi.Output<outputs.ElasticacheClusterCacheNode[]>;
    ...
    public readonly logDeliveryConfigurations!: pulumi.Output<outputs.ElasticacheClusterLogDeliveryConfiguration[] | undefined>;
    ...
    /**
     * Create a ElasticacheCluster resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ElasticacheClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ElasticacheClusterArgs | ElasticacheClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ElasticacheClusterState | undefined;
            ...
            const args = argsOrState as ElasticacheClusterArgs | undefined;
        ...
        super(ElasticacheCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ElasticacheCluster resources.
 */
export interface ElasticacheClusterState {
    applyImmediately?: pulumi.Input<boolean>;
    arn?: pulumi.Input<string>;
    autoMinorVersionUpgrade?: pulumi.Input<string>;
    availabilityZone?: pulumi.Input<string>;
    azMode?: pulumi.Input<string>;
    cacheNodes?: pulumi.Input<pulumi.Input<inputs.ElasticacheClusterCacheNode>[]>;
    ...
    logDeliveryConfigurations?: pulumi.Input<pulumi.Input<inputs.ElasticacheClusterLogDeliveryConfiguration>[]>;
...
/**
 * The set of arguments for constructing a ElasticacheCluster resource.
 */
