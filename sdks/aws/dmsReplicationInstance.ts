...
export class DmsReplicationInstance extends pulumi.CustomResource {
    /**
     * Get an existing DmsReplicationInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DmsReplicationInstanceState, opts?: pulumi.CustomResourceOptions): DmsReplicationInstance {
        return new DmsReplicationInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dmsReplicationInstance:DmsReplicationInstance';

    /**
     * Returns true if the given object is an instance of DmsReplicationInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DmsReplicationInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DmsReplicationInstance.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DmsReplicationInstanceTimeouts | undefined>;
    public readonly vpcSecurityGroupIds!: pulumi.Output<string[]>;

    /**
     * Create a DmsReplicationInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DmsReplicationInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DmsReplicationInstanceArgs | DmsReplicationInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DmsReplicationInstanceState | undefined;
            ...
            const args = argsOrState as DmsReplicationInstanceArgs | undefined;
        ...
        super(DmsReplicationInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DmsReplicationInstance resources.
 */
export interface DmsReplicationInstanceState {
    ...
    timeouts?: pulumi.Input<inputs.DmsReplicationInstanceTimeouts>;
    vpcSecurityGroupIds?: pulumi.Input<pulumi.Input<string>[]>;
}

/**
 * The set of arguments for constructing a DmsReplicationInstance resource.
 */
export interface DmsReplicationInstanceArgs {
    allocatedStorage?: pulumi.Input<number>;
    allowMajorVersionUpgrade?: pulumi.Input<boolean>;
    applyImmediately?: pulumi.Input<boolean>;
    autoMinorVersionUpgrade?: pulumi.Input<boolean>;
