...
export class AppstreamFleet extends pulumi.CustomResource {
    /**
     * Get an existing AppstreamFleet resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppstreamFleetState, opts?: pulumi.CustomResourceOptions): AppstreamFleet {
        return new AppstreamFleet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/appstreamFleet:AppstreamFleet';

    /**
     * Returns true if the given object is an instance of AppstreamFleet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppstreamFleet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppstreamFleet.__pulumiType;
    }

    public /*out*/ readonly arn!: pulumi.Output<string>;
    public readonly computeCapacity!: pulumi.Output<outputs.AppstreamFleetComputeCapacity>;
    public /*out*/ readonly createdTime!: pulumi.Output<string>;
    public readonly description!: pulumi.Output<string>;
    public readonly disconnectTimeoutInSeconds!: pulumi.Output<number>;
    public readonly displayName!: pulumi.Output<string>;
    public readonly domainJoinInfo!: pulumi.Output<outputs.AppstreamFleetDomainJoinInfo | undefined>;
    ...
    public readonly vpcConfig!: pulumi.Output<outputs.AppstreamFleetVpcConfig | undefined>;

    /**
     * Create a AppstreamFleet resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppstreamFleetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppstreamFleetArgs | AppstreamFleetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppstreamFleetState | undefined;
            ...
            const args = argsOrState as AppstreamFleetArgs | undefined;
        ...
        super(AppstreamFleet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppstreamFleet resources.
 */
export interface AppstreamFleetState {
    arn?: pulumi.Input<string>;
    computeCapacity?: pulumi.Input<inputs.AppstreamFleetComputeCapacity>;
    createdTime?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    disconnectTimeoutInSeconds?: pulumi.Input<number>;
    displayName?: pulumi.Input<string>;
    domainJoinInfo?: pulumi.Input<inputs.AppstreamFleetDomainJoinInfo>;
    ...
    vpcConfig?: pulumi.Input<inputs.AppstreamFleetVpcConfig>;
}

/**
 * The set of arguments for constructing a AppstreamFleet resource.
 */
export interface AppstreamFleetArgs {
    computeCapacity: pulumi.Input<inputs.AppstreamFleetComputeCapacity>;
    description?: pulumi.Input<string>;
    disconnectTimeoutInSeconds?: pulumi.Input<number>;
    displayName?: pulumi.Input<string>;
