...
export class NetworkmanagerGlobalNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/networkmanagerGlobalNetwork:NetworkmanagerGlobalNetwork';
    ...
    public readonly timeouts!: pulumi.Output<outputs.NetworkmanagerGlobalNetworkTimeouts | undefined>;
...
export interface NetworkmanagerGlobalNetworkState {
    ...
    timeouts?: pulumi.Input<inputs.NetworkmanagerGlobalNetworkTimeouts>;
}
