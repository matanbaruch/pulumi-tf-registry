...
export class VpcEndpointSubnetAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpcEndpointSubnetAssociation:VpcEndpointSubnetAssociation';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpcEndpointSubnetAssociationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VpcEndpointSubnetAssociationArgs | VpcEndpointSubnetAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcEndpointSubnetAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VpcEndpointSubnetAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.VpcEndpointSubnetAssociationTimeouts>;
