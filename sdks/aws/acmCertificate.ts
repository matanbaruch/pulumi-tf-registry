...
export class AcmCertificate extends pulumi.CustomResource {
    /**
     * Get an existing AcmCertificate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AcmCertificateState, opts?: pulumi.CustomResourceOptions): AcmCertificate {
        return new AcmCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/acmCertificate:AcmCertificate';

    /**
     * Returns true if the given object is an instance of AcmCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AcmCertificate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AcmCertificate.__pulumiType;
    }
    ...
    public /*out*/ readonly domainValidationOptions!: pulumi.Output<outputs.AcmCertificateDomainValidationOption[]>;
    ...
    public readonly options!: pulumi.Output<outputs.AcmCertificateOptions | undefined>;
    ...
    public /*out*/ readonly renewalSummaries!: pulumi.Output<outputs.AcmCertificateRenewalSummary[]>;
    ...
    public readonly validationOptions!: pulumi.Output<outputs.AcmCertificateValidationOption[] | undefined>;

    /**
     * Create a AcmCertificate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: AcmCertificateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AcmCertificateArgs | AcmCertificateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AcmCertificateState | undefined;
            ...
            const args = argsOrState as AcmCertificateArgs | undefined;
        ...
        super(AcmCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AcmCertificate resources.
 */
export interface AcmCertificateState {
    ...
    domainValidationOptions?: pulumi.Input<pulumi.Input<inputs.AcmCertificateDomainValidationOption>[]>;
    earlyRenewalDuration?: pulumi.Input<string>;
    keyAlgorithm?: pulumi.Input<string>;
    notAfter?: pulumi.Input<string>;
    notBefore?: pulumi.Input<string>;
    options?: pulumi.Input<inputs.AcmCertificateOptions>;
    pendingRenewal?: pulumi.Input<boolean>;
    privateKey?: pulumi.Input<string>;
    renewalEligibility?: pulumi.Input<string>;
    renewalSummaries?: pulumi.Input<pulumi.Input<inputs.AcmCertificateRenewalSummary>[]>;
    ...
    validationOptions?: pulumi.Input<pulumi.Input<inputs.AcmCertificateValidationOption>[]>;
}

/**
 * The set of arguments for constructing a AcmCertificate resource.
 */
