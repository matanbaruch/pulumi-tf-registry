...
export class Cloudtrail extends pulumi.CustomResource {
    /**
     * Get an existing Cloudtrail resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudtrailState, opts?: pulumi.CustomResourceOptions): Cloudtrail {
        return new Cloudtrail(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/cloudtrail:Cloudtrail';

    /**
     * Returns true if the given object is an instance of Cloudtrail.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Cloudtrail {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Cloudtrail.__pulumiType;
    }

    public readonly advancedEventSelectors!: pulumi.Output<outputs.CloudtrailAdvancedEventSelector[] | undefined>;
    ...
    public readonly eventSelectors!: pulumi.Output<outputs.CloudtrailEventSelector[] | undefined>;
    ...
    public readonly insightSelectors!: pulumi.Output<outputs.CloudtrailInsightSelector[] | undefined>;
    ...
    /**
     * Create a Cloudtrail resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CloudtrailArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudtrailArgs | CloudtrailState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudtrailState | undefined;
            ...
            const args = argsOrState as CloudtrailArgs | undefined;
        ...
        super(Cloudtrail.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Cloudtrail resources.
 */
export interface CloudtrailState {
    advancedEventSelectors?: pulumi.Input<pulumi.Input<inputs.CloudtrailAdvancedEventSelector>[]>;
    ...
    eventSelectors?: pulumi.Input<pulumi.Input<inputs.CloudtrailEventSelector>[]>;
    homeRegion?: pulumi.Input<string>;
    includeGlobalServiceEvents?: pulumi.Input<boolean>;
    insightSelectors?: pulumi.Input<pulumi.Input<inputs.CloudtrailInsightSelector>[]>;
...
/**
 * The set of arguments for constructing a Cloudtrail resource.
 */
