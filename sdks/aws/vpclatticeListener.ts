...
export class VpclatticeListener extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/vpclatticeListener:VpclatticeListener';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VpclatticeListenerTimeouts | undefined>;
...
export interface VpclatticeListenerState {
    ...
    timeouts?: pulumi.Input<inputs.VpclatticeListenerTimeouts>;
}
