...
export class DxTransitVirtualInterface extends pulumi.CustomResource {
    /**
     * Get an existing DxTransitVirtualInterface resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DxTransitVirtualInterfaceState, opts?: pulumi.CustomResourceOptions): DxTransitVirtualInterface {
        return new DxTransitVirtualInterface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/dxTransitVirtualInterface:DxTransitVirtualInterface';

    /**
     * Returns true if the given object is an instance of DxTransitVirtualInterface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DxTransitVirtualInterface {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DxTransitVirtualInterface.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.DxTransitVirtualInterfaceTimeouts | undefined>;
    public readonly vlan!: pulumi.Output<number>;

    /**
     * Create a DxTransitVirtualInterface resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DxTransitVirtualInterfaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DxTransitVirtualInterfaceArgs | DxTransitVirtualInterfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DxTransitVirtualInterfaceState | undefined;
            ...
            const args = argsOrState as DxTransitVirtualInterfaceArgs | undefined;
        ...
        super(DxTransitVirtualInterface.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DxTransitVirtualInterface resources.
 */
export interface DxTransitVirtualInterfaceState {
    ...
    timeouts?: pulumi.Input<inputs.DxTransitVirtualInterfaceTimeouts>;
    vlan?: pulumi.Input<number>;
}

/**
 * The set of arguments for constructing a DxTransitVirtualInterface resource.
 */
export interface DxTransitVirtualInterfaceArgs {
    addressFamily: pulumi.Input<string>;
    amazonAddress?: pulumi.Input<string>;
    bgpAsn: pulumi.Input<number>;
    bgpAuthKey?: pulumi.Input<string>;
