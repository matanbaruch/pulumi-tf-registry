...
export class VolumeAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/volumeAttachment:VolumeAttachment';
    ...
    public readonly timeouts!: pulumi.Output<outputs.VolumeAttachmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: VolumeAttachmentArgs | VolumeAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VolumeAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface VolumeAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.VolumeAttachmentTimeouts>;
