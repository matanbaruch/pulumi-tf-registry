...
export class CloudformationType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:index/cloudformationType:CloudformationType';
    ...
    constructor(name: string, argsOrState?: CloudformationTypeArgs | CloudformationTypeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CloudformationType.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
