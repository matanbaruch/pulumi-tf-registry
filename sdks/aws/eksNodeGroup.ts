...
export class EksNodeGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EksNodeGroupState, opts?: pulumi.CustomResourceOptions): EksNodeGroup {
        return new EksNodeGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:index/eksNodeGroup:EksNodeGroup';
    ...
    public readonly launchTemplate!: pulumi.Output<outputs.EksNodeGroupLaunchTemplate | undefined>;
    ...
    public readonly remoteAccess!: pulumi.Output<outputs.EksNodeGroupRemoteAccess | undefined>;
    public /*out*/ readonly resources!: pulumi.Output<outputs.EksNodeGroupResource[]>;
    public readonly scalingConfig!: pulumi.Output<outputs.EksNodeGroupScalingConfig>;
    public /*out*/ readonly status!: pulumi.Output<string>;
    public readonly subnetIds!: pulumi.Output<string[]>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly tagsAll!: pulumi.Output<{[key: string]: string}>;
    public readonly taints!: pulumi.Output<outputs.EksNodeGroupTaint[] | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.EksNodeGroupTimeouts | undefined>;
    public readonly updateConfig!: pulumi.Output<outputs.EksNodeGroupUpdateConfig | undefined>;
    ...
    constructor(name: string, argsOrState?: EksNodeGroupArgs | EksNodeGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EksNodeGroupState | undefined;
            ...
            const args = argsOrState as EksNodeGroupArgs | undefined;
        ...
        super(EksNodeGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface EksNodeGroupState {
    ...
    launchTemplate?: pulumi.Input<inputs.EksNodeGroupLaunchTemplate>;
    nodeGroupName?: pulumi.Input<string>;
    nodeGroupNamePrefix?: pulumi.Input<string>;
    nodeRoleArn?: pulumi.Input<string>;
    releaseVersion?: pulumi.Input<string>;
    remoteAccess?: pulumi.Input<inputs.EksNodeGroupRemoteAccess>;
    resources?: pulumi.Input<pulumi.Input<inputs.EksNodeGroupResource>[]>;
    scalingConfig?: pulumi.Input<inputs.EksNodeGroupScalingConfig>;
    status?: pulumi.Input<string>;
    subnetIds?: pulumi.Input<pulumi.Input<string>[]>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    tagsAll?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    taints?: pulumi.Input<pulumi.Input<inputs.EksNodeGroupTaint>[]>;
    timeouts?: pulumi.Input<inputs.EksNodeGroupTimeouts>;
    updateConfig?: pulumi.Input<inputs.EksNodeGroupUpdateConfig>;
