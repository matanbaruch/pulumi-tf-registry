...
export class PanoramaAggregateInterface extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaAggregateInterface resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaAggregateInterfaceState, opts?: pulumi.CustomResourceOptions): PanoramaAggregateInterface {
        return new PanoramaAggregateInterface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaAggregateInterface:PanoramaAggregateInterface';

    /**
     * Returns true if the given object is an instance of PanoramaAggregateInterface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaAggregateInterface {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaAggregateInterface.__pulumiType;
    }
    ...
    /**
     * Create a PanoramaAggregateInterface resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaAggregateInterfaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaAggregateInterfaceArgs | PanoramaAggregateInterfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaAggregateInterfaceState | undefined;
            ...
            const args = argsOrState as PanoramaAggregateInterfaceArgs | undefined;
        ...
        super(PanoramaAggregateInterface.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaAggregateInterface resources.
 */
export interface PanoramaAggregateInterfaceState {
...
/**
 * The set of arguments for constructing a PanoramaAggregateInterface resource.
 */
export interface PanoramaAggregateInterfaceArgs {
    adjustTcpMss?: pulumi.Input<boolean>;
    comment?: pulumi.Input<string>;
    createDhcpDefaultRoute?: pulumi.Input<boolean>;
    decryptForward?: pulumi.Input<boolean>;
