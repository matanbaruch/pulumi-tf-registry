...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("panos");
			params.setVersion("1.11.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BhbG9hbHRvbmV0d29ya3MvcGFub3MiLCJ2ZXJzaW9uIjoiMS4xMS4xIn19"), c => c.charCodeAt(0)));
