...
export class IpsecCryptoProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/ipsecCryptoProfile:IpsecCryptoProfile';
    ...
    constructor(name: string, argsOrState?: IpsecCryptoProfileArgs | IpsecCryptoProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IpsecCryptoProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
