...
export class DeviceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/deviceGroup:DeviceGroup';
     ...
     */
    public readonly devices!: pulumi.Output<outputs.DeviceGroupDevice[] | undefined>;
...
export interface DeviceGroupState {
     ...
     * NGFW serial numbers and vsys spec.
     */
    devices?: pulumi.Input<pulumi.Input<inputs.DeviceGroupDevice>[]>;
