...
export class GreTunnel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/greTunnel:GreTunnel';
    ...
    constructor(name: string, argsOrState?: GreTunnelArgs | GreTunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GreTunnel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
