...
export class PanoramaRedistributionProfileIpv4 extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaRedistributionProfileIpv4 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaRedistributionProfileIpv4State, opts?: pulumi.CustomResourceOptions): PanoramaRedistributionProfileIpv4 {
        return new PanoramaRedistributionProfileIpv4(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaRedistributionProfileIpv4:PanoramaRedistributionProfileIpv4';

    /**
     * Returns true if the given object is an instance of PanoramaRedistributionProfileIpv4.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaRedistributionProfileIpv4 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaRedistributionProfileIpv4.__pulumiType;
    }
    ...
    /**
     * Create a PanoramaRedistributionProfileIpv4 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaRedistributionProfileIpv4Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaRedistributionProfileIpv4Args | PanoramaRedistributionProfileIpv4State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaRedistributionProfileIpv4State | undefined;
            ...
            const args = argsOrState as PanoramaRedistributionProfileIpv4Args | undefined;
        ...
        super(PanoramaRedistributionProfileIpv4.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaRedistributionProfileIpv4 resources.
 */
export interface PanoramaRedistributionProfileIpv4State {
...
/**
 * The set of arguments for constructing a PanoramaRedistributionProfileIpv4 resource.
 */
export interface PanoramaRedistributionProfileIpv4Args {
    action?: pulumi.Input<string>;
    bgpCommunities?: pulumi.Input<pulumi.Input<string>[]>;
    bgpExtendedCommunities?: pulumi.Input<pulumi.Input<string>[]>;
    destinations?: pulumi.Input<pulumi.Input<string>[]>;
