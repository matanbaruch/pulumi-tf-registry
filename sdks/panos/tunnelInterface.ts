...
export class TunnelInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/tunnelInterface:TunnelInterface';
    ...
    constructor(name: string, argsOrState?: TunnelInterfaceArgs | TunnelInterfaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TunnelInterface.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
