...
export class SecurityPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/securityPolicy:SecurityPolicy';
    ...
    public readonly timeouts!: pulumi.Output<outputs.SecurityPolicyTimeouts | undefined>;
    /**
...
export interface SecurityPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.SecurityPolicyTimeouts>;
    /**
     * The vsys this object belongs in.
     */
