...
export class PanoramaIpsecTunnelProxyIdIpv4 extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaIpsecTunnelProxyIdIpv4 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaIpsecTunnelProxyIdIpv4State, opts?: pulumi.CustomResourceOptions): PanoramaIpsecTunnelProxyIdIpv4 {
        return new PanoramaIpsecTunnelProxyIdIpv4(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaIpsecTunnelProxyIdIpv4:PanoramaIpsecTunnelProxyIdIpv4';

    /**
     * Returns true if the given object is an instance of PanoramaIpsecTunnelProxyIdIpv4.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaIpsecTunnelProxyIdIpv4 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaIpsecTunnelProxyIdIpv4.__pulumiType;
    }
    ...
    /**
     * Create a PanoramaIpsecTunnelProxyIdIpv4 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaIpsecTunnelProxyIdIpv4Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaIpsecTunnelProxyIdIpv4Args | PanoramaIpsecTunnelProxyIdIpv4State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaIpsecTunnelProxyIdIpv4State | undefined;
            ...
            const args = argsOrState as PanoramaIpsecTunnelProxyIdIpv4Args | undefined;
        ...
        super(PanoramaIpsecTunnelProxyIdIpv4.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaIpsecTunnelProxyIdIpv4 resources.
 */
export interface PanoramaIpsecTunnelProxyIdIpv4State {
...
/**
 * The set of arguments for constructing a PanoramaIpsecTunnelProxyIdIpv4 resource.
 */
export interface PanoramaIpsecTunnelProxyIdIpv4Args {
    ipsecTunnel: pulumi.Input<string>;
    local?: pulumi.Input<string>;
    name?: pulumi.Input<string>;
    protocolAny?: pulumi.Input<boolean>;
