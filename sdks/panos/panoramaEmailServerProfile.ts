...
export class PanoramaEmailServerProfile extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaEmailServerProfile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaEmailServerProfileState, opts?: pulumi.CustomResourceOptions): PanoramaEmailServerProfile {
        return new PanoramaEmailServerProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaEmailServerProfile:PanoramaEmailServerProfile';

    /**
     * Returns true if the given object is an instance of PanoramaEmailServerProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaEmailServerProfile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaEmailServerProfile.__pulumiType;
    }
    ...
    public readonly emailServers!: pulumi.Output<outputs.PanoramaEmailServerProfileEmailServer[]>;
    ...
    /**
     * Create a PanoramaEmailServerProfile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaEmailServerProfileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaEmailServerProfileArgs | PanoramaEmailServerProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaEmailServerProfileState | undefined;
            ...
            const args = argsOrState as PanoramaEmailServerProfileArgs | undefined;
        ...
        super(PanoramaEmailServerProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaEmailServerProfile resources.
 */
export interface PanoramaEmailServerProfileState {
    ...
    emailServers?: pulumi.Input<pulumi.Input<inputs.PanoramaEmailServerProfileEmailServer>[]>;
...
/**
 * The set of arguments for constructing a PanoramaEmailServerProfile resource.
 */
export interface PanoramaEmailServerProfileArgs {
    authFormat?: pulumi.Input<string>;
    configFormat?: pulumi.Input<string>;
    dataFormat?: pulumi.Input<string>;
    /**
