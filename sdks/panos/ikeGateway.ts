...
export class IkeGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/ikeGateway:IkeGateway';
    ...
    constructor(name: string, argsOrState?: IkeGatewayArgs | IkeGatewayState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IkeGateway.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
