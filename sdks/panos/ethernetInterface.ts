...
export class EthernetInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/ethernetInterface:EthernetInterface';
    ...
    constructor(name: string, argsOrState?: EthernetInterfaceArgs | EthernetInterfaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EthernetInterface.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
