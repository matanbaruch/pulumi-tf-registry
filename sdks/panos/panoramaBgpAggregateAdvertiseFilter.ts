...
export class PanoramaBgpAggregateAdvertiseFilter extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaBgpAggregateAdvertiseFilter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaBgpAggregateAdvertiseFilterState, opts?: pulumi.CustomResourceOptions): PanoramaBgpAggregateAdvertiseFilter {
        return new PanoramaBgpAggregateAdvertiseFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaBgpAggregateAdvertiseFilter:PanoramaBgpAggregateAdvertiseFilter';

    /**
     * Returns true if the given object is an instance of PanoramaBgpAggregateAdvertiseFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaBgpAggregateAdvertiseFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaBgpAggregateAdvertiseFilter.__pulumiType;
    }

    public readonly addressPrefixes!: pulumi.Output<outputs.PanoramaBgpAggregateAdvertiseFilterAddressPrefix[] | undefined>;
    ...
    /**
     * Create a PanoramaBgpAggregateAdvertiseFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaBgpAggregateAdvertiseFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaBgpAggregateAdvertiseFilterArgs | PanoramaBgpAggregateAdvertiseFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaBgpAggregateAdvertiseFilterState | undefined;
            ...
            const args = argsOrState as PanoramaBgpAggregateAdvertiseFilterArgs | undefined;
        ...
        super(PanoramaBgpAggregateAdvertiseFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaBgpAggregateAdvertiseFilter resources.
 */
export interface PanoramaBgpAggregateAdvertiseFilterState {
    addressPrefixes?: pulumi.Input<pulumi.Input<inputs.PanoramaBgpAggregateAdvertiseFilterAddressPrefix>[]>;
...
/**
 * The set of arguments for constructing a PanoramaBgpAggregateAdvertiseFilter resource.
 */
export interface PanoramaBgpAggregateAdvertiseFilterArgs {
    addressPrefixes?: pulumi.Input<pulumi.Input<inputs.PanoramaBgpAggregateAdvertiseFilterAddressPrefix>[]>;
    asPathRegex?: pulumi.Input<string>;
    bgpAggregate: pulumi.Input<string>;
    communityRegex?: pulumi.Input<string>;
