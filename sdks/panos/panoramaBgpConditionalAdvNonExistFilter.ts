...
export class PanoramaBgpConditionalAdvNonExistFilter extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaBgpConditionalAdvNonExistFilter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaBgpConditionalAdvNonExistFilterState, opts?: pulumi.CustomResourceOptions): PanoramaBgpConditionalAdvNonExistFilter {
        return new PanoramaBgpConditionalAdvNonExistFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaBgpConditionalAdvNonExistFilter:PanoramaBgpConditionalAdvNonExistFilter';

    /**
     * Returns true if the given object is an instance of PanoramaBgpConditionalAdvNonExistFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaBgpConditionalAdvNonExistFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaBgpConditionalAdvNonExistFilter.__pulumiType;
    }
    ...
    /**
     * Create a PanoramaBgpConditionalAdvNonExistFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaBgpConditionalAdvNonExistFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaBgpConditionalAdvNonExistFilterArgs | PanoramaBgpConditionalAdvNonExistFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaBgpConditionalAdvNonExistFilterState | undefined;
            ...
            const args = argsOrState as PanoramaBgpConditionalAdvNonExistFilterArgs | undefined;
        ...
        super(PanoramaBgpConditionalAdvNonExistFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaBgpConditionalAdvNonExistFilter resources.
 */
export interface PanoramaBgpConditionalAdvNonExistFilterState {
...
/**
 * The set of arguments for constructing a PanoramaBgpConditionalAdvNonExistFilter resource.
 */
export interface PanoramaBgpConditionalAdvNonExistFilterArgs {
    addressPrefixes: pulumi.Input<pulumi.Input<string>[]>;
    asPathRegex?: pulumi.Input<string>;
    bgpConditionalAdv: pulumi.Input<string>;
    communityRegex?: pulumi.Input<string>;
