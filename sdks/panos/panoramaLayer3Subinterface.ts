...
export class PanoramaLayer3Subinterface extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaLayer3Subinterface resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaLayer3SubinterfaceState, opts?: pulumi.CustomResourceOptions): PanoramaLayer3Subinterface {
        return new PanoramaLayer3Subinterface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaLayer3Subinterface:PanoramaLayer3Subinterface';

    /**
     * Returns true if the given object is an instance of PanoramaLayer3Subinterface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaLayer3Subinterface {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaLayer3Subinterface.__pulumiType;
    }
    ...
    /**
     * Create a PanoramaLayer3Subinterface resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaLayer3SubinterfaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaLayer3SubinterfaceArgs | PanoramaLayer3SubinterfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaLayer3SubinterfaceState | undefined;
            ...
            const args = argsOrState as PanoramaLayer3SubinterfaceArgs | undefined;
        ...
        super(PanoramaLayer3Subinterface.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaLayer3Subinterface resources.
 */
export interface PanoramaLayer3SubinterfaceState {
...
/**
 * The set of arguments for constructing a PanoramaLayer3Subinterface resource.
 */
export interface PanoramaLayer3SubinterfaceArgs {
    adjustTcpMss?: pulumi.Input<boolean>;
    comment?: pulumi.Input<string>;
    createDhcpDefaultRoute?: pulumi.Input<boolean>;
    decryptForward?: pulumi.Input<boolean>;
