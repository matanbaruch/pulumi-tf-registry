...
export class PanoramaBgp extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaBgp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaBgpState, opts?: pulumi.CustomResourceOptions): PanoramaBgp {
        return new PanoramaBgp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaBgp:PanoramaBgp';

    /**
     * Returns true if the given object is an instance of PanoramaBgp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaBgp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaBgp.__pulumiType;
    }
    ...
    /**
     * Create a PanoramaBgp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PanoramaBgpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaBgpArgs | PanoramaBgpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaBgpState | undefined;
            ...
            const args = argsOrState as PanoramaBgpArgs | undefined;
        ...
        super(PanoramaBgp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaBgp resources.
 */
export interface PanoramaBgpState {
...
/**
 * The set of arguments for constructing a PanoramaBgp resource.
 */
export interface PanoramaBgpArgs {
    aggregateMed?: pulumi.Input<boolean>;
    allowRedistributeDefaultRoute?: pulumi.Input<boolean>;
    alwaysCompareMed?: pulumi.Input<boolean>;
    asFormat?: pulumi.Input<string>;
