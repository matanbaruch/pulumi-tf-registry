...
export class BgpAggregateAdvertiseFilter extends pulumi.CustomResource {
    /**
     * Get an existing BgpAggregateAdvertiseFilter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BgpAggregateAdvertiseFilterState, opts?: pulumi.CustomResourceOptions): BgpAggregateAdvertiseFilter {
        return new BgpAggregateAdvertiseFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/bgpAggregateAdvertiseFilter:BgpAggregateAdvertiseFilter';

    /**
     * Returns true if the given object is an instance of BgpAggregateAdvertiseFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BgpAggregateAdvertiseFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === BgpAggregateAdvertiseFilter.__pulumiType;
    }

    public readonly addressPrefixes!: pulumi.Output<outputs.BgpAggregateAdvertiseFilterAddressPrefix[] | undefined>;
    ...
    /**
     * Create a BgpAggregateAdvertiseFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: BgpAggregateAdvertiseFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: BgpAggregateAdvertiseFilterArgs | BgpAggregateAdvertiseFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BgpAggregateAdvertiseFilterState | undefined;
            ...
            const args = argsOrState as BgpAggregateAdvertiseFilterArgs | undefined;
        ...
        super(BgpAggregateAdvertiseFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering BgpAggregateAdvertiseFilter resources.
 */
export interface BgpAggregateAdvertiseFilterState {
    addressPrefixes?: pulumi.Input<pulumi.Input<inputs.BgpAggregateAdvertiseFilterAddressPrefix>[]>;
...
/**
 * The set of arguments for constructing a BgpAggregateAdvertiseFilter resource.
 */
export interface BgpAggregateAdvertiseFilterArgs {
    addressPrefixes?: pulumi.Input<pulumi.Input<inputs.BgpAggregateAdvertiseFilterAddressPrefix>[]>;
    asPathRegex?: pulumi.Input<string>;
    bgpAggregate: pulumi.Input<string>;
    communityRegex?: pulumi.Input<string>;
