...
export class PanoramaZone extends pulumi.CustomResource {
    /**
     * Get an existing PanoramaZone resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PanoramaZoneState, opts?: pulumi.CustomResourceOptions): PanoramaZone {
        return new PanoramaZone(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'panos:index/panoramaZone:PanoramaZone';

    /**
     * Returns true if the given object is an instance of PanoramaZone.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PanoramaZone {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PanoramaZone.__pulumiType;
    }
    ...
    /**
     * Create a PanoramaZone resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PanoramaZoneArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PanoramaZoneArgs | PanoramaZoneState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PanoramaZoneState | undefined;
            ...
            const args = argsOrState as PanoramaZoneArgs | undefined;
        ...
        super(PanoramaZone.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PanoramaZone resources.
 */
export interface PanoramaZoneState {
    /**
     * Boolean to enable user identification.
     */
...
/**
 * The set of arguments for constructing a PanoramaZone resource.
 */
export interface PanoramaZoneArgs {
    /**
     * Boolean to enable user identification.
     */
    enableUserId?: pulumi.Input<boolean>;
