...
export class SyslogServerProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'panos:index/syslogServerProfile:SyslogServerProfile';
    ...
    public readonly syslogServers!: pulumi.Output<outputs.SyslogServerProfileSyslogServer[]>;
    ...
    constructor(name: string, argsOrState?: SyslogServerProfileArgs | SyslogServerProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SyslogServerProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SyslogServerProfileState {
    ...
    syslogServers?: pulumi.Input<pulumi.Input<inputs.SyslogServerProfileSyslogServer>[]>;
