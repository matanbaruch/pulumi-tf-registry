...
export class PeeringGroup extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.PeeringGroupTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PeeringGroupArgs | PeeringGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PeeringGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PeeringGroupState {
    ...
    timeouts?: pulumi.Input<inputs.PeeringGroupTimeouts>;
}
