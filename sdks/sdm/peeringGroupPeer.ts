...
export class PeeringGroupPeer extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.PeeringGroupPeerTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PeeringGroupPeerArgs | PeeringGroupPeerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PeeringGroupPeer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PeeringGroupPeerState {
    ...
    timeouts?: pulumi.Input<inputs.PeeringGroupPeerTimeouts>;
}
