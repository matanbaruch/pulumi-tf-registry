...
export class PeeringGroupResource extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.PeeringGroupResourceTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PeeringGroupResourceArgs | PeeringGroupResourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PeeringGroupResource.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PeeringGroupResourceState {
    ...
    timeouts?: pulumi.Input<inputs.PeeringGroupResourceTimeouts>;
}
