...
export class RemoteIdentity extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.RemoteIdentityTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RemoteIdentityArgs | RemoteIdentityState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RemoteIdentity.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RemoteIdentityState {
    ...
    timeouts?: pulumi.Input<inputs.RemoteIdentityTimeouts>;
    /**
     * The username to be used as the remote identity for this account.
     */
