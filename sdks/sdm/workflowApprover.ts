...
export class WorkflowApprover extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.WorkflowApproverTimeouts | undefined>;
    /**
     * The workflow id.
     */
    ...
    constructor(name: string, argsOrState?: WorkflowApproverArgs | WorkflowApproverState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WorkflowApprover.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface WorkflowApproverState {
    ...
    timeouts?: pulumi.Input<inputs.WorkflowApproverTimeouts>;
    /**
     * The workflow id.
     */
