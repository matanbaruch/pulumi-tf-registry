...
export class ApprovalWorkflowApprover extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ApprovalWorkflowApproverTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ApprovalWorkflowApproverArgs | ApprovalWorkflowApproverState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApprovalWorkflowApprover.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ApprovalWorkflowApproverState {
    ...
    timeouts?: pulumi.Input<inputs.ApprovalWorkflowApproverTimeouts>;
}
