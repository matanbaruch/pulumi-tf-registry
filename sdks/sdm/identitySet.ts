...
export class IdentitySet extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.IdentitySetTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: IdentitySetArgs | IdentitySetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IdentitySet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface IdentitySetState {
    ...
    timeouts?: pulumi.Input<inputs.IdentitySetTimeouts>;
}
