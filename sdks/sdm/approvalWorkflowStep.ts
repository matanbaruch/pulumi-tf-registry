...
export class ApprovalWorkflowStep extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ApprovalWorkflowStepTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ApprovalWorkflowStepArgs | ApprovalWorkflowStepState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApprovalWorkflowStep.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ApprovalWorkflowStepState {
    ...
    timeouts?: pulumi.Input<inputs.ApprovalWorkflowStepTimeouts>;
}
