...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("njalla");
			params.setVersion("0.10.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3NpZ2hlcnkvbmphbGxhIiwidmVyc2lvbiI6IjAuMTAuMCJ9fQ=="), c => c.charCodeAt(0)));
