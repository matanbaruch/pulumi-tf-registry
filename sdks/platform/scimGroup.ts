...
export class ScimGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'platform:index/scimGroup:ScimGroup';
    ...
    public readonly members!: pulumi.Output<outputs.ScimGroupMember[]>;
...
export interface ScimGroupState {
    ...
    members?: pulumi.Input<pulumi.Input<inputs.ScimGroupMember>[]>;
