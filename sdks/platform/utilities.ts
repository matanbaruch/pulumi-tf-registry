...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("platform");
			params.setVersion("1.11.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2pmcm9nL3BsYXRmb3JtIiwidmVyc2lvbiI6IjEuMTEuMCJ9fQ=="), c => c.charCodeAt(0)));
