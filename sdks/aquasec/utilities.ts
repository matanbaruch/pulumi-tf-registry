...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("aquasec");
			params.setVersion("0.8.29");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FxdWFzZWN1cml0eS9hcXVhc2VjIiwidmVyc2lvbiI6IjAuOC4yOSJ9fQ=="), c => c.charCodeAt(0)));
