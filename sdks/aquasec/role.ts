...
export class Role extends pulumi.CustomResource {
    ...
    /**
     * The name of the user who created the role. Only returned from the API for existing permissions, not part of the
     * permission creation/modification structure.
     */
