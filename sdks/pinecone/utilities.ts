...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pinecone");
			params.setVersion("0.7.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BpbmVjb25lLWlvL3BpbmVjb25lIiwidmVyc2lvbiI6IjAuNy40In19"), c => c.charCodeAt(0)));
