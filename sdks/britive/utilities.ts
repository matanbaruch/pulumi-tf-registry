...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("britive");
			params.setVersion("2.0.10");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2JyaXRpdmUvYnJpdGl2ZSIsInZlcnNpb24iOiIyLjAuMTAifX0="), c => c.charCodeAt(0)));
