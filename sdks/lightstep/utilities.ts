...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("lightstep");
			params.setVersion("1.98.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2xpZ2h0c3RlcC9saWdodHN0ZXAiLCJ2ZXJzaW9uIjoiMS45OC4xIn19"), c => c.charCodeAt(0)));
