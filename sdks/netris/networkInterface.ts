...
export class NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'netris:index/networkInterface:NetworkInterface';
    ...
    /**
     * Toggle interface speed, make sure that current node supports the configured speed. Possibe values: `auto`, `1g`, `10g`,
     * `25g`, `40g`, `50g`, `100g`, `200g`, `400g`. Default value is `auto`
     */
