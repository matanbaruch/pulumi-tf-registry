...
export class UserRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'netris:index/userRole:UserRole';
     ...
     */
    public readonly pgroup!: pulumi.Output<string>;
    /**
     * List of tenant IDs
     */
    public readonly tenantids!: pulumi.Output<number[] | undefined>;
    ...
    constructor(name: string, argsOrState?: UserRoleArgs | UserRoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.pgroup === undefined) && !opts.urn) {
                throw new Error("Missing required property 'pgroup'");
            }
...
export interface UserRoleState {
     ...
     * List of tenant IDs
     */
    tenantids?: pulumi.Input<pulumi.Input<number>[]>;
}
