...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("prismacloudcompute");
			params.setVersion("0.8.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BhbG9hbHRvbmV0d29ya3MvcHJpc21hY2xvdWRjb21wdXRlIiwidmVyc2lvbiI6IjAuOC4wIn19"), c => c.charCodeAt(0)));
