...
export class HostRuntimePolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prismacloudcompute:index/hostRuntimePolicy:HostRuntimePolicy';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.HostRuntimePolicyRule[] | undefined>;
...
export interface HostRuntimePolicyState {
     ...
     * Rules that make up the policy.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.HostRuntimePolicyRule>[]>;
}
