...
export class ContainerRuntimePolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'prismacloudcompute:index/containerRuntimePolicy:ContainerRuntimePolicy';
     ...
     */
    public readonly learningDisabled!: pulumi.Output<boolean | undefined>;
    /**
     * Rules that make up the policy.
     */
    public readonly rules!: pulumi.Output<outputs.ContainerRuntimePolicyRule[] | undefined>;
    ...
    constructor(name: string, argsOrState?: ContainerRuntimePolicyArgs | ContainerRuntimePolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["learningDisabled"] = state ? state.learningDisabled : undefined;
            resourceInputs["rules"] = state ? state.rules : undefined;
        } else {
            const args = argsOrState as ContainerRuntimePolicyArgs | undefined;
            resourceInputs["learningDisabled"] = args ? args.learningDisabled : undefined;
...
export interface ContainerRuntimePolicyState {
     ...
     * Whether or not to disable automatic behavioral learning.
     */
    learningDisabled?: pulumi.Input<boolean>;
    /**
     * Rules that make up the policy.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.ContainerRuntimePolicyRule>[]>;
}
