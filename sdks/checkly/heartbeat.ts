...
export class Heartbeat extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'checkly:index/heartbeat:Heartbeat';
    ...
    public readonly alertChannelSubscriptions!: pulumi.Output<outputs.HeartbeatAlertChannelSubscription[] | undefined>;
    public readonly alertSettings!: pulumi.Output<outputs.HeartbeatAlertSettings | undefined>;
    public readonly heartbeat!: pulumi.Output<outputs.HeartbeatHeartbeat>;
    /**
...
export interface HeartbeatState {
    ...
    alertChannelSubscriptions?: pulumi.Input<pulumi.Input<inputs.HeartbeatAlertChannelSubscription>[]>;
    alertSettings?: pulumi.Input<inputs.HeartbeatAlertSettings>;
    heartbeat?: pulumi.Input<inputs.HeartbeatHeartbeat>;
    /**
     * Determines if any notifications will be sent out when a check fails/degrades/recovers.
     */
