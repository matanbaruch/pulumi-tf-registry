...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("checkly");
			params.setVersion("1.8.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NoZWNrbHkvY2hlY2tseSIsInZlcnNpb24iOiIxLjguMiJ9fQ=="), c => c.charCodeAt(0)));
