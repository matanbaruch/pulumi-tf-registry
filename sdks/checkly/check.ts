...
export class Check extends pulumi.CustomResource {
    ...
    /**
     * An array of channel IDs and whether they're activated or not. If you don't set at least one alert subscription for your
     * check, we won't be able to alert you in case something goes wrong with it.
     */
    public readonly alertChannelSubscriptions!: pulumi.Output<outputs.CheckAlertChannelSubscription[] | undefined>;
    public readonly alertSettings!: pulumi.Output<outputs.CheckAlertSettings | undefined>;
    /**
     ...
     */
    public readonly retryStrategy!: pulumi.Output<outputs.CheckRetryStrategy | undefined>;
    /**
