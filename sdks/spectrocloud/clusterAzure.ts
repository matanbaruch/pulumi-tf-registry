...
export class ClusterAzure extends pulumi.CustomResource {
    /**
     * Get an existing ClusterAzure resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterAzureState, opts?: pulumi.CustomResourceOptions): ClusterAzure {
        return new ClusterAzure(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/clusterAzure:ClusterAzure';

    /**
     * Returns true if the given object is an instance of ClusterAzure.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClusterAzure {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClusterAzure.__pulumiType;
    }
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.ClusterAzureBackupPolicy | undefined>;
    /**
    ...
    public readonly cloudConfig!: pulumi.Output<outputs.ClusterAzureCloudConfig>;
    /**
    ...
    public readonly clusterProfiles!: pulumi.Output<outputs.ClusterAzureClusterProfile[] | undefined>;
    /**
     * The RBAC binding for the cluster.
     */
    public readonly clusterRbacBindings!: pulumi.Output<outputs.ClusterAzureClusterRbacBinding[] | undefined>;
     ...
     */
    public readonly hostConfigs!: pulumi.Output<outputs.ClusterAzureHostConfig[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly locationConfigs!: pulumi.Output<outputs.ClusterAzureLocationConfig[]>;
    public readonly machinePools!: pulumi.Output<outputs.ClusterAzureMachinePool[]>;
    /**
     ...
     */
    public readonly namespaces!: pulumi.Output<outputs.ClusterAzureNamespace[] | undefined>;
    /**
     ...
     */
    public readonly scanPolicy!: pulumi.Output<outputs.ClusterAzureScanPolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClusterAzureTimeouts | undefined>;

    /**
     * Create a ClusterAzure resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClusterAzureArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClusterAzureArgs | ClusterAzureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterAzureState | undefined;
            ...
            const args = argsOrState as ClusterAzureArgs | undefined;
        ...
        super(ClusterAzure.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClusterAzure resources.
 */
export interface ClusterAzureState {
    /**
     * Admin Kube-config for the cluster. This can be used to connect to the cluster using `kubectl`, With admin privilege.
     */
     ...
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterAzureBackupPolicy>;
    /**
     * ID of the cloud account to be used for the cluster. This cloud account must be of type `azure`.
     */
    cloudAccountId?: pulumi.Input<string>;
    cloudConfig?: pulumi.Input<inputs.ClusterAzureCloudConfig>;
    /**
     * ID of the cloud config used for the cluster. This cloud config must be of type `azure`.
     *
     * @deprecated Deprecated
    ...
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.ClusterAzureClusterProfile>[]>;
    /**
     * The RBAC binding for the cluster.
     */
    clusterRbacBindings?: pulumi.Input<pulumi.Input<inputs.ClusterAzureClusterRbacBinding>[]>;
     ...
     * The host configuration for the cluster.
     */
    hostConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterAzureHostConfig>[]>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
     ...
     * The location of the cluster.
     */
    locationConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterAzureLocationConfig>[]>;
    machinePools?: pulumi.Input<pulumi.Input<inputs.ClusterAzureMachinePool>[]>;
    /**
     * Name of the cluster. This name will be used to create the cluster in Azure.
     */
     ...
     * The namespaces for the cluster.
     */
    namespaces?: pulumi.Input<pulumi.Input<inputs.ClusterAzureNamespace>[]>;
    /**
     * Date and time after which to patch cluster `RFC3339: 2006-01-02T15:04:05Z07:00`
     */
     ...
     * The scan policy for the cluster.
     */
    scanPolicy?: pulumi.Input<inputs.ClusterAzureScanPolicy>;
    /**
     * If `true`, the cluster will be created asynchronously. Default value is `false`.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClusterAzureTimeouts>;
}

/**
 * The set of arguments for constructing a ClusterAzure resource.
 */
export interface ClusterAzureArgs {
    /**
     * The setting to apply the cluster profile. `DownloadAndInstall` will download and install packs in one action.
     * `DownloadAndInstallLater` will only download artifact and postpone install for later. Default value is
     * `DownloadAndInstall`.
