...
export class ClusterAws extends pulumi.CustomResource {
    /**
     * Get an existing ClusterAws resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterAwsState, opts?: pulumi.CustomResourceOptions): ClusterAws {
        return new ClusterAws(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/clusterAws:ClusterAws';

    /**
     * Returns true if the given object is an instance of ClusterAws.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClusterAws {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClusterAws.__pulumiType;
    }
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.ClusterAwsBackupPolicy | undefined>;
    public readonly cloudAccountId!: pulumi.Output<string>;
    public readonly cloudConfig!: pulumi.Output<outputs.ClusterAwsCloudConfig>;
    /**
    ...
    public readonly clusterProfiles!: pulumi.Output<outputs.ClusterAwsClusterProfile[] | undefined>;
    /**
     * The RBAC binding for the cluster.
     */
    public readonly clusterRbacBindings!: pulumi.Output<outputs.ClusterAwsClusterRbacBinding[] | undefined>;
     ...
     */
    public readonly hostConfigs!: pulumi.Output<outputs.ClusterAwsHostConfig[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly locationConfigs!: pulumi.Output<outputs.ClusterAwsLocationConfig[]>;
    public readonly machinePools!: pulumi.Output<outputs.ClusterAwsMachinePool[]>;
    public readonly name!: pulumi.Output<string>;
    /**
     * The namespaces for the cluster.
     */
    public readonly namespaces!: pulumi.Output<outputs.ClusterAwsNamespace[] | undefined>;
    /**
     ...
     */
    public readonly scanPolicy!: pulumi.Output<outputs.ClusterAwsScanPolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClusterAwsTimeouts | undefined>;

    /**
     * Create a ClusterAws resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClusterAwsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClusterAwsArgs | ClusterAwsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterAwsState | undefined;
            ...
            const args = argsOrState as ClusterAwsArgs | undefined;
        ...
        super(ClusterAws.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClusterAws resources.
 */
export interface ClusterAwsState {
    /**
     * Admin Kube-config for the cluster. This can be used to connect to the cluster using `kubectl`, With admin privilege.
     */
     ...
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterAwsBackupPolicy>;
    cloudAccountId?: pulumi.Input<string>;
    cloudConfig?: pulumi.Input<inputs.ClusterAwsCloudConfig>;
    /**
     * ID of the cloud config used for the cluster. This cloud config must be of type `azure`.
     *
     * @deprecated Deprecated
    ...
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.ClusterAwsClusterProfile>[]>;
    /**
     * The RBAC binding for the cluster.
     */
    clusterRbacBindings?: pulumi.Input<pulumi.Input<inputs.ClusterAwsClusterRbacBinding>[]>;
     ...
     * The host configuration for the cluster.
     */
    hostConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterAwsHostConfig>[]>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
     ...
     * The location of the cluster.
     */
    locationConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterAwsLocationConfig>[]>;
    machinePools?: pulumi.Input<pulumi.Input<inputs.ClusterAwsMachinePool>[]>;
    name?: pulumi.Input<string>;
    /**
     * The namespaces for the cluster.
     */
    namespaces?: pulumi.Input<pulumi.Input<inputs.ClusterAwsNamespace>[]>;
    /**
     * Date and time after which to patch cluster `RFC3339: 2006-01-02T15:04:05Z07:00`
     */
     ...
     * The scan policy for the cluster.
     */
    scanPolicy?: pulumi.Input<inputs.ClusterAwsScanPolicy>;
    /**
     * If `true`, the cluster will be created asynchronously. Default value is `false`.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClusterAwsTimeouts>;
}

/**
 * The set of arguments for constructing a ClusterAws resource.
 */
export interface ClusterAwsArgs {
    /**
     * The setting to apply the cluster profile. `DownloadAndInstall` will download and install packs in one action.
     * `DownloadAndInstallLater` will only download artifact and postpone install for later. Default value is
     * `DownloadAndInstall`.
