...
export class ClusterEdgeVsphere extends pulumi.CustomResource {
    /**
     * Get an existing ClusterEdgeVsphere resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterEdgeVsphereState, opts?: pulumi.CustomResourceOptions): ClusterEdgeVsphere {
        return new ClusterEdgeVsphere(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/clusterEdgeVsphere:ClusterEdgeVsphere';

    /**
     * Returns true if the given object is an instance of ClusterEdgeVsphere.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClusterEdgeVsphere {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClusterEdgeVsphere.__pulumiType;
    }
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.ClusterEdgeVsphereBackupPolicy | undefined>;
    public readonly cloudConfig!: pulumi.Output<outputs.ClusterEdgeVsphereCloudConfig>;
    /**
    ...
    public readonly clusterProfiles!: pulumi.Output<outputs.ClusterEdgeVsphereClusterProfile[] | undefined>;
    /**
     * The RBAC binding for the cluster.
     */
    public readonly clusterRbacBindings!: pulumi.Output<outputs.ClusterEdgeVsphereClusterRbacBinding[] | undefined>;
    public readonly context!: pulumi.Output<string | undefined>;
    /**
     * The description of the cluster. Default value is empty string.
     */
    public readonly description!: pulumi.Output<string | undefined>;
    public readonly edgeHostUid!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly hostConfigs!: pulumi.Output<outputs.ClusterEdgeVsphereHostConfig[] | undefined>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
    public /*out*/ readonly kubeconfig!: pulumi.Output<string>;
    public readonly locationConfigs!: pulumi.Output<outputs.ClusterEdgeVsphereLocationConfig[] | undefined>;
    public readonly machinePools!: pulumi.Output<outputs.ClusterEdgeVsphereMachinePool[]>;
    public readonly name!: pulumi.Output<string>;
    /**
     * The namespaces for the cluster.
     */
    public readonly namespaces!: pulumi.Output<outputs.ClusterEdgeVsphereNamespace[] | undefined>;
    /**
     ...
     */
    public readonly scanPolicy!: pulumi.Output<outputs.ClusterEdgeVsphereScanPolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClusterEdgeVsphereTimeouts | undefined>;

    /**
     * Create a ClusterEdgeVsphere resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClusterEdgeVsphereArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClusterEdgeVsphereArgs | ClusterEdgeVsphereState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterEdgeVsphereState | undefined;
            ...
            resourceInputs["edgeHostUid"] = state ? state.edgeHostUid : undefined;
            ...
            const args = argsOrState as ClusterEdgeVsphereArgs | undefined;
            if ((!args || args.cloudConfig === undefined) && !opts.urn) {
                throw new Error("Missing required property 'cloudConfig'");
            }
            if ((!args || args.edgeHostUid === undefined) && !opts.urn) {
                throw new Error("Missing required property 'edgeHostUid'");
            }
            ...
            resourceInputs["edgeHostUid"] = args ? args.edgeHostUid : undefined;
        ...
        super(ClusterEdgeVsphere.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClusterEdgeVsphere resources.
 */
export interface ClusterEdgeVsphereState {
    /**
     * Admin Kube-config for the cluster. This can be used to connect to the cluster using `kubectl`, With admin privilege.
     */
     ...
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterEdgeVsphereBackupPolicy>;
    cloudConfig?: pulumi.Input<inputs.ClusterEdgeVsphereCloudConfig>;
    /**
     * ID of the cloud config used for the cluster. This cloud config must be of type `azure`.
     *
     * @deprecated Deprecated
    ...
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.ClusterEdgeVsphereClusterProfile>[]>;
    /**
     * The RBAC binding for the cluster.
     */
    clusterRbacBindings?: pulumi.Input<pulumi.Input<inputs.ClusterEdgeVsphereClusterRbacBinding>[]>;
    context?: pulumi.Input<string>;
    /**
     * The description of the cluster. Default value is empty string.
     */
    description?: pulumi.Input<string>;
    edgeHostUid?: pulumi.Input<string>;
    /**
     * If set to `true`, the cluster will be force deleted and user has to manually clean up the provisioned cloud resources.
     */
     ...
     * The host configuration for the cluster.
     */
    hostConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterEdgeVsphereHostConfig>[]>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
    kubeconfig?: pulumi.Input<string>;
    locationConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterEdgeVsphereLocationConfig>[]>;
    machinePools?: pulumi.Input<pulumi.Input<inputs.ClusterEdgeVsphereMachinePool>[]>;
    name?: pulumi.Input<string>;
    /**
     * The namespaces for the cluster.
     */
    namespaces?: pulumi.Input<pulumi.Input<inputs.ClusterEdgeVsphereNamespace>[]>;
    /**
     * Date and time after which to patch cluster `RFC3339: 2006-01-02T15:04:05Z07:00`
     */
     ...
     * The scan policy for the cluster.
     */
    scanPolicy?: pulumi.Input<inputs.ClusterEdgeVsphereScanPolicy>;
    /**
     * If `true`, the cluster will be created asynchronously. Default value is `false`.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClusterEdgeVsphereTimeouts>;
}

/**
 * The set of arguments for constructing a ClusterEdgeVsphere resource.
 */
export interface ClusterEdgeVsphereArgs {
    /**
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterEdgeVsphereBackupPolicy>;
