...
export class ClusterGke extends pulumi.CustomResource {
    /**
     * Get an existing ClusterGke resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterGkeState, opts?: pulumi.CustomResourceOptions): ClusterGke {
        return new ClusterGke(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/clusterGke:ClusterGke';

    /**
     * Returns true if the given object is an instance of ClusterGke.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClusterGke {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClusterGke.__pulumiType;
    }
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.ClusterGkeBackupPolicy | undefined>;
     ...
     */
    public readonly cloudConfig!: pulumi.Output<outputs.ClusterGkeCloudConfig>;
    /**
    ...
    public readonly clusterProfiles!: pulumi.Output<outputs.ClusterGkeClusterProfile[] | undefined>;
    /**
     * The RBAC binding for the cluster.
     */
    public readonly clusterRbacBindings!: pulumi.Output<outputs.ClusterGkeClusterRbacBinding[] | undefined>;
     ...
     */
    public readonly hostConfigs!: pulumi.Output<outputs.ClusterGkeHostConfig[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly locationConfigs!: pulumi.Output<outputs.ClusterGkeLocationConfig[]>;
    /**
     * The machine pool configuration for the cluster.
     */
    public readonly machinePools!: pulumi.Output<outputs.ClusterGkeMachinePool[]>;
    /**
     ...
     */
    public readonly namespaces!: pulumi.Output<outputs.ClusterGkeNamespace[] | undefined>;
    /**
     ...
     */
    public readonly scanPolicy!: pulumi.Output<outputs.ClusterGkeScanPolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClusterGkeTimeouts | undefined>;
    public readonly updateWorkerPoolInParallel!: pulumi.Output<boolean | undefined>;

    /**
     * Create a ClusterGke resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClusterGkeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClusterGkeArgs | ClusterGkeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterGkeState | undefined;
            ...
            resourceInputs["updateWorkerPoolInParallel"] = state ? state.updateWorkerPoolInParallel : undefined;
        } else {
            const args = argsOrState as ClusterGkeArgs | undefined;
            ...
            resourceInputs["updateWorkerPoolInParallel"] = args ? args.updateWorkerPoolInParallel : undefined;
        ...
        super(ClusterGke.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClusterGke resources.
 */
export interface ClusterGkeState {
    /**
     * Admin Kube-config for the cluster. This can be used to connect to the cluster using `kubectl`, With admin privilege.
     */
     ...
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterGkeBackupPolicy>;
    cloudAccountId?: pulumi.Input<string>;
    /**
     * The GKE environment configuration settings such as project parameters and region parameters that apply to this cluster.
     */
    cloudConfig?: pulumi.Input<inputs.ClusterGkeCloudConfig>;
    /**
     * ID of the cloud config used for the cluster. This cloud config must be of type `azure`.
     *
     * @deprecated Deprecated
    ...
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.ClusterGkeClusterProfile>[]>;
    /**
     * The RBAC binding for the cluster.
     */
    clusterRbacBindings?: pulumi.Input<pulumi.Input<inputs.ClusterGkeClusterRbacBinding>[]>;
     ...
     * The host configuration for the cluster.
     */
    hostConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterGkeHostConfig>[]>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
     ...
     * The location of the cluster.
     */
    locationConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterGkeLocationConfig>[]>;
    /**
     * The machine pool configuration for the cluster.
     */
    machinePools?: pulumi.Input<pulumi.Input<inputs.ClusterGkeMachinePool>[]>;
    /**
     * The name of the cluster.
     */
     ...
     * The namespaces for the cluster.
     */
    namespaces?: pulumi.Input<pulumi.Input<inputs.ClusterGkeNamespace>[]>;
    /**
     * Date and time after which to patch cluster `RFC3339: 2006-01-02T15:04:05Z07:00`
     */
     ...
     * The scan policy for the cluster.
     */
    scanPolicy?: pulumi.Input<inputs.ClusterGkeScanPolicy>;
    /**
     * If `true`, the cluster will be created asynchronously. Default value is `false`.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClusterGkeTimeouts>;
    updateWorkerPoolInParallel?: pulumi.Input<boolean>;
}

/**
 * The set of arguments for constructing a ClusterGke resource.
 */
export interface ClusterGkeArgs {
    /**
     * The setting to apply the cluster profile. `DownloadAndInstall` will download and install packs in one action.
     * `DownloadAndInstallLater` will only download artifact and postpone install for later. Default value is
     * `DownloadAndInstall`.
