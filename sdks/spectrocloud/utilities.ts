...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("spectrocloud");
			params.setVersion("0.21.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NwZWN0cm9jbG91ZC9zcGVjdHJvY2xvdWQiLCJ2ZXJzaW9uIjoiMC4yMS4yIn19"), c => c.charCodeAt(0)));
