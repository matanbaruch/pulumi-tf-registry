...
export class ClusterAks extends pulumi.CustomResource {
    /**
     * Get an existing ClusterAks resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterAksState, opts?: pulumi.CustomResourceOptions): ClusterAks {
        return new ClusterAks(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/clusterAks:ClusterAks';

    /**
     * Returns true if the given object is an instance of ClusterAks.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClusterAks {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClusterAks.__pulumiType;
    }
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.ClusterAksBackupPolicy | undefined>;
    public readonly cloudAccountId!: pulumi.Output<string>;
    public readonly cloudConfig!: pulumi.Output<outputs.ClusterAksCloudConfig>;
    /**
    ...
    public readonly clusterProfiles!: pulumi.Output<outputs.ClusterAksClusterProfile[] | undefined>;
    /**
     * The RBAC binding for the cluster.
     */
    public readonly clusterRbacBindings!: pulumi.Output<outputs.ClusterAksClusterRbacBinding[] | undefined>;
     ...
     */
    public readonly hostConfigs!: pulumi.Output<outputs.ClusterAksHostConfig[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly locationConfigs!: pulumi.Output<outputs.ClusterAksLocationConfig[]>;
    public readonly machinePools!: pulumi.Output<outputs.ClusterAksMachinePool[]>;
    public readonly name!: pulumi.Output<string>;
    /**
     * The namespaces for the cluster.
     */
    public readonly namespaces!: pulumi.Output<outputs.ClusterAksNamespace[] | undefined>;
    /**
     ...
     */
    public readonly scanPolicy!: pulumi.Output<outputs.ClusterAksScanPolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClusterAksTimeouts | undefined>;

    /**
     * Create a ClusterAks resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClusterAksArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClusterAksArgs | ClusterAksState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterAksState | undefined;
            ...
            const args = argsOrState as ClusterAksArgs | undefined;
        ...
        super(ClusterAks.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClusterAks resources.
 */
export interface ClusterAksState {
    /**
     * Admin Kube-config for the cluster. This can be used to connect to the cluster using `kubectl`, With admin privilege.
     */
     ...
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterAksBackupPolicy>;
    cloudAccountId?: pulumi.Input<string>;
    cloudConfig?: pulumi.Input<inputs.ClusterAksCloudConfig>;
    /**
     * ID of the cloud config used for the cluster. This cloud config must be of type `azure`.
     *
     * @deprecated Deprecated
    ...
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.ClusterAksClusterProfile>[]>;
    /**
     * The RBAC binding for the cluster.
     */
    clusterRbacBindings?: pulumi.Input<pulumi.Input<inputs.ClusterAksClusterRbacBinding>[]>;
     ...
     * The host configuration for the cluster.
     */
    hostConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterAksHostConfig>[]>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
     ...
     * The location of the cluster.
     */
    locationConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterAksLocationConfig>[]>;
    machinePools?: pulumi.Input<pulumi.Input<inputs.ClusterAksMachinePool>[]>;
    name?: pulumi.Input<string>;
    /**
     * The namespaces for the cluster.
     */
    namespaces?: pulumi.Input<pulumi.Input<inputs.ClusterAksNamespace>[]>;
    /**
     * The date and time after which to patch the cluster. Prefix the time value with the respective RFC. Ex: `RFC3339:
     * 2006-01-02T15:04:05Z07:00`
     */
     ...
     * The scan policy for the cluster.
     */
    scanPolicy?: pulumi.Input<inputs.ClusterAksScanPolicy>;
    /**
     * If `true`, the cluster will be created asynchronously. Default value is `false`.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClusterAksTimeouts>;
}

/**
 * The set of arguments for constructing a ClusterAks resource.
 */
export interface ClusterAksArgs {
    /**
     * The setting to apply the cluster profile. `DownloadAndInstall` will download and install packs in one action.
     * `DownloadAndInstallLater` will only download artifact and postpone install for later. Default value is
     * `DownloadAndInstall`.
