...
export class CloudaccountGcp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/cloudaccountGcp:CloudaccountGcp';
    ...
    public readonly gcpJsonCredentials!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: CloudaccountGcpArgs | CloudaccountGcpState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["gcpJsonCredentials"] = state ? state.gcpJsonCredentials : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
        } else {
            const args = argsOrState as CloudaccountGcpArgs | undefined;
            if ((!args || args.gcpJsonCredentials === undefined) && !opts.urn) {
                throw new Error("Missing required property 'gcpJsonCredentials'");
            }
            resourceInputs["context"] = args ? args.context : undefined;
            resourceInputs["gcpJsonCredentials"] = args?.gcpJsonCredentials ? pulumi.secret(args.gcpJsonCredentials) : undefined;
            resourceInputs["name"] = args ? args.name : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const secretOpts = { additionalSecretOutputs: ["gcpJsonCredentials"] };
...
export interface CloudaccountGcpState {
    ...
    gcpJsonCredentials?: pulumi.Input<string>;
