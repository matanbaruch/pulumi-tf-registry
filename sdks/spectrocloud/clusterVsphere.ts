...
export class ClusterVsphere extends pulumi.CustomResource {
    /**
     * Get an existing ClusterVsphere resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterVsphereState, opts?: pulumi.CustomResourceOptions): ClusterVsphere {
        return new ClusterVsphere(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/clusterVsphere:ClusterVsphere';

    /**
     * Returns true if the given object is an instance of ClusterVsphere.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClusterVsphere {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClusterVsphere.__pulumiType;
    }
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.ClusterVsphereBackupPolicy | undefined>;
    /**
    ...
    public readonly cloudConfig!: pulumi.Output<outputs.ClusterVsphereCloudConfig>;
    /**
    ...
    public readonly clusterProfiles!: pulumi.Output<outputs.ClusterVsphereClusterProfile[] | undefined>;
    /**
     * The RBAC binding for the cluster.
     */
    public readonly clusterRbacBindings!: pulumi.Output<outputs.ClusterVsphereClusterRbacBinding[] | undefined>;
     ...
     */
    public readonly hostConfigs!: pulumi.Output<outputs.ClusterVsphereHostConfig[] | undefined>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
    public /*out*/ readonly kubeconfig!: pulumi.Output<string>;
    public readonly locationConfigs!: pulumi.Output<outputs.ClusterVsphereLocationConfig[] | undefined>;
    public readonly machinePools!: pulumi.Output<outputs.ClusterVsphereMachinePool[]>;
    /**
     ...
     */
    public readonly namespaces!: pulumi.Output<outputs.ClusterVsphereNamespace[] | undefined>;
    /**
     ...
     */
    public readonly scanPolicy!: pulumi.Output<outputs.ClusterVsphereScanPolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClusterVsphereTimeouts | undefined>;

    /**
     * Create a ClusterVsphere resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClusterVsphereArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClusterVsphereArgs | ClusterVsphereState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterVsphereState | undefined;
            ...
            const args = argsOrState as ClusterVsphereArgs | undefined;
        ...
        super(ClusterVsphere.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClusterVsphere resources.
 */
export interface ClusterVsphereState {
    /**
     * Admin Kube-config for the cluster. This can be used to connect to the cluster using `kubectl`, With admin privilege.
     */
     ...
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterVsphereBackupPolicy>;
    /**
     * ID of the cloud account to be used for the cluster. This cloud account must be of type `vsphere`.
     */
    cloudAccountId?: pulumi.Input<string>;
    cloudConfig?: pulumi.Input<inputs.ClusterVsphereCloudConfig>;
    /**
     * ID of the cloud config used for the cluster. This cloud config must be of type `azure`.
     *
     * @deprecated Deprecated
    ...
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.ClusterVsphereClusterProfile>[]>;
    /**
     * The RBAC binding for the cluster.
     */
    clusterRbacBindings?: pulumi.Input<pulumi.Input<inputs.ClusterVsphereClusterRbacBinding>[]>;
     ...
     * The host configuration for the cluster.
     */
    hostConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterVsphereHostConfig>[]>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
    kubeconfig?: pulumi.Input<string>;
    locationConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterVsphereLocationConfig>[]>;
    machinePools?: pulumi.Input<pulumi.Input<inputs.ClusterVsphereMachinePool>[]>;
    /**
     * The name of the cluster.
     */
     ...
     * The namespaces for the cluster.
     */
    namespaces?: pulumi.Input<pulumi.Input<inputs.ClusterVsphereNamespace>[]>;
    /**
     * The date and time after which to patch the cluster. Prefix the time value with the respective RFC. Ex: `RFC3339:
     * 2006-01-02T15:04:05Z07:00`
     */
     ...
     * The scan policy for the cluster.
     */
    scanPolicy?: pulumi.Input<inputs.ClusterVsphereScanPolicy>;
    /**
     * If `true`, the cluster will be created asynchronously. Default value is `false`.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClusterVsphereTimeouts>;
}

/**
 * The set of arguments for constructing a ClusterVsphere resource.
 */
export interface ClusterVsphereArgs {
    /**
     * The setting to apply the cluster profile. `DownloadAndInstall` will download and install packs in one action.
     * `DownloadAndInstallLater` will only download artifact and postpone install for later. Default value is
     * `DownloadAndInstall`.
