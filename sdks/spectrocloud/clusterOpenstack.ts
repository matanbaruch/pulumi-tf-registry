...
export class ClusterOpenstack extends pulumi.CustomResource {
    /**
     * Get an existing ClusterOpenstack resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterOpenstackState, opts?: pulumi.CustomResourceOptions): ClusterOpenstack {
        return new ClusterOpenstack(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spectrocloud:index/clusterOpenstack:ClusterOpenstack';

    /**
     * Returns true if the given object is an instance of ClusterOpenstack.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClusterOpenstack {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClusterOpenstack.__pulumiType;
    }
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.ClusterOpenstackBackupPolicy | undefined>;
    public readonly cloudAccountId!: pulumi.Output<string>;
    public readonly cloudConfig!: pulumi.Output<outputs.ClusterOpenstackCloudConfig>;
    /**
    ...
    public readonly clusterProfiles!: pulumi.Output<outputs.ClusterOpenstackClusterProfile[] | undefined>;
    /**
     * The RBAC binding for the cluster.
     */
    public readonly clusterRbacBindings!: pulumi.Output<outputs.ClusterOpenstackClusterRbacBinding[] | undefined>;
     ...
     */
    public readonly hostConfigs!: pulumi.Output<outputs.ClusterOpenstackHostConfig[] | undefined>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
    public /*out*/ readonly kubeconfig!: pulumi.Output<string>;
    public readonly locationConfigs!: pulumi.Output<outputs.ClusterOpenstackLocationConfig[] | undefined>;
    public readonly machinePools!: pulumi.Output<outputs.ClusterOpenstackMachinePool[]>;
    public readonly name!: pulumi.Output<string>;
    /**
     * The namespaces for the cluster.
     */
    public readonly namespaces!: pulumi.Output<outputs.ClusterOpenstackNamespace[] | undefined>;
    /**
     ...
     */
    public readonly scanPolicy!: pulumi.Output<outputs.ClusterOpenstackScanPolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClusterOpenstackTimeouts | undefined>;

    /**
     * Create a ClusterOpenstack resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClusterOpenstackArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClusterOpenstackArgs | ClusterOpenstackState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterOpenstackState | undefined;
            ...
            const args = argsOrState as ClusterOpenstackArgs | undefined;
        ...
        super(ClusterOpenstack.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClusterOpenstack resources.
 */
export interface ClusterOpenstackState {
    /**
     * Admin Kube-config for the cluster. This can be used to connect to the cluster using `kubectl`, With admin privilege.
     */
     ...
     * The backup policy for the cluster. If not specified, no backups will be taken.
     */
    backupPolicy?: pulumi.Input<inputs.ClusterOpenstackBackupPolicy>;
    cloudAccountId?: pulumi.Input<string>;
    cloudConfig?: pulumi.Input<inputs.ClusterOpenstackCloudConfig>;
    /**
     * ID of the cloud config used for the cluster. This cloud config must be of type `azure`.
     *
     * @deprecated Deprecated
    ...
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.ClusterOpenstackClusterProfile>[]>;
    /**
     * The RBAC binding for the cluster.
     */
    clusterRbacBindings?: pulumi.Input<pulumi.Input<inputs.ClusterOpenstackClusterRbacBinding>[]>;
     ...
     * The host configuration for the cluster.
     */
    hostConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterOpenstackHostConfig>[]>;
    /**
     * Kubeconfig for the cluster. This can be used to connect to the cluster using `kubectl`.
     */
    kubeconfig?: pulumi.Input<string>;
    locationConfigs?: pulumi.Input<pulumi.Input<inputs.ClusterOpenstackLocationConfig>[]>;
    machinePools?: pulumi.Input<pulumi.Input<inputs.ClusterOpenstackMachinePool>[]>;
    name?: pulumi.Input<string>;
    /**
     * The namespaces for the cluster.
     */
    namespaces?: pulumi.Input<pulumi.Input<inputs.ClusterOpenstackNamespace>[]>;
    /**
     * The date and time after which to patch the cluster. Prefix the time value with the respective RFC. Ex: `RFC3339:
     * 2006-01-02T15:04:05Z07:00`
     */
     ...
     * The scan policy for the cluster.
     */
    scanPolicy?: pulumi.Input<inputs.ClusterOpenstackScanPolicy>;
    /**
     * If `true`, the cluster will be created asynchronously. Default value is `false`.
     */
    ...
    timeouts?: pulumi.Input<inputs.ClusterOpenstackTimeouts>;
}

/**
 * The set of arguments for constructing a ClusterOpenstack resource.
 */
export interface ClusterOpenstackArgs {
    /**
     * The setting to apply the cluster profile. `DownloadAndInstall` will download and install packs in one action.
     * `DownloadAndInstallLater` will only download artifact and postpone install for later. Default value is
     * `DownloadAndInstall`.
