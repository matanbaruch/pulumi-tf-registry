...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("configcat");
			params.setVersion("5.5.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NvbmZpZ2NhdC9jb25maWdjYXQiLCJ2ZXJzaW9uIjoiNS41LjEifX0="), c => c.charCodeAt(0)));
