...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("amixr");
			params.setVersion("0.2.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FsZXJ0bWl4ZXIvYW1peHIiLCJ2ZXJzaW9uIjoiMC4yLjMifX0="), c => c.charCodeAt(0)));
