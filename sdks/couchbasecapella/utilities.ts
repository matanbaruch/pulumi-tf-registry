...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("couchbasecapella");
			params.setVersion("0.2.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvdWNoYmFzZWNsb3VkL2NvdWNoYmFzZWNhcGVsbGEiLCJ2ZXJzaW9uIjoiMC4yLjIifX0="), c => c.charCodeAt(0)));
