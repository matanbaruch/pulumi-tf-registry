...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NvdWNoYmFzZWNsb3VkL2NvdWNoYmFzZWNhcGVsbGEiLCJ2ZXJzaW9uIjoiMC4yLjIifX0="), c => c.charCodeAt(0)));
