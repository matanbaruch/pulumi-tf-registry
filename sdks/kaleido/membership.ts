...
export class Membership extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kaleido:index/membership:Membership';
    ...
    /**
     * In a decentalized consortium memberships are driven by invitation, and will be pre-existing at the point of deploying
     * infrastructure.
     */
    public readonly preExisting!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: MembershipArgs | MembershipState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["preExisting"] = state ? state.preExisting : undefined;
        } else {
            ...
            resourceInputs["preExisting"] = args ? args.preExisting : undefined;
        }
...
export interface MembershipState {
     ...
     * infrastructure.
     */
    preExisting?: pulumi.Input<boolean>;
}
