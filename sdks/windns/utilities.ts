...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("windns");
			params.setVersion("0.5.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BvcnRvZnBvcnRsYW5kL3dpbmRucyIsInZlcnNpb24iOiIwLjUuMyJ9fQ=="), c => c.charCodeAt(0)));
