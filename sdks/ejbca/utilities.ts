...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ejbca");
			params.setVersion("1.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2tleWZhY3Rvci1wdWIvZWpiY2EiLCJ2ZXJzaW9uIjoiMS4xLjAifX0="), c => c.charCodeAt(0)));
