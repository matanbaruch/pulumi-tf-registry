...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("nirmata");
			params.setVersion("1.1.13");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL25pcm1hdGEvbmlybWF0YSIsInZlcnNpb24iOiIxLjEuMTMifX0="), c => c.charCodeAt(0)));
