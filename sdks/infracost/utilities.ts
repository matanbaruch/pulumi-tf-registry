...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("infracost");
			params.setVersion("0.0.9");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2luZnJhY29zdC9pbmZyYWNvc3QiLCJ2ZXJzaW9uIjoiMC4wLjkifX0="), c => c.charCodeAt(0)));
