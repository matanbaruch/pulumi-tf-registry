...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("aviatrix");
			params.setVersion("3.1.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2F2aWF0cml4c3lzdGVtcy9hdmlhdHJpeCIsInZlcnNpb24iOiIzLjEuNSJ9fQ=="), c => c.charCodeAt(0)));
