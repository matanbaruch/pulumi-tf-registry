...
export class EdgeGatewaySelfmanaged extends pulumi.CustomResource {
    /**
     * Get an existing EdgeGatewaySelfmanaged resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EdgeGatewaySelfmanagedState, opts?: pulumi.CustomResourceOptions): EdgeGatewaySelfmanaged {
        return new EdgeGatewaySelfmanaged(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/edgeGatewaySelfmanaged:EdgeGatewaySelfmanaged';

    /**
     * Returns true if the given object is an instance of EdgeGatewaySelfmanaged.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EdgeGatewaySelfmanaged {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EdgeGatewaySelfmanaged.__pulumiType;
    }
     ...
     */
    public readonly interfaces!: pulumi.Output<outputs.EdgeGatewaySelfmanagedInterface[]>;
    /**
    ...
    /**
     * State of Edge gateway selfmanaged.
     */
    public /*out*/ readonly state!: pulumi.Output<string>;
    /**
     * VLAN configuration.
     */
    public readonly vlans!: pulumi.Output<outputs.EdgeGatewaySelfmanagedVlan[] | undefined>;
    /**
    ...
    /**
     * Create a EdgeGatewaySelfmanaged resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: EdgeGatewaySelfmanagedArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: EdgeGatewaySelfmanagedArgs | EdgeGatewaySelfmanagedState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EdgeGatewaySelfmanagedState | undefined;
            ...
            const args = argsOrState as EdgeGatewaySelfmanagedArgs | undefined;
        ...
        super(EdgeGatewaySelfmanaged.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering EdgeGatewaySelfmanaged resources.
 */
export interface EdgeGatewaySelfmanagedState {
    /**
     * Approved learned CIDRs for BGP Spoke Gateway.
     */
     ...
     * WAN/LAN/MANAGEMENT interfaces.
     */
    interfaces?: pulumi.Input<pulumi.Input<inputs.EdgeGatewaySelfmanagedInterface>[]>;
    /**
     * The latitude of the Edge as a Spoke.
     */
     ...
     * VLAN configuration.
     */
    vlans?: pulumi.Input<pulumi.Input<inputs.EdgeGatewaySelfmanagedVlan>[]>;
    /**
     * The location where the ZTP file will be stored.
     */
...
/**
 * The set of arguments for constructing a EdgeGatewaySelfmanaged resource.
 */
export interface EdgeGatewaySelfmanagedArgs {
    /**
     * Approved learned CIDRs for BGP Spoke Gateway.
     */
    approvedLearnedCidrs?: pulumi.Input<pulumi.Input<string>[]>;
