...
export class SpokeGateway extends pulumi.CustomResource {
    ...
    /**
     * Number of interfaces that will be created for BGP over LAN enabled Azure spoke. Only valid for 8 (Azure), 32 (AzureGov)
     * or AzureChina (2048). Default value: 1. Available as of provider version R3.0.2+.
     */
    public readonly bgpLanInterfacesCount!: pulumi.Output<number | undefined>;
    /**
     * List of available BGP LAN interface IPs for spoke external device connection creation. Only supports 8 (Azure), 32
     * (AzureGov) or AzureChina (2048). Available as of provider version R3.0.2+.
     */
    ...
    /**
     * Pre-allocate a network interface(eth4) for "BGP over LAN" functionality. Only valid for 8 (Azure), 32 (AzureGov) or
     * AzureChina (2048). Valid values: true or false. Default value: false. Available as of provider version R3.0.2+.
     */
     ...
     */
    public readonly enableGlobalVpc!: pulumi.Output<boolean | undefined>;
    /**
     * Specify whether to disable GRO/GSO or not.
     */
    public readonly enableGroGso!: pulumi.Output<boolean | undefined>;
    /**
    ...
    /**
     * List of available BGP LAN interface IPs for spoke external device HA connection creation. Only supports 8 (Azure), 32
     * (AzureGov) or AzureChina (2048). Available as of provider version R3.0.2+.
     */
     ...
     * the aviatrix.ControllerConfig resource.
     */
    ...
    /**
     * This parameter is a switch used to determine whether or not to manage spoke ha gateway using the aviatrix.SpokeGateway
     * resource. If this is set to false, managing spoke ha gateway must be done using the aviatrix.SpokeHaGateway resource.
     * Valid values: true, false. Default value: true.
     */
    public readonly manageHaGateway!: pulumi.Output<boolean | undefined>;
    /**
     ...
     * aviatrix.ControllerConfig resource.
     */
    ...
    /**
     * Availability Zone. Only available for Azure (8), Azure GOV (32) and Azure CHINA (2048). Must be in the form 'az-n', for
     * example, 'az-2'.
     */
    ...
    constructor(name: string, argsOrState?: SpokeGatewayArgs | SpokeGatewayState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["enableGlobalVpc"] = state ? state.enableGlobalVpc : undefined;
            resourceInputs["enableGroGso"] = state ? state.enableGroGso : undefined;
            ...
            resourceInputs["manageHaGateway"] = state ? state.manageHaGateway : undefined;
            ...
            resourceInputs["enableGlobalVpc"] = args ? args.enableGlobalVpc : undefined;
            resourceInputs["enableGroGso"] = args ? args.enableGroGso : undefined;
            ...
            resourceInputs["manageHaGateway"] = args ? args.manageHaGateway : undefined;
        ...
        super(SpokeGateway.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SpokeGatewayState {
     ...
     * Set to true to enable global VPC. Only supported for GCP.
     */
    enableGlobalVpc?: pulumi.Input<boolean>;
    /**
     * Specify whether to disable GRO/GSO or not.
     */
    enableGroGso?: pulumi.Input<boolean>;
    /**
     * Enable jumbo frame support for spoke gateway. Valid values: true or false. Default value: true.
     */
     ...
     * Valid values: true, false. Default value: true.
     */
    manageHaGateway?: pulumi.Input<boolean>;
    /**
     * A set of monitored instance ids. Only valid when 'enable_monitor_gateway_subnets' = true.
     */
