...
export class TransitGateway extends pulumi.CustomResource {
    ...
    /**
     * Number of interfaces that will be created for BGP over LAN enabled Azure transit. Applies on HA Transit as well if
     * enabled. Updatable as of provider version 3.0.3+.
     */
     ...
     * (Azure). Valid values: true or false. Default value: false. Available as of provider version R2.18+. Updatable as of
     * provider version 3.0.3+.
     */
