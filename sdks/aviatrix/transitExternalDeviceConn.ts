...
export class TransitExternalDeviceConn extends pulumi.CustomResource {
    /**
     * Get an existing TransitExternalDeviceConn resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransitExternalDeviceConnState, opts?: pulumi.CustomResourceOptions): TransitExternalDeviceConn {
        return new TransitExternalDeviceConn(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/transitExternalDeviceConn:TransitExternalDeviceConn';

    /**
     * Returns true if the given object is an instance of TransitExternalDeviceConn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransitExternalDeviceConn {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransitExternalDeviceConn.__pulumiType;
    }
     ...
     * Gateway insane mode enabled. Valid values: true, false. Default: false. Available as of provider version R2.21+.
     */
    ...
    /**
     * Create a TransitExternalDeviceConn resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TransitExternalDeviceConnArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransitExternalDeviceConnArgs | TransitExternalDeviceConnState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TransitExternalDeviceConnState | undefined;
            ...
            const args = argsOrState as TransitExternalDeviceConnArgs | undefined;
        ...
        super(TransitExternalDeviceConn.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TransitExternalDeviceConn resources.
 */
export interface TransitExternalDeviceConnState {
    /**
     * Set of approved cidrs. Requires 'enable_learned_cidrs_approval' to be true. Type: Set(String).
     */
 ...
 */
export interface TransitExternalDeviceConnArgs {
    /**
     * Set of approved cidrs. Requires 'enable_learned_cidrs_approval' to be true. Type: Set(String).
     */
    approvedCidrs?: pulumi.Input<pulumi.Input<string>[]>;
