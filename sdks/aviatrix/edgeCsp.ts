...
export class EdgeCsp extends pulumi.CustomResource {
    /**
     * Get an existing EdgeCsp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EdgeCspState, opts?: pulumi.CustomResourceOptions): EdgeCsp {
        return new EdgeCsp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/edgeCsp:EdgeCsp';

    /**
     * Returns true if the given object is an instance of EdgeCsp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EdgeCsp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EdgeCsp.__pulumiType;
    }
     ...
     */
    public readonly interfaces!: pulumi.Output<outputs.EdgeCspInterface[]>;
    /**
     ...
     * VLAN configuration.
     */
    public readonly vlans!: pulumi.Output<outputs.EdgeCspVlan[] | undefined>;
    /**
    ...
    /**
     * Create a EdgeCsp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: EdgeCspArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: EdgeCspArgs | EdgeCspState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EdgeCspState | undefined;
            ...
            const args = argsOrState as EdgeCspArgs | undefined;
        ...
        super(EdgeCsp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering EdgeCsp resources.
 */
export interface EdgeCspState {
    /**
     * Edge CSP account name.
     */
     ...
     * WAN/LAN/MANAGEMENT interfaces.
     */
    interfaces?: pulumi.Input<pulumi.Input<inputs.EdgeCspInterface>[]>;
    /**
     * List of LAN interface names.
     */
     ...
     * VLAN configuration.
     */
    vlans?: pulumi.Input<pulumi.Input<inputs.EdgeCspVlan>[]>;
    /**
     * List of WAN interface names.
     */
...
/**
 * The set of arguments for constructing a EdgeCsp resource.
 */
export interface EdgeCspArgs {
    /**
     * Edge CSP account name.
     */
    accountName: pulumi.Input<string>;
