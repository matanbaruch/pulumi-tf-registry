...
export class Gateway extends pulumi.CustomResource {
     ...
     */
    public readonly maxVpnConn!: pulumi.Output<string>;
    /**
     ...
     * through the aviatrix.ControllerConfig resource.
     */
    ...
    /**
     * Availability Zone. Only available for Azure (8), Azure GOV (32), Azure CHINA (2048) and Public Subnet Filtering gateway.
     * Must be in the form 'az-n', for example, 'az-2'.
     */
