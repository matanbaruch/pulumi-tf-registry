...
export class EdgeZededa extends pulumi.CustomResource {
    /**
     * Get an existing EdgeZededa resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EdgeZededaState, opts?: pulumi.CustomResourceOptions): EdgeZededa {
        return new EdgeZededa(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/edgeZededa:EdgeZededa';

    /**
     * Returns true if the given object is an instance of EdgeZededa.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EdgeZededa {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EdgeZededa.__pulumiType;
    }
     ...
     */
    public readonly interfaces!: pulumi.Output<outputs.EdgeZededaInterface[]>;
    /**
     * List of LAN interface names.
     */
    public readonly lanInterfaceNames!: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    public readonly managementInterfaceNames!: pulumi.Output<string[] | undefined>;
    /**
     ...
     * VLAN configuration.
     */
    public readonly vlans!: pulumi.Output<outputs.EdgeZededaVlan[] | undefined>;
    /**
     * List of WAN interface names.
     */
    public readonly wanInterfaceNames!: pulumi.Output<string[] | undefined>;

    /**
     * Create a EdgeZededa resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: EdgeZededaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: EdgeZededaArgs | EdgeZededaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EdgeZededaState | undefined;
            ...
            const args = argsOrState as EdgeZededaArgs | undefined;
        ...
        super(EdgeZededa.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering EdgeZededa resources.
 */
export interface EdgeZededaState {
    /**
     * Edge CSP account name.
     */
     ...
     * WAN/LAN/MANAGEMENT interfaces.
     */
    interfaces?: pulumi.Input<pulumi.Input<inputs.EdgeZededaInterface>[]>;
    /**
     * List of LAN interface names.
     */
     ...
     * VLAN configuration.
     */
    vlans?: pulumi.Input<pulumi.Input<inputs.EdgeZededaVlan>[]>;
    /**
     * List of WAN interface names.
     */
...
/**
 * The set of arguments for constructing a EdgeZededa resource.
 */
export interface EdgeZededaArgs {
    /**
     * Edge CSP account name.
     */
    accountName: pulumi.Input<string>;
