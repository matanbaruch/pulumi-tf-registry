...
export class EdgeNeo extends pulumi.CustomResource {
    /**
     * Get an existing EdgeNeo resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EdgeNeoState, opts?: pulumi.CustomResourceOptions): EdgeNeo {
        return new EdgeNeo(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/edgeNeo:EdgeNeo';

    /**
     * Returns true if the given object is an instance of EdgeNeo.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EdgeNeo {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EdgeNeo.__pulumiType;
    }
     ...
     */
    public readonly interfaces!: pulumi.Output<outputs.EdgeNeoInterface[]>;
    /**
     ...
     * VLAN configuration.
     */
    public readonly vlans!: pulumi.Output<outputs.EdgeNeoVlan[] | undefined>;
    /**
    ...
    /**
     * Create a EdgeNeo resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: EdgeNeoArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: EdgeNeoArgs | EdgeNeoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EdgeNeoState | undefined;
            ...
            const args = argsOrState as EdgeNeoArgs | undefined;
        ...
        super(EdgeNeo.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering EdgeNeo resources.
 */
export interface EdgeNeoState {
    /**
     * Edge CSP account name.
     */
     ...
     * WAN/LAN/MANAGEMENT interfaces.
     */
    interfaces?: pulumi.Input<pulumi.Input<inputs.EdgeNeoInterface>[]>;
    /**
     * List of LAN interface names.
     */
     ...
     * VLAN configuration.
     */
    vlans?: pulumi.Input<pulumi.Input<inputs.EdgeNeoVlan>[]>;
    /**
     * List of WAN interface names.
     */
...
/**
 * The set of arguments for constructing a EdgeNeo resource.
 */
export interface EdgeNeoArgs {
    /**
     * Edge CSP account name.
     */
    accountName: pulumi.Input<string>;
