...
export class AwsTgwVpnConn extends pulumi.CustomResource {
    /**
     * Get an existing AwsTgwVpnConn resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AwsTgwVpnConnState, opts?: pulumi.CustomResourceOptions): AwsTgwVpnConn {
        return new AwsTgwVpnConn(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/awsTgwVpnConn:AwsTgwVpnConn';

    /**
     * Returns true if the given object is an instance of AwsTgwVpnConn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AwsTgwVpnConn {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AwsTgwVpnConn.__pulumiType;
    }
     ...
     * VPN tunnel data.
     */
    public /*out*/ readonly vpnTunnelDatas!: pulumi.Output<outputs.AwsTgwVpnConnVpnTunnelData[]>;

    /**
     * Create a AwsTgwVpnConn resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AwsTgwVpnConnArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AwsTgwVpnConnArgs | AwsTgwVpnConnState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AwsTgwVpnConnState | undefined;
            ...
            const args = argsOrState as AwsTgwVpnConnArgs | undefined;
        ...
        super(AwsTgwVpnConn.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AwsTgwVpnConn resources.
 */
export interface AwsTgwVpnConnState {
    /**
     * Unique name of the connection.
     */
     ...
     * VPN tunnel data.
     */
    vpnTunnelDatas?: pulumi.Input<pulumi.Input<inputs.AwsTgwVpnConnVpnTunnelData>[]>;
}

/**
 * The set of arguments for constructing a AwsTgwVpnConn resource.
 */
export interface AwsTgwVpnConnArgs {
    /**
     * Unique name of the connection.
     */
    connectionName: pulumi.Input<string>;
