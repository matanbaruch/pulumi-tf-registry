...
export class SpokeExternalDeviceConn extends pulumi.CustomResource {
    /**
     * Get an existing SpokeExternalDeviceConn resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpokeExternalDeviceConnState, opts?: pulumi.CustomResourceOptions): SpokeExternalDeviceConn {
        return new SpokeExternalDeviceConn(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/spokeExternalDeviceConn:SpokeExternalDeviceConn';

    /**
     * Returns true if the given object is an instance of SpokeExternalDeviceConn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SpokeExternalDeviceConn {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SpokeExternalDeviceConn.__pulumiType;
    }
    ...
    /**
     * Switch to enable BGP LAN ActiveMesh. Only valid for GCP and Azure with Remote Gateway HA enabled. Requires Azure Remote
     * Gateway insane mode enabled. Valid values: true, false. Default: false. Available as of provider version R3.0.2+.
     */
     ...
     */
    public readonly phase1LocalIdentifier!: pulumi.Output<string | undefined>;
    /**
     * List of phase 1 remote identifier of the IPsec tunnel. This can be configured as a list of any string, including emtpy
     * string.
     */
     ...
     * with an Azure spoke gateway. Must be in the form "<VNET-name>:<resource-group-name>". Available as of provider version
     * R3.0.2+.
     */
    ...
    /**
     * Create a SpokeExternalDeviceConn resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SpokeExternalDeviceConnArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SpokeExternalDeviceConnArgs | SpokeExternalDeviceConnState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SpokeExternalDeviceConnState | undefined;
            ...
            resourceInputs["phase1LocalIdentifier"] = state ? state.phase1LocalIdentifier : undefined;
            ...
            const args = argsOrState as SpokeExternalDeviceConnArgs | undefined;
            ...
            resourceInputs["phase1LocalIdentifier"] = args ? args.phase1LocalIdentifier : undefined;
        ...
        super(SpokeExternalDeviceConn.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SpokeExternalDeviceConn resources.
 */
export interface SpokeExternalDeviceConnState {
    /**
     * Set of approved cidrs. Requires 'enable_learned_cidrs_approval' to be true. Type: Set(String).
     */
     ...
     * By default, gateway’s public IP is configured as the Local Identifier.
     */
    phase1LocalIdentifier?: pulumi.Input<string>;
    /**
     * List of phase 1 remote identifier of the IPsec tunnel. This can be configured as a list of any string, including emtpy
     * string.
     */
 ...
 */
export interface SpokeExternalDeviceConnArgs {
    /**
     * Set of approved cidrs. Requires 'enable_learned_cidrs_approval' to be true. Type: Set(String).
     */
    approvedCidrs?: pulumi.Input<pulumi.Input<string>[]>;
