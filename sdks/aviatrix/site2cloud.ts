...
export class Site2cloud extends pulumi.CustomResource {
    /**
     * Get an existing Site2cloud resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Site2cloudState, opts?: pulumi.CustomResourceOptions): Site2cloud {
        return new Site2cloud(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aviatrix:index/site2cloud:Site2cloud';

    /**
     * Returns true if the given object is an instance of Site2cloud.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Site2cloud {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Site2cloud.__pulumiType;
    }
    ...
    /**
     * Create a Site2cloud resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: Site2cloudArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Site2cloudArgs | Site2cloudState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Site2cloudState | undefined;
            ...
            const args = argsOrState as Site2cloudArgs | undefined;
        ...
        super(Site2cloud.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Site2cloud resources.
 */
export interface Site2cloudState {
    /**
     * Authentication Type. Valid values: 'PSK' and 'Cert'. Default value: 'PSK'.
     */
 ...
 */
export interface Site2cloudArgs {
    /**
     * Authentication Type. Valid values: 'PSK' and 'Cert'. Default value: 'PSK'.
     */
    authType?: pulumi.Input<string>;
