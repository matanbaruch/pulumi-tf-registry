...
export { BlockArgs, BlockState } from "./block";
...
export { BlockAccessArgs, BlockAccessState } from "./blockAccess";
export type BlockAccess = import("./blockAccess").BlockAccess;
export const BlockAccess: typeof import("./blockAccess").BlockAccess = null as any;
utilities.lazyLoad(exports, ["BlockAccess"], () => require("./blockAccess"));
...
export { GetBlockArgs, GetBlockResult, GetBlockOutputArgs } from "./getBlock";
export const getBlock: typeof import("./getBlock").getBlock = null as any;
export const getBlockOutput: typeof import("./getBlock").getBlockOutput = null as any;
utilities.lazyLoad(exports, ["getBlock","getBlockOutput"], () => require("./getBlock"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "prefect:index/block:Block":
                return new Block(name, <any>undefined, { urn })
            case "prefect:index/blockAccess:BlockAccess":
                return new BlockAccess(name, <any>undefined, { urn })
            case "prefect:index/deployment:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "prefect:index/flow:Flow":
...
pulumi.runtime.registerResourceModule("prefect", "index/block", _module)
pulumi.runtime.registerResourceModule("prefect", "index/blockAccess", _module)
pulumi.runtime.registerResourceModule("prefect", "index/deployment", _module)
pulumi.runtime.registerResourceModule("prefect", "index/flow", _module)
