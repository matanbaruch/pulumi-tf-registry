...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("kentik-synthetics");
			params.setVersion("0.2.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tlbnRpay9rZW50aWstc3ludGhldGljcyIsInZlcnNpb24iOiIwLjIuMSJ9fQ=="), c => c.charCodeAt(0)));
