...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "ciscomcd:index/addressObject:AddressObject":
                return new AddressObject(name, <any>undefined, { urn })
            case "ciscomcd:index/alertProfile:AlertProfile":
                return new AlertProfile(name, <any>undefined, { urn })
            case "ciscomcd:index/alertRule:AlertRule":
                return new AlertRule(name, <any>undefined, { urn })
            case "ciscomcd:index/certificate:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "ciscomcd:index/cloudAccount:CloudAccount":
                return new CloudAccount(name, <any>undefined, { urn })
            case "ciscomcd:index/cloudAccountLogProfileAssociation:CloudAccountLogProfileAssociation":
                return new CloudAccountLogProfileAssociation(name, <any>undefined, { urn })
            case "ciscomcd:index/externalId:ExternalId":
                return new ExternalId(name, <any>undefined, { urn })
            case "ciscomcd:index/gateway:Gateway":
                return new Gateway(name, <any>undefined, { urn })
            case "ciscomcd:index/policyRuleSet:PolicyRuleSet":
                return new PolicyRuleSet(name, <any>undefined, { urn })
            case "ciscomcd:index/policyRules:PolicyRules":
                return new PolicyRules(name, <any>undefined, { urn })
            case "ciscomcd:index/profileAntiMalware:ProfileAntiMalware":
                return new ProfileAntiMalware(name, <any>undefined, { urn })
            case "ciscomcd:index/profileAntiVirus:ProfileAntiVirus":
                return new ProfileAntiVirus(name, <any>undefined, { urn })
            case "ciscomcd:index/profileApplicationThreat:ProfileApplicationThreat":
                return new ProfileApplicationThreat(name, <any>undefined, { urn })
            case "ciscomcd:index/profileDecryption:ProfileDecryption":
                return new ProfileDecryption(name, <any>undefined, { urn })
            case "ciscomcd:index/profileDiagnostics:ProfileDiagnostics":
                return new ProfileDiagnostics(name, <any>undefined, { urn })
            case "ciscomcd:index/profileDlp:ProfileDlp":
                return new ProfileDlp(name, <any>undefined, { urn })
            case "ciscomcd:index/profileDns:ProfileDns":
                return new ProfileDns(name, <any>undefined, { urn })
            case "ciscomcd:index/profileFqdn:ProfileFqdn":
                return new ProfileFqdn(name, <any>undefined, { urn })
            case "ciscomcd:index/profileL7dos:ProfileL7dos":
                return new ProfileL7dos(name, <any>undefined, { urn })
            case "ciscomcd:index/profileLogForwarding:ProfileLogForwarding":
                return new ProfileLogForwarding(name, <any>undefined, { urn })
            case "ciscomcd:index/profileMaliciousIp:ProfileMaliciousIp":
                return new ProfileMaliciousIp(name, <any>undefined, { urn })
            case "ciscomcd:index/profileMaliciousSource:ProfileMaliciousSource":
                return new ProfileMaliciousSource(name, <any>undefined, { urn })
            case "ciscomcd:index/profileMetricsForwarding:ProfileMetricsForwarding":
                return new ProfileMetricsForwarding(name, <any>undefined, { urn })
            case "ciscomcd:index/profileNetworkIntrusion:ProfileNetworkIntrusion":
                return new ProfileNetworkIntrusion(name, <any>undefined, { urn })
            case "ciscomcd:index/profileNtp:ProfileNtp":
                return new ProfileNtp(name, <any>undefined, { urn })
            case "ciscomcd:index/profilePacketCapture:ProfilePacketCapture":
                return new ProfilePacketCapture(name, <any>undefined, { urn })
            case "ciscomcd:index/profileUrlfilter:ProfileUrlfilter":
                return new ProfileUrlfilter(name, <any>undefined, { urn })
            case "ciscomcd:index/serviceObject:ServiceObject":
                return new ServiceObject(name, <any>undefined, { urn })
            case "ciscomcd:index/serviceVpc:ServiceVpc":
                return new ServiceVpc(name, <any>undefined, { urn })
            case "ciscomcd:index/spokeVpc:SpokeVpc":
...
pulumi.runtime.registerResourceModule("ciscomcd", "index/addressObject", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/alertProfile", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/alertRule", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/certificate", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/cloudAccount", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/cloudAccountLogProfileAssociation", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/externalId", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/gateway", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/policyRuleSet", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/policyRules", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileAntiMalware", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileAntiVirus", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileApplicationThreat", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileDecryption", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileDiagnostics", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileDlp", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileDns", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileFqdn", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileL7dos", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileLogForwarding", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileMaliciousIp", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileMaliciousSource", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileMetricsForwarding", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileNetworkIntrusion", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileNtp", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profilePacketCapture", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/profileUrlfilter", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/serviceObject", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/serviceVpc", _module)
pulumi.runtime.registerResourceModule("ciscomcd", "index/spokeVpc", _module)
pulumi.runtime.registerResourcePackage("ciscomcd", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:ciscomcd") {
