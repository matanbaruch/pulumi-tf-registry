...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("hpegl");
			params.setVersion("0.4.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hwZS9ocGVnbCIsInZlcnNpb24iOiIwLjQuNSJ9fQ=="), c => c.charCodeAt(0)));
