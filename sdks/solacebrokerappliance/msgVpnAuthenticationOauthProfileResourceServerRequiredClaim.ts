...
export class MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'solacebrokerappliance:index/msgVpnAuthenticationOauthProfileResourceServerRequiredClaim:MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim';
