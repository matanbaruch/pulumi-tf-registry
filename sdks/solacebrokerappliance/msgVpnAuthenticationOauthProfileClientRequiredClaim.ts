...
export class MsgVpnAuthenticationOauthProfileClientRequiredClaim extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'solacebrokerappliance:index/msgVpnAuthenticationOauthProfileClientRequiredClaim:MsgVpnAuthenticationOauthProfileClientRequiredClaim';
