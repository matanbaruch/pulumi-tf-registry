...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "solacebrokerappliance:index/broker:Broker":
                return new Broker(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/clientCertAuthority:ClientCertAuthority":
                return new ClientCertAuthority(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/clientCertAuthorityOcspTlsTrustedCommonName:ClientCertAuthorityOcspTlsTrustedCommonName":
                return new ClientCertAuthorityOcspTlsTrustedCommonName(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/dmrCluster:DmrCluster":
                return new DmrCluster(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/dmrClusterCertMatchingRule:DmrClusterCertMatchingRule":
                return new DmrClusterCertMatchingRule(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/dmrClusterCertMatchingRuleAttributeFilter:DmrClusterCertMatchingRuleAttributeFilter":
                return new DmrClusterCertMatchingRuleAttributeFilter(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/dmrClusterCertMatchingRuleCondition:DmrClusterCertMatchingRuleCondition":
                return new DmrClusterCertMatchingRuleCondition(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/dmrClusterLink:DmrClusterLink":
                return new DmrClusterLink(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/dmrClusterLinkAttribute:DmrClusterLinkAttribute":
                return new DmrClusterLinkAttribute(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/dmrClusterLinkRemoteAddress:DmrClusterLinkRemoteAddress":
                return new DmrClusterLinkRemoteAddress(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/domainCertAuthority:DomainCertAuthority":
                return new DomainCertAuthority(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpn:MsgVpn":
                return new MsgVpn(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAclProfile:MsgVpnAclProfile":
                return new MsgVpnAclProfile(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAclProfileClientConnectException:MsgVpnAclProfileClientConnectException":
                return new MsgVpnAclProfileClientConnectException(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAclProfilePublishTopicException:MsgVpnAclProfilePublishTopicException":
                return new MsgVpnAclProfilePublishTopicException(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAclProfileSubscribeShareNameException:MsgVpnAclProfileSubscribeShareNameException":
                return new MsgVpnAclProfileSubscribeShareNameException(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAclProfileSubscribeTopicException:MsgVpnAclProfileSubscribeTopicException":
                return new MsgVpnAclProfileSubscribeTopicException(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAuthenticationOauthProfile:MsgVpnAuthenticationOauthProfile":
                return new MsgVpnAuthenticationOauthProfile(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAuthenticationOauthProfileClientRequiredClaim:MsgVpnAuthenticationOauthProfileClientRequiredClaim":
                return new MsgVpnAuthenticationOauthProfileClientRequiredClaim(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAuthenticationOauthProfileResourceServerRequiredClaim:MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim":
                return new MsgVpnAuthenticationOauthProfileResourceServerRequiredClaim(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnAuthorizationGroup:MsgVpnAuthorizationGroup":
                return new MsgVpnAuthorizationGroup(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnBridge:MsgVpnBridge":
                return new MsgVpnBridge(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnBridgeRemoteMsgVpn:MsgVpnBridgeRemoteMsgVpn":
                return new MsgVpnBridgeRemoteMsgVpn(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnBridgeRemoteSubscription:MsgVpnBridgeRemoteSubscription":
                return new MsgVpnBridgeRemoteSubscription(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnCertMatchingRule:MsgVpnCertMatchingRule":
                return new MsgVpnCertMatchingRule(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnCertMatchingRuleAttributeFilter:MsgVpnCertMatchingRuleAttributeFilter":
                return new MsgVpnCertMatchingRuleAttributeFilter(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnCertMatchingRuleCondition:MsgVpnCertMatchingRuleCondition":
                return new MsgVpnCertMatchingRuleCondition(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnClientProfile:MsgVpnClientProfile":
                return new MsgVpnClientProfile(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnClientUsername:MsgVpnClientUsername":
                return new MsgVpnClientUsername(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnClientUsernameAttribute:MsgVpnClientUsernameAttribute":
                return new MsgVpnClientUsernameAttribute(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnDistributedCache:MsgVpnDistributedCache":
                return new MsgVpnDistributedCache(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnDistributedCacheCluster:MsgVpnDistributedCacheCluster":
                return new MsgVpnDistributedCacheCluster(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnDistributedCacheClusterGlobalCachingHomeCluster:MsgVpnDistributedCacheClusterGlobalCachingHomeCluster":
                return new MsgVpnDistributedCacheClusterGlobalCachingHomeCluster(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix:MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix":
                return new MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnDistributedCacheClusterInstance:MsgVpnDistributedCacheClusterInstance":
                return new MsgVpnDistributedCacheClusterInstance(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnDistributedCacheClusterTopic:MsgVpnDistributedCacheClusterTopic":
                return new MsgVpnDistributedCacheClusterTopic(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnDmrBridge:MsgVpnDmrBridge":
                return new MsgVpnDmrBridge(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnJndiConnectionFactory:MsgVpnJndiConnectionFactory":
                return new MsgVpnJndiConnectionFactory(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnJndiQueue:MsgVpnJndiQueue":
                return new MsgVpnJndiQueue(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnJndiTopic:MsgVpnJndiTopic":
                return new MsgVpnJndiTopic(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnMqttRetainCache:MsgVpnMqttRetainCache":
                return new MsgVpnMqttRetainCache(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnMqttSession:MsgVpnMqttSession":
                return new MsgVpnMqttSession(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnMqttSessionSubscription:MsgVpnMqttSessionSubscription":
                return new MsgVpnMqttSessionSubscription(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnProxy:MsgVpnProxy":
                return new MsgVpnProxy(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnQueue:MsgVpnQueue":
                return new MsgVpnQueue(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnQueueSubscription:MsgVpnQueueSubscription":
                return new MsgVpnQueueSubscription(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnQueueTemplate:MsgVpnQueueTemplate":
                return new MsgVpnQueueTemplate(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnReplayLog:MsgVpnReplayLog":
                return new MsgVpnReplayLog(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnReplayLogTopicFilterSubscription:MsgVpnReplayLogTopicFilterSubscription":
                return new MsgVpnReplayLogTopicFilterSubscription(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnReplicatedTopic:MsgVpnReplicatedTopic":
                return new MsgVpnReplicatedTopic(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnRestDeliveryPoint:MsgVpnRestDeliveryPoint":
                return new MsgVpnRestDeliveryPoint(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnRestDeliveryPointQueueBinding:MsgVpnRestDeliveryPointQueueBinding":
                return new MsgVpnRestDeliveryPointQueueBinding(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnRestDeliveryPointQueueBindingProtectedRequestHeader:MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader":
                return new MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnRestDeliveryPointQueueBindingRequestHeader:MsgVpnRestDeliveryPointQueueBindingRequestHeader":
                return new MsgVpnRestDeliveryPointQueueBindingRequestHeader(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnRestDeliveryPointRestConsumer:MsgVpnRestDeliveryPointRestConsumer":
                return new MsgVpnRestDeliveryPointRestConsumer(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnRestDeliveryPointRestConsumerOauthJwtClaim:MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim":
                return new MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnSequencedTopic:MsgVpnSequencedTopic":
                return new MsgVpnSequencedTopic(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnTelemetryProfile:MsgVpnTelemetryProfile":
                return new MsgVpnTelemetryProfile(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnTelemetryProfileReceiverAclConnectException:MsgVpnTelemetryProfileReceiverAclConnectException":
                return new MsgVpnTelemetryProfileReceiverAclConnectException(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnTelemetryProfileTraceFilter:MsgVpnTelemetryProfileTraceFilter":
                return new MsgVpnTelemetryProfileTraceFilter(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnTelemetryProfileTraceFilterSubscription:MsgVpnTelemetryProfileTraceFilterSubscription":
                return new MsgVpnTelemetryProfileTraceFilterSubscription(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnTopicEndpoint:MsgVpnTopicEndpoint":
                return new MsgVpnTopicEndpoint(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/msgVpnTopicEndpointTemplate:MsgVpnTopicEndpointTemplate":
                return new MsgVpnTopicEndpointTemplate(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfile:OauthProfile":
                return new OauthProfile(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfileAccessLevelGroup:OauthProfileAccessLevelGroup":
                return new OauthProfileAccessLevelGroup(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfileAccessLevelGroupMsgVpnAccessLevelException:OauthProfileAccessLevelGroupMsgVpnAccessLevelException":
                return new OauthProfileAccessLevelGroupMsgVpnAccessLevelException(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfileClientAllowedHost:OauthProfileClientAllowedHost":
                return new OauthProfileClientAllowedHost(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfileClientAuthorizationParameter:OauthProfileClientAuthorizationParameter":
                return new OauthProfileClientAuthorizationParameter(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfileClientRequiredClaim:OauthProfileClientRequiredClaim":
                return new OauthProfileClientRequiredClaim(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfileDefaultMsgVpnAccessLevelException:OauthProfileDefaultMsgVpnAccessLevelException":
                return new OauthProfileDefaultMsgVpnAccessLevelException(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/oauthProfileResourceServerRequiredClaim:OauthProfileResourceServerRequiredClaim":
                return new OauthProfileResourceServerRequiredClaim(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/proxy:Proxy":
                return new Proxy(name, <any>undefined, { urn })
            case "solacebrokerappliance:index/virtualHostname:VirtualHostname":
...
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/broker", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/clientCertAuthority", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/clientCertAuthorityOcspTlsTrustedCommonName", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/dmrCluster", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/dmrClusterCertMatchingRule", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/dmrClusterCertMatchingRuleAttributeFilter", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/dmrClusterCertMatchingRuleCondition", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/dmrClusterLink", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/dmrClusterLinkAttribute", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/dmrClusterLinkRemoteAddress", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/domainCertAuthority", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpn", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAclProfile", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAclProfileClientConnectException", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAclProfilePublishTopicException", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAclProfileSubscribeShareNameException", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAclProfileSubscribeTopicException", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAuthenticationOauthProfile", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAuthenticationOauthProfileClientRequiredClaim", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAuthenticationOauthProfileResourceServerRequiredClaim", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnAuthorizationGroup", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnBridge", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnBridgeRemoteMsgVpn", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnBridgeRemoteSubscription", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnCertMatchingRule", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnCertMatchingRuleAttributeFilter", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnCertMatchingRuleCondition", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnClientProfile", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnClientUsername", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnClientUsernameAttribute", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnDistributedCache", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnDistributedCacheCluster", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnDistributedCacheClusterGlobalCachingHomeCluster", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnDistributedCacheClusterInstance", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnDistributedCacheClusterTopic", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnDmrBridge", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnJndiConnectionFactory", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnJndiQueue", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnJndiTopic", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnMqttRetainCache", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnMqttSession", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnMqttSessionSubscription", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnProxy", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnQueue", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnQueueSubscription", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnQueueTemplate", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnReplayLog", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnReplayLogTopicFilterSubscription", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnReplicatedTopic", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnRestDeliveryPoint", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnRestDeliveryPointQueueBinding", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnRestDeliveryPointQueueBindingProtectedRequestHeader", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnRestDeliveryPointQueueBindingRequestHeader", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnRestDeliveryPointRestConsumer", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnRestDeliveryPointRestConsumerOauthJwtClaim", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnSequencedTopic", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnTelemetryProfile", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnTelemetryProfileReceiverAclConnectException", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnTelemetryProfileTraceFilter", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnTelemetryProfileTraceFilterSubscription", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnTopicEndpoint", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/msgVpnTopicEndpointTemplate", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfile", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfileAccessLevelGroup", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfileAccessLevelGroupMsgVpnAccessLevelException", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfileClientAllowedHost", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfileClientAuthorizationParameter", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfileClientRequiredClaim", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfileDefaultMsgVpnAccessLevelException", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/oauthProfileResourceServerRequiredClaim", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/proxy", _module)
pulumi.runtime.registerResourceModule("solacebrokerappliance", "index/virtualHostname", _module)
pulumi.runtime.registerResourcePackage("solacebrokerappliance", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:solacebrokerappliance") {
