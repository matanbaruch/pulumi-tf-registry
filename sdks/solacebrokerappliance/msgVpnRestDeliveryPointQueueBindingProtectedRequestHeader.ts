...
export class MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'solacebrokerappliance:index/msgVpnRestDeliveryPointQueueBindingProtectedRequestHeader:MsgVpnRestDeliveryPointQueueBindingProtectedRequestHeader';
