...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("kentik-cloudexport");
			params.setVersion("0.4.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2tlbnRpay9rZW50aWstY2xvdWRleHBvcnQiLCJ2ZXJzaW9uIjoiMC40LjEifX0="), c => c.charCodeAt(0)));
