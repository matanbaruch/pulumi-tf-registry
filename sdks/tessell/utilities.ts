...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("tessell");
			params.setVersion("0.0.19");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Rlc3NlbGwtY2xvdWQvdGVzc2VsbCIsInZlcnNpb24iOiIwLjAuMTkifX0="), c => c.charCodeAt(0)));
