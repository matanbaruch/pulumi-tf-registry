...
export class CdnSslcert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcore:index/cdnSslcert:CdnSslcert';
     ...
     */
    public readonly automated!: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CdnSslcertArgs | CdnSslcertState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["automated"] = args ? args.automated : undefined;
