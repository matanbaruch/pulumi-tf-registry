...
export class FaasFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcore:index/faasFunction:FaasFunction';
     ...
     */
    public readonly enableApiKey!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: FaasFunctionArgs | FaasFunctionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["enableApiKey"] = state ? state.enableApiKey : undefined;
            ...
            resourceInputs["enableApiKey"] = args ? args.enableApiKey : undefined;
...
export interface FaasFunctionState {
     ...
     * Enable/Disable api key authorization
     */
    enableApiKey?: pulumi.Input<boolean>;
