...
export class DnsZone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcore:index/dnsZone:DnsZone';
    ...
    /**
     * Activation or deactivation of DNSSEC for the zone.Set it to true to enable DNSSEC for the zone or false to disable it.By
     * default, DNSSEC is set to false wich means it is disabled.
     */
