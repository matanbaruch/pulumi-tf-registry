...
export class Lbpool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcore:index/lbpool:Lbpool';
    ...
    /**
     * ID of the desired project to create load balancer pool in. Alternative for `project_name`. One of them should be
     * specified.
     */
    public readonly projectId!: pulumi.Output<number | undefined>;
    /**
     * Name of the desired project to create load balancer pool in. Alternative for `project_id`. One of them should be
     * specified.
     */
    ...
    /**
     * ID of the desired region to create load balancer pool in. Alternative for `region_name`. One of them should be
     * specified.
     */
    public readonly regionId!: pulumi.Output<number | undefined>;
    /**
     * Name of the desired region to create load balancer pool in. Alternative for `region_id`. One of them should be
     * specified.
     */
    public readonly regionName!: pulumi.Output<string | undefined>;
    /**
     * Pool session persistence tells the load balancer to attempt to send future requests from a client to the same backend
     * member as the initial request.
     */
