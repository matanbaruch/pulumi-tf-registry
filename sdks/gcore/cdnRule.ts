...
export class CdnRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcore:index/cdnRule:CdnRule';
    ...
    /**
     * Each option in CDN rule settings. Each option added to CDN rule settings should have the following mandatory request
