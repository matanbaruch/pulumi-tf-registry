...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gcore");
			params.setVersion("0.8.14");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ctY29yZS9nY29yZSIsInZlcnNpb24iOiIwLjguMTQifX0="), c => c.charCodeAt(0)));
