...
export class HyperflexSysConfigPolicy extends pulumi.CustomResource {
    /**
     * Get an existing HyperflexSysConfigPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HyperflexSysConfigPolicyState, opts?: pulumi.CustomResourceOptions): HyperflexSysConfigPolicy {
        return new HyperflexSysConfigPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/hyperflexSysConfigPolicy:HyperflexSysConfigPolicy';

    /**
     * Returns true if the given object is an instance of HyperflexSysConfigPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HyperflexSysConfigPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HyperflexSysConfigPolicy.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.HyperflexSysConfigPolicyAncestor[]>;
    /**
     ...
     */
    public readonly clusterProfiles!: pulumi.Output<outputs.HyperflexSysConfigPolicyClusterProfile[]>;
    /**
     ...
     */
    public readonly organizations!: pulumi.Output<outputs.HyperflexSysConfigPolicyOrganization[]>;
    public readonly owners!: pulumi.Output<string[]>;
    /**
     * A reference to a moBaseMo resource. When the $expand query parameter is specified, the referenced resource is returned
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.HyperflexSysConfigPolicyParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.HyperflexSysConfigPolicyPermissionResource[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.HyperflexSysConfigPolicyTag[]>;
    /**
     * The timezone of the HyperFlex cluster's system clock. * `Pacific/Niue` - * `Africa/Abidjan` - * `Africa/Accra` - *
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.HyperflexSysConfigPolicyVersionContext[]>;

    /**
     * Create a HyperflexSysConfigPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: HyperflexSysConfigPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HyperflexSysConfigPolicyArgs | HyperflexSysConfigPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HyperflexSysConfigPolicyState | undefined;
            ...
            const args = argsOrState as HyperflexSysConfigPolicyArgs | undefined;
        ...
        super(HyperflexSysConfigPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering HyperflexSysConfigPolicy resources.
 */
export interface HyperflexSysConfigPolicyState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.HyperflexSysConfigPolicyAncestor>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
     ...
     * An array of relationships to hyperflexClusterProfile resources.
     */
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.HyperflexSysConfigPolicyClusterProfile>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * resource is returned inline.
     */
    organizations?: pulumi.Input<pulumi.Input<inputs.HyperflexSysConfigPolicyOrganization>[]>;
    owners?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * A reference to a moBaseMo resource. When the $expand query parameter is specified, the referenced resource is returned
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.HyperflexSysConfigPolicyParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.HyperflexSysConfigPolicyPermissionResource>[]>;
    /**
     * Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made
     * available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally
     * available to all end users or restricted to end users based on their license entitlement. Users can use this property to
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.HyperflexSysConfigPolicyTag>[]>;
    /**
     * The timezone of the HyperFlex cluster's system clock. * `Pacific/Niue` - * `Africa/Abidjan` - * `Africa/Accra` - *
     * `Africa/Addis_Ababa` - * `Africa/Algiers` - * `Africa/Asmara` - * `Africa/Bamako` - * `Africa/Bangui` - *
     * `Africa/Banjul` - * `Africa/Bissau` - * `Africa/Blantyre` - * `Africa/Brazzaville` - * `Africa/Bujumbura` - *
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.HyperflexSysConfigPolicyVersionContext>[]>;
}

/**
 * The set of arguments for constructing a HyperflexSysConfigPolicy resource.
 */
export interface HyperflexSysConfigPolicyArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
