...
export class SoftwareHclMeta extends pulumi.CustomResource {
    /**
     * Get an existing SoftwareHclMeta resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareHclMetaState, opts?: pulumi.CustomResourceOptions): SoftwareHclMeta {
        return new SoftwareHclMeta(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/softwareHclMeta:SoftwareHclMeta';

    /**
     * Returns true if the given object is an instance of SoftwareHclMeta.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SoftwareHclMeta {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SoftwareHclMeta.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.SoftwareHclMetaAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.SoftwareHclMetaCatalog[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    public readonly classId!: pulumi.Output<string | undefined>;
    public readonly componentMetas!: pulumi.Output<outputs.SoftwareHclMetaComponentMeta[]>;
    /**
     * The type of content that the Json file holds (Incremental or full dump). * `Full` - Indicates that the JSON File does
     * have full content for HCL metadata. * `Incremental` - Indicates that the JSON File does have only the diff of the Hcl
     * meta to be uploaded.
     */
     ...
     */
    public readonly distributableMetas!: pulumi.Output<outputs.SoftwareHclMetaDistributableMeta[]>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.SoftwareHclMetaNrSource[]>;
    /**
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.SoftwareHclMetaParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.SoftwareHclMetaPermissionResource[]>;
    /**
     ...
     * resource is returned inline.
     */
    public readonly releases!: pulumi.Output<outputs.SoftwareHclMetaRelease[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.SoftwareHclMetaTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.SoftwareHclMetaVersionContext[]>;

    /**
     * Create a SoftwareHclMeta resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SoftwareHclMetaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SoftwareHclMetaArgs | SoftwareHclMetaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SoftwareHclMetaState | undefined;
            ...
            const args = argsOrState as SoftwareHclMetaArgs | undefined;
        ...
        super(SoftwareHclMeta.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SoftwareHclMeta resources.
 */
export interface SoftwareHclMetaState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaAncestor>[]>;
    /**
     * The bundle type of the image, as published on cisco.com.
     */
     ...
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    classId?: pulumi.Input<string>;
    componentMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaComponentMeta>[]>;
    /**
     * The type of content that the Json file holds (Incremental or full dump). * `Full` - Indicates that the JSON File does
     * have full content for HCL metadata. * `Incremental` - Indicates that the JSON File does have only the diff of the Hcl
     * meta to be uploaded.
     ...
     * An array of relationships to firmwareDistributableMeta resources.
     */
    distributableMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaDistributableMeta>[]>;
    /**
     * The DomainGroup ID for this managed object.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaPermissionResource>[]>;
    /**
     * The platform type of the image.
     */
     ...
     * resource is returned inline.
     */
    releases?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaRelease>[]>;
    /**
     * The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the
     * local repository.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.SoftwareHclMetaVersionContext>[]>;
}

/**
 * The set of arguments for constructing a SoftwareHclMeta resource.
 */
export interface SoftwareHclMetaArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
