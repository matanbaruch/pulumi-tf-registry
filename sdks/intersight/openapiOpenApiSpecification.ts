...
export class OpenapiOpenApiSpecification extends pulumi.CustomResource {
    /**
     * Get an existing OpenapiOpenApiSpecification resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OpenapiOpenApiSpecificationState, opts?: pulumi.CustomResourceOptions): OpenapiOpenApiSpecification {
        return new OpenapiOpenApiSpecification(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/openapiOpenApiSpecification:OpenapiOpenApiSpecification';

    /**
     * Returns true if the given object is an instance of OpenapiOpenApiSpecification.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OpenapiOpenApiSpecification {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OpenapiOpenApiSpecification.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.OpenapiOpenApiSpecificationAncestor[]>;
    /**
     ...
     */
    public readonly fileUploadId!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.OpenapiOpenApiSpecificationNrSource[]>;
    /**
     ...
     */
    public readonly organizations!: pulumi.Output<outputs.OpenapiOpenApiSpecificationOrganization[]>;
    public readonly owners!: pulumi.Output<string[]>;
    /**
     * A reference to a moBaseMo resource. When the $expand query parameter is specified, the referenced resource is returned
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.OpenapiOpenApiSpecificationParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.OpenapiOpenApiSpecificationPermissionResource[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.OpenapiOpenApiSpecificationTag[]>;
    /**
     * The versioning info for this managed object.
     */
    public readonly versionContexts!: pulumi.Output<outputs.OpenapiOpenApiSpecificationVersionContext[]>;

    /**
     * Create a OpenapiOpenApiSpecification resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: OpenapiOpenApiSpecificationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OpenapiOpenApiSpecificationArgs | OpenapiOpenApiSpecificationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OpenapiOpenApiSpecificationState | undefined;
            ...
            resourceInputs["fileUploadId"] = state ? state.fileUploadId : undefined;
            ...
            const args = argsOrState as OpenapiOpenApiSpecificationArgs | undefined;
            ...
            resourceInputs["fileUploadId"] = args ? args.fileUploadId : undefined;
        ...
        super(OpenapiOpenApiSpecification.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OpenapiOpenApiSpecification resources.
 */
export interface OpenapiOpenApiSpecificationState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.OpenapiOpenApiSpecificationAncestor>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.OpenapiOpenApiSpecificationNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * resource is returned inline.
     */
    organizations?: pulumi.Input<pulumi.Input<inputs.OpenapiOpenApiSpecificationOrganization>[]>;
    owners?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * A reference to a moBaseMo resource. When the $expand query parameter is specified, the referenced resource is returned
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.OpenapiOpenApiSpecificationParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.OpenapiOpenApiSpecificationPermissionResource>[]>;
    /**
     * The date on which the file was released or distributed by its vendor.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.OpenapiOpenApiSpecificationTag>[]>;
    /**
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.OpenapiOpenApiSpecificationVersionContext>[]>;
}

/**
 * The set of arguments for constructing a OpenapiOpenApiSpecification resource.
 */
export interface OpenapiOpenApiSpecificationArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
