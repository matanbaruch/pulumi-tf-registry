...
export class FirmwareServerConfigurationUtilityDistributable extends pulumi.CustomResource {
    /**
     * Get an existing FirmwareServerConfigurationUtilityDistributable resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirmwareServerConfigurationUtilityDistributableState, opts?: pulumi.CustomResourceOptions): FirmwareServerConfigurationUtilityDistributable {
        return new FirmwareServerConfigurationUtilityDistributable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/firmwareServerConfigurationUtilityDistributable:FirmwareServerConfigurationUtilityDistributable';

    /**
     * Returns true if the given object is an instance of FirmwareServerConfigurationUtilityDistributable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirmwareServerConfigurationUtilityDistributable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirmwareServerConfigurationUtilityDistributable.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableCatalog[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    public readonly classId!: pulumi.Output<string | undefined>;
    public readonly componentMetas!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableComponentMeta[]>;
    /**
     ...
     */
    public readonly distributableMetas!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableDistributableMeta[]>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableNrSource[]>;
    /**
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributablePermissionResource[]>;
    /**
     ...
     * resource is returned inline.
     */
    public readonly releases!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableRelease[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.FirmwareServerConfigurationUtilityDistributableVersionContext[]>;

    /**
     * Create a FirmwareServerConfigurationUtilityDistributable resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: FirmwareServerConfigurationUtilityDistributableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirmwareServerConfigurationUtilityDistributableArgs | FirmwareServerConfigurationUtilityDistributableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirmwareServerConfigurationUtilityDistributableState | undefined;
            ...
            const args = argsOrState as FirmwareServerConfigurationUtilityDistributableArgs | undefined;
        ...
        super(FirmwareServerConfigurationUtilityDistributable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering FirmwareServerConfigurationUtilityDistributable resources.
 */
export interface FirmwareServerConfigurationUtilityDistributableState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableAncestor>[]>;
    /**
     * The bundle type of the image, as published on cisco.com.
     */
     ...
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    classId?: pulumi.Input<string>;
    componentMetas?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableComponentMeta>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * An array of relationships to firmwareDistributableMeta resources.
     */
    distributableMetas?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableDistributableMeta>[]>;
    /**
     * The DomainGroup ID for this managed object.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributablePermissionResource>[]>;
    /**
     * The platform type of the image.
     */
     ...
     * resource is returned inline.
     */
    releases?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableRelease>[]>;
    /**
     * The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the
     * local repository.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.FirmwareServerConfigurationUtilityDistributableVersionContext>[]>;
}

/**
 * The set of arguments for constructing a FirmwareServerConfigurationUtilityDistributable resource.
 */
export interface FirmwareServerConfigurationUtilityDistributableArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
