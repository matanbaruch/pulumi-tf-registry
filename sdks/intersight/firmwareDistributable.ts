...
export class FirmwareDistributable extends pulumi.CustomResource {
    /**
     * Get an existing FirmwareDistributable resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirmwareDistributableState, opts?: pulumi.CustomResourceOptions): FirmwareDistributable {
        return new FirmwareDistributable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/firmwareDistributable:FirmwareDistributable';

    /**
     * Returns true if the given object is an instance of FirmwareDistributable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirmwareDistributable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirmwareDistributable.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.FirmwareDistributableAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.FirmwareDistributableCatalog[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    public readonly classId!: pulumi.Output<string | undefined>;
    public readonly componentMetas!: pulumi.Output<outputs.FirmwareDistributableComponentMeta[]>;
    /**
     ...
     */
    public readonly distributableMetas!: pulumi.Output<outputs.FirmwareDistributableDistributableMeta[]>;
    /**
     ...
     */
    public readonly fileLocation!: pulumi.Output<string | undefined>;
    /**
     * The unique identifier for an image in a Cisco repository.
     */
    public readonly guid!: pulumi.Output<string>;
    /**
     * The category into which the distributable falls into according to the supported platform series. For e.g.;
     * C-Series/B-Series/Infrastructure.
     */
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.FirmwareDistributableNrSource[]>;
    /**
    ...
    /**
     * The source of the distributable. If it has been created by the user or system. * `System` - The distributable has been
     * created by the System. * `User` - The distributable has been created by the User.
     */
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.FirmwareDistributableParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.FirmwareDistributablePermissionResource[]>;
    /**
     ...
     * resource is returned inline.
     */
    public readonly releases!: pulumi.Output<outputs.FirmwareDistributableRelease[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.FirmwareDistributableTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.FirmwareDistributableVersionContext[]>;

    /**
     * Create a FirmwareDistributable resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: FirmwareDistributableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirmwareDistributableArgs | FirmwareDistributableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirmwareDistributableState | undefined;
            ...
            const args = argsOrState as FirmwareDistributableArgs | undefined;
        ...
        super(FirmwareDistributable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering FirmwareDistributable resources.
 */
export interface FirmwareDistributableState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableAncestor>[]>;
    /**
     * The bundle type of the image, as published on cisco.com.
     */
     ...
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    classId?: pulumi.Input<string>;
    componentMetas?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableComponentMeta>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * An array of relationships to firmwareDistributableMeta resources.
     */
    distributableMetas?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableDistributableMeta>[]>;
    /**
     * The DomainGroup ID for this managed object.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributablePermissionResource>[]>;
    /**
     * The platform type of the image.
     */
     ...
     * resource is returned inline.
     */
    releases?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableRelease>[]>;
    /**
     * The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the
     * local repository.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.FirmwareDistributableVersionContext>[]>;
}

/**
 * The set of arguments for constructing a FirmwareDistributable resource.
 */
export interface FirmwareDistributableArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
