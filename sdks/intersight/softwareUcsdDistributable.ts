...
export class SoftwareUcsdDistributable extends pulumi.CustomResource {
    /**
     * Get an existing SoftwareUcsdDistributable resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareUcsdDistributableState, opts?: pulumi.CustomResourceOptions): SoftwareUcsdDistributable {
        return new SoftwareUcsdDistributable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/softwareUcsdDistributable:SoftwareUcsdDistributable';

    /**
     * Returns true if the given object is an instance of SoftwareUcsdDistributable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SoftwareUcsdDistributable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SoftwareUcsdDistributable.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.SoftwareUcsdDistributableAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.SoftwareUcsdDistributableCatalog[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    public readonly classId!: pulumi.Output<string | undefined>;
    public readonly componentMetas!: pulumi.Output<outputs.SoftwareUcsdDistributableComponentMeta[]>;
    /**
     ...
     */
    public readonly distributableMetas!: pulumi.Output<outputs.SoftwareUcsdDistributableDistributableMeta[]>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.SoftwareUcsdDistributableNrSource[]>;
    /**
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.SoftwareUcsdDistributableParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.SoftwareUcsdDistributablePermissionResource[]>;
    /**
     ...
     * resource is returned inline.
     */
    public readonly releases!: pulumi.Output<outputs.SoftwareUcsdDistributableRelease[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.SoftwareUcsdDistributableTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.SoftwareUcsdDistributableVersionContext[]>;

    /**
     * Create a SoftwareUcsdDistributable resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SoftwareUcsdDistributableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SoftwareUcsdDistributableArgs | SoftwareUcsdDistributableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SoftwareUcsdDistributableState | undefined;
            ...
            const args = argsOrState as SoftwareUcsdDistributableArgs | undefined;
        ...
        super(SoftwareUcsdDistributable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SoftwareUcsdDistributable resources.
 */
export interface SoftwareUcsdDistributableState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableAncestor>[]>;
    /**
     * The bundle type of the image, as published on cisco.com.
     */
     ...
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    classId?: pulumi.Input<string>;
    componentMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableComponentMeta>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * An array of relationships to firmwareDistributableMeta resources.
     */
    distributableMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableDistributableMeta>[]>;
    /**
     * The DomainGroup ID for this managed object.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributablePermissionResource>[]>;
    /**
     * The platform type of the image.
     */
     ...
     * resource is returned inline.
     */
    releases?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableRelease>[]>;
    /**
     * The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the
     * local repository.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.SoftwareUcsdDistributableVersionContext>[]>;
}

/**
 * The set of arguments for constructing a SoftwareUcsdDistributable resource.
 */
export interface SoftwareUcsdDistributableArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
