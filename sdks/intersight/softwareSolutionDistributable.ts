...
export class SoftwareSolutionDistributable extends pulumi.CustomResource {
    /**
     * Get an existing SoftwareSolutionDistributable resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareSolutionDistributableState, opts?: pulumi.CustomResourceOptions): SoftwareSolutionDistributable {
        return new SoftwareSolutionDistributable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/softwareSolutionDistributable:SoftwareSolutionDistributable';

    /**
     * Returns true if the given object is an instance of SoftwareSolutionDistributable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SoftwareSolutionDistributable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SoftwareSolutionDistributable.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.SoftwareSolutionDistributableAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.SoftwareSolutionDistributableCatalog[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    public readonly classId!: pulumi.Output<string | undefined>;
    public readonly componentMetas!: pulumi.Output<outputs.SoftwareSolutionDistributableComponentMeta[]>;
    /**
     ...
     */
    public readonly distributableMetas!: pulumi.Output<outputs.SoftwareSolutionDistributableDistributableMeta[]>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.SoftwareSolutionDistributableNrSource[]>;
    /**
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.SoftwareSolutionDistributableParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.SoftwareSolutionDistributablePermissionResource[]>;
    /**
     ...
     * resource is returned inline.
     */
    public readonly releases!: pulumi.Output<outputs.SoftwareSolutionDistributableRelease[]>;
    /**
     ...
     */
    public readonly solutionName!: pulumi.Output<string | undefined>;
    /**
     * The type of the file like OS image, Script etc. * `osimage` - The solution OS image for deployment. * `script` - The
     * Python script for the solution VM configuration and deployment.
     */
    public readonly subType!: pulumi.Output<string | undefined>;
    public readonly supportedModels!: pulumi.Output<string[]>;
    public readonly tags!: pulumi.Output<outputs.SoftwareSolutionDistributableTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.SoftwareSolutionDistributableVersionContext[]>;

    /**
     * Create a SoftwareSolutionDistributable resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SoftwareSolutionDistributableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SoftwareSolutionDistributableArgs | SoftwareSolutionDistributableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SoftwareSolutionDistributableState | undefined;
            ...
            const args = argsOrState as SoftwareSolutionDistributableArgs | undefined;
        ...
        super(SoftwareSolutionDistributable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SoftwareSolutionDistributable resources.
 */
export interface SoftwareSolutionDistributableState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableAncestor>[]>;
    /**
     * The bundle type of the image, as published on cisco.com.
     */
     ...
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    classId?: pulumi.Input<string>;
    componentMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableComponentMeta>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * An array of relationships to firmwareDistributableMeta resources.
     */
    distributableMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableDistributableMeta>[]>;
    /**
     * The DomainGroup ID for this managed object.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributablePermissionResource>[]>;
    /**
     * The platform type of the image.
     */
     ...
     * resource is returned inline.
     */
    releases?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableRelease>[]>;
    /**
     * The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the
     * local repository.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.SoftwareSolutionDistributableVersionContext>[]>;
}

/**
 * The set of arguments for constructing a SoftwareSolutionDistributable resource.
 */
export interface SoftwareSolutionDistributableArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
