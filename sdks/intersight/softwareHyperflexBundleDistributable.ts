...
export class SoftwareHyperflexBundleDistributable extends pulumi.CustomResource {
    /**
     * Get an existing SoftwareHyperflexBundleDistributable resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareHyperflexBundleDistributableState, opts?: pulumi.CustomResourceOptions): SoftwareHyperflexBundleDistributable {
        return new SoftwareHyperflexBundleDistributable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/softwareHyperflexBundleDistributable:SoftwareHyperflexBundleDistributable';

    /**
     * Returns true if the given object is an instance of SoftwareHyperflexBundleDistributable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SoftwareHyperflexBundleDistributable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SoftwareHyperflexBundleDistributable.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableCatalog[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    public readonly classId!: pulumi.Output<string | undefined>;
    public readonly componentMetas!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableComponentMeta[]>;
    /**
     ...
     */
    public readonly distributableMetas!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableDistributableMeta[]>;
    /**
     ...
     */
    public readonly images!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableImage[]>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableNrSource[]>;
    /**
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributablePermissionResource[]>;
    /**
     ...
     * resource is returned inline.
     */
    public readonly releases!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableRelease[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.SoftwareHyperflexBundleDistributableVersionContext[]>;

    /**
     * Create a SoftwareHyperflexBundleDistributable resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SoftwareHyperflexBundleDistributableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SoftwareHyperflexBundleDistributableArgs | SoftwareHyperflexBundleDistributableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SoftwareHyperflexBundleDistributableState | undefined;
            ...
            const args = argsOrState as SoftwareHyperflexBundleDistributableArgs | undefined;
        ...
        super(SoftwareHyperflexBundleDistributable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SoftwareHyperflexBundleDistributable resources.
 */
export interface SoftwareHyperflexBundleDistributableState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableAncestor>[]>;
    /**
     * The bundle type of the image, as published on cisco.com.
     */
     ...
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    classId?: pulumi.Input<string>;
    componentMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableComponentMeta>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * An array of relationships to firmwareDistributableMeta resources.
     */
    distributableMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableDistributableMeta>[]>;
    /**
     * The DomainGroup ID for this managed object.
     */
     ...
     * An array of relationships to softwareHyperflexDistributable resources.
     */
    images?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableImage>[]>;
    /**
     * The action to be performed on the imported file. If 'PreCache' is set, the image will be cached in Appliance. Applicable
     * in Intersight appliance deployment. If 'Evict' is set, the cached file will be removed. Applicable in Intersight
     * appliance deployment. If 'GeneratePreSignedUploadUrl' is set, generates pre signed URL (s) for the file to be imported
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributablePermissionResource>[]>;
    /**
     * The platform type of the image.
     */
     ...
     * resource is returned inline.
     */
    releases?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableRelease>[]>;
    /**
     * The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the
     * local repository.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.SoftwareHyperflexBundleDistributableVersionContext>[]>;
}

/**
 * The set of arguments for constructing a SoftwareHyperflexBundleDistributable resource.
 */
export interface SoftwareHyperflexBundleDistributableArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
