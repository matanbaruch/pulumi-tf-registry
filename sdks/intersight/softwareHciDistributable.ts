...
export class SoftwareHciDistributable extends pulumi.CustomResource {
    /**
     * Get an existing SoftwareHciDistributable resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwareHciDistributableState, opts?: pulumi.CustomResourceOptions): SoftwareHciDistributable {
        return new SoftwareHciDistributable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/softwareHciDistributable:SoftwareHciDistributable';

    /**
     * Returns true if the given object is an instance of SoftwareHciDistributable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SoftwareHciDistributable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SoftwareHciDistributable.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.SoftwareHciDistributableAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.SoftwareHciDistributableCatalog[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    public readonly classId!: pulumi.Output<string | undefined>;
    public readonly componentMetas!: pulumi.Output<outputs.SoftwareHciDistributableComponentMeta[]>;
    /**
     ...
     */
    public readonly distributableMetas!: pulumi.Output<outputs.SoftwareHciDistributableDistributableMeta[]>;
    /**
    ...
    /**
     * Additional information associated with the distributable object. This data is provided as a JSON blob by Nutanix, a
     * partner vendor, and the format is not fixed.
     */
    public readonly metaInfo!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.SoftwareHciDistributableNrSource[]>;
    /**
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.SoftwareHciDistributableParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.SoftwareHciDistributablePermissionResource[]>;
    /**
     ...
     * resource is returned inline.
     */
    public readonly releases!: pulumi.Output<outputs.SoftwareHciDistributableRelease[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.SoftwareHciDistributableTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.SoftwareHciDistributableVersionContext[]>;

    /**
     * Create a SoftwareHciDistributable resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SoftwareHciDistributableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SoftwareHciDistributableArgs | SoftwareHciDistributableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SoftwareHciDistributableState | undefined;
            ...
            resourceInputs["metaInfo"] = state ? state.metaInfo : undefined;
            ...
            const args = argsOrState as SoftwareHciDistributableArgs | undefined;
            ...
            resourceInputs["metaInfo"] = args ? args.metaInfo : undefined;
        ...
        super(SoftwareHciDistributable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SoftwareHciDistributable resources.
 */
export interface SoftwareHciDistributableState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableAncestor>[]>;
    /**
     * The bundle type of the image, as published on cisco.com.
     */
     ...
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
    classId?: pulumi.Input<string>;
    componentMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableComponentMeta>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * An array of relationships to firmwareDistributableMeta resources.
     */
    distributableMetas?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableDistributableMeta>[]>;
    /**
     * The DomainGroup ID for this managed object.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributablePermissionResource>[]>;
    /**
     * The platform type of the image.
     */
     ...
     * resource is returned inline.
     */
    releases?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableRelease>[]>;
    /**
     * The sha512sum of the file. This information is available for all Cisco distributed images and files imported to the
     * local repository.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.SoftwareHciDistributableVersionContext>[]>;
}

/**
 * The set of arguments for constructing a SoftwareHciDistributable resource.
 */
export interface SoftwareHciDistributableArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
