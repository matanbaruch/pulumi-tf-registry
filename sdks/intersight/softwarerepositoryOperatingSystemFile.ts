...
export class SoftwarerepositoryOperatingSystemFile extends pulumi.CustomResource {
    /**
     * Get an existing SoftwarerepositoryOperatingSystemFile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SoftwarerepositoryOperatingSystemFileState, opts?: pulumi.CustomResourceOptions): SoftwarerepositoryOperatingSystemFile {
        return new SoftwarerepositoryOperatingSystemFile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/softwarerepositoryOperatingSystemFile:SoftwarerepositoryOperatingSystemFile';

    /**
     * Returns true if the given object is an instance of SoftwarerepositoryOperatingSystemFile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SoftwarerepositoryOperatingSystemFile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SoftwarerepositoryOperatingSystemFile.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.SoftwarerepositoryOperatingSystemFileAncestor[]>;
    /**
     ...
     */
    public readonly catalogs!: pulumi.Output<outputs.SoftwarerepositoryOperatingSystemFileCatalog[]>;
    /**
     ...
     */
    public readonly nrSources!: pulumi.Output<outputs.SoftwarerepositoryOperatingSystemFileNrSource[]>;
    /**
     ...
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.SoftwarerepositoryOperatingSystemFileParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.SoftwarerepositoryOperatingSystemFilePermissionResource[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.SoftwarerepositoryOperatingSystemFileTag[]>;
    /**
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.SoftwarerepositoryOperatingSystemFileVersionContext[]>;

    /**
     * Create a SoftwarerepositoryOperatingSystemFile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SoftwarerepositoryOperatingSystemFileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SoftwarerepositoryOperatingSystemFileArgs | SoftwarerepositoryOperatingSystemFileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SoftwarerepositoryOperatingSystemFileState | undefined;
            ...
            const args = argsOrState as SoftwarerepositoryOperatingSystemFileArgs | undefined;
        ...
        super(SoftwarerepositoryOperatingSystemFile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SoftwarerepositoryOperatingSystemFile resources.
 */
export interface SoftwarerepositoryOperatingSystemFileState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.SoftwarerepositoryOperatingSystemFileAncestor>[]>;
    /**
     * A reference to a softwarerepositoryCatalog resource. When the $expand query parameter is specified, the referenced
     * resource is returned inline.
     */
    catalogs?: pulumi.Input<pulumi.Input<inputs.SoftwarerepositoryOperatingSystemFileCatalog>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
     ...
     * Location of the file in an external repository.
     */
    nrSources?: pulumi.Input<pulumi.Input<inputs.SoftwarerepositoryOperatingSystemFileNrSource>[]>;
    /**
     * Vendor provided version for the file.
     */
     ...
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.SoftwarerepositoryOperatingSystemFileParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.SoftwarerepositoryOperatingSystemFilePermissionResource>[]>;
    /**
     * The date on which the file was released or distributed by its vendor.
     */
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.SoftwarerepositoryOperatingSystemFileTag>[]>;
    /**
     * The vendor or publisher of this file.
     */
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.SoftwarerepositoryOperatingSystemFileVersionContext>[]>;
}

/**
 * The set of arguments for constructing a SoftwarerepositoryOperatingSystemFile resource.
 */
export interface SoftwarerepositoryOperatingSystemFileArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
