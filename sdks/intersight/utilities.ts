...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("intersight");
			params.setVersion("1.0.52");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Npc2NvZGV2bmV0L2ludGVyc2lnaHQiLCJ2ZXJzaW9uIjoiMS4wLjUyIn19"), c => c.charCodeAt(0)));
