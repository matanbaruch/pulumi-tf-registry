...
export class KubernetesSysConfigPolicy extends pulumi.CustomResource {
    /**
     * Get an existing KubernetesSysConfigPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KubernetesSysConfigPolicyState, opts?: pulumi.CustomResourceOptions): KubernetesSysConfigPolicy {
        return new KubernetesSysConfigPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'intersight:index/kubernetesSysConfigPolicy:KubernetesSysConfigPolicy';

    /**
     * Returns true if the given object is an instance of KubernetesSysConfigPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubernetesSysConfigPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubernetesSysConfigPolicy.__pulumiType;
    }
     ...
     */
    public readonly ancestors!: pulumi.Output<outputs.KubernetesSysConfigPolicyAncestor[]>;
    /**
     ...
     */
    public readonly clusterProfiles!: pulumi.Output<outputs.KubernetesSysConfigPolicyClusterProfile[]>;
    /**
     ...
     */
    public readonly dnsDomainName!: pulumi.Output<string | undefined>;
     ...
     */
    public readonly organizations!: pulumi.Output<outputs.KubernetesSysConfigPolicyOrganization[]>;
    public readonly owners!: pulumi.Output<string[]>;
    /**
     * A reference to a moBaseMo resource. When the $expand query parameter is specified, the referenced resource is returned
     * inline.
     */
    public readonly parents!: pulumi.Output<outputs.KubernetesSysConfigPolicyParent[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    public readonly permissionResources!: pulumi.Output<outputs.KubernetesSysConfigPolicyPermissionResource[]>;
    /**
    ...
    public readonly tags!: pulumi.Output<outputs.KubernetesSysConfigPolicyTag[]>;
    /**
     * The timezone of the node's system clock. * `Pacific/Niue` - * `Africa/Abidjan` - * `Africa/Accra` - *
     * `Africa/Addis_Ababa` - * `Africa/Algiers` - * `Africa/Asmara` - * `Africa/Bamako` - * `Africa/Bangui` - *
     ...
     * `Asia/Amman` - * `Asia/Anadyr` - * `Asia/Aqtau` - * `Asia/Aqtobe` - * `Asia/Ashgabat` - * `Asia/Baghdad` - *
     * `Asia/Bahrain` - * `Asia/Baku` - * `Asia/Bangkok` - * `Asia/Beirut` - * `Asia/Bishkek` - * `Asia/Brunei` - *
     * `Asia/Calcutta` - * `Asia/Choibalsan` - * `Asia/Chongqing` - * `Asia/Colombo` - * `Asia/Damascus` - * `Asia/Dhaka` - *
     * `Asia/Dili` - * `Asia/Dubai` - * `Asia/Dushanbe` - * `Asia/Gaza` - * `Asia/Harbin` - * `Asia/Hebron` - *
     ...
     * * `Etc/GMT` - * `Europe/Amsterdam` - * `Europe/Andorra` - * `Europe/Athens` - * `Europe/Belgrade` - * `Europe/Berlin` -
     ...
     */
    public readonly versionContexts!: pulumi.Output<outputs.KubernetesSysConfigPolicyVersionContext[]>;

    /**
     * Create a KubernetesSysConfigPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: KubernetesSysConfigPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KubernetesSysConfigPolicyArgs | KubernetesSysConfigPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KubernetesSysConfigPolicyState | undefined;
            ...
            const args = argsOrState as KubernetesSysConfigPolicyArgs | undefined;
        ...
        super(KubernetesSysConfigPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KubernetesSysConfigPolicy resources.
 */
export interface KubernetesSysConfigPolicyState {
    /**
     * The Account ID for this managed object.
     */
     ...
     * An array of relationships to moBaseMo resources.
     */
    ancestors?: pulumi.Input<pulumi.Input<inputs.KubernetesSysConfigPolicyAncestor>[]>;
    /**
     * The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the
     * type of the payload when marshaling and unmarshaling data.
     */
     ...
     * An array of relationships to kubernetesClusterProfile resources.
     */
    clusterProfiles?: pulumi.Input<pulumi.Input<inputs.KubernetesSysConfigPolicyClusterProfile>[]>;
    /**
     * The time when this managed object was created.
     */
     ...
     * resource is returned inline.
     */
    organizations?: pulumi.Input<pulumi.Input<inputs.KubernetesSysConfigPolicyOrganization>[]>;
    owners?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * A reference to a moBaseMo resource. When the $expand query parameter is specified, the referenced resource is returned
     * inline.
     */
    parents?: pulumi.Input<pulumi.Input<inputs.KubernetesSysConfigPolicyParent>[]>;
    /**
     * An array of relationships to moBaseMo resources.
     */
    permissionResources?: pulumi.Input<pulumi.Input<inputs.KubernetesSysConfigPolicyPermissionResource>[]>;
    /**
     * Intersight provides pre-built workflows, tasks and policies to end users through global catalogs. Objects that are made
     * available through global catalogs are said to have a 'shared' ownership. Shared objects are either made globally
     * available to all end users or restricted to end users based on their license entitlement. Users can use this property to
    ...
    tags?: pulumi.Input<pulumi.Input<inputs.KubernetesSysConfigPolicyTag>[]>;
    /**
     * The timezone of the node's system clock. * `Pacific/Niue` - * `Africa/Abidjan` - * `Africa/Accra` - *
     * `Africa/Addis_Ababa` - * `Africa/Algiers` - * `Africa/Asmara` - * `Africa/Bamako` - * `Africa/Bangui` - *
     * `Africa/Banjul` - * `Africa/Bissau` - * `Africa/Blantyre` - * `Africa/Brazzaville` - * `Africa/Bujumbura` - *
     ...
     * The versioning info for this managed object.
     */
    versionContexts?: pulumi.Input<pulumi.Input<inputs.KubernetesSysConfigPolicyVersionContext>[]>;
}

/**
 * The set of arguments for constructing a KubernetesSysConfigPolicy resource.
 */
export interface KubernetesSysConfigPolicyArgs {
    /**
     * The Account ID for this managed object.
     */
    accountMoid?: pulumi.Input<string>;
