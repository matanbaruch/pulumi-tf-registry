...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("powerflex");
			params.setVersion("1.6.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RlbGwvcG93ZXJmbGV4IiwidmVyc2lvbiI6IjEuNi4wIn19"), c => c.charCodeAt(0)));
