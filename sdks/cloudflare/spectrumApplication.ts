...
export class SpectrumApplication extends pulumi.CustomResource {
    ...
    /**
     * Origin port range to proxy traffice to. When using a range, the protocol field must also specify a range, e.g.
     * `tcp/22-23`. Conflicts with `origin_port`.
     */
    ...
    /**
     * TLS configuration option for Cloudflare to connect to your origin. Available values: `off`, `flexible`, `full`,
     * `strict`.
     */
    ...
    constructor(name: string, argsOrState?: SpectrumApplicationArgs | SpectrumApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SpectrumApplication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
