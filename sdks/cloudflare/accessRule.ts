...
export class AccessRule extends pulumi.CustomResource {
    ...
    /**
     * The account identifier to target for the resource. Must provide only one of `account_id`, `zone_id`. **Modifying this
    ...
    /**
     * The zone identifier to target for the resource. Must provide only one of `account_id`, `zone_id`. **Modifying this
     * attribute will force creation of a new resource.**
     */
