...
export class WebAnalyticsSite extends pulumi.CustomResource {
    ...
    /**
     * Whether Cloudflare will automatically inject the JavaScript snippet for orange-clouded sites. **Modifying this attribute
     * will force creation of a new resource.**
     */
    public readonly autoInstall!: pulumi.Output<boolean>;
    /**
     * The hostname to use for gray-clouded sites. Must provide only one of `zone_tag`. **Modifying this attribute will force
    ...
    public readonly timeouts!: pulumi.Output<outputs.WebAnalyticsSiteTimeouts | undefined>;
    /**
     * The zone identifier for orange-clouded sites. Must provide only one of `host`. **Modifying this attribute will force
     * creation of a new resource.**
     */
    ...
    constructor(name: string, argsOrState?: WebAnalyticsSiteArgs | WebAnalyticsSiteState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebAnalyticsSite.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface WebAnalyticsSiteState {
    ...
    timeouts?: pulumi.Input<inputs.WebAnalyticsSiteTimeouts>;
    /**
     * The zone identifier for orange-clouded sites. Must provide only one of `host`. **Modifying this attribute will force
     * creation of a new resource.**
     */
