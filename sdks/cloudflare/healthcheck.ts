...
export class Healthcheck extends pulumi.CustomResource {
     ...
     * but will increase the load on the origin as we check from multiple locations. Defaults to `60`.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.HealthcheckTimeouts | undefined>;
    /**
