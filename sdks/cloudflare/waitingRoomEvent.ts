...
export class WaitingRoomEvent extends pulumi.CustomResource {
    ...
    /**
     * ISO 8601 timestamp that marks the start of the event. Must occur at least 1 minute before `event_end_time`. **Modifying
    ...
    /**
     * A unique name to identify the event. Only alphanumeric characters, hyphens, and underscores are allowed. **Modifying
     * this attribute will force creation of a new resource.**
     */
    ...
    constructor(name: string, argsOrState?: WaitingRoomEventArgs | WaitingRoomEventState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WaitingRoomEvent.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
