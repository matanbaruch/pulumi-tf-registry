...
export class RegionalHostname extends pulumi.CustomResource {
    ...
    /**
     * The region key. See [the full region
     * list](https://developers.cloudflare.com/data-localization/regional-services/get-started/).
     */
    public readonly regionKey!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.RegionalHostnameTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RegionalHostnameArgs | RegionalHostnameState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RegionalHostname.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RegionalHostnameState {
    ...
    timeouts?: pulumi.Input<inputs.RegionalHostnameTimeouts>;
    /**
     * The zone identifier to target for the resource.
     */
