...
export class ZeroTrustAccessOrganization extends pulumi.CustomResource {
    /**
     * Get an existing ZeroTrustAccessOrganization resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustAccessOrganizationState, opts?: pulumi.CustomResourceOptions): ZeroTrustAccessOrganization {
        return new ZeroTrustAccessOrganization(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'cloudflare:index/zeroTrustAccessOrganization:ZeroTrustAccessOrganization';

    /**
     * Returns true if the given object is an instance of ZeroTrustAccessOrganization.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ZeroTrustAccessOrganization {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ZeroTrustAccessOrganization.__pulumiType;
    }
     ...
     */
    public readonly customPages!: pulumi.Output<outputs.ZeroTrustAccessOrganizationCustomPage[] | undefined>;
    /**
     * When set to true, this will disable all editing of Access resources via the Zero Trust Dashboard.
     */
    public readonly isUiReadOnly!: pulumi.Output<boolean | undefined>;
    public readonly loginDesigns!: pulumi.Output<outputs.ZeroTrustAccessOrganizationLoginDesign[] | undefined>;
    /**
    ...
    /**
     * Create a ZeroTrustAccessOrganization resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ZeroTrustAccessOrganizationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ZeroTrustAccessOrganizationArgs | ZeroTrustAccessOrganizationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZeroTrustAccessOrganizationState | undefined;
            ...
            const args = argsOrState as ZeroTrustAccessOrganizationArgs | undefined;
        ...
        super(ZeroTrustAccessOrganization.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ZeroTrustAccessOrganizationState {
    /**
     * The account identifier to target for the resource. Conflicts with `zone_id`.
     */
     ...
     * Custom pages for your Zero Trust organization.
     */
    customPages?: pulumi.Input<pulumi.Input<inputs.ZeroTrustAccessOrganizationCustomPage>[]>;
    /**
     * When set to true, this will disable all editing of Access resources via the Zero Trust Dashboard.
     */
    isUiReadOnly?: pulumi.Input<boolean>;
    loginDesigns?: pulumi.Input<pulumi.Input<inputs.ZeroTrustAccessOrganizationLoginDesign>[]>;
    /**
     * The name of your Zero Trust organization.
     */
 ...
 */
export interface ZeroTrustAccessOrganizationArgs {
    /**
     * The account identifier to target for the resource. Conflicts with `zone_id`.
     */
    accountId?: pulumi.Input<string>;
