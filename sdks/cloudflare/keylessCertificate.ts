...
export class KeylessCertificate extends pulumi.CustomResource {
     ...
     * chain, but does not otherwise modify it. Available values: `ubiquitous`, `optimal`, `force`. Defaults to `ubiquitous`.
     * **Modifying this attribute will force creation of a new resource.**
     */
    public readonly bundleMethod!: pulumi.Output<string | undefined>;
    /**
     * The zone's SSL certificate or SSL certificate and intermediate(s). **Modifying this attribute will force creation of a
     * new resource.**
     */
    ...
    constructor(name: string, argsOrState?: KeylessCertificateArgs | KeylessCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KeylessCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
