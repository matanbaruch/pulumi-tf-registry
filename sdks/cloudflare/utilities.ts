...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudflare");
			params.setVersion("4.40.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Nsb3VkZmxhcmUvY2xvdWRmbGFyZSIsInZlcnNpb24iOiI0LjQwLjAifX0="), c => c.charCodeAt(0)));
