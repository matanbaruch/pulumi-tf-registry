...
export class MagicWanIpsecTunnel extends pulumi.CustomResource {
    ...
    /**
     * Specifies the direction for the health check. Available values: `unidirectional`, `bidirectional` Default:
     * `unidirectional`.
     */
     ...
     */
    public readonly replayProtection!: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MagicWanIpsecTunnelArgs | MagicWanIpsecTunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MagicWanIpsecTunnel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
