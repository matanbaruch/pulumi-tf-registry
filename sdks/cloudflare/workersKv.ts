...
export class WorkersKv extends pulumi.CustomResource {
    ...
    /**
     * The ID of the Workers KV namespace in which you want to create the KV pair. **Modifying this attribute will force
    ...
    constructor(name: string, argsOrState?: WorkersKvArgs | WorkersKvState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WorkersKv.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
