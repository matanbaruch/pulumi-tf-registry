...
export class WebAnalyticsRule extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.WebAnalyticsRuleTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: WebAnalyticsRuleArgs | WebAnalyticsRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WebAnalyticsRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface WebAnalyticsRuleState {
    ...
    timeouts?: pulumi.Input<inputs.WebAnalyticsRuleTimeouts>;
}
