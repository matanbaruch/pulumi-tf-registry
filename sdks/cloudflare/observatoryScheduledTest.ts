...
export class ObservatoryScheduledTest extends pulumi.CustomResource {
    ...
    /**
     * The frequency to run the test. Available values: `DAILY`, `WEEKLY`. **Modifying this attribute will force creation of a
     * new resource.**
     */
    public readonly frequency!: pulumi.Output<string>;
    /**
     * The region to run the test in. Available values: `us-central1`, `us-east1`, `us-east4`, `us-south1`, `us-west1`,
     * `southamerica-east1`, `europe-north1`, `europe-southwest1`, `europe-west1`, `europe-west2`, `europe-west3`,
     * `europe-west4`, `europe-west8`, `europe-west9`, `asia-east1`, `asia-south1`, `asia-southeast1`, `me-west1`,
     * `australia-southeast1`. **Modifying this attribute will force creation of a new resource.**
     */
    public readonly region!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.ObservatoryScheduledTestTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ObservatoryScheduledTestArgs | ObservatoryScheduledTestState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ObservatoryScheduledTest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ObservatoryScheduledTestState {
    ...
    timeouts?: pulumi.Input<inputs.ObservatoryScheduledTestTimeouts>;
    /**
     * The page to run the test on. **Modifying this attribute will force creation of a new resource.**
     */
