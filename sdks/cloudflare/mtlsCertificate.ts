...
export class MtlsCertificate extends pulumi.CustomResource {
    ...
    /**
     * Certificate you intend to use with mTLS-enabled services. **Modifying this attribute will force creation of a new
     * resource.**
     */
    ...
    constructor(name: string, argsOrState?: MtlsCertificateArgs | MtlsCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MtlsCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
