...
export class ZoneSettingsOverride extends pulumi.CustomResource {
    ...
    public readonly settings!: pulumi.Output<outputs.ZoneSettingsOverrideSettings | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ZoneSettingsOverrideArgs | ZoneSettingsOverrideState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ZoneSettingsOverride.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
