...
export class ZeroTrustTunnelCloudflared extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:index/zeroTrustTunnelCloudflared:ZeroTrustTunnelCloudflared';
     ...
     */
    public static isInstance(obj: any): obj is ZeroTrustTunnelCloudflared {
    ...
    constructor(name: string, argsOrState?: ZeroTrustTunnelCloudflaredArgs | ZeroTrustTunnelCloudflaredState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ZeroTrustTunnelCloudflaredState | undefined;
        ...
        super(ZeroTrustTunnelCloudflared.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
