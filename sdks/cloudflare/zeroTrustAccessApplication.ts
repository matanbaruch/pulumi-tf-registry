...
export class ZeroTrustAccessApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'cloudflare:index/zeroTrustAccessApplication:ZeroTrustAccessApplication';
     ...
     */
    public static isInstance(obj: any): obj is ZeroTrustAccessApplication {
     ...
     */
    public readonly corsHeaders!: pulumi.Output<outputs.ZeroTrustAccessApplicationCorsHeader[] | undefined>;
    /**
     ...
     * `vnc`, `warp`. Defaults to `self_hosted`.
     */
