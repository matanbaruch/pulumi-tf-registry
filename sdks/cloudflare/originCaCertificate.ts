...
export class OriginCaCertificate extends pulumi.CustomResource {
    ...
    /**
     * The Certificate Signing Request. Must be newline-encoded. **Modifying this attribute will force creation of a new
     * resource.**
     */
    ...
    /**
     * A list of hostnames or wildcard names bound to the certificate. **Modifying this attribute will force creation of a new
     * resource.**
     */
    ...
    /**
     * The number of days for which the certificate should be valid. Available values: `7`, `30`, `90`, `365`, `730`, `1095`,
     * `5475`. **Modifying this attribute will force creation of a new resource.**
     */
    ...
    constructor(name: string, argsOrState?: OriginCaCertificateArgs | OriginCaCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OriginCaCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
