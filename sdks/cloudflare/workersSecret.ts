...
export class WorkersSecret extends pulumi.CustomResource {
    ...
    /**
     * The name of the Worker script to associate the secret with. **Modifying this attribute will force creation of a new
     * resource.**
     */
    ...
    constructor(name: string, argsOrState?: WorkersSecretArgs | WorkersSecretState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WorkersSecret.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
