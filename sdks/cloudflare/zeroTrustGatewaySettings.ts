...
export class ZeroTrustGatewaySettings extends pulumi.CustomResource {
     ...
     */
    public readonly extendedEmailMatching!: pulumi.Output<outputs.ZeroTrustGatewaySettingsExtendedEmailMatching | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ZeroTrustGatewaySettingsArgs | ZeroTrustGatewaySettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ZeroTrustGatewaySettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
