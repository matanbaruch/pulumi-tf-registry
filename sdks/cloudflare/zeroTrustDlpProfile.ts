...
export class ZeroTrustDlpProfile extends pulumi.CustomResource {
     ...
     */
    public readonly contextAwareness!: pulumi.Output<outputs.ZeroTrustDlpProfileContextAwareness | undefined>;
    /**
    ...
    /**
     * The type of the profile. Available values: `custom`, `predefined`. **Modifying this attribute will force creation of a
     * new resource.**
     */
    ...
    constructor(name: string, argsOrState?: ZeroTrustDlpProfileArgs | ZeroTrustDlpProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ZeroTrustDlpProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
