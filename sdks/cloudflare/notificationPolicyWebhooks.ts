...
export class NotificationPolicyWebhooks extends pulumi.CustomResource {
    ...
    /**
     * An optional secret can be provided that will be passed in the `cf-webhook-auth` header when dispatching a webhook
     * notification. Secrets are not returned in any API response body. Refer to the
     * [documentation](https://api.cloudflare.com/#notification-webhooks-create-webhook) for more details.
     */
    ...
    constructor(name: string, argsOrState?: NotificationPolicyWebhooksArgs | NotificationPolicyWebhooksState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NotificationPolicyWebhooks.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
