...
export class Record extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.RecordTimeouts | undefined>;
    /**
     ...
     * `DNSKEY`, `DS`, `NAPTR`, `SMIMEA`, `SSHFP`, `TLSA`, `URI`, `PTR`, `HTTPS`, `SVCB`. **Modifying this attribute will force
...
export interface RecordState {
    ...
    timeouts?: pulumi.Input<inputs.RecordTimeouts>;
    /**
     * The TTL of the record.
     */
