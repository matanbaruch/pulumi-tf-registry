...
export class PagesProject extends pulumi.CustomResource {
    ...
    /**
     * Configuration for the project build process. Read more about the build configuration in the [developer
    ...
    /**
     * Configuration for the project source. Read more about the source configuration in the [developer
     * documentation](https://developers.cloudflare.com/pages/platform/branch-build-controls/).
     */
    ...
    constructor(name: string, argsOrState?: PagesProjectArgs | PagesProjectState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PagesProject.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
