...
export class ByoIpPrefix extends pulumi.CustomResource {
    ...
    /**
     * Whether or not the prefix shall be announced. A prefix can be activated or deactivated once every 15 minutes (attempting
     * more regular updates will trigger rate limiting). Available values: `on`, `off`.
     */
