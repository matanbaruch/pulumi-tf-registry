...
export class EriRouterToAzureMicrosoftConnectionV1 extends pulumi.CustomResource {
    /**
     * Get an existing EriRouterToAzureMicrosoftConnectionV1 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EriRouterToAzureMicrosoftConnectionV1State, opts?: pulumi.CustomResourceOptions): EriRouterToAzureMicrosoftConnectionV1 {
        return new EriRouterToAzureMicrosoftConnectionV1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fic:index/eriRouterToAzureMicrosoftConnectionV1:EriRouterToAzureMicrosoftConnectionV1';

    /**
     * Returns true if the given object is an instance of EriRouterToAzureMicrosoftConnectionV1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EriRouterToAzureMicrosoftConnectionV1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EriRouterToAzureMicrosoftConnectionV1.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.EriRouterToAzureMicrosoftConnectionV1Timeouts | undefined>;

    /**
     * Create a EriRouterToAzureMicrosoftConnectionV1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: EriRouterToAzureMicrosoftConnectionV1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: EriRouterToAzureMicrosoftConnectionV1Args | EriRouterToAzureMicrosoftConnectionV1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EriRouterToAzureMicrosoftConnectionV1State | undefined;
            ...
            const args = argsOrState as EriRouterToAzureMicrosoftConnectionV1Args | undefined;
        ...
        super(EriRouterToAzureMicrosoftConnectionV1.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering EriRouterToAzureMicrosoftConnectionV1 resources.
 */
export interface EriRouterToAzureMicrosoftConnectionV1State {
    ...
    timeouts?: pulumi.Input<inputs.EriRouterToAzureMicrosoftConnectionV1Timeouts>;
}

/**
 * The set of arguments for constructing a EriRouterToAzureMicrosoftConnectionV1 resource.
 */
export interface EriRouterToAzureMicrosoftConnectionV1Args {
    bandwidth: pulumi.Input<string>;
    destinationAdvertisedPublicPrefixes: pulumi.Input<pulumi.Input<string>[]>;
    destinationInterconnect: pulumi.Input<string>;
    destinationQosType: pulumi.Input<string>;
