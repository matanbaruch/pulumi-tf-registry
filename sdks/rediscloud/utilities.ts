...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("rediscloud");
			params.setVersion("1.8.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3JlZGlzbGFicy9yZWRpc2Nsb3VkIiwidmVyc2lvbiI6IjEuOC4xIn19"), c => c.charCodeAt(0)));
