...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("dockerless");
			params.setVersion("0.1.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL251bGxzdG9uZS1pby9kb2NrZXJsZXNzIiwidmVyc2lvbiI6IjAuMS4xIn19"), c => c.charCodeAt(0)));
