...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "dockerless:index/remoteImage:RemoteImage":
...
pulumi.runtime.registerResourceModule("dockerless", "index/remoteImage", _module)
pulumi.runtime.registerResourcePackage("dockerless", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:dockerless") {
