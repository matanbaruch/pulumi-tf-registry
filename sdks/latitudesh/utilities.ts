...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("latitudesh");
			params.setVersion("1.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2xhdGl0dWRlc2gvbGF0aXR1ZGVzaCIsInZlcnNpb24iOiIxLjIuMCJ9fQ=="), c => c.charCodeAt(0)));
