...
export class BusinessMetadataBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/businessMetadataBinding:BusinessMetadataBinding';
    ...
    constructor(name: string, argsOrState?: BusinessMetadataBindingArgs | BusinessMetadataBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BusinessMetadataBinding.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
