...
export class ByokKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/byokKey:ByokKey';
    ...
    public readonly aws!: pulumi.Output<outputs.ByokKeyAws | undefined>;
    public readonly azure!: pulumi.Output<outputs.ByokKeyAzure | undefined>;
    public readonly gcp!: pulumi.Output<outputs.ByokKeyGcp | undefined>;
    ...
    constructor(name: string, argsOrState?: ByokKeyArgs | ByokKeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ByokKey.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
