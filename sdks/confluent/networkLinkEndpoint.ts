...
export class NetworkLinkEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/networkLinkEndpoint:NetworkLinkEndpoint';
    ...
    constructor(name: string, argsOrState?: NetworkLinkEndpointArgs | NetworkLinkEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkLinkEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
