...
export class TfImporter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/tfImporter:TfImporter';
    ...
    constructor(name: string, argsOrState?: TfImporterArgs | TfImporterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TfImporter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
