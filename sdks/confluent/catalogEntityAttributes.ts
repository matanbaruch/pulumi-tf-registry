...
export class CatalogEntityAttributes extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/catalogEntityAttributes:CatalogEntityAttributes';
    ...
    constructor(name: string, argsOrState?: CatalogEntityAttributesArgs | CatalogEntityAttributesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CatalogEntityAttributes.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
