...
export class PrivateLinkAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/privateLinkAttachment:PrivateLinkAttachment';
    ...
    constructor(name: string, argsOrState?: PrivateLinkAttachmentArgs | PrivateLinkAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PrivateLinkAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
