...
export class Peering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/peering:Peering';
    ...
    public readonly timeouts!: pulumi.Output<outputs.PeeringTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PeeringArgs | PeeringState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Peering.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PeeringState {
    ...
    timeouts?: pulumi.Input<inputs.PeeringTimeouts>;
}
