...
export class KafkaMirrorTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/kafkaMirrorTopic:KafkaMirrorTopic';
    ...
    /**
     * Name of the topic to be mirrored over the Kafka Mirror Topic, i.e. the source topic's name. Only required when there is
     * a prefix configured on the link.
     */
    ...
    constructor(name: string, argsOrState?: KafkaMirrorTopicArgs | KafkaMirrorTopicState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaMirrorTopic.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
