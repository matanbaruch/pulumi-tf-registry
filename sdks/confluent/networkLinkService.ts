...
export class NetworkLinkService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/networkLinkService:NetworkLinkService';
    ...
    public readonly accept!: pulumi.Output<outputs.NetworkLinkServiceAccept | undefined>;
    ...
    constructor(name: string, argsOrState?: NetworkLinkServiceArgs | NetworkLinkServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkLinkService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
