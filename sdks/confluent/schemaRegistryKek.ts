...
export class SchemaRegistryKek extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/schemaRegistryKek:SchemaRegistryKek';
    ...
    constructor(name: string, argsOrState?: SchemaRegistryKekArgs | SchemaRegistryKekState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SchemaRegistryKek.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
