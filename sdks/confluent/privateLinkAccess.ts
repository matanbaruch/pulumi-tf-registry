...
export class PrivateLinkAccess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/privateLinkAccess:PrivateLinkAccess';
    ...
    public readonly timeouts!: pulumi.Output<outputs.PrivateLinkAccessTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PrivateLinkAccessArgs | PrivateLinkAccessState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PrivateLinkAccess.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PrivateLinkAccessState {
    ...
    timeouts?: pulumi.Input<inputs.PrivateLinkAccessTimeouts>;
}
