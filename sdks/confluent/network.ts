...
export class Network extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/network:Network';
    ...
    public readonly aws!: pulumi.Output<outputs.NetworkAw[] | undefined>;
    public readonly azures!: pulumi.Output<outputs.NetworkAzure[] | undefined>;
    /**
     ...
     */
    public readonly dnsConfig!: pulumi.Output<outputs.NetworkDnsConfig | undefined>;
    /**
    ...
    public readonly gcps!: pulumi.Output<outputs.NetworkGcp[] | undefined>;
    /**
     * The cloud service provider region where the network exists.
     */
    public readonly region!: pulumi.Output<string>;
    /**
     * The IPv4 CIDR block reserved for Confluent Cloud Network. Must be /24. If not specified, Confluent Cloud Network uses
     * 172.20.255.0/24
     */
    ...
    /**
     * The DNS subdomain for each zone. Present on networks that support PrivateLink. Keys are zones and values are DNS
     * domains.
     */
     ...
     */
    public readonly zoneInfos!: pulumi.Output<outputs.NetworkZoneInfo[] | undefined>;
    /**
     * The 3 availability zones for this network. They can optionally be specified for only AWS networks used with PrivateLink.
