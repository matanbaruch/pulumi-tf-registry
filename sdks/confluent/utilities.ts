...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("confluent");
			params.setVersion("2.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NvbmZsdWVudGluYy9jb25mbHVlbnQiLCJ2ZXJzaW9uIjoiMi4xLjAifX0="), c => c.charCodeAt(0)));
