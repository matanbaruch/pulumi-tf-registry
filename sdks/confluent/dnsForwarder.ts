...
export class DnsForwarder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/dnsForwarder:DnsForwarder';
    ...
    constructor(name: string, argsOrState?: DnsForwarderArgs | DnsForwarderState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DnsForwarder.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
