...
export class SchemaRegistryDek extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluent:index/schemaRegistryDek:SchemaRegistryDek';
    ...
    constructor(name: string, argsOrState?: SchemaRegistryDekArgs | SchemaRegistryDekState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SchemaRegistryDek.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
