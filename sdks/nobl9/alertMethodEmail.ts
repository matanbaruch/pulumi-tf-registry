...
export class AlertMethodEmail extends pulumi.CustomResource {
    ...
    /**
     * This value was used as the template for the email alert's body. 'body' is deprecated and not used anywhere; however,
     * its' kept for backward compatibility.
     *
    ...
    /**
     * This value was used as the email alert's subject. 'subject' is deprecated and not used anywhere; however, its' kept for
    ...
    constructor(name: string, argsOrState?: AlertMethodEmailArgs | AlertMethodEmailState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AlertMethodEmail.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
