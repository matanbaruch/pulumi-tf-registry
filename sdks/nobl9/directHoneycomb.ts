...
export class DirectHoneycomb extends pulumi.CustomResource {
     ...
     */
    public readonly historicalDataRetrieval!: pulumi.Output<outputs.DirectHoneycombHistoricalDataRetrieval | undefined>;
    /**
     ...
     */
    public readonly queryDelay!: pulumi.Output<outputs.DirectHoneycombQueryDelay | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DirectHoneycombArgs | DirectHoneycombState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DirectHoneycomb.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
