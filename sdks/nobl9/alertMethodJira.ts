...
export class AlertMethodJira extends pulumi.CustomResource {
    ...
    /**
     * [API Token](https://support.atlassian.com/atlassian-account/docs/manage-api-tokens-for-your-atlassian-account/) with
    ...
    constructor(name: string, argsOrState?: AlertMethodJiraArgs | AlertMethodJiraState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AlertMethodJira.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
