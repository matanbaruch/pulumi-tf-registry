...
export class AlertMethodPagerduty extends pulumi.CustomResource {
    ...
    /**
     * PagerDuty Integration Key. For more details, check [Services and
     * integrations](https://support.pagerduty.com/docs/services-and-integrations).
     */
    ...
    constructor(name: string, argsOrState?: AlertMethodPagerdutyArgs | AlertMethodPagerdutyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AlertMethodPagerduty.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
