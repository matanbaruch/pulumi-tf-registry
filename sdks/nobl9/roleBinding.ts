...
export class RoleBinding extends pulumi.CustomResource {
    ...
    /**
     * Group name that can be retrieved from the Nobl9 UI (**Settings** > **Access Controls** > **Groups**) or using sloctl
     * `get usergroups` command.
     */
    public readonly groupRef!: pulumi.Output<string | undefined>;
    /**
     * Automatically generated, unique name of the resource, must conform to the naming convention from [DNS
     * RFC1123](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names).
     */
    public readonly name!: pulumi.Output<string>;
    /**
     * Project name, the project in which we want the user or group to assume the specified role. When `project_ref` is empty,
     * `role_ref` must contain an Organization Role.
     */
