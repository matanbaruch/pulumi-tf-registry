...
export class DirectAzureMonitor extends pulumi.CustomResource {
     ...
     */
    public readonly historicalDataRetrieval!: pulumi.Output<outputs.DirectAzureMonitorHistoricalDataRetrieval | undefined>;
    /**
     ...
     */
    public readonly queryDelay!: pulumi.Output<outputs.DirectAzureMonitorQueryDelay | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DirectAzureMonitorArgs | DirectAzureMonitorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DirectAzureMonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
