...
export interface AlertPolicyCondition {
    ...
    /**
     * One of `timeToBurnBudget` | `timeToBurnEntireBudget` | `burnRate` | `burnedBudget` | `budgetDrop`.
     */
...
export interface BudgetAdjustmentFilter {
    slos: pulumi.Input<pulumi.Input<inputs.BudgetAdjustmentFilterSlo>[]>;
}

export interface BudgetAdjustmentFilterSlo {
    /**
     * SLO where budget adjustment event will be applied.
     */
    slos: pulumi.Input<pulumi.Input<inputs.BudgetAdjustmentFilterSloSlo>[]>;
}

export interface BudgetAdjustmentFilterSloSlo {
    /**
...
export interface SloObjective {
    /**
     * An assembly of objectives from different SLOs reflecting their combined performance.
     */
    composites?: pulumi.Input<pulumi.Input<inputs.SloObjectiveComposite>[]>;
    /**
...
export interface SloObjectiveComposite {
    /**
     * Objectives to be assembled in your composite SLO.
     */
    components?: pulumi.Input<pulumi.Input<inputs.SloObjectiveCompositeComponent>[]>;
    /**
...
export interface SloObjectiveCompositeComponent {
    /**
     * An additional nesting for the components of your composite SLO.
     */
    objectives?: pulumi.Input<pulumi.Input<inputs.SloObjectiveCompositeComponentObjective>[]>;
}

export interface SloObjectiveCompositeComponentObjective {
    /**
     * Your composite SLO component.
     */
    compositeObjectives?: pulumi.Input<pulumi.Input<inputs.SloObjectiveCompositeComponentObjectiveCompositeObjective>[]>;
}

export interface SloObjectiveCompositeComponentObjectiveCompositeObjective {
    /**
     * SLO objective name.
     */
     ...
     */
    whenDelayed: pulumi.Input<string>;
}
...
export interface SloObjectiveCountMetricBad {
    ...
    /**
     * [Configuration documentation](https://docs.nobl9.com/Sources/logic-monitor#creating-slos-with-logic-monitor)
     */
    logicMonitors?: pulumi.Input<pulumi.Input<inputs.SloObjectiveCountMetricBadLogicMonitor>[]>;
    /**
...
export interface SloObjectiveCountMetricBadCloudwatch {
    ...
    accountId?: pulumi.Input<string>;
    /**
     * Set of name/value pairs that is part of the identity of a metric
     */
...
export interface SloObjectiveCountMetricBadLogicMonitor {
    /**
     * Device Datasource Instance ID
     */
    deviceDataSourceInstanceId: pulumi.Input<number>;
    /**
     * Graph ID
     */
    graphId: pulumi.Input<number>;
    /**
     * Line
     */
...
export interface SloObjectiveCountMetricGood {
     ...
     * [Configuration documentation](https://docs.nobl9.com/Sources/logic-monitor#creating-slos-with-logic-monitor)
     */
    logicMonitors?: pulumi.Input<pulumi.Input<inputs.SloObjectiveCountMetricGoodLogicMonitor>[]>;
    /**
     * [Configuration documentation](https://docs.nobl9.com/Sources/new-relic#creating-slos-with-new-relic)
     */
...
export interface SloObjectiveCountMetricGoodLogicMonitor {
    /**
     * Device Datasource Instance ID
     */
    deviceDataSourceInstanceId: pulumi.Input<number>;
...
export interface SloObjectiveCountMetricTotal {
     ...
     * [Configuration documentation](https://docs.nobl9.com/Sources/logic-monitor#creating-slos-with-logic-monitor)
     */
    logicMonitors?: pulumi.Input<pulumi.Input<inputs.SloObjectiveCountMetricTotalLogicMonitor>[]>;
    /**
     * [Configuration documentation](https://docs.nobl9.com/Sources/new-relic#creating-slos-with-new-relic)
     */
...
export interface SloObjectiveCountMetricTotalLogicMonitor {
    /**
     * Device Datasource Instance ID
     */
    deviceDataSourceInstanceId: pulumi.Input<number>;
...
export interface SloObjectiveRawMetricQuery {
     ...
     * [Configuration documentation](https://docs.nobl9.com/Sources/logic-monitor#creating-slos-with-logic-monitor)
     */
    logicMonitors?: pulumi.Input<pulumi.Input<inputs.SloObjectiveRawMetricQueryLogicMonitor>[]>;
    /**
     * [Configuration documentation](https://docs.nobl9.com/Sources/new-relic#creating-slos-with-new-relic)
     */
