...
export class AlertMethodMsteams extends pulumi.CustomResource {
    ...
    /**
     * Either [MS Teams Workflow URL](https://docs.nobl9.com/alerting/alert-methods/ms-teams/#2) or deprecated [Webhook
     * URL](https://docs.nobl9.com/alerting/alert-methods/ms-teams/#webhook-url-).
     */
    ...
    constructor(name: string, argsOrState?: AlertMethodMsteamsArgs | AlertMethodMsteamsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AlertMethodMsteams.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
