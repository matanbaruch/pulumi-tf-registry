...
export class Agent extends pulumi.CustomResource {
     ...
     */
    public readonly historicalDataRetrieval!: pulumi.Output<outputs.AgentHistoricalDataRetrieval | undefined>;
    /**
    ...
    /**
     * [Configuration documentation](https://docs.nobl9.com/Sources/logic-monitor#logic-monitor-agent)
     */
    public readonly logicMonitorConfig!: pulumi.Output<outputs.AgentLogicMonitorConfig | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AgentArgs | AgentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["logicMonitorConfig"] = state ? state.logicMonitorConfig : undefined;
            ...
            resourceInputs["logicMonitorConfig"] = args ? args.logicMonitorConfig : undefined;
...
export interface AgentState {
     ...
     * [Configuration documentation](https://docs.nobl9.com/Sources/logic-monitor#logic-monitor-agent)
     */
    logicMonitorConfig?: pulumi.Input<inputs.AgentLogicMonitorConfig>;
    /**
     * Unique name of the resource, must conform to the naming convention from [DNS
     * RFC1123](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names).
     */
