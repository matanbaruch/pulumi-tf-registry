...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("transloadit");
			params.setVersion("0.7.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3RyYW5zbG9hZGl0L3RyYW5zbG9hZGl0IiwidmVyc2lvbiI6IjAuNy4wIn19"), c => c.charCodeAt(0)));
