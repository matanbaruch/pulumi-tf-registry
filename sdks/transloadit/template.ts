...
export class Template extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'transloadit:index/template:Template';
     ...
     */
    public readonly requireSignatureAuth!: pulumi.Output<boolean | undefined>;
    /**
     * template in json
     */
    ...
    constructor(name: string, argsOrState?: TemplateArgs | TemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["requireSignatureAuth"] = state ? state.requireSignatureAuth : undefined;
            ...
            resourceInputs["requireSignatureAuth"] = args ? args.requireSignatureAuth : undefined;
...
export interface TemplateState {
     ...
     * Use true to deny requests that do not include a signature
     */
    requireSignatureAuth?: pulumi.Input<boolean>;
    /**
     * template in json
     */
