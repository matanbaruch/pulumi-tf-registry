...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("zerotier");
			params.setVersion("1.6.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3plcm90aWVyL3plcm90aWVyIiwidmVyc2lvbiI6IjEuNi4wIn19"), c => c.charCodeAt(0)));
