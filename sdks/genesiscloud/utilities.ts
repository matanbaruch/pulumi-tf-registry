...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("genesiscloud");
			params.setVersion("1.1.9");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2dlbmVzaXNjbG91ZC9nZW5lc2lzY2xvdWQiLCJ2ZXJzaW9uIjoiMS4xLjkifX0="), c => c.charCodeAt(0)));
