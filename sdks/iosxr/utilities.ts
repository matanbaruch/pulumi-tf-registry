...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("iosxr");
			params.setVersion("0.5.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Npc2NvZGV2bmV0L2lvc3hyIiwidmVyc2lvbiI6IjAuNS4xIn19"), c => c.charCodeAt(0)));
