...
export class Banner extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'thunder:index/banner:Banner';
    ...
    public readonly execBannerCfg!: pulumi.Output<outputs.BannerExecBannerCfg | undefined>;
    public readonly loginBannerCfg!: pulumi.Output<outputs.BannerLoginBannerCfg | undefined>;
    /**
     * uuid of the object
     */
    ...
    constructor(name: string, argsOrState?: BannerArgs | BannerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["execBannerCfg"] = state ? state.execBannerCfg : undefined;
            resourceInputs["loginBannerCfg"] = state ? state.loginBannerCfg : undefined;
            resourceInputs["uuid"] = state ? state.uuid : undefined;
        } else {
            const args = argsOrState as BannerArgs | undefined;
            resourceInputs["execBannerCfg"] = args ? args.execBannerCfg : undefined;
            resourceInputs["loginBannerCfg"] = args ? args.loginBannerCfg : undefined;
...
export interface BannerState {
    execBannerCfg?: pulumi.Input<inputs.BannerExecBannerCfg>;
    loginBannerCfg?: pulumi.Input<inputs.BannerLoginBannerCfg>;
    /**
     * uuid of the object
     */
