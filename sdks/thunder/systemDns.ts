...
export class SystemDns extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'thunder:index/systemDns:SystemDns';
    ...
    public readonly recursiveNameserver!: pulumi.Output<outputs.SystemDnsRecursiveNameserver | undefined>;
    public readonly samplingEnables!: pulumi.Output<outputs.SystemDnsSamplingEnable[] | undefined>;
    /**
     * uuid of the object
     */
    ...
    constructor(name: string, argsOrState?: SystemDnsArgs | SystemDnsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["recursiveNameserver"] = state ? state.recursiveNameserver : undefined;
            resourceInputs["samplingEnables"] = state ? state.samplingEnables : undefined;
            resourceInputs["uuid"] = state ? state.uuid : undefined;
        } else {
            const args = argsOrState as SystemDnsArgs | undefined;
            resourceInputs["recursiveNameserver"] = args ? args.recursiveNameserver : undefined;
...
export interface SystemDnsState {
    recursiveNameserver?: pulumi.Input<inputs.SystemDnsRecursiveNameserver>;
    samplingEnables?: pulumi.Input<pulumi.Input<inputs.SystemDnsSamplingEnable>[]>;
    /**
     * uuid of the object
     */
