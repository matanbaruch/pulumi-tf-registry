...
export class RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor extends pulumi.CustomResource {
    /**
     * Get an existing RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RouterBgpAddressFamilyIpv6NeighborIpv6NeighborState, opts?: pulumi.CustomResourceOptions): RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor {
        return new RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/routerBgpAddressFamilyIpv6NeighborIpv6Neighbor:RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor';

    /**
     * Returns true if the given object is an instance of RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor.__pulumiType;
    }
    ...
    public readonly distributeLists!: pulumi.Output<outputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborDistributeList[] | undefined>;
    /**
    ...
    public readonly neighborFilterLists!: pulumi.Output<outputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborNeighborFilterList[] | undefined>;
    /**
     * Neighbor IPv6 address
     */
    public readonly neighborIpv6!: pulumi.Output<string>;
    public readonly neighborPrefixLists!: pulumi.Output<outputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborNeighborPrefixList[] | undefined>;
    public readonly neighborRouteMapLists!: pulumi.Output<outputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborNeighborRouteMapList[] | undefined>;
    /**
    ...
    /**
     * Create a RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RouterBgpAddressFamilyIpv6NeighborIpv6NeighborArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RouterBgpAddressFamilyIpv6NeighborIpv6NeighborArgs | RouterBgpAddressFamilyIpv6NeighborIpv6NeighborState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RouterBgpAddressFamilyIpv6NeighborIpv6NeighborState | undefined;
            ...
            resourceInputs["neighborIpv6"] = state ? state.neighborIpv6 : undefined;
            ...
            const args = argsOrState as RouterBgpAddressFamilyIpv6NeighborIpv6NeighborArgs | undefined;
            if ((!args || args.asNumber === undefined) && !opts.urn) {
                throw new Error("Missing required property 'asNumber'");
            }
            if ((!args || args.neighborIpv6 === undefined) && !opts.urn) {
                throw new Error("Missing required property 'neighborIpv6'");
            }
            ...
            resourceInputs["neighborIpv6"] = args ? args.neighborIpv6 : undefined;
        ...
        super(RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor resources.
 */
export interface RouterBgpAddressFamilyIpv6NeighborIpv6NeighborState {
    /**
     * Enable the Address Family for this Neighbor
     */
    ...
    distributeLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborDistributeList>[]>;
    /**
     * enable graceful-restart helper for this neighbor
     */
    ...
    neighborFilterLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborNeighborFilterList>[]>;
    /**
     * Neighbor IPv6 address
     */
    neighborIpv6?: pulumi.Input<string>;
    neighborPrefixLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborNeighborPrefixList>[]>;
    neighborRouteMapLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpAddressFamilyIpv6NeighborIpv6NeighborNeighborRouteMapList>[]>;
    /**
     * Disable the next hop calculation for this neighbor
     */
...
/**
 * The set of arguments for constructing a RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor resource.
 */
export interface RouterBgpAddressFamilyIpv6NeighborIpv6NeighborArgs {
    /**
     * Enable the Address Family for this Neighbor
     */
    activate?: pulumi.Input<number>;
