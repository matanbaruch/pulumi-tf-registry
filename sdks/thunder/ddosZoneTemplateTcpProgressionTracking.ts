...
export class DdosZoneTemplateTcpProgressionTracking extends pulumi.CustomResource {
    /**
     * Get an existing DdosZoneTemplateTcpProgressionTracking resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosZoneTemplateTcpProgressionTrackingState, opts?: pulumi.CustomResourceOptions): DdosZoneTemplateTcpProgressionTracking {
        return new DdosZoneTemplateTcpProgressionTracking(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosZoneTemplateTcpProgressionTracking:DdosZoneTemplateTcpProgressionTracking';

    /**
     * Returns true if the given object is an instance of DdosZoneTemplateTcpProgressionTracking.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosZoneTemplateTcpProgressionTracking {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosZoneTemplateTcpProgressionTracking.__pulumiType;
    }

    public readonly connectionTracking!: pulumi.Output<outputs.DdosZoneTemplateTcpProgressionTrackingConnectionTracking | undefined>;
    /**
     ...
     */
    public readonly ignoreTlsHandshake!: pulumi.Output<number | undefined>;
    /**
     * Name
     */
    ...
    public readonly timeWindowTracking!: pulumi.Output<outputs.DdosZoneTemplateTcpProgressionTrackingTimeWindowTracking | undefined>;
    /**
     * uuid of the object
     */
    ...
    /**
     * Create a DdosZoneTemplateTcpProgressionTracking resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosZoneTemplateTcpProgressionTrackingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosZoneTemplateTcpProgressionTrackingArgs | DdosZoneTemplateTcpProgressionTrackingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosZoneTemplateTcpProgressionTrackingState | undefined;
            ...
            resourceInputs["ignoreTlsHandshake"] = state ? state.ignoreTlsHandshake : undefined;
            ...
            const args = argsOrState as DdosZoneTemplateTcpProgressionTrackingArgs | undefined;
            ...
            resourceInputs["ignoreTlsHandshake"] = args ? args.ignoreTlsHandshake : undefined;
        ...
        super(DdosZoneTemplateTcpProgressionTracking.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosZoneTemplateTcpProgressionTracking resources.
 */
export interface DdosZoneTemplateTcpProgressionTrackingState {
    connectionTracking?: pulumi.Input<inputs.DdosZoneTemplateTcpProgressionTrackingConnectionTracking>;
    /**
     * Set the maximum wait time from connection creation until the first data is transmitted over the connection (100 ms)
     */
     ...
     * Ignore TLS handshake
     */
    ignoreTlsHandshake?: pulumi.Input<number>;
    /**
     * Name
     */
    ...
    timeWindowTracking?: pulumi.Input<inputs.DdosZoneTemplateTcpProgressionTrackingTimeWindowTracking>;
    /**
     * uuid of the object
     */
...
/**
 * The set of arguments for constructing a DdosZoneTemplateTcpProgressionTracking resource.
 */
export interface DdosZoneTemplateTcpProgressionTrackingArgs {
    connectionTracking?: pulumi.Input<inputs.DdosZoneTemplateTcpProgressionTrackingConnectionTracking>;
    /**
     * Set the maximum wait time from connection creation until the first data is transmitted over the connection (100 ms)
     */
