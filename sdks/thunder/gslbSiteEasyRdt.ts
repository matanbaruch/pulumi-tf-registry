...
export class GslbSiteEasyRdt extends pulumi.CustomResource {
    /**
     * Get an existing GslbSiteEasyRdt resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GslbSiteEasyRdtState, opts?: pulumi.CustomResourceOptions): GslbSiteEasyRdt {
        return new GslbSiteEasyRdt(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/gslbSiteEasyRdt:GslbSiteEasyRdt';

    /**
     * Returns true if the given object is an instance of GslbSiteEasyRdt.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GslbSiteEasyRdt {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GslbSiteEasyRdt.__pulumiType;
    }
    ...
    /**
     * Create a GslbSiteEasyRdt resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GslbSiteEasyRdtArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GslbSiteEasyRdtArgs | GslbSiteEasyRdtState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GslbSiteEasyRdtState | undefined;
            ...
            const args = argsOrState as GslbSiteEasyRdtArgs | undefined;
        ...
        super(GslbSiteEasyRdt.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering GslbSiteEasyRdt resources.
 */
export interface GslbSiteEasyRdtState {
    /**
     * Aging Time, Unit: min, default is 10
     */
...
/**
 * The set of arguments for constructing a GslbSiteEasyRdt resource.
 */
export interface GslbSiteEasyRdtArgs {
    /**
     * Aging Time, Unit: min, default is 10
     */
    agingTime?: pulumi.Input<number>;
