...
export class DdosDstZoneIpProtoProtoNumberLevelIndicator extends pulumi.CustomResource {
    /**
     * Get an existing DdosDstZoneIpProtoProtoNumberLevelIndicator resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosDstZoneIpProtoProtoNumberLevelIndicatorState, opts?: pulumi.CustomResourceOptions): DdosDstZoneIpProtoProtoNumberLevelIndicator {
        return new DdosDstZoneIpProtoProtoNumberLevelIndicator(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosDstZoneIpProtoProtoNumberLevelIndicator:DdosDstZoneIpProtoProtoNumberLevelIndicator';

    /**
     * Returns true if the given object is an instance of DdosDstZoneIpProtoProtoNumberLevelIndicator.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosDstZoneIpProtoProtoNumberLevelIndicator {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosDstZoneIpProtoProtoNumberLevelIndicator.__pulumiType;
    }
    ...
    /**
     * Create a DdosDstZoneIpProtoProtoNumberLevelIndicator resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosDstZoneIpProtoProtoNumberLevelIndicatorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosDstZoneIpProtoProtoNumberLevelIndicatorArgs | DdosDstZoneIpProtoProtoNumberLevelIndicatorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosDstZoneIpProtoProtoNumberLevelIndicatorState | undefined;
            ...
            const args = argsOrState as DdosDstZoneIpProtoProtoNumberLevelIndicatorArgs | undefined;
        ...
        super(DdosDstZoneIpProtoProtoNumberLevelIndicator.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosDstZoneIpProtoProtoNumberLevelIndicator resources.
 */
export interface DdosDstZoneIpProtoProtoNumberLevelIndicatorState {
    /**
     * Expected minimal data size
     */
...
/**
 * The set of arguments for constructing a DdosDstZoneIpProtoProtoNumberLevelIndicator resource.
 */
export interface DdosDstZoneIpProtoProtoNumberLevelIndicatorArgs {
    /**
     * Expected minimal data size
     */
    dataPacketSize?: pulumi.Input<number>;
