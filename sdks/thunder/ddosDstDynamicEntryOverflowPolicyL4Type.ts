...
export class DdosDstDynamicEntryOverflowPolicyL4Type extends pulumi.CustomResource {
    /**
     * Get an existing DdosDstDynamicEntryOverflowPolicyL4Type resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosDstDynamicEntryOverflowPolicyL4TypeState, opts?: pulumi.CustomResourceOptions): DdosDstDynamicEntryOverflowPolicyL4Type {
        return new DdosDstDynamicEntryOverflowPolicyL4Type(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosDstDynamicEntryOverflowPolicyL4Type:DdosDstDynamicEntryOverflowPolicyL4Type';

    /**
     * Returns true if the given object is an instance of DdosDstDynamicEntryOverflowPolicyL4Type.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosDstDynamicEntryOverflowPolicyL4Type {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosDstDynamicEntryOverflowPolicyL4Type.__pulumiType;
    }
    ...
    public readonly tunnelDecap!: pulumi.Output<outputs.DdosDstDynamicEntryOverflowPolicyL4TypeTunnelDecap | undefined>;
    public readonly tunnelRateLimit!: pulumi.Output<outputs.DdosDstDynamicEntryOverflowPolicyL4TypeTunnelRateLimit | undefined>;
    /**
     * Customized tag
     */
    ...
    /**
     * Create a DdosDstDynamicEntryOverflowPolicyL4Type resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosDstDynamicEntryOverflowPolicyL4TypeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosDstDynamicEntryOverflowPolicyL4TypeArgs | DdosDstDynamicEntryOverflowPolicyL4TypeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosDstDynamicEntryOverflowPolicyL4TypeState | undefined;
            ...
            const args = argsOrState as DdosDstDynamicEntryOverflowPolicyL4TypeArgs | undefined;
        ...
        super(DdosDstDynamicEntryOverflowPolicyL4Type.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosDstDynamicEntryOverflowPolicyL4Type resources.
 */
export interface DdosDstDynamicEntryOverflowPolicyL4TypeState {
    /**
     * DefaultAddressType
     */
    ...
    tunnelDecap?: pulumi.Input<inputs.DdosDstDynamicEntryOverflowPolicyL4TypeTunnelDecap>;
    tunnelRateLimit?: pulumi.Input<inputs.DdosDstDynamicEntryOverflowPolicyL4TypeTunnelRateLimit>;
    /**
     * Customized tag
     */
...
/**
 * The set of arguments for constructing a DdosDstDynamicEntryOverflowPolicyL4Type resource.
 */
export interface DdosDstDynamicEntryOverflowPolicyL4TypeArgs {
    /**
     * DefaultAddressType
     */
    defaultAddressType: pulumi.Input<string>;
