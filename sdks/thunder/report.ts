...
export class Report extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'thunder:index/report:Report';
    ...
    public readonly debug!: pulumi.Output<outputs.ReportDebug | undefined>;
...
export interface ReportState {
    debug?: pulumi.Input<inputs.ReportDebug>;
}
