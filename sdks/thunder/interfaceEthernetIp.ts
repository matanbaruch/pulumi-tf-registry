...
export class InterfaceEthernetIp extends pulumi.CustomResource {
    /**
     * Get an existing InterfaceEthernetIp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceEthernetIpState, opts?: pulumi.CustomResourceOptions): InterfaceEthernetIp {
        return new InterfaceEthernetIp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/interfaceEthernetIp:InterfaceEthernetIp';

    /**
     * Returns true if the given object is an instance of InterfaceEthernetIp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InterfaceEthernetIp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InterfaceEthernetIp.__pulumiType;
    }

    public readonly addressLists!: pulumi.Output<outputs.InterfaceEthernetIpAddressList[] | undefined>;
    /**
    ...
    public readonly helperAddressLists!: pulumi.Output<outputs.InterfaceEthernetIpHelperAddressList[] | undefined>;
    /**
     * Ifnum
     */
    ...
    public readonly ospf!: pulumi.Output<outputs.InterfaceEthernetIpOspf | undefined>;
    /**
    ...
    public readonly rip!: pulumi.Output<outputs.InterfaceEthernetIpRip | undefined>;
    public readonly router!: pulumi.Output<outputs.InterfaceEthernetIpRouter | undefined>;
    /**
    ...
    public readonly statefulFirewall!: pulumi.Output<outputs.InterfaceEthernetIpStatefulFirewall | undefined>;
    /**
    ...
    /**
     * Create a InterfaceEthernetIp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: InterfaceEthernetIpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: InterfaceEthernetIpArgs | InterfaceEthernetIpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InterfaceEthernetIpState | undefined;
            ...
            const args = argsOrState as InterfaceEthernetIpArgs | undefined;
        ...
        super(InterfaceEthernetIp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering InterfaceEthernetIp resources.
 */
export interface InterfaceEthernetIpState {
    addressLists?: pulumi.Input<pulumi.Input<inputs.InterfaceEthernetIpAddressList>[]>;
    /**
     * Allow traffic to be associated with promiscuous VIP
     */
    ...
    helperAddressLists?: pulumi.Input<pulumi.Input<inputs.InterfaceEthernetIpHelperAddressList>[]>;
    /**
     * Ifnum
     */
    ...
    ospf?: pulumi.Input<inputs.InterfaceEthernetIpOspf>;
    /**
     * Configure interface as outside
     */
    ...
    rip?: pulumi.Input<inputs.InterfaceEthernetIpRip>;
    router?: pulumi.Input<inputs.InterfaceEthernetIpRouter>;
    /**
     * Server facing interface for IPv4/v6 traffic
     */
    ...
    statefulFirewall?: pulumi.Input<inputs.InterfaceEthernetIpStatefulFirewall>;
    /**
     * Configure Enable SYN-cookie on the interface
     */
...
/**
 * The set of arguments for constructing a InterfaceEthernetIp resource.
 */
export interface InterfaceEthernetIpArgs {
    addressLists?: pulumi.Input<pulumi.Input<inputs.InterfaceEthernetIpAddressList>[]>;
    /**
     * Allow traffic to be associated with promiscuous VIP
     */
