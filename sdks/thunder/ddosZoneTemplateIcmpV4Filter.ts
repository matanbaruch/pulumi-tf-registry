...
export class DdosZoneTemplateIcmpV4Filter extends pulumi.CustomResource {
    /**
     * Get an existing DdosZoneTemplateIcmpV4Filter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosZoneTemplateIcmpV4FilterState, opts?: pulumi.CustomResourceOptions): DdosZoneTemplateIcmpV4Filter {
        return new DdosZoneTemplateIcmpV4Filter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosZoneTemplateIcmpV4Filter:DdosZoneTemplateIcmpV4Filter';

    /**
     * Returns true if the given object is an instance of DdosZoneTemplateIcmpV4Filter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosZoneTemplateIcmpV4Filter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosZoneTemplateIcmpV4Filter.__pulumiType;
    }
    ...
    /**
     * Create a DdosZoneTemplateIcmpV4Filter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosZoneTemplateIcmpV4FilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosZoneTemplateIcmpV4FilterArgs | DdosZoneTemplateIcmpV4FilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosZoneTemplateIcmpV4FilterState | undefined;
            ...
            const args = argsOrState as DdosZoneTemplateIcmpV4FilterArgs | undefined;
        ...
        super(DdosZoneTemplateIcmpV4Filter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosZoneTemplateIcmpV4Filter resources.
 */
export interface DdosZoneTemplateIcmpV4FilterState {
    /**
     * filter using Berkeley packet filter syntax
     */
...
/**
 * The set of arguments for constructing a DdosZoneTemplateIcmpV4Filter resource.
 */
export interface DdosZoneTemplateIcmpV4FilterArgs {
    /**
     * filter using Berkeley packet filter syntax
     */
    byteOffsetFilter?: pulumi.Input<string>;
