...
export class DdosTemplateTcpProgressionTrackingTimeWindowTracking extends pulumi.CustomResource {
    /**
     * Get an existing DdosTemplateTcpProgressionTrackingTimeWindowTracking resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosTemplateTcpProgressionTrackingTimeWindowTrackingState, opts?: pulumi.CustomResourceOptions): DdosTemplateTcpProgressionTrackingTimeWindowTracking {
        return new DdosTemplateTcpProgressionTrackingTimeWindowTracking(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosTemplateTcpProgressionTrackingTimeWindowTracking:DdosTemplateTcpProgressionTrackingTimeWindowTracking';

    /**
     * Returns true if the given object is an instance of DdosTemplateTcpProgressionTrackingTimeWindowTracking.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosTemplateTcpProgressionTrackingTimeWindowTracking {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosTemplateTcpProgressionTrackingTimeWindowTracking.__pulumiType;
    }
    ...
    /**
     * Create a DdosTemplateTcpProgressionTrackingTimeWindowTracking resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosTemplateTcpProgressionTrackingTimeWindowTrackingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosTemplateTcpProgressionTrackingTimeWindowTrackingArgs | DdosTemplateTcpProgressionTrackingTimeWindowTrackingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosTemplateTcpProgressionTrackingTimeWindowTrackingState | undefined;
            ...
            const args = argsOrState as DdosTemplateTcpProgressionTrackingTimeWindowTrackingArgs | undefined;
        ...
        super(DdosTemplateTcpProgressionTrackingTimeWindowTracking.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosTemplateTcpProgressionTrackingTimeWindowTracking resources.
 */
export interface DdosTemplateTcpProgressionTrackingTimeWindowTrackingState {
    /**
     * Name
     */
...
/**
 * The set of arguments for constructing a DdosTemplateTcpProgressionTrackingTimeWindowTracking resource.
 */
export interface DdosTemplateTcpProgressionTrackingTimeWindowTrackingArgs {
    /**
     * Name
     */
    name?: pulumi.Input<string>;
