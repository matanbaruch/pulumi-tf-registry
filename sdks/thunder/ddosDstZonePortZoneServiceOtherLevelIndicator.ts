...
export class DdosDstZonePortZoneServiceOtherLevelIndicator extends pulumi.CustomResource {
    /**
     * Get an existing DdosDstZonePortZoneServiceOtherLevelIndicator resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosDstZonePortZoneServiceOtherLevelIndicatorState, opts?: pulumi.CustomResourceOptions): DdosDstZonePortZoneServiceOtherLevelIndicator {
        return new DdosDstZonePortZoneServiceOtherLevelIndicator(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosDstZonePortZoneServiceOtherLevelIndicator:DdosDstZonePortZoneServiceOtherLevelIndicator';

    /**
     * Returns true if the given object is an instance of DdosDstZonePortZoneServiceOtherLevelIndicator.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosDstZonePortZoneServiceOtherLevelIndicator {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosDstZonePortZoneServiceOtherLevelIndicator.__pulumiType;
    }
    ...
    /**
     * Create a DdosDstZonePortZoneServiceOtherLevelIndicator resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosDstZonePortZoneServiceOtherLevelIndicatorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosDstZonePortZoneServiceOtherLevelIndicatorArgs | DdosDstZonePortZoneServiceOtherLevelIndicatorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosDstZonePortZoneServiceOtherLevelIndicatorState | undefined;
            ...
            const args = argsOrState as DdosDstZonePortZoneServiceOtherLevelIndicatorArgs | undefined;
        ...
        super(DdosDstZonePortZoneServiceOtherLevelIndicator.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosDstZonePortZoneServiceOtherLevelIndicator resources.
 */
export interface DdosDstZonePortZoneServiceOtherLevelIndicatorState {
    /**
     * Expected minimal data size
     */
...
/**
 * The set of arguments for constructing a DdosDstZonePortZoneServiceOtherLevelIndicator resource.
 */
export interface DdosDstZonePortZoneServiceOtherLevelIndicatorArgs {
    /**
     * Expected minimal data size
     */
    dataPacketSize?: pulumi.Input<number>;
