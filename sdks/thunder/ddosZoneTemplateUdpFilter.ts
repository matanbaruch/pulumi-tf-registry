...
export class DdosZoneTemplateUdpFilter extends pulumi.CustomResource {
    /**
     * Get an existing DdosZoneTemplateUdpFilter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosZoneTemplateUdpFilterState, opts?: pulumi.CustomResourceOptions): DdosZoneTemplateUdpFilter {
        return new DdosZoneTemplateUdpFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosZoneTemplateUdpFilter:DdosZoneTemplateUdpFilter';

    /**
     * Returns true if the given object is an instance of DdosZoneTemplateUdpFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosZoneTemplateUdpFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosZoneTemplateUdpFilter.__pulumiType;
    }
    ...
    /**
     * Create a DdosZoneTemplateUdpFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosZoneTemplateUdpFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosZoneTemplateUdpFilterArgs | DdosZoneTemplateUdpFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosZoneTemplateUdpFilterState | undefined;
            ...
            const args = argsOrState as DdosZoneTemplateUdpFilterArgs | undefined;
        ...
        super(DdosZoneTemplateUdpFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosZoneTemplateUdpFilter resources.
 */
export interface DdosZoneTemplateUdpFilterState {
    /**
     * Filter using Berkeley Packet Filter syntax
     */
...
/**
 * The set of arguments for constructing a DdosZoneTemplateUdpFilter resource.
 */
export interface DdosZoneTemplateUdpFilterArgs {
    /**
     * Filter using Berkeley Packet Filter syntax
     */
    byteOffsetFilter?: pulumi.Input<string>;
