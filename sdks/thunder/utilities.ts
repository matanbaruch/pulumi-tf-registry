...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("thunder");
			params.setVersion("1.4.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2ExMG5ldHdvcmtzL3RodW5kZXIiLCJ2ZXJzaW9uIjoiMS40LjIifX0="), c => c.charCodeAt(0)));
