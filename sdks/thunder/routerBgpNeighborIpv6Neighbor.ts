...
export class RouterBgpNeighborIpv6Neighbor extends pulumi.CustomResource {
    /**
     * Get an existing RouterBgpNeighborIpv6Neighbor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RouterBgpNeighborIpv6NeighborState, opts?: pulumi.CustomResourceOptions): RouterBgpNeighborIpv6Neighbor {
        return new RouterBgpNeighborIpv6Neighbor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/routerBgpNeighborIpv6Neighbor:RouterBgpNeighborIpv6Neighbor';

    /**
     * Returns true if the given object is an instance of RouterBgpNeighborIpv6Neighbor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RouterBgpNeighborIpv6Neighbor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RouterBgpNeighborIpv6Neighbor.__pulumiType;
    }
    ...
    public readonly distributeLists!: pulumi.Output<outputs.RouterBgpNeighborIpv6NeighborDistributeList[] | undefined>;
    /**
    ...
    public readonly neighborFilterLists!: pulumi.Output<outputs.RouterBgpNeighborIpv6NeighborNeighborFilterList[] | undefined>;
    /**
     * Neighbor IPv6 address
     */
    public readonly neighborIpv6!: pulumi.Output<string>;
    public readonly neighborPrefixLists!: pulumi.Output<outputs.RouterBgpNeighborIpv6NeighborNeighborPrefixList[] | undefined>;
    public readonly neighborRouteMapLists!: pulumi.Output<outputs.RouterBgpNeighborIpv6NeighborNeighborRouteMapList[] | undefined>;
    /**
    ...
    /**
     * Create a RouterBgpNeighborIpv6Neighbor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RouterBgpNeighborIpv6NeighborArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RouterBgpNeighborIpv6NeighborArgs | RouterBgpNeighborIpv6NeighborState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RouterBgpNeighborIpv6NeighborState | undefined;
            ...
            const args = argsOrState as RouterBgpNeighborIpv6NeighborArgs | undefined;
        ...
        super(RouterBgpNeighborIpv6Neighbor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RouterBgpNeighborIpv6Neighbor resources.
 */
export interface RouterBgpNeighborIpv6NeighborState {
    /**
     * Send BGP update to ACOS application
     */
    ...
    distributeLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpNeighborIpv6NeighborDistributeList>[]>;
    /**
     * Do not perform capability negotiation
     */
    ...
    neighborFilterLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpNeighborIpv6NeighborNeighborFilterList>[]>;
    /**
     * Neighbor IPv6 address
     */
    neighborIpv6?: pulumi.Input<string>;
    neighborPrefixLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpNeighborIpv6NeighborNeighborPrefixList>[]>;
    neighborRouteMapLists?: pulumi.Input<pulumi.Input<inputs.RouterBgpNeighborIpv6NeighborNeighborRouteMapList>[]>;
    /**
     * Disable the next hop calculation for this neighbor
     */
...
/**
 * The set of arguments for constructing a RouterBgpNeighborIpv6Neighbor resource.
 */
export interface RouterBgpNeighborIpv6NeighborArgs {
    /**
     * Send BGP update to ACOS application
     */
    acosApplicationOnly?: pulumi.Input<number>;
