...
export class DomainGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'thunder:index/domainGroup:DomainGroup';
    ...
    public readonly domainGroupLists!: pulumi.Output<outputs.DomainGroupDomainGroupList[] | undefined>;
    public readonly domainRateLists!: pulumi.Output<outputs.DomainGroupDomainRateList[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DomainGroupArgs | DomainGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["domainGroupLists"] = state ? state.domainGroupLists : undefined;
            resourceInputs["domainRateLists"] = state ? state.domainRateLists : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
            resourceInputs["userTag"] = state ? state.userTag : undefined;
            resourceInputs["uuid"] = state ? state.uuid : undefined;
        } else {
            const args = argsOrState as DomainGroupArgs | undefined;
            resourceInputs["domainGroupLists"] = args ? args.domainGroupLists : undefined;
            resourceInputs["domainRateLists"] = args ? args.domainRateLists : undefined;
            resourceInputs["name"] = args ? args.name : undefined;
            resourceInputs["userTag"] = args ? args.userTag : undefined;
            resourceInputs["uuid"] = args ? args.uuid : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(DomainGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DomainGroupState {
    domainGroupLists?: pulumi.Input<pulumi.Input<inputs.DomainGroupDomainGroupList>[]>;
    domainRateLists?: pulumi.Input<pulumi.Input<inputs.DomainGroupDomainRateList>[]>;
    /**
     * Specify name of the domain group
     */
