...
export class FwRadiusServer extends pulumi.CustomResource {
    /**
     * Get an existing FwRadiusServer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FwRadiusServerState, opts?: pulumi.CustomResourceOptions): FwRadiusServer {
        return new FwRadiusServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/fwRadiusServer:FwRadiusServer';

    /**
     * Returns true if the given object is an instance of FwRadiusServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FwRadiusServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FwRadiusServer.__pulumiType;
    }
    ...
    public readonly attributes!: pulumi.Output<outputs.FwRadiusServerAttribute[] | undefined>;
    /**
    ...
    public readonly remote!: pulumi.Output<outputs.FwRadiusServerRemote | undefined>;
    public readonly samplingEnables!: pulumi.Output<outputs.FwRadiusServerSamplingEnable[] | undefined>;
    /**
    ...
    /**
     * Create a FwRadiusServer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: FwRadiusServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FwRadiusServerArgs | FwRadiusServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FwRadiusServerState | undefined;
            ...
            const args = argsOrState as FwRadiusServerArgs | undefined;
        ...
        super(FwRadiusServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering FwRadiusServer resources.
 */
export interface FwRadiusServerState {
    /**
     * 'ignore': Ignore (default); 'append-entry': Append the AVPs to existing entry; 'replace-entry': Replace the AVPs of
     * existing entry;
     */
    ...
    attributes?: pulumi.Input<pulumi.Input<inputs.FwRadiusServerAttribute>[]>;
    /**
     * Clear using customized attribute
     */
    ...
    remote?: pulumi.Input<inputs.FwRadiusServerRemote>;
    samplingEnables?: pulumi.Input<pulumi.Input<inputs.FwRadiusServerSamplingEnable>[]>;
    /**
     * Configure shared secret
     */
...
/**
 * The set of arguments for constructing a FwRadiusServer resource.
 */
export interface FwRadiusServerArgs {
    /**
     * 'ignore': Ignore (default); 'append-entry': Append the AVPs to existing entry; 'replace-entry': Replace the AVPs of
     * existing entry;
     */
