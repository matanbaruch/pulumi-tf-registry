...
export class SlbTemplateReqmodIcap extends pulumi.CustomResource {
    /**
     * Get an existing SlbTemplateReqmodIcap resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SlbTemplateReqmodIcapState, opts?: pulumi.CustomResourceOptions): SlbTemplateReqmodIcap {
        return new SlbTemplateReqmodIcap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/slbTemplateReqmodIcap:SlbTemplateReqmodIcap';

    /**
     * Returns true if the given object is an instance of SlbTemplateReqmodIcap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SlbTemplateReqmodIcap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SlbTemplateReqmodIcap.__pulumiType;
    }
     ...
     */
    public readonly allowedHttpMethods!: pulumi.Output<string | undefined>;
    public readonly bypassIpCfgs!: pulumi.Output<outputs.SlbTemplateReqmodIcapBypassIpCfg[] | undefined>;
    /**
    ...
    /**
     * Create a SlbTemplateReqmodIcap resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SlbTemplateReqmodIcapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SlbTemplateReqmodIcapArgs | SlbTemplateReqmodIcapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SlbTemplateReqmodIcapState | undefined;
            resourceInputs["action"] = state ? state.action : undefined;
            resourceInputs["allowedHttpMethods"] = state ? state.allowedHttpMethods : undefined;
            ...
            const args = argsOrState as SlbTemplateReqmodIcapArgs | undefined;
            resourceInputs["action"] = args ? args.action : undefined;
            resourceInputs["allowedHttpMethods"] = args ? args.allowedHttpMethods : undefined;
        ...
        super(SlbTemplateReqmodIcap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SlbTemplateReqmodIcap resources.
 */
export interface SlbTemplateReqmodIcapState {
    /**
     * 'continue': Continue; 'drop': Drop; 'reset': Reset;
     */
    ...
    bypassIpCfgs?: pulumi.Input<pulumi.Input<inputs.SlbTemplateReqmodIcapBypassIpCfg>[]>;
    /**
     * Don't reset http server
     */
...
/**
 * The set of arguments for constructing a SlbTemplateReqmodIcap resource.
 */
export interface SlbTemplateReqmodIcapArgs {
    /**
     * 'continue': Continue; 'drop': Drop; 'reset': Reset;
     */
    action?: pulumi.Input<string>;
