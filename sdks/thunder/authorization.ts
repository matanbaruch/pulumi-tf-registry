...
export class Authorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'thunder:index/authorization:Authorization';
    ...
    /**
     * Specify the debug level for authorization (Debug level for command authorization. bitwise OR of the following:
     * 1(common), 2(packet),4(packet detail), 8(md5))
     */
    public readonly debug!: pulumi.Output<number | undefined>;
    public readonly method!: pulumi.Output<outputs.AuthorizationMethod | undefined>;
    /**
     * uuid of the object
     */
    ...
    constructor(name: string, argsOrState?: AuthorizationArgs | AuthorizationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Authorization.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AuthorizationState {
    ...
    method?: pulumi.Input<inputs.AuthorizationMethod>;
    /**
     * uuid of the object
     */
