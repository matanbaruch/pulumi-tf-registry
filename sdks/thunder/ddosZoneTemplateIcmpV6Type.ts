...
export class DdosZoneTemplateIcmpV6Type extends pulumi.CustomResource {
    /**
     * Get an existing DdosZoneTemplateIcmpV6Type resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosZoneTemplateIcmpV6TypeState, opts?: pulumi.CustomResourceOptions): DdosZoneTemplateIcmpV6Type {
        return new DdosZoneTemplateIcmpV6Type(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosZoneTemplateIcmpV6Type:DdosZoneTemplateIcmpV6Type';

    /**
     * Returns true if the given object is an instance of DdosZoneTemplateIcmpV6Type.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosZoneTemplateIcmpV6Type {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosZoneTemplateIcmpV6Type.__pulumiType;
    }
    ...
    public readonly v6DstCodeCfgs!: pulumi.Output<outputs.DdosZoneTemplateIcmpV6TypeV6DstCodeCfg[] | undefined>;
    public readonly v6DstRateCfg!: pulumi.Output<outputs.DdosZoneTemplateIcmpV6TypeV6DstRateCfg | undefined>;
    public readonly v6SrcCodeCfgs!: pulumi.Output<outputs.DdosZoneTemplateIcmpV6TypeV6SrcCodeCfg[] | undefined>;
    public readonly v6SrcRateCfg!: pulumi.Output<outputs.DdosZoneTemplateIcmpV6TypeV6SrcRateCfg | undefined>;

    /**
     * Create a DdosZoneTemplateIcmpV6Type resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosZoneTemplateIcmpV6TypeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosZoneTemplateIcmpV6TypeArgs | DdosZoneTemplateIcmpV6TypeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosZoneTemplateIcmpV6TypeState | undefined;
            ...
            resourceInputs["v6DstCodeCfgs"] = state ? state.v6DstCodeCfgs : undefined;
            resourceInputs["v6DstRateCfg"] = state ? state.v6DstRateCfg : undefined;
            resourceInputs["v6SrcCodeCfgs"] = state ? state.v6SrcCodeCfgs : undefined;
            resourceInputs["v6SrcRateCfg"] = state ? state.v6SrcRateCfg : undefined;
        } else {
            const args = argsOrState as DdosZoneTemplateIcmpV6TypeArgs | undefined;
            ...
            resourceInputs["v6DstCodeCfgs"] = args ? args.v6DstCodeCfgs : undefined;
            resourceInputs["v6DstRateCfg"] = args ? args.v6DstRateCfg : undefined;
            resourceInputs["v6SrcCodeCfgs"] = args ? args.v6SrcCodeCfgs : undefined;
            resourceInputs["v6SrcRateCfg"] = args ? args.v6SrcRateCfg : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(DdosZoneTemplateIcmpV6Type.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosZoneTemplateIcmpV6Type resources.
 */
export interface DdosZoneTemplateIcmpV6TypeState {
    /**
     * Specify the rate with other code
     */
    ...
    v6DstCodeCfgs?: pulumi.Input<pulumi.Input<inputs.DdosZoneTemplateIcmpV6TypeV6DstCodeCfg>[]>;
    v6DstRateCfg?: pulumi.Input<inputs.DdosZoneTemplateIcmpV6TypeV6DstRateCfg>;
    v6SrcCodeCfgs?: pulumi.Input<pulumi.Input<inputs.DdosZoneTemplateIcmpV6TypeV6SrcCodeCfg>[]>;
    v6SrcRateCfg?: pulumi.Input<inputs.DdosZoneTemplateIcmpV6TypeV6SrcRateCfg>;
}

/**
 * The set of arguments for constructing a DdosZoneTemplateIcmpV6Type resource.
 */
export interface DdosZoneTemplateIcmpV6TypeArgs {
    /**
     * Specify the rate with other code
     */
    dstCodeOtherRate?: pulumi.Input<number>;
