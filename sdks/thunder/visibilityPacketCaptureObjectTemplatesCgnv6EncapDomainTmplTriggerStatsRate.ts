...
export class VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate extends pulumi.CustomResource {
    /**
     * Get an existing VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateState, opts?: pulumi.CustomResourceOptions): VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate {
        return new VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/visibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate:VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate';

    /**
     * Returns true if the given object is an instance of VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate.__pulumiType;
    }
    ...
    /**
     * Create a VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateArgs | VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateState | undefined;
            ...
            const args = argsOrState as VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateArgs | undefined;
        ...
        super(VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate resources.
 */
export interface VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateState {
    /**
     * Time in seconds to look for the anomaly, default is 60
     */
...
/**
 * The set of arguments for constructing a VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRate resource.
 */
export interface VisibilityPacketCaptureObjectTemplatesCgnv6EncapDomainTmplTriggerStatsRateArgs {
    /**
     * Time in seconds to look for the anomaly, default is 60
     */
    duration?: pulumi.Input<number>;
