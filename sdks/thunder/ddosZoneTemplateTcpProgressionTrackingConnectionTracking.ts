...
export class DdosZoneTemplateTcpProgressionTrackingConnectionTracking extends pulumi.CustomResource {
    /**
     * Get an existing DdosZoneTemplateTcpProgressionTrackingConnectionTracking resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DdosZoneTemplateTcpProgressionTrackingConnectionTrackingState, opts?: pulumi.CustomResourceOptions): DdosZoneTemplateTcpProgressionTrackingConnectionTracking {
        return new DdosZoneTemplateTcpProgressionTrackingConnectionTracking(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thunder:index/ddosZoneTemplateTcpProgressionTrackingConnectionTracking:DdosZoneTemplateTcpProgressionTrackingConnectionTracking';

    /**
     * Returns true if the given object is an instance of DdosZoneTemplateTcpProgressionTrackingConnectionTracking.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DdosZoneTemplateTcpProgressionTrackingConnectionTracking {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DdosZoneTemplateTcpProgressionTrackingConnectionTracking.__pulumiType;
    }
    ...
    /**
     * Create a DdosZoneTemplateTcpProgressionTrackingConnectionTracking resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DdosZoneTemplateTcpProgressionTrackingConnectionTrackingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DdosZoneTemplateTcpProgressionTrackingConnectionTrackingArgs | DdosZoneTemplateTcpProgressionTrackingConnectionTrackingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DdosZoneTemplateTcpProgressionTrackingConnectionTrackingState | undefined;
            ...
            const args = argsOrState as DdosZoneTemplateTcpProgressionTrackingConnectionTrackingArgs | undefined;
        ...
        super(DdosZoneTemplateTcpProgressionTrackingConnectionTracking.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DdosZoneTemplateTcpProgressionTrackingConnectionTracking resources.
 */
export interface DdosZoneTemplateTcpProgressionTrackingConnectionTrackingState {
    /**
     * Set the maximum duration time (in unit of 100ms, up to 24 hours)
     */
...
/**
 * The set of arguments for constructing a DdosZoneTemplateTcpProgressionTrackingConnectionTracking resource.
 */
export interface DdosZoneTemplateTcpProgressionTrackingConnectionTrackingArgs {
    /**
     * Set the maximum duration time (in unit of 100ms, up to 24 hours)
     */
    connDurationMax?: pulumi.Input<number>;
