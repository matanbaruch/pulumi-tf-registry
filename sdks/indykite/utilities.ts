...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("indykite");
			params.setVersion("0.7.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2luZHlraXRlL2luZHlraXRlIiwidmVyc2lvbiI6IjAuNy4xIn19"), c => c.charCodeAt(0)));
