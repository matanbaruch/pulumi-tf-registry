...
export interface DestinationBigqueryConfigurationLoadingMethod {
     ...
     */
    standardInserts?: pulumi.Input<inputs.DestinationBigqueryConfigurationLoadingMethodStandardInserts>;
}
...
export interface DestinationDatabricksConfigurationDataSource {
    amazonS3?: pulumi.Input<inputs.DestinationDatabricksConfigurationDataSourceAmazonS3>;
    azureBlobStorage?: pulumi.Input<inputs.DestinationDatabricksConfigurationDataSourceAzureBlobStorage>;
    recommendedManagedTables?: pulumi.Input<inputs.DestinationDatabricksConfigurationDataSourceRecommendedManagedTables>;
}
...
export interface DestinationLangchainConfigurationEmbedding {
     ...
     * Use a fake embedding made out of random vectors with 1536 embedding dimensions. This is useful for testing the data pipeline without incurring any costs.
     */
    fake?: pulumi.Input<inputs.DestinationLangchainConfigurationEmbeddingFake>;
    /**
     * Use the OpenAI API to embed text. This option is using the text-embedding-ada-002 model with 1536 embedding dimensions.
     */
    openAi?: pulumi.Input<inputs.DestinationLangchainConfigurationEmbeddingOpenAi>;
}
...
export interface DestinationLangchainConfigurationIndexing {
     ...
     */
    chromaLocalPersistance?: pulumi.Input<inputs.DestinationLangchainConfigurationIndexingChromaLocalPersistance>;
    /**
     ...
     */
    docArrayHnswSearch?: pulumi.Input<inputs.DestinationLangchainConfigurationIndexingDocArrayHnswSearch>;
    /**
     ...
     */
    pinecone?: pulumi.Input<inputs.DestinationLangchainConfigurationIndexingPinecone>;
}
...
export interface DestinationRedshiftConfigurationUploadingMethodAwss3Staging {
     ...
     */
    encryption?: pulumi.Input<inputs.DestinationRedshiftConfigurationUploadingMethodAwss3StagingEncryption>;
    /**
     * The pattern allows you to set the file-name format for the S3 staging file(s)
     */
    fileNamePattern?: pulumi.Input<string>;
...
export interface DestinationRedshiftConfigurationUploadingMethodAwss3StagingEncryption {
     ...
     */
    aescbcEnvelopeEncryption?: pulumi.Input<inputs.DestinationRedshiftConfigurationUploadingMethodAwss3StagingEncryptionAescbcEnvelopeEncryption>;
    /**
     * Staging data will be stored in plaintext.
     */
    noEncryption?: pulumi.Input<inputs.DestinationRedshiftConfigurationUploadingMethodAwss3StagingEncryptionNoEncryption>;
}
...
export interface SourceAzureBlobStorageConfigurationStream {
     ...
     */
    legacyPrefix?: pulumi.Input<string>;
    /**
...
export interface SourceAzureBlobStorageConfigurationStreamFormatCsvFormat {
     ...
     */
    inferenceType?: pulumi.Input<string>;
    /**
...
export interface SourceGoogleAnalyticsV4ServiceAccountOnlyConfiguration {
     ...
     * Credentials for the service
     */
    credentials?: pulumi.Input<inputs.SourceGoogleAnalyticsV4ServiceAccountOnlyConfigurationCredentials>;
    /**
...
export interface SourceGoogleAnalyticsV4ServiceAccountOnlyConfigurationCredentials {
    serviceAccountKeyAuthentication?: pulumi.Input<inputs.SourceGoogleAnalyticsV4ServiceAccountOnlyConfigurationCredentialsServiceAccountKeyAuthentication>;
}
...
export interface SourceJiraConfiguration {
     ...
     */
    expandIssueTransition?: pulumi.Input<boolean>;
    /**
     * Select fields to Expand the `Issues` stream when replicating with:
     */
    issuesStreamExpandWiths?: pulumi.Input<pulumi.Input<string>[]>;
    /**
...
export interface SourceMicrosoftOnedriveConfigurationStreamFormat {
     ...
     * Extract text from document formats (.pdf, .docx, .md, .pptx) and emit as one record per file.
     */
    documentFileTypeFormatExperimental?: pulumi.Input<inputs.SourceMicrosoftOnedriveConfigurationStreamFormatDocumentFileTypeFormatExperimental>;
...
export interface SourceMicrosoftOnedriveConfigurationStreamFormatDocumentFileTypeFormatExperimental {
     ...
     * Processing configuration
     */
    processing?: pulumi.Input<inputs.SourceMicrosoftOnedriveConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing>;
    /**
     * If true, skip files that cannot be parsed and pass the error message along as the _ab_source_file_parse_error field. If false, fail the sync. Default: true
     */
    skipUnprocessableFiles?: pulumi.Input<boolean>;
...
export interface SourceMicrosoftOnedriveConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing {
     ...
     * Process files locally, supporting `fast` and `ocr` modes. This is the default option.
     */
    local?: pulumi.Input<inputs.SourceMicrosoftOnedriveConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingLocal>;
}
...
export interface SourceMicrosoftSharepointConfigurationStreamFormat {
     ...
     * Extract text from document formats (.pdf, .docx, .md, .pptx) and emit as one record per file.
     */
    documentFileTypeFormatExperimental?: pulumi.Input<inputs.SourceMicrosoftSharepointConfigurationStreamFormatDocumentFileTypeFormatExperimental>;
...
export interface SourceMicrosoftSharepointConfigurationStreamFormatDocumentFileTypeFormatExperimental {
     ...
     * Processing configuration
     */
    processing?: pulumi.Input<inputs.SourceMicrosoftSharepointConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing>;
    /**
     * If true, skip files that cannot be parsed and pass the error message along as the _ab_source_file_parse_error field. If false, fail the sync. Default: true
     */
    skipUnprocessableFiles?: pulumi.Input<boolean>;
...
export interface SourceMicrosoftSharepointConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing {
     ...
     * Process files locally, supporting `fast` and `ocr` modes. This is the default option.
     */
    local?: pulumi.Input<inputs.SourceMicrosoftSharepointConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingLocal>;
}
...
export interface SourceS3ConfigurationFormat {
     ...
     */
    avro?: pulumi.Input<inputs.SourceS3ConfigurationFormatAvro>;
    /**
     ...
     */
    csv?: pulumi.Input<inputs.SourceS3ConfigurationFormatCsv>;
    /**
     ...
     */
    jsonl?: pulumi.Input<inputs.SourceS3ConfigurationFormatJsonl>;
    /**
     ...
     */
    parquet?: pulumi.Input<inputs.SourceS3ConfigurationFormatParquet>;
}
...
export interface SourceS3ConfigurationStreamFormat {
     ...
     * Extract text from document formats (.pdf, .docx, .md, .pptx) and emit as one record per file.
     */
    documentFileTypeFormatExperimental?: pulumi.Input<inputs.SourceS3ConfigurationStreamFormatDocumentFileTypeFormatExperimental>;
...
export interface SourceS3ConfigurationStreamFormatDocumentFileTypeFormatExperimental {
     ...
     * Processing configuration
     */
    processing?: pulumi.Input<inputs.SourceS3ConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing>;
    /**
     * If true, skip files that cannot be parsed and pass the error message along as the _ab_source_file_parse_error field. If false, fail the sync. Default: true
     */
    skipUnprocessableFiles?: pulumi.Input<boolean>;
...
export interface SourceS3ConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing {
     ...
     * Process files locally, supporting `fast` and `ocr` modes. This is the default option.
     */
    local?: pulumi.Input<inputs.SourceS3ConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingLocal>;
}
...
export interface SourceSftpBulkConfigurationStreamFormat {
     ...
     * Extract text from document formats (.pdf, .docx, .md, .pptx) and emit as one record per file.
     */
    documentFileTypeFormatExperimental?: pulumi.Input<inputs.SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimental>;
...
export interface SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimental {
     ...
     * Processing configuration
     */
    processing?: pulumi.Input<inputs.SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing>;
    /**
     * If true, skip files that cannot be parsed and pass the error message along as the _ab_source_file_parse_error field. If false, fail the sync. Default: true
     */
    skipUnprocessableFiles?: pulumi.Input<boolean>;
...
export interface SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessing {
     ...
     * Process files locally, supporting `fast` and `ocr` modes. This is the default option.
     */
    local?: pulumi.Input<inputs.SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingLocal>;
    /**
     ...
     */
    viaApi?: pulumi.Input<inputs.SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingViaApi>;
}
...
export interface SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingViaApi {
     ...
     */
    parameters?: pulumi.Input<pulumi.Input<inputs.SourceSftpBulkConfigurationStreamFormatDocumentFileTypeFormatExperimentalProcessingViaApiParameter>[]>;
}
