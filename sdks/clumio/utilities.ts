...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("clumio");
			params.setVersion("0.10.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NsdW1pby1jb2RlL2NsdW1pbyIsInZlcnNpb24iOiIwLjEwLjIifX0="), c => c.charCodeAt(0)));
