...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("keyfactor");
			params.setVersion("2.1.11");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2tleWZhY3Rvci1wdWIva2V5ZmFjdG9yIiwidmVyc2lvbiI6IjIuMS4xMSJ9fQ=="), c => c.charCodeAt(0)));
