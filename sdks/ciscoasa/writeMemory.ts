...
export class WriteMemory extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ciscoasa:index/writeMemory:WriteMemory';
    ...
    /**
     * A map of arbitrary strings that, when changed, will force the write_memory resource to be replaced, re-running saving
     * changes.
     */
