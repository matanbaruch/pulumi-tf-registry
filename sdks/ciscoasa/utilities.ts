...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ciscoasa");
			params.setVersion("1.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Npc2NvZGV2bmV0L2Npc2NvYXNhIiwidmVyc2lvbiI6IjEuMy4wIn19"), c => c.charCodeAt(0)));
