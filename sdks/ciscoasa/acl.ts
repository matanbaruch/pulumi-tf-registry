...
export class Acl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ciscoasa:index/acl:Acl';
    ...
    public readonly rules!: pulumi.Output<outputs.AclRule[]>;
...
export interface AclState {
    ...
    rules?: pulumi.Input<pulumi.Input<inputs.AclRule>[]>;
}
