...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("site24x7");
			params.setVersion("1.0.90");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NpdGUyNHg3L3NpdGUyNHg3IiwidmVyc2lvbiI6IjEuMC45MCJ9fQ=="), c => c.charCodeAt(0)));
