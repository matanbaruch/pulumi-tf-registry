...
export class CronMonitor extends pulumi.CustomResource {
    /**
     * Get an existing CronMonitor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CronMonitorState, opts?: pulumi.CustomResourceOptions): CronMonitor {
        return new CronMonitor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'site24x7:index/cronMonitor:CronMonitor';

    /**
     * Returns true if the given object is an instance of CronMonitor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CronMonitor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CronMonitor.__pulumiType;
    }
     ...
     */
    public readonly cronTz!: pulumi.Output<string>;
    /**
    ...
    /**
     * Provide an extended period of time (seconds) to define when your alerts should be triggered. This is basically to avoid
     * false alerts.
     */
    public readonly waitTime!: pulumi.Output<number>;

    /**
     * Create a CronMonitor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CronMonitorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CronMonitorArgs | CronMonitorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CronMonitorState | undefined;
            resourceInputs["cronExpression"] = state ? state.cronExpression : undefined;
            resourceInputs["cronTz"] = state ? state.cronTz : undefined;
            ...
            const args = argsOrState as CronMonitorArgs | undefined;
            if ((!args || args.cronExpression === undefined) && !opts.urn) {
                throw new Error("Missing required property 'cronExpression'");
            }
            if ((!args || args.cronTz === undefined) && !opts.urn) {
                throw new Error("Missing required property 'cronTz'");
            }
            if ((!args || args.displayName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'displayName'");
            }
            if ((!args || args.waitTime === undefined) && !opts.urn) {
                throw new Error("Missing required property 'waitTime'");
            }
            resourceInputs["cronExpression"] = args ? args.cronExpression : undefined;
            resourceInputs["cronTz"] = args ? args.cronTz : undefined;
        ...
        super(CronMonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CronMonitor resources.
 */
...
/**
 * The set of arguments for constructing a CronMonitor resource.
 */
export interface CronMonitorArgs {
    /**
     * Cron expression to denote the job schedule.
     */
    cronExpression: pulumi.Input<string>;
