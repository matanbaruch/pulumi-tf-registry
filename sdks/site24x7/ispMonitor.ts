...
export class IspMonitor extends pulumi.CustomResource {
    /**
     * Get an existing IspMonitor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IspMonitorState, opts?: pulumi.CustomResourceOptions): IspMonitor {
        return new IspMonitor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'site24x7:index/ispMonitor:IspMonitor';

    /**
     * Returns true if the given object is an instance of IspMonitor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IspMonitor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IspMonitor.__pulumiType;
    }
    ...
    /**
     * Create a IspMonitor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IspMonitorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IspMonitorArgs | IspMonitorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IspMonitorState | undefined;
            ...
            const args = argsOrState as IspMonitorArgs | undefined;
        ...
        super(IspMonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IspMonitor resources.
 */
export interface IspMonitorState {
    /**
     * Action to be performed on monitor status changes
     */
...
/**
 * The set of arguments for constructing a IspMonitor resource.
 */
export interface IspMonitorArgs {
    /**
     * Action to be performed on monitor status changes
     */
    actions?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
