...
export class Ipv6Network extends pulumi.CustomResource {
    /**
     * Get an existing Ipv6Network resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Ipv6NetworkState, opts?: pulumi.CustomResourceOptions): Ipv6Network {
        return new Ipv6Network(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infoblox:index/ipv6Network:Ipv6Network';

    /**
     * Returns true if the given object is an instance of Ipv6Network.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ipv6Network {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ipv6Network.__pulumiType;
    }
    ...
    /**
     * Create a Ipv6Network resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: Ipv6NetworkArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Ipv6NetworkArgs | Ipv6NetworkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Ipv6NetworkState | undefined;
            ...
            const args = argsOrState as Ipv6NetworkArgs | undefined;
        ...
        super(Ipv6Network.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Ipv6Network resources.
 */
export interface Ipv6NetworkState {
    /**
     * Set the parameter's value > 0 to allocate next available network with corresponding prefix length from the network
     * container defined by 'parent_cidr'
     */
...
/**
 * The set of arguments for constructing a Ipv6Network resource.
 */
export interface Ipv6NetworkArgs {
    /**
     * Set the parameter's value > 0 to allocate next available network with corresponding prefix length from the network
     * container defined by 'parent_cidr'
     */
