...
export class Ipv6NetworkContainer extends pulumi.CustomResource {
    /**
     * Get an existing Ipv6NetworkContainer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Ipv6NetworkContainerState, opts?: pulumi.CustomResourceOptions): Ipv6NetworkContainer {
        return new Ipv6NetworkContainer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infoblox:index/ipv6NetworkContainer:Ipv6NetworkContainer';

    /**
     * Returns true if the given object is an instance of Ipv6NetworkContainer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ipv6NetworkContainer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ipv6NetworkContainer.__pulumiType;
    }
    ...
    /**
     * Create a Ipv6NetworkContainer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: Ipv6NetworkContainerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Ipv6NetworkContainerArgs | Ipv6NetworkContainerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Ipv6NetworkContainerState | undefined;
            ...
            const args = argsOrState as Ipv6NetworkContainerArgs | undefined;
        ...
        super(Ipv6NetworkContainer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering Ipv6NetworkContainer resources.
 */
export interface Ipv6NetworkContainerState {
    /**
     * Set the parameter's value > 0 to allocate next available network container with corresponding prefix length from the
     * network container defined by 'parent_cidr'
     */
...
/**
 * The set of arguments for constructing a Ipv6NetworkContainer resource.
 */
export interface Ipv6NetworkContainerArgs {
    /**
     * Set the parameter's value > 0 to allocate next available network container with corresponding prefix length from the
     * network container defined by 'parent_cidr'
     */
