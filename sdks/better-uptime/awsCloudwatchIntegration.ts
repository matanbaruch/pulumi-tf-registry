...
export class AwsCloudwatchIntegration extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AwsCloudwatchIntegrationState, opts?: pulumi.CustomResourceOptions): AwsCloudwatchIntegration {
        return new AwsCloudwatchIntegration(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'better-uptime:index/awsCloudwatchIntegration:AwsCloudwatchIntegration';

    /**
     * Returns true if the given object is an instance of AwsCloudwatchIntegration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AwsCloudwatchIntegration {
    ...
    constructor(name: string, argsOrState?: AwsCloudwatchIntegrationArgs | AwsCloudwatchIntegrationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AwsCloudwatchIntegrationState | undefined;
            ...
            const args = argsOrState as AwsCloudwatchIntegrationArgs | undefined;
