...
export class PrometheusIntegration extends pulumi.CustomResource {
    /**
     * Get an existing PrometheusIntegration resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrometheusIntegrationState, opts?: pulumi.CustomResourceOptions): PrometheusIntegration {
        return new PrometheusIntegration(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'better-uptime:index/prometheusIntegration:PrometheusIntegration';

    /**
     * Returns true if the given object is an instance of PrometheusIntegration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PrometheusIntegration {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PrometheusIntegration.__pulumiType;
    }
    ...
    /**
     * Create a PrometheusIntegration resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PrometheusIntegrationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PrometheusIntegrationArgs | PrometheusIntegrationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PrometheusIntegrationState | undefined;
            ...
            const args = argsOrState as PrometheusIntegrationArgs | undefined;
        ...
        super(PrometheusIntegration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PrometheusIntegration resources.
 */
export interface PrometheusIntegrationState {
    /**
     * Do we call the on-call person?
     */
...
/**
 * The set of arguments for constructing a PrometheusIntegration resource.
 */
export interface PrometheusIntegrationArgs {
    /**
     * Do we call the on-call person?
     */
    call?: pulumi.Input<boolean>;
