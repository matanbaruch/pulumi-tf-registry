...
export class SensitiveAttribute extends pulumi.CustomResource {
    /**
     * Get an existing SensitiveAttribute resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SensitiveAttributeState, opts?: pulumi.CustomResourceOptions): SensitiveAttribute {
        return new SensitiveAttribute(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/sensitiveAttribute:SensitiveAttribute';

    /**
     * Returns true if the given object is an instance of SensitiveAttribute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SensitiveAttribute {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SensitiveAttribute.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.SensitiveAttributeRequiredAction[]>;
    /**
    ...
    /**
     * Create a SensitiveAttribute resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SensitiveAttributeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SensitiveAttributeArgs | SensitiveAttributeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SensitiveAttributeState | undefined;
            ...
            const args = argsOrState as SensitiveAttributeArgs | undefined;
            if ((!args || args.attributeTypes === undefined) && !opts.urn) {
                throw new Error("Missing required property 'attributeTypes'");
            }
        ...
        super(SensitiveAttribute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SensitiveAttribute resources.
 */
export interface SensitiveAttributeState {
    /**
     * Indicates whether clients will be allowed to include sensitive attributes in add requests.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.SensitiveAttributeRequiredAction>[]>;
    /**
     * The type of Sensitive Attribute resource. Options are ['sensitive-attribute']
     */
...
/**
 * The set of arguments for constructing a SensitiveAttribute resource.
 */
export interface SensitiveAttributeArgs {
    /**
     * Indicates whether clients will be allowed to include sensitive attributes in add requests.
     */
    allowInAdd?: pulumi.Input<string>;
