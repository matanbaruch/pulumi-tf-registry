...
export class DefaultCipherStreamProvider extends pulumi.CustomResource {
    /**
     * Get an existing DefaultCipherStreamProvider resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultCipherStreamProviderState, opts?: pulumi.CustomResourceOptions): DefaultCipherStreamProvider {
        return new DefaultCipherStreamProvider(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultCipherStreamProvider:DefaultCipherStreamProvider';

    /**
     * Returns true if the given object is an instance of DefaultCipherStreamProvider.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultCipherStreamProvider {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultCipherStreamProvider.__pulumiType;
    }
     ...
     */
    public readonly keyStorePinEnvironmentVariable!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly kmsEncryptionKeyArn!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultCipherStreamProviderRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultCipherStreamProvider resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultCipherStreamProviderArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultCipherStreamProviderArgs | DefaultCipherStreamProviderState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultCipherStreamProviderState | undefined;
            ...
            const args = argsOrState as DefaultCipherStreamProviderArgs | undefined;
        ...
        super(DefaultCipherStreamProvider.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultCipherStreamProvider resources.
 */
export interface DefaultCipherStreamProviderState {
    /**
     * The access key ID that will be used if this cipher stream provider will authenticate to the Amazon Key Management
     * Service using an access key rather than an IAM role associated with an EC2 instance.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultCipherStreamProviderRequiredAction>[]>;
    /**
     * The name of the JSON field whose value is the passphrase that will be used to generate the encryption key for protecting
     * the contents of the encryption settings database.
     */
...
/**
 * The set of arguments for constructing a DefaultCipherStreamProvider resource.
 */
export interface DefaultCipherStreamProviderArgs {
    /**
     * The access key ID that will be used if this cipher stream provider will authenticate to the Amazon Key Management
     * Service using an access key rather than an IAM role associated with an EC2 instance.
     */
