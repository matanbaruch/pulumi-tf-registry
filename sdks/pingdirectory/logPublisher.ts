...
export class LogPublisher extends pulumi.CustomResource {
    /**
     * Get an existing LogPublisher resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogPublisherState, opts?: pulumi.CustomResourceOptions): LogPublisher {
        return new LogPublisher(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/logPublisher:LogPublisher';

    /**
     * Returns true if the given object is an instance of LogPublisher.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LogPublisher {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LogPublisher.__pulumiType;
    }
     ...
     */
    public readonly logFieldBehavior!: pulumi.Output<string | undefined>;
    /**
     * The log field mapping associates loggable fields to database column names. The table name is not part of this mapping.
     */
    public readonly logFieldMapping!: pulumi.Output<string | undefined>;
    /**
     ...
     * Publisher
     */
    public readonly minIncludedOperationProcessingTime!: pulumi.Output<string | undefined>;
    /**
     * The minimum length of time in nanoseconds that an operation phase should take before it is included in a log message.
     */
    public readonly minIncludedPhaseTimeNanos!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.LogPublisherRequiredAction[]>;
    /**
     ...
     * Log Publisher.
     */
    public readonly searchEntryCriteria!: pulumi.Output<string | undefined>;
    /**
     * When the `type` attribute is set to: - One of [`third-party-file-based-access`, `jdbc-based-access`,
     * `syslog-based-access`, `syslog-text-access`, `json-access`, `debug-access`, `third-party-access`,
     * `groovy-scripted-file-based-access`, `syslog-json-access`, `groovy-scripted-access`, `console-json-access`,
     ...
     */
    public readonly searchReferenceCriteria!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly syslogMessageApplicationName!: pulumi.Output<string | undefined>;
    /**
     ...
     * be included in syslog messages that are logged by this Syslog JSON Error Log Publisher.
     */
    public readonly syslogMessageHostName!: pulumi.Output<string | undefined>;
    /**
    ...
    /**
     * Create a LogPublisher resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LogPublisherArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LogPublisherArgs | LogPublisherState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LogPublisherState | undefined;
            ...
            const args = argsOrState as LogPublisherArgs | undefined;
        ...
        super(LogPublisher.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LogPublisher resources.
 */
export interface LogPublisherState {
    /**
     * Specifies the access token validator message types that can be logged.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.LogPublisherRequiredAction>[]>;
    /**
     * Specifies a set of result criteria that must match the associated operation result in order for that result to be logged
     * by this Access Log Publisher.
     */
...
/**
 * The set of arguments for constructing a LogPublisher resource.
 */
export interface LogPublisherArgs {
    /**
     * Specifies the access token validator message types that can be logged.
     */
    accessTokenValidatorMessageTypes?: pulumi.Input<pulumi.Input<string>[]>;
