...
export class RecurringTask extends pulumi.CustomResource {
    /**
     * Get an existing RecurringTask resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RecurringTaskState, opts?: pulumi.CustomResourceOptions): RecurringTask {
        return new RecurringTask(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/recurringTask:RecurringTask';

    /**
     * Returns true if the given object is an instance of RecurringTask.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RecurringTask {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RecurringTask.__pulumiType;
    }
     ...
     */
    public readonly commandArguments!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly commandOutputFileBaseName!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly commandPath!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly durationToWaitForSearchToReturnEntries!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly durationToWaitForWorkQueueIdle!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly encryptionPassphraseFile!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly filenamePattern!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly logDuration!: pulumi.Output<string | undefined>;
    /**
     * The amount of data to collect from the beginning of each log file included in the support data archive.
     */
    public readonly logFileHeadCollectionSize!: pulumi.Output<string | undefined>;
    /**
     * The amount of data to collect from the end of each log file included in the support data archive.
     */
    public readonly logFileTailCollectionSize!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly maxMegabytesPerSecond!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public readonly profileDirectory!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.RecurringTaskRequiredAction[]>;
    /**
     ...
     */
    public readonly searchTimeLimit!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly sleepDuration!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly taskJavaClass!: pulumi.Output<string | undefined>;
    /**
    ...
    /**
     * Create a RecurringTask resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RecurringTaskArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RecurringTaskArgs | RecurringTaskState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RecurringTaskState | undefined;
            ...
            const args = argsOrState as RecurringTaskArgs | undefined;
        ...
        super(RecurringTask.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RecurringTask resources.
 */
export interface RecurringTaskState {
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.RecurringTaskRequiredAction>[]>;
    /**
     * The minimum aggregate size of files that will be retained. The size should be specified as an integer followed by a unit
     * that is one of "b" or "bytes", "kb" or "kilobytes", "mb" or "megabytes", "gb" or "gigabytes", or "tb" or "terabytes".
     * For example, a value of "1 gb" indicates that at least one gigabyte of files should be retained.
...
/**
 * The set of arguments for constructing a RecurringTask resource.
 */
export interface RecurringTaskArgs {
    /**
     * Indicates whether the server should generate an administrative alert whenever an instance of this Recurring Task fails
     * to complete successfully.
     */
