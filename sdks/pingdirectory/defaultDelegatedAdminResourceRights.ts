...
export class DefaultDelegatedAdminResourceRights extends pulumi.CustomResource {
    /**
     * Get an existing DefaultDelegatedAdminResourceRights resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultDelegatedAdminResourceRightsState, opts?: pulumi.CustomResourceOptions): DefaultDelegatedAdminResourceRights {
        return new DefaultDelegatedAdminResourceRights(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultDelegatedAdminResourceRights:DefaultDelegatedAdminResourceRights';

    /**
     * Returns true if the given object is an instance of DefaultDelegatedAdminResourceRights.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultDelegatedAdminResourceRights {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultDelegatedAdminResourceRights.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultDelegatedAdminResourceRightsRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultDelegatedAdminResourceRights resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DefaultDelegatedAdminResourceRightsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultDelegatedAdminResourceRightsArgs | DefaultDelegatedAdminResourceRightsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultDelegatedAdminResourceRightsState | undefined;
            ...
            const args = argsOrState as DefaultDelegatedAdminResourceRightsArgs | undefined;
        ...
        super(DefaultDelegatedAdminResourceRights.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultDelegatedAdminResourceRights resources.
 */
export interface DefaultDelegatedAdminResourceRightsState {
    /**
     * Specifies administrator(s) permissions.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultDelegatedAdminResourceRightsRequiredAction>[]>;
    /**
     * Specifies subtrees within the search base whose entries can be managed by the administrator(s). The admin-scope must be
     * set to resources-in-specific-subtrees.
     */
...
/**
 * The set of arguments for constructing a DefaultDelegatedAdminResourceRights resource.
 */
export interface DefaultDelegatedAdminResourceRightsArgs {
    /**
     * Specifies administrator(s) permissions.
     */
    adminPermissions?: pulumi.Input<pulumi.Input<string>[]>;
