...
export class DefaultUncachedEntryCriteria extends pulumi.CustomResource {
    /**
     * Get an existing DefaultUncachedEntryCriteria resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultUncachedEntryCriteriaState, opts?: pulumi.CustomResourceOptions): DefaultUncachedEntryCriteria {
        return new DefaultUncachedEntryCriteria(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultUncachedEntryCriteria:DefaultUncachedEntryCriteria';

    /**
     * Returns true if the given object is an instance of DefaultUncachedEntryCriteria.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultUncachedEntryCriteria {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultUncachedEntryCriteria.__pulumiType;
    }
     ...
     */
    public readonly accessTimeThreshold!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultUncachedEntryCriteriaRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultUncachedEntryCriteria resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultUncachedEntryCriteriaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultUncachedEntryCriteriaArgs | DefaultUncachedEntryCriteriaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultUncachedEntryCriteriaState | undefined;
            ...
            const args = argsOrState as DefaultUncachedEntryCriteriaArgs | undefined;
        ...
        super(DefaultUncachedEntryCriteria.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultUncachedEntryCriteria resources.
 */
export interface DefaultUncachedEntryCriteriaState {
    /**
     * Specifies the maximum length of time that has passed since an entry was last accessed that it should still be included
     * in the id2entry database. Entries that have not been accessed in more than this length of time may be written into the
     * uncached-id2entry database.
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultUncachedEntryCriteriaRequiredAction>[]>;
    /**
     * The set of arguments used to customize the behavior for the Scripted Uncached Entry Criteria. Each configuration
     * property should be given in the form 'name=value'.
     */
...
/**
 * The set of arguments for constructing a DefaultUncachedEntryCriteria resource.
 */
export interface DefaultUncachedEntryCriteriaArgs {
    /**
     * Specifies the maximum length of time that has passed since an entry was last accessed that it should still be included
     * in the id2entry database. Entries that have not been accessed in more than this length of time may be written into the
     * uncached-id2entry database.
