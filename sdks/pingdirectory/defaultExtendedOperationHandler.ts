...
export class DefaultExtendedOperationHandler extends pulumi.CustomResource {
    /**
     * Get an existing DefaultExtendedOperationHandler resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultExtendedOperationHandlerState, opts?: pulumi.CustomResourceOptions): DefaultExtendedOperationHandler {
        return new DefaultExtendedOperationHandler(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultExtendedOperationHandler:DefaultExtendedOperationHandler';

    /**
     * Returns true if the given object is an instance of DefaultExtendedOperationHandler.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultExtendedOperationHandler {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultExtendedOperationHandler.__pulumiType;
    }
    ...
    /**
     * The default password generator that will be used if the selected password policy is not configured with a password
     * generator.
     */
    public readonly defaultPasswordGenerator!: pulumi.Output<string>;
    /**
     * The default password policy that should be used when generating and validating passwords if the request does not specify
     * an alternate policy. If this is not provided, then this Generate Password Extended Operation Handler will use the
     * default password policy defined in the global configuration.
     */
     ...
     */
    public readonly maximumPasswordsPerRequest!: pulumi.Output<number>;
    /**
     * The maximum number of attempts that the server may use to generate a password that passes validation.
     */
    public readonly maximumValidationAttemptsPerPassword!: pulumi.Output<number>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultExtendedOperationHandlerRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultExtendedOperationHandler resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultExtendedOperationHandlerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultExtendedOperationHandlerArgs | DefaultExtendedOperationHandlerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultExtendedOperationHandlerState | undefined;
            ...
            resourceInputs["defaultPasswordGenerator"] = state ? state.defaultPasswordGenerator : undefined;
            ...
            resourceInputs["maximumPasswordsPerRequest"] = state ? state.maximumPasswordsPerRequest : undefined;
            resourceInputs["maximumValidationAttemptsPerPassword"] = state ? state.maximumValidationAttemptsPerPassword : undefined;
            ...
            const args = argsOrState as DefaultExtendedOperationHandlerArgs | undefined;
            ...
            resourceInputs["defaultPasswordGenerator"] = args ? args.defaultPasswordGenerator : undefined;
            ...
            resourceInputs["maximumPasswordsPerRequest"] = args ? args.maximumPasswordsPerRequest : undefined;
            resourceInputs["maximumValidationAttemptsPerPassword"] = args ? args.maximumValidationAttemptsPerPassword : undefined;
        ...
        super(DefaultExtendedOperationHandler.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultExtendedOperationHandler resources.
 */
export interface DefaultExtendedOperationHandlerState {
    /**
     * The number of adjacent time intervals (both before and after the current time) that should be checked when performing
     * authentication.
     */
     ...
     * generator.
     */
    defaultPasswordGenerator?: pulumi.Input<string>;
    /**
     * The default password policy that should be used when generating and validating passwords if the request does not specify
     * an alternate policy. If this is not provided, then this Generate Password Extended Operation Handler will use the
     * default password policy defined in the global configuration.
     ...
     * The maximum number of passwords that may be generated and returned to the client for a single request.
     */
    maximumPasswordsPerRequest?: pulumi.Input<number>;
    /**
     * The maximum number of attempts that the server may use to generate a password that passes validation.
     */
    maximumValidationAttemptsPerPassword?: pulumi.Input<number>;
    /**
     * Name of this config object.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultExtendedOperationHandlerRequiredAction>[]>;
    /**
     * The name or OID of the attribute that will be used to hold the shared secret key used during TOTP processing.
     */
...
/**
 * The set of arguments for constructing a DefaultExtendedOperationHandler resource.
 */
export interface DefaultExtendedOperationHandlerArgs {
    /**
     * The number of adjacent time intervals (both before and after the current time) that should be checked when performing
     * authentication.
     */
