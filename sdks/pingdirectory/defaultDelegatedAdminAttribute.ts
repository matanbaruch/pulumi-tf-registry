...
export class DefaultDelegatedAdminAttribute extends pulumi.CustomResource {
    /**
     * Get an existing DefaultDelegatedAdminAttribute resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultDelegatedAdminAttributeState, opts?: pulumi.CustomResourceOptions): DefaultDelegatedAdminAttribute {
        return new DefaultDelegatedAdminAttribute(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultDelegatedAdminAttribute:DefaultDelegatedAdminAttribute';

    /**
     * Returns true if the given object is an instance of DefaultDelegatedAdminAttribute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultDelegatedAdminAttribute {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultDelegatedAdminAttribute.__pulumiType;
    }
     ...
     */
    public readonly attributeCategory!: pulumi.Output<string>;
    /**
     * Indicates how the attribute is presented to the user of the app.
     */
    public readonly attributePresentation!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly referenceResourceType!: pulumi.Output<string>;
    /**
     * Required actions returned by the PingDirectory Configuration API.
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultDelegatedAdminAttributeRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultDelegatedAdminAttribute resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DefaultDelegatedAdminAttributeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultDelegatedAdminAttributeArgs | DefaultDelegatedAdminAttributeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultDelegatedAdminAttributeState | undefined;
            ...
            const args = argsOrState as DefaultDelegatedAdminAttributeArgs | undefined;
        ...
        super(DefaultDelegatedAdminAttribute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultDelegatedAdminAttribute resources.
 */
export interface DefaultDelegatedAdminAttributeState {
    /**
     * The list of file types allowed to be uploaded. If no types are specified, then all types will be allowed.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultDelegatedAdminAttributeRequiredAction>[]>;
    /**
     * Name of the parent REST Resource Type
     */
...
/**
 * The set of arguments for constructing a DefaultDelegatedAdminAttribute resource.
 */
export interface DefaultDelegatedAdminAttributeArgs {
    /**
     * The list of file types allowed to be uploaded. If no types are specified, then all types will be allowed.
     */
    allowedMimeTypes?: pulumi.Input<pulumi.Input<string>[]>;
