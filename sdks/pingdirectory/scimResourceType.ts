...
export class ScimResourceType extends pulumi.CustomResource {
    /**
     * Get an existing ScimResourceType resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScimResourceTypeState, opts?: pulumi.CustomResourceOptions): ScimResourceType {
        return new ScimResourceType(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/scimResourceType:ScimResourceType';

    /**
     * Returns true if the given object is an instance of ScimResourceType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ScimResourceType {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ScimResourceType.__pulumiType;
    }
     ...
     * SCIM Resource Type.
     */
    public readonly coreSchema!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly includeBaseDn!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.ScimResourceTypeRequiredAction[]>;
    /**
     ...
     */
    public readonly structuralLdapObjectclass!: pulumi.Output<string | undefined>;
    /**
    ...
    /**
     * Create a ScimResourceType resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ScimResourceTypeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ScimResourceTypeArgs | ScimResourceTypeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ScimResourceTypeState | undefined;
            ...
            const args = argsOrState as ScimResourceTypeArgs | undefined;
        ...
        super(ScimResourceType.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ScimResourceType resources.
 */
export interface ScimResourceTypeState {
    /**
     * Specifies an auxiliary LDAP object class that should be exposed by this SCIM Resource Type.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.ScimResourceTypeRequiredAction>[]>;
    /**
     * Required additive schemas that are enforced on extension attributes in a SCIM resource representation for this Mapping
     * SCIM Resource Type.
     */
...
/**
 * The set of arguments for constructing a ScimResourceType resource.
 */
export interface ScimResourceTypeArgs {
    /**
     * Specifies an auxiliary LDAP object class that should be exposed by this SCIM Resource Type.
     */
    auxiliaryLdapObjectclasses?: pulumi.Input<pulumi.Input<string>[]>;
