...
export class DefaultLocalDbCompositeIndex extends pulumi.CustomResource {
    /**
     * Get an existing DefaultLocalDbCompositeIndex resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultLocalDbCompositeIndexState, opts?: pulumi.CustomResourceOptions): DefaultLocalDbCompositeIndex {
        return new DefaultLocalDbCompositeIndex(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultLocalDbCompositeIndex:DefaultLocalDbCompositeIndex';

    /**
     * Returns true if the given object is an instance of DefaultLocalDbCompositeIndex.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultLocalDbCompositeIndex {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultLocalDbCompositeIndex.__pulumiType;
    }
     ...
     */
    public readonly indexBaseDnPattern!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultLocalDbCompositeIndexRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultLocalDbCompositeIndex resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DefaultLocalDbCompositeIndexArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultLocalDbCompositeIndexArgs | DefaultLocalDbCompositeIndexState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultLocalDbCompositeIndexState | undefined;
            ...
            const args = argsOrState as DefaultLocalDbCompositeIndexArgs | undefined;
        ...
        super(DefaultLocalDbCompositeIndex.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultLocalDbCompositeIndex resources.
 */
export interface DefaultLocalDbCompositeIndexState {
    /**
     * Name of the parent Backend
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultLocalDbCompositeIndexRequiredAction>[]>;
    /**
     * The type of Local DB Composite Index resource. Options are ['local-db-composite-index']
     */
...
/**
 * The set of arguments for constructing a DefaultLocalDbCompositeIndex resource.
 */
export interface DefaultLocalDbCompositeIndexArgs {
    /**
     * Name of the parent Backend
     */
    backendName: pulumi.Input<string>;
