...
export class AccountStatusNotificationHandler extends pulumi.CustomResource {
    /**
     * Get an existing AccountStatusNotificationHandler resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountStatusNotificationHandlerState, opts?: pulumi.CustomResourceOptions): AccountStatusNotificationHandler {
        return new AccountStatusNotificationHandler(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/accountStatusNotificationHandler:AccountStatusNotificationHandler';

    /**
     * Returns true if the given object is an instance of AccountStatusNotificationHandler.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccountStatusNotificationHandler {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccountStatusNotificationHandler.__pulumiType;
    }
     ...
     */
    public readonly accountAuthenticatedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountAuthenticationNotificationResultCriteria!: pulumi.Output<string | undefined>;
    /**
     ...
     * property.
     */
    public readonly accountCreatedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * A request criteria object that identifies which add requests should result in account creation notifications for this
     * handler.
     */
    public readonly accountCreationNotificationRequestCriteria!: pulumi.Output<string | undefined>;
    /**
     * Supported in PingDirectory product version 9.3.0.0+. The path to a file containing the template to use to generate the
     ...
     */
    public readonly accountDeletedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountDeletionNotificationRequestCriteria!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountDisabledMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * The path to a file containing the template to use to generate the email message to send in the event that a user's
     * account is enabled by an administrator.
     */
    public readonly accountEnabledMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountExpiredMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountIdleLockedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * The path to a file containing the template to use to generate the email message to send in the event that an
     * authentication attempt fails because the account has an activation time that is in the future.
     */
    public readonly accountNotYetActiveMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountPermanentlyFailureLockedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * The path to a file containing the template to use to generate the email message to send in the event that authentication
     * attempt fails because the user failed to choose a new password in a timely manner after an administrative reset.
     */
    public readonly accountResetLockedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountTemporarilyFailureLockedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * The path to a file containing the template to use to generate the email message to send in the event that a user's
     * account has been unlocked (e.g., by an administrative password reset).
     */
    public readonly accountUnlockedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountUpdateNotificationRequestCriteria!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly accountUpdatedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly bindPasswordFailedValidationMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly mustChangePasswordMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     * their own password.
     */
    public readonly passwordChangedMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * The path to a file containing the template to use to generate the email message to send in the event that an
     * authentication attempt fails because the account has an expired password.
     */
    public readonly passwordExpiredMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * The path to a file containing the template to use to generate the email message to send in the event that an
     ...
     * expiration.
     */
    public readonly passwordExpiringMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     * The path to a file containing the template to use to generate the email message to send in the event that a user's
     * password has been reset by an administrator.
     */
    public readonly passwordResetMessageTemplate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.AccountStatusNotificationHandlerRequiredAction[]>;
    /**
    ...
    /**
     * Create a AccountStatusNotificationHandler resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AccountStatusNotificationHandlerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccountStatusNotificationHandlerArgs | AccountStatusNotificationHandlerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccountStatusNotificationHandlerState | undefined;
            ...
            const args = argsOrState as AccountStatusNotificationHandlerArgs | undefined;
        ...
        super(AccountStatusNotificationHandler.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AccountStatusNotificationHandler resources.
 */
export interface AccountStatusNotificationHandlerState {
    /**
     * Supported in PingDirectory product version 9.3.0.0+. The path to a file containing the template to use to generate the
     * email message to send in the event that an account has successfully authenticated in a bind operation that matches the
     * criteria provided in the account-authentication-notification-request-criteria property.
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.AccountStatusNotificationHandlerRequiredAction>[]>;
    /**
     * The set of arguments used to customize the behavior for the Scripted Account Status Notification Handler. Each
     * configuration property should be given in the form 'name=value'.
     */
...
/**
 * The set of arguments for constructing a AccountStatusNotificationHandler resource.
 */
export interface AccountStatusNotificationHandlerArgs {
    /**
     * Supported in PingDirectory product version 9.3.0.0+. The path to a file containing the template to use to generate the
     * email message to send in the event that an account has successfully authenticated in a bind operation that matches the
     * criteria provided in the account-authentication-notification-request-criteria property.
