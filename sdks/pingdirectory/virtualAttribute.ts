...
export class VirtualAttribute extends pulumi.CustomResource {
    /**
     * Get an existing VirtualAttribute resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualAttributeState, opts?: pulumi.CustomResourceOptions): VirtualAttribute {
        return new VirtualAttribute(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/virtualAttribute:VirtualAttribute';

    /**
     * Returns true if the given object is an instance of VirtualAttribute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualAttribute {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualAttribute.__pulumiType;
    }
     ...
     */
    public readonly includedGroupFilter!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly joinBaseDnType!: pulumi.Output<string | undefined>;
    /**
     * The fixed, administrator-specified base DN for the internal searches used to identify joined entries.
     */
    public readonly joinCustomBaseDn!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly joinDnAttribute!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly joinFilter!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly joinSourceAttribute!: pulumi.Output<string | undefined>;
    /**
     * The attribute in target entries whose value(s) match values of the source attribute in the source entry.
     */
    public readonly joinTargetAttribute!: pulumi.Output<string | undefined>;
    /**
     * Specifies the order in which virtual attribute definitions for the same attribute type will be evaluated when generating
     * values for an entry.
     */
    public readonly multipleVirtualAttributeEvaluationOrderIndex!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.VirtualAttributeRequiredAction[]>;
    /**
     ...
     */
    public readonly sourceAttribute!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly sourceEntryDnAttribute!: pulumi.Output<string | undefined>;
    /**
     * Specifies a DN map that will be used to identify the entry from which to obtain the source attribute providing the
     * values for this virtual attribute.
     */
    public readonly sourceEntryDnMap!: pulumi.Output<string | undefined>;
    /**
    ...
    /**
     * Create a VirtualAttribute resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualAttributeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualAttributeArgs | VirtualAttributeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualAttributeState | undefined;
            ...
            const args = argsOrState as VirtualAttributeArgs | undefined;
        ...
        super(VirtualAttribute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VirtualAttribute resources.
 */
export interface VirtualAttributeState {
    /**
     * Indicates whether the server should allow creating or altering this virtual attribute definition even if it conflicts
     * with one or more indexes defined in the server.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.VirtualAttributeRequiredAction>[]>;
    /**
     * Search filters that include Is Member Of Virtual Attribute searches on dynamic groups can be updated to include the
     * dynamic group filter in the search filter itself. This can allow the backend to more efficiently process the search
     * filter by using attribute indexes sooner in the search processing.
...
/**
 * The set of arguments for constructing a VirtualAttribute resource.
 */
export interface VirtualAttributeArgs {
    /**
     * Indicates whether the server should allow creating or altering this virtual attribute definition even if it conflicts
     * with one or more indexes defined in the server.
     */
