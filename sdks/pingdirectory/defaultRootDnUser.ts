...
export class DefaultRootDnUser extends pulumi.CustomResource {
    /**
     * Get an existing DefaultRootDnUser resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultRootDnUserState, opts?: pulumi.CustomResourceOptions): DefaultRootDnUser {
        return new DefaultRootDnUser(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultRootDnUser:DefaultRootDnUser';

    /**
     * Returns true if the given object is an instance of DefaultRootDnUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultRootDnUser {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultRootDnUser.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultRootDnUserRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultRootDnUser resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultRootDnUserArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultRootDnUserArgs | DefaultRootDnUserState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultRootDnUserState | undefined;
            ...
            const args = argsOrState as DefaultRootDnUserArgs | undefined;
        ...
        super(DefaultRootDnUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultRootDnUser resources.
 */
export interface DefaultRootDnUserState {
    /**
     * Specifies the time, in generalized time format (e.g., '20160101070000Z'), that the root user account should become
     * active. If an activation time is specified, the user will not be permitted to authenticate, nor can the account be used
     * as an authorization identity, until the activation time has arrived. This is stored in the
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultRootDnUserRequiredAction>[]>;
    /**
     * Specifies the maximum number of entries that the server may return to the user in response to any single search request.
     * A value of 0 indicates no limit should be enforced. This is stored in the ds-rlim-size-limit LDAP attribute.
     */
...
/**
 * The set of arguments for constructing a DefaultRootDnUser resource.
 */
export interface DefaultRootDnUserArgs {
    /**
     * Specifies the time, in generalized time format (e.g., '20160101070000Z'), that the root user account should become
     * active. If an activation time is specified, the user will not be permitted to authenticate, nor can the account be used
     * as an authorization identity, until the activation time has arrived. This is stored in the
