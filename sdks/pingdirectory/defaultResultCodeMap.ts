...
export class DefaultResultCodeMap extends pulumi.CustomResource {
    /**
     * Get an existing DefaultResultCodeMap resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultResultCodeMapState, opts?: pulumi.CustomResourceOptions): DefaultResultCodeMap {
        return new DefaultResultCodeMap(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultResultCodeMap:DefaultResultCodeMap';

    /**
     * Returns true if the given object is an instance of DefaultResultCodeMap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultResultCodeMap {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultResultCodeMap.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultResultCodeMapRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultResultCodeMap resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultResultCodeMapArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultResultCodeMapArgs | DefaultResultCodeMapState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultResultCodeMapState | undefined;
            ...
            const args = argsOrState as DefaultResultCodeMapArgs | undefined;
        ...
        super(DefaultResultCodeMap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultResultCodeMap resources.
 */
export interface DefaultResultCodeMapState {
    /**
     * Specifies the result code that should be returned if a bind attempt fails because the user's account is locked as a
     * result of too many failed authentication attempts.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultResultCodeMapRequiredAction>[]>;
    /**
     * Specifies the result code that should be returned if a generic error occurs within the server.
     */
...
/**
 * The set of arguments for constructing a DefaultResultCodeMap resource.
 */
export interface DefaultResultCodeMapArgs {
    /**
     * Specifies the result code that should be returned if a bind attempt fails because the user's account is locked as a
     * result of too many failed authentication attempts.
     */
