...
export class PassphraseProvider extends pulumi.CustomResource {
    /**
     * Get an existing PassphraseProvider resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PassphraseProviderState, opts?: pulumi.CustomResourceOptions): PassphraseProvider {
        return new PassphraseProvider(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/passphraseProvider:PassphraseProvider';

    /**
     * Returns true if the given object is an instance of PassphraseProvider.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PassphraseProvider {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PassphraseProvider.__pulumiType;
    }
     ...
     */
    public readonly environmentVariable!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly obscuredValue!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.PassphraseProviderRequiredAction[]>;
    /**
    ...
    /**
     * Create a PassphraseProvider resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PassphraseProviderArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PassphraseProviderArgs | PassphraseProviderState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PassphraseProviderState | undefined;
            ...
            const args = argsOrState as PassphraseProviderArgs | undefined;
        ...
        super(PassphraseProvider.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PassphraseProvider resources.
 */
export interface PassphraseProviderState {
    /**
     * The external server with information to use when interacting with the AWS Secrets Manager.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.PassphraseProviderRequiredAction>[]>;
    /**
     * The name of the JSON field whose value is the passphrase that will be retrieved.
     */
...
/**
 * The set of arguments for constructing a PassphraseProvider resource.
 */
export interface PassphraseProviderArgs {
    /**
     * The external server with information to use when interacting with the AWS Secrets Manager.
     */
    awsExternalServer?: pulumi.Input<string>;
