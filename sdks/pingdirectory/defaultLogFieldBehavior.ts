...
export class DefaultLogFieldBehavior extends pulumi.CustomResource {
    /**
     * Get an existing DefaultLogFieldBehavior resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultLogFieldBehaviorState, opts?: pulumi.CustomResourceOptions): DefaultLogFieldBehavior {
        return new DefaultLogFieldBehavior(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultLogFieldBehavior:DefaultLogFieldBehavior';

    /**
     * Returns true if the given object is an instance of DefaultLogFieldBehavior.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultLogFieldBehavior {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultLogFieldBehavior.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultLogFieldBehaviorRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultLogFieldBehavior resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultLogFieldBehaviorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultLogFieldBehaviorArgs | DefaultLogFieldBehaviorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultLogFieldBehaviorState | undefined;
            ...
            const args = argsOrState as DefaultLogFieldBehaviorArgs | undefined;
        ...
        super(DefaultLogFieldBehavior.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultLogFieldBehavior resources.
 */
export interface DefaultLogFieldBehaviorState {
    /**
     * The default behavior that the server should exhibit for fields for which no explicit behavior is defined. If no default
     * behavior is defined, the server will fall back to using the default behavior configured for the syntax used for each log
     * field.
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultLogFieldBehaviorRequiredAction>[]>;
    /**
     * The names of any custom fields whose values should be completely tokenized. This should generally only be used for
     * fields that are not available through the tokenize-entire-value-field property (for example, custom log fields defined
     * in Server SDK extensions).
...
/**
 * The set of arguments for constructing a DefaultLogFieldBehavior resource.
 */
export interface DefaultLogFieldBehaviorArgs {
    /**
     * The default behavior that the server should exhibit for fields for which no explicit behavior is defined. If no default
     * behavior is defined, the server will fall back to using the default behavior configured for the syntax used for each log
     * field.
