...
export class DefaultAlertHandler extends pulumi.CustomResource {
    /**
     * Get an existing DefaultAlertHandler resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultAlertHandlerState, opts?: pulumi.CustomResourceOptions): DefaultAlertHandler {
        return new DefaultAlertHandler(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultAlertHandler:DefaultAlertHandler';

    /**
     * Returns true if the given object is an instance of DefaultAlertHandler.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultAlertHandler {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultAlertHandler.__pulumiType;
    }
     ...
     */
    public readonly includeMonitorDataFilter!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultAlertHandlerRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultAlertHandler resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultAlertHandlerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultAlertHandlerArgs | DefaultAlertHandlerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultAlertHandlerState | undefined;
            ...
            const args = argsOrState as DefaultAlertHandlerArgs | undefined;
        ...
        super(DefaultAlertHandler.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultAlertHandler resources.
 */
export interface DefaultAlertHandlerState {
    /**
     * When the `type` attribute is set to: - One of [`output`, `groovy-scripted`, `custom`, `error-log`, `third-party`]:
     * Indicates whether the server should attempt to invoke this Alert Handler in a background thread so that any
     * potentially-expensive processing (e.g., performing network communication to deliver the alert notification) will not
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultAlertHandlerRequiredAction>[]>;
    /**
     * The set of arguments used to customize the behavior for the Scripted Alert Handler. Each configuration property should
     * be given in the form 'name=value'.
     */
...
/**
 * The set of arguments for constructing a DefaultAlertHandler resource.
 */
export interface DefaultAlertHandlerArgs {
    /**
     * When the `type` attribute is set to: - One of [`output`, `groovy-scripted`, `custom`, `error-log`, `third-party`]:
     * Indicates whether the server should attempt to invoke this Alert Handler in a background thread so that any
     * potentially-expensive processing (e.g., performing network communication to deliver the alert notification) will not
