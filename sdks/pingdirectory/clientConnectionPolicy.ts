...
export class ClientConnectionPolicy extends pulumi.CustomResource {
    /**
     * Get an existing ClientConnectionPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClientConnectionPolicyState, opts?: pulumi.CustomResourceOptions): ClientConnectionPolicy {
        return new ClientConnectionPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/clientConnectionPolicy:ClientConnectionPolicy';

    /**
     * Returns true if the given object is an instance of ClientConnectionPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClientConnectionPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClientConnectionPolicy.__pulumiType;
    }
     ...
     * rejected.
     */
    public readonly prohibitedOperationRequestCriteria!: pulumi.Output<string | undefined>;
    /**
     * Required actions returned by the PingDirectory Configuration API.
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.ClientConnectionPolicyRequiredAction[]>;
    /**
     ...
     */
    public readonly requiredOperationRequestCriteria!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly resultCodeMap!: pulumi.Output<string | undefined>;
    /**
    ...
    /**
     * Create a ClientConnectionPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClientConnectionPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClientConnectionPolicyArgs | ClientConnectionPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClientConnectionPolicyState | undefined;
            ...
            const args = argsOrState as ClientConnectionPolicyArgs | undefined;
        ...
        super(ClientConnectionPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClientConnectionPolicy resources.
 */
export interface ClientConnectionPolicyState {
    /**
     * Indicates whether clients will be allowed to request search operations that cannot be efficiently processed using the
     * set of indexes defined in the corresponding backend. Note that even if this is false, some clients may be able to
     * request unindexed searches if the allow-unindexed-searches-with-control property has a value of true and the necessary
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.ClientConnectionPolicyRequiredAction>[]>;
    /**
     * Specifies a request criteria object that will be required to match all requests submitted by clients associated with
     * this Client Connection Policy. If a client submits a request that does not satisfy this request criteria object, then
     * that request will be rejected.
...
/**
 * The set of arguments for constructing a ClientConnectionPolicy resource.
 */
export interface ClientConnectionPolicyArgs {
    /**
     * Indicates whether clients will be allowed to request search operations that cannot be efficiently processed using the
     * set of indexes defined in the corresponding backend. Note that even if this is false, some clients may be able to
     * request unindexed searches if the allow-unindexed-searches-with-control property has a value of true and the necessary
