...
export class RecurringTaskChain extends pulumi.CustomResource {
    /**
     * Get an existing RecurringTaskChain resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RecurringTaskChainState, opts?: pulumi.CustomResourceOptions): RecurringTaskChain {
        return new RecurringTaskChain(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/recurringTaskChain:RecurringTaskChain';

    /**
     * Returns true if the given object is an instance of RecurringTaskChain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RecurringTaskChain {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RecurringTaskChain.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.RecurringTaskChainRequiredAction[]>;
    /**
    ...
    /**
     * Create a RecurringTaskChain resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RecurringTaskChainArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RecurringTaskChainArgs | RecurringTaskChainState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RecurringTaskChainState | undefined;
            ...
            const args = argsOrState as RecurringTaskChainArgs | undefined;
            if ((!args || args.recurringTasks === undefined) && !opts.urn) {
                throw new Error("Missing required property 'recurringTasks'");
            }
            if ((!args || args.scheduledDateSelectionType === undefined) && !opts.urn) {
                throw new Error("Missing required property 'scheduledDateSelectionType'");
            }
            if ((!args || args.scheduledTimeOfDays === undefined) && !opts.urn) {
                throw new Error("Missing required property 'scheduledTimeOfDays'");
            }
        ...
        super(RecurringTaskChain.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RecurringTaskChain resources.
 */
export interface RecurringTaskChainState {
    /**
     * A description for this Recurring Task Chain
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.RecurringTaskChainRequiredAction>[]>;
    /**
     * The mechanism used to determine the dates on which instances of this Recurring Task Chain may be scheduled to start.
     */
...
/**
 * The set of arguments for constructing a RecurringTaskChain resource.
 */
export interface RecurringTaskChainArgs {
    /**
     * A description for this Recurring Task Chain
     */
    description?: pulumi.Input<string>;
