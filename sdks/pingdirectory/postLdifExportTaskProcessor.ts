...
export class PostLdifExportTaskProcessor extends pulumi.CustomResource {
    /**
     * Get an existing PostLdifExportTaskProcessor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostLdifExportTaskProcessorState, opts?: pulumi.CustomResourceOptions): PostLdifExportTaskProcessor {
        return new PostLdifExportTaskProcessor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/postLdifExportTaskProcessor:PostLdifExportTaskProcessor';

    /**
     * Returns true if the given object is an instance of PostLdifExportTaskProcessor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PostLdifExportTaskProcessor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PostLdifExportTaskProcessor.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.PostLdifExportTaskProcessorRequiredAction[]>;
    /**
    ...
    /**
     * Create a PostLdifExportTaskProcessor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PostLdifExportTaskProcessorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PostLdifExportTaskProcessorArgs | PostLdifExportTaskProcessorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PostLdifExportTaskProcessorState | undefined;
            ...
            const args = argsOrState as PostLdifExportTaskProcessorArgs | undefined;
        ...
        super(PostLdifExportTaskProcessor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PostLdifExportTaskProcessor resources.
 */
export interface PostLdifExportTaskProcessorState {
    /**
     * The external server with information to use when interacting with the AWS S3 service.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.PostLdifExportTaskProcessorRequiredAction>[]>;
    /**
     * The name of the S3 bucket into which LDIF files should be copied.
     */
...
/**
 * The set of arguments for constructing a PostLdifExportTaskProcessor resource.
 */
export interface PostLdifExportTaskProcessorArgs {
    /**
     * The external server with information to use when interacting with the AWS S3 service.
     */
    awsExternalServer?: pulumi.Input<string>;
