...
export class RootDnUser extends pulumi.CustomResource {
    /**
     * Get an existing RootDnUser resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RootDnUserState, opts?: pulumi.CustomResourceOptions): RootDnUser {
        return new RootDnUser(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/rootDnUser:RootDnUser';

    /**
     * Returns true if the given object is an instance of RootDnUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RootDnUser {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RootDnUser.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.RootDnUserRequiredAction[]>;
    /**
    ...
    /**
     * Create a RootDnUser resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: RootDnUserArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RootDnUserArgs | RootDnUserState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RootDnUserState | undefined;
            ...
            const args = argsOrState as RootDnUserArgs | undefined;
        ...
        super(RootDnUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RootDnUser resources.
 */
export interface RootDnUserState {
    /**
     * Specifies the time, in generalized time format (e.g., '20160101070000Z'), that the root user account should become
     * active. If an activation time is specified, the user will not be permitted to authenticate, nor can the account be used
     * as an authorization identity, until the activation time has arrived. This is stored in the
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.RootDnUserRequiredAction>[]>;
    /**
     * Specifies the maximum number of entries that the server may return to the user in response to any single search request.
     * A value of 0 indicates no limit should be enforced. This is stored in the ds-rlim-size-limit LDAP attribute.
     */
...
/**
 * The set of arguments for constructing a RootDnUser resource.
 */
export interface RootDnUserArgs {
    /**
     * Specifies the time, in generalized time format (e.g., '20160101070000Z'), that the root user account should become
     * active. If an activation time is specified, the user will not be permitted to authenticate, nor can the account be used
     * as an authorization identity, until the activation time has arrived. This is stored in the
