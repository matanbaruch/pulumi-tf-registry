...
export class DefaultJsonFieldConstraints extends pulumi.CustomResource {
    /**
     * Get an existing DefaultJsonFieldConstraints resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultJsonFieldConstraintsState, opts?: pulumi.CustomResourceOptions): DefaultJsonFieldConstraints {
        return new DefaultJsonFieldConstraints(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultJsonFieldConstraints:DefaultJsonFieldConstraints';

    /**
     * Returns true if the given object is an instance of DefaultJsonFieldConstraints.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultJsonFieldConstraints {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultJsonFieldConstraints.__pulumiType;
    }
     ...
     * numeric value.
     */
    public readonly maximumNumericValue!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly maximumValueCount!: pulumi.Output<number>;
    /**
     ...
     */
    public readonly maximumValueLength!: pulumi.Output<number>;
    /**
     ...
     * value.
     */
    public readonly minimumNumericValue!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly minimumValueCount!: pulumi.Output<number>;
    /**
     ...
     */
    public readonly minimumValueLength!: pulumi.Output<number>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultJsonFieldConstraintsRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultJsonFieldConstraints resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DefaultJsonFieldConstraintsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultJsonFieldConstraintsArgs | DefaultJsonFieldConstraintsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultJsonFieldConstraintsState | undefined;
            ...
            const args = argsOrState as DefaultJsonFieldConstraintsArgs | undefined;
        ...
        super(DefaultJsonFieldConstraints.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultJsonFieldConstraints resources.
 */
export interface DefaultJsonFieldConstraintsState {
    /**
     * Indicates whether the target field may have a value that is an empty JSON object (i.e., a JSON object with zero fields).
     * This may only be set to true if value-type property is set to object.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultJsonFieldConstraintsRequiredAction>[]>;
    /**
     * Indicates whether the backend should attempt to assign a compact token for each distinct value for the target field in
     * an attempt to reduce the encoded size of the field in JSON objects. These tokens would be assigned prior to using any
     * from the token set used for automatic compaction of some JSON string values.
...
/**
 * The set of arguments for constructing a DefaultJsonFieldConstraints resource.
 */
export interface DefaultJsonFieldConstraintsArgs {
    /**
     * Indicates whether the target field may have a value that is an empty JSON object (i.e., a JSON object with zero fields).
     * This may only be set to true if value-type property is set to object.
     */
