...
export class PasswordValidator extends pulumi.CustomResource {
    /**
     * Get an existing PasswordValidator resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PasswordValidatorState, opts?: pulumi.CustomResourceOptions): PasswordValidator {
        return new PasswordValidator(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/passwordValidator:PasswordValidator';

    /**
     * Returns true if the given object is an instance of PasswordValidator.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PasswordValidator {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PasswordValidator.__pulumiType;
    }
     ...
     */
    public readonly disallowedCharacters!: pulumi.Output<string | undefined>;
    /**
     * A set of characters that will not be allowed as the first character of the password.
     */
    public readonly disallowedLeadingCharacters!: pulumi.Output<string | undefined>;
    /**
     * A set of characters that will not be allowed as the last character of the password.
     */
    public readonly disallowedTrailingCharacters!: pulumi.Output<string | undefined>;
    /**
     ...
     * property.
     */
    public readonly matchBehavior!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly maxConsecutiveLength!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public readonly minPasswordDifference!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.PasswordValidatorRequiredAction[]>;
    /**
     ...
     */
    public readonly trustManagerProvider!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly validatorFailureMessage!: pulumi.Output<string | undefined>;
    /**
     ...
     * validator.
     */
    public readonly validatorRequirementDescription!: pulumi.Output<string | undefined>;

    /**
     * Create a PasswordValidator resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PasswordValidatorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PasswordValidatorArgs | PasswordValidatorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PasswordValidatorState | undefined;
            ...
            const args = argsOrState as PasswordValidatorArgs | undefined;
        ...
        super(PasswordValidator.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PasswordValidator resources.
 */
export interface PasswordValidatorState {
    /**
     * Indicates whether to accept the proposed password if an error occurs while attempting to interact with the Pwned
     * Passwords service.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.PasswordValidatorRequiredAction>[]>;
    /**
     * The set of arguments used to customize the behavior for the Scripted Password Validator. Each configuration property
     * should be given in the form 'name=value'.
     */
...
/**
 * The set of arguments for constructing a PasswordValidator resource.
 */
export interface PasswordValidatorArgs {
    /**
     * Indicates whether to accept the proposed password if an error occurs while attempting to interact with the Pwned
     * Passwords service.
     */
