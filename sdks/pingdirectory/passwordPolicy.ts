...
export class PasswordPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/passwordPolicy:PasswordPolicy';
     ...
     */
    public readonly failureLockoutAction!: pulumi.Output<string | undefined>;
    /**
     ...
     * last authenticated.
     */
    public readonly lastLoginIpAddressAttribute!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly lastLoginTimeFormat!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly maximumRecentLoginHistoryFailedAuthenticationCount!: pulumi.Output<number | undefined>;
    /**
     * The maximum age of failed authentication attempts to include in the recent login history for each account.
     */
    public readonly maximumRecentLoginHistoryFailedAuthenticationDuration!: pulumi.Output<string | undefined>;
    /**
     * The maximum number of successful authentication attempts to include in the recent login history for each account.
     */
    public readonly maximumRecentLoginHistorySuccessfulAuthenticationCount!: pulumi.Output<number | undefined>;
    /**
     * The maximum age of successful authentication attempts to include in the recent login history for each account.
     */
    public readonly maximumRecentLoginHistorySuccessfulAuthenticationDuration!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly requireChangeByTime!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.PasswordPolicyRequiredAction[]>;
    /**
    ...
    constructor(name: string, argsOrState?: PasswordPolicyArgs | PasswordPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.defaultPasswordStorageSchemes === undefined) && !opts.urn) {
                throw new Error("Missing required property 'defaultPasswordStorageSchemes'");
            }
            if ((!args || args.passwordAttribute === undefined) && !opts.urn) {
                throw new Error("Missing required property 'passwordAttribute'");
            }
...
export interface PasswordPolicyState {
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.PasswordPolicyRequiredAction>[]>;
    /**
     * Indicates whether the server should return the password expiring and password expired response controls (as described in
     * draft-vchu-ldap-pwd-policy).
     */
