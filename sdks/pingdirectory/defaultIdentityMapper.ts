...
export class DefaultIdentityMapper extends pulumi.CustomResource {
    /**
     * Get an existing DefaultIdentityMapper resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultIdentityMapperState, opts?: pulumi.CustomResourceOptions): DefaultIdentityMapper {
        return new DefaultIdentityMapper(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultIdentityMapper:DefaultIdentityMapper';

    /**
     * Returns true if the given object is an instance of DefaultIdentityMapper.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultIdentityMapper {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultIdentityMapper.__pulumiType;
    }
     ...
     */
    public readonly matchFilter!: pulumi.Output<string>;
    /**
     ...
     * expression pattern.
     */
    public readonly replacePattern!: pulumi.Output<string>;
    /**
     * Required actions returned by the PingDirectory Configuration API.
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultIdentityMapperRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultIdentityMapper resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultIdentityMapperArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultIdentityMapperArgs | DefaultIdentityMapperState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultIdentityMapperState | undefined;
            ...
            const args = argsOrState as DefaultIdentityMapperArgs | undefined;
        ...
        super(DefaultIdentityMapper.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultIdentityMapper resources.
 */
export interface DefaultIdentityMapperState {
    /**
     * The set of identity mappers that must all match the target entry. Each identity mapper must uniquely match the same
     * target entry. If any of the identity mappers match multiple entries, if any of them match zero entries, or if any of
     * them match different entries, then the mapping will fail.
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultIdentityMapperRequiredAction>[]>;
    /**
     * The set of arguments used to customize the behavior for the Scripted Identity Mapper. Each configuration property should
     * be given in the form 'name=value'.
     */
...
/**
 * The set of arguments for constructing a DefaultIdentityMapper resource.
 */
export interface DefaultIdentityMapperArgs {
    /**
     * The set of identity mappers that must all match the target entry. Each identity mapper must uniquely match the same
     * target entry. If any of the identity mappers match multiple entries, if any of them match zero entries, or if any of
     * them match different entries, then the mapping will fail.
