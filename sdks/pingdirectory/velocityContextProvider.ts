...
export class VelocityContextProvider extends pulumi.CustomResource {
    /**
     * Get an existing VelocityContextProvider resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VelocityContextProviderState, opts?: pulumi.CustomResourceOptions): VelocityContextProvider {
        return new VelocityContextProvider(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/velocityContextProvider:VelocityContextProvider';

    /**
     * Returns true if the given object is an instance of VelocityContextProvider.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VelocityContextProvider {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VelocityContextProvider.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.VelocityContextProviderRequiredAction[]>;
    /**
    ...
    /**
     * Create a VelocityContextProvider resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VelocityContextProviderArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VelocityContextProviderArgs | VelocityContextProviderState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VelocityContextProviderState | undefined;
            ...
            const args = argsOrState as VelocityContextProviderArgs | undefined;
        ...
        super(VelocityContextProvider.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VelocityContextProvider resources.
 */
export interface VelocityContextProviderState {
    /**
     * The fully-qualified name of a Velocity Tool class that will be initialized once for the life of the server. May
     * optionally include a path to a properties file used to configure this tool separated from the class name by a semi-colon
     * (;). The path may absolute or relative to the server root.
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.VelocityContextProviderRequiredAction>[]>;
    /**
     * Specifies HTTP header fields and values added to response headers for template page requests to which this Velocity
     * Context Provider contributes content.
     */
...
/**
 * The set of arguments for constructing a VelocityContextProvider resource.
 */
export interface VelocityContextProviderArgs {
    /**
     * The fully-qualified name of a Velocity Tool class that will be initialized once for the life of the server. May
     * optionally include a path to a properties file used to configure this tool separated from the class name by a semi-colon
     * (;). The path may absolute or relative to the server root.
