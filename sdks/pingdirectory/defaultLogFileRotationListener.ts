...
export class DefaultLogFileRotationListener extends pulumi.CustomResource {
    /**
     * Get an existing DefaultLogFileRotationListener resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultLogFileRotationListenerState, opts?: pulumi.CustomResourceOptions): DefaultLogFileRotationListener {
        return new DefaultLogFileRotationListener(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultLogFileRotationListener:DefaultLogFileRotationListener';

    /**
     * Returns true if the given object is an instance of DefaultLogFileRotationListener.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultLogFileRotationListener {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultLogFileRotationListener.__pulumiType;
    }
     ...
     * they are copied.
     */
    public readonly copyToDirectory!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultLogFileRotationListenerRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultLogFileRotationListener resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultLogFileRotationListenerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultLogFileRotationListenerArgs | DefaultLogFileRotationListenerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultLogFileRotationListenerState | undefined;
            ...
            const args = argsOrState as DefaultLogFileRotationListenerArgs | undefined;
        ...
        super(DefaultLogFileRotationListener.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultLogFileRotationListener resources.
 */
export interface DefaultLogFileRotationListenerState {
    /**
     * The external server with information to use when interacting with the AWS S3 service.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultLogFileRotationListenerRequiredAction>[]>;
    /**
     * The name of the S3 bucket into which rotated log files should be copied.
     */
...
/**
 * The set of arguments for constructing a DefaultLogFileRotationListener resource.
 */
export interface DefaultLogFileRotationListenerArgs {
    /**
     * The external server with information to use when interacting with the AWS S3 service.
     */
    awsExternalServer?: pulumi.Input<string>;
