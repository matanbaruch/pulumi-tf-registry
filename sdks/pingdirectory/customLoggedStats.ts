...
export class CustomLoggedStats extends pulumi.CustomResource {
    /**
     * Get an existing CustomLoggedStats resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomLoggedStatsState, opts?: pulumi.CustomResourceOptions): CustomLoggedStats {
        return new CustomLoggedStats(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/customLoggedStats:CustomLoggedStats';

    /**
     * Returns true if the given object is an instance of CustomLoggedStats.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CustomLoggedStats {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CustomLoggedStats.__pulumiType;
    }
     ...
     */
    public readonly divideValueBy!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly headerPrefix!: pulumi.Output<string | undefined>;
    /**
     * An optional attribute from the monitor entry that is included as a prefix before the column name in the column header.
     */
    public readonly headerPrefixAttribute!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly regexReplacement!: pulumi.Output<string | undefined>;
    /**
     * Required actions returned by the PingDirectory Configuration API.
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.CustomLoggedStatsRequiredAction[]>;
    /**
    ...
    /**
     * Create a CustomLoggedStats resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CustomLoggedStatsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CustomLoggedStatsArgs | CustomLoggedStatsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CustomLoggedStatsState | undefined;
            ...
            const args = argsOrState as CustomLoggedStatsArgs | undefined;
            if ((!args || args.attributeToLogs === undefined) && !opts.urn) {
                throw new Error("Missing required property 'attributeToLogs'");
            }
            ...
            if ((!args || args.statisticTypes === undefined) && !opts.urn) {
                throw new Error("Missing required property 'statisticTypes'");
            }
        ...
        super(CustomLoggedStats.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CustomLoggedStats resources.
 */
export interface CustomLoggedStatsState {
    /**
     * Specifies the attributes on the monitor entries that should be included in the output.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.CustomLoggedStatsRequiredAction>[]>;
    /**
     * Specifies the type of statistic to include in the output for each monitored attribute.
     */
...
/**
 * The set of arguments for constructing a CustomLoggedStats resource.
 */
export interface CustomLoggedStatsArgs {
    /**
     * Specifies the attributes on the monitor entries that should be included in the output.
     */
    attributeToLogs: pulumi.Input<pulumi.Input<string>[]>;
