...
export class DefaultOtpDeliveryMechanism extends pulumi.CustomResource {
    /**
     * Get an existing DefaultOtpDeliveryMechanism resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultOtpDeliveryMechanismState, opts?: pulumi.CustomResourceOptions): DefaultOtpDeliveryMechanism {
        return new DefaultOtpDeliveryMechanism(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultOtpDeliveryMechanism:DefaultOtpDeliveryMechanism';

    /**
     * Returns true if the given object is an instance of DefaultOtpDeliveryMechanism.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultOtpDeliveryMechanism {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultOtpDeliveryMechanism.__pulumiType;
    }
     ...
     */
    public readonly messageTextAfterOtp!: pulumi.Output<string>;
    /**
     * Any text that should appear in the message before the one-time password value.
     */
    public readonly messageTextBeforeOtp!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly phoneNumberJsonField!: pulumi.Output<string>;
    /**
     * A JSON object filter that may be used to identify which phone number value to use when sending the message.
     */
    public readonly phoneNumberJsonObjectFilter!: pulumi.Output<string>;
    /**
     * Required actions returned by the PingDirectory Configuration API.
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultOtpDeliveryMechanismRequiredAction[]>;
    /**
     ...
     */
    public readonly twilioAccountSid!: pulumi.Output<string>;
    /**
     * The auth token for the Twilio account that will be used.
     */
    public readonly twilioAuthToken!: pulumi.Output<string>;
    /**
     * The passphrase provider that may be used to obtain the auth token for the Twilio account that will be used.
     */
    public readonly twilioAuthTokenPassphraseProvider!: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a DefaultOtpDeliveryMechanism resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultOtpDeliveryMechanismArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultOtpDeliveryMechanismArgs | DefaultOtpDeliveryMechanismState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultOtpDeliveryMechanismState | undefined;
            ...
            const args = argsOrState as DefaultOtpDeliveryMechanismArgs | undefined;
        ...
        super(DefaultOtpDeliveryMechanism.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultOtpDeliveryMechanism resources.
 */
export interface DefaultOtpDeliveryMechanismState {
    /**
     * A description for this OTP Delivery Mechanism
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultOtpDeliveryMechanismRequiredAction>[]>;
    /**
     * The e-mail address to use as the sender for the one-time password.
     */
...
/**
 * The set of arguments for constructing a DefaultOtpDeliveryMechanism resource.
 */
export interface DefaultOtpDeliveryMechanismArgs {
    /**
     * A description for this OTP Delivery Mechanism
     */
    description?: pulumi.Input<string>;
