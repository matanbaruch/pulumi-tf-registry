...
export class ConnectionHandler extends pulumi.CustomResource {
    /**
     * Get an existing ConnectionHandler resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectionHandlerState, opts?: pulumi.CustomResourceOptions): ConnectionHandler {
        return new ConnectionHandler(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/connectionHandler:ConnectionHandler';

    /**
     * Returns true if the given object is an instance of ConnectionHandler.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ConnectionHandler {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ConnectionHandler.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.ConnectionHandlerRequiredAction[]>;
    /**
    ...
    /**
     * Create a ConnectionHandler resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ConnectionHandlerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ConnectionHandlerArgs | ConnectionHandlerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ConnectionHandlerState | undefined;
            ...
            const args = argsOrState as ConnectionHandlerArgs | undefined;
        ...
        super(ConnectionHandler.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ConnectionHandler resources.
 */
export interface ConnectionHandlerState {
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.ConnectionHandlerRequiredAction>[]>;
    /**
     * Specifies HTTP header fields and values added to response headers for all requests.
     */
...
/**
 * The set of arguments for constructing a ConnectionHandler resource.
 */
