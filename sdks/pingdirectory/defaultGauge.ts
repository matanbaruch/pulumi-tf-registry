...
export class DefaultGauge extends pulumi.CustomResource {
    /**
     * Get an existing DefaultGauge resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultGaugeState, opts?: pulumi.CustomResourceOptions): DefaultGauge {
        return new DefaultGauge(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultGauge:DefaultGauge';

    /**
     * Returns true if the given object is an instance of DefaultGauge.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultGauge {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultGauge.__pulumiType;
    }

    /**
     * Specifies the level at which alerts are sent for alarms raised by this Gauge.
     */
    public readonly alertLevel!: pulumi.Output<string>;
    /**
     * A value that is used to determine whether the current monitored value indicates this gauge's severity should no longer
     * be 'critical'.
     */
    public readonly criticalExitValue!: pulumi.Output<number>;
    /**
     ...
     */
    public readonly criticalValue!: pulumi.Output<string>;
    /**
     ...
     * be 'major'.
     */
    public readonly majorExitValue!: pulumi.Output<number>;
    /**
     * When the `type` attribute is set to: - `indicator`: A regular expression pattern that is used to determine whether the
     ...
     */
    public readonly majorValue!: pulumi.Output<string>;
    /**
     * A value that is used to determine whether the current monitored value indicates this gauge's severity should no longer
     * be 'minor'.
     */
    public readonly minorExitValue!: pulumi.Output<number>;
    /**
     * When the `type` attribute is set to: - `indicator`: A regular expression pattern that is used to determine whether the
     ...
     */
    public readonly minorValue!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly overrideSeverity!: pulumi.Output<string>;
    /**
     * Required actions returned by the PingDirectory Configuration API.
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultGaugeRequiredAction[]>;
    /**
     ...
     * be 'warning'.
     */
    public readonly warningExitValue!: pulumi.Output<number>;
    /**
     * When the `type` attribute is set to: - `indicator`: A regular expression pattern that is used to determine whether the
     ...
     */
    public readonly warningValue!: pulumi.Output<string>;

    /**
     * Create a DefaultGauge resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultGaugeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultGaugeArgs | DefaultGaugeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultGaugeState | undefined;
            ...
            const args = argsOrState as DefaultGaugeArgs | undefined;
        ...
        super(DefaultGauge.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultGauge resources.
 */
export interface DefaultGaugeState {
    /**
     * Specifies the level at which alerts are sent for alarms raised by this Gauge.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultGaugeRequiredAction>[]>;
    /**
     * Indicates the number of times the monitor data source value will be collected during the update interval.
     */
...
/**
 * The set of arguments for constructing a DefaultGauge resource.
 */
export interface DefaultGaugeArgs {
    /**
     * Specifies the level at which alerts are sent for alarms raised by this Gauge.
     */
    alertLevel?: pulumi.Input<string>;
