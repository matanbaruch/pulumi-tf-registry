...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pingdirectory");
			params.setVersion("1.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BpbmdpZGVudGl0eS9waW5nZGlyZWN0b3J5IiwidmVyc2lvbiI6IjEuMy4wIn19"), c => c.charCodeAt(0)));
