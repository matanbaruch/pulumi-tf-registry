...
export class DebugTarget extends pulumi.CustomResource {
    /**
     * Get an existing DebugTarget resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DebugTargetState, opts?: pulumi.CustomResourceOptions): DebugTarget {
        return new DebugTarget(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/debugTarget:DebugTarget';

    /**
     * Returns true if the given object is an instance of DebugTarget.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DebugTarget {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DebugTarget.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DebugTargetRequiredAction[]>;
    /**
    ...
    /**
     * Create a DebugTarget resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DebugTargetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DebugTargetArgs | DebugTargetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DebugTargetState | undefined;
            ...
            const args = argsOrState as DebugTargetArgs | undefined;
            if ((!args || args.debugLevel === undefined) && !opts.urn) {
                throw new Error("Missing required property 'debugLevel'");
            }
        ...
        super(DebugTarget.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DebugTarget resources.
 */
export interface DebugTargetState {
    /**
     * Specifies the debug message categories to be logged.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DebugTargetRequiredAction>[]>;
    /**
     * Specifies the property to indicate the number of stack frames to include in the stack trace for method entry and
     * exception thrown messages.
     */
...
/**
 * The set of arguments for constructing a DebugTarget resource.
 */
export interface DebugTargetArgs {
    /**
     * Specifies the debug message categories to be logged.
     */
    debugCategories?: pulumi.Input<pulumi.Input<string>[]>;
