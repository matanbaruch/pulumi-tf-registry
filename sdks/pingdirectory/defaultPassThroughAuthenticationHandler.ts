...
export class DefaultPassThroughAuthenticationHandler extends pulumi.CustomResource {
    /**
     * Get an existing DefaultPassThroughAuthenticationHandler resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultPassThroughAuthenticationHandlerState, opts?: pulumi.CustomResourceOptions): DefaultPassThroughAuthenticationHandler {
        return new DefaultPassThroughAuthenticationHandler(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultPassThroughAuthenticationHandler:DefaultPassThroughAuthenticationHandler';

    /**
     * Returns true if the given object is an instance of DefaultPassThroughAuthenticationHandler.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultPassThroughAuthenticationHandler {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultPassThroughAuthenticationHandler.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultPassThroughAuthenticationHandlerRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultPassThroughAuthenticationHandler resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultPassThroughAuthenticationHandlerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultPassThroughAuthenticationHandlerArgs | DefaultPassThroughAuthenticationHandlerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultPassThroughAuthenticationHandlerState | undefined;
            ...
            const args = argsOrState as DefaultPassThroughAuthenticationHandlerArgs | undefined;
        ...
        super(DefaultPassThroughAuthenticationHandler.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultPassThroughAuthenticationHandler resources.
 */
export interface DefaultPassThroughAuthenticationHandlerState {
    /**
     * An optional SCIM filter that will be ANDed with the filter created to identify the account in the PingOne service that
     * corresponds to the local entry. Only the "eq", "sw", "and", and "or" filter types may be used.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultPassThroughAuthenticationHandlerRequiredAction>[]>;
    /**
     * The base DN to use when searching for the user entry using a filter constructed from the pattern defined in the
     * search-filter-pattern property. If no base DN is specified, the null DN will be used as the search base DN.
     */
...
/**
 * The set of arguments for constructing a DefaultPassThroughAuthenticationHandler resource.
 */
export interface DefaultPassThroughAuthenticationHandlerArgs {
    /**
     * An optional SCIM filter that will be ANDed with the filter created to identify the account in the PingOne service that
     * corresponds to the local entry. Only the "eq", "sw", "and", and "or" filter types may be used.
     */
