...
export class DefaultConnectionCriteria extends pulumi.CustomResource {
    /**
     * Get an existing DefaultConnectionCriteria resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultConnectionCriteriaState, opts?: pulumi.CustomResourceOptions): DefaultConnectionCriteria {
        return new DefaultConnectionCriteria(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultConnectionCriteria:DefaultConnectionCriteria';

    /**
     * Returns true if the given object is an instance of DefaultConnectionCriteria.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultConnectionCriteria {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultConnectionCriteria.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultConnectionCriteriaRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultConnectionCriteria resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultConnectionCriteriaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultConnectionCriteriaArgs | DefaultConnectionCriteriaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultConnectionCriteriaState | undefined;
            ...
            const args = argsOrState as DefaultConnectionCriteriaArgs | undefined;
        ...
        super(DefaultConnectionCriteria.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultConnectionCriteria resources.
 */
export interface DefaultConnectionCriteriaState {
    /**
     * Specifies a connection criteria object that must match the associated client connection in order to match the aggregate
     * connection criteria. If one or more all-included connection criteria objects are provided, then a client connection must
     * match all of them in order to match the aggregate connection criteria.
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultConnectionCriteriaRequiredAction>[]>;
    /**
     * The type of Connection Criteria resource. Options are ['simple', 'aggregate', 'third-party']
     */
...
/**
 * The set of arguments for constructing a DefaultConnectionCriteria resource.
 */
export interface DefaultConnectionCriteriaArgs {
    /**
     * Specifies a connection criteria object that must match the associated client connection in order to match the aggregate
     * connection criteria. If one or more all-included connection criteria objects are provided, then a client connection must
     * match all of them in order to match the aggregate connection criteria.
