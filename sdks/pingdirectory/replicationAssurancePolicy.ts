...
export class ReplicationAssurancePolicy extends pulumi.CustomResource {
    /**
     * Get an existing ReplicationAssurancePolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReplicationAssurancePolicyState, opts?: pulumi.CustomResourceOptions): ReplicationAssurancePolicy {
        return new ReplicationAssurancePolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/replicationAssurancePolicy:ReplicationAssurancePolicy';

    /**
     * Returns true if the given object is an instance of ReplicationAssurancePolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ReplicationAssurancePolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ReplicationAssurancePolicy.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.ReplicationAssurancePolicyRequiredAction[]>;
    /**
    ...
    /**
     * Create a ReplicationAssurancePolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ReplicationAssurancePolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ReplicationAssurancePolicyArgs | ReplicationAssurancePolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ReplicationAssurancePolicyState | undefined;
            ...
            const args = argsOrState as ReplicationAssurancePolicyArgs | undefined;
        ...
        super(ReplicationAssurancePolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ReplicationAssurancePolicy resources.
 */
export interface ReplicationAssurancePolicyState {
    /**
     * Specifies a connection criteria used to indicate which operations from clients matching this criteria use this policy.
     * If both a connection criteria and a request criteria are specified for a policy, then both must match an operation for
     * the policy to be assigned.
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.ReplicationAssurancePolicyRequiredAction>[]>;
    /**
     * Specifies the maximum length of time to wait for the replication assurance requirements to be met before timing out and
     * replying to the client.
     */
...
/**
 * The set of arguments for constructing a ReplicationAssurancePolicy resource.
 */
export interface ReplicationAssurancePolicyArgs {
    /**
     * Specifies a connection criteria used to indicate which operations from clients matching this criteria use this policy.
     * If both a connection criteria and a request criteria are specified for a policy, then both must match an operation for
     * the policy to be assigned.
