...
export class DefaultTrustManagerProvider extends pulumi.CustomResource {
    /**
     * Get an existing DefaultTrustManagerProvider resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultTrustManagerProviderState, opts?: pulumi.CustomResourceOptions): DefaultTrustManagerProvider {
        return new DefaultTrustManagerProvider(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultTrustManagerProvider:DefaultTrustManagerProvider';

    /**
     * Returns true if the given object is an instance of DefaultTrustManagerProvider.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultTrustManagerProvider {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultTrustManagerProvider.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultTrustManagerProviderRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultTrustManagerProvider resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultTrustManagerProviderArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultTrustManagerProviderArgs | DefaultTrustManagerProviderState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultTrustManagerProviderState | undefined;
            ...
            const args = argsOrState as DefaultTrustManagerProviderArgs | undefined;
        ...
        super(DefaultTrustManagerProvider.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultTrustManagerProvider resources.
 */
export interface DefaultTrustManagerProviderState {
    /**
     * Indicate whether the Trust Manager Provider is enabled for use.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultTrustManagerProviderRequiredAction>[]>;
    /**
     * Specifies the path to the file containing the trust information. It can be an absolute path or a path that is relative
     * to the Directory Server instance root.
     */
...
/**
 * The set of arguments for constructing a DefaultTrustManagerProvider resource.
 */
export interface DefaultTrustManagerProviderArgs {
    /**
     * Indicate whether the Trust Manager Provider is enabled for use.
     */
    enabled?: pulumi.Input<boolean>;
