...
export class LocalDbIndex extends pulumi.CustomResource {
    /**
     * Get an existing LocalDbIndex resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalDbIndexState, opts?: pulumi.CustomResourceOptions): LocalDbIndex {
        return new LocalDbIndex(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/localDbIndex:LocalDbIndex';

    /**
     * Returns true if the given object is an instance of LocalDbIndex.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalDbIndex {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalDbIndex.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.LocalDbIndexRequiredAction[]>;
    /**
     ...
     */
    public readonly substringIndexEntryLimit!: pulumi.Output<number | undefined>;
    /**
    ...
    /**
     * Create a LocalDbIndex resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LocalDbIndexArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalDbIndexArgs | LocalDbIndexState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalDbIndexState | undefined;
            ...
            const args = argsOrState as LocalDbIndexArgs | undefined;
            ...
            if ((!args || args.indexTypes === undefined) && !opts.urn) {
                throw new Error("Missing required property 'indexTypes'");
            }
        ...
        super(LocalDbIndex.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LocalDbIndex resources.
 */
export interface LocalDbIndexState {
    /**
     * Specifies the name of the attribute for which the index is to be maintained.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.LocalDbIndexRequiredAction>[]>;
    /**
     * Specifies, for substring indexes, the maximum number of entries that are allowed to match a given index key before that
     * particular index key is no longer maintained. Setting a large limit can dramatically increase the database size on disk
     * and have a big impact on server performance if the indexed attribute is modified frequently. When a very large limit is
...
/**
 * The set of arguments for constructing a LocalDbIndex resource.
 */
export interface LocalDbIndexArgs {
    /**
     * Specifies the name of the attribute for which the index is to be maintained.
     */
    attribute: pulumi.Input<string>;
