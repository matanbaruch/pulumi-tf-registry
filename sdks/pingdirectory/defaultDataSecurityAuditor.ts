...
export class DefaultDataSecurityAuditor extends pulumi.CustomResource {
    /**
     * Get an existing DefaultDataSecurityAuditor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultDataSecurityAuditorState, opts?: pulumi.CustomResourceOptions): DefaultDataSecurityAuditor {
        return new DefaultDataSecurityAuditor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultDataSecurityAuditor:DefaultDataSecurityAuditor';

    /**
     * Returns true if the given object is an instance of DefaultDataSecurityAuditor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultDataSecurityAuditor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultDataSecurityAuditor.__pulumiType;
    }
     ...
     */
    public readonly accountExpirationWarningInterval!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly idleAccountErrorInterval!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly idleAccountWarningInterval!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly maximumIdleTime!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly neverLoggedInAccountErrorInterval!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly neverLoggedInAccountWarningInterval!: pulumi.Output<string>;
    /**
     ...
     * not enabled.
     */
    public readonly passwordEvaluationAge!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultDataSecurityAuditorRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultDataSecurityAuditor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultDataSecurityAuditorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultDataSecurityAuditorArgs | DefaultDataSecurityAuditorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultDataSecurityAuditorState | undefined;
            ...
            const args = argsOrState as DefaultDataSecurityAuditorArgs | undefined;
        ...
        super(DefaultDataSecurityAuditor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultDataSecurityAuditor resources.
 */
export interface DefaultDataSecurityAuditorState {
    /**
     * If set, the auditor will report all users with account expiration times are in the future, but are within the specified
     * length of time away from the current time.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultDataSecurityAuditorRequiredAction>[]>;
    /**
     * The type of Data Security Auditor resource. Options are ['expired-password', 'idle-account', 'disabled-account',
     * 'weakly-encoded-password', 'privilege', 'account-usability-issues', 'locked-account', 'filter',
     * 'account-validity-window', 'multiple-password', 'deprecated-password-storage-scheme', 'nonexistent-password-policy',
...
/**
 * The set of arguments for constructing a DefaultDataSecurityAuditor resource.
 */
export interface DefaultDataSecurityAuditorArgs {
    /**
     * If set, the auditor will report all users with account expiration times are in the future, but are within the specified
     * length of time away from the current time.
     */
