...
export class DefaultIdTokenValidator extends pulumi.CustomResource {
    /**
     * Get an existing DefaultIdTokenValidator resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultIdTokenValidatorState, opts?: pulumi.CustomResourceOptions): DefaultIdTokenValidator {
        return new DefaultIdTokenValidator(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/defaultIdTokenValidator:DefaultIdTokenValidator';

    /**
     * Returns true if the given object is an instance of DefaultIdTokenValidator.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DefaultIdTokenValidator {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DefaultIdTokenValidator.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.DefaultIdTokenValidatorRequiredAction[]>;
    /**
    ...
    /**
     * Create a DefaultIdTokenValidator resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DefaultIdTokenValidatorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DefaultIdTokenValidatorArgs | DefaultIdTokenValidatorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DefaultIdTokenValidatorState | undefined;
            ...
            const args = argsOrState as DefaultIdTokenValidatorArgs | undefined;
        ...
        super(DefaultIdTokenValidator.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DefaultIdTokenValidator resources.
 */
export interface DefaultIdTokenValidatorState {
    /**
     * Specifies an allow list of JWT signing algorithms that will be accepted by the OpenID Connect ID Token Validator.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.DefaultIdTokenValidatorRequiredAction>[]>;
    /**
     * Specifies the locally stored certificates that may be used to validate the signature of an incoming ID token. This
     * property may be specified if a JWKS endpoint should not be used to retrieve public signing keys.
     */
...
/**
 * The set of arguments for constructing a DefaultIdTokenValidator resource.
 */
export interface DefaultIdTokenValidatorArgs {
    /**
     * Specifies an allow list of JWT signing algorithms that will be accepted by the OpenID Connect ID Token Validator.
     */
    allowedSigningAlgorithms?: pulumi.Input<pulumi.Input<string>[]>;
