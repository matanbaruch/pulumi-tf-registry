...
export class LogFieldMapping extends pulumi.CustomResource {
    /**
     * Get an existing LogFieldMapping resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogFieldMappingState, opts?: pulumi.CustomResourceOptions): LogFieldMapping {
        return new LogFieldMapping(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/logFieldMapping:LogFieldMapping';

    /**
     * Returns true if the given object is an instance of LogFieldMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LogFieldMapping {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LogFieldMapping.__pulumiType;
    }
     ...
     */
    public readonly logFieldAdditionalInformation!: pulumi.Output<string | undefined>;
    /**
     * The DN of the alternate authorization identity used when processing the operation.
     */
    public readonly logFieldAlternateAuthorizationDn!: pulumi.Output<string | undefined>;
    /**
     * The DN of the user that authenticated to the server.
     */
    public readonly logFieldAuthenticatedUserDn!: pulumi.Output<string | undefined>;
    /**
     * The numeric identifier for the authentication failure reason.
     */
    public readonly logFieldAuthenticationFailureId!: pulumi.Output<string | undefined>;
    /**
     * A message explaining the reason that the authentication attempt failed.
     */
    public readonly logFieldAuthenticationFailureReason!: pulumi.Output<string | undefined>;
    /**
     * The type of authentication requested by the client.
     */
    public readonly logFieldAuthenticationType!: pulumi.Output<string | undefined>;
    /**
     * The base DN for a search operation.
     */
    public readonly logFieldBaseDn!: pulumi.Output<string | undefined>;
    /**
     * The bind DN for a bind operation.
     */
    public readonly logFieldBindDn!: pulumi.Output<string | undefined>;
    /**
     * The category for the log message.
     */
    public readonly logFieldCategory!: pulumi.Output<string | undefined>;
    /**
     * The connection ID assigned to the client connection.
     */
    public readonly logFieldConnectionId!: pulumi.Output<string | undefined>;
    /**
     * Indicates whether the old RDN values should be removed from an entry while processing a modify DN operation.
     */
    public readonly logFieldDeleteOldRdn!: pulumi.Output<string | undefined>;
    /**
     * The reason that the client connection was closed.
     */
    public readonly logFieldDisconnectReason!: pulumi.Output<string | undefined>;
    /**
     * The number of search result entries returned to the client.
     */
    public readonly logFieldEntriesReturned!: pulumi.Output<string | undefined>;
    /**
     * The DN of the entry targeted by the operation.
     */
    public readonly logFieldEntryDn!: pulumi.Output<string | undefined>;
    /**
     * The filter from a search operation.
     */
    public readonly logFieldFilter!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly logFieldInstanceName!: pulumi.Output<string | undefined>;
    /**
     * The contents of the intermediate client request control provided by the client.
     */
    public readonly logFieldIntermediateClientRequest!: pulumi.Output<string | undefined>;
    /**
     * The contents of the intermediate client response control returned to the client.
     */
    public readonly logFieldIntermediateClientResult!: pulumi.Output<string | undefined>;
    /**
     * The DN of the superior entry closest to the DN specified by the client.
     */
    public readonly logFieldMatchedDn!: pulumi.Output<string | undefined>;
    /**
     * When the `type` attribute is set to: - `access`: The diagnostic message for the operation. - `error`: The text of the
     * log message.
     */
    public readonly logFieldMessage!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly logFieldMessageId!: pulumi.Output<string | undefined>;
    /**
     * The message ID of the operation to be abandoned.
     */
    public readonly logFieldMessageIdToAbandon!: pulumi.Output<string | undefined>;
    /**
     * The type of log message. Message types may include "CONNECT", "DISCONNECT", "FORWARD", "RESULT", "ENTRY", or
     * "REFERENCE".
     */
    public readonly logFieldMessageType!: pulumi.Output<string | undefined>;
    /**
     * The new RDN to use for a modify DN operation.
     */
    public readonly logFieldNewRdn!: pulumi.Output<string | undefined>;
    /**
     * The new superior DN from a modify DN operation.
     */
    public readonly logFieldNewSuperiorDn!: pulumi.Output<string | undefined>;
    /**
     * The operation ID for the operation processed by the server.
     */
    public readonly logFieldOperationId!: pulumi.Output<string | undefined>;
    /**
     * The type of operation that was processed.
     */
    public readonly logFieldOperationType!: pulumi.Output<string | undefined>;
    /**
     ...
     * client).
     */
    public readonly logFieldOrigin!: pulumi.Output<string | undefined>;
    /**
     * The length of time (in milliseconds with microsecond accuracy) required to process the operation.
     */
    public readonly logFieldProcessingTime!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly logFieldProductName!: pulumi.Output<string | undefined>;
    /**
     * The name of the protocol the client is using to communicate with the Directory Server.
     */
    public readonly logFieldProtocolName!: pulumi.Output<string | undefined>;
    /**
     * The protocol version used by the client when communicating with the Directory Server.
     */
    public readonly logFieldProtocolVersion!: pulumi.Output<string | undefined>;
    /**
     * The referral URLs returned to the client.
     */
    public readonly logFieldReferralUrls!: pulumi.Output<string | undefined>;
    /**
     * The replication change ID.
     */
    public readonly logFieldReplicationChangeId!: pulumi.Output<string | undefined>;
    /**
     * The OIDs of the request controls returned to the client.
     */
    public readonly logFieldRequestControls!: pulumi.Output<string | undefined>;
    /**
     * The OID of an extended request.
     */
    public readonly logFieldRequestOid!: pulumi.Output<string | undefined>;
    /**
     * The set of requested attributes for the search operation.
     */
    public readonly logFieldRequestedAttributes!: pulumi.Output<string | undefined>;
    /**
     * The DN of the user that requested the operation.
     */
    public readonly logFieldRequesterDn!: pulumi.Output<string | undefined>;
    /**
     * The IP address of the client that requested the operation.
     */
    public readonly logFieldRequesterIpAddress!: pulumi.Output<string | undefined>;
    /**
     * The OIDs of the response controls returned to the client.
     */
    public readonly logFieldResponseControls!: pulumi.Output<string | undefined>;
    /**
     * The OID of an extended response.
     */
    public readonly logFieldResponseOid!: pulumi.Output<string | undefined>;
    /**
     * The numeric result code for the operation.
     */
    public readonly logFieldResultCode!: pulumi.Output<string | undefined>;
    /**
     * The name of the SASL mechanism used to authenticate.
     */
    public readonly logFieldSaslMechanismName!: pulumi.Output<string | undefined>;
    /**
     * The scope for the search operation.
     */
    public readonly logFieldScope!: pulumi.Output<string | undefined>;
    /**
     * The severity for the log message.
     */
    public readonly logFieldSeverity!: pulumi.Output<string | undefined>;
    /**
     * The address of the client from which the connection was established.
     */
    public readonly logFieldSourceAddress!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly logFieldStartupid!: pulumi.Output<string | undefined>;
    /**
     * The network address of the Directory Server to which the client connection has been established.
     */
    public readonly logFieldTargetAddress!: pulumi.Output<string | undefined>;
    /**
     * The name of the attribute targeted by a compare operation.
     */
    public readonly logFieldTargetAttribute!: pulumi.Output<string | undefined>;
    /**
     * The address of the server to which the request has been forwarded.
     */
    public readonly logFieldTargetHost!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly logFieldTargetPort!: pulumi.Output<string | undefined>;
    /**
     * The protocol used when forwarding the request to a backend server.
     */
    public readonly logFieldTargetProtocol!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly logFieldTimestamp!: pulumi.Output<string | undefined>;
    /**
     * Indicates whether the requested search operation was unindexed.
     */
    public readonly logFieldUnindexed!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.LogFieldMappingRequiredAction[]>;
    /**
    ...
    /**
     * Create a LogFieldMapping resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LogFieldMappingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LogFieldMappingArgs | LogFieldMappingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LogFieldMappingState | undefined;
            ...
            const args = argsOrState as LogFieldMappingArgs | undefined;
        ...
        super(LogFieldMapping.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LogFieldMapping resources.
 */
export interface LogFieldMappingState {
    /**
     * A description for this Log Field Mapping
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.LogFieldMappingRequiredAction>[]>;
    /**
     * The type of Log Field Mapping resource. Options are ['access', 'error']
     */
...
/**
 * The set of arguments for constructing a LogFieldMapping resource.
 */
export interface LogFieldMappingArgs {
    /**
     * A description for this Log Field Mapping
     */
    description?: pulumi.Input<string>;
