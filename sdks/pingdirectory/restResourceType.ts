...
export class RestResourceType extends pulumi.CustomResource {
    /**
     * Get an existing RestResourceType resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RestResourceTypeState, opts?: pulumi.CustomResourceOptions): RestResourceType {
        return new RestResourceType(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/restResourceType:RestResourceType';

    /**
     * Returns true if the given object is an instance of RestResourceType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RestResourceType {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RestResourceType.__pulumiType;
    }
     ...
     */
    public readonly createRdnAttributeType!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly parentResourceType!: pulumi.Output<string | undefined>;
    /**
     * Specifies which attribute category the password belongs to.
     */
    public readonly passwordAttributeCategory!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly passwordDisplayOrderIndex!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public readonly primaryDisplayAttributeType!: pulumi.Output<string | undefined>;
    /**
     ...
     * parent DN.
     */
    public readonly relativeDnFromParentResource!: pulumi.Output<string | undefined>;
    /**
     * Required actions returned by the PingDirectory Configuration API.
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.RestResourceTypeRequiredAction[]>;
    /**
    ...
    /**
     * Create a RestResourceType resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RestResourceTypeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RestResourceTypeArgs | RestResourceTypeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RestResourceTypeState | undefined;
            ...
            const args = argsOrState as RestResourceTypeArgs | undefined;
            if ((!args || args.enabled === undefined) && !opts.urn) {
                throw new Error("Missing required property 'enabled'");
            }
            if ((!args || args.resourceEndpoint === undefined) && !opts.urn) {
                throw new Error("Missing required property 'resourceEndpoint'");
            }
            if ((!args || args.searchBaseDn === undefined) && !opts.urn) {
                throw new Error("Missing required property 'searchBaseDn'");
            }
        ...
        super(RestResourceType.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RestResourceType resources.
 */
export interface RestResourceTypeState {
    /**
     * Specifies an auxiliary LDAP object class that should be exposed by this REST Resource Type.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.RestResourceTypeRequiredAction>[]>;
    /**
     * The HTTP addressable endpoint of this REST Resource Type relative to a REST API base URL. Do not include a leading '/'.
     */
...
/**
 * The set of arguments for constructing a RestResourceType resource.
 */
export interface RestResourceTypeArgs {
    /**
     * Specifies an auxiliary LDAP object class that should be exposed by this REST Resource Type.
     */
    auxiliaryLdapObjectclasses?: pulumi.Input<pulumi.Input<string>[]>;
