...
export class ScimSubattribute extends pulumi.CustomResource {
    /**
     * Get an existing ScimSubattribute resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScimSubattributeState, opts?: pulumi.CustomResourceOptions): ScimSubattribute {
        return new ScimSubattribute(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingdirectory:index/scimSubattribute:ScimSubattribute';

    /**
     * Returns true if the given object is an instance of ScimSubattribute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ScimSubattribute {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ScimSubattribute.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly requiredActions!: pulumi.Output<outputs.ScimSubattributeRequiredAction[]>;
    /**
    ...
    /**
     * Create a ScimSubattribute resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ScimSubattributeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ScimSubattributeArgs | ScimSubattributeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ScimSubattributeState | undefined;
            ...
            const args = argsOrState as ScimSubattributeArgs | undefined;
        ...
        super(ScimSubattribute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ScimSubattribute resources.
 */
export interface ScimSubattributeState {
    /**
     * Specifies the suggested canonical type values for the sub-attribute.
     */
     ...
     * Required actions returned by the PingDirectory Configuration API.
     */
    requiredActions?: pulumi.Input<pulumi.Input<inputs.ScimSubattributeRequiredAction>[]>;
    /**
     * The type of SCIM Subattribute resource. Options are ['scim-subattribute']
     */
...
/**
 * The set of arguments for constructing a ScimSubattribute resource.
 */
export interface ScimSubattributeArgs {
    /**
     * Specifies the suggested canonical type values for the sub-attribute.
     */
    canonicalValues?: pulumi.Input<pulumi.Input<string>[]>;
