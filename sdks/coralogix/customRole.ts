...
export class CustomRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'coralogix:index/customRole:CustomRole';
     ...
     * Parent role name
     */
    public readonly parentRole!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: CustomRoleArgs | CustomRoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["parentRole"] = state ? state.parentRole : undefined;
            ...
            if ((!args || args.parentRole === undefined) && !opts.urn) {
                throw new Error("Missing required property 'parentRole'");
            }
            ...
            resourceInputs["parentRole"] = args ? args.parentRole : undefined;
...
export interface CustomRoleState {
     ...
     * Parent role name
     */
    parentRole?: pulumi.Input<string>;
    /**
     * Custom role permissions
     */
