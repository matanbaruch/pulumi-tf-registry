...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("coralogix");
			params.setVersion("1.18.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvcmFsb2dpeC9jb3JhbG9naXgiLCJ2ZXJzaW9uIjoiMS4xOC41In19"), c => c.charCodeAt(0)));
