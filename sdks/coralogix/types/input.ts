...
export interface AlertFlowStageGroup {
    /**
     * The operator to use on the alert. can be one of ["OR" "AND"]
     */
...
export interface AlertMetricLuceneCondition {
    /**
     * The arithmetic operator to use on the alert. can be one of ["Percentile" "Avg" "Min" "Max" "Sum" "Count"]
     */
    ...
    /**
     * The bounded time frame for the threshold to be occurred within, to trigger the alert. Can be one of ["1Min" "5Min" "2H" "4H" "24H" "12H" "10Min" "15Min" "20Min" "30Min" "1H" "6H"]
     */
...
export interface AlertNewValue {
    ...
    searchQuery?: pulumi.Input<string>;
    /**
     * An array of log severities that we interested in. Can be one of ["Info" "Warning" "Error" "Critical" "Debug" "Verbose"]
     */
...
export interface AlertRatioCondition {
    ...
    /**
     * The bounded time frame for the threshold to be occurred within, to trigger the alert. Can be one of ["5Min" "10Min" "30Min" "1H" "2H" "4H" "6H" "36H" "15Min" "20Min" "12H" "24H"]
     */
    timeWindow: pulumi.Input<string>;
}
...
export interface AlertSchedulingTimeFrame {
    /**
     * Days of week. Can be one of ["Friday" "Saturday" "Sunday" "Monday" "Tuesday" "Wednesday" "Thursday"]
     */
...
export interface AlertUniqueCountCondition {
    ...
    /**
     * The bounded time frame for the threshold to be occurred within, to trigger the alert. Can be one of ["24H" "1Min" "30Min" "1H" "6H" "12H" "4H" "5Min" "10Min" "15Min" "20Min" "2H"]
     */
    timeWindow: pulumi.Input<string>;
    /**
...
export interface DashboardFilterSourceSpansField {
    ...
    type: pulumi.Input<string>;
    /**
     * The value of the field. When the field type is `metadata`, can be one of ["subsystem_name" "service_name" "operation_name" "unspecified" "application_name"]
     */
    value: pulumi.Input<string>;
}
...
export interface DashboardLayoutSectionRowWidgetDefinitionBarChart {
    ...
    /**
     * The unit of the chart. Can be one of gibytes, euro, microseconds, kbytes, mbytes, gbytes, kibytes, usd_cents, euro_cents, milliseconds, bytes, bytes_iec, usd, unspecified, seconds, mibytes.
     */
...
export interface DashboardLayoutSectionRowWidgetDefinitionBarChartQuerySpansAggregation {
    /**
     * The type of the aggregation. When the aggregation type is `metrics`, can be one of ["percentile_99" "percentile_95" "percentile_50" "unspecified" "min" "max" "avg" "sum"]. When the aggregation type is `dimension`, can be one of ["unique_count" "error_count" "unspecified"].
     */
    aggregationType: pulumi.Input<string>;
    /**
     * The field to aggregate on. When the aggregation type is `metrics`, can be one of ["unspecified" "duration"]. When the aggregation type is `dimension`, can be one of ["unspecified" "trace_id"].
     */
    field: pulumi.Input<string>;
    /**
...
export interface DashboardLayoutSectionRowWidgetDefinitionDataTable {
    ...
    /**
     * The data mode type. Can be one of ["unspecified" "archive"].
     */
    dataModeType?: pulumi.Input<string>;
    ...
    /**
     * The style of the rows. Can be one of ["json" "one_line" "two_line" "condensed"].
     */
...
export interface DashboardLayoutSectionRowWidgetDefinitionGauge {
    ...
    /**
     * The unit of the gauge. Can be one of ["kbytes" "kibytes" "euro" "bytes" "gbytes" "bytes_iec" "gibytes" "euro_cents" "none" "microseconds" "seconds" "mbytes" "percent" "milliseconds" "mibytes" "usd_cents" "usd"].
     */
    unit: pulumi.Input<string>;
}
...
export interface DashboardLayoutSectionRowWidgetDefinitionLineChartLegend {
    /**
     * The columns to display in the legend. Valid values are: max, sum, avg, last, unspecified, min.
     */
...
export interface DashboardLayoutSectionRowWidgetDefinitionLineChartQueryDefinition {
    ...
    /**
     * The unit. Valid values are: gibytes, euro, microseconds, kbytes, mbytes, gbytes, kibytes, usd_cents, euro_cents, milliseconds, bytes, bytes_iec, usd, unspecified, seconds, mibytes.
     */
    unit?: pulumi.Input<string>;
}
...
export interface DashboardLayoutSectionRowWidgetDefinitionLineChartTooltip {
    ...
    /**
     * The tooltip type. Valid values are: unspecified, all, single.
     */
    type?: pulumi.Input<string>;
}
...
export interface DashboardLayoutSectionRowWidgetDefinitionPieChartLabelDefinition {
    isVisible?: pulumi.Input<boolean>;
    /**
     * The source of the label. Valid values are: unspecified, inner, stack
     */
...
export interface Events2metricLogsQuery {
    ...
    /**
     * An array of severities that we interested in. Can be one of ["Info" "Warning" "Error" "Critical" "Unspecified" "Debug" "Verbose"]
     */
    severities?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * An array that contains log’s subsystem names that we want to be notified on.  Subsystems can be filtered by prefix, suffix, and contains using the next patterns - filter:startsWith:xxx, filter:endsWith:xxx, filter:contains:xxx
...
export interface RulesGroupRuleSubgroupRuleExtractTimestamp {
    ...
    description?: pulumi.Input<string>;
    /**
     * The format standard you want to use. Can be one of ["Strftime" "JavaSDF" "Golang" "SecondTS" "MilliTS" "MicroTS" "NanoTS"]
     */
...
export interface RulesGroupRuleSubgroupRuleJsonExtract {
    ...
    description?: pulumi.Input<string>;
    /**
     * The field that will be populated by the results of RegEx operation.Can be one of [Method ThreadID Severity Category Class].
     */
...
export interface SloFilter {
    /**
     * Compare type. This is the compare type of the SLO. Valid values are: ["unspecified" "is" "starts_with" "ends_with" "includes"]
     */
...
export interface TcoPoliciesLogsPolicyApplications {
    ...
    /**
     * The rule type. Can be one of ["is" "is_not" "starts_with" "includes"].
     */
