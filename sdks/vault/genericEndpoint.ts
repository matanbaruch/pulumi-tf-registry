...
export class GenericEndpoint extends pulumi.CustomResource {
    /**
     * Get an existing GenericEndpoint resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GenericEndpointState, opts?: pulumi.CustomResourceOptions): GenericEndpoint {
        return new GenericEndpoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/genericEndpoint:GenericEndpoint';

    /**
     * Returns true if the given object is an instance of GenericEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GenericEndpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GenericEndpoint.__pulumiType;
    }
    ...
    /**
     * Create a GenericEndpoint resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GenericEndpointArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GenericEndpointArgs | GenericEndpointState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GenericEndpointState | undefined;
            ...
            const args = argsOrState as GenericEndpointArgs | undefined;
        ...
        super(GenericEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering GenericEndpoint resources.
 */
export interface GenericEndpointState {
    /**
     * JSON-encoded data to write.
     */
...
/**
 * The set of arguments for constructing a GenericEndpoint resource.
 */
export interface GenericEndpointArgs {
    /**
     * JSON-encoded data to write.
     */
    dataJson: pulumi.Input<string>;
