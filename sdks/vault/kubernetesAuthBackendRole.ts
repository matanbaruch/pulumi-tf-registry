...
export class KubernetesAuthBackendRole extends pulumi.CustomResource {
    /**
     * Get an existing KubernetesAuthBackendRole resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KubernetesAuthBackendRoleState, opts?: pulumi.CustomResourceOptions): KubernetesAuthBackendRole {
        return new KubernetesAuthBackendRole(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/kubernetesAuthBackendRole:KubernetesAuthBackendRole';

    /**
     * Returns true if the given object is an instance of KubernetesAuthBackendRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubernetesAuthBackendRole {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubernetesAuthBackendRole.__pulumiType;
    }
    ...
    /**
     * Create a KubernetesAuthBackendRole resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: KubernetesAuthBackendRoleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KubernetesAuthBackendRoleArgs | KubernetesAuthBackendRoleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KubernetesAuthBackendRoleState | undefined;
            ...
            const args = argsOrState as KubernetesAuthBackendRoleArgs | undefined;
        ...
        super(KubernetesAuthBackendRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KubernetesAuthBackendRole resources.
 */
export interface KubernetesAuthBackendRoleState {
    /**
     * Configures how identity aliases are generated. Valid choices are: serviceaccount_uid, serviceaccount_name
     */
...
/**
 * The set of arguments for constructing a KubernetesAuthBackendRole resource.
 */
export interface KubernetesAuthBackendRoleArgs {
    /**
     * Configures how identity aliases are generated. Valid choices are: serviceaccount_uid, serviceaccount_name
     */
    aliasNameSource?: pulumi.Input<string>;
