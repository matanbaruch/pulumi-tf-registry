...
export class IdentityMfaPingid extends pulumi.CustomResource {
    /**
     * Get an existing IdentityMfaPingid resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityMfaPingidState, opts?: pulumi.CustomResourceOptions): IdentityMfaPingid {
        return new IdentityMfaPingid(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/identityMfaPingid:IdentityMfaPingid';

    /**
     * Returns true if the given object is an instance of IdentityMfaPingid.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityMfaPingid {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityMfaPingid.__pulumiType;
    }
    ...
    /**
     * Create a IdentityMfaPingid resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityMfaPingidArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityMfaPingidArgs | IdentityMfaPingidState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityMfaPingidState | undefined;
            ...
            const args = argsOrState as IdentityMfaPingidArgs | undefined;
        ...
        super(IdentityMfaPingid.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityMfaPingid resources.
 */
export interface IdentityMfaPingidState {
    /**
     * The admin URL, derived from "settings_file_base64"
     */
...
/**
 * The set of arguments for constructing a IdentityMfaPingid resource.
 */
export interface IdentityMfaPingidArgs {
    /**
     * Target namespace. (requires Enterprise)
     */
    namespace?: pulumi.Input<string>;
