...
export class PkiSecretBackendSign extends pulumi.CustomResource {
    /**
     * Get an existing PkiSecretBackendSign resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PkiSecretBackendSignState, opts?: pulumi.CustomResourceOptions): PkiSecretBackendSign {
        return new PkiSecretBackendSign(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/pkiSecretBackendSign:PkiSecretBackendSign';

    /**
     * Returns true if the given object is an instance of PkiSecretBackendSign.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PkiSecretBackendSign {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PkiSecretBackendSign.__pulumiType;
    }
    ...
    /**
     * Create a PkiSecretBackendSign resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PkiSecretBackendSignArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PkiSecretBackendSignArgs | PkiSecretBackendSignState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PkiSecretBackendSignState | undefined;
            ...
            const args = argsOrState as PkiSecretBackendSignArgs | undefined;
        ...
        super(PkiSecretBackendSign.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PkiSecretBackendSign resources.
 */
export interface PkiSecretBackendSignState {
    /**
     * List of alternative names.
     */
...
/**
 * The set of arguments for constructing a PkiSecretBackendSign resource.
 */
export interface PkiSecretBackendSignArgs {
    /**
     * List of alternative names.
     */
    altNames?: pulumi.Input<pulumi.Input<string>[]>;
