...
export class AzureAuthBackendRole extends pulumi.CustomResource {
    /**
     * Get an existing AzureAuthBackendRole resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AzureAuthBackendRoleState, opts?: pulumi.CustomResourceOptions): AzureAuthBackendRole {
        return new AzureAuthBackendRole(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/azureAuthBackendRole:AzureAuthBackendRole';

    /**
     * Returns true if the given object is an instance of AzureAuthBackendRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AzureAuthBackendRole {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AzureAuthBackendRole.__pulumiType;
    }
    ...
    /**
     * Create a AzureAuthBackendRole resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AzureAuthBackendRoleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AzureAuthBackendRoleArgs | AzureAuthBackendRoleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AzureAuthBackendRoleState | undefined;
            ...
            const args = argsOrState as AzureAuthBackendRoleArgs | undefined;
        ...
        super(AzureAuthBackendRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AzureAuthBackendRole resources.
 */
export interface AzureAuthBackendRoleState {
    /**
     * Unique name of the auth backend to configure.
     */
...
/**
 * The set of arguments for constructing a AzureAuthBackendRole resource.
 */
export interface AzureAuthBackendRoleArgs {
    /**
     * Unique name of the auth backend to configure.
     */
    backend?: pulumi.Input<string>;
