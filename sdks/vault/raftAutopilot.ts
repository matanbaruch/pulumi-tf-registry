...
export class RaftAutopilot extends pulumi.CustomResource {
    ...
    /**
     * Specifies whether to remove dead server nodes periodically or when a new server joins. This requires that min-quorum is
     * also set.
     */
    public readonly cleanupDeadServers!: pulumi.Output<boolean | undefined>;
    /**
     * Limit the amount of time a server can go without leader contact before being considered failed. This only takes effect
     * when cleanup_dead_servers is set.
     */
    ...
    /**
     * Minimum number of servers allowed in a cluster before autopilot can prune dead servers. This should at least be 3.
     * Applicable only for voting nodes.
     */
    ...
    constructor(name: string, argsOrState?: RaftAutopilotArgs | RaftAutopilotState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RaftAutopilot.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
