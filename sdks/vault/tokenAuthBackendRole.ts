...
export class TokenAuthBackendRole extends pulumi.CustomResource {
    /**
     * Get an existing TokenAuthBackendRole resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TokenAuthBackendRoleState, opts?: pulumi.CustomResourceOptions): TokenAuthBackendRole {
        return new TokenAuthBackendRole(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/tokenAuthBackendRole:TokenAuthBackendRole';

    /**
     * Returns true if the given object is an instance of TokenAuthBackendRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TokenAuthBackendRole {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TokenAuthBackendRole.__pulumiType;
    }
    ...
    /**
     * Create a TokenAuthBackendRole resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TokenAuthBackendRoleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TokenAuthBackendRoleArgs | TokenAuthBackendRoleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TokenAuthBackendRoleState | undefined;
            ...
            const args = argsOrState as TokenAuthBackendRoleArgs | undefined;
        ...
        super(TokenAuthBackendRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TokenAuthBackendRole resources.
 */
export interface TokenAuthBackendRoleState {
    /**
     * Set of allowed entity aliases for this role.
     */
...
/**
 * The set of arguments for constructing a TokenAuthBackendRole resource.
 */
export interface TokenAuthBackendRoleArgs {
    /**
     * Set of allowed entity aliases for this role.
     */
    allowedEntityAliases?: pulumi.Input<pulumi.Input<string>[]>;
