...
export class LdapSecretBackend extends pulumi.CustomResource {
    /**
     * Get an existing LdapSecretBackend resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LdapSecretBackendState, opts?: pulumi.CustomResourceOptions): LdapSecretBackend {
        return new LdapSecretBackend(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/ldapSecretBackend:LdapSecretBackend';

    /**
     * Returns true if the given object is an instance of LdapSecretBackend.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LdapSecretBackend {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LdapSecretBackend.__pulumiType;
    }
    ...
    /**
     * Create a LdapSecretBackend resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LdapSecretBackendArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LdapSecretBackendArgs | LdapSecretBackendState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LdapSecretBackendState | undefined;
            ...
            const args = argsOrState as LdapSecretBackendArgs | undefined;
        ...
        super(LdapSecretBackend.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LdapSecretBackend resources.
 */
export interface LdapSecretBackendState {
    /**
     * Accessor of the mount
     */
...
/**
 * The set of arguments for constructing a LdapSecretBackend resource.
 */
export interface LdapSecretBackendArgs {
    /**
     * List of managed key registry entry names that the mount in question is allowed to access
     */
    allowedManagedKeys?: pulumi.Input<pulumi.Input<string>[]>;
