...
export class PkiSecretBackendRootSignIntermediate extends pulumi.CustomResource {
    /**
     * Get an existing PkiSecretBackendRootSignIntermediate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PkiSecretBackendRootSignIntermediateState, opts?: pulumi.CustomResourceOptions): PkiSecretBackendRootSignIntermediate {
        return new PkiSecretBackendRootSignIntermediate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/pkiSecretBackendRootSignIntermediate:PkiSecretBackendRootSignIntermediate';

    /**
     * Returns true if the given object is an instance of PkiSecretBackendRootSignIntermediate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PkiSecretBackendRootSignIntermediate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PkiSecretBackendRootSignIntermediate.__pulumiType;
    }
    ...
    /**
     * The concatenation of the intermediate and issuing CA certificates (PEM encoded). Requires the format to be set to any
     * of: pem, pem_bundle. The value will be empty for all other formats.
     */
    ...
    /**
     * Create a PkiSecretBackendRootSignIntermediate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PkiSecretBackendRootSignIntermediateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PkiSecretBackendRootSignIntermediateArgs | PkiSecretBackendRootSignIntermediateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PkiSecretBackendRootSignIntermediateState | undefined;
            ...
            const args = argsOrState as PkiSecretBackendRootSignIntermediateArgs | undefined;
        ...
        super(PkiSecretBackendRootSignIntermediate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PkiSecretBackendRootSignIntermediate resources.
 */
export interface PkiSecretBackendRootSignIntermediateState {
    /**
     * List of alternative names.
     */
...
/**
 * The set of arguments for constructing a PkiSecretBackendRootSignIntermediate resource.
 */
export interface PkiSecretBackendRootSignIntermediateArgs {
    /**
     * List of alternative names.
     */
    altNames?: pulumi.Input<pulumi.Input<string>[]>;
