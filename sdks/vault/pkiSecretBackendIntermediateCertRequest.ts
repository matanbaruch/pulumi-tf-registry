...
export class PkiSecretBackendIntermediateCertRequest extends pulumi.CustomResource {
    /**
     * Get an existing PkiSecretBackendIntermediateCertRequest resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PkiSecretBackendIntermediateCertRequestState, opts?: pulumi.CustomResourceOptions): PkiSecretBackendIntermediateCertRequest {
        return new PkiSecretBackendIntermediateCertRequest(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/pkiSecretBackendIntermediateCertRequest:PkiSecretBackendIntermediateCertRequest';

    /**
     * Returns true if the given object is an instance of PkiSecretBackendIntermediateCertRequest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PkiSecretBackendIntermediateCertRequest {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PkiSecretBackendIntermediateCertRequest.__pulumiType;
    }

    /**
     * Set 'CA: true' in a Basic Constraints extension. Only needed as a workaround in some compatibility scenarios with Active
    ...
    /**
     * Create a PkiSecretBackendIntermediateCertRequest resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PkiSecretBackendIntermediateCertRequestArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PkiSecretBackendIntermediateCertRequestArgs | PkiSecretBackendIntermediateCertRequestState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PkiSecretBackendIntermediateCertRequestState | undefined;
            ...
            const args = argsOrState as PkiSecretBackendIntermediateCertRequestArgs | undefined;
        ...
        super(PkiSecretBackendIntermediateCertRequest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PkiSecretBackendIntermediateCertRequest resources.
 */
export interface PkiSecretBackendIntermediateCertRequestState {
    /**
     * Set 'CA: true' in a Basic Constraints extension. Only needed as a workaround in some compatibility scenarios with Active
     * Directory Certificate Services.
     */
...
/**
 * The set of arguments for constructing a PkiSecretBackendIntermediateCertRequest resource.
 */
export interface PkiSecretBackendIntermediateCertRequestArgs {
    /**
     * Set 'CA: true' in a Basic Constraints extension. Only needed as a workaround in some compatibility scenarios with Active
     * Directory Certificate Services.
     */
