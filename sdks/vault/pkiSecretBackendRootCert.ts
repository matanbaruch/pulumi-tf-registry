...
export class PkiSecretBackendRootCert extends pulumi.CustomResource {
    /**
     * Get an existing PkiSecretBackendRootCert resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PkiSecretBackendRootCertState, opts?: pulumi.CustomResourceOptions): PkiSecretBackendRootCert {
        return new PkiSecretBackendRootCert(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/pkiSecretBackendRootCert:PkiSecretBackendRootCert';

    /**
     * Returns true if the given object is an instance of PkiSecretBackendRootCert.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PkiSecretBackendRootCert {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PkiSecretBackendRootCert.__pulumiType;
    }
    ...
    /**
     * Create a PkiSecretBackendRootCert resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PkiSecretBackendRootCertArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PkiSecretBackendRootCertArgs | PkiSecretBackendRootCertState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PkiSecretBackendRootCertState | undefined;
            ...
            const args = argsOrState as PkiSecretBackendRootCertArgs | undefined;
        ...
        super(PkiSecretBackendRootCert.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PkiSecretBackendRootCert resources.
 */
export interface PkiSecretBackendRootCertState {
    /**
     * List of alternative names.
     */
...
/**
 * The set of arguments for constructing a PkiSecretBackendRootCert resource.
 */
export interface PkiSecretBackendRootCertArgs {
    /**
     * List of alternative names.
     */
    altNames?: pulumi.Input<pulumi.Input<string>[]>;
