...
export class AuthBackend extends pulumi.CustomResource {
    ...
    public readonly tunes!: pulumi.Output<outputs.AuthBackendTune[]>;
    /**
    ...
    constructor(name: string, argsOrState?: AuthBackendArgs | AuthBackendState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AuthBackend.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AuthBackendState {
    ...
    tunes?: pulumi.Input<pulumi.Input<inputs.AuthBackendTune>[]>;
    /**
     * Name of the auth backend
     */
