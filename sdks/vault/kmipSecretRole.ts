...
export class KmipSecretRole extends pulumi.CustomResource {
    /**
     * Get an existing KmipSecretRole resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KmipSecretRoleState, opts?: pulumi.CustomResourceOptions): KmipSecretRole {
        return new KmipSecretRole(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/kmipSecretRole:KmipSecretRole';

    /**
     * Returns true if the given object is an instance of KmipSecretRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KmipSecretRole {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KmipSecretRole.__pulumiType;
    }
    ...
    /**
     * Create a KmipSecretRole resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: KmipSecretRoleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KmipSecretRoleArgs | KmipSecretRoleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KmipSecretRoleState | undefined;
            ...
            const args = argsOrState as KmipSecretRoleArgs | undefined;
        ...
        super(KmipSecretRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KmipSecretRole resources.
 */
export interface KmipSecretRoleState {
    /**
     * Target namespace. (requires Enterprise)
     */
...
/**
 * The set of arguments for constructing a KmipSecretRole resource.
 */
export interface KmipSecretRoleArgs {
    /**
     * Target namespace. (requires Enterprise)
     */
    namespace?: pulumi.Input<string>;
