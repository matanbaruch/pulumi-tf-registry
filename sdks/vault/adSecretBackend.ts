...
export class AdSecretBackend extends pulumi.CustomResource {
    /**
     * Get an existing AdSecretBackend resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AdSecretBackendState, opts?: pulumi.CustomResourceOptions): AdSecretBackend {
        return new AdSecretBackend(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/adSecretBackend:AdSecretBackend';

    /**
     * Returns true if the given object is an instance of AdSecretBackend.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AdSecretBackend {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AdSecretBackend.__pulumiType;
    }
    ...
    /**
     * Create a AdSecretBackend resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AdSecretBackendArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AdSecretBackendArgs | AdSecretBackendState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AdSecretBackendState | undefined;
            ...
            const args = argsOrState as AdSecretBackendArgs | undefined;
        ...
        super(AdSecretBackend.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AdSecretBackend resources.
 */
export interface AdSecretBackendState {
    /**
     * Use anonymous binds when performing LDAP group searches (if true the initial credentials will still be used for the
     * initial connection test).
     */
...
/**
 * The set of arguments for constructing a AdSecretBackend resource.
 */
export interface AdSecretBackendArgs {
    /**
     * Use anonymous binds when performing LDAP group searches (if true the initial credentials will still be used for the
     * initial connection test).
     */
