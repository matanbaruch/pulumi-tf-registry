...
export class QuotaRateLimit extends pulumi.CustomResource {
    ...
    /**
     * If set, when a client reaches a rate limit threshold, the client will be prohibited from any further requests until
     * after the 'block_interval' in seconds has elapsed.
     */
    ...
    constructor(name: string, argsOrState?: QuotaRateLimitArgs | QuotaRateLimitState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(QuotaRateLimit.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
