...
export class IdentityMfaTotp extends pulumi.CustomResource {
    /**
     * Get an existing IdentityMfaTotp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityMfaTotpState, opts?: pulumi.CustomResourceOptions): IdentityMfaTotp {
        return new IdentityMfaTotp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/identityMfaTotp:IdentityMfaTotp';

    /**
     * Returns true if the given object is an instance of IdentityMfaTotp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityMfaTotp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityMfaTotp.__pulumiType;
    }
    ...
    /**
     * Create a IdentityMfaTotp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityMfaTotpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityMfaTotpArgs | IdentityMfaTotpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityMfaTotpState | undefined;
            ...
            const args = argsOrState as IdentityMfaTotpArgs | undefined;
        ...
        super(IdentityMfaTotp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityMfaTotp resources.
 */
export interface IdentityMfaTotpState {
    /**
     * Specifies the hashing algorithm used to generate the TOTP code. Options include SHA1, SHA256, SHA512.
     */
...
/**
 * The set of arguments for constructing a IdentityMfaTotp resource.
 */
export interface IdentityMfaTotpArgs {
    /**
     * Specifies the hashing algorithm used to generate the TOTP code. Options include SHA1, SHA256, SHA512.
     */
    algorithm?: pulumi.Input<string>;
