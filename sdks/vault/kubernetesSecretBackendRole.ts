...
export class KubernetesSecretBackendRole extends pulumi.CustomResource {
    /**
     * Get an existing KubernetesSecretBackendRole resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KubernetesSecretBackendRoleState, opts?: pulumi.CustomResourceOptions): KubernetesSecretBackendRole {
        return new KubernetesSecretBackendRole(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/kubernetesSecretBackendRole:KubernetesSecretBackendRole';

    /**
     * Returns true if the given object is an instance of KubernetesSecretBackendRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubernetesSecretBackendRole {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubernetesSecretBackendRole.__pulumiType;
    }

    /**
     * A label selector for Kubernetes namespaces in which credentials can begenerated. Accepts either a JSON or YAML object.
     * The value should be of typeLabelSelector. If set with `allowed_kubernetes_namespace`, the conditions are `OR`ed.
     */
    public readonly allowedKubernetesNamespaceSelector!: pulumi.Output<string | undefined>;
    /**
     * The list of Kubernetes namespaces this role can generate credentials for. If set to '*' all namespaces are allowed. If
     * set with`allowed_kubernetes_namespace_selector`, the conditions are `OR`ed.
     */
    ...
    /**
     * The Role or ClusterRole rules to use when generating a role. Accepts either JSON or YAML formatted rules. Mutually
     * exclusive with 'service_account_name' and 'kubernetes_role_name'. If set, the entire chain of Kubernetes objects will be
     * generated when credentials are requested.
     */
    public readonly generatedRoleRules!: pulumi.Output<string | undefined>;
    /**
     * The pre-existing Role or ClusterRole to bind a generated service account to. Mutually exclusive with
     * 'service_account_name' and 'generated_role_rules'. If set, Kubernetes token, service account, and role binding objects
     * will be created when credentials are requested.
     */
    ...
    /**
     * The name template to use when generating service accounts, roles and role bindings. If unset, a default template is
     * used.
     */
    ...
    /**
     * The pre-existing service account to generate tokens for. Mutually exclusive with 'kubernetes_role_name' and
     * 'generated_role_rules'. If set, only a Kubernetes token will be created when credentials are requested.
     */
    ...
    /**
     * Create a KubernetesSecretBackendRole resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: KubernetesSecretBackendRoleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KubernetesSecretBackendRoleArgs | KubernetesSecretBackendRoleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KubernetesSecretBackendRoleState | undefined;
            ...
            const args = argsOrState as KubernetesSecretBackendRoleArgs | undefined;
        ...
        super(KubernetesSecretBackendRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KubernetesSecretBackendRole resources.
 */
export interface KubernetesSecretBackendRoleState {
    /**
     * A label selector for Kubernetes namespaces in which credentials can begenerated. Accepts either a JSON or YAML object.
     * The value should be of typeLabelSelector. If set with `allowed_kubernetes_namespace`, the conditions are `OR`ed.
     */
...
/**
 * The set of arguments for constructing a KubernetesSecretBackendRole resource.
 */
export interface KubernetesSecretBackendRoleArgs {
    /**
     * A label selector for Kubernetes namespaces in which credentials can begenerated. Accepts either a JSON or YAML object.
     * The value should be of typeLabelSelector. If set with `allowed_kubernetes_namespace`, the conditions are `OR`ed.
     */
