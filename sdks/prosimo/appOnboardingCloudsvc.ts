...
export class AppOnboardingCloudsvc extends pulumi.CustomResource {
    /**
     * Get an existing AppOnboardingCloudsvc resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppOnboardingCloudsvcState, opts?: pulumi.CustomResourceOptions): AppOnboardingCloudsvc {
        return new AppOnboardingCloudsvc(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'prosimo:index/appOnboardingCloudsvc:AppOnboardingCloudsvc';

    /**
     * Returns true if the given object is an instance of AppOnboardingCloudsvc.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppOnboardingCloudsvc {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppOnboardingCloudsvc.__pulumiType;
    }
    ...
    public readonly appUrls!: pulumi.Output<outputs.AppOnboardingCloudsvcAppUrl[]>;
    /**
     * Client Cert details
     */
     ...
     */
    public readonly cloudSvc!: pulumi.Output<string | undefined>;
    /**
     * Choose any custom policy created from the policy library or create one
     */
    public readonly customizePolicy!: pulumi.Output<outputs.AppOnboardingCloudsvcCustomizePolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppOnboardingCloudsvcTimeouts | undefined>;
    /**
    ...
    /**
     * Create a AppOnboardingCloudsvc resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppOnboardingCloudsvcArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppOnboardingCloudsvcArgs | AppOnboardingCloudsvcState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppOnboardingCloudsvcState | undefined;
            ...
            resourceInputs["cloudSvc"] = state ? state.cloudSvc : undefined;
            ...
            const args = argsOrState as AppOnboardingCloudsvcArgs | undefined;
            ...
            resourceInputs["cloudSvc"] = args ? args.cloudSvc : undefined;
        ...
        super(AppOnboardingCloudsvc.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppOnboardingCloudsvc resources.
 */
export interface AppOnboardingCloudsvcState {
    /**
     * e.g: Agent or Agentless
     */
    ...
    appUrls?: pulumi.Input<pulumi.Input<inputs.AppOnboardingCloudsvcAppUrl>[]>;
    /**
     * Client Cert details
     */
     ...
     * Cloud service platform, as of now default platform is amazon s3
     */
    cloudSvc?: pulumi.Input<string>;
    /**
     * Choose any custom policy created from the policy library or create one
     */
    customizePolicy?: pulumi.Input<inputs.AppOnboardingCloudsvcCustomizePolicy>;
    /**
     * Set this to true if you would like app to be offboarded from fabric
     */
    ...
    timeouts?: pulumi.Input<inputs.AppOnboardingCloudsvcTimeouts>;
    /**
     * Wait for the rollout of the task to complete. Defaults to true.
     */
...
/**
 * The set of arguments for constructing a AppOnboardingCloudsvc resource.
 */
export interface AppOnboardingCloudsvcArgs {
    /**
     * name for the application
     */
    appName: pulumi.Input<string>;
