...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("prosimo");
			params.setVersion("4.4.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Byb3NpbW8taW8vcHJvc2ltbyIsInZlcnNpb24iOiI0LjQuMSJ9fQ=="), c => c.charCodeAt(0)));
