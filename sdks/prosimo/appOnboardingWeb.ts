...
export class AppOnboardingWeb extends pulumi.CustomResource {
    /**
     * Get an existing AppOnboardingWeb resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppOnboardingWebState, opts?: pulumi.CustomResourceOptions): AppOnboardingWeb {
        return new AppOnboardingWeb(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'prosimo:index/appOnboardingWeb:AppOnboardingWeb';

    /**
     * Returns true if the given object is an instance of AppOnboardingWeb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppOnboardingWeb {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppOnboardingWeb.__pulumiType;
    }
    ...
    public readonly appUrls!: pulumi.Output<outputs.AppOnboardingWebAppUrl[]>;
    /**
     * Client Cert details
     */
     ...
     */
    public readonly customizePolicy!: pulumi.Output<outputs.AppOnboardingWebCustomizePolicy | undefined>;
    /**
     ...
     */
    public readonly samlRewrite!: pulumi.Output<outputs.AppOnboardingWebSamlRewrite | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.AppOnboardingWebTimeouts | undefined>;
    /**
    ...
    /**
     * Create a AppOnboardingWeb resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppOnboardingWebArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppOnboardingWebArgs | AppOnboardingWebState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppOnboardingWebState | undefined;
            ...
            const args = argsOrState as AppOnboardingWebArgs | undefined;
        ...
        super(AppOnboardingWeb.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppOnboardingWeb resources.
 */
export interface AppOnboardingWebState {
    /**
     * e.g: Agent or Agentless
     */
    ...
    appUrls?: pulumi.Input<pulumi.Input<inputs.AppOnboardingWebAppUrl>[]>;
    /**
     * Client Cert details
     */
     ...
     * Choose any custom policy created from the policy library or create one.
     */
    customizePolicy?: pulumi.Input<inputs.AppOnboardingWebCustomizePolicy>;
    /**
     * Set this to true if you would like app to be offboarded from fabric
     */
     ...
     * App authentication option while selecting prosimo domain
     */
    samlRewrite?: pulumi.Input<inputs.AppOnboardingWebSamlRewrite>;
    timeouts?: pulumi.Input<inputs.AppOnboardingWebTimeouts>;
    /**
     * Wait for the rollout of the task to complete. Defaults to true.
     */
...
/**
 * The set of arguments for constructing a AppOnboardingWeb resource.
 */
export interface AppOnboardingWebArgs {
    /**
     * name for the application
     */
    appName: pulumi.Input<string>;
