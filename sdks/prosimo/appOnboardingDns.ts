...
export class AppOnboardingDns extends pulumi.CustomResource {
    /**
     * Get an existing AppOnboardingDns resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppOnboardingDnsState, opts?: pulumi.CustomResourceOptions): AppOnboardingDns {
        return new AppOnboardingDns(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'prosimo:index/appOnboardingDns:AppOnboardingDns';

    /**
     * Returns true if the given object is an instance of AppOnboardingDns.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppOnboardingDns {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppOnboardingDns.__pulumiType;
    }
    ...
    public readonly appUrls!: pulumi.Output<outputs.AppOnboardingDnsAppUrl[]>;
    /**
     * Choose any custom policy created from the policy library or create one.
     */
    public readonly customizePolicy!: pulumi.Output<outputs.AppOnboardingDnsCustomizePolicy | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppOnboardingDnsTimeouts | undefined>;
    /**
    ...
    /**
     * Create a AppOnboardingDns resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppOnboardingDnsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppOnboardingDnsArgs | AppOnboardingDnsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppOnboardingDnsState | undefined;
            ...
            const args = argsOrState as AppOnboardingDnsArgs | undefined;
        ...
        super(AppOnboardingDns.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppOnboardingDns resources.
 */
export interface AppOnboardingDnsState {
    /**
     * e.g: Agent or Agentless
     */
    ...
    appUrls?: pulumi.Input<pulumi.Input<inputs.AppOnboardingDnsAppUrl>[]>;
    /**
     * Choose any custom policy created from the policy library or create one.
     */
    customizePolicy?: pulumi.Input<inputs.AppOnboardingDnsCustomizePolicy>;
    /**
     * Set this to true if you would like app to be offboarded from fabric
     */
    ...
    timeouts?: pulumi.Input<inputs.AppOnboardingDnsTimeouts>;
    /**
     * Wait for the rollout of the task to complete. Defaults to true.
     */
...
/**
 * The set of arguments for constructing a AppOnboardingDns resource.
 */
export interface AppOnboardingDnsArgs {
    /**
     * name for the application
     */
    appName: pulumi.Input<string>;
