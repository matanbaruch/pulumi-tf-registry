...
export class AppOnboardingCitrixvdi extends pulumi.CustomResource {
    /**
     * Get an existing AppOnboardingCitrixvdi resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppOnboardingCitrixvdiState, opts?: pulumi.CustomResourceOptions): AppOnboardingCitrixvdi {
        return new AppOnboardingCitrixvdi(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'prosimo:index/appOnboardingCitrixvdi:AppOnboardingCitrixvdi';

    /**
     * Returns true if the given object is an instance of AppOnboardingCitrixvdi.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppOnboardingCitrixvdi {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppOnboardingCitrixvdi.__pulumiType;
    }
    ...
    public readonly appUrls!: pulumi.Output<outputs.AppOnboardingCitrixvdiAppUrl[]>;
    /**
     * List of citrix ips
     */
    public readonly citrixIps!: pulumi.Output<string[] | undefined>;
    /**
     * Client Cert details
     */
     ...
     */
    public readonly customizePolicy!: pulumi.Output<outputs.AppOnboardingCitrixvdiCustomizePolicy | undefined>;
    /**
     ...
     */
    public readonly samlRewrite!: pulumi.Output<outputs.AppOnboardingCitrixvdiSamlRewrite | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.AppOnboardingCitrixvdiTimeouts | undefined>;
    /**
    ...
    /**
     * Create a AppOnboardingCitrixvdi resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppOnboardingCitrixvdiArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppOnboardingCitrixvdiArgs | AppOnboardingCitrixvdiState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppOnboardingCitrixvdiState | undefined;
            ...
            resourceInputs["citrixIps"] = state ? state.citrixIps : undefined;
            ...
            const args = argsOrState as AppOnboardingCitrixvdiArgs | undefined;
            ...
            resourceInputs["citrixIps"] = args ? args.citrixIps : undefined;
        ...
        super(AppOnboardingCitrixvdi.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppOnboardingCitrixvdi resources.
 */
export interface AppOnboardingCitrixvdiState {
    /**
     * e.g: Agent or Agentless
     */
    ...
    appUrls?: pulumi.Input<pulumi.Input<inputs.AppOnboardingCitrixvdiAppUrl>[]>;
    /**
     * List of citrix ips
     */
    citrixIps?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * Client Cert details
     */
     ...
     * Choose any custom policy created from the policy library or create one.
     */
    customizePolicy?: pulumi.Input<inputs.AppOnboardingCitrixvdiCustomizePolicy>;
    /**
     * Set this to true if you would like app to be offboarded from fabric
     */
     ...
     * App authentication option while selecting prosimo domain
     */
    samlRewrite?: pulumi.Input<inputs.AppOnboardingCitrixvdiSamlRewrite>;
    timeouts?: pulumi.Input<inputs.AppOnboardingCitrixvdiTimeouts>;
    /**
     * Wait for the rollout of the task to complete. Defaults to true.
     */
...
/**
 * The set of arguments for constructing a AppOnboardingCitrixvdi resource.
 */
export interface AppOnboardingCitrixvdiArgs {
    /**
     * name for the application
     */
    appName: pulumi.Input<string>;
