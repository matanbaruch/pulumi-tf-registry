...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("timeplus");
			params.setVersion("0.1.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3RpbWVwbHVzLWlvL3RpbWVwbHVzIiwidmVyc2lvbiI6IjAuMS41In19"), c => c.charCodeAt(0)));
