...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pingaccess");
			params.setVersion("0.11.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2l3YXJhcHRlci9waW5nYWNjZXNzIiwidmVyc2lvbiI6IjAuMTEuMSJ9fQ=="), c => c.charCodeAt(0)));
