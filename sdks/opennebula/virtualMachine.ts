...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'opennebula:index/virtualMachine:VirtualMachine';
     ...
     */
    public readonly cpumodel!: pulumi.Output<outputs.VirtualMachineCpumodel | undefined>;
    /**
     ...
     */
    public readonly graphics!: pulumi.Output<outputs.VirtualMachineGraphics | undefined>;
    /**
     ...
     */
    public readonly keepNicOrder!: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    public readonly nics!: pulumi.Output<outputs.VirtualMachineNic[] | undefined>;
    public readonly onDiskChange!: pulumi.Output<string | undefined>;
    /**
     * Definition of OS boot and type for the Virtual Machine
     */
    public readonly os!: pulumi.Output<outputs.VirtualMachineOs | undefined>;
    /**
     ...
     */
    public readonly raw!: pulumi.Output<outputs.VirtualMachineRaw | undefined>;
    /**
     ...
     */
    public /*out*/ readonly templateDisks!: pulumi.Output<outputs.VirtualMachineTemplateDisk[]>;
    /**
     * Id of the VM template to use. Defaults to -1: no template used.
     */
    public readonly templateId!: pulumi.Output<number | undefined>;
    /**
     * Network adapter(s) assigned to the Virtual Machine via a template
     */
    public /*out*/ readonly templateNics!: pulumi.Output<outputs.VirtualMachineTemplateNic[]>;
    /**
     ...
     */
    public readonly templateSections!: pulumi.Output<outputs.VirtualMachineTemplateSection[] | undefined>;
    /**
     ...
     */
    public readonly vmgroup!: pulumi.Output<outputs.VirtualMachineVmgroup | undefined>;
    ...
    constructor(name: string, argsOrState?: VirtualMachineArgs | VirtualMachineState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["keepNicOrder"] = state ? state.keepNicOrder : undefined;
            ...
            resourceInputs["templateNics"] = state ? state.templateNics : undefined;
            ...
            resourceInputs["keepNicOrder"] = args ? args.keepNicOrder : undefined;
            ...
            resourceInputs["templateNics"] = undefined /*out*/;
...
export interface VirtualMachineState {
     ...
     * Definition of CPU Model type for the Virtual Machine
     */
    cpumodel?: pulumi.Input<inputs.VirtualMachineCpumodel>;
    /**
     * Default tags defined in the provider configuration
     */
     ...
     * Definition of graphics adapter assigned to the Virtual Machine
     */
    graphics?: pulumi.Input<inputs.VirtualMachineGraphics>;
    /**
     * Name of the Group that onws the resource, If empty, it uses caller group
     */
     ...
     * Force the provider to keep nics order at update.
     */
    keepNicOrder?: pulumi.Input<boolean>;
    /**
     * Current LCM state of the VM
     */
     ...
     * Definition of network adapter(s) assigned to the Virtual Machine
     */
    nics?: pulumi.Input<pulumi.Input<inputs.VirtualMachineNic>[]>;
    onDiskChange?: pulumi.Input<string>;
    /**
     * Definition of OS boot and type for the Virtual Machine
     */
    os?: pulumi.Input<inputs.VirtualMachineOs>;
    /**
     * Pending state of the VM during its creation, by default it is set to false
     */
     ...
     * Low-level hypervisor tuning
     */
    raw?: pulumi.Input<inputs.VirtualMachineRaw>;
    /**
     * Storage placement requirements to deploy the resource following specific rule
     */
     ...
     * Disks assigned to the Virtual Machine via a template
     */
    templateDisks?: pulumi.Input<pulumi.Input<inputs.VirtualMachineTemplateDisk>[]>;
    /**
     * Id of the VM template to use. Defaults to -1: no template used.
     */
     ...
     * Network adapter(s) assigned to the Virtual Machine via a template
     */
    templateNics?: pulumi.Input<pulumi.Input<inputs.VirtualMachineTemplateNic>[]>;
    /**
     * When template_id was set this keeps the template sections names.
     */
     ...
     * Add custom section to the resource
     */
    templateSections?: pulumi.Input<pulumi.Input<inputs.VirtualMachineTemplateSection>[]>;
    /**
     * When template_id was set this keeps the template tags.
     */
     ...
     * Virtual Machine Group to associate with during VM creation only. If it changes, a New VM is created
     */
    vmgroup?: pulumi.Input<inputs.VirtualMachineVmgroup>;
}
