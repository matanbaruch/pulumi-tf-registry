...
export class Host extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'opennebula:index/host:Host';
    ...
    public readonly customs!: pulumi.Output<outputs.HostCustom[] | undefined>;
    /**
    ...
    public readonly overcommits!: pulumi.Output<outputs.HostOvercommit[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.HostTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: HostArgs | HostState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["overcommits"] = state ? state.overcommits : undefined;
            ...
            resourceInputs["overcommits"] = args ? args.overcommits : undefined;
...
export interface HostState {
    ...
    customs?: pulumi.Input<pulumi.Input<inputs.HostCustom>[]>;
    /**
     * Default tags defined in the provider configuration
     */
    ...
    overcommits?: pulumi.Input<pulumi.Input<inputs.HostOvercommit>[]>;
    /**
     * Add custom tags to the resource
     */
    ...
    timeouts?: pulumi.Input<inputs.HostTimeouts>;
    /**
     * Type of the new host: kvm, qemu, lxd, lxc, firecracker, custom
     */
