...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("opennebula");
			params.setVersion("1.4.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL29wZW5uZWJ1bGEvb3Blbm5lYnVsYSIsInZlcnNpb24iOiIxLjQuMCJ9fQ=="), c => c.charCodeAt(0)));
