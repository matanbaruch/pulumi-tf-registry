...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("azapi");
			params.setVersion("1.15.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2F6dXJlL2F6YXBpIiwidmVyc2lvbiI6IjEuMTUuMCJ9fQ=="), c => c.charCodeAt(0)));
