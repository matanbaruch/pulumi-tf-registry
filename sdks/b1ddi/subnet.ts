...
export class Subnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'b1ddi:index/subnet:Subnet';
    ...
    /**
     * The address of the subnet in the form 'a.b.c.d/n' where the '/n' may be omitted. In this case, the CIDR value must be
     ...
     */
    public readonly asmConfig!: pulumi.Output<outputs.SubnetAsmConfig | undefined>;
    /**
     ...
     */
    public readonly cidr!: pulumi.Output<number | undefined>;
    /**
     ...
     */
    public readonly dhcpConfig!: pulumi.Output<outputs.SubnetDhcpConfig | undefined>;
    /**
     ...
     */
    public readonly dhcpOptions!: pulumi.Output<outputs.SubnetDhcpOption[] | undefined>;
    /**
     * The utilization of IP addresses within the DHCP ranges of the subnet.
     */
    public /*out*/ readonly dhcpUtilizations!: pulumi.Output<outputs.SubnetDhcpUtilization[]>;
    /**
     ...
     */
    public /*out*/ readonly inheritanceAssignedHosts!: pulumi.Output<outputs.SubnetInheritanceAssignedHost[]>;
    /**
     * The resource identifier.
     */
    public /*out*/ readonly inheritanceParent!: pulumi.Output<string>;
    /**
     * The DHCP inheritance configuration for the subnet.
     */
    public readonly inheritanceSources!: pulumi.Output<outputs.SubnetInheritanceSources | undefined>;
    /**
     * The name of the subnet. May contain 1 to 256 characters. Can include UTF-8.
     */
    public readonly name!: pulumi.Output<string>;
    /**
     * The resource ID in the form "ipam/[address_block]/<UUID>". This will create the next available resource in the given
     * address block
     */
     ...
     */
    public readonly threshold!: pulumi.Output<outputs.SubnetThreshold | undefined>;
    /**
     ...
     */
    public /*out*/ readonly utilizations!: pulumi.Output<outputs.SubnetUtilization[]>;
    ...
    constructor(name: string, argsOrState?: SubnetArgs | SubnetState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["inheritanceParent"] = undefined /*out*/;
...
export interface SubnetState {
     ...
     * The Automated Scope Management configuration for the subnet.
     */
    asmConfig?: pulumi.Input<inputs.SubnetAsmConfig>;
    /**
     * Set to 1 to indicate that the subnet may run out of addresses.
     */
     ...
     * The DHCP configuration of the subnet that controls how leases are issued.
     */
    dhcpConfig?: pulumi.Input<inputs.SubnetDhcpConfig>;
    /**
     * The resource identifier.
     */
     ...
     * The DHCP options of the subnet. This can either be a specific option or a group of options.
     */
    dhcpOptions?: pulumi.Input<pulumi.Input<inputs.SubnetDhcpOption>[]>;
    /**
     * The utilization of IP addresses within the DHCP ranges of the subnet.
     */
    dhcpUtilizations?: pulumi.Input<pulumi.Input<inputs.SubnetDhcpUtilization>[]>;
    /**
     * The configuration for header option filename field.
     */
     ...
     * The list of the inheritance assigned hosts of the object.
     */
    inheritanceAssignedHosts?: pulumi.Input<pulumi.Input<inputs.SubnetInheritanceAssignedHost>[]>;
    /**
     * The resource identifier.
     */
     ...
     * The DHCP inheritance configuration for the subnet.
     */
    inheritanceSources?: pulumi.Input<inputs.SubnetInheritanceSources>;
    /**
     * The name of the subnet. May contain 1 to 256 characters. Can include UTF-8.
     */
     ...
     * The IP address utilization threshold settings for the subnet.
     */
    threshold?: pulumi.Input<inputs.SubnetThreshold>;
    /**
     * Time when the object has been updated. Equals to _created_at_ if not updated after creation.
     */
     ...
     * The IP address utilization statistics of the subnet.
     */
    utilizations?: pulumi.Input<pulumi.Input<inputs.SubnetUtilization>[]>;
}
