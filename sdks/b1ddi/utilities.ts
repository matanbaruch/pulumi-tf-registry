...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("b1ddi");
			params.setVersion("0.1.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2luZm9ibG94b3Blbi9iMWRkaSIsInZlcnNpb24iOiIwLjEuNSJ9fQ=="), c => c.charCodeAt(0)));
