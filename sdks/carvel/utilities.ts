...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("carvel");
			params.setVersion("0.11.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3Ztd2FyZS10YW56dS9jYXJ2ZWwiLCJ2ZXJzaW9uIjoiMC4xMS4yIn19"), c => c.charCodeAt(0)));
