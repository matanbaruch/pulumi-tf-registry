...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("anxcloud");
			params.setVersion("0.6.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FuZXhpYS1pdC9hbnhjbG91ZCIsInZlcnNpb24iOiIwLjYuNCJ9fQ=="), c => c.charCodeAt(0)));
