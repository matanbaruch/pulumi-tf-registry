...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("packetfabric");
			params.setVersion("1.8.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BhY2tldGZhYnJpYy9wYWNrZXRmYWJyaWMiLCJ2ZXJzaW9uIjoiMS44LjAifX0="), c => c.charCodeAt(0)));
