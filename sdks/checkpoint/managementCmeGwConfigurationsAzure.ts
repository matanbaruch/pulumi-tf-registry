...
export class ManagementCmeGwConfigurationsAzure extends pulumi.CustomResource {
    /**
     * Get an existing ManagementCmeGwConfigurationsAzure resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementCmeGwConfigurationsAzureState, opts?: pulumi.CustomResourceOptions): ManagementCmeGwConfigurationsAzure {
        return new ManagementCmeGwConfigurationsAzure(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'checkpoint:index/managementCmeGwConfigurationsAzure:ManagementCmeGwConfigurationsAzure';

    /**
     * Returns true if the given object is an instance of ManagementCmeGwConfigurationsAzure.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ManagementCmeGwConfigurationsAzure {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagementCmeGwConfigurationsAzure.__pulumiType;
    }
     ...
     */
    public readonly blades!: pulumi.Output<outputs.ManagementCmeGwConfigurationsAzureBlades>;
    /**
     ...
     */
    public readonly repositoryGatewayScripts!: pulumi.Output<outputs.ManagementCmeGwConfigurationsAzureRepositoryGatewayScript[] | undefined>;
    /**
    ...
    /**
     * Create a ManagementCmeGwConfigurationsAzure resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ManagementCmeGwConfigurationsAzureArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ManagementCmeGwConfigurationsAzureArgs | ManagementCmeGwConfigurationsAzureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagementCmeGwConfigurationsAzureState | undefined;
            ...
            const args = argsOrState as ManagementCmeGwConfigurationsAzureArgs | undefined;
        ...
        super(ManagementCmeGwConfigurationsAzure.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ManagementCmeGwConfigurationsAzure resources.
 */
export interface ManagementCmeGwConfigurationsAzureState {
    /**
     * Base64 key for trusted communication between management and GW.
     */
     ...
     * Dictionary of activated/deactivated blades on the GW.
     */
    blades?: pulumi.Input<inputs.ManagementCmeGwConfigurationsAzureBlades>;
    /**
     * The GW configuration name.
     */
     ...
     * List of objects that each contains name/UID of a script that exists in the scripts repository on the Management server.
     */
    repositoryGatewayScripts?: pulumi.Input<pulumi.Input<inputs.ManagementCmeGwConfigurationsAzureRepositoryGatewayScript>[]>;
    /**
     * Alert Log Servers names to which alerts are sent.
     */
...
/**
 * The set of arguments for constructing a ManagementCmeGwConfigurationsAzure resource.
 */
export interface ManagementCmeGwConfigurationsAzureArgs {
    /**
     * Base64 key for trusted communication between management and GW.
     */
    base64SicKey: pulumi.Input<string>;
