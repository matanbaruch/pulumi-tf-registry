...
export class ManagementServiceUdp extends pulumi.CustomResource {
    /**
     * Get an existing ManagementServiceUdp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementServiceUdpState, opts?: pulumi.CustomResourceOptions): ManagementServiceUdp {
        return new ManagementServiceUdp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'checkpoint:index/managementServiceUdp:ManagementServiceUdp';

    /**
     * Returns true if the given object is an instance of ManagementServiceUdp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ManagementServiceUdp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagementServiceUdp.__pulumiType;
    }
    ...
    /**
     * Create a ManagementServiceUdp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ManagementServiceUdpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ManagementServiceUdpArgs | ManagementServiceUdpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagementServiceUdpState | undefined;
            ...
            const args = argsOrState as ManagementServiceUdpArgs | undefined;
        ...
        super(ManagementServiceUdp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ManagementServiceUdp resources.
 */
export interface ManagementServiceUdpState {
    /**
     * N/A
     */
...
/**
 * The set of arguments for constructing a ManagementServiceUdp resource.
 */
export interface ManagementServiceUdpArgs {
    /**
     * N/A
     */
    acceptReplies?: pulumi.Input<boolean>;
