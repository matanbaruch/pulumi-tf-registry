...
export class ManagementServiceSctp extends pulumi.CustomResource {
    /**
     * Get an existing ManagementServiceSctp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementServiceSctpState, opts?: pulumi.CustomResourceOptions): ManagementServiceSctp {
        return new ManagementServiceSctp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'checkpoint:index/managementServiceSctp:ManagementServiceSctp';

    /**
     * Returns true if the given object is an instance of ManagementServiceSctp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ManagementServiceSctp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagementServiceSctp.__pulumiType;
    }
    ...
    /**
     * Source port number. To specify a port range add a hyphen between the lowest and the highest port numbers, for example
     * 44-45.
     */
    ...
    /**
     * Create a ManagementServiceSctp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ManagementServiceSctpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ManagementServiceSctpArgs | ManagementServiceSctpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagementServiceSctpState | undefined;
            ...
            const args = argsOrState as ManagementServiceSctpArgs | undefined;
        ...
        super(ManagementServiceSctp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ManagementServiceSctp resources.
 */
export interface ManagementServiceSctpState {
    /**
     * Sets short (aggressive) timeouts for idle connections.
     */
...
/**
 * The set of arguments for constructing a ManagementServiceSctp resource.
 */
export interface ManagementServiceSctpArgs {
    /**
     * Sets short (aggressive) timeouts for idle connections.
     */
    aggressiveAging?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
