...
export class ManagementThreatException extends pulumi.CustomResource {
    /**
     * Get an existing ManagementThreatException resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementThreatExceptionState, opts?: pulumi.CustomResourceOptions): ManagementThreatException {
        return new ManagementThreatException(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'checkpoint:index/managementThreatException:ManagementThreatException';

    /**
     * Returns true if the given object is an instance of ManagementThreatException.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ManagementThreatException {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagementThreatException.__pulumiType;
    }
     ...
     */
    public readonly exceptionGroupName!: pulumi.Output<string | undefined>;
    /**
     * The UID of the exception-group.
     */
    public readonly exceptionGroupUid!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly protectionOrSites!: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    public readonly ruleUid!: pulumi.Output<string | undefined>;
    /**
    ...
    /**
     * Create a ManagementThreatException resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ManagementThreatExceptionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ManagementThreatExceptionArgs | ManagementThreatExceptionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagementThreatExceptionState | undefined;
            resourceInputs["action"] = state ? state.action : undefined;
            resourceInputs["comments"] = state ? state.comments : undefined;
            resourceInputs["destinationNegate"] = state ? state.destinationNegate : undefined;
            resourceInputs["destinations"] = state ? state.destinations : undefined;
            resourceInputs["enabled"] = state ? state.enabled : undefined;
            resourceInputs["exceptionGroupName"] = state ? state.exceptionGroupName : undefined;
            resourceInputs["exceptionGroupUid"] = state ? state.exceptionGroupUid : undefined;
            ...
            resourceInputs["protectionOrSites"] = state ? state.protectionOrSites : undefined;
            resourceInputs["ruleName"] = state ? state.ruleName : undefined;
            resourceInputs["ruleUid"] = state ? state.ruleUid : undefined;
            ...
            const args = argsOrState as ManagementThreatExceptionArgs | undefined;
            ...
            resourceInputs["exceptionGroupName"] = args ? args.exceptionGroupName : undefined;
            resourceInputs["exceptionGroupUid"] = args ? args.exceptionGroupUid : undefined;
            ...
            resourceInputs["protectionOrSites"] = args ? args.protectionOrSites : undefined;
            resourceInputs["ruleName"] = args ? args.ruleName : undefined;
            resourceInputs["ruleUid"] = args ? args.ruleUid : undefined;
        ...
        super(ManagementThreatException.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ManagementThreatException resources.
 */
export interface ManagementThreatExceptionState {
    /**
     * Action-the enforced profile.
     */
     ...
     * Name of the protection or site.
     */
    protectionOrSites?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * The name of the parent rule.
     */
...
/**
 * The set of arguments for constructing a ManagementThreatException resource.
 */
export interface ManagementThreatExceptionArgs {
    /**
     * Action-the enforced profile.
     */
    action?: pulumi.Input<string>;
