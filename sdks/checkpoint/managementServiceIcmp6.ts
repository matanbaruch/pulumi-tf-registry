...
export class ManagementServiceIcmp6 extends pulumi.CustomResource {
    /**
     * Get an existing ManagementServiceIcmp6 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementServiceIcmp6State, opts?: pulumi.CustomResourceOptions): ManagementServiceIcmp6 {
        return new ManagementServiceIcmp6(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'checkpoint:index/managementServiceIcmp6:ManagementServiceIcmp6';

    /**
     * Returns true if the given object is an instance of ManagementServiceIcmp6.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ManagementServiceIcmp6 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagementServiceIcmp6.__pulumiType;
    }
    ...
    /**
     * Create a ManagementServiceIcmp6 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ManagementServiceIcmp6Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ManagementServiceIcmp6Args | ManagementServiceIcmp6State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagementServiceIcmp6State | undefined;
            ...
            const args = argsOrState as ManagementServiceIcmp6Args | undefined;
        ...
        super(ManagementServiceIcmp6.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ManagementServiceIcmp6 resources.
 */
export interface ManagementServiceIcmp6State {
    /**
     * Color of the object. Should be one of existing colors.
     */
...
/**
 * The set of arguments for constructing a ManagementServiceIcmp6 resource.
 */
export interface ManagementServiceIcmp6Args {
    /**
     * Color of the object. Should be one of existing colors.
     */
    color?: pulumi.Input<string>;
