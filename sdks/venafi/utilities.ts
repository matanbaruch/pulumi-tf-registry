...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("venafi");
			params.setVersion("0.21.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ZlbmFmaS92ZW5hZmkiLCJ2ZXJzaW9uIjoiMC4yMS4wIn19"), c => c.charCodeAt(0)));
