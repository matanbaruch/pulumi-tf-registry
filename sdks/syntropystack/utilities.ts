...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("syntropystack");
			params.setVersion("0.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3N5bnRyb3B5bmV0L3N5bnRyb3B5c3RhY2siLCJ2ZXJzaW9uIjoiMC4zLjAifX0="), c => c.charCodeAt(0)));
