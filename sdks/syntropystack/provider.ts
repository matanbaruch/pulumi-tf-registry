...
/**
 * The provider type for the syntropystack package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'syntropystack';
    ...
    /**
     * Syntropy platform access token
     */
    public readonly accessToken!: pulumi.Output<string>;
    /**
     * Syntropy platform API URL
     */
