...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("schemas");
			params.setVersion("0.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2dyYWZhbmEvc2NoZW1hcyIsInZlcnNpb24iOiIwLjIuMCJ9fQ=="), c => c.charCodeAt(0)));
