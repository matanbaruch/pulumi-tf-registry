...
export class Category extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'outlook:index/category:Category';
    ...
    public readonly timeouts!: pulumi.Output<outputs.CategoryTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CategoryArgs | CategoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Category.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CategoryState {
    ...
    timeouts?: pulumi.Input<inputs.CategoryTimeouts>;
}
