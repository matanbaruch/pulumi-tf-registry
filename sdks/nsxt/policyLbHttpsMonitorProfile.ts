...
export class PolicyLbHttpsMonitorProfile extends pulumi.CustomResource {
    /**
     * Get an existing PolicyLbHttpsMonitorProfile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyLbHttpsMonitorProfileState, opts?: pulumi.CustomResourceOptions): PolicyLbHttpsMonitorProfile {
        return new PolicyLbHttpsMonitorProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nsxt:index/policyLbHttpsMonitorProfile:PolicyLbHttpsMonitorProfile';

    /**
     * Returns true if the given object is an instance of PolicyLbHttpsMonitorProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyLbHttpsMonitorProfile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyLbHttpsMonitorProfile.__pulumiType;
    }
     ...
     */
    public readonly requestHeaders!: pulumi.Output<outputs.PolicyLbHttpsMonitorProfileRequestHeader[] | undefined>;
    /**
    ...
    public readonly serverSsl!: pulumi.Output<outputs.PolicyLbHttpsMonitorProfileServerSsl | undefined>;
    /**
     * Set of opaque identifiers meaningful to the user
     */
    public readonly tags!: pulumi.Output<outputs.PolicyLbHttpsMonitorProfileTag[] | undefined>;
    /**
    ...
    /**
     * Create a PolicyLbHttpsMonitorProfile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PolicyLbHttpsMonitorProfileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyLbHttpsMonitorProfileArgs | PolicyLbHttpsMonitorProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyLbHttpsMonitorProfileState | undefined;
            ...
            const args = argsOrState as PolicyLbHttpsMonitorProfileArgs | undefined;
        ...
        super(PolicyLbHttpsMonitorProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyLbHttpsMonitorProfile resources.
 */
export interface PolicyLbHttpsMonitorProfileState {
    /**
     * Description for this resource
     */
     ...
     * Array of HTTP request headers
     */
    requestHeaders?: pulumi.Input<pulumi.Input<inputs.PolicyLbHttpsMonitorProfileRequestHeader>[]>;
    /**
     * Health check method for HTTP monitor type
     */
    ...
    serverSsl?: pulumi.Input<inputs.PolicyLbHttpsMonitorProfileServerSsl>;
    /**
     * Set of opaque identifiers meaningful to the user
     */
    tags?: pulumi.Input<pulumi.Input<inputs.PolicyLbHttpsMonitorProfileTag>[]>;
    /**
     * Number of seconds the target has to respond to the monitor request
     */
...
/**
 * The set of arguments for constructing a PolicyLbHttpsMonitorProfile resource.
 */
export interface PolicyLbHttpsMonitorProfileArgs {
    /**
     * Description for this resource
     */
    description?: pulumi.Input<string>;
