...
export class NatRule extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: NatRuleArgs | NatRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["matchDestinationNetwork"] = state ? state.matchDestinationNetwork : undefined;
            resourceInputs["matchSourceNetwork"] = state ? state.matchSourceNetwork : undefined;
            resourceInputs["natPass"] = state ? state.natPass : undefined;
            ...
            resourceInputs["matchDestinationNetwork"] = args ? args.matchDestinationNetwork : undefined;
            resourceInputs["matchSourceNetwork"] = args ? args.matchSourceNetwork : undefined;
            resourceInputs["natPass"] = args ? args.natPass : undefined;
        ...
        super(NatRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NatRuleState {
     ...
     * IP Address | CIDR
     */
    matchDestinationNetwork?: pulumi.Input<string>;
    /**
     * IP Address | CIDR
     */
    matchSourceNetwork?: pulumi.Input<string>;
    /**
     * A boolean flag which reflects whether the following firewall stage will be skipped
     */
    natPass?: pulumi.Input<boolean>;
    /**
     * The _revision property describes the current revision of the resource. To prevent clients from overwriting each other's
     * changes, PUT operations must include the current _revision of the resource, which clients should obtain by issuing a GET
     * operation. If the _revision provided in a PUT request is missing or stale, the operation will be rejected
     ...
     * Set of opaque identifiers meaningful to the user
     */
    tags?: pulumi.Input<pulumi.Input<inputs.NatRuleTag>[]>;
    /**
     * IP Address | IP Range | CIDR
     */
