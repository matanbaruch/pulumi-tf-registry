...
export class PolicyVmTags extends pulumi.CustomResource {
     ...
     * Resource context
     */
    public readonly context!: pulumi.Output<outputs.PolicyVmTagsContext | undefined>;
    /**
     * Instance id
     */
    ...
    constructor(name: string, argsOrState?: PolicyVmTagsArgs | PolicyVmTagsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PolicyVmTags.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PolicyVmTagsState {
     ...
     * Resource context
     */
    context?: pulumi.Input<inputs.PolicyVmTagsContext>;
    /**
     * Instance id
     */
     ...
     * Tag specificiation for corresponding segment port
     */
    ports?: pulumi.Input<pulumi.Input<inputs.PolicyVmTagsPort>[]>;
    /**
     * Set of opaque identifiers meaningful to the user
     */
    tags?: pulumi.Input<pulumi.Input<inputs.PolicyVmTagsTag>[]>;
}
