...
export class LbUdpVirtualServer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LbUdpVirtualServerState, opts?: pulumi.CustomResourceOptions): LbUdpVirtualServer {
        return new LbUdpVirtualServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nsxt:index/lbUdpVirtualServer:LbUdpVirtualServer';

    /**
     * Returns true if the given object is an instance of LbUdpVirtualServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LbUdpVirtualServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LbUdpVirtualServer.__pulumiType;
    }
     ...
     */
    public readonly tags!: pulumi.Output<outputs.LbUdpVirtualServerTag[] | undefined>;
     ...
     */
    constructor(name: string, args: LbUdpVirtualServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LbUdpVirtualServerArgs | LbUdpVirtualServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LbUdpVirtualServerState | undefined;
            ...
            const args = argsOrState as LbUdpVirtualServerArgs | undefined;
        ...
        super(LbUdpVirtualServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface LbUdpVirtualServerState {
    /**
     * Whether access log is enabled
     */
     ...
     * Set of opaque identifiers meaningful to the user
     */
    tags?: pulumi.Input<pulumi.Input<inputs.LbUdpVirtualServerTag>[]>;
}

/**
 * The set of arguments for constructing a LbUdpVirtualServer resource.
 */
export interface LbUdpVirtualServerArgs {
    /**
     * Whether access log is enabled
     */
    accessLogEnabled?: pulumi.Input<boolean>;
