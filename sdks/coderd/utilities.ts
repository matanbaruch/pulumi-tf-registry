...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("coderd");
			params.setVersion("0.0.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvZGVyL2NvZGVyZCIsInZlcnNpb24iOiIwLjAuNCJ9fQ=="), c => c.charCodeAt(0)));
