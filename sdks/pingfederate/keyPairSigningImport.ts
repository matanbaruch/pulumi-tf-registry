...
export class KeyPairSigningImport extends pulumi.CustomResource {
    /**
     * Get an existing KeyPairSigningImport resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KeyPairSigningImportState, opts?: pulumi.CustomResourceOptions): KeyPairSigningImport {
        return new KeyPairSigningImport(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingfederate:index/keyPairSigningImport:KeyPairSigningImport';

    /**
     * Returns true if the given object is an instance of KeyPairSigningImport.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KeyPairSigningImport {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KeyPairSigningImport.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly rotationSettings!: pulumi.Output<outputs.KeyPairSigningImportRotationSettings>;
    /**
    ...
    /**
     * Create a KeyPairSigningImport resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: KeyPairSigningImportArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KeyPairSigningImportArgs | KeyPairSigningImportState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KeyPairSigningImportState | undefined;
            ...
            const args = argsOrState as KeyPairSigningImportArgs | undefined;
        ...
        super(KeyPairSigningImport.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KeyPairSigningImport resources.
 */
export interface KeyPairSigningImportState {
    /**
     * Cryptographic Provider. This is only applicable if Hybrid HSM mode is true. (LOCAL, HSM)
     */
     ...
     * The local identity profile data store configuration.
     */
    rotationSettings?: pulumi.Input<inputs.KeyPairSigningImportRotationSettings>;
    /**
     * The serial number assigned by the CA
     */
...
/**
 * The set of arguments for constructing a KeyPairSigningImport resource.
 */
export interface KeyPairSigningImportArgs {
    /**
     * Cryptographic Provider. This is only applicable if Hybrid HSM mode is true. (LOCAL, HSM)
     */
    cryptoProvider?: pulumi.Input<string>;
