...
export class AuthenticationPolicies extends pulumi.CustomResource {
     ...
     */
    public readonly authnSelectionTrees!: pulumi.Output<outputs.AuthenticationPoliciesAuthnSelectionTree[]>;
    /**
     * The default authentication sources.
     */
    public readonly defaultAuthenticationSources!: pulumi.Output<outputs.AuthenticationPoliciesDefaultAuthenticationSource[]>;
    /**
     * Fail if policy finds no authentication source.
     */
    public readonly failIfNoSelection!: pulumi.Output<boolean>;
    /**
     ...
     */
    public readonly trackedHttpParameters!: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: AuthenticationPoliciesArgs | AuthenticationPoliciesState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.authnSelectionTrees === undefined) && !opts.urn) {
                throw new Error("Missing required property 'authnSelectionTrees'");
            }
