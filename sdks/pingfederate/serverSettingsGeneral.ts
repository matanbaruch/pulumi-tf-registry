...
export class ServerSettingsGeneral extends pulumi.CustomResource {
    /**
     * Get an existing ServerSettingsGeneral resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServerSettingsGeneralState, opts?: pulumi.CustomResourceOptions): ServerSettingsGeneral {
        return new ServerSettingsGeneral(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingfederate:index/serverSettingsGeneral:ServerSettingsGeneral';

    /**
     * Returns true if the given object is an instance of ServerSettingsGeneral.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServerSettingsGeneral {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServerSettingsGeneral.__pulumiType;
    }
    ...
    /**
     * Create a ServerSettingsGeneral resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ServerSettingsGeneralArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ServerSettingsGeneralArgs | ServerSettingsGeneralState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ServerSettingsGeneralState | undefined;
            ...
            const args = argsOrState as ServerSettingsGeneralArgs | undefined;
        ...
        super(ServerSettingsGeneral.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ServerSettingsGeneral resources.
 */
export interface ServerSettingsGeneralState {
    /**
     * Determines how long (in seconds) the result of testing a datastore connection is cached. The default is `300`.
     */
...
/**
 * The set of arguments for constructing a ServerSettingsGeneral resource.
 */
export interface ServerSettingsGeneralArgs {
    /**
     * Determines how long (in seconds) the result of testing a datastore connection is cached. The default is `300`.
     */
    datastoreValidationIntervalSecs?: pulumi.Input<number>;
