...
export class IncomingProxySettings extends pulumi.CustomResource {
     ...
     */
    public readonly forwardedHostHeaderIndex!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly forwardedIpAddressHeaderIndex!: pulumi.Output<string>;
    /**
     ...
     * the reverse proxy and PingFederate. Default value is `false`.
     */
    public readonly proxyTerminatesHttpsConns!: pulumi.Output<boolean>;
