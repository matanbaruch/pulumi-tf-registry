...
export class SessionSettings extends pulumi.CustomResource {
     ...
     */
    public readonly revokeUserSessionOnLogout!: pulumi.Output<boolean>;
    /**
     * How long a session revocation is tracked and stored, in minutes. The default is `40`.
     */
    public readonly sessionRevocationLifetime!: pulumi.Output<number>;
    /**
     * Determines whether adapter sessions are tracked for cleanup during single logout. The default is `false`.
     */
    public readonly trackAdapterSessionsForLogout!: pulumi.Output<boolean>;
