...
export class KeypairSigning extends pulumi.CustomResource {
    /**
     * Get an existing KeypairSigning resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KeypairSigningState, opts?: pulumi.CustomResourceOptions): KeypairSigning {
        return new KeypairSigning(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'pingfederate:index/keypairSigning:KeypairSigning';

    /**
     * Returns true if the given object is an instance of KeypairSigning.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KeypairSigning {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KeypairSigning.__pulumiType;
    }
    ...
    /**
     * Create a KeypairSigning resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: KeypairSigningArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KeypairSigningArgs | KeypairSigningState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KeypairSigningState | undefined;
            ...
            const args = argsOrState as KeypairSigningArgs | undefined;
        ...
        super(KeypairSigning.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KeypairSigning resources.
 */
export interface KeypairSigningState {
    /**
     * City.
     */
...
/**
 * The set of arguments for constructing a KeypairSigning resource.
 */
export interface KeypairSigningArgs {
    /**
     * City.
     */
    city?: pulumi.Input<string>;
