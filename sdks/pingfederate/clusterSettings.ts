...
export class ClusterSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'pingfederate:index/clusterSettings:ClusterSettings';
    ...
    /**
     * Whether changes to OAuth clients will automatically be replicated to the cluster. This setting only applies when using
     * XML Client storage. Defaults to `false`.
     */
    public readonly replicateClientsOnSave!: pulumi.Output<boolean>;
    /**
     * Whether changes to connections will automatically be replicated to the cluster. Defaults to `false`.
     */
    public readonly replicateConnectionsOnSave!: pulumi.Output<boolean>;
    ...
    constructor(name: string, argsOrState?: ClusterSettingsArgs | ClusterSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["replicateClientsOnSave"] = state ? state.replicateClientsOnSave : undefined;
            resourceInputs["replicateConnectionsOnSave"] = state ? state.replicateConnectionsOnSave : undefined;
        } else {
            const args = argsOrState as ClusterSettingsArgs | undefined;
            resourceInputs["replicateClientsOnSave"] = args ? args.replicateClientsOnSave : undefined;
            resourceInputs["replicateConnectionsOnSave"] = args ? args.replicateConnectionsOnSave : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(ClusterSettings.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ClusterSettingsState {
     ...
     * XML Client storage. Defaults to `false`.
     */
    replicateClientsOnSave?: pulumi.Input<boolean>;
    /**
     * Whether changes to connections will automatically be replicated to the cluster. Defaults to `false`.
     */
    replicateConnectionsOnSave?: pulumi.Input<boolean>;
}
