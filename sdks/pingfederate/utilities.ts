...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pingfederate");
			params.setVersion("0.15.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BpbmdpZGVudGl0eS9waW5nZmVkZXJhdGUiLCJ2ZXJzaW9uIjoiMC4xNS4wIn19"), c => c.charCodeAt(0)));
