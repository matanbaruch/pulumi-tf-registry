...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudscale");
			params.setVersion("4.4.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Nsb3Vkc2NhbGUtY2gvY2xvdWRzY2FsZSIsInZlcnNpb24iOiI0LjQuMCJ9fQ=="), c => c.charCodeAt(0)));
