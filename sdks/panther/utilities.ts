...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("panther");
			params.setVersion("0.1.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BhbnRoZXItbGFicy9wYW50aGVyIiwidmVyc2lvbiI6IjAuMS40In19"), c => c.charCodeAt(0)));
