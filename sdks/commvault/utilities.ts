...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("commvault");
			params.setVersion("1.2.10");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvbW12YXVsdC9jb21tdmF1bHQiLCJ2ZXJzaW9uIjoiMS4yLjEwIn19"), c => c.charCodeAt(0)));
