...
export class KafkaClusterV2 extends pulumi.CustomResource {
    /**
     * Get an existing KafkaClusterV2 resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KafkaClusterV2State, opts?: pulumi.CustomResourceOptions): KafkaClusterV2 {
        return new KafkaClusterV2(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'instaclustr:index/kafkaClusterV2:KafkaClusterV2';

    /**
     * Returns true if the given object is an instance of KafkaClusterV2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KafkaClusterV2 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KafkaClusterV2.__pulumiType;
    }
     ...
     */
    public readonly collocatedZookeepers!: pulumi.Output<outputs.KafkaClusterV2CollocatedZookeeper[] | undefined>;
    /**
     ...
     */
    public readonly dataCentres!: pulumi.Output<outputs.KafkaClusterV2DataCentre[]>;
    /**
     ...
     */
    public readonly dedicatedKraftControllers!: pulumi.Output<outputs.KafkaClusterV2DedicatedKraftController[] | undefined>;
    /**
     * Provision additional dedicated nodes for Apache Zookeeper to run on. Zookeeper nodes will be co-located with Kafka if
     * this is not provided
     */
    public readonly dedicatedZookeepers!: pulumi.Output<outputs.KafkaClusterV2DedicatedZookeeper[] | undefined>;
    /**
     ...
     */
    public readonly karapaceRestProxies!: pulumi.Output<outputs.KafkaClusterV2KarapaceRestProxy[] | undefined>;
    /**
     * Adds the specified version of Kafka Karapace Schema Registry to this Kafka cluster.
     */
    public readonly karapaceSchemaRegistries!: pulumi.Output<outputs.KafkaClusterV2KarapaceSchemaRegistry[] | undefined>;
    /**
     ...
     */
    public readonly krafts!: pulumi.Output<outputs.KafkaClusterV2Kraft[] | undefined>;
    /**
     * Name of the cluster.
     */
     ...
     */
    public readonly resizeSettings!: pulumi.Output<outputs.KafkaClusterV2ResizeSetting[] | undefined>;
    /**
     * Adds the specified version of Kafka REST Proxy to this Kafka cluster.
     */
    public readonly restProxies!: pulumi.Output<outputs.KafkaClusterV2RestProxy[] | undefined>;
    /**
     * Adds the specified version of Kafka Schema Registry to this Kafka cluster.
     */
    public readonly schemaRegistries!: pulumi.Output<outputs.KafkaClusterV2SchemaRegistry[] | undefined>;
    /**
     ...
     */
    public readonly tieredStorages!: pulumi.Output<outputs.KafkaClusterV2TieredStorage[] | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.KafkaClusterV2Timeouts | undefined>;
    public readonly twoFactorDeletes!: pulumi.Output<outputs.KafkaClusterV2TwoFactorDelete[] | undefined>;

    /**
     * Create a KafkaClusterV2 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: KafkaClusterV2Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KafkaClusterV2Args | KafkaClusterV2State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KafkaClusterV2State | undefined;
            ...
            const args = argsOrState as KafkaClusterV2Args | undefined;
        ...
        super(KafkaClusterV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KafkaClusterV2 resources.
 */
export interface KafkaClusterV2State {
    /**
     * Allows topics to be deleted via the kafka-topics tool
     */
     ...
     * 3.6.1 and later will use KRaft instead of Zookeeper unless this is specified.
     */
    collocatedZookeepers?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2CollocatedZookeeper>[]>;
    /**
     * Indicates if the cluster is currently performing any restructuring operation such as being created or resized
     */
     ...
     * List of data centre settings.
     */
    dataCentres?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2DataCentre>[]>;
    /**
     * Provision additional dedicated nodes for KRaft Controllers. If this is not provided, some Kafka brokers will be required
     * to act as KRaft controllers.
     */
    dedicatedKraftControllers?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2DedicatedKraftController>[]>;
    /**
     * Provision additional dedicated nodes for Apache Zookeeper to run on. Zookeeper nodes will be co-located with Kafka if
     * this is not provided
     */
    dedicatedZookeepers?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2DedicatedZookeeper>[]>;
    /**
     * Default number of partitions to use when created new topics.
     */
     ...
     * Adds the specified version of Kafka Karapace REST Proxy to this Kafka cluster.
     */
    karapaceRestProxies?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2KarapaceRestProxy>[]>;
    /**
     * Adds the specified version of Kafka Karapace Schema Registry to this Kafka cluster.
     */
    karapaceSchemaRegistries?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2KarapaceSchemaRegistry>[]>;
    /**
     * Create a collocated KRaft Cluster. Note that this is the default behaviour for Kafka clusters provisioned using Kafka
     * 3.6.1 and later. Kafka clusters provisioned with earlier Kafka versions will use a collocated Zookeeper cluster instead.
     */
    krafts?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2Kraft>[]>;
    /**
     * Name of the cluster.
     */
     ...
     * Settings to determine how resize requests will be performed for the cluster.
     */
    resizeSettings?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2ResizeSetting>[]>;
    /**
     * Adds the specified version of Kafka REST Proxy to this Kafka cluster.
     */
    restProxies?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2RestProxy>[]>;
    /**
     * Adds the specified version of Kafka Schema Registry to this Kafka cluster.
     */
    schemaRegistries?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2SchemaRegistry>[]>;
    /**
     * SLA Tier of the cluster. Non-production clusters may receive lower priority support and reduced SLAs. Production tier is
     * not available when using Developer class nodes. See [SLA
     * Tier](https://www.instaclustr.com/support/documentation/useful-information/sla-tier/) for more information.
     ...
     * Enable Tiered Storage for Kafka
     */
    tieredStorages?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2TieredStorage>[]>;
    timeouts?: pulumi.Input<inputs.KafkaClusterV2Timeouts>;
    twoFactorDeletes?: pulumi.Input<pulumi.Input<inputs.KafkaClusterV2TwoFactorDelete>[]>;
}

/**
 * The set of arguments for constructing a KafkaClusterV2 resource.
 */
export interface KafkaClusterV2Args {
    /**
     * Allows topics to be deleted via the kafka-topics tool
     */
    allowDeleteTopics: pulumi.Input<boolean>;
