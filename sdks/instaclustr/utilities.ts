...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("instaclustr");
			params.setVersion("2.0.150");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2luc3RhY2x1c3RyL2luc3RhY2x1c3RyIiwidmVyc2lvbiI6IjIuMC4xNTAifX0="), c => c.charCodeAt(0)));
