...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("triton");
			params.setVersion("0.8.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2pveWVudC90cml0b24iLCJ2ZXJzaW9uIjoiMC44LjIifX0="), c => c.charCodeAt(0)));
