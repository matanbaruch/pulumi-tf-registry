...
export class Organization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'snyk:index/organization:Organization';
     ...
     */
    public readonly sourceOrganizationId!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: OrganizationArgs | OrganizationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sourceOrganizationId"] = state ? state.sourceOrganizationId : undefined;
        } else {
            const args = argsOrState as OrganizationArgs | undefined;
            resourceInputs["groupId"] = args ? args.groupId : undefined;
            resourceInputs["name"] = args ? args.name : undefined;
            resourceInputs["sourceOrganizationId"] = args ? args.sourceOrganizationId : undefined;
        }
...
export interface OrganizationState {
     ...
     * The id of an organization to copy settings from.
     */
    sourceOrganizationId?: pulumi.Input<string>;
}
