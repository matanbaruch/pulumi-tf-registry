...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("brightbox");
			params.setVersion("3.4.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2JyaWdodGJveC9icmlnaHRib3giLCJ2ZXJzaW9uIjoiMy40LjMifX0="), c => c.charCodeAt(0)));
