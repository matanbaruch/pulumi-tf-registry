...
export class TacacsCommandSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/tacacsCommandSet:TacacsCommandSet';
    ...
    public readonly commands!: pulumi.Output<outputs.TacacsCommandSetCommand[] | undefined>;
    /**
     * Description
     */
    ...
    constructor(name: string, argsOrState?: TacacsCommandSetArgs | TacacsCommandSetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TacacsCommandSet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface TacacsCommandSetState {
    commands?: pulumi.Input<pulumi.Input<inputs.TacacsCommandSetCommand>[]>;
    /**
     * Description
     */
