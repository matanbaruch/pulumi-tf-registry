...
export class NetworkAccessPolicySet extends pulumi.CustomResource {
    /**
     * Get an existing NetworkAccessPolicySet resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAccessPolicySetState, opts?: pulumi.CustomResourceOptions): NetworkAccessPolicySet {
        return new NetworkAccessPolicySet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/networkAccessPolicySet:NetworkAccessPolicySet';

    /**
     * Returns true if the given object is an instance of NetworkAccessPolicySet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkAccessPolicySet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkAccessPolicySet.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessPolicySetChildren[] | undefined>;
    /**
    ...
    /**
     * Create a NetworkAccessPolicySet resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkAccessPolicySetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkAccessPolicySetArgs | NetworkAccessPolicySetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkAccessPolicySetState | undefined;
            ...
            const args = argsOrState as NetworkAccessPolicySetArgs | undefined;
        ...
        super(NetworkAccessPolicySet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkAccessPolicySet resources.
 */
export interface NetworkAccessPolicySetState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessPolicySetChildren>[]>;
    /**
     * Dictionary attribute name
     */
...
/**
 * The set of arguments for constructing a NetworkAccessPolicySet resource.
 */
export interface NetworkAccessPolicySetArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessPolicySetChildren>[]>;
