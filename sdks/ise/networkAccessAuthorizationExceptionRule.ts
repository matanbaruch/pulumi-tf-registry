...
export class NetworkAccessAuthorizationExceptionRule extends pulumi.CustomResource {
    /**
     * Get an existing NetworkAccessAuthorizationExceptionRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAccessAuthorizationExceptionRuleState, opts?: pulumi.CustomResourceOptions): NetworkAccessAuthorizationExceptionRule {
        return new NetworkAccessAuthorizationExceptionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/networkAccessAuthorizationExceptionRule:NetworkAccessAuthorizationExceptionRule';

    /**
     * Returns true if the given object is an instance of NetworkAccessAuthorizationExceptionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkAccessAuthorizationExceptionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkAccessAuthorizationExceptionRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessAuthorizationExceptionRuleChildren[] | undefined>;
    /**
    ...
    /**
     * Create a NetworkAccessAuthorizationExceptionRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkAccessAuthorizationExceptionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkAccessAuthorizationExceptionRuleArgs | NetworkAccessAuthorizationExceptionRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkAccessAuthorizationExceptionRuleState | undefined;
            ...
            const args = argsOrState as NetworkAccessAuthorizationExceptionRuleArgs | undefined;
        ...
        super(NetworkAccessAuthorizationExceptionRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkAccessAuthorizationExceptionRule resources.
 */
export interface NetworkAccessAuthorizationExceptionRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorizationExceptionRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
...
/**
 * The set of arguments for constructing a NetworkAccessAuthorizationExceptionRule resource.
 */
export interface NetworkAccessAuthorizationExceptionRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorizationExceptionRuleChildren>[]>;
