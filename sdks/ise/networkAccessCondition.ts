...
export class NetworkAccessCondition extends pulumi.CustomResource {
    /**
     * Get an existing NetworkAccessCondition resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAccessConditionState, opts?: pulumi.CustomResourceOptions): NetworkAccessCondition {
        return new NetworkAccessCondition(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/networkAccessCondition:NetworkAccessCondition';

    /**
     * Returns true if the given object is an instance of NetworkAccessCondition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkAccessCondition {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkAccessCondition.__pulumiType;
    }
     ...
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessConditionChildren[] | undefined>;
    /**
    ...
    /**
     * Create a NetworkAccessCondition resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkAccessConditionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkAccessConditionArgs | NetworkAccessConditionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkAccessConditionState | undefined;
            ...
            const args = argsOrState as NetworkAccessConditionArgs | undefined;
        ...
        super(NetworkAccessCondition.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkAccessCondition resources.
 */
export interface NetworkAccessConditionState {
    /**
     * Dictionary attribute name
     */
     ...
     * List of child conditions. `condition_type` must be one of `LibraryConditionAndBlock` or `LibraryConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessConditionChildren>[]>;
    /**
     * Indicates whether the record is the condition itself or a logical aggregation. Logical aggreation indicates that
     * additional conditions are present under the children attribute. - Choices: `LibraryConditionAndBlock`,
     * `LibraryConditionAttributes`, `LibraryConditionOrBlock`
...
/**
 * The set of arguments for constructing a NetworkAccessCondition resource.
 */
export interface NetworkAccessConditionArgs {
    /**
     * Dictionary attribute name
     */
    attributeName?: pulumi.Input<string>;
