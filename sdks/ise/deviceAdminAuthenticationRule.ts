...
export class DeviceAdminAuthenticationRule extends pulumi.CustomResource {
    /**
     * Get an existing DeviceAdminAuthenticationRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceAdminAuthenticationRuleState, opts?: pulumi.CustomResourceOptions): DeviceAdminAuthenticationRule {
        return new DeviceAdminAuthenticationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/deviceAdminAuthenticationRule:DeviceAdminAuthenticationRule';

    /**
     * Returns true if the given object is an instance of DeviceAdminAuthenticationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DeviceAdminAuthenticationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DeviceAdminAuthenticationRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.DeviceAdminAuthenticationRuleChildren[] | undefined>;
    /**
    ...
    /**
     * Create a DeviceAdminAuthenticationRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DeviceAdminAuthenticationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DeviceAdminAuthenticationRuleArgs | DeviceAdminAuthenticationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceAdminAuthenticationRuleState | undefined;
            ...
            const args = argsOrState as DeviceAdminAuthenticationRuleArgs | undefined;
        ...
        super(DeviceAdminAuthenticationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DeviceAdminAuthenticationRule resources.
 */
export interface DeviceAdminAuthenticationRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminAuthenticationRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
...
/**
 * The set of arguments for constructing a DeviceAdminAuthenticationRule resource.
 */
export interface DeviceAdminAuthenticationRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminAuthenticationRuleChildren>[]>;
