...
export class DeviceAdminAuthorizationExceptionRule extends pulumi.CustomResource {
    /**
     * Get an existing DeviceAdminAuthorizationExceptionRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceAdminAuthorizationExceptionRuleState, opts?: pulumi.CustomResourceOptions): DeviceAdminAuthorizationExceptionRule {
        return new DeviceAdminAuthorizationExceptionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/deviceAdminAuthorizationExceptionRule:DeviceAdminAuthorizationExceptionRule';

    /**
     * Returns true if the given object is an instance of DeviceAdminAuthorizationExceptionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DeviceAdminAuthorizationExceptionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DeviceAdminAuthorizationExceptionRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.DeviceAdminAuthorizationExceptionRuleChildren[] | undefined>;
    /**
    ...
    /**
     * Create a DeviceAdminAuthorizationExceptionRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DeviceAdminAuthorizationExceptionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DeviceAdminAuthorizationExceptionRuleArgs | DeviceAdminAuthorizationExceptionRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceAdminAuthorizationExceptionRuleState | undefined;
            ...
            const args = argsOrState as DeviceAdminAuthorizationExceptionRuleArgs | undefined;
        ...
        super(DeviceAdminAuthorizationExceptionRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DeviceAdminAuthorizationExceptionRule resources.
 */
export interface DeviceAdminAuthorizationExceptionRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminAuthorizationExceptionRuleChildren>[]>;
    /**
     * Command sets enforce the specified list of commands that can be executed by a device administrator
     */
...
/**
 * The set of arguments for constructing a DeviceAdminAuthorizationExceptionRule resource.
 */
export interface DeviceAdminAuthorizationExceptionRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminAuthorizationExceptionRuleChildren>[]>;
