...
export class NetworkAccessAuthorizationRule extends pulumi.CustomResource {
    /**
     * Get an existing NetworkAccessAuthorizationRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAccessAuthorizationRuleState, opts?: pulumi.CustomResourceOptions): NetworkAccessAuthorizationRule {
        return new NetworkAccessAuthorizationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/networkAccessAuthorizationRule:NetworkAccessAuthorizationRule';

    /**
     * Returns true if the given object is an instance of NetworkAccessAuthorizationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkAccessAuthorizationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkAccessAuthorizationRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessAuthorizationRuleChildren[] | undefined>;
    /**
    ...
    /**
     * Create a NetworkAccessAuthorizationRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkAccessAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkAccessAuthorizationRuleArgs | NetworkAccessAuthorizationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkAccessAuthorizationRuleState | undefined;
            ...
            const args = argsOrState as NetworkAccessAuthorizationRuleArgs | undefined;
        ...
        super(NetworkAccessAuthorizationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkAccessAuthorizationRule resources.
 */
export interface NetworkAccessAuthorizationRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorizationRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
...
/**
 * The set of arguments for constructing a NetworkAccessAuthorizationRule resource.
 */
export interface NetworkAccessAuthorizationRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorizationRuleChildren>[]>;
