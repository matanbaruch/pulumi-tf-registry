...
export class DeviceAdminAuthorizationRule extends pulumi.CustomResource {
    /**
     * Get an existing DeviceAdminAuthorizationRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceAdminAuthorizationRuleState, opts?: pulumi.CustomResourceOptions): DeviceAdminAuthorizationRule {
        return new DeviceAdminAuthorizationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/deviceAdminAuthorizationRule:DeviceAdminAuthorizationRule';

    /**
     * Returns true if the given object is an instance of DeviceAdminAuthorizationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DeviceAdminAuthorizationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DeviceAdminAuthorizationRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.DeviceAdminAuthorizationRuleChildren[] | undefined>;
    /**
    ...
    /**
     * Create a DeviceAdminAuthorizationRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DeviceAdminAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DeviceAdminAuthorizationRuleArgs | DeviceAdminAuthorizationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceAdminAuthorizationRuleState | undefined;
            ...
            const args = argsOrState as DeviceAdminAuthorizationRuleArgs | undefined;
        ...
        super(DeviceAdminAuthorizationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DeviceAdminAuthorizationRule resources.
 */
export interface DeviceAdminAuthorizationRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminAuthorizationRuleChildren>[]>;
    /**
     * Command sets enforce the specified list of commands that can be executed by a device administrator
     */
...
/**
 * The set of arguments for constructing a DeviceAdminAuthorizationRule resource.
 */
export interface DeviceAdminAuthorizationRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminAuthorizationRuleChildren>[]>;
