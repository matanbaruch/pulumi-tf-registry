...
export class ActiveDirectoryAddGroups extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/activeDirectoryAddGroups:ActiveDirectoryAddGroups';
     ...
     * List of AD Groups
     */
    public readonly groups!: pulumi.Output<outputs.ActiveDirectoryAddGroupsGroup[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ActiveDirectoryAddGroupsArgs | ActiveDirectoryAddGroupsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ActiveDirectoryAddGroups.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ActiveDirectoryAddGroupsState {
     ...
     * List of AD Groups
     */
    groups?: pulumi.Input<pulumi.Input<inputs.ActiveDirectoryAddGroupsGroup>[]>;
    /**
     * Active Directory Join Point ID
     */
