...
export class NetworkAccessAuthorizationGlobalExceptionRule extends pulumi.CustomResource {
    /**
     * Get an existing NetworkAccessAuthorizationGlobalExceptionRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAccessAuthorizationGlobalExceptionRuleState, opts?: pulumi.CustomResourceOptions): NetworkAccessAuthorizationGlobalExceptionRule {
        return new NetworkAccessAuthorizationGlobalExceptionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/networkAccessAuthorizationGlobalExceptionRule:NetworkAccessAuthorizationGlobalExceptionRule';

    /**
     * Returns true if the given object is an instance of NetworkAccessAuthorizationGlobalExceptionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkAccessAuthorizationGlobalExceptionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkAccessAuthorizationGlobalExceptionRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessAuthorizationGlobalExceptionRuleChildren[] | undefined>;
    /**
    ...
    /**
     * Create a NetworkAccessAuthorizationGlobalExceptionRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: NetworkAccessAuthorizationGlobalExceptionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkAccessAuthorizationGlobalExceptionRuleArgs | NetworkAccessAuthorizationGlobalExceptionRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkAccessAuthorizationGlobalExceptionRuleState | undefined;
            ...
            const args = argsOrState as NetworkAccessAuthorizationGlobalExceptionRuleArgs | undefined;
        ...
        super(NetworkAccessAuthorizationGlobalExceptionRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkAccessAuthorizationGlobalExceptionRule resources.
 */
export interface NetworkAccessAuthorizationGlobalExceptionRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorizationGlobalExceptionRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
...
/**
 * The set of arguments for constructing a NetworkAccessAuthorizationGlobalExceptionRule resource.
 */
export interface NetworkAccessAuthorizationGlobalExceptionRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthorizationGlobalExceptionRuleChildren>[]>;
