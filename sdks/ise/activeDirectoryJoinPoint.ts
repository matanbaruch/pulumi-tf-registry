...
export class ActiveDirectoryJoinPoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/activeDirectoryJoinPoint:ActiveDirectoryJoinPoint';
     ...
     */
    public readonly attributes!: pulumi.Output<outputs.ActiveDirectoryJoinPointAttribute[] | undefined>;
    /**
     ...
     * List of AD Groups
     */
    public readonly groups!: pulumi.Output<outputs.ActiveDirectoryJoinPointGroup[] | undefined>;
    /**
     ...
     */
    public readonly rewriteRules!: pulumi.Output<outputs.ActiveDirectoryJoinPointRewriteRule[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ActiveDirectoryJoinPointArgs | ActiveDirectoryJoinPointState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ActiveDirectoryJoinPoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ActiveDirectoryJoinPointState {
     ...
     * List of AD attributes
     */
    attributes?: pulumi.Input<pulumi.Input<inputs.ActiveDirectoryJoinPointAttribute>[]>;
    /**
     * Enable prevent AD account lockout for WIRELESS/WIRED/BOTH - Choices: `WIRELESS`, `WIRED`, `BOTH`
     */
     ...
     * List of AD Groups
     */
    groups?: pulumi.Input<pulumi.Input<inputs.ActiveDirectoryJoinPointGroup>[]>;
    /**
     * Identity Not In AD Behaviour - Choices: `REJECT`, `SEARCH_JOINED_FOREST`, `SEARCH_ALL`
     */
     ...
     * List of Rewrite rules
     */
    rewriteRules?: pulumi.Input<pulumi.Input<inputs.ActiveDirectoryJoinPointRewriteRule>[]>;
    /**
     * Schema - Choices: `ACTIVE_DIRECTORY`, `CUSTOM`
     */
