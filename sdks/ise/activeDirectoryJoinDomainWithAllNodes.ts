...
export class ActiveDirectoryJoinDomainWithAllNodes extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/activeDirectoryJoinDomainWithAllNodes:ActiveDirectoryJoinDomainWithAllNodes';
    ...
    public readonly additionalDatas!: pulumi.Output<outputs.ActiveDirectoryJoinDomainWithAllNodesAdditionalData[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ActiveDirectoryJoinDomainWithAllNodesArgs | ActiveDirectoryJoinDomainWithAllNodesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ActiveDirectoryJoinDomainWithAllNodes.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ActiveDirectoryJoinDomainWithAllNodesState {
    additionalDatas?: pulumi.Input<pulumi.Input<inputs.ActiveDirectoryJoinDomainWithAllNodesAdditionalData>[]>;
    /**
     * Active Directory Join Point ID
     */
