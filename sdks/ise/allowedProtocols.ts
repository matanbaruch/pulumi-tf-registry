...
export class AllowedProtocols extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/allowedProtocols:AllowedProtocols';
    ...
    constructor(name: string, argsOrState?: AllowedProtocolsArgs | AllowedProtocolsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AllowedProtocols.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
