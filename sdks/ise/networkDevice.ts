...
export class NetworkDevice extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/networkDevice:NetworkDevice';
     ...
     * List of IP subnets
     */
    public readonly ips!: pulumi.Output<outputs.NetworkDeviceIp[]>;
    /**
     * Model name
     */
...
export interface NetworkDeviceState {
     ...
     * List of IP subnets
     */
    ips?: pulumi.Input<pulumi.Input<inputs.NetworkDeviceIp>[]>;
    /**
     * Model name
     */
