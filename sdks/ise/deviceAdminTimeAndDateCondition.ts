...
export class DeviceAdminTimeAndDateCondition extends pulumi.CustomResource {
    /**
     * Get an existing DeviceAdminTimeAndDateCondition resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceAdminTimeAndDateConditionState, opts?: pulumi.CustomResourceOptions): DeviceAdminTimeAndDateCondition {
        return new DeviceAdminTimeAndDateCondition(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/deviceAdminTimeAndDateCondition:DeviceAdminTimeAndDateCondition';

    /**
     * Returns true if the given object is an instance of DeviceAdminTimeAndDateCondition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DeviceAdminTimeAndDateCondition {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DeviceAdminTimeAndDateCondition.__pulumiType;
    }
    ...
    /**
     * Create a DeviceAdminTimeAndDateCondition resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: DeviceAdminTimeAndDateConditionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DeviceAdminTimeAndDateConditionArgs | DeviceAdminTimeAndDateConditionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceAdminTimeAndDateConditionState | undefined;
            ...
            const args = argsOrState as DeviceAdminTimeAndDateConditionArgs | undefined;
        ...
        super(DeviceAdminTimeAndDateCondition.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DeviceAdminTimeAndDateCondition resources.
 */
export interface DeviceAdminTimeAndDateConditionState {
    /**
     * Condition description
     */
...
/**
 * The set of arguments for constructing a DeviceAdminTimeAndDateCondition resource.
 */
export interface DeviceAdminTimeAndDateConditionArgs {
    /**
     * Condition description
     */
    description?: pulumi.Input<string>;
