...
export class AllowedProtocolsTacacs extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/allowedProtocolsTacacs:AllowedProtocolsTacacs';
    ...
    constructor(name: string, argsOrState?: AllowedProtocolsTacacsArgs | AllowedProtocolsTacacsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AllowedProtocolsTacacs.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
