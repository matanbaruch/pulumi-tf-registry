...
export class DownloadableAcl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/downloadableAcl:DownloadableAcl';
    ...
    constructor(name: string, argsOrState?: DownloadableAclArgs | DownloadableAclState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DownloadableAcl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
