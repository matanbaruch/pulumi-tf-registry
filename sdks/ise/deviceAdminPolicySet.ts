...
export class DeviceAdminPolicySet extends pulumi.CustomResource {
    /**
     * Get an existing DeviceAdminPolicySet resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeviceAdminPolicySetState, opts?: pulumi.CustomResourceOptions): DeviceAdminPolicySet {
        return new DeviceAdminPolicySet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/deviceAdminPolicySet:DeviceAdminPolicySet';

    /**
     * Returns true if the given object is an instance of DeviceAdminPolicySet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DeviceAdminPolicySet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DeviceAdminPolicySet.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.DeviceAdminPolicySetChildren[] | undefined>;
    /**
    ...
    /**
     * Create a DeviceAdminPolicySet resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DeviceAdminPolicySetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DeviceAdminPolicySetArgs | DeviceAdminPolicySetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DeviceAdminPolicySetState | undefined;
            ...
            const args = argsOrState as DeviceAdminPolicySetArgs | undefined;
        ...
        super(DeviceAdminPolicySet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DeviceAdminPolicySet resources.
 */
export interface DeviceAdminPolicySetState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminPolicySetChildren>[]>;
    /**
     * Dictionary attribute name
     */
...
/**
 * The set of arguments for constructing a DeviceAdminPolicySet resource.
 */
export interface DeviceAdminPolicySetArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.DeviceAdminPolicySetChildren>[]>;
