...
export class IdentitySourceSequence extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/identitySourceSequence:IdentitySourceSequence';
    ...
    public readonly identitySources!: pulumi.Output<outputs.IdentitySourceSequenceIdentitySource[]>;
    /**
    ...
    constructor(name: string, argsOrState?: IdentitySourceSequenceArgs | IdentitySourceSequenceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IdentitySourceSequence.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface IdentitySourceSequenceState {
    ...
    identitySources?: pulumi.Input<pulumi.Input<inputs.IdentitySourceSequenceIdentitySource>[]>;
    /**
     * The name of the identity source sequence
     */
