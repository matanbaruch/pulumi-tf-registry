...
export class CertificateAuthenticationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/certificateAuthenticationProfile:CertificateAuthenticationProfile';
    ...
    constructor(name: string, argsOrState?: CertificateAuthenticationProfileArgs | CertificateAuthenticationProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CertificateAuthenticationProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
