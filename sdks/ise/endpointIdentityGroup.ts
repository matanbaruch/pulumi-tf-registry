...
export class EndpointIdentityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/endpointIdentityGroup:EndpointIdentityGroup';
    ...
    constructor(name: string, argsOrState?: EndpointIdentityGroupArgs | EndpointIdentityGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EndpointIdentityGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
