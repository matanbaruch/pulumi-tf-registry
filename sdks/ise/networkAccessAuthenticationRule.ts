...
export class NetworkAccessAuthenticationRule extends pulumi.CustomResource {
    /**
     * Get an existing NetworkAccessAuthenticationRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAccessAuthenticationRuleState, opts?: pulumi.CustomResourceOptions): NetworkAccessAuthenticationRule {
        return new NetworkAccessAuthenticationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ise:index/networkAccessAuthenticationRule:NetworkAccessAuthenticationRule';

    /**
     * Returns true if the given object is an instance of NetworkAccessAuthenticationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NetworkAccessAuthenticationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NetworkAccessAuthenticationRule.__pulumiType;
    }

    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    public readonly childrens!: pulumi.Output<outputs.NetworkAccessAuthenticationRuleChildren[] | undefined>;
    /**
    ...
    /**
     * Create a NetworkAccessAuthenticationRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NetworkAccessAuthenticationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: NetworkAccessAuthenticationRuleArgs | NetworkAccessAuthenticationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkAccessAuthenticationRuleState | undefined;
            ...
            const args = argsOrState as NetworkAccessAuthenticationRuleArgs | undefined;
        ...
        super(NetworkAccessAuthenticationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering NetworkAccessAuthenticationRule resources.
 */
export interface NetworkAccessAuthenticationRuleState {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthenticationRuleChildren>[]>;
    /**
     * Dictionary attribute name
     */
...
/**
 * The set of arguments for constructing a NetworkAccessAuthenticationRule resource.
 */
export interface NetworkAccessAuthenticationRuleArgs {
    /**
     * List of child conditions. `condition_type` must be one of `ConditionAndBlock` or `ConditionOrBlock`.
     */
    childrens?: pulumi.Input<pulumi.Input<inputs.NetworkAccessAuthenticationRuleChildren>[]>;
