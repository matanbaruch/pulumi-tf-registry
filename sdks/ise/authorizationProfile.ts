...
export class AuthorizationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ise:index/authorizationProfile:AuthorizationProfile';
     ...
     */
    public readonly advancedAttributes!: pulumi.Output<outputs.AuthorizationProfileAdvancedAttribute[] | undefined>;
    /**
     * Agentless Posture.
     */
    ...
    constructor(name: string, argsOrState?: AuthorizationProfileArgs | AuthorizationProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AuthorizationProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AuthorizationProfileState {
     ...
     * List of advanced attributes
     */
    advancedAttributes?: pulumi.Input<pulumi.Input<inputs.AuthorizationProfileAdvancedAttribute>[]>;
    /**
     * Agentless Posture.
     */
