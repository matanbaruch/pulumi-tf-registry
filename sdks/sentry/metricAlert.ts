...
export class MetricAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sentry:index/metricAlert:MetricAlert';
    ...
    /**
     * An optional int representing the time delta to use as the comparison period, in minutes. Required when using a
    ...
    public readonly triggers!: pulumi.Output<outputs.MetricAlertTrigger[]>;
    ...
    constructor(name: string, argsOrState?: MetricAlertArgs | MetricAlertState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MetricAlert.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MetricAlertState {
    ...
    triggers?: pulumi.Input<pulumi.Input<inputs.MetricAlertTrigger>[]>;
}
