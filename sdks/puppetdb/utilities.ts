...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("puppetdb");
			params.setVersion("2.0.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NhbXB0b2NhbXAvcHVwcGV0ZGIiLCJ2ZXJzaW9uIjoiMi4wLjAifX0="), c => c.charCodeAt(0)));
