...
export class UserHandoffNotificationRule extends pulumi.CustomResource {
     ...
     */
    public readonly contactMethods!: pulumi.Output<outputs.UserHandoffNotificationRuleContactMethod[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: UserHandoffNotificationRuleArgs | UserHandoffNotificationRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserHandoffNotificationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface UserHandoffNotificationRuleState {
     ...
     * The contact method to notify for the user handoff notification rule.
     */
    contactMethods?: pulumi.Input<pulumi.Input<inputs.UserHandoffNotificationRuleContactMethod>[]>;
    /**
     * The type of handoff to notify for. Possible values are 'both', 'oncall', 'offcall'.
     */
