...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pagerduty");
			params.setVersion("3.15.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BhZ2VyZHV0eS9wYWdlcmR1dHkiLCJ2ZXJzaW9uIjoiMy4xNS42In19"), c => c.charCodeAt(0)));
