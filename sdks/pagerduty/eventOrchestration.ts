...
export class EventOrchestration extends pulumi.CustomResource {
    ...
    public readonly integrations!: pulumi.Output<outputs.EventOrchestrationIntegration[] | undefined>;
    ...
    constructor(name: string, argsOrState?: EventOrchestrationArgs | EventOrchestrationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EventOrchestration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
