...
export class Secretstore extends pulumi.CustomResource {
    ...
    /**
     * A human-readable name for the Secret Store. The value must contain only letters, numbers, dashes (-), underscores (_),
     * or periods (.). It is important to note that changing this attribute will delete and recreate the Secret Store, and
     * discard the current entries. You MUST first delete the associated resource_link block from your service before modifying
     * this field.
     */
    ...
    constructor(name: string, argsOrState?: SecretstoreArgs | SecretstoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Secretstore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
