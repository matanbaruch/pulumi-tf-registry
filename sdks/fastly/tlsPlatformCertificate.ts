...
export class TlsPlatformCertificate extends pulumi.CustomResource {
    ...
    /**
     * Disable checking whether the root of the certificate chain is trusted. Useful for development purposes to allow use of
     * self-signed CAs. Defaults to false. Write-only on create.
     */
    ...
    constructor(name: string, argsOrState?: TlsPlatformCertificateArgs | TlsPlatformCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TlsPlatformCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
