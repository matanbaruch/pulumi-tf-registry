...
export class TlsSubscriptionValidation extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.TlsSubscriptionValidationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: TlsSubscriptionValidationArgs | TlsSubscriptionValidationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TlsSubscriptionValidation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface TlsSubscriptionValidationState {
    ...
    timeouts?: pulumi.Input<inputs.TlsSubscriptionValidationTimeouts>;
}
