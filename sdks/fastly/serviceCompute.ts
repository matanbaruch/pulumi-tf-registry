...
export class ServiceCompute extends pulumi.CustomResource {
    ...
    public readonly loggingHerokus!: pulumi.Output<outputs.ServiceComputeLoggingHerokus[] | undefined>;
    ...
    constructor(name: string, argsOrState?: ServiceComputeArgs | ServiceComputeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceCompute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServiceComputeState {
    ...
    loggingHerokus?: pulumi.Input<pulumi.Input<inputs.ServiceComputeLoggingHerokus>[]>;
