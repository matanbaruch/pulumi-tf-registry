...
export class TlsSubscription extends pulumi.CustomResource {
    ...
    /**
     * The entity that issues and certifies the TLS certificates for your subscription. Valid values are `lets-encrypt`,
     * `globalsign` or `certainly`.
     */
    ...
    /**
     * The common name associated with the subscription generated by Fastly TLS. If you do not pass a common name on create, we
     * will default to the first TLS domain included. If provided, the domain chosen as the common name must be included in TLS
     * domains.
     */
    ...
    /**
     * Force delete the subscription even if it has active domains. Warning: this can disable production traffic if used
     * incorrectly. Defaults to false.
     */
    public readonly forceDestroy!: pulumi.Output<boolean | undefined>;
    /**
     * Force update the subscription even if it has active domains. Warning: this can disable production traffic if used
     * incorrectly.
     */
    ...
    /**
     * A list of options for configuring DNS to respond to ACME HTTP challenge in order to verify domain ownership. Best
     * accessed through a `for` expression to filter the relevant record.
     */
    public /*out*/ readonly managedHttpChallenges!: pulumi.Output<outputs.TlsSubscriptionManagedHttpChallenge[]>;
    /**
     * The current state of the subscription. The list of possible states are: `pending`, `processing`, `issued`, and
     * `renewing`.
     */
    ...
    constructor(name: string, argsOrState?: TlsSubscriptionArgs | TlsSubscriptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TlsSubscription.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
