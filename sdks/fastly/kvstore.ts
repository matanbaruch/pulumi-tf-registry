...
export class Kvstore extends pulumi.CustomResource {
    ...
    /**
     * A unique name to identify the KV Store. It is important to note that changing this attribute will delete and recreate
     * the KV Store, and discard the current entries. You MUST first delete the associated resource_link block from your
     * service before modifying this field.
     */
    ...
    constructor(name: string, argsOrState?: KvstoreArgs | KvstoreState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Kvstore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
