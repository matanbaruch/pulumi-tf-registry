...
export class ServiceWafConfiguration extends pulumi.CustomResource {
    ...
    /**
     * Conditionally prevents a new firewall version from being activated. The apply step will continue to create a new draft
     * version but will not activate it if this is set to `false`. Default `true`
     */
    ...
    constructor(name: string, argsOrState?: ServiceWafConfigurationArgs | ServiceWafConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceWafConfiguration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
