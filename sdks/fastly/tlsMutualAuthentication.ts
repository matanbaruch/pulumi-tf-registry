...
export class TlsMutualAuthentication extends pulumi.CustomResource {
    ...
    /**
     * Determines whether Mutual TLS will fail closed (enforced) or fail open. A true value will require a successful Mutual
     * TLS handshake for the connection to continue and will fail closed if unsuccessful. A false value will fail open and
     * allow the connection to proceed (if this attribute is not set we default to `false`).
     */
    ...
    constructor(name: string, argsOrState?: TlsMutualAuthenticationArgs | TlsMutualAuthenticationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TlsMutualAuthentication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
