...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("fastly");
			params.setVersion("5.13.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Zhc3RseS9mYXN0bHkiLCJ2ZXJzaW9uIjoiNS4xMy4wIn19"), c => c.charCodeAt(0)));
