...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("waapm");
			params.setVersion("2.0.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3dhbGxpeC93YWFwbSIsInZlcnNpb24iOiIyLjAuMiJ9fQ=="), c => c.charCodeAt(0)));
