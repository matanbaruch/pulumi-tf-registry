...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("iosxe");
			params.setVersion("0.5.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Npc2NvZGV2bmV0L2lvc3hlIiwidmVyc2lvbiI6IjAuNS42In19"), c => c.charCodeAt(0)));
