...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("vultr");
			params.setVersion("2.21.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Z1bHRyL3Z1bHRyIiwidmVyc2lvbiI6IjIuMjEuMCJ9fQ=="), c => c.charCodeAt(0)));
