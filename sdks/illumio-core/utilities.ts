...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("illumio-core");
			params.setVersion("1.1.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2lsbHVtaW8vaWxsdW1pby1jb3JlIiwidmVyc2lvbiI6IjEuMS42In19"), c => c.charCodeAt(0)));
