...
export class K8sNodePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'profitbricks:index/k8sNodePool:K8sNodePool';
     ...
     */
    public readonly lans!: pulumi.Output<number[] | undefined>;
    /**
...
export interface K8sNodePoolState {
     ...
     * A list of Local Area Networks the node pool should be part of
     */
    lans?: pulumi.Input<pulumi.Input<number>[]>;
    /**
     * A maintenance window comprise of a day of the week and a time for maintenance to be allowed
     */
