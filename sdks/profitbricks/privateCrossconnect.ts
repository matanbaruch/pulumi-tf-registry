...
export class PrivateCrossconnect extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'profitbricks:index/privateCrossconnect:PrivateCrossconnect';
     ...
     */
    public /*out*/ readonly connectableDatacenters!: pulumi.Output<outputs.PrivateCrossconnectConnectableDatacenter[]>;
    /**
    ...
    /**
     * A list containing the details of all datacenter cross-connected through this private cross-connect
     */
    public /*out*/ readonly peers!: pulumi.Output<outputs.PrivateCrossconnectPeer[]>;
    ...
    constructor(name: string, argsOrState?: PrivateCrossconnectArgs | PrivateCrossconnectState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["connectableDatacenters"] = undefined /*out*/;
