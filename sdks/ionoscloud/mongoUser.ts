...
export class MongoUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ionoscloud:index/mongoUser:MongoUser';
    ...
    public readonly roles!: pulumi.Output<outputs.MongoUserRole[] | undefined>;
    public readonly timeouts!: pulumi.Output<outputs.MongoUserTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: MongoUserArgs | MongoUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MongoUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MongoUserState {
    ...
    roles?: pulumi.Input<pulumi.Input<inputs.MongoUserRole>[]>;
    timeouts?: pulumi.Input<inputs.MongoUserTimeouts>;
