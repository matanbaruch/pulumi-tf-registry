...
export class Lan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ionoscloud:index/lan:Lan';
    ...
    public readonly ipFailovers!: pulumi.Output<outputs.LanIpFailover[] | undefined>;
    /**
...
export interface LanState {
    ...
    ipFailovers?: pulumi.Input<pulumi.Input<inputs.LanIpFailover>[]>;
    /**
     * IPv6 CIDR block assigned to the LAN. Can be set to 'AUTO' for an automatically assigned address or the address can be
     * explicitly supplied.
     */
