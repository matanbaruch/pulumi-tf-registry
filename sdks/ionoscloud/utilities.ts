...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ionoscloud");
			params.setVersion("6.5.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2lvbm9zLWNsb3VkL2lvbm9zY2xvdWQiLCJ2ZXJzaW9uIjoiNi41LjMifX0="), c => c.charCodeAt(0)));
