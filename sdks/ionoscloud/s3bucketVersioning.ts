...
export class S3BucketVersioning extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ionoscloud:index/s3BucketVersioning:S3BucketVersioning';
     ...
     */
    public readonly versioningConfiguration!: pulumi.Output<outputs.S3BucketVersioningVersioningConfiguration | undefined>;
    ...
    constructor(name: string, argsOrState?: S3BucketVersioningArgs | S3BucketVersioningState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(S3BucketVersioning.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
