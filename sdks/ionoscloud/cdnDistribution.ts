...
export class CdnDistribution extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CdnDistributionTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CdnDistributionArgs | CdnDistributionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CdnDistribution.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CdnDistributionState {
    ...
    timeouts?: pulumi.Input<inputs.CdnDistributionTimeouts>;
}
