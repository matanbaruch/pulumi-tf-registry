...
export class Ipblock extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'ionoscloud:index/ipblock:Ipblock';
    ...
    public readonly ipConsumers!: pulumi.Output<outputs.IpblockIpConsumer[] | undefined>;
...
export interface IpblockState {
    ipConsumers?: pulumi.Input<pulumi.Input<inputs.IpblockIpConsumer>[]>;
