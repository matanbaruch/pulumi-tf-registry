...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("shipa");
			params.setVersion("0.0.18");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NoaXBhLWNvcnAvc2hpcGEiLCJ2ZXJzaW9uIjoiMC4wLjE4In19"), c => c.charCodeAt(0)));
