...
export class Framework extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'shipa:index/framework:Framework';
    ...
    public readonly framework!: pulumi.Output<outputs.FrameworkFramework>;
...
export interface FrameworkState {
    framework?: pulumi.Input<inputs.FrameworkFramework>;
}
