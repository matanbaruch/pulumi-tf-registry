...
export class Slug extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'heroku:index/slug:Slug';
    ...
    public /*out*/ readonly blobs!: pulumi.Output<outputs.SlugBlob[]>;
    ...
    constructor(name: string, argsOrState?: SlugArgs | SlugState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Slug.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SlugState {
    ...
    blobs?: pulumi.Input<pulumi.Input<inputs.SlugBlob>[]>;
