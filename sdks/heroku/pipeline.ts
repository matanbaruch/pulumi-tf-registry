...
export class Pipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'heroku:index/pipeline:Pipeline';
    ...
    public readonly owner!: pulumi.Output<outputs.PipelineOwner | undefined>;
...
export interface PipelineState {
    ...
    owner?: pulumi.Input<inputs.PipelineOwner>;
}
