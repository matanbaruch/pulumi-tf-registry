...
export class Build extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'heroku:index/build:Build';
    ...
    public readonly source!: pulumi.Output<outputs.BuildSource>;
    public /*out*/ readonly stack!: pulumi.Output<string>;
    public /*out*/ readonly status!: pulumi.Output<string>;
    public /*out*/ readonly users!: pulumi.Output<outputs.BuildUser[]>;
...
export interface BuildState {
    ...
    source?: pulumi.Input<inputs.BuildSource>;
    stack?: pulumi.Input<string>;
    status?: pulumi.Input<string>;
    users?: pulumi.Input<pulumi.Input<inputs.BuildUser>[]>;
