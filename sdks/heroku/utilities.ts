...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("heroku");
			params.setVersion("5.2.9");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hlcm9rdS9oZXJva3UiLCJ2ZXJzaW9uIjoiNS4yLjkifX0="), c => c.charCodeAt(0)));
