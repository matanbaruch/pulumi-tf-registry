...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("netactuate");
			params.setVersion("0.2.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL25ldGFjdHVhdGUvbmV0YWN0dWF0ZSIsInZlcnNpb24iOiIwLjIuMyJ9fQ=="), c => c.charCodeAt(0)));
