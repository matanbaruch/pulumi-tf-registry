...
export class LogsPipelineOrder extends pulumi.CustomResource {
    ...
    /**
     * The name attribute in the resource `datadog.LogsPipelineOrder` needs to be unique. It's recommended to use the same
    ...
    constructor(name: string, argsOrState?: LogsPipelineOrderArgs | LogsPipelineOrderState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogsPipelineOrder.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
