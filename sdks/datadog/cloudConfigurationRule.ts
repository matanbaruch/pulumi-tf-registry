...
export class CloudConfigurationRule extends pulumi.CustomResource {
    ...
    /**
     * Defaults to empty list. This function will be deprecated soon. Use the notification rules function instead. Fields to
     * group by when generating signals, e.g. @resource.
     */
    ...
    /**
     * This function will be deprecated soon. Use the notification rules function instead. Notification targets for signals.
    ...
    constructor(name: string, argsOrState?: CloudConfigurationRuleArgs | CloudConfigurationRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CloudConfigurationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
