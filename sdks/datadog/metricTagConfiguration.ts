...
export class MetricTagConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly aggregations!: pulumi.Output<outputs.MetricTagConfigurationAggregation[] | undefined>;
    /**
     * Toggle to include/exclude tags as queryable for your metric. Can only be applied to metrics that have one or more tags
    ...
    /**
     * The metric's type. This field can't be updated after creation. Valid values are `gauge`, `count`, `rate`,
     * `distribution`.
     */
    ...
    constructor(name: string, argsOrState?: MetricTagConfigurationArgs | MetricTagConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MetricTagConfiguration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
