...
export class SyntheticsTest extends pulumi.CustomResource {
    ...
    /**
     * Required if `type = "browser"`. Array with the different device IDs used to run the test. Valid values are
     * `laptop_large`, `tablet`, `mobile_small`, `chrome.laptop_large`, `chrome.tablet`, `chrome.mobile_small`,
     * `firefox.laptop_large`, `firefox.tablet`, `firefox.mobile_small`, `edge.laptop_large`, `edge.tablet`,
     * `edge.mobile_small`.
     */
    public readonly deviceIds!: pulumi.Output<string[] | undefined>;
    /**
     * A boolean indicating whether this synthetics test can be deleted even if it's referenced by other resources (for
     ...
     * using the same `@username` notation as events. Defaults to `""`.
     */
    ...
    /**
     * The subtype of the Synthetic API test. Defaults to `http`. Valid values are `http`, `ssl`, `tcp`, `dns`, `multi`,
     * `icmp`, `udp`, `websocket`, `grpc`.
     */
    ...
    constructor(name: string, argsOrState?: SyntheticsTestArgs | SyntheticsTestState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SyntheticsTest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
