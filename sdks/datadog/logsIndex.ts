...
export class LogsIndex extends pulumi.CustomResource {
     ...
     * Logs filter
     */
    public readonly filter!: pulumi.Output<outputs.LogsIndexFilter>;
    /**
     * The name of the index. Index names cannot be modified after creation. If this value is changed, a new index will be
     * created.
     */
    ...
    constructor(name: string, argsOrState?: LogsIndexArgs | LogsIndexState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogsIndex.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LogsIndexState {
     ...
     * Logs filter
     */
    filter?: pulumi.Input<inputs.LogsIndexFilter>;
    /**
     * The name of the index. Index names cannot be modified after creation. If this value is changed, a new index will be
     * created.
     */
