...
export class RestrictionPolicy extends pulumi.CustomResource {
    ...
    /**
     * Identifier for the resource, formatted as resource_type:resource_id. Note: Dashboards support is in private beta. Reach
     * out to your Datadog contact or support to enable this.
     */
    ...
    constructor(name: string, argsOrState?: RestrictionPolicyArgs | RestrictionPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RestrictionPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
