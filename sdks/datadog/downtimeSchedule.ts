...
export class DowntimeSchedule extends pulumi.CustomResource {
    ...
    /**
     * The timezone in which to display the downtime's start and end times in Datadog applications. This is not used as an
     * offset for scheduling.
     */
    public readonly displayTimezone!: pulumi.Output<string>;
    /**
     * A message to include with notifications for this downtime. Email notifications can be sent to specific users by using
    ...
    constructor(name: string, argsOrState?: DowntimeScheduleArgs | DowntimeScheduleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DowntimeSchedule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
