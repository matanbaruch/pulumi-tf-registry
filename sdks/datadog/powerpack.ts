...
export class Powerpack extends pulumi.CustomResource {
     ...
     */
    public readonly layout!: pulumi.Output<outputs.PowerpackLayout | undefined>;
    /**
     * The timeframe to use when displaying the widget. Valid values are `1m`, `5m`, `10m`, `15m`, `30m`, `1h`, `4h`, `1d`,
     * `2d`, `1w`, `1mo`, `3mo`, `6mo`, `week_to_date`, `month_to_date`, `1y`, `alert`.
     */
    ...
    constructor(name: string, argsOrState?: PowerpackArgs | PowerpackState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Powerpack.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
