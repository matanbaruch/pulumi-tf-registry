...
export class SensitiveDataScannerGroup extends pulumi.CustomResource {
    ...
    /**
     * Whether or not the scanning group is enabled. If the group doesn't contain any rule or if all the rules in it are
     * disabled, the group is force-disabled by our backend
     */
    ...
    constructor(name: string, argsOrState?: SensitiveDataScannerGroupArgs | SensitiveDataScannerGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SensitiveDataScannerGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
