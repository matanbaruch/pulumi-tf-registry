...
export class SecurityMonitoringRule extends pulumi.CustomResource {
    ...
    /**
     * Additional queries to filter matched events before they are processed. **Note**: This field is deprecated for log
     * detection, signal correlation, and workload security rules.
     */
    ...
    /**
     * The rule type. Valid values are `application_security`, `log_detection`, `workload_security`, `signal_correlation`.
    ...
    constructor(name: string, argsOrState?: SecurityMonitoringRuleArgs | SecurityMonitoringRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SecurityMonitoringRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
