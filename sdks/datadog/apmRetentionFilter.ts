...
export class ApmRetentionFilter extends pulumi.CustomResource {
    ...
    /**
     * The type of the retention filter, currently only spans-processing-sampling is available. Valid values are
    ...
    /**
     * Sample rate to apply to spans going through this retention filter as a string, a value of 1.0 keeps all spans matching
     * the query.
     */
    ...
    constructor(name: string, argsOrState?: ApmRetentionFilterArgs | ApmRetentionFilterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApmRetentionFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
