...
export class ServiceLevelObjective extends pulumi.CustomResource {
    ...
    /**
     * A boolean indicating whether this monitor can be deleted even if it's referenced by other resources (for example,
     * dashboards).
     */
    ...
    /**
     * The primary time frame for the objective. The mapping from these types to the types found in the Datadog Web UI can be
     * found in the Datadog API documentation page. Valid values are `7d`, `30d`, `90d`, `custom`.
     */
     ...
     * page](https://docs.datadoghq.com/api/v1/service-level-objectives/#create-a-slo-object). Valid values are `metric`,
     * `monitor`, `time_slice`.
     */
    ...
    /**
     * The objective's warning value in `(0,100)`. This must be greater than the target value and match the corresponding
     * thresholds of the primary time frame.
     */
    ...
    constructor(name: string, argsOrState?: ServiceLevelObjectiveArgs | ServiceLevelObjectiveState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceLevelObjective.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
