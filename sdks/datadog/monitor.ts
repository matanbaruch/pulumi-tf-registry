...
export class Monitor extends pulumi.CustomResource {
     ...
     * `new_host_delay` to zero for monitors grouped by host. **Deprecated.** Use `new_group_delay` except when setting
     * `new_host_delay` to zero. Defaults to `300`.
     *
     * @deprecated Deprecated
     */
     ...
     * timeframe for metric alerts or 2 minutes for service checks. Defaults to `10`.
     */
    public readonly noDataTimeframe!: pulumi.Output<number | undefined>;
    /**
     * Toggles the display of additional content sent in the monitor notification. Valid values are `show_all`, `hide_query`,
     * `hide_handles`, `hide_all`.
     */
     ...
     * `require_full_window` must be false and will be ignored. Defaults to `true`.
     */
     ...
     */
    public readonly schedulingOptions!: pulumi.Output<outputs.MonitorSchedulingOptions | undefined>;
    /**
     ...
     * cannot be changed after a monitor is created. Valid values are `composite`, `event alert`, `log alert`, `metric alert`,
     * `process alert`, `query alert`, `rum alert`, `service check`, `synthetics alert`, `trace-analytics alert`, `slo alert`,
     * `event-v2 alert`, `audit alert`, `ci-pipelines alert`, `ci-tests alert`, `error-tracking alert`, `database-monitoring
     * alert`, `network-performance alert`.
     */
