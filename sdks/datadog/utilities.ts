...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("datadog");
			params.setVersion("3.43.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RhdGFkb2cvZGF0YWRvZyIsInZlcnNpb24iOiIzLjQzLjEifX0="), c => c.charCodeAt(0)));
