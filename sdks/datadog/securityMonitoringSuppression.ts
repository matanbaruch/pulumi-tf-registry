...
export class SecurityMonitoringSuppression extends pulumi.CustomResource {
    ...
    /**
     * An exclusion query on the input data of the security rules, which could be logs, Agent events, or other types of data
     * based on the security rule. Events matching this query are ignored by any detection rules referenced in the suppression
     * rule.
     */
    ...
    /**
     * A RFC3339 timestamp giving an expiration date for the suppression rule. After this date, it won't suppress signals
     * anymore.
     */
    ...
    /**
     * The suppression query of the suppression rule. If a signal matches this query, it is suppressed and is not triggered. It
     * uses the same syntax as the queries to search signals in the Signals Explorer.
     */
    ...
    constructor(name: string, argsOrState?: SecurityMonitoringSuppressionArgs | SecurityMonitoringSuppressionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SecurityMonitoringSuppression.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
