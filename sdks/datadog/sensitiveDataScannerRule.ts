...
export class SensitiveDataScannerRule extends pulumi.CustomResource {
    ...
    /**
     * Object defining a set of keywords and a number of characters that help reduce noise. You can provide a list of keywords
     * you would like to check within a defined proximity of the matching pattern. If any of the keywords are found within the
     * proximity check then the match is kept. If none are found, the match is discarded. Setting the `create_before_destroy`
     * lifecycle Meta-argument to `true` is highly recommended if modifying this field to avoid unexpectedly disabling
    ...
    /**
     * Attributes included in the scan. If namespaces is empty or missing, all attributes except excluded_namespaces are
     * scanned. If both are missing the whole event is scanned.
     */
    ...
    /**
     * Priority level of the rule (optional). Used to order sensitive data discovered in the sds summary page. It must be
     * between 1 and 5 (1 being the most important).
     */
    ...
    constructor(name: string, argsOrState?: SensitiveDataScannerRuleArgs | SensitiveDataScannerRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SensitiveDataScannerRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
