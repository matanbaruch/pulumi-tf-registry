...
export class SloCorrection extends pulumi.CustomResource {
    ...
    /**
     * Category the SLO correction belongs to. Valid values are `Scheduled Maintenance`, `Outside Business Hours`,
     * `Deployment`, `Other`.
     */
    ...
    constructor(name: string, argsOrState?: SloCorrectionArgs | SloCorrectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SloCorrection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
