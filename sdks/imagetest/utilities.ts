...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("imagetest");
			params.setVersion("0.0.35");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NoYWluZ3VhcmQtZGV2L2ltYWdldGVzdCIsInZlcnNpb24iOiIwLjAuMzUifX0="), c => c.charCodeAt(0)));
