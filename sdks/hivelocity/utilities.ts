...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("hivelocity");
			params.setVersion("0.7.9");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hpdmVsb2NpdHkvaGl2ZWxvY2l0eSIsInZlcnNpb24iOiIwLjcuOSJ9fQ=="), c => c.charCodeAt(0)));
