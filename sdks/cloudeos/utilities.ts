...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudeos");
			params.setVersion("1.2.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2FyaXN0YW5ldHdvcmtzL2Nsb3VkZW9zIiwidmVyc2lvbiI6IjEuMi4yIn19"), c => c.charCodeAt(0)));
