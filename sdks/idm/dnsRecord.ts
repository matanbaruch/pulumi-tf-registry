...
export class DnsRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'idm:index/dnsRecord:DnsRecord';
    ...
    public readonly idmDnsName!: pulumi.Output<string>;
    public readonly idmDnsZoneName!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: DnsRecordArgs | DnsRecordState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["idmDnsName"] = state ? state.idmDnsName : undefined;
            resourceInputs["idmDnsZoneName"] = state ? state.idmDnsZoneName : undefined;
            resourceInputs["records"] = state ? state.records : undefined;
            resourceInputs["ttl"] = state ? state.ttl : undefined;
            resourceInputs["type"] = state ? state.type : undefined;
        } else {
            const args = argsOrState as DnsRecordArgs | undefined;
            if ((!args || args.idmDnsName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'idmDnsName'");
            }
            if ((!args || args.idmDnsZoneName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'idmDnsZoneName'");
            }
            ...
            resourceInputs["idmDnsName"] = args ? args.idmDnsName : undefined;
            resourceInputs["idmDnsZoneName"] = args ? args.idmDnsZoneName : undefined;
...
export interface DnsRecordState {
    ...
    idmDnsName?: pulumi.Input<string>;
    idmDnsZoneName?: pulumi.Input<string>;
