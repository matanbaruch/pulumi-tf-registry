...
export class Wlan extends pulumi.CustomResource {
    ...
    /**
     * Set minimum data rate control for 2G devices, in Kbps. Use `0` to disable minimum data rates. Valid values are: `1000`,
     * `2000`, `5500`, `6000`, `9000`, `11000`, `12000`, `18000`, `24000`, `36000`, `48000`, and `54000`.
     */
    public readonly minimumDataRate2gKbps!: pulumi.Output<number | undefined>;
    /**
     * Set minimum data rate control for 5G devices, in Kbps. Use `0` to disable minimum data rates. Valid values are: `6000`,
     * `9000`, `12000`, `18000`, `24000`, `36000`, `48000`, and `54000`.
     */
    ...
    /**
     * Enable Protected Management Frames. This cannot be disabled if using WPA 3. Valid values are `required`, `optional` and
