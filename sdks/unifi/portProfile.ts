...
export class PortProfile extends pulumi.CustomResource {
    ...
    /**
     * The type forwarding to use for the port profile. Can be `all`, `native`, `customize` or `disabled`. Defaults to
     * `native`.
     */
    ...
    /**
     * The link speed to set for the port profile. Can be one of `10`, `100`, `1000`, `2500`, `5000`, `10000`, `20000`,
     * `25000`, `40000`, `50000` or `100000`
     */
