...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("azurecaf");
			params.setVersion("1.2.28");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2F6dGZtb2QvYXp1cmVjYWYiLCJ2ZXJzaW9uIjoiMS4yLjI4In19"), c => c.charCodeAt(0)));
