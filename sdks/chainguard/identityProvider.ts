...
export class IdentityProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'chainguard:index/identityProvider:IdentityProvider';
     ...
     */
    public readonly oidc!: pulumi.Output<outputs.IdentityProviderOidc | undefined>;
    /**
