...
export class KafkaIntegration extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KafkaIntegrationState, opts?: pulumi.CustomResourceOptions): KafkaIntegration {
        return new KafkaIntegration(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rockset:index/kafkaIntegration:KafkaIntegration';

    /**
     * Returns true if the given object is an instance of KafkaIntegration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KafkaIntegration {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KafkaIntegration.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: KafkaIntegrationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KafkaIntegrationArgs | KafkaIntegrationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KafkaIntegrationState | undefined;
            ...
            const args = argsOrState as KafkaIntegrationArgs | undefined;
        ...
        super(KafkaIntegration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface KafkaIntegrationState {
    /**
     * The Kafka bootstrap server url(s). Required only for V3 integration.
     */
 ...
 */
export interface KafkaIntegrationArgs {
    /**
     * The Kafka bootstrap server url(s). Required only for V3 integration.
     */
    bootstrapServers?: pulumi.Input<string>;
