...
export class MongodbCollection extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MongodbCollectionState, opts?: pulumi.CustomResourceOptions): MongodbCollection {
        return new MongodbCollection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rockset:index/mongodbCollection:MongodbCollection';

    /**
     * Returns true if the given object is an instance of MongodbCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MongodbCollection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MongodbCollection.__pulumiType;
    }
     ...
     */
    public readonly sources!: pulumi.Output<outputs.MongodbCollectionSource[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.MongodbCollectionTimeouts | undefined>;
    /**
     ...
     */
    constructor(name: string, args: MongodbCollectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MongodbCollectionArgs | MongodbCollectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MongodbCollectionState | undefined;
            ...
            const args = argsOrState as MongodbCollectionArgs | undefined;
        ...
        super(MongodbCollection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface MongodbCollectionState {
    /**
     * Text describing the collection.
     */
     ...
     * Defines a source for this collection.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.MongodbCollectionSource>[]>;
    /**
     * RocksDB storage compression type. Possible values: ZSTD, LZ4.
     */
    storageCompressionType?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.MongodbCollectionTimeouts>;
    /**
     * Wait until the collection is ready.
     */
 ...
 */
export interface MongodbCollectionArgs {
    /**
     * Text describing the collection.
     */
    description?: pulumi.Input<string>;
