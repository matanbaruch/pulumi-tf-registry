...
export { GetCollectionSourceArgs, GetCollectionSourceResult, GetCollectionSourceOutputArgs } from "./getCollectionSource";
export const getCollectionSource: typeof import("./getCollectionSource").getCollectionSource = null as any;
export const getCollectionSourceOutput: typeof import("./getCollectionSource").getCollectionSourceOutput = null as any;
utilities.lazyLoad(exports, ["getCollectionSource","getCollectionSourceOutput"], () => require("./getCollectionSource"));
...
export { ScheduledLambdaArgs, ScheduledLambdaState } from "./scheduledLambda";
export type ScheduledLambda = import("./scheduledLambda").ScheduledLambda;
export const ScheduledLambda: typeof import("./scheduledLambda").ScheduledLambda = null as any;
utilities.lazyLoad(exports, ["ScheduledLambda"], () => require("./scheduledLambda"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "rockset:index/autoscalingPolicy:AutoscalingPolicy":
            ...
            case "rockset:index/scheduledLambda:ScheduledLambda":
                return new ScheduledLambda(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("rockset", "index/autoscalingPolicy", _module)
...
pulumi.runtime.registerResourceModule("rockset", "index/scheduledLambda", _module)
