...
export class GcsCollection extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GcsCollectionState, opts?: pulumi.CustomResourceOptions): GcsCollection {
        return new GcsCollection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rockset:index/gcsCollection:GcsCollection';

    /**
     * Returns true if the given object is an instance of GcsCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GcsCollection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GcsCollection.__pulumiType;
    }
     ...
     */
    public readonly sources!: pulumi.Output<outputs.GcsCollectionSource[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.GcsCollectionTimeouts | undefined>;
    /**
    ...
    /**
     * Create a GcsCollection resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GcsCollectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GcsCollectionArgs | GcsCollectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GcsCollectionState | undefined;
            ...
            const args = argsOrState as GcsCollectionArgs | undefined;
        ...
        super(GcsCollection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface GcsCollectionState {
    /**
     * Text describing the collection.
     */
     ...
     * Defines a source for this collection.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.GcsCollectionSource>[]>;
    /**
     * RocksDB storage compression type. Possible values: ZSTD, LZ4.
     */
    storageCompressionType?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.GcsCollectionTimeouts>;
    /**
     * Wait until the collection is ready.
     */
 ...
 */
export interface GcsCollectionArgs {
    /**
     * Text describing the collection.
     */
    description?: pulumi.Input<string>;
