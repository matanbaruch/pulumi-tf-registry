...
export class DynamodbCollection extends pulumi.CustomResource {
    /**
     * Get an existing DynamodbCollection resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DynamodbCollectionState, opts?: pulumi.CustomResourceOptions): DynamodbCollection {
        return new DynamodbCollection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'rockset:index/dynamodbCollection:DynamodbCollection';

    /**
     * Returns true if the given object is an instance of DynamodbCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DynamodbCollection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DynamodbCollection.__pulumiType;
    }
     ...
     */
    public readonly sources!: pulumi.Output<outputs.DynamodbCollectionSource[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.DynamodbCollectionTimeouts | undefined>;
    /**
    ...
    /**
     * Create a DynamodbCollection resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DynamodbCollectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DynamodbCollectionArgs | DynamodbCollectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DynamodbCollectionState | undefined;
            ...
            const args = argsOrState as DynamodbCollectionArgs | undefined;
        ...
        super(DynamodbCollection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface DynamodbCollectionState {
    /**
     * Text describing the collection.
     */
     ...
     * Defines a source for this collection.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.DynamodbCollectionSource>[]>;
    /**
     * RocksDB storage compression type. Possible values: ZSTD, LZ4.
     */
    storageCompressionType?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.DynamodbCollectionTimeouts>;
    /**
     * Wait until the collection is ready.
     */
 ...
 */
export interface DynamodbCollectionArgs {
    /**
     * Text describing the collection.
     */
    description?: pulumi.Input<string>;
