...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("rockset");
			params.setVersion("0.9.8");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3JvY2tzZXQvcm9ja3NldCIsInZlcnNpb24iOiIwLjkuOCJ9fQ=="), c => c.charCodeAt(0)));
