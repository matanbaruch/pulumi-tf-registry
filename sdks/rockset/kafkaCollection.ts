...
export class KafkaCollection extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaCollectionTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: KafkaCollectionArgs | KafkaCollectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaCollection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaCollectionState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaCollectionTimeouts>;
    /**
     * Wait until the collection is ready.
     */
