...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("lambdabased");
			params.setVersion("0.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3RyYWNlYWJsZWFpL2xhbWJkYWJhc2VkIiwidmVyc2lvbiI6IjAuMS4wIn19"), c => c.charCodeAt(0)));
