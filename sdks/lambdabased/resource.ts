...
export class Resource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lambdabased:index/resource:Resource';
    ...
    public readonly concealInput!: pulumi.Output<boolean | undefined>;
    public readonly concealResult!: pulumi.Output<boolean | undefined>;
    public readonly finalizer!: pulumi.Output<outputs.ResourceFinalizer | undefined>;
    ...
    constructor(name: string, argsOrState?: ResourceArgs | ResourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["concealInput"] = state ? state.concealInput : undefined;
            resourceInputs["concealResult"] = state ? state.concealResult : undefined;
            resourceInputs["finalizer"] = state ? state.finalizer : undefined;
            ...
            resourceInputs["concealInput"] = args ? args.concealInput : undefined;
            resourceInputs["concealResult"] = args ? args.concealResult : undefined;
            resourceInputs["finalizer"] = args ? args.finalizer : undefined;
...
export interface ResourceState {
    concealInput?: pulumi.Input<boolean>;
    concealResult?: pulumi.Input<boolean>;
    finalizer?: pulumi.Input<inputs.ResourceFinalizer>;
