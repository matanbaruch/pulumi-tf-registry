...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pipeline");
			params.setVersion("1.2.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2pmcm9nL3BpcGVsaW5lIiwidmVyc2lvbiI6IjEuMi40In19"), c => c.charCodeAt(0)));
