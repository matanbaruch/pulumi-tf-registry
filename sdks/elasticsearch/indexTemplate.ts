...
export class IndexTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'elasticsearch:index/indexTemplate:IndexTemplate';
    ...
    constructor(name: string, argsOrState?: IndexTemplateArgs | IndexTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IndexTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
