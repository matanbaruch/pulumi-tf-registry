...
export class ComposableIndexTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'elasticsearch:index/composableIndexTemplate:ComposableIndexTemplate';
    ...
    constructor(name: string, argsOrState?: ComposableIndexTemplateArgs | ComposableIndexTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ComposableIndexTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
