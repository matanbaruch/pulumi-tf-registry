...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("elasticsearch");
			params.setVersion("2.0.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BoaWxsYmFrZXIvZWxhc3RpY3NlYXJjaCIsInZlcnNpb24iOiIyLjAuNyJ9fQ=="), c => c.charCodeAt(0)));
