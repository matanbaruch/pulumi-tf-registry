...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("junos-vsrx");
			params.setVersion("20.32.106");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2p1bmlwZXIvanVub3MtdnNyeCIsInZlcnNpb24iOiIyMC4zMi4xMDYifX0="), c => c.charCodeAt(0)));
