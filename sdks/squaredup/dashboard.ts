...
export class Dashboard extends pulumi.CustomResource {
    ...
    /**
     * The timeframe of the dashboard. It should be one of the following: last1hour, last12hours, last24hours, last7days,
     * last30days, thisMonth, thisQuarter, thisYear, lastMonth, lastQuarter, lastYear
     */
