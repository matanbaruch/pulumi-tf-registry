...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("squaredup");
			params.setVersion("1.4.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NxdWFyZWR1cC9zcXVhcmVkdXAiLCJ2ZXJzaW9uIjoiMS40LjAifX0="), c => c.charCodeAt(0)));
