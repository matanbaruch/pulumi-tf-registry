...
export class Script extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'squaredup:index/script:Script';
    ...
    /**
     * The last updated date of the script
     */
     ...
     */
    public readonly scriptType!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: ScriptArgs | ScriptState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.scriptType === undefined) && !opts.urn) {
                throw new Error("Missing required property 'scriptType'");
            }
