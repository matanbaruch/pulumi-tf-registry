...
export class PrivateService extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateServiceState, opts?: pulumi.CustomResourceOptions): PrivateService {
        return new PrivateService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'render:index/privateService:PrivateService';
     ...
     */
    public readonly autoscaling!: pulumi.Output<outputs.PrivateServiceAutoscaling | undefined>;
    /**
     * [Persistent disk](https://docs.render.com/disks) to attach to the service.
     */
    public readonly disk!: pulumi.Output<outputs.PrivateServiceDisk | undefined>;
    /**
     * Map of environment variable names to their values.
     */
    public readonly envVars!: pulumi.Output<{[key: string]: outputs.PrivateServiceEnvVars} | undefined>;
    /**
     ...
     */
    public readonly notificationOverride!: pulumi.Output<outputs.PrivateServiceNotificationOverride>;
     ...
     */
    public readonly runtimeSource!: pulumi.Output<outputs.PrivateServiceRuntimeSource>;
    /**
     * A map of secret file paths to their contents.
     */
    public readonly secretFiles!: pulumi.Output<{[key: string]: outputs.PrivateServiceSecretFiles} | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PrivateServiceArgs | PrivateServiceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PrivateServiceState | undefined;
            ...
            const args = argsOrState as PrivateServiceArgs | undefined;
        ...
        super(PrivateService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PrivateServiceState {
     ...
     * [Autoscaling settings](https://docs.render.com/scaling#autoscaling) for the service
     */
    autoscaling?: pulumi.Input<inputs.PrivateServiceAutoscaling>;
    /**
     * [Persistent disk](https://docs.render.com/disks) to attach to the service.
     */
    disk?: pulumi.Input<inputs.PrivateServiceDisk>;
    /**
     * Map of environment variable names to their values.
     */
    envVars?: pulumi.Input<{[key: string]: pulumi.Input<inputs.PrivateServiceEnvVars>}>;
    /**
     * ID of the [project environment](https://docs.render.com/projects) that the resource belongs to
     */
     ...
     * global notification settings of the user or team.
     */
    notificationOverride?: pulumi.Input<inputs.PrivateServiceNotificationOverride>;
     ...
     * [image](https://docs.render.com/deploy-an-image).
     */
    runtimeSource?: pulumi.Input<inputs.PrivateServiceRuntimeSource>;
    /**
     * A map of secret file paths to their contents.
     */
    secretFiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.PrivateServiceSecretFiles>}>;
    /**
     * Unique slug for the service
     */
