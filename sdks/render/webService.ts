...
export class WebService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'render:index/webService:WebService';
     ...
     */
    public readonly autoscaling!: pulumi.Output<outputs.WebServiceAutoscaling | undefined>;
    /**
     * Custom domains to associate with the service.
     */
    public readonly customDomains!: pulumi.Output<outputs.WebServiceCustomDomain[] | undefined>;
    /**
     * [Persistent disk](https://docs.render.com/disks) to attach to the service.
     */
    public readonly disk!: pulumi.Output<outputs.WebServiceDisk | undefined>;
    /**
     * Map of environment variable names to their values.
     */
    public readonly envVars!: pulumi.Output<{[key: string]: outputs.WebServiceEnvVars} | undefined>;
    /**
    ...
    /**
     * If you're running a server, enter the path where your server will always return a 200 OK response. We use it to monitor
     * your app and for [zero downtime deploys](https://docs.render.com/deploys#zero-downtime-deploys).
     */
     ...
     */
    public readonly notificationOverride!: pulumi.Output<outputs.WebServiceNotificationOverride>;
     ...
     */
    public readonly runtimeSource!: pulumi.Output<outputs.WebServiceRuntimeSource>;
    /**
     * A map of secret file paths to their contents.
     */
    public readonly secretFiles!: pulumi.Output<{[key: string]: outputs.WebServiceSecretFiles} | undefined>;
    /**
...
export interface WebServiceState {
     ...
     * [Autoscaling settings](https://docs.render.com/scaling#autoscaling) for the service
     */
    autoscaling?: pulumi.Input<inputs.WebServiceAutoscaling>;
    /**
     * Custom domains to associate with the service.
     */
    customDomains?: pulumi.Input<pulumi.Input<inputs.WebServiceCustomDomain>[]>;
    /**
     * [Persistent disk](https://docs.render.com/disks) to attach to the service.
     */
    disk?: pulumi.Input<inputs.WebServiceDisk>;
    /**
     * Map of environment variable names to their values.
     */
    envVars?: pulumi.Input<{[key: string]: pulumi.Input<inputs.WebServiceEnvVars>}>;
    /**
     * ID of the [project environment](https://docs.render.com/projects) that the resource belongs to
     */
     ...
     * global notification settings of the user or team.
     */
    notificationOverride?: pulumi.Input<inputs.WebServiceNotificationOverride>;
     ...
     * [image](https://docs.render.com/deploy-an-image).
     */
    runtimeSource?: pulumi.Input<inputs.WebServiceRuntimeSource>;
    /**
     * A map of secret file paths to their contents.
     */
    secretFiles?: pulumi.Input<{[key: string]: pulumi.Input<inputs.WebServiceSecretFiles>}>;
    /**
     * Unique slug for the service
     */
