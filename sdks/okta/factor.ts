...
export class Factor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'okta:index/factor:Factor';
    ...
    /**
     * The MFA provider name. Allowed values are `duo`, `fido_u2f`, `fido_webauthn`, `google_otp`, `okta_call`, `okta_otp`,
     * `okta_password`, `okta_push`, `okta_question`, `okta_sms`, `okta_email`, `rsa_token`, `symantec_vip`, `yubikey_token`,
     * or `hotp`.
     */
    ...
    constructor(name: string, argsOrState?: FactorArgs | FactorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Factor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
