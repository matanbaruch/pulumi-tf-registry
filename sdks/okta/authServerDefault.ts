...
export class AuthServerDefault extends pulumi.CustomResource {
    ...
    /**
     * The key rotation mode for the authorization server. Can be `AUTO` or `MANUAL`. Default: `MANUAL`.Credential rotation
     * mode, in many cases you cannot set this to MANUAL, the API will ignore the value and you will get a perpetual diff. This
    ...
    constructor(name: string, argsOrState?: AuthServerDefaultArgs | AuthServerDefaultState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AuthServerDefault.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
