...
export class EmailDomain extends pulumi.CustomResource {
    ...
    /**
     * Status of the email domain. Values: NOT_STARTED, IN_PROGRESS, VERIFIED, COMPLETED
     */
    ...
    constructor(name: string, argsOrState?: EmailDomainArgs | EmailDomainState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EmailDomain.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
