...
export class IdpSocial extends pulumi.CustomResource {
    /**
     * Get an existing IdpSocial resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdpSocialState, opts?: pulumi.CustomResourceOptions): IdpSocial {
        return new IdpSocial(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/idpSocial:IdpSocial';

    /**
     * Returns true if the given object is an instance of IdpSocial.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdpSocial {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdpSocial.__pulumiType;
    }
    ...
    /**
     * The Key ID that you obtained from Apple when you created the private key for the client. PrivateKey is required when
     * resource is first created. For all consecutive updates, it can be empty/omitted and keeps the existing value if it is
     * empty/omitted. PrivateKey isn't returned when importing this resource.
     */
    ...
    /**
     * Indicates whether Okta uses the original Okta org domain URL, or a custom domain URL. It can be `ORG_URL` or
     * `CUSTOM_URL`. Default: `ORG_URL`
     */
     ...
     * IdP username. By default, it is set to `USERNAME`. It can be set to `USERNAME`, `EMAIL`, `USERNAME_OR_EMAIL` or
     * `CUSTOM_ATTRIBUTE`.
     */
    ...
    /**
     * Create a IdpSocial resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdpSocialArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdpSocialArgs | IdpSocialState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdpSocialState | undefined;
            ...
            const args = argsOrState as IdpSocialArgs | undefined;
        ...
        super(IdpSocial.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdpSocial resources.
 */
export interface IdpSocialState {
    /**
     * Specifies the account linking action for an IdP user. Default: `AUTO`
     */
...
/**
 * The set of arguments for constructing a IdpSocial resource.
 */
export interface IdpSocialArgs {
    /**
     * Specifies the account linking action for an IdP user. Default: `AUTO`
     */
    accountLinkAction?: pulumi.Input<string>;
