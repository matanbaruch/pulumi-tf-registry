...
export class GroupRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'okta:index/groupRule:GroupRule';
    ...
    constructor(name: string, argsOrState?: GroupRuleArgs | GroupRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GroupRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
