...
export class PolicyRuleMfa extends pulumi.CustomResource {
    /**
     * Get an existing PolicyRuleMfa resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyRuleMfaState, opts?: pulumi.CustomResourceOptions): PolicyRuleMfa {
        return new PolicyRuleMfa(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/policyRuleMfa:PolicyRuleMfa';

    /**
     * Returns true if the given object is an instance of PolicyRuleMfa.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyRuleMfa {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyRuleMfa.__pulumiType;
    }
     ...
     */
    public readonly appExcludes!: pulumi.Output<outputs.PolicyRuleMfaAppExclude[] | undefined>;
    /**
     ...
     * of applications should be included. - 'type' - (Required) One of: 'APP', 'APP_TYPE'
     */
    public readonly appIncludes!: pulumi.Output<outputs.PolicyRuleMfaAppInclude[] | undefined>;
    /**
    ...
    /**
     * Create a PolicyRuleMfa resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyRuleMfaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyRuleMfaArgs | PolicyRuleMfaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyRuleMfaState | undefined;
            ...
            const args = argsOrState as PolicyRuleMfaArgs | undefined;
        ...
        super(PolicyRuleMfa.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyRuleMfa resources.
 */
export interface PolicyRuleMfaState {
    /**
     * Applications to exclude in discovery rule. **IMPORTANT**: this field is only available in Classic Organizations. - 'id'
     * - (Optional) Use if 'type' is 'APP' to indicate the application id to include. - 'name' - (Optional) Use if the 'type'
     * is 'APP_TYPE' to indicate the type of application(s) to include in instances where an entire group (i.e. 'yahoo_mail')
     * of applications should be included. - 'type' - (Required) One of: 'APP', 'APP_TYPE'
     */
    appExcludes?: pulumi.Input<pulumi.Input<inputs.PolicyRuleMfaAppExclude>[]>;
    /**
     * Applications to include in discovery rule. **IMPORTANT**: this field is only available in Classic Organizations. - 'id'
     * - (Optional) Use if 'type' is 'APP' to indicate the application id to include. - 'name' - (Optional) Use if the 'type'
     * is 'APP_TYPE' to indicate the type of application(s) to include in instances where an entire group (i.e. 'yahoo_mail')
     * of applications should be included. - 'type' - (Required) One of: 'APP', 'APP_TYPE'
     */
    appIncludes?: pulumi.Input<pulumi.Input<inputs.PolicyRuleMfaAppInclude>[]>;
    /**
     * When a user should be prompted for MFA. It can be `CHALLENGE`, `LOGIN`, or `NEVER`.
     */
...
/**
 * The set of arguments for constructing a PolicyRuleMfa resource.
 */
export interface PolicyRuleMfaArgs {
    /**
     * Applications to exclude in discovery rule. **IMPORTANT**: this field is only available in Classic Organizations. - 'id'
     * - (Optional) Use if 'type' is 'APP' to indicate the application id to include. - 'name' - (Optional) Use if the 'type'
     * is 'APP_TYPE' to indicate the type of application(s) to include in instances where an entire group (i.e. 'yahoo_mail')
