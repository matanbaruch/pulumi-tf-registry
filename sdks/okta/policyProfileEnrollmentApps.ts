...
export class PolicyProfileEnrollmentApps extends pulumi.CustomResource {
    ...
    /**
     * ID of the Default Enrollment Policy. This policy is used as a policy to re-assign apps to when they are unassigned from
     * this one
     */
    ...
    constructor(name: string, argsOrState?: PolicyProfileEnrollmentAppsArgs | PolicyProfileEnrollmentAppsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PolicyProfileEnrollmentApps.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
