...
export class IdpOidc extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'okta:index/idpOidc:IdpOidc';
     ...
     * `CUSTOM_URL`, or `DYNAMIC`. Default: `ORG_URL`
     */
    ...
    /**
     * The HMAC Signature Algorithm used when signing an authorization request. Defaults to `HS256`. It can be `HS256`,
     * `HS384`, `HS512`, `SHA-256`. `RS256`, `RS384`, or `RS512`. NOTE: `SHA-256` an undocumented legacy value and not continue
     * to be valid. See API docs https://developer.okta.com/docs/reference/api/idps/#oidc-request-signature-algorithm-object
     */
    public readonly requestSignatureAlgorithm!: pulumi.Output<string | undefined>;
    /**
     * Specifies whether to digitally sign an AuthnRequest messages to the IdP. Defaults to `REQUEST`. It can be `REQUEST` or
     * `NONE`.
     */
    ...
    /**
     * User type ID. Can be used as `target_id` in the `okta.ProfileMapping` resource.
     */
    ...
    constructor(name: string, argsOrState?: IdpOidcArgs | IdpOidcState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IdpOidc.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
