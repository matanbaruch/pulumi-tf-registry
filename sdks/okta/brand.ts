...
export class Brand extends pulumi.CustomResource {
    ...
    /**
     * Brand ID - Note: Okta API for brands only reads and updates therefore the okta.Brand resource needs to act as a quasi
     * data source. Do this by setting brand_id. `DEPRECATED`: Okta has fully support brand creation, this attribute is a no op
     * and will be removed
     *
