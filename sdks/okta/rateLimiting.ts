...
export class RateLimiting extends pulumi.CustomResource {
    ...
    /**
     * Called during authentication. Valid values: `ENFORCE` _(Enforce limit and log per client (recommended))_, `DISABLE` _(Do
     * nothing (not recommended))_, `PREVIEW` _(Log per client)_.
     */
    ...
    /**
     * Called when accessing the Okta hosted login page. Valid values: `ENFORCE` _(Enforce limit and log per client
     * (recommended))_, `DISABLE` _(Do nothing (not recommended))_, `PREVIEW` _(Log per client)_.
     */
    ...
    constructor(name: string, argsOrState?: RateLimitingArgs | RateLimitingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RateLimiting.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
