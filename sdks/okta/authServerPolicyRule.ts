...
export class AuthServerPolicyRule extends pulumi.CustomResource {
    /**
     * Get an existing AuthServerPolicyRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthServerPolicyRuleState, opts?: pulumi.CustomResourceOptions): AuthServerPolicyRule {
        return new AuthServerPolicyRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/authServerPolicyRule:AuthServerPolicyRule';

    /**
     * Returns true if the given object is an instance of AuthServerPolicyRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AuthServerPolicyRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AuthServerPolicyRule.__pulumiType;
    }
    ...
    /**
     * Create a AuthServerPolicyRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AuthServerPolicyRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AuthServerPolicyRuleArgs | AuthServerPolicyRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AuthServerPolicyRuleState | undefined;
            ...
            const args = argsOrState as AuthServerPolicyRuleArgs | undefined;
        ...
        super(AuthServerPolicyRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AuthServerPolicyRule resources.
 */
export interface AuthServerPolicyRuleState {
    /**
     * Lifetime of access token. Can be set to a value between 5 and 1440 minutes. Default is `60`.
     */
...
/**
 * The set of arguments for constructing a AuthServerPolicyRule resource.
 */
export interface AuthServerPolicyRuleArgs {
    /**
     * Lifetime of access token. Can be set to a value between 5 and 1440 minutes. Default is `60`.
     */
    accessTokenLifetimeMinutes?: pulumi.Input<number>;
