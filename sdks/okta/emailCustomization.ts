...
export class EmailCustomization extends pulumi.CustomResource {
    ...
    /**
     * Force is_default on the create and delete by deleting all email customizations. Comma separated string with values of
     * 'create' or 'destroy' or both `create,destroy'.
     *
    ...
    /**
     * The language supported by the customization - Example values from [supported
     * languages](https://developer.okta.com/docs/reference/api/brands/#supported-languages)
     */
    ...
    constructor(name: string, argsOrState?: EmailCustomizationArgs | EmailCustomizationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EmailCustomization.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
