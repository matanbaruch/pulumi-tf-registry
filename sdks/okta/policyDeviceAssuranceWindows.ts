...
export class PolicyDeviceAssuranceWindows extends pulumi.CustomResource {
    /**
     * Get an existing PolicyDeviceAssuranceWindows resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyDeviceAssuranceWindowsState, opts?: pulumi.CustomResourceOptions): PolicyDeviceAssuranceWindows {
        return new PolicyDeviceAssuranceWindows(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/policyDeviceAssuranceWindows:PolicyDeviceAssuranceWindows';

    /**
     * Returns true if the given object is an instance of PolicyDeviceAssuranceWindows.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyDeviceAssuranceWindows {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyDeviceAssuranceWindows.__pulumiType;
    }
     ...
     */
    public readonly tpspCrowdStrikeAgentId!: pulumi.Output<string | undefined>;
    /**
     * Third party signal provider crowdstrike user id
     */
    public readonly tpspCrowdStrikeCustomerId!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly tpspSecureBootEnabled!: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    public readonly tpspThirdPartyBlockingEnabled!: pulumi.Output<boolean | undefined>;
    /**
     * Third party signal provider windows machine domain
     */
    public readonly tpspWindowsMachineDomain!: pulumi.Output<string | undefined>;
    /**
     * Third party signal provider windows user domain
     */
    public readonly tpspWindowsUserDomain!: pulumi.Output<string | undefined>;

    /**
     * Create a PolicyDeviceAssuranceWindows resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyDeviceAssuranceWindowsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyDeviceAssuranceWindowsArgs | PolicyDeviceAssuranceWindowsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyDeviceAssuranceWindowsState | undefined;
            ...
            resourceInputs["tpspCrowdStrikeAgentId"] = state ? state.tpspCrowdStrikeAgentId : undefined;
            resourceInputs["tpspCrowdStrikeCustomerId"] = state ? state.tpspCrowdStrikeCustomerId : undefined;
            ...
            resourceInputs["tpspSecureBootEnabled"] = state ? state.tpspSecureBootEnabled : undefined;
            resourceInputs["tpspSiteIsolationEnabled"] = state ? state.tpspSiteIsolationEnabled : undefined;
            resourceInputs["tpspThirdPartyBlockingEnabled"] = state ? state.tpspThirdPartyBlockingEnabled : undefined;
            resourceInputs["tpspWindowsMachineDomain"] = state ? state.tpspWindowsMachineDomain : undefined;
            resourceInputs["tpspWindowsUserDomain"] = state ? state.tpspWindowsUserDomain : undefined;
        } else {
            const args = argsOrState as PolicyDeviceAssuranceWindowsArgs | undefined;
            ...
            resourceInputs["tpspCrowdStrikeAgentId"] = args ? args.tpspCrowdStrikeAgentId : undefined;
            resourceInputs["tpspCrowdStrikeCustomerId"] = args ? args.tpspCrowdStrikeCustomerId : undefined;
            ...
            resourceInputs["tpspSecureBootEnabled"] = args ? args.tpspSecureBootEnabled : undefined;
            resourceInputs["tpspSiteIsolationEnabled"] = args ? args.tpspSiteIsolationEnabled : undefined;
            resourceInputs["tpspThirdPartyBlockingEnabled"] = args ? args.tpspThirdPartyBlockingEnabled : undefined;
            resourceInputs["tpspWindowsMachineDomain"] = args ? args.tpspWindowsMachineDomain : undefined;
            resourceInputs["tpspWindowsUserDomain"] = args ? args.tpspWindowsUserDomain : undefined;
        ...
        super(PolicyDeviceAssuranceWindows.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyDeviceAssuranceWindows resources.
 */
export interface PolicyDeviceAssuranceWindowsState {
    /**
     * Created by
     */
...
/**
 * The set of arguments for constructing a PolicyDeviceAssuranceWindows resource.
 */
export interface PolicyDeviceAssuranceWindowsArgs {
    /**
     * List of disk encryption type, can be `ALL_INTERNAL_VOLUMES`
     */
    diskEncryptionTypes?: pulumi.Input<pulumi.Input<string>[]>;
