...
export class PolicyRuleSignon extends pulumi.CustomResource {
    /**
     * Get an existing PolicyRuleSignon resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyRuleSignonState, opts?: pulumi.CustomResourceOptions): PolicyRuleSignon {
        return new PolicyRuleSignon(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/policyRuleSignon:PolicyRuleSignon';

    /**
     * Returns true if the given object is an instance of PolicyRuleSignon.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyRuleSignon {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyRuleSignon.__pulumiType;
    }
     ...
     */
    public readonly factorSequences!: pulumi.Output<outputs.PolicyRuleSignonFactorSequence[] | undefined>;
    /**
    ...
    /**
     * Create a PolicyRuleSignon resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyRuleSignonArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyRuleSignonArgs | PolicyRuleSignonState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyRuleSignonState | undefined;
            ...
            const args = argsOrState as PolicyRuleSignonArgs | undefined;
        ...
        super(PolicyRuleSignon.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyRuleSignon resources.
 */
export interface PolicyRuleSignonState {
    /**
     * Allow or deny access based on the rule conditions: `ALLOW`, `DENY` or `CHALLENGE`. Default: `ALLOW`
     */
     ...
     * authentication step. - 'factor_type' - (Required) Factor type of the additional authentication step.
     */
    factorSequences?: pulumi.Input<pulumi.Input<inputs.PolicyRuleSignonFactorSequence>[]>;
    /**
     * Apply rule based on the IdP used: `ANY`, `OKTA` or `SPECIFIC_IDP`. Default: `ANY`. > **WARNING**: Use of
     * `identity_provider` requires a feature flag to be enabled.
     */
...
/**
 * The set of arguments for constructing a PolicyRuleSignon resource.
 */
export interface PolicyRuleSignonArgs {
    /**
     * Allow or deny access based on the rule conditions: `ALLOW`, `DENY` or `CHALLENGE`. Default: `ALLOW`
     */
    access?: pulumi.Input<string>;
