...
export class AppOauth extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'okta:index/appOauth:AppOauth';
    ...
    /**
     * Requested key rotation mode. If auto_key_rotation isn't specified, the client automatically opts in for Okta's key
     * rotation. You can update this property via the API or via the administrator UI. See:
    ...
    /**
     * OAuth client secret value, this is output only. This will be in plain text in your statefile unless you set omit_secret
     * above.
     */
    ...
    /**
     * Groups claim for an OpenID Connect client application (argument is ignored when API auth is done with OAuth 2.0
     * credentials)
     */
    public readonly groupsClaim!: pulumi.Output<outputs.AppOauthGroupsClaim | undefined>;
    /**
    ...
    public readonly jwks!: pulumi.Output<outputs.AppOauthJwk[] | undefined>;
    /**
    ...
    /**
     * This tells the provider not manage the client_secret value in state. When this is false (the default), it will cause the
     * auto-generated client_secret to be persisted in the client_secret attribute in state. This also means that every time an
     * update to this app is run, this value is also set on the API. If this changes from false => true, the `client_secret` is
     * dropped from state and the secret at the time of the apply is what remains. If this is ever changes from true => false
     * your app will be recreated, due to the need to regenerate a secret we can store in state.
     */
    ...
    /**
     * List of URIs for redirection after logout. Note: see okta.AppOauthPostLogoutRedirectUri for appending to this list in a
     * decentralized way.
     */
     ...
     * okta.AppOauthRedirectUri for appending to this list in a decentralized way.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppOauthTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AppOauthArgs | AppOauthState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AppOauth.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AppOauthState {
     ...
     * credentials)
     */
    groupsClaim?: pulumi.Input<inputs.AppOauthGroupsClaim>;
    /**
     * Do not display application icon on mobile app
     */
    ...
    jwks?: pulumi.Input<pulumi.Input<inputs.AppOauthJwk>[]>;
    /**
     * URL reference to JWKS
     */
    ...
    timeouts?: pulumi.Input<inputs.AppOauthTimeouts>;
    /**
     * Requested authentication method for the token endpoint.
     */
