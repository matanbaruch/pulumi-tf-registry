...
export class PolicyDeviceAssuranceMacos extends pulumi.CustomResource {
    /**
     * Get an existing PolicyDeviceAssuranceMacos resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyDeviceAssuranceMacosState, opts?: pulumi.CustomResourceOptions): PolicyDeviceAssuranceMacos {
        return new PolicyDeviceAssuranceMacos(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/policyDeviceAssuranceMacos:PolicyDeviceAssuranceMacos';

    /**
     * Returns true if the given object is an instance of PolicyDeviceAssuranceMacos.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyDeviceAssuranceMacos {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyDeviceAssuranceMacos.__pulumiType;
    }
    ...
    /**
     * Create a PolicyDeviceAssuranceMacos resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyDeviceAssuranceMacosArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyDeviceAssuranceMacosArgs | PolicyDeviceAssuranceMacosState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyDeviceAssuranceMacosState | undefined;
            ...
            const args = argsOrState as PolicyDeviceAssuranceMacosArgs | undefined;
        ...
        super(PolicyDeviceAssuranceMacos.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyDeviceAssuranceMacos resources.
 */
export interface PolicyDeviceAssuranceMacosState {
    /**
     * Created by
     */
...
/**
 * The set of arguments for constructing a PolicyDeviceAssuranceMacos resource.
 */
export interface PolicyDeviceAssuranceMacosArgs {
    /**
     * List of disk encryption type, can be `ALL_INTERNAL_VOLUMES`
     */
    diskEncryptionTypes?: pulumi.Input<pulumi.Input<string>[]>;
