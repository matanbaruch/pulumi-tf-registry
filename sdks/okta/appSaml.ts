...
export class AppSaml extends pulumi.CustomResource {
    /**
     * Get an existing AppSaml resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppSamlState, opts?: pulumi.CustomResourceOptions): AppSaml {
        return new AppSaml(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/appSaml:AppSaml';

    /**
     * Returns true if the given object is an instance of AppSaml.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppSaml {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppSaml.__pulumiType;
    }
    ...
    public readonly attributeStatements!: pulumi.Output<outputs.AppSamlAttributeStatement[] | undefined>;
    /**
     * Audience Restriction
     */
    public readonly audience!: pulumi.Output<string | undefined>;
    /**
     * The ID of the associated `app_signon_policy`. If this property is removed from the application the `default`
     * sign-on-policy will be associated with this application.y
     */
     ...
     * Application keys
     */
    public /*out*/ readonly keys!: pulumi.Output<outputs.AppSamlKey[]>;
    /**
    ...
    /**
     * Name of application from the Okta Integration Network. For instance 'slack'. If not included a custom app will be
     * created. If not provided the following arguments are required: 'sso_url' 'recipient' 'destination' 'audience'
     * 'subject_name_id_template' 'subject_name_id_format' 'signature_algorithm' 'digest_algorithm' 'authn_context_class_ref'
     */
    ...
    /**
     * x509 encoded certificate that the Service Provider uses to sign Single Logout requests. Note: should be provided without
     * `-----BEGIN CERTIFICATE-----` and `-----END CERTIFICATE-----`, see [official
     * documentation](https://developer.okta.com/docs/reference/api/apps/#service-provider-certificate).
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppSamlTimeouts | undefined>;
    /**
    ...
    /**
     * Create a AppSaml resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppSamlArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppSamlArgs | AppSamlState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppSamlState | undefined;
            ...
            const args = argsOrState as AppSamlArgs | undefined;
        ...
        super(AppSaml.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppSaml resources.
 */
export interface AppSamlState {
    /**
     * Custom error page URL
     */
    ...
    attributeStatements?: pulumi.Input<pulumi.Input<inputs.AppSamlAttributeStatement>[]>;
    /**
     * Audience Restriction
     */
     ...
     * Application keys
     */
    keys?: pulumi.Input<pulumi.Input<inputs.AppSamlKey>[]>;
    /**
     * The Application's display name.
     */
    ...
    timeouts?: pulumi.Input<inputs.AppSamlTimeouts>;
    /**
     * Username template. Default: `${source.login}`
     */
...
/**
 * The set of arguments for constructing a AppSaml resource.
 */
export interface AppSamlArgs {
    /**
     * Custom error page URL
     */
    accessibilityErrorRedirectUrl?: pulumi.Input<string>;
