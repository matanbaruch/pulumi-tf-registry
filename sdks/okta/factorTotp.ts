...
export class FactorTotp extends pulumi.CustomResource {
    ...
    /**
     * Clock drift interval. This setting allows you to build in tolerance for any drift between the token's current time and
     * the server's current time. Valid values: `3`, `5`, `10`. Default is `3`.
     */
    ...
    constructor(name: string, argsOrState?: FactorTotpArgs | FactorTotpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FactorTotp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
