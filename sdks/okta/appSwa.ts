...
export class AppSwa extends pulumi.CustomResource {
    /**
     * Get an existing AppSwa resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppSwaState, opts?: pulumi.CustomResourceOptions): AppSwa {
        return new AppSwa(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/appSwa:AppSwa';

    /**
     * Returns true if the given object is an instance of AppSwa.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppSwa {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppSwa.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppSwaTimeouts | undefined>;
    /**
     * Login URL
     */
    ...
    /**
     * Create a AppSwa resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppSwaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppSwaArgs | AppSwaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppSwaState | undefined;
            ...
            const args = argsOrState as AppSwaArgs | undefined;
        ...
        super(AppSwa.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppSwa resources.
 */
export interface AppSwaState {
    /**
     * Custom error page URL
     */
    ...
    timeouts?: pulumi.Input<inputs.AppSwaTimeouts>;
    /**
     * Login URL
     */
...
/**
 * The set of arguments for constructing a AppSwa resource.
 */
export interface AppSwaArgs {
    /**
     * Custom error page URL
     */
    accessibilityErrorRedirectUrl?: pulumi.Input<string>;
