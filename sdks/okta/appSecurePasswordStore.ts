...
export class AppSecurePasswordStore extends pulumi.CustomResource {
    /**
     * Get an existing AppSecurePasswordStore resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppSecurePasswordStoreState, opts?: pulumi.CustomResourceOptions): AppSecurePasswordStore {
        return new AppSecurePasswordStore(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/appSecurePasswordStore:AppSecurePasswordStore';

    /**
     * Returns true if the given object is an instance of AppSecurePasswordStore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppSecurePasswordStore {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppSecurePasswordStore.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppSecurePasswordStoreTimeouts | undefined>;
    /**
     * Login URL
     */
    ...
    /**
     * Create a AppSecurePasswordStore resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppSecurePasswordStoreArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppSecurePasswordStoreArgs | AppSecurePasswordStoreState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppSecurePasswordStoreState | undefined;
            ...
            const args = argsOrState as AppSecurePasswordStoreArgs | undefined;
        ...
        super(AppSecurePasswordStore.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppSecurePasswordStore resources.
 */
export interface AppSecurePasswordStoreState {
    /**
     * Custom error page URL
     */
    ...
    timeouts?: pulumi.Input<inputs.AppSecurePasswordStoreTimeouts>;
    /**
     * Login URL
     */
...
/**
 * The set of arguments for constructing a AppSecurePasswordStore resource.
 */
export interface AppSecurePasswordStoreArgs {
    /**
     * Custom error page URL
     */
    accessibilityErrorRedirectUrl?: pulumi.Input<string>;
