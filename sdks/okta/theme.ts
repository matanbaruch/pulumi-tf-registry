...
export class Theme extends pulumi.CustomResource {
    ...
    /**
     * Variant for the Okta End-User Dashboard (`OKTA_DEFAULT`, `WHITE_LOGO_BACKGROUND`, `FULL_THEME`,
    ...
    /**
     * Theme ID - Note: Okta API for theme only reads and updates therefore the okta.Theme resource needs to act as a quasi
     * data source. Do this by setting theme_id.
     */
