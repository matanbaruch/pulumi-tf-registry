...
export class AuthServerClaimDefault extends pulumi.CustomResource {
    ...
    /**
     * The name of the claim. Can be set to `sub`, `address`, `birthdate`, `email`,`email_verified`, `family_name`, `gender`,
     * `given_name`, `locale`, `middle_name`, `name`, `nickname`,`phone_number`, `picture`, `preferred_username`, `profile`,
    ...
    constructor(name: string, argsOrState?: AuthServerClaimDefaultArgs | AuthServerClaimDefaultState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AuthServerClaimDefault.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
