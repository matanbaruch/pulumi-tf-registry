...
export class AppSharedCredentials extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppSharedCredentialsTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AppSharedCredentialsArgs | AppSharedCredentialsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AppSharedCredentials.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AppSharedCredentialsState {
    ...
    timeouts?: pulumi.Input<inputs.AppSharedCredentialsTimeouts>;
    /**
     * The URL of the sign-in page for this app.
     */
