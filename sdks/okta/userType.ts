...
export class UserType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'okta:index/userType:UserType';
    ...
    constructor(name: string, argsOrState?: UserTypeArgs | UserTypeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserType.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
