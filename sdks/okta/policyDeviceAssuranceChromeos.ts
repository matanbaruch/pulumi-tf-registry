...
export class PolicyDeviceAssuranceChromeos extends pulumi.CustomResource {
    /**
     * Get an existing PolicyDeviceAssuranceChromeos resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyDeviceAssuranceChromeosState, opts?: pulumi.CustomResourceOptions): PolicyDeviceAssuranceChromeos {
        return new PolicyDeviceAssuranceChromeos(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/policyDeviceAssuranceChromeos:PolicyDeviceAssuranceChromeos';

    /**
     * Returns true if the given object is an instance of PolicyDeviceAssuranceChromeos.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyDeviceAssuranceChromeos {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyDeviceAssuranceChromeos.__pulumiType;
    }
    ...
    /**
     * Create a PolicyDeviceAssuranceChromeos resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyDeviceAssuranceChromeosArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyDeviceAssuranceChromeosArgs | PolicyDeviceAssuranceChromeosState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyDeviceAssuranceChromeosState | undefined;
            ...
            const args = argsOrState as PolicyDeviceAssuranceChromeosArgs | undefined;
        ...
        super(PolicyDeviceAssuranceChromeos.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyDeviceAssuranceChromeos resources.
 */
export interface PolicyDeviceAssuranceChromeosState {
    /**
     * Created by
     */
...
/**
 * The set of arguments for constructing a PolicyDeviceAssuranceChromeos resource.
 */
export interface PolicyDeviceAssuranceChromeosArgs {
    /**
     * Name of the device assurance policy.
     */
    name?: pulumi.Input<string>;
