...
export class GroupRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'okta:index/groupRole:GroupRole';
    ...
    constructor(name: string, argsOrState?: GroupRoleArgs | GroupRoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GroupRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
