...
export class PolicyMfa extends pulumi.CustomResource {
    /**
     * Get an existing PolicyMfa resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyMfaState, opts?: pulumi.CustomResourceOptions): PolicyMfa {
        return new PolicyMfa(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'okta:index/policyMfa:PolicyMfa';

    /**
     * Returns true if the given object is an instance of PolicyMfa.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyMfa {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyMfa.__pulumiType;
    }
    ...
    /**
     * Create a PolicyMfa resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyMfaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyMfaArgs | PolicyMfaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyMfaState | undefined;
            ...
            const args = argsOrState as PolicyMfaArgs | undefined;
        ...
        super(PolicyMfa.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyMfa resources.
 */
export interface PolicyMfaState {
    /**
     * Policy Description
     */
...
/**
 * The set of arguments for constructing a PolicyMfa resource.
 */
export interface PolicyMfaArgs {
    /**
     * Policy Description
     */
    description?: pulumi.Input<string>;
