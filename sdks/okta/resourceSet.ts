...
export class ResourceSet extends pulumi.CustomResource {
    ...
    /**
     * The endpoints that reference the resources to be included in the new Resource Set. At least one endpoint must be
     * specified when creating resource set.
     */
    ...
    constructor(name: string, argsOrState?: ResourceSetArgs | ResourceSetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ResourceSet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
