...
export class IdpSaml extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'okta:index/idpSaml:IdpSaml';
    ...
    /**
     * Specifies whether to digitally sign an AuthnRequest messages to the IdP. It can be `REQUEST` or `NONE`. Default:
     * `REQUEST`
     */
    public readonly requestSignatureScope!: pulumi.Output<string | undefined>;
    /**
     * The minimum XML digital signature algorithm allowed when verifying a `SAMLResponse` message or Assertion element. It can
     * be `SHA-256` or `SHA-1`. Default: `SHA-256`
     */
    public readonly responseSignatureAlgorithm!: pulumi.Output<string | undefined>;
    /**
     * Specifies whether to verify a `SAMLResponse` message or Assertion element XML digital signature. It can be `RESPONSE`,
     * `ASSERTION`, or `ANY`. Default: `ANY`
     */
