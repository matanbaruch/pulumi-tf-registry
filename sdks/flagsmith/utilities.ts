...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("flagsmith");
			params.setVersion("0.8.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ZsYWdzbWl0aC9mbGFnc21pdGgiLCJ2ZXJzaW9uIjoiMC44LjAifX0="), c => c.charCodeAt(0)));
