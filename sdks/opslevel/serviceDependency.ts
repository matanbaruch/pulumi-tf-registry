...
export class ServiceDependency extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'opslevel:index/serviceDependency:ServiceDependency';
     ...
     */
    public readonly dependsUpon!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceDependencyArgs | ServiceDependencyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dependsUpon"] = state ? state.dependsUpon : undefined;
            resourceInputs["note"] = state ? state.note : undefined;
            resourceInputs["service"] = state ? state.service : undefined;
        } else {
            const args = argsOrState as ServiceDependencyArgs | undefined;
            if ((!args || args.dependsUpon === undefined) && !opts.urn) {
                throw new Error("Missing required property 'dependsUpon'");
            }
            if ((!args || args.service === undefined) && !opts.urn) {
                throw new Error("Missing required property 'service'");
            }
            resourceInputs["dependsUpon"] = args ? args.dependsUpon : undefined;
...
export interface ServiceDependencyState {
     ...
     * The ID or alias of the service that is depended upon.
     */
    dependsUpon?: pulumi.Input<string>;
    /**
     * Notes for service dependency.
     */
