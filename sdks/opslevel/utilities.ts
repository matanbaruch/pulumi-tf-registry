...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("opslevel");
			params.setVersion("1.2.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL29wc2xldmVsL29wc2xldmVsIiwidmVyc2lvbiI6IjEuMi43In19"), c => c.charCodeAt(0)));
