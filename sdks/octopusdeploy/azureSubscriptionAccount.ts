...
export class AzureSubscriptionAccount extends pulumi.CustomResource {
    ...
    public readonly managementEndpoint!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly storageEndpointSuffix!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AzureSubscriptionAccountArgs | AzureSubscriptionAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AzureSubscriptionAccount.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
