...
export class OfflinePackageDropDeploymentTarget extends pulumi.CustomResource {
    ...
    public readonly destination!: pulumi.Output<outputs.OfflinePackageDropDeploymentTargetDestination | undefined>;
    public readonly endpoints!: pulumi.Output<outputs.OfflinePackageDropDeploymentTargetEndpoint[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: OfflinePackageDropDeploymentTargetArgs | OfflinePackageDropDeploymentTargetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OfflinePackageDropDeploymentTarget.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
