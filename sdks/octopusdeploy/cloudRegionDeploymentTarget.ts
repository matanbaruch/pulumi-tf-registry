...
export class CloudRegionDeploymentTarget extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudRegionDeploymentTargetState, opts?: pulumi.CustomResourceOptions): CloudRegionDeploymentTarget {
        return new CloudRegionDeploymentTarget(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'octopusdeploy:index/cloudRegionDeploymentTarget:CloudRegionDeploymentTarget';

    /**
     * Returns true if the given object is an instance of CloudRegionDeploymentTarget.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudRegionDeploymentTarget {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudRegionDeploymentTarget.__pulumiType;
    }

    public readonly defaultWorkerPoolId!: pulumi.Output<string | undefined>;
    public readonly endpoints!: pulumi.Output<outputs.CloudRegionDeploymentTargetEndpoint[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: CloudRegionDeploymentTargetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CloudRegionDeploymentTargetArgs | CloudRegionDeploymentTargetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudRegionDeploymentTargetState | undefined;
            ...
            const args = argsOrState as CloudRegionDeploymentTargetArgs | undefined;
        ...
        super(CloudRegionDeploymentTarget.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface CloudRegionDeploymentTargetState {
    defaultWorkerPoolId?: pulumi.Input<string>;
    endpoints?: pulumi.Input<pulumi.Input<inputs.CloudRegionDeploymentTargetEndpoint>[]>;
    /**
     * A list of environment IDs associated with this resource.
     */
 ...
 */
export interface CloudRegionDeploymentTargetArgs {
    defaultWorkerPoolId?: pulumi.Input<string>;
    endpoints?: pulumi.Input<pulumi.Input<inputs.CloudRegionDeploymentTargetEndpoint>[]>;
    /**
     * A list of environment IDs associated with this resource.
