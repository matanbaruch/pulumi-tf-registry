...
export class DeploymentProcess extends pulumi.CustomResource {
    ...
    /**
     * The branch name associated with this deployment process (i.e. `main`). This value is optional and only applies to
     * associated projects that are stored in version control.
     */
    ...
    constructor(name: string, argsOrState?: DeploymentProcessArgs | DeploymentProcessState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DeploymentProcess.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
