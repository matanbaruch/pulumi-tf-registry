...
export class ScriptModule extends pulumi.CustomResource {
     ...
     */
    public readonly scripts!: pulumi.Output<outputs.ScriptModuleScript[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ScriptModuleArgs | ScriptModuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["scripts"] = state ? state.scripts : undefined;
        ...
        super(ScriptModule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ScriptModuleState {
     ...
     * The script associated with this script module.
     */
    scripts?: pulumi.Input<pulumi.Input<inputs.ScriptModuleScript>[]>;
    /**
     * The space ID associated with this Script Module.
     */
