...
export class PollingTentacleDeploymentTarget extends pulumi.CustomResource {
    ...
    public readonly endpoints!: pulumi.Output<outputs.PollingTentacleDeploymentTargetEndpoint[] | undefined>;
    /**
    ...
    public readonly tentacleVersionDetails!: pulumi.Output<outputs.PollingTentacleDeploymentTargetTentacleVersionDetail[] | undefined>;
    ...
    constructor(name: string, argsOrState?: PollingTentacleDeploymentTargetArgs | PollingTentacleDeploymentTargetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PollingTentacleDeploymentTarget.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
