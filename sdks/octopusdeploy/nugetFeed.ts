...
export class NugetFeed extends pulumi.CustomResource {
     ...
     */
    public readonly downloadAttempts!: pulumi.Output<number>;
    /**
     * The number of seconds to apply as a linear back off between download attempts.
     */
    public readonly downloadRetryBackoffSeconds!: pulumi.Output<number>;
    public readonly feedUri!: pulumi.Output<string>;
    /**
     * This will improve performance of the NuGet feed but may not be supported by some older feeds. Disable if the operation,
     * Create Release does not return the latest version for a package.
     */
    public readonly isEnhancedMode!: pulumi.Output<boolean>;
    /**
    ...
    constructor(name: string, argsOrState?: NugetFeedArgs | NugetFeedState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NugetFeed.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
