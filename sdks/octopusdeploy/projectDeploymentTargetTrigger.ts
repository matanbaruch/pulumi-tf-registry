...
export class ProjectDeploymentTargetTrigger extends pulumi.CustomResource {
    ...
    /**
     * Apply environment id filters to restrict which deployment targets will actually cause the trigger to fire, and
     * consequently, which deployment targets will be automatically deployed to.
     */
    public readonly environmentIds!: pulumi.Output<string[] | undefined>;
    /**
     * Apply event category filters to restrict which deployment targets will actually cause the trigger to fire, and
     * consequently, which deployment targets will be automatically deployed to.
     */
    public readonly eventCategories!: pulumi.Output<string[] | undefined>;
    /**
     * Apply event group filters to restrict which deployment targets will actually cause the trigger to fire, and
     * consequently, which deployment targets will be automatically deployed to.
     */
    ...
    /**
     * Apply event role filters to restrict which deployment targets will actually cause the trigger to fire, and consequently,
     * which deployment targets will be automatically deployed to.
     */
    ...
    constructor(name: string, argsOrState?: ProjectDeploymentTargetTriggerArgs | ProjectDeploymentTargetTriggerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectDeploymentTargetTrigger.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
