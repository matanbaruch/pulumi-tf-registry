...
export class ListeningTentacleDeploymentTarget extends pulumi.CustomResource {
    ...
    public readonly tentacleVersionDetails!: pulumi.Output<outputs.ListeningTentacleDeploymentTargetTentacleVersionDetail[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ListeningTentacleDeploymentTargetArgs | ListeningTentacleDeploymentTargetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ListeningTentacleDeploymentTarget.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
