...
export class MachinePolicy extends pulumi.CustomResource {
    ...
    public readonly machineCleanupPolicy!: pulumi.Output<outputs.MachinePolicyMachineCleanupPolicy | undefined>;
    public readonly machineConnectivityPolicy!: pulumi.Output<outputs.MachinePolicyMachineConnectivityPolicy | undefined>;
    public readonly machineHealthCheckPolicy!: pulumi.Output<outputs.MachinePolicyMachineHealthCheckPolicy | undefined>;
    public readonly machineUpdatePolicy!: pulumi.Output<outputs.MachinePolicyMachineUpdatePolicy | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MachinePolicyArgs | MachinePolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MachinePolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
