...
export class AdministrativeUnitRoleMember extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AdministrativeUnitRoleMemberTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AdministrativeUnitRoleMemberArgs | AdministrativeUnitRoleMemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AdministrativeUnitRoleMember.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AdministrativeUnitRoleMemberState {
    ...
    timeouts?: pulumi.Input<inputs.AdministrativeUnitRoleMemberTimeouts>;
}
