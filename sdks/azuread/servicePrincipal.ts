...
export class ServicePrincipal extends pulumi.CustomResource {
     ...
     */
    public readonly featureTags!: pulumi.Output<outputs.ServicePrincipalFeatureTag[] | undefined>;
    /**
     * Block of features to configure for this service principal using tags
     *
     * @deprecated Deprecated
     */
    public readonly features!: pulumi.Output<outputs.ServicePrincipalFeature[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServicePrincipalTimeouts | undefined>;
    /**
...
export interface ServicePrincipalState {
    ...
    timeouts?: pulumi.Input<inputs.ServicePrincipalTimeouts>;
    /**
     * Identifies whether the service principal represents an application or a managed identity
     */
