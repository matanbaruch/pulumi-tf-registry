...
export class SynchronizationJob extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.SynchronizationJobTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SynchronizationJobArgs | SynchronizationJobState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SynchronizationJob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SynchronizationJobState {
    ...
    timeouts?: pulumi.Input<inputs.SynchronizationJobTimeouts>;
}
