...
export class ApplicationFederatedIdentityCredential extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ApplicationFederatedIdentityCredentialTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ApplicationFederatedIdentityCredentialArgs | ApplicationFederatedIdentityCredentialState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApplicationFederatedIdentityCredential.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ApplicationFederatedIdentityCredentialState {
    ...
    timeouts?: pulumi.Input<inputs.ApplicationFederatedIdentityCredentialTimeouts>;
}
