...
export class AdministrativeUnitMember extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AdministrativeUnitMemberTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AdministrativeUnitMemberArgs | AdministrativeUnitMemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AdministrativeUnitMember.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AdministrativeUnitMemberState {
    ...
    timeouts?: pulumi.Input<inputs.AdministrativeUnitMemberTimeouts>;
}
