...
export class ApplicationRedirectUris extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ApplicationRedirectUrisTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ApplicationRedirectUrisArgs | ApplicationRedirectUrisState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApplicationRedirectUris.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ApplicationRedirectUrisState {
    ...
    timeouts?: pulumi.Input<inputs.ApplicationRedirectUrisTimeouts>;
    /**
     * The type of redirect URIs to assign to the application
     */
