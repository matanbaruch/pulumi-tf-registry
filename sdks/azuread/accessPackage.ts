...
export class AccessPackage extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AccessPackageTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AccessPackageArgs | AccessPackageState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AccessPackage.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AccessPackageState {
    ...
    timeouts?: pulumi.Input<inputs.AccessPackageTimeouts>;
}
