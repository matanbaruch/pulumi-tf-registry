...
export class ConditionalAccessPolicy extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ConditionalAccessPolicyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ConditionalAccessPolicyArgs | ConditionalAccessPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConditionalAccessPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ConditionalAccessPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.ConditionalAccessPolicyTimeouts>;
}
