...
export class AccessPackageCatalog extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AccessPackageCatalogTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AccessPackageCatalogArgs | AccessPackageCatalogState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AccessPackageCatalog.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AccessPackageCatalogState {
    ...
    timeouts?: pulumi.Input<inputs.AccessPackageCatalogTimeouts>;
}
