...
export class AppRoleAssignment extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AppRoleAssignmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AppRoleAssignmentArgs | AppRoleAssignmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AppRoleAssignment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AppRoleAssignmentState {
    ...
    timeouts?: pulumi.Input<inputs.AppRoleAssignmentTimeouts>;
}
