...
export class UserFlowAttribute extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.UserFlowAttributeTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: UserFlowAttributeArgs | UserFlowAttributeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserFlowAttribute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface UserFlowAttributeState {
    ...
    timeouts?: pulumi.Input<inputs.UserFlowAttributeTimeouts>;
}
