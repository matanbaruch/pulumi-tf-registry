...
export class DirectoryRoleAssignment extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DirectoryRoleAssignmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DirectoryRoleAssignmentArgs | DirectoryRoleAssignmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DirectoryRoleAssignment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DirectoryRoleAssignmentState {
    ...
    timeouts?: pulumi.Input<inputs.DirectoryRoleAssignmentTimeouts>;
}
