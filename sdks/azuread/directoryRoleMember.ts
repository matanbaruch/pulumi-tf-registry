...
export class DirectoryRoleMember extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.DirectoryRoleMemberTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: DirectoryRoleMemberArgs | DirectoryRoleMemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DirectoryRoleMember.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DirectoryRoleMemberState {
    ...
    timeouts?: pulumi.Input<inputs.DirectoryRoleMemberTimeouts>;
}
