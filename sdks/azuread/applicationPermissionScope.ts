...
export class ApplicationPermissionScope extends pulumi.CustomResource {
    ...
    /**
     * Delegated permission description that appears in all tenant-wide admin consent experiences, intended to be read by an
     * administrator granting the permission on behalf of all users
     */
    public readonly adminConsentDescription!: pulumi.Output<string>;
    /**
     * Display name for the delegated permission, intended to be read by an administrator granting the permission on behalf of
     * all users
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.ApplicationPermissionScopeTimeouts | undefined>;
    /**
     * Whether this delegated permission should be considered safe for non-admin users to consent to on behalf of themselves,
     * or whether an administrator should be required for consent to the permissions
     */
    public readonly type!: pulumi.Output<string | undefined>;
    /**
     * Delegated permission description that appears in the end user consent experience, intended to be read by a user
    ...
    constructor(name: string, argsOrState?: ApplicationPermissionScopeArgs | ApplicationPermissionScopeState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApplicationPermissionScope.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ApplicationPermissionScopeState {
    ...
    timeouts?: pulumi.Input<inputs.ApplicationPermissionScopeTimeouts>;
    /**
     * Whether this delegated permission should be considered safe for non-admin users to consent to on behalf of themselves,
     * or whether an administrator should be required for consent to the permissions
     */
