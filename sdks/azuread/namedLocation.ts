...
export class NamedLocation extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.NamedLocationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: NamedLocationArgs | NamedLocationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NamedLocation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface NamedLocationState {
    ...
    timeouts?: pulumi.Input<inputs.NamedLocationTimeouts>;
}
