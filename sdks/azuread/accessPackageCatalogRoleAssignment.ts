...
export class AccessPackageCatalogRoleAssignment extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AccessPackageCatalogRoleAssignmentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AccessPackageCatalogRoleAssignmentArgs | AccessPackageCatalogRoleAssignmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AccessPackageCatalogRoleAssignment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AccessPackageCatalogRoleAssignmentState {
    ...
    timeouts?: pulumi.Input<inputs.AccessPackageCatalogRoleAssignmentTimeouts>;
}
