...
export class AuthenticationStrengthPolicy extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AuthenticationStrengthPolicyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AuthenticationStrengthPolicyArgs | AuthenticationStrengthPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AuthenticationStrengthPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AuthenticationStrengthPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.AuthenticationStrengthPolicyTimeouts>;
}
