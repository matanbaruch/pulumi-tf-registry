...
export class ServicePrincipalCertificate extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServicePrincipalCertificateTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServicePrincipalCertificateArgs | ServicePrincipalCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServicePrincipalCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServicePrincipalCertificateState {
    ...
    timeouts?: pulumi.Input<inputs.ServicePrincipalCertificateTimeouts>;
    /**
     * The type of key/certificate
     */
