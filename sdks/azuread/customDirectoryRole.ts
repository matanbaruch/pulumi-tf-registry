...
export class CustomDirectoryRole extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CustomDirectoryRoleTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CustomDirectoryRoleArgs | CustomDirectoryRoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CustomDirectoryRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CustomDirectoryRoleState {
    ...
    timeouts?: pulumi.Input<inputs.CustomDirectoryRoleTimeouts>;
    /**
     * The version of the role definition.
     */
