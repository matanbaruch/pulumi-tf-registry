...
export class ClaimsMappingPolicy extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClaimsMappingPolicyTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ClaimsMappingPolicyArgs | ClaimsMappingPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClaimsMappingPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ClaimsMappingPolicyState {
    ...
    timeouts?: pulumi.Input<inputs.ClaimsMappingPolicyTimeouts>;
}
