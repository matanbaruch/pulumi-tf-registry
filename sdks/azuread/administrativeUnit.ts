...
export class AdministrativeUnit extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AdministrativeUnitTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AdministrativeUnitArgs | AdministrativeUnitState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AdministrativeUnit.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AdministrativeUnitState {
    ...
    timeouts?: pulumi.Input<inputs.AdministrativeUnitTimeouts>;
}
