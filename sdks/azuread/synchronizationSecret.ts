...
export class SynchronizationSecret extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.SynchronizationSecretTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: SynchronizationSecretArgs | SynchronizationSecretState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SynchronizationSecret.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SynchronizationSecretState {
    ...
    timeouts?: pulumi.Input<inputs.SynchronizationSecretTimeouts>;
}
