...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("stackbill");
			params.setVersion("0.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2Fzc2lzdGFuei9zdGFja2JpbGwiLCJ2ZXJzaW9uIjoiMC4xLjAifX0="), c => c.charCodeAt(0)));
