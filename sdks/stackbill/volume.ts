...
export class Volume extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'stackbill:index/volume:Volume';
    ...
    public readonly storageOfferingUuid!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: VolumeArgs | VolumeState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.storageOfferingUuid === undefined) && !opts.urn) {
                throw new Error("Missing required property 'storageOfferingUuid'");
            }
