...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("apstra");
			params.setVersion("0.71.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2p1bmlwZXIvYXBzdHJhIiwidmVyc2lvbiI6IjAuNzEuMCJ9fQ=="), c => c.charCodeAt(0)));
