...
export class Keypair extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcorelabs:index/keypair:Keypair';
    ...
    constructor(name: string, argsOrState?: KeypairArgs | KeypairState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.sshkeyName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'sshkeyName'");
            }
