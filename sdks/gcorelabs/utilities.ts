...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gcorelabs");
			params.setVersion("0.3.63");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2ctY29yZS9nY29yZWxhYnMiLCJ2ZXJzaW9uIjoiMC4zLjYzIn19"), c => c.charCodeAt(0)));
