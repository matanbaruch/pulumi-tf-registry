...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("dmsnitch");
			params.setVersion("0.1.5");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BsdWtldmRoL2Rtc25pdGNoIiwidmVyc2lvbiI6IjAuMS41In19"), c => c.charCodeAt(0)));
