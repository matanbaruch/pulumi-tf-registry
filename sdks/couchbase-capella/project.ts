...
export class Project extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'couchbase-capella:index/project:Project';
    ...
    public /*out*/ readonly audit!: pulumi.Output<outputs.ProjectAudit>;
...
export interface ProjectState {
    audit?: pulumi.Input<inputs.ProjectAudit>;
