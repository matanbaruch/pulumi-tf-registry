...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("couchbase-capella");
			params.setVersion("1.2.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvdWNoYmFzZWNsb3VkL2NvdWNoYmFzZS1jYXBlbGxhIiwidmVyc2lvbiI6IjEuMi4xIn19"), c => c.charCodeAt(0)));
