...
export class AppJvm extends pulumi.CustomResource {
    /**
     * Get an existing AppJvm resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppJvmState, opts?: pulumi.CustomResourceOptions): AppJvm {
        return new AppJvm(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sematext:index/appJvm:AppJvm';

    /**
     * Returns true if the given object is an instance of AppJvm.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppJvm {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppJvm.__pulumiType;
    }

    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    public readonly apptokens!: pulumi.Output<outputs.AppJvmApptoken[]>;
    /**
    ...
    /**
     * Create a AppJvm resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppJvmArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppJvmArgs | AppJvmState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppJvmState | undefined;
            ...
            const args = argsOrState as AppJvmArgs | undefined;
        ...
        super(AppJvm.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppJvm resources.
 */
export interface AppJvmState {
    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    apptokens?: pulumi.Input<pulumi.Input<inputs.AppJvmApptoken>[]>;
    /**
     * (Required) Plan ID attached to the monitor app in Sematext Cloud.
     */
...
/**
 * The set of arguments for constructing a AppJvm resource.
 */
export interface AppJvmArgs {
    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    apptokens: pulumi.Input<pulumi.Input<inputs.AppJvmApptoken>[]>;
