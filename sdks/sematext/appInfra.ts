...
export class AppInfra extends pulumi.CustomResource {
    /**
     * Get an existing AppInfra resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppInfraState, opts?: pulumi.CustomResourceOptions): AppInfra {
        return new AppInfra(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sematext:index/appInfra:AppInfra';

    /**
     * Returns true if the given object is an instance of AppInfra.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppInfra {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppInfra.__pulumiType;
    }

    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    public readonly apptokens!: pulumi.Output<outputs.AppInfraApptoken[]>;
    /**
    ...
    /**
     * Create a AppInfra resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppInfraArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppInfraArgs | AppInfraState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppInfraState | undefined;
            ...
            const args = argsOrState as AppInfraArgs | undefined;
        ...
        super(AppInfra.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppInfra resources.
 */
export interface AppInfraState {
    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    apptokens?: pulumi.Input<pulumi.Input<inputs.AppInfraApptoken>[]>;
    /**
     * (Required) Plan ID attached to the monitor app in Sematext Cloud.
     */
...
/**
 * The set of arguments for constructing a AppInfra resource.
 */
