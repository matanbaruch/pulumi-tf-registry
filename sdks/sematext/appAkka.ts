...
export class AppAkka extends pulumi.CustomResource {
    /**
     * Get an existing AppAkka resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppAkkaState, opts?: pulumi.CustomResourceOptions): AppAkka {
        return new AppAkka(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sematext:index/appAkka:AppAkka';

    /**
     * Returns true if the given object is an instance of AppAkka.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppAkka {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppAkka.__pulumiType;
    }

    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    public readonly apptokens!: pulumi.Output<outputs.AppAkkaApptoken[]>;
    /**
    ...
    /**
     * Create a AppAkka resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppAkkaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppAkkaArgs | AppAkkaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppAkkaState | undefined;
            ...
            const args = argsOrState as AppAkkaArgs | undefined;
        ...
        super(AppAkka.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppAkka resources.
 */
export interface AppAkkaState {
    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    apptokens?: pulumi.Input<pulumi.Input<inputs.AppAkkaApptoken>[]>;
    /**
     * (Required) Plan ID attached to the monitor app in Sematext Cloud.
     */
...
/**
 * The set of arguments for constructing a AppAkka resource.
 */
export interface AppAkkaArgs {
    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    apptokens: pulumi.Input<pulumi.Input<inputs.AppAkkaApptoken>[]>;
