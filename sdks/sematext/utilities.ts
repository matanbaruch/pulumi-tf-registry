...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("sematext");
			params.setVersion("0.6.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NlbWF0ZXh0L3NlbWF0ZXh0IiwidmVyc2lvbiI6IjAuNi4zIn19"), c => c.charCodeAt(0)));
