...
export class AppSolr extends pulumi.CustomResource {
    /**
     * Get an existing AppSolr resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppSolrState, opts?: pulumi.CustomResourceOptions): AppSolr {
        return new AppSolr(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sematext:index/appSolr:AppSolr';

    /**
     * Returns true if the given object is an instance of AppSolr.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppSolr {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppSolr.__pulumiType;
    }

    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    public readonly apptokens!: pulumi.Output<outputs.AppSolrApptoken[]>;
    /**
    ...
    /**
     * Create a AppSolr resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AppSolrArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppSolrArgs | AppSolrState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppSolrState | undefined;
            ...
            const args = argsOrState as AppSolrArgs | undefined;
        ...
        super(AppSolr.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AppSolr resources.
 */
export interface AppSolrState {
    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    apptokens?: pulumi.Input<pulumi.Input<inputs.AppSolrApptoken>[]>;
    /**
     * (Required) Plan ID attached to the monitor app in Sematext Cloud.
     */
...
/**
 * The set of arguments for constructing a AppSolr resource.
 */
export interface AppSolrArgs {
    /**
     * (required) apptoken(s) attached to the monitor app in Sematext Cloud.
     */
    apptokens: pulumi.Input<pulumi.Input<inputs.AppSolrApptoken>[]>;
