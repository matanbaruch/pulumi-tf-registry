...
export class SysSnmpTraps extends pulumi.CustomResource {
    /**
     * Get an existing SysSnmpTraps resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SysSnmpTrapsState, opts?: pulumi.CustomResourceOptions): SysSnmpTraps {
        return new SysSnmpTraps(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'bigip:index/sysSnmpTraps:SysSnmpTraps';

    /**
     * Returns true if the given object is an instance of SysSnmpTraps.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SysSnmpTraps {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SysSnmpTraps.__pulumiType;
    }
    ...
    /**
     * Create a SysSnmpTraps resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SysSnmpTrapsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SysSnmpTrapsArgs | SysSnmpTrapsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SysSnmpTrapsState | undefined;
            ...
            const args = argsOrState as SysSnmpTrapsArgs | undefined;
        ...
        super(SysSnmpTraps.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SysSnmpTraps resources.
 */
export interface SysSnmpTrapsState {
    /**
     * Encrypted password
     */
...
/**
 * The set of arguments for constructing a SysSnmpTraps resource.
 */
export interface SysSnmpTrapsArgs {
    /**
     * Encrypted password
     */
    authPasswordencrypted?: pulumi.Input<string>;
