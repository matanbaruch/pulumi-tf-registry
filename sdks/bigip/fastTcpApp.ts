...
export class FastTcpApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/fastTcpApp:FastTcpApp';
    ...
    constructor(name: string, argsOrState?: FastTcpAppArgs | FastTcpAppState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FastTcpApp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
