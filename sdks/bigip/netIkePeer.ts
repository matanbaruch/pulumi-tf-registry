...
export class NetIkePeer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/netIkePeer:NetIkePeer';
    ...
    /**
     * Enable or disable the generation of Security Policy Database entries(SPD) when the device is the responder of the IKE
     * remote node
     */
    ...
    /**
     * Defines the exchange mode for phase 1 when racoon is the initiator, or the acceptable exchange mode when racoon is the
     * responder
     */
    ...
    constructor(name: string, argsOrState?: NetIkePeerArgs | NetIkePeerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetIkePeer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
