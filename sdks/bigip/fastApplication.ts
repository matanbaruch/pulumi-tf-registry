...
export class FastApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/fastApplication:FastApplication';
    ...
    /**
     * Name of FAST application tenant.
     */
    ...
    constructor(name: string, argsOrState?: FastApplicationArgs | FastApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FastApplication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
