...
export class SslKeyCert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/sslKeyCert:SslKeyCert';
    ...
    constructor(name: string, argsOrState?: SslKeyCertArgs | SslKeyCertState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SslKeyCert.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
