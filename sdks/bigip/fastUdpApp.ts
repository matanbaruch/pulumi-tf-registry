...
export class FastUdpApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/fastUdpApp:FastUdpApp';
    ...
    /**
     * Name of the UDP FAST application
     */
    public readonly application!: pulumi.Output<string>;
    /**
     * Enables use of FastL4 profiles on the virtual server.
     */
    ...
    /**
     * Name of the UDP FAST application tenant
     */
    ...
    constructor(name: string, argsOrState?: FastUdpAppArgs | FastUdpAppState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FastUdpApp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
