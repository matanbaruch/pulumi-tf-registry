...
export class LtmPersistenceProfileSsl extends pulumi.CustomResource {
    /**
     * Get an existing LtmPersistenceProfileSsl resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LtmPersistenceProfileSslState, opts?: pulumi.CustomResourceOptions): LtmPersistenceProfileSsl {
        return new LtmPersistenceProfileSsl(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'bigip:index/ltmPersistenceProfileSsl:LtmPersistenceProfileSsl';

    /**
     * Returns true if the given object is an instance of LtmPersistenceProfileSsl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LtmPersistenceProfileSsl {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LtmPersistenceProfileSsl.__pulumiType;
    }
    ...
    /**
     * Create a LtmPersistenceProfileSsl resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LtmPersistenceProfileSslArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LtmPersistenceProfileSslArgs | LtmPersistenceProfileSslState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LtmPersistenceProfileSslState | undefined;
            ...
            const args = argsOrState as LtmPersistenceProfileSslArgs | undefined;
        ...
        super(LtmPersistenceProfileSsl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LtmPersistenceProfileSsl resources.
 */
export interface LtmPersistenceProfileSslState {
...
/**
 * The set of arguments for constructing a LtmPersistenceProfileSsl resource.
 */
export interface LtmPersistenceProfileSslArgs {
    appService?: pulumi.Input<string>;
    /**
     * Inherit defaults from parent profile
     */
