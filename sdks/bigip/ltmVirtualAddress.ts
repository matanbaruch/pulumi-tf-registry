...
export class LtmVirtualAddress extends pulumi.CustomResource {
    /**
     * Get an existing LtmVirtualAddress resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LtmVirtualAddressState, opts?: pulumi.CustomResourceOptions): LtmVirtualAddress {
        return new LtmVirtualAddress(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'bigip:index/ltmVirtualAddress:LtmVirtualAddress';

    /**
     * Returns true if the given object is an instance of LtmVirtualAddress.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LtmVirtualAddress {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LtmVirtualAddress.__pulumiType;
    }
    ...
    /**
     * Create a LtmVirtualAddress resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: LtmVirtualAddressArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LtmVirtualAddressArgs | LtmVirtualAddressState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LtmVirtualAddressState | undefined;
            ...
            const args = argsOrState as LtmVirtualAddressArgs | undefined;
        ...
        super(LtmVirtualAddress.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LtmVirtualAddress resources.
 */
export interface LtmVirtualAddressState {
    /**
     * Enabled dynamic routing of the address
     */
...
/**
 * The set of arguments for constructing a LtmVirtualAddress resource.
 */
export interface LtmVirtualAddressArgs {
    /**
     * Enabled dynamic routing of the address
     */
    advertizeRoute?: pulumi.Input<string>;
