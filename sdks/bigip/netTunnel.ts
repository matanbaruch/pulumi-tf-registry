...
export class NetTunnel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/netTunnel:NetTunnel';
    ...
    /**
     * Specifies a value for insertion into the Type of Service (ToS) octet within the IP header of the encapsulating header of
     * transmitted packets
     */
    ...
    constructor(name: string, argsOrState?: NetTunnelArgs | NetTunnelState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetTunnel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
