...
export class TrafficSelector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/trafficSelector:TrafficSelector';
    ...
    /**
     * Specifies the host or network IP address to which the application traffic is destined.When creating a new traffic
    ...
    /**
     * Specifies the IPsec policy that tells the BIG-IP system how to handle the packets.When creating a new traffic selector,
     * if this parameter is not specified, the default is default-ipsec-policy.
     */
     ...
     * matched to the traffic selector with the highest priority (lowest order number).When creating a new traffic selector, if
     * this parameter is not specified, the default is last.
     */
    public readonly order!: pulumi.Output<number>;
    /**
     * Specifies the host or network IP address from which the application traffic originates.When creating a new traffic
     * selector, this parameter is required.
     */
    ...
    constructor(name: string, argsOrState?: TrafficSelectorArgs | TrafficSelectorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TrafficSelector.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
