...
export function getWafEntityParameter(args: GetWafEntityParameterArgs, opts?: pulumi.InvokeOptions): Promise<GetWafEntityParameterResult> {
    ...
    return pulumi.runtime.invoke("bigip:index/getWafEntityParameter:getWafEntityParameter", {
...
export interface GetWafEntityParameterArgs {
    ...
    type?: string;
    url?: inputs.GetWafEntityParameterUrl;
    valueType?: string;
}
...
export interface GetWafEntityParameterResult {
    ...
    readonly url?: outputs.GetWafEntityParameterUrl;
...
export interface GetWafEntityParameterOutputArgs {
    ...
    url?: pulumi.Input<inputs.GetWafEntityParameterUrlArgs>;
