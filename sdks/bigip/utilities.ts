...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("bigip");
			params.setVersion("1.22.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Y1bmV0d29ya3MvYmlnaXAiLCJ2ZXJzaW9uIjoiMS4yMi4zIn19"), c => c.charCodeAt(0)));
