...
export class LtmPersistenceProfileDstaddr extends pulumi.CustomResource {
    /**
     * Get an existing LtmPersistenceProfileDstaddr resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LtmPersistenceProfileDstaddrState, opts?: pulumi.CustomResourceOptions): LtmPersistenceProfileDstaddr {
        return new LtmPersistenceProfileDstaddr(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'bigip:index/ltmPersistenceProfileDstaddr:LtmPersistenceProfileDstaddr';

    /**
     * Returns true if the given object is an instance of LtmPersistenceProfileDstaddr.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LtmPersistenceProfileDstaddr {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LtmPersistenceProfileDstaddr.__pulumiType;
    }
    ...
    /**
     * Create a LtmPersistenceProfileDstaddr resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LtmPersistenceProfileDstaddrArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LtmPersistenceProfileDstaddrArgs | LtmPersistenceProfileDstaddrState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LtmPersistenceProfileDstaddrState | undefined;
            ...
            const args = argsOrState as LtmPersistenceProfileDstaddrArgs | undefined;
        ...
        super(LtmPersistenceProfileDstaddr.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LtmPersistenceProfileDstaddr resources.
 */
export interface LtmPersistenceProfileDstaddrState {
...
/**
 * The set of arguments for constructing a LtmPersistenceProfileDstaddr resource.
 */
export interface LtmPersistenceProfileDstaddrArgs {
    appService?: pulumi.Input<string>;
    /**
     * Inherit defaults from parent profile
     */
