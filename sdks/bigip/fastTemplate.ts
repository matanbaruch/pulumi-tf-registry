...
export class FastTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bigip:index/fastTemplate:FastTemplate';
    ...
    constructor(name: string, argsOrState?: FastTemplateArgs | FastTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FastTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
