...
export class TsfRepository extends pulumi.CustomResource {
    /**
     * Get an existing TsfRepository resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfRepositoryState, opts?: pulumi.CustomResourceOptions): TsfRepository {
        return new TsfRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfRepository:TsfRepository';

    /**
     * Returns true if the given object is an instance of TsfRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfRepository.__pulumiType;
    }
    ...
    /**
     * Create a TsfRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfRepositoryArgs | TsfRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfRepositoryState | undefined;
            ...
            const args = argsOrState as TsfRepositoryArgs | undefined;
        ...
        super(TsfRepository.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfRepository resources.
 */
export interface TsfRepositoryState {
    /**
     * the name of the bucket where the warehouse is located.
     */
...
/**
 * The set of arguments for constructing a TsfRepository resource.
 */
export interface TsfRepositoryArgs {
    /**
     * the name of the bucket where the warehouse is located.
     */
    bucketName: pulumi.Input<string>;
