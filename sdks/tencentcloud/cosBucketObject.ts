...
export class CosBucketObject extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cosBucketObject:CosBucketObject';
    ...
    constructor(name: string, argsOrState?: CosBucketObjectArgs | CosBucketObjectState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CosBucketObject.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
