...
export class Ccn extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CcnState, opts?: pulumi.CustomResourceOptions): Ccn {
        return new Ccn(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ccn:Ccn';

    /**
     * Returns true if the given object is an instance of Ccn.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ccn {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ccn.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: CcnArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CcnArgs | CcnState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CcnState | undefined;
            ...
            const args = argsOrState as CcnArgs | undefined;
        ...
        super(Ccn.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
