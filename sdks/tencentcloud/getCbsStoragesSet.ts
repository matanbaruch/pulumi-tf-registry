...
export function getCbsStoragesSet(args?: GetCbsStoragesSetArgs, opts?: pulumi.InvokeOptions): Promise<GetCbsStoragesSetResult> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("tencentcloud:index/getCbsStoragesSet:getCbsStoragesSet", {
...
/**
 * A collection of arguments for invoking getCbsStoragesSet.
 */
export interface GetCbsStoragesSetArgs {
...
/**
 * A collection of values returned by getCbsStoragesSet.
 */
export interface GetCbsStoragesSetResult {
    ...
    readonly storageLists: outputs.GetCbsStoragesSetStorageList[];
...
export function getCbsStoragesSetOutput(args?: GetCbsStoragesSetOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCbsStoragesSetResult> {
    return pulumi.output(args).apply((a: any) => getCbsStoragesSet(a, opts))
}

/**
 * A collection of arguments for invoking getCbsStoragesSet.
 */
export interface GetCbsStoragesSetOutputArgs {
