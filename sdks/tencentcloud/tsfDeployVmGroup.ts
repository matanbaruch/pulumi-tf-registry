...
export class TsfDeployVmGroup extends pulumi.CustomResource {
    /**
     * Get an existing TsfDeployVmGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfDeployVmGroupState, opts?: pulumi.CustomResourceOptions): TsfDeployVmGroup {
        return new TsfDeployVmGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfDeployVmGroup:TsfDeployVmGroup';

    /**
     * Returns true if the given object is an instance of TsfDeployVmGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfDeployVmGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfDeployVmGroup.__pulumiType;
    }

    /**
     * javaagent info: SERVICE_AGENT/OT_AGENT.
     */
    public readonly agentProfileLists!: pulumi.Output<outputs.TsfDeployVmGroupAgentProfileList[] | undefined>;
    /**
     ...
     */
    public readonly healthCheckSettings!: pulumi.Output<outputs.TsfDeployVmGroupHealthCheckSettings | undefined>;
    /**
     ...
     * warmup setting.
     */
    public readonly warmupSetting!: pulumi.Output<outputs.TsfDeployVmGroupWarmupSetting | undefined>;

    /**
     * Create a TsfDeployVmGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfDeployVmGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfDeployVmGroupArgs | TsfDeployVmGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfDeployVmGroupState | undefined;
            ...
            const args = argsOrState as TsfDeployVmGroupArgs | undefined;
        ...
        super(TsfDeployVmGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfDeployVmGroup resources.
 */
export interface TsfDeployVmGroupState {
    /**
     * javaagent info: SERVICE_AGENT/OT_AGENT.
     */
    agentProfileLists?: pulumi.Input<pulumi.Input<inputs.TsfDeployVmGroupAgentProfileList>[]>;
    /**
     * The ratio of instances participating in each batch during rolling release.
     */
     ...
     * When enabling health check, configure the health check settings.
     */
    healthCheckSettings?: pulumi.Input<inputs.TsfDeployVmGroupHealthCheckSettings>;
    /**
     * Whether to perform incremental deployment. The default value is false, which means full update.
     */
     ...
     * warmup setting.
     */
    warmupSetting?: pulumi.Input<inputs.TsfDeployVmGroupWarmupSetting>;
}

/**
 * The set of arguments for constructing a TsfDeployVmGroup resource.
 */
export interface TsfDeployVmGroupArgs {
    /**
     * javaagent info: SERVICE_AGENT/OT_AGENT.
     */
    agentProfileLists?: pulumi.Input<pulumi.Input<inputs.TsfDeployVmGroupAgentProfileList>[]>;
