...
export class CbsStorageSet extends pulumi.CustomResource {
    /**
     * Get an existing CbsStorageSet resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CbsStorageSetState, opts?: pulumi.CustomResourceOptions): CbsStorageSet {
        return new CbsStorageSet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cbsStorageSet:CbsStorageSet';

    /**
     * Returns true if the given object is an instance of CbsStorageSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CbsStorageSet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CbsStorageSet.__pulumiType;
    }
    ...
    /**
     * Create a CbsStorageSet resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CbsStorageSetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CbsStorageSetArgs | CbsStorageSetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CbsStorageSetState | undefined;
            ...
            const args = argsOrState as CbsStorageSetArgs | undefined;
        ...
        super(CbsStorageSet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CbsStorageSet resources.
 */
export interface CbsStorageSetState {
    /**
     * Indicates whether the CBS is mounted the CVM.
     */
...
/**
 * The set of arguments for constructing a CbsStorageSet resource.
 */
export interface CbsStorageSetArgs {
    /**
     * The available zone that the CBS instance locates at.
     */
    availabilityZone: pulumi.Input<string>;
