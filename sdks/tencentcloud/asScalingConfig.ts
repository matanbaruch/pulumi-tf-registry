...
export class AsScalingConfig extends pulumi.CustomResource {
    /**
     * Get an existing AsScalingConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AsScalingConfigState, opts?: pulumi.CustomResourceOptions): AsScalingConfig {
        return new AsScalingConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/asScalingConfig:AsScalingConfig';

    /**
     * Returns true if the given object is an instance of AsScalingConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AsScalingConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AsScalingConfig.__pulumiType;
    }
     ...
     */
    public readonly dataDisks!: pulumi.Output<outputs.AsScalingConfigDataDisk[] | undefined>;
    /**
     ...
     */
    public readonly hostNameSettings!: pulumi.Output<outputs.AsScalingConfigHostNameSettings | undefined>;
    /**
     ...
     */
    public readonly instanceNameSettings!: pulumi.Output<outputs.AsScalingConfigInstanceNameSettings | undefined>;
    /**
     * A list of tags used to associate different resources.
     */
    public readonly instanceTags!: pulumi.Output<{[key: string]: string} | undefined>;
    /**
    ...
    /**
     * Create a AsScalingConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AsScalingConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AsScalingConfigArgs | AsScalingConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AsScalingConfigState | undefined;
            ...
            const args = argsOrState as AsScalingConfigArgs | undefined;
        ...
        super(AsScalingConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AsScalingConfig resources.
 */
export interface AsScalingConfigState {
    /**
     * CAM role name authorized to access.
     */
     ...
     * Configurations of data disk.
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.AsScalingConfigDataDisk>[]>;
    /**
     * Policy of cloud disk type. Valid values: `ORIGINAL` and `AUTOMATIC`. Default is `ORIGINAL`.
     */
     ...
     * Related settings of the cloud server hostname (HostName).
     */
    hostNameSettings?: pulumi.Input<inputs.AsScalingConfigHostNameSettings>;
    /**
     * An available image ID for a cvm instance.
     */
     ...
     * Settings of CVM instance names.
     */
    instanceNameSettings?: pulumi.Input<inputs.AsScalingConfigInstanceNameSettings>;
    /**
     * A list of tags used to associate different resources.
     */
...
/**
 * The set of arguments for constructing a AsScalingConfig resource.
 */
export interface AsScalingConfigArgs {
    /**
     * CAM role name authorized to access.
     */
    camRoleName?: pulumi.Input<string>;
