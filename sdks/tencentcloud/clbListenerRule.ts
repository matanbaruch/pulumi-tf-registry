...
export class ClbListenerRule extends pulumi.CustomResource {
    /**
     * Get an existing ClbListenerRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClbListenerRuleState, opts?: pulumi.CustomResourceOptions): ClbListenerRule {
        return new ClbListenerRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/clbListenerRule:ClbListenerRule';

    /**
     * Returns true if the given object is an instance of ClbListenerRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClbListenerRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClbListenerRule.__pulumiType;
    }
     ...
     * configuration, HTTP/HTTPS listener needs to be configured in `tencentcloud.ClbListenerRule`.
     */
    ...
    /**
     * Create a ClbListenerRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClbListenerRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClbListenerRuleArgs | ClbListenerRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClbListenerRuleState | undefined;
            ...
            const args = argsOrState as ClbListenerRuleArgs | undefined;
        ...
        super(ClbListenerRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClbListenerRule resources.
 */
export interface ClbListenerRuleState {
    /**
     * ID of the client certificate. NOTES: Only supports listeners of HTTPS protocol.
     */
...
/**
 * The set of arguments for constructing a ClbListenerRule resource.
 */
export interface ClbListenerRuleArgs {
    /**
     * ID of the client certificate. NOTES: Only supports listeners of HTTPS protocol.
     */
    certificateCaId?: pulumi.Input<string>;
