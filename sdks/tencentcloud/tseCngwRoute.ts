...
export class TseCngwRoute extends pulumi.CustomResource {
    /**
     * Get an existing TseCngwRoute resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TseCngwRouteState, opts?: pulumi.CustomResourceOptions): TseCngwRoute {
        return new TseCngwRoute(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tseCngwRoute:TseCngwRoute';

    /**
     * Returns true if the given object is an instance of TseCngwRoute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TseCngwRoute {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TseCngwRoute.__pulumiType;
    }
     ...
     */
    public readonly headers!: pulumi.Output<outputs.TseCngwRouteHeader[] | undefined>;
    /**
     * host list.
     */
    ...
    /**
     * Create a TseCngwRoute resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TseCngwRouteArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TseCngwRouteArgs | TseCngwRouteState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TseCngwRouteState | undefined;
            ...
            const args = argsOrState as TseCngwRouteArgs | undefined;
        ...
        super(TseCngwRoute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TseCngwRoute resources.
 */
export interface TseCngwRouteState {
    /**
     * destination port for Layer 4 matching.
     */
     ...
     * the headers of route.
     */
    headers?: pulumi.Input<pulumi.Input<inputs.TseCngwRouteHeader>[]>;
    /**
     * host list.
     */
...
/**
 * The set of arguments for constructing a TseCngwRoute resource.
 */
export interface TseCngwRouteArgs {
    /**
     * destination port for Layer 4 matching.
     */
    destinationPorts?: pulumi.Input<pulumi.Input<number>[]>;
