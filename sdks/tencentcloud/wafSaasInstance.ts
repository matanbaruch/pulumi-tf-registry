...
export class WafSaasInstance extends pulumi.CustomResource {
    /**
     * Get an existing WafSaasInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WafSaasInstanceState, opts?: pulumi.CustomResourceOptions): WafSaasInstance {
        return new WafSaasInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wafSaasInstance:WafSaasInstance';

    /**
     * Returns true if the given object is an instance of WafSaasInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WafSaasInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WafSaasInstance.__pulumiType;
    }
    ...
    /**
     * Create a WafSaasInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WafSaasInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WafSaasInstanceArgs | WafSaasInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WafSaasInstanceState | undefined;
            ...
            const args = argsOrState as WafSaasInstanceArgs | undefined;
        ...
        super(WafSaasInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WafSaasInstance resources.
 */
export interface WafSaasInstanceState {
    /**
     * Whether to purchase API Security, 1: yes, 0: no. Default is 0.
     */
...
/**
 * The set of arguments for constructing a WafSaasInstance resource.
 */
export interface WafSaasInstanceArgs {
    /**
     * Whether to purchase API Security, 1: yes, 0: no. Default is 0.
     */
    apiSecurity?: pulumi.Input<number>;
