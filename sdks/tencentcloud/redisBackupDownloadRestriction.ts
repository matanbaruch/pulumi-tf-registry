...
export class RedisBackupDownloadRestriction extends pulumi.CustomResource {
    /**
     * Get an existing RedisBackupDownloadRestriction resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RedisBackupDownloadRestrictionState, opts?: pulumi.CustomResourceOptions): RedisBackupDownloadRestriction {
        return new RedisBackupDownloadRestriction(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/redisBackupDownloadRestriction:RedisBackupDownloadRestriction';

    /**
     * Returns true if the given object is an instance of RedisBackupDownloadRestriction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RedisBackupDownloadRestriction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RedisBackupDownloadRestriction.__pulumiType;
    }
     ...
     * parameter.
     */
    public readonly limitVpcs!: pulumi.Output<outputs.RedisBackupDownloadRestrictionLimitVpc[] | undefined>;
    /**
    ...
    /**
     * Create a RedisBackupDownloadRestriction resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RedisBackupDownloadRestrictionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RedisBackupDownloadRestrictionArgs | RedisBackupDownloadRestrictionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RedisBackupDownloadRestrictionState | undefined;
            ...
            const args = argsOrState as RedisBackupDownloadRestrictionArgs | undefined;
        ...
        super(RedisBackupDownloadRestriction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RedisBackupDownloadRestriction resources.
 */
export interface RedisBackupDownloadRestrictionState {
    /**
     * Identifies whether the customized LimitIP address can download the backup file.- In: Custom IP addresses are available
     * for download.- NotIn: Custom IPs are not available for download.
     */
     ...
     * parameter.
     */
    limitVpcs?: pulumi.Input<pulumi.Input<inputs.RedisBackupDownloadRestrictionLimitVpc>[]>;
    /**
     * This parameter only supports entering In, which means that the custom LimitVpc can download the backup file.
     */
...
/**
 * The set of arguments for constructing a RedisBackupDownloadRestriction resource.
 */
export interface RedisBackupDownloadRestrictionArgs {
    /**
     * Identifies whether the customized LimitIP address can download the backup file.- In: Custom IP addresses are available
     * for download.- NotIn: Custom IPs are not available for download.
     */
