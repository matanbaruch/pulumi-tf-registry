...
export class Dcx extends pulumi.CustomResource {
    /**
     * Get an existing Dcx resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DcxState, opts?: pulumi.CustomResourceOptions): Dcx {
        return new Dcx(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dcx:Dcx';

    /**
     * Returns true if the given object is an instance of Dcx.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Dcx {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Dcx.__pulumiType;
    }
    ...
    /**
     * Create a Dcx resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DcxArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DcxArgs | DcxState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DcxState | undefined;
            ...
            const args = argsOrState as DcxArgs | undefined;
        ...
        super(Dcx.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
