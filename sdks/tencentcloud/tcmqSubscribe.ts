...
export class TcmqSubscribe extends pulumi.CustomResource {
    /**
     * Get an existing TcmqSubscribe resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TcmqSubscribeState, opts?: pulumi.CustomResourceOptions): TcmqSubscribe {
        return new TcmqSubscribe(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tcmqSubscribe:TcmqSubscribe';

    /**
     * Returns true if the given object is an instance of TcmqSubscribe.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TcmqSubscribe {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TcmqSubscribe.__pulumiType;
    }
    ...
    /**
     * Create a TcmqSubscribe resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TcmqSubscribeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TcmqSubscribeArgs | TcmqSubscribeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TcmqSubscribeState | undefined;
            ...
            const args = argsOrState as TcmqSubscribeArgs | undefined;
        ...
        super(TcmqSubscribe.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TcmqSubscribe resources.
 */
export interface TcmqSubscribeState {
    /**
     * The number of `BindingKey` cannot exceed 5, and the length of each `BindingKey` cannot exceed 64 bytes. This field
     * indicates the filtering policy for subscribing to and receiving messages. Each `BindingKey` includes up to 15 dots
     * (namely up to 16 segments).
...
/**
 * The set of arguments for constructing a TcmqSubscribe resource.
 */
export interface TcmqSubscribeArgs {
    /**
     * The number of `BindingKey` cannot exceed 5, and the length of each `BindingKey` cannot exceed 64 bytes. This field
     * indicates the filtering policy for subscribing to and receiving messages. Each `BindingKey` includes up to 15 dots
     * (namely up to 16 segments).
