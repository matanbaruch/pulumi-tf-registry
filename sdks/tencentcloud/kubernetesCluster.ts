...
export class KubernetesCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/kubernetesCluster:KubernetesCluster';
     ...
     */
    public readonly authOptions!: pulumi.Output<outputs.KubernetesClusterAuthOptions | undefined>;
    /**
     ...
     */
    public readonly clusterAudit!: pulumi.Output<outputs.KubernetesClusterClusterAudit | undefined>;
    /**
     ...
     */
    public readonly clusterExtraArgs!: pulumi.Output<outputs.KubernetesClusterClusterExtraArgs | undefined>;
    /**
     * Open internet access or not. If this field is set 'true', the field below `worker_config` must be set. Because only
     * cluster with node is allowed enable access endpoint. You may open it through `tencentcloud.KubernetesClusterEndpoint`.
     */
    ...
    /**
     * Specify cluster level, valid for managed cluster, use data source `tencentcloud.getKubernetesClusterLevels` to query
     ...
     */
    public readonly eventPersistence!: pulumi.Output<outputs.KubernetesClusterEventPersistence | undefined>;
    /**
     * create tke cluster by existed instances.
     */
    public readonly existInstances!: pulumi.Output<outputs.KubernetesClusterExistInstance[] | undefined>;
    /**
     * Information of the add-on to be installed.
     */
    public readonly extensionAddons!: pulumi.Output<outputs.KubernetesClusterExtensionAddon[] | undefined>;
    /**
     ...
     */
    public readonly logAgent!: pulumi.Output<outputs.KubernetesClusterLogAgent | undefined>;
    /**
     ...
     */
    public readonly masterConfigs!: pulumi.Output<outputs.KubernetesClusterMasterConfig[] | undefined>;
    /**
     ...
     */
    public readonly nodePoolGlobalConfigs!: pulumi.Output<outputs.KubernetesClusterNodePoolGlobalConfig[] | undefined>;
    /**
     * Password of account.
     */
     ...
     */
    public readonly workerConfigs!: pulumi.Output<outputs.KubernetesClusterWorkerConfig[] | undefined>;
    /**
     * An information list of cvm within the 'WORKER' clusters. Each element contains the following attributes:
     */
    public /*out*/ readonly workerInstancesLists!: pulumi.Output<outputs.KubernetesClusterWorkerInstancesList[]>;
...
export interface KubernetesClusterState {
     ...
     * Specify cluster authentication configuration. Only available for managed cluster and `cluster_version` >= 1.20.
     */
    authOptions?: pulumi.Input<inputs.KubernetesClusterAuthOptions>;
    /**
     * Whether the cluster level auto upgraded, valid for managed cluster.
     */
     ...
     * Specify Cluster Audit config. NOTE: Please make sure your TKE CamRole have permission to access CLS service.
     */
    clusterAudit?: pulumi.Input<inputs.KubernetesClusterClusterAudit>;
    /**
     * A network address block of the cluster. Different from vpc cidr and cidr of other clusters within this vpc. Must be in
     * 10./192.168/172.[16-31] segments.
     */
     ...
     * Customized parameters for master component,such as kube-apiserver, kube-controller-manager, kube-scheduler.
     */
    clusterExtraArgs?: pulumi.Input<inputs.KubernetesClusterClusterExtraArgs>;
    /**
     * Open internet access or not. If this field is set 'true', the field below `worker_config` must be set. Because only
     * cluster with node is allowed enable access endpoint. You may open it through `tencentcloud.KubernetesClusterEndpoint`.
     */
     ...
     * Specify cluster Event Persistence config. NOTE: Please make sure your TKE CamRole have permission to access CLS service.
     */
    eventPersistence?: pulumi.Input<inputs.KubernetesClusterEventPersistence>;
    /**
     * create tke cluster by existed instances.
     */
    existInstances?: pulumi.Input<pulumi.Input<inputs.KubernetesClusterExistInstance>[]>;
    /**
     * Information of the add-on to be installed.
     */
    extensionAddons?: pulumi.Input<pulumi.Input<inputs.KubernetesClusterExtensionAddon>[]>;
    /**
     * Custom parameter information related to the node.
     */
     ...
     * Specify cluster log agent config.
     */
    logAgent?: pulumi.Input<inputs.KubernetesClusterLogAgent>;
    /**
     * Security policies for managed cluster internet, like:'192.168.1.0/24' or '113.116.51.27', '0.0.0.0/0' means all. This
     * field can only set when field `cluster_deploy_type` is 'MANAGED_CLUSTER' and `cluster_internet` is true.
     * `managed_cluster_internet_security_policies` can not delete or empty once be set.
     ...
     * Deploy the machine configuration information of the 'MASTER_ETCD' service, and create <=7 units for common users.
     */
    masterConfigs?: pulumi.Input<pulumi.Input<inputs.KubernetesClusterMasterConfig>[]>;
    /**
     * Mount target. Default is not mounting.
     */
     ...
     * Global config effective for all node pools.
     */
    nodePoolGlobalConfigs?: pulumi.Input<pulumi.Input<inputs.KubernetesClusterNodePoolGlobalConfig>[]>;
    /**
     * Password of account.
     */
     ...
     * 'WORK' service are added by 'tencentcloud_kubernetes_scale_worker'.
     */
    workerConfigs?: pulumi.Input<pulumi.Input<inputs.KubernetesClusterWorkerConfig>[]>;
    /**
     * An information list of cvm within the 'WORKER' clusters. Each element contains the following attributes:
     */
    workerInstancesLists?: pulumi.Input<pulumi.Input<inputs.KubernetesClusterWorkerInstancesList>[]>;
}
