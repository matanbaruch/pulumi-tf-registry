...
export class SqlserverGeneralCloudInstance extends pulumi.CustomResource {
    /**
     * Get an existing SqlserverGeneralCloudInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlserverGeneralCloudInstanceState, opts?: pulumi.CustomResourceOptions): SqlserverGeneralCloudInstance {
        return new SqlserverGeneralCloudInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sqlserverGeneralCloudInstance:SqlserverGeneralCloudInstance';

    /**
     * Returns true if the given object is an instance of SqlserverGeneralCloudInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SqlserverGeneralCloudInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SqlserverGeneralCloudInstance.__pulumiType;
    }
     ...
     */
    public readonly resourceTags!: pulumi.Output<outputs.SqlserverGeneralCloudInstanceResourceTag[] | undefined>;
    /**
    ...
    /**
     * Create a SqlserverGeneralCloudInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SqlserverGeneralCloudInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlserverGeneralCloudInstanceArgs | SqlserverGeneralCloudInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SqlserverGeneralCloudInstanceState | undefined;
            ...
            const args = argsOrState as SqlserverGeneralCloudInstanceArgs | undefined;
        ...
        super(SqlserverGeneralCloudInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SqlserverGeneralCloudInstance resources.
 */
export interface SqlserverGeneralCloudInstanceState {
    /**
     * Automatic renewal flag: 0-normal renewal 1-automatic renewal, the default is 1 automatic renewal. Valid only when
     * purchasing a prepaid instance. Valid only when the 'instance_charge_type' parameter value is 'PREPAID'.
     */
     ...
     * A collection of tags bound to the new instance.
     */
    resourceTags?: pulumi.Input<pulumi.Input<inputs.SqlserverGeneralCloudInstanceResourceTag>[]>;
    /**
     * Security group list, fill in the security group ID in the form of sg-xxx.
     */
...
/**
 * The set of arguments for constructing a SqlserverGeneralCloudInstance resource.
 */
export interface SqlserverGeneralCloudInstanceArgs {
    /**
     * Automatic renewal flag: 0-normal renewal 1-automatic renewal, the default is 1 automatic renewal. Valid only when
     * purchasing a prepaid instance. Valid only when the 'instance_charge_type' parameter value is 'PREPAID'.
     */
