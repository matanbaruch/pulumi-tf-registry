...
export class ContainerClusterInstance extends pulumi.CustomResource {
    /**
     * Get an existing ContainerClusterInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ContainerClusterInstanceState, opts?: pulumi.CustomResourceOptions): ContainerClusterInstance {
        return new ContainerClusterInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/containerClusterInstance:ContainerClusterInstance';

    /**
     * Returns true if the given object is an instance of ContainerClusterInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ContainerClusterInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ContainerClusterInstance.__pulumiType;
    }
    ...
    /**
     * Create a ContainerClusterInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ContainerClusterInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ContainerClusterInstanceArgs | ContainerClusterInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ContainerClusterInstanceState | undefined;
            ...
            const args = argsOrState as ContainerClusterInstanceArgs | undefined;
        ...
        super(ContainerClusterInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ContainerClusterInstance resources.
 */
export interface ContainerClusterInstanceState {
    /**
     * Describe the reason when node is in abnormal state(if it was).
     */
...
/**
 * The set of arguments for constructing a ContainerClusterInstance resource.
 */
export interface ContainerClusterInstanceArgs {
    /**
     * The network bandwidth of the node.
     */
    bandwidth: pulumi.Input<number>;
