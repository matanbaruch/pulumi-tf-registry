...
export class ClbListener extends pulumi.CustomResource {
    /**
     * Get an existing ClbListener resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClbListenerState, opts?: pulumi.CustomResourceOptions): ClbListener {
        return new ClbListener(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/clbListener:ClbListener';

    /**
     * Returns true if the given object is an instance of ClbListener.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClbListener {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClbListener.__pulumiType;
    }
     ...
     * listener allows direct configuration, HTTP/HTTPS listener needs to be configured in `tencentcloud.ClbListenerRule`.
     */
     ...
     * direct configuration, HTTP/HTTPS listener needs to be configured in `tencentcloud.ClbListenerRule`.
     */
     ...
     * allows direct configuration, HTTP/HTTPS listener needs to be configured in `tencentcloud.ClbListenerRule`.
     */
     ...
     * listener needs to be configured in `tencentcloud.ClbListenerRule`.
     */
     ...
     * each rule in `tencentcloud.ClbListenerRule`, otherwise all rules have a certificate.
     */
    ...
    /**
     * Create a ClbListener resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClbListenerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClbListenerArgs | ClbListenerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClbListenerState | undefined;
            ...
            const args = argsOrState as ClbListenerArgs | undefined;
        ...
        super(ClbListener.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClbListener resources.
 */
export interface ClbListenerState {
    /**
     * ID of the client certificate. NOTES: Only supports listeners of `HTTPS` and `TCP_SSL` protocol and must be set when the
     * ssl mode is `MUTUAL`.
     */
...
/**
 * The set of arguments for constructing a ClbListener resource.
 */
export interface ClbListenerArgs {
    /**
     * ID of the client certificate. NOTES: Only supports listeners of `HTTPS` and `TCP_SSL` protocol and must be set when the
     * ssl mode is `MUTUAL`.
     */
