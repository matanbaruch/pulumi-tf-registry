...
export class MysqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mysqlDatabase:MysqlDatabase';
    ...
    constructor(name: string, argsOrState?: MysqlDatabaseArgs | MysqlDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MysqlDatabase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
