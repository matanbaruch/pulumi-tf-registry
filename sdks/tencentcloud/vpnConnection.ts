...
export class VpnConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpnConnection:VpnConnection';
     ...
     */
    public readonly securityGroupPolicies!: pulumi.Output<outputs.VpnConnectionSecurityGroupPolicy[] | undefined>;
    /**
...
export interface VpnConnectionState {
     ...
     * network segments in your IDC.
     */
    securityGroupPolicies?: pulumi.Input<pulumi.Input<inputs.VpnConnectionSecurityGroupPolicy>[]>;
    /**
     * State of the connection. Valid value: `PENDING`, `AVAILABLE`, `DELETING`.
     */
