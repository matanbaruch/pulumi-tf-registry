...
export class CdnUrlPush extends pulumi.CustomResource {
    /**
     * Get an existing CdnUrlPush resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CdnUrlPushState, opts?: pulumi.CustomResourceOptions): CdnUrlPush {
        return new CdnUrlPush(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cdnUrlPush:CdnUrlPush';

    /**
     * Returns true if the given object is an instance of CdnUrlPush.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CdnUrlPush {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CdnUrlPush.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly pushHistories!: pulumi.Output<outputs.CdnUrlPushPushHistory[]>;
    /**
    ...
    /**
     * Create a CdnUrlPush resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CdnUrlPushArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CdnUrlPushArgs | CdnUrlPushState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CdnUrlPushState | undefined;
            ...
            const args = argsOrState as CdnUrlPushArgs | undefined;
        ...
        super(CdnUrlPush.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CdnUrlPush resources.
 */
export interface CdnUrlPushState {
    /**
     * Specify push area. NOTE: only push same area cache contents.
     */
     ...
     * logs of latest push task.
     */
    pushHistories?: pulumi.Input<pulumi.Input<inputs.CdnUrlPushPushHistory>[]>;
    /**
     * Change to push again. NOTE: this argument only works while resource update, if set to `0` or null will not be triggered.
     */
...
/**
 * The set of arguments for constructing a CdnUrlPush resource.
 */
export interface CdnUrlPushArgs {
    /**
     * Specify push area. NOTE: only push same area cache contents.
     */
    area?: pulumi.Input<string>;
