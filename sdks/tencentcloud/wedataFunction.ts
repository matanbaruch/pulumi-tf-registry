...
export class WedataFunction extends pulumi.CustomResource {
    /**
     * Get an existing WedataFunction resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WedataFunctionState, opts?: pulumi.CustomResourceOptions): WedataFunction {
        return new WedataFunction(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wedataFunction:WedataFunction';

    /**
     * Returns true if the given object is an instance of WedataFunction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WedataFunction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WedataFunction.__pulumiType;
    }
     ...
     */
    public readonly resourceLists!: pulumi.Output<outputs.WedataFunctionResourceList[]>;
    /**
    ...
    /**
     * Create a WedataFunction resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WedataFunctionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WedataFunctionArgs | WedataFunctionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WedataFunctionState | undefined;
            ...
            const args = argsOrState as WedataFunctionArgs | undefined;
        ...
        super(WedataFunction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WedataFunction resources.
 */
export interface WedataFunctionState {
    /**
     * Class name of function entry.
     */
     ...
     * Resource of the function, stored in WeData COS(.jar,...).
     */
    resourceLists?: pulumi.Input<pulumi.Input<inputs.WedataFunctionResourceList>[]>;
    /**
     * Description of the Return value.
     */
...
/**
 * The set of arguments for constructing a WedataFunction resource.
 */
export interface WedataFunctionArgs {
    /**
     * Class name of function entry.
     */
    className: pulumi.Input<string>;
