...
export class CkafkaTopic extends pulumi.CustomResource {
    /**
     * Get an existing CkafkaTopic resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CkafkaTopicState, opts?: pulumi.CustomResourceOptions): CkafkaTopic {
        return new CkafkaTopic(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ckafkaTopic:CkafkaTopic';

    /**
     * Returns true if the given object is an instance of CkafkaTopic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CkafkaTopic {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CkafkaTopic.__pulumiType;
    }
    ...
    /**
     * Create a CkafkaTopic resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CkafkaTopicArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CkafkaTopicArgs | CkafkaTopicState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CkafkaTopicState | undefined;
            ...
            const args = argsOrState as CkafkaTopicArgs | undefined;
        ...
        super(CkafkaTopic.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CkafkaTopic resources.
 */
export interface CkafkaTopicState {
    /**
     * Clear log policy, log clear mode, default is `delete`. `delete`: logs are deleted according to the storage time.
     * `compact`: logs are compressed according to the key. `compact, delete`: logs are compressed according to the key and
     * will be deleted according to the storage time.
...
/**
 * The set of arguments for constructing a CkafkaTopic resource.
 */
export interface CkafkaTopicArgs {
    /**
     * Clear log policy, log clear mode, default is `delete`. `delete`: logs are deleted according to the storage time.
     * `compact`: logs are compressed according to the key. `compact, delete`: logs are compressed according to the key and
     * will be deleted according to the storage time.
