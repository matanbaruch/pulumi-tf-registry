...
export class DcdbHourdbInstance extends pulumi.CustomResource {
    /**
     * Get an existing DcdbHourdbInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DcdbHourdbInstanceState, opts?: pulumi.CustomResourceOptions): DcdbHourdbInstance {
        return new DcdbHourdbInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dcdbHourdbInstance:DcdbHourdbInstance';

    /**
     * Returns true if the given object is an instance of DcdbHourdbInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DcdbHourdbInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DcdbHourdbInstance.__pulumiType;
    }
     ...
     * resource tags.
     */
    public readonly resourceTags!: pulumi.Output<outputs.DcdbHourdbInstanceResourceTag[] | undefined>;
    /**
     * security group id.
     */
    ...
    /**
     * Create a DcdbHourdbInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DcdbHourdbInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DcdbHourdbInstanceArgs | DcdbHourdbInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DcdbHourdbInstanceState | undefined;
            ...
            const args = argsOrState as DcdbHourdbInstanceArgs | undefined;
        ...
        super(DcdbHourdbInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DcdbHourdbInstance resources.
 */
export interface DcdbHourdbInstanceState {
    /**
     * db engine version, default to Percona 5.7.17.
     */
     ...
     * resource tags.
     */
    resourceTags?: pulumi.Input<pulumi.Input<inputs.DcdbHourdbInstanceResourceTag>[]>;
    /**
     * security group id.
     */
...
/**
 * The set of arguments for constructing a DcdbHourdbInstance resource.
 */
export interface DcdbHourdbInstanceArgs {
    /**
     * db engine version, default to Percona 5.7.17.
     */
    dbVersionId?: pulumi.Input<string>;
