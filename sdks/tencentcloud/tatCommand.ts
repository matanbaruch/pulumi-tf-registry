...
export class TatCommand extends pulumi.CustomResource {
    /**
     * Get an existing TatCommand resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TatCommandState, opts?: pulumi.CustomResourceOptions): TatCommand {
        return new TatCommand(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tatCommand:TatCommand';

    /**
     * Returns true if the given object is an instance of TatCommand.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TatCommand {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TatCommand.__pulumiType;
    }
     ...
     */
    public readonly tags!: pulumi.Output<outputs.TatCommandTag[] | undefined>;
    /**
    ...
    /**
     * Create a TatCommand resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TatCommandArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TatCommandArgs | TatCommandState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TatCommandState | undefined;
            ...
            const args = argsOrState as TatCommandArgs | undefined;
        ...
        super(TatCommand.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TatCommand resources.
 */
export interface TatCommandState {
    /**
     * Command name. The name can be up to 60 bytes, and contain [a-z], [A-Z], [0-9] and [_-.].
     */
     ...
     * Tags bound to the command. At most 10 tags are allowed.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.TatCommandTag>[]>;
    /**
     * Command timeout period. Default value: 60 seconds. Value range: [1, 86400].
     */
...
/**
 * The set of arguments for constructing a TatCommand resource.
 */
export interface TatCommandArgs {
    /**
     * Command name. The name can be up to 60 bytes, and contain [a-z], [A-Z], [0-9] and [_-.].
     */
    commandName: pulumi.Input<string>;
