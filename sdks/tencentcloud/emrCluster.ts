...
export class EmrCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/emrCluster:EmrCluster';
     ...
     */
    public readonly loginSettings!: pulumi.Output<{[key: string]: string} | undefined>;
    /**
     ...
     * @deprecated Deprecated
     */
    public readonly placement!: pulumi.Output<{[key: string]: string}>;
    /**
     * The location of the instance.
     */
    public readonly placementInfo!: pulumi.Output<outputs.EmrClusterPlacementInfo | undefined>;
    /**
     ...
     */
    public readonly resourceSpec!: pulumi.Output<outputs.EmrClusterResourceSpec | undefined>;
    /**
     ...
     */
    public readonly vpcSettings!: pulumi.Output<{[key: string]: string}>;
...
export interface EmrClusterState {
     ...
     * The location of the instance.
     */
    placementInfo?: pulumi.Input<inputs.EmrClusterPlacementInfo>;
    /**
     * Product ID. Different products ID represents different EMR product versions. Value range: - 16: represents EMR-V2.3.0 -
     * 20: indicates EMR-V2.5.0 - 25: represents EMR-V3.1.0 - 27: represents KAFKA-V1.0.0 - 30: indicates EMR-V2.6.0 - 33:
     * represents EMR-V3.2.1 - 34: stands for EMR-V3.3.0 - 36: represents STARROCKS-V1.0.0 - 37: indicates EMR-V3.4.0 - 38:
     ...
     * Resource specification of EMR instance.
     */
    resourceSpec?: pulumi.Input<inputs.EmrClusterResourceSpec>;
    /**
     * The ID of the security group to which the instance belongs, in the form of sg-xxxxxxxx.
     */
