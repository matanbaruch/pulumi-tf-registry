...
export class PtsJob extends pulumi.CustomResource {
    /**
     * Get an existing PtsJob resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PtsJobState, opts?: pulumi.CustomResourceOptions): PtsJob {
        return new PtsJob(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ptsJob:PtsJob';

    /**
     * Returns true if the given object is an instance of PtsJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PtsJob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PtsJob.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly datasets!: pulumi.Output<outputs.PtsJobDataset[]>;
    /**
     * Whether to debug.
     */
     ...
     */
    public /*out*/ readonly domainNameConfigs!: pulumi.Output<outputs.PtsJobDomainNameConfig[]>;
    /**
     * Job duration.
     */
     ...
     */
    public /*out*/ readonly loads!: pulumi.Output<outputs.PtsJobLoad[]>;
    /**
     ...
     */
    public /*out*/ readonly plugins!: pulumi.Output<outputs.PtsJobPlugin[]>;
    /**
     * Project ID.
     */
     ...
     */
    public /*out*/ readonly protocols!: pulumi.Output<outputs.PtsJobProtocol[]>;
    /**
     * Request file information.
     */
    public /*out*/ readonly requestFiles!: pulumi.Output<outputs.PtsJobRequestFile[]>;
    /**
     ...
     */
    public /*out*/ readonly testScripts!: pulumi.Output<outputs.PtsJobTestScript[]>;
    /**
     * Scene Type.
     */
    ...
    /**
     * Create a PtsJob resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PtsJobArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PtsJobArgs | PtsJobState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PtsJobState | undefined;
            ...
            const args = argsOrState as PtsJobArgs | undefined;
        ...
        super(PtsJob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PtsJob resources.
 */
export interface PtsJobState {
    /**
     * Cause of interruption.
     */
     ...
     * Dataset file for the job.
     */
    datasets?: pulumi.Input<pulumi.Input<inputs.PtsJobDataset>[]>;
    /**
     * Whether to debug.
     */
     ...
     * Domain name binding configuration.
     */
    domainNameConfigs?: pulumi.Input<pulumi.Input<inputs.PtsJobDomainNameConfig>[]>;
    /**
     * Job duration.
     */
     ...
     * Pressure configuration of job.
     */
    loads?: pulumi.Input<pulumi.Input<inputs.PtsJobLoad>[]>;
    /**
     * Maximum requests per second.
     */
     ...
     * Expansion package file information.
     */
    plugins?: pulumi.Input<pulumi.Input<inputs.PtsJobPlugin>[]>;
    /**
     * Project ID.
     */
     ...
     * Protocol script information.
     */
    protocols?: pulumi.Input<pulumi.Input<inputs.PtsJobProtocol>[]>;
    /**
     * Request file information.
     */
    requestFiles?: pulumi.Input<pulumi.Input<inputs.PtsJobRequestFile>[]>;
    /**
     * Total number of requests.
     */
     ...
     * Test script information.
     */
    testScripts?: pulumi.Input<pulumi.Input<inputs.PtsJobTestScript>[]>;
    /**
     * Scene Type.
     */
...
/**
 * The set of arguments for constructing a PtsJob resource.
 */
export interface PtsJobArgs {
    /**
     * Whether to debug.
     */
    debug?: pulumi.Input<boolean>;
