...
export class ClickhouseInstance extends pulumi.CustomResource {
    /**
     * Get an existing ClickhouseInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClickhouseInstanceState, opts?: pulumi.CustomResourceOptions): ClickhouseInstance {
        return new ClickhouseInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/clickhouseInstance:ClickhouseInstance';

    /**
     * Returns true if the given object is an instance of ClickhouseInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClickhouseInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClickhouseInstance.__pulumiType;
    }
     ...
     * ZK node.
     */
    public readonly commonSpec!: pulumi.Output<outputs.ClickhouseInstanceCommonSpec | undefined>;
    /**
     * COS bucket name.
     */
     ...
     * Data spec.
     */
    public readonly dataSpec!: pulumi.Output<outputs.ClickhouseInstanceDataSpec>;
    /**
     * Expire time.
     */
    ...
    /**
     * Create a ClickhouseInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClickhouseInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClickhouseInstanceArgs | ClickhouseInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClickhouseInstanceState | undefined;
            ...
            const args = argsOrState as ClickhouseInstanceArgs | undefined;
        ...
        super(ClickhouseInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClickhouseInstance resources.
 */
export interface ClickhouseInstanceState {
    /**
     * Billing type: `PREPAID` prepaid, `POSTPAID_BY_HOUR` postpaid.
     */
     ...
     * ZK node.
     */
    commonSpec?: pulumi.Input<inputs.ClickhouseInstanceCommonSpec>;
    /**
     * COS bucket name.
     */
     ...
     * Data spec.
     */
    dataSpec?: pulumi.Input<inputs.ClickhouseInstanceDataSpec>;
    /**
     * Expire time.
     */
...
/**
 * The set of arguments for constructing a ClickhouseInstance resource.
 */
export interface ClickhouseInstanceArgs {
    /**
     * Billing type: `PREPAID` prepaid, `POSTPAID_BY_HOUR` postpaid.
     */
    chargeType: pulumi.Input<string>;
