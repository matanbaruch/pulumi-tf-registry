...
export class TemLogConfig extends pulumi.CustomResource {
    /**
     * Get an existing TemLogConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TemLogConfigState, opts?: pulumi.CustomResourceOptions): TemLogConfig {
        return new TemLogConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/temLogConfig:TemLogConfig';

    /**
     * Returns true if the given object is an instance of TemLogConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TemLogConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TemLogConfig.__pulumiType;
    }
    ...
    /**
     * Create a TemLogConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TemLogConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TemLogConfigArgs | TemLogConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TemLogConfigState | undefined;
            ...
            const args = argsOrState as TemLogConfigArgs | undefined;
        ...
        super(TemLogConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TemLogConfig resources.
 */
export interface TemLogConfigState {
    /**
     * application ID.
     */
...
/**
 * The set of arguments for constructing a TemLogConfig resource.
 */
export interface TemLogConfigArgs {
    /**
     * application ID.
     */
    applicationId: pulumi.Input<string>;
