...
export class DasbResource extends pulumi.CustomResource {
    /**
     * Get an existing DasbResource resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DasbResourceState, opts?: pulumi.CustomResourceOptions): DasbResource {
        return new DasbResource(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dasbResource:DasbResource';

    /**
     * Returns true if the given object is an instance of DasbResource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DasbResource {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DasbResource.__pulumiType;
    }
    ...
    /**
     * Create a DasbResource resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DasbResourceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DasbResourceArgs | DasbResourceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DasbResourceState | undefined;
            ...
            const args = argsOrState as DasbResourceArgs | undefined;
        ...
        super(DasbResource.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DasbResource resources.
 */
export interface DasbResourceState {
    /**
     * Automatic renewal. 1 is auto renew flag, 0 is not.
     */
...
/**
 * The set of arguments for constructing a DasbResource resource.
 */
export interface DasbResourceArgs {
    /**
     * Automatic renewal. 1 is auto renew flag, 0 is not.
     */
    autoRenewFlag: pulumi.Input<number>;
