...
export class VpcPeerConnectManager extends pulumi.CustomResource {
    /**
     * Get an existing VpcPeerConnectManager resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcPeerConnectManagerState, opts?: pulumi.CustomResourceOptions): VpcPeerConnectManager {
        return new VpcPeerConnectManager(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpcPeerConnectManager:VpcPeerConnectManager';

    /**
     * Returns true if the given object is an instance of VpcPeerConnectManager.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpcPeerConnectManager {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VpcPeerConnectManager.__pulumiType;
    }
    ...
    /**
     * Create a VpcPeerConnectManager resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VpcPeerConnectManagerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VpcPeerConnectManagerArgs | VpcPeerConnectManagerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VpcPeerConnectManagerState | undefined;
            ...
            const args = argsOrState as VpcPeerConnectManagerArgs | undefined;
        ...
        super(VpcPeerConnectManager.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VpcPeerConnectManager resources.
 */
export interface VpcPeerConnectManagerState {
    /**
     * Bandwidth upper limit, unit Mbps.
     */
...
/**
 * The set of arguments for constructing a VpcPeerConnectManager resource.
 */
export interface VpcPeerConnectManagerArgs {
    /**
     * Bandwidth upper limit, unit Mbps.
     */
    bandwidth?: pulumi.Input<number>;
