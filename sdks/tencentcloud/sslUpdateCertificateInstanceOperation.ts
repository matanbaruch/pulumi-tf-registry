...
export class SslUpdateCertificateInstanceOperation extends pulumi.CustomResource {
    /**
     * Get an existing SslUpdateCertificateInstanceOperation resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SslUpdateCertificateInstanceOperationState, opts?: pulumi.CustomResourceOptions): SslUpdateCertificateInstanceOperation {
        return new SslUpdateCertificateInstanceOperation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sslUpdateCertificateInstanceOperation:SslUpdateCertificateInstanceOperation';

    /**
     * Returns true if the given object is an instance of SslUpdateCertificateInstanceOperation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SslUpdateCertificateInstanceOperation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SslUpdateCertificateInstanceOperation.__pulumiType;
    }
     ...
     */
    public readonly resourceTypesRegions!: pulumi.Output<outputs.SslUpdateCertificateInstanceOperationResourceTypesRegion[] | undefined>;

    /**
     * Create a SslUpdateCertificateInstanceOperation resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SslUpdateCertificateInstanceOperationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SslUpdateCertificateInstanceOperationArgs | SslUpdateCertificateInstanceOperationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SslUpdateCertificateInstanceOperationState | undefined;
            ...
            const args = argsOrState as SslUpdateCertificateInstanceOperationArgs | undefined;
        ...
        super(SslUpdateCertificateInstanceOperation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SslUpdateCertificateInstanceOperation resources.
 */
export interface SslUpdateCertificateInstanceOperationState {
    /**
     * Whether to allow downloading, if you choose to upload the certificate, you can configure this parameter.
     */
     ...
     * List of regions where cloud resources need to be deploye.
     */
    resourceTypesRegions?: pulumi.Input<pulumi.Input<inputs.SslUpdateCertificateInstanceOperationResourceTypesRegion>[]>;
}

/**
 * The set of arguments for constructing a SslUpdateCertificateInstanceOperation resource.
 */
export interface SslUpdateCertificateInstanceOperationArgs {
    /**
     * Whether to allow downloading, if you choose to upload the certificate, you can configure this parameter.
     */
    allowDownload?: pulumi.Input<boolean>;
