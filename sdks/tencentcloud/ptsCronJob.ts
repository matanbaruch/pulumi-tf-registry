...
export class PtsCronJob extends pulumi.CustomResource {
    /**
     * Get an existing PtsCronJob resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PtsCronJobState, opts?: pulumi.CustomResourceOptions): PtsCronJob {
        return new PtsCronJob(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ptsCronJob:PtsCronJob';

    /**
     * Returns true if the given object is an instance of PtsCronJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PtsCronJob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PtsCronJob.__pulumiType;
    }
    ...
    /**
     * Create a PtsCronJob resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PtsCronJobArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PtsCronJobArgs | PtsCronJobState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PtsCronJobState | undefined;
            ...
            const args = argsOrState as PtsCronJobArgs | undefined;
        ...
        super(PtsCronJob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PtsCronJob resources.
 */
export interface PtsCronJobState {
    /**
     * Reason for suspension.
     */
...
/**
 * The set of arguments for constructing a PtsCronJob resource.
 */
export interface PtsCronJobArgs {
    /**
     * Cron expression, When setting cron_expression at that time, frequency_type must be greater than 1.
     */
    cronExpression: pulumi.Input<string>;
