...
export class CcnAttachment extends pulumi.CustomResource {
    /**
     * Get an existing CcnAttachment resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CcnAttachmentState, opts?: pulumi.CustomResourceOptions): CcnAttachment {
        return new CcnAttachment(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ccnAttachment:CcnAttachment';

    /**
     * Returns true if the given object is an instance of CcnAttachment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CcnAttachment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CcnAttachment.__pulumiType;
    }
    ...
    /**
     * Create a CcnAttachment resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CcnAttachmentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CcnAttachmentArgs | CcnAttachmentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CcnAttachmentState | undefined;
            ...
            const args = argsOrState as CcnAttachmentArgs | undefined;
        ...
        super(CcnAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CcnAttachment resources.
 */
export interface CcnAttachmentState {
    /**
     * Time of attaching.
     */
...
/**
 * The set of arguments for constructing a CcnAttachment resource.
 */
export interface CcnAttachmentArgs {
    /**
     * ID of the CCN.
     */
    ccnId: pulumi.Input<string>;
