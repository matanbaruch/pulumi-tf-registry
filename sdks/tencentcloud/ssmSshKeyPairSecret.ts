...
export class SsmSshKeyPairSecret extends pulumi.CustomResource {
    /**
     * Get an existing SsmSshKeyPairSecret resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SsmSshKeyPairSecretState, opts?: pulumi.CustomResourceOptions): SsmSshKeyPairSecret {
        return new SsmSshKeyPairSecret(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ssmSshKeyPairSecret:SsmSshKeyPairSecret';

    /**
     * Returns true if the given object is an instance of SsmSshKeyPairSecret.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SsmSshKeyPairSecret {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SsmSshKeyPairSecret.__pulumiType;
    }
    ...
    /**
     * Create a SsmSshKeyPairSecret resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SsmSshKeyPairSecretArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SsmSshKeyPairSecretArgs | SsmSshKeyPairSecretState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SsmSshKeyPairSecretState | undefined;
            ...
            const args = argsOrState as SsmSshKeyPairSecretArgs | undefined;
        ...
        super(SsmSshKeyPairSecret.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SsmSshKeyPairSecret resources.
 */
export interface SsmSshKeyPairSecretState {
    /**
     * Specifies whether to delete the SSH key from both the secret and the SSH key list in the CVM console. This field is only
     * take effect when delete SSH key secrets. Valid values: `True`: deletes SSH key from both the secret and SSH key list in
     * the CVM console. Note that the deletion will fail if the SSH key is already bound to a CVM instance.`False`: only
...
/**
 * The set of arguments for constructing a SsmSshKeyPairSecret resource.
 */
export interface SsmSshKeyPairSecretArgs {
    /**
     * Specifies whether to delete the SSH key from both the secret and the SSH key list in the CVM console. This field is only
     * take effect when delete SSH key secrets. Valid values: `True`: deletes SSH key from both the secret and SSH key list in
     * the CVM console. Note that the deletion will fail if the SSH key is already bound to a CVM instance.`False`: only
