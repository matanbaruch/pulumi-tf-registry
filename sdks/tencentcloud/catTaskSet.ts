...
export class CatTaskSet extends pulumi.CustomResource {
    /**
     * Get an existing CatTaskSet resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CatTaskSetState, opts?: pulumi.CustomResourceOptions): CatTaskSet {
        return new CatTaskSet(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/catTaskSet:CatTaskSet';

    /**
     * Returns true if the given object is an instance of CatTaskSet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CatTaskSet {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CatTaskSet.__pulumiType;
    }

    /**
     * Batch task name address.
     */
    public readonly batchTasks!: pulumi.Output<outputs.CatTaskSetBatchTasks>;
    /**
    ...
    /**
     * Create a CatTaskSet resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CatTaskSetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CatTaskSetArgs | CatTaskSetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CatTaskSetState | undefined;
            ...
            const args = argsOrState as CatTaskSetArgs | undefined;
        ...
        super(CatTaskSet.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CatTaskSet resources.
 */
export interface CatTaskSetState {
    /**
     * Batch task name address.
     */
    batchTasks?: pulumi.Input<inputs.CatTaskSetBatchTasks>;
    /**
     * Timer task cron expression.
     */
...
/**
 * The set of arguments for constructing a CatTaskSet resource.
 */
export interface CatTaskSetArgs {
    /**
     * Batch task name address.
     */
    batchTasks: pulumi.Input<inputs.CatTaskSetBatchTasks>;
