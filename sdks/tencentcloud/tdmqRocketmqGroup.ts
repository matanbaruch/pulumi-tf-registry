...
export class TdmqRocketmqGroup extends pulumi.CustomResource {
    /**
     * Get an existing TdmqRocketmqGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TdmqRocketmqGroupState, opts?: pulumi.CustomResourceOptions): TdmqRocketmqGroup {
        return new TdmqRocketmqGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tdmqRocketmqGroup:TdmqRocketmqGroup';

    /**
     * Returns true if the given object is an instance of TdmqRocketmqGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TdmqRocketmqGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TdmqRocketmqGroup.__pulumiType;
    }
    ...
    /**
     * Create a TdmqRocketmqGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TdmqRocketmqGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TdmqRocketmqGroupArgs | TdmqRocketmqGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TdmqRocketmqGroupState | undefined;
            ...
            const args = argsOrState as TdmqRocketmqGroupArgs | undefined;
        ...
        super(TdmqRocketmqGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TdmqRocketmqGroup resources.
 */
export interface TdmqRocketmqGroupState {
    /**
     * Whether to enable broadcast consumption.
     */
...
/**
 * The set of arguments for constructing a TdmqRocketmqGroup resource.
 */
export interface TdmqRocketmqGroupArgs {
    /**
     * Whether to enable broadcast consumption.
     */
    broadcastEnable: pulumi.Input<boolean>;
