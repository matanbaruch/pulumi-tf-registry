...
export class VpnGatewayRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpnGatewayRoute:VpnGatewayRoute';
    ...
    constructor(name: string, argsOrState?: VpnGatewayRouteArgs | VpnGatewayRouteState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpnGatewayRoute.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
