...
export class WedataRuleTemplate extends pulumi.CustomResource {
    /**
     * Get an existing WedataRuleTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WedataRuleTemplateState, opts?: pulumi.CustomResourceOptions): WedataRuleTemplate {
        return new WedataRuleTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wedataRuleTemplate:WedataRuleTemplate';

    /**
     * Returns true if the given object is an instance of WedataRuleTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WedataRuleTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WedataRuleTemplate.__pulumiType;
    }
    ...
    /**
     * Create a WedataRuleTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WedataRuleTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WedataRuleTemplateArgs | WedataRuleTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WedataRuleTemplateState | undefined;
            ...
            const args = argsOrState as WedataRuleTemplateArgs | undefined;
        ...
        super(WedataRuleTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WedataRuleTemplate resources.
 */
export interface WedataRuleTemplateState {
    /**
     * Description of Template.
     */
...
/**
 * The set of arguments for constructing a WedataRuleTemplate resource.
 */
export interface WedataRuleTemplateArgs {
    /**
     * Description of Template.
     */
    description?: pulumi.Input<string>;
