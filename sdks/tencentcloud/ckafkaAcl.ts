...
export class CkafkaAcl extends pulumi.CustomResource {
    /**
     * Get an existing CkafkaAcl resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CkafkaAclState, opts?: pulumi.CustomResourceOptions): CkafkaAcl {
        return new CkafkaAcl(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ckafkaAcl:CkafkaAcl';

    /**
     * Returns true if the given object is an instance of CkafkaAcl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CkafkaAcl {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CkafkaAcl.__pulumiType;
    }
    ...
    /**
     * Create a CkafkaAcl resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CkafkaAclArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CkafkaAclArgs | CkafkaAclState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CkafkaAclState | undefined;
            ...
            const args = argsOrState as CkafkaAclArgs | undefined;
        ...
        super(CkafkaAcl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CkafkaAcl resources.
 */
export interface CkafkaAclState {
    /**
     * The default is *, which means that any host can access it. Support filling in IP or network segment, and support
     * `;`separation.
     */
...
/**
 * The set of arguments for constructing a CkafkaAcl resource.
 */
export interface CkafkaAclArgs {
    /**
     * The default is *, which means that any host can access it. Support filling in IP or network segment, and support
     * `;`separation.
     */
