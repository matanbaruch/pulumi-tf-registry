...
export class TsfApplicationPublicConfig extends pulumi.CustomResource {
    /**
     * Get an existing TsfApplicationPublicConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfApplicationPublicConfigState, opts?: pulumi.CustomResourceOptions): TsfApplicationPublicConfig {
        return new TsfApplicationPublicConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfApplicationPublicConfig:TsfApplicationPublicConfig';

    /**
     * Returns true if the given object is an instance of TsfApplicationPublicConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfApplicationPublicConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfApplicationPublicConfig.__pulumiType;
    }
    ...
    /**
     * Create a TsfApplicationPublicConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfApplicationPublicConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfApplicationPublicConfigArgs | TsfApplicationPublicConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfApplicationPublicConfigState | undefined;
            ...
            const args = argsOrState as TsfApplicationPublicConfigArgs | undefined;
        ...
        super(TsfApplicationPublicConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfApplicationPublicConfig resources.
 */
export interface TsfApplicationPublicConfigState {
    /**
     * Config Name.
     */
...
/**
 * The set of arguments for constructing a TsfApplicationPublicConfig resource.
 */
export interface TsfApplicationPublicConfigArgs {
    /**
     * Config Name.
     */
    configName: pulumi.Input<string>;
