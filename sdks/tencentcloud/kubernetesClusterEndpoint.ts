...
export class KubernetesClusterEndpoint extends pulumi.CustomResource {
    /**
     * Get an existing KubernetesClusterEndpoint resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KubernetesClusterEndpointState, opts?: pulumi.CustomResourceOptions): KubernetesClusterEndpoint {
        return new KubernetesClusterEndpoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/kubernetesClusterEndpoint:KubernetesClusterEndpoint';

    /**
     * Returns true if the given object is an instance of KubernetesClusterEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubernetesClusterEndpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubernetesClusterEndpoint.__pulumiType;
    }
    ...
    /**
     * Create a KubernetesClusterEndpoint resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: KubernetesClusterEndpointArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: KubernetesClusterEndpointArgs | KubernetesClusterEndpointState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KubernetesClusterEndpointState | undefined;
            ...
            const args = argsOrState as KubernetesClusterEndpointArgs | undefined;
        ...
        super(KubernetesClusterEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering KubernetesClusterEndpoint resources.
 */
export interface KubernetesClusterEndpointState {
    /**
     * The certificate used for access.
     */
...
/**
 * The set of arguments for constructing a KubernetesClusterEndpoint resource.
 */
export interface KubernetesClusterEndpointArgs {
    /**
     * Specify cluster ID.
     */
    clusterId: pulumi.Input<string>;
