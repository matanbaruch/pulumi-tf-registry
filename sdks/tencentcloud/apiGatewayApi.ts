...
export class ApiGatewayApi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/apiGatewayApi:ApiGatewayApi';
     ...
     */
    public readonly microServices!: pulumi.Output<outputs.ApiGatewayApiMicroService[] | undefined>;
    /**
     * OAuth configuration. Effective when AuthType is OAUTH.
     */
    public readonly oauthConfig!: pulumi.Output<outputs.ApiGatewayApiOauthConfig | undefined>;
    /**
     * Owner of resources.
     */
     ...
     */
    public readonly responseErrorCodes!: pulumi.Output<outputs.ApiGatewayApiResponseErrorCode[] | undefined>;
    /**
     ...
     */
    public readonly serviceConfigCosConfig!: pulumi.Output<outputs.ApiGatewayApiServiceConfigCosConfig | undefined>;
    /**
     ...
     */
    public readonly serviceParameters!: pulumi.Output<outputs.ApiGatewayApiServiceParameter[] | undefined>;
    /**
     * Health check configuration for microservices.
     */
    public readonly serviceTsfHealthCheckConf!: pulumi.Output<outputs.ApiGatewayApiServiceTsfHealthCheckConf | undefined>;
    /**
     * Load balancing configuration for microservices.
     */
    public readonly serviceTsfLoadBalanceConf!: pulumi.Output<outputs.ApiGatewayApiServiceTsfLoadBalanceConf | undefined>;
    /**
     ...
     */
    public readonly targetServices!: pulumi.Output<outputs.ApiGatewayApiTargetService[] | undefined>;
    /**
     * Target health check configuration. (Internal testing stage).
     */
    public readonly targetServicesHealthCheckConf!: pulumi.Output<outputs.ApiGatewayApiTargetServicesHealthCheckConf | undefined>;
    /**
...
export interface ApiGatewayApiState {
     ...
     * API bound microservice list.
     */
    microServices?: pulumi.Input<pulumi.Input<inputs.ApiGatewayApiMicroService>[]>;
    /**
     * OAuth configuration. Effective when AuthType is OAUTH.
     */
    oauthConfig?: pulumi.Input<inputs.ApiGatewayApiOauthConfig>;
    /**
     * Owner of resources.
     */
     ...
     * Custom error code configuration. Must keep at least one after set.
     */
    responseErrorCodes?: pulumi.Input<pulumi.Input<inputs.ApiGatewayApiResponseErrorCode>[]>;
    /**
     * Response failure sample of custom response configuration.
     */
     ...
     * null, indicating that a valid value cannot be obtained.
     */
    serviceConfigCosConfig?: pulumi.Input<inputs.ApiGatewayApiServiceConfigCosConfig>;
    /**
     * API backend service request method, such as `GET`. If `service_config_type` is `HTTP`, this parameter will be required.
     * The frontend `request_config_method` and backend method `service_config_method` can be different.
     */
     ...
     * The backend service parameters of the API.
     */
    serviceParameters?: pulumi.Input<pulumi.Input<inputs.ApiGatewayApiServiceParameter>[]>;
    /**
     * Health check configuration for microservices.
     */
    serviceTsfHealthCheckConf?: pulumi.Input<inputs.ApiGatewayApiServiceTsfHealthCheckConf>;
    /**
     * Load balancing configuration for microservices.
     */
    serviceTsfLoadBalanceConf?: pulumi.Input<inputs.ApiGatewayApiServiceTsfLoadBalanceConf>;
    /**
     * Tsf serverless namespace ID. (In internal testing).
     */
     ...
     * Target type backend resource information. (Internal testing stage).
     */
    targetServices?: pulumi.Input<pulumi.Input<inputs.ApiGatewayApiTargetService>[]>;
    /**
     * Target health check configuration. (Internal testing stage).
     */
    targetServicesHealthCheckConf?: pulumi.Input<inputs.ApiGatewayApiTargetServicesHealthCheckConf>;
    /**
     * Target type load balancing configuration. (Internal testing stage).
     */
