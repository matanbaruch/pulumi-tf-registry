...
export class MariadbInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mariadbInstance:MariadbInstance';
     ...
     */
    public readonly initParams!: pulumi.Output<outputs.MariadbInstanceInitParam[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MariadbInstanceArgs | MariadbInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MariadbInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MariadbInstanceState {
     ...
     * synchronous; 2 - strong synchronous can degenerate. The default is strong synchronous can degenerate).
     */
    initParams?: pulumi.Input<pulumi.Input<inputs.MariadbInstanceInitParam>[]>;
    /**
     * Instance ID, uniquely identifies a TDSQL instance.
     */
