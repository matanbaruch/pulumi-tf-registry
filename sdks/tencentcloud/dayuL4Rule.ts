...
export class DayuL4Rule extends pulumi.CustomResource {
    /**
     * Get an existing DayuL4Rule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DayuL4RuleState, opts?: pulumi.CustomResourceOptions): DayuL4Rule {
        return new DayuL4Rule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dayuL4Rule:DayuL4Rule';

    /**
     * Returns true if the given object is an instance of DayuL4Rule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DayuL4Rule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DayuL4Rule.__pulumiType;
    }
     ...
     * 20.
     */
    public readonly sourceLists!: pulumi.Output<outputs.DayuL4RuleSourceList[]>;
    /**
    ...
    /**
     * Create a DayuL4Rule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DayuL4RuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DayuL4RuleArgs | DayuL4RuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DayuL4RuleState | undefined;
            ...
            const args = argsOrState as DayuL4RuleArgs | undefined;
        ...
        super(DayuL4Rule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DayuL4Rule resources.
 */
export interface DayuL4RuleState {
    /**
     * The destination port of the L4 rule.
     */
     ...
     * 20.
     */
    sourceLists?: pulumi.Input<pulumi.Input<inputs.DayuL4RuleSourceList>[]>;
    /**
     * Source type, `1` for source of host, `2` for source of IP.
     */
...
/**
 * The set of arguments for constructing a DayuL4Rule resource.
 */
export interface DayuL4RuleArgs {
    /**
     * The destination port of the L4 rule.
     */
    dPort: pulumi.Input<number>;
