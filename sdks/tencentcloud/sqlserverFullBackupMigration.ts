...
export class SqlserverFullBackupMigration extends pulumi.CustomResource {
    /**
     * Get an existing SqlserverFullBackupMigration resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlserverFullBackupMigrationState, opts?: pulumi.CustomResourceOptions): SqlserverFullBackupMigration {
        return new SqlserverFullBackupMigration(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sqlserverFullBackupMigration:SqlserverFullBackupMigration';

    /**
     * Returns true if the given object is an instance of SqlserverFullBackupMigration.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SqlserverFullBackupMigration {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SqlserverFullBackupMigration.__pulumiType;
    }
    ...
    /**
     * Create a SqlserverFullBackupMigration resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SqlserverFullBackupMigrationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlserverFullBackupMigrationArgs | SqlserverFullBackupMigrationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SqlserverFullBackupMigrationState | undefined;
            ...
            const args = argsOrState as SqlserverFullBackupMigrationArgs | undefined;
        ...
        super(SqlserverFullBackupMigration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SqlserverFullBackupMigration resources.
 */
export interface SqlserverFullBackupMigrationState {
    /**
     * If the UploadType is COS_URL, fill in the URL here. If the UploadType is COS_UPLOAD, fill in the name of the backup file
     * here. Only 1 backup file is supported, but a backup file can involve multiple databases.
     */
...
/**
 * The set of arguments for constructing a SqlserverFullBackupMigration resource.
 */
export interface SqlserverFullBackupMigrationArgs {
    /**
     * If the UploadType is COS_URL, fill in the URL here. If the UploadType is COS_UPLOAD, fill in the name of the backup file
     * here. Only 1 backup file is supported, but a backup file can involve multiple databases.
     */
