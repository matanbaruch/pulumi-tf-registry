...
export class MpsSampleSnapshotTemplate extends pulumi.CustomResource {
    /**
     * Get an existing MpsSampleSnapshotTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MpsSampleSnapshotTemplateState, opts?: pulumi.CustomResourceOptions): MpsSampleSnapshotTemplate {
        return new MpsSampleSnapshotTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mpsSampleSnapshotTemplate:MpsSampleSnapshotTemplate';

    /**
     * Returns true if the given object is an instance of MpsSampleSnapshotTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MpsSampleSnapshotTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MpsSampleSnapshotTemplate.__pulumiType;
    }
    ...
    /**
     * Create a MpsSampleSnapshotTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MpsSampleSnapshotTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MpsSampleSnapshotTemplateArgs | MpsSampleSnapshotTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MpsSampleSnapshotTemplateState | undefined;
            ...
            const args = argsOrState as MpsSampleSnapshotTemplateArgs | undefined;
        ...
        super(MpsSampleSnapshotTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MpsSampleSnapshotTemplate resources.
 */
export interface MpsSampleSnapshotTemplateState {
    /**
     * Template description information, length limit: 256 characters.
     */
...
/**
 * The set of arguments for constructing a MpsSampleSnapshotTemplate resource.
 */
export interface MpsSampleSnapshotTemplateArgs {
    /**
     * Template description information, length limit: 256 characters.
     */
    comment?: pulumi.Input<string>;
