...
export class TsfNamespace extends pulumi.CustomResource {
    /**
     * Get an existing TsfNamespace resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfNamespaceState, opts?: pulumi.CustomResourceOptions): TsfNamespace {
        return new TsfNamespace(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfNamespace:TsfNamespace';

    /**
     * Returns true if the given object is an instance of TsfNamespace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfNamespace {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfNamespace.__pulumiType;
    }
    ...
    /**
     * Create a TsfNamespace resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfNamespaceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfNamespaceArgs | TsfNamespaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfNamespaceState | undefined;
            ...
            const args = argsOrState as TsfNamespaceArgs | undefined;
        ...
        super(TsfNamespace.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfNamespace resources.
 */
export interface TsfNamespaceState {
    /**
     * cluster ID.
     */
...
/**
 * The set of arguments for constructing a TsfNamespace resource.
 */
export interface TsfNamespaceArgs {
    /**
     * cluster ID.
     */
    clusterId?: pulumi.Input<string>;
