...
export class ElasticsearchLogstash extends pulumi.CustomResource {
    /**
     * Get an existing ElasticsearchLogstash resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ElasticsearchLogstashState, opts?: pulumi.CustomResourceOptions): ElasticsearchLogstash {
        return new ElasticsearchLogstash(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/elasticsearchLogstash:ElasticsearchLogstash';

    /**
     * Returns true if the given object is an instance of ElasticsearchLogstash.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ElasticsearchLogstash {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ElasticsearchLogstash.__pulumiType;
    }
     ...
     */
    public readonly operationDuration!: pulumi.Output<outputs.ElasticsearchLogstashOperationDuration | undefined>;
    /**
    ...
    /**
     * Create a ElasticsearchLogstash resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ElasticsearchLogstashArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ElasticsearchLogstashArgs | ElasticsearchLogstashState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ElasticsearchLogstashState | undefined;
            ...
            const args = argsOrState as ElasticsearchLogstashArgs | undefined;
        ...
        super(ElasticsearchLogstash.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ElasticsearchLogstash resources.
 */
export interface ElasticsearchLogstashState {
    /**
     * whether to use voucher auto, 1 when use, else 0.
     */
     ...
     * operation time by tencent clound.
     */
    operationDuration?: pulumi.Input<inputs.ElasticsearchLogstashOperationDuration>;
    /**
     * Automatic renewal flag. RENEW_FLAG_AUTO: auto renewal; RENEW_FLAG_MANUAL: do not renew automatically, users renew
     * manually. It needs to be set when ChargeType is PREPAID. If this parameter is not passed, ordinary users will not renew
     * automatically by default, and SVIP users will renew automatically.
...
/**
 * The set of arguments for constructing a ElasticsearchLogstash resource.
 */
export interface ElasticsearchLogstashArgs {
    /**
     * whether to use voucher auto, 1 when use, else 0.
     */
    autoVoucher?: pulumi.Input<number>;
