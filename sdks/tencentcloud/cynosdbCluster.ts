...
export class CynosdbCluster extends pulumi.CustomResource {
    /**
     * Get an existing CynosdbCluster resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CynosdbClusterState, opts?: pulumi.CustomResourceOptions): CynosdbCluster {
        return new CynosdbCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cynosdbCluster:CynosdbCluster';

    /**
     * Returns true if the given object is an instance of CynosdbCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CynosdbCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CynosdbCluster.__pulumiType;
    }
     ...
     */
    public readonly paramItems!: pulumi.Output<outputs.CynosdbClusterParamItem[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly roGroupAddrs!: pulumi.Output<outputs.CynosdbClusterRoGroupAddr[]>;
    /**
     ...
     */
    public /*out*/ readonly roGroupInstances!: pulumi.Output<outputs.CynosdbClusterRoGroupInstance[]>;
    /**
     ...
     */
    public /*out*/ readonly rwGroupAddrs!: pulumi.Output<outputs.CynosdbClusterRwGroupAddr[]>;
    /**
     ...
     */
    public /*out*/ readonly rwGroupInstances!: pulumi.Output<outputs.CynosdbClusterRwGroupInstance[]>;
    /**
    ...
    /**
     * Create a CynosdbCluster resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CynosdbClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CynosdbClusterArgs | CynosdbClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CynosdbClusterState | undefined;
            ...
            const args = argsOrState as CynosdbClusterArgs | undefined;
        ...
        super(CynosdbCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CynosdbCluster resources.
 */
export interface CynosdbClusterState {
    /**
     * Specify whether the cluster can auto-pause while `db_mode` is `SERVERLESS`. Values: `yes` (default), `no`.
     */
     ...
     * `data.tencentcloud_mysql_default_params` to query available parameter details.
     */
    paramItems?: pulumi.Input<pulumi.Input<inputs.CynosdbClusterParamItem>[]>;
    /**
     * The ID of the parameter template.
     */
     ...
     * Readonly addresses. Each element contains the following attributes:
     */
    roGroupAddrs?: pulumi.Input<pulumi.Input<inputs.CynosdbClusterRoGroupAddr>[]>;
    /**
     * ID of read-only instance group.
     */
     ...
     * List of instances in the read-only instance group.
     */
    roGroupInstances?: pulumi.Input<pulumi.Input<inputs.CynosdbClusterRoGroupInstance>[]>;
    /**
     * IDs of security group for `ro_group`.
     */
     ...
     * Read-write addresses. Each element contains the following attributes:
     */
    rwGroupAddrs?: pulumi.Input<pulumi.Input<inputs.CynosdbClusterRwGroupAddr>[]>;
    /**
     * ID of read-write instance group.
     */
     ...
     * List of instances in the read-write instance group.
     */
    rwGroupInstances?: pulumi.Input<pulumi.Input<inputs.CynosdbClusterRwGroupInstance>[]>;
    /**
     * IDs of security group for `rw_group`.
     */
...
/**
 * The set of arguments for constructing a CynosdbCluster resource.
 */
export interface CynosdbClusterArgs {
    /**
     * Specify whether the cluster can auto-pause while `db_mode` is `SERVERLESS`. Values: `yes` (default), `no`.
     */
    autoPause?: pulumi.Input<string>;
