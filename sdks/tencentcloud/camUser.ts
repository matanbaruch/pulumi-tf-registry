...
export class CamUser extends pulumi.CustomResource {
    /**
     * Get an existing CamUser resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CamUserState, opts?: pulumi.CustomResourceOptions): CamUser {
        return new CamUser(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/camUser:CamUser';

    /**
     * Returns true if the given object is an instance of CamUser.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CamUser {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CamUser.__pulumiType;
    }
    ...
    /**
     * Create a CamUser resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: CamUserArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CamUserArgs | CamUserState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CamUserState | undefined;
            ...
            const args = argsOrState as CamUserArgs | undefined;
        ...
        super(CamUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CamUser resources.
 */
...
/**
 * The set of arguments for constructing a CamUser resource.
 */
export interface CamUserArgs {
    /**
     * Indicate whether the CAM user can login to the web console or not.
     */
    consoleLogin?: pulumi.Input<boolean>;
