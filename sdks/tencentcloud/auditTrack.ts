...
export class AuditTrack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/auditTrack:AuditTrack';
     ...
     */
    public readonly storage!: pulumi.Output<outputs.AuditTrackStorage>;
    /**
    ...
    constructor(name: string, argsOrState?: AuditTrackArgs | AuditTrackState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AuditTrack.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AuditTrackState {
     ...
     * Track Storage, support `cos` and `cls`.
     */
    storage?: pulumi.Input<inputs.AuditTrackStorage>;
    /**
     * Whether to enable the delivery of group member operation logs to the group management account or trusted service
     * management account, optional:- `0`: Close- `1`: Open.
     */
