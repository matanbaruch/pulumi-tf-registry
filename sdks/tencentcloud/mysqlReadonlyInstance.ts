...
export class MysqlReadonlyInstance extends pulumi.CustomResource {
    /**
     * Get an existing MysqlReadonlyInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MysqlReadonlyInstanceState, opts?: pulumi.CustomResourceOptions): MysqlReadonlyInstance {
        return new MysqlReadonlyInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mysqlReadonlyInstance:MysqlReadonlyInstance';

    /**
     * Returns true if the given object is an instance of MysqlReadonlyInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MysqlReadonlyInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MysqlReadonlyInstance.__pulumiType;
    }
    ...
    /**
     * Create a MysqlReadonlyInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MysqlReadonlyInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MysqlReadonlyInstanceArgs | MysqlReadonlyInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MysqlReadonlyInstanceState | undefined;
            ...
            const args = argsOrState as MysqlReadonlyInstanceArgs | undefined;
        ...
        super(MysqlReadonlyInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MysqlReadonlyInstance resources.
 */
export interface MysqlReadonlyInstanceState {
    /**
     * Auto renew flag. NOTES: Only supported prepaid instance.
     */
...
/**
 * The set of arguments for constructing a MysqlReadonlyInstance resource.
 */
export interface MysqlReadonlyInstanceArgs {
    /**
     * Auto renew flag. NOTES: Only supported prepaid instance.
     */
    autoRenewFlag?: pulumi.Input<number>;
