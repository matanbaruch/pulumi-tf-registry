...
export class ScfProvisionedConcurrencyConfig extends pulumi.CustomResource {
    /**
     * Get an existing ScfProvisionedConcurrencyConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScfProvisionedConcurrencyConfigState, opts?: pulumi.CustomResourceOptions): ScfProvisionedConcurrencyConfig {
        return new ScfProvisionedConcurrencyConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/scfProvisionedConcurrencyConfig:ScfProvisionedConcurrencyConfig';

    /**
     * Returns true if the given object is an instance of ScfProvisionedConcurrencyConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ScfProvisionedConcurrencyConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ScfProvisionedConcurrencyConfig.__pulumiType;
    }
     ...
     */
    public readonly triggerActions!: pulumi.Output<outputs.ScfProvisionedConcurrencyConfigTriggerAction[] | undefined>;
    /**
    ...
    /**
     * Create a ScfProvisionedConcurrencyConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ScfProvisionedConcurrencyConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ScfProvisionedConcurrencyConfigArgs | ScfProvisionedConcurrencyConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ScfProvisionedConcurrencyConfigState | undefined;
            ...
            const args = argsOrState as ScfProvisionedConcurrencyConfigArgs | undefined;
        ...
        super(ScfProvisionedConcurrencyConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ScfProvisionedConcurrencyConfig resources.
 */
export interface ScfProvisionedConcurrencyConfigState {
    /**
     * Name of the function for which to set the provisioned concurrency.
     */
     ...
     * Scheduled provisioned concurrency scaling action.
     */
    triggerActions?: pulumi.Input<pulumi.Input<inputs.ScfProvisionedConcurrencyConfigTriggerAction>[]>;
    /**
     * Provisioned concurrency amount. Note: there is an upper limit for the sum of provisioned concurrency amounts of all
     * versions, which currently is the function&amp;#39;s maximum concurrency quota minus 100.
     */
...
/**
 * The set of arguments for constructing a ScfProvisionedConcurrencyConfig resource.
 */
export interface ScfProvisionedConcurrencyConfigArgs {
    /**
     * Name of the function for which to set the provisioned concurrency.
     */
    functionName: pulumi.Input<string>;
