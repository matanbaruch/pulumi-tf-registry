...
export class MongodbInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mongodbInstance:MongodbInstance';
     ...
     */
    public readonly addNodeLists!: pulumi.Output<outputs.MongodbInstanceAddNodeList[] | undefined>;
    /**
     ...
     * Add node attribute list.
     */
    public readonly removeNodeLists!: pulumi.Output<outputs.MongodbInstanceRemoveNodeList[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly standbyInstanceLists!: pulumi.Output<outputs.MongodbInstanceStandbyInstanceList[]>;
    /**
...
export interface MongodbInstanceState {
     ...
     * Add node attribute list.
     */
    addNodeLists?: pulumi.Input<pulumi.Input<inputs.MongodbInstanceAddNodeList>[]>;
    /**
     * Auto renew flag. Valid values are `0`(NOTIFY_AND_MANUAL_RENEW), `1`(NOTIFY_AND_AUTO_RENEW) and
     * `2`(DISABLE_NOTIFY_AND_MANUAL_RENEW). Default value is `0`. Note: only works for PREPAID instance. Only supports`0` and
     * `1` for creation.
     ...
     * Add node attribute list.
     */
    removeNodeLists?: pulumi.Input<pulumi.Input<inputs.MongodbInstanceRemoveNodeList>[]>;
    /**
     * ID of the security group.
     */
     ...
     * List of standby instances' info.
     */
    standbyInstanceLists?: pulumi.Input<pulumi.Input<inputs.MongodbInstanceStandbyInstanceList>[]>;
    /**
     * Status of the Mongodb instance, and available values include pending initialization(expressed with 0),
     * processing(expressed with 1), running(expressed with 2) and expired(expressed with -2).
     */
