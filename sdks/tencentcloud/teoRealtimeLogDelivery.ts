...
export class TeoRealtimeLogDelivery extends pulumi.CustomResource {
    /**
     * Get an existing TeoRealtimeLogDelivery resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TeoRealtimeLogDeliveryState, opts?: pulumi.CustomResourceOptions): TeoRealtimeLogDelivery {
        return new TeoRealtimeLogDelivery(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/teoRealtimeLogDelivery:TeoRealtimeLogDelivery';

    /**
     * Returns true if the given object is an instance of TeoRealtimeLogDelivery.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TeoRealtimeLogDelivery {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TeoRealtimeLogDelivery.__pulumiType;
    }
     ...
     */
    public readonly cls!: pulumi.Output<outputs.TeoRealtimeLogDeliveryCls | undefined>;
    /**
     * Customize the configuration information of the HTTP service. This parameter is required when TaskType is set to
     * custom_endpoint.
     */
    public readonly customEndpoint!: pulumi.Output<outputs.TeoRealtimeLogDeliveryCustomEndpoint | undefined>;
    /**
     ...
     */
    public readonly customFields!: pulumi.Output<outputs.TeoRealtimeLogDeliveryCustomField[] | undefined>;
    /**
     * The filter condition for log delivery. If it is not filled, all logs will be delivered.
     */
    public readonly deliveryConditions!: pulumi.Output<outputs.TeoRealtimeLogDeliveryDeliveryCondition[] | undefined>;
    /**
     ...
     * LogFormat.
     */
    public readonly logFormat!: pulumi.Output<outputs.TeoRealtimeLogDeliveryLogFormat | undefined>;
    /**
     ...
     */
    public readonly s3!: pulumi.Output<outputs.TeoRealtimeLogDeliveryS3 | undefined>;
    /**
    ...
    /**
     * Create a TeoRealtimeLogDelivery resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TeoRealtimeLogDeliveryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TeoRealtimeLogDeliveryArgs | TeoRealtimeLogDeliveryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TeoRealtimeLogDeliveryState | undefined;
            ...
            const args = argsOrState as TeoRealtimeLogDeliveryArgs | undefined;
        ...
        super(TeoRealtimeLogDelivery.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TeoRealtimeLogDelivery resources.
 */
export interface TeoRealtimeLogDeliveryState {
    /**
     * Data delivery area, possible values are: `mainland`: within mainland China; `overseas`: worldwide (excluding mainland
     * China).
     */
     ...
     * CLS configuration information. This parameter is required when TaskType is cls.
     */
    cls?: pulumi.Input<inputs.TeoRealtimeLogDeliveryCls>;
    /**
     * Customize the configuration information of the HTTP service. This parameter is required when TaskType is set to
     * custom_endpoint.
     */
    customEndpoint?: pulumi.Input<inputs.TeoRealtimeLogDeliveryCustomEndpoint>;
    /**
     * The list of custom fields delivered supports extracting specified field values from HTTP request headers, response
     * headers, and cookies. Custom field names cannot be repeated and cannot exceed 200 fields.
     */
    customFields?: pulumi.Input<pulumi.Input<inputs.TeoRealtimeLogDeliveryCustomField>[]>;
    /**
     * The filter condition for log delivery. If it is not filled, all logs will be delivered.
     */
    deliveryConditions?: pulumi.Input<pulumi.Input<inputs.TeoRealtimeLogDeliveryDeliveryCondition>[]>;
    /**
     * The status of the real-time log delivery task. The values are: `enabled`: enabled; `disabled`: disabled. Leave it blank
     * to keep the original configuration. Not required when creating.
     */
     ...
     * LogFormat.
     */
    logFormat?: pulumi.Input<inputs.TeoRealtimeLogDeliveryLogFormat>;
    /**
     * Data delivery type, the values are: `domain`: site acceleration log; `application`: four-layer proxy log;
     * `web-rateLiming`: rate limit and CC attack protection log; `web-attack`: managed rule log; `web-rule`: custom rule log;
     * `web-bot`: Bot management log.
     ...
     * Configuration information of AWS S3 compatible storage bucket. This parameter is required when TaskType is s3.
     */
    s3?: pulumi.Input<inputs.TeoRealtimeLogDeliveryS3>;
    /**
     * The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio
     * is 60.5%. Leaving it blank means the sampling ratio is 100%.
     */
...
/**
 * The set of arguments for constructing a TeoRealtimeLogDelivery resource.
 */
export interface TeoRealtimeLogDeliveryArgs {
    /**
     * Data delivery area, possible values are: `mainland`: within mainland China; `overseas`: worldwide (excluding mainland
     * China).
     */
