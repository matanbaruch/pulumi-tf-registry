...
export class Eni extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/eni:Eni';
     ...
     */
    public /*out*/ readonly ipv4Infos!: pulumi.Output<outputs.EniIpv4Info[]>;
    /**
     ...
     */
    public readonly ipv4s!: pulumi.Output<outputs.EniIpv4[] | undefined>;
    /**
     * MAC address.
     */
    ...
    constructor(name: string, argsOrState?: EniArgs | EniState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Eni.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface EniState {
     ...
     * An information list of IPv4s. Each element contains the following attributes:
     */
    ipv4Infos?: pulumi.Input<pulumi.Input<inputs.EniIpv4Info>[]>;
    /**
     * Applying for intranet IPv4s collection, conflict with `ipv4_count`. When there are multiple ipv4s, can only be one
     * primary IP, and the maximum length of the array is 30. Each element contains the following attributes:
     */
    ipv4s?: pulumi.Input<pulumi.Input<inputs.EniIpv4>[]>;
    /**
     * MAC address.
     */
