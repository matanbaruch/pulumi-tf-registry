...
export class SecurityGroupRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/securityGroupRule:SecurityGroupRule';
     ...
     */
    public readonly addressTemplate!: pulumi.Output<outputs.SecurityGroupRuleAddressTemplate | undefined>;
    /**
     ...
     */
    public readonly protocolTemplate!: pulumi.Output<outputs.SecurityGroupRuleProtocolTemplate | undefined>;
    /**
...
export interface SecurityGroupRuleState {
     ...
     * ID of the address template, and confilicts with `source_sgid` and `cidr_ip`.
     */
    addressTemplate?: pulumi.Input<inputs.SecurityGroupRuleAddressTemplate>;
    /**
     * An IP address network or segment, and conflict with `source_sgid` and `address_template`.
     */
     ...
     * ID of the address template, and conflict with `ip_protocol`, `port_range`.
     */
    protocolTemplate?: pulumi.Input<inputs.SecurityGroupRuleProtocolTemplate>;
    /**
     * ID of the security group to be queried.
     */
