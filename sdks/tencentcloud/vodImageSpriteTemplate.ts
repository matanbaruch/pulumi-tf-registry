...
export class VodImageSpriteTemplate extends pulumi.CustomResource {
    /**
     * Get an existing VodImageSpriteTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VodImageSpriteTemplateState, opts?: pulumi.CustomResourceOptions): VodImageSpriteTemplate {
        return new VodImageSpriteTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vodImageSpriteTemplate:VodImageSpriteTemplate';

    /**
     * Returns true if the given object is an instance of VodImageSpriteTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VodImageSpriteTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VodImageSpriteTemplate.__pulumiType;
    }
    ...
    /**
     * Create a VodImageSpriteTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VodImageSpriteTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VodImageSpriteTemplateArgs | VodImageSpriteTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VodImageSpriteTemplateState | undefined;
            ...
            const args = argsOrState as VodImageSpriteTemplateArgs | undefined;
        ...
        super(VodImageSpriteTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VodImageSpriteTemplate resources.
 */
export interface VodImageSpriteTemplateState {
    /**
     * Subimage column count of an image sprite.
     */
...
/**
 * The set of arguments for constructing a VodImageSpriteTemplate resource.
 */
export interface VodImageSpriteTemplateArgs {
    /**
     * Subimage column count of an image sprite.
     */
    columnCount: pulumi.Input<number>;
