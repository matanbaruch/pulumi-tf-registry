...
export class VodSnapshotByTimeOffsetTemplate extends pulumi.CustomResource {
    /**
     * Get an existing VodSnapshotByTimeOffsetTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VodSnapshotByTimeOffsetTemplateState, opts?: pulumi.CustomResourceOptions): VodSnapshotByTimeOffsetTemplate {
        return new VodSnapshotByTimeOffsetTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vodSnapshotByTimeOffsetTemplate:VodSnapshotByTimeOffsetTemplate';

    /**
     * Returns true if the given object is an instance of VodSnapshotByTimeOffsetTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VodSnapshotByTimeOffsetTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VodSnapshotByTimeOffsetTemplate.__pulumiType;
    }
    ...
    /**
     * Create a VodSnapshotByTimeOffsetTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: VodSnapshotByTimeOffsetTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VodSnapshotByTimeOffsetTemplateArgs | VodSnapshotByTimeOffsetTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VodSnapshotByTimeOffsetTemplateState | undefined;
            ...
            const args = argsOrState as VodSnapshotByTimeOffsetTemplateArgs | undefined;
        ...
        super(VodSnapshotByTimeOffsetTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VodSnapshotByTimeOffsetTemplate resources.
 */
export interface VodSnapshotByTimeOffsetTemplateState {
    /**
     * Template description. Length limit: 256 characters.
     */
...
/**
 * The set of arguments for constructing a VodSnapshotByTimeOffsetTemplate resource.
 */
export interface VodSnapshotByTimeOffsetTemplateArgs {
    /**
     * Template description. Length limit: 256 characters.
     */
    comment?: pulumi.Input<string>;
