...
export class TseCngwGateway extends pulumi.CustomResource {
    /**
     * Get an existing TseCngwGateway resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TseCngwGatewayState, opts?: pulumi.CustomResourceOptions): TseCngwGateway {
        return new TseCngwGateway(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tseCngwGateway:TseCngwGateway';

    /**
     * Returns true if the given object is an instance of TseCngwGateway.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TseCngwGateway {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TseCngwGateway.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly instancePorts!: pulumi.Output<outputs.TseCngwGatewayInstancePort[]>;
    /**
     * internet configration.
     */
    public readonly internetConfig!: pulumi.Output<outputs.TseCngwGatewayInternetConfig | undefined>;
    /**
     ...
     */
    public readonly nodeConfig!: pulumi.Output<outputs.TseCngwGatewayNodeConfig>;
    /**
     ...
     * vpc information.
     */
    public readonly vpcConfig!: pulumi.Output<outputs.TseCngwGatewayVpcConfig>;

    /**
     * Create a TseCngwGateway resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TseCngwGatewayArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TseCngwGatewayArgs | TseCngwGatewayState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TseCngwGatewayState | undefined;
            ...
            const args = argsOrState as TseCngwGatewayArgs | undefined;
        ...
        super(TseCngwGateway.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TseCngwGateway resources.
 */
export interface TseCngwGatewayState {
    /**
     * description information, up to 120 characters.
     */
     ...
     * Port information that the instance listens to.
     */
    instancePorts?: pulumi.Input<pulumi.Input<inputs.TseCngwGatewayInstancePort>[]>;
    /**
     * internet configration.
     */
    internetConfig?: pulumi.Input<inputs.TseCngwGatewayInternetConfig>;
    /**
     * public network outbound traffic bandwidth,[1,2048]Mbps.
     */
     ...
     * gateway node configration.
     */
    nodeConfig?: pulumi.Input<inputs.TseCngwGatewayNodeConfig>;
    /**
     * Public IP address list.
     */
     ...
     * vpc information.
     */
    vpcConfig?: pulumi.Input<inputs.TseCngwGatewayVpcConfig>;
}

/**
 * The set of arguments for constructing a TseCngwGateway resource.
 */
export interface TseCngwGatewayArgs {
    /**
     * description information, up to 120 characters.
     */
    description?: pulumi.Input<string>;
