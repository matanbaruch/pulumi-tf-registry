...
export class RumProject extends pulumi.CustomResource {
    /**
     * Get an existing RumProject resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RumProjectState, opts?: pulumi.CustomResourceOptions): RumProject {
        return new RumProject(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/rumProject:RumProject';

    /**
     * Returns true if the given object is an instance of RumProject.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RumProject {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RumProject.__pulumiType;
    }
    ...
    /**
     * Create a RumProject resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RumProjectArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RumProjectArgs | RumProjectState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RumProjectState | undefined;
            ...
            const args = argsOrState as RumProjectArgs | undefined;
        ...
        super(RumProject.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering RumProject resources.
 */
export interface RumProjectState {
    /**
     * Create Time.
     */
...
/**
 * The set of arguments for constructing a RumProject resource.
 */
export interface RumProjectArgs {
    /**
     * Description of the created project (optional and up to 1,000 characters).
     */
    desc?: pulumi.Input<string>;
