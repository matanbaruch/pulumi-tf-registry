...
export class CdwdorisInstance extends pulumi.CustomResource {
    /**
     * Get an existing CdwdorisInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CdwdorisInstanceState, opts?: pulumi.CustomResourceOptions): CdwdorisInstance {
        return new CdwdorisInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cdwdorisInstance:CdwdorisInstance';

    /**
     * Returns true if the given object is an instance of CdwdorisInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CdwdorisInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CdwdorisInstance.__pulumiType;
    }

    /**
     * BE specifications.
     */
    public readonly beSpec!: pulumi.Output<outputs.CdwdorisInstanceBeSpec>;
    /**
     ...
     * Payment type.
     */
    public readonly chargeProperties!: pulumi.Output<outputs.CdwdorisInstanceChargeProperties>;
    /**
     * Database password.
     */
     ...
     * FE specifications.
     */
    public readonly feSpec!: pulumi.Output<outputs.CdwdorisInstanceFeSpec>;
    /**
     ...
     * Tag list.
     */
    public readonly tags!: pulumi.Output<outputs.CdwdorisInstanceTag[] | undefined>;
    /**
     * After the Multi-AZ is enabled, all user's Availability Zones and Subnets information are shown.
     */
    public readonly userMultiZoneInfos!: pulumi.Output<outputs.CdwdorisInstanceUserMultiZoneInfos | undefined>;
    /**
     * User subnet ID.
     */
    ...
    /**
     * Create a CdwdorisInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CdwdorisInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CdwdorisInstanceArgs | CdwdorisInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CdwdorisInstanceState | undefined;
            ...
            const args = argsOrState as CdwdorisInstanceArgs | undefined;
        ...
        super(CdwdorisInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CdwdorisInstance resources.
 */
export interface CdwdorisInstanceState {
    /**
     * BE specifications.
     */
    beSpec?: pulumi.Input<inputs.CdwdorisInstanceBeSpec>;
    /**
     * Whether the table name is case sensitive, 0 refers to sensitive, 1 refers to insensitive, compared in lowercase; 2
     * refers to insensitive, and the table name is changed to lowercase for storage.
     */
     ...
     * Payment type.
     */
    chargeProperties?: pulumi.Input<inputs.CdwdorisInstanceChargeProperties>;
    /**
     * Database password.
     */
     ...
     * FE specifications.
     */
    feSpec?: pulumi.Input<inputs.CdwdorisInstanceFeSpec>;
    /**
     * Whether it is highly available.
     */
     ...
     * Tag list.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.CdwdorisInstanceTag>[]>;
    /**
     * After the Multi-AZ is enabled, all user's Availability Zones and Subnets information are shown.
     */
    userMultiZoneInfos?: pulumi.Input<inputs.CdwdorisInstanceUserMultiZoneInfos>;
    /**
     * User subnet ID.
     */
...
/**
 * The set of arguments for constructing a CdwdorisInstance resource.
 */
export interface CdwdorisInstanceArgs {
    /**
     * BE specifications.
     */
    beSpec: pulumi.Input<inputs.CdwdorisInstanceBeSpec>;
