...
export class ChdfsFileSystem extends pulumi.CustomResource {
    /**
     * Get an existing ChdfsFileSystem resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ChdfsFileSystemState, opts?: pulumi.CustomResourceOptions): ChdfsFileSystem {
        return new ChdfsFileSystem(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/chdfsFileSystem:ChdfsFileSystem';

    /**
     * Returns true if the given object is an instance of ChdfsFileSystem.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ChdfsFileSystem {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ChdfsFileSystem.__pulumiType;
    }
    ...
    /**
     * Create a ChdfsFileSystem resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ChdfsFileSystemArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ChdfsFileSystemArgs | ChdfsFileSystemState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ChdfsFileSystemState | undefined;
            ...
            const args = argsOrState as ChdfsFileSystemArgs | undefined;
        ...
        super(ChdfsFileSystem.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ChdfsFileSystem resources.
 */
export interface ChdfsFileSystemState {
    /**
     * file system capacity. min 1GB, max 1PB, CapacityQuota is N * 1073741824.
     */
...
/**
 * The set of arguments for constructing a ChdfsFileSystem resource.
 */
export interface ChdfsFileSystemArgs {
    /**
     * file system capacity. min 1GB, max 1PB, CapacityQuota is N * 1073741824.
     */
    capacityQuota: pulumi.Input<number>;
