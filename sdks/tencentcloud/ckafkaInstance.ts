...
export class CkafkaInstance extends pulumi.CustomResource {
    /**
     * Get an existing CkafkaInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CkafkaInstanceState, opts?: pulumi.CustomResourceOptions): CkafkaInstance {
        return new CkafkaInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ckafkaInstance:CkafkaInstance';

    /**
     * Returns true if the given object is an instance of CkafkaInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CkafkaInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CkafkaInstance.__pulumiType;
    }
     ...
     */
    public readonly config!: pulumi.Output<outputs.CkafkaInstanceConfig | undefined>;
    /**
     ...
     */
    public readonly dynamicRetentionConfig!: pulumi.Output<outputs.CkafkaInstanceDynamicRetentionConfig | undefined>;
    /**
     * Instance name.
     */
     ...
     * Tag set of instance.
     */
    public readonly tagSet!: pulumi.Output<{[key: string]: string}>;
    /**
     * Tags of instance. Partition size, the professional version does not need tag.
     *
     * @deprecated Deprecated
     */
    public readonly tags!: pulumi.Output<outputs.CkafkaInstanceTag[] | undefined>;
    /**
    ...
    /**
     * Create a CkafkaInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CkafkaInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CkafkaInstanceArgs | CkafkaInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CkafkaInstanceState | undefined;
            ...
            const args = argsOrState as CkafkaInstanceArgs | undefined;
        ...
        super(CkafkaInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CkafkaInstance resources.
 */
export interface CkafkaInstanceState {
    /**
     * Instance bandwidth in MBps.
     */
     ...
     * Instance configuration.
     */
    config?: pulumi.Input<inputs.CkafkaInstanceConfig>;
    /**
     * Disk Size. Its interval varies with bandwidth, and the input must be within the interval, which can be viewed through
     * the control. If it is not within the interval, the plan will cause a change when first created.
     */
     ...
     * Dynamic message retention policy configuration.
     */
    dynamicRetentionConfig?: pulumi.Input<inputs.CkafkaInstanceDynamicRetentionConfig>;
    /**
     * Instance name.
     */
     ...
     * @deprecated Deprecated
     */
    tags?: pulumi.Input<pulumi.Input<inputs.CkafkaInstanceTag>[]>;
    /**
     * POSTPAID_BY_HOUR scale-down mode - 1: stable transformation; - 2: High-speed transformer.
     */
...
/**
 * The set of arguments for constructing a CkafkaInstance resource.
 */
export interface CkafkaInstanceArgs {
    /**
     * Instance bandwidth in MBps.
     */
    bandWidth?: pulumi.Input<number>;
