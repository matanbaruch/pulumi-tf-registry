...
export class CssLiveTranscodeTemplate extends pulumi.CustomResource {
    /**
     * Get an existing CssLiveTranscodeTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CssLiveTranscodeTemplateState, opts?: pulumi.CustomResourceOptions): CssLiveTranscodeTemplate {
        return new CssLiveTranscodeTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cssLiveTranscodeTemplate:CssLiveTranscodeTemplate';

    /**
     * Returns true if the given object is an instance of CssLiveTranscodeTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CssLiveTranscodeTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CssLiveTranscodeTemplate.__pulumiType;
    }
    ...
    /**
     * Create a CssLiveTranscodeTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CssLiveTranscodeTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CssLiveTranscodeTemplateArgs | CssLiveTranscodeTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CssLiveTranscodeTemplateState | undefined;
            ...
            const args = argsOrState as CssLiveTranscodeTemplateArgs | undefined;
        ...
        super(CssLiveTranscodeTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CssLiveTranscodeTemplate resources.
 */
export interface CssLiveTranscodeTemplateState {
    /**
     * default aac, not support now.
     */
...
/**
 * The set of arguments for constructing a CssLiveTranscodeTemplate resource.
 */
export interface CssLiveTranscodeTemplateArgs {
    /**
     * default aac, not support now.
     */
    acodec?: pulumi.Input<string>;
