...
export class MysqlAccountPrivilege extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MysqlAccountPrivilegeState, opts?: pulumi.CustomResourceOptions): MysqlAccountPrivilege {
        return new MysqlAccountPrivilege(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mysqlAccountPrivilege:MysqlAccountPrivilege';

    /**
     * Returns true if the given object is an instance of MysqlAccountPrivilege.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MysqlAccountPrivilege {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MysqlAccountPrivilege.__pulumiType;
    }
    ...
    /**
     * Create a MysqlAccountPrivilege resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MysqlAccountPrivilegeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MysqlAccountPrivilegeArgs | MysqlAccountPrivilegeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MysqlAccountPrivilegeState | undefined;
            ...
            const args = argsOrState as MysqlAccountPrivilegeArgs | undefined;
        ...
        super(MysqlAccountPrivilege.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface MysqlAccountPrivilegeState {
    /**
     * Account host, default is `%`.
     */
 ...
 */
export interface MysqlAccountPrivilegeArgs {
    /**
     * Account host, default is `%`.
     */
    accountHost?: pulumi.Input<string>;
