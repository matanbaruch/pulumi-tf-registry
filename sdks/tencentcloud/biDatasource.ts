...
export class BiDatasource extends pulumi.CustomResource {
    /**
     * Get an existing BiDatasource resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BiDatasourceState, opts?: pulumi.CustomResourceOptions): BiDatasource {
        return new BiDatasource(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/biDatasource:BiDatasource';

    /**
     * Returns true if the given object is an instance of BiDatasource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BiDatasource {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === BiDatasource.__pulumiType;
    }
    ...
    /**
     * Create a BiDatasource resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: BiDatasourceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: BiDatasourceArgs | BiDatasourceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BiDatasourceState | undefined;
            ...
            const args = argsOrState as BiDatasourceArgs | undefined;
        ...
        super(BiDatasource.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering BiDatasource resources.
 */
export interface BiDatasourceState {
    /**
     * Catalog.
     */
...
/**
 * The set of arguments for constructing a BiDatasource resource.
 */
export interface BiDatasourceArgs {
    /**
     * Catalog.
     */
    catalog?: pulumi.Input<string>;
