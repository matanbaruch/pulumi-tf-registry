...
export class TatInvocationCommandAttachment extends pulumi.CustomResource {
    /**
     * Get an existing TatInvocationCommandAttachment resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TatInvocationCommandAttachmentState, opts?: pulumi.CustomResourceOptions): TatInvocationCommandAttachment {
        return new TatInvocationCommandAttachment(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tatInvocationCommandAttachment:TatInvocationCommandAttachment';

    /**
     * Returns true if the given object is an instance of TatInvocationCommandAttachment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TatInvocationCommandAttachment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TatInvocationCommandAttachment.__pulumiType;
    }
    ...
    /**
     * Create a TatInvocationCommandAttachment resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TatInvocationCommandAttachmentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TatInvocationCommandAttachmentArgs | TatInvocationCommandAttachmentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TatInvocationCommandAttachmentState | undefined;
            ...
            const args = argsOrState as TatInvocationCommandAttachmentArgs | undefined;
        ...
        super(TatInvocationCommandAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TatInvocationCommandAttachment resources.
 */
export interface TatInvocationCommandAttachmentState {
    /**
     * Command ID.
     */
...
/**
 * The set of arguments for constructing a TatInvocationCommandAttachment resource.
 */
export interface TatInvocationCommandAttachmentArgs {
    /**
     * Command name. The name can be up to 60 bytes, and contain [a-z], [A-Z], [0-9] and [_-.].
     */
    commandName?: pulumi.Input<string>;
