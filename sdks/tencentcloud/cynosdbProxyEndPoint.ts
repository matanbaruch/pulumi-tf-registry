...
export class CynosdbProxyEndPoint extends pulumi.CustomResource {
    /**
     * Get an existing CynosdbProxyEndPoint resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CynosdbProxyEndPointState, opts?: pulumi.CustomResourceOptions): CynosdbProxyEndPoint {
        return new CynosdbProxyEndPoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cynosdbProxyEndPoint:CynosdbProxyEndPoint';

    /**
     * Returns true if the given object is an instance of CynosdbProxyEndPoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CynosdbProxyEndPoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CynosdbProxyEndPoint.__pulumiType;
    }
     ...
     * Instance Weight.
     */
    public readonly instanceWeights!: pulumi.Output<outputs.CynosdbProxyEndPointInstanceWeight[] | undefined>;
    /**
    ...
    /**
     * Create a CynosdbProxyEndPoint resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CynosdbProxyEndPointArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CynosdbProxyEndPointArgs | CynosdbProxyEndPointState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CynosdbProxyEndPointState | undefined;
            ...
            const args = argsOrState as CynosdbProxyEndPointArgs | undefined;
        ...
        super(CynosdbProxyEndPoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CynosdbProxyEndPoint resources.
 */
export interface CynosdbProxyEndPointState {
    /**
     * Connection mode: nearby, balance.
     */
     ...
     * Instance Weight.
     */
    instanceWeights?: pulumi.Input<pulumi.Input<inputs.CynosdbProxyEndPointInstanceWeight>[]>;
    /**
     * Whether to enable Connection pool, yes - enable, no - do not enable.
     */
...
/**
 * The set of arguments for constructing a CynosdbProxyEndPoint resource.
 */
export interface CynosdbProxyEndPointArgs {
    /**
     * Connection mode: nearby, balance.
     */
    accessMode?: pulumi.Input<string>;
