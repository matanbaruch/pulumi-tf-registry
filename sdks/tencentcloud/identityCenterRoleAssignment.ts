...
export class IdentityCenterRoleAssignment extends pulumi.CustomResource {
    /**
     * Get an existing IdentityCenterRoleAssignment resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityCenterRoleAssignmentState, opts?: pulumi.CustomResourceOptions): IdentityCenterRoleAssignment {
        return new IdentityCenterRoleAssignment(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/identityCenterRoleAssignment:IdentityCenterRoleAssignment';

    /**
     * Returns true if the given object is an instance of IdentityCenterRoleAssignment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityCenterRoleAssignment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityCenterRoleAssignment.__pulumiType;
    }
    ...
    /**
     * Create a IdentityCenterRoleAssignment resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityCenterRoleAssignmentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityCenterRoleAssignmentArgs | IdentityCenterRoleAssignmentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityCenterRoleAssignmentState | undefined;
            ...
            const args = argsOrState as IdentityCenterRoleAssignmentArgs | undefined;
        ...
        super(IdentityCenterRoleAssignment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityCenterRoleAssignment resources.
 */
export interface IdentityCenterRoleAssignmentState {
    /**
     * Create time.
     */
...
/**
 * The set of arguments for constructing a IdentityCenterRoleAssignment resource.
 */
export interface IdentityCenterRoleAssignmentArgs {
    /**
     * When you remove the last authorization configured with a certain privilege on a group account target account, whether to
     * cancel the privilege configuration deployment at the same time. Value: DeprovisionForLastRoleAssignmentOnAccount: Remove
     * privileges to configure deployment. None (default): Configure deployment without delegating privileges.
