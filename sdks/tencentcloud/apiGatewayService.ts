...
export class ApiGatewayService extends pulumi.CustomResource {
    /**
     * Get an existing ApiGatewayService resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiGatewayServiceState, opts?: pulumi.CustomResourceOptions): ApiGatewayService {
        return new ApiGatewayService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/apiGatewayService:ApiGatewayService';

    /**
     * Returns true if the given object is an instance of ApiGatewayService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApiGatewayService {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApiGatewayService.__pulumiType;
    }

    /**
     * A list of APIs.
     */
    public /*out*/ readonly apiLists!: pulumi.Output<outputs.ApiGatewayServiceApiList[]>;
    /**
     ...
     */
    public /*out*/ readonly usagePlanLists!: pulumi.Output<outputs.ApiGatewayServiceUsagePlanList[]>;

    /**
     * Create a ApiGatewayService resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ApiGatewayServiceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApiGatewayServiceArgs | ApiGatewayServiceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApiGatewayServiceState | undefined;
            ...
            const args = argsOrState as ApiGatewayServiceArgs | undefined;
        ...
        super(ApiGatewayService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ApiGatewayService resources.
 */
export interface ApiGatewayServiceState {
    /**
     * A list of APIs.
     */
    apiLists?: pulumi.Input<pulumi.Input<inputs.ApiGatewayServiceApiList>[]>;
    /**
     * Creation time in the format of YYYY-MM-DDThh:mm:ssZ according to ISO 8601 standard. UTC time is used.
     */
     ...
     * A list of attach usage plans.
     */
    usagePlanLists?: pulumi.Input<pulumi.Input<inputs.ApiGatewayServiceUsagePlanList>[]>;
}

/**
 * The set of arguments for constructing a ApiGatewayService resource.
 */
export interface ApiGatewayServiceArgs {
    /**
     * Self-deployed cluster name, which is used to specify the self-deployed cluster where the service is to be created.
     *
     * @deprecated Deprecated
