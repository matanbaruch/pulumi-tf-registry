...
export class SqlserverInstance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlserverInstanceState, opts?: pulumi.CustomResourceOptions): SqlserverInstance {
        return new SqlserverInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sqlserverInstance:SqlserverInstance';
    ...
    constructor(name: string, argsOrState?: SqlserverInstanceArgs | SqlserverInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SqlserverInstanceState | undefined;
        ...
        super(SqlserverInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface SqlserverInstanceState {
    /**
     * Automatic renewal sign. 0 for normal renewal, 1 for automatic renewal (Default). Only valid when purchasing a prepaid
     * instance.
     */
