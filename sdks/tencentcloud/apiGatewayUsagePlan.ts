...
export class ApiGatewayUsagePlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/apiGatewayUsagePlan:ApiGatewayUsagePlan';
     ...
     */
    public /*out*/ readonly attachLists!: pulumi.Output<outputs.ApiGatewayUsagePlanAttachList[]>;
    /**
...
export interface ApiGatewayUsagePlanState {
     ...
     * Attach service and API list.
     */
    attachLists?: pulumi.Input<pulumi.Input<inputs.ApiGatewayUsagePlanAttachList>[]>;
    /**
     * Creation time in the format of YYYY-MM-DDThh:mm:ssZ according to ISO 8601 standard. UTC time is used.
     */
