...
export class CdcSite extends pulumi.CustomResource {
    /**
     * Get an existing CdcSite resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CdcSiteState, opts?: pulumi.CustomResourceOptions): CdcSite {
        return new CdcSite(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cdcSite:CdcSite';

    /**
     * Returns true if the given object is an instance of CdcSite.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CdcSite {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CdcSite.__pulumiType;
    }
    ...
    /**
     * Create a CdcSite resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CdcSiteArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CdcSiteArgs | CdcSiteState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CdcSiteState | undefined;
            ...
            const args = argsOrState as CdcSiteArgs | undefined;
        ...
        super(CdcSite.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CdcSite resources.
 */
export interface CdcSiteState {
    /**
     * Site Detail Address.
     */
...
/**
 * The set of arguments for constructing a CdcSite resource.
 */
export interface CdcSiteArgs {
    /**
     * Site Detail Address.
     */
    addressLine: pulumi.Input<string>;
