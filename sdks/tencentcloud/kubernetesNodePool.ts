...
export class KubernetesNodePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/kubernetesNodePool:KubernetesNodePool';
     ...
     */
    public readonly autoScalingConfig!: pulumi.Output<outputs.KubernetesNodePoolAutoScalingConfig>;
    /**
     ...
     * Node config.
     */
    public readonly nodeConfig!: pulumi.Output<outputs.KubernetesNodePoolNodeConfig | undefined>;
    /**
...
export interface KubernetesNodePoolState {
     ...
     * Auto scaling config parameters.
     */
    autoScalingConfig?: pulumi.Input<inputs.KubernetesNodePoolAutoScalingConfig>;
    /**
     * The auto scaling group ID.
     */
     ...
     * Node config.
     */
    nodeConfig?: pulumi.Input<inputs.KubernetesNodePoolNodeConfig>;
    /**
     * The total node count.
     */
