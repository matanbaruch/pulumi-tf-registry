...
export class VpnSslServer extends pulumi.CustomResource {
    /**
     * Get an existing VpnSslServer resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpnSslServerState, opts?: pulumi.CustomResourceOptions): VpnSslServer {
        return new VpnSslServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpnSslServer:VpnSslServer';

    /**
     * Returns true if the given object is an instance of VpnSslServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpnSslServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VpnSslServer.__pulumiType;
    }
    ...
    /**
     * Create a VpnSslServer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VpnSslServerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VpnSslServerArgs | VpnSslServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VpnSslServerState | undefined;
            ...
            const args = argsOrState as VpnSslServerArgs | undefined;
        ...
        super(VpnSslServer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VpnSslServer resources.
 */
export interface VpnSslServerState {
    /**
     * need compressed. Default value: False.
     */
...
/**
 * The set of arguments for constructing a VpnSslServer resource.
 */
export interface VpnSslServerArgs {
    /**
     * need compressed. Default value: False.
     */
    compress?: pulumi.Input<boolean>;
