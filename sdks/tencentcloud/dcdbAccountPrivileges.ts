...
export class DcdbAccountPrivileges extends pulumi.CustomResource {
    /**
     * Get an existing DcdbAccountPrivileges resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DcdbAccountPrivilegesState, opts?: pulumi.CustomResourceOptions): DcdbAccountPrivileges {
        return new DcdbAccountPrivileges(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dcdbAccountPrivileges:DcdbAccountPrivileges';

    /**
     * Returns true if the given object is an instance of DcdbAccountPrivileges.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DcdbAccountPrivileges {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DcdbAccountPrivileges.__pulumiType;
    }

    /**
     * The account of the database, including username and host.
     */
    public readonly account!: pulumi.Output<outputs.DcdbAccountPrivilegesAccount>;
    /**
     ...
     */
    public readonly columnPrivileges!: pulumi.Output<outputs.DcdbAccountPrivilegesColumnPrivileges | undefined>;
    /**
     ...
     */
    public readonly databasePrivileges!: pulumi.Output<outputs.DcdbAccountPrivilegesDatabasePrivileges | undefined>;
    /**
     ...
     * Privileges field.
     */
    public readonly tablePrivileges!: pulumi.Output<outputs.DcdbAccountPrivilegesTablePrivileges | undefined>;
    /**
     ...
     * field.
     */
    public readonly viewPrivileges!: pulumi.Output<outputs.DcdbAccountPrivilegesViewPrivileges | undefined>;

    /**
     * Create a DcdbAccountPrivileges resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DcdbAccountPrivilegesArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DcdbAccountPrivilegesArgs | DcdbAccountPrivilegesState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DcdbAccountPrivilegesState | undefined;
            ...
            const args = argsOrState as DcdbAccountPrivilegesArgs | undefined;
        ...
        super(DcdbAccountPrivileges.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DcdbAccountPrivileges resources.
 */
export interface DcdbAccountPrivilegesState {
    /**
     * The account of the database, including username and host.
     */
    account?: pulumi.Input<inputs.DcdbAccountPrivilegesAccount>;
    /**
     * Permissions for columns in database tables. Optional values for the Privileges permission are: SELECT, INSERT, UPDATE,
     * REFERENCES. Note that if this parameter is not passed, the existing privileges are reserved. If you need to clear them,
     * please pass an empty array in the complex type Privileges field.
     */
    columnPrivileges?: pulumi.Input<inputs.DcdbAccountPrivilegesColumnPrivileges>;
    /**
     * Database permissions. Optional values for the Privileges permission are: SELECT, INSERT, UPDATE, DELETE, CREATE, DROP,
     * REFERENCES, INDEX, ALTER, CREATE TEMPORARY TABLES, LOCK TABLES, EXECUTE, CREATE VIEW, SHOW VIEW, CREATE ROUTINE, ALTER
     * ROUTINE, EVENT, TRIGGER. Note that if this parameter is not passed, the existing privileges are reserved. If you need to
     * clear them, please pass an empty array in the complex type Privileges field.
     */
    databasePrivileges?: pulumi.Input<inputs.DcdbAccountPrivilegesDatabasePrivileges>;
    /**
     * Global permissions. Among them, the optional value of the permission in GlobalPrivileges is: SELECT, INSERT, UPDATE,
     * DELETE, CREATE, PROCESS, DROP, REFERENCES, INDEX, ALTER, SHOW DATABASES, CREATE TEMPORARY TABLES, LOCK TABLES, EXECUTE,
     * CREATE VIEW, SHOW VIEW, CREATE ROUTINE, ALTER ROUTINE, EVENT, TRIGGER. Note that if this parameter is not passed, it
     ...
     * Privileges field.
     */
    tablePrivileges?: pulumi.Input<inputs.DcdbAccountPrivilegesTablePrivileges>;
    /**
     * Permissions for database views. Optional values for the Privileges permission are: SELECT, INSERT, UPDATE, DELETE,
     * CREATE, DROP, REFERENCES, INDEX, ALTER, CREATE VIEW, SHOW VIEW, TRIGGER. Note that if this parameter is not passed, the
     * existing privileges are reserved. If you need to clear them, please pass an empty array in the complex type Privileges
     * field.
     */
    viewPrivileges?: pulumi.Input<inputs.DcdbAccountPrivilegesViewPrivileges>;
}

/**
 * The set of arguments for constructing a DcdbAccountPrivileges resource.
 */
export interface DcdbAccountPrivilegesArgs {
    /**
     * The account of the database, including username and host.
     */
    account: pulumi.Input<inputs.DcdbAccountPrivilegesAccount>;
