...
export class WafSaasDomain extends pulumi.CustomResource {
    /**
     * Get an existing WafSaasDomain resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WafSaasDomainState, opts?: pulumi.CustomResourceOptions): WafSaasDomain {
        return new WafSaasDomain(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wafSaasDomain:WafSaasDomain';

    /**
     * Returns true if the given object is an instance of WafSaasDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WafSaasDomain {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WafSaasDomain.__pulumiType;
    }
     ...
     */
    public readonly ports!: pulumi.Output<outputs.WafSaasDomainPort[]>;
    /**
    ...
    /**
     * Create a WafSaasDomain resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WafSaasDomainArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WafSaasDomainArgs | WafSaasDomainState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WafSaasDomainState | undefined;
            ...
            const args = argsOrState as WafSaasDomainArgs | undefined;
        ...
        super(WafSaasDomain.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WafSaasDomain resources.
 */
export interface WafSaasDomainState {
    /**
     * Whether to enable active health detection, 0 represents disable and 1 represents enable.
     */
     ...
     * This field needs to be set for multiple ports in the upstream server.
     */
    ports?: pulumi.Input<pulumi.Input<inputs.WafSaasDomainPort>[]>;
    /**
     * Certificate key, When CertType=1, this parameter needs to be filled.
     */
...
/**
 * The set of arguments for constructing a WafSaasDomain resource.
 */
export interface WafSaasDomainArgs {
    /**
     * Whether to enable active health detection, 0 represents disable and 1 represents enable.
     */
    activeCheck?: pulumi.Input<number>;
