...
export class ClsMachineGroup extends pulumi.CustomResource {
    /**
     * Get an existing ClsMachineGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClsMachineGroupState, opts?: pulumi.CustomResourceOptions): ClsMachineGroup {
        return new ClsMachineGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/clsMachineGroup:ClsMachineGroup';

    /**
     * Returns true if the given object is an instance of ClsMachineGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClsMachineGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClsMachineGroup.__pulumiType;
    }
     ...
     */
    public readonly machineGroupType!: pulumi.Output<outputs.ClsMachineGroupMachineGroupType>;
    /**
    ...
    /**
     * Create a ClsMachineGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClsMachineGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClsMachineGroupArgs | ClsMachineGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClsMachineGroupState | undefined;
            ...
            const args = argsOrState as ClsMachineGroupArgs | undefined;
        ...
        super(ClsMachineGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClsMachineGroup resources.
 */
export interface ClsMachineGroupState {
    /**
     * Whether to enable automatic update for the machine group.
     */
     ...
     * Type of the machine group to be created.
     */
    machineGroupType?: pulumi.Input<inputs.ClsMachineGroupMachineGroupType>;
    /**
     * Whether to enable the service log to record the logs generated by the LogListener service itself. After it is enabled,
     * the internal logset cls_service_logging and the loglistener_status, loglistener_alarm, and loglistener_business log
     * topics will be created, which will not incur fees.
...
/**
 * The set of arguments for constructing a ClsMachineGroup resource.
 */
export interface ClsMachineGroupArgs {
    /**
     * Whether to enable automatic update for the machine group.
     */
    autoUpdate?: pulumi.Input<boolean>;
