...
export class VpcNetDetect extends pulumi.CustomResource {
    /**
     * Get an existing VpcNetDetect resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcNetDetectState, opts?: pulumi.CustomResourceOptions): VpcNetDetect {
        return new VpcNetDetect(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpcNetDetect:VpcNetDetect';

    /**
     * Returns true if the given object is an instance of VpcNetDetect.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpcNetDetect {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VpcNetDetect.__pulumiType;
    }
    ...
    /**
     * Create a VpcNetDetect resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VpcNetDetectArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VpcNetDetectArgs | VpcNetDetectState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VpcNetDetectState | undefined;
            ...
            const args = argsOrState as VpcNetDetectArgs | undefined;
        ...
        super(VpcNetDetect.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VpcNetDetect resources.
 */
export interface VpcNetDetectState {
    /**
     * An array of probe destination IPv4 addresses. Up to two.
     */
...
/**
 * The set of arguments for constructing a VpcNetDetect resource.
 */
export interface VpcNetDetectArgs {
    /**
     * An array of probe destination IPv4 addresses. Up to two.
     */
    detectDestinationIps: pulumi.Input<pulumi.Input<string>[]>;
