...
export class GaapHttpRule extends pulumi.CustomResource {
    /**
     * Get an existing GaapHttpRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GaapHttpRuleState, opts?: pulumi.CustomResourceOptions): GaapHttpRule {
        return new GaapHttpRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/gaapHttpRule:GaapHttpRule';

    /**
     * Returns true if the given object is an instance of GaapHttpRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GaapHttpRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GaapHttpRule.__pulumiType;
    }
     ...
     */
    public readonly realservers!: pulumi.Output<outputs.GaapHttpRuleRealserver[] | undefined>;
    /**
    ...
    /**
     * Create a GaapHttpRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GaapHttpRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GaapHttpRuleArgs | GaapHttpRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GaapHttpRuleState | undefined;
            ...
            const args = argsOrState as GaapHttpRuleArgs | undefined;
        ...
        super(GaapHttpRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering GaapHttpRule resources.
 */
export interface GaapHttpRuleState {
    /**
     * Timeout of the health check response, default value is 2s.
     */
     ...
     * An information list of GAAP realserver.
     */
    realservers?: pulumi.Input<pulumi.Input<inputs.GaapHttpRuleRealserver>[]>;
    /**
     * Scheduling policy of the forward rule, default value is `rr`. Valid value: `rr`, `wrr` and `lc`.
     */
...
/**
 * The set of arguments for constructing a GaapHttpRule resource.
 */
export interface GaapHttpRuleArgs {
    /**
     * Timeout of the health check response, default value is 2s.
     */
    connectTimeout?: pulumi.Input<number>;
