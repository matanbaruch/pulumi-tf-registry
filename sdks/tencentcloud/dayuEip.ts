...
export class DayuEip extends pulumi.CustomResource {
    /**
     * Get an existing DayuEip resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DayuEipState, opts?: pulumi.CustomResourceOptions): DayuEip {
        return new DayuEip(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dayuEip:DayuEip';

    /**
     * Returns true if the given object is an instance of DayuEip.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DayuEip {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DayuEip.__pulumiType;
    }
    ...
    /**
     * Create a DayuEip resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DayuEipArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DayuEipArgs | DayuEipState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DayuEipState | undefined;
            ...
            const args = argsOrState as DayuEipArgs | undefined;
        ...
        super(DayuEip.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DayuEip resources.
 */
export interface DayuEipState {
    /**
     * Resource id to bind.
     */
...
/**
 * The set of arguments for constructing a DayuEip resource.
 */
export interface DayuEipArgs {
    /**
     * Resource id to bind.
     */
    bindResourceId: pulumi.Input<string>;
