...
export class WedataIntegrationOfflineTask extends pulumi.CustomResource {
    /**
     * Get an existing WedataIntegrationOfflineTask resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WedataIntegrationOfflineTaskState, opts?: pulumi.CustomResourceOptions): WedataIntegrationOfflineTask {
        return new WedataIntegrationOfflineTask(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wedataIntegrationOfflineTask:WedataIntegrationOfflineTask';

    /**
     * Returns true if the given object is an instance of WedataIntegrationOfflineTask.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WedataIntegrationOfflineTask {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WedataIntegrationOfflineTask.__pulumiType;
    }
     ...
     * Task Information.
     */
    public readonly taskInfo!: pulumi.Output<outputs.WedataIntegrationOfflineTaskTaskInfo>;
    /**
    ...
    /**
     * Create a WedataIntegrationOfflineTask resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WedataIntegrationOfflineTaskArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WedataIntegrationOfflineTaskArgs | WedataIntegrationOfflineTaskState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WedataIntegrationOfflineTaskState | undefined;
            ...
            const args = argsOrState as WedataIntegrationOfflineTaskArgs | undefined;
        ...
        super(WedataIntegrationOfflineTask.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WedataIntegrationOfflineTask resources.
 */
export interface WedataIntegrationOfflineTaskState {
    /**
     * Interval time of scheduling, the minimum value: 1.
     */
     ...
     * Task Information.
     */
    taskInfo?: pulumi.Input<inputs.WedataIntegrationOfflineTaskTaskInfo>;
    /**
     * Task display mode, 0: canvas mode, 1: form mode.
     */
...
/**
 * The set of arguments for constructing a WedataIntegrationOfflineTask resource.
 */
export interface WedataIntegrationOfflineTaskArgs {
    /**
     * Interval time of scheduling, the minimum value: 1.
     */
    cycleStep: pulumi.Input<number>;
