...
export class CynosdbReadonlyInstance extends pulumi.CustomResource {
    /**
     * Get an existing CynosdbReadonlyInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CynosdbReadonlyInstanceState, opts?: pulumi.CustomResourceOptions): CynosdbReadonlyInstance {
        return new CynosdbReadonlyInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cynosdbReadonlyInstance:CynosdbReadonlyInstance';

    /**
     * Returns true if the given object is an instance of CynosdbReadonlyInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CynosdbReadonlyInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CynosdbReadonlyInstance.__pulumiType;
    }
    ...
    /**
     * Create a CynosdbReadonlyInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CynosdbReadonlyInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CynosdbReadonlyInstanceArgs | CynosdbReadonlyInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CynosdbReadonlyInstanceState | undefined;
            ...
            const args = argsOrState as CynosdbReadonlyInstanceArgs | undefined;
        ...
        super(CynosdbReadonlyInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CynosdbReadonlyInstance resources.
 */
export interface CynosdbReadonlyInstanceState {
    /**
     * Cluster ID which the readonly instance belongs to.
     */
...
/**
 * The set of arguments for constructing a CynosdbReadonlyInstance resource.
 */
export interface CynosdbReadonlyInstanceArgs {
    /**
     * Cluster ID which the readonly instance belongs to.
     */
    clusterId: pulumi.Input<string>;
