...
export class WedataDatasource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wedataDatasource:WedataDatasource';
    ...
    constructor(name: string, argsOrState?: WedataDatasourceArgs | WedataDatasourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WedataDatasource.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
