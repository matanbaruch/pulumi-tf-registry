...
export class ClbInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/clbInstance:ClbInstance';
     ...
     * untraceable, please import resource `tencentcloud.ClbSnatIp` to handle fixed ips.
     */
    public readonly snatIps!: pulumi.Output<outputs.ClbInstanceSnatIp[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ClbInstanceArgs | ClbInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClbInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ClbInstanceState {
     ...
     * untraceable, please import resource `tencentcloud.ClbSnatIp` to handle fixed ips.
     */
    snatIps?: pulumi.Input<pulumi.Input<inputs.ClbInstanceSnatIp>[]>;
    /**
     * Indicates whether Binding IPs of other VPCs feature switch.
     */
