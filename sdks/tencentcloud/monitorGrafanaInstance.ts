...
export class MonitorGrafanaInstance extends pulumi.CustomResource {
    /**
     * Get an existing MonitorGrafanaInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MonitorGrafanaInstanceState, opts?: pulumi.CustomResourceOptions): MonitorGrafanaInstance {
        return new MonitorGrafanaInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/monitorGrafanaInstance:MonitorGrafanaInstance';

    /**
     * Returns true if the given object is an instance of MonitorGrafanaInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MonitorGrafanaInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MonitorGrafanaInstance.__pulumiType;
    }
    ...
    /**
     * Create a MonitorGrafanaInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MonitorGrafanaInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MonitorGrafanaInstanceArgs | MonitorGrafanaInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MonitorGrafanaInstanceState | undefined;
            ...
            const args = argsOrState as MonitorGrafanaInstanceArgs | undefined;
        ...
        super(MonitorGrafanaInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MonitorGrafanaInstance resources.
 */
export interface MonitorGrafanaInstanceState {
    /**
     * Whether to automatically use vouchers.
     */
...
/**
 * The set of arguments for constructing a MonitorGrafanaInstance resource.
 */
export interface MonitorGrafanaInstanceArgs {
    /**
     * Whether to automatically use vouchers.
     */
    autoVoucher?: pulumi.Input<boolean>;
