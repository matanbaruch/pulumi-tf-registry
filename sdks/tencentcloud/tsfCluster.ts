...
export class TsfCluster extends pulumi.CustomResource {
    /**
     * Get an existing TsfCluster resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfClusterState, opts?: pulumi.CustomResourceOptions): TsfCluster {
        return new TsfCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfCluster:TsfCluster';

    /**
     * Returns true if the given object is an instance of TsfCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfCluster.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly operationInfos!: pulumi.Output<outputs.TsfClusterOperationInfo[]>;
    /**
    ...
    /**
     * Create a TsfCluster resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfClusterArgs | TsfClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfClusterState | undefined;
            ...
            const args = argsOrState as TsfClusterArgs | undefined;
        ...
        super(TsfCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfCluster resources.
 */
export interface TsfClusterState {
    /**
     * Abnormal number of deployment groups.
     */
     ...
     * Control information for buttons on the front end.
     */
    operationInfos?: pulumi.Input<pulumi.Input<inputs.TsfClusterOperationInfo>[]>;
    /**
     * The dataset ID to be bound.
     */
...
/**
 * The set of arguments for constructing a TsfCluster resource.
 */
export interface TsfClusterArgs {
    /**
     * CIDR assigned to cluster containers and service IP.
     */
    clusterCidr?: pulumi.Input<string>;
