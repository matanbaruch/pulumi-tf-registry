...
export class SqlserverBasicInstance extends pulumi.CustomResource {
    /**
     * Get an existing SqlserverBasicInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlserverBasicInstanceState, opts?: pulumi.CustomResourceOptions): SqlserverBasicInstance {
        return new SqlserverBasicInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sqlserverBasicInstance:SqlserverBasicInstance';

    /**
     * Returns true if the given object is an instance of SqlserverBasicInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SqlserverBasicInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SqlserverBasicInstance.__pulumiType;
    }
    ...
    /**
     * Create a SqlserverBasicInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SqlserverBasicInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlserverBasicInstanceArgs | SqlserverBasicInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SqlserverBasicInstanceState | undefined;
            ...
            const args = argsOrState as SqlserverBasicInstanceArgs | undefined;
        ...
        super(SqlserverBasicInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SqlserverBasicInstance resources.
 */
export interface SqlserverBasicInstanceState {
    /**
     * Automatic renewal sign. 0 for normal renewal, 1 for automatic renewal, the default is 1 automatic renewal. Only valid
     * when purchasing a prepaid instance.
     */
...
/**
 * The set of arguments for constructing a SqlserverBasicInstance resource.
 */
export interface SqlserverBasicInstanceArgs {
    /**
     * Automatic renewal sign. 0 for normal renewal, 1 for automatic renewal, the default is 1 automatic renewal. Only valid
     * when purchasing a prepaid instance.
     */
