...
export class SmsSign extends pulumi.CustomResource {
    /**
     * Get an existing SmsSign resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SmsSignState, opts?: pulumi.CustomResourceOptions): SmsSign {
        return new SmsSign(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/smsSign:SmsSign';

    /**
     * Returns true if the given object is an instance of SmsSign.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SmsSign {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SmsSign.__pulumiType;
    }
    ...
    /**
     * Create a SmsSign resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SmsSignArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SmsSignArgs | SmsSignState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SmsSignState | undefined;
            ...
            const args = argsOrState as SmsSignArgs | undefined;
        ...
        super(SmsSign.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SmsSign resources.
 */
export interface SmsSignState {
    /**
     * Power of attorney, which should be submitted if SignPurpose is for use by others. You should Base64-encode the image
     * first, remove the prefix data:image/jpeg;base64, from the resulted string, and then use it as the value of this
     * parameter. Note: this field will take effect only when SignPurpose is 1 (for user by others).
...
/**
 * The set of arguments for constructing a SmsSign resource.
 */
export interface SmsSignArgs {
    /**
     * Power of attorney, which should be submitted if SignPurpose is for use by others. You should Base64-encode the image
     * first, remove the prefix data:image/jpeg;base64, from the resulted string, and then use it as the value of this
     * parameter. Note: this field will take effect only when SignPurpose is 1 (for user by others).
