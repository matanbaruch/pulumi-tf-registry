...
export class DtsMigrateService extends pulumi.CustomResource {
    /**
     * Get an existing DtsMigrateService resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DtsMigrateServiceState, opts?: pulumi.CustomResourceOptions): DtsMigrateService {
        return new DtsMigrateService(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dtsMigrateService:DtsMigrateService';

    /**
     * Returns true if the given object is an instance of DtsMigrateService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DtsMigrateService {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DtsMigrateService.__pulumiType;
    }
     ...
     * tags.
     */
    public readonly tags!: pulumi.Output<outputs.DtsMigrateServiceTag[] | undefined>;

    /**
     * Create a DtsMigrateService resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DtsMigrateServiceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DtsMigrateServiceArgs | DtsMigrateServiceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DtsMigrateServiceState | undefined;
            ...
            const args = argsOrState as DtsMigrateServiceArgs | undefined;
        ...
        super(DtsMigrateService.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DtsMigrateService resources.
 */
export interface DtsMigrateServiceState {
    /**
     * destination database type, optional value is mysql/redis/percona/mongodb/postgresql/sqlserver/mariadb.
     */
     ...
     * tags.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.DtsMigrateServiceTag>[]>;
}

/**
 * The set of arguments for constructing a DtsMigrateService resource.
 */
export interface DtsMigrateServiceArgs {
    /**
     * destination database type, optional value is mysql/redis/percona/mongodb/postgresql/sqlserver/mariadb.
     */
    dstDatabaseType: pulumi.Input<string>;
