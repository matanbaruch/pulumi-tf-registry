...
export class TsfApplicationConfig extends pulumi.CustomResource {
    /**
     * Get an existing TsfApplicationConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfApplicationConfigState, opts?: pulumi.CustomResourceOptions): TsfApplicationConfig {
        return new TsfApplicationConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfApplicationConfig:TsfApplicationConfig';

    /**
     * Returns true if the given object is an instance of TsfApplicationConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfApplicationConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfApplicationConfig.__pulumiType;
    }
    ...
    /**
     * Create a TsfApplicationConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfApplicationConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfApplicationConfigArgs | TsfApplicationConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfApplicationConfigState | undefined;
            ...
            const args = argsOrState as TsfApplicationConfigArgs | undefined;
        ...
        super(TsfApplicationConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfApplicationConfig resources.
 */
export interface TsfApplicationConfigState {
    /**
     * Application ID.
     */
...
/**
 * The set of arguments for constructing a TsfApplicationConfig resource.
 */
export interface TsfApplicationConfigArgs {
    /**
     * Application ID.
     */
    applicationId: pulumi.Input<string>;
