...
export class IdentityCenterUserSyncProvisioning extends pulumi.CustomResource {
    /**
     * Get an existing IdentityCenterUserSyncProvisioning resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityCenterUserSyncProvisioningState, opts?: pulumi.CustomResourceOptions): IdentityCenterUserSyncProvisioning {
        return new IdentityCenterUserSyncProvisioning(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/identityCenterUserSyncProvisioning:IdentityCenterUserSyncProvisioning';

    /**
     * Returns true if the given object is an instance of IdentityCenterUserSyncProvisioning.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IdentityCenterUserSyncProvisioning {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IdentityCenterUserSyncProvisioning.__pulumiType;
    }
    ...
    /**
     * Create a IdentityCenterUserSyncProvisioning resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IdentityCenterUserSyncProvisioningArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IdentityCenterUserSyncProvisioningArgs | IdentityCenterUserSyncProvisioningState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IdentityCenterUserSyncProvisioningState | undefined;
            ...
            const args = argsOrState as IdentityCenterUserSyncProvisioningArgs | undefined;
        ...
        super(IdentityCenterUserSyncProvisioning.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering IdentityCenterUserSyncProvisioning resources.
 */
export interface IdentityCenterUserSyncProvisioningState {
    /**
     * Create time.
     */
...
/**
 * The set of arguments for constructing a IdentityCenterUserSyncProvisioning resource.
 */
export interface IdentityCenterUserSyncProvisioningArgs {
    /**
     * Deletion policy. It indicates the handling policy for CAM users already synchronized when the CAM user synchronization
     * is deleted. Valid values: Delete: Delete the CAM users already synchronized from CIC to CAM when the CAM user
     * synchronization is deleted; Keep: Keep the CAM users already synchronized from CIC to CAM when the CAM user
