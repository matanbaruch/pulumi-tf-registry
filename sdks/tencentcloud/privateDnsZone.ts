...
export class PrivateDnsZone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/privateDnsZone:PrivateDnsZone';
     ...
     */
    public readonly accountVpcSets!: pulumi.Output<outputs.PrivateDnsZoneAccountVpcSet[] | undefined>;
    /**
     ...
     */
    public readonly tagSets!: pulumi.Output<outputs.PrivateDnsZoneTagSet[] | undefined>;
    /**
     ...
     */
    public readonly vpcSets!: pulumi.Output<outputs.PrivateDnsZoneVpcSet[] | undefined>;
...
export interface PrivateDnsZoneState {
     ...
     * List of authorized accounts' VPCs to associate with the private domain.
     */
    accountVpcSets?: pulumi.Input<pulumi.Input<inputs.PrivateDnsZoneAccountVpcSet>[]>;
    /**
     * CNAME acceleration: ENABLED, DISABLED, Default value is ENABLED.
     */
     ...
     * @deprecated Deprecated
     */
    tagSets?: pulumi.Input<pulumi.Input<inputs.PrivateDnsZoneTagSet>[]>;
    /**
     * Tags of the private dns zone.
     */
     ...
     * Associates the private domain to a VPC when it is created.
     */
    vpcSets?: pulumi.Input<pulumi.Input<inputs.PrivateDnsZoneVpcSet>[]>;
}
