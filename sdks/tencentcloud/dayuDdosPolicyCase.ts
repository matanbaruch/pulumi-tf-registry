...
export class DayuDdosPolicyCase extends pulumi.CustomResource {
    /**
     * Get an existing DayuDdosPolicyCase resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DayuDdosPolicyCaseState, opts?: pulumi.CustomResourceOptions): DayuDdosPolicyCase {
        return new DayuDdosPolicyCase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dayuDdosPolicyCase:DayuDdosPolicyCase';

    /**
     * Returns true if the given object is an instance of DayuDdosPolicyCase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DayuDdosPolicyCase {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DayuDdosPolicyCase.__pulumiType;
    }
    ...
    /**
     * Create a DayuDdosPolicyCase resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DayuDdosPolicyCaseArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DayuDdosPolicyCaseArgs | DayuDdosPolicyCaseState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DayuDdosPolicyCaseState | undefined;
            ...
            const args = argsOrState as DayuDdosPolicyCaseArgs | undefined;
        ...
        super(DayuDdosPolicyCase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DayuDdosPolicyCase resources.
 */
export interface DayuDdosPolicyCaseState {
    /**
     * App protocol set of the DDoS policy case.
     */
...
/**
 * The set of arguments for constructing a DayuDdosPolicyCase resource.
 */
export interface DayuDdosPolicyCaseArgs {
    /**
     * App protocol set of the DDoS policy case.
     */
    appProtocols: pulumi.Input<pulumi.Input<string>[]>;
