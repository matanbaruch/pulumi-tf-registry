...
export class OceanusJob extends pulumi.CustomResource {
    /**
     * Get an existing OceanusJob resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OceanusJobState, opts?: pulumi.CustomResourceOptions): OceanusJob {
        return new OceanusJob(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/oceanusJob:OceanusJob';

    /**
     * Returns true if the given object is an instance of OceanusJob.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OceanusJob {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OceanusJob.__pulumiType;
    }
    ...
    /**
     * Create a OceanusJob resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OceanusJobArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OceanusJobArgs | OceanusJobState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OceanusJobState | undefined;
            ...
            const args = argsOrState as OceanusJobArgs | undefined;
        ...
        super(OceanusJob.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OceanusJob resources.
 */
export interface OceanusJobState {
    /**
     * When ClusterType=2, it is required to specify the ID of the exclusive cluster to which the job is submitted.
     */
...
/**
 * The set of arguments for constructing a OceanusJob resource.
 */
export interface OceanusJobArgs {
    /**
     * When ClusterType=2, it is required to specify the ID of the exclusive cluster to which the job is submitted.
     */
    clusterId?: pulumi.Input<string>;
