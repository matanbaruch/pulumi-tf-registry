...
export class CssSnapshotTemplate extends pulumi.CustomResource {
    /**
     * Get an existing CssSnapshotTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CssSnapshotTemplateState, opts?: pulumi.CustomResourceOptions): CssSnapshotTemplate {
        return new CssSnapshotTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cssSnapshotTemplate:CssSnapshotTemplate';

    /**
     * Returns true if the given object is an instance of CssSnapshotTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CssSnapshotTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CssSnapshotTemplate.__pulumiType;
    }
    ...
    /**
     * Create a CssSnapshotTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CssSnapshotTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CssSnapshotTemplateArgs | CssSnapshotTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CssSnapshotTemplateState | undefined;
            ...
            const args = argsOrState as CssSnapshotTemplateArgs | undefined;
        ...
        super(CssSnapshotTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CssSnapshotTemplate resources.
 */
export interface CssSnapshotTemplateState {
    /**
     * Cos application ID.
     */
...
/**
 * The set of arguments for constructing a CssSnapshotTemplate resource.
 */
export interface CssSnapshotTemplateArgs {
    /**
     * Cos application ID.
     */
    cosAppId: pulumi.Input<number>;
