...
export class VpcBandwidthPackage extends pulumi.CustomResource {
    /**
     * Get an existing VpcBandwidthPackage resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcBandwidthPackageState, opts?: pulumi.CustomResourceOptions): VpcBandwidthPackage {
        return new VpcBandwidthPackage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpcBandwidthPackage:VpcBandwidthPackage';

    /**
     * Returns true if the given object is an instance of VpcBandwidthPackage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpcBandwidthPackage {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VpcBandwidthPackage.__pulumiType;
    }
    ...
    /**
     * Create a VpcBandwidthPackage resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: VpcBandwidthPackageArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VpcBandwidthPackageArgs | VpcBandwidthPackageState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VpcBandwidthPackageState | undefined;
            ...
            const args = argsOrState as VpcBandwidthPackageArgs | undefined;
        ...
        super(VpcBandwidthPackage.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VpcBandwidthPackage resources.
 */
export interface VpcBandwidthPackageState {
    /**
     * Bandwidth package name.
     */
...
/**
 * The set of arguments for constructing a VpcBandwidthPackage resource.
 */
export interface VpcBandwidthPackageArgs {
    /**
     * Bandwidth package name.
     */
    bandwidthPackageName?: pulumi.Input<string>;
