...
export class TsfApiGroup extends pulumi.CustomResource {
    /**
     * Get an existing TsfApiGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfApiGroupState, opts?: pulumi.CustomResourceOptions): TsfApiGroup {
        return new TsfApiGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfApiGroup:TsfApiGroup';

    /**
     * Returns true if the given object is an instance of TsfApiGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfApiGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfApiGroup.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly bindedGatewayDeployGroups!: pulumi.Output<outputs.TsfApiGroupBindedGatewayDeployGroup[]>;
    /**
    ...
    /**
     * Create a TsfApiGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfApiGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfApiGroupArgs | TsfApiGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfApiGroupState | undefined;
            ...
            const args = argsOrState as TsfApiGroupArgs | undefined;
        ...
        super(TsfApiGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfApiGroup resources.
 */
export interface TsfApiGroupState {
    /**
     * Access group ACL type.
     */
     ...
     * api group bound gateway deployment group.
     */
    bindedGatewayDeployGroups?: pulumi.Input<pulumi.Input<inputs.TsfApiGroupBindedGatewayDeployGroup>[]>;
    /**
     * Group creation time such as: 2019-06-20 15:51:28.
     */
...
/**
 * The set of arguments for constructing a TsfApiGroup resource.
 */
export interface TsfApiGroupArgs {
    /**
     * authentication type. secret: key authentication; none: no authentication.
     */
    authType?: pulumi.Input<string>;
