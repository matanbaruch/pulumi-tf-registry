...
export class CssStreamMonitor extends pulumi.CustomResource {
    /**
     * Get an existing CssStreamMonitor resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CssStreamMonitorState, opts?: pulumi.CustomResourceOptions): CssStreamMonitor {
        return new CssStreamMonitor(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cssStreamMonitor:CssStreamMonitor';

    /**
     * Returns true if the given object is an instance of CssStreamMonitor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CssStreamMonitor {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CssStreamMonitor.__pulumiType;
    }
     ...
     */
    public readonly inputLists!: pulumi.Output<outputs.CssStreamMonitorInputList[]>;
    /**
     * Monitor task name.
     */
     ...
     */
    public readonly notifyPolicy!: pulumi.Output<outputs.CssStreamMonitorNotifyPolicy | undefined>;
    /**
     ...
     */
    public readonly outputInfo!: pulumi.Output<outputs.CssStreamMonitorOutputInfo>;

    /**
     * Create a CssStreamMonitor resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CssStreamMonitorArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CssStreamMonitorArgs | CssStreamMonitorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CssStreamMonitorState | undefined;
            ...
            const args = argsOrState as CssStreamMonitorArgs | undefined;
        ...
        super(CssStreamMonitor.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CssStreamMonitor resources.
 */
export interface CssStreamMonitorState {
    /**
     * AI asr input index list.(first input index is 1.).
     */
     ...
     * Wait monitor input info list.
     */
    inputLists?: pulumi.Input<pulumi.Input<inputs.CssStreamMonitorInputList>[]>;
    /**
     * Monitor task name.
     */
     ...
     * Monitor event notify policy.
     */
    notifyPolicy?: pulumi.Input<inputs.CssStreamMonitorNotifyPolicy>;
    /**
     * Intelligent text recognition language settings: ocr language.0: close.1. Chinese,English.
     */
     ...
     * Monitor task output info.
     */
    outputInfo?: pulumi.Input<inputs.CssStreamMonitorOutputInfo>;
}

/**
 * The set of arguments for constructing a CssStreamMonitor resource.
 */
export interface CssStreamMonitorArgs {
    /**
     * AI asr input index list.(first input index is 1.).
     */
    aiAsrInputIndexLists?: pulumi.Input<pulumi.Input<number>[]>;
