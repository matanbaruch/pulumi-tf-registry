...
export class CvmLaunchTemplateVersion extends pulumi.CustomResource {
    /**
     * Get an existing CvmLaunchTemplateVersion resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CvmLaunchTemplateVersionState, opts?: pulumi.CustomResourceOptions): CvmLaunchTemplateVersion {
        return new CvmLaunchTemplateVersion(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cvmLaunchTemplateVersion:CvmLaunchTemplateVersion';

    /**
     * Returns true if the given object is an instance of CvmLaunchTemplateVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CvmLaunchTemplateVersion {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CvmLaunchTemplateVersion.__pulumiType;
    }

    /**
     * Scheduled tasks.
     */
    public readonly actionTimer!: pulumi.Output<outputs.CvmLaunchTemplateVersionActionTimer | undefined>;
    /**
     ...
     * by default.
     */
    public readonly dataDisks!: pulumi.Output<outputs.CvmLaunchTemplateVersionDataDisk[] | undefined>;
    /**
     ...
     */
    public readonly enhancedService!: pulumi.Output<outputs.CvmLaunchTemplateVersionEnhancedService | undefined>;
    /**
     * Hostname of a CVM.
     */
     ...
     */
    public readonly instanceChargePrepaid!: pulumi.Output<outputs.CvmLaunchTemplateVersionInstanceChargePrepaid | undefined>;
    /**
     ...
     */
    public readonly instanceMarketOptions!: pulumi.Output<outputs.CvmLaunchTemplateVersionInstanceMarketOptions | undefined>;
    /**
     ...
     * bandwidth, etc.
     */
    public readonly internetAccessible!: pulumi.Output<outputs.CvmLaunchTemplateVersionInternetAccessible | undefined>;
    /**
     ...
     */
    public readonly loginSettings!: pulumi.Output<outputs.CvmLaunchTemplateVersionLoginSettings | undefined>;
    /**
     ...
     */
    public readonly placement!: pulumi.Output<outputs.CvmLaunchTemplateVersionPlacement>;
    /**
     ...
     * the system default.
     */
    public readonly systemDisk!: pulumi.Output<outputs.CvmLaunchTemplateVersionSystemDisk | undefined>;
    /**
     * Description of tags associated with resource instances during instance creation.
     */
    public readonly tagSpecifications!: pulumi.Output<outputs.CvmLaunchTemplateVersionTagSpecification[] | undefined>;
    /**
     ...
     */
    public readonly virtualPrivateCloud!: pulumi.Output<outputs.CvmLaunchTemplateVersionVirtualPrivateCloud | undefined>;

    /**
     * Create a CvmLaunchTemplateVersion resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CvmLaunchTemplateVersionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CvmLaunchTemplateVersionArgs | CvmLaunchTemplateVersionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CvmLaunchTemplateVersionState | undefined;
            ...
            const args = argsOrState as CvmLaunchTemplateVersionArgs | undefined;
        ...
        super(CvmLaunchTemplateVersion.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CvmLaunchTemplateVersion resources.
 */
export interface CvmLaunchTemplateVersionState {
    /**
     * Scheduled tasks.
     */
    actionTimer?: pulumi.Input<inputs.CvmLaunchTemplateVersionActionTimer>;
    /**
     * The role name of CAM.
     */
     ...
     * by default.
     */
    dataDisks?: pulumi.Input<pulumi.Input<inputs.CvmLaunchTemplateVersionDataDisk>[]>;
    /**
     * Whether the termination protection is enabled. `TRUE`: Enable instance protection, which means that this instance can
     * not be deleted by an API action.`FALSE`: Do not enable the instance protection. Default value: `FALSE`.
     */
     ...
     * If this parameter is not specified, Cloud Monitor and Anti-DDoS are enabled for public images by default.
     */
    enhancedService?: pulumi.Input<inputs.CvmLaunchTemplateVersionEnhancedService>;
    /**
     * Hostname of a CVM.
     */
     ...
     * Describes the billing method of an instance.
     */
    instanceChargePrepaid?: pulumi.Input<inputs.CvmLaunchTemplateVersionInstanceChargePrepaid>;
    /**
     * The charge type of instance.
     */
     ...
     * Options related to bidding requests.
     */
    instanceMarketOptions?: pulumi.Input<inputs.CvmLaunchTemplateVersionInstanceMarketOptions>;
    /**
     * Instance name to be displayed.
     */
     ...
     * bandwidth, etc.
     */
    internetAccessible?: pulumi.Input<inputs.CvmLaunchTemplateVersionInternetAccessible>;
    /**
     * Instance launch template ID. This parameter is used as a basis for creating new template versions.
     */
     ...
     * Describes login settings of an instance.
     */
    loginSettings?: pulumi.Input<inputs.CvmLaunchTemplateVersionLoginSettings>;
    /**
     * Location of the instance. You can use this parameter to specify the attributes of the instance, such as its availability
     * zone, project, and CDH (for dedicated CVMs).
     */
    placement?: pulumi.Input<inputs.CvmLaunchTemplateVersionPlacement>;
    /**
     * Security groups to which the instance belongs. If this parameter is not specified, the instance will be associated with
     * default security groups.
     */
     ...
     * the system default.
     */
    systemDisk?: pulumi.Input<inputs.CvmLaunchTemplateVersionSystemDisk>;
    /**
     * Description of tags associated with resource instances during instance creation.
     */
    tagSpecifications?: pulumi.Input<pulumi.Input<inputs.CvmLaunchTemplateVersionTagSpecification>[]>;
    /**
     * User data provided to the instance. This parameter needs to be encoded in base64 format with the maximum size of 16 KB.
     */
     ...
     * Describes information on VPC, including subnets, IP addresses, etc.
     */
    virtualPrivateCloud?: pulumi.Input<inputs.CvmLaunchTemplateVersionVirtualPrivateCloud>;
}

/**
 * The set of arguments for constructing a CvmLaunchTemplateVersion resource.
 */
export interface CvmLaunchTemplateVersionArgs {
    /**
     * Scheduled tasks.
     */
    actionTimer?: pulumi.Input<inputs.CvmLaunchTemplateVersionActionTimer>;
