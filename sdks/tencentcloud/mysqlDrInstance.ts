...
export class MysqlDrInstance extends pulumi.CustomResource {
    /**
     * Get an existing MysqlDrInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MysqlDrInstanceState, opts?: pulumi.CustomResourceOptions): MysqlDrInstance {
        return new MysqlDrInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mysqlDrInstance:MysqlDrInstance';

    /**
     * Returns true if the given object is an instance of MysqlDrInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MysqlDrInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MysqlDrInstance.__pulumiType;
    }
    ...
    /**
     * Create a MysqlDrInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MysqlDrInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MysqlDrInstanceArgs | MysqlDrInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MysqlDrInstanceState | undefined;
            ...
            const args = argsOrState as MysqlDrInstanceArgs | undefined;
        ...
        super(MysqlDrInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MysqlDrInstance resources.
 */
export interface MysqlDrInstanceState {
    /**
     * Auto renew flag. NOTES: Only supported prepaid instance.
     */
...
/**
 * The set of arguments for constructing a MysqlDrInstance resource.
 */
export interface MysqlDrInstanceArgs {
    /**
     * Auto renew flag. NOTES: Only supported prepaid instance.
     */
    autoRenewFlag?: pulumi.Input<number>;
