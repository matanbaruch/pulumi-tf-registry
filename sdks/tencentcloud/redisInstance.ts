...
export class RedisInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/redisInstance:RedisInstance';
     ...
     */
    public /*out*/ readonly nodeInfos!: pulumi.Output<outputs.RedisInstanceNodeInfo[]>;
    /**
     ...
     * specific region support specific types, need to refer data `tencentcloud.getRedisZoneConfig`.
     *
     * @deprecated Deprecated
     */
    public readonly type!: pulumi.Output<string | undefined>;
    /**
     * Instance type. Available values reference data source `tencentcloud.getRedisZoneConfig` or
...
export interface RedisInstanceState {
     ...
     * Readonly Primary/Replica nodes.
     */
    nodeInfos?: pulumi.Input<pulumi.Input<inputs.RedisInstanceNodeInfo>[]>;
    /**
     * Refers to the category of the pre-modified network, including: `changeVip`: refers to switching the private network,
     * including its intranet IPv4 address and port; `changeVpc`: refers to switching the subnet to which the private network
     * belongs; `changeBaseToVpc`: refers to switching the basic network to a private network; `changeVPort`: refers to only
