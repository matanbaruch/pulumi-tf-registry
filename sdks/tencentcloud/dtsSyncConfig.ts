...
export class DtsSyncConfig extends pulumi.CustomResource {
    /**
     * Get an existing DtsSyncConfig resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DtsSyncConfigState, opts?: pulumi.CustomResourceOptions): DtsSyncConfig {
        return new DtsSyncConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dtsSyncConfig:DtsSyncConfig';

    /**
     * Returns true if the given object is an instance of DtsSyncConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DtsSyncConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DtsSyncConfig.__pulumiType;
    }
     ...
     */
    public readonly dstInfo!: pulumi.Output<outputs.DtsSyncConfigDstInfo | undefined>;
    /**
     ...
     */
    public readonly objects!: pulumi.Output<outputs.DtsSyncConfigObjects>;
    /**
     * Sync Task Options.
     */
    public readonly options!: pulumi.Output<outputs.DtsSyncConfigOptions | undefined>;
    /**
     ...
     */
    public readonly srcInfo!: pulumi.Output<outputs.DtsSyncConfigSrcInfo | undefined>;

    /**
     * Create a DtsSyncConfig resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DtsSyncConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DtsSyncConfigArgs | DtsSyncConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DtsSyncConfigState | undefined;
            ...
            const args = argsOrState as DtsSyncConfigArgs | undefined;
        ...
        super(DtsSyncConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DtsSyncConfig resources.
 */
export interface DtsSyncConfigState {
    /**
     * The time period of automatic retry, can be set from 5 to 720 minutes, 0 means no retry.
     */
     ...
     * Target information, single-node database use.
     */
    dstInfo?: pulumi.Input<inputs.DtsSyncConfigDstInfo>;
    /**
     * Expected start time, when the value of RunMode is Timed, this value is required, such as: 2006-01-02 15:04:05.
     */
     ...
     * Synchronize database table object information.
     */
    objects?: pulumi.Input<inputs.DtsSyncConfigObjects>;
    /**
     * Sync Task Options.
     */
    options?: pulumi.Input<inputs.DtsSyncConfigOptions>;
    /**
     * Operation mode, such as: Immediate (indicates immediate operation, the default value is this value), Timed (indicates
     * scheduled operation).
     */
     ...
     * Source information, single-node database use.
     */
    srcInfo?: pulumi.Input<inputs.DtsSyncConfigSrcInfo>;
}

/**
 * The set of arguments for constructing a DtsSyncConfig resource.
 */
export interface DtsSyncConfigArgs {
    /**
     * The time period of automatic retry, can be set from 5 to 720 minutes, 0 means no retry.
     */
    autoRetryTimeRangeMinutes?: pulumi.Input<number>;
