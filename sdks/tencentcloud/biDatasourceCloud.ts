...
export class BiDatasourceCloud extends pulumi.CustomResource {
    /**
     * Get an existing BiDatasourceCloud resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BiDatasourceCloudState, opts?: pulumi.CustomResourceOptions): BiDatasourceCloud {
        return new BiDatasourceCloud(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/biDatasourceCloud:BiDatasourceCloud';

    /**
     * Returns true if the given object is an instance of BiDatasourceCloud.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BiDatasourceCloud {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === BiDatasourceCloud.__pulumiType;
    }
     ...
     */
    public readonly serviceType!: pulumi.Output<outputs.BiDatasourceCloudServiceType>;
    /**
    ...
    /**
     * Create a BiDatasourceCloud resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: BiDatasourceCloudArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: BiDatasourceCloudArgs | BiDatasourceCloudState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BiDatasourceCloudState | undefined;
            ...
            const args = argsOrState as BiDatasourceCloudArgs | undefined;
        ...
        super(BiDatasourceCloud.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering BiDatasourceCloud resources.
 */
export interface BiDatasourceCloudState {
    /**
     * Charset.
     */
     ...
     * Service type, Own or Cloud.
     */
    serviceType?: pulumi.Input<inputs.BiDatasourceCloudServiceType>;
    /**
     * Datasource name in BI.
     */
...
/**
 * The set of arguments for constructing a BiDatasourceCloud resource.
 */
export interface BiDatasourceCloudArgs {
    /**
     * Charset.
     */
    charset: pulumi.Input<string>;
