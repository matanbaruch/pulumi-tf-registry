...
export class CssPullStreamTask extends pulumi.CustomResource {
    /**
     * Get an existing CssPullStreamTask resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CssPullStreamTaskState, opts?: pulumi.CustomResourceOptions): CssPullStreamTask {
        return new CssPullStreamTask(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cssPullStreamTask:CssPullStreamTask';

    /**
     * Returns true if the given object is an instance of CssPullStreamTask.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CssPullStreamTask {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CssPullStreamTask.__pulumiType;
    }
     ...
     */
    public readonly watermarkLists!: pulumi.Output<outputs.CssPullStreamTaskWatermarkList[] | undefined>;

    /**
     * Create a CssPullStreamTask resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CssPullStreamTaskArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CssPullStreamTaskArgs | CssPullStreamTaskState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CssPullStreamTaskState | undefined;
            ...
            const args = argsOrState as CssPullStreamTaskArgs | undefined;
        ...
        super(CssPullStreamTask.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CssPullStreamTask resources.
 */
export interface CssPullStreamTaskState {
    /**
     * push app name.
     */
     ...
     * watermark list, max 4 setting.
     */
    watermarkLists?: pulumi.Input<pulumi.Input<inputs.CssPullStreamTaskWatermarkList>[]>;
}

/**
 * The set of arguments for constructing a CssPullStreamTask resource.
 */
export interface CssPullStreamTaskArgs {
    /**
     * push app name.
     */
    appName: pulumi.Input<string>;
