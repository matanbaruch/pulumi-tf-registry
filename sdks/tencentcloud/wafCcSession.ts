...
export class WafCcSession extends pulumi.CustomResource {
    /**
     * Get an existing WafCcSession resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WafCcSessionState, opts?: pulumi.CustomResourceOptions): WafCcSession {
        return new WafCcSession(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wafCcSession:WafCcSession';

    /**
     * Returns true if the given object is an instance of WafCcSession.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WafCcSession {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WafCcSession.__pulumiType;
    }
    ...
    /**
     * Create a WafCcSession resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WafCcSessionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WafCcSessionArgs | WafCcSessionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WafCcSessionState | undefined;
            ...
            const args = argsOrState as WafCcSessionArgs | undefined;
        ...
        super(WafCcSession.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WafCcSession resources.
 */
export interface WafCcSessionState {
    /**
     * Session match pattern, Optional patterns are match, location.
     */
...
/**
 * The set of arguments for constructing a WafCcSession resource.
 */
export interface WafCcSessionArgs {
    /**
     * Session match pattern, Optional patterns are match, location.
     */
    category: pulumi.Input<string>;
