...
export class WafCc extends pulumi.CustomResource {
    /**
     * Get an existing WafCc resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WafCcState, opts?: pulumi.CustomResourceOptions): WafCc {
        return new WafCc(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wafCc:WafCc';

    /**
     * Returns true if the given object is an instance of WafCc.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WafCc {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WafCc.__pulumiType;
    }
    ...
    /**
     * Create a WafCc resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WafCcArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WafCcArgs | WafCcState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WafCcState | undefined;
            ...
            const args = argsOrState as WafCcArgs | undefined;
        ...
        super(WafCc.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WafCc resources.
 */
export interface WafCcState {
    /**
     * Rule Action, 20 log, 21 captcha, 22 deny, 23 accurate deny.
     */
...
/**
 * The set of arguments for constructing a WafCc resource.
 */
export interface WafCcArgs {
    /**
     * Rule Action, 20 log, 21 captcha, 22 deny, 23 accurate deny.
     */
    actionType: pulumi.Input<string>;
