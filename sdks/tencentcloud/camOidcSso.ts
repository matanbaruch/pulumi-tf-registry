...
export class CamOidcSso extends pulumi.CustomResource {
    /**
     * Get an existing CamOidcSso resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CamOidcSsoState, opts?: pulumi.CustomResourceOptions): CamOidcSso {
        return new CamOidcSso(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/camOidcSso:CamOidcSso';

    /**
     * Returns true if the given object is an instance of CamOidcSso.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CamOidcSso {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CamOidcSso.__pulumiType;
    }
    ...
    /**
     * Create a CamOidcSso resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CamOidcSsoArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CamOidcSsoArgs | CamOidcSsoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CamOidcSsoState | undefined;
            ...
            const args = argsOrState as CamOidcSsoArgs | undefined;
        ...
        super(CamOidcSso.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CamOidcSso resources.
 */
export interface CamOidcSsoState {
    /**
     * Authorization request Endpoint, OpenID Connect identity provider authorization address. Corresponds to the value of the
     * `authorization_endpoint` field in the Openid-configuration provided by the Enterprise IdP.
     */
...
/**
 * The set of arguments for constructing a CamOidcSso resource.
 */
export interface CamOidcSsoArgs {
    /**
     * Authorization request Endpoint, OpenID Connect identity provider authorization address. Corresponds to the value of the
     * `authorization_endpoint` field in the Openid-configuration provided by the Enterprise IdP.
     */
