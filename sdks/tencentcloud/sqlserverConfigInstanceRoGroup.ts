...
export class SqlserverConfigInstanceRoGroup extends pulumi.CustomResource {
    /**
     * Get an existing SqlserverConfigInstanceRoGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlserverConfigInstanceRoGroupState, opts?: pulumi.CustomResourceOptions): SqlserverConfigInstanceRoGroup {
        return new SqlserverConfigInstanceRoGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sqlserverConfigInstanceRoGroup:SqlserverConfigInstanceRoGroup';

    /**
     * Returns true if the given object is an instance of SqlserverConfigInstanceRoGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SqlserverConfigInstanceRoGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SqlserverConfigInstanceRoGroup.__pulumiType;
    }
     ...
     */
    public readonly weightPairs!: pulumi.Output<outputs.SqlserverConfigInstanceRoGroupWeightPair[] | undefined>;

    /**
     * Create a SqlserverConfigInstanceRoGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SqlserverConfigInstanceRoGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlserverConfigInstanceRoGroupArgs | SqlserverConfigInstanceRoGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SqlserverConfigInstanceRoGroupState | undefined;
            ...
            const args = argsOrState as SqlserverConfigInstanceRoGroupArgs | undefined;
        ...
        super(SqlserverConfigInstanceRoGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SqlserverConfigInstanceRoGroup resources.
 */
export interface SqlserverConfigInstanceRoGroupState {
    /**
     * 0-user-defined weight (adjusted according to WeightPairs), 1-system automatically assigns weight (WeightPairs is
     * invalid), the default is 0.
     */
     ...
     * Read-only group instance weight modification set, if this parameter is not filled, it will not be modified.
     */
    weightPairs?: pulumi.Input<pulumi.Input<inputs.SqlserverConfigInstanceRoGroupWeightPair>[]>;
}

/**
 * The set of arguments for constructing a SqlserverConfigInstanceRoGroup resource.
 */
export interface SqlserverConfigInstanceRoGroupArgs {
    /**
     * 0-user-defined weight (adjusted according to WeightPairs), 1-system automatically assigns weight (WeightPairs is
     * invalid), the default is 0.
     */
