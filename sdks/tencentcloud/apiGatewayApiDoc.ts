...
export class ApiGatewayApiDoc extends pulumi.CustomResource {
    /**
     * Get an existing ApiGatewayApiDoc resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiGatewayApiDocState, opts?: pulumi.CustomResourceOptions): ApiGatewayApiDoc {
        return new ApiGatewayApiDoc(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/apiGatewayApiDoc:ApiGatewayApiDoc';

    /**
     * Returns true if the given object is an instance of ApiGatewayApiDoc.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApiGatewayApiDoc {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApiGatewayApiDoc.__pulumiType;
    }
    ...
    /**
     * Create a ApiGatewayApiDoc resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ApiGatewayApiDocArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApiGatewayApiDocArgs | ApiGatewayApiDocState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApiGatewayApiDocState | undefined;
            ...
            const args = argsOrState as ApiGatewayApiDocArgs | undefined;
        ...
        super(ApiGatewayApiDoc.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ApiGatewayApiDoc resources.
 */
export interface ApiGatewayApiDocState {
    /**
     * Api Document count.
     */
...
/**
 * The set of arguments for constructing a ApiGatewayApiDoc resource.
 */
export interface ApiGatewayApiDocArgs {
    /**
     * Api Document name.
     */
    apiDocName: pulumi.Input<string>;
