...
export class WedataIntegrationTaskNode extends pulumi.CustomResource {
    /**
     * Get an existing WedataIntegrationTaskNode resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WedataIntegrationTaskNodeState, opts?: pulumi.CustomResourceOptions): WedataIntegrationTaskNode {
        return new WedataIntegrationTaskNode(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wedataIntegrationTaskNode:WedataIntegrationTaskNode';

    /**
     * Returns true if the given object is an instance of WedataIntegrationTaskNode.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WedataIntegrationTaskNode {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WedataIntegrationTaskNode.__pulumiType;
    }
     ...
     * Node information.
     */
    public readonly nodeInfo!: pulumi.Output<outputs.WedataIntegrationTaskNodeNodeInfo>;
    /**
    ...
    /**
     * Create a WedataIntegrationTaskNode resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WedataIntegrationTaskNodeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WedataIntegrationTaskNodeArgs | WedataIntegrationTaskNodeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WedataIntegrationTaskNodeState | undefined;
            ...
            const args = argsOrState as WedataIntegrationTaskNodeArgs | undefined;
        ...
        super(WedataIntegrationTaskNode.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WedataIntegrationTaskNode resources.
 */
export interface WedataIntegrationTaskNodeState {
    /**
     * Data source type: MYSQL, POSTGRE, ORACLE, SQLSERVER, FTP, HIVE, HDFS, ICEBERG, KAFKA, HBASE, SPARK, TBASE, DB2, DM,
     * GAUSSDB, GBASE, IMPALA, ES, S3_DATAINSIGHT, GREENPLUM, PHOENIX, SAP_HANA, SFTP, OCEANBASE, CLICKHOUSE, KUDU, VERTICA,
     * REDIS, COS, DLC, DORIS, CKAFKA, DTS_KAFKA, S3, CDW, TDSQLC, TDSQL, MONGODB, SYBASE, REST_API, StarRocks, TCHOUSE_X.
     ...
     * Node information.
     */
    nodeInfo?: pulumi.Input<inputs.WedataIntegrationTaskNodeNodeInfo>;
    /**
     * Node type: INPUT, OUTPUT, JOIN, FILTER, TRANSFORM.
     */
...
/**
 * The set of arguments for constructing a WedataIntegrationTaskNode resource.
 */
export interface WedataIntegrationTaskNodeArgs {
    /**
     * Data source type: MYSQL, POSTGRE, ORACLE, SQLSERVER, FTP, HIVE, HDFS, ICEBERG, KAFKA, HBASE, SPARK, TBASE, DB2, DM,
     * GAUSSDB, GBASE, IMPALA, ES, S3_DATAINSIGHT, GREENPLUM, PHOENIX, SAP_HANA, SFTP, OCEANBASE, CLICKHOUSE, KUDU, VERTICA,
     * REDIS, COS, DLC, DORIS, CKAFKA, DTS_KAFKA, S3, CDW, TDSQLC, TDSQL, MONGODB, SYBASE, REST_API, StarRocks, TCHOUSE_X.
