...
export class ClsScheduledSql extends pulumi.CustomResource {
    /**
     * Get an existing ClsScheduledSql resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClsScheduledSqlState, opts?: pulumi.CustomResourceOptions): ClsScheduledSql {
        return new ClsScheduledSql(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/clsScheduledSql:ClsScheduledSql';

    /**
     * Returns true if the given object is an instance of ClsScheduledSql.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClsScheduledSql {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClsScheduledSql.__pulumiType;
    }

    /**
     * scheduled slq dst resource.
     */
    public readonly dstResource!: pulumi.Output<outputs.ClsScheduledSqlDstResource>;
    /**
     * task enable flag.
     */
    ...
    /**
     * Create a ClsScheduledSql resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClsScheduledSqlArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClsScheduledSqlArgs | ClsScheduledSqlState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClsScheduledSqlState | undefined;
            ...
            const args = argsOrState as ClsScheduledSqlArgs | undefined;
        ...
        super(ClsScheduledSql.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClsScheduledSql resources.
 */
export interface ClsScheduledSqlState {
    /**
     * scheduled slq dst resource.
     */
    dstResource?: pulumi.Input<inputs.ClsScheduledSqlDstResource>;
    /**
     * task enable flag.
     */
...
/**
 * The set of arguments for constructing a ClsScheduledSql resource.
 */
export interface ClsScheduledSqlArgs {
    /**
     * scheduled slq dst resource.
     */
    dstResource: pulumi.Input<inputs.ClsScheduledSqlDstResource>;
