...
export class VpcSnapshotPolicy extends pulumi.CustomResource {
    /**
     * Get an existing VpcSnapshotPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcSnapshotPolicyState, opts?: pulumi.CustomResourceOptions): VpcSnapshotPolicy {
        return new VpcSnapshotPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpcSnapshotPolicy:VpcSnapshotPolicy';

    /**
     * Returns true if the given object is an instance of VpcSnapshotPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpcSnapshotPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VpcSnapshotPolicy.__pulumiType;
    }

    /**
     * Time backup strategy. Note: This field may return null, indicating that no valid value can be obtained.
     */
    public readonly backupPolicies!: pulumi.Output<outputs.VpcSnapshotPolicyBackupPolicy[] | undefined>;
    /**
    ...
    /**
     * Create a VpcSnapshotPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VpcSnapshotPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VpcSnapshotPolicyArgs | VpcSnapshotPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VpcSnapshotPolicyState | undefined;
            ...
            const args = argsOrState as VpcSnapshotPolicyArgs | undefined;
        ...
        super(VpcSnapshotPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VpcSnapshotPolicy resources.
 */
export interface VpcSnapshotPolicyState {
    /**
     * Time backup strategy. Note: This field may return null, indicating that no valid value can be obtained.
     */
    backupPolicies?: pulumi.Input<pulumi.Input<inputs.VpcSnapshotPolicyBackupPolicy>[]>;
    /**
     * Backup strategy type, `operate`: operate backup, `time`: schedule backup.
     */
...
/**
 * The set of arguments for constructing a VpcSnapshotPolicy resource.
 */
export interface VpcSnapshotPolicyArgs {
    /**
     * Time backup strategy. Note: This field may return null, indicating that no valid value can be obtained.
     */
    backupPolicies?: pulumi.Input<pulumi.Input<inputs.VpcSnapshotPolicyBackupPolicy>[]>;
