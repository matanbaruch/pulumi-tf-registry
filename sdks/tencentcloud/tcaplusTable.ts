...
export class TcaplusTable extends pulumi.CustomResource {
    /**
     * Get an existing TcaplusTable resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TcaplusTableState, opts?: pulumi.CustomResourceOptions): TcaplusTable {
        return new TcaplusTable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tcaplusTable:TcaplusTable';

    /**
     * Returns true if the given object is an instance of TcaplusTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TcaplusTable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TcaplusTable.__pulumiType;
    }
    ...
    /**
     * Create a TcaplusTable resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TcaplusTableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TcaplusTableArgs | TcaplusTableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TcaplusTableState | undefined;
            ...
            const args = argsOrState as TcaplusTableArgs | undefined;
        ...
        super(TcaplusTable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TcaplusTable resources.
 */
export interface TcaplusTableState {
    /**
     * ID of the TcaplusDB cluster to which the table belongs.
     */
...
/**
 * The set of arguments for constructing a TcaplusTable resource.
 */
export interface TcaplusTableArgs {
    /**
     * ID of the TcaplusDB cluster to which the table belongs.
     */
    clusterId: pulumi.Input<string>;
