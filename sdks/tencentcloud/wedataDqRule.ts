...
export class WedataDqRule extends pulumi.CustomResource {
    /**
     * Get an existing WedataDqRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WedataDqRuleState, opts?: pulumi.CustomResourceOptions): WedataDqRule {
        return new WedataDqRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wedataDqRule:WedataDqRule';

    /**
     * Returns true if the given object is an instance of WedataDqRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WedataDqRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WedataDqRule.__pulumiType;
    }
     ...
     */
    public readonly compareRule!: pulumi.Output<outputs.WedataDqRuleCompareRule>;
    /**
     ...
     */
    public readonly fieldConfig!: pulumi.Output<outputs.WedataDqRuleFieldConfig | undefined>;
    /**
     * Rule name.
     */
    ...
    /**
     * Create a WedataDqRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WedataDqRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WedataDqRuleArgs | WedataDqRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WedataDqRuleState | undefined;
            ...
            const args = argsOrState as WedataDqRuleArgs | undefined;
        ...
        super(WedataDqRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WedataDqRule resources.
 */
export interface WedataDqRuleState {
    /**
     * Alarm trigger levels 1. Low, 2. Medium, 3. High.
     */
     ...
     * Alarm trigger condition.
     */
    compareRule?: pulumi.Input<inputs.WedataDqRuleCompareRule>;
    /**
     * Condition scans WHERE condition expressions.
     */
     ...
     * Custom template sql expression field replacement parameters.
     */
    fieldConfig?: pulumi.Input<inputs.WedataDqRuleFieldConfig>;
    /**
     * Rule name.
     */
...
/**
 * The set of arguments for constructing a WedataDqRule resource.
 */
export interface WedataDqRuleArgs {
    /**
     * Alarm trigger levels 1. Low, 2. Medium, 3. High.
     */
    alarmLevel: pulumi.Input<number>;
