...
export class WafClbInstance extends pulumi.CustomResource {
    /**
     * Get an existing WafClbInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WafClbInstanceState, opts?: pulumi.CustomResourceOptions): WafClbInstance {
        return new WafClbInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/wafClbInstance:WafClbInstance';

    /**
     * Returns true if the given object is an instance of WafClbInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WafClbInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === WafClbInstance.__pulumiType;
    }
    ...
    /**
     * Create a WafClbInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WafClbInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: WafClbInstanceArgs | WafClbInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WafClbInstanceState | undefined;
            ...
            const args = argsOrState as WafClbInstanceArgs | undefined;
        ...
        super(WafClbInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering WafClbInstance resources.
 */
export interface WafClbInstanceState {
    /**
     * Whether to purchase API Security, 1: yes, 0: no. Default is 0.
     */
...
/**
 * The set of arguments for constructing a WafClbInstance resource.
 */
export interface WafClbInstanceArgs {
    /**
     * Whether to purchase API Security, 1: yes, 0: no. Default is 0.
     */
    apiSecurity?: pulumi.Input<number>;
