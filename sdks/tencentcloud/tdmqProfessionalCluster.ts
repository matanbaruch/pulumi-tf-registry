...
export class TdmqProfessionalCluster extends pulumi.CustomResource {
    /**
     * Get an existing TdmqProfessionalCluster resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TdmqProfessionalClusterState, opts?: pulumi.CustomResourceOptions): TdmqProfessionalCluster {
        return new TdmqProfessionalCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tdmqProfessionalCluster:TdmqProfessionalCluster';

    /**
     * Returns true if the given object is an instance of TdmqProfessionalCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TdmqProfessionalCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TdmqProfessionalCluster.__pulumiType;
    }
     ...
     */
    public readonly vpc!: pulumi.Output<outputs.TdmqProfessionalClusterVpc | undefined>;
    /**
    ...
    /**
     * Create a TdmqProfessionalCluster resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TdmqProfessionalClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TdmqProfessionalClusterArgs | TdmqProfessionalClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TdmqProfessionalClusterState | undefined;
            ...
            const args = argsOrState as TdmqProfessionalClusterArgs | undefined;
        ...
        super(TdmqProfessionalCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TdmqProfessionalCluster resources.
 */
export interface TdmqProfessionalClusterState {
    /**
     * Whether to turn on automatic monthly renewal. `1`: turn on, `0`: turn off.
     */
     ...
     * Label of VPC network.
     */
    vpc?: pulumi.Input<inputs.TdmqProfessionalClusterVpc>;
    /**
     * Multi-AZ deployment select three Availability Zones, like: [200002,200003,200004]. Single availability zone deployment
     * selects an availability zone, like [200002].
     */
...
/**
 * The set of arguments for constructing a TdmqProfessionalCluster resource.
 */
export interface TdmqProfessionalClusterArgs {
    /**
     * Whether to turn on automatic monthly renewal. `1`: turn on, `0`: turn off.
     */
    autoRenewFlag: pulumi.Input<number>;
