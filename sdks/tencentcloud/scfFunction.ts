...
export class ScfFunction extends pulumi.CustomResource {
    /**
     * Get an existing ScfFunction resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScfFunctionState, opts?: pulumi.CustomResourceOptions): ScfFunction {
        return new ScfFunction(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/scfFunction:ScfFunction';

    /**
     * Returns true if the given object is an instance of ScfFunction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ScfFunction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ScfFunction.__pulumiType;
    }
     ...
     */
    public readonly cfsConfigs!: pulumi.Output<outputs.ScfFunctionCfsConfig[] | undefined>;
    /**
     ...
     */
    public readonly imageConfigs!: pulumi.Output<outputs.ScfFunctionImageConfig[] | undefined>;
    /**
     ...
     */
    public readonly intranetConfig!: pulumi.Output<outputs.ScfFunctionIntranetConfig | undefined>;
    /**
     ...
     */
    public readonly layers!: pulumi.Output<outputs.ScfFunctionLayer[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly triggerInfos!: pulumi.Output<outputs.ScfFunctionTriggerInfo[]>;
    /**
     ...
     */
    public readonly triggers!: pulumi.Output<outputs.ScfFunctionTrigger[] | undefined>;
    /**
     * SCF function vip.
     */
    ...
    /**
     * Create a ScfFunction resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ScfFunctionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ScfFunctionArgs | ScfFunctionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ScfFunctionState | undefined;
            ...
            const args = argsOrState as ScfFunctionArgs | undefined;
        ...
        super(ScfFunction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ScfFunction resources.
 */
export interface ScfFunctionState {
    /**
     * Whether SCF function asynchronous attribute is enabled. `TRUE` is open, `FALSE` is close.
     */
     ...
     * List of CFS configurations.
     */
    cfsConfigs?: pulumi.Input<pulumi.Input<inputs.ScfFunctionCfsConfig>[]>;
    /**
     * cls logset id of the SCF function.
     */
     ...
     * Image of the SCF function, conflict with `cos_bucket_name`, `cos_object_name`, `cos_bucket_region`, `zip_file`.
     */
    imageConfigs?: pulumi.Input<pulumi.Input<inputs.ScfFunctionImageConfig>[]>;
    /**
     * Whether to automatically install dependencies.
     */
     ...
     * Intranet access configuration.
     */
    intranetConfig?: pulumi.Input<inputs.ScfFunctionIntranetConfig>;
    /**
     * Enable L5 for SCF function, default is `false`.
     */
     ...
     * The list of association layers.
     */
    layers?: pulumi.Input<pulumi.Input<inputs.ScfFunctionLayer>[]>;
    /**
     * Memory size of the SCF function, unit is MB. The default is `128`MB. The ladder is 128M.
     */
     ...
     * SCF trigger details list. Each element contains the following attributes:
     */
    triggerInfos?: pulumi.Input<pulumi.Input<inputs.ScfFunctionTriggerInfo>[]>;
    /**
     * Trigger list of the SCF function, note that if you modify the trigger list, all existing triggers will be deleted, and
     * then create triggers in the new list. Each element contains the following attributes:
     */
    triggers?: pulumi.Input<pulumi.Input<inputs.ScfFunctionTrigger>[]>;
    /**
     * SCF function vip.
     */
...
/**
 * The set of arguments for constructing a ScfFunction resource.
 */
export interface ScfFunctionArgs {
    /**
     * Whether SCF function asynchronous attribute is enabled. `TRUE` is open, `FALSE` is close.
     */
    asyncRunEnable?: pulumi.Input<string>;
