...
export class MpsAnimatedGraphicsTemplate extends pulumi.CustomResource {
    /**
     * Get an existing MpsAnimatedGraphicsTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MpsAnimatedGraphicsTemplateState, opts?: pulumi.CustomResourceOptions): MpsAnimatedGraphicsTemplate {
        return new MpsAnimatedGraphicsTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mpsAnimatedGraphicsTemplate:MpsAnimatedGraphicsTemplate';

    /**
     * Returns true if the given object is an instance of MpsAnimatedGraphicsTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MpsAnimatedGraphicsTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MpsAnimatedGraphicsTemplate.__pulumiType;
    }
    ...
    /**
     * Create a MpsAnimatedGraphicsTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MpsAnimatedGraphicsTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MpsAnimatedGraphicsTemplateArgs | MpsAnimatedGraphicsTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MpsAnimatedGraphicsTemplateState | undefined;
            ...
            const args = argsOrState as MpsAnimatedGraphicsTemplateArgs | undefined;
        ...
        super(MpsAnimatedGraphicsTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MpsAnimatedGraphicsTemplate resources.
 */
export interface MpsAnimatedGraphicsTemplateState {
    /**
     * Template description information, length limit: 256 characters.
     */
...
/**
 * The set of arguments for constructing a MpsAnimatedGraphicsTemplate resource.
 */
export interface MpsAnimatedGraphicsTemplateArgs {
    /**
     * Template description information, length limit: 256 characters.
     */
    comment?: pulumi.Input<string>;
