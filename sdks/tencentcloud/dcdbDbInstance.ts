...
export class DcdbDbInstance extends pulumi.CustomResource {
    /**
     * Get an existing DcdbDbInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DcdbDbInstanceState, opts?: pulumi.CustomResourceOptions): DcdbDbInstance {
        return new DcdbDbInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dcdbDbInstance:DcdbDbInstance';

    /**
     * Returns true if the given object is an instance of DcdbDbInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DcdbDbInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DcdbDbInstance.__pulumiType;
    }
     ...
     */
    public readonly initParams!: pulumi.Output<outputs.DcdbDbInstanceInitParam[] | undefined>;
    /**
     ...
     */
    public readonly resourceTags!: pulumi.Output<outputs.DcdbDbInstanceResourceTag[] | undefined>;
    /**
    ...
    /**
     * Create a DcdbDbInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DcdbDbInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DcdbDbInstanceArgs | DcdbDbInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DcdbDbInstanceState | undefined;
            ...
            const args = argsOrState as DcdbDbInstanceArgs | undefined;
        ...
        super(DcdbDbInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DcdbDbInstance resources.
 */
export interface DcdbDbInstanceState {
    /**
     * Automatic renewal flag, 0 means the default state (the user has not set it, that is, the initial state is manual
     * renewal, and the user has activated the prepaid non-stop privilege and will also perform automatic renewal). 1 means
     * automatic renewal, 2 means no automatic renewal (user setting). if the business has no concept of renewal or automatic
     ...
     * synchronous degenerate. The default is strong synchronous degenerate) .
     */
    initParams?: pulumi.Input<pulumi.Input<inputs.DcdbDbInstanceInitParam>[]>;
    /**
     * Instance name, you can set the name of the instance independently through this field.
     */
     ...
     * Array of tag key-value pairs.
     */
    resourceTags?: pulumi.Input<pulumi.Input<inputs.DcdbDbInstanceResourceTag>[]>;
    /**
     * Security group ids, the security group can be passed in the form of an array, compatible with the previous
     * SecurityGroupId parameter.
     */
...
/**
 * The set of arguments for constructing a DcdbDbInstance resource.
 */
export interface DcdbDbInstanceArgs {
    /**
     * Automatic renewal flag, 0 means the default state (the user has not set it, that is, the initial state is manual
     * renewal, and the user has activated the prepaid non-stop privilege and will also perform automatic renewal). 1 means
     * automatic renewal, 2 means no automatic renewal (user setting). if the business has no concept of renewal or automatic
