...
export class SslPayCertificate extends pulumi.CustomResource {
    /**
     * Get an existing SslPayCertificate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SslPayCertificateState, opts?: pulumi.CustomResourceOptions): SslPayCertificate {
        return new SslPayCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sslPayCertificate:SslPayCertificate';

    /**
     * Returns true if the given object is an instance of SslPayCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SslPayCertificate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SslPayCertificate.__pulumiType;
    }
     ...
     */
    public readonly dvAuths!: pulumi.Output<outputs.SslPayCertificateDvAuth[] | undefined>;
    /**
     * Certificate information.
     */
    public readonly information!: pulumi.Output<outputs.SslPayCertificateInformation>;
    /**
     * Order ID returned.
     */
    ...
    /**
     * Create a SslPayCertificate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SslPayCertificateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SslPayCertificateArgs | SslPayCertificateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SslPayCertificateState | undefined;
            ...
            const args = argsOrState as SslPayCertificateArgs | undefined;
        ...
        super(SslPayCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SslPayCertificate resources.
 */
export interface SslPayCertificateState {
    /**
     * Remark name.
     */
     ...
     * DV certification information.
     */
    dvAuths?: pulumi.Input<pulumi.Input<inputs.SslPayCertificateDvAuth>[]>;
    /**
     * Certificate information.
     */
    information?: pulumi.Input<inputs.SslPayCertificateInformation>;
    /**
     * Order ID returned.
     */
...
/**
 * The set of arguments for constructing a SslPayCertificate resource.
 */
export interface SslPayCertificateArgs {
    /**
     * Remark name.
     */
    alias?: pulumi.Input<string>;
