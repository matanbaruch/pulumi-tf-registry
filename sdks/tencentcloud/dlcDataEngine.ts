...
export class DlcDataEngine extends pulumi.CustomResource {
    /**
     * Get an existing DlcDataEngine resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DlcDataEngineState, opts?: pulumi.CustomResourceOptions): DlcDataEngine {
        return new DlcDataEngine(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dlcDataEngine:DlcDataEngine';

    /**
     * Returns true if the given object is an instance of DlcDataEngine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DlcDataEngine {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DlcDataEngine.__pulumiType;
    }
     ...
     */
    public readonly crontabResumeSuspendStrategy!: pulumi.Output<outputs.DlcDataEngineCrontabResumeSuspendStrategy | undefined>;
    /**
     * Cluster advanced configuration.
     */
    public readonly dataEngineConfigPairs!: pulumi.Output<outputs.DlcDataEngineDataEngineConfigPair[] | undefined>;
    /**
     * Engine name.
     */
     ...
     */
    public readonly sessionResourceTemplate!: pulumi.Output<outputs.DlcDataEngineSessionResourceTemplate | undefined>;
    /**
    ...
    /**
     * Create a DlcDataEngine resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DlcDataEngineArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DlcDataEngineArgs | DlcDataEngineState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DlcDataEngineState | undefined;
            ...
            const args = argsOrState as DlcDataEngineArgs | undefined;
        ...
        super(DlcDataEngine.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DlcDataEngine resources.
 */
export interface DlcDataEngineState {
    /**
     * Engine auto renew, only support 0: Default, 1: AutoRenewON, 2: AutoRenewOFF.
     */
     ...
     * Engine auto suspend strategy, when AutoSuspend is true, CrontabResumeSuspend must stop.
     */
    crontabResumeSuspendStrategy?: pulumi.Input<inputs.DlcDataEngineCrontabResumeSuspendStrategy>;
    /**
     * Cluster advanced configuration.
     */
    dataEngineConfigPairs?: pulumi.Input<pulumi.Input<inputs.DlcDataEngineDataEngineConfigPair>[]>;
    /**
     * Engine name.
     */
     ...
     * For spark Batch ExecType, cluster session resource configuration template.
     */
    sessionResourceTemplate?: pulumi.Input<inputs.DlcDataEngineSessionResourceTemplate>;
    /**
     * Cluster size. Required when updating.
     */
...
/**
 * The set of arguments for constructing a DlcDataEngine resource.
 */
export interface DlcDataEngineArgs {
    /**
     * Engine auto renew, only support 0: Default, 1: AutoRenewON, 2: AutoRenewOFF.
     */
    autoRenew?: pulumi.Input<number>;
