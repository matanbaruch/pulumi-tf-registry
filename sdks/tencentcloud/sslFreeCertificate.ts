...
export class SslFreeCertificate extends pulumi.CustomResource {
    /**
     * Get an existing SslFreeCertificate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SslFreeCertificateState, opts?: pulumi.CustomResourceOptions): SslFreeCertificate {
        return new SslFreeCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sslFreeCertificate:SslFreeCertificate';

    /**
     * Returns true if the given object is an instance of SslFreeCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SslFreeCertificate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SslFreeCertificate.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly dvAuths!: pulumi.Output<outputs.SslFreeCertificateDvAuth[]>;
    /**
    ...
    /**
     * Create a SslFreeCertificate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SslFreeCertificateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SslFreeCertificateArgs | SslFreeCertificateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SslFreeCertificateState | undefined;
            ...
            const args = argsOrState as SslFreeCertificateArgs | undefined;
        ...
        super(SslFreeCertificate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SslFreeCertificate resources.
 */
export interface SslFreeCertificateState {
    /**
     * Specify alias for remark.
     */
     ...
     * DV certification information.
     */
    dvAuths?: pulumi.Input<pulumi.Input<inputs.SslFreeCertificateDvAuth>[]>;
    /**
     * Certificate insert time.
     */
...
/**
 * The set of arguments for constructing a SslFreeCertificate resource.
 */
export interface SslFreeCertificateArgs {
    /**
     * Specify alias for remark.
     */
    alias?: pulumi.Input<string>;
