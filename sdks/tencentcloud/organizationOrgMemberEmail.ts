...
export class OrganizationOrgMemberEmail extends pulumi.CustomResource {
    /**
     * Get an existing OrganizationOrgMemberEmail resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrganizationOrgMemberEmailState, opts?: pulumi.CustomResourceOptions): OrganizationOrgMemberEmail {
        return new OrganizationOrgMemberEmail(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/organizationOrgMemberEmail:OrganizationOrgMemberEmail';

    /**
     * Returns true if the given object is an instance of OrganizationOrgMemberEmail.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrganizationOrgMemberEmail {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OrganizationOrgMemberEmail.__pulumiType;
    }
    ...
    /**
     * Create a OrganizationOrgMemberEmail resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OrganizationOrgMemberEmailArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OrganizationOrgMemberEmailArgs | OrganizationOrgMemberEmailState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OrganizationOrgMemberEmailState | undefined;
            ...
            const args = argsOrState as OrganizationOrgMemberEmailArgs | undefined;
        ...
        super(OrganizationOrgMemberEmail.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OrganizationOrgMemberEmail resources.
 */
export interface OrganizationOrgMemberEmailState {
    /**
     * Application timeNote: This field may return NULL, indicating that the valid value cannot be obtained.
     */
...
/**
 * The set of arguments for constructing a OrganizationOrgMemberEmail resource.
 */
export interface OrganizationOrgMemberEmailArgs {
    /**
     * International region.
     */
    countryCode: pulumi.Input<string>;
