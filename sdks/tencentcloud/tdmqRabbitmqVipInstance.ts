...
export class TdmqRabbitmqVipInstance extends pulumi.CustomResource {
    /**
     * Get an existing TdmqRabbitmqVipInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TdmqRabbitmqVipInstanceState, opts?: pulumi.CustomResourceOptions): TdmqRabbitmqVipInstance {
        return new TdmqRabbitmqVipInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tdmqRabbitmqVipInstance:TdmqRabbitmqVipInstance';

    /**
     * Returns true if the given object is an instance of TdmqRabbitmqVipInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TdmqRabbitmqVipInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TdmqRabbitmqVipInstance.__pulumiType;
    }
    ...
    /**
     * Create a TdmqRabbitmqVipInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TdmqRabbitmqVipInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TdmqRabbitmqVipInstanceArgs | TdmqRabbitmqVipInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TdmqRabbitmqVipInstanceState | undefined;
            ...
            const args = argsOrState as TdmqRabbitmqVipInstanceArgs | undefined;
        ...
        super(TdmqRabbitmqVipInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TdmqRabbitmqVipInstance resources.
 */
export interface TdmqRabbitmqVipInstanceState {
    /**
     * Automatic renewal, the default is true.
     */
...
/**
 * The set of arguments for constructing a TdmqRabbitmqVipInstance resource.
 */
export interface TdmqRabbitmqVipInstanceArgs {
    /**
     * Automatic renewal, the default is true.
     */
    autoRenewFlag?: pulumi.Input<boolean>;
