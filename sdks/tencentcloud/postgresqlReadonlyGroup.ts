...
export class PostgresqlReadonlyGroup extends pulumi.CustomResource {
    /**
     * Get an existing PostgresqlReadonlyGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostgresqlReadonlyGroupState, opts?: pulumi.CustomResourceOptions): PostgresqlReadonlyGroup {
        return new PostgresqlReadonlyGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/postgresqlReadonlyGroup:PostgresqlReadonlyGroup';

    /**
     * Returns true if the given object is an instance of PostgresqlReadonlyGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PostgresqlReadonlyGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PostgresqlReadonlyGroup.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly netInfoLists!: pulumi.Output<outputs.PostgresqlReadonlyGroupNetInfoList[]>;
    /**
     * Project ID.
     */
    ...
    /**
     * Create a PostgresqlReadonlyGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PostgresqlReadonlyGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PostgresqlReadonlyGroupArgs | PostgresqlReadonlyGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PostgresqlReadonlyGroupState | undefined;
            ...
            const args = argsOrState as PostgresqlReadonlyGroupArgs | undefined;
        ...
        super(PostgresqlReadonlyGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PostgresqlReadonlyGroup resources.
 */
export interface PostgresqlReadonlyGroupState {
    /**
     * Create time of the postgresql instance.
     */
     ...
     * List of db instance net info.
     */
    netInfoLists?: pulumi.Input<pulumi.Input<inputs.PostgresqlReadonlyGroupNetInfoList>[]>;
    /**
     * Project ID.
     */
...
/**
 * The set of arguments for constructing a PostgresqlReadonlyGroup resource.
 */
export interface PostgresqlReadonlyGroupArgs {
    /**
     * Primary instance ID.
     */
    masterDbInstanceId: pulumi.Input<string>;
