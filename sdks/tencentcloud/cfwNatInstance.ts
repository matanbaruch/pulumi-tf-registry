...
export class CfwNatInstance extends pulumi.CustomResource {
    /**
     * Get an existing CfwNatInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CfwNatInstanceState, opts?: pulumi.CustomResourceOptions): CfwNatInstance {
        return new CfwNatInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cfwNatInstance:CfwNatInstance';

    /**
     * Returns true if the given object is an instance of CfwNatInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CfwNatInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CfwNatInstance.__pulumiType;
    }
     ...
     */
    public readonly newModeItems!: pulumi.Output<outputs.CfwNatInstanceNewModeItems | undefined>;
    /**
     * Bandwidth.
     */
    ...
    /**
     * Create a CfwNatInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CfwNatInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CfwNatInstanceArgs | CfwNatInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CfwNatInstanceState | undefined;
            ...
            const args = argsOrState as CfwNatInstanceArgs | undefined;
        ...
        super(CfwNatInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CfwNatInstance resources.
 */
export interface CfwNatInstanceState {
    /**
     * Off-site disaster recovery 1: use off-site disaster recovery; 0: do not use off-site disaster recovery; if empty, the
     * default is not to use off-site disaster recovery.
     */
     ...
     * New mode passing parameters are added, at least one of new_mode_items and nat_gw_list is passed.
     */
    newModeItems?: pulumi.Input<inputs.CfwNatInstanceNewModeItems>;
    /**
     * Bandwidth.
     */
...
/**
 * The set of arguments for constructing a CfwNatInstance resource.
 */
export interface CfwNatInstanceArgs {
    /**
     * Off-site disaster recovery 1: use off-site disaster recovery; 0: do not use off-site disaster recovery; if empty, the
     * default is not to use off-site disaster recovery.
     */
