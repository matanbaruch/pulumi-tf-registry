...
export class PtsFile extends pulumi.CustomResource {
    /**
     * Get an existing PtsFile resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PtsFileState, opts?: pulumi.CustomResourceOptions): PtsFile {
        return new PtsFile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ptsFile:PtsFile';

    /**
     * Returns true if the given object is an instance of PtsFile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PtsFile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PtsFile.__pulumiType;
    }
     ...
     * Files in a folder.
     */
    public readonly fileInfos!: pulumi.Output<outputs.PtsFileFileInfo[] | undefined>;
    /**
    ...
    /**
     * Create a PtsFile resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PtsFileArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PtsFileArgs | PtsFileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PtsFileState | undefined;
            ...
            const args = argsOrState as PtsFileArgs | undefined;
        ...
        super(PtsFile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PtsFile resources.
 */
export interface PtsFileState {
    /**
     * File id.
     */
     ...
     * Files in a folder.
     */
    fileInfos?: pulumi.Input<pulumi.Input<inputs.PtsFileFileInfo>[]>;
    /**
     * The first few lines of data.
     */
...
/**
 * The set of arguments for constructing a PtsFile resource.
 */
export interface PtsFileArgs {
    /**
     * File id.
     */
    fileId: pulumi.Input<string>;
