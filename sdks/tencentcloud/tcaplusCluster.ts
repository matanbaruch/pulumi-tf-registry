...
export class TcaplusCluster extends pulumi.CustomResource {
    /**
     * Get an existing TcaplusCluster resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TcaplusClusterState, opts?: pulumi.CustomResourceOptions): TcaplusCluster {
        return new TcaplusCluster(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tcaplusCluster:TcaplusCluster';

    /**
     * Returns true if the given object is an instance of TcaplusCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TcaplusCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TcaplusCluster.__pulumiType;
    }
    ...
    /**
     * Create a TcaplusCluster resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TcaplusClusterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TcaplusClusterArgs | TcaplusClusterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TcaplusClusterState | undefined;
            ...
            const args = argsOrState as TcaplusClusterArgs | undefined;
        ...
        super(TcaplusCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TcaplusCluster resources.
 */
export interface TcaplusClusterState {
    /**
     * Access ID of the TcaplusDB cluster.For TcaplusDB SDK connect.
     */
...
/**
 * The set of arguments for constructing a TcaplusCluster resource.
 */
export interface TcaplusClusterArgs {
    /**
     * Name of the TcaplusDB cluster. Name length should be between 1 and 30.
     */
    clusterName: pulumi.Input<string>;
