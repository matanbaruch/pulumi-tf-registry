...
export class ElasticsearchInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/elasticsearchInstance:ElasticsearchInstance';
     ...
     */
    public readonly esAcl!: pulumi.Output<outputs.ElasticsearchInstanceEsAcl | undefined>;
    /**
     ...
     */
    public readonly multiZoneInfos!: pulumi.Output<outputs.ElasticsearchInstanceMultiZoneInfo[] | undefined>;
    /**
     ...
     */
    public readonly nodeInfoLists!: pulumi.Output<outputs.ElasticsearchInstanceNodeInfoList[]>;
    /**
     ...
     */
    public readonly webNodeTypeInfos!: pulumi.Output<outputs.ElasticsearchInstanceWebNodeTypeInfo[] | undefined>;
...
export interface ElasticsearchInstanceState {
     ...
     * Kibana Access Control Configuration.
     */
    esAcl?: pulumi.Input<inputs.ElasticsearchInstanceEsAcl>;
    /**
     * Name of the instance, which can contain 1 to 50 English letters, Chinese characters, digits, dashes(-), or
     * underscores(_).
     */
     ...
     * Details of AZs in multi-AZ deployment mode (which is required when deploy_mode is `1`).
     */
    multiZoneInfos?: pulumi.Input<pulumi.Input<inputs.ElasticsearchInstanceMultiZoneInfo>[]>;
    /**
     * Node information list, which is used to describe the specification information of various types of nodes in the cluster,
     * such as node type, node quantity, node specification, disk type, and disk size.
     */
    nodeInfoLists?: pulumi.Input<pulumi.Input<inputs.ElasticsearchInstanceNodeInfoList>[]>;
    /**
     * Password to an instance, the password needs to be 8 to 16 characters, including at least two items ([a-z,A-Z], [0-9] and
     * [-!@#$%&^*+=_:;,.?] special symbols.
     */
     ...
     * Visual node configuration.
     */
    webNodeTypeInfos?: pulumi.Input<pulumi.Input<inputs.ElasticsearchInstanceWebNodeTypeInfo>[]>;
}
