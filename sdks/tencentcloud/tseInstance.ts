...
export class TseInstance extends pulumi.CustomResource {
    /**
     * Get an existing TseInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TseInstanceState, opts?: pulumi.CustomResourceOptions): TseInstance {
        return new TseInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tseInstance:TseInstance';

    /**
     * Returns true if the given object is an instance of TseInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TseInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TseInstance.__pulumiType;
    }
     ...
     */
    public readonly engineRegionInfos!: pulumi.Output<outputs.TseInstanceEngineRegionInfo[] | undefined>;
    /**
    ...
    /**
     * Create a TseInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TseInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TseInstanceArgs | TseInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TseInstanceState | undefined;
            ...
            const args = argsOrState as TseInstanceArgs | undefined;
        ...
        super(TseInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TseInstance resources.
 */
export interface TseInstanceState {
    /**
     * Client public network access, `true`: on, `false`: off, default: false.
     */
     ...
     * the use of the EngineRegionInfos parameter.
     */
    engineRegionInfos?: pulumi.Input<pulumi.Input<inputs.TseInstanceEngineRegionInfo>[]>;
    /**
     * engine spec ID. see EngineProductVersion.
     */
...
/**
 * The set of arguments for constructing a TseInstance resource.
 */
export interface TseInstanceArgs {
    /**
     * Client public network access, `true`: on, `false`: off, default: false.
     */
    enableClientInternetAccess?: pulumi.Input<boolean>;
