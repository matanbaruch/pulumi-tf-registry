...
export class ScfInvokeFunction extends pulumi.CustomResource {
    /**
     * Get an existing ScfInvokeFunction resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScfInvokeFunctionState, opts?: pulumi.CustomResourceOptions): ScfInvokeFunction {
        return new ScfInvokeFunction(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/scfInvokeFunction:ScfInvokeFunction';

    /**
     * Returns true if the given object is an instance of ScfInvokeFunction.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ScfInvokeFunction {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ScfInvokeFunction.__pulumiType;
    }
    ...
    /**
     * Create a ScfInvokeFunction resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ScfInvokeFunctionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ScfInvokeFunctionArgs | ScfInvokeFunctionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ScfInvokeFunctionState | undefined;
            ...
            const args = argsOrState as ScfInvokeFunctionArgs | undefined;
        ...
        super(ScfInvokeFunction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ScfInvokeFunction resources.
 */
export interface ScfInvokeFunctionState {
    /**
     * Function running parameter, which is in the JSON format. The maximum parameter size is 6 MB for synchronized invocations
     * and 128KB for asynchronized invocations. This field corresponds to event input parameter.
     */
...
/**
 * The set of arguments for constructing a ScfInvokeFunction resource.
 */
export interface ScfInvokeFunctionArgs {
    /**
     * Function running parameter, which is in the JSON format. The maximum parameter size is 6 MB for synchronized invocations
     * and 128KB for asynchronized invocations. This field corresponds to event input parameter.
     */
