...
export class GaapLayer7Listener extends pulumi.CustomResource {
    /**
     * Get an existing GaapLayer7Listener resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GaapLayer7ListenerState, opts?: pulumi.CustomResourceOptions): GaapLayer7Listener {
        return new GaapLayer7Listener(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/gaapLayer7Listener:GaapLayer7Listener';

    /**
     * Returns true if the given object is an instance of GaapLayer7Listener.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GaapLayer7Listener {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GaapLayer7Listener.__pulumiType;
    }
    ...
    /**
     * Create a GaapLayer7Listener resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GaapLayer7ListenerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GaapLayer7ListenerArgs | GaapLayer7ListenerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GaapLayer7ListenerState | undefined;
            ...
            const args = argsOrState as GaapLayer7ListenerArgs | undefined;
        ...
        super(GaapLayer7Listener.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering GaapLayer7Listener resources.
 */
export interface GaapLayer7ListenerState {
    /**
     * Authentication type of the layer7 listener. `0` is one-way authentication and `1` is mutual authentication. NOTES: Only
     * supports listeners of `HTTPS` protocol.
     */
...
/**
 * The set of arguments for constructing a GaapLayer7Listener resource.
 */
export interface GaapLayer7ListenerArgs {
    /**
     * Authentication type of the layer7 listener. `0` is one-way authentication and `1` is mutual authentication. NOTES: Only
     * supports listeners of `HTTPS` protocol.
     */
