...
export class MysqlInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mysqlInstance:MysqlInstance';
    ...
    constructor(name: string, argsOrState?: MysqlInstanceArgs | MysqlInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MysqlInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
