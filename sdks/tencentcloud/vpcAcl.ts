...
export class VpcAcl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vpcAcl:VpcAcl';
    ...
    constructor(name: string, argsOrState?: VpcAclArgs | VpcAclState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VpcAcl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
