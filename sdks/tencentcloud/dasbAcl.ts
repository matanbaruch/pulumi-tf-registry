...
export class DasbAcl extends pulumi.CustomResource {
    /**
     * Get an existing DasbAcl resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DasbAclState, opts?: pulumi.CustomResourceOptions): DasbAcl {
        return new DasbAcl(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/dasbAcl:DasbAcl';

    /**
     * Returns true if the given object is an instance of DasbAcl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DasbAcl {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DasbAcl.__pulumiType;
    }
    ...
    /**
     * Create a DasbAcl resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DasbAclArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DasbAclArgs | DasbAclState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DasbAclState | undefined;
            ...
            const args = argsOrState as DasbAclArgs | undefined;
        ...
        super(DasbAcl.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering DasbAcl resources.
 */
export interface DasbAclState {
    /**
     * Associate high-risk DB template IDs.
     */
...
/**
 * The set of arguments for constructing a DasbAcl resource.
 */
export interface DasbAclArgs {
    /**
     * Associate high-risk DB template IDs.
     */
    acTemplateIdSets?: pulumi.Input<pulumi.Input<string>[]>;
