...
export class ApiGatewayCustomDomain extends pulumi.CustomResource {
    /**
     * Get an existing ApiGatewayCustomDomain resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiGatewayCustomDomainState, opts?: pulumi.CustomResourceOptions): ApiGatewayCustomDomain {
        return new ApiGatewayCustomDomain(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/apiGatewayCustomDomain:ApiGatewayCustomDomain';

    /**
     * Returns true if the given object is an instance of ApiGatewayCustomDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApiGatewayCustomDomain {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApiGatewayCustomDomain.__pulumiType;
    }
    ...
    /**
     * Create a ApiGatewayCustomDomain resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ApiGatewayCustomDomainArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApiGatewayCustomDomainArgs | ApiGatewayCustomDomainState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApiGatewayCustomDomainState | undefined;
            ...
            const args = argsOrState as ApiGatewayCustomDomainArgs | undefined;
        ...
        super(ApiGatewayCustomDomain.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ApiGatewayCustomDomain resources.
 */
export interface ApiGatewayCustomDomainState {
    /**
     * Unique certificate ID of the custom domain name to be bound. You can choose to upload for the `protocol` attribute value
     * `https` or `http&https`.
     */
...
/**
 * The set of arguments for constructing a ApiGatewayCustomDomain resource.
 */
export interface ApiGatewayCustomDomainArgs {
    /**
     * Unique certificate ID of the custom domain name to be bound. You can choose to upload for the `protocol` attribute value
     * `https` or `http&https`.
     */
