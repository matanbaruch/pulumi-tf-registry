...
export class TsfConfigTemplate extends pulumi.CustomResource {
    /**
     * Get an existing TsfConfigTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfConfigTemplateState, opts?: pulumi.CustomResourceOptions): TsfConfigTemplate {
        return new TsfConfigTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfConfigTemplate:TsfConfigTemplate';

    /**
     * Returns true if the given object is an instance of TsfConfigTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfConfigTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfConfigTemplate.__pulumiType;
    }
    ...
    /**
     * Create a TsfConfigTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfConfigTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfConfigTemplateArgs | TsfConfigTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfConfigTemplateState | undefined;
            ...
            const args = argsOrState as TsfConfigTemplateArgs | undefined;
        ...
        super(TsfConfigTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfConfigTemplate resources.
 */
export interface TsfConfigTemplateState {
    /**
     * Configuration template description.
     */
...
/**
 * The set of arguments for constructing a TsfConfigTemplate resource.
 */
export interface TsfConfigTemplateArgs {
    /**
     * Configuration template description.
     */
    configTemplateDesc?: pulumi.Input<string>;
