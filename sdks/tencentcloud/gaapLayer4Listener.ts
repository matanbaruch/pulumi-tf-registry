...
export class GaapLayer4Listener extends pulumi.CustomResource {
    /**
     * Get an existing GaapLayer4Listener resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GaapLayer4ListenerState, opts?: pulumi.CustomResourceOptions): GaapLayer4Listener {
        return new GaapLayer4Listener(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/gaapLayer4Listener:GaapLayer4Listener';

    /**
     * Returns true if the given object is an instance of GaapLayer4Listener.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GaapLayer4Listener {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GaapLayer4Listener.__pulumiType;
    }
     ...
     */
    public readonly realserverBindSets!: pulumi.Output<outputs.GaapLayer4ListenerRealserverBindSet[] | undefined>;
    /**
    ...
    /**
     * Create a GaapLayer4Listener resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GaapLayer4ListenerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GaapLayer4ListenerArgs | GaapLayer4ListenerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GaapLayer4ListenerState | undefined;
            ...
            const args = argsOrState as GaapLayer4ListenerArgs | undefined;
        ...
        super(GaapLayer4Listener.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering GaapLayer4Listener resources.
 */
export interface GaapLayer4ListenerState {
    /**
     * The way the listener gets the client IP, 0 for TOA, 1 for Proxy Protocol, default value is 0. NOTES: Only supports
     * listeners of `TCP` protocol.
     */
     ...
     * An information list of GAAP realserver.
     */
    realserverBindSets?: pulumi.Input<pulumi.Input<inputs.GaapLayer4ListenerRealserverBindSet>[]>;
    /**
     * Type of the realserver. Valid value: `IP` and `DOMAIN`. NOTES: when the `protocol` is specified as `TCP` and the
     * `scheduler` is specified as `wrr`, the item can only be set to `IP`.
     */
...
/**
 * The set of arguments for constructing a GaapLayer4Listener resource.
 */
export interface GaapLayer4ListenerArgs {
    /**
     * The way the listener gets the client IP, 0 for TOA, 1 for Proxy Protocol, default value is 0. NOTES: Only supports
     * listeners of `TCP` protocol.
     */
