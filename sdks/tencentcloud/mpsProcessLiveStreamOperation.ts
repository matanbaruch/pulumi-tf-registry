...
export class MpsProcessLiveStreamOperation extends pulumi.CustomResource {
    /**
     * Get an existing MpsProcessLiveStreamOperation resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MpsProcessLiveStreamOperationState, opts?: pulumi.CustomResourceOptions): MpsProcessLiveStreamOperation {
        return new MpsProcessLiveStreamOperation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mpsProcessLiveStreamOperation:MpsProcessLiveStreamOperation';

    /**
     * Returns true if the given object is an instance of MpsProcessLiveStreamOperation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MpsProcessLiveStreamOperation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MpsProcessLiveStreamOperation.__pulumiType;
    }

    /**
     * AI video intelligent analysis input parameter types.
     */
    public readonly aiAnalysisTask!: pulumi.Output<outputs.MpsProcessLiveStreamOperationAiAnalysisTask | undefined>;
    /**
     * Type parameter of a video content audit task.
     */
    public readonly aiContentReviewTask!: pulumi.Output<outputs.MpsProcessLiveStreamOperationAiContentReviewTask | undefined>;
    /**
     * The parameters for a video quality control task.
     */
    public readonly aiQualityControlTask!: pulumi.Output<outputs.MpsProcessLiveStreamOperationAiQualityControlTask | undefined>;
    /**
     * Type parameter of video content recognition task.
     */
    public readonly aiRecognitionTask!: pulumi.Output<outputs.MpsProcessLiveStreamOperationAiRecognitionTask | undefined>;
    /**
     ...
     */
    public readonly outputStorage!: pulumi.Output<outputs.MpsProcessLiveStreamOperationOutputStorage | undefined>;
    /**
     ...
     */
    public readonly taskNotifyConfig!: pulumi.Output<outputs.MpsProcessLiveStreamOperationTaskNotifyConfig>;
    /**
    ...
    /**
     * Create a MpsProcessLiveStreamOperation resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MpsProcessLiveStreamOperationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MpsProcessLiveStreamOperationArgs | MpsProcessLiveStreamOperationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MpsProcessLiveStreamOperationState | undefined;
            ...
            const args = argsOrState as MpsProcessLiveStreamOperationArgs | undefined;
        ...
        super(MpsProcessLiveStreamOperation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MpsProcessLiveStreamOperation resources.
 */
export interface MpsProcessLiveStreamOperationState {
    /**
     * AI video intelligent analysis input parameter types.
     */
    aiAnalysisTask?: pulumi.Input<inputs.MpsProcessLiveStreamOperationAiAnalysisTask>;
    /**
     * Type parameter of a video content audit task.
     */
    aiContentReviewTask?: pulumi.Input<inputs.MpsProcessLiveStreamOperationAiContentReviewTask>;
    /**
     * The parameters for a video quality control task.
     */
    aiQualityControlTask?: pulumi.Input<inputs.MpsProcessLiveStreamOperationAiQualityControlTask>;
    /**
     * Type parameter of video content recognition task.
     */
    aiRecognitionTask?: pulumi.Input<inputs.MpsProcessLiveStreamOperationAiRecognitionTask>;
    /**
     * Target directory of a live stream processing output file, such as `/movie/201909/`. If this parameter is left empty, the
     * `/` directory will be used.
     */
     ...
     * Target bucket of a live stream processing output file. This parameter is required if a file will be output.
     */
    outputStorage?: pulumi.Input<inputs.MpsProcessLiveStreamOperationOutputStorage>;
    /**
     * The scheme ID.Note 1: About `OutputStorage` and `OutputDir`:If an output storage and directory are specified for a
     * subtask of the scheme, those output settings will be applied.If an output storage and directory are not specified for
     * the subtasks of a scheme, the output parameters passed in the `ProcessMedia` API will be applied.Note 2: If
     ...
     * Event notification information of a task, which is used to specify the live stream processing result.
     */
    taskNotifyConfig?: pulumi.Input<inputs.MpsProcessLiveStreamOperationTaskNotifyConfig>;
    /**
     * Live stream URL, which must be a live stream file address. RTMP, HLS, and FLV are supported.
     */
...
/**
 * The set of arguments for constructing a MpsProcessLiveStreamOperation resource.
 */
export interface MpsProcessLiveStreamOperationArgs {
    /**
     * AI video intelligent analysis input parameter types.
     */
    aiAnalysisTask?: pulumi.Input<inputs.MpsProcessLiveStreamOperationAiAnalysisTask>;
