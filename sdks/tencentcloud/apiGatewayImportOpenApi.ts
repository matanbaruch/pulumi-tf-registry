...
export class ApiGatewayImportOpenApi extends pulumi.CustomResource {
    /**
     * Get an existing ApiGatewayImportOpenApi resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiGatewayImportOpenApiState, opts?: pulumi.CustomResourceOptions): ApiGatewayImportOpenApi {
        return new ApiGatewayImportOpenApi(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/apiGatewayImportOpenApi:ApiGatewayImportOpenApi';

    /**
     * Returns true if the given object is an instance of ApiGatewayImportOpenApi.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApiGatewayImportOpenApi {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApiGatewayImportOpenApi.__pulumiType;
    }
     ...
     * Constant parameter.
     */
    public /*out*/ readonly constantParameters!: pulumi.Output<outputs.ApiGatewayImportOpenApiConstantParameter[]>;
    /**
     ...
     */
    public /*out*/ readonly microServices!: pulumi.Output<outputs.ApiGatewayImportOpenApiMicroService[]>;
    /**
     * OAuth configuration. Effective when AuthType is OAUTH.
     */
    public /*out*/ readonly oauthConfigs!: pulumi.Output<outputs.ApiGatewayImportOpenApiOauthConfig[]>;
    /**
     ...
     */
    public /*out*/ readonly requestParameters!: pulumi.Output<outputs.ApiGatewayImportOpenApiRequestParameter[]>;
    /**
     * Custom error code configuration. Must keep at least one after set.
     */
    public /*out*/ readonly responseErrorCodes!: pulumi.Output<outputs.ApiGatewayImportOpenApiResponseErrorCode[]>;
    /**
     ...
     */
    public /*out*/ readonly serviceConfigCosConfigs!: pulumi.Output<outputs.ApiGatewayImportOpenApiServiceConfigCosConfig[]>;
    /**
     ...
     */
    public /*out*/ readonly serviceParameters!: pulumi.Output<outputs.ApiGatewayImportOpenApiServiceParameter[]>;
    /**
     * Health check configuration for microservices.
     */
    public /*out*/ readonly serviceTsfHealthCheckConfs!: pulumi.Output<outputs.ApiGatewayImportOpenApiServiceTsfHealthCheckConf[]>;
    /**
     * Load balancing configuration for microservices.
     */
    public /*out*/ readonly serviceTsfLoadBalanceConfs!: pulumi.Output<outputs.ApiGatewayImportOpenApiServiceTsfLoadBalanceConf[]>;
    /**
    ...
    /**
     * Create a ApiGatewayImportOpenApi resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ApiGatewayImportOpenApiArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApiGatewayImportOpenApiArgs | ApiGatewayImportOpenApiState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApiGatewayImportOpenApiState | undefined;
            ...
            const args = argsOrState as ApiGatewayImportOpenApiArgs | undefined;
        ...
        super(ApiGatewayImportOpenApi.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ApiGatewayImportOpenApi resources.
 */
export interface ApiGatewayImportOpenApiState {
    /**
     * When `auth_type` is OAUTH, this field is valid, NORMAL: Business API, OAUTH: Authorization API.
     */
     ...
     * Constant parameter.
     */
    constantParameters?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiConstantParameter>[]>;
    /**
     * OpenAPI body content.
     */
     ...
     * API bound microservice list.
     */
    microServices?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiMicroService>[]>;
    /**
     * OAuth configuration. Effective when AuthType is OAUTH.
     */
    oauthConfigs?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiOauthConfig>[]>;
    /**
     * API frontend request type. Valid values: `HTTP`, `WEBSOCKET`. Default value: `HTTP`.
     */
     ...
     * Frontend request parameters.
     */
    requestParameters?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiRequestParameter>[]>;
    /**
     * Custom error code configuration. Must keep at least one after set.
     */
    responseErrorCodes?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiResponseErrorCode>[]>;
    /**
     * Response failure sample of custom response configuration.
     */
     ...
     * null, indicating that a valid value cannot be obtained.
     */
    serviceConfigCosConfigs?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiServiceConfigCosConfig>[]>;
    /**
     * API backend service request method, such as `GET`. If `service_config_type` is `HTTP`, this parameter will be required.
     * The frontend `request_config_method` and backend method `service_config_method` can be different.
     */
     ...
     * The backend service parameters of the API.
     */
    serviceParameters?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiServiceParameter>[]>;
    /**
     * Health check configuration for microservices.
     */
    serviceTsfHealthCheckConfs?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiServiceTsfHealthCheckConf>[]>;
    /**
     * Load balancing configuration for microservices.
     */
    serviceTsfLoadBalanceConfs?: pulumi.Input<pulumi.Input<inputs.ApiGatewayImportOpenApiServiceTsfLoadBalanceConf>[]>;
    /**
     * Last modified time in the format of YYYY-MM-DDThh:mm:ssZ according to ISO 8601 standard. UTC time is used.
     */
...
/**
 * The set of arguments for constructing a ApiGatewayImportOpenApi resource.
 */
export interface ApiGatewayImportOpenApiArgs {
    /**
     * OpenAPI body content.
     */
    content: pulumi.Input<string>;
