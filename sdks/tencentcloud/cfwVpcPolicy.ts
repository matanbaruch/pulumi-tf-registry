...
export class CfwVpcPolicy extends pulumi.CustomResource {
    /**
     * Get an existing CfwVpcPolicy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CfwVpcPolicyState, opts?: pulumi.CustomResourceOptions): CfwVpcPolicy {
        return new CfwVpcPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cfwVpcPolicy:CfwVpcPolicy';

    /**
     * Returns true if the given object is an instance of CfwVpcPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CfwVpcPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CfwVpcPolicy.__pulumiType;
    }

    /**
     * Beta mission details. Note: This field may return null, indicating that no valid value can be obtained.
     */
    public /*out*/ readonly betaLists!: pulumi.Output<outputs.CfwVpcPolicyBetaList[]>;
    /**
     * Describe.
     */
    ...
    /**
     * Create a CfwVpcPolicy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CfwVpcPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CfwVpcPolicyArgs | CfwVpcPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CfwVpcPolicyState | undefined;
            ...
            const args = argsOrState as CfwVpcPolicyArgs | undefined;
        ...
        super(CfwVpcPolicy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CfwVpcPolicy resources.
 */
export interface CfwVpcPolicyState {
    /**
     * Beta mission details. Note: This field may return null, indicating that no valid value can be obtained.
     */
    betaLists?: pulumi.Input<pulumi.Input<inputs.CfwVpcPolicyBetaList>[]>;
    /**
     * Describe.
     */
...
/**
 * The set of arguments for constructing a CfwVpcPolicy resource.
 */
export interface CfwVpcPolicyArgs {
    /**
     * Describe.
     */
    description: pulumi.Input<string>;
