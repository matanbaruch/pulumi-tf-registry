...
export class MongodbStandbyInstance extends pulumi.CustomResource {
    /**
     * Get an existing MongodbStandbyInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MongodbStandbyInstanceState, opts?: pulumi.CustomResourceOptions): MongodbStandbyInstance {
        return new MongodbStandbyInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mongodbStandbyInstance:MongodbStandbyInstance';

    /**
     * Returns true if the given object is an instance of MongodbStandbyInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MongodbStandbyInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MongodbStandbyInstance.__pulumiType;
    }
    ...
    /**
     * Create a MongodbStandbyInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MongodbStandbyInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MongodbStandbyInstanceArgs | MongodbStandbyInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MongodbStandbyInstanceState | undefined;
            ...
            const args = argsOrState as MongodbStandbyInstanceArgs | undefined;
        ...
        super(MongodbStandbyInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MongodbStandbyInstance resources.
 */
export interface MongodbStandbyInstanceState {
    /**
     * Auto renew flag. Valid values are `0`(NOTIFY_AND_MANUAL_RENEW), `1`(NOTIFY_AND_AUTO_RENEW) and
     * `2`(DISABLE_NOTIFY_AND_MANUAL_RENEW). Default value is `0`. Note: only works for PREPAID instance. Only supports`0` and
     * `1` for creation.
...
/**
 * The set of arguments for constructing a MongodbStandbyInstance resource.
 */
export interface MongodbStandbyInstanceArgs {
    /**
     * Auto renew flag. Valid values are `0`(NOTIFY_AND_MANUAL_RENEW), `1`(NOTIFY_AND_AUTO_RENEW) and
     * `2`(DISABLE_NOTIFY_AND_MANUAL_RENEW). Default value is `0`. Note: only works for PREPAID instance. Only supports`0` and
     * `1` for creation.
