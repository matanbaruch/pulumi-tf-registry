...
export class SqlserverReadonlyInstance extends pulumi.CustomResource {
    /**
     * Get an existing SqlserverReadonlyInstance resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlserverReadonlyInstanceState, opts?: pulumi.CustomResourceOptions): SqlserverReadonlyInstance {
        return new SqlserverReadonlyInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sqlserverReadonlyInstance:SqlserverReadonlyInstance';

    /**
     * Returns true if the given object is an instance of SqlserverReadonlyInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SqlserverReadonlyInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SqlserverReadonlyInstance.__pulumiType;
    }
    ...
    /**
     * Create a SqlserverReadonlyInstance resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SqlserverReadonlyInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlserverReadonlyInstanceArgs | SqlserverReadonlyInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SqlserverReadonlyInstanceState | undefined;
            ...
            const args = argsOrState as SqlserverReadonlyInstanceArgs | undefined;
        ...
        super(SqlserverReadonlyInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SqlserverReadonlyInstance resources.
 */
export interface SqlserverReadonlyInstanceState {
    /**
     * Whether to use the voucher automatically; 1 for yes, 0 for no, the default is 0.
     */
...
/**
 * The set of arguments for constructing a SqlserverReadonlyInstance resource.
 */
export interface SqlserverReadonlyInstanceArgs {
    /**
     * Whether to use the voucher automatically; 1 for yes, 0 for no, the default is 0.
     */
    autoVoucher?: pulumi.Input<number>;
