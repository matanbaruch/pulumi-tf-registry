...
export class ClsCosRecharge extends pulumi.CustomResource {
    /**
     * Get an existing ClsCosRecharge resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClsCosRechargeState, opts?: pulumi.CustomResourceOptions): ClsCosRecharge {
        return new ClsCosRecharge(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/clsCosRecharge:ClsCosRecharge';

    /**
     * Returns true if the given object is an instance of ClsCosRecharge.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ClsCosRecharge {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClsCosRecharge.__pulumiType;
    }
     ...
     * extract rule info.
     */
    public readonly extractRuleInfo!: pulumi.Output<outputs.ClsCosRechargeExtractRuleInfo | undefined>;
    /**
     * log type.
     */
    ...
    /**
     * Create a ClsCosRecharge resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ClsCosRechargeArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ClsCosRechargeArgs | ClsCosRechargeState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClsCosRechargeState | undefined;
            ...
            const args = argsOrState as ClsCosRechargeArgs | undefined;
        ...
        super(ClsCosRecharge.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ClsCosRecharge resources.
 */
export interface ClsCosRechargeState {
    /**
     * cos bucket.
     */
     ...
     * extract rule info.
     */
    extractRuleInfo?: pulumi.Input<inputs.ClsCosRechargeExtractRuleInfo>;
    /**
     * log type.
     */
...
/**
 * The set of arguments for constructing a ClsCosRecharge resource.
 */
export interface ClsCosRechargeArgs {
    /**
     * cos bucket.
     */
    bucket: pulumi.Input<string>;
