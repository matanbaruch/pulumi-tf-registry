...
export class Audit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/audit:Audit';
    ...
    /**
     * Existing CMK unique key. This field can be get by data source `tencentcloud.getAuditKeyAlias`. Caution: the region of
     * the KMS must be as same as the `cos_region`.
     */
