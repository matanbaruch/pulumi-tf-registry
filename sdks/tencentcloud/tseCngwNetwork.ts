...
export class TseCngwNetwork extends pulumi.CustomResource {
    /**
     * Get an existing TseCngwNetwork resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TseCngwNetworkState, opts?: pulumi.CustomResourceOptions): TseCngwNetwork {
        return new TseCngwNetwork(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tseCngwNetwork:TseCngwNetwork';

    /**
     * Returns true if the given object is an instance of TseCngwNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TseCngwNetwork {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TseCngwNetwork.__pulumiType;
    }
    ...
    /**
     * Create a TseCngwNetwork resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TseCngwNetworkArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TseCngwNetworkArgs | TseCngwNetworkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TseCngwNetworkState | undefined;
            ...
            const args = argsOrState as TseCngwNetworkArgs | undefined;
        ...
        super(TseCngwNetwork.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TseCngwNetwork resources.
 */
export interface TseCngwNetworkState {
    /**
     * description of clb.
     */
...
/**
 * The set of arguments for constructing a TseCngwNetwork resource.
 */
export interface TseCngwNetworkArgs {
    /**
     * description of clb.
     */
    description?: pulumi.Input<string>;
