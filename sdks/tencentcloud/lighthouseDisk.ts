...
export class LighthouseDisk extends pulumi.CustomResource {
    /**
     * Get an existing LighthouseDisk resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LighthouseDiskState, opts?: pulumi.CustomResourceOptions): LighthouseDisk {
        return new LighthouseDisk(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/lighthouseDisk:LighthouseDisk';

    /**
     * Returns true if the given object is an instance of LighthouseDisk.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LighthouseDisk {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LighthouseDisk.__pulumiType;
    }

    /**
     * Automatically mount and initialize data disks.
     */
    public readonly autoMountConfiguration!: pulumi.Output<outputs.LighthouseDiskAutoMountConfiguration | undefined>;
    /**
     ...
     */
    public readonly diskChargePrepaid!: pulumi.Output<outputs.LighthouseDiskDiskChargePrepaid>;
    /**
    ...
    /**
     * Create a LighthouseDisk resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LighthouseDiskArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LighthouseDiskArgs | LighthouseDiskState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LighthouseDiskState | undefined;
            ...
            const args = argsOrState as LighthouseDiskArgs | undefined;
        ...
        super(LighthouseDisk.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering LighthouseDisk resources.
 */
export interface LighthouseDiskState {
    /**
     * Automatically mount and initialize data disks.
     */
    autoMountConfiguration?: pulumi.Input<inputs.LighthouseDiskAutoMountConfiguration>;
    /**
     * Whether to automatically use the voucher. Not used by default.
     */
     ...
     * Disk subscription related parameter settings.
     */
    diskChargePrepaid?: pulumi.Input<inputs.LighthouseDiskDiskChargePrepaid>;
    /**
     * Disk count. Values: [1, 30]. Default: 1.
     */
...
/**
 * The set of arguments for constructing a LighthouseDisk resource.
 */
export interface LighthouseDiskArgs {
    /**
     * Automatically mount and initialize data disks.
     */
    autoMountConfiguration?: pulumi.Input<inputs.LighthouseDiskAutoMountConfiguration>;
