...
export class CkafkaConsumerGroupModifyOffset extends pulumi.CustomResource {
    /**
     * Get an existing CkafkaConsumerGroupModifyOffset resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CkafkaConsumerGroupModifyOffsetState, opts?: pulumi.CustomResourceOptions): CkafkaConsumerGroupModifyOffset {
        return new CkafkaConsumerGroupModifyOffset(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/ckafkaConsumerGroupModifyOffset:CkafkaConsumerGroupModifyOffset';

    /**
     * Returns true if the given object is an instance of CkafkaConsumerGroupModifyOffset.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CkafkaConsumerGroupModifyOffset {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CkafkaConsumerGroupModifyOffset.__pulumiType;
    }
    ...
    /**
     * Create a CkafkaConsumerGroupModifyOffset resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CkafkaConsumerGroupModifyOffsetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CkafkaConsumerGroupModifyOffsetArgs | CkafkaConsumerGroupModifyOffsetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CkafkaConsumerGroupModifyOffsetState | undefined;
            ...
            const args = argsOrState as CkafkaConsumerGroupModifyOffsetArgs | undefined;
        ...
        super(CkafkaConsumerGroupModifyOffset.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CkafkaConsumerGroupModifyOffset resources.
 */
export interface CkafkaConsumerGroupModifyOffsetState {
    /**
     * kafka group.
     */
...
/**
 * The set of arguments for constructing a CkafkaConsumerGroupModifyOffset resource.
 */
export interface CkafkaConsumerGroupModifyOffsetArgs {
    /**
     * kafka group.
     */
    group: pulumi.Input<string>;
