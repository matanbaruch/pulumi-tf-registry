...
export class SqlserverConfigBackupStrategy extends pulumi.CustomResource {
    /**
     * Get an existing SqlserverConfigBackupStrategy resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SqlserverConfigBackupStrategyState, opts?: pulumi.CustomResourceOptions): SqlserverConfigBackupStrategy {
        return new SqlserverConfigBackupStrategy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/sqlserverConfigBackupStrategy:SqlserverConfigBackupStrategy';

    /**
     * Returns true if the given object is an instance of SqlserverConfigBackupStrategy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SqlserverConfigBackupStrategy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SqlserverConfigBackupStrategy.__pulumiType;
    }
    ...
    /**
     * Create a SqlserverConfigBackupStrategy resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SqlserverConfigBackupStrategyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SqlserverConfigBackupStrategyArgs | SqlserverConfigBackupStrategyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SqlserverConfigBackupStrategyState | undefined;
            ...
            const args = argsOrState as SqlserverConfigBackupStrategyArgs | undefined;
        ...
        super(SqlserverConfigBackupStrategy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SqlserverConfigBackupStrategy resources.
 */
export interface SqlserverConfigBackupStrategyState {
    /**
     * The days of the week on which backup will be performed when `BackupType` is weekly. If data backup retention period is
     * less than 7 days, the values will be 1-7, indicating that backup will be performed everyday by default; if data backup
     * retention period is greater than or equal to 7 days, the values will be at least any two days, indicating that backup
...
/**
 * The set of arguments for constructing a SqlserverConfigBackupStrategy resource.
 */
export interface SqlserverConfigBackupStrategyArgs {
    /**
     * The days of the week on which backup will be performed when `BackupType` is weekly. If data backup retention period is
     * less than 7 days, the values will be 1-7, indicating that backup will be performed everyday by default; if data backup
     * retention period is greater than or equal to 7 days, the values will be at least any two days, indicating that backup
