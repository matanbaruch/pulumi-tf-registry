...
export class VodSampleSnapshotTemplate extends pulumi.CustomResource {
    /**
     * Get an existing VodSampleSnapshotTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VodSampleSnapshotTemplateState, opts?: pulumi.CustomResourceOptions): VodSampleSnapshotTemplate {
        return new VodSampleSnapshotTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/vodSampleSnapshotTemplate:VodSampleSnapshotTemplate';

    /**
     * Returns true if the given object is an instance of VodSampleSnapshotTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VodSampleSnapshotTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VodSampleSnapshotTemplate.__pulumiType;
    }
    ...
    /**
     * Create a VodSampleSnapshotTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VodSampleSnapshotTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VodSampleSnapshotTemplateArgs | VodSampleSnapshotTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VodSampleSnapshotTemplateState | undefined;
            ...
            const args = argsOrState as VodSampleSnapshotTemplateArgs | undefined;
        ...
        super(VodSampleSnapshotTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VodSampleSnapshotTemplate resources.
 */
export interface VodSampleSnapshotTemplateState {
    /**
     * Template description. Length limit: 256 characters.
     */
...
/**
 * The set of arguments for constructing a VodSampleSnapshotTemplate resource.
 */
export interface VodSampleSnapshotTemplateArgs {
    /**
     * Template description. Length limit: 256 characters.
     */
    comment?: pulumi.Input<string>;
