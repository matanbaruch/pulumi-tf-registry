...
export class OrganizationOrgMember extends pulumi.CustomResource {
    /**
     * Get an existing OrganizationOrgMember resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrganizationOrgMemberState, opts?: pulumi.CustomResourceOptions): OrganizationOrgMember {
        return new OrganizationOrgMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/organizationOrgMember:OrganizationOrgMember';

    /**
     * Returns true if the given object is an instance of OrganizationOrgMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OrganizationOrgMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OrganizationOrgMember.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly orgPermissions!: pulumi.Output<outputs.OrganizationOrgMemberOrgPermission[]>;
    /**
    ...
    /**
     * Create a OrganizationOrgMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OrganizationOrgMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OrganizationOrgMemberArgs | OrganizationOrgMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OrganizationOrgMemberState | undefined;
            ...
            const args = argsOrState as OrganizationOrgMemberArgs | undefined;
        ...
        super(OrganizationOrgMember.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OrganizationOrgMember resources.
 */
export interface OrganizationOrgMemberState {
    /**
     * Member creation time.
     */
     ...
     * Financial management permissions.
     */
    orgPermissions?: pulumi.Input<pulumi.Input<inputs.OrganizationOrgMemberOrgPermission>[]>;
    /**
     * Organization policy name.
     */
...
/**
 * The set of arguments for constructing a OrganizationOrgMember resource.
 */
export interface OrganizationOrgMemberArgs {
    /**
     * Member name.
     */
    name?: pulumi.Input<string>;
