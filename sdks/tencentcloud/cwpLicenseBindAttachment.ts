...
export class CwpLicenseBindAttachment extends pulumi.CustomResource {
    /**
     * Get an existing CwpLicenseBindAttachment resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CwpLicenseBindAttachmentState, opts?: pulumi.CustomResourceOptions): CwpLicenseBindAttachment {
        return new CwpLicenseBindAttachment(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cwpLicenseBindAttachment:CwpLicenseBindAttachment';

    /**
     * Returns true if the given object is an instance of CwpLicenseBindAttachment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CwpLicenseBindAttachment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CwpLicenseBindAttachment.__pulumiType;
    }
    ...
    /**
     * Create a CwpLicenseBindAttachment resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CwpLicenseBindAttachmentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CwpLicenseBindAttachmentArgs | CwpLicenseBindAttachmentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CwpLicenseBindAttachmentState | undefined;
            ...
            const args = argsOrState as CwpLicenseBindAttachmentArgs | undefined;
        ...
        super(CwpLicenseBindAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CwpLicenseBindAttachment resources.
 */
export interface CwpLicenseBindAttachmentState {
    /**
     * agent status.
     */
...
/**
 * The set of arguments for constructing a CwpLicenseBindAttachment resource.
 */
export interface CwpLicenseBindAttachmentArgs {
    /**
     * License ID.
     */
    licenseId: pulumi.Input<number>;
