...
export class TeoApplicationProxyRule extends pulumi.CustomResource {
    /**
     * Get an existing TeoApplicationProxyRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TeoApplicationProxyRuleState, opts?: pulumi.CustomResourceOptions): TeoApplicationProxyRule {
        return new TeoApplicationProxyRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/teoApplicationProxyRule:TeoApplicationProxyRule';

    /**
     * Returns true if the given object is an instance of TeoApplicationProxyRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TeoApplicationProxyRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TeoApplicationProxyRule.__pulumiType;
    }
    ...
    /**
     * Create a TeoApplicationProxyRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TeoApplicationProxyRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TeoApplicationProxyRuleArgs | TeoApplicationProxyRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TeoApplicationProxyRuleState | undefined;
            ...
            const args = argsOrState as TeoApplicationProxyRuleArgs | undefined;
        ...
        super(TeoApplicationProxyRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TeoApplicationProxyRule resources.
 */
export interface TeoApplicationProxyRuleState {
    /**
     * Passes the client IP. Default value is `OFF`. When Proto is TCP, valid values: `TOA`: Pass the client IP via TOA;
     * `PPV1`: Pass the client IP via Proxy Protocol V1; `PPV2`: Pass the client IP via Proxy Protocol V2; `OFF`: Do not pass
     * the client IP. When Proto=UDP, valid values: `PPV2`: Pass the client IP via Proxy Protocol V2; `OFF`: Do not pass the
...
/**
 * The set of arguments for constructing a TeoApplicationProxyRule resource.
 */
export interface TeoApplicationProxyRuleArgs {
    /**
     * Passes the client IP. Default value is `OFF`. When Proto is TCP, valid values: `TOA`: Pass the client IP via TOA;
     * `PPV1`: Pass the client IP via Proxy Protocol V1; `PPV2`: Pass the client IP via Proxy Protocol V2; `OFF`: Do not pass
     * the client IP. When Proto=UDP, valid values: `PPV2`: Pass the client IP via Proxy Protocol V2; `OFF`: Do not pass the
