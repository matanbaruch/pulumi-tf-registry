...
export class TemApplication extends pulumi.CustomResource {
    /**
     * Get an existing TemApplication resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TemApplicationState, opts?: pulumi.CustomResourceOptions): TemApplication {
        return new TemApplication(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/temApplication:TemApplication';

    /**
     * Returns true if the given object is an instance of TemApplication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TemApplication {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TemApplication.__pulumiType;
    }
    ...
    /**
     * Create a TemApplication resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TemApplicationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TemApplicationArgs | TemApplicationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TemApplicationState | undefined;
            ...
            const args = argsOrState as TemApplicationArgs | undefined;
        ...
        super(TemApplication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TemApplication resources.
 */
export interface TemApplicationState {
    /**
     * application name.
     */
...
/**
 * The set of arguments for constructing a TemApplication resource.
 */
export interface TemApplicationArgs {
    /**
     * application name.
     */
    applicationName: pulumi.Input<string>;
