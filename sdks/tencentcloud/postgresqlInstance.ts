...
export class PostgresqlInstance extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PostgresqlInstanceState, opts?: pulumi.CustomResourceOptions): PostgresqlInstance {
        return new PostgresqlInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/postgresqlInstance:PostgresqlInstance';

    /**
     * Returns true if the given object is an instance of PostgresqlInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PostgresqlInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PostgresqlInstance.__pulumiType;
    }
     ...
     */
    public readonly backupPlan!: pulumi.Output<outputs.PostgresqlInstanceBackupPlan | undefined>;
    /**
     ...
     */
    public readonly dbNodeSets!: pulumi.Output<outputs.PostgresqlInstanceDbNodeSet[] | undefined>;
    /**
     ...
     * `storage_max` which data source `tencentcloud.getPostgresqlSpecinfos` provides.
     */
     ...
     */
    constructor(name: string, args: PostgresqlInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PostgresqlInstanceArgs | PostgresqlInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PostgresqlInstanceState | undefined;
            ...
            const args = argsOrState as PostgresqlInstanceArgs | undefined;
        ...
        super(PostgresqlInstance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface PostgresqlInstanceState {
    /**
     * Auto renew flag, `1` for enabled. NOTES: Only support prepaid instance.
     */
     ...
     * Specify DB backup plan.
     */
    backupPlan?: pulumi.Input<inputs.PostgresqlInstanceBackupPlan>;
    /**
     * Pay type of the postgresql instance. Values `POSTPAID_BY_HOUR` (Default), `PREPAID`. It only support to update the type
     * from `POSTPAID_BY_HOUR` to `PREPAID`.
     */
     ...
     * Specify instance node info for disaster migration.
     */
    dbNodeSets?: pulumi.Input<pulumi.Input<inputs.PostgresqlInstanceDbNodeSet>[]>;
    /**
     * Whether to enable instance deletion protection. Default: false.
     */
 ...
 */
export interface PostgresqlInstanceArgs {
    /**
     * Auto renew flag, `1` for enabled. NOTES: Only support prepaid instance.
     */
    autoRenewFlag?: pulumi.Input<number>;
