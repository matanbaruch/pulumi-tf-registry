...
export class CdnDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/cdnDomain:CdnDomain';
     ...
     */
    public readonly authentication!: pulumi.Output<outputs.CdnDomainAuthentication | undefined>;
    /**
     * Access authentication for S3 origin.
     */
    public readonly awsPrivateAccess!: pulumi.Output<outputs.CdnDomainAwsPrivateAccess | undefined>;
    /**
     * Bandwidth cap configuration.
     */
    public readonly bandWidthAlert!: pulumi.Output<outputs.CdnDomainBandWidthAlert | undefined>;
    /**
     * Cache key configuration (Ignore Query String configuration). NOTE: All of `full_url_cache` default value is `on`.
     */
    public readonly cacheKey!: pulumi.Output<outputs.CdnDomainCacheKey | undefined>;
    /**
     ...
     */
    public readonly compression!: pulumi.Output<outputs.CdnDomainCompression | undefined>;
    /**
     ...
     */
    public readonly downstreamCapping!: pulumi.Output<outputs.CdnDomainDownstreamCapping | undefined>;
    /**
     ...
     */
    public readonly errorPage!: pulumi.Output<outputs.CdnDomainErrorPage | undefined>;
    /**
     ...
     */
    public readonly httpsConfig!: pulumi.Output<outputs.CdnDomainHttpsConfig | undefined>;
    /**
     * Access authentication for OBS origin.
     */
    public readonly hwPrivateAccess!: pulumi.Output<outputs.CdnDomainHwPrivateAccess | undefined>;
    /**
     * Specify Ip filter configurations.
     */
    public readonly ipFilter!: pulumi.Output<outputs.CdnDomainIpFilter | undefined>;
    /**
     * Specify Ip frequency limit configurations.
     */
    public readonly ipFreqLimit!: pulumi.Output<outputs.CdnDomainIpFreqLimit | undefined>;
    /**
     ...
     */
    public readonly maxAge!: pulumi.Output<outputs.CdnDomainMaxAge | undefined>;
    /**
     ...
     */
    public readonly origin!: pulumi.Output<outputs.CdnDomainOrigin>;
    /**
     * Cross-border linkage optimization configuration. (This feature is in beta and not generally available yet).
     */
    public readonly originPullOptimization!: pulumi.Output<outputs.CdnDomainOriginPullOptimization | undefined>;
    /**
     * Cross-border linkage optimization configuration.
     */
    public readonly originPullTimeout!: pulumi.Output<outputs.CdnDomainOriginPullTimeout | undefined>;
    /**
     * Access authentication for OSS origin.
     */
    public readonly ossPrivateAccess!: pulumi.Output<outputs.CdnDomainOssPrivateAccess | undefined>;
    /**
     * Maximum post size configuration.
     */
    public readonly postMaxSizes!: pulumi.Output<outputs.CdnDomainPostMaxSize[] | undefined>;
    /**
     ...
     * Access authentication for OBS origin.
     */
    public readonly qnPrivateAccess!: pulumi.Output<outputs.CdnDomainQnPrivateAccess | undefined>;
    /**
     ...
     */
    public readonly referer!: pulumi.Output<outputs.CdnDomainReferer | undefined>;
    /**
     * Request header configuration. It's a list and consist of at most one item.
     */
    public readonly requestHeader!: pulumi.Output<outputs.CdnDomainRequestHeader | undefined>;
    /**
     * Response header configurations.
     */
    public readonly responseHeader!: pulumi.Output<outputs.CdnDomainResponseHeader | undefined>;
    /**
     ...
     */
    public readonly ruleCaches!: pulumi.Output<outputs.CdnDomainRuleCach[] | undefined>;
    /**
     ...
     */
    public readonly statusCodeCache!: pulumi.Output<outputs.CdnDomainStatusCodeCache | undefined>;
    /**
     * Tags of cdn domain.
     */
...
export interface CdnDomainState {
     ...
     * Specify timestamp hotlink protection configuration, NOTE: only one type can choose for the sub elements.
     */
    authentication?: pulumi.Input<inputs.CdnDomainAuthentication>;
    /**
     * Access authentication for S3 origin.
     */
    awsPrivateAccess?: pulumi.Input<inputs.CdnDomainAwsPrivateAccess>;
    /**
     * Bandwidth cap configuration.
     */
    bandWidthAlert?: pulumi.Input<inputs.CdnDomainBandWidthAlert>;
    /**
     * Cache key configuration (Ignore Query String configuration). NOTE: All of `full_url_cache` default value is `on`.
     */
    cacheKey?: pulumi.Input<inputs.CdnDomainCacheKey>;
    /**
     * CNAME address of domain name.
     */
     ...
     * Smart compression configurations.
     */
    compression?: pulumi.Input<inputs.CdnDomainCompression>;
    /**
     * Creation time of domain name.
     */
     ...
     * Downstream capping configuration.
     */
    downstreamCapping?: pulumi.Input<inputs.CdnDomainDownstreamCapping>;
    /**
     * Used for store `dry_run` request json.
     */
     ...
     * Error page configurations.
     */
    errorPage?: pulumi.Input<inputs.CdnDomainErrorPage>;
    /**
     * Used for validate only by store arguments to request json string as expected, WARNING: if set to `true`, NO Cloud Api
     * will be invoked but store as local data, do not use this argument unless you really know what you are doing.
     */
     ...
     * HTTPS acceleration configuration. It's a list and consist of at most one item.
     */
    httpsConfig?: pulumi.Input<inputs.CdnDomainHttpsConfig>;
    /**
     * Access authentication for OBS origin.
     */
    hwPrivateAccess?: pulumi.Input<inputs.CdnDomainHwPrivateAccess>;
    /**
     * Specify Ip filter configurations.
     */
    ipFilter?: pulumi.Input<inputs.CdnDomainIpFilter>;
    /**
     * Specify Ip frequency limit configurations.
     */
    ipFreqLimit?: pulumi.Input<inputs.CdnDomainIpFreqLimit>;
    /**
     * ipv6 access configuration switch. Only available when area set to `mainland`. Valid values are `on` and `off`. Default
     * value is `off`.
     */
     ...
     * Browser cache configuration. (This feature is in beta and not generally available yet).
     */
    maxAge?: pulumi.Input<inputs.CdnDomainMaxAge>;
    /**
     * Offline cache switch, available values: `on`, `off` (default).
     */
     ...
     * Origin server configuration. It's a list and consist of at most one item.
     */
    origin?: pulumi.Input<inputs.CdnDomainOrigin>;
    /**
     * Cross-border linkage optimization configuration. (This feature is in beta and not generally available yet).
     */
    originPullOptimization?: pulumi.Input<inputs.CdnDomainOriginPullOptimization>;
    /**
     * Cross-border linkage optimization configuration.
     */
    originPullTimeout?: pulumi.Input<inputs.CdnDomainOriginPullTimeout>;
    /**
     * Access authentication for OSS origin.
     */
    ossPrivateAccess?: pulumi.Input<inputs.CdnDomainOssPrivateAccess>;
    /**
     * Maximum post size configuration.
     */
    postMaxSizes?: pulumi.Input<pulumi.Input<inputs.CdnDomainPostMaxSize>[]>;
    /**
     * The project CDN belongs to, default to 0.
     */
     ...
     * Access authentication for OBS origin.
     */
    qnPrivateAccess?: pulumi.Input<inputs.CdnDomainQnPrivateAccess>;
    /**
     * QUIC switch, available values: `on`, `off` (default).
     */
     ...
     * Referer configuration.
     */
    referer?: pulumi.Input<inputs.CdnDomainReferer>;
    /**
     * Request header configuration. It's a list and consist of at most one item.
     */
    requestHeader?: pulumi.Input<inputs.CdnDomainRequestHeader>;
    /**
     * Response header configurations.
     */
    responseHeader?: pulumi.Input<inputs.CdnDomainResponseHeader>;
    /**
     * Response header cache switch, available values: `on`, `off` (default).
     */
     ...
     * Advanced path cache configuration.
     */
    ruleCaches?: pulumi.Input<pulumi.Input<inputs.CdnDomainRuleCach>[]>;
    /**
     * SEO switch, available values: `on`, `off` (default).
     */
     ...
     * Status code cache configurations.
     */
    statusCodeCache?: pulumi.Input<inputs.CdnDomainStatusCodeCache>;
    /**
     * Tags of cdn domain.
     */
