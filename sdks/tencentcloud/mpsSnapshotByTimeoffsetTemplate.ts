...
export class MpsSnapshotByTimeoffsetTemplate extends pulumi.CustomResource {
    /**
     * Get an existing MpsSnapshotByTimeoffsetTemplate resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MpsSnapshotByTimeoffsetTemplateState, opts?: pulumi.CustomResourceOptions): MpsSnapshotByTimeoffsetTemplate {
        return new MpsSnapshotByTimeoffsetTemplate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mpsSnapshotByTimeoffsetTemplate:MpsSnapshotByTimeoffsetTemplate';

    /**
     * Returns true if the given object is an instance of MpsSnapshotByTimeoffsetTemplate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MpsSnapshotByTimeoffsetTemplate {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MpsSnapshotByTimeoffsetTemplate.__pulumiType;
    }
    ...
    /**
     * Create a MpsSnapshotByTimeoffsetTemplate resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: MpsSnapshotByTimeoffsetTemplateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MpsSnapshotByTimeoffsetTemplateArgs | MpsSnapshotByTimeoffsetTemplateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MpsSnapshotByTimeoffsetTemplateState | undefined;
            ...
            const args = argsOrState as MpsSnapshotByTimeoffsetTemplateArgs | undefined;
        ...
        super(MpsSnapshotByTimeoffsetTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MpsSnapshotByTimeoffsetTemplate resources.
 */
export interface MpsSnapshotByTimeoffsetTemplateState {
    /**
     * Template description information, length limit: 256 characters.
     */
...
/**
 * The set of arguments for constructing a MpsSnapshotByTimeoffsetTemplate resource.
 */
export interface MpsSnapshotByTimeoffsetTemplateArgs {
    /**
     * Template description information, length limit: 256 characters.
     */
    comment?: pulumi.Input<string>;
