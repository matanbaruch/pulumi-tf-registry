...
export class TsfDeployContainerGroup extends pulumi.CustomResource {
    /**
     * Get an existing TsfDeployContainerGroup resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TsfDeployContainerGroupState, opts?: pulumi.CustomResourceOptions): TsfDeployContainerGroup {
        return new TsfDeployContainerGroup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/tsfDeployContainerGroup:TsfDeployContainerGroup';

    /**
     * Returns true if the given object is an instance of TsfDeployContainerGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TsfDeployContainerGroup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TsfDeployContainerGroup.__pulumiType;
    }
     ...
     */
    public readonly agentProfileLists!: pulumi.Output<outputs.TsfDeployContainerGroupAgentProfileList[] | undefined>;
    /**
     ...
     */
    public readonly envs!: pulumi.Output<outputs.TsfDeployContainerGroupEnv[] | undefined>;
    /**
     * group Id.
     */
     ...
     * default.
     */
    public readonly healthCheckSettings!: pulumi.Output<outputs.TsfDeployContainerGroupHealthCheckSettings | undefined>;
    /**
     ...
     */
    public readonly schedulingStrategy!: pulumi.Output<outputs.TsfDeployContainerGroupSchedulingStrategy | undefined>;
    /**
     * image server.
     */
     ...
     */
    public readonly serviceSetting!: pulumi.Output<outputs.TsfDeployContainerGroupServiceSetting | undefined>;
    /**
     ...
     */
    public readonly volumeInfoLists!: pulumi.Output<outputs.TsfDeployContainerGroupVolumeInfoList[] | undefined>;
    /**
     * Volume mount point information, list type.
     */
    public readonly volumeMountInfoLists!: pulumi.Output<outputs.TsfDeployContainerGroupVolumeMountInfoList[] | undefined>;
    /**
     * warmup setting.
     */
    public readonly warmupSetting!: pulumi.Output<outputs.TsfDeployContainerGroupWarmupSetting | undefined>;

    /**
     * Create a TsfDeployContainerGroup resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TsfDeployContainerGroupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TsfDeployContainerGroupArgs | TsfDeployContainerGroupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TsfDeployContainerGroupState | undefined;
            ...
            const args = argsOrState as TsfDeployContainerGroupArgs | undefined;
        ...
        super(TsfDeployContainerGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TsfDeployContainerGroup resources.
 */
export interface TsfDeployContainerGroupState {
    /**
     * The maximum number of CPU cores allocated to the agent container corresponds to the limit field in Kubernetes.
     */
     ...
     * javaagent info: SERVICE_AGENT/OT_AGENT.
     */
    agentProfileLists?: pulumi.Input<pulumi.Input<inputs.TsfDeployContainerGroupAgentProfileList>[]>;
    /**
     * The maximum number of CPU cores for the business container, corresponding to the limit in K8S. If not specified, it
     * defaults to twice the request.
     */
     ...
     * additional environment variables are set by default.
     */
    envs?: pulumi.Input<pulumi.Input<inputs.TsfDeployContainerGroupEnv>[]>;
    /**
     * group Id.
     */
     ...
     * default.
     */
    healthCheckSettings?: pulumi.Input<inputs.TsfDeployContainerGroupHealthCheckSettings>;
    /**
     * Whether to perform incremental deployment. The default value is false, which means full update.
     */
     ...
     * Node scheduling strategy. If this parameter is not specified, the node scheduling strategy will not be used by default.
     */
    schedulingStrategy?: pulumi.Input<inputs.TsfDeployContainerGroupSchedulingStrategy>;
    /**
     * image server.
     */
     ...
     * Network settings for container deployment groups.
     */
    serviceSetting?: pulumi.Input<inputs.TsfDeployContainerGroupServiceSetting>;
    /**
     * image version name, v1.
     */
     ...
     * Volume information, as a list.
     */
    volumeInfoLists?: pulumi.Input<pulumi.Input<inputs.TsfDeployContainerGroupVolumeInfoList>[]>;
    /**
     * Volume mount point information, list type.
     */
    volumeMountInfoLists?: pulumi.Input<pulumi.Input<inputs.TsfDeployContainerGroupVolumeMountInfoList>[]>;
    /**
     * warmup setting.
     */
    warmupSetting?: pulumi.Input<inputs.TsfDeployContainerGroupWarmupSetting>;
}

/**
 * The set of arguments for constructing a TsfDeployContainerGroup resource.
 */
export interface TsfDeployContainerGroupArgs {
    /**
     * The maximum number of CPU cores allocated to the agent container corresponds to the limit field in Kubernetes.
     */
    agentCpuLimit?: pulumi.Input<string>;
