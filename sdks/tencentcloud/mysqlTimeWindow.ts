...
export class MysqlTimeWindow extends pulumi.CustomResource {
    /**
     * Get an existing MysqlTimeWindow resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MysqlTimeWindowState, opts?: pulumi.CustomResourceOptions): MysqlTimeWindow {
        return new MysqlTimeWindow(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:index/mysqlTimeWindow:MysqlTimeWindow';

    /**
     * Returns true if the given object is an instance of MysqlTimeWindow.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MysqlTimeWindow {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MysqlTimeWindow.__pulumiType;
    }
    ...
    /**
     * Create a MysqlTimeWindow resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: MysqlTimeWindowArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MysqlTimeWindowArgs | MysqlTimeWindowState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MysqlTimeWindowState | undefined;
            ...
            const args = argsOrState as MysqlTimeWindowArgs | undefined;
        ...
        super(MysqlTimeWindow.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering MysqlTimeWindow resources.
 */
export interface MysqlTimeWindowState {
    /**
     * Instance ID in the format of cdb-c1nl9rpv or cdbro-c1nl9rpv. It is the same as the instance ID displayed on the
     * TencentDB Console page.
     */
...
/**
 * The set of arguments for constructing a MysqlTimeWindow resource.
 */
export interface MysqlTimeWindowArgs {
    /**
     * Instance ID in the format of cdb-c1nl9rpv or cdbro-c1nl9rpv. It is the same as the instance ID displayed on the
     * TencentDB Console page.
     */
