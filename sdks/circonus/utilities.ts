...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("circonus");
			params.setVersion("0.12.15");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NpcmNvbnVzLWxhYnMvY2lyY29udXMiLCJ2ZXJzaW9uIjoiMC4xMi4xNSJ9fQ=="), c => c.charCodeAt(0)));
