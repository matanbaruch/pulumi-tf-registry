...
export class Maintenance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'circonus:index/maintenance:Maintenance';
    ...
    constructor(name: string, argsOrState?: MaintenanceArgs | MaintenanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["stop"] = state ? state.stop : undefined;
        ...
        super(Maintenance.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
