...
export class String extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StringState, opts?: pulumi.CustomResourceOptions): String {
        return new String(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'random:index/string:String';
    ...
    constructor(name: string, argsOrState?: StringArgs | StringState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StringState | undefined;
            ...
            const args = argsOrState as StringArgs | undefined;
        ...
        super(String.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
