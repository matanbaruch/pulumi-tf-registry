...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("sumologic");
			params.setVersion("2.31.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3N1bW9sb2dpYy9zdW1vbG9naWMiLCJ2ZXJzaW9uIjoiMi4zMS4zIn19"), c => c.charCodeAt(0)));
