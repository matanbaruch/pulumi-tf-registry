...
export class Content extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ContentTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ContentArgs | ContentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Content.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ContentState {
    ...
    timeouts?: pulumi.Input<inputs.ContentTimeouts>;
}
