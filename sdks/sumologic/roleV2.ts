...
export class RoleV2 extends pulumi.CustomResource {
    ...
    /**
     * List of [capabilities](https://help.sumologic.com/docs/manage/users-roles/roles/role-capabilities/) associated with this
     * role
     */
    ...
    constructor(name: string, argsOrState?: RoleV2Args | RoleV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RoleV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
