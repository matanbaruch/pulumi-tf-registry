...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("matchbox");
			params.setVersion("0.5.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3Bvc2VpZG9uL21hdGNoYm94IiwidmVyc2lvbiI6IjAuNS40In19"), c => c.charCodeAt(0)));
