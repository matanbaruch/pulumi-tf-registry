...
export class TagAssociation extends pulumi.CustomResource {
     ...
     * INTEGRATION NETWORK POLICY ROLE SHARE USER WAREHOUSE DATABASE ROLE SCHEMA ALERT EXTERNAL FUNCTION EXTERNAL TABLE GIT
     * REPOSITORY ICEBERG TABLE MATERIALIZED VIEW PIPE MASKING POLICY PASSWORD POLICY ROW ACCESS POLICY SESSION POLICY
     * PROCEDURE STAGE STREAM TABLE TASK VIEW COLUMN EVENT TABLE].
     */
    ...
    /**
     * Specifies the identifier for the tag. Note: format must follow: "databaseName"."schemaName"."tagName" or
     * "databaseName.schemaName.tagName" or "databaseName|schemaName.tagName" (snowflake_tag.tag.id)
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.TagAssociationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: TagAssociationArgs | TagAssociationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TagAssociation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface TagAssociationState {
    ...
    timeouts?: pulumi.Input<inputs.TagAssociationTimeouts>;
}
