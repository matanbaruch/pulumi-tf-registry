...
export class Procedure extends pulumi.CustomResource {
    ...
    /**
     * Sets execution context. Allowed values are CALLER and OWNER (consult a proper section in the
     * [docs](https://docs.snowflake.com/en/sql-reference/sql/create-procedure#id1)). For more information see [caller's rights
     * and owner's rights](https://docs.snowflake.com/en/developer-guide/stored-procedure/stored-procedures-rights).
     */
    ...
    /**
     * List of package imports to use for Java / Python procedures. For Java, package imports should be of the form:
     ...
     * Information with Secure UDFs and Stored Procedures.
     */
    ...
    constructor(name: string, argsOrState?: ProcedureArgs | ProcedureState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Procedure.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
