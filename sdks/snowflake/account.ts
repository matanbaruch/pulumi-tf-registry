...
export class Account extends pulumi.CustomResource {
    ...
    /**
     * Login name of the initial administrative user of the account. A new user is created in the new account with this name
     * and password and granted the ACCOUNTADMIN role in the account. A login name can be any string consisting of letters,
     * numbers, and underscores. Login names are always case-insensitive.
     */
    public readonly adminName!: pulumi.Output<string>;
    /**
     * Password for the initial administrative user of the account. Optional if the `ADMIN_RSA_PUBLIC_KEY` parameter is
     * specified. For more information about passwords in Snowflake, see [Snowflake-provided Password
     * Policy](https://docs.snowflake.com/en/sql-reference/sql/create-account.html#:~:text=Snowflake%2Dprovided%20Password%20Policy).
     */
    public readonly adminPassword!: pulumi.Output<string | undefined>;
    /**
     * Assigns a public key to the initial administrative user of the account in order to implement [key pair
     * authentication](https://docs.snowflake.com/en/sql-reference/sql/create-account.html#:~:text=key%20pair%20authentication)
     * for the user. Optional if the `ADMIN_PASSWORD` parameter is specified.
     */
    ...
    /**
     * [Snowflake Edition](https://docs.snowflake.com/en/user-guide/intro-editions.html) of the account. Valid values are:
     * STANDARD | ENTERPRISE | BUSINESS_CRITICAL
     */
    public readonly edition!: pulumi.Output<string>;
    /**
     * Email address of the initial administrative user of the account. This email address is used to send any notifications
     * about the account.
     */
    ...
    /**
     * Specifies whether the new user created to administer the account is forced to change their password upon first login
     * into the account.
     */
    public readonly mustChangePassword!: pulumi.Output<boolean | undefined>;
    /**
     * Specifies the identifier (i.e. name) for the account; must be unique within an organization, regardless of which
     * Snowflake Region the account is in. In addition, the identifier must start with an alphabetic character and cannot
     * contain spaces or special characters except for underscores (_). Note that if the account name includes underscores,
     * features that do not accept account names with underscores (e.g. Okta SSO or SCIM) can reference a version of the
     * account name that substitutes hyphens (-) for the underscores.
     */
    public readonly name!: pulumi.Output<string>;
    /**
     * ID of the Snowflake Region where the account is created. If no value is provided, Snowflake creates the account in the
     * same Snowflake Region as the current account (i.e. the account in which the CREATE ACCOUNT statement is executed.)
     */
