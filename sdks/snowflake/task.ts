...
export class Task extends pulumi.CustomResource {
    ...
    /**
     * Specifies one or more predecessor tasks for the current task. Use this option to create a DAG of tasks or add this task
     * to an existing DAG. A DAG is a series of tasks that starts with a scheduled root task and is linked together by
     * dependencies.
     */
     ...
     * parameter value to TRUE permits DAG runs to overlap.
     */
     ...
     * default is 0 (no automatic suspension).
     */
