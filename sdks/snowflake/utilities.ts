...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("snowflake");
			params.setVersion("0.95.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Nub3dmbGFrZS1sYWJzL3Nub3dmbGFrZSIsInZlcnNpb24iOiIwLjk1LjAifX0="), c => c.charCodeAt(0)));
