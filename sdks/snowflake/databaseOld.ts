...
export class DatabaseOld extends pulumi.CustomResource {
    ...
    /**
     * Number of days for which Snowflake retains historical data for performing Time Travel actions (SELECT, CLONE, UNDROP) on
     * the object. A value of 0 effectively disables Time Travel for the specified database. Default value for this field is
     * set to -1, which is a fallback to use Snowflake default. For more information, see [Understanding & Using Time
    ...
    /**
     * Specify a provider and a share in this map to create a database from a share. As of version 0.87.0, the provider field
     * is the account locator.
     */
    public readonly fromShare!: pulumi.Output<{[key: string]: string} | undefined>;
    /**
     * Specifies a database as transient. Transient databases do not have a Fail-safe period so they do not incur additional
    ...
    constructor(name: string, argsOrState?: DatabaseOldArgs | DatabaseOldState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseOld.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
