...
export class SessionParameter extends pulumi.CustomResource {
    ...
    /**
     * Name of session parameter. Valid values are those in [session
     * parameters](https://docs.snowflake.com/en/sql-reference/parameters.html#session-parameters).
     */
    ...
    /**
     * Value of session parameter, as a string. Constraints are the same as those for the parameters in Snowflake
     * documentation.
     */
    ...
    constructor(name: string, argsOrState?: SessionParameterArgs | SessionParameterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SessionParameter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
