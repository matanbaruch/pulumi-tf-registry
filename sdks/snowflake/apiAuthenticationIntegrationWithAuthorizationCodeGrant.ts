...
export class ApiAuthenticationIntegrationWithAuthorizationCodeGrant extends pulumi.CustomResource {
    ...
    /**
     * Specifies the client secret for the OAuth application in the ServiceNow instance from the previous step. The connector
     * uses this to request an access token from the ServiceNow instance.
     */
    ...
    constructor(name: string, argsOrState?: ApiAuthenticationIntegrationWithAuthorizationCodeGrantArgs | ApiAuthenticationIntegrationWithAuthorizationCodeGrantState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApiAuthenticationIntegrationWithAuthorizationCodeGrant.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
