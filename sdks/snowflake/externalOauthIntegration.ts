...
export class ExternalOauthIntegration extends pulumi.CustomResource {
     ...
     * command to set the EXTERNAL_OAUTH_ADD_PRIVILEGED_ROLES_TO_BLOCKED_LIST account parameter to FALSE.
     */
    ...
    constructor(name: string, argsOrState?: ExternalOauthIntegrationArgs | ExternalOauthIntegrationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ExternalOauthIntegration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
