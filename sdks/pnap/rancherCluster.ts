...
export class RancherCluster extends pulumi.CustomResource {
    ...
    public readonly nodePools!: pulumi.Output<outputs.RancherClusterNodePools | undefined>;
    public /*out*/ readonly statusDescription!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.RancherClusterTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: RancherClusterArgs | RancherClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RancherCluster.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RancherClusterState {
    ...
    timeouts?: pulumi.Input<inputs.RancherClusterTimeouts>;
