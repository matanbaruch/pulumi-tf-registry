...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("pnap");
			params.setVersion("0.25.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3Bob2VuaXhuYXAvcG5hcCIsInZlcnNpb24iOiIwLjI1LjEifX0="), c => c.charCodeAt(0)));
