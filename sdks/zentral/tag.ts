...
export class Tag extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zentral:index/tag:Tag';
     ...
     */
    public readonly taxonomyId!: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: TagArgs | TagState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["taxonomyId"] = state ? state.taxonomyId : undefined;
        } else {
...
export interface TagState {
     ...
     * `ID` of the tag taxonomy.
     */
    taxonomyId?: pulumi.Input<number>;
}
