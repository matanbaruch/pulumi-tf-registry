...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("zentral");
			params.setVersion("0.1.50");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3plbnRyYWxvcGVuc291cmNlL3plbnRyYWwiLCJ2ZXJzaW9uIjoiMC4xLjUwIn19"), c => c.charCodeAt(0)));
