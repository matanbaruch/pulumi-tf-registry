...
export class Taxonomy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zentral:index/taxonomy:Taxonomy';
    ...
    constructor(name: string, argsOrState?: TaxonomyArgs | TaxonomyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Taxonomy.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
