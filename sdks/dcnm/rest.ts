...
export class Rest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'dcnm:index/rest:Rest';
    ...
    public readonly payloadType!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: RestArgs | RestState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["payloadType"] = state ? state.payloadType : undefined;
        } else {
            ...
            resourceInputs["payloadType"] = args ? args.payloadType : undefined;
        }
