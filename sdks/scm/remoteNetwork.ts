...
export class RemoteNetwork extends pulumi.CustomResource {
    ...
    /**
     * The Folder param. String can either be a specific string(`"Remote Networks"`) or match this regex:
     * `^[\s0-9a-zA-Z._-]{1,}$`. Default: `"Remote Networks"`.
     */
    ...
    /**
     * New customer will only be on aggregate bandwidth licensing. String length must exceed 1 characters. Default:
     * `"FWAAS-AGGREGATE"`.
     */
    ...
    constructor(name: string, argsOrState?: RemoteNetworkArgs | RemoteNetworkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RemoteNetwork.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
