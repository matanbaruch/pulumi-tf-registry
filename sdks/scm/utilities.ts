...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("scm");
			params.setVersion("0.9.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3BhbG9hbHRvbmV0d29ya3Mvc2NtIiwidmVyc2lvbiI6IjAuOS4yIn19"), c => c.charCodeAt(0)));
