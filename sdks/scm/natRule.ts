...
export class NatRule extends pulumi.CustomResource {
    ...
    /**
     * The destination address(es). Individual elements in this list are subject to additional validation. String must be one
     * of these: `"any"`.
     */
    ...
    /**
     * The source security zone(s). Individual elements in this list are subject to additional validation. String must be one
     * of these: `"any"`.
     */
    ...
    /**
     * The source address(es). Individual elements in this list are subject to additional validation. String must be one of
     * these: `"any"`.
     */
