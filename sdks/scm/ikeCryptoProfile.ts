...
export class IkeCryptoProfile extends pulumi.CustomResource {
     ...
     * Value must be less than or equal to 50. Default: `0`.
     */
    ...
    /**
     * The DhGroups param. Individual elements in this list are subject to additional validation. String must be one of these:
     * `"group1"`, `"group2"`, `"group5"`, `"group14"`, `"group19"`, `"group20"`.
     */
    public readonly dhGroups!: pulumi.Output<string[]>;
    /**
     * Encryption algorithm. Individual elements in this list are subject to additional validation. String must be one of
     * these: `"des"`, `"3des"`, `"aes-128-cbc"`, `"aes-192-cbc"`, `"aes-256-cbc"`, `"aes-128-gcm"`, `"aes-256-gcm"`.
     */
