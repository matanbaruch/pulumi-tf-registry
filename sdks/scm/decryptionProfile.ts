...
export class DecryptionProfile extends pulumi.CustomResource {
    ...
    /**
     * Must start with alphanumeric char and should contain only alphanemeric, underscore, hyphen, dot or space. String
     * validation regex: `^[A-Za-z0-9]{1}[A-Za-z0-9_\-\.\s]{0,}$`.
     */
    ...
    constructor(name: string, argsOrState?: DecryptionProfileArgs | DecryptionProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DecryptionProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
