...
export class ServiceConnection extends pulumi.CustomResource {
    ...
    /**
     * The Folder param. String can either be a specific string(`"Service Connections"`) or match this regex:
     * `^[0-9a-zA-Z._\s-]{1,}$`. Default: `"Service Connections"`.
     */
    ...
    /**
     * The NoExportCommunity param. String must be one of these: `"Disabled"`, `"Enabled-In"`, `"Enabled-Out"`,
     * `"Enabled-Both"`.
     */
    ...
    constructor(name: string, argsOrState?: ServiceConnectionArgs | ServiceConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
