...
export interface GetAntiSpywareSignatureListData {
    ...
    /**
     * threat id range <15000-18000> and <6900001-7000000>. Value must be between 15000 and 70000000.
     */
    threatId: number;
    /**
...
export interface GetHipObjectCustomChecksCriteriaPlistKey {
    /**
     * Key name. String length must not exceed 1023 characters.
     */
    name: string;
    /**
...
export interface GetVulnerabilityProtectionSignaturesListData {
    ...
    /**
     * threat id range <41000-45000> and <6800001-6900000>. Value must be between 41000 and 6900000.
     */
    threatId: number;
    /**
     * The Threatname param. String length must not exceed 1024 characters.
