...
export class TlsServiceProfile extends pulumi.CustomResource {
    ...
    /**
     * SSL TLS Service Profile name, value is muCustomDomainSSLProfile when it is used on mobile-agent infra settings. String
     * length must not exceed 127 characters. String validation regex: `^[a-zA-Z0-9._-]+$`.
     */
    ...
    constructor(name: string, argsOrState?: TlsServiceProfileArgs | TlsServiceProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TlsServiceProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
