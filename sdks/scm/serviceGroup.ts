...
export class ServiceGroup extends pulumi.CustomResource {
    ...
    /**
     * The Members param. Individual elements in this list are subject to additional validation. String length must not exceed
     * 63 characters.
     */
    ...
    /**
     * Tags for service group object. List must contain at most 64 elements. Individual elements in this list are subject to
