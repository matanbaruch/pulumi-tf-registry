...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("wavefront");
			params.setVersion("5.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Ztd2FyZS93YXZlZnJvbnQiLCJ2ZXJzaW9uIjoiNS4xLjAifX0="), c => c.charCodeAt(0)));
