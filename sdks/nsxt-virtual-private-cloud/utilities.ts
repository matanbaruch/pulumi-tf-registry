...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("nsxt-virtual-private-cloud");
			params.setVersion("1.0.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3Ztd2FyZS9uc3h0LXZpcnR1YWwtcHJpdmF0ZS1jbG91ZCIsInZlcnNpb24iOiIxLjAuMCJ9fQ=="), c => c.charCodeAt(0)));
