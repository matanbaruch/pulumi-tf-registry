...
export class VpcSecurityPolicyRule extends pulumi.CustomResource {
    /**
     * Get an existing VpcSecurityPolicyRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcSecurityPolicyRuleState, opts?: pulumi.CustomResourceOptions): VpcSecurityPolicyRule {
        return new VpcSecurityPolicyRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nsxt-virtual-private-cloud:index/vpcSecurityPolicyRule:VpcSecurityPolicyRule';

    /**
     * Returns true if the given object is an instance of VpcSecurityPolicyRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VpcSecurityPolicyRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VpcSecurityPolicyRule.__pulumiType;
    }
    ...
    public readonly serviceEntries!: pulumi.Output<outputs.VpcSecurityPolicyRuleServiceEntry[] | undefined>;
    ...
    public readonly tags!: pulumi.Output<outputs.VpcSecurityPolicyRuleTag[] | undefined>;

    /**
     * Create a VpcSecurityPolicyRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VpcSecurityPolicyRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VpcSecurityPolicyRuleArgs | VpcSecurityPolicyRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VpcSecurityPolicyRuleState | undefined;
            ...
            const args = argsOrState as VpcSecurityPolicyRuleArgs | undefined;
        ...
        super(VpcSecurityPolicyRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering VpcSecurityPolicyRule resources.
 */
export interface VpcSecurityPolicyRuleState {
    ...
    serviceEntries?: pulumi.Input<pulumi.Input<inputs.VpcSecurityPolicyRuleServiceEntry>[]>;
    services?: pulumi.Input<pulumi.Input<string>[]>;
    sourceGroups?: pulumi.Input<pulumi.Input<string>[]>;
    sourcesExcluded?: pulumi.Input<boolean>;
    tag?: pulumi.Input<string>;
    tags?: pulumi.Input<pulumi.Input<inputs.VpcSecurityPolicyRuleTag>[]>;
}

/**
 * The set of arguments for constructing a VpcSecurityPolicyRule resource.
 */
export interface VpcSecurityPolicyRuleArgs {
    action?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    destinationGroups?: pulumi.Input<pulumi.Input<string>[]>;
    destinationsExcluded?: pulumi.Input<boolean>;
