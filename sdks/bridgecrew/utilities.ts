...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("bridgecrew");
			params.setVersion("0.3.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3BhbG9hbHRvbmV0d29ya3MvYnJpZGdlY3JldyIsInZlcnNpb24iOiIwLjMuNyJ9fQ=="), c => c.charCodeAt(0)));
