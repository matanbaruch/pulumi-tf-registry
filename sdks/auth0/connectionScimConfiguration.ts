...
export class ConnectionScimConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly mappings!: pulumi.Output<outputs.ConnectionScimConfigurationMapping[] | undefined>;
    /**
    ...
    /**
     * User ID attribute for generation unique of user ids. If `user_id_attribute` is set, `mapping` must be set as well.
     * Defaults to `userName` for SAML connections and `externalId` for OIDC connections.
     */
    ...
    constructor(name: string, argsOrState?: ConnectionScimConfigurationArgs | ConnectionScimConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConnectionScimConfiguration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
