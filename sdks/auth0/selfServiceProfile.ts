...
export class SelfServiceProfile extends pulumi.CustomResource {
     ...
     */
    public readonly branding!: pulumi.Output<outputs.SelfServiceProfileBranding | undefined>;
    /**
    ...
    /**
     * This array stores the mapping information that will be shown to the user during the SS-SSO flow. The user will be
     * prompted to map the attributes on their identity provider to ensure the specified attributes get passed to Auth0.
     */
    ...
    constructor(name: string, argsOrState?: SelfServiceProfileArgs | SelfServiceProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SelfServiceProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
