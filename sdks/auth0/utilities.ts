...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("auth0");
			params.setVersion("1.5.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2F1dGgwL2F1dGgwIiwidmVyc2lvbiI6IjEuNS4wIn19"), c => c.charCodeAt(0)));
