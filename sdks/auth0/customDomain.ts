...
export class CustomDomain extends pulumi.CustomResource {
    ...
    /**
     * Once the configuration status is `ready`, the DNS name of the Auth0 origin server that handles traffic for the custom
     * domain.
     */
    ...
    /**
     * TLS policy for the custom domain. Available options are: `compatible` or `recommended`. Compatible includes TLS 1.0,
     * 1.1, 1.2, and recommended only includes TLS 1.2. Cannot be set on self_managed domains.
     */
