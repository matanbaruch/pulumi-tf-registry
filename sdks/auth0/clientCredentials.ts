...
export class ClientCredentials extends pulumi.CustomResource {
    ...
    /**
     * Configure the method to use when making requests to any endpoint that requires this client to authenticate. Options
     * include `none` (public client without a client secret), `client_secret_post` (confidential client using HTTP POST
     * parameters), `client_secret_basic` (confidential client using HTTP Basic), `private_key_jwt` (confidential client using
     * a Private Key JWT).
     */
    ...
    constructor(name: string, argsOrState?: ClientCredentialsArgs | ClientCredentialsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClientCredentials.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
