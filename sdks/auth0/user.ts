...
export class User extends pulumi.CustomResource {
    ...
    /**
     * Custom fields that store info about the user that impact the user's core functionality, such as how an application
     * functions or what the user can access. Examples include support plans and IDs for external accounts.
     */
    ...
    /**
     * Family name of the user. This value can only be updated if the connection is a database connection (using the Auth0
     * store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more
     * information, see: [Configure Identity Provider Connection for User Profile
     * Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
     */
    public readonly familyName!: pulumi.Output<string | undefined>;
    /**
     * Given name of the user. This value can only be updated if the connection is a database connection (using the Auth0
     * store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more
     * information, see: [Configure Identity Provider Connection for User Profile
     * Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
     */
    ...
    /**
     * Name of the user. This value can only be updated if the connection is a database connection (using the Auth0 store), a
     * passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more
     * information, see: [Configure Identity Provider Connection for User Profile
     * Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
     */
    public readonly name!: pulumi.Output<string>;
    /**
     * Preferred nickname or alias of the user. This value can only be updated if the connection is a database connection
     * (using the Auth0 store), a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each
     * login'. For more information, see: [Configure Identity Provider Connection for User Profile
     * Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
     */
    ...
    /**
     * Picture of the user. This value can only be updated if the connection is a database connection (using the Auth0 store),
     * a passwordless connection (email or sms) or has disabled 'Sync user profile attributes at each login'. For more
     * information, see: [Configure Identity Provider Connection for User Profile
     * Updates](https://auth0.com/docs/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0).
     */
    ...
    /**
     * Custom fields that store info about the user that does not impact a user's core functionality. Examples include work
     * address, home address, and user preferences.
     */
    ...
    /**
     * Indicates whether the user will receive a verification email after creation. Overrides behavior of `email_verified`
     * parameter.
     */
