...
export class PromptPartials extends pulumi.CustomResource {
    ...
    /**
     * The prompt that you are adding partials for. Options are: `login-id`, `login`, `login-password`, `signup`, `signup-id`,
     * `signup-password`.
     */
    ...
    constructor(name: string, argsOrState?: PromptPartialsArgs | PromptPartialsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PromptPartials.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
