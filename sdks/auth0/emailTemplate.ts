...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    /**
     * Body of the email template. You can include [common
     * variables](https://auth0.com/docs/customize/email/email-templates#common-variables).
     */
    ...
    /**
     * Email address to use as the sender. You can include [common
     * variables](https://auth0.com/docs/customize/email/email-templates#common-variables).
     */
    public readonly from!: pulumi.Output<string>;
    /**
     * Whether the `reset_email` and `verify_email` templates should include the user's email address as the email parameter in
     * the `returnUrl` (true) or whether no email address should be included in the redirect (false). Defaults to `true`.
     */
    public readonly includeEmailInRedirect!: pulumi.Output<boolean>;
    /**
     * URL to redirect the user to after a successful action. [Learn
     * more](https://auth0.com/docs/customize/email/email-templates#configure-template-fields).
     */
    public readonly resultUrl!: pulumi.Output<string | undefined>;
    /**
     * Subject line of the email. You can include [common
     * variables](https://auth0.com/docs/customize/email/email-templates#common-variables).
     */
    ...
    /**
     * Template name. Options include `verify_email`, `verify_email_by_code`, `reset_email`, `welcome_email`,
     * `blocked_account`, `stolen_credentials`, `enrollment_email`, `mfa_oob_code`, `user_invitation`, `change_password`
    ...
    constructor(name: string, argsOrState?: EmailTemplateArgs | EmailTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EmailTemplate.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
