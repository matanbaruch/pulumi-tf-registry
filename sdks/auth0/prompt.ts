...
export class Prompt extends pulumi.CustomResource {
    ...
    /**
     * Determines if the login screen uses identifier and biometrics first. Setting this property to `true`, requires MFA
     * factors enabled for enrollment; use the `auth0.Guardian` resource to set one up.
     */
    ...
    constructor(name: string, argsOrState?: PromptArgs | PromptState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Prompt.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
