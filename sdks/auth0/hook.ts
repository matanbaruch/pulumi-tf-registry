...
export class Hook extends pulumi.CustomResource {
    ...
    /**
     * Execution stage of this rule. Can be credentials-exchange, pre-user-registration, post-user-registration,
     * post-change-password, or send-phone-message.
     */
    ...
    constructor(name: string, argsOrState?: HookArgs | HookState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Hook.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
