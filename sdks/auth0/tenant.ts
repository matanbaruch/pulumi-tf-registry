...
export class Tenant extends pulumi.CustomResource {
    ...
    /**
     * API Audience to use by default for API Authorization flows. This setting is equivalent to appending the audience to
     * every authorization request made to the tenant for every application.
     */
    public readonly defaultAudience!: pulumi.Output<string>;
    /**
     * Name of the connection to be used for Password Grant exchanges. Options include `auth0-adldap`, `ad`, `auth0`, `email`,
     * `sms`, `waad`, and `adfs`.
     */
     ...
     */
    public readonly flags!: pulumi.Output<outputs.TenantFlags | undefined>;
    /**
    ...
    /**
     * URL of logo to be shown for the tenant. Recommended size is 150px x 150px. If no URL is provided, the Auth0 logo will be
     * used.
     */
    public readonly pictureUrl!: pulumi.Output<string>;
    /**
     * Selected sandbox version for the extensibility environment, which allows you to use custom scripts to extend parts of
     * Auth0's functionality.
     */
     ...
     */
    public readonly sessionCookie!: pulumi.Output<outputs.TenantSessionCookie | undefined>;
    /**
     ...
     */
    public readonly sessions!: pulumi.Output<outputs.TenantSessions | undefined>;
    /**
