...
export class PromptCustomText extends pulumi.CustomResource {
    ...
    /**
     * JSON containing the custom texts. You can check the options for each prompt
     * [here](https://auth0.com/docs/customize/universal-login-pages/customize-login-text-prompts#prompt-values).
     */
    public readonly body!: pulumi.Output<string>;
    /**
     * Language of the custom text. Options include: `ar`, `bg`, `bs`, `ca-ES`, `cs`, `cy`, `da`, `de`, `el`, `en`, `es`, `et`,
     * `eu-ES`, `fi`, `fr`, `fr-CA`, `fr-FR`, `gl-ES`, `he`, `hi`, `hr`, `hu`, `id`, `is`, `it`, `ja`, `ko`, `lt`, `lv`, `nb`,
     * `nl`, `nn`, `no`, `pl`, `pt`, `pt-BR`, `pt-PT`, `ro`, `ru`, `sk`, `sl`, `sr`, `sv`, `th`, `tr`, `uk`, `vi`, `zh-CN`,
     * `zh-TW`.
     */
    public readonly language!: pulumi.Output<string>;
    /**
     * The term `prompt` is used to refer to a specific step in the login flow. Options include: `captcha`, `common`,
     * `consent`, `custom-form`, `customized-consent`, `device-flow`, `email-otp-challenge`, `email-verification`,
     * `invitation`, `login`, `login-email-verification`, `login-id`, `login-password`, `login-passwordless`, `logout`, `mfa`,
     * `mfa-email`, `mfa-otp`, `mfa-phone`, `mfa-push`, `mfa-recovery-code`, `mfa-sms`, `mfa-voice`, `mfa-webauthn`,
     * `organizations`, `passkeys`, `phone-identifier-challenge`, `phone-identifier-enrollment`, `reset-password`, `signup`,
     * `signup-id`, `signup-password`, `status`.
     */
    ...
    constructor(name: string, argsOrState?: PromptCustomTextArgs | PromptCustomTextState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PromptCustomText.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
