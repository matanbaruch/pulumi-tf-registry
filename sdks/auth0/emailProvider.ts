...
export class EmailProvider extends pulumi.CustomResource {
    ...
    /**
     * Name of the email provider. Options include `azure_cs`, `mailgun`, `mandrill`, `ms365`, `sendgrid`, `ses`, `smtp` and
     * `sparkpost`.
     */
     ...
     */
    public readonly settings!: pulumi.Output<outputs.EmailProviderSettings | undefined>;
    ...
    constructor(name: string, argsOrState?: EmailProviderArgs | EmailProviderState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EmailProvider.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
