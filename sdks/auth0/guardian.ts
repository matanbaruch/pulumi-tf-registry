...
export class Guardian extends pulumi.CustomResource {
    ...
    /**
     * Configuration settings for the WebAuthn with FIDO Device Biometrics MFA. If this block is present, WebAuthn with FIDO
     * Device Biometrics MFA will be enabled, and disabled otherwise.
     */
    public readonly webauthnPlatform!: pulumi.Output<outputs.GuardianWebauthnPlatform | undefined>;
    /**
     * Configuration settings for the WebAuthn with FIDO Security Keys MFA. If this block is present, WebAuthn with FIDO
     * Security Keys MFA will be enabled, and disabled otherwise.
     */
    ...
    constructor(name: string, argsOrState?: GuardianArgs | GuardianState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Guardian.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
