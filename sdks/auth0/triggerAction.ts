...
export class TriggerAction extends pulumi.CustomResource {
    ...
    /**
     * The name for this action within the trigger. This can be useful for distinguishing between multiple instances of the
     * same action bound to a trigger. Defaults to action name when not provided.
     */
    public readonly displayName!: pulumi.Output<string>;
    /**
     * The ID of the trigger to bind with. Available options: `post-login`, `credentials-exchange`, `pre-user-registration`,
    ...
    constructor(name: string, argsOrState?: TriggerActionArgs | TriggerActionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TriggerAction.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
