...
export class OrganizationConnection extends pulumi.CustomResource {
     ...
     * When `false`, users must be granted membership in the organization before logging in with this connection.
     */
    ...
    /**
     * Determines whether organization sign-up should be enabled for this organization connection. Only applicable for database
     * connections. Note: `is_signup_enabled` can only be `true` if `assign_membership_on_login` is `true`.
     */
    ...
    /**
     * Determines whether a connection should be displayed on this organization’s login prompt. Only applicable for
    ...
    constructor(name: string, argsOrState?: OrganizationConnectionArgs | OrganizationConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
