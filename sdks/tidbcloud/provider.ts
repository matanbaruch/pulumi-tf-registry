...
/**
 * The provider type for the tidbcloud package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'tidbcloud';
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["sync"] = pulumi.output(args ? args.sync : undefined).apply(JSON.stringify);
        }
