...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("tidbcloud");
			params.setVersion("0.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3RpZGJjbG91ZC90aWRiY2xvdWQiLCJ2ZXJzaW9uIjoiMC4zLjAifX0="), c => c.charCodeAt(0)));
