...
export class Login extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'secretsmanager:index/login:Login';
     ...
     * FileRef field data.
     */
    public readonly fileRef!: pulumi.Output<outputs.LoginFileRef | undefined>;
    /**
     ...
     * Login field data.
     */
    public readonly login!: pulumi.Output<outputs.LoginLogin | undefined>;
    /**
     * The secret notes.
     */
     ...
     * Password field data.
     */
    public readonly password!: pulumi.Output<outputs.LoginPassword | undefined>;
    /**
     * The secret title.
     */
     ...
     * TOTP field data.
     */
    public readonly totp!: pulumi.Output<outputs.LoginTotp | undefined>;
    /**
     * The secret type.
     */
     ...
     * URL field data.
     */
    public readonly url!: pulumi.Output<outputs.LoginUrl | undefined>;
...
export interface LoginState {
     ...
     * FileRef field data.
     */
    fileRef?: pulumi.Input<inputs.LoginFileRef>;
    /**
     * The folder UID where the secret is stored. The parent shared folder must be non empty.
     */
     ...
     * Login field data.
     */
    login?: pulumi.Input<inputs.LoginLogin>;
    /**
     * The secret notes.
     */
     ...
     * Password field data.
     */
    password?: pulumi.Input<inputs.LoginPassword>;
    /**
     * The secret title.
     */
     ...
     * TOTP field data.
     */
    totp?: pulumi.Input<inputs.LoginTotp>;
    /**
     * The secret type.
     */
     ...
     * URL field data.
     */
    url?: pulumi.Input<inputs.LoginUrl>;
}
