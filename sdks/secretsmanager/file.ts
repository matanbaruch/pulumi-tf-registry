...
export class File extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'secretsmanager:index/file:File';
     ...
     * FileRef field data.
     */
    public readonly fileRef!: pulumi.Output<outputs.FileFileRef | undefined>;
    /**
...
export interface FileState {
     ...
     * FileRef field data.
     */
    fileRef?: pulumi.Input<inputs.FileFileRef>;
    /**
     * The folder UID where the secret is stored. The parent shared folder must be non empty.
     */
