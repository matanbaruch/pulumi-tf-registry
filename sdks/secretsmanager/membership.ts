...
export class Membership extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'secretsmanager:index/membership:Membership';
     ...
     */
    public readonly accountNumber!: pulumi.Output<outputs.MembershipAccountNumber | undefined>;
    /**
     * FileRef field data.
     */
    public readonly fileRef!: pulumi.Output<outputs.MembershipFileRef | undefined>;
    /**
     ...
     * Name field data.
     */
    public readonly name!: pulumi.Output<outputs.MembershipName | undefined>;
    /**
     * The secret notes.
     */
     ...
     * Password field data.
     */
    public readonly password!: pulumi.Output<outputs.MembershipPassword | undefined>;
    /**
     * The secret title.
     */
...
export interface MembershipState {
     ...
     * Account number field data.
     */
    accountNumber?: pulumi.Input<inputs.MembershipAccountNumber>;
    /**
     * FileRef field data.
     */
    fileRef?: pulumi.Input<inputs.MembershipFileRef>;
    /**
     * The folder UID where the secret is stored. The parent shared folder must be non empty.
     */
     ...
     * Name field data.
     */
    name?: pulumi.Input<inputs.MembershipName>;
    /**
     * The secret notes.
     */
     ...
     * Password field data.
     */
    password?: pulumi.Input<inputs.MembershipPassword>;
    /**
     * The secret title.
     */
