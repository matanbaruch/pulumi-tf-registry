...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("secretsmanager");
			params.setVersion("1.1.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2tlZXBlci1zZWN1cml0eS9zZWNyZXRzbWFuYWdlciIsInZlcnNpb24iOiIxLjEuNCJ9fQ=="), c => c.charCodeAt(0)));
