...
export class AgentToAgent extends pulumi.CustomResource {
    /**
     * Get an existing AgentToAgent resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentToAgentState, opts?: pulumi.CustomResourceOptions): AgentToAgent {
        return new AgentToAgent(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'thousandeyes:index/agentToAgent:AgentToAgent';

    /**
     * Returns true if the given object is an instance of AgentToAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentToAgent {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentToAgent.__pulumiType;
    }

    /**
     * The list of ThousandEyes agents to use.
     */
    public readonly agents!: pulumi.Output<outputs.AgentToAgentAgent[]>;
    /**
     ...
     */
    public readonly alertRules!: pulumi.Output<outputs.AgentToAgentAlertRule[] | undefined>;
    /**
     ...
     * and href elements.
     */
    public /*out*/ readonly apiLinks!: pulumi.Output<outputs.AgentToAgentApiLink[]>;
    /**
     ...
     */
    public readonly bgpMonitors!: pulumi.Output<outputs.AgentToAgentBgpMonitor[] | undefined>;
    /**
     * Created by user.
     */
     ...
     */
    public /*out*/ readonly groups!: pulumi.Output<outputs.AgentToAgentGroup[]>;
    /**
     ...
     */
    public readonly sharedWithAccounts!: pulumi.Output<outputs.AgentToAgentSharedWithAccount[] | undefined>;
    /**
     ...
     */
    public readonly throughputDuration!: pulumi.Output<number | undefined>;
    /**
     * Enables or disables throughput measurements. This is not allowed when the source or target of the test is a Cloud Agent.
     * Defaults to disabled.
     */
    public readonly throughputMeasurements!: pulumi.Output<boolean | undefined>;
    /**
     * Defines the throughput rate. Fo UDP tests only.
     */
    public readonly throughputRate!: pulumi.Output<number | undefined>;
    /**
     * The type of test.
     */
    ...
    /**
     * Create a AgentToAgent resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AgentToAgentArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AgentToAgentArgs | AgentToAgentState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AgentToAgentState | undefined;
            ...
            resourceInputs["throughputDuration"] = state ? state.throughputDuration : undefined;
            resourceInputs["throughputMeasurements"] = state ? state.throughputMeasurements : undefined;
            resourceInputs["throughputRate"] = state ? state.throughputRate : undefined;
            resourceInputs["type"] = state ? state.type : undefined;
            resourceInputs["usePublicBgp"] = state ? state.usePublicBgp : undefined;
        } else {
            const args = argsOrState as AgentToAgentArgs | undefined;
            ...
            resourceInputs["throughputDuration"] = args ? args.throughputDuration : undefined;
            resourceInputs["throughputMeasurements"] = args ? args.throughputMeasurements : undefined;
            resourceInputs["throughputRate"] = args ? args.throughputRate : undefined;
        ...
        super(AgentToAgent.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering AgentToAgent resources.
 */
export interface AgentToAgentState {
    /**
     * The list of ThousandEyes agents to use.
     */
    agents?: pulumi.Input<pulumi.Input<inputs.AgentToAgentAgent>[]>;
    /**
     * Gets the ruleId from the /alert-rules endpoint. If alertsEnabled is set to 'true' and alertRules is not included in a
     * creation/update query, the applicable defaults will be used.
     */
    alertRules?: pulumi.Input<pulumi.Input<inputs.AgentToAgentAlertRule>[]>;
    /**
     * Set to 'true' to enable alerts, or 'false' to disable alerts. The default value is 'true'.
     */
     ...
     * and href elements.
     */
    apiLinks?: pulumi.Input<pulumi.Input<inputs.AgentToAgentApiLink>[]>;
    /**
     * Enable BGP measurements. Set to true for enabled, false for disabled.
     */
     ...
     * The array of BGP monitor object IDs. The monitorIDs can be sourced from the /bgp-monitors endpoint.
     */
    bgpMonitors?: pulumi.Input<pulumi.Input<inputs.AgentToAgentBgpMonitor>[]>;
    /**
     * Created by user.
     */
     ...
     * The array of label objects.
     */
    groups?: pulumi.Input<pulumi.Input<inputs.AgentToAgentGroup>[]>;
    /**
     * The interval to run the test on, in seconds.
     */
     ...
     * [“serverName”: “fqdn of server”] The array of DNS Server objects.
     */
    sharedWithAccounts?: pulumi.Input<pulumi.Input<inputs.AgentToAgentSharedWithAccount>[]>;
    /**
     * The target agent's unique ID. Pulled from the /agents endpoint. Both the 'agents': [] and the targetAgentID cannot be
     * Cloud Agents. Can be Enterprise Agent > Cloud, Cloud > Enterprise Agent, or Enterprise Agent > Enterprise Agent.
     */
     ...
     * The throughput duration in milliseconds. The default value is 10000.
     */
    throughputDuration?: pulumi.Input<number>;
    /**
     * Enables or disables throughput measurements. This is not allowed when the source or target of the test is a Cloud Agent.
     * Defaults to disabled.
     */
    throughputMeasurements?: pulumi.Input<boolean>;
    /**
     * Defines the throughput rate. Fo UDP tests only.
     */
    throughputRate?: pulumi.Input<number>;
    /**
     * The type of test.
     */
...
/**
 * The set of arguments for constructing a AgentToAgent resource.
 */
export interface AgentToAgentArgs {
    /**
     * The list of ThousandEyes agents to use.
     */
    agents: pulumi.Input<pulumi.Input<inputs.AgentToAgentAgent>[]>;
