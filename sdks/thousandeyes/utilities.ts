...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("thousandeyes");
			params.setVersion("2.0.9");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3Rob3VzYW5kZXllcy90aG91c2FuZGV5ZXMiLCJ2ZXJzaW9uIjoiMi4wLjkifX0="), c => c.charCodeAt(0)));
