...
export class Dnssec extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'thousandeyes:index/dnssec:Dnssec';
     ...
     */
    public readonly agents!: pulumi.Output<outputs.DnssecAgent[]>;
    /**
     ...
     */
    public readonly alertRules!: pulumi.Output<outputs.DnssecAlertRule[] | undefined>;
    /**
     ...
     * and href elements.
     */
    public /*out*/ readonly apiLinks!: pulumi.Output<outputs.DnssecApiLink[]>;
    /**
     * Created by user.
     */
     ...
     */
    public /*out*/ readonly groups!: pulumi.Output<outputs.DnssecGroup[]>;
    /**
     ...
     */
    public readonly sharedWithAccounts!: pulumi.Output<outputs.DnssecSharedWithAccount[] | undefined>;
    /**
...
export interface DnssecState {
     ...
     * The list of ThousandEyes agents to use.
     */
    agents?: pulumi.Input<pulumi.Input<inputs.DnssecAgent>[]>;
    /**
     * Gets the ruleId from the /alert-rules endpoint. If alertsEnabled is set to 'true' and alertRules is not included in a
     * creation/update query, the applicable defaults will be used.
     */
    alertRules?: pulumi.Input<pulumi.Input<inputs.DnssecAlertRule>[]>;
    /**
     * Set to 'true' to enable alerts, or 'false' to disable alerts. The default value is 'true'.
     */
     ...
     * and href elements.
     */
    apiLinks?: pulumi.Input<pulumi.Input<inputs.DnssecApiLink>[]>;
    /**
     * Created by user.
     */
     ...
     * The array of label objects.
     */
    groups?: pulumi.Input<pulumi.Input<inputs.DnssecGroup>[]>;
    /**
     * The interval to run the test on, in seconds.
     */
     ...
     * [“serverName”: “fqdn of server”] The array of DNS Server objects.
     */
    sharedWithAccounts?: pulumi.Input<pulumi.Input<inputs.DnssecSharedWithAccount>[]>;
    /**
     * The unique ID of the test.
     */
