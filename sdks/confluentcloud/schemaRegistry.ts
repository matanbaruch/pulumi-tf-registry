...
export class SchemaRegistry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'confluentcloud:index/schemaRegistry:SchemaRegistry';
    ...
    constructor(name: string, argsOrState?: SchemaRegistryArgs | SchemaRegistryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SchemaRegistry.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
