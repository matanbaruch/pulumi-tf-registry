...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("confluentcloud");
			params.setVersion("0.0.15");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21vbmdleS9jb25mbHVlbnRjbG91ZCIsInZlcnNpb24iOiIwLjAuMTUifX0="), c => c.charCodeAt(0)));
