...
export class Item extends pulumi.CustomResource {
     ...
     */
    public readonly passwordRecipes!: pulumi.Output<outputs.ItemPasswordRecipe[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ItemArgs | ItemState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["passwordRecipes"] = state ? state.passwordRecipes : undefined;
            ...
            resourceInputs["passwordRecipes"] = args ? args.passwordRecipes : undefined;
...
export interface ItemState {
     ...
     * The recipe used to generate a new value for a password.
     */
    passwordRecipes?: pulumi.Input<pulumi.Input<inputs.ItemPasswordRecipe>[]>;
    /**
     * (Only applies to the database category) The port the database is listening on.
     */
