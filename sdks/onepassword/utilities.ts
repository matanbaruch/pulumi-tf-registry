...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("onepassword");
			params.setVersion("2.1.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnLzFwYXNzd29yZC9vbmVwYXNzd29yZCIsInZlcnNpb24iOiIyLjEuMiJ9fQ=="), c => c.charCodeAt(0)));
