...
export class GrafanaDashboard extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'logzio:index/grafanaDashboard:GrafanaDashboard';
    ...
    public /*out*/ readonly dashboardUid!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: GrafanaDashboardArgs | GrafanaDashboardState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dashboardUid"] = undefined /*out*/;
            resourceInputs["url"] = undefined /*out*/;
            resourceInputs["version"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(GrafanaDashboard.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
