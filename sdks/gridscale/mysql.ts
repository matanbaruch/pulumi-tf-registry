...
export class Mysql extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gridscale:index/mysql:Mysql';
     ...
     */
    public /*out*/ readonly listenPorts!: pulumi.Output<outputs.MysqlListenPort[]>;
    /**
     ...
     */
    public readonly mysqlBinlogFormat!: pulumi.Output<string | undefined>;
    /**
     * Server Timezone.
     */
     ...
     * Binary Logging.
     */
    public readonly mysqlLogBin!: pulumi.Output<boolean | undefined>;
    /**
     ...
     * Enable query cache.
     */
    public readonly mysqlQueryCache!: pulumi.Output<boolean | undefined>;
    /**
     * Query Cache Limit. Format: xM (where x is an integer, M stands for unit: k(kB), M(MB), G(GB)).
     */
    public readonly mysqlQueryCacheLimit!: pulumi.Output<string | undefined>;
    /**
     * Query Cache Size. Format: xM (where x is an integer, M stands for unit: k(kB), M(MB), G(GB)).
     */
    public readonly mysqlQueryCacheSize!: pulumi.Output<string | undefined>;
    /**
     * Server Id.
     */
    public readonly mysqlServerId!: pulumi.Output<number | undefined>;
    /**
     * SQL Mode.
     */
    ...
    constructor(name: string, argsOrState?: MysqlArgs | MysqlState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mysqlBinlogFormat"] = state ? state.mysqlBinlogFormat : undefined;
            resourceInputs["mysqlDefaultTimeZone"] = state ? state.mysqlDefaultTimeZone : undefined;
            resourceInputs["mysqlLogBin"] = state ? state.mysqlLogBin : undefined;
            ...
            resourceInputs["mysqlQueryCache"] = state ? state.mysqlQueryCache : undefined;
            resourceInputs["mysqlQueryCacheLimit"] = state ? state.mysqlQueryCacheLimit : undefined;
            resourceInputs["mysqlQueryCacheSize"] = state ? state.mysqlQueryCacheSize : undefined;
            ...
            resourceInputs["mysqlBinlogFormat"] = args ? args.mysqlBinlogFormat : undefined;
            resourceInputs["mysqlDefaultTimeZone"] = args ? args.mysqlDefaultTimeZone : undefined;
            resourceInputs["mysqlLogBin"] = args ? args.mysqlLogBin : undefined;
            ...
            resourceInputs["mysqlQueryCache"] = args ? args.mysqlQueryCache : undefined;
            resourceInputs["mysqlQueryCacheLimit"] = args ? args.mysqlQueryCacheLimit : undefined;
            resourceInputs["mysqlQueryCacheSize"] = args ? args.mysqlQueryCacheSize : undefined;
...
export interface MysqlState {
     ...
     * The port numbers where this MySQL service accepts connections.
     */
    listenPorts?: pulumi.Input<pulumi.Input<inputs.MysqlListenPort>[]>;
    /**
     * Maximum CPU core count. The MySQL instance's CPU core count will be autoscaled based on the workload. The number of
     * cores stays between 1 and `max_core_count`.
     */
     ...
     * Binary Logging Format.
     */
    mysqlBinlogFormat?: pulumi.Input<string>;
    /**
     * Server Timezone.
     */
     ...
     * Binary Logging.
     */
    mysqlLogBin?: pulumi.Input<boolean>;
    /**
     * Max Allowed Packet Size. Format: xM (where x is an integer, M stands for unit: k(kB), M(MB), G(GB)).
     */
     ...
     * Enable query cache.
     */
    mysqlQueryCache?: pulumi.Input<boolean>;
    /**
     * Query Cache Limit. Format: xM (where x is an integer, M stands for unit: k(kB), M(MB), G(GB)).
     */
    mysqlQueryCacheLimit?: pulumi.Input<string>;
    /**
     * Query Cache Size. Format: xM (where x is an integer, M stands for unit: k(kB), M(MB), G(GB)).
     */
    mysqlQueryCacheSize?: pulumi.Input<string>;
    /**
     * Server Id.
     */
    mysqlServerId?: pulumi.Input<number>;
    /**
     * SQL Mode.
     */
