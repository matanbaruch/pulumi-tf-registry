...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gridscale");
			params.setVersion("1.26.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2dyaWRzY2FsZS9ncmlkc2NhbGUiLCJ2ZXJzaW9uIjoiMS4yNi4wIn19"), c => c.charCodeAt(0)));
