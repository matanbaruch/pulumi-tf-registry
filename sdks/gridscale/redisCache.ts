...
export class RedisCache extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gridscale:index/redisCache:RedisCache';
     ...
     */
    public /*out*/ readonly listenPorts!: pulumi.Output<outputs.RedisCacheListenPort[]>;
    /**
    ...
    /**
     * Password for Redis cache service. It is used to connect to the Redis cache instance.
     */
     ...
     * get the list of available Redis cache service releases.
     */
    ...
    /**
     * Username for Redis cache service. It is used to connect to the Redis cache instance.
     */
...
export interface RedisCacheState {
     ...
     * The port numbers where this Redis cache service accepts connections.
     */
    listenPorts?: pulumi.Input<pulumi.Input<inputs.RedisCacheListenPort>[]>;
    /**
     * The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.
     */
