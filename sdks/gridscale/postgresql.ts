...
export class Postgresql extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gridscale:index/postgresql:Postgresql';
     ...
     */
    public /*out*/ readonly listenPorts!: pulumi.Output<outputs.PostgresqlListenPort[]>;
    /**
     * Maximum CPU core count. The PostgreSQL instance's CPU core count will be autoscaled based on the workload. The number of
    ...
    /**
     * Password for PostgreSQL service. It is used to connect to the PostgreSQL instance.
     */
     ...
     */
    public readonly pgauditLogAccessKey!: pulumi.Output<string>;
    /**
     * Object Storage bucket to upload audit logs to. For pgAudit to be enabled these additional parameters need to be
     * configured: pgaudit_log_server_url, pgaudit_log_access_key, pgaudit_log_secret_key.
     */
    public readonly pgauditLogBucket!: pulumi.Output<string>;
    /**
     * Rotation (in minutes) for audit logs. Logs are uploaded to Object Storage once rotated.
     */
    public readonly pgauditLogRotationFrequency!: pulumi.Output<number>;
    /**
     * Secret key used to authenticate against Object Storage server.
     */
    public readonly pgauditLogSecretKey!: pulumi.Output<string>;
    /**
     * Object Storage server URL the bucket is located on.
     */
    public readonly pgauditLogServerUrl!: pulumi.Output<string>;
    /**
     * The PostgreSQL release of this instance.\n For convenience, please use gscloud https://github.com/gridscale/gscloud to
     * get the list of available PostgreSQL service releases.
     */
    ...
    /**
     * Username for PostgreSQL service. It is used to connect to the PostgreSQL instance.
     */
    ...
    constructor(name: string, argsOrState?: PostgresqlArgs | PostgresqlState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["pgauditLogAccessKey"] = state ? state.pgauditLogAccessKey : undefined;
            resourceInputs["pgauditLogBucket"] = state ? state.pgauditLogBucket : undefined;
            resourceInputs["pgauditLogRotationFrequency"] = state ? state.pgauditLogRotationFrequency : undefined;
            resourceInputs["pgauditLogSecretKey"] = state ? state.pgauditLogSecretKey : undefined;
            resourceInputs["pgauditLogServerUrl"] = state ? state.pgauditLogServerUrl : undefined;
            ...
            resourceInputs["pgauditLogAccessKey"] = args ? args.pgauditLogAccessKey : undefined;
            resourceInputs["pgauditLogBucket"] = args ? args.pgauditLogBucket : undefined;
            resourceInputs["pgauditLogRotationFrequency"] = args ? args.pgauditLogRotationFrequency : undefined;
            resourceInputs["pgauditLogSecretKey"] = args ? args.pgauditLogSecretKey : undefined;
            resourceInputs["pgauditLogServerUrl"] = args ? args.pgauditLogServerUrl : undefined;
...
export interface PostgresqlState {
     ...
     * The port numbers where this PostgreSQL service accepts connections.
     */
    listenPorts?: pulumi.Input<pulumi.Input<inputs.PostgresqlListenPort>[]>;
    /**
     * Maximum CPU core count. The PostgreSQL instance's CPU core count will be autoscaled based on the workload. The number of
     * cores stays between 1 and `max_core_count`.
     */
     ...
     * Access key used to authenticate against Object Storage server.
     */
    pgauditLogAccessKey?: pulumi.Input<string>;
    /**
     * Object Storage bucket to upload audit logs to. For pgAudit to be enabled these additional parameters need to be
     * configured: pgaudit_log_server_url, pgaudit_log_access_key, pgaudit_log_secret_key.
     */
    pgauditLogBucket?: pulumi.Input<string>;
    /**
     * Rotation (in minutes) for audit logs. Logs are uploaded to Object Storage once rotated.
     */
    pgauditLogRotationFrequency?: pulumi.Input<number>;
    /**
     * Secret key used to authenticate against Object Storage server.
     */
    pgauditLogSecretKey?: pulumi.Input<string>;
    /**
     * Object Storage server URL the bucket is located on.
     */
    pgauditLogServerUrl?: pulumi.Input<string>;
    /**
     * The PostgreSQL release of this instance.\n For convenience, please use gscloud https://github.com/gridscale/gscloud to
     * get the list of available PostgreSQL service releases.
     */
