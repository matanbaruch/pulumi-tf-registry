...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("netapp-gcp");
			params.setVersion("24.6.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL25ldGFwcC9uZXRhcHAtZ2NwIiwidmVyc2lvbiI6IjI0LjYuMCJ9fQ=="), c => c.charCodeAt(0)));
