...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("vmworkstation");
			params.setVersion("1.1.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Vsc3VkYW5vL3Ztd29ya3N0YXRpb24iLCJ2ZXJzaW9uIjoiMS4xLjYifX0="), c => c.charCodeAt(0)));
