...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("devcycle");
			params.setVersion("1.0.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2RldmN5Y2xlaHEvZGV2Y3ljbGUiLCJ2ZXJzaW9uIjoiMS4wLjIifX0="), c => c.charCodeAt(0)));
