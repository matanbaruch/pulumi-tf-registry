...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudvision");
			params.setVersion("0.1.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FyaXN0YW5ldHdvcmtzL2Nsb3VkdmlzaW9uIiwidmVyc2lvbiI6IjAuMS42In19"), c => c.charCodeAt(0)));
