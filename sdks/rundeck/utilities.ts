...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("rundeck");
			params.setVersion("0.4.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3J1bmRlY2svcnVuZGVjayIsInZlcnNpb24iOiIwLjQuNyJ9fQ=="), c => c.charCodeAt(0)));
