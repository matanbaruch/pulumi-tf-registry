...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ilert");
			params.setVersion("2.9.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2lsZXJ0L2lsZXJ0IiwidmVyc2lvbiI6IjIuOS4wIn19"), c => c.charCodeAt(0)));
