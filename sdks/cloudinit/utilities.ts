...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cloudinit");
			params.setVersion("2.3.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hhc2hpY29ycC9jbG91ZGluaXQiLCJ2ZXJzaW9uIjoiMi4zLjQifX0="), c => c.charCodeAt(0)));
