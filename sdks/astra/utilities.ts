...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("astra");
			params.setVersion("2.3.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2RhdGFzdGF4L2FzdHJhIiwidmVyc2lvbiI6IjIuMy42In19"), c => c.charCodeAt(0)));
