...
export class SystemAdminLdap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemAdminLdap:SystemAdminLdap';
    ...
    public readonly fazadoms!: pulumi.Output<outputs.SystemAdminLdapFazadom[] | undefined>;
...
export interface SystemAdminLdapState {
    ...
    fazadoms?: pulumi.Input<pulumi.Input<inputs.SystemAdminLdapFazadom>[]>;
