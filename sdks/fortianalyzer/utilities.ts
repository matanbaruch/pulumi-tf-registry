...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("fortianalyzer");
			params.setVersion("1.4.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2ZvcnRpbmV0ZGV2L2ZvcnRpYW5hbHl6ZXIiLCJ2ZXJzaW9uIjoiMS40LjEifX0="), c => c.charCodeAt(0)));
