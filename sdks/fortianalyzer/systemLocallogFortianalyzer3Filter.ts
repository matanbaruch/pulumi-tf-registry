...
export class SystemLocallogFortianalyzer3Filter extends pulumi.CustomResource {
    /**
     * Get an existing SystemLocallogFortianalyzer3Filter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLocallogFortianalyzer3FilterState, opts?: pulumi.CustomResourceOptions): SystemLocallogFortianalyzer3Filter {
        return new SystemLocallogFortianalyzer3Filter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLocallogFortianalyzer3Filter:SystemLocallogFortianalyzer3Filter';

    /**
     * Returns true if the given object is an instance of SystemLocallogFortianalyzer3Filter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLocallogFortianalyzer3Filter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLocallogFortianalyzer3Filter.__pulumiType;
    }
    ...
    /**
     * Create a SystemLocallogFortianalyzer3Filter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLocallogFortianalyzer3FilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLocallogFortianalyzer3FilterArgs | SystemLocallogFortianalyzer3FilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLocallogFortianalyzer3FilterState | undefined;
            ...
            const args = argsOrState as SystemLocallogFortianalyzer3FilterArgs | undefined;
        ...
        super(SystemLocallogFortianalyzer3Filter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLocallogFortianalyzer3Filter resources.
 */
export interface SystemLocallogFortianalyzer3FilterState {
...
/**
 * The set of arguments for constructing a SystemLocallogFortianalyzer3Filter resource.
 */
export interface SystemLocallogFortianalyzer3FilterArgs {
    aid?: pulumi.Input<string>;
    controller?: pulumi.Input<string>;
    devcfg?: pulumi.Input<string>;
    devops?: pulumi.Input<string>;
