...
export class SystemLogfetchClientprofile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLogfetchClientprofile:SystemLogfetchClientprofile';
    ...
    public readonly endTimes!: pulumi.Output<string[] | undefined>;
