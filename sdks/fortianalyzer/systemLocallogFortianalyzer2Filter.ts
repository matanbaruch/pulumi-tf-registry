...
export class SystemLocallogFortianalyzer2Filter extends pulumi.CustomResource {
    /**
     * Get an existing SystemLocallogFortianalyzer2Filter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLocallogFortianalyzer2FilterState, opts?: pulumi.CustomResourceOptions): SystemLocallogFortianalyzer2Filter {
        return new SystemLocallogFortianalyzer2Filter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLocallogFortianalyzer2Filter:SystemLocallogFortianalyzer2Filter';

    /**
     * Returns true if the given object is an instance of SystemLocallogFortianalyzer2Filter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLocallogFortianalyzer2Filter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLocallogFortianalyzer2Filter.__pulumiType;
    }
    ...
    /**
     * Create a SystemLocallogFortianalyzer2Filter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLocallogFortianalyzer2FilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLocallogFortianalyzer2FilterArgs | SystemLocallogFortianalyzer2FilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLocallogFortianalyzer2FilterState | undefined;
            ...
            const args = argsOrState as SystemLocallogFortianalyzer2FilterArgs | undefined;
        ...
        super(SystemLocallogFortianalyzer2Filter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLocallogFortianalyzer2Filter resources.
 */
export interface SystemLocallogFortianalyzer2FilterState {
...
/**
 * The set of arguments for constructing a SystemLocallogFortianalyzer2Filter resource.
 */
export interface SystemLocallogFortianalyzer2FilterArgs {
    aid?: pulumi.Input<string>;
    controller?: pulumi.Input<string>;
    devcfg?: pulumi.Input<string>;
    devops?: pulumi.Input<string>;
