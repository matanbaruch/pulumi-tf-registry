...
export class SystemLocallogMemoryFilter extends pulumi.CustomResource {
    /**
     * Get an existing SystemLocallogMemoryFilter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLocallogMemoryFilterState, opts?: pulumi.CustomResourceOptions): SystemLocallogMemoryFilter {
        return new SystemLocallogMemoryFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLocallogMemoryFilter:SystemLocallogMemoryFilter';

    /**
     * Returns true if the given object is an instance of SystemLocallogMemoryFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLocallogMemoryFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLocallogMemoryFilter.__pulumiType;
    }
    ...
    /**
     * Create a SystemLocallogMemoryFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLocallogMemoryFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLocallogMemoryFilterArgs | SystemLocallogMemoryFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLocallogMemoryFilterState | undefined;
            ...
            const args = argsOrState as SystemLocallogMemoryFilterArgs | undefined;
        ...
        super(SystemLocallogMemoryFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLocallogMemoryFilter resources.
 */
export interface SystemLocallogMemoryFilterState {
...
/**
 * The set of arguments for constructing a SystemLocallogMemoryFilter resource.
 */
export interface SystemLocallogMemoryFilterArgs {
    aid?: pulumi.Input<string>;
    controller?: pulumi.Input<string>;
    devcfg?: pulumi.Input<string>;
    devops?: pulumi.Input<string>;
