...
export class SystemLocallogFortianalyzerFilter extends pulumi.CustomResource {
    /**
     * Get an existing SystemLocallogFortianalyzerFilter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLocallogFortianalyzerFilterState, opts?: pulumi.CustomResourceOptions): SystemLocallogFortianalyzerFilter {
        return new SystemLocallogFortianalyzerFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLocallogFortianalyzerFilter:SystemLocallogFortianalyzerFilter';

    /**
     * Returns true if the given object is an instance of SystemLocallogFortianalyzerFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLocallogFortianalyzerFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLocallogFortianalyzerFilter.__pulumiType;
    }
    ...
    /**
     * Create a SystemLocallogFortianalyzerFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLocallogFortianalyzerFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLocallogFortianalyzerFilterArgs | SystemLocallogFortianalyzerFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLocallogFortianalyzerFilterState | undefined;
            ...
            const args = argsOrState as SystemLocallogFortianalyzerFilterArgs | undefined;
        ...
        super(SystemLocallogFortianalyzerFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLocallogFortianalyzerFilter resources.
 */
export interface SystemLocallogFortianalyzerFilterState {
...
/**
 * The set of arguments for constructing a SystemLocallogFortianalyzerFilter resource.
 */
export interface SystemLocallogFortianalyzerFilterArgs {
    aid?: pulumi.Input<string>;
    controller?: pulumi.Input<string>;
    devcfg?: pulumi.Input<string>;
    devops?: pulumi.Input<string>;
