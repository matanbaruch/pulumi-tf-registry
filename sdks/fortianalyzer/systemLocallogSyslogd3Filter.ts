...
export class SystemLocallogSyslogd3Filter extends pulumi.CustomResource {
    /**
     * Get an existing SystemLocallogSyslogd3Filter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLocallogSyslogd3FilterState, opts?: pulumi.CustomResourceOptions): SystemLocallogSyslogd3Filter {
        return new SystemLocallogSyslogd3Filter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLocallogSyslogd3Filter:SystemLocallogSyslogd3Filter';

    /**
     * Returns true if the given object is an instance of SystemLocallogSyslogd3Filter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLocallogSyslogd3Filter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLocallogSyslogd3Filter.__pulumiType;
    }
    ...
    /**
     * Create a SystemLocallogSyslogd3Filter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLocallogSyslogd3FilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLocallogSyslogd3FilterArgs | SystemLocallogSyslogd3FilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLocallogSyslogd3FilterState | undefined;
            ...
            const args = argsOrState as SystemLocallogSyslogd3FilterArgs | undefined;
        ...
        super(SystemLocallogSyslogd3Filter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLocallogSyslogd3Filter resources.
 */
export interface SystemLocallogSyslogd3FilterState {
...
/**
 * The set of arguments for constructing a SystemLocallogSyslogd3Filter resource.
 */
export interface SystemLocallogSyslogd3FilterArgs {
    aid?: pulumi.Input<string>;
    controller?: pulumi.Input<string>;
    devcfg?: pulumi.Input<string>;
    devops?: pulumi.Input<string>;
