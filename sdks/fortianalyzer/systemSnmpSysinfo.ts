...
export class SystemSnmpSysinfo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemSnmpSysinfo:SystemSnmpSysinfo';
    ...
    public readonly fortianalyzerLegacySysoid!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: SystemSnmpSysinfoArgs | SystemSnmpSysinfoState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["fortianalyzerLegacySysoid"] = state ? state.fortianalyzerLegacySysoid : undefined;
            ...
            resourceInputs["fortianalyzerLegacySysoid"] = args ? args.fortianalyzerLegacySysoid : undefined;
...
export interface SystemSnmpSysinfoState {
    ...
    fortianalyzerLegacySysoid?: pulumi.Input<string>;
