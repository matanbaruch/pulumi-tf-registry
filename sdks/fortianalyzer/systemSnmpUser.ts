...
export class SystemSnmpUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemSnmpUser:SystemSnmpUser';
    ...
    public readonly authPwds!: pulumi.Output<string[] | undefined>;
    ...
    public readonly privPwds!: pulumi.Output<string[] | undefined>;
