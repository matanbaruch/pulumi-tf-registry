...
export class SystemLocallogSyslogd2Filter extends pulumi.CustomResource {
    /**
     * Get an existing SystemLocallogSyslogd2Filter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLocallogSyslogd2FilterState, opts?: pulumi.CustomResourceOptions): SystemLocallogSyslogd2Filter {
        return new SystemLocallogSyslogd2Filter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLocallogSyslogd2Filter:SystemLocallogSyslogd2Filter';

    /**
     * Returns true if the given object is an instance of SystemLocallogSyslogd2Filter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLocallogSyslogd2Filter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLocallogSyslogd2Filter.__pulumiType;
    }
    ...
    /**
     * Create a SystemLocallogSyslogd2Filter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLocallogSyslogd2FilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLocallogSyslogd2FilterArgs | SystemLocallogSyslogd2FilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLocallogSyslogd2FilterState | undefined;
            ...
            const args = argsOrState as SystemLocallogSyslogd2FilterArgs | undefined;
        ...
        super(SystemLocallogSyslogd2Filter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLocallogSyslogd2Filter resources.
 */
export interface SystemLocallogSyslogd2FilterState {
...
/**
 * The set of arguments for constructing a SystemLocallogSyslogd2Filter resource.
 */
export interface SystemLocallogSyslogd2FilterArgs {
    aid?: pulumi.Input<string>;
    controller?: pulumi.Input<string>;
    devcfg?: pulumi.Input<string>;
    devops?: pulumi.Input<string>;
