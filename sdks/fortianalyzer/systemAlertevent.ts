...
export class SystemAlertevent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemAlertevent:SystemAlertevent';
    ...
    public readonly enableGenericTextUnitary!: pulumi.Output<string>;
    public readonly enableGenericTexts!: pulumi.Output<string[]>;
    public readonly enableSeverityFilterUnitary!: pulumi.Output<string>;
    ...
    public readonly severityLevelCompUnitary!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: SystemAlerteventArgs | SystemAlerteventState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["enableGenericTextUnitary"] = state ? state.enableGenericTextUnitary : undefined;
            resourceInputs["enableGenericTexts"] = state ? state.enableGenericTexts : undefined;
            resourceInputs["enableSeverityFilterUnitary"] = state ? state.enableSeverityFilterUnitary : undefined;
            ...
            resourceInputs["severityLevelCompUnitary"] = state ? state.severityLevelCompUnitary : undefined;
            ...
            resourceInputs["enableGenericTextUnitary"] = args ? args.enableGenericTextUnitary : undefined;
            resourceInputs["enableGenericTexts"] = args ? args.enableGenericTexts : undefined;
            resourceInputs["enableSeverityFilterUnitary"] = args ? args.enableSeverityFilterUnitary : undefined;
            ...
            resourceInputs["severityLevelCompUnitary"] = args ? args.severityLevelCompUnitary : undefined;
...
export interface SystemAlerteventState {
    ...
    enableGenericTextUnitary?: pulumi.Input<string>;
    enableGenericTexts?: pulumi.Input<pulumi.Input<string>[]>;
    enableSeverityFilterUnitary?: pulumi.Input<string>;
    ...
    severityLevelCompUnitary?: pulumi.Input<string>;
