...
export class SystemBackupAllsettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemBackupAllsettings:SystemBackupAllsettings';
    ...
    public readonly crptpasswds!: pulumi.Output<string[] | undefined>;
