...
export class SystemLocallogDiskFilter extends pulumi.CustomResource {
    /**
     * Get an existing SystemLocallogDiskFilter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLocallogDiskFilterState, opts?: pulumi.CustomResourceOptions): SystemLocallogDiskFilter {
        return new SystemLocallogDiskFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLocallogDiskFilter:SystemLocallogDiskFilter';

    /**
     * Returns true if the given object is an instance of SystemLocallogDiskFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLocallogDiskFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLocallogDiskFilter.__pulumiType;
    }
    ...
    /**
     * Create a SystemLocallogDiskFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLocallogDiskFilterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLocallogDiskFilterArgs | SystemLocallogDiskFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLocallogDiskFilterState | undefined;
            ...
            const args = argsOrState as SystemLocallogDiskFilterArgs | undefined;
        ...
        super(SystemLocallogDiskFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLocallogDiskFilter resources.
 */
export interface SystemLocallogDiskFilterState {
...
/**
 * The set of arguments for constructing a SystemLocallogDiskFilter resource.
 */
export interface SystemLocallogDiskFilterArgs {
    aid?: pulumi.Input<string>;
    controller?: pulumi.Input<string>;
    devcfg?: pulumi.Input<string>;
    devops?: pulumi.Input<string>;
