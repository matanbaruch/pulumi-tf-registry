...
export class SystemLogSettingsRollinglocal extends pulumi.CustomResource {
    /**
     * Get an existing SystemLogSettingsRollinglocal resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLogSettingsRollinglocalState, opts?: pulumi.CustomResourceOptions): SystemLogSettingsRollinglocal {
        return new SystemLogSettingsRollinglocal(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLogSettingsRollinglocal:SystemLogSettingsRollinglocal';

    /**
     * Returns true if the given object is an instance of SystemLogSettingsRollinglocal.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLogSettingsRollinglocal {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLogSettingsRollinglocal.__pulumiType;
    }

    public readonly days!: pulumi.Output<string[] | undefined>;
    ...
    /**
     * Create a SystemLogSettingsRollinglocal resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLogSettingsRollinglocalArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLogSettingsRollinglocalArgs | SystemLogSettingsRollinglocalState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLogSettingsRollinglocalState | undefined;
            ...
            const args = argsOrState as SystemLogSettingsRollinglocalArgs | undefined;
        ...
        super(SystemLogSettingsRollinglocal.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLogSettingsRollinglocal resources.
 */
export interface SystemLogSettingsRollinglocalState {
...
/**
 * The set of arguments for constructing a SystemLogSettingsRollinglocal resource.
 */
export interface SystemLogSettingsRollinglocalArgs {
    days?: pulumi.Input<pulumi.Input<string>[]>;
    delFiles?: pulumi.Input<string>;
    directory?: pulumi.Input<string>;
    fileSize?: pulumi.Input<number>;
