...
export class SystemLogSettingsRollingregular extends pulumi.CustomResource {
    /**
     * Get an existing SystemLogSettingsRollingregular resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLogSettingsRollingregularState, opts?: pulumi.CustomResourceOptions): SystemLogSettingsRollingregular {
        return new SystemLogSettingsRollingregular(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortianalyzer:index/systemLogSettingsRollingregular:SystemLogSettingsRollingregular';

    /**
     * Returns true if the given object is an instance of SystemLogSettingsRollingregular.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemLogSettingsRollingregular {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SystemLogSettingsRollingregular.__pulumiType;
    }
    ...
    public readonly rollingUpgradeStatus!: pulumi.Output<number>;
    ...
    /**
     * Create a SystemLogSettingsRollingregular resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: SystemLogSettingsRollingregularArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SystemLogSettingsRollingregularArgs | SystemLogSettingsRollingregularState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemLogSettingsRollingregularState | undefined;
            ...
            const args = argsOrState as SystemLogSettingsRollingregularArgs | undefined;
        ...
        super(SystemLogSettingsRollingregular.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering SystemLogSettingsRollingregular resources.
 */
export interface SystemLogSettingsRollingregularState {
...
/**
 * The set of arguments for constructing a SystemLogSettingsRollingregular resource.
 */
export interface SystemLogSettingsRollingregularArgs {
    days?: pulumi.Input<pulumi.Input<string>[]>;
    delFiles?: pulumi.Input<string>;
    directory?: pulumi.Input<string>;
    fileSize?: pulumi.Input<number>;
