...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("zedcloud");
			params.setVersion("2.2.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3plZGVkYS96ZWRjbG91ZCIsInZlcnNpb24iOiIyLjIuNyJ9fQ=="), c => c.charCodeAt(0)));
