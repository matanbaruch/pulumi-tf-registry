...
export class UserSchema extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gsuite:index/userSchema:UserSchema';
    ...
    public readonly fields!: pulumi.Output<outputs.UserSchemaField[]>;
    ...
    constructor(name: string, argsOrState?: UserSchemaArgs | UserSchemaState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserSchema.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface UserSchemaState {
    ...
    fields?: pulumi.Input<pulumi.Input<inputs.UserSchemaField>[]>;
