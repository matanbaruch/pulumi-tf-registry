...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("gsuite");
			params.setVersion("0.1.62");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2RldmlhdmlyL2dzdWl0ZSIsInZlcnNpb24iOiIwLjEuNjIifX0="), c => c.charCodeAt(0)));
