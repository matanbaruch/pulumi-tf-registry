...
/**
 * The provider type for the gsuite package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'gsuite';
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["timeoutMinutes"] = pulumi.output(args ? args.timeoutMinutes : undefined).apply(JSON.stringify);
            resourceInputs["updateExisting"] = pulumi.output(args ? args.updateExisting : undefined).apply(JSON.stringify);
        }
