...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("oktaasa");
			params.setVersion("1.0.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL29rdGFkZXZlbG9wZXIvb2t0YWFzYSIsInZlcnNpb24iOiIxLjAuMSJ9fQ=="), c => c.charCodeAt(0)));
