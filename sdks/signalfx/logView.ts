...
export class LogView extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'signalfx:index/logView:LogView';
     ...
     */
    public readonly columns!: pulumi.Output<outputs.LogViewColumn[] | undefined>;
    /**
     ...
     */
    public readonly sortOptions!: pulumi.Output<outputs.LogViewSortOption[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LogViewArgs | LogViewState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogView.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface LogViewState {
     ...
     * Column configuration
     */
    columns?: pulumi.Input<pulumi.Input<inputs.LogViewColumn>[]>;
    /**
     * default connection that the dashboard uses
     */
     ...
     * Sorting options configuration
     */
    sortOptions?: pulumi.Input<pulumi.Input<inputs.LogViewSortOption>[]>;
    /**
     * Seconds since epoch to start the visualization
     */
