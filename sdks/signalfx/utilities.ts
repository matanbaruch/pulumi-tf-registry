...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("signalfx");
			params.setVersion("9.1.6");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NwbHVuay10ZXJyYWZvcm0vc2lnbmFsZngiLCJ2ZXJzaW9uIjoiOS4xLjYifX0="), c => c.charCodeAt(0)));
