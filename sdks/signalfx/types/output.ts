...
export interface AzureIntegrationResourceFilterRule {
    filterSource: string;
}
...
export interface GcpIntegrationProjectServiceKey {
    projectId: string;
    projectKey: string;
}
...
export interface LogViewSortOption {
    /**
     * Name of the column
     */
    descending: boolean;
