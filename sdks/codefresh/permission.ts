...
export class Permission extends pulumi.CustomResource {
    ...
    /**
     * Action to be allowed. Possible values: * create * read * update * delete * run (Only valid for pipeline resource) *
     * approve (Only valid for pipeline resource) * debug (Only valid for pipeline resource)
     */
    public readonly action!: pulumi.Output<string>;
    /**
     * Specifies the resource to use when evaluating the tags. Possible values: * project
     */
    public readonly relatedResource!: pulumi.Output<string | undefined>;
    /**
     * The type of resources the permission applies to. Possible values: * pipeline * cluster * project
     */
    public readonly resource!: pulumi.Output<string>;
    /**
     * The tags for which to apply the permission. Supports two custom tags: * untagged: Apply to all resources without tags *
...
export interface PermissionState {
     ...
     * Specifies the resource to use when evaluating the tags. Possible values: * project
     */
    relatedResource?: pulumi.Input<string>;
    /**
     * The type of resources the permission applies to. Possible values: * pipeline * cluster * project
     */
