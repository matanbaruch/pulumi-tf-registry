...
export class Idp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'codefresh:index/idp:Idp';
     ...
     */
    public readonly auth0!: pulumi.Output<outputs.IdpAuth0 | undefined>;
    /**
     * Settings for Azure IDP
     */
    public readonly azure!: pulumi.Output<outputs.IdpAzure | undefined>;
    /**
     ...
     */
    public readonly github!: pulumi.Output<outputs.IdpGithub | undefined>;
    /**
     * Settings for GitLab IDP
     */
    public readonly gitlab!: pulumi.Output<outputs.IdpGitlab | undefined>;
    /**
     * Settings for Google IDP
     */
    public readonly google!: pulumi.Output<outputs.IdpGoogle | undefined>;
    /**
     * Settings for Keycloak IDP
     */
    public readonly keycloak!: pulumi.Output<outputs.IdpKeycloak | undefined>;
    /**
     * Settings for Keycloak IDP
     */
    public readonly ldap!: pulumi.Output<outputs.IdpLdap | undefined>;
    /**
     ...
     */
    public readonly okta!: pulumi.Output<outputs.IdpOkta | undefined>;
    /**
     * Settings for onelogin IDP
     */
    public readonly onelogin!: pulumi.Output<outputs.IdpOnelogin | undefined>;
    /**
...
export interface IdpState {
     ...
     * Settings for Auth0 IDP
     */
    auth0?: pulumi.Input<inputs.IdpAuth0>;
    /**
     * Settings for Azure IDP
     */
    azure?: pulumi.Input<inputs.IdpAzure>;
    /**
     * Type of the IDP. Derived from idp specific config object (github, gitlab etc)
     */
     ...
     * Settings for GitHub IDP
     */
    github?: pulumi.Input<inputs.IdpGithub>;
    /**
     * Settings for GitLab IDP
     */
    gitlab?: pulumi.Input<inputs.IdpGitlab>;
    /**
     * Settings for Google IDP
     */
    google?: pulumi.Input<inputs.IdpGoogle>;
    /**
     * Settings for Keycloak IDP
     */
    keycloak?: pulumi.Input<inputs.IdpKeycloak>;
    /**
     * Settings for Keycloak IDP
     */
    ldap?: pulumi.Input<inputs.IdpLdap>;
    /**
     * Login url using the IDP to Codefresh
     */
     ...
     * Settings for Okta IDP
     */
    okta?: pulumi.Input<inputs.IdpOkta>;
    /**
     * Settings for onelogin IDP
     */
    onelogin?: pulumi.Input<inputs.IdpOnelogin>;
    /**
     * UI Callback url for the identity provider
     */
