...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("codefresh");
			params.setVersion("0.10.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2NvZGVmcmVzaC1pby9jb2RlZnJlc2giLCJ2ZXJzaW9uIjoiMC4xMC4xIn19"), c => c.charCodeAt(0)));
