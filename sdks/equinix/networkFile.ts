...
export class NetworkFile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'equinix:index/networkFile:NetworkFile';
    ...
    constructor(name: string, argsOrState?: NetworkFileArgs | NetworkFileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NetworkFile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
