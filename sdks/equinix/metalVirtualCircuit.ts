...
export class MetalVirtualCircuit extends pulumi.CustomResource {
    ...
    /**
     * The Metal IPv6 address for the SVI (Switch Virtual Interface) of the VirtualCircuit. Will default to the first usable IP
     * in the IPv6 subnet.
     */
    ...
    /**
     * A subnet from one of the IPv6 blocks associated with the VRF that we will help create an IP reservation for. Can only be
     * either a /126 or /127. * For a /127 block, it will only have two IP addresses, which will be used for the metal_ip and
     * customer_ip. * For a /126 block, it will have four IP addresses, but the first and last IP addresses are not usable. We
     * will default to the first usable IP address for the metal_ip.
     */
    ...
    constructor(name: string, argsOrState?: MetalVirtualCircuitArgs | MetalVirtualCircuitState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MetalVirtualCircuit.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
