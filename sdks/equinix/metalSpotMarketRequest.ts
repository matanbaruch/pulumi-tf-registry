...
export class MetalSpotMarketRequest extends pulumi.CustomResource {
    ...
    /**
     * Parameters for devices provisioned from this request. You can find the parameter description from the
     * equinix.MetalDevice doc
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.MetalSpotMarketRequestTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MetalSpotMarketRequestArgs | MetalSpotMarketRequestState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MetalSpotMarketRequest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MetalSpotMarketRequestState {
    ...
    timeouts?: pulumi.Input<inputs.MetalSpotMarketRequestTimeouts>;
    /**
     * On resource creation - wait until all desired devices are active, on resource destruction - wait until devices are
     * removed
     */
