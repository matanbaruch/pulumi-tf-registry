...
export class FabricCloudRouter extends pulumi.CustomResource {
    /**
     * Get an existing FabricCloudRouter resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FabricCloudRouterState, opts?: pulumi.CustomResourceOptions): FabricCloudRouter {
        return new FabricCloudRouter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'equinix:index/fabricCloudRouter:FabricCloudRouter';

    /**
     * Returns true if the given object is an instance of FabricCloudRouter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FabricCloudRouter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FabricCloudRouter.__pulumiType;
    }

    /**
     * Customer account information that is associated with this Fabric Cloud Router
     */
    public readonly account!: pulumi.Output<outputs.FabricCloudRouterAccount>;
    /**
     ...
     */
    public /*out*/ readonly changeLogs!: pulumi.Output<outputs.FabricCloudRouterChangeLog[]>;
    /**
     ...
     */
    public readonly location!: pulumi.Output<outputs.FabricCloudRouterLocation>;
    /**
     ...
     */
    public readonly notifications!: pulumi.Output<outputs.FabricCloudRouterNotification[]>;
    /**
     * Order information related to this Fabric Cloud Router
     */
    public readonly order!: pulumi.Output<outputs.FabricCloudRouterOrder | undefined>;
    /**
     * Fabric Cloud Router Package Type
     */
    public readonly package!: pulumi.Output<outputs.FabricCloudRouterPackage>;
    /**
     * Customer resource hierarchy project information. Applicable to customers onboarded to Equinix Identity and Access
     * Management. For more information see Identity and Access Management: Projects
     */
    public readonly project!: pulumi.Output<outputs.FabricCloudRouterProject>;
    /**
     * Fabric Cloud Router overall state
     */
    public /*out*/ readonly state!: pulumi.Output<string>;
    public readonly timeouts!: pulumi.Output<outputs.FabricCloudRouterTimeouts | undefined>;
    /**
    ...
    /**
     * Create a FabricCloudRouter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FabricCloudRouterArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FabricCloudRouterArgs | FabricCloudRouterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FabricCloudRouterState | undefined;
            ...
            const args = argsOrState as FabricCloudRouterArgs | undefined;
        ...
        super(FabricCloudRouter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering FabricCloudRouter resources.
 */
export interface FabricCloudRouterState {
    /**
     * Customer account information that is associated with this Fabric Cloud Router
     */
    account?: pulumi.Input<inputs.FabricCloudRouterAccount>;
    /**
     * Number of IPv4 BGP routes in use (including non-distinct prefixes)
     */
     ...
     * Captures Fabric Cloud Router lifecycle change information
     */
    changeLogs?: pulumi.Input<pulumi.Input<inputs.FabricCloudRouterChangeLog>[]>;
    /**
     * Number of connections associated with this Fabric Cloud Router instance
     */
     ...
     * Fabric Cloud Router location
     */
    location?: pulumi.Input<inputs.FabricCloudRouterLocation>;
    /**
     * Fabric Cloud Router name. An alpha-numeric 24 characters string which can include only hyphens and underscores
     */
     ...
     * Preferences for notifications on Fabric Cloud Router configuration or status changes
     */
    notifications?: pulumi.Input<pulumi.Input<inputs.FabricCloudRouterNotification>[]>;
    /**
     * Order information related to this Fabric Cloud Router
     */
    order?: pulumi.Input<inputs.FabricCloudRouterOrder>;
    /**
     * Fabric Cloud Router Package Type
     */
    package?: pulumi.Input<inputs.FabricCloudRouterPackage>;
    /**
     * Customer resource hierarchy project information. Applicable to customers onboarded to Equinix Identity and Access
     * Management. For more information see Identity and Access Management: Projects
     */
    project?: pulumi.Input<inputs.FabricCloudRouterProject>;
    /**
     * Fabric Cloud Router overall state
     */
    state?: pulumi.Input<string>;
    timeouts?: pulumi.Input<inputs.FabricCloudRouterTimeouts>;
    /**
     * Defines the FCR type like; XF_ROUTER
     */
...
/**
 * The set of arguments for constructing a FabricCloudRouter resource.
 */
export interface FabricCloudRouterArgs {
    /**
     * Customer account information that is associated with this Fabric Cloud Router
     */
    account: pulumi.Input<inputs.FabricCloudRouterAccount>;
