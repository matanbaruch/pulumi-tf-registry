...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("openshift");
			params.setVersion("1.1.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2xsb21ndWkvb3BlbnNoaWZ0IiwidmVyc2lvbiI6IjEuMS4wIn19"), c => c.charCodeAt(0)));
