...
export class ClusterRoleBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterRoleBindingState, opts?: pulumi.CustomResourceOptions): ClusterRoleBinding {
        return new ClusterRoleBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:index/clusterRoleBinding:ClusterRoleBinding';
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.ClusterRoleBindingMetadata>;
    /**
     * RoleRef references the Cluster Role for this binding
     */
    public readonly roleRef!: pulumi.Output<outputs.ClusterRoleBindingRoleRef>;
    /**
     * Subjects defines the entities to bind a ClusterRole to.
     */
    public readonly subjects!: pulumi.Output<outputs.ClusterRoleBindingSubject[]>;
    ...
    constructor(name: string, argsOrState?: ClusterRoleBindingArgs | ClusterRoleBindingState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClusterRoleBinding.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ClusterRoleBindingState {
    /**
     * Standard clusterRoleBinding's metadata. More info:
     * https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.ClusterRoleBindingMetadata>;
    /**
     * RoleRef references the Cluster Role for this binding
     */
    roleRef?: pulumi.Input<inputs.ClusterRoleBindingRoleRef>;
    /**
     * Subjects defines the entities to bind a ClusterRole to.
     */
    subjects?: pulumi.Input<pulumi.Input<inputs.ClusterRoleBindingSubject>[]>;
}
