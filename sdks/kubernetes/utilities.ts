...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("kubernetes");
			params.setVersion("2.32.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hhc2hpY29ycC9rdWJlcm5ldGVzIiwidmVyc2lvbiI6IjIuMzIuMCJ9fQ=="), c => c.charCodeAt(0)));
