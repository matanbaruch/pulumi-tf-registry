...
export class ReplicationController extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReplicationControllerState, opts?: pulumi.CustomResourceOptions): ReplicationController {
        return new ReplicationController(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:index/replicationController:ReplicationController';
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.ReplicationControllerMetadata>;
    /**
     * Spec defines the specification of the desired behavior of the replication controller. More info:
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public readonly spec!: pulumi.Output<outputs.ReplicationControllerSpec>;
    public readonly timeouts!: pulumi.Output<outputs.ReplicationControllerTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ReplicationControllerArgs | ReplicationControllerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ReplicationController.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ReplicationControllerState {
    /**
     * Standard replication controller's metadata. More info:
     * https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.ReplicationControllerMetadata>;
    /**
     * Spec defines the specification of the desired behavior of the replication controller. More info:
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    spec?: pulumi.Input<inputs.ReplicationControllerSpec>;
    timeouts?: pulumi.Input<inputs.ReplicationControllerTimeouts>;
}
