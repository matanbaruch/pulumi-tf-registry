...
export class Daemonset extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DaemonsetState, opts?: pulumi.CustomResourceOptions): Daemonset {
        return new Daemonset(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:index/daemonset:Daemonset';
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.DaemonsetMetadata>;
    /**
     ...
     */
    public readonly spec!: pulumi.Output<outputs.DaemonsetSpec>;
    public readonly timeouts!: pulumi.Output<outputs.DaemonsetTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DaemonsetArgs | DaemonsetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Daemonset.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface DaemonsetState {
     ...
     * https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.DaemonsetMetadata>;
    /**
     * Spec defines the specification of the desired behavior of the daemonset. More info:
     * https://v1-9.docs.kubernetes.io/docs/reference/generated/kubernetes-api/v1.9/#daemonset-v1-apps
     */
    spec?: pulumi.Input<inputs.DaemonsetSpec>;
    timeouts?: pulumi.Input<inputs.DaemonsetTimeouts>;
    /**
     * Wait for the rollout of the deployment to complete. Defaults to true.
     */
