...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:index/job:Job';
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.JobMetadata>;
    /**
     * Spec of the job owned by the cluster
     */
    public readonly spec!: pulumi.Output<outputs.JobSpec>;
...
export interface JobState {
     ...
     * https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.JobMetadata>;
    /**
     * Spec of the job owned by the cluster
     */
    spec?: pulumi.Input<inputs.JobSpec>;
