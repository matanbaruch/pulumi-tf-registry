...
export class RoleBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:index/roleBinding:RoleBinding';
     ...
     */
    public readonly metadata!: pulumi.Output<outputs.RoleBindingMetadata>;
    /**
     * RoleRef references the Role for this binding
     */
    public readonly roleRef!: pulumi.Output<outputs.RoleBindingRoleRef>;
    /**
     * Subjects defines the entities to bind a Role to.
     */
    public readonly subjects!: pulumi.Output<outputs.RoleBindingSubject[]>;
...
export interface RoleBindingState {
     ...
     * https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.RoleBindingMetadata>;
    /**
     * RoleRef references the Role for this binding
     */
    roleRef?: pulumi.Input<inputs.RoleBindingRoleRef>;
    /**
     * Subjects defines the entities to bind a Role to.
     */
    subjects?: pulumi.Input<pulumi.Input<inputs.RoleBindingSubject>[]>;
}
