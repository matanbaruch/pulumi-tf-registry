...
export class ServiceLanVpnInterfaceIpsecProfileParcel extends pulumi.CustomResource {
    /**
     * Get an existing ServiceLanVpnInterfaceIpsecProfileParcel resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceLanVpnInterfaceIpsecProfileParcelState, opts?: pulumi.CustomResourceOptions): ServiceLanVpnInterfaceIpsecProfileParcel {
        return new ServiceLanVpnInterfaceIpsecProfileParcel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/serviceLanVpnInterfaceIpsecProfileParcel:ServiceLanVpnInterfaceIpsecProfileParcel';

    /**
     * Returns true if the given object is an instance of ServiceLanVpnInterfaceIpsecProfileParcel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServiceLanVpnInterfaceIpsecProfileParcel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServiceLanVpnInterfaceIpsecProfileParcel.__pulumiType;
    }
    ...
    /**
     * Create a ServiceLanVpnInterfaceIpsecProfileParcel resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ServiceLanVpnInterfaceIpsecProfileParcelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ServiceLanVpnInterfaceIpsecProfileParcelArgs | ServiceLanVpnInterfaceIpsecProfileParcelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ServiceLanVpnInterfaceIpsecProfileParcelState | undefined;
            ...
            const args = argsOrState as ServiceLanVpnInterfaceIpsecProfileParcelArgs | undefined;
        ...
        super(ServiceLanVpnInterfaceIpsecProfileParcel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ServiceLanVpnInterfaceIpsecProfileParcel resources.
 */
export interface ServiceLanVpnInterfaceIpsecProfileParcelState {
    /**
     * Enable Application Tunnel Type - Choices: `none`, `sig`
     */
...
/**
 * The set of arguments for constructing a ServiceLanVpnInterfaceIpsecProfileParcel resource.
 */
export interface ServiceLanVpnInterfaceIpsecProfileParcelArgs {
    /**
     * Enable Application Tunnel Type - Choices: `none`, `sig`
     */
    applicationTunnelType: pulumi.Input<string>;
