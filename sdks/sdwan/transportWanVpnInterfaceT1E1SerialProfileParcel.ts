...
export class TransportWanVpnInterfaceT1E1SerialProfileParcel extends pulumi.CustomResource {
    /**
     * Get an existing TransportWanVpnInterfaceT1E1SerialProfileParcel resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransportWanVpnInterfaceT1E1SerialProfileParcelState, opts?: pulumi.CustomResourceOptions): TransportWanVpnInterfaceT1E1SerialProfileParcel {
        return new TransportWanVpnInterfaceT1E1SerialProfileParcel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/transportWanVpnInterfaceT1E1SerialProfileParcel:TransportWanVpnInterfaceT1E1SerialProfileParcel';

    /**
     * Returns true if the given object is an instance of TransportWanVpnInterfaceT1E1SerialProfileParcel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransportWanVpnInterfaceT1E1SerialProfileParcel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransportWanVpnInterfaceT1E1SerialProfileParcel.__pulumiType;
    }
     ...
     */
    public readonly tunnelInterfaceEncapsulations!: pulumi.Output<outputs.TransportWanVpnInterfaceT1E1SerialProfileParcelTunnelInterfaceEncapsulation[] | undefined>;
    /**
     * Variable name
     */
    ...
    /**
     * Create a TransportWanVpnInterfaceT1E1SerialProfileParcel resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TransportWanVpnInterfaceT1E1SerialProfileParcelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransportWanVpnInterfaceT1E1SerialProfileParcelArgs | TransportWanVpnInterfaceT1E1SerialProfileParcelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TransportWanVpnInterfaceT1E1SerialProfileParcelState | undefined;
            ...
            const args = argsOrState as TransportWanVpnInterfaceT1E1SerialProfileParcelArgs | undefined;
        ...
        super(TransportWanVpnInterfaceT1E1SerialProfileParcel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TransportWanVpnInterfaceT1E1SerialProfileParcel resources.
 */
export interface TransportWanVpnInterfaceT1E1SerialProfileParcelState {
    /**
     * Interface bandwidth capacity, in kbps - Range: `1`-`200000000`
     */
     ...
     * Encapsulation for TLOC
     */
    tunnelInterfaceEncapsulations?: pulumi.Input<pulumi.Input<inputs.TransportWanVpnInterfaceT1E1SerialProfileParcelTunnelInterfaceEncapsulation>[]>;
    /**
     * Variable name
     */
...
/**
 * The set of arguments for constructing a TransportWanVpnInterfaceT1E1SerialProfileParcel resource.
 */
export interface TransportWanVpnInterfaceT1E1SerialProfileParcelArgs {
    /**
     * Interface bandwidth capacity, in kbps - Range: `1`-`200000000`
     */
    bandwidth?: pulumi.Input<number>;
