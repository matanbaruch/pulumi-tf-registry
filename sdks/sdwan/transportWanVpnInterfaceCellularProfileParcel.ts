...
export class TransportWanVpnInterfaceCellularProfileParcel extends pulumi.CustomResource {
    /**
     * Get an existing TransportWanVpnInterfaceCellularProfileParcel resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransportWanVpnInterfaceCellularProfileParcelState, opts?: pulumi.CustomResourceOptions): TransportWanVpnInterfaceCellularProfileParcel {
        return new TransportWanVpnInterfaceCellularProfileParcel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/transportWanVpnInterfaceCellularProfileParcel:TransportWanVpnInterfaceCellularProfileParcel';

    /**
     * Returns true if the given object is an instance of TransportWanVpnInterfaceCellularProfileParcel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransportWanVpnInterfaceCellularProfileParcel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransportWanVpnInterfaceCellularProfileParcel.__pulumiType;
    }

    /**
     * Configure ARP entries
     */
    public readonly arps!: pulumi.Output<outputs.TransportWanVpnInterfaceCellularProfileParcelArp[] | undefined>;
    /**
     ...
     */
    public readonly tunnelInterfaceEncapsulations!: pulumi.Output<outputs.TransportWanVpnInterfaceCellularProfileParcelTunnelInterfaceEncapsulation[] | undefined>;
    /**
     * Variable name
     */
    ...
    /**
     * Create a TransportWanVpnInterfaceCellularProfileParcel resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TransportWanVpnInterfaceCellularProfileParcelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransportWanVpnInterfaceCellularProfileParcelArgs | TransportWanVpnInterfaceCellularProfileParcelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TransportWanVpnInterfaceCellularProfileParcelState | undefined;
            ...
            const args = argsOrState as TransportWanVpnInterfaceCellularProfileParcelArgs | undefined;
        ...
        super(TransportWanVpnInterfaceCellularProfileParcel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TransportWanVpnInterfaceCellularProfileParcel resources.
 */
export interface TransportWanVpnInterfaceCellularProfileParcelState {
    /**
     * Configure ARP entries
     */
    arps?: pulumi.Input<pulumi.Input<inputs.TransportWanVpnInterfaceCellularProfileParcelArp>[]>;
    /**
     * Interface downstream bandwidth capacity, in kbps - Range: `1`-`2147483647`
     */
     ...
     * Encapsulation for TLOC
     */
    tunnelInterfaceEncapsulations?: pulumi.Input<pulumi.Input<inputs.TransportWanVpnInterfaceCellularProfileParcelTunnelInterfaceEncapsulation>[]>;
    /**
     * Variable name
     */
...
/**
 * The set of arguments for constructing a TransportWanVpnInterfaceCellularProfileParcel resource.
 */
export interface TransportWanVpnInterfaceCellularProfileParcelArgs {
    /**
     * Configure ARP entries
     */
    arps?: pulumi.Input<pulumi.Input<inputs.TransportWanVpnInterfaceCellularProfileParcelArp>[]>;
