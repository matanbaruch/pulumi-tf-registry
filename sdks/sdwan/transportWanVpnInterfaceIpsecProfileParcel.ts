...
export class TransportWanVpnInterfaceIpsecProfileParcel extends pulumi.CustomResource {
    /**
     * Get an existing TransportWanVpnInterfaceIpsecProfileParcel resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TransportWanVpnInterfaceIpsecProfileParcelState, opts?: pulumi.CustomResourceOptions): TransportWanVpnInterfaceIpsecProfileParcel {
        return new TransportWanVpnInterfaceIpsecProfileParcel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sdwan:index/transportWanVpnInterfaceIpsecProfileParcel:TransportWanVpnInterfaceIpsecProfileParcel';

    /**
     * Returns true if the given object is an instance of TransportWanVpnInterfaceIpsecProfileParcel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TransportWanVpnInterfaceIpsecProfileParcel {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TransportWanVpnInterfaceIpsecProfileParcel.__pulumiType;
    }
    ...
    /**
     * Create a TransportWanVpnInterfaceIpsecProfileParcel resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TransportWanVpnInterfaceIpsecProfileParcelArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: TransportWanVpnInterfaceIpsecProfileParcelArgs | TransportWanVpnInterfaceIpsecProfileParcelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TransportWanVpnInterfaceIpsecProfileParcelState | undefined;
            ...
            const args = argsOrState as TransportWanVpnInterfaceIpsecProfileParcelArgs | undefined;
        ...
        super(TransportWanVpnInterfaceIpsecProfileParcel.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering TransportWanVpnInterfaceIpsecProfileParcel resources.
 */
export interface TransportWanVpnInterfaceIpsecProfileParcelState {
    /**
     * Enable Application Tunnel Type - Choices: `none`, `sig`
     */
...
/**
 * The set of arguments for constructing a TransportWanVpnInterfaceIpsecProfileParcel resource.
 */
export interface TransportWanVpnInterfaceIpsecProfileParcelArgs {
    /**
     * Enable Application Tunnel Type - Choices: `none`, `sig`
     */
    applicationTunnelType: pulumi.Input<string>;
