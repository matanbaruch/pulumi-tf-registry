...
export class ProjectUser extends pulumi.CustomResource {
    ...
    /**
     * Whether the user has accepted the request to join the project. Users get an invite and become project members after
    ...
    public readonly timeouts!: pulumi.Output<outputs.ProjectUserTimeouts | undefined>;
...
export interface ProjectUserState {
    ...
    timeouts?: pulumi.Input<inputs.ProjectUserTimeouts>;
}
