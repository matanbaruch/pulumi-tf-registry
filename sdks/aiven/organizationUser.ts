...
export class OrganizationUser extends pulumi.CustomResource {
    ...
    /**
     * This is a boolean flag that determines whether an invitation was accepted or not by the user. `false` value means that
     * the invitation was sent to the user but not yet accepted. `true` means that the user accepted the invitation and now a
    ...
    public readonly timeouts!: pulumi.Output<outputs.OrganizationUserTimeouts | undefined>;
    /**
     * This is a user email address that first will be invited, and after accepting an invitation, they become a member of the
     * organization. Should be lowercase. Changing this property forces recreation of the resource.
     */
...
export interface OrganizationUserState {
    ...
    timeouts?: pulumi.Input<inputs.OrganizationUserTimeouts>;
    /**
     * This is a user email address that first will be invited, and after accepting an invitation, they become a member of the
     * organization. Should be lowercase. Changing this property forces recreation of the resource.
     */
