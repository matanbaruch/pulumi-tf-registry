...
export class M3db extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: M3dbState, opts?: pulumi.CustomResourceOptions): M3db {
        return new M3db(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/m3db:M3db';

    /**
     * Returns true if the given object is an instance of M3db.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is M3db {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === M3db.__pulumiType;
    }
     ...
     */
    public readonly m3db!: pulumi.Output<outputs.M3dbM3db | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.M3dbTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: M3dbArgs | M3dbState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(M3db.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface M3dbState {
    ...
    timeouts?: pulumi.Input<inputs.M3dbTimeouts>;
}
