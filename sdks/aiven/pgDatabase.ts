...
export class PgDatabase extends pulumi.CustomResource {
    ...
    /**
     * Default string sort order (`LC_COLLATE`) of the database. The default value is `en_US.UTF-8`. Changing this property
     * forces recreation of the resource.
     */
    public readonly lcCollate!: pulumi.Output<string | undefined>;
    /**
     * Default character classification (`LC_CTYPE`) of the database. The default value is `en_US.UTF-8`. Changing this
    ...
    public readonly timeouts!: pulumi.Output<outputs.PgDatabaseTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PgDatabaseArgs | PgDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PgDatabase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
