...
export class AwsVpcPeeringConnection extends pulumi.CustomResource {
    ...
    /**
     * The AWS region of the peered VPC, if different from the Aiven VPC region. Changing this property forces recreation of
     * the resource.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.AwsVpcPeeringConnectionTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AwsVpcPeeringConnectionArgs | AwsVpcPeeringConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AwsVpcPeeringConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AwsVpcPeeringConnectionState {
    ...
    timeouts?: pulumi.Input<inputs.AwsVpcPeeringConnectionTimeouts>;
    /**
     * The ID of the Aiven VPC. Changing this property forces recreation of the resource.
     */
