...
export class AzurePrivatelinkConnectionApproval extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AzurePrivatelinkConnectionApprovalTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AzurePrivatelinkConnectionApprovalArgs | AzurePrivatelinkConnectionApprovalState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AzurePrivatelinkConnectionApproval.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AzurePrivatelinkConnectionApprovalState {
    ...
    timeouts?: pulumi.Input<inputs.AzurePrivatelinkConnectionApprovalTimeouts>;
}
