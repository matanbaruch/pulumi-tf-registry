...
export class AwsPrivatelink extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AwsPrivatelinkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: AwsPrivatelinkArgs | AwsPrivatelinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AwsPrivatelink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AwsPrivatelinkState {
    ...
    timeouts?: pulumi.Input<inputs.AwsPrivatelinkTimeouts>;
}
