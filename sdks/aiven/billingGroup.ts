...
export class BillingGroup extends pulumi.CustomResource {
    ...
    /**
     * Billing currency for the billing group. Supported currencies are: AUD, CAD, CHF, DKK, EUR, GBP, JPY, NOK, NZD, SEK, SGD,
     * and USD.
     */
    ...
    /**
     * Link a billing group to an existing organization or account by using its ID. To set up proper dependencies please refer
     * to this variable as a reference.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.BillingGroupTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: BillingGroupArgs | BillingGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BillingGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
