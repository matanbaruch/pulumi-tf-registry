...
export class Project extends pulumi.CustomResource {
    ...
    /**
     * Link a project to an existing account using its account ID. This field is deprecated. Use `parent_id` instead. To set up
     * proper dependencies please refer to this variable as a reference.
     *
    ...
    /**
     * The ID of the billing group this project is assigned to. To set up proper dependencies please refer to this variable as
     * a reference.
     */
    public readonly billingGroup!: pulumi.Output<string | undefined>;
    /**
     * The CA certificate for the project. This is required for configuring clients that connect to certain services like
     * Kafka.
     */
    public /*out*/ readonly caCert!: pulumi.Output<string>;
    /**
     * The name of the project to copy billing information, technical contacts, and some other project attributes from. This is
     * most useful to set up the same billing method when you use bank transfers to pay invoices for other projects. You can
     * only do this when creating a project. You can't set the billing over the API for an existing. To set up proper
     * dependencies please refer to this variable as a reference.
     */
    public readonly copyFromProject!: pulumi.Output<string | undefined>;
    /**
     * Default cloud provider and region where services are hosted. This can be changed after the project is created and will
    ...
    /**
     * Link a project to an [organization, organizational unit,](https://aiven.io/docs/platform/concepts/orgs-units-projects)
     * or account by using its ID. To set up proper dependencies please refer to this variable as a reference.
     */
    ...
    /**
     * The name of the project. Names must be globally unique among all Aiven customers and cannot be changed later without
     * destroying and re-creating the project, including all sub-resources.
     */
    ...
    /**
     * The email addresses for [project contacts](https://aiven.io/docs/platform/howto/technical-emails), who will receive
     * important alerts and updates about this project and its services. You can also set email contacts at the service level.
