...
export class AzurePrivatelink extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AzurePrivatelinkTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AzurePrivatelinkArgs | AzurePrivatelinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AzurePrivatelink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AzurePrivatelinkState {
    ...
    timeouts?: pulumi.Input<inputs.AzurePrivatelinkTimeouts>;
    /**
     * A list of allowed subscription IDs. Maximum length: `16`.
     */
