...
export class Opensearch extends pulumi.CustomResource {
     ...
     */
    public readonly opensearch!: pulumi.Output<outputs.OpensearchOpensearch | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.OpensearchTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OpensearchArgs | OpensearchState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Opensearch.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface OpensearchState {
    ...
    timeouts?: pulumi.Input<inputs.OpensearchTimeouts>;
}
