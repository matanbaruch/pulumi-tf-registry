...
export class ServiceIntegration extends pulumi.CustomResource {
    ...
    /**
     * Type of the service integration. Possible values: `alertmanager`, `autoscaler`, `caching`,
     * `cassandra_cross_service_cluster`, `clickhouse_credentials`, `clickhouse_kafka`, `clickhouse_postgresql`, `dashboard`,
     * `datadog`, `datasource`, `external_aws_cloudwatch_logs`, `external_aws_cloudwatch_metrics`,
     * `external_elasticsearch_logs`, `external_google_cloud_logging`, `external_opensearch_logs`, `flink`,
     * `flink_external_bigquery`, `flink_external_kafka`, `flink_external_postgresql`, `internal_connectivity`, `jolokia`,
     * `kafka_connect`, `kafka_connect_postgresql`, `kafka_logs`, `kafka_mirrormaker`, `logs`, `m3aggregator`, `m3coordinator`,
     * `metrics`, `opensearch_cross_cluster_replication`, `opensearch_cross_cluster_search`, `prometheus`, `read_replica`,
     * `rsyslog`, `schema_registry_proxy`, `stresstester`, `thanos_distributed_query`, `thanos_migrate`, `thanoscompactor`,
     * `thanosquery`, `thanosstore`, `vector`, `vmalert`
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServiceIntegrationTimeouts | undefined>;
...
export interface ServiceIntegrationState {
    ...
    timeouts?: pulumi.Input<inputs.ServiceIntegrationTimeouts>;
}
