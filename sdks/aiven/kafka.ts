...
export class Kafka extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KafkaState, opts?: pulumi.CustomResourceOptions): Kafka {
        return new Kafka(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/kafka:Kafka';
     ...
     */
    public readonly kafka!: pulumi.Output<outputs.KafkaKafka | undefined>;
    /**
     ...
     */
    public readonly serviceIntegrations!: pulumi.Output<outputs.KafkaServiceIntegration[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: KafkaArgs | KafkaState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as KafkaArgs | undefined;
        ...
        super(Kafka.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaTimeouts>;
}
