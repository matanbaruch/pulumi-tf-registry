...
export class StaticIp extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.StaticIpTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: StaticIpArgs | StaticIpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(StaticIp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
