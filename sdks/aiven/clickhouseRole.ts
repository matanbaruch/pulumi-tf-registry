...
export class ClickhouseRole extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClickhouseRoleTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ClickhouseRoleArgs | ClickhouseRoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClickhouseRole.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ClickhouseRoleState {
    ...
    timeouts?: pulumi.Input<inputs.ClickhouseRoleTimeouts>;
}
