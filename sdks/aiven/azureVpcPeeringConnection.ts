...
export class AzureVpcPeeringConnection extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AzureVpcPeeringConnectionTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AzureVpcPeeringConnectionArgs | AzureVpcPeeringConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AzureVpcPeeringConnection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AzureVpcPeeringConnectionState {
    ...
    timeouts?: pulumi.Input<inputs.AzureVpcPeeringConnectionTimeouts>;
    /**
     * The name of the Azure VNet. Changing this property forces recreation of the resource.
     */
