...
export class KafkaAcl extends pulumi.CustomResource {
    ...
    /**
     * Permissions to grant. The possible values are `admin`, `read`, `readwrite` and `write`. Changing this property forces
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaAclTimeouts | undefined>;
    /**
...
export interface KafkaAclState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaAclTimeouts>;
    /**
     * Topics that the permissions apply to. Changing this property forces recreation of the resource.
     */
