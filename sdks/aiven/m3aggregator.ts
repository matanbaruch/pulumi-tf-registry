...
export class M3aggregator extends pulumi.CustomResource {
     ...
     */
    public readonly m3aggregator!: pulumi.Output<outputs.M3aggregatorM3aggregator | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.M3aggregatorTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: M3aggregatorArgs | M3aggregatorState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["m3aggregator"] = args ? args.m3aggregator : undefined;
        ...
        super(M3aggregator.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface M3aggregatorState {
    ...
    timeouts?: pulumi.Input<inputs.M3aggregatorTimeouts>;
}
