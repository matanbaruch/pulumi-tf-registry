...
export class Influxdb extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InfluxdbState, opts?: pulumi.CustomResourceOptions): Influxdb {
        return new Influxdb(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/influxdb:Influxdb';

    /**
     * Returns true if the given object is an instance of Influxdb.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Influxdb {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Influxdb.__pulumiType;
    }
     ...
     */
    public readonly influxdb!: pulumi.Output<outputs.InfluxdbInfluxdb | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.InfluxdbTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: InfluxdbArgs | InfluxdbState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InfluxdbState | undefined;
        ...
        super(Influxdb.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InfluxdbState {
     ...
     * InfluxDB server provided values
     */
    influxdb?: pulumi.Input<inputs.InfluxdbInfluxdb>;
    /**
     * Influxdb user configurable settings
     */
    ...
    timeouts?: pulumi.Input<inputs.InfluxdbTimeouts>;
}
