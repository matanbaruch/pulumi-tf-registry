...
export class ConnectionPool extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ConnectionPoolTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ConnectionPoolArgs | ConnectionPoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConnectionPool.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
