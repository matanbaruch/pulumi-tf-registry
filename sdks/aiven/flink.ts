...
export class Flink extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FlinkState, opts?: pulumi.CustomResourceOptions): Flink {
        return new Flink(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/flink:Flink';

    /**
     * Returns true if the given object is an instance of Flink.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Flink {
     ...
     */
    public readonly flink!: pulumi.Output<outputs.FlinkFlink | undefined>;
    /**
     ...
     */
    public readonly serviceIntegrations!: pulumi.Output<outputs.FlinkServiceIntegration[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.FlinkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: FlinkArgs | FlinkState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FlinkState | undefined;
        ...
        super(Flink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FlinkState {
    ...
    timeouts?: pulumi.Input<inputs.FlinkTimeouts>;
}
