...
export class KafkaConnector extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaConnectorTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: KafkaConnectorArgs | KafkaConnectorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaConnector.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaConnectorState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaConnectorTimeouts>;
}
