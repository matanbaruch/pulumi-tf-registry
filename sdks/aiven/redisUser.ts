...
export class RedisUser extends pulumi.CustomResource {
    ...
    /**
     * Defines command category rules. The field is required with`redis_acl_commands` and `redis_acl_keys`. Changing this
     * property forces recreation of the resource.
     */
    ...
    /**
     * Defines rules for individual commands. The field is required with`redis_acl_categories` and `redis_acl_keys`. Changing
     * this property forces recreation of the resource.
     */
    public readonly redisAclCommands!: pulumi.Output<string[] | undefined>;
    /**
     * Defines key access rules. The field is required with`redis_acl_categories` and `redis_acl_keys`. Changing this property
    ...
    public readonly timeouts!: pulumi.Output<outputs.RedisUserTimeouts | undefined>;
    /**
     * Type of the user account. Tells whether the user is the primary account or a regular account.
     */
    public /*out*/ readonly type!: pulumi.Output<string>;
    /**
     * The actual name of the Redis User. To set up proper dependencies please refer to this variable as a reference. Changing
     * this property forces recreation of the resource.
     */
    ...
    constructor(name: string, argsOrState?: RedisUserArgs | RedisUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RedisUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface RedisUserState {
    ...
    timeouts?: pulumi.Input<inputs.RedisUserTimeouts>;
    /**
     * Type of the user account. Tells whether the user is the primary account or a regular account.
     */
