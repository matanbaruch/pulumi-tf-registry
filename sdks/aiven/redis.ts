...
export class Redis extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aiven:index/redis:Redis';
     ...
     */
    public /*out*/ readonly components!: pulumi.Output<outputs.RedisComponent[]>;
    /**
     ...
     */
    public readonly redis!: pulumi.Output<outputs.RedisRedis | undefined>;
    /**
     ...
     */
    public readonly serviceIntegrations!: pulumi.Output<outputs.RedisServiceIntegration[] | undefined>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.RedisTag[] | undefined>;
    /**
     ...
     */
    public readonly techEmails!: pulumi.Output<outputs.RedisTechEmail[] | undefined>;
    /**
...
export interface RedisState {
     ...
     * important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.RedisTechEmail>[]>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent
     * unintentional service deletion. This does not shield against deleting databases or topics but for services with backups
     * much of the content can at least be restored from backup in case accidental deletion is done.
