...
export class InfluxdbUser extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.InfluxdbUserTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InfluxdbUserArgs | InfluxdbUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InfluxdbUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface InfluxdbUserState {
    ...
    timeouts?: pulumi.Input<inputs.InfluxdbUserTimeouts>;
    /**
     * Type of the user account. Tells whether the user is the primary account or a regular account.
     */
