...
export class ProjectVpc extends pulumi.CustomResource {
    ...
    /**
     * The cloud provider and region where the service is hosted in the format `CLOUD_PROVIDER-REGION_NAME`. For example,
     * `google-europe-west1` or `aws-us-east-2`. Changing this property forces recreation of the resource.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.ProjectVpcTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ProjectVpcArgs | ProjectVpcState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectVpc.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ProjectVpcState {
    ...
    timeouts?: pulumi.Input<inputs.ProjectVpcTimeouts>;
}
