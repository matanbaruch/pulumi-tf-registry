...
export class GcpPrivatelink extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.GcpPrivatelinkTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: GcpPrivatelinkArgs | GcpPrivatelinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GcpPrivatelink.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface GcpPrivatelinkState {
    ...
    timeouts?: pulumi.Input<inputs.GcpPrivatelinkTimeouts>;
}
