...
export class ClickhouseDatabase extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClickhouseDatabaseTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ClickhouseDatabaseArgs | ClickhouseDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClickhouseDatabase.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
