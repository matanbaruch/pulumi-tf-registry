...
export class AccountTeamMember extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AccountTeamMemberTimeouts | undefined>;
    /**
     * Is a user email address that first will be invited, and after accepting an invitation, he or she becomes a member of a
     * team. Should be lowercase. Changing this property forces recreation of the resource.
     */
    ...
    constructor(name: string, argsOrState?: AccountTeamMemberArgs | AccountTeamMemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AccountTeamMember.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AccountTeamMemberState {
    ...
    timeouts?: pulumi.Input<inputs.AccountTeamMemberTimeouts>;
    /**
     * Is a user email address that first will be invited, and after accepting an invitation, he or she becomes a member of a
     * team. Should be lowercase. Changing this property forces recreation of the resource.
     */
