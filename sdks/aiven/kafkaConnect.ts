...
export class KafkaConnect extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: KafkaConnectState, opts?: pulumi.CustomResourceOptions): KafkaConnect {
        return new KafkaConnect(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/kafkaConnect:KafkaConnect';
     ...
     */
    public /*out*/ readonly components!: pulumi.Output<outputs.KafkaConnectComponent[]>;
    /**
     ...
     */
    public readonly serviceIntegrations!: pulumi.Output<outputs.KafkaConnectServiceIntegration[] | undefined>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.KafkaConnectTag[] | undefined>;
    /**
     ...
     */
    public readonly techEmails!: pulumi.Output<outputs.KafkaConnectTechEmail[] | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaConnectTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: KafkaConnectArgs | KafkaConnectState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as KafkaConnectState | undefined;
            ...
            const args = argsOrState as KafkaConnectArgs | undefined;
        ...
        super(KafkaConnect.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaConnectState {
     ...
     * important alerts and updates about this service. You can also set email contacts at the project level.
     */
    techEmails?: pulumi.Input<pulumi.Input<inputs.KafkaConnectTechEmail>[]>;
    /**
     * Prevents the service from being deleted. It is recommended to set this to `true` for all production services to prevent
     * unintentional service deletion. This does not shield against deleting databases or topics but for services with backups
     * much of the content can at least be restored from backup in case accidental deletion is done.
    ...
    timeouts?: pulumi.Input<inputs.KafkaConnectTimeouts>;
}
