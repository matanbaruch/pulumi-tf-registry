...
export class OrganizationApplicationUser extends pulumi.CustomResource {
    ...
    /**
     * An email address automatically generated by Aiven to help identify the application user. No notifications are sent to
     * this email.
     */
    public /*out*/ readonly email!: pulumi.Output<string>;
    /**
     * Makes the application user a super admin. The super admin role has full access to an organization, its billing and
     * settings, and all its organizational units, projects, and services.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.OrganizationApplicationUserTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: OrganizationApplicationUserArgs | OrganizationApplicationUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationApplicationUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
