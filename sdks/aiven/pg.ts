...
export class Pg extends pulumi.CustomResource {
     ...
     */
    public readonly pg!: pulumi.Output<outputs.PgPg | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.PgTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: PgArgs | PgState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Pg.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PgState {
    ...
    timeouts?: pulumi.Input<inputs.PgTimeouts>;
}
