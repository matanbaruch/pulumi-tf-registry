...
export class MirrormakerReplicationFlow extends pulumi.CustomResource {
    ...
    /**
     * List of topic configuration properties and/or regular expressions to not replicate. The properties that are not
     * replicated by default are: `follower.replication.throttled.replicas`, `leader.replication.throttled.replicas`,
     * `message.timestamp.difference.max.ms`, `message.timestamp.type`, `unclean.leader.election.enable`, and
     * `min.insync.replicas`. Setting this overrides the defaults. For example, to enable replication for 'min.insync.replicas'
     * and 'unclean.leader.election.enable' set this to: ["follower\\\\.replication\\\\.throttled\\\\.replicas",
     * "leader\\\\.replication\\\\.throttled\\\\.replicas", "message\\\\.timestamp\\\\.difference\\\\.max\\\\.ms",
     * "message\\\\.timestamp\\\\.type"]
     */
    public readonly configPropertiesExcludes!: pulumi.Output<string[] | undefined>;
    /**
     * Whether to emit heartbeats to the direction opposite to the flow, i.e. to the source cluster. The default value is
     * `false`.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.MirrormakerReplicationFlowTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MirrormakerReplicationFlowArgs | MirrormakerReplicationFlowState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MirrormakerReplicationFlow.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface MirrormakerReplicationFlowState {
    ...
    timeouts?: pulumi.Input<inputs.MirrormakerReplicationFlowTimeouts>;
    /**
     * List of topics and/or regular expressions to replicate
     */
