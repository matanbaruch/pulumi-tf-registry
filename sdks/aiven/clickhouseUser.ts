...
export class ClickhouseUser extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClickhouseUserTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ClickhouseUserArgs | ClickhouseUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClickhouseUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
