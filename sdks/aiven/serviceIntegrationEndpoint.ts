...
export class ServiceIntegrationEndpoint extends pulumi.CustomResource {
    ...
    /**
     * Type of the service integration endpoint. Possible values: `autoscaler`, `datadog`, `external_aws_cloudwatch_logs`,
     * `external_aws_cloudwatch_metrics`, `external_aws_s3`, `external_clickhouse`, `external_elasticsearch_logs`,
     * `external_google_cloud_bigquery`, `external_google_cloud_logging`, `external_kafka`, `external_mysql`,
     * `external_opensearch_logs`, `external_postgresql`, `external_redis`, `external_schema_registry`,
     * `external_sumologic_logs`, `jolokia`, `prometheus`, `rsyslog`
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.ServiceIntegrationEndpointTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ServiceIntegrationEndpointArgs | ServiceIntegrationEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceIntegrationEndpoint.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ServiceIntegrationEndpointState {
    ...
    timeouts?: pulumi.Input<inputs.ServiceIntegrationEndpointTimeouts>;
}
