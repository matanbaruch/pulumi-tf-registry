...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("aiven");
			params.setVersion("4.24.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2FpdmVuL2FpdmVuIiwidmVyc2lvbiI6IjQuMjQuMCJ9fQ=="), c => c.charCodeAt(0)));
