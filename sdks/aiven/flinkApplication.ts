...
export class FlinkApplication extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.FlinkApplicationTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: FlinkApplicationArgs | FlinkApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FlinkApplication.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
