...
export class ClickhouseGrant extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClickhouseGrantTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ClickhouseGrantArgs | ClickhouseGrantState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClickhouseGrant.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ClickhouseGrantState {
    ...
    timeouts?: pulumi.Input<inputs.ClickhouseGrantTimeouts>;
    /**
     * The user to grant privileges or roles to. To set up proper dependencies please refer to this variable as a reference.
     * Changing this property forces recreation of the resource.
     */
