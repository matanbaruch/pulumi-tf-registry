...
export class KafkaMirrormaker extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaMirrormakerTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: KafkaMirrormakerArgs | KafkaMirrormakerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaMirrormaker.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaMirrormakerState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaMirrormakerTimeouts>;
}
