...
export class KafkaSchema extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaSchemaTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: KafkaSchemaArgs | KafkaSchemaState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaSchema.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaSchemaState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaSchemaTimeouts>;
    /**
     * Kafka Schema configuration version.
     */
