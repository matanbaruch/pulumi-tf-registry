...
export class CassandraUser extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.CassandraUserTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CassandraUserArgs | CassandraUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CassandraUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CassandraUserState {
    ...
    timeouts?: pulumi.Input<inputs.CassandraUserTimeouts>;
    /**
     * Type of the user account. Tells whether the user is the primary account or a regular account.
     */
