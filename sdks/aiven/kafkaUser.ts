...
export class KafkaUser extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaUserTimeouts | undefined>;
    /**
     * User account type, such as primary or regular account.
     */
    public /*out*/ readonly type!: pulumi.Output<string>;
    /**
     * Name of the Kafka service user. To set up proper dependencies please refer to this variable as a reference. Changing
    ...
    constructor(name: string, argsOrState?: KafkaUserArgs | KafkaUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaUser.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaUserState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaUserTimeouts>;
    /**
     * User account type, such as primary or regular account.
     */
