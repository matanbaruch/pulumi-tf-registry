...
export class TransitGatewayVpcAttachment extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.TransitGatewayVpcAttachmentTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: TransitGatewayVpcAttachmentArgs | TransitGatewayVpcAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TransitGatewayVpcAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface TransitGatewayVpcAttachmentState {
    ...
    timeouts?: pulumi.Input<inputs.TransitGatewayVpcAttachmentTimeouts>;
    /**
     * List of private IPv4 ranges to route through the peering connection
     */
