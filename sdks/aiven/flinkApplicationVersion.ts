...
export class FlinkApplicationVersion extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.FlinkApplicationVersionTimeouts | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: FlinkApplicationVersionArgs | FlinkApplicationVersionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FlinkApplicationVersion.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface FlinkApplicationVersionState {
    ...
    timeouts?: pulumi.Input<inputs.FlinkApplicationVersionTimeouts>;
    /**
     * Application version number.
     */
