...
export class KafkaSchemaConfiguration extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.KafkaSchemaConfigurationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: KafkaSchemaConfigurationArgs | KafkaSchemaConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaSchemaConfiguration.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface KafkaSchemaConfigurationState {
    ...
    timeouts?: pulumi.Input<inputs.KafkaSchemaConfigurationTimeouts>;
}
