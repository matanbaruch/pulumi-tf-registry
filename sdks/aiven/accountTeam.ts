...
export class AccountTeam extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.AccountTeamTimeouts | undefined>;
    /**
     * Time of last update
     */
    ...
    constructor(name: string, argsOrState?: AccountTeamArgs | AccountTeamState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AccountTeam.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AccountTeamState {
    ...
    timeouts?: pulumi.Input<inputs.AccountTeamTimeouts>;
    /**
     * Time of last update
     */
