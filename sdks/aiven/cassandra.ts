...
export class Cassandra extends pulumi.CustomResource {
     ...
     */
    public readonly cassandra!: pulumi.Output<outputs.CassandraCassandra | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.CassandraTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: CassandraArgs | CassandraState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Cassandra.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface CassandraState {
    ...
    timeouts?: pulumi.Input<inputs.CassandraTimeouts>;
}
