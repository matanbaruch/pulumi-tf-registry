...
export class Clickhouse extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClickhouseState, opts?: pulumi.CustomResourceOptions): Clickhouse {
        return new Clickhouse(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aiven:index/clickhouse:Clickhouse';

    /**
     * Returns true if the given object is an instance of Clickhouse.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Clickhouse {
     ...
     */
    public readonly clickhouse!: pulumi.Output<outputs.ClickhouseClickhouse | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.ClickhouseTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ClickhouseArgs | ClickhouseState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as ClickhouseArgs | undefined;
        ...
        super(Clickhouse.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ClickhouseState {
    ...
    timeouts?: pulumi.Input<inputs.ClickhouseTimeouts>;
}
