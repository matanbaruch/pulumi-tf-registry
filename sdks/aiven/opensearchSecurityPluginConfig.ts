...
export class OpensearchSecurityPluginConfig extends pulumi.CustomResource {
    ...
    /**
     * Whether the os-sec-admin user is enabled. This indicates whether the user management with the security plugin is
     * enabled. This is always true when the os-sec-admin password was set at least once.
     */
    ...
    public readonly timeouts!: pulumi.Output<outputs.OpensearchSecurityPluginConfigTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: OpensearchSecurityPluginConfigArgs | OpensearchSecurityPluginConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OpensearchSecurityPluginConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
