...
export class Grafana extends pulumi.CustomResource {
     ...
     */
    public readonly grafana!: pulumi.Output<outputs.GrafanaGrafana | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.GrafanaTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: GrafanaArgs | GrafanaState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Grafana.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface GrafanaState {
    ...
    timeouts?: pulumi.Input<inputs.GrafanaTimeouts>;
}
