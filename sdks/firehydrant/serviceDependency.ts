...
export class ServiceDependency extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'firehydrant:index/serviceDependency:ServiceDependency';
    ...
    public readonly connectedServiceId!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: ServiceDependencyArgs | ServiceDependencyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["connectedServiceId"] = state ? state.connectedServiceId : undefined;
            resourceInputs["notes"] = state ? state.notes : undefined;
            resourceInputs["serviceId"] = state ? state.serviceId : undefined;
        } else {
            const args = argsOrState as ServiceDependencyArgs | undefined;
            if ((!args || args.connectedServiceId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'connectedServiceId'");
            }
            if ((!args || args.serviceId === undefined) && !opts.urn) {
                throw new Error("Missing required property 'serviceId'");
            }
            resourceInputs["connectedServiceId"] = args ? args.connectedServiceId : undefined;
...
export interface ServiceDependencyState {
    connectedServiceId?: pulumi.Input<string>;
