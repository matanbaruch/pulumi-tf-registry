...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("firehydrant");
			params.setVersion("0.11.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2ZpcmVoeWRyYW50L2ZpcmVoeWRyYW50IiwidmVyc2lvbiI6IjAuMTEuMCJ9fQ=="), c => c.charCodeAt(0)));
