...
export class Functionality extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'firehydrant:index/functionality:Functionality';
    ...
    constructor(name: string, argsOrState?: FunctionalityArgs | FunctionalityState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Functionality.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
