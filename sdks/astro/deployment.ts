...
export class Deployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'astro:index/deployment:Deployment';
    ...
    /**
     * Deployment cloud provider - required for 'STANDARD' deployments. If changing this value, the deployment will be
     * recreated in the new cloud provider
     */
    public readonly cloudProvider!: pulumi.Output<string>;
    /**
     * Deployment cluster identifier - required for 'HYBRID' and 'DEDICATED' deployments. If changing this value, the
     * deployment will be recreated in the new cluster
     */
    ...
    /**
     * Whether DAG deploy is enabled - Changing this value may disrupt your deployment. Read more at
     * https://docs.astronomer.io/astro/deploy-dags#enable-or-disable-dag-only-deploys-on-a-deployment
     */
    public readonly isDagDeployEnabled!: pulumi.Output<boolean>;
    /**
     * Deployment development mode - required for 'STANDARD' and 'DEDICATED' deployments. If changing from 'False' to 'True',
    ...
    /**
     * Deployment region - required for 'STANDARD' deployments. If changing this value, the deployment will be recreated in the
     * new region
     */
