...
export class UserInvite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'astro:index/userInvite:UserInvite';
    ...
    constructor(name: string, argsOrState?: UserInviteArgs | UserInviteState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserInvite.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
