...
export class TeamRoles extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'astro:index/teamRoles:TeamRoles';
    ...
    constructor(name: string, argsOrState?: TeamRolesArgs | TeamRolesState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(TeamRoles.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
