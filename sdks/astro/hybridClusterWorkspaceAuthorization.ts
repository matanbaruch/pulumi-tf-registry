...
export class HybridClusterWorkspaceAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'astro:index/hybridClusterWorkspaceAuthorization:HybridClusterWorkspaceAuthorization';
    ...
    constructor(name: string, argsOrState?: HybridClusterWorkspaceAuthorizationArgs | HybridClusterWorkspaceAuthorizationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(HybridClusterWorkspaceAuthorization.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
