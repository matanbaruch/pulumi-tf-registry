...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("astro");
			params.setVersion("1.0.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2FzdHJvbm9tZXIvYXN0cm8iLCJ2ZXJzaW9uIjoiMS4wLjAifX0="), c => c.charCodeAt(0)));
