...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "astro:index/apiToken:ApiToken":
                return new ApiToken(name, <any>undefined, { urn })
            case "astro:index/cluster:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "astro:index/deployment:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "astro:index/hybridClusterWorkspaceAuthorization:HybridClusterWorkspaceAuthorization":
                return new HybridClusterWorkspaceAuthorization(name, <any>undefined, { urn })
            case "astro:index/team:Team":
                return new Team(name, <any>undefined, { urn })
            case "astro:index/teamRoles:TeamRoles":
                return new TeamRoles(name, <any>undefined, { urn })
            case "astro:index/userInvite:UserInvite":
                return new UserInvite(name, <any>undefined, { urn })
            case "astro:index/userRoles:UserRoles":
                return new UserRoles(name, <any>undefined, { urn })
            case "astro:index/workspace:Workspace":
...
pulumi.runtime.registerResourceModule("astro", "index/apiToken", _module)
pulumi.runtime.registerResourceModule("astro", "index/cluster", _module)
pulumi.runtime.registerResourceModule("astro", "index/deployment", _module)
pulumi.runtime.registerResourceModule("astro", "index/hybridClusterWorkspaceAuthorization", _module)
pulumi.runtime.registerResourceModule("astro", "index/team", _module)
pulumi.runtime.registerResourceModule("astro", "index/teamRoles", _module)
pulumi.runtime.registerResourceModule("astro", "index/userInvite", _module)
pulumi.runtime.registerResourceModule("astro", "index/userRoles", _module)
pulumi.runtime.registerResourceModule("astro", "index/workspace", _module)
pulumi.runtime.registerResourcePackage("astro", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:astro") {
