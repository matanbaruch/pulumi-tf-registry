...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("lyvecloud");
			params.setVersion("0.2.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3NlYWdhdGUvbHl2ZWNsb3VkIiwidmVyc2lvbiI6IjAuMi4yIn19"), c => c.charCodeAt(0)));
