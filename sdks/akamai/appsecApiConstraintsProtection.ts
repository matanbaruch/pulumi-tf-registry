...
export class AppsecApiConstraintsProtection extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppsecApiConstraintsProtectionState, opts?: pulumi.CustomResourceOptions): AppsecApiConstraintsProtection {
        return new AppsecApiConstraintsProtection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'akamai:index/appsecApiConstraintsProtection:AppsecApiConstraintsProtection';

    /**
     * Returns true if the given object is an instance of AppsecApiConstraintsProtection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppsecApiConstraintsProtection {
     ...
     */
    constructor(name: string, args: AppsecApiConstraintsProtectionArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AppsecApiConstraintsProtectionArgs | AppsecApiConstraintsProtectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AppsecApiConstraintsProtection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
