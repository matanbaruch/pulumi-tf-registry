...
export function getCloudaccessKeyOutput(args: GetCloudaccessKeyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCloudaccessKeyResult> {
    return pulumi.output(args).apply((a: any) => getCloudaccessKey(a, opts))
}
