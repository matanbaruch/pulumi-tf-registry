...
export class PropertyActivation extends pulumi.CustomResource {
    ...
    public readonly ruleErrors!: pulumi.Output<outputs.PropertyActivationRuleError[] | undefined>;
    ...
    constructor(name: string, argsOrState?: PropertyActivationArgs | PropertyActivationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PropertyActivation.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
