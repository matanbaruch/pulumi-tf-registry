...
export class ImagingPolicyVideo extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImagingPolicyVideoState, opts?: pulumi.CustomResourceOptions): ImagingPolicyVideo {
        return new ImagingPolicyVideo(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'akamai:index/imagingPolicyVideo:ImagingPolicyVideo';

    /**
     * Returns true if the given object is an instance of ImagingPolicyVideo.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImagingPolicyVideo {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImagingPolicyVideo.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ImagingPolicyVideoArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImagingPolicyVideoArgs | ImagingPolicyVideoState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImagingPolicyVideoState | undefined;
            ...
            const args = argsOrState as ImagingPolicyVideoArgs | undefined;
        ...
        super(ImagingPolicyVideo.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
 ...
 */
export interface ImagingPolicyVideoState {
    /**
     * With this flag set to false, the user can perform modifications on staging without affecting the version already saved
     * to production. With this flag set to true, the policy will be saved on the production network. It is possible to change
     * it back to false only when there are any changes to the policy qualifying it for the new version.
 ...
 */
export interface ImagingPolicyVideoArgs {
    /**
     * With this flag set to false, the user can perform modifications on staging without affecting the version already saved
     * to production. With this flag set to true, the policy will be saved on the production network. It is possible to change
     * it back to false only when there are any changes to the policy qualifying it for the new version.
