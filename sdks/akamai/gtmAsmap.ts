...
export class GtmAsmap extends pulumi.CustomResource {
    ...
    public readonly defaultDatacenters!: pulumi.Output<outputs.GtmAsmapDefaultDatacenter[]>;
    ...
    constructor(name: string, argsOrState?: GtmAsmapArgs | GtmAsmapState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(GtmAsmap.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface GtmAsmapState {
    ...
    defaultDatacenters?: pulumi.Input<pulumi.Input<inputs.GtmAsmapDefaultDatacenter>[]>;
