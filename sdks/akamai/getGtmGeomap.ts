...
export function getGtmGeomapOutput(args: GetGtmGeomapOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGtmGeomapResult> {
    return pulumi.output(args).apply((a: any) => getGtmGeomap(a, opts))
}
