...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("netskopebwan");
			params.setVersion("0.0.2");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL25ldHNrb3Blb3NzL25ldHNrb3BlYndhbiIsInZlcnNpb24iOiIwLjAuMiJ9fQ=="), c => c.charCodeAt(0)));
