...
export class SystemIpv6neighborcache extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/systemIpv6neighborcache:SystemIpv6neighborcache';
    ...
    constructor(name: string, argsOrState?: SystemIpv6neighborcacheArgs | SystemIpv6neighborcacheState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemIpv6neighborcache.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
