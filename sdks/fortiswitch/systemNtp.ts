...
export class SystemNtp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/systemNtp:SystemNtp';
    ...
    public readonly allowUnsyncSource!: pulumi.Output<string>;
    ...
    public readonly logTimeAdjustments!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: SystemNtpArgs | SystemNtpState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["allowUnsyncSource"] = state ? state.allowUnsyncSource : undefined;
            resourceInputs["authentication"] = state ? state.authentication : undefined;
            resourceInputs["dynamicSortSubtable"] = state ? state.dynamicSortSubtable : undefined;
            resourceInputs["key"] = state ? state.key : undefined;
            resourceInputs["keyId"] = state ? state.keyId : undefined;
            resourceInputs["keyType"] = state ? state.keyType : undefined;
            resourceInputs["logTimeAdjustments"] = state ? state.logTimeAdjustments : undefined;
            ...
            resourceInputs["allowUnsyncSource"] = args ? args.allowUnsyncSource : undefined;
            resourceInputs["authentication"] = args ? args.authentication : undefined;
            resourceInputs["dynamicSortSubtable"] = args ? args.dynamicSortSubtable : undefined;
            resourceInputs["key"] = args?.key ? pulumi.secret(args.key) : undefined;
            resourceInputs["keyId"] = args ? args.keyId : undefined;
            resourceInputs["keyType"] = args ? args.keyType : undefined;
            resourceInputs["logTimeAdjustments"] = args ? args.logTimeAdjustments : undefined;
...
export interface SystemNtpState {
    allowUnsyncSource?: pulumi.Input<string>;
    authentication?: pulumi.Input<string>;
    dynamicSortSubtable?: pulumi.Input<string>;
    key?: pulumi.Input<string>;
    keyId?: pulumi.Input<number>;
    keyType?: pulumi.Input<string>;
    logTimeAdjustments?: pulumi.Input<string>;
