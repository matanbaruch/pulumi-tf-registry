...
export class UserPeergrp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/userPeergrp:UserPeergrp';
    ...
    constructor(name: string, argsOrState?: UserPeergrpArgs | UserPeergrpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(UserPeergrp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
