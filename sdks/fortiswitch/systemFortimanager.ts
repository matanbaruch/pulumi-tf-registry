...
export class SystemFortimanager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/systemFortimanager:SystemFortimanager';
    ...
    constructor(name: string, argsOrState?: SystemFortimanagerArgs | SystemFortimanagerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemFortimanager.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
