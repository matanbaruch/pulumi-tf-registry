...
export class RouterAuthpath extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/routerAuthpath:RouterAuthpath';
    ...
    constructor(name: string, argsOrState?: RouterAuthpathArgs | RouterAuthpathState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RouterAuthpath.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
