...
export class SystemProxyarp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/systemProxyarp:SystemProxyarp';
    ...
    constructor(name: string, argsOrState?: SystemProxyarpArgs | SystemProxyarpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemProxyarp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
