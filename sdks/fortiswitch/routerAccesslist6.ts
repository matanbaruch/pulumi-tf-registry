...
export class RouterAccesslist6 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/routerAccesslist6:RouterAccesslist6';
    ...
    constructor(name: string, argsOrState?: RouterAccesslist6Args | RouterAccesslist6State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RouterAccesslist6.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
