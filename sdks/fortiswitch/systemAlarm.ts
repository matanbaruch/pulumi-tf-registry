...
export class SystemAlarm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'fortiswitch:index/systemAlarm:SystemAlarm';
    ...
    constructor(name: string, argsOrState?: SystemAlarmArgs | SystemAlarmState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SystemAlarm.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
