...
export class PeeringToken extends pulumi.CustomResource {
    ...
    /**
     * The addresses for the cluster that generates the peering token. Addresses take the form {host or IP}:port. You can
     * specify one or more load balancers or external IPs that route external traffic to this cluster's Consul servers.
     */
    ...
    constructor(name: string, argsOrState?: PeeringTokenArgs | PeeringTokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PeeringToken.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
