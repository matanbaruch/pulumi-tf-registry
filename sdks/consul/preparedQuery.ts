...
export class PreparedQuery extends pulumi.CustomResource {
    ...
    /**
     * When `true` the prepared query will return connect proxy services for a queried service. Conditions such as `tags` in
     * the prepared query will be matched against the proxy service. Defaults to false.
     */
    ...
    /**
     * Specifies a list of check IDs that should be ignored when filtering unhealthy instances. This is mostly useful in an
     * emergency or as a temporary measure when a health check is found to be unreliable. Being able to ignore it in
     * centrally-defined queries can be simpler than de-registering the check as an interim solution until the check can be
     * fixed.
     */
    public readonly ignoreCheckIds!: pulumi.Output<string[] | undefined>;
    /**
     * The name of the prepared query. Used to identify the prepared query during requests. Can be specified as an empty string
     * to configure the query as a catch-all.
     */
    public readonly name!: pulumi.Output<string>;
    /**
     * Allows specifying the name of a node to sort results near using Consul's distance sorting and network coordinates. The
     * magic `_agent` value can be used to always sort nearest the node servicing the request.
     */
    public readonly near!: pulumi.Output<string | undefined>;
    /**
     * Specifies a list of user-defined key/value pairs that will be used for filtering the query results to nodes with the
     * given metadata values present.
     */
    ...
    /**
     * Specifies a list of user-defined key/value pairs that will be used for filtering the query results to services with the
     * given metadata values present.
     */
    public readonly serviceMeta!: pulumi.Output<{[key: string]: string} | undefined>;
    /**
     * The name of the Consul session to tie this query's lifetime to. This is an advanced parameter that should not be used
     * without a complete understanding of Consul sessions and the implications of their use (it is recommended to leave this
     * blank in nearly all cases). If this parameter is omitted the query will not expire.
     */
    ...
    /**
     * The list of required and/or disallowed tags. If a tag is in this list it must be present. If the tag is preceded with a
    ...
    constructor(name: string, argsOrState?: PreparedQueryArgs | PreparedQueryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PreparedQuery.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
