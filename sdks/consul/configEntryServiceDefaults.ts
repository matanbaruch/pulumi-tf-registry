...
export class ConfigEntryServiceDefaults extends pulumi.CustomResource {
    ...
    /**
     * Specifies the number of milliseconds allowed for establishing connections to the local application instance before
     * timing out.
     */
    ...
    /**
     * Controls whether mutual TLS is required for incoming connections to this service. This setting is only supported for
     * services with transparent proxy enabled.
     */
    ...
    /**
     * Specifies the name of the name of the Consul admin partition that the configuration entry applies to. Refer to Admin
     * Partitions for additional information.
     */
    ...
    /**
     * Controls configurations specific to proxies in transparent mode. Refer to Transparent Proxy Mode for additional
     * information.
     */
    ...
    constructor(name: string, argsOrState?: ConfigEntryServiceDefaultsArgs | ConfigEntryServiceDefaultsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConfigEntryServiceDefaults.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
