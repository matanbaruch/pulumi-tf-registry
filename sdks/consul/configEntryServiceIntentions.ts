...
export class ConfigEntryServiceIntentions extends pulumi.CustomResource {
    ...
    /**
     * Specifies a JSON Web Token provider configured in a JWT provider configuration entry, as well as additional
     * configurations for verifying a service's JWT before authorizing communication between services
     */
    ...
    constructor(name: string, argsOrState?: ConfigEntryServiceIntentionsArgs | ConfigEntryServiceIntentionsState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConfigEntryServiceIntentions.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
