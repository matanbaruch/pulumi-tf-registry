...
export class ConfigEntryServiceResolver extends pulumi.CustomResource {
    ...
    /**
     * Specifies a defined subset of service instances to use when no explicit subset is requested. If this parameter is not
     * specified, Consul uses the unnamed default subset.
     */
    ...
    /**
     * Specifies redirect instructions for local service traffic so that services deployed to a different network location
     * resolve the upstream request instead.
     */
    ...
    constructor(name: string, argsOrState?: ConfigEntryServiceResolverArgs | ConfigEntryServiceResolverState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ConfigEntryServiceResolver.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
