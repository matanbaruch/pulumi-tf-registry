...
export class AclBindingRule extends pulumi.CustomResource {
    ...
    /**
     * The variables used when binding rule type is `templated-policy`. Can be lightly templated using HIL `${foo}` syntax from
    ...
    constructor(name: string, argsOrState?: AclBindingRuleArgs | AclBindingRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AclBindingRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
