...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("keeper");
			params.setVersion("1.2.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2tlZXBlci1zZWN1cml0eS9rZWVwZXIiLCJ2ZXJzaW9uIjoiMS4yLjAifX0="), c => c.charCodeAt(0)));
