...
export class InspectionProfile extends pulumi.CustomResource {
    ...
    public readonly controlsInfos!: pulumi.Output<outputs.InspectionProfileControlsInfo[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InspectionProfileArgs | InspectionProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InspectionProfile.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
