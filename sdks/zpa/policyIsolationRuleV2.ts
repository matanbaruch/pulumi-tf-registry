...
export class PolicyIsolationRuleV2 extends pulumi.CustomResource {
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.PolicyIsolationRuleV2Condition[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PolicyIsolationRuleV2Args | PolicyIsolationRuleV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PolicyIsolationRuleV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
