...
export class PolicyTimeoutRule extends pulumi.CustomResource {
    /**
     * Get an existing PolicyTimeoutRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyTimeoutRuleState, opts?: pulumi.CustomResourceOptions): PolicyTimeoutRule {
        return new PolicyTimeoutRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/policyTimeoutRule:PolicyTimeoutRule';

    /**
     * Returns true if the given object is an instance of PolicyTimeoutRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyTimeoutRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyTimeoutRule.__pulumiType;
    }
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.PolicyTimeoutRuleCondition[] | undefined>;
    /**
    ...
    /**
     * Create a PolicyTimeoutRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyTimeoutRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyTimeoutRuleArgs | PolicyTimeoutRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyTimeoutRuleState | undefined;
            ...
            const args = argsOrState as PolicyTimeoutRuleArgs | undefined;
        ...
        super(PolicyTimeoutRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyTimeoutRule resources.
 */
export interface PolicyTimeoutRuleState {
    /**
     * This is for providing the rule action.
     */
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.PolicyTimeoutRuleCondition>[]>;
    /**
     * This is for providing a customer message for the user.
     */
...
/**
 * The set of arguments for constructing a PolicyTimeoutRule resource.
 */
export interface PolicyTimeoutRuleArgs {
    /**
     * This is for providing the rule action.
     */
    action?: pulumi.Input<string>;
