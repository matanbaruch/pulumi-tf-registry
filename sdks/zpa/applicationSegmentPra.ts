...
export class ApplicationSegmentPra extends pulumi.CustomResource {
    ...
    public readonly commonAppsDtos!: pulumi.Output<outputs.ApplicationSegmentPraCommonAppsDto[] | undefined>;
    ...
    constructor(name: string, argsOrState?: ApplicationSegmentPraArgs | ApplicationSegmentPraState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApplicationSegmentPra.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
