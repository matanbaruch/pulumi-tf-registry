...
export class ApplicationSegmentInspection extends pulumi.CustomResource {
    ...
    public readonly commonAppsDtos!: pulumi.Output<outputs.ApplicationSegmentInspectionCommonAppsDto[] | undefined>;
    ...
    constructor(name: string, argsOrState?: ApplicationSegmentInspectionArgs | ApplicationSegmentInspectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApplicationSegmentInspection.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
