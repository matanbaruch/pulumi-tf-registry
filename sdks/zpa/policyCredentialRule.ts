...
export class PolicyCredentialRule extends pulumi.CustomResource {
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.PolicyCredentialRuleCondition[] | undefined>;
    ...
    constructor(name: string, argsOrState?: PolicyCredentialRuleArgs | PolicyCredentialRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PolicyCredentialRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
