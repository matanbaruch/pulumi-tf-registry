...
export class PolicyIsolationRule extends pulumi.CustomResource {
    /**
     * Get an existing PolicyIsolationRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyIsolationRuleState, opts?: pulumi.CustomResourceOptions): PolicyIsolationRule {
        return new PolicyIsolationRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/policyIsolationRule:PolicyIsolationRule';

    /**
     * Returns true if the given object is an instance of PolicyIsolationRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyIsolationRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyIsolationRule.__pulumiType;
    }
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.PolicyIsolationRuleCondition[] | undefined>;
    /**
    ...
    /**
     * Create a PolicyIsolationRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyIsolationRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyIsolationRuleArgs | PolicyIsolationRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyIsolationRuleState | undefined;
            ...
            const args = argsOrState as PolicyIsolationRuleArgs | undefined;
        ...
        super(PolicyIsolationRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyIsolationRule resources.
 */
export interface PolicyIsolationRuleState {
    /**
     * This is for providing the rule action.
     */
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.PolicyIsolationRuleCondition>[]>;
    /**
     * This is for providing a customer message for the user.
     */
...
/**
 * The set of arguments for constructing a PolicyIsolationRule resource.
 */
export interface PolicyIsolationRuleArgs {
    /**
     * This is for providing the rule action.
     */
    action?: pulumi.Input<string>;
