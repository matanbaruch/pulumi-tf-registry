...
export class SegmentGroup extends pulumi.CustomResource {
    ...
    public readonly applications!: pulumi.Output<outputs.SegmentGroupApplication[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SegmentGroupArgs | SegmentGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SegmentGroup.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
