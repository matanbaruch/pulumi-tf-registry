...
export class PolicyTimeoutRuleV2 extends pulumi.CustomResource {
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.PolicyTimeoutRuleV2Condition[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PolicyTimeoutRuleV2Args | PolicyTimeoutRuleV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PolicyTimeoutRuleV2.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
