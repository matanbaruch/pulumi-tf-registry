...
export class PraApprovalController extends pulumi.CustomResource {
    ...
    public readonly workingHours!: pulumi.Output<outputs.PraApprovalControllerWorkingHour[] | undefined>;
    ...
    constructor(name: string, argsOrState?: PraApprovalControllerArgs | PraApprovalControllerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PraApprovalController.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
