...
export class PolicyInspectionRule extends pulumi.CustomResource {
    /**
     * Get an existing PolicyInspectionRule resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PolicyInspectionRuleState, opts?: pulumi.CustomResourceOptions): PolicyInspectionRule {
        return new PolicyInspectionRule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'zpa:index/policyInspectionRule:PolicyInspectionRule';

    /**
     * Returns true if the given object is an instance of PolicyInspectionRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PolicyInspectionRule {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PolicyInspectionRule.__pulumiType;
    }
     ...
     */
    public readonly conditions!: pulumi.Output<outputs.PolicyInspectionRuleCondition[] | undefined>;
    /**
    ...
    /**
     * Create a PolicyInspectionRule resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: PolicyInspectionRuleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PolicyInspectionRuleArgs | PolicyInspectionRuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PolicyInspectionRuleState | undefined;
            ...
            const args = argsOrState as PolicyInspectionRuleArgs | undefined;
        ...
        super(PolicyInspectionRule.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering PolicyInspectionRule resources.
 */
export interface PolicyInspectionRuleState {
    /**
     * This is for providing the rule action.
     */
     ...
     * This is for proviidng the set of conditions for the policy.
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.PolicyInspectionRuleCondition>[]>;
    /**
     * This is for providing a customer message for the user.
     */
...
/**
 * The set of arguments for constructing a PolicyInspectionRule resource.
 */
export interface PolicyInspectionRuleArgs {
    /**
     * This is for providing the rule action.
     */
    action?: pulumi.Input<string>;
