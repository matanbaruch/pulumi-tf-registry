...
export class ProvisioningKey extends pulumi.CustomResource {
     ...
     */
    public readonly provisioningKey!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: ProvisioningKeyArgs | ProvisioningKeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["provisioningKey"] = args ? args.provisioningKey : undefined;
        ...
        super(ProvisioningKey.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
