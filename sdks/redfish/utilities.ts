...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("redfish");
			params.setVersion("1.4.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2RlbGwvcmVkZmlzaCIsInZlcnNpb24iOiIxLjQuMCJ9fQ=="), c => c.charCodeAt(0)));
