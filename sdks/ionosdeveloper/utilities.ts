...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ionosdeveloper");
			params.setVersion("0.0.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2lvbm9zLWRldmVsb3Blci9pb25vc2RldmVsb3BlciIsInZlcnNpb24iOiIwLjAuMSJ9fQ=="), c => c.charCodeAt(0)));
