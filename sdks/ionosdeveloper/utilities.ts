...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL2lvbm9zLWRldmVsb3Blci9pb25vc2RldmVsb3BlciIsInZlcnNpb24iOiIwLjAuMSJ9fQ=="), c => c.charCodeAt(0)));
