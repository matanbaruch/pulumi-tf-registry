...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "ionosdeveloper:index/dnsRecord:DnsRecord":
...
pulumi.runtime.registerResourceModule("ionosdeveloper", "index/dnsRecord", _module)
pulumi.runtime.registerResourcePackage("ionosdeveloper", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:ionosdeveloper") {
