...
export class ManagedInstanceAws extends pulumi.CustomResource {
    /**
     * Get an existing ManagedInstanceAws resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceAwsState, opts?: pulumi.CustomResourceOptions): ManagedInstanceAws {
        return new ManagedInstanceAws(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spotinst:index/managedInstanceAws:ManagedInstanceAws';

    /**
     * Returns true if the given object is an instance of ManagedInstanceAws.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ManagedInstanceAws {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagedInstanceAws.__pulumiType;
    }

    public readonly autoHealing!: pulumi.Output<boolean | undefined>;
    public readonly blockDeviceMappings!: pulumi.Output<outputs.ManagedInstanceAwsBlockDeviceMapping[] | undefined>;
    public readonly blockDevicesMode!: pulumi.Output<string | undefined>;
    public readonly cpuCredits!: pulumi.Output<string | undefined>;
    public readonly deletes!: pulumi.Output<outputs.ManagedInstanceAwsDelete[] | undefined>;
    ...
    public readonly integrationRoute53!: pulumi.Output<outputs.ManagedInstanceAwsIntegrationRoute53 | undefined>;
    public readonly keyPair!: pulumi.Output<string | undefined>;
    public readonly lifeCycle!: pulumi.Output<string | undefined>;
    public readonly loadBalancers!: pulumi.Output<outputs.ManagedInstanceAwsLoadBalancer[] | undefined>;
    public readonly managedInstanceAction!: pulumi.Output<outputs.ManagedInstanceAwsManagedInstanceAction | undefined>;
    public readonly metadataOptions!: pulumi.Output<outputs.ManagedInstanceAwsMetadataOptions | undefined>;
    public readonly minimumInstanceLifetime!: pulumi.Output<number | undefined>;
    public readonly name!: pulumi.Output<string>;
    public readonly networkInterfaces!: pulumi.Output<outputs.ManagedInstanceAwsNetworkInterface[] | undefined>;
    ...
    public readonly resourceTagSpecifications!: pulumi.Output<outputs.ManagedInstanceAwsResourceTagSpecification[] | undefined>;
    public readonly revertToSpot!: pulumi.Output<outputs.ManagedInstanceAwsRevertToSpot | undefined>;
    public readonly scheduledTasks!: pulumi.Output<outputs.ManagedInstanceAwsScheduledTask[] | undefined>;
    public readonly securityGroupIds!: pulumi.Output<string[] | undefined>;
    public readonly shutdownScript!: pulumi.Output<string | undefined>;
    public readonly subnetIds!: pulumi.Output<string[]>;
    public readonly tags!: pulumi.Output<outputs.ManagedInstanceAwsTag[] | undefined>;
    ...
    /**
     * Create a ManagedInstanceAws resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ManagedInstanceAwsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ManagedInstanceAwsArgs | ManagedInstanceAwsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagedInstanceAwsState | undefined;
            ...
            const args = argsOrState as ManagedInstanceAwsArgs | undefined;
        ...
        super(ManagedInstanceAws.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering ManagedInstanceAws resources.
 */
export interface ManagedInstanceAwsState {
    autoHealing?: pulumi.Input<boolean>;
    blockDeviceMappings?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsBlockDeviceMapping>[]>;
    blockDevicesMode?: pulumi.Input<string>;
    cpuCredits?: pulumi.Input<string>;
    deletes?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsDelete>[]>;
    ...
    integrationRoute53?: pulumi.Input<inputs.ManagedInstanceAwsIntegrationRoute53>;
    keyPair?: pulumi.Input<string>;
    lifeCycle?: pulumi.Input<string>;
    loadBalancers?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsLoadBalancer>[]>;
    managedInstanceAction?: pulumi.Input<inputs.ManagedInstanceAwsManagedInstanceAction>;
    metadataOptions?: pulumi.Input<inputs.ManagedInstanceAwsMetadataOptions>;
    minimumInstanceLifetime?: pulumi.Input<number>;
    name?: pulumi.Input<string>;
    networkInterfaces?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsNetworkInterface>[]>;
    ...
    resourceTagSpecifications?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsResourceTagSpecification>[]>;
    revertToSpot?: pulumi.Input<inputs.ManagedInstanceAwsRevertToSpot>;
    scheduledTasks?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsScheduledTask>[]>;
    securityGroupIds?: pulumi.Input<pulumi.Input<string>[]>;
    shutdownScript?: pulumi.Input<string>;
    subnetIds?: pulumi.Input<pulumi.Input<string>[]>;
    tags?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsTag>[]>;
...
/**
 * The set of arguments for constructing a ManagedInstanceAws resource.
 */
export interface ManagedInstanceAwsArgs {
    autoHealing?: pulumi.Input<boolean>;
    blockDeviceMappings?: pulumi.Input<pulumi.Input<inputs.ManagedInstanceAwsBlockDeviceMapping>[]>;
    blockDevicesMode?: pulumi.Input<string>;
    cpuCredits?: pulumi.Input<string>;
