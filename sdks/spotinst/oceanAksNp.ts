...
export class OceanAksNp extends pulumi.CustomResource {
    /**
     * Get an existing OceanAksNp resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OceanAksNpState, opts?: pulumi.CustomResourceOptions): OceanAksNp {
        return new OceanAksNp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'spotinst:index/oceanAksNp:OceanAksNp';

    /**
     * Returns true if the given object is an instance of OceanAksNp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OceanAksNp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OceanAksNp.__pulumiType;
    }
    ...
    public readonly autoscaler!: pulumi.Output<outputs.OceanAksNpAutoscaler | undefined>;
    ...
    public readonly filters!: pulumi.Output<outputs.OceanAksNpFilters | undefined>;
    public readonly headrooms!: pulumi.Output<outputs.OceanAksNpHeadroom[] | undefined>;
    public readonly health!: pulumi.Output<outputs.OceanAksNpHealth | undefined>;
    public readonly kubernetesVersion!: pulumi.Output<string | undefined>;
    public readonly labels!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly linuxOsConfigs!: pulumi.Output<outputs.OceanAksNpLinuxOsConfig[] | undefined>;
    ...
    public readonly scheduling!: pulumi.Output<outputs.OceanAksNpScheduling | undefined>;
    public readonly spotPercentage!: pulumi.Output<number | undefined>;
    public readonly tags!: pulumi.Output<{[key: string]: string} | undefined>;
    public readonly taints!: pulumi.Output<outputs.OceanAksNpTaint[] | undefined>;
    public readonly updatePolicy!: pulumi.Output<outputs.OceanAksNpUpdatePolicy | undefined>;
    public readonly vnetSubnetIds!: pulumi.Output<string[] | undefined>;

    /**
     * Create a OceanAksNp resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OceanAksNpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OceanAksNpArgs | OceanAksNpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OceanAksNpState | undefined;
            ...
            const args = argsOrState as OceanAksNpArgs | undefined;
        ...
        super(OceanAksNp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering OceanAksNp resources.
 */
export interface OceanAksNpState {
    ...
    autoscaler?: pulumi.Input<inputs.OceanAksNpAutoscaler>;
    availabilityZones?: pulumi.Input<pulumi.Input<string>[]>;
    controllerClusterId?: pulumi.Input<string>;
    enableNodePublicIp?: pulumi.Input<boolean>;
    fallbackToOndemand?: pulumi.Input<boolean>;
    filters?: pulumi.Input<inputs.OceanAksNpFilters>;
    headrooms?: pulumi.Input<pulumi.Input<inputs.OceanAksNpHeadroom>[]>;
    health?: pulumi.Input<inputs.OceanAksNpHealth>;
    kubernetesVersion?: pulumi.Input<string>;
    labels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    linuxOsConfigs?: pulumi.Input<pulumi.Input<inputs.OceanAksNpLinuxOsConfig>[]>;
    ...
    scheduling?: pulumi.Input<inputs.OceanAksNpScheduling>;
    spotPercentage?: pulumi.Input<number>;
    tags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    taints?: pulumi.Input<pulumi.Input<inputs.OceanAksNpTaint>[]>;
    updatePolicy?: pulumi.Input<inputs.OceanAksNpUpdatePolicy>;
    vnetSubnetIds?: pulumi.Input<pulumi.Input<string>[]>;
}

/**
 * The set of arguments for constructing a OceanAksNp resource.
 */
export interface OceanAksNpArgs {
    aksClusterName: pulumi.Input<string>;
    aksInfrastructureResourceGroupName: pulumi.Input<string>;
    aksRegion: pulumi.Input<string>;
    aksResourceGroupName: pulumi.Input<string>;
