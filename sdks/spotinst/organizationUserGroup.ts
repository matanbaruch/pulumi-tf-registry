...
export class OrganizationUserGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'spotinst:index/organizationUserGroup:OrganizationUserGroup';
    ...
    public readonly policies!: pulumi.Output<outputs.OrganizationUserGroupPolicy[] | undefined>;
...
export interface OrganizationUserGroupState {
    ...
    policies?: pulumi.Input<pulumi.Input<inputs.OrganizationUserGroupPolicy>[]>;
