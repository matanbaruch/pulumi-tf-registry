...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("helmfile");
			params.setVersion("0.14.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL211bW9zaHUvaGVsbWZpbGUiLCJ2ZXJzaW9uIjoiMC4xNC4xIn19"), c => c.charCodeAt(0)));
