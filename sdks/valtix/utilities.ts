...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("valtix");
			params.setVersion("24.2.3");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3ZhbHRpeC1zZWN1cml0eS92YWx0aXgiLCJ2ZXJzaW9uIjoiMjQuMi4zIn19"), c => c.charCodeAt(0)));
