...
export class CertRequest extends pulumi.CustomResource {
     ...
     */
    public readonly subjects!: pulumi.Output<outputs.CertRequestSubject[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CertRequestArgs | CertRequestState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CertRequest.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
