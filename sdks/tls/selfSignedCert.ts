...
export class SelfSignedCert extends pulumi.CustomResource {
     ...
     */
    public readonly subjects!: pulumi.Output<outputs.SelfSignedCertSubject[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SelfSignedCertArgs | SelfSignedCertState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SelfSignedCert.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
