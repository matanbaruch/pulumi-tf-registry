...
export class AllowList extends pulumi.CustomResource {
    ...
    /**
     * IP address component of the [CIDR](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing#CIDR_notation) range for
     * this entry.
     */
    public readonly cidrIp!: pulumi.Output<string>;
    /**
     * The [CIDR](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing#CIDR_notation) notation prefix length. A number
     * ranging from 0 to 32 indicating the size of the network. Use 32 to allow a single IP address.
     */
