...
export class MetricExportCloudwatchConfig extends pulumi.CustomResource {
    ...
    /**
     * Elaborates on the metric export status and hints at how to fix issues that may have occurred during asynchronous
     * operations.
     */
    ...
    constructor(name: string, argsOrState?: MetricExportCloudwatchConfigArgs | MetricExportCloudwatchConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MetricExportCloudwatchConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
