...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cockroach");
			params.setVersion("1.7.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NvY2tyb2FjaGRiL2NvY2tyb2FjaCIsInZlcnNpb24iOiIxLjcuNyJ9fQ=="), c => c.charCodeAt(0)));
