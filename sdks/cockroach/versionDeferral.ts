...
export class VersionDeferral extends pulumi.CustomResource {
    ...
    /**
     * The policy for managing automated minor version upgrades. Set to FIXED_DEFERRAL to defer upgrades by 60 days or
     * NOT_DEFERRED to apply upgrades immediately.
     */
    ...
    constructor(name: string, argsOrState?: VersionDeferralArgs | VersionDeferralState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VersionDeferral.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
