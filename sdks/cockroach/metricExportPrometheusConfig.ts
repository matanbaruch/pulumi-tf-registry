...
export class MetricExportPrometheusConfig extends pulumi.CustomResource {
    ...
    /**
     * The current state of the metric export configuration. Possible values are: [`NOT_DEPLOYED` `DISABLING` `ENABLING`
     * `ENABLED` `ERROR`]
     */
    ...
    constructor(name: string, argsOrState?: MetricExportPrometheusConfigArgs | MetricExportPrometheusConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MetricExportPrometheusConfig.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
