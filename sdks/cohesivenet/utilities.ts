...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("cohesivenet");
			params.setVersion("1.0.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2NvaGVzaXZlL2NvaGVzaXZlbmV0IiwidmVyc2lvbiI6IjEuMC40In19"), c => c.charCodeAt(0)));
