...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("zenlayercloud");
			params.setVersion("0.1.11");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3plbmxheWVyL3plbmxheWVyY2xvdWQiLCJ2ZXJzaW9uIjoiMC4xLjExIn19"), c => c.charCodeAt(0)));
