...
export class SecurityGroupAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zenlayercloud:index/securityGroupAttachment:SecurityGroupAttachment';
    ...
    constructor(name: string, argsOrState?: SecurityGroupAttachmentArgs | SecurityGroupAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SecurityGroupAttachment.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
