...
export class CdmBootstrapCcesAws extends pulumi.CustomResource {
    /**
     * Get an existing CdmBootstrapCcesAws resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CdmBootstrapCcesAwsState, opts?: pulumi.CustomResourceOptions): CdmBootstrapCcesAws {
        return new CdmBootstrapCcesAws(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'polaris:index/cdmBootstrapCcesAws:CdmBootstrapCcesAws';

    /**
     * Returns true if the given object is an instance of CdmBootstrapCcesAws.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CdmBootstrapCcesAws {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CdmBootstrapCcesAws.__pulumiType;
    }
    ...
    public readonly timeouts!: pulumi.Output<outputs.CdmBootstrapCcesAwsTimeouts | undefined>;
    public readonly waitForCompletion!: pulumi.Output<boolean | undefined>;

    /**
     * Create a CdmBootstrapCcesAws resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CdmBootstrapCcesAwsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CdmBootstrapCcesAwsArgs | CdmBootstrapCcesAwsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CdmBootstrapCcesAwsState | undefined;
            ...
            const args = argsOrState as CdmBootstrapCcesAwsArgs | undefined;
        ...
        super(CdmBootstrapCcesAws.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CdmBootstrapCcesAws resources.
 */
export interface CdmBootstrapCcesAwsState {
    /**
     * The Rubrik cluster sends messages for the admin account to this email address.
     */
    ...
    timeouts?: pulumi.Input<inputs.CdmBootstrapCcesAwsTimeouts>;
    waitForCompletion?: pulumi.Input<boolean>;
}

/**
 * The set of arguments for constructing a CdmBootstrapCcesAws resource.
 */
export interface CdmBootstrapCcesAwsArgs {
    /**
     * The Rubrik cluster sends messages for the admin account to this email address.
     */
    adminEmail: pulumi.Input<string>;
