...
export class CdmBootstrapCcesAzure extends pulumi.CustomResource {
    /**
     * Get an existing CdmBootstrapCcesAzure resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CdmBootstrapCcesAzureState, opts?: pulumi.CustomResourceOptions): CdmBootstrapCcesAzure {
        return new CdmBootstrapCcesAzure(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'polaris:index/cdmBootstrapCcesAzure:CdmBootstrapCcesAzure';

    /**
     * Returns true if the given object is an instance of CdmBootstrapCcesAzure.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CdmBootstrapCcesAzure {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CdmBootstrapCcesAzure.__pulumiType;
    }
     ...
     */
    public readonly enableImmutability!: pulumi.Output<boolean | undefined>;
    /**
    ...
    public readonly timeouts!: pulumi.Output<outputs.CdmBootstrapCcesAzureTimeouts | undefined>;
    public readonly waitForCompletion!: pulumi.Output<boolean | undefined>;

    /**
     * Create a CdmBootstrapCcesAzure resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: CdmBootstrapCcesAzureArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CdmBootstrapCcesAzureArgs | CdmBootstrapCcesAzureState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CdmBootstrapCcesAzureState | undefined;
            ...
            resourceInputs["enableImmutability"] = state ? state.enableImmutability : undefined;
            ...
            const args = argsOrState as CdmBootstrapCcesAzureArgs | undefined;
            ...
            resourceInputs["enableImmutability"] = args ? args.enableImmutability : undefined;
        ...
        super(CdmBootstrapCcesAzure.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}

/**
 * Input properties used for looking up and filtering CdmBootstrapCcesAzure resources.
 */
export interface CdmBootstrapCcesAzureState {
    /**
     * The Rubrik cluster sends messages for the admin account to this email address.
     */
     ...
     * Flag to determine if versioning will be used on the Azure Blob storage to enable immutability.
     */
    enableImmutability?: pulumi.Input<boolean>;
    /**
     * IP address assigned to the management network gateway
     */
    ...
    timeouts?: pulumi.Input<inputs.CdmBootstrapCcesAzureTimeouts>;
    waitForCompletion?: pulumi.Input<boolean>;
}

/**
 * The set of arguments for constructing a CdmBootstrapCcesAzure resource.
 */
export interface CdmBootstrapCcesAzureArgs {
    /**
     * The Rubrik cluster sends messages for the admin account to this email address.
     */
    adminEmail: pulumi.Input<string>;
