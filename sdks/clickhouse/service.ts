...
export class Service extends pulumi.CustomResource {
    ...
    /**
     * Set minimum idling timeout (in minutes). Must be greater than or equal to 5 minutes. Must be set if idle_scaling is
     * enabled
     */
    ...
    /**
     * Maximum total memory of all workers during auto-scaling in Gb. Available only for 'production' services. Must be a
     * multiple of 12 and lower than 360 for non paid services or 720 for paid services.
     */
    public readonly maxTotalMemoryGb!: pulumi.Output<number | undefined>;
    /**
     * Minimum total memory of all workers during auto-scaling in Gb. Available only for 'production' services. Must be a
     * multiple of 12 and greater than 24.
     */
    ...
    /**
     * Number of replicas for the service. Available only for 'production' services. Must be between 3 and 20. Contact support
