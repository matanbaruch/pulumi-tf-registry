...
export class MsgVpnDistributedCacheClusterGlobalCachingHomeCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'solacebroker:index/msgVpnDistributedCacheClusterGlobalCachingHomeCluster:MsgVpnDistributedCacheClusterGlobalCachingHomeCluster';
