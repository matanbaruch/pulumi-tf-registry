...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("solacebroker");
			params.setVersion("1.0.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkudGVycmFmb3JtLmlvL3NvbGFjZXByb2R1Y3RzL3NvbGFjZWJyb2tlciIsInZlcnNpb24iOiIxLjAuMSJ9fQ=="), c => c.charCodeAt(0)));
